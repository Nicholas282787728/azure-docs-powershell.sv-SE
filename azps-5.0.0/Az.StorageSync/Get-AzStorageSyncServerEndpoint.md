...
## PROBLEMBESKRIVNING
Det här kommandot visar alla Server slut punkter i en given synkroniseringskoppling. Den kan också användas för att lista attributen för varje server slut punkt.
...
Det här kommandot får alla Server slut punkter i den angivna synkroniseringsresursen. Ange-ServerEndpointName för att returnera ett specifikt nummer.
