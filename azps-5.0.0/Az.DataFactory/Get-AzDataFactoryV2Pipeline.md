...
## PROBLEMBESKRIVNING
Get-AzDataFactoryV2Pipeline cmdlet får information om rörledningar i Azure Data Factory.
...
### Exempel 4: Hämta information om indata för den första aktiviteten
```powershell
