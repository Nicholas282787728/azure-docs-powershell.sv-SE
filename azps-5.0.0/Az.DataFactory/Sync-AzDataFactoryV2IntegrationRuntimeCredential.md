...
## PROBLEMBESKRIVNING
**Sync-AzDataFactoryV2IntegrationRuntimeCredential** -cmdleten synkroniserar lokala autentiseringsuppgifter bland integrations körnings noder, vilket innebär att autentiseringsuppgifterna är identiska på alla noder.

## BESKRIVS

### Exempel 1: synkronisera en referens till integration runtime

Synkroniserar uppgifter med kör tids noder för integration. (automatiskt genererat)
