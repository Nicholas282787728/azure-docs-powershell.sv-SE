...
## PROBLEMBESKRIVNING
Skapar ett objekt som representerar en Azure-lagringsenhet som ska monteras i ett webb program.
...
### -AccessKey
Åtkomst till Azure Storage-kontot
...
T. ex.: myfilestorageaccount.file.core.windows.net
...
### -MountPath
Sökvägen i behållaren där resursen som anges av resurs namn ska visas
...
### -Namn
ID för Azure Storage-egenskapen.
Måste vara unikt inom webb programmet eller plats
...
### -ShareName
Namn på resursen som ska monteras i behållaren
...
### – Skriv
Typ av Azure Storage-konto.
Windows-behållare stöder bara Azure-filer
