...
## PROBLEMBESKRIVNING
Cmdleten **Edit-AzWebAppBackupConfiguration** redigerar den aktuella konfigurations säkerhets kopian för en Azure Web App.

## BESKRIVS

### Exempel 1

Edit-AzWebAppBackupConfiguration cmdlet redigerar den aktuella konfigurations säkerhets kopian för en Azure Web App. (automatiskt genererat)
