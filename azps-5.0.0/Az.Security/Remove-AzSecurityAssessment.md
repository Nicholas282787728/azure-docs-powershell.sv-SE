...
## Sammanfattning
Tar bort en säkerhets utvärdering från ett abonnemang.
...
## PROBLEMBESKRIVNING
Tar bort ett resultat för säkerhets utvärdering från ett abonnemang, som vanligt vis används när en resoruce tas bort eller när utvärderingen inte är relevant för en viss resurs längre
...
Tar bort ett utvärderings resultat för ett abonnemang
