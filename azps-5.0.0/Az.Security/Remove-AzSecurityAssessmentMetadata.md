...
## Sammanfattning
Tar bort en metadata för säkerhets utvärdering från ett abonnemang.
...
## PROBLEMBESKRIVNING
Tar bort en metadata för säkerhets utvärdering från ett abonnemang. Den här åtgärden tar bort utvärderings typen och alla relevanta utvärderings resultat från abonnemanget.
...
Tar bort en utvärderings typ från ett abonnemang
