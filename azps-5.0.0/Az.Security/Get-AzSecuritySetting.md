...
## Sammanfattning
Hämta säkerhets inställningar i Azure Security Center
...
## PROBLEMBESKRIVNING
Get-AzSecuritySetting cmdlet får säkerhets inställningar i Azure Security Center.
...
Hämtar en inställning för data export för MCAS   
