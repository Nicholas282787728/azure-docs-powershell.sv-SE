...
## PROBLEMBESKRIVNING
Get-AzIotSecuritySolution cmdlet returnerar en eller flera IoT-säkerhetslösningar. IoT-säkerhetslösningen samlar in säkerhets data från IoT-enheter och IoT Hub för att förhindra och upptäcka hot.
...
Få lösningen "Sample" i resurs gruppen "MyResourceGroup"
...
Få en lista över alla säkerhetslösningar i resurs gruppen "MyResourceGroup"
