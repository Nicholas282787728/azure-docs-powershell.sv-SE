...
## PROBLEMBESKRIVNING
Cmdleten **New-AzLogicApp** skapar ett logiskt program med hjälp av funktionen logiska appar.
...
Du kan skapa en logik-app genom att ange namn, plats, logik program definition, resurs grupp och abonnemang.
...
### Exempel 1: skapa ett logiskt program med hjälp av definitions-och parameter fil Sök vägar
```
...
Det här kommandot skapar ett logiskt program i den angivna resurs gruppen.
Programmet logik innehåller definitionen och parametrarna som anges i fil Sök vägar.

### Exempel 2: skapa ett logiskt program med hjälp av definitions-och parameter objekt
```
...
Det här kommandot skapar ett logiskt program i den angivna resurs gruppen resurs grupp.

### Exempel 3: skapa ett logiskt program med hjälp av pipeline för att ange resurs gruppen
```
...
Det här kommandot får resurs gruppen "ResourceGroup11" genom att använda Get-AzResourceGroup cmdlet.
Kommandot överför den resurs gruppen till den aktuella cmdleten med hjälp av pipeline-operatorn.
Den aktuella cmdleten skapar ett logiskt program i den resurs gruppen.
Programmet logik innehåller definitionen och parametrarna som anges i fil Sök vägar.

### Exempel 4: skapa ett logiskt program baserat på ett befintligt logiskt program
```
...
Det första kommandot får till gång till logik programmet med namnet LogicApp03 med hjälp av Get-AzLogicApp cmdlet.
Kommandot lagrar programmet logik i $Workflow variabel.
Det andra kommandot skapar ett nytt logiskt program som använder definitionen och parametrarna för logik programmet som lagras i $Workflow.
...
### -Definition
Anger definitionen för din logik-app som ett objekt eller en sträng i JSON-format (JavaScript Object Notation).
