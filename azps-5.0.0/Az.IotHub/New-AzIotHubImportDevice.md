...
## PROBLEMBESKRIVNING
Skapar ett nytt import enheter jobb för IotHub.
Detta importerar alla enheter till IotHub från den angivna behållaren. Läs följande artikel om hur du skapar SAS URI.
...
Skapar en ny begäran om import enhet för IotHub "myiothub".
...
URI för BLOB-behållare för FileUpload
...
Den URI som utdata ska skrivas till. 
