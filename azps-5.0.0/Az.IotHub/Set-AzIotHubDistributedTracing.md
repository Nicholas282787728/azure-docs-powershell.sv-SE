...
### -SamplingMode
Aktiverar och inaktiverar sampling för distribuerad spårning.
...
### -SamplingRate
Kontrollerar hur många meddelanden som samplats för att lägga till spårnings kontext.
Det här värdet är ett procenttal.
Endast värden från 0 till 100 tillåts.
