...
Skapa en enhet i en IoT-hubb.

### [Add-AzIotHubDeviceChildren](Add-AzIotHubDeviceChildren.md)
Lägga till icke-arbetsenheter som underordnade till Edge-enheten.
...
Skapa en modul på en mål-IoT-enhet i en IoT-hubb.
...
Visar en lista över alla eller en särskild IoT Edge-distribution.

### [Get-AzIotHubDevice](Get-AzIotHubDevice.md)
Visar alla enheter eller en viss enhet i ett Azure IoT-hubb. 
...
Skaffa anslutnings strängen för en modul för mål-IoT i en IoT-hubb.
...
Anropa en metod för Edge-modul.

### [Invoke-AzIotHubQuery](Invoke-AzIotHubQuery.md)
Fråga en IoT-hubb med ett kraftfullt SQL-gilla-språk.
...
Skapa en SAS-token för en måls IoT Hub, enhet eller modul.
...
Ta bort en IoT-enhets konfiguration.
...
Ta bort icke kantbaserade enheter som barn från angiven Edge-enhet.
...
Ta bort modul (er) på en mål-IoT-enhet i en IoT-hubb.
...
### [Skicka-AzIotHubDevice2CloudMessage](Send-AzIotHubDevice2CloudMessage.md)
...
Uppdatera mutable-fälten för konfigurations registreringen.

### [Set-AzIotHubDeployment](Set-AzIotHubDeployment.md)
Uppdatera mutable-fälten i en IoT Edge-distribution.
...
Ställ in Edge-moduler på en enda Edge-enhet.
...
Uppdatera en modul på en mål-IoT-enhet i en IoT-hubb.
...
Uppdaterar Taggar och önskade egenskaper för en IoT-enhet.
