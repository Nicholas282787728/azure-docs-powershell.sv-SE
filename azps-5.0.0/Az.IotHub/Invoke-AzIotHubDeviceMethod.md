...
## PROBLEMBESKRIVNING
Starta en direkt metod på en enhet. Mer https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods information finns i.
...
Starta en enhets metod.

## MALLPARAMETRAR

### -ConnectionTimeOut
Antal sekunder att vänta tills en anslutning har genomförts.
...
### -Namn
Namnet på den metod som ska startas på den här enheten.
...
### -Nyttolast
Nytto lasten för metoden att starta på den här enheten.
...
### -ResponseTimeOut
Antal sekunder att vänta tills ett resultat erhålls från metoden Direct.
Standardvärdet är 10.
