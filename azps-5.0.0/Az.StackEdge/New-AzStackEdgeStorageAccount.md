...
## PROBLEMBESKRIVNING
Cmdleten **New-AzStackEdgeStorageAccount** skapar ett nytt Edge Storage-konto i en stack Edge-enhet. För en enhet går det bara att mappa ett gräns lagrings konto högst till ett moln lagrings konto.
...
2 EdgeStorageAccounts på enheten kan inte dela mer än 1 moln lagrings konto
...
### -Molnet
Använder en CloudStorageAccount för skiktning
...
### Microsoft. Azure. PowerShell. cmdletar. StackEdge. Models. PSStackEdgeStorageAccount
