...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzStackEdgeJob** hämtar de aktiva jobben på en stack Edge-enhet. Du kan nämna parametern name för att få information om ett visst jobb.
...
### -Namn
Namnet på jobbet, vanligt vis ett GUID
...
### Microsoft. Azure. PowerShell. cmdletar. StackEdge. Models. PSStackEdgeJob
