...
## PROBLEMBESKRIVNING
Cmdleten **New-AzServiceBusTopic** skapar ett nytt tjänst Bus-avsnitt i det angivna Service Bus-namnområdet.
...
Skapar ett nytt tjänst Bus-avsnitt i det angivna Service Bus-namnområdet. (automatiskt genererat)
