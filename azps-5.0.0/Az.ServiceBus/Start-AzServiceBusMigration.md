...
## PROBLEMBESKRIVNING
Cmdleten **Start-AzServiceBusMigration** skapar en ny migrering och börjar migrera enheter från standard till premie namn områden
...
Skapar en ny migrerings konfiguration för ' TestingNamespaceStandardMigration ' till ' TestingNamespacePremiumMigration '-namn områden
...
### -PostMigrationName
Namn på migrering för standard namn område i migrering
