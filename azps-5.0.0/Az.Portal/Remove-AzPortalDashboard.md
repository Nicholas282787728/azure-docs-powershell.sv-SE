...
### Exempel 1: ta bort en instrument panel
```powershell
PS C:\td\> Remove-AzPortalDashboard -ResourceGroupName my-rg -DashboardName dashbase02
```

Ta bort en Dashbaord med resurs grupp namn och instrument panels namn.

### Exempel 2: ta bort en instrument panel med pipelinen
```powershell
PS C:\> Get-AzPortalDashboard -ResourceGroupName my-rg -DashboardName dashbase02 | Remove-AzPortalDashboard
```

Ta bort instrument panelen från ett Get-AzDashboard samtal.
