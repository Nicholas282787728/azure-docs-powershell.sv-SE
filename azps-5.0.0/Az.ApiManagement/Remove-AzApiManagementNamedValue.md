...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzApiManagementNamedValue** tar bort ett Azure API Management **namet-värde**.
...
Det här kommandot tar bort det namngivna värdet med ID-Property11.
