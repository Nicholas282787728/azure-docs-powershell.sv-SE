...
## PROBLEMBESKRIVNING
Cmdleten **New-AzApiManagementOpenIdConnectProvider** skapar en OpenID Connect-leverantör i Azure API Management.

## BESKRIVS

### Exempel 1: skapa en leverantör
```powershell
...
Det här kommandot skapar en OpenID Connect- **leverantör** som heter Contoso OpenID Connect-leverantören

### Exempel 2

Skapar en OpenID. (automatiskt genererat)
