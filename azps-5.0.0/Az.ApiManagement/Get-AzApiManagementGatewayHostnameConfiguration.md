...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzApiManagementGatewayHostnameConfiguration** hämtar all eller specifik värd konfiguration för den befintliga gatewayen.

## BESKRIVS

### Exempel 1: Hämta alla hostname-konfigurationer för gatewayen
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGatewayHostnameConfiguration -Context $apimContext  -GatewayId "0123456789"
```

Det här kommandot får alla hostname-konfigurationer för en "0123456789"-Gateway.

### Exempel 2: skaffa en hostname-konfiguration för gatewayen
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Med det här kommandot får du "123"-värd konfiguration för en "0123456789"-Gateway.
...
Konfigurations identifierare för hostname.
