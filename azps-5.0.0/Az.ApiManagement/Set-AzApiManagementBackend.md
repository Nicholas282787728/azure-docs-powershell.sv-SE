...
### Exempel 1: uppdaterar beskrivningen av Server delen 123
```powershell
...
Uppdaterar en server del. (automatiskt genererat)
...
### -InputObject
Instans av PsApiManagementBackend. Denna parameter är obligatorisk.
