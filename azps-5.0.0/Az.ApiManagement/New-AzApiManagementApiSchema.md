...
## PROBLEMBESKRIVNING
Skapar det nya API-schemat för API: t.

## BESKRIVS

### Exempel 1: skapa ett nytt schema för Swagger petstore omfattande API
```powershell
...
Cmdlet **New-AzApiManagementApiSchema** skapar eller uppdaterar schemat för `swagger-petstore-extensive` aPI: t.

## MALLPARAMETRAR

### -ApiId
ID för API. Denna parameter är obligatorisk.
...
ContentType för API-schema. Denna parameter är obligatorisk.
