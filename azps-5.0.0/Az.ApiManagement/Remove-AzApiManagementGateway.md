...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzApiManagementGateway kopplar bort** ett API från en gateway.

## BESKRIVS

### Exempel 1: ta bort en befintlig gateway
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementGateway -Context $apimContext -GatewayId "g0001" -Force
```

Detta kommando tar bort en befintlig gateway och ber inte användaren att bekräfta.
