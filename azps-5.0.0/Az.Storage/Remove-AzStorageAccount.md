...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzStorageAccount** tar bort ett lagrings konto från Azure.
...
Det här kommandot tar bort det angivna lagrings kontot.
...
### -ResourceGroupName
Anger namnet på den resurs grupp som innehåller det lagrings konto som ska tas bort.
