...
## PROBLEMBESKRIVNING
**New-AzRmStorageShare** cmdlet tar bort en lagrings fil resurs.

## BESKRIVS

### Exempel 1: ta bort en lagrings fil med lagrings konto namn och resurs namn
```
PS C:\>Remove-AzRmStorageShare -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount" -Name "myshare"
```

Det här kommandot tar bort en lagrings fil resurs med namn på lagrings konto och resurs namn.

### Exempel 2: ta bort en lagrings fil med lagrings konto objekt och resurs namn
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount"
PS C:\>Remove-AzRmStorageShare -StorageAccount $accountObject -Name "myshare"
```

Det här kommandot tar bort en lagrings fil med lagrings konto objekt och resurs namn.

### Exempel 3: ta bort alla lagrings fil resurser i ett lagrings konto med pipeline
```
PS C:\>Get-AzStorageShare -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount" | Remove-AzRmStorageShare -Force
```

Detta kommando tar bort alla lagrings fil resurser i ett lagrings konto med pipelinan.
...
### -Force
Tvinga att ta bort delningen och allt innehåll i den
