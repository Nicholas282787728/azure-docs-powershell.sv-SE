...
## PROBLEMBESKRIVNING
Cmdleten **Move-AzDataLakeGen2Item** flyttar en fil eller katalog till en annan fil eller katalog på samma lagrings konto.
...
### Exempel 1: flytta en vikning i samma filesystem
```
...
Det här kommandot flyttar katalogen ' dir1 ' till katalogen ' dir3 ' i samma fil system.

### Exempel 2: flytta en fil via pipeline till ett annat fil system med samma lagrings konto utan att fråga
```
...
Det här kommandot flyttar filen ' dir1/fil1 ' i ' filesystem1 ' till filen ' dir2/fil2 ' i ' filesystem2 ' på samma lagrings konto utan fråga.
...
### -Force
Tvinga fram överskrivning av destinationen.
...
### -InputObject
Azure Datalake Gen2 objekt objekt att flytta från.
...
### -Path
Sökvägen i angivet filesystem som ska flyttas från.
