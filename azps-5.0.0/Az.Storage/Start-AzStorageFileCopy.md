...
## PROBLEMBESKRIVNING
Cmdleten **Start-AzStorageFileCopy** börjar kopiera en källfil till en målfil.
...
Använd **New-AzStorageContext** för att få en kontext.
...
Du kan skapa en moln-BLOB eller skaffa en genom att använda Get-AzStorageBlob cmdlet.
...
Du kan skapa Cloud BLOB Container-objekt eller använda Get-AzStorageContainer cmdlet.
...
### -SrcFile
Anger ett **CloudFile** -objekt.
Du kan skapa en moln fil eller skaffa en genom att använda **Get-AzStorageFile**.
...
Du kan skapa en moln fil resurs eller skaffa en genom att använda Get-AzStorageShare cmdlet.
