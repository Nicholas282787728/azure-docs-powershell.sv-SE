...
### Exempel 1: skapa en Databricks-arbetsyta
```powershell
...
Det här kommandot skapar en Databricks-arbetsyta.

### Exempel 2: skapa en Databricks-arbetsyta med ett anpassat virtuellt nätverk
```powershell
...
Det här kommandot skapar en Databricks-arbetsyta med anpassat virtuellt nätverk i en resurs grupp.

### Exempel 3: skapa en Databricks-arbetsyta med Aktivera kryptering
```powershell
...
Det här kommandot skapar en Databricks-arbetsyta och anger att den ska förberedas för kryptering.
Se exemplen på Update-AzDatabricksWorkspace för att få fler inställningar för kryptering.
...
Namnet på den hanterade resurs gruppen.
...
### -PrivateSubnetName
Namnet på det privata under nätet i det virtuella nätverket.
...
Ett booleskt värde som anger om DBFS-rot fil systemet kommer att aktive ras med sekundärt krypterings nivå med Platform-hanterade nycklar för data på rest.
...
### -VirtualNetworkId
ID för ett virtuellt nätverk där detta Databricks-kluster ska skapas.
