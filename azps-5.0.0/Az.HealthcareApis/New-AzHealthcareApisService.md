...
### -AllowCorsCredential
HealthcareApis FHIR tjänst AllowCorsCredential.
...
### -CorsOrigin
HealthcareApis FHIR tjänst lista över CORS Origine. Ange URL: er för ursprungs webbplatser som har till gång till detta API eller Använd * för att tillåta åtkomst från vilken webbplats som helst.
