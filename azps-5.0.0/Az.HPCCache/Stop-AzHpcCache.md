...
## PROBLEMBESKRIVNING
Cmdleten **Stop-AzHpcCache** stoppar en Azure HPC-cache.
...
### -Force
Anger att cmdleten inte ber dig bekräfta. Denna cmdlet uppmanar dig som standard att bekräfta att du vill stoppa cacheminnet.
...
### -ResourceGroupName
Namnet på den resurs grupp under vilket du vill stoppa cacheminnet.
