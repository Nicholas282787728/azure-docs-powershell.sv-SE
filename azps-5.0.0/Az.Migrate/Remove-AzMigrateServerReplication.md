...
Synkronisera efter ID.

### Exempel 2: ta bort med indatavärdet
```powershell
...
### -ForceRemove
Anger om replikeringen måste göras borttagen.
...
### -TargetObjectID
Anger den replcating-server som replicatio måste avaktiveras för.
