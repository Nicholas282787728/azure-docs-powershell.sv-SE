...
Metod för att skapa ett nytt migrera projekt.
...
### -Egenskap
Anger projekt egenskaper.
Om du vill skapa läser du avsnittet anteckningar för EGENSKAPs egenskaper och skapar en hash-tabell.
...
EGENSKAP <IMigrateProjectProperties> : anger projekt egenskaper.
  - `[ProvisioningState <ProvisioningState?>]`: Etablerings status för det migrerande projektet.
  - `[RegisteredTool <String[]>]`: Hämtar eller anger listan över verktyg som är registrerade i det migrerande projektet.
