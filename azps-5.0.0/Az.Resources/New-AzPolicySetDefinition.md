...
## PROBLEMBESKRIVNING
Cmdleten **New-AzPolicySetDefinition** skapar en definition för princip uppsättning.

## BESKRIVS

### Exempel 1: skapa en definition för princip uppsättning med metadata genom att använda en princip uppsättnings fil
```
[
   {
...
Det här kommandot skapar en princip uppsättnings definition med namnet VMPolicySetDefinition med metadata som visar att dess kategori är "virtuell dator" som innehåller de princip definitioner som anges i C:\VMPolicy.js. Exempel på innehållet i VMPolicy.jsär aktiverat ovan.

### Exempel 2: skapa en definition för parameter uppsättning
```
[
   {
      "policyDefinitionId": "/providers/Microsoft.Authorization/policyDefinitions/2a0e14a6-b0a6-4fab-991a-187a4f81c498",
...
Det här kommandot skapar en parameter uppsättnings definition med namnet VMPolicySetDefinition som innehåller de princip definitioner som anges i C:\VMPolicy.jspå. Exempel på innehållet i VMPolicy.jsär aktiverat ovan.

### Exempel 3: skapa en definition för princip uppsättningar med princip definitions grupper
```
[
   {
      "policyDefinitionId": "/providers/Microsoft.Authorization/policyDefinitions/2a0e14a6-b0a6-4fab-991a-187a4f81c498",
...
Det här kommandot skapar en princip uppsättnings definition med namnet VMPolicySetDefinition med gruppering av princip definitioner som anges i C:\VMPolicy.jspå. Exempel på innehållet i VMPolicy.jsär aktiverat ovan.
...
### -GroupDefinition
Princip definitions grupperna för den nya definitionen för princip uppsättningar. Det kan antingen vara en sökväg till en fil som innehåller grupperna eller grupperna som en JSON-sträng.
...
### -ManagementGroupName
Namnet på hanterings gruppen för den nya definitionen för princip uppsättning.
...
### -Metadata
Metadata för princip uppsättnings definitionen. Det kan vara en sökväg till ett fil namn som innehåller metadata, eller metadata som en JSON-sträng.
...
Det kan antingen vara en sökväg till ett fil namn som innehåller parameter deklarationen eller parameter deklarationen som en JSON-sträng.
...
### -PolicyDefinition
Princip definitioner. Det kan vara en sökväg till ett fil namn som innehåller princip definitionerna eller princip definitionerna som en JSON-sträng.
...
### -SubscriptionId
Prenumerations-ID för den nya definitionen för princip uppsättning.
