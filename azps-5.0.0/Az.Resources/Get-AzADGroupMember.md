...
### Exempel 1: lista medlemmar efter AD-gruppobjekt-ID
...
### Exempel 2: lista medlemmar efter AD-gruppobjekt-ID med sid indelning
...
### Exempel 3: lista medlemmar efter ledning

```powershell
PS C:\> Get-AzADGroup -ObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE | Get-AzADGroupMember
```

Hämtar AD-gruppen med objekt-ID ' 85F89C90-780E-4AA6-9F4F-6F268D322EEE ' och kopplar den till Get-AzADGroupMember cmdlet för att lista alla medlemmar i gruppen. 
