...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzResourceProvider** får en Azure Resource-leverantör.

## BESKRIVS

### Exempel 1: få alla resurs leverantörer registrerade med nuvarande abonnemang
...
Det här kommandot får alla resurs leverantörer från abonnemanget.

### Exempel 2: Hämta alla resurstilldelnings uppgifter från angiven ProviderNamespace
...
Det här kommandot får alla resurs leverantörer under "Microsoft. Compute".

### Exempel 3: Hämta alla resursinformation från den angivna ProviderNamespace-matrisen
...
Det här kommandot får alla resurs leverantörer under "Microsoft. Compute" och "Microsoft. Network".
...
### -ListAvailable
Indikerar att den här åtgärden får alla tillgängliga resurs leverantörer.
...
### -Plats
Anger resurs leverantörens plats.
