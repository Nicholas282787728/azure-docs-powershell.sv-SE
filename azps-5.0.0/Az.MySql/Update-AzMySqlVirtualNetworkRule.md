...
### Exempel 1: uppdatera MySql-regel per namn
```powershell
...
Denna cmdlet uppdaterar MySql-regel för virtuell nätverks trafik efter namn.

### Exempel 2: uppdatera MySql-regel för virtuell nätverks trafik efter identitet.
```powershell
...
Dessa cmdletar uppdaterar MySql-regel för virtuell nätverks trafik efter identitet.
...
### Microsoft. Azure. PowerShell. cmdletar. MySql. Models. Api20171201. IVirtualNetworkRule
