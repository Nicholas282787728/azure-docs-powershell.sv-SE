...
### Exempel 1: ta bort MySql-servern genom resourceGroup och Server namn
```powershell
PS C:\> Remove-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Denna cmdlet tar bort MySql-servern genom resourceGroup och Server namn.

### Exempel 2: ta bort MySql-servern efter identitet
```powershell
...
Dessa cmdletar tar bort MySql-servern efter identitet.
