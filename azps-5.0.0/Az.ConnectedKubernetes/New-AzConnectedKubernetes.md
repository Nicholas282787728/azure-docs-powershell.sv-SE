...
## Sammanfattning
API för att registrera ett nytt K8s-kluster och därmed skapa en spårad resurs i armar
...
### Exempel 1: skapa en ansluten Kubernetes
```powershell
...
Det här kommandot skapar en ansluten Kubernetes.

### Exempel 1: skapa en ansluten Kubernetes med parametrarna kubeConfig och kubeContext
```powershell
...
Det här kommandot skapar en ansluten Kubernetes med parametrarna kubeConfig och kubeContext.
...
### -KubeConfig
Sökvägen till Kube-konfigurations filen
...
### -KubeContext
Kubconfig kontext från aktuell dator
...
### -ResourceGroupName
Namnet på resurs gruppen som Kubernetes-klustret är registrerat i.
...
### -SubscriptionId
ID för det abonnemang som Kubernetes-klustret är registrerat för.
