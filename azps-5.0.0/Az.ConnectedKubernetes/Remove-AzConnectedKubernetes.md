...
## Sammanfattning
Ta bort ett anslutet kluster och ta bort den spårade resursen i en Azure Resource Manager (ARM).
...
### Exempel 1: ta bort en ansluten Kubernetes
```powershell
PS C:\> Remove-AzConnectedKubernetes -ResourceGroupName azureps-manual-test -ClusterName ps-connaks-t01

```

Det här kommandot tar bort en ansluten Kubernetes

### Exempel 2: ta bort en ansluten Kubernetes efter objekt
```powershell
...
Det här kommandot tar bort en ansluten Kubernetes efter objekt
