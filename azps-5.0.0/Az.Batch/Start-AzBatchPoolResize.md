...
## PROBLEMBESKRIVNING
Cmdleten **Start-AzBatchPoolResize** startar en storleks ändring i Azure-satsen på en pool.
...
Antalet dedikerade datornoder för mål.
...
Antalet mål noder med låg prioritets beräkning.
