...
## Sammanfattning
Tar bort datornoder från en pool.
...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzBatchComputeNode** tar bort Azure Batch-datornoder från en pool.

## BESKRIVS

### Exempel 1: ta bort en datornod
```
...
Det här kommandot tar bort Compute-noden med angivet ID från poolen med ID-Pool07.
Kommandot anger alternativet avsluta avallokering.
Tids gränsen för storleks ändring är 10 minuter.

### Exempel 2: ta bort en datornod med hjälp av pipeline
```
...
Det här kommandot får Compute-noden som har angivet ID från poolen med ID-Pool07 med hjälp av Get-AzBatchComputeNode cmdlet.
Kommandot skickar noden till den aktuella cmdleten med hjälp av pipeline.
Den aktuella cmdleten tar bort Compute-noden.
...
Det här kommandot tar bort två datornoder från poolen med ID-Pool07.
...
### -ComputeNode
Anger det **PSComputeNode** -objekt som representerar den datornod som denna cmdlet tar bort.
...
### -DeallocationOption
Anger ett alternativ för debeläggning för borttagnings åtgärden som den här cmdleten startar.
...
### -ID
Anger en matris med ID-nummer för datornoder som den här cmdleten tar bort från poolen.
...
### -PoolId
Anger ID för poolen som innehåller de datornoder som denna cmdlet tar bort.
...
### -ResizeTimeout
Anger tids gräns intervallet för borttagning av datornoderna från poolen.
Standardvärdet är 10 minuter.
Minimivärdet är 5 minuter.
