...
## PROBLEMBESKRIVNING
Cmdleten **New-AzBatchApplication** lägger till ett program till det angivna Azure Batch-kontot.

## BESKRIVS

### Exempel 1: lägga till ett tomt program i ett batch-konto
```
...
Det här kommandot skapar programmet Litware i ContosoBatch-kontot.
Programmet innehåller inte några paket.

## MALLPARAMETRAR

### -AccountName
Anger namnet på den Batch-konto som den här cmdleten lägger till ett program.
