...
## PROBLEMBESKRIVNING
New-AzRecoveryServicesAsrProtectionContainer-cmdleten skapar en skydds behållare under den angivna infrastruktur resursen för Azure Site Recovery.
...
### -InputObject
Skapar objektet för replikering av replikerade objekt (Azure Fabric).
