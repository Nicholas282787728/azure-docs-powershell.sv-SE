...
### -AzureToVMware
Anger katastrof återställning för Azure till vMWare.
...
### -HyperVToAzure
Byt parameter indikerar att den angivna principen används för att replikera Hyper-V-virtuella datorer till Azure.
...
### -VmmToVmm
Switch parameter anger att den angivna principen används för att replikera VMM-hanterade Hyper-V-datorer mellan två Hyper-V-webbplatser.
...
### -VMwareToAzure
Byt parameter indikerar att den angivna principen används för att replikera VMware-virtuella datorer till Azure.
