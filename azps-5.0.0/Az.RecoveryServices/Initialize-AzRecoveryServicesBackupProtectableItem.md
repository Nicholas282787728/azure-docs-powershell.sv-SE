...
## PROBLEMBESKRIVNING
cmdleten söker efter specifika arbets belastningar i en behållare. Då utlöses en åtgärd som skapar skyddade objekt.
...
Cmdleten kör en identifierings åtgärd för nya oskyddade objekt.

### Exempel 2

Det här kommandot utlöser identifieringen av oskyddade objekt av den angivna typen av arbets belastning i den angivna behållaren. (automatiskt genererat)
...
### -PassThru
Returnerar den behållare där identifieringen utlöses.
...
### -WorkloadType
Arbets belastnings typ för resursen. De aktuella värdena är AzureVM, WindowsServer, AzureFiles, MSSQL
