...
## PROBLEMBESKRIVNING
Update-AzContainerRegistry cmdlet uppdaterar en behållar register.

## BESKRIVS

### Exempel 1: Aktivera administratörs användare för ett angivet behållar-register
```powershell
...
Det här kommandot aktiverar administratörs användaren för den angivna behållar registret.

### Exempel 2: Ange det lagrings konto som används av ett angivet behållar-register
```powershell
...
Det här kommandot anger det angivna behållar-registret så att det använder ett befintligt lagrings konto \` mystorageaccount \` i samma prenumeration.
...
### -NetworkRuleSet
Nätverks regeln för en behållar register.
