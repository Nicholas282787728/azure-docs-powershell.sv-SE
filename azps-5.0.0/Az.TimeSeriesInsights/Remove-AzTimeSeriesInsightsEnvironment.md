...
### Exempel 1: ta bort en miljö syn miljöer utifrån namn
```powershell
PS C:\> Remove-AzTimeSeriesInsightsEnvironment -ResourceGroupName testgroup -Name tsill

```

Det här kommandot tar bort en miljö med tids serier.

### Exempel 2: ta bort en miljö för tids serie Insights efter objekt
```powershell
