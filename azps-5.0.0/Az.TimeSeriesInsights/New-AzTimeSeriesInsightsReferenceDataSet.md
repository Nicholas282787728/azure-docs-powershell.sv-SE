...
### Exempel 1: skapa en referens data uppsättning för en viss miljö  
```powershell
...
Det här kommandot skapar en referens data uppsättning för en viss miljö.

## MALLPARAMETRAR

### -DataStringComparisonBehavior
Det går att ange den här egenskapen med hjälp av funktionen för jämförelse av referens data uppsättning.
Som standard är värdet ' ordinal '-vilket innebär Skift läges känslig jämförelse av nycklar som utförs när du ansluter till referens data med händelser eller när du lägger till nya referens data.
När "OrdinalIgnoreCase" anges används Skift läges okänslig jämförelse.
...
### -Egenskapen-egenskap
Listan över centrala egenskaper för referens data uppsättningen.
Om du vill skapa läser du avsnittet anteckningar för egenskaper för nyckel egenskaper och skapar en hash-tabell.
...
### -Namn
Referens data uppsättningens namn.
...
<egenskapen IReferenceDataSetKeyProperty [] >: listan med nyckel egenskaper för referens data uppsättningen.
  - `[Name <String>]`: Namnet på nyckel egenskapen.
  - `[Type <ReferenceDataKeyPropertyType?>]`: Typen av nyckel egenskap.
