...
### Exempel 1: uppdatera vår moln app efter namn.
```powershell
...
Uppdatera vår moln app efter namn.

### Exempel 2: uppdatera vår moln app från en pipe.
```powershell
...
Uppdatera vår moln app från pipe.
...
### -Plats
GEO-platsen för programmet, alltid samma som den överordnade resursen
...
Monterings vägen för den beständiga disken
...
Den beständiga diskens storlek i GB
...
### -Offentlig
Anger om programmet exponerar en offentlig slut punkt
...
Monterings vägen för den tillfälliga disken
...
Storleken på den tillfälliga disken i GB
...
### Microsoft. Azure. PowerShell. cmdletar. SpringCloud. Models. Api20200701. IAppResource
