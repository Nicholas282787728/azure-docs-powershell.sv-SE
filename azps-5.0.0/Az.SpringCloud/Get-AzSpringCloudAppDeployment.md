...
### Exempel 1: Hämta Deploymeng till vår moln efter namn.
```powershell
...
Skaffa ett Deploymeng efter namn.

### Exempel 2: Visa en lista över alla distributioner under en viss fjäder moln app.
```powershell
...
Visa en lista över alla distributioner under en viss fjäder moln app.
...
### -Version
Version av distributionerna som ska listas
