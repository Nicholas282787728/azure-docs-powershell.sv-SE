...
## PROBLEMBESKRIVNING
Set-AzEventHubNamespace cmdlet uppdaterar egenskaperna för de angivna namn områdena för händelse nav.
...
Uppdaterar taggarna för namespace \` MyNamespaceName \` som skapats.
...
Uppdaterar tillståndet för namn områdes \` MyNamespaceName \` med automittre = Enabled och MaximumThroughputUnits = 10

### Exempel 3

Uppdaterar namn området för de angivna Event Hub. (automatiskt genererat)

```powershell <!-- Aladdin Generated Example --> 
Set-AzEventHubNamespace -Location 'WestUS' -Name MyNamespaceName -ResourceGroupName MyResourceGroupName -SkuName Basic
```

### Exempel 5: skapa och uppdatera namnrymd med hantera identitet i ett kluster 
```powershell
...
### -IdentityUserDefined
Användardefinierad identitet eller ingen
...
### -Egenskapen-egenskap
Lista över egenskaper för nycklar, @ (@ (nyckelvärdet namn, KeyVaultUri, # version), @ (nyckelvärdet, KeyVaultUri, version))
...
### -State
Inaktivera/aktivera namn område.
...
### System. Nullable ' 1 [[Microsoft. Azure. kommandon. EventHub. Models. NamespaceState, Microsoft. Azure. PowerShell. cmdletar. EventHub, version = 1.4.3.0, Culture = neutralt, PublicKeyToken = null]]
