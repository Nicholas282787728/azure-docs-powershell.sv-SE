...
## Sammanfattning
Genererar en SAS-token för Azure eventhub-auktoriseringsregeln för namespace/eventhub. 
...
## PROBLEMBESKRIVNING
New-AzEventHubAuthorizationRuleSASToken-cmdleten genererar en SAS-token (Shared Access signatur) för en Azure Eventhub-Namesapce eller Azure Eventhub
