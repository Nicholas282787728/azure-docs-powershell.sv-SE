...
## PROBLEMBESKRIVNING
Get-AzSqlElasticJobExecution cmdlet får ett eller flera jobb körningar

## BESKRIVS

### Exempel 1: hämtar ett eller flera jobb för alla jobb
```powershell
...
### Exempel 2: hämtar ett eller flera jobb för jobbet
```powershell
PS C:\> $agent = Get-AzSqlElasticJobAgent -ResourceGroupName rg -ServerName elasticjobserver -Name agent
...
Får ett eller flera jobb. (automatiskt genererat)
