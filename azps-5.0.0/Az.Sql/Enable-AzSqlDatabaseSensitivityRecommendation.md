...
## PROBLEMBESKRIVNING
Med cmdleten Enable-AzSqlDatabaseSensitivityRecommendation kan du aktivera känslighets rekommendationer för kolumner i databasen.

## BESKRIVS

### Exempel 1: Aktivera känslighets rekommendationer för en viss kolumn i en Azure SQL-databas.
```powershell
...
### Exempel 2: Aktivera känslighets rekommendationer för en viss kolumn Azure SQL-databas med ledning.
```powershell
