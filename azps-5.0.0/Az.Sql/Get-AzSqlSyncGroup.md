...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlSyncGroup** returnerar information om en eller flera synkroniseringsresurser för Azure SQL-databas.
Ange namnet på en synkroniseringsresurs för att visa information för enbart den synkroniseringsresursen.

## BESKRIVS

### Exempel 1: få alla instanser av Azure SQL Sync-gruppen kopplad till en Azure SQL-databas
```
...
Med det här kommandot får du information om alla synkroniseringsresurser för Azure SQL Database som tilldelats till en Azure SQL-databas.

### Exempel 2: Hämta information om en Azure SQL Database Sync-grupp
```
...
Med det här kommandot får du information om synkroniseringsresursen för Azure SQL-databasen med namnet "SyncGroup01"

### Exempel 3: Hämta alla instanser av Azure SQL Sync-gruppen som är kopplad till en Azure SQL-databas med filter
```
...
Med det här kommandot får du information om alla synkroniseringsresurser för Azure SQL-databaser som har tilldelats till en Azure SQL-databas som börjar med "SyncGroup".
