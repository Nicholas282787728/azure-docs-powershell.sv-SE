...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlDatabaseAudit** hämtar gransknings inställningarna för en Azure SQL-databas.
Använd cmdleten *ResourceGroupName* , *servername* och *databasename* för att identifiera databasen.

## BESKRIVS

### Exempel 1: Hämta gransknings inställningar för en Azure SQL-databas
```
...
### Exempel 2: gå till pipeline, gransknings inställningar för en Azure SQL-databas
```
...
### Exempel 3: Hämta gransknings inställningar för en Azure SQL-databas
```
PS C:\>Get-AzSqlDatabaseAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
ServerName                          : server01
DatabaseName                        : database01
