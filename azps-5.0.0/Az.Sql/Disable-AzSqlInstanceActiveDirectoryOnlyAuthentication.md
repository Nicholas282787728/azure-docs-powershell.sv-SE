...
## PROBLEMBESKRIVNING
Cmdleten **disable-AzSqlInstanceActiveDirectoryOnlyAuthentication** inaktiverar Azure Active Directory (Azure AD)-autentiseringskrav endast för en AzureSQL-hanterad instans i den aktuella prenumerationen.
...
Det här kommandot inaktiverar bara Azure Active Directory (Azure AD)-autentiseringskrav för en AzureSQL-hanterad instans som heter ManagedInstance01 som är kopplad till en resurs grupp med namnet ResourceGroup01.
...
### -InstanceName
Namnet på den hanterade Azure SQL-instansen Azure Active Directory-inloggningen är aktive rad.
