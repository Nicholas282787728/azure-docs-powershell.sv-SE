...
Hämtar alla långsiktiga säkerhets kopior för en viss databas.  Resurs gruppen är valfri. 
...
### -DatabaseName
Namnet på den hanterade databas som säkerhets kopiorna ligger under.
...
### -InstanceName
Namnet på den hanterade instans som säkerhets kopiorna står under.
