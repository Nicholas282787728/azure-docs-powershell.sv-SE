...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzSqlServerAdvancedThreatProtectionSetting** anger ett avancerat skydds inställningar på en Azure SQL Server.
För att aktivera avancerat skydd för en server måste gransknings inställningar vara aktiverade på den servern.
...
Det här kommandot anger de avancerade inställningarna för skydd mot en server med namnet Server01.

### Exempel 2

Anger ett avancerat skydd på en server. (automatiskt genererat)
