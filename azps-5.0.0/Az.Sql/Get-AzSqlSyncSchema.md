...
### Exempel 1: Hämta synkroniseringsschemat för en nav-databas
```powershell
...
### Exempel 2: Hämta synkroniseringsschemat för en nav-databas och expandera tabeller
```powershell
...
### Exempel 3: Hämta synkroniseringsschemat för en medlems databas
```powershell
