...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlServerServiceObjective** hämtar de tillgängliga tjänst målen för en Azure SQL Database-Server.

## BESKRIVS

### Exempel 1: få service mål
```
...
Det här kommandot hämtar tjänst målen för servern med namnet Server01.

### Exempel 2: få service mål med hjälp av filtrering
```
...
Det här kommandot får tjänst målen för servern med namnet Server01 som börjar med "system".

### Exempel 3: få service mål för en plats
```
...
Med det här kommandot får du tjänst målen för angiven Azure-region.
...
### -Plats
Namnet på den plats där du ska få tjänstens mål.
...
Denna cmdlet hämtar tjänst mål för en SQL-databasserver som tilldelats den här resursen.
...
### -ServerName
Anger namnet på en SQL-databasserver i SQL-databasen.
...
Anger namnet på ett tjänst mål för en Azure SQL Database-Server.
De acceptabla värdena för den här parametern är: Basic, S0, S1, S2, P1, P2 och P3.
