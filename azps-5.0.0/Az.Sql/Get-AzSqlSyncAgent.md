...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlSyncAgent** returnerar information om en eller flera Sync-agenter för Azure SQL.
Ange namnet på en synkroniseringsresurs för att visa information för enbart den synkroniseringsklienten.

## BESKRIVS

### Exempel 1: få alla instanser av Azure SQL Sync agent tilldelad till en Azure SQL-Server
```
...
Med det här kommandot får du information om alla de Azure SQL Sync-agenter som tilldelats en Azure SQL Server.

### Exempel 2: Hämta information om en Azure SQL Sync-agent
```
...
Det här kommandot får information om Synkroniseringshanteraren för Azure SQL Database med namnet "SyncAgent01"

### Exempel 3: Hämta alla instanser av Azure SQL Sync agent som är tilldelad en Azure SQL-Server med filter
```
...
Med det här kommandot får du information om alla de Azure SQL Sync-agenter som tilldelats en Azure SQL-Server som börjar med "SyncAgent".
