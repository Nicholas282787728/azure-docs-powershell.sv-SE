...
I det här exemplet skapas en version "v1" under typ "testAppType". Versionen i program manifestet i paketet ska ha samma version som den som anges i versionen.
...
### -DefaultParameter
Ange standardvärden för program parametrarna som nycklar/värde-par.
