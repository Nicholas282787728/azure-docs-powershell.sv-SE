...
### Exempel 1 Skapa en ny kontinuerlig export konfiguration för resursen Application Insights
```
...
Skapa en ny Application Insights-kontinuerlig export konfiguration för att exportera "begäran" och "spåra" dokument typer till lagrings utrymme innehåller "testcontainer" i lagrings kontot "teststorageaccount" i resurs gruppen "testgroup". SAS-token måste vara giltiga och ha Skriv behörighet till behållaren, annars fungerar inte löpande exportera. Om SAS-token upphörde att gälla kommer funktionen fort löp ande inte längre att fungera.
