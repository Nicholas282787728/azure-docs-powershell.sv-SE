...
## PROBLEMBESKRIVNING
Update-AzPowerBIEmbeddedCapacity cmdlet ändrar en instans av PowerBI inbäddade kapacitet
...
Ändrar kapaciteten som heter testcapacity i resourcegroup testgroup för att ställa in taggarna som KEY1: värde1 and key2: värde2 and Administrator to och testuser1@contoso.com testuser2@contoso.com tjänstens huvud namn: 9035a021-a96f-43ea-acbf-864227c2abbb@45119f4f-c71b-4420-b6ec-60e503450098

## MALLPARAMETRAR

### -Administratör
Ett kommaseparerad namn som ska anges som administratörer på kapaciteten. För tjänstens huvud namn: <service principal object id>@<tenant id>
