...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzDataLakeStoreVirtualNetworkRule** tar bort den angivna regeln för virtuella nätverk i den angivna data Lake Store.
...
Tar bort den virtuella nätverks regeln "myVNET" från kontot "DLS"
