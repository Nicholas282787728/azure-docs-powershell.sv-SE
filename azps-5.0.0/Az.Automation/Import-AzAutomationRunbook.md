...
Med det andra kommandot importeras en grafisk Runbook med namnet GraphicalRunbook06 till Automation-kontot med namnet AutomationAccount01.
Kommandot tilldelar också taggarna som lagras i $Tags.

### Exempel 2

Importerar en automatiserings Runbook. (automatiskt genererat)
...
Anger namnet på det Automation-konto där denna cmdlet importerar en Runbook.
...
### -Beskrivning
Anger en beskrivning av den importerade Runbook-flödet.
...
### -LogProgress
Anger om förlopps information för Runbook loggar in.
...
### -LogVerbose
Anger om Runbook loggar detaljerad information.
...
### -Path
Anger sökvägen till en. ps1-eller. graphrunbook-fil som denna cmdlet importerar.
...
### -Publicerad
Anger att denna cmdlet publicerar den Runbook som den importerar.
...
### -ResourceGroupName
Anger namnet på den resurs grupp som denna cmdlet importerar en Runbook till.
