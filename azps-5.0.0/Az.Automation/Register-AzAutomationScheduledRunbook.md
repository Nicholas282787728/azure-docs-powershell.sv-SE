...
## PROBLEMBESKRIVNING
**Register-AzAutomationScheduledRunbook** cmdlet associerar en Azure Automation-Runbook till ett schema.
...
Associerar en Runbook till ett schema. (automatiskt genererat)
