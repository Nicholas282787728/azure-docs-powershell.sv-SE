...
## PROBLEMBESKRIVNING
Den Update-AzAutomationSourceControl cmdleten ändrar värdet för ett fält i en käll kontroll i Azure Automation.

## BESKRIVS

### Exempel 1
Med det här kommandot anges fältet PublishRunbook till falskt för Azure Automation Source Control med namnet VSTSNative i kontot som heter devAccount.
...
Uppdaterar en käll kontroll för Azure Automation. (automatiskt genererat)
