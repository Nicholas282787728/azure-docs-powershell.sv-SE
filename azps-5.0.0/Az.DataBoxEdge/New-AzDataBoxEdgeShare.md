...
## PROBLEMBESKRIVNING
**New-AzDataBoxEdgeShare** cmdlet skapar en ny resurs i data Box Edge-enheten.
...
### -ClientAccessRight
Läs-och skriv åtkomst för clientIds, till ex: @ (@ {"ClientId" = "192.168.10.10"; " AccessRight "=" noaccess "}, @ {" ClientId "=" 192.168.10.11 ";" AccessRight "=" ReadOnly "})
...
### -CloudShare
Ange befintligt StorageAccountCredential
...
### -ContainerName
Behållar namn (baserat på det data format som anges representerar detta namnet på Azure-filer/Pageblob/Block Blob)
...
### -DataFormat
Ange data format från t ex: PageBlob, BlobBlob
...
### -NFS
AccessProtocol om du vill skapa en resurs
...
### -UserAccessRight
ge åtkomst direkt med befintliga användar namn för åtkomst till SMB-filtyper, till ex: @ (@ {"username" = "User-Name-1"; " AccessRight "=" Läs "}, @ {" username "=" User-Name-2 ";" AccessRight "=" Läs "}, @ {" username "=" User-Name-3 ";" AccessRight "=" Custom "})
