...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzDataBoxEdgeStorageAccount** tar bort ett tillhör ande lagrings konto för en Edge-enhet. Du kan ange namnet på lagrings kontot för Edge som ska tas bort som en parameter i cmdleten.
