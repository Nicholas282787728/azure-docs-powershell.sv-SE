...
## PROBLEMBESKRIVNING
Cmdleten **New-AzManagedHsm** skapar en hanterad HSM i den angivna resurs gruppen. Om du vill lägga till, ta bort eller lista nycklar i den hanterade HSM ska användaren bevilja behörigheter genom att lägga till användar-ID i administratören.
