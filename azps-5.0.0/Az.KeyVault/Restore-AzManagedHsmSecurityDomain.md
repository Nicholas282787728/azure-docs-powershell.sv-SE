...
## Sammanfattning
Återställer tidigare säkerhets domän data till en hanterad HSM.
...
## PROBLEMBESKRIVNING
Denna cmdlet återställer tidigare säkerhets domän data till en hanterad HSM.
...
Först måste nycklarna tillhandahållas för att dekryptera säkerhets domän data. Då återställer kommandot **reAzManagedHsmSecurityDomain** till en hanterad HSM med de här tangenterna.
