...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzKeyVaultCertificatePolicy** hämtar policyn för ett certifikat i ett nyckelord i Azure Key Vault.

## BESKRIVS

### Exempel 1: skaffa en certifikat policy
```powershell
...
Det här kommandot får certifikat principen för TestCert01-certifikatet i ContosoKV01-nyckelvärdet.
