...
I exemplet visas alla roller i "/Keys"-området.
...
Exemplet får rollen "hanterad HSM-säkerhetskopiering" och kontrollerar dess behörigheter.
...
### -RoleDefinitionName
Namn på den roll definition som ska visas.
...
### Microsoft. Azure. commands. valv. Models. PSKeyVaultRoleDefinition
