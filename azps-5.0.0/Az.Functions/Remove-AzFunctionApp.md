...
### Exempel 1: Hämta en funktion-app efter namn och ta bort den.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Remove-AzFunctionApp -Force
```

Det här kommandot får en funktion-app efter namn och tar bort den.

### Exempel 2: ta bort en funktion app efter namn.
```powershell
PS C:\> Remove-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName -Force
```

Det här kommandot tar bort en Function-app efter namn.
...
### -Force
Tvingar cmdleten att ta bort programmet utan att behöva bekräfta.
