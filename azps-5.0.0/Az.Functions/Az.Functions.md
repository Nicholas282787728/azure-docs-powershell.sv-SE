...
Hämtar systemAssignedIdentity som är tillgängliga under det angivna RP-scopet.

### [GetAzWebAppConfig](GetAzWebAppConfig.md)


### [Get-AzWebAppFunctionKey](Get-AzWebAppFunctionKey.md)
Beskrivning för Get-funktionstangent för en funktion på en webbplats eller en distributions plats.
...
Beskrivning för program inställningar för konfigurations referens och status för ett program

### [Get-AzWebAppSyncStatus](Get-AzWebAppSyncStatus.md)
Beskrivning för detta är att tillåta samtal via PowerShell och ARM-mallen.
...
### [Move-AZ](Move-Az.md)
Beskrivning för att flytta resurser mellan resurs grupper.
...
Beskrivning för funktionen synkroniseringar metadata till hanterings databasen

### [Test-AZ](Test-Az.md)
Beskrivning för verifiering om en resurs kan skapas.
