...
### Exempel 1: ta bort appinställningar i ett Function-program.
```powershell
...
Det här kommandot tar bort program inställningar i ett Function-program.

## MALLPARAMETRAR

### -AppSettingName
Lista över inställningar för funktionalitet som ska tas bort från programmet funktion.
...
### -Force
Tvingar cmdleten att ta bort programinställning utan att behöva bekräfta.
