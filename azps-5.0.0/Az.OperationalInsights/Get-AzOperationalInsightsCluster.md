...
## PROBLEMBESKRIVNING
Hämta eller lista kluster, lista kluster under resurs grupp när "-kluster namn" inte angavs angavs lista kluster under prenumerationen när "-kluster namn" och "ResourceGroupName" inte tillhandahölls.
