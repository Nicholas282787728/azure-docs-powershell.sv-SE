...
### Exempel 1: ta bort PostgreSql Server-regel per namn
```powershell
PS C:\> Remove-AzPostgreSqlVirtualNetworkRule -Name vnet -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Denna cmdlet tar bort PostgreSql Server-regel efter namn.

### Exempel 2: ta bort PostgreSql Server-regel efter identitet
```powershell
...
Dessa cmdletar tar bort PostgreSql Server-regel efter identitet.
