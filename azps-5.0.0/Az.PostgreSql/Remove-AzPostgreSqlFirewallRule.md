...
### Exempel 1: ta bort PostgreSql brand Väggs regel efter namn
```powershell
PS C:\> Remove-AzPostgreSqlFirewallRule -Name rule -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Denna cmdlet tar bort PostgreSql efter namn.

### Exempel 2: ta bort PostgreSql brand Väggs regel efter identitet
```powershell
...
De här cmdletarna tar bort PostgreSql brand Väggs regel efter identitet.
