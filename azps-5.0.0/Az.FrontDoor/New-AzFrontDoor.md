...
### ByFieldsWithBackendPoolsSettingParameterSet (standard)
```
...
## PROBLEMBESKRIVNING
Cmdleten **New-AzFrontDoor** skapar en ny Azure-startlucka i den angivna resurs gruppen under aktuell prenumeration

## BESKRIVS

### Exempel 1: skapa en front dörr baserat på angivna parametrar.
```powershell
