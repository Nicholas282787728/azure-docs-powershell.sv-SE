...
## PROBLEMBESKRIVNING
Cmdleten **New-AzFrontDoorBackendpoolsSettingObject** skapar ett nytt PSBackendPoolsSettings-objekt för skapande av front dörrar.

## BESKRIVS

### Exempel 1: skapa BackendPoolsSettings-objekt med standardvärden
```powershell
...
### Exempel 2: skapa BackendPoolsSettings-objekt med användardefinierade värden
```powershell
...
Om certifikat namns kontrollen ska tillämpas på HTTPS-begäranden till alla backend-pooler.
Ingen effekt på icke-HTTPS-begäranden.
...
Skicka och ta emot timeout för vidarebefordran till Server delen. Det går inte att returnera och returnerar en begäran.
