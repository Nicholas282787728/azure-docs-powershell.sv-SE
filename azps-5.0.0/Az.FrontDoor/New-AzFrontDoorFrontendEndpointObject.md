...
### -HostName
Värd namnet på frontendEndpoint.
Måste vara ett domän namn.
...
### -MinimumTlsVersion
Den minsta TLS-version som krävs från klienter för att upprätta en SSL-handskakning med front dörren.
...
### -ProtocolType
TLS-filtillägg som används för säker leverans
...
Om den här värden ska tillåtas för tillhörighet.
...
TTL för användning i sekunder för session-tillhörighet, om tillämpligt. Standardvärdet är 0
...
### -Valv
Det viktigaste valvet med SSL-certifikatet
...
### -WebApplicationFirewallPolicyLink
Resurs-ID för webb program brand Väggs princip för varje värd (om tillämpligt)
