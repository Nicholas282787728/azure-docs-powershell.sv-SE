...
### -MatchValue
Matcha värden för att passa.
Operatorn gäller för varje värde i här med eller semantik.
Om någon av dem matchar variabeln med den givna operatorn anses matchnings villkoret vara en träff.
...
### -MatchVariable
Matcha variabel.
Möjliga värden är IsMobile, RemoteAddr, RequestMethod, QueryString, PostArg, RequestUri, RequestPath, RequestFileName, RequestfilenameExtension, RequestHeader, RequestBody, RequestScheme
...
### -NegateCondition
Beskriver om det här är negationer eller inte
...
### -Operatör
Beskriver vilken operator som ska användas för matchnings villkoret.
Möjliga värden är alla, IPMatch, mindreän, lika med, innehåller,, GreaterThan, LessThanOrEqual, GreaterThanOrEqual, börjarmed, Slutarmed.
...
### -Omvandla
Lista över vilka transformeringar som ska tillämpas innan du matchar. Möjliga enskilda värden för transformering är gemener, versaler, trim, UrlDecode, UrlEncode, RemoveNulls.
