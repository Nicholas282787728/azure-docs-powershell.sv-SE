...
## Sammanfattning
Tar bort en CosmosDB Cassandra-tabell.
...
## PROBLEMBESKRIVNING
Tabellen **Remove-AzCosmosDBCassandraTable** Delete a CosmosDB Cassandra.
...
Cmdleten returnerar ett objekt av typen bool (när-PassThru skickas), vilket är sant, om borttagningen lyckades.
...
### -PassThru
Anges till sant om användaren vill få ett resultat.
Resultatet är sant om åtgärden lyckades och ett fel inträffar om det inte är det.
