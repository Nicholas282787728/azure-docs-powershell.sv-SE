...
## PROBLEMBESKRIVNING
Uppdatera regioner i ett CosmosDB-konto. Platsen kan tillhandahållas antingen som ett objekt av typen PSLocation eller som strängar med plats namnet ordnade efter prioritet för redundans.
LocationObject parameter förväntar sig att listan med aktuella platser (failover prioritiies) läggs till av de nya LocationObjects som motsvarar nya platser som ska läggas till.
Parametern location förväntar sig en lista över aktuell plats (ordnad efter prioritet för redundans) och de nya platserna. Observera att vi inte har stöd för att lägga till regioner. Ange plats eller LocationObject.
...
### -Plats
Namn på platsen som ska läggas till.
