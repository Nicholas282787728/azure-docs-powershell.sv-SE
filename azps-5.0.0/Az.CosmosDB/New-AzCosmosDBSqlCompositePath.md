...
## Sammanfattning
Skapar ett nytt objekt av typen PSCompositePath. Det kan skickas som ett parameter värde för set-AzCosmosDBSqlContainer.
...
## PROBLEMBESKRIVNING
Objekt som motsvarar SQL API-CompositePath.
