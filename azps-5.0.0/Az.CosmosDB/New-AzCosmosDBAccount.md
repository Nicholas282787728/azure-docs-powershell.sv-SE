...
## PROBLEMBESKRIVNING
Skapa ett nytt CosmosDB-konto i angiven ResourceGroup.
...
Ett nytt CosmosDB-konto med namnet databaseAccountName skapas i ResourceGroup resourceGroupName.

## MALLPARAMETRAR

### -ApiKind
Den typ av Cosmos DB-databas som ska skapas.
Godkända värden: GlobalDocumentDB, MongoDB, Gremlin, Table, Cassandra.
...
### -EnableFreeTier
Bool för att ange om en nivå är aktive rad för kontot.
...
### -IpRule
Stöd för brand väggar. Anger uppsättningen IP-adresser eller IP-adressintervall i CIDR-format som ska tas med i listan över tillåtna klienter för ett visst databas konto.
...
### -Plats
Lägga till en plats i Cosmos DB-databasnamn.
Matris med strängar sorterade efter prioritet för växling vid fel.
...
### -LocationObject
Lägga till en plats i Cosmos DB-databasnamn. Matris med PSLocation-objekt.
...
### -ServerVersion
ServerVersion, giltigt endast i händelse av MongoDB-konton.
