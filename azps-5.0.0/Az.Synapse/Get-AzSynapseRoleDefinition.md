...
### GetByWorkspaceNameAndIdParameterSet (standard)
```
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSynapseRoleDefinition** hämtar en Azure Synapse Analytics-roll.
Om du inte anger ett rollnamn eller ett roll-ID får denna cmdlet alla roll definitioner.
...
Det här kommandot får alla roll definitioner under en arbets yta.
...
Det här kommandot får roll definitionen under arbets ytans ContosoWorkspace med namnet ContosoRole.
...
Det här kommandot får alla roll definitioner under en arbets yta via pipeline.
