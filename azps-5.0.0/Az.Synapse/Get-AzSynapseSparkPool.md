...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSynapseSparkPool** hämtar information om en Azure Synapse Analytics Spark-pool.
...
Det här kommandot får alla Spark-pooler under en arbets yta.
...
Det här kommandot får Spark-poolen under arbets ytans ContosoWorkspace med namnet ContosoSparkPool.
...
Det här kommandot får alla Spark-pooler under en arbets yta genom pipeline.
...
Det här kommandot får Spark-poolen med angivet resurs-ID.
