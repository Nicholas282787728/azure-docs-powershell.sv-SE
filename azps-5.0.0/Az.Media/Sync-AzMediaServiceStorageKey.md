...
## PROBLEMBESKRIVNING
**AzMediaServiceStorageKey** cmdlet synkroniserar lagrings konto nycklar för ett lagrings konto som är kopplat till medie tjänsten.

## BESKRIVS

### Exempel 1: synkronisera lagrings konto nycklar för ett lagrings konto som är kopplat till medie tjänsten
```
...
Det första kommandot använder cmdleten Get-AzStorageAccount för att hämta lagrings kontot med namnet Storage135 som tillhör ResourceGroup001 och lagrar resultatet i variabeln som heter $StorageAccount.
Det andra kommandot synkroniserar lagrings konto nycklar för medie tjänsten med namnet MediaService001 med egenskapen **ID** som finns i $StorageAccount variabeln.

## MALLPARAMETRAR

### -AccountName
Anger namnet på den medie tjänst som denna cmdlet synkroniserar.
...
### -StorageAccountId
Anger det lagrings konto-ID som är kopplat till medie tjänstens konto.
