...
## PROBLEMBESKRIVNING
New-AzApplicationGatewayProbeConfig cmdlet skapar en hälso sökning.

## BESKRIVS

### Exempel 1: Example1: skapa en hälso kontroll
```powershell
...
Skapar en hälso sökning. (automatiskt genererat)
...
### -Port
Anger vilken port som används för dina Bing-servrar.
