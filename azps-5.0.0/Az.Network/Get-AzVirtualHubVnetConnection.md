...
När du har skapat navets virtuella nätverks anslutning får du den virtuella nav-anslutningen med dess resurs grupp namn, hubbens namn och anslutnings namnet.
...
När den virtuella nav-nätverksanslutningen har skapats visas en lista med alla virtuella hubbar för navet med dess resurs grupp namn och hubbens namn.
...
Denna cmdlet visar alla virtuella Hubbs nätverks anslutningar som börjar med "test" med dess resurs grupp namn och hubbens namn.
