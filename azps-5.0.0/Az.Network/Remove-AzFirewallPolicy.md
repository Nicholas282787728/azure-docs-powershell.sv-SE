...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzFirewallPolicy** tar bort en Azure Firewall-princip.
...
I det här exemplet tas brand Väggs principen "firewallpolicy" bort i resourcegroup "TestRg"
...
I det här exemplet tas brand Väggs principen bort med ID.
...
Det här exemplet tar bort brand Väggs princip $fp
