...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzRouteConfig** tar bort en väg från en Azure route-tabell.
...
Den aktuella cmdleten tar bort vägen med namnet Route02 och skickar resultatet till cmdleten **set-AzRouteTable** , som uppdaterar tabellen så att den återspeglar dina ändringar.
