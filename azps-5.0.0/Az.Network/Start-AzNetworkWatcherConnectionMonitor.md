...
## PROBLEMBESKRIVNING
Den angivna anslutnings övervakaren startas med Start-AzNetworkWatcherConnectionMonitor cmdlet.

## BESKRIVS

### Exempel 1: starta en anslutnings bildskärm
```
PS C:\> Start-AzNetworkWatcherConnectionMonitor -NetworkWatcherName NetworkWatcher_centraluseuap -ResourceGroupName NetworkWatcherRG -Name cm
```

I det här exemplet startas anslutnings övervakaren som anges med namn och nätverks bevakning
