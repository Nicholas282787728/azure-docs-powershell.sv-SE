...
## PROBLEMBESKRIVNING
Cmdleten **set-AzApplicationGatewaySslCertificate** uppdaterar ett SSL-certifikat för en Programgateway.

## BESKRIVS

### Exempel 1: uppdatera ett befintligt SSL-certifikat på Application Gateway
```
...
Uppdatera ett befintligt SSL-certifikat för den Programgateway som heter ApplicationGateway01.

### Exempel 2: uppdatera ett befintligt SSL-certifikat med nyckel valv hemlighet (version-mindre secretId) på Application Gateway
```
...
Få hemligheten och uppdatera ett befintligt SSL-certifikat med `Set-AzApplicationGatewaySslCertificate` .

### Exempel 3: uppdatera ett befintligt SSL-certifikat med nyckel valv hemlighet på Application Gateway
```
PS C:\> $secret = Get-AzKeyVaultSecret -VaultName "keyvault01" -Name "sslCert01"
