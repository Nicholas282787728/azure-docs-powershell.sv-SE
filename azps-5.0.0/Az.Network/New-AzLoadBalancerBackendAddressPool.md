...
## Sammanfattning
Skapar en adresspool för backend-adresser på en Loadbalancer. 
...
## PROBLEMBESKRIVNING
Skapar en adresspool för backend-adresser på en Loadbalancer. Möjliggör specifiying en matris med PSLoadBalancerBackendAddress. 
## BESKRIVS
...
### -LoadBalancer
Resursen för belastnings utjämning.
...
### -ResourceGroupName
Belastnings utjämningens resurs grupp namn.
