...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzPrivateEndpoint** tar bort en privat slut punkt. 
...
Det här exemplet tar bort en privat slut punkt med namnet MyPrivateEndpoint1.
...
### -ResourceGroupName
Namnet på den privata slut punkten för resursen.
