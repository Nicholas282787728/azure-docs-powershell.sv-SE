...
## PROBLEMBESKRIVNING
Cmdleten **New-AzApplicationGatewayRewriteRuleSet** skapar en regel uppsättning för att skriva om för en Azure Application Gateway.
...
Det här kommandot skapar en regel uppsättning med namnet ruleset1 och lagrar resultatet i variabeln som heter $ruleset.
...
### -RewriteRule
Lista över omskrivnings regler
...
### Microsoft. Azure. commands. Networks. Models. PSApplicationGatewayRewriteRuleSet
