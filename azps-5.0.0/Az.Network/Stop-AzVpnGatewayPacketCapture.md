...
## Sammanfattning
Stoppar paket registrerings åtgärd på en VPN-gateway.
...
## PROBLEMBESKRIVNING
Stoppar paket registrerings åtgärden på en VPN-gateway och laddar upp resultatet på angiven SasUrl.
...
### -InputObject
VPN gateway-objekt där paket upptagningen ska startas.
...
### -Namn
Namnet på den VPN-gateway där paket upptagningen ska startas.
...
### -ResourceId
Azure Resource ID för den VpnGateway där paket upptagningen ska startas.
...
### -SasUrl
SAS URL-paketfiltrering på VPN gateway.
...
### Microsoft. Azure. commands. Networks. Models. PSVpnGatewayPacketCaptureResult
