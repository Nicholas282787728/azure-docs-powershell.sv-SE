...
Det andra kommandot hämtar SSL-principen från den Application Gateway som lagras i variabeln $AppGW.

## MALLPARAMETRAR

### -ApplicationGateway
Anger Application Gateway för SSL-policyn som denna cmdlet får.
