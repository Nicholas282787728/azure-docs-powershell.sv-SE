...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzPublicIPAddress** har en eller flera offentliga IP-adresser i en resurs grupp.
...
Det här kommandot får en offentlig IP-adressresurs med namnet myPublicIp i resurs gruppen myRg.
...
Det här kommandot får alla offentliga IP-adressresurser vars namn börjar med myPublicIp.
