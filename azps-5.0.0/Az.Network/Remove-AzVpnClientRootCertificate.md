...
Du kan hämta PublicCertData med hjälp av Windows PowerShell-kommandon som den här: $Text = Get-Content-Path "C:\Azure\Certificates\ExportedCertificate.cer" $CertificateText = för ($i = 1; $i-lt $Text. length-1; $i + +) {$Text \[ $i \] }
