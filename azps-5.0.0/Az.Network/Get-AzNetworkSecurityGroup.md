...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzNetworkSecurityGroup** får en Azure Network Security-grupp.

## BESKRIVS

### Exempel 1: Hämta en befintlig nätverks säkerhets grupp
```powershell
...
### Exempel 2: Visa en lista över befintliga nätverks säkerhets grupper med hjälp av filtrering
```powershell
...
Det här kommandot returnerar innehållet i Azure Network Security Groups som börjar med "NSG"
