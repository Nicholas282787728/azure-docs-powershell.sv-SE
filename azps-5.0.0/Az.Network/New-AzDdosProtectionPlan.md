...
## PROBLEMBESKRIVNING
New-AzDdosProtectionPlan-cmdleten skapar ett DDoS skydds abonnemang.

## BESKRIVS

### Exempel 1: skapa och koppla ett DDoS skydds abonnemang till ett nytt virtuellt nätverk
```
...
Först skapar vi ett nytt DDoS skydds abonnemang med kommandot **ny-AzDdosProtectionPlan** .
Sedan skapar vi ett nytt virtuellt nätverk med **New-AzVirtualNetwork** och anger ID för det nya abonnemanget i parametern **DdosProtectionPlanId**. I det här fallet, eftersom vi associerar det virtuella nätverket med en plan, kan vi också ange parametern **EnableDdoSProtection**.

### Exempel 2: skapa och koppla ett DDoS skydds abonnemang till ett befintligt virtuellt nätverk
```
D:\> $ddosProtectionPlan = New-AzDdosProtectionPlan -ResourceGroupName ResourceGroupName -Name DdosProtectionPlanName -Location "West US"
...
Först skapar vi ett nytt DDoS skydds abonnemang med kommandot **ny-AzDdosProtectionPlan** .
För det andra får vi den senaste versionen av det virtuella nätverk vi vill associera med abonnemanget. Vi uppdaterar egenskapen **DdosProtectionPlan** med ett **PSResourceId** -objekt som innehåller en referens till det ID för det nya abonnemanget. I det här fallet kan vi även ange flaggan **EnableDdosProtection** till sant om vi associerar det virtuella nätverket med ett DDoS.
Slutligen sparar vi den nya statusen genom att översätta den lokala variabeln till **set-AzVirtualNetwork**.
...
### -Plats
Anger platsen för det DDoS som ska skapas.
...
### -Namn
Anger namnet på det DDoS som ska skapas.
...
### -ResourceGroupName
Anger resurs gruppen för det DDoS skydds abonnemang som ska skapas.
