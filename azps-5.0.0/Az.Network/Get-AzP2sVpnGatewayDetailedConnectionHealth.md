...
## PROBLEMBESKRIVNING
Med cmdleten **Get-AzP2sVpnGatewayDetailedConnectionHealth** kan du få detaljerad information om aktuella punkter för webbplats anslutningar från P2SVpnGateway. Kunden måste skicka SAS-URL: er där vi kan ange den detaljerade hälso informationen.
...
Med cmdleten **Get-AzP2sVpnGatewayDetailedConnectionHealth** kan du få detaljerad information om aktuella punkter för webbplats anslutningar från P2SVpnGateway. Kunden kan ladda ned hälso information från godkänd URL-nedladdning. Då visas information om varje punkt för webbplats anslutning med användar namn, byte in, byte ut, tilldelad IP-adress etc.
...
### -OutputBlobSasUrl
OutputBlob SAS URL till vilken P2s för VPN-anslutningen skrivs.
...
### -VpnUserNamesFilter
Listan med P2S VPN-namn som ska filtreras.
...
### Microsoft. Azure. commands. Networks. Models. PSP2SVpnConnectionHealth
