...
Det första kommandot får ett virtuellt nätverk.
Det andra kommandot får ett undernät med det skapade virtuella nätverket.
Det tredje kommandot får programgatewayen och lagras i $AppGw variabel.
Det fjärde kommandot lägger till IP-konfigurationen till den Programgateway som lagras i $AppGw.
