...
Kommandot ovan skapar en ReadOnly-databas "mykustodatabase" i klustret "testnewkustoclusterf".
Det följer databasen "mykustodatabase" från kluster "testnewkustocluster"
...
### -ClusterResourceId
Resurs-ID för det kluster där databaserna som du vill ansluta finns.
...
### -DatabaseName
Namnet på den databas som du vill bifoga, Använd * om du vill följa alla aktuella och framtida databaser.
...
Standard principens ändrings typ
...
### -Namn
Namnet på den anslutna databas konfigurationen.
...
### Microsoft. Azure. PowerShell. cmdletar. Kusto. Models. Api20200614. IAttachedDatabaseConfiguration
