...
### Exempel 1: här visas giltiga SKU: er
```powershell
...
Kommandot ovan visar kvalificerade SKU: er.

### Exempel 2: listar giltiga SKU: er för specifika kluster
```powershell
...
Kommandot ovan visar kvalificerade SKU: er för specifika kluster
...
### Microsoft. Azure. PowerShell. cmdletar. Kusto. Models. Api20200614. IAzureResourceSku

### Microsoft. Azure. PowerShell. cmdletar. Kusto. Models. Api20200614. ISkuDescription
