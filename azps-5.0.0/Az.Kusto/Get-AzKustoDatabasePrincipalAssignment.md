...
### Exempel 2: Hämta en specifik PrincipalAssignment i en databas efter namn
```powershell
...
Kommandot ovan returnerar alla PrincipalAssignment med namnet "kustoprincipal1" i databasen "mykustodatabase" i klustret "testnewkustocluster".
...
### Microsoft. Azure. PowerShell. cmdletar. Kusto. Models. Api20200614. IDatabasePrincipalAssignment
