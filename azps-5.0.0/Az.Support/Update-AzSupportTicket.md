...
## PROBLEMBESKRIVNING
Använd denna cmdlet för att uppdatera support ärendets allvarlighets nivå, status eller kund kontakt uppgifter. Observera att det inte går att uppdatera allvarlighets graden eller status för en support biljett när biljetten kopplas till en support tekniker. Om du vill uppdatera allvarlighets graden eller statusen efter biljett tilldelningen kontaktar du support teknikern genom att skicka en kommunikation på biljetten.

## BESKRIVS

### Exempel 1: uppdatera allvarlighets grad för support ärende.
```powershell
...
### Exempel 2: uppdatera status för support ärende.
```powershell
...
### Exempel 3: uppdatera kontakt information för support ärendet genom att ange Contact-objekt.
```powershell
...
### Exempel 4: uppdatera allvarlighets graden för support biljetter via ett Ticket support-objekt.
```powershell
...
### Exempel 5: uppdatera kontakt information för support ärendet genom att ange enskilda kontakt parametrar.
```powershell
...
### Exempel 6: uppdatera status för support ärende via biljett objekt för support biljetter.
```powershell
...
Uppdatera kontakt detaljer på SupportTicket.
...
Språk för kund preferens support.
Detta måste vara ett giltigt språk för fortion för något av de språk som stöds här https://azure.microsoft.com/support/faq/ .
...
### -InputObject
SupportTicket som denna cmdlet uppdaterar.
...
### -Namn
Namn på SupportTicket resurs som denna cmdlet uppdaterar.
...
### – Allvarlighets grad
Uppdatera allvarlighets graden för SupportTicket.
...
### -Status
Uppdatera status för SupportTicket.
