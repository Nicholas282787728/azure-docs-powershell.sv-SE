...
## PROBLEMBESKRIVNING
Cmdleten **set-AzDtlAllowedVMSizesPolicy** anger den tillåtna principen för den virtuella dator storleken, som anger en lista över storlekar för virtuell dator som är tillåtna i en labb miljö.
...
### -Inaktivera
Anger att denna cmdlet inaktiverar principen.
...
### -Aktivera
Anger att denna cmdlet aktiverar policyn.
...
### -LabName
Anger namnet på den Lab för vilken denna cmdlet ställer in princip för virtuell dator storlek.
...
### -VmSizes
Anger, som en sträng mat ris lista, som är tillåtna i Lab.
