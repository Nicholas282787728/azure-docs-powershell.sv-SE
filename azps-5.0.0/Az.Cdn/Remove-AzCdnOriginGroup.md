...
## PROBLEMBESKRIVNING
Remove-AzCdnOriginGroup tar bort en CDN-ursprung från den angivna slut punkten. 
...
Denna cmdlet tar bort den angivna ursprungs gruppen från den angivna slut punkten. 
...
### -ResourceId
Resurs-ID för Azure CDN Origin-gruppen.
