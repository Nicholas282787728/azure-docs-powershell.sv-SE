...
## PROBLEMBESKRIVNING
Cmdleten **New-AzCdnProfile** skapar en CDN-profil (Content Delivery Network).

## BESKRIVS

### Exempel 1

Skapar en CDN-profil. (automatiskt genererat)
...
### -Plats
Anger resurs platsen för profilen.
...
### -Tagg
De taggar som ska kopplas till Azure CDN-profilen.
