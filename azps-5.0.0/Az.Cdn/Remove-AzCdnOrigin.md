...
## PROBLEMBESKRIVNING
Remove-AzCdnOrigin tar bort ett CDN-ursprung från den angivna slut punkten. Om Origo är det enda ursprunget inom den angivna slut punkten Miss lyckas borttagningen eftersom minst 1 Origo behövs. 
...
```
Denna cmdlet tar bort angivet ursprung från den angivna slut punkten. 
