...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzCdnProfileSupportedOptimizationType** får optimerings typerna som stöds för den aktuella profilen. En användare kan skapa en slut punkt med en optimerings typ från värdena i listan.
...
Få optimerings typer som stöds för en CDN-profil.
