...
## Sammanfattning
Skapar en ny CDN-ursprungs grupp
...
## PROBLEMBESKRIVNING
New-AzCdnOriginGroup skapar en ny ursprungs grupp inom den angivna slut punkten. Om det här är den första start gruppen för slut punkten måste också egenskapen DefaultOriginGroup vara inställd.
...
```
Denna cmdlet kommer att skapa en ny ursprungs grupp för den angivna slut punkten. Det kommer att använda de angivna ursprungs-ID: na.

## MALLPARAMETRAR

### -CdnOriginGroup
Gruppobjektet CDN-ursprung.
...
### -OriginGroupName
Namn på en grupp med Azure CDN-ursprung.
...
### -OriginId
Grupp-ID: n för Azure CDN-ursprung.
...
Antal sekunder mellan hälso avsökningarna.
...
### -ProbePath
Sökvägen i förhållande till ursprunget som används för att fastställa statusen för origo.
...
### -ProbeProtocol
Protokoll som ska användas för hälso sökning.
...
### -ProbeRequestType
Typ av begäran om hälso sökning.
