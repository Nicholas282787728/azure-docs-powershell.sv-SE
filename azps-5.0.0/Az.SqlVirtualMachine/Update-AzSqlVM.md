...
## PROBLEMBESKRIVNING
Update-AzSqlVM cmdlet uppdaterar en virtuell SQL-dator.
...
Uppdaterar taggarna för en virtuell SQL-dator.

### Exempel 2

Uppdaterar en virtuell SQL-dator. (automatiskt genererat)
