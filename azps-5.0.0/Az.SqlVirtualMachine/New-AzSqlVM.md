...
## PROBLEMBESKRIVNING
New-AzSqlVM-cmdleten skapar en virtuell Azure SQL-dator.
...
Skapar en ny virtuell Azure SQL-dator med namn VM i resurs gruppen ResourceGroup01 
...
### -Plats
Plats för virtuell dator för SQL.
