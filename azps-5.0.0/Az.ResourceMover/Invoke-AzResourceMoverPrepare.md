...
### Exempel 1: verifiera dependecies innan du förbereder dem
```powershell
...
Verifiera dependecies innan du förbereder resursen.

### Exempel 2: initiera förbereda för uppsättningen med resurser i flytt samlingen med "MoveResource Name" som indata
```powershell
...
Börja förbereda en uppsättning resurser i flytt samlingen med "MoveResource Name" som indata.

### Exempel 3: initiera förbereda för uppsättningen med resurser i flytt samlingen med "SourceARMID"
```powershell
...
Börja förbereda en uppsättning resurser i flytt samlingen med "SourceARMID".
