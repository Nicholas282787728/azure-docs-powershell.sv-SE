...
### Exempel 1: lägga till en resurs i flytt mängden.
```powershell
...
Lägga till en resurs i flytt samlingen inom det angivna abonnemanget.
...
### -DependsOnOverride
Hämtar eller anger åsidosättningar för flytt av resurs beroenden.
För att konstruera kan du läsa avsnittet anteckningar för DEPENDSONOVERRIDE-egenskaper och skapa en hash-tabell.
...
### -ExistingTargetId
Hämtar eller anger resursens befintliga Målprogram-ID.
...
Resurs typen.
Värdet kan till exempel vara Microsoft. Compute/virtualMachines.
...
Hämtar eller anger mål resursens namn.
...
### -SourceId
Hämtar eller anger resursens käll ARM-ID.
...
DEPENDSONOVERRIDE <IMoveResourceDependencyOverride [] >: hämtar eller anger åsidosättningarna för att flytta resurs beroenden.
  - `[Id <String>]`: Hämtar eller anger ID för den beroende resursen.
  - `[TargetId <String>]`: Hämtar eller anger Resource ARM-ID för antingen MoveResource eller Resource ARM-ID för den beroende resursen.
