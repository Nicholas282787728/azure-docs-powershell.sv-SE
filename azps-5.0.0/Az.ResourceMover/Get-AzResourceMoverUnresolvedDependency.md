...
### Exempel 1: Hämta lista med ej lösta beroende resurser
```powershell
...
Få en lista med ej lösta beroende resurser för en flytt mängd.
...
### Microsoft. Azure. PowerShell. cmdletar. ResourceMover. Models. Api20191001Preview. IUnresolvedDependencyCollection
