...
## PROBLEMBESKRIVNING
**Remove-AzActionRule** cmdlet tar bort en åtgärds regel.
...
Denna cmdlet tar bort åtgärds regeln med namn ActionRuleName i resurs grupp test-rg
