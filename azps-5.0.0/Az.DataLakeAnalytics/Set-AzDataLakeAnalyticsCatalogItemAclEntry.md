...
## PROBLEMBESKRIVNING
Cmdleten **set-AzDataLakeAnalyticsCatalogItemAclEntry** lägger till eller ändrar en post (ACE) i åtkomst kontrol listan (ACL) för en katalog eller katalog objekt i data Lake Analytics.

## BESKRIVS

### Exempel 1: ändra användar behörigheter för en katalog
```powershell
...
Det här kommandot ändrar katalogens ACE för Patti Nilsson till Läs behörighet.

### Exempel 2: ändra användar behörigheter för en databas
```powershell
...
Det här kommandot ändrar databasens ACE för Patti Nilsson till Läs behörighet.
...
Det här kommandot ändrar katalogens ACE för att få Läs behörighet.
...
### Exempel 5: ändra behörigheter för användar ägare för en katalog
```powershell
...
Det här kommandot anger ägar behörigheten för kontot som ska läsas.

### Exempel 6: ändra behörigheter för användar ägare för en databas
```powershell
...
Det här kommandot anger ägar behörighet för databasen att läsa.
...
### -Grupp
Ange ACL-post för katalog för gruppen.
...
### -GroupOwner
Ange ACL-post för katalog för grupp ägare.
...
### -ObjectId
Identiteten för användaren som ska ställas in.
...
### -Annat
Ange ACL-post för andra kataloger.
...
### -Användare
Ange ACL-post för katalog för användare.
...
### -UserOwner
Ange ACL-post för katalog för användarens ägare.
