...
### Exempel 1: uppdatera MariaDB brand Väggs regel
```powershell
...
Det här kommandot uppdaterar en MariaDB.

### Exempel 2: uppdatera MariaDB brand Väggs regel efter identitet.
```powershell
...
Cmdleten uppdaterar MariaDB brand Väggs regel efter identitet.

### Exempel 3: uppdatera MariaDB brand Väggs regel by-ClientIPAddress.
```powershell
PS C:\> $ID = "/subscriptions/<SubscriptionId>/resourceGroups/mariadb-test-qu5ov0/providers/Microsoft.DBforMariaDB/servers/mariadb-test-4rmtig/firewallRules/fr-cfgl3y"
...
Cmdleten uppdaterar MariaDB med-ClientIPAddress.
