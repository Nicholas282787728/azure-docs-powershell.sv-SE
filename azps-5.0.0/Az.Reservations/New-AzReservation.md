...
## PROBLEMBESKRIVNING
Köp en reservations instans och få nytta
...
Efter att ha beräknat pris kan kunden Purcahse att RI tillhandahåller via calculatePrice
...
### -ReservationOrderId
ID för reservations order att köpa, generera med AZ reservationer reservation.
