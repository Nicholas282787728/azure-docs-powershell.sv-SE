...
## PROBLEMBESKRIVNING
Dela upp en `Reservation` i två `Reservation` s med angiven mängd fördelning.
...
Dela upp angiven `Reservation` i två `Reservation` s med motsvarande antal
...
### -Antal
Kommaavgränsade heltal för fältet Antal för de båda `Reservation` s
...
### -ReservationOrderId
ID för det `ReservationOrder` som innehåller den `Reservation` användare som vill dela
