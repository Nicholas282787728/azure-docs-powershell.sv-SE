...
## PROBLEMBESKRIVNING
**New-AzSnapshotConfig-** cmdleten skapar ett konfigurerbart SnapShot-objekt.
...
Skapar ett konfigurerbart SnapShot-objekt. (automatiskt genererat)
...
### -ImageReference
Anger bild referensen för en ögonblicks bild.
...
### -Inkrementellt
Anger en stegvis ögonblicks bild. Inkrementella ögonblicks bilder på samma disk tar mindre plats än fullständiga stillbilder och kan omräknas.
