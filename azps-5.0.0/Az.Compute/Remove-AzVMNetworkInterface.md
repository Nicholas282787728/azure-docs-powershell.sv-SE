...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzVMNetworkInterface** tar bort ett nätverks gränssnitt från en virtuell dator.
...
### -NetworkInterfaceIDs
Anger en matris med nätverkskort-ID: n som denna cmdlet tar bort.
...
### -VM
Anger den virtuella dator från vilken denna cmdlet tar bort ett nätverks gränssnitt.
