...
## PROBLEMBESKRIVNING
Cmdleten **set-AzVmssVM** ändrar tillståndet för en virtuell dators skalnings uppsättning (VMSS).

## BESKRIVS

### Exempel 1

Ändrar tillstånd för en VMSS-instans. (automatiskt genererat)
...
### -InstanceId
Anger ID för den VMSS-instans som denna cmdlet ändrar tillstånd för.
...
### -PerformMaintenance
Anger att denna cmdlet utför underhåll på en virtuell dator i VMSS.
...
### -Omdistribuera
Anger att denna cmdlet omdistribuerar en virtuell dator i VMSS.
...
### -Ombild
Anger att denna cmdlet ombildar VMSS-instansen.
...
### -ReimageAll
Anger att cmdleten återavbildningar alla diskar i VMSS-instansen.
...
### -ResourceGroupName
Anger namnet på den resurs grupp som innehåller VMSS-instansen.
...
### -SimulateEviction
Anger att denna cmdlet simulerar avlägsnande av en virtuell dator i en virtuell dator.
...
### -VMScaleSetName
Anger namnet på den VMSS-instans som denna cmdlet ändrar.
