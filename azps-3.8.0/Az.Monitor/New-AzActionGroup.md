...
## BESKRIVNING
Cmdleten **New-AzActionGroup** skapar ett referensobjekt för åtgärdsgrupper i minnet.

## EXEMPEL

### Exempel 1: Skapa ett referensobjekt för åtgärdsgrupp i minnet
```
...
### -WebhookProperty
Egenskaperna webhook för åtgärdsgruppen
