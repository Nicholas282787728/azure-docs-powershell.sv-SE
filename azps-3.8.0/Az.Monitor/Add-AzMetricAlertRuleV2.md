...
## Sammanfattning
Lägger till eller uppdaterar en v2-baserad notifieringsregel (icke-klassiskt).

## FRÅGESYNTAXEN

### CreateAlertByResourceId (standard)
```
...
## PROBLEMBESKRIVNING
Lägger till eller uppdaterar en **v2-baserad notifieringsregel (icke-klassiskt)**. Den tillagda regeln associeras med en resurs grupp och har ett namn. Denna cmdlet implementerar ShouldProcess-mönstret, t. ex. det kan begära bekräftelse från användaren innan de skapar, ändrar eller tar bort resursen.

## BESKRIVS

### Exempel 1: lägga till en regel för att varna på en virtuell dator
...
Det här kommandot skapar en regel för att varna för en virtuell dator. $condition är utdata från New-AzMetricAlertRuleV2Criteria cmdlet och $act är utdata från New-AzActionGroup cmdlet

### Exempel 2: lägga till en regel för notifieringsregler för alla virtuella datorer i ett abonnemang
```powershell
...
Det här kommandot skapar en metrisk varnings regel för alla virtuella datorer i prenumerationen som är i öster

### Exempel 3: inaktivera en regel för att varna
```powershell
...
Det här kommandot inaktiverar en regel för metrisk avisering. Här tar vi ledningar för Get-AzMetricAlertRuleV2 till Add-AzMetricAlertRuleV2 

### Exempel 4: Lägg till en regel för att varna med dimensioner
...
Om du vill skapa en mer komplex varnings regel som de som innefattar att välja dimensions värden eller ha flera villkor kan du använda cmdletarna New-AzMetricAlertRuleV2DimensionSelection och New-AzMetricAlertRuleV2Criteria.

Ovanstående uppsättning cmdletar skapar en regel för metriska varningar med dimensioner.

## MALLPARAMETRAR

### -ActionGroup
Åtgärds gruppen för regel
...
### -Beskrivning
Beskrivning av varnings regeln för metriska enheter
...
### -Frekvens
Utvärderings frekvens för regel
...
### – Allvarlighets grad
Allvarlighets graden för Metric-varningen
...
### -TargetResourceScope
Mål resurs omfattning för regel
...
### System. Collections. Generic. list ' 1 [[Microsoft. Azure. commands. Insights. OutputClasses. IPSMultiMetricCriteria, Microsoft. Azure. PowerShell. cmdletar. Monitor, version = 1.0.1.0, Culture = neutralt, PublicKeyToken = null]]

### Microsoft. Azure. Management. Monitoring. Models. ActivityLogAlertActionGroup []
