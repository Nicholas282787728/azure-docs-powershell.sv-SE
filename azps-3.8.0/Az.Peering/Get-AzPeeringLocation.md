...
## PROBLEMBESKRIVNING
Får peering-funktionerna där användarna kan ansluta med ARM.
...
En lång lista med platser. Hämtar alla funktioner för direkt peering.
...
Hämtar Exchange peering-platsen för Honolulu. 
...
Hämtar Exchange peering-platsen för peering Facility ID 71. 
...
### -DirectPeeringType
Välj "Edge", "CDN" och "transitering".
...
### Microsoft. Azure. PowerShell. cmdletar. peering. Models. PSPeeringLocation
