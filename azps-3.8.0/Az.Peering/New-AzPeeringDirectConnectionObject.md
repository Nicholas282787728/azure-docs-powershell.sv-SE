...
Skapa direkt peering-anslutning med användning för peering-tjänsten aktive rad och Microsofts IP-adresser
...
Skapa direkt peering-anslutning med användning för peering-tjänsten aktive rad och peer-tillhandahållna IP-adresser
...
Skapa direkt peering-anslutning utan BGP-sessionens IP-adresser. Motparten måste ange IP-adresserna innan BGP-sessionen kan konfigureras.

## MALLPARAMETRAR

### -BandwidthInMbps
Bandbredden som erbjuds på den här platsen i Mbps.
...
Aktivera flagga som anger att Microsoft ska tillhandahålla BGP-sessionens adresser.
...
Aktivera för användning med Microsoft peering service (MPS).
