...
Uppgraderar bandbredden för den första anslutningen i peering-objektet i minnet. 
...
### Uppdaterings användning för peering-tjänsten
```powershell
...
Uppdaterar anslutningen för användning med peering service
