...
## PROBLEMBESKRIVNING
Cmdleten **set-AzStorageTableStoredAccessPolicy** anger den lagrade åtkomst principen för en Azure Storage-tabell.

## BESKRIVS

### Exempel 1: Ange en lagrad åtkomst princip i en tabell med fullständig behörighet
```
PS C:\>Set-AzStorageTableStoredAccessPolicy -Table "MyTable" -Policy "Policy08" -Permission raud
```

Det här kommandot ställer in en åtkomst princip med namnet Policy08 för lagrings tabellen tabellen.
...
### -ExpiryTime
Anger den tid då den lagrade åtkomst policyn upphör att gälla.
...
### -NoExpiryTime
Visar att åtkomst policyn inte har något utgångs datum.
...
### -NoStartTime
Anger att start tiden är inställd på $Null.
...
### -Tillstånd
Anger behörigheter i den lagrade åtkomst principen för att komma åt lagrings tabellen.
...
### -Princip
Anger namnet på den lagrade åtkomst principen.
