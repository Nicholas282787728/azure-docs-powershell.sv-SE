...
Det här kommandot skapar ett lagrings konto med Azure-filer AAD DS-identifiering och aktiverar stor fil resurs..

### Exempel 8: skapa ett lagrings konto med konto – begränsad krypterings nycklar för kö och tabell tjänst.
```
...
Det här kommandot skapar ett lagrings konto med hanterat konto – begränsat krypterings nycklar, så att kön och tabellen använder samma krypterings nycklar med blobben och fil tjänsten. Hämta sedan egenskaperna för lagrings kontot och Visa krypterings typen för kö-och tabell tjänsten.
