...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlServerAudit** hämtar gransknings inställningarna för en Azure SQL Server.
...
### Exempel 2: gå till pipeline, gransknings inställningar för en Azure SQL-Server
```
...
### Exempel 3: Hämta gransknings inställningar för en Azure SQL Server
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
