...
## PROBLEMBESKRIVNING
Disable-AzSqlInstanceDatabaseSensitivityRecommendation cmdlet inaktiverar (missar) känslighets rekommendationer för kolumner i den SQL-hanterade instans-databasen.

## BESKRIVS

### Exempel 1: inaktivera känslighets rekommendationer för en viss kolumn i en Azure SQL-hanterad instans-databas.
```powershell
...
### Exempel 2: inaktivera känslighets rekommendationer för kolumner med känslighets rekommendationer i en Azure SQL-hanterad instans databas med rör.
```powershell
...
### Exempel 3: inaktivera känslighets rekommendationer för en viss kolumn i en Azure SQL-hanterad instans med rör.
```powershell
