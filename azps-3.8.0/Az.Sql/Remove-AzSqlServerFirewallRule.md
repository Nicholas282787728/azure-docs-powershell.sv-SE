...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSqlServerFirewallRule** tar bort en brand Väggs regel från den angivna Azure SQL Database-servern.

## BESKRIVS

### Exempel 1: ta bort en regel
```
PS C:\>Remove-AzSqlServerFirewallRule -FirewallRuleName "Rule01" -ResourceGroupName "ResourceGroup01" -ServerName "Server01"
```

Det här kommandot tar bort en brand Väggs regel med namnet Rule01 på servern med namnet Server01.
...
### -FirewallRuleName
Anger namnet på brand Väggs regeln som tas bort med denna cmdlet.
