...
## PROBLEMBESKRIVNING
Med Get-AzSqlElasticJobStepExecution cmdlet får du ett eller flera jobb körningar från en jobb körning

## BESKRIVS

### Exempel 1-hämtar ett eller flera jobb-körningar från ett jobb försök
```
...
### Exempel 2 – får ett eller flera jobb körningar från en jobb körning, filtrerar enligt steg namn
```
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
