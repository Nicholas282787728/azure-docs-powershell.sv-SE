...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlDatabaseImportExportStatus** hämtar information om en BACPAC-fil import från ett lagrings konto till en Azure SQL-databas eller en export av en Azure SQL-databas som en BACPAC-fil till ett lagrings konto.
...
### -OperationStatusLink
Anger den status länk som returneras från New-AzSqlDatabaseExport eller New-AzSqlDatabaseImport cmdletar.
