...
## PROBLEMBESKRIVNING
Med det här kommandot tas den instansen av redundans bort med det angivna namnet och alla databaser blir oförändrade. Lyssnar slut punkten kommer att avregistreras från DNS.
...
Ta bort en failover-grupp för en instans.
...
### -InputObject
Den instans av grupp objekt som ska tas bort
...
### -Namn
Namnet på den instans av instansen som ska tas bort.
...
### -PassThru
Anger om du vill överföra utdata från en cmdlet.
...
### -ResourceId
Resurs-ID för den instans som ska tas bort.
