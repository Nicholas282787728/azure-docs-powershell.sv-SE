...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzStackEdgeDevice** tar bort konfigurationen för en trave Edge-enhet.
Observera att enheten bara kan tas bort när du har placerat beställningen och innan enheten förbereds av Microsoft för leverans.

Läs dokumentationen om hur du tar bort resursen innan du använder denna [cmdlet](https://docs.microsoft.com/en-us/azure/databox-online/data-box-edge-return-device#delete-the-resource)
