...
## PROBLEMBESKRIVNING
Det här kommandot abonnerar händelse utlösaren på angivna externa tjänst händelser från trigger defintion.
...
Det här kommandot abonnerar på BlobEnetTrigger1 för angivna händelser från utlösaren defintion.
