...
## PROBLEMBESKRIVNING
Cmdleten **New-AzDataFactoryGateway** skapar en gateway i Azure Data Factory.

## BESKRIVS

### Exempel 1: skapa en gateway
```
...
Det här kommandot skapar en gateway med namnet ContosoGateway i data fabriken med namnet WikiADF i resurs gruppen med namnet ADF.

## MALLPARAMETRAR

### -DataFactory
Anger ett **PSDataFactory** -objekt.
Denna cmdlet skapar en gateway för data fabriken som den här parametern anger.
...
### -Namn
Anger namnet på den gateway som ska skapas.
...
Denna cmdlet skapar en gateway som tillhör den grupp som den här parametern anger.
