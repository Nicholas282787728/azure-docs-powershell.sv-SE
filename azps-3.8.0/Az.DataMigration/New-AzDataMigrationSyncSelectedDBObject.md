...
New-AzDataMigrationSyncSelectedDB-cmdleten skapar ett specifikt databas informations objekt för det synkroniseringsförsök som innehåller information om käll-och mål databaser.
...
I det här exemplet skapas ett metadataobjekt för databas som beskriver migrerade inställningar för $DatabaseName till databas $DatabaseName.  
...
### -MigrationSetting
Inställningar för migrering som styr migreringens beteende
...
### -SourceSetting
Käll inställningar för att justera källa för slut punkts migrering
...
### -TargetSetting
Mål inställningar för att finjustera beteendet för migrering av mål slut punkter
