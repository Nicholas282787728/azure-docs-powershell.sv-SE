...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzCosmosDBSqlContainer** tar bort den CosmosDB SQL-container som motsvarar angivet ResourceGroupName, AccountName, databasename och ContainerName.
