...
## PROBLEMBESKRIVNING
Cmdleten **set-AzCosmosDBCassandraKeyspace** anger CosmosDB Cassandra.
...
Resurs objekt innehåller värdena för _rid _ts _etag egenskaper.
