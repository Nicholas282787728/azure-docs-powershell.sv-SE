...
## Sammanfattning
Skapar ett nytt objekt av typen PSIndexes. Det kan skickas som ett parameter värde för set-AzCosmosDBSqlIncludedPath.
...
## PROBLEMBESKRIVNING
Objekt som motsvarar SQL API-IncludedPath's-index.
