...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzPowerBIWorkspaceCollection** tar bort en Power BI-arbetsyta från din Azure-prenumeration och resurs grupp.

## BESKRIVS

### Exempel 1: ta bort en samling med arbets ytor
```
PS C:\>Remove-AzPowerBIWorkspaceCollection -ResourceGroupName "ResourceGroup17" -WorkspaceCollectionName "WCN11"
```

Det här kommandot tar bort arbets ytans samling med namnet WCN11 i den angivna resurs gruppen.
...
### -ResourceGroupName
Anger namnet på den resurs grupp från vilken denna cmdlet tar bort en arbets yta.
...
Anger namnet på den Power BI-arbetsyta som denna cmdlet tar bort.
