...
## PROBLEMBESKRIVNING
Cmdleten **set-AzApiManagementGroup** konfigurerar en API-hanterings grupp.
...
Det här kommandot konfigurerar en hanterings grupp som heter Group0001.
...
### -Kund-
Anger ID för hanterings gruppen.
