...
### Skapa autentiseringsuppgifter för backend In-Memory objekt
```powershell
...
Skapar ett autentiseringsuppgifter för backend

## PARAMETERS

### -AuthorizationHeaderParameter
Auktoriseringshuvud som används för backend.
...
Auktoriseringsschema som används för backend.
Den här parametern är valfri.
...
### -Header
Rubrikparametervärden som accepterats av Backend.
Den här parametern är valfri.
...
### -Query
Frågeparametervärden som accepterats av Backend.
Den här parametern är valfri.
