...
## PROBLEMBESKRIVNING
Cmdlet **Remove-AzApiManagementDiagnostic** tar bort den diagnostiska enhet som anges av `DiagnosticId` från globalt scope eller ett `ApiId` scope

## BESKRIVS

### Exempel 1: ta bort den diagnostiska enheten
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementDiagnostic -Context $apimContext -DiagnosticId "applicationinsights"
```

I det här exemplet tas diagnostik bort `applicationinsights` från API Management-tjänsten.
...
### -InputObject
Instans av PsApiManagementDiagnostic. Denna parameter är obligatorisk.
...
### -ResourceId
Arm ResourceId för diagnostik. Denna parameter är obligatorisk.
