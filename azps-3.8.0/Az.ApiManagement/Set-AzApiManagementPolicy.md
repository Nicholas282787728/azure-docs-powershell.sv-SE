...
### -Format
Anger principens format. Om `application/vnd.ms-azure-apim.policy+xml` du använder, måste uttryck i principen vara XML-avmarkerat. När du använder `application/vnd.ms-azure-apim.policy.raw+xml` den är det **inte** nödvändigt att principen är avmarkerad.
