...
## PROBLEMBESKRIVNING
Cmdleten **set-AzSearchService** ändrar en Azure Search-tjänst.
...
Exemplet ändrar antalet partitioner och antalet repliker för Azure Search-tjänsten till 2.
...
### -PartitionCount
Antal partitioner för Sök tjänsten.
