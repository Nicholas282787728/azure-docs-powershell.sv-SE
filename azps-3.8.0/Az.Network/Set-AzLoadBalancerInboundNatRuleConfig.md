...
## PROBLEMBESKRIVNING
Cmdleten **set-AzLoadBalancerInboundNatRuleConfig** anger en regel för inkommande NAT-regler (Network Address Translation) för en Azure-belastningsutjämnare.
...
Det andra kommandot använder pipeline-operatorn för att överföra belastningsutjämnaren i $slb till Add-AzLoadBalancerInboundNatRuleConfig, vilket lägger till en inkommande NAT-regel.
Det tredje kommandot skickar belastningsutjämnaren till **set-AzLoadBalancerInboundNatRuleConfig** , som sparar och uppdaterar den inkommande NAT-regelns konfiguration.
