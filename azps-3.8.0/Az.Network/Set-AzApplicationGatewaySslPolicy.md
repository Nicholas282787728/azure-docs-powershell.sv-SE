...
## PROBLEMBESKRIVNING
Cmdleten **set-AzApplicationGatewaySslPolicy** ändrar SSL-principen för en Programgateway.
...
### -ApplicationGateway
Anger Application Gateway för SSL-policyn som denna cmdlet ändrar.
...
Anger vilka protokoll som är inaktiverade.
