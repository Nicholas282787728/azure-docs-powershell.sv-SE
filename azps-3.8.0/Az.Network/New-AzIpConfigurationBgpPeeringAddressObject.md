...
```
## PROBLEMBESKRIVNING
**New-AzIpConfigurationBgpPeeringAddressObject** skapar ett IpConfigurationBgpPeeringAddressObject-objekt som representerar BgpPeeringAddresses-egenskapen i din virtuella nätverksgateway bgpsettings.

## BESKRIVS

### 1: skapa en AzIpConfigurationBgpPeeringAddressObject
```
...
Ovanstående skapar en IpConfigurationBgpPeeringAddressObject. Detta nya objekt kommer att vara till gw1ipconfBgp1.
...
### -CustomAddress
Den virtuella Nätverksgatewayen CustomAddress listan för BgpPeeringAddresses.
...
### -IpConfigurationId
Den virtuella Nätverksgatewayen IpConfigurationId för BgpPeeringAddresses.
...
### Microsoft. Azure. commands. Networks. Models. PSIpConfigurationBgpPeeringAddress
