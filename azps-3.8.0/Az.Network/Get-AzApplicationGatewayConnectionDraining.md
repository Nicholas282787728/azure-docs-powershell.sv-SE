...
## BESKRIVNING
Cmdleten **Get-AzApplicationGatewayConnectionDraining** får konfiguration av anslutningen som töms på ett HTTP-inställningsobjekt i backend-delen.
