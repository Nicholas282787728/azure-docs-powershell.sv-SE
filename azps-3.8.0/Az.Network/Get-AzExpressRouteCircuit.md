...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzExpressRouteCircuit** används för att hämta ett ExpressRoute-kretskort från din prenumeration. Det kretsar som returneras kan användas som indata för andra cmdlets som fungerar på ExpressRoute-kretsar.

## BESKRIVS

### Exempel 1: skaffa ExpressRoute-kretsen
```
...
Skaffa en specifik ExpressRoute-krets med namnet "testrg" och ResourceGroupName "test"

### Exempel 2: lista de ExpressRoutea kretsarna med hjälp av filtrering
```
...
Få alla ExpressRoute-kretsar vars namn börjar med "test".
