...
## PROBLEMBESKRIVNING
Cmdleten **set-AzApplicationGatewayUrlPathMapConfig** anger konfiguration för en matris med URL-sökvägar till en Server grupp.

## BESKRIVS

### Exempel 1: uppdatera en URL-mappsökväg
```
...
Det andra kommandot uppdaterar URL-sökvägen med namnet map01 i programgatewayen.
