...
## PROBLEMBESKRIVNING
Cmdleten **set-AzApplicationGatewayRewriteRuleSet** ändrar en regel för en anslutningsbegäran.
...
Med det andra kommandot ändras regel för ny skrivning för Application Gateway för användning av omskrivnings regler som anges i variabeln $rule.
