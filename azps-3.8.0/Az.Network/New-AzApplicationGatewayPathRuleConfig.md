...
$firewallPolicy = New-AzApplicationGatewayFirewallPolicy -Name "wafPolicy1" -ResourceGroup "rgName" En brandväggsprincip som skapats med ovanstående kommandolet kan hänvisas på en nivå med sökvägsregel. kommandot ovan skulle skapa standardinställningar för principen och hanterade regler.
I stället för standardvärdena kan användarna ange PolicySettings, ManagedRules med hjälp New-AzApplicationGatewayFirewallPolicySettings och New-AzApplicationGatewayFirewallPolicyManagedRules respektive.
