...
Ovanstående skapar en resurs grupp, virtuellt WAN, virtuellt nätverk, virtuellt nav i västra centrala USA i resurs gruppen "testRG" i Azure. En ExpressRoute gateway kommer att skapas därefter i det virtuella navet med två skal enheter.

Då hämtas ExpressRouteGateway med dess resourceGroupName och gateway-namnet.
...
Det här kommandot får alla ExpressRouteGateways som börjar med "test"
