...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzPublicIpPrefix** tar bort ett prefix för Azure offentlig IP så länge det inte finns några offentliga IP-adresser tilldelade till sig.
...
Tar bort det offentliga IP-prefixet med namnet $prefixName från resurs gruppen $rgName
...
### -ResourceId
ResourceId för resursen som ska tas bort
