...
### Exempel 4: Inaktivera trafikanalys för en viss NSG med Flow Logging och Trafikanalys konfigurerade
```
PS C:\> $NW = Get-AzNetworkWatcher -ResourceGroupName NetworkWatcherRg -Name NetworkWatcher_westcentralus
PS C:\> $nsg = Get-AzNetworkSecurityGroup -ResourceGroupName NSGRG -Name appNSG
PS C:\> $storageId = "/subscriptions/bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb/resourceGroups/NSGRG/providers/Microsoft.Storage/storageAccounts/contosostorageacct123"
...
I det här exemplet inaktiverar vi Trafikanalys för en nätverkssäkerhetsgrupp som har flödesloggning och Trafikanalys som konfigurerats tidigare. I svaret ser vi att den angivna NSG-funktionen har flödesloggning aktiverad men Trafikanalys inaktiverad.
