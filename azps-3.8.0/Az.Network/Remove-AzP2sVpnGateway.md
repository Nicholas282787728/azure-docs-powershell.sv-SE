...
## PROBLEMBESKRIVNING
Med cmdleten **Remove-AzP2sVpnGateway** kan du ta bort en befintlig P2SVpnGateway under VirtualHub. Alla anslutningar till klient klienter Miss lyckas när P2SVpnGateway har tagits bort.
...
Med cmdleten **Remove-AzP2sVpnGateway** kan du ta bort en befintlig P2SVpnGateway under VirtualHub.
...
### -InputObject
P2sVpnGateway-objekt som ska tas bort.
...
### -ResourceId
Azure Resource ID för p2sVpnGateway ska tas bort.
