...
## PROBLEMBESKRIVNING
Get-AzNetworkWatcherConnectionMonitorReport cmdlet returnerar rapporten med de senaste anslutnings lägena.

## BESKRIVS

### Exempel 1: hämta den senaste anslutningen för anslutnings övervakaren med namn på den angivna platsen
```
...
I det här exemplet frågar vi de senaste anslutnings lägena för den angivna anslutnings övervakaren.
...
### Microsoft. Azure. commands. Networks. Models. PSConnectionMonitorQueryResult
