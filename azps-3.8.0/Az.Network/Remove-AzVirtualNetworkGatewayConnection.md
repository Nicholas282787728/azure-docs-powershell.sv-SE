...
Cmdleten **Remove-AzVirtualNetworkGatewayConnection** tar bort objektet i din anslutning baserat på namn-och resurs grupp namn.

## BESKRIVS

### 1: ta bort en anslutning till en virtuell nätverksgateway
```
Remove-AzVirtualNetworkGatewayConnection -Name myTunnel -ResourceGroupName myRG
```

Tar bort objektet för den virtuella Nätverksgatewayen med namnet "tunnel" i resurs gruppen "myRG"
...
### -Namn
Anger namnet på den virtuella Nätverksgatewayen som denna cmdlet tar bort.
...
### -ResourceGroupName
Anger namnet på den resurs grupp som innehåller anslutningen för den virtuella Nätverksgatewayen.
