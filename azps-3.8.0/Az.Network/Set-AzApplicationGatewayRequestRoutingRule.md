...
## PROBLEMBESKRIVNING
Cmdleten **set-AzApplicationGatewayRequestRoutingRule** ändrar en regel för en anslutningsbegäran.

## BESKRIVS

### Exempel 1: uppdatera en regel för en anslutningsbegäran
```
...
Det andra kommandot ändrar regeln för anslutningsbegäran för Application Gateway för användning av backend-HTTP-inställningar som anges i $Setting variabel, en HTTP-lyssnare som anges i $Listener-variabeln och en backend-adresspool som angetts i $Pool variabeln.

## MALLPARAMETRAR

### -ApplicationGateway
Anger det Application Gateway-objekt som denna cmdlet associerar en anslutningsbegäran för.
...
### -BackendAddressPool
Anger backend-adresspoolen för Application Gateway.
...
Anger programgatewayens backend-ID.
...
### -BackendHttpSettings
Anger Server delen för Programgateway-HTTP-inställningar.
...
Anger backend-ID för HTTP-inställningar för Application Gateway.
...
### -HttpListener
Anger HTTP-lyssnaren för Application Gateway.
...
### -Namn
Anger namnet på regeln för anslutningsbegäran som denna cmdlet ändrar.
