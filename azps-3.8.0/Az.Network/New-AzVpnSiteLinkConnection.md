...
### -ConnectionBandwidth
Bandbredden som måste hanteras av den här länk anslutningen i Mbps.
...
### -EnableBgp
Aktivera BGP för denna länk anslutning
...
### -IpSecPolicy
IpSec-princip som ska användas för den här länken.
...
### -SharedKey
Den delade knapp som krävs för att konfigurera länken.
...
Använd lokal Azure-IP-adress som käll-IP för den här länken.
...
Använd principbaserad trafikväljaren för den här länk anslutningen.
...
### -VpnSiteLink
Länken VPN-plats att ansluta till.
...
### Microsoft. Azure. commands. Networks. Models. PSVpnSiteLink

## VÄRDEN

### Microsoft. Azure. commands. Networks. Models. PSVpnSiteLinkConnection
