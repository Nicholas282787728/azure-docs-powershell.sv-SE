...
## PROBLEMBESKRIVNING
Cmdleten **restore-AzKeyVaultSecret** skapar en hemlighet i det angivna nyckel valvet.
...
Det här kommandot återställer en hemlighet, inklusive alla dess versioner, från säkerhets kopian som heter Backup. blob till nyckel valvet contoso.
