...
Det här kommandot uppdaterar webb programmet som heter ContosoSite som tillhör resurs gruppens standardinställning för att använda åtkomst begränsnings konfiguration för huvud webbplatsen på SCM-webbplatsen.
