...
# AZ. Automation-modul
## Problembeskrivning
I det här avsnittet visas hjälp avsnitt för Azure Automation-cmdletar.

## AZ. Automation-cmdletar
...
Exporterar en automatiserings Runbook.
...
Hämtar automatiserings Runbook-jobb.
...
Hämtar en lista över konfigurationer för Azure Automation-programuppdatering.
...
Hämtar utdata från ett synkroniseringsjobb för Azure Automation.

### [Get-AzAutomationVariable](Get-AzAutomationVariable.md)
Hämtar en Automation-variabel.
...
Importerar en automatiserings Runbook.
...
Återskapar registrerings nycklar för ett Automation-konto.
...
Registrerar en virtuell Azure-dator som en DSC-nod för ett Automation-konto.
...
Tar bort en automatiserings anslutning.

### [Remove-AzAutomationConnectionType](Remove-AzAutomationConnectionType.md)
Tar bort en typ av Automation-anslutning.

### [Remove-AzAutomationCredential](Remove-AzAutomationCredential.md)
Tar bort en automatiserings autentiseringsuppgift.
...
Tar bort hybrid Worker-gruppen från Automation.
...
Återupptar ett uppehållet automatiserings jobb.
...
Ändrar värdet för ett fält i en Automation-anslutning.
...
Startar en Azure Automation-synkroniseringsjobb.
...
### [Avregistrera-AzAutomationScheduledRunbook](Unregister-AzAutomationScheduledRunbook.md)
Tar bort en association mellan en Runbook och ett schema.

### [Update-AzAutomationSourceControl](Update-AzAutomationSourceControl.md)
Uppdaterar en käll kontroll för Azure Automation.
