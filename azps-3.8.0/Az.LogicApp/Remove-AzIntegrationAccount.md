...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzIntegrationAccount** tar bort ett integrerings konto från en resurs grupp.
...
### Exempel 1: ta bort ett integrations konto
```
PS C:\>Remove-AzIntegrationAccount -ResourceGroupName "ResourceGroup11" -Name "IntegrationAccount31" -Force
```

Det här kommandot tar bort ett integrerings konto med namnet IntegrationAccount31.
