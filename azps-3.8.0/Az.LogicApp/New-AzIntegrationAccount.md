...
## PROBLEMBESKRIVNING
Cmdleten **New-AzIntegrationAccount** skapar ett integrations konto.
Denna cmdlet returnerar ett objekt som representerar integrations kontot. Ange ett namn, en plats, resurs gruppens namn och ett SKU-namn.
...
### Exempel 1: skapa ett integrations konto
```
...
Det här kommandot skapar ett integrerings konto med namnet IntegrationAccount31 i den angivna resurs gruppen.
...
### -Plats
Anger en plats för integrations kontot.
...
### -SKU
Anger ett SKU-namn för integrations kontot.
