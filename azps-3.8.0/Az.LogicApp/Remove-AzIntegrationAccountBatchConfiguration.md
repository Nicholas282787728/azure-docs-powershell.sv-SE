...
## Sammanfattning
Tar bort en batch-konfiguration för integrerings konton.
...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzIntegrationAccountBatchConfiguration** tar bort en grupp konfiguration från ett integrations konto.

## BESKRIVS

### Exempel 1: ta bort en kommando konfiguration efter parametrar
```powershell
...
Tar bort gruppkonfigurationen med namnet "sampleBatchConfig" som finns i integrations kontot "sampleIntegrationAccount".
...
### -PassThru
Returnera om kommandot lyckades eller inte.
