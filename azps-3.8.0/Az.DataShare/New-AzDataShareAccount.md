...
## PROBLEMBESKRIVNING
**New-AzDataShareAccount** cmdlet skapar ett datashare-konto i den angivna Azure resurs gruppen.
...
Skapar ett konto med namnet "WikiADS" i resurs gruppen "annonser"
...
### -Plats
Den plats där du vill skapa data delnings kontot.
...
### -ResourceGroupName
Resurs grupp namnet för Azure Data Share-kontot skapas i.
...
### -Tagg
De taggar som ska kopplas till Azure Data Share-kontot.
