...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzBatchApplicationPackage** hämtar information om ett programpaket i ett Azure Batch-konto.

## BESKRIVS

### Exempel 1: Hämta information om ett programpaket i ett batch-konto
```
...
Det här kommandot får information om version 1,0 av paketet Litware.

## MALLPARAMETRAR

### -AccountName
Anger namnet på den Batch-konto från vilken denna cmdlet hämtar information.
