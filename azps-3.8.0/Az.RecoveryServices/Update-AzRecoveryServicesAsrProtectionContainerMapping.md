...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzRecoveryServicesAsrProtectionContainerMapping** uppdaterar den angivna mappningen för Azure Site Recovery-skydd.
...
Starta åtgärden för att inaktivera automatisk uppdatering för behållaren.
...
Starta operationen för att inaktivera aktivera automatisk uppdatering för behållaren.

## MALLPARAMETRAR

### -AutomationAccountId
Anger den Automation accountId som används för automatiska UDPATE.
...
### -AzureToAzure
Anger Azure-till-Azure-skydds behållare.
...
### -InputObject
Objekt för mappning av skydds behållare.
