...
## PROBLEMBESKRIVNING
Cmdleten **set-AzBackupProtectionPolicy** ändrar en befintlig Azure Backup-säkerhetsprincip.
...
I åttonde och nionde anges de resurs grupp parametrar som är associerade med principer som lagrar återställnings punkterna.
