...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzStreamAnalyticsDefaultFunctionDefinition** hämtar standard definitionen för en funktion i Azure Stream Analytics.
Du kan använda standard definitionen och New-AzStreamAnalyticsFunction cmdlet för att skapa en funktion.
