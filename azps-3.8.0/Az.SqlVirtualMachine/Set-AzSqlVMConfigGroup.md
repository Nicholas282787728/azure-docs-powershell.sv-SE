...
## PROBLEMBESKRIVNING
Den Set-AzSqlVMConfigGroup cmdleten anger den information som behövs för att ansluta till en virtuell SQL-dator grupp för en konfiguration för SQL-dator.
...
Uppdatera grupp informationen för en konfiguration av en virtuell SQL-dator.

## MALLPARAMETRAR

### -ClusterBootstrapAccountPassword
Lösen ord för klustrets start konto
...
Lösen ord för kluster operatörs kontot
...
Lösen ord för SQL-tjänstkontot
...
### -SqlVM
Den konfiguration för SQL-virtuell dator vars grupp medlemskap läggs till
...
### -SqlVMGroup
Gruppen som den virtuella SQL-datorn kommer att ingå i
