...
## Sammanfattning
Få problem klassificeringar för den angivna tjänsten.
...
### Exempel 1: få alla problem classificaitons för en tjänst med parametern service-ID.
```powershell
...
### Exempel 2: få alla problem classificaitons för en tjänst med överordnat tjänst objekt
```powershell
...
### Exempel 3: få information om ett enskilt problem classificaiton via ID efter lednings tjänst objekt
```powershell
...
### -ServiceId
Tjänst-ID som alla problem klassificeringar hämtas för.
...
### -ServiceObject
Service objekt där problem klassificeringar hämtas.
