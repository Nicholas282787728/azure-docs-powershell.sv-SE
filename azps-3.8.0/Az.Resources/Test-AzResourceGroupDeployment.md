...
## PROBLEMBESKRIVNING
**Test-AzResourceGroupDeployment** cmdlet bestämmer om en Azure Resource Group-distributionsmall och dess parameter värden är giltiga.

## BESKRIVS

### Exempel 1: testa distributionen med ett anpassat malldokument och en parameter fil
...
Det här kommandot testar en distribution i angiven resurs grupp med hjälp av en webb-hash med en i minnet skapad från den angivna mallfilen och en parameter fil.

### Exempel 2: testa distribution via mallfil och parameter objekt
...
Det här kommandot testar en distribution i den angivna resurs gruppen och resursen med den medföljande mallfilen och en parameter fil.
...
### -ResourceGroupName
Anger namnet på den resurs grupp som ska testas.
