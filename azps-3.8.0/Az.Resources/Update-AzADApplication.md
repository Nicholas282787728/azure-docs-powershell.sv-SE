...
## PROBLEMBESKRIVNING
Uppdaterar ett befintligt Azure Active Directory-program.
Använd New-AzADAppCredential cmdlet för att uppdatera autentiseringsuppgifterna för det här programmet.
...
Hämtar programmet med objekt-ID ' fb7b3405-ca44-4b5b-8584-12392f5d96d7 ' och rör till cmdleten Update-AzADApplication för att uppdatera programmets visnings namn till "MyNewDisplayName".
