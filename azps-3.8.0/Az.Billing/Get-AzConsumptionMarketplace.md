...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzConsumptionMarketplace** får plats för abonnemanget.

## BESKRIVS

### Exempel 1: få användning av Marketplace
```powershell
...
### Exempel 2: skaffa användning av Marketplace med datum intervall
```powershell
...
### Exempel 3: skaffa Marketplace-användning för BillingPeriodName
```powershell
...
### Exempel 4: Hämta användning av Marketplace med filtret instans namn
```powershell
...
### -BillingPeriodName
Namnet på en viss fakturerings period för att få den Marketplace som är associerad med.
...
### -EndDate
Slutdatumet (i UTC) för att filtrera.
...
### -InstanceId
Instans-ID för de Marketplace som ska filtreras.
...
### -InstanceName
Instans namnet på den marknads plats som ska filtreras.
...
### -ResourceGroup
Resurs gruppen för marknads platser som ska filtreras.
...
### -StartDate
Start datumet (i UTC) för de marknads platser som ska filtreras.
...
### Microsoft. Azure. commands. förbrukning. Models. PSMarketplace
