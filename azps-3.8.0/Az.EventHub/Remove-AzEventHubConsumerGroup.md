...
## PROBLEMBESKRIVNING
Remove-AzEventHubConsumerGroup-cmdleten tar bort och tar bort den angivna konsument gruppen från den angivna händelsehubben.
...
### Exempel 2,2 – InputObject – använder rör
```
...
### Exempel 3,2-ResourceId med sträng
```
