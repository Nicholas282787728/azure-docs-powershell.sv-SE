...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmDataFactoryV2ActivityRun** hämtar information om hur man kör i Azure Data Factory för den angivna pipelinen som inträffade under den angivna tids perioden. Du kan dessutom ange filter för aktivitets namn, länkat tjänst namn som kördes och status för kör.

## BESKRIVS

### Exempel 1: Hämta alla aktiviteter för en pipeline-körning
```
...
Det här kommandot får information om all aktivitet körs i pipeline-körningen med ID "f288712d-FB08-4cb8-96ef-82d3b9b30621" som inträffade mellan "2017-09-01" och "2017-09-30".
...
### -RunStartedAfter
Den tid och det klock slag då förloppet körs.
...
### -RunStartedBefore
Tiden då den tid då förloppet körs.
...
Parametrar: DataFactory (ByValue)
