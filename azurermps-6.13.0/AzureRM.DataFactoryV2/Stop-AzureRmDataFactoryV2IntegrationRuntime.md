...
## PROBLEMBESKRIVNING
Cmdleten **Stop-AzureRmDataFactoryV2IntegrationRuntime** stoppar den hanterade dedikerade integrerings miljön i tillståndet ' start ', som startas av Start-AzureRmDataFactoryV2IntegrationRuntime cmdlet. Resurserna släpps och delstatlig överföring till "stoppad".
...
Körnings miljön test-reserlved-IR är i starta-läge. När du har kört Stop-AzureRmDataFactoryV2IntegrationRuntime cmdleten släpps resurserna och läget överförs till "stoppad".
