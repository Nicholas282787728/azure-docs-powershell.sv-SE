...
Det här kommandot skapar en kontext med OAuth-autentisering.
...
### -UseConnectedAccount
Anger att denna cmdlet skapar en Azure-lagringsenhet med OAuth-autentisering.
En OAuth-autentisering används som standard i cmdleten om du inte har angett någon annan anthentication.
