...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureStorageShareStoredAccessPolicy** skapar en lagrad åtkomst princip på en Azure lagrings plats.

## BESKRIVS

### Exempel 1: skapa en lagrad åtkomst princip i en resurs
```
PS C:\>New-AzureStorageShareStoredAccessPolicy -ShareName "ContosoShare" -Policy "GeneralPolicy" -Permission "rwdl"
```

Det här kommandot skapar en lagrad åtkomst princip med fullständig behörighet i en resurs.
...
### -Tillstånd
Anger behörigheter i den lagrade åtkomst principen för att komma åt lagrings resursen eller filerna under den.
