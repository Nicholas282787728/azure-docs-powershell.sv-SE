...
Om du vill använda en lagrings kontext som skapats från en SAS-token utan Läs behörighet behöver du Add-Force parameter för att hoppa över kontroll av BLOB-uppifrån.
