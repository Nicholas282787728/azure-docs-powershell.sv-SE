...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmDataFactoryGateway** tar bort angiven Gateway från Azure Data Factory.

## BESKRIVS

### Exempel 1: ta bort en gateway
```
...
Det här kommandot tar bort den gateway som heter ContosoGateway från data fabriken med namnet WikiADF.

## MALLPARAMETRAR

### -DataFactory
Anger ett **PSDataFactory** -objekt.
Denna cmdlet tar bort en gateway från data fabriken som den här parametern anger.
...
### -Force
Anger att denna cmdlet tar bort en gateway utan att du behöver bekräfta.
...
### -Namn
Anger namnet på den gateway som ska tas bort.
...
Denna cmdlet tar bort en gateway som tillhör den grupp som den här parametern anger.
