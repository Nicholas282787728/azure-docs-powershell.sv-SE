...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmDataFactoryLinkedService** tar bort en länkad tjänst från Azure Data Factory.
...
### -Force
Anger att denna cmdlet tar bort en länkad tjänst utan att be dig bekräfta.
