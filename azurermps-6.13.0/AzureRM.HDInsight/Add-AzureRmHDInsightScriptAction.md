...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzureRmHDInsightScriptAction** lägger till skript åtgärder i HDInsight-konfigurationsobjektet som skapas av New-AzureRmHDInsightClusterConfig cmdlet.
