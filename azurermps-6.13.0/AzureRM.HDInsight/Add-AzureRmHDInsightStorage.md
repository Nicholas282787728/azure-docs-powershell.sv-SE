...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzureRmHDInsightStorage** lägger till en Azure Storage-loggpost i Azure HDInsight-konfigurationsobjektet som skapas av New-AzureRmHDInsightClusterConfig cmdlet.

## BESKRIVS

### Exempel 1: lägga till en Azure Storage-plats i klustrets konfigurations objekt
```
...
Det här kommandot lägger till en post för en BLOB-lagringsenhet i HDInsight-konfigurationen som heter din-Hadoop-001.
...
### -StorageAccountKey
Anger lagrings konto för lagrings konto som ska läggas till i det nya klustret.
...
### -StorageAccountName
Anger namnet på lagrings kontot för det lagrings konto som ska läggas till i klustret.
