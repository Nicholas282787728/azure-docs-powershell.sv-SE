...
## PROBLEMBESKRIVNING
New-AzureRmContainerRegistry-cmdleten skapar en container-registrering.

## BESKRIVS

### Exempel 1: skapa ett behållar register med ett nytt lagrings konto.
```powershell
...
Det här kommandot skapar ett behållar register med ett nytt lagrings konto i resurs gruppen \` MyResourceGroup \` .

### Exempel 2: skapa en behållare med administratörs användare aktive rad.
```powershell
...
Det här kommandot skapar ett behållar register med administratörs användare aktive rad.

### Exempel 3: skapa ett behållar register med ett befintligt lagrings konto.
```powershell
...
Det här kommandot skapar ett behållar register med ett befintligt lagrings konto \` mystorageaccount \` i samma prenumeration.
...
### -EnableAdminUser
Aktivera administratörs användare för behållar registret.
...
### -SKU
SKU för behållar registret.
Tillåtna värden: grundläggande.
...
### -StorageAccountName
Namnet på ett befintligt lagrings konto.
...
### -Tagg
Register märken för behållare. nyckel värde par i form av en hash-tabell.
Till exempel: @ {key0 = "value0"; KEY1 = $null; key2 = "värde2"}
