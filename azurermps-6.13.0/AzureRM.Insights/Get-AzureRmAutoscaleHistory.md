...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmAutoscaleHistory** hämtar historiken för händelser relaterade till en autoskalningsinställning.

## BESKRIVS

### Exempel 1: Hämta alla händelser som är kopplade till ett abonnemang
```
PS C:\>Get-AzureRmAutoscaleHistory -StartTime 2015-02-09T18:35:00 -EndTime 2015-02-09T18:40:00 -DetailedOutput
```

Det här kommandot får alla Autoskala-relaterade händelser som är kopplade till det aktuella abonnemanget.
...
Det här kommandot får alla Autoskala-relaterade händelser som är kopplade till en viss resurs som identifieras av resursens ID (egentligen, ResourceUri).
...
### -DetailedOutput
Anger att den här åtgärden innehöll detaljerade utdata.
Om du inte anger den här parametern sammanfattas utdata.
...
### -ResourceId
Anger det resurs-ID som den autoskalningsinställning är kopplad till.
...
Denna parameter är valfri.
Felet är en tom sträng (det vill säga inga filter)
