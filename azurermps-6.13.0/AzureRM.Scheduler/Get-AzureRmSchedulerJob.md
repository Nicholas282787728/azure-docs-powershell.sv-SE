...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmSchedulerJob** får Azure Scheduler-jobb.
...
### -JobCollectionName
Anger namnet på en jobb samling som innehåller jobb som ska visas.
...
### -JobName
Anger namnet på det jobb som ska visas.
...
### -JobState
Anger ett jobb tillstånd för att få jobb.
...
### -ResourceGroupName
Anger resurs gruppen för de jobb som ska visas.
