...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmMediaService** skapar en medie tjänst.
Om medie tjänsten redan finns uppdaterar denna cmdlet dess egenskaper.

## BESKRIVS

### Example1: skapa en medie tjänst med endast det primära lagrings kontot
```
PS C:\># Variables
## Global
...
Det här exemplet visar hur du skapar en medie tjänst med endast det primära lagrings kontot.
Det här skriptet använder flera andra cmdletar.

### Exempel 2: skapa en medie tjänst med flera lagrings enheter
```
PS C:\># Variables
...
Det här exemplet visar hur du skapar en medie tjänst med flera lagrings konton.
Det här skriptet använder flera andra cmdletar.

## MALLPARAMETRAR

### -AccountName
Anger namnet på den medie tjänst som denna cmdlet skapar.
...
### -Plats
Anger den region som den här cmdleten skapar medie tjänsten i.
...
### -ResourceGroupName
Anger namnet på resurs gruppen som medie tjänsten är tilldelad till.
...
### -StorageAccountId
Anger det lagrings konto som är kopplat till medie tjänst kontot.
...
### -StorageAccounts
Anger en matris med lagrings konton som ska kopplas till medie tjänsten.
...
### -Tagg
De taggar som är kopplade till medie tjänst kontot.
