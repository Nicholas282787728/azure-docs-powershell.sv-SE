...
## PROBLEMBESKRIVNING
Uppdaterar ett befintligt objekt i Azure Active Directory-tjänsten. Använd New-AzureRmADSpCredential cmdlet för att uppdatera autentiseringsuppgifterna som är associerade med den här tjänstens huvud säkerhets objekt. Använd Update-AzureRmADApplication cmdlet för att uppdatera egenskaperna för det underliggande programmet.
...
Hämtar tjänstens huvud namn med objekt-ID ' 784136ca-3ae2-4fdd-a388-89d793e7c780 ' och pipes till Update-AzureRmADServicePrincipal cmdlet för att uppdatera visnings namnet för tjänstens huvud konto till "MyNewDisplayName".
