...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmSqlServerFirewallRule** ändrar en brand Väggs regel i en Azure SQL Database-Server.
...
Det här kommandot ändrar en brand Väggs regel som heter Rule01 på den server som heter Server01.
Kommandot ändrar Start-och slut-IP-adresser.
