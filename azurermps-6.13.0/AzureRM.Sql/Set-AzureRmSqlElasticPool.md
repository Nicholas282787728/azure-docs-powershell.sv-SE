...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmSqlElasticPool** anger egenskaper för en elastisk pool i Azure SQL-databasen. Denna cmdlet kan ändra eDTUs per pool ( *DTU* ), Max storlek per pool ( *StorageMB* ), högsta EDTUs per databas ( *DatabaseDtuMax* ) och minimum eDTUs per databas ( *DatqabaseDtuMin* ).
