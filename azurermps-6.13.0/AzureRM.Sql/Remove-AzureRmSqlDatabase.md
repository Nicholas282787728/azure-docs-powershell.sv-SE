...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmSqlDatabase** tar bort en Azure SQL-databas.
Denna cmdlet stöds också av SQL Server utsträckt databas tjänst på Azure.

## BESKRIVS

### Exempel 1: ta bort en databas från en Azure SQL-Server
```
PS C:\>Remove-AzureRmSqlDatabase -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

Det här kommandot tar bort databasen som heter Database01 från Server Server01.
...
### -ResourceGroupName
Anger namnet på den Azure Resource-grupp som databasen har tilldelats till.
