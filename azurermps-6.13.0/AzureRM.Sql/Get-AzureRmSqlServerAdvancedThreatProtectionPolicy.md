...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmSqlServerAdvancedThreatProtectionPolicy** för att skydda en server.

## BESKRIVS

### Exempel 1 – får Avancerat skydd mot Server
```powershell
...
### Exempel 2 – får Avancerat skydd mot Server resurs
```powershell
...
### -InputObject
Serverobjektet som ska användas med åtgärden för avancerad skydds policy
