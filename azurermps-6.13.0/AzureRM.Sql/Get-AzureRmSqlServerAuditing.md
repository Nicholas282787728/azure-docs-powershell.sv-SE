...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmSqlServerAuditing** hämtar BLOB-gransknings principen för en Azure SQL Server.
Ange parametrarna *ResourceGroupName* och *servername* för att identifiera databasen.
Denna cmdlet returnerar en princip som används av de Azure SQL-databaser som har definierats i den angivna Azure SQL-servern.

## BESKRIVS

### Exempel 1: Hämta gransknings inställningar för en Azure SQL Server
```
