...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmFrontDoor** tar bort en WAF-princip under den aktuella prenumerationen
...
Ta bort WAF policy $name i $resourceGroup.
...
Ta bort alla WAF-principer i $resourceGroup.
