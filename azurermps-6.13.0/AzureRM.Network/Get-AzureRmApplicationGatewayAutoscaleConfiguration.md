...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmApplicationGatewayAutoscaleConfiguration** hämtar autoskalans konfiguration för programgatewayen.
...
Det andra kommandot extraherar autoskalans konfiguration från applicationg Gateway.
