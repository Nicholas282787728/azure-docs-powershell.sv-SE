...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmPublicIpPrefix** får ett eller flera offentliga IP-prefix i en resurs grupp.
...
Det här kommandot får en offentlig IP-prefixlängd med $prefixName i resurs gruppen $rgName
