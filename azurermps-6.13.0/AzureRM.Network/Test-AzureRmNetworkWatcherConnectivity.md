...
## PROBLEMBESKRIVNING
Den Test-AzureRmNetworkWatcherConnectivity cmdleten returnerar anslutnings information för en viss angiven källa och ett mål. Om det inte går att upprätta anslutningen mellan källan och målet returnerar cmdleten information om problemet.
...
Protocal-konfiguration där kontrol lera anslutningen ska utföras.
