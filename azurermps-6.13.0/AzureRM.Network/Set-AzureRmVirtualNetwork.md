...
I det här exemplet skapas ett virtuellt nätverk med namnet TestResourceGroup med två undernät: frontendSubnet och backendSubnet. Sedan tas den bort från backendSubnet i minnet för det virtuella nätverket. Set-AzureRmVirtualNetwork cmdlet används sedan för att skriva det ändrade virtuella nätverks tillståndet på tjänstens sida. När Set-AzureRmVirtualNetwork cmdlet körs tas backendSubnet bort.
