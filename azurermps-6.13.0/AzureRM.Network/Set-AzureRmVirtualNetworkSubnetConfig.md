...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmVirtualNetworkSubnetConfig** konfigurerar mål tillståndet för en under nätverks konfiguration i ett Azure Virtual Network.
...
I det här exemplet skapas ett virtuellt nätverk med ett undernät. Sedan ringer Set-AzureRmVirtualNetworkSubnetConfig för att ändra AddressPrefix för under nätet. Detta påverkar endast det virtuella nätverkets minnes representation. Set-AzureRmVirtualNetwork anropas sedan för att ändra det virtuella nätverket i Azure.
...
I det här exemplet skapas en resurs grupp med ett virtuellt nätverk som bara innehåller ett undernät. Därefter skapas en nätverks säkerhets grupp med en Tillåt-regel för RDP-trafik. Set-AzureRmVirtualNetworkSubnetConfig-cmdleten används för att ändra uppslags filen för nät klient delen så att den pekar på den nya nätverks säkerhets gruppen. Set-AzureRmVirtualNetwork cmdlet anropas sedan för att skriva tillbaka till tjänsten.
