...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmVirtualNetwork** tar bort ett Azure Virtual Network.

## BESKRIVS

### 1: skapa och ta bort ett virtuellt nätverk
```
...
I det här exemplet skapas ett virtuellt nätverk i en resurs grupp och sedan tas det omedelbart bort. Om du inte vill att meddelandet ska visas när det virtuella nätverket tas bort använder du flaggan-Force.
...
### -Namn
Anger namnet på det virtuella nätverk som denna cmdlet tar bort.
...
### -ResourceGroupName
Anger namnet på den resurs grupp som innehåller det virtuella nätverk som den här cmdleten tar bort.
