...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmFirewall** uppdaterar en Azure Firewall.
...
### PSAzureFirewall
Parametern ' AzureFirewall ' godkänner värdet av typen ' PSAzureFirewall ' från pipeline
