...
När gatewayen har skapats är den ansluten till VpnSite med kommandot New-AzureRmVpnConnection.

Konfigurationen hämtas då med den här cmdleten.

Om cmdleten lyckas skrivs nedladdnings konfigurationen till den blob som anges av SignedSasUrl.
...
### -StorageSasUrl
SAS URL för lagrings platsen där konfigurationen ska skapas.
...
### -VpnSite
Listan med VpnSite resurs-ID: n som konfigurerar konfiguration för.
...
### Microsoft. Azure. commands. Networks. Models. PSVirtualWanVpnSitesConfiguration
