...
## PROBLEMBESKRIVNING
Med * * Remove-AzureRmPublicIpPrefix cmdlet tas ett prefix för Azure Public IP bort så länge det inte finns några offentliga IP-adresser tilldelade till sig.
