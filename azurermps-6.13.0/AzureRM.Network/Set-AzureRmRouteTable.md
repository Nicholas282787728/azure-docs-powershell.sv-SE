...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmRouteTable** anger mål tillståndet för en Azure route-tabell.

## BESKRIVS

### Exempel 1: lägga till en väg och ange mål tillstånd för routningstabellen
```
...
Det här kommandot hämtar routningstabellen med namnet RouteTable01 med hjälp av Get-AzureRmRouteTable cmdlet.
Kommandot skickar den tabellen till Add-AzureRmRouteConfig cmdlet med hjälp av pipeline-operatorn.
**Add-AzureRmRouteConfig** lägger till vägen med namnet Route07 och skickar sedan resultatet till den aktuella cmdleten, vilket uppdaterar tabellen så att den återspeglar dina ändringar.
...
### -RouteTable
Anger ett väg tabell objekt som representerar det mål tillstånd där denna cmdlet ställer in väg tabellen.
