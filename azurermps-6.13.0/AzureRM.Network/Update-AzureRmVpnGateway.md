...
## Sammanfattning
Update-AzureRmVpnGateway uppdaterar en skalbar VPN-gateway till rätt mål tillstånd.
...
## PROBLEMBESKRIVNING
Update-AzureRmVpnGateway uppdaterar en skalbar VPN-gateway till rätt mål tillstånd. En AzureRmVpnGateway är en program varu anslutning för webbplats anslutningar i VirtualHub. Denna gateway ändrar storlek på och skalar baserat på den enhet som anges av användaren. Det går att konfigurera en anslutning från en filial/webbplats som kallas VPNSite till den utbyggbara gatewayen. Varje anslutning består av 2 Active-Active tunnlar
...
När du har skapat gatewayen använder den Set-AzureRmVpnGateway för att uppgradera gatewayen till 3 skal enheter.
