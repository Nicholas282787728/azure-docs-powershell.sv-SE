...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmContainerService** skapar en behållar tjänst.
Ange ett behållar tjänst objekt som du kan skapa med hjälp av New-AzureRmContainerServiceConfig cmdlet.
...
Mer information finns i New-AzureRmResourceGroup cmdlet.
Det andra kommandot skapar en container och lagrar sedan den i $Container variabel.
Mer information finns i New-AzureRmContainerServiceConfig cmdlet.
...
För att hämta ett **ContainerService** -objekt, Använd cmdleten New-AzureRmContainerServiceConfig.
...
Parametrar: ContainerService (ByValue)
