...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmVmssStorageProfile** anger lagrings profil egenskaperna för den virtuella datorns skal uppsättning (VMSS).
...
Anger VMSS-objektet.
Använd New-AzureRmVmssConfig-objektet för att få ett objekt.
