...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzureRmVMDataDisk** lägger till en datadisk till en virtuell dator eller en VMSS VM.
...
### Exempel 5: lägga till en hanterad datadisk till en VMSS VM.
```
...
Du kan använda cmdleten **Get-AzureRmVmssVM** för att erhålla en virtuell dators skala ange virtuellt dator objekt.
