...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmCdnCustomDomain** tar bort den anpassade domänen från en slut punkt för Azure Content Delivery Network (CDN).
...
### -CdnCustomDomain
Anger den anpassade domän som ska tas bort med denna cmdlet.
...
### -CustomDomainName
Anger resurs namnet på den anpassade domän där denna cmdlet ska tas bort.
...
### -EndpointName
Anger namnet på den slut punkt från vilken denna cmdlet tar bort en egen domän.
...
### -Profilnamn
Anger namnet på den profil som cmdleten tar bort en egen domän från.
...
### -ResourceGroupName
Anger namnet på den resurs grupp från vilken denna cmdlet tar bort en egen domän.
...
Parametrar: CdnCustomDomain (ByValue)
