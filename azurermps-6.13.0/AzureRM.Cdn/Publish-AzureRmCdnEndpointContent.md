...
## PROBLEMBESKRIVNING
Cmdleten **Publishing-AzureRmCdnEndpointContent** läser in innehåll från en ursprunglig Server för CDN-slutpunkten (Azure Content Delivery Network).
...
### -LoadContent
Anger en matris med relativa sökvägar för innehållet på ursprungs servern som denna cmdlet publicerar.
...
### -Profilnamn
Anger namnet på den profil som ursprungs servern tillhör.
...
### -ResourceGroupName
Anger namnet på den resurs grupp som ursprungs servern tillhör.
...
Parametrar: CdnEndpoint (ByValue)
