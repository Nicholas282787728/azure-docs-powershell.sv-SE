...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureKeyVaultCertificateAdministratorDetails** skapar ett objekt med information om hur du gör i minnet.

## BESKRIVS

### Exempel 1: skapa ett objekt med information om certifikat administratör
```
...
Det här kommandot skapar ett objekt för information om certifikat i minnet och lagrar det sedan i $AdminDetails variabel.
...
### -EmailAddress
Anger e-postadressen för certifikat administratören.
...
### -FirstName
Anger certifikat administratörens förnamn.
...
### -LastName
Anger certifikat administratörens efter namn.
...
### -Telefonnummer
Anger telefonnumret till certifikat administratören.
...
### Microsoft. Azure. commands. valv. Models. PSKeyVaultCertificateAdministratorDetails
