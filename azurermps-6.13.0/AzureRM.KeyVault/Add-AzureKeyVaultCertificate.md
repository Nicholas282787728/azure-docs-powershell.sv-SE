...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzureKeyVaultCertificate** startar processen för registrering av ett certifikat i ett nyckeltal i Azure Key Vault.

## BESKRIVS

### Exempel 1: lägga till ett certifikat
```powershell
...
Det första kommandot använder cmdleten New-AzureKeyVaultCertificatePolicy för att skapa en certifikat princip och lagrar den sedan i $Policy variabel.
Det andra kommandot använder **Add-AzureKeyVaultCertificate** för att starta processen för att skapa ett certifikat.
I det tredje kommandot används cmdleten Get-AzureKeyVaultCertificateOperation för att undersöka om den är slutförd.
Det sista kommandot använder cmdleten Get-AzureKeyVaultCertificate för att hämta certifikatet.

## MALLPARAMETRAR

### -CertificatePolicy
Anger ett **KeyVaultCertificatePolicy** -objekt.
...
### -Namn
Anger namnet på det certifikat som ska läggas till.
...
Parametrar: CertificatePolicy (ByValue)
