...
En JSON-fil är en textfil som använder syntax som liknar den här: {  
    ...
    "Rättigheter": \[  
        ...
        Bifoga  
    \]  
} När det används tillsammans med cmdleten **set-AzureRmNotificationHubsNamespaceAuthorizationRules** ändrar det föregående JSON-exemplet en auktoriseringsregel med namnet ContosoAuthorizationRule för att ge användarna behörighet att avlyssna och skicka rättigheter till namn området.
