...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmBatchApplication** ändrar inställningar för det angivna Azure Batch-programmet.
...
Det här kommandot ändrar om Llitware-programmet i ContosoBatch-kontot kan uppdatera.
