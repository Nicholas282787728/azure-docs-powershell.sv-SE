...
---
# Modulen AzureRM.BatCH
## Problembeskrivning
Med Azure-cmdleten i Azure-modulen kan du hantera Microsoft Azure-grupptjänster i Azure PowerShell.

## Cmdlets för AzureRM.BatCH
...
Inaktiverar schemaläggning av batchjobb.
...
Hämtar information om ett programpaket i ett batch-konto.
...
Lägger till ett program i angivet batch-konto.
...
Tar bort angiven gruppbearbetningssekvens.
