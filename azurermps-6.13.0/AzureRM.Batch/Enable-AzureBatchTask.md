...
## PROBLEMBESKRIVNING
Cmdleten **Enable-AzureBatchTask** reaktiverar en uppgift.
...
Med det här kommandot får du den batch-uppgift som har det ID-Task3 i jobbet som har ID-Job8 med hjälp av Get-AzureBatchTask cmdlet.
