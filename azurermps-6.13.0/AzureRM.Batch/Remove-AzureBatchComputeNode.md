...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureBatchComputeNode** tar bort Azure Batch-datornoder från en pool.
...
Det här kommandot får Compute-noden som har angivet ID från poolen med ID-Pool07 med hjälp av Get-AzureBatchComputeNode cmdlet.
