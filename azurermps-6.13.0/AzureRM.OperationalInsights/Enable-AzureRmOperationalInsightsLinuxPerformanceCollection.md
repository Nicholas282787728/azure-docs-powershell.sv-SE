...
## PROBLEMBESKRIVNING
Cmdleten **Enable-AzureRmOperationalInsightsLinuxPerformanceCollection** startar en samling prestanda räknare från anslutna Linux-datorer på en arbets yta.
