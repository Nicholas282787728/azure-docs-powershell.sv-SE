...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmRelayNamespace** tar bort namn området från den angivna resurs gruppen.
...
Tar bort relä namnområdet `TestNameSpace-Relay1` från den angivna resurs gruppen `Default-ServiceBus-WestUS` .
