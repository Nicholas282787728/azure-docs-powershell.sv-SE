...
### System. String
Parametrar: CertificateFile (ByValue), CertificateOutputFolder (ByValue), CertificateSubjectName (ByValue), KeyVaultName (ByValue), KeyVaultResouceGroupName (ByValue), plats (ByValue), namn (ByValue), ParameterFile (ByValue), SecondaryCertificateFile (ByValue) SecretIdentifier (ByValue), TemplateFile (ByValue), VmUserName (ByValue)
