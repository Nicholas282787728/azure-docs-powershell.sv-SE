...
## PROBLEMBESKRIVNING
Använd **Remove-AzureRmServiceFabricClientCertificate** om du vill ta bort ett eller flera klient certifikat eller certifikat subjekt namn som används för klientautentisering till klustret.
...
### System. String
Parametrar: CommonName (ByValue), IssuerThumbprint (ByValue), tumavtryck (ByValue)

### System. string []
Parametrar: AdminClientThumbprint (ByValue), ReadonlyClientThumbprint (ByValue)

### Microsoft. Azure. commands. ServiceFabric. Models. PSClientCertificateCommonName []
Parametrar: ClientCertificateCommonName (ByValue)
