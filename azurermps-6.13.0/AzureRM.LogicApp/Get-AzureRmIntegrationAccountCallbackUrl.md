...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmIntegrationAccountCallbackUrl** hämtar en URL för återuppringning från en resurs grupp.
Denna cmdlet returnerar ett **CallbackUrl** -objekt som representerar URL: en för integrerings konto.
Ange namnet på integrations kontot och resurs grupp namnet.
...
### Exempel 1: Hämta en URL för ett integrerings konto
```
...
Det här kommandot får en URL för återuppringning med integrerings konto.
...
### -NotAfter
Anger utgångs datumet för URL: en för återuppringning.
