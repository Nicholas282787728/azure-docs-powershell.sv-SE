...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmLogicAppTrigger** får utlösare från ett logik program.
Denna cmdlet returnerar ett **WorkflowTrigger** -objekt.
Ange arbets flödet, resurs gruppen och utlösaren.
...
### Exempel 1: få en utlösare av ett logik program
```
...
Det här kommandot får utlösaren med namnet Trigger01 från programmet Logic som heter LogicApp05.

### Exempel 2: Hämta alla utlösare för ett logik program
```
...
Det här kommandot får utlösarna till logik programmet som heter LogicApp07.
...
### -Namn
Anger namnet på den logik app som den här cmdleten får en utlösare från.
...
### -ResourceGroupName
Anger namnet på en resurs grupp där denna cmdlet ska ha en utlösare.
...
### -TriggerName
Anger namnet på den utlösare som denna cmdlet får.
