...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmIntegrationAccountSchema** ändrar ett integrations konto schema.
...
### Exempel 1: ändra ett integrations konto schema
```
...
Det här kommandot ändrar det integrerings konto schema som heter IntegrationAccountSchema43.
...
### -SchemaName
Anger namnet på integrations konto schema.
