...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmIntegrationAccountPartner** skapar en integrerings konto partner.
Denna cmdlet returnerar ett objekt som representerar integrerings konto partnern.
Ange integrerings konto namn, resurs grupps namn, partner namn och partner identiteter.
...
### Exempel 1: skapa en integrations konto partner
```
...
Det här kommandot skapar integrerings konto partnern med namnet IntegrationAccountPartner22 i den angivna resurs gruppen.

## MALLPARAMETRAR

### -BusinessIdentities
Anger företags identitet för integrerings konto partnern.
Ange en hash-tabell.
...
### -PartnerName
Anger ett namn på integrations konto partnern.
...
### -PartnerType
Anger typen av integrations konto.
