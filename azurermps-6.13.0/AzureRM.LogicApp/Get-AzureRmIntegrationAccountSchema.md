...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmIntegrationAccountSchema** hämtar ett integrerings konto.
...
### Exempel 1: skaffa ett integrations konto schema
```
...
Det här kommandot får integrerings kontots schema med namnet IntegrationAccountSchema43.

### Exempel 2: skaffa ett integrations konto schema för en resurs grupp
```
...
Det här kommandot får integrerings konto scheman för resurs gruppen "ResourceGroup11".
