...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmAutomationConnection** tar bort en anslutning från Azure Automation.
...
Det här kommandot tar bort ett certifikat som heter ContosoConnection i Automation-kontot med namnet Contoso17.

## MALLPARAMETRAR

### -AutomationAccountName
Anger namnet på det Automation-konto som denna cmdlet tar bort en anslutning för.
...
### -Namn
Anger namnet på den anslutning som denna cmdlet tar bort.
...
### -ResourceGroupName
Anger namnet på den resurs grupp för vilken denna cmdlet tar bort en anslutning.
