...
## PROBLEMBESKRIVNING
**Start-AzureRmAutomationRunbook** cmdlet startar ett Azure Automation Runbook-jobb.
...
### Exempel 2: starta ett Runbook-jobb och vänta med resultat
```
...
-Denna cmdlet returnerar ett **Job** -objekt om du inte anger parametern _wait_ .
-Om du inte anger _vänta_ returneras ett **jobb** objekt omedelbart av Azure PowerShell.
-Om du anger _vänta_ blir jobbet slutfört och resultatet returneras.
-Resultatet är inte ett **Job** -objekt.
