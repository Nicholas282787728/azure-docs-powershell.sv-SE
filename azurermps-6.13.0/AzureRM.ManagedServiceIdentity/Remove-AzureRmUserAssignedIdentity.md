...
## Sammanfattning
Tar bort en tilldelad identitet.

[!INCLUDE [migrate-to-az-banner](../../includes/migrate-to-az-banner.md)]

## FRÅGESYNTAXEN

### ResourceGroupAndNameParameterSet (standard)
```
...
## PROBLEMBESKRIVNING
**Remove-AzureRmUserAssignedIdentity** tar bort den angivna användarens identitet.
...
Med den här cmdleten tar du bort identiteten **id1** under resurs grupp **PSRG**.
Sant
