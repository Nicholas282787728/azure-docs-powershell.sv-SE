...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzureRmApiManagementApiRelease** ändrar en version av Azure API Management API.

## BESKRIVS

### Exempel 1: uppdaterar en API-version för en API-revision
```powershell
...
Det här kommandot uppdaterar `echo-api-release` API-versionen av API: et `echo-api` med ny anteckning.
...
### -InputObject
Instans av Skriv Microsoft. Azure. commands. ApiManagement. ServiceManagement. Models. PsApiManagementApiRelease.
...
### -PassThru
Om det anges kommer instansen av Microsoft. Azure. kommandon. ApiManagement. ServiceManagement. Models. PsApiManagementApiRelease typ som representerar set API-versionen.
...
### -ReleaseId
ID för ReleaseId för API-revision.
Denna parameter är obligatorisk.
