...
## PROBLEMBESKRIVNING
Kommandot hjälp för att skapa en instans av PsApiManagementRegion.
Kommandot ska användas med kommandot New-AzureRmApiManagement.
...
Skapar en ApiManagement-tjänst för extern VpnType i västra USA-regionen, med ytterligare en region i Central USA.

## MALLPARAMETRAR

### -Kapacitet
SKU-kapacitet för Azure API Management Service ytterligare region.
Standardvärdet är 1.
...
### -VirtualNetwork
Konfigurations region för Azure API Management med virtuellt nätverk.
