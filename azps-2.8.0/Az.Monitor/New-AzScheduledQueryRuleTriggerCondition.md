...
## PROBLEMBESKRIVNING
Skapar ett objekt av typen trigger villkor.
Det här objektet ska överföras till kommandot som skapar ett varnings objekt
...
### -MetricTrigger
Utlös ande villkor för regeln för metriska frågor
...
### -Tröskel
Tröskelvärde över vilken varning utlöses
...
### -ThresholdOperator
Tröskelvärdes operatör: GreaterThan, mindreän eller lika
