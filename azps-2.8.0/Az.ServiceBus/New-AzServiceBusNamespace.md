...
## PROBLEMBESKRIVNING
Cmdleten **New-AzServiceBusNamespace** skapar ett nytt Service Bus-namnområde. När namn rymds resursens manifest har skapats är det oföränderligt. Denna åtgärd är idempotent.
...
Skapar ett nytt Service Bus-namnområde i den angivna resurs gruppen.
...
### -Plats
Plats för Service Bus-namnrymden.
...
### -SkuCapacity
Data flödes enheterna för Service Bus Premium namespace, tillåtna värden 1 eller 4
...
### -SkuName
Service Bus namn områdets SKU-namn.
