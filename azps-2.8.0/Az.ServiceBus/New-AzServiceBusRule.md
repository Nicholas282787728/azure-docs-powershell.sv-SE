...
## PROBLEMBESKRIVNING
Cmdleten **New-AzServiceBusRule** skapar en ny regel för angiven prenumeration.
...
New-AzServiceBusRule cmdlet skapar en ny regel för det angivna abonnemanget.
...
New-AzServiceBusRule cmdlet skapar en ny regel för den angivna prenumerationen med ActionFilter.

## MALLPARAMETRAR

### -ActionSqlExpression
Instruktionen SqlFilter
