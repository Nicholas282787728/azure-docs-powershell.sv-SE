...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzServiceBusKey** returnerar de primära och sekundära anslutnings strängarna för ett namn område, en kö eller ett ämne (GeoDR-konfigurationer).
...
Primära och sekundära anslutnings strängar till den angivna kön.
...
Primära och sekundära anslutnings strängar till det angivna avsnittet.
...
Primära och sekundära anslutnings strängar till det angivna namn området och aliaset.
