...
## PROBLEMBESKRIVNING
Remove-AzEventHubAuthorizationRule-cmdleten tar bort och tar bort den angivna auktoriseringsregeln från den angivna händelsehubben.
...
Tar bort \` MyAuthRuleName från händelsehubben \` \` MyEventHubName \` .
