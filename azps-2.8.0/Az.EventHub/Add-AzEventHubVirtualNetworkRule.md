...
Lägger till givet undernät och IgnoreMissingVnetServiceEndpoint (VirtualNetworkRule) i NetworkRuleSet för det angivna namn området
...
Lägger till $virtualruleset 1 i NetworkRuleSet för det angivna namn området
...
VirtualNetworkRule-konfigurations objekt
