...
Denna cmdlet skapar en åtgärds regel för Supression.
...
Denna cmdlet skapar en åtgärds regel för gruppen åtgärd.
...
Denna cmdlet skapar en åtgärds regel för diagnostikinställningar.
...
Förväntat format-{ \< åtgärd \> : \< kommaavgränsad lista med värden \> } till exempel.
