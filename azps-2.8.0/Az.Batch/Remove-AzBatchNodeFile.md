...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzBatchNodeFile** tar bort en Azure-batchjournal för en aktivitet eller en datornod.

## BESKRIVS

### Exempel 1: ta bort en fil som är kopplad till en aktivitet
```
...
Det här kommandot får Node-filen genom att använda **Get-AzBatchNodeFile**.
Filen är kopplad till uppgiften som har ID-Task26 under jobbet jobb-000001.
...
För att få en **PSNodeFile** , Använd cmdleten Get-AzBatchNodeFile.
