...
## PROBLEMBESKRIVNING
Cmdleten **New-AzBatchComputeNodeUser** skapar ett användar konto på en Azure Batch-datornod.
...
Det här kommandot får Compute-noden med namnet ComputeNode01 med hjälp av cmdleten **Get-AzBatchComputeNode** .
Noden finns i poolen med ID-MyPool01.
Kommandot skickar den beräknade noden till den aktuella cmdleten med hjälp av pipeline-operatorn.
Kommandot skapar ett användar konto som har användar namnet TestUser och lösen ordet.
