...
## PROBLEMBESKRIVNING
Cmdleten **unpublishing-AzCdnEndpointContent** rensar innehållet från en CDN-slutpunkt (Azure Content Delivery Network).
...
### -CdnEndpoint
Anger slut punkten som rensar den här cmdleten.
...
### -EndpointName
Anger namnet på slut punkten som den här cmdleten rensar.
...
### -PurgeContent
Anger en matris med relativa sökvägar för innehållet på ursprungs servern som den här cmdleten rensar.
