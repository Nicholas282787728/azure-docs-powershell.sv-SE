...
## PROBLEMBESKRIVNING
Cmdleten **import-AzApiManagementApi** importerar ett API för Azure API-hantering från en fil eller en URL-adress (Web Application Description Language), WSDL-eller Swagger-format.
...
### Exempel 4: importera ett API från en öppen API-länk
```powershell
...
Det här kommandot importerar ett API från den angivna länken för Open 3,0-specifikationen.

### Exempel 5: importera ett API från en öppen API-länk till en ApiVersion-uppsättning
...
Det här kommandot importerar ett API från det angivna Open 3,0 Specification-dokumentet och skapar ett nytt ApiVersion.
...
### -Protokoll
Webb-API-protokoll (http, https). Protokoll som finns tillgängliga för API. Denna parameter är valfri. Om den anges åsidosätts de protokoll som anges i förfrågnings dokumentet.
...
### -ServiceUrl
En URL för webb tjänsten som visar API: t. Denna URL kommer endast att användas av Azure API Management och blir inte offentlig. Denna parameter är valfri. Om den anges åsidosätter den ServiceUrl som anges i förfrågnings dokumentet.
...
### System. Nullable ' 1 [[Microsoft. Azure. commands. ApiManagement. ServiceManagement. Models. PsApiManagementApiType, Microsoft. Azure. PowerShell. cmdletar. ApiManagement. ServiceManagement, version = 1.0.0.0, Culture = neutralt, PublicKeyToken = null]]
