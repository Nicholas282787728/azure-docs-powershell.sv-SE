...
## PROBLEMBESKRIVNING
Cmdlet **New-AzApiManagementPipelineDiagnosticSetting** skapar diagnostikinställningar för inkommande/utgående HTTP-meddelanden till gatewayen.
...
Skapa en pipeline-diagnostik som ska användas i antingen klient delen eller Server delen i den diagnostiska enheten.
...
### -Begäran
Diagnostisk inställning för begäran.
...
### -Svar
Diagnostisk inställning för svar.
Denna parameter är valfri.
