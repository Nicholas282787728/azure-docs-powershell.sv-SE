...
### Exempel 2: Hämta Server delen som anges av ID 123
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### -ResourceId
Server delen för arm-resursen. Om det här alternativet väljs kommer att försöka hitta server delen av identifieraren. Denna parameter är obligatorisk.
