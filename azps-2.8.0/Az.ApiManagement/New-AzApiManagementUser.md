...
## PROBLEMBESKRIVNING
**New-AzApiManagementUser-** cmdleten registrerar en ny användare.

## BESKRIVS

### Exempel 1: registrera en ny användare
```
...
Det här kommandot registrerar en ny användare som heter Patti Nilsson.
...
Anger användar-ID.
Denna parameter är valfri.
Om den här parametern inte anges skapar den här cmdleten ett användar-ID.
...
### System. Nullable ' 1 [[Microsoft. Azure. commands. ApiManagement. ServiceManagement. Models. PsApiManagementUserState, Microsoft. Azure. PowerShell. cmdletar. ApiManagement. ServiceManagement, version = 1.0.0.0, Culture = neutralt, PublicKeyToken = null]]
