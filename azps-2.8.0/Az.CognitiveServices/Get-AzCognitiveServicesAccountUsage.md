...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzCognitiveServicesAccountUsage** hämtar aktuella användnings områden för ett kognitivt Services-konto.
...
### -InputObject
Konto objekt för kognitiva tjänster.
...
### -ResourceId
Resurs-ID för kognitiva tjänster.
