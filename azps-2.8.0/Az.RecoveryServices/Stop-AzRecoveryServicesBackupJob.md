...
## PROBLEMBESKRIVNING
Cmdleten **Stop-AzRecoveryServicesBackupJob** avbryter ett befintligt Azure Backup-jobb.
...
För att få ett **BackupJob** -objekt, Använd Get-AzRecoveryServicesBackupJob.
