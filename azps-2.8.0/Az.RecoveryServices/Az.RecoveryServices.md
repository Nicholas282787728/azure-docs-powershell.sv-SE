...
Aktiverar automatisk säkerhets kopiering för en skyddad artikel med en angiven säkerhets kopierings princip.
...
Skydda objekt från en behållare.
...
Skaffa tidsintervall för ett säkerhetskopierat objekt.
...
Skaffa återställnings plan för ett säkerhets kopierings objekt.
...
Förfrågningar om nya DBs i arbets belastningen.
...
Registrerar en skyddad behållare.
