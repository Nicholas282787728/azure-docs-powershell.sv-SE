...
Kommandot ovan skapar ett AD-tjänsthuvudnamn med standardvärden för parametrar som inte anges. Eftersom inget program-ID tillhandahölls skapades ett program för tjänstens huvudnamn. Eftersom inga värden har angetts för, eller `Role` så har den skapade `Scope` tjänstens huvudnamn inga behörigheter.

### Exempel 2 – Enkel generering av AD-tjänstens huvudnamn med en angiven roll och standardomfattning
...
Den representerar bas-64-kodat certifikat.
