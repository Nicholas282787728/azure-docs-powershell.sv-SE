...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzManagementGroup** **uppdaterar värdet för** namn eller **DisplayName** för en hanterings grupp.

## BESKRIVS

### Exempel 1: uppdatera namnet på en hanterings grupp
```
...
### Exempel 2: uppdatera chef för en hanterings grupp
```
...
### Exempel 3: uppdatera en hanterings grupp efter ledning PSManagementGroup-objekt
```
...
### Exempel 4: uppdatera en hanterings grupps förälder med ParentObject
```
...
### -InputObject
Infoga objekt från get-samtalet
