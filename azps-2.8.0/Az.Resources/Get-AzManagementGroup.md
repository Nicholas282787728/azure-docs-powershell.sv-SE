...
## PROBLEMBESKRIVNING
Get-AzManagementGroup cmdlet får alla eller en specifik hanterings grupp.

## BESKRIVS

### Exempel 1: Hämta alla hanterings grupper
```
...
### Exempel 2: Hämta specifik hanterings grupp
```
...
### Exempel 3: Hämta specifik hanterings grupp och första nivån i hierarkin
```
...
Med `Expand` flaggan kan en navigera mellan `Children` matrisen och få information för varje underordnad. Ger till exempel `Children[0]` information om gruppen med visnings namn `TestGroup1DisplayName` .

### Exempel 4: Hämta specifik hanterings grupp och alla hierarkinivåer
```
...
### -Expandera
Expandera utdata för att visa en lista över underordnade till hanterings gruppen
...
### -Recurse
Lista över underordnade objekt i hanterings gruppen rekursivt
