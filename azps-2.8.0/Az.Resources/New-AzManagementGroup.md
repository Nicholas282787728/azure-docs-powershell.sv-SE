...
## PROBLEMBESKRIVNING
Cmdleten **New-AzManagementGroup** skapar en hanterings grupp.
...
Skapa en ny grupp med `DisplayName` och `ParentId` Ange som `null` . Det `DisplayName` kommer att vara samma som `GroupName` och den överordnade gruppen blir då innehavaren.  

### Exempel 2: skapa en hanterings grupp med ett visnings namn
```
...
I det här fallet blir den överordnade för gruppen innehavaren och `DisplayName` kommer att anges till det angivna värdet.

### Exempel 3: skapa en hanterings grupp med ett överordnat och ett visnings namn
```
...
### Exempel 4: skapa en hanterings grupp med en överordnad (med ett överordnat objekt)
```
...
### -DisplayName
Visnings namn för hanterings gruppen
...
### -
Överordnat ID för hanterings gruppen
