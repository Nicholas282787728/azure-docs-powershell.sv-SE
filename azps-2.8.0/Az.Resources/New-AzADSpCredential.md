...
## PROBLEMBESKRIVNING
New-AzADSpCredential cmdleten kan användas för att lägga till en ny autentiseringsuppgift eller för att lyfta autentiseringsuppgifter för ett tjänst huvud konto.
Tjänstens huvud namn identifieras genom att ange antingen objekt-ID: t eller SPN.

## BESKRIVS

### Exempel 1 – Skapa en ny tjänst säkerhets referens med ett genererat lösen ord
...
En ny lösen ords identifiering läggs till i det befintliga tjänst säkerhets objekt med objekt-ID ' 1f99cf81-0146-4f4e-BEAE-2007d0668476 '.

### Exempel 2 – Skapa en ny tjänst säkerhets referens med ett certifikat
...
Det tillhandahållna base64-kodade X509-certifikatet ("MyApp. cer") läggs till i det befintliga tjänst säkerhets objekt med dess SPN.

### Exempel 3 – skapa en ny tjänst huvud referenser med ledning
...
Hämtar tjänstens huvud namn med objekt-ID ' 1f99cf81-0146-4f4e-BEAE-2007d0668476 ' och rör till New-AzADSpCredential för att skapa en ny tjänst huvud identifiering för den tjänstens huvud konto med ett genererat lösen ord.
...
Standardvärdet för slutdatumet är ett år från idag.
För en "asymmetrisk" typ autentiseringsuppgift måste detta ställas in på eller före det datum då X509-certifikatet är giltigt.
...
Tjänst huvud objekt för att lägga till autentiseringsuppgifterna.
...
### Microsoft. Azure. kommandon. sources. Models. Authorization. PSADCredentialWrapper
