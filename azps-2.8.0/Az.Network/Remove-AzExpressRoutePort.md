...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzExpressRoutePort** tar bort en ExpressRoutePort.
...
Tar bort $PortName ExpressRoutePort-resursen i $rg resurs grupp i prenumerationen.
