...
## PROBLEMBESKRIVNING
Cmdleten **set-AzLoadBalancerRuleConfig** uppdaterar en regel konfiguration för belastnings utjämning.
...
I det andra kommandot används pipeline-operatorn för att överföra belastningsutjämnaren i $slb till Add-AzLoadBalancerRuleConfig, som lägger till en regel som heter NewRule.
Det tredje kommandot skickar belastningsutjämnaren till **set-AzLoadBalancerRuleConfig** , som anger den nya regel konfigurationen.
...
Denna cmdlet uppdaterar en regel konfiguration för belastningsutjämnaren som den här parametern anger.
