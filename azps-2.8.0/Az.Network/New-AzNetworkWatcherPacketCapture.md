...
ms.locfileid: "100414670"
---
# New-AzNetworkWatcherPacketCapture

## SYNOPSIS
Skapar en ny paketinspelningsresurs och startar en paketinspelningssession på en VM.
...
## BESKRIVNING
Med New-AzNetworkWatcherPacketCapture-cmdleten skapas en ny paketin capture-resurs och startar en paketinspelningssession på en VM.
Längden på paketinspelningssessioner kan konfigureras via en tidsbegränsning eller en storleksbegränsning. Mängden data som lagras för varje paket kan också konfigureras.
Filter kan tillämpas på en given paketinspelningssession, så att du kan anpassa vilken typ av paket som fångas. Filter kan begränsa paket på lokala och fjärr-IP-adresser & adressintervall, lokala portar och fjärrportar & portintervall och sessionsnivåprotokoll som ska fångas. Filter är tänkbara och flera filter kan användas för att ge detaljerad information om inröjning.
...
### -Filter
Filter för paketinspelningssession.
...
Detta är målets virtuella dator-ID.
