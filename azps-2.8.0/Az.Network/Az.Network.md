...
Skaffa en privat slut punkts anslutning
...
Hämtar anslutnings status för VPN-klienter för varje VPN-klient.
...
Skapar en princip för IPSec-trafikväljaren.
...
Uppdatera en anslutnings övervakare.
...
Kontrollerar om en privat länk tjänst är synlig för aktuell användning.
