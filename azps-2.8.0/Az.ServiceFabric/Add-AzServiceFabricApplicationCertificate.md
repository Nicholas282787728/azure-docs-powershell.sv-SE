...
## PROBLEMBESKRIVNING
Använd **Add-AzServiceFabricApplicationCertificate** för att installera ett certifikat för alla noder i klustret. Du kan ange ett certifikat som du redan har eller låta systemet skapa ett nytt för dig och överföra det till ett nytt eller befintligt Azure Key-valv.
...
Det här kommandot lägger till ett certifikat från ett befintligt Azure Key-valv till alla nodtyper i klustret.
...
Det här kommandot skapar ett självsignerat certifikat i Azure-valvet med nyckelordet Key valv resurs grupp namn och valv namn, installerar till alla nodtyper för klustret och hämtar certifikatet under mappen "c:\test". Namnet på det hämtade certifikatet är samma som namnet på Key valv-certifikatet.
...
### -CertificateFile
Sökvägen till det befintliga certifikatet
...
Den mapp där det nya certifikatet behöver hämtas.
...
### -KeyVaultName
Namn på Azure-valv om det inte anges blir det standard namnet på resurs gruppen
...
Resurs grupp namn för Azure-valv om det inte anges blir det standard för resurs grupps namn
...
### -SecretIdentifier
Den befintliga hemliga URL-adressen för Azure Key Vault, till exempel " https://mykv.vault.azure.net:443/secrets/mysecrets/55ec7c4dc61a462bbc645ffc9b4b225f '
