...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzNetAppFilesSnapshot** tar bort en ANF-stillbild.
...
Det här kommandot tar bort ANF Snapshot "MyAnfSnapshot".
...
### -VolumeObject
Volume-objektet som innehåller den ögonblicks bild som ska tas bort
