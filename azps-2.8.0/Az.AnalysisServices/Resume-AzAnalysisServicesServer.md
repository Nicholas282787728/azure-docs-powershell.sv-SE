...
## PROBLEMBESKRIVNING
Resume-AzAnalysisServicesServer cmdleten återupptar en instans av Analysis Services-servern
...
Det här kommandot återupptar en pausad server med namnet testserver i resourcegroup testgroup
