...
## PROBLEMBESKRIVNING
Cmdleten **disable-AzStorageStaticWebsite** inaktiverar den statiska webbplatsen för Azure Storage-kontot.

## BESKRIVS

### Exempel 1: inaktivera statisk webbplats för ett Azure Storage-konto
```
C:\PS>Disable-AzStorageStaticWebsite
```

Det här kommandot inaktiverar den statiska webbplatsen för ett Azure Storage-konto.
