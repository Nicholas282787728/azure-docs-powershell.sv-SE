...
## PROBLEMBESKRIVNING
Cmdleten **Stop-AzStorageBlobCopy** stoppar en kopierings åtgärd till angiven destinations-blob.
...
Det här kommandot stoppar kopieringen genom att skicka behållaren i pipeline från **Get-AzStorageContainer**.

### Exempel 3: Stoppa kopieringen med hjälp av pipeline och Get-AzStorageBlob
```
PS C:\>Get-AzStorageBlob -Container "ContainerName" | Stop-AzStorageBlobCopy -Force
```

I det här exemplet avbryts kopieringen genom att behållaren skickas från Get-AzStorageBlob cmdlet.
...
Du kan skapa kontexten med hjälp av New-AzStorageContext cmdlet.
