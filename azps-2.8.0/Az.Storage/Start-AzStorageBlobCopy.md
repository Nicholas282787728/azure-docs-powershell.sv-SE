...
### Exempel 6: kopiera en Block-Blob till en mål container med ett nytt BLOB-namn och ange StandardBlobTier som Arkiv, RehydratePriority som hög
```
...
Det här kommandot startar kopieringen av en Block-Blob till mål container med ett nytt BLOB-namn och anger mål-BLOB-StandardBlobTier som Arkiv, RehydratePriority som hög
