...
### AccountNamePolicyRule (standard)
```
...
## PROBLEMBESKRIVNING
Cmdleten **set-AzStorageAccountManagementPolicy** skapar eller ändrar hanterings principen för ett Azure Storage-konto.

## BESKRIVS

### Exempel 1: skapa eller uppdatera hanterings principen för ett lagrings konto med ManagementPolicy regel objekt.
```
...
Det här kommandot skapar först två ManagementPolicy regel objekt och skapar eller uppdaterar sedan hanterings principen för ett lagrings konto med de två ManagementPolicy-regel objekt.

### Exempel 2: skapa eller uppdatera hanterings principen för ett lagrings konto med en JSON-formatering.
```
...
Det här kommandot skapar eller uppdaterar hanterings principen för ett lagrings konto med en JSON-format princip.

### Exempel 3: Hämta hanterings principen från ett lagrings konto och ange det till ett annat lagrings konto.
```
...
Det här kommandot får först en hanterings princip från ett lagrings konto och anger det till ett annat lagrings konto.
...
### -Princip
Hanterings princip objekt som ska anges
...
### -Regel
Regler för hanterings principer. Hämta objektet med New-AzStorageAccountManagementPolicyRule cmdlet.
