...
### Exempel 1 Ange daglig data volym Cap för en program Insights-resurs
```
...
Ange daglig data volym Cap till 400 GB per dag och sluta skicka meddelande när du trycker på "test" i resurs gruppen "testgroup"
