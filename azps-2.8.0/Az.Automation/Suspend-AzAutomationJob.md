...
## PROBLEMBESKRIVNING
Cmdleten **suspend-AzAutomationJob** inaktive ras ett Azure Automation-jobb.
Ange ett automatiserings jobb som körs.
Om du vill återuppta ett avbrutet jobb kan du använda Resume-AzAutomationJob cmdlet.
