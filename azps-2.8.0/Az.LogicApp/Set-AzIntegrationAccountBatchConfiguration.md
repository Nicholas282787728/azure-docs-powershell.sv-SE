...
## Sammanfattning
Ändrar kommando konfiguration för integrerings konto.
...
## PROBLEMBESKRIVNING
Cmdleten **set-AzIntegrationAccountBatchConfiguration** ändrar en batch-konfiguration för integrerings konto.

## BESKRIVS

### Exempel 1: ändra en kommando konfiguration med lokal fil
```powershell
...
Ändra en kommando konfiguration med namnet "sampleBatchConfig" med den lokala filen som finns på fil Sök vägen i $batchConfigurationFilePath.

### Exempel 2: ändra en kommando konfiguration med hjälp av en JSON-sträng
```powershell
...
Ändra en kommando konfiguration med namnet "sampleBatchConfig" med hjälp av en JSON-sträng i "$batchConfigurationContent".

### Exempel 3: ändra en kommando konfiguration med hjälp av parametrar
```powershell
...
Ändra en kommando konfiguration med namnet "sampleBatchConfig" genom att manuellt tillhandahålla alla nödvändiga parametrar.
...
### -InputObject
En batch-konfiguration för integrerings konto.
