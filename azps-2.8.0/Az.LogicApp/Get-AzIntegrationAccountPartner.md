...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzIntegrationAccountPartner** får integrerings konto partner från en resurs grupp.
...
### Exempel 1: skaffa en integrations konto partner
```
...
Det här kommandot får integrerings konto partnern med namnet IntegrationAccountPartner22.

### Exempel 2: skaffa ett integrerings konto partner med hjälp av ett integrations konto namn
```
...
Det här kommandot får integrerings konto partners för integrations kontot med namnet IntegrationAccount31.
