...
## PROBLEMBESKRIVNING
Med för nätverks åtkomst principer (JIT) kan du definiera en princip som gör det möjligt för enkla användare att skapa en tillfällig nätverks anslutning till en virtuell dator.
Principen definierar vilka portar, protokoll-och käll-IP-adresser som kan begära en anslutning till en virtuell dator och maximal varaktighet innan anslutningen stängs automatiskt.
I principen kan du även se anslutningsbegäran som har gjorts med den här principen. 
...
Få alla åtkomst principer för JIT-nätverk för en prenumeration
...
Få alla åtkomst principer för JIT-nätverk i resurs gruppen "myService1"
...
Hämtar en specifik policy för JIT-nätverks åtkomst
