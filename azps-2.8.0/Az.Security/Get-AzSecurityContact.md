...
## PROBLEMBESKRIVNING
Hämtar säkerhets kontakter som har kon figurer ATS för det här abonnemanget.
Säkerhets kontakten får aviseringar om säkerhets varningar som uppstår på abonnemanget.
...
Hämtar alla konfigurerade säkerhets kontakter för abonnemanget
