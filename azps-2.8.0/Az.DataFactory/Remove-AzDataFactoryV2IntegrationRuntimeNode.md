...
## PROBLEMBESKRIVNING
Remove-AzDataFactoryV2IntegrationRuntimeNode cmdlet tar bort en nod i en integrations körning.

## BESKRIVS

### Exempel 1: ta bort en nod från en integrations körning
```
...
Det här kommandot tar bort en nod med namnet "Node_1" i integrations körningen med namnet "test-selfhost-IR" i prenumerationen för resurs gruppen med namnet "RG-test-dfv2" och data fabriken med namnet "test-DF-EU2".
