...
### Exempel 2: skapa en data fabrik med repoconfiguration uppgifter med hjälp av ett befintligt Factory-objekt.
```
...
### -HostName
Värd namnet för repo-konfiguration.
...
### -Projektetsnamn
Projekt namnet för repo-konfiguration.
...
### -TenantId
Klient-ID för konfiguration av repo.
