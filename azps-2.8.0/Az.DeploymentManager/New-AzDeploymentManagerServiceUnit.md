...
## PROBLEMBESKRIVNING
Cmdleten **New-AzDeploymentManagerServiceUnit** skapar en tjänst under en tjänst i en tjänst sto pol Ogin och returnerar ett objekt som representerar den tjänst enheten.
Ange tjänst enheten utifrån dess namn, tjänst namn, topologi för tjänsten och resurs gruppens namn. 

Cmdleten returnerar ett ServiceUnit-objekt. Du kan ändra det här objektet lokalt och sedan tillämpa ändringarna på tjänsten genom att använda Set-AzDeploymentManagerService cmdlet.
...
Sökvägen till parameter filen i förhållande till artefakt källan.
Kräver att ArtifactSource refereras i ServiceTopology.
...
### -ParametersUri
SAS URI till parameter filen.
Om ArtifactSourceId refererades i ServiceTopology anger du relativ sökväg med ParametersArtifactSourceRelativePath.
...
### -ServiceTopologyName
Namnet på tjänst topologin som denna tjänst enhet är en del av.
...
Sökvägen till mallfilen i förhållande till artefakt källan.
Kräver att ArtifactSource refereras i ServiceTopology.
...
### -TemplateUri
SAS URI till mallfilen.
Om ArtifactSourceId refererades i ServiceTopology anger du relativ sökväg med TemplateArtifactSourceRelativePath.
