...
## PROBLEMBESKRIVNING
Att ta bort en server slut punkt är en destruktiv åtgärd. Den här Server platsen slutar synkroniseras. Denna åtgärd ska inte utföras för att lösa synkroniseringsproblem. Om den här Server platsen (inkl. filer) läggs till i samma synkroniseringsresurs som en server slut punkt kan den leda till konfliktskapande filer och andra oavsiktliga konsekvenser. Det här kommandot är endast avsett för att avställa.
...
Det här kommandot tar bort Server slut punkten.
...
### -InputObject
ServerEndpoint, vanligt vis passerar genom pipeline.
