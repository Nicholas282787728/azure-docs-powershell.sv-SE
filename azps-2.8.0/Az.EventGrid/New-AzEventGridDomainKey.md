...
Återskapa nyckeln som motsvarar nyckeln \' KEY1 ' \ of Event rutmönster Domain \` domain1 \` i resurs grupp \` MyResourceGroupName \` .
...
Återskapa nyckeln som motsvarar nyckeln \' key2 ' \ of Event rutmönster Domain \` domain1 \` i resurs gruppen \` MyResourceGroupName \` med dess fullständiga resurs-ID.
...
### -Namn
Namnet på den nyckeln som måste återskapas
