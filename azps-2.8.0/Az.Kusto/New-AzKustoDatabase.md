...
### Exempel 1 – Skapa en ny Kusto-databas efter namn
...
Kommandot ovan skapar en ny Kusto-databas med namnet "mykustodatabase" i det befintliga klustret "mykustocluster" i resurs gruppen "testrg".

## MALLPARAMETRAR

### -Kluster namn
Namnet på det kluster som du vill skapa databasen under.
...
Antalet dagar med data som ska behållas i cacheminnet för snabba frågor.
...
### -Namn
Namn på databasen som ska skapas.
...
Antalet dagar som data ska sparas innan det upphör att vara tillgängligt för frågor.
