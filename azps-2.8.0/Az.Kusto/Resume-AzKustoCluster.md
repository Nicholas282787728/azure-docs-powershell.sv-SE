...
### Exempel 1-Resume a Suspended Kusto Cluster efter namn

```
PS C:\> Resume-AzKustoCluster -ResourceGroupName testrg -Name mykustocluster
```

Kommandot ovan återupptar det upphävda Kusto-klustret med namnet "mykustocluster" i resurs gruppen "testrg".

### Exempel 2 – återuppta ett suspenderat Kusto-kluster genom att koppla

```
PS C:\> Get-AzKustoCluster -ResourceGroupName testrg -Name mykustocluster | Resume-AzKustoCluster
```

Kommandot ovan får till Kusto-klustret med namnet "mykustocluster" i resurs gruppen "testrg" med hjälp av `Get-AzKustoCluster` cmdleten, och sedan flyttas resultatet till `Resume-AzKustoCluster` för att återuppta det.
...
### -Namn
Namn på klustret som ska återupptas.
