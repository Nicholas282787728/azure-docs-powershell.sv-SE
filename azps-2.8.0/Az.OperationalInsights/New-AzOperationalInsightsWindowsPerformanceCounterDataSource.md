...
## PROBLEMBESKRIVNING
Cmdleten **New-AzOperationalInsightsWindowsPerformanceCounterDataSource** lägger till en data källa för Windows prestanda räknare för anslutna datorer som kör operativ systemet Windows.
...
### -UseLegacyCollector
Använda äldre insamlare eller standard insamlaren.
