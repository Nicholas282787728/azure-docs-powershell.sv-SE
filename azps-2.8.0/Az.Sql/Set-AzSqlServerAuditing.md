...
## Sammanfattning
**Viktigt: denna cmdlet är föråldrad, [set-AzSqlServerAudit](https://docs.microsoft.com/en-us/powershell/module/az.sql/set-azsqlserveraudit) ersätter den.**
...
## PROBLEMBESKRIVNING
Cmdleten **set-AzSqlServerAuditing** ändrar gransknings inställningarna för en Azure SQL Server.
...
Om cmdleten lyckas och du använder parametern *Passthru* returneras ett objekt som beskriver de aktuella gransknings inställningarna, utöver Server-ID.
Server-ID: n inkluderar, men är inte begränsade till, **ResourceGroupName** och **servername**.

## BESKRIVS

### Exempel 1: Aktivera gransknings princip för blob-lagring för en Azure SQL-Server
```
...
### Exempel 2: inaktivera gransknings princip för blob-lagring för en Azure SQL-Server
```
PS C:\>Set-AzSqlServerAuditing -State Disabled -ResourceGroupName "ResourceGroup01" -ServerName "Server01"
```

### Exempel 3: Aktivera gransknings princip för blob-lagring för en Azure SQL Server med ett lagrings konto från ett annat abonnemang
```
...
### Exempel 4: Aktivera gransknings princip för blob-lagring för en Azure SQL Server med avancerad filtrering med ett T-SQL-predikat
```
...
### Exempel 5: ta bort inställningen Advanced filter from lagrings principen för BLOB-granskning för en Azure SQL-Server
```
...
### Exempel 6: Aktivera gransknings principen för händelsehubben för en Azure SQL-Server
```
...
### Exempel 7: inaktivera gransknings princip för en Azure SQL-Server för händelsehubben
```
PS C:\>Set-AzSqlServerAuditing -State Disabled -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -EventHubName
```

### Exempel 8: Aktivera gransknings princip för logganalys för en Azure SQL Server
```
...
### Exempel 9: inaktivera gransknings principen för logganalys-SQL-servern
```
PS C:\>Set-AzSqlServerAuditing -State Disabled -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -LogAnalytics
```

### Exempel 10: inaktivera, genom pipeline, gransknings princip för logganalys för en Azure SQL Server
```
...
### Microsoft. Azure. commands. SQL. granskning. Model. ServerBlobAuditingSettingsModel
