...
## PROBLEMBESKRIVNING
Cmdleten **Clear-AzSqlDatabaseAdvancedThreatProtectionSettings** tar bort avancerade skydds inställningar från en AzureAzure SQL-databas.
...
### Exempel 1: ta bort avancerade skydds inställningar för en databas
```
...
Det här kommandot tar bort de avancerade skydds inställningarna från en databas som heter Database01 på den server som heter Server01.

## MALLPARAMETRAR

### -DatabaseName
Anger namnet på en databas där inställningarna för avancerat skydd ska tas bort.
