...
## PROBLEMBESKRIVNING
Get-AzSqlServerTransparentDataEncryptionProtector-cmdleten hämtar information om TDE-skydd.

## BESKRIVS

### Exempel 1: Hämta det transparenta data krypterings skyddet (TDE)
```
