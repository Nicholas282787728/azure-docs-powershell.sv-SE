...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlInstancePool** returnerar information om en eller flera Azure SQL-instanser.
Ange namnet på en instans för att visa information för endast den instans.

## BESKRIVS

### Exempel 1: Hämta alla instanser av en kund prenumeration
```powershell
...
Det här kommandot får information om alla instanser inom kund abonnemanget.

### Exempel 2: Hämta alla instanser i en resurs grupp
```powershell
...
Med det här kommandot får du information om alla instanser i resurs gruppen resourcegroup01.

### Exempel 3: Hämta information om en instans-pool
```powershell
...
Med det här kommandot får du information om instancePool0.

### Exempel 4: Hämta information om en instans med hjälp av resurs-ID för en pool
```powershell
...
Med det här kommandot får du information om entitetsinstansen med dess resurs-ID.
