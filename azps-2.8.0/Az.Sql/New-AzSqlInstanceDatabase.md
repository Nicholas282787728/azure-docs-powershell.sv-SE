...
## PROBLEMBESKRIVNING
Cmdleten **New-AzSqlInstanceDatabase** skapar en Azure SQL-hanterad instans.

## BESKRIVS

### Exempel 1: skapa en databas på en angiven instans
```
...
Det här kommandot skapar en instans databas med namnet Database01 på instance managedInstance1.
...
### -Sortering
Sorteringen av databas sortering för Azure SQL-instans.
...
### -Namn
Namnet på den Azure SQL instance-databas som ska skapas.
...
### -Tagg
De taggar som ska kopplas till Azure SQL instance-databasen
