...
## BESKRIVNING
**Cmdleten Update-AzSqlServerAdvancedThreatProtectionSettings** ställer in en avancerad inställning för skydd mot hot på en Azure SQL-server.
För att kunna aktivera avancerat skydd på en server måste en granskningsinställning vara aktiverad på servern.
