...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlInstanceDatabase** hämtar en eller flera Azure SQL-databaser från en hanterad Azure SQL-databas.

## BESKRIVS

### Exempel 1: Hämta alla databaser på en instans
```
...
Det här kommandot får alla databaser från förekomsten managedInstance1.

### Exempel 2: Hämta en databas med namn på en hanterad instans
```
...
Det här kommandot får en databas som heter managedDatabase1 från en instans med namnet managedInstance1.

### Exempel 3: Hämta alla databaser på en instans med hjälp av filtrering
```
...
Det här kommandot får alla databaser från förekomsten managedInstance1 som börjar med "managedDatabase".
...
### -InstanceObject
Instans objekt som ska användas för att hämta instans databasen
...
### -Namn
Namnet på den Azure SQL instance-databas som ska hämtas.
