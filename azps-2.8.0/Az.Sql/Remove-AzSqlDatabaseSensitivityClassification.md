...
## PROBLEMBESKRIVNING
Remove-AzSqlDatabaseSensitivityClassification cmdlet tar bort data typerna och känslighets etiketterna för kolumner i databasen.

## BESKRIVS

### Exempel 1: ta bort informations typ och känslighets etikett för en kolumn i en Azure SQL-databas.
```powershell
...
### Exempel 2: ta bort aktuella informations typer och känslighets etiketter för kolumner i en Azure SQL-databas med hjälp av rör.
```powershell
...
### Exempel 3: ta bort informations typ och känslighets etikett för en kolumn i en Azure SQL-databas med dragning.
```powershell
