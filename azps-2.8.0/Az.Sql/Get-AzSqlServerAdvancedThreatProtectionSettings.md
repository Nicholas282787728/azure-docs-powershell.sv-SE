...
## BESKRIVNING
Cmdleten **Get-AzSqlServerAdvancedThreatProtectionSettings** får de avancerade inställningarna för skydd mot hot på en Azure SQL-server.
