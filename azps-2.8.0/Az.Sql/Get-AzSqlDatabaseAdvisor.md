...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlDatabaseAdvisor** hämtar en eller flera Azure SQL-databas rådgivare för en Azure SQL-databas.

## BESKRIVS

### Exempel 1: lista alla rådgivare för den angivna databasen
```
...
Med det här kommandot får du en lista med alla rådgivare för databasen med namnet WIRunner som tillhör servern med namnet WiFi-öst.

### Exempel 2: skaffa en enda rådgivare för den angivna databasen
```
...
Det här kommandot får rådgivaren CreateIndex för databasen med namnet WIRunner.

### Exempel 3: Visa alla rådgivare med de rekommenderade åtgärderna i svaret
```
...
Det här kommandot får alla rådgivare för databasen ' WIRunner ' med de rekommenderade åtgärderna i svaret.
Eftersom parametern *ExpandRecommendedActions* används i kommandot får cmdleten de rekommenderade åtgärderna med svaret.

### Exempel 4: skaffa en enda rådgivare med de rekommenderade åtgärderna i svaret
```
...
Det här kommandot får den rådgivare som heter CreateIndex från databasen med namnet WIRunner med de rekommenderade åtgärderna i svaret.
Eftersom parametern *ExpandRecommendedActions* används i kommandot får cmdleten de rekommenderade åtgärderna med svaret.

### Exempel 5: lista alla rådgivare för den angivna databasen med hjälp av filtrering
```
...
Med det här kommandot får du en lista med alla rådgivare för databasen med namnet WIRunner som tillhör servern med namnet WiFi-öst-öster och börjar med bokstaven "d".

## MALLPARAMETRAR

### -AdvisorName
Anger namnet på den rådgivare som denna cmdlet får.
...
### -DatabaseName
Anger namnet på den databas där denna cmdlet begär rådgivare.
...
Anger att denna cmdlet får de rekommenderade åtgärderna med svaret.
...
## ANMÄRKNINGAR
* Nyckelord: Azure, azurerm, arm, resurs, hantering, chef, SQL, databas, MSSQL, rådgivare
