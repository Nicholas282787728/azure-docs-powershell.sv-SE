...
Hämtar den säkra anslutnings principen för en databas. Säker anslutning är inaktuellt och det här kommandot tas bort i framtida versioner. Använd SQL-databasens blad i Azure-portalen för att Visa anslutnings strängarna
...
Hämtar en servers avancerade skydds policy.
