...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlServerAdvisor** hämtar en eller flera Azure SQL Server-rådgivare för en Azure SQL Server.

## BESKRIVS

### Exempel 1: lista alla rådgivare för servern
```
...
Det här kommandot får en lista över alla rådgivare för servern med namnet WiFi-öst som tillhör resurs gruppen WIRunnersProd.

### Exempel 2: skaffa en enda rådgivare för servern
```
...
Det här kommandot får rådgivaren med namnet CreateIndex för servern med namnet WiFi-öst.
...
Det här kommandot får alla rådgivare för servern med namnet WiFi-öst.
Eftersom parametern *ExpandRecommendedActions* används i kommandot, får de rådgivare som rekommenderas i svaret.
...
Det här kommandot får rådgivaren CreateIndex från servern med namnet Wi-löpare-öst, med de rekommenderade åtgärderna i svaret.

### Exempel 5: lista alla rådgivare för servern med hjälp av filtrering
```
...
Det här kommandot får en lista över alla rådgivare för servern med namnet WiFi-öst som tillhör resurs gruppen WIRunnersProd som börjar med bokstaven "d".
...
Anger att cmdleten innehåller de rekommenderade åtgärderna för de rådgivare som ingår i svaret.
...
### -ResourceGroupName
Anger namnet på Server gruppen.
...
### -ServerName
Anger namnet på servern för den rådgivare som denna cmdlet begär.
