...
## PROBLEMBESKRIVNING
Cmdleten **Stop-AzSqlElasticPoolActivity** avbryter den asynkrona uppdaterings åtgärden på en elastisk pool.

## BESKRIVS

### Exempel 1: Avbryt den asynkrona uppdateringen på en elastisk pool
```
...
Det här kommandot avbryter den asynkrona uppdateringen för den elastiska poolen.
...
### -ElasticPoolName
Namnet på den elastiska Azure SQL-poolen.
