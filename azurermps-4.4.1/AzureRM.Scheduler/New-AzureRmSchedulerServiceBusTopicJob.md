...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmSchedulerServiceBusTopicJob** skapar ett artikel jobb för Service Bus i Azure Scheduler.
...
### -ServiceBusMessage
Anger ett avsnitts meddelande för Service Bus.
...
### -ServiceBusTopicPath
Anger sökvägen till en tjänst buss.
