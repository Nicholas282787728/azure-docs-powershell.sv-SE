...
## PROBLEMBESKRIVNING
**AzureRmMediaServiceStorageKeys** cmdlet synkroniserar lagrings konto nycklar för ett lagrings konto som är kopplat till medie tjänsten.
...
Det första kommandot använder cmdleten Get-AzureRmStorageAccount för att hämta lagrings kontot med namnet Storage135 som tillhör ResourceGroup001 och lagrar resultatet i variabeln som heter $StorageAccount.
