...
När det används tillsammans med New-AzureRmNotificationHubAuthorizationRules cmdlet ändrar det föregående JSON-provet en auktoriseringsregel med namnet ContosoAuthorizationRule för att ge användarna behörighet att lyssna och skicka till navet.
