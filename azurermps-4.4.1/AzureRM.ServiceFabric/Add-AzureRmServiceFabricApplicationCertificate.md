...
## PROBLEMBESKRIVNING
Använd **Add-AzureRmServiceFabricApplicationCertificate** för att installera ett certifikat för alla noder i klustret. Du kan ange ett certifikat som du redan har eller låta systemet skapa ett nytt för dig och överföra det till ett nytt eller befintligt Azure Key-valv.
...
Sökvägen till det nya certifikat som ska skapas.
...
### -SecretIdentifier
Den befintliga Azure Key Vault Secret URI.
