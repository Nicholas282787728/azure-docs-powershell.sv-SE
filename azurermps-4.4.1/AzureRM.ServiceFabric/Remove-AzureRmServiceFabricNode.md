...
## PROBLEMBESKRIVNING
Använd **Remove-AzureRmServiceFabricNode** för att ta bort noder från en viss nodtyp från ett kluster. Borttagningen fortsätter bara om den uppfyller kluster hälso måtten.
...
Antalet noder som ska tas bort.
