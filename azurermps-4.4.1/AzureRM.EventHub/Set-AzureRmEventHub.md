...
## PROBLEMBESKRIVNING
Den Set-AzureRmEventHub cmdleten uppdaterar egenskaperna för den angivna Händelsehubben.

## BESKRIVS

### Exempel 1
Följ stegen nedan om du vill uppdatera Eventhub med beskrivnings egenskaper för insamling. 
...
Uppdaterar den MyEventHubName som \` \` representeras av \` MyCreatedEventHub \` -objektet, ställer in tids perioden för meddelanden till 4 dagar, antalet partitioner till 2 och CaptureDescription egenskaper
...
Uppdaterar \` MyEventHubName som \` representeras av \` MyCreatedEventHub \` -objektet, ställer in tids perioden till 4 dagar och antalet partitioner till 2.

## MALLPARAMETRAR

### -messageRetentionInDays
Logg period för meddelanden om händelsehubben under dagar.
...
### -partitionCount
Antal partitioner i den här händelsehubben.
