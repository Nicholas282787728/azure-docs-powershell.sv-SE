...
## PROBLEMBESKRIVNING
Cmdleten **Resume-AzureRmDataFactoryPipeline** återupptar en pausad pipeline i Azure Data Factory.
...
Använd cmdleten **suspend-AzureRmDataFactoryPipeline** för att skjuta upp en rörledning.
