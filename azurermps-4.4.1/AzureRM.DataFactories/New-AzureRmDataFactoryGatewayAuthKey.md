...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmDataFactoryGatewayAuthKey** skapar Gateway-autentiseringsuppsättningen för en angiven Azure Data Factory Gateway.
Du registrerar gatewayen med en moln tjänst med den här nyckeln.

## BESKRIVS

### Exempel 1: skapar en gateway-autentiseringsprovider för KEY1
```
...
Det här kommandot skapar en gateway-autentiseringsprovider för KEY1 för data fabriks-gatewayen med namnet min Gateway.
...
### -Namn
Namnet på den gateway-autentiseringsprovider som ska återskapas, antingen "KEY1" eller "key2".
