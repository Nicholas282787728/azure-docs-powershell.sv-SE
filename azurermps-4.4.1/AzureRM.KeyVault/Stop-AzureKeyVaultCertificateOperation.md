...
## PROBLEMBESKRIVNING
Cmdleten **Stop-AzureKeyVaultCertificateOperation** avbryter en certifikat åtgärd i Azure Key valv-tjänsten.

## BESKRIVS

### Exempel 1: avbryta en certifikat åtgärd
```
...
Det här kommandot avbryter TestCert02 certifikat åtgärden.
