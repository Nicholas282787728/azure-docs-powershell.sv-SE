...
### Ett lås vid det angivna omfånget. Vis
```
...
`/subscriptions/`abonnemang ID `/resourceGroups/` resurs grupp namn `/providers/Microsoft.Sql/servers/` Server namn `/databases/` databas namn

Använd följande format för att ange en resurs grupp: 
