...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmManagedApplication** tar bort ett hanterat program
...
Det första kommandot får ett hanterat program som heter Mittprog med hjälp av Get-AzureRmManagedApplication cmdlet.
