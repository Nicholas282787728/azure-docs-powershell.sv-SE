...
### Parameter uppsättningens definitions namn. Vis
```
...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmPolicySetDefinition** ändrar en princip definition.
...
Det första kommandot får en princip uppsättnings definition med hjälp av Get-AzureRmPolicySetDefinition cmdlet.
