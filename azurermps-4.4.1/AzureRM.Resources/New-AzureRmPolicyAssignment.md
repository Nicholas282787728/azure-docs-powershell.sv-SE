...
### Princip tilldelning utan parametrar (standard)
```
...
### Princip tilldelning med parametrar via princip parameter objekt
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
...
### Princip tilldelning med parametrar via princip parameter sträng
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
 [-Description <String>] -PolicyDefinition <PSObject> [-PolicySetDefinition <PSObject>]
...
### Princip tilldelning med parametrar via princip uppsättningens parameter objekt
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
 [-Description <String>] [-PolicyDefinition <PSObject>] -PolicySetDefinition <PSObject>
 -PolicyParameterObject <Hashtable> [-Sku <Hashtable>] [-ApiVersion <String>] [-Pre]
...
### Princip tilldelning med parametrar via princip uppsättningens parameter sträng
```
New-AzureRmPolicyAssignment -Name <String> -Scope <String> [-NotScope <String[]>] [-DisplayName <String>]
 [-Description <String>] [-PolicyDefinition <PSObject>] -PolicySetDefinition <PSObject>
 -PolicyParameter <String> [-Sku <Hashtable>] [-ApiVersion <String>] [-Pre]
...
### -Beskrivning
Beskrivningen av princip tilldelningen.
...
### -SKU
En hash-tabell som representerar SKU-egenskaper. Standard är gratis SKU: namn = a0, nivå = gratis
