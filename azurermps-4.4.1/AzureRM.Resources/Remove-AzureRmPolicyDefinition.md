...
### Parametern för princip definitions namn. Vis
```
...
### Parameter uppsättning för princip Definitions-ID.
```
...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmPolicyDefinition** tar bort en princip definition.
