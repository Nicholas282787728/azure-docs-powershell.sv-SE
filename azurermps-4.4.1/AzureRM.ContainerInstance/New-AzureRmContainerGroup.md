...
### Exempel 3: skapar en behållar grupp med hjälp av bild i Azure-behållarobjekt
```
...
### Exempel 4: skapar en behållar grupp med hjälp av bild i eget register för behållar bilder
```
PS C:\> $secpasswd = ConvertTo-SecureString "PlainTextPassword" -AsPlainText -Force
