...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmOperationalInsightsWorkspace** tar bort en befintlig arbets yta.
...
Det här kommandot använder cmdleten Get-AzureRmOperationalInsightsWorkspace för att hämta arbets ytan med namnet min arbets yta och skickar den till cmdlet **Remove-AzureRmOperationalInsightsWorkspace** genom att använda pipeline-operatorn för att ta bort den.
