...
## PROBLEMBESKRIVNING
Cmdleten **disable-AzureRmOperationalInsightsIISLogCollection** stoppar samlingen Internet Information Services (IIS)-loggar från anslutna datorer på en arbets yta.
