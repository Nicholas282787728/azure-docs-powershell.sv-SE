...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmOperationalInsightsSavedSearch** tar bort en sparad sökning från arbets ytan.

## BESKRIVS

### Exempel 1: ta bort en sparad sökning
```
...
Det här kommandot tar bort en sparad sökning från arbets ytan.
