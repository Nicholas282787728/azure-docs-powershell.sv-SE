...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmDtlVMsPerUserPolicy** anger de virtuella datorerna per användar princip för ett labb som anger det högsta antalet virtuella datorer som tillåts per användare.
