...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmHDInsightJobOutput** hämtar logg resultatet för ett jobb från det lagrings konto som är kopplat till ett Azure HDInsight-kluster.

## BESKRIVS

### Exempel 1: Hämta logg resultatet för ett jobb
```
PS C:\># Cluster info
...
Det här kommandot hämtar loggen från det kluster som heter ditt-Hadoop-001.
...
### -DefaultContainer
Anger standard behållarens namn.
...
Anger standard för lagrings konto.
...
Anger standard namnet på lagrings kontot.
...
### -DisplayOutputType
Anger utskrifts typen för jobbet som begärs.
...
### -JobId
Anger jobb-ID för det jobb vars utdata ska hämtas.
