...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmHDInsightPersistedScriptAction** anger en tidigare körd skript åtgärd som ska vara en bestående skript åtgärd.
...
Kör-ID för skript åtgärden kan hittas med Get-AzureRmHDInsightScriptActionHistory.
