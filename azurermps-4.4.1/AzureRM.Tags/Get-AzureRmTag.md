...
Om prenumerationen innehåller fördefinierade koder kan du inte använda odefinierade taggar eller värden i en resurs eller resurs grupp i prenumerationen.
...
### Microsoft. Azure. commands. taggar. Model. PSTag, Microsoft. Azure. commands. Tags
