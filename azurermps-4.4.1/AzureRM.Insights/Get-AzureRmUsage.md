...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmUsage** hämtar användnings måtten för en viss resurs.

## BESKRIVS

### Exempel 1: Hämta användnings mått efter resurs-ID
```
...
Det här kommandot får användnings måtten för den angivna webbplatsen.

## MALLPARAMETRAR

### -ApiVersion
Anger en API-sträng, till exempel 2014-04-01, som godkänns av resurs leverantören.
...
### -Slut tid
Anger senaste tid och datum för sökning.
...
### -ResourceId
Anger ID för resursen för måttet.
...
### -StartTime
Anger den tid och det datum då du vill söka.
