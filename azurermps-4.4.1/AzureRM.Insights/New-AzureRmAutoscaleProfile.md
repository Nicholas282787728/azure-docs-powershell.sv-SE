...
### Parametrar för New-AzureRmAutoscaleProfile cmdlet utan schemalagda tider
```
...
### Parametrar för New-AzureRmAutoscaleProfile cmdlet med åtgärd för fast datum
```
New-AzureRmAutoscaleProfile -Name <String> -DefaultCapacity <String> -MaximumCapacity <String>
...
### Parametrar för New-AzureRmAutoscaleProfile cmdlet med återkommande tids planering
```
New-AzureRmAutoscaleProfile -Name <String> -DefaultCapacity <String> -MaximumCapacity <String>
