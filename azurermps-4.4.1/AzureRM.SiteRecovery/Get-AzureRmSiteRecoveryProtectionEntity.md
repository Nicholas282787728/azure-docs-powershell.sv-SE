...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmSiteRecoveryProtectionEntity** hämtar en lista över skydds bara eller skyddade enheter, till exempel virtuella datorer, i det aktuella Azure Site Recovery-valvet.
...
### -FriendlyName
Anger det egna namnet på skydds enheten.
...
### -Namn
Anger namnet på skydds enheten.
...
### -ProtectionContainer
Anger Protection Container-objekt.
