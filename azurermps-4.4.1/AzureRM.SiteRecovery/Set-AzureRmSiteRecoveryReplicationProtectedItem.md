...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmSiteRecoveryReplicationProtectedItem** anger återställnings egenskaper för ett replikerat objekt.
...
### -LicenseType
Anger licens typs valet för virtuella datorer med Windows Server som migrerats genom hybrid användning.
...
### -Namn
Anger namnet på den virtuella återställnings datorn.
...
### -RecoveryNetworkId
Anger ID för det Azure Virtual Network som denna cmdlet återställer det skyddade objektet för.
...
Anger namnet på under nätet i det virtuella Recovery Azure-nätverket för vilket denna cmdlet återställer det skyddade objektet.
...
Anger det skyddade objektet för replikering av Azure Site Recovery-objekt.
