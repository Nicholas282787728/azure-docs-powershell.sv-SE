...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmSiteRecoverySite** tar bort en Azure Site Recovery-webbplats från det aktuella valvet.
...
### -Site
Anger plats objekt för webbplats återställning.
...
### ASRSite
Parametern ' site ' godkänner värdet av typen ' ASRSite ' från pipeline
