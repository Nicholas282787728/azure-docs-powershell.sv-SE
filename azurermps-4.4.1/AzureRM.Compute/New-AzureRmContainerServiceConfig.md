...
Kommandot anger olika inställningar för behållar tjänst konfigurationen.
Kommandot skickar konfigurationsobjektet till Add-AzureRmContainerServiceAgentPoolProfile cmdlet genom att använda pipeline-operatorn.
Denna cmdlet lägger till en cacheprofil för poolen.
...
### -Tagg
Anger taggar för behållar tjänsten.
