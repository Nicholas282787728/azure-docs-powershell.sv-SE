...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmSnapshotImageReference** anger bild referens egenskaperna för ett SnapShot-objekt.
...
Det första kommandot skapar ett lokalt SnapShot-objekt med storleken 10 GB i Premium_LRS lagrings konto typ.  Den anger också Windows OS-typ.
Det andra kommandot ställer in bild-ID och det logiska enhets numret 0 för objektet ögonblicks bild.
