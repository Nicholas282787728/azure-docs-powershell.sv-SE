...
### -CreateOption
Anger om den här cmdleten skapar en ögonblicks bild på den virtuella datorn från en plattform eller en användar bild, skapar en tom disk eller kopplar en befintlig disk.
