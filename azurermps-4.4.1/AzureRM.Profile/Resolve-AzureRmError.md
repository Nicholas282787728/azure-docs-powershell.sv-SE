...
## PROBLEMBESKRIVNING
Matchar och visar detaljerad information om fel i den aktuella PowerShell-sessionen, inklusive var felet uppstod i skript, stack spårning och alla inre och sammansatta undantag. För Azure PowerShell-fel finns mer information i fel sökning av tjänst problem, inklusive fullständig information om begäran och Server svaret som orsakade felet.

## BESKRIVS

### Exempel 1: Lös det senaste felet
```
...
### Exempel 2: lös alla fel i sessionen
```
...
### Exempel 3: åtgärda ett specifikt fel
```
...
Få information om det angivna felet.
...
### -Fel
En eller flera fel poster att lösa.  Om inga parametrar anges löses alla fel i sessionen.
...
### -Senaste
Lös bara det senaste felet som inträffade i sessionen.
...
Information om ett PowerShell-fel som inte inbegriper en excpetion.

### Microsoft. Azure. commands. Profile. errors. AzureExceptionRecord
Information om ett fel som innehåller detaljerad information om det undantag som utlöste felet.

### Microsoft. Azure. commands. Profile. errors. AzureRestExceptionRecord
Information om fel i cleint/server kommunikation.  Detta innehåller ofta viktig information om felet från servern.
