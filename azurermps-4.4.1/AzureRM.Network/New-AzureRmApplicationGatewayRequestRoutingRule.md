...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzureRmApplicationGatewayRequestRoutingRule** skapar en regel för en anslutningsbegäran för en Azure Application Gateway.

## BESKRIVS

### Exempel 1: skapa en regel för en anslutningsbegäran för en Programgateway
```
...
Det här kommandot skapar en grundläggande Dirigerings regel med namnet Rule01 och lagrar resultatet i variabeln som heter $Rule.

## MALLPARAMETRAR

### -BackendAddressPool
Anger backend-adresspoolen som ett objekt för regeln för att skapa en begäran.
...
Anger backend-adressens adresspool-ID för regeln för anslutningsbegäran som ska skapas.
...
### -BackendHttpSettings
Anger backend-HTTP-inställningar, som ett objekt, för regeln för anslutningsbegäran.
...
Anger backend HTTP-inställningar ID för regeln för anslutningsbegäran som ska skapas.
...
### -HttpListener
Anger den backend-HTTP-lyssnaren som regeln för anslutningsbegäran kan skapa.
...
### -HttpListenerId
Anger Server delens HTTP-lyssnar-ID för regeln för att skapa en begäran.
...
### -Namn
Anger namnet på regeln för anslutningsbegäran som denna cmdlet skapar.
...
### -RuleType
Anger typen för regeln för anslutningsbegäran.
