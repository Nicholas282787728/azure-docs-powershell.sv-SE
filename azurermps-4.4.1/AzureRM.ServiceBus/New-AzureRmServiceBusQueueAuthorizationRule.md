...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmServiceBusQueueAuthorizationRule** skapar en ny auktoriseringsregel för den angivna tjänst buss kön.
...
Skapar en auktoriseringsregel `SBAuthoRule1` med behörigheten **lyssna och skicka** för kön `SB-Queue_exampl1` .
...
### -Rättigheter
Anger rättigheterna; till exempel:  
@ ("Lyssna", "Skicka", "hantera")
