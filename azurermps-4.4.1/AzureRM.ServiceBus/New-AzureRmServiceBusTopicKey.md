...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmServiceBusTopicKey** skapar en ny primär eller sekundär anslutnings sträng för det angivna tjänst buss ämnet och auktoriseringsregeln.
...
Återskapar den primära anslutnings strängen för namn området.
...
Återskapar sekundär anslutnings strängen för namn området.

## MALLPARAMETRAR

### -RegenerateKeys
Anger om primära eller sekundära nycklar ska återskapas.
