...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmServiceBusTopicAuthorizationRule** uppdaterar beskrivningen för den angivna auktoriseringsregeln för den angivna tjänst Bus artikeln.
...
Lägger **till behörigheter för** behörighets regeln `SBTopicAuthoRule1` i avsnittet `SB-Topic_exampl1` .
...
### -InputObj
ServiceBus ämne AuthorizationRule objekt.
