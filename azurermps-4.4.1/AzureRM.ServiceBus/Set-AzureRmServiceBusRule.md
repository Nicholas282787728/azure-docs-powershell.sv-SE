...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmServiceBusRule** uppdaterar beskrivningen för den angivna regeln för angiven prenumeration.
...
uppdaterar sqlexpression **mysqlexpression = ' villkor** för regeln `SBEule` för abonnemanget `SBSubscription` i ämnet `SBTopic`
