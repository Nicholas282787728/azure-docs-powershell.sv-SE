...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmServiceBusTopicAuthorizationRule** tar bort auktoriseringsregeln för ett ämne från det angivna tjänst buss namn området.
...
Tar bort auktoriseringsregeln `SBTopicAuthoRule1` för avsnittet `SB-Topic_exampl1` från namn området `SB-Example1` .
...
### -Namn
Ämnes namn för AuthorizationRule.
