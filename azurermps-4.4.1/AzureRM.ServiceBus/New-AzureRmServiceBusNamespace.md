...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmServiceBusNamespace** skapar ett nytt Service Bus-namnområde. När namn rymds resursens manifest har skapats är det oföränderligt. Denna åtgärd är idempotent.
