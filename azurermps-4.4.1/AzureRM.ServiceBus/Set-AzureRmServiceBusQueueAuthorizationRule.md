...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmServiceBusQueueAuthorizationRule** uppdaterar beskrivningen för den angivna auktoriseringsregeln för den angivna tjänst buss kön.
...
Lägger **till behörigheter för** behörighets reglerna för `SBAuthoRule1` kön `SB-Queue_exampl1` .

## MALLPARAMETRAR

### -AuthorizationRuleName
Namn på auktoriseringsregeln. Obligatoriskt om **-AuthruleObj** inte har angetts.
...
### -AuthRuleObj
Objektet för auktoriseringsregeln för Service Bus Queue.
...
### -Rättigheter
Rättigheterna; till exempel @ ("lyssna", "Skicka", "hantera"). Obligatoriskt om ' AuthruleObj ' inte har angetts.
