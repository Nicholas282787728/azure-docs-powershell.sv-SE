...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmContainerRegistry** skapar en container-registrering.
...
### -Tagg
Register märken för behållare. nyckel värde par i form av en hash-tabell. Till exempel:
