...
### Parameter uppsättning för fält parametrar
```
...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmCdnEndpoint** tar bort en slut punkt för Azure Content Delivery Network (CDN).
...
### -CdnEndpoint
Anger slut punkten som den här cmdleten tar bort.
...
### -EndpointName
Anger namnet på den slut punkt som denna cmdlet tar bort.
