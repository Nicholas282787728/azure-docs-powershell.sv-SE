...
Om du vill skapa en händelse prenumeration till en Azure-resurs som stöds anger du resursens fullständiga resurs-ID. Kör cmdleten Get-AzureRmEventGridTopicType om du vill visa listan över typer som stöds.
