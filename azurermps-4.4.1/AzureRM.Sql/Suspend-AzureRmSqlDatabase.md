...
## PROBLEMBESKRIVNING
Cmdleten **suspend-AzureRmSqlDatabase** inaktive ras en Azure SQL Data Warehouse-databas.

## BESKRIVS

### Exempel 1: inaktiverar en Azure SQL Data Warehouse-databas
```
PS C:\>Suspend-AzureRmSqlDatabase -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

Det här kommandot gör att en Active Azure SQL Data Warehouse-databas stoppas.

## MALLPARAMETRAR

### -DatabaseName
Anger namnet på den databas som denna cmdlet gör paus för.
...
## ANMÄRKNINGAR
* Cmdleten **suspend-AzureRmSqlDatabase** fungerar bara i Azure SQL Data Warehouse-databaser. Den här åtgärden stöds inte i SQL-databaserna Basic, standard och Premium.
