...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmSqlServerRecommendedAction** har en eller flera rekommenderade åtgärder för en Azure SQL Server Advisor.

## BESKRIVS

### Exempel 1: få en lista över alla rekommenderade åtgärder för en viss rådgivare
```
...
Det här kommandot får en lista över alla rekommenderade åtgärder för SQL Server Advisor med namnet CreateIndex tillgängligt för servern med namnet Wi-löpare-Australien-öst.
...
Med det här kommandot får du en Rekommenderad åtgärd som heter IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893 från rådgivaren CreateIndex.

## MALLPARAMETRAR

### -AdvisorName
Anger namnet på den rådgivare för vilken denna cmdlet begär åtgärder.
...
### -ResourceGroupName
Anger namnet på resurs gruppen för den server som innehåller servern.
...
### -ServerName
Anger namnet på den server som Advisor tillhör.
