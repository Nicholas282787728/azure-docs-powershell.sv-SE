...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmSqlCapability** hämtar de tillgängliga Azure SQL-databas funktionerna för en region.
...
Mer information finns i Azure-regioner https://azure.microsoft.com/en-us/regions/ ( https://azure.microsoft.com/en-us/regions/) .
