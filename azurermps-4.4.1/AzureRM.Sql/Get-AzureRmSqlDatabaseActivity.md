...
## Sammanfattning
Hämtar status för elastiska databaser.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmSqlDatabaseActivity** får statusen för elastiska databaser som flyttas in i eller ut ur en Elastic Database-pool i Azure SQL Database.
...
### -ServerName
Anger namnet på den Microsoft SQL Server som är värd för den Elastic Database-poolen.
