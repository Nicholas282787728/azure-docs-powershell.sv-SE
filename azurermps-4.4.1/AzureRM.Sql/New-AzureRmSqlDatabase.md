...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmSqlDatabase** skapar en Azure SQL-databas.
...
Det här kommandot skapar en databas med namnet Database01 i den Elastic pool som heter ElasticPool01 på Server Server01.
...
### -Taggar
Anger en ord lista med par med nyckelord i form av en hash-tabell som denna cmdlet associerar med den nya databasen. Till exempel:
