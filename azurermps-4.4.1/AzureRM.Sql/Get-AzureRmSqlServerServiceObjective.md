...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmSqlServerServiceObjective** hämtar de tillgängliga tjänst målen för en Azure SQL Database-Server.
...
Med det här kommandot får du tjänst målen för servern med namnet Server01 och databasen med namnet Database01.

## MALLPARAMETRAR

### -DatabaseName
Anger namnet på en Azure SQL-databas.
