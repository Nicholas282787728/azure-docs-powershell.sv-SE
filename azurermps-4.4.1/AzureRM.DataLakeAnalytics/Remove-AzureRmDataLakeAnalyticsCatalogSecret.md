...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmDataLakeAnalyticsCatalogSecret** tar bort en Azure Data Lake Analytics-katalog hemlighet.

## BESKRIVS

### Exempel 1: ta bort en hemlighet
```
PS C:\>Remove-AzureRmDataLakeAnalyticsCatalogSecret -Account "ContosoAdla" -DatabaseName "DatabaseName" -Name "SecretName"
```

Det här kommandot tar bort den angivna data Lake-katalog hemligheten.
