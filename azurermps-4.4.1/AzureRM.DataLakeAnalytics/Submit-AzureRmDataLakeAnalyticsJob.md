...
### Skicka jobb med skript Sök väg för U-SQL
```
...
### Skicka jobb med skript Sök väg för U-SQL med reucurrence information
```
Submit-AzureRmDataLakeAnalyticsJob [-Account] <String> [-Name] <String> [-ScriptPath] <String>
 [[-Runtime] <String>] [[-CompileMode] <String>] [-CompileOnly] [[-DegreeOfParallelism] <Int32>]
...
### Skicka U-SQL-jobb med upprepnings information
```
Submit-AzureRmDataLakeAnalyticsJob [-Account] <String> [-Name] <String> [-Script] <String>
 [[-Runtime] <String>] [[-CompileMode] <String>] [-CompileOnly] [[-DegreeOfParallelism] <Int32>]
 [[-Priority] <Int32>] -RecurrenceId <Guid> [-RecurrenceName <String>]
...
### Skicka jobb med skript Sök väg för U-SQL med reucurrence och pipeline-uppgifter
```
Submit-AzureRmDataLakeAnalyticsJob [-Account] <String> [-Name] <String> [-ScriptPath] <String>
 [[-Runtime] <String>] [[-CompileMode] <String>] [-CompileOnly] [[-DegreeOfParallelism] <Int32>]
...
### Skicka U-SQL-jobb med information om upprepning och pipeline
```
Submit-AzureRmDataLakeAnalyticsJob [-Account] <String> [-Name] <String> [-Script] <String>
 [[-Runtime] <String>] [[-CompileMode] <String>] [-CompileOnly] [[-DegreeOfParallelism] <Int32>]
 [[-Priority] <Int32>] -RecurrenceId <Guid> [-RecurrenceName <String>] -PipelineId <Guid>
...
### -CompileOnly
Anger att denna cmdlet kompilerar jobbet utan att köra det.
...
### -DegreeOfParallelism
Anger de data Lake Analytics-enheter (DLAU) för jobbet, vilket anger det högsta tillåtna parallellt för jobbet.
...
Om det inte anges är prioriteten 1000.
Ett lågt nummer indikerar en högre jobb prioritet.
...
### -Runtime
Anger kör tids versionen för jobbet.
...
### -Skript
Anger innehållet i det skript som ska köras.
...
### -ScriptPath
Anger den lokala fil Sök vägen till det skript som ska köras.
