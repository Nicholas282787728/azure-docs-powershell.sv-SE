...
## PROBLEMBESKRIVNING
Exporterar definitionsfiler för den angivna webb serving som en JSON-formaterad sträng.
Du kan returnera strängen direkt eller spara den i en fil.

## BESKRIVS

### --------------------------Exempel 1: exportera som sträng--------------------------
@ {paragraf = PS C: \\ \> }
...
### -Utdatafil
Sökvägen till den exporterade definitionen.
...
### -ToJsonString
Anger att definitionen exporteras som en JSON-sträng.
...
### -Webservice
Webb tjänst definitions objekt som ska exporteras.
...
### Webb tjänst
Parametern "WebService" accepterar värdet för typen "WebService" från pipeline
