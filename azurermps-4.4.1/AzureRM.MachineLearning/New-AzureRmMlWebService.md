...
### Skapa en ny Azure ML-webtjänst från en JSON Definiton-fil.
```
...
### --------------------------Exempel 1: skapa en ny tjänst från en JSON-baserad definition--------------------------
@ {paragraf = PS C: \\ \> }
...
### Webb tjänst
Parametern ' NewWebServiceDefinition ' godkänner värdet för typen "WebService" från pipeline
