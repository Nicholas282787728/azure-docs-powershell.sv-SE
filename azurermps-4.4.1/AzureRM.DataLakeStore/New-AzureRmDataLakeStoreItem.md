...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmDataLakeStoreItem** skapar en ny fil eller mapp i data Lake Store.

## BESKRIVS

### Exempel 1: skapa en ny fil och en ny mapp
```
PS C:\>New-AzureRmDataLakeStoreItem -AccountName "ContosoADL" -Path "/NewFile.txt"
PS C:\> New-AzureRmDataLakeStoreItem -AccountName "ContosoADL" -Path "/NewFolder" -Folder
```

Det första kommandot skapar filen NewFile.txt för det angivna kontot.

Det andra kommandot skapar mappen NewFolder i rotmappen.
...
### -Mappen
Anger att den här åtgärden skapar en mapp.
...
### -Force
Anger att den här åtgärden kan skriva över målobjektet om det redan finns.
...
### -Path
Anger data Lake Store-sökvägen för det objekt som ska skapas, från rot katalogen (/).
...
### -Värde
Anger vilket innehåll som ska läggas till i det objekt som du skapar.
...
### Serverobjektet
Parametern ' värde ' godkänner värdet för typen ' object ' från pipeline

## VÄRDEN

### strängvärdet
Den fullständiga sökvägen till den skapade filen eller mappen.
