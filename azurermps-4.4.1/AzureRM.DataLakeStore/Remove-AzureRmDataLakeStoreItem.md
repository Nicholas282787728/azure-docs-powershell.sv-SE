...
### -Rengör
Indikerar att den här åtgärden tar bort allt innehåll i målmappen och behåller mappen.
Använd den här parametern med parametern *recurse* .
...
Om du inte anger parametern *rengör* tas även målmappen bort.
...
### bool
Om PassThru anges returnerar resultatet av åtgärden.
