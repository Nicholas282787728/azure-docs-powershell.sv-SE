...
## PROBLEMBESKRIVNING
Cmdleten **Move-AzureRmDataLakeStoreItem** flyttar eller byter namn på en fil eller mapp i data Lake Store.
...
### strängvärdet
Den fullständiga sökvägen till den flyttade filen eller mappen.
