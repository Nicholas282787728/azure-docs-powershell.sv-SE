...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzureRmDataLakeStoreFirewallRule** lägger till en brand Väggs regel i det angivna data Lake Store-kontot.

## BESKRIVS

### Exempel 1: lägga till en ny brand Väggs regel i ett data Lake Store-konto
```
...
Detta skapar en ny brand Väggs regel som heter "min regel" i kontot "ContosoADL" med ett IP-intervall på 127.0.0.1-127.0.0.2

## MALLPARAMETRAR

### -Konto
Data Lake Store-konto för att lägga till brand Väggs regeln i
...
### -EndIpAddress
Slutet på det giltiga IP-intervallet för brand Väggs regeln
...
### -Namn
Namnet på den brand Väggs regel som ska läggas till.
...
### -ResourceGroupName
Namnet på den resurs grupp under vilken kontot för att lägga till brand Väggs regeln är.
...
### -StartIpAddress
Början på det giltiga IP-intervallet för brand Väggs regeln
...
Brand Väggs regeln som har lagts till.
