...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmBatchAccount** får ett Azure Batch-konto i det aktuella abonnemanget. Du kan använda parametern *AccountName* för att få ett enskilt konto, eller så kan du använda parametern *ResourceGroupName* för att hämta konton under den resurs gruppen.
...
Denna cmdlet hämtar konton som innehåller de taggar som den här parametern anger.
