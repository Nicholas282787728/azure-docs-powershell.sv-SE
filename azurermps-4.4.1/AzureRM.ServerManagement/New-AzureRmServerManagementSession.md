...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmServerManagementSession** skapar en Azure Server Management-session.
...
Anger ett **PSCredential** -objekt för anslutningen till Server hanterings sessionen.
...
### -Nod
Anger den nod som den här cmdleten skapar sessionen för.
...
### -Nodnamn
Anger namnet på den nod som den här cmdleten skapar en session för.
...
### -ResourceGroupName
Anger resurs gruppen för den nod som denna cmdlet skapar en session för.
...
### -Sessionsnamn
Anger det namn som ska användas för sessionen.
