...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureStorageContainerStoredAccessPolicy** anger en lagrad åtkomst princip för en Azure Storage-behållare.

## BESKRIVS

### Exempel 1: Ange en lagrad åtkomst princip i en lagrings behållare med fullständig behörighet
```
PS C:\>Set-AzureStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy06" -Permission rwdl
```

Det här kommandot anger en åtkomst princip med namnet Policy06 för Storage container med namnet $.
...
### -NoStartTime
Anger start tiden som ska $Null.
...
### -Tillstånd
Anger behörigheter i den lagrade åtkomst principen för att komma åt lagrings behållaren.
...
Parametern "container" accepterar värdet för typen String från pipeline
