...
## PROBLEMBESKRIVNING
Cmdleten **restart-AzureRmWebApp** stoppar och startar sedan en Azure Web App.
Om webb programmet är i ett stoppat tillstånd kan du använda Start-AzureRmWebApp cmdlet.
