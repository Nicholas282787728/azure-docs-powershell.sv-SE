...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmApiManagement** tar bort en Azure API Management-tjänst.

## BESKRIVS

### Exempel 1: ta bort en API-hanterings tjänst
```
PS C:\>Remove-AzureRmApiManagement -ResourceGroupName "ContosoGroup02" -Name "ContosoApi"
```

Det här kommandot tar bort API-hanteringskonsolen med namnet ContosoApi.

## MALLPARAMETRAR

### -Namn
Anger namnet på den API-hanterings distribution som cmdleten tar bort.
...
### -PassThru
Anger att den här cmdleten returnerar ett värde för $True om åtgärden lyckas.
