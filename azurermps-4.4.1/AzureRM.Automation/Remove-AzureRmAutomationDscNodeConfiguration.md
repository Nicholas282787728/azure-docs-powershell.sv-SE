...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmAutomationDscNodeConfiguration** tar bort metadata från DSC-nodkonfigurationer (önskad tillstånd Configuration) i Azure Automation.
...
[Azure Automation-cmdletar](./AzureRM.Automation.md)
