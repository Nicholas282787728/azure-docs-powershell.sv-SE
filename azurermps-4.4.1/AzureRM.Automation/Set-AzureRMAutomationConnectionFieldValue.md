...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmAutomationConnectionFieldValue** ändrar värdet för ett fält i en anslutning i Azure Automation.

## BESKRIVS

### Exempel 1: ändra ett fält värde i en anslutning
```
...
Det här kommandot ändrar prenumerations-ID för Azure-anslutningen som heter ContosoConnection i Automation-kontot med namnet AutomationAccount01.

## MALLPARAMETRAR

### -AutomationAccountName
Anger namnet på det Automation-konto som denna cmdlet ändrar ett fält i en anslutning till.
...
### -ConnectionFieldName
Anger ett namn för fältet som denna cmdlet ändrar.
...
### -Namn
Anger ett namn för den anslutning där denna cmdlet ändrar ett fält.
...
### -ResourceGroupName
Anger namnet på den resurs grupp för vilken denna cmdlet ändrar ett fält i en anslutning.
...
### -Värde
Anger det värde som ska ändras i fältet Connection.
