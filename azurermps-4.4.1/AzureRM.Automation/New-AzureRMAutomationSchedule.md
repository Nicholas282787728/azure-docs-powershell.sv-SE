...
## PROBLEMBESKRIVNING
**New-AzureRmAutomationSchedule-** cmdleten skapar ett schema i Azure Automation.
...
Med kommandot slut skapas ett dagligt schema med namnet Schedule01 som börjar vid den tid som lagras i $StartDate och upphör vid den tid som lagras i $EndDate.
...
### -ExpiryTime
Anger utgångs tiden för ett schema som ett **DateTimeOffest** -objekt.
