...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmAutomationSchedule** tar bort ett schema från Azure Automation.
...
Anger namnet på ett Automation-konto som denna cmdlet ändrar ett schema för.
