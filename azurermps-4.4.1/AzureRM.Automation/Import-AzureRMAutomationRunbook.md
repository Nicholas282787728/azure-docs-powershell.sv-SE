...
## PROBLEMBESKRIVNING
Cmdleten **import-AzureRmAutomationRunbook** importerar en Azure Automation-Runbook. Ange sökvägen till en wps_2-skriptfil (. ps1) som du vill importera för wps_2 och wps_2 arbets flödes-eller graphrunbook-filer för grafiska runbooks. Namnet på filen blir namnet på Runbook-flödet. För wps_2 arbets flödes Runbooks måste skriptet innehålla en enda wps_2 arbets flödes definition som matchar namnet på filen.
