...
## PROBLEMBESKRIVNING
**Register-AzureRmAutomationDscNode** cmdlet registrerar en virtuell Azure-dator som en DSC-nod (önskad tillstånds konfiguration) i ett Azure Automation-konto.
...
### -AzureVMLocation
Anger den plats där denna cmdlet registrerar en virtuell dator.
...
### -AzureVMName
Anger namnet på den virtuella Azure-datorn som denna cmdlet registrerar för Management.
...
Anger namnet på resurs gruppen för den virtuella Azure-datorn som denna cmdlet registrerar.
