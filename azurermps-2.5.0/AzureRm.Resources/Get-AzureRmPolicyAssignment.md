...
Det första kommandot får en resurs grupp som heter ResourceGroup11 genom att använda Get-AzureRMResourceGroup cmdletand lagrar den i $ResourceGroup variabeln.
