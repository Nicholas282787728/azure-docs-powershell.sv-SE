...
## PROBLEMBESKRIVNING
**Växeln AzureRmWebAppSlot** växlar två platser associerade med en Azure Web App.
...
Det här kommandot växlar plats "sourceslot"-fack med "destinationslot" för webb programmet ContosoWebApp associerat med resurs gruppens standard-väst
...
Byt med förhands gransknings åtgärd
