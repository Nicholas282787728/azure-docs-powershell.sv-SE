...
## PROBLEMBESKRIVNING
Get-AzureRmNetworkWatcherPacketCapture hämtar egenskaper och status för en paket infångnings resurs.
...
I det här exemplet skapar vi en paket avbildning med namnet "PacketCaptureTest" med flera filter och en tids gräns. När sessionen är klar sparas den till det angivna lagrings kontot. Vi ringer sedan Get-AzureRmNetworkWatcherPacketCapture för att hämta statusen för insamlingsbufferten. 
