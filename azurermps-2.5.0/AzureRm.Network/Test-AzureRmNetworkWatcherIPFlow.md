...
## PROBLEMBESKRIVNING
Test-AzureRmNetworkWatcherIPFlow cmdlet för en viss VM-resurs och ett paket med angiven riktning med lokala och fjärr-IP-adresser och portar, returnerar eller nekar paketet.

## BESKRIVS

### ---Exempel 1: kör Test-AzureRmNetworkWatcherIPFlow---
```
...
Får nätverks tittaren i västra central för det här abonnemanget och hämtar sedan den virtuella datorn och dess associerade nätverks gränssnitt. För det första nätverks gränssnittet körs Test-AzureRmNetworkWatcherIPFlow med den första IP-adressen från det första nätverks gränssnittet för en utgående anslutning till en IP-adress på Internet.
...
### Microsoft. Azure. commands. Networks. Models. PSIPFlowVerifyResult
