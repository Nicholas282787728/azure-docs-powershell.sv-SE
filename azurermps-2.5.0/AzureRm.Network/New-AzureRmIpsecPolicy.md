...
## PROBLEMBESKRIVNING
New-AzureRmIpsecPolicy-cmdleten skapar ett abonnemang för IPSec-principer som ska användas i en anslutning till en virtuell nätverksgateway.
...
### -IkeIntegrity
IKE-integritetsalgoritmen (IKE Phase 2)
