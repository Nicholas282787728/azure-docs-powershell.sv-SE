...
## PROBLEMBESKRIVNING
Get-AzureRmNetworkWatcherTopology cmdlet en nätverks nivå med resurser och deras relationer i en resurs grupp. OBS! om resurser från flera regioner lagras i resurs gruppen är det bara resurserna i samma område som nätverks Watchen som visas i JSON-utdata.

## BESKRIVS

### --------------------------Exempel 1: skaffa en Azure-topologi--------------------------
```
...
I det här exemplet kör vi Get-AzureRmNetworkWatcherTopology cmdlet för en resurs grupp som innehåller en VM, NIC, NSG och offentlig IP.
...
### Microsoft. Azure. commands. Networks. Models. PSTopology

## ANMÄRKNINGAR
Nyckelord: Azure, azurerm, arm, resurs, hantering, chef, nätverk, nätverk, nätverks bevakning, topologi, vy 
