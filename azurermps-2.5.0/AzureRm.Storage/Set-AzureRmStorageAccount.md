...
Om du ändrar åtkomst nivån kan det leda till extra avgifter. Mer information finns i [Azure Blob Storage: varmt och coolda lagrings nivåer](https://go.microsoft.com/fwlink/?LinkId=786482).
