...
Om du vill kontrol lera om den här cmdleten frågar dig för comfirmation använder du parametern *Confirm* .
...
SOA-poster skapas automatiskt när zonen skapas och kan inte skapas manuellt.
...
Denna cmdlet returnerar ett **Recordset** -objekt.
