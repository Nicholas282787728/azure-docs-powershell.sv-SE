...
Skapa en abonnemangs plan.

## MALLPARAMETRAR

### -AcquiredPlanDefinition
För att konstruera kan du läsa avsnittet anteckningar för ACQUIREDPLANDEFINITION-egenskaper och skapa en hash-tabell.
...
ACQUIREDPLANDEFINITION <IPlanAcquisition> : 
  - `[AcquisitionId <String>]`: Anskaffnings-ID.
  - `[AcquisitionTime <DateTime?>]`: Anskaffnings tid.
  - `[ExternalReferenceId <String>]`: Identifierare för extern referens.
  - `[Id <String>]`: ID i kontext för klient organisationens prenumeration.
  - `[PlanId <String>]`: Planera identifierare i kontexten för klient organisations prenumeration.
  - `[ProvisioningState <ProvisioningState?>]`: Etablerings status.
