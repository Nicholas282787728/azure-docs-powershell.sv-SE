...
Laddar upp TestUbuntu. test. 1.0.0 i galleriet.
...
### -GalleryItemUri
URI för ditt Galleri paket som redan har laddats upp online.
...
Plats för nytto last för Galleri objekt.
För att konstruera kan du läsa avsnittet anteckningar för GALLERYITEMURIPAYLOAD-egenskaper och skapa en hash-tabell.
...
GALLERYITEMURIPAYLOAD <IGalleryItemUriPayload> : plats för nytto last för Galleri objekt.
  - `[GalleryItemUri <String>]`: URI för ditt Galleri paket som redan har laddats upp online.
