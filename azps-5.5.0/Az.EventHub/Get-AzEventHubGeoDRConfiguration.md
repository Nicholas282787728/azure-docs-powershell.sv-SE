...
## BESKRIVNING
**Get-AzEventHubGeoDRConfiguration** Retrieves Alias(Disaster Recovery configuration) för primärt eller sekundärt namnområde
...
Hämtar aliaskonfigurationen "SampleDRConfigName" för det primära namnområdet "SampleNamespace_Primary"
