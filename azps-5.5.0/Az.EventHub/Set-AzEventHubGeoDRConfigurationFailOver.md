...
## BESKRIVNING
**Set-AzEventHubGeoDRConfigurationFailOver-cmdleten** anropar GEO DR-redundans och konfigurerar om aliaset så att det pekar på det sekundära namnområdet
