...
ms.locfileid: "100234431"
---
# Remove-AzEventHubVirtualNetworkRule

## SYNOPSIS
Tar bort den enstaka angivna VirtualNetworkRule för NetworkRuleSet i namnområdet
...
Ta bort $virtualruleset 1 av NetworkRuleSet för det angivna namnområdet
