...
## BESKRIVNING
Cmdlet Set-AzEventHubAuthorizationRule uppdaterar den angivna auktoriseringsregeln för den givna händelsehubben.
...
Uppdaterar auktoriseringsregeln MyAuthRuleName för att bevilja behörighet att hantera rättigheter till Händelsehubben \` \` \` MyEventHubName, som omfattas av \` namnområdet \` MyNamespaceName. \`
