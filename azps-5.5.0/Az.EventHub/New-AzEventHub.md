...
## BESKRIVNING
Med New-AzEventHub-cmdleten skapas ett nytt Azure Event Hub.
Följ stegen nedan (exempel 2) om du vill skapa Händelsehubben med egenskaper för inspelningsbeskrivning. 
...
Skapar ett händelsenav med namnet MyEventHubName med en 3-dagars bevarandeperiod för meddelanden och två partitioner, på WestUS-platsen, med resursgruppen \` \` \` \` \` MyResourceGroupName. \`
...
Skapar ett händelsenav med namnet MyEventHubName med en 3-dagars bevarandeperiod för \` \` meddelanden, 2 partitioner och CaptureDescription-egenskaper på WestUS-platsen med resursgruppen \` \` \` MyResourceGroupName. \`
...
Bevarande av eventhub-meddelanden i dagar
