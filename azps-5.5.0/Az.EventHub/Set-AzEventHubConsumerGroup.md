...
## BESKRIVNING
Cmdlet Set-AzEventHubConsumerGroup uppdaterar den angivna konsumentgruppen Event Hubs.
...
Anger användarmetadata för \` konsumentgruppen MyConsumerGroupName \` till "Testar".
...
### -UserMetadata
Användarmetadata för Konsumentgrupp
