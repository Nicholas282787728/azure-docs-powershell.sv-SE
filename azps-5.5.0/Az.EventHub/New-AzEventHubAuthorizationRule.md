...
## BESKRIVNING
Med New-AzEventHubAuthorizationRule-cmdleten skapas en ny auktoriseringsregel för Händelsehubben.
...
Skapar en auktoriseringsregel, MyAuthRuleName som beviljar behörigheten Lyssna och Skicka till namnområdet MyNamespaceName, med resursgruppen \` \` \` \` \` MyResourceGroupName. \`
...
Skapar en auktoriseringsregel, MyAuthRuleName som beviljar behörigheten Lyssna och Skicka till Händelsehubben \` \` \` MyEventHubName i \` namnområdet MyNamespaceName, med resursgruppen \` \` \` MyResourceGroupName. \`
