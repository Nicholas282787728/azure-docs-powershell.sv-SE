...
Skapar konsumentgruppen MyConsumerGroupName i Händelsehubben \` \` \` MyEventHubName, begränsad till \` namnområdet MyNamespaceName, med resursgruppen \` \` \` MyResourceGroupName. \`
