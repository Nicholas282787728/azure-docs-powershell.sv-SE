...
ms.locfileid: "100228455"
---
# New-AzEventHubAuthorizationRuleSASToken

## SYNOPSIS
Genererar en SAS-token för Azure eventhub-auktoriseringsregel för namnområde/eventhub. 
...
## BESKRIVNING
Cmdlet New-AzEventHubAuthorizationRuleSASToken genererar en SAS-token (Shared Access Signature) för en Azure Eventhub-namneapce eller Azure Eventhub
...
Generera SAS token för den givna redigeringsregeln för Namnområde med start- och utgångstid.
...
Generera SAS token för den givna redigeringsregeln för Namnområde med utgångstid.

## PARAMETERS

### -AuthorizationRuleId
ARM ResourceId för auktoriseringsregeln
