...
## BESKRIVNING
Cmdleten New-AzEventHubKey omgenererar primär eller sekundär SAS-nyckel för den angivna auktoriseringsregeln för Event Hubs.

## EXEMPEL

### Exempel 1: Namnområde – AuthorizationRule PrimaryKey
```powershell
PS C:\> New-AzEventHubKey -ResourceGroup MyResourceGroupName -Namespace MyNamespaceName -Name MyAuthRuleName -RegenerateKey PrimaryKey
```

Återskapar primärnyckeln för auktoriseringsregeln \` MyAuthRuleName. \`
...
Återskapar sekundärnyckeln för auktoriseringsregeln \` MyAuthRuleName. \`
