...
## BESKRIVNING
**Cmdleten New-AzEventHubGeoDRConfiguration** skapar ett nytt alias(katastrofåterställningskonfiguration)
...
Skapar ett alias "SampleDRConfigName" med primärt namnområde "SampleNamespace_Primary" med sekundärt namnområde "SampleNamespace_Secondary"

## PARAMETERS

### -AlternateName
AlternateName krävs när DR-konfigurationsnamn är samma som primärt namnområde
