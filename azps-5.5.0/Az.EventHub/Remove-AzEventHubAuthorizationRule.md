...
## BESKRIVNING
Med Remove-AzEventHubAuthorizationRule-cmdleten tas den angivna auktoriseringsregeln bort från det angivna händelsehubben.
...
Tar bort auktoriseringsregeln \` MyAuthRuleName \` från Namnområdet \` MyNamespaceName. \`
...
Tar bort auktoriseringsregeln \` MyAuthRuleName \` från Händelsehubben \` MyEventHubName. \`
