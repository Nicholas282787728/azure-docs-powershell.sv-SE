...
## BESKRIVNING
Cmdleten **Add-AzDataLakeStoreVirtualNetworkRule** lägger till en virtuell nätverksregel i det angivna Data Lake Store-kontot.
...
Detta skapar en ny virtuell nätverksregel som kallas "myVNET" i kontot "dls" med ett undernäts-ID "testId"

## PARAMETERS

### -Konto
Data Lake Store-kontot som du vill lägga till regeln för virtuellt nätverk i
...
### -SubnetId
Undernätsid för regeln för virtuellt nätverk
