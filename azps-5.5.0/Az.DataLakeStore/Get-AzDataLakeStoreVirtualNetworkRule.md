...
## BESKRIVNING
Med Get-AzDataLakeStoreVirtualNetworkRule-cmdleten får du de angivna reglerna för virtuella nätverk i den angivna Data Lake Store.
Om ingen regel för virtuellt nätverk anges visas alla regler för det virtuella nätverket för kontot.
...
Returnerar den virtuella nätverksregeln med namnet "myVNET" från kontot "dls"

## PARAMETERS

### -Konto
Kontot för Data Lake Store för att få regeln om virtuellt nätverk från
