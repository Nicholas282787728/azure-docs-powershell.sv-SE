...
## BESKRIVNING
Cmdleten **Set-AzDataLakeStoreTrustedIdProvider** ändrar den angivna betrodda identitetsleverantören i den angivna Data Lake Store.

## EXEMPEL

### Exempel 1: Uppdatera en slutpunkt för betrodd identitetsprovider
```
...
Det här uppdaterar providerslutpunkten för brandväggsregeln "MyProvider" i kontot "ContosoADL" till https://sts.windows.net/6b04908c-b91f-40ce-8024-7ee8a4fd6150 " "

## PARAMETERS

### -Konto
Data Lake Store-kontot som du vill lägga till den betrodda identitetsleverantören i
...
### -ResourceGroupName
Anger namnet på den resursgrupp som innehåller kontot som identitetsleverantören ska uppdateras för.
