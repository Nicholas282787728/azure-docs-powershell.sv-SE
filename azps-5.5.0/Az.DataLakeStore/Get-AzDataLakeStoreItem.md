...
## BESKRIVNING
Cmdleten **Get-AzDataLakeStoreItem** hämtar information om en fil eller mapp i Data Lake Store.
...
Med det här kommandot hämtar du information Test.csv filen från Data Lake Store.
...
### -Path
Anger data lake store-sökvägen som du vill hämta information om ett objekt från, med början i rotkatalogen (/).
