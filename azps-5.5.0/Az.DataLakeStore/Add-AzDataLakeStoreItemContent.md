...
## BESKRIVNING
**Cmdleten Add-AzDataLakeStoreItemContent** lägger till innehåll till ett objekt i en Azure Data Lake Store.
...
Med det här kommandot läggs innehåll till i myFile.txt.
...
### -Värde
Anger innehållet som ska läggas till i objektet.
