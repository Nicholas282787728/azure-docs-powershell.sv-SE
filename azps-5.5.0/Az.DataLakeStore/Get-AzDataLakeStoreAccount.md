...
## BESKRIVNING
Cmdleten **Get-AzDataLakeStoreAccount** får information om ett Data Lake Store-konto.

## EXEMPEL

### Exempel 1: Hämta ett Data Lake Store-konto
```
...
### -Name
Anger namnet på det konto som ska hämtas.
...
### -ResourceGroupName
Anger namnet på resursgruppen som innehåller det Data Lake Store-konto som ska hämtas.
