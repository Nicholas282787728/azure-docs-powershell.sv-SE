...
Med det här kommandot skapas ett Data Lake Store-konto med namnet ContosoADL för platsen östra USA 2.

## PARAMETERS

### -DefaultGroup
Anger objekt-ID för AzureActive Directory-gruppen som ska användas som standardgruppägare för nya filer och mappar.
...
### -DisableEncryption
Anger att kontot inte har någon form av kryptering tillämpad på det.
...
### -Plats
Anger platsen som kontot ska användas till.
...
### -ResourceGroupName
Anger namnet på den resursgrupp som innehåller kontot.
