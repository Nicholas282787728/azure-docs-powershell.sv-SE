...
## BESKRIVNING
Cmdleten **Get-AzDataLakeStoreItemPermission** får behörigheten oktal för en fil eller mapp i Data Lake Store.

## EXEMPEL

### Exempel 1: Ange behörigheten för en fil
```
PS C:\>Get-AzDataLakeStoreItemPermission -AccountName "ContosoADL" -Path "/file.txt"
```

Det här kommandot får behörigheten oktal för en fil.
