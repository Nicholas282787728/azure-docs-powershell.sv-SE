...
ms.locfileid: "100232190"
---
# Set-AzDataLakeStoreVirtualNetworkRule

## SYNOPSIS
Ändrar den angivna regeln för virtuellt nätverk i den angivna Data Lake Store.
...
## BESKRIVNING
Cmdleten **Set-AzDataLakeStoreVirtualNetworkRule** ändrar den angivna virtuella nätverksregeln i den angivna Data Lake Store.
...
Uppdaterar undernäts-ID för regeln "myVNET" i kontot "dls" till "updatedId"

## PARAMETERS

### -Konto
Data Lake Store-kontot som du vill uppdatera regeln för virtuella nätverk i
...
### -SubnetId
Början av det giltiga IP-intervallet för regeln för det virtuella nätverket
