...
## BESKRIVNING
**Cmdleten Add-AzDataLakeStoreTrustedIdProvider** lägger till en betrodd identitetsprovider i det angivna Data Lake Store-kontot.

## EXEMPEL

### Exempel 1: Lägga till en betrodd identitetsprovider
```
...
Lägger till leverantören "MyProvider" i kontot "ContosoADL" med leverantörsslutpunkten https://sts.windows.net/6b04908c-b91f-40ce-8024-7ee8a4fd6150 " "

## PARAMETERS

### -Konto
Namnet på det Data Lake Store-konto som du vill lägga till den angivna betrodda identitetsleverantören i.
...
### -Name
Namnet på den betrodda identitetsprovider som ska läggas till
...
### -ProviderEndpoint
Den giltiga slutpunkten för betrodd leverantör i formatet: https://sts.windows.net/ \<provider identity\> "
...
### -ResourceGroupName
Namn på resursgrupp där kontot för att lägga till den betrodda identitetsprovidern finns.
