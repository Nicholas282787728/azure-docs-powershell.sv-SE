...
ms.locfileid: "100233846"
---
# Update-AzSmartGroupState

## SYNOPSIS
Uppdaterar smart grupptillstånd

## SYNTAX

### By SmartGroupId (standard)
```
...
## BESKRIVNING
**Cmdleten Update-Az SmartGroupState** uppdaterar smart grupptillstånd.
...
Den här cmdleten uppdaterar det smarta grupptillståndet till Acknowleged.
...
### -SmartGroupId
Unik identifierare för smart grupp/resurs-ID för smart grupp.
...
### -Delstat
Uppdaterade smarta grupptillstånd
