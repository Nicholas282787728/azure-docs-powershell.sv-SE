...
ms.locfileid: "100251925"
---
# Measure-AzAlertStatistic

## SYNOPSIS
Får sammanfattningsinformation för aviseringar
...
## BESKRIVNING
**Cmdleten Measure-AzAlertStatistic** hämtar information om aviseringssammanfattningen.
...
Summera antalet aviseringar grupperade efter allvarlighetsgrad och tillstånd filtrerat efter aktivt läge.
...
### -Include SmartGroupsCount
Inkludera SmartGroups Count
