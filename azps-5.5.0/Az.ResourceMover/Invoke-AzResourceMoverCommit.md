...
### Exempel 1: Verifiera sambanden innan resurserna åtar sig
```powershell
...
Verifiera sambanden innan du åtar dig resurserna.

### Exempel 2: Spara uppsättningen med resurser i samlingen Flytta med hjälp av "MoveResource Name" som indata
```powershell
...
Spara uppsättningen med resurser i flyttsamlingen med hjälp av "MoveResource Name" som indata

### Exempel 3: Spara uppsättningen med resurser i flyttsamlingen med "SourceARMID" som indata
```powershell
...
Spara uppsättningen med resurser i flyttsamlingen med "SourceARMID" som indata
...
### -MoveResource
Hämtar eller anger listan med resurs-ID:n. Som standard godkänner flyttning av resurs-ID om inte inmatningstypen byts ut via egenskapen moveResourceInputType.
