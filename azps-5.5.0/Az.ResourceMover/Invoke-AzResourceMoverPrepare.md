...
ms.locfileid: "100217790"
---
# Invoke-AzResourceMoverPrepare

## SYNOPSIS
Initierar förberedelser för den uppsättning resurser som ingår i begärans brödtext.
...
### Exempel 1: Verifiera sambanden innan du förbereder för resurserna
```powershell
...
Verifiera sambanden innan du förbereder för resurserna.

### Exempel 2: Initiera förberedelsen av resursuppsättningen i samlingen Flytta med hjälp av "MoveResource Name" som indata
```powershell
...
Starta förbereda uppsättningen med resurser i flyttningssamlingen med hjälp av "MoveResource Name" som indata.

### Exempel 3: Initiera förberedelsen av resursuppsättningen i flyttsamlingen med "SourceARMID"
```powershell
...
Initiera förberedelsen av uppsättningen med resurser i flyttsamlingen med hjälp av "SourceARMID".
