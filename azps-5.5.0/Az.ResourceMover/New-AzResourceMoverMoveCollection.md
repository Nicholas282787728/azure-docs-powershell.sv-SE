...
### Exempel 1: Skapa en ny samling för flyttning.
```powershell
...
Skapa en ny flyttsamling i en prenumeration.
...
### -IdentityTenantId
Hämtar eller anger klientorganisations-ID: t.
...
### -IdentityType
Den typ av identitet som används för flytttjänsten för regionen.
...
### -SourceRegion
Hämtar eller anger källområdet.
