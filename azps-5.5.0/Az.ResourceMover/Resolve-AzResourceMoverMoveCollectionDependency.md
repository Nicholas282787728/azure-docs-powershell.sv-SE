...
### Exempel 1: Beräknar, löser och verifierar sambanden för moveresources i samlingen Flytta.
```powershell
...
Beräknar, löser och verifierar sambanden för moveresources i samlingen Flytta.
