...
### Exempel 1: Verifiera sambanden innan resurserna tas bort.
```powershell
...
Verifiera beroenden innan resurserna tas bort.

### Exempel 2: Tar bort flytten av resurserna med hjälp av "MoveResource Name" som indata
```powershell
...
Tar bort flytten av resurserna med hjälp av "MoveResource Name" som indata.

### Exempel 3: Tar bort flytten av resurser med "SourceARMID" som indata
```powershell
...
Tar bort flytten av resurserna med "SourceARMID" som indata.
