...
### Exempel 1: Lägga till en resurs i flyttningssamlingen.
```powershell
...
Lägga till en resurs i flyttningssamlingen inom den angivna prenumerationen.
...
### -DependsOnOverride
Hämtar eller anger åsidosättningar av flyttningsresurssamband.
Information om hur du skapar en tabell finns i avsnittet ANTECKNINGAR för BEROENDEONOVERRIDE-egenskaper och skapa en hash-tabell.
...
### -ExistingTargetId
Hämtar eller anger befintliga ARM för resursen.
...
Hämtar eller anger målresursens namn.
...
### -SourceId
Hämtar eller anger ARM för resursen.
...
DEPENDSONOVERRIDE <IMoveResourceDependencyOverride[]>: Hämtar eller anger åsidosättningar av flyttningsresurssamband.
  - `[Id <String>]`: Hämtar eller anger ARM ID för den beroende resursen.
  - `[TargetId <String>]`: Hämtar eller anger ARM för antingen MoveResource eller resursens ARM-ID för den beroende resursen.
