...
## BESKRIVNING
Cmdleten **Remove-AzRelayHybridConnection** tar bort HybridConnection från det angivna Relay-namnområdet.
...
Tar bort HybridConnection `TestHybridConnection` från `TestNameSpace-Relay1` namnområdet.
