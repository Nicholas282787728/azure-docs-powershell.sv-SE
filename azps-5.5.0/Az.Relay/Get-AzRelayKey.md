...
## BESKRIVNING
Cmdleten **Get-AzRelayKey** returnerar de primära och sekundära anslutningssträngarna för angivna reläenheter (Namespace/WcfRelay/HybridConnection).

## EXEMPEL

### Exempel 1: Namnområde
```powershell
...
Primär och sekundär anslutningssträng till angivna reläenheter (Namespace/WcfRelay/HybridConnection).
