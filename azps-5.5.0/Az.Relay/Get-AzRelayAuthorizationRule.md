...
## BESKRIVNING
Cmdleten **Get-AzRelayAuthorizationRule** får en beskrivning av den angivna auktoriseringsregeln i de givna reläenheterna (Namespace/WcfRelay/HybridConnection).
...
Returnerar den angivna auktoriseringsregelbeskrivningen för en viss WcfRelay.
...
Returnerar den angivna auktoriseringsregelbeskrivningen för en viss HybridConnection.
