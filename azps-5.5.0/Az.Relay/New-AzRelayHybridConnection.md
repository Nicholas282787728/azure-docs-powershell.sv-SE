...
## BESKRIVNING
Med New-AzRelayHybridConnection-cmdleten skapas en HybridConnection i det angivna relänamnområdet.
...
Skapar en ny HybirdConnection TestHybirdConnection2 i det angivna \` \` relänamnområdet \` TestNameSpace-HybirdConnection. \`
...
Skapar en ny HybirdConnection TestHybirdConnection1 i det angivna \` \` relänamnområdet \` TestNameSpace-HybirdConnection. \`
...
true om klientauktorisering krävs för den här HybridConnections annars falskt
...
### -UserMetadata
Hämtar eller anger usermetadata är en platshållare för att lagra användardefinierade strängdata för HybridConnection-slutpunkten, t.ex. Den kan användas för att lagra beskrivande data, till exempel en lista över team och deras kontaktinformation, även användardefinierade konfigurationsinställningar kan lagras.
