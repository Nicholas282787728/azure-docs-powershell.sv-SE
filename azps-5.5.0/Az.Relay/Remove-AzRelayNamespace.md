...
## BESKRIVNING
Cmdleten **Remove-AzRelayNamespace** tar bort namnområdet från den angivna resursgruppen.
...
Tar bort namnområdet Relä `TestNameSpace-Relay1` från den angivna `Default-ServiceBus-WestUS` resursgruppen.
