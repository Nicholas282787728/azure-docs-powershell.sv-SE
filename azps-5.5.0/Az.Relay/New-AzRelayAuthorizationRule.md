...
## BESKRIVNING
Cmdleten **New-AzRelayAuthorizationRule** skapar en ny auktoriseringsregel för angivna reläenheter (Namespace/WcfRelay/HybridConnection).
...
Skapar `AuthoRule1` med **lyssnande** rättigheter för namnområdet. `TestNameSpace-Relay1`
...
Skapar `AuthoRule1` auktoriseringsregel  med lyssnande rättigheter för WcfRelay. `TestWCFRelay1`
...
Skapar `AuthoRule1` med **lyssnande** rättigheter för hybridanslutningen. `TestHybridConnection`
