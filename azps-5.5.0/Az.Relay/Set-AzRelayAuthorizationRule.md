...
## BESKRIVNING
Cmdleten **Set-AzRelayAuthorizationRule** uppdaterar beskrivningen av den angivna auktoriseringsregeln för givna reläenheter (Namespace/WcfRelay/HybridConnection).

## EXEMPEL

### Exempel 1.1 – Namnområde med InputObject
```
PS C:\>
...
Lägger **till Skicka** från åtkomstbehörigheten för auktoriseringsregeln i `AuthoRule1` `TestNameSpace-Relay1` namnområdet.

### Exempel 1.2 – Namnområde med rightsparameter
```
...
Lägger **till Skicka** i åtkomstbehörigheten för auktoriseringsregeln för `AuthoRule1` WcfRelay. `TestWCFRelay1`

### Exempel 2.2 – WcfRelay med Rights-parameter
```
...
Lägger **till Skicka** i åtkomstbehörigheten för auktoriseringsregeln för `AuthoRule1` HybridConnection. `TestHybridConnection`

### Exempel 3.2 – HybridConnection med rights-parameter
```
...
Lägger **till** Skicka i åtkomstbehörigheten för auktoriseringsregeln `AuthoRule1` för HybridConnection. `TestHybridConnection`
...
### -Rights
Rättigheter, t.ex. @("Lyssna","Skicka","Hantera")
