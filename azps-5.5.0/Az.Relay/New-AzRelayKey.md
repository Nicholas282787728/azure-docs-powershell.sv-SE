...
## BESKRIVNING
Cmdleten **New-AzRelayKey** genererar de primära och sekundära anslutningssträngarna för angivna reläenheter (Namespace/WcfRelay/HybridConnection).
...
Återskapar de primära eller sekundära anslutningssträngarna för den givna Relay-Namespace entitet.

### Exempel 1.1 - Namespace KeyValue provided
```
...
genererar de primära eller sekundära anslutningssträngarna för den angivna Relay-Namespace med nyckelvärdet an angett
...
Återskapar de primära eller sekundära anslutningssträngarna för den givna Relay-WcfRelay entitet.

### Exempel 2.1 - WcfRelay KeyValue provided
```
...
genererar de primära eller sekundära anslutningssträngarna för den givna Relay-WcfRelay med nyckelvärdet an angett
...
### Exempel 3.1 – HybridConnection KeyValue
```
...
genererar de primära eller sekundära anslutningssträngarna för den angivna Relay-HybridConnection med nyckelvärdet an angett
...
### -KeyValue
En base64-kodad 256-bitars nyckel för signering och validering av SAS-token.
...
### -RegenerateKey
Generera nycklar – 'PrimaryKey'/'SecondaryKey'.
