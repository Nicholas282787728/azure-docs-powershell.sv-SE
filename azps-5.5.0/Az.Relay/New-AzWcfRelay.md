...
## BESKRIVNING
Med New-AzWcfRelay-cmdleten skapas en WcfRelay i det angivna Relay-namnområdet.
...
Skapar en ny WcfRelay \` TestWCFRelay2 \` i angivet Relay namespace \` TestNameSpace-Relay. \`
...
Skapar en ny WcfRelay \` TestWCFRelay \` i angivet Relay namespace \` TestNameSpace-Relay1. \`
...
true om klientauktorisering krävs för det här reläet; annars falskt
...
### -Requires TransportSecurity
true om transportsäkerhet krävs för det här reläet; annars falskt
...
### -UserMetadata
Hämtar eller anger usermetadata är en platshållare för att lagra användardefinierade strängdata för till exempel HybridConnection-slutpunkten. Den kan användas för att lagra beskrivande data, till exempel en lista över team och deras kontaktinformation, även användardefinierade konfigurationsinställningar kan lagras.
