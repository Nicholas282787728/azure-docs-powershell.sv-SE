...
## BESKRIVNING
Cmdleten **Add-AzTrafficManagerCustomHeaderToEndpoint** lägger till anpassad rubrikinformation i ett lokalt Azure Traffic Manager-slutpunktsobjekt.
...
### Exempel 1: Lägga till anpassad rubrikinformation i en slutpunkt
```
...
Med det andra kommandot läggs anpassad rubrikinformation till i slutpunkten som lagras i $TrafficManagerEndpoint.
...
### -Värde
Anger värdet för den anpassade sidhuvudsinformation som ska läggas till.
