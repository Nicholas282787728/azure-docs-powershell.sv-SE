...
## BESKRIVNING
Cmdleten **Remove-AzTrafficManagerIpAddressRange** tar bort ett IP-adressintervall från ett lokalt Azure Traffic Manager-slutpunktsobjekt.
...
### Exempel 1: Ta bort IP-adressintervall från en slutpunkt
```
...
Det andra kommandot tar bort ett IP-adressintervall från slutpunkten som lagras i $TrafficManagerEndpoint.
...
### -First
Anger den första IP-adressen i intervallet som ska tas bort.
