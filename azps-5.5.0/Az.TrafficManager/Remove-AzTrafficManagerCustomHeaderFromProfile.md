...
## BESKRIVNING
Cmdleten **Remove-AzTrafficManagerCustomHeaderFromProfile** tar bort anpassad sidhuvudinformation från ett lokalt Azure Traffic Manager-profilobjekt.
...
### Exempel 1: Ta bort anpassad sidhuvudinformation från en profil
```
...
Det andra kommandot tar bort anpassad sidhuvudinformation från den profil som lagras i $TrafficManagerProfile.
