...
## BESKRIVNING
Cmdleten **Add-AzTrafficManagerCustomHeaderToProfile** lägger till anpassad rubrikinformation i ett lokalt Azure Traffic Manager-profilobjekt.
...
### Exempel 1: Lägga till anpassad sidhuvudinformation i en profil
```
...
Med det andra kommandot läggs anpassad rubrikinformation till i den profil som lagras i $TrafficManagerProfile.
