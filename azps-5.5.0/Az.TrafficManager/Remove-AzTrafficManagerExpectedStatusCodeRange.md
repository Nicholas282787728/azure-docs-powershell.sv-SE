...
## BESKRIVNING
Cmdleten **Remove-AzTrafficManagerExpectedStatusCodeRange** tar bort ett intervall med förväntade statuskoder från ett lokalt Azure Traffic Manager-profilobjekt.
...
### Exempel 1: Ta bort ett förväntat statuskodintervall från en profil
```
...
Det andra kommandot tar bort ett förväntat statuskodsområde från den profil som lagras i $TrafficManagerProfile.
...
### -Min
Anger det lägsta värdet i statuskodområdet som ska tas bort.
