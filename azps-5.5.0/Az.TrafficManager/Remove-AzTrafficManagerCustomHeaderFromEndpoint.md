...
## BESKRIVNING
Cmdleten **Remove-AzTrafficManagerCustomHeaderFromEndpoint** tar bort anpassad sidhuvudinformation från ett lokalt Azure Traffic Manager-slutpunktsobjekt.
...
### Exempel 1: Ta bort information om anpassat undernät från en slutpunkt
```
...
Det första kommandot hämtar Azure-slutpunkten contoso från profilen ContosoProfile i resursgruppen ResourceGroup11 och lagrar sedan objektet i den $TrafficManagerEndpoint variabeln.
Det andra kommandot tar bort anpassad sidhuvudinformation från slutpunkten som lagras i $TrafficManagerEndpoint.
...
### -Name
Anger namnet på den anpassade rubrikinformationen som ska tas bort.
