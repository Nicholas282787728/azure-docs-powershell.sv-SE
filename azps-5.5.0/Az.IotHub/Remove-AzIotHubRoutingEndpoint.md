...
## BESKRIVNING
Ta bort en slutpunkt. Kom ihåg att ta bort routes som använder den här slutpunkten.
...
Ta bort slutpunkt "E2" från "myiothub" IoT-hubben.
...
### -PassThru
Gör att det booleska objektet kan returneras. Som standard genererar inte den här cmdleten några utdata.
