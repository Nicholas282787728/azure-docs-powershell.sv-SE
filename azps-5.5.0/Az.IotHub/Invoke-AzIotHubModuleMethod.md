...
## BESKRIVNING
Anropa en Edge-modulmetod. Mer https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods information finns i
...
### -ConnectionTimeOut
Antal sekunder att vänta tills en anslutning har skapats.
...
### -Name
Namnet på den metod som ska anropas i den här enhetsmodulen.
...
### -Nyttolast
Nyttolasten för metoden som ska anropas i den här enhetsmodulen.
...
### -ResponseTimeOut
Antal sekunder som ska vänta tills ett resultat tas emot från direktmetoden.
Standardvärdet är 10.
