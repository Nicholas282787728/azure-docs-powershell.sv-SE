...
## BESKRIVNING
För SAS-token för enheter används principparametern endast för åtkomst till enhetsregistret. Därför bör principen ha läsbehörighet till registret.
...
Skapa en SAS-token för IoT Hub med hjälp av iothubowner-principen och primärnyckeln.
...
Generera en SAS-token för IoT Hub med hjälp av registryRead-principen och sekundärnyckeln.
...
Generera en SAS token för enheten med iothubowner-principen för att få åtkomst till enhetsregistret för {iothub_name}.
...
Generera en MODUL SAS token med iothubowner-principen för att få åtkomst till enhetsregistret {iothub_name}.
...
### -Duration
Framtida utgång (i sekunder) för den token som ska skapas.
