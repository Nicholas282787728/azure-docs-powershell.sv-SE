...
Testa all route med källan "DeviceMessages".
...
Testa en specifik route och visa orsaken till felet.
...
Testa en specifik route med AppProperty och SystemProperty.

## PARAMETERS

### -AppProperty
Appegenskaper för routemeddelandet
...
### -ShowError
Visa detaljerade fel, om sådana finns
...
### -SystemProperty
Systemegenskaper för routemeddelandet
