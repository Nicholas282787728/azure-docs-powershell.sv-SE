...
### Exempel 1 Uppdatera SKU:n
```
PS C:\> Set-AzIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -SkuName S1 -Units 5
```

Uppdatera SKU:n till S1 och enheterna till 5 för IotHub med namnet "myiothub"

### Exempel 2 Uppdatera egenskaper för händelsehubben
```
PS C:\> Set-AzIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -EventHubRetentionTimeInDays 4
```

Uppdatera lagringstiden för telemetri i dagar till 4 för IotHub med namnet "myiothub"

## PARAMETERS

### -CloudToDevice
Egenskaperna för molnet till enhetens kommandokö. 
...
Flagga som anger om meddelanden ska aktiveras för filuppladdning. 
...
Namnet på behållaren som filerna ska överföras till.
...
Det maximala antalet meddelanden om filuppladdning.  
...
### -FileUploadSasUriTtl
Dags att använda SAS Uri som genereras för filuppladdning. 
...
Lagringsanslutningssträngen som filerna ska laddas upp till. 
...
### -Routes
Routes som ska läggas till för routning
...
### -RoutingProperties
Egenskaper för routning för att dirigera meddelanden till externa slutpunkter 
