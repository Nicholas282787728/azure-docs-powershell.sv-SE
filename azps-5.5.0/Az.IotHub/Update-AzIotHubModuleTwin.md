...
Returnerar det uppdaterade enhetsmodulobjektet.
...
Returnerar enhetsmodulens objekt med uppdaterade önskade egenskaper.
...
Returnerar enhetsmodulens objekt med uppdaterad egenskap för taggar.
...
Returnerar den ersatta enhetsmodulen.
...
### -Desired
Lägg till eller uppdatera önskad egenskap i en modul.
...
### -Partial
Tillåter endast delvis uppdatering av taggarna och önskade egenskaper för en modul.
...
### -Tag
Lägga till eller uppdatera egenskapen för taggar i en modul.
