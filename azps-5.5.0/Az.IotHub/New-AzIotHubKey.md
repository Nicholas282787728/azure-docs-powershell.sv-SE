...
### Exempel 1 Generera primärnyckel
```
...
Genererad primärnyckel för auktoriseringsprincipen "testKey" för ett Azure iot-nav.

### Exempel 2 Byta nycklar
```
...
Bytesnycklar för auktoriseringsprincipen "testKey" för ett azure iot-nav.
