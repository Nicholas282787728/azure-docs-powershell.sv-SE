...
## BESKRIVNING
Den utlöser redundans för IoT-hubben till den sekundära platsen. Den här åtgärden orsakar förlust av tid och telemetri för din lösning. Det här är en lång åtgärd som kan ta flera minuter att slutföra. Var försiktig när du använder den.
...
Initierar redundansprocessen för "myiothub" IoT Hub.
...
Initierar redundansprocessen för "myiothub" IoT-hubben i bakgrunden.
