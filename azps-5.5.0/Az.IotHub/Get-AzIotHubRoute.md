...
## BESKRIVNING
Få information om vägen. Du kan få alla vägar från ett IoT-nav, få routes till en typ av slutpunkt eller få routes till en viss slutpunkt.
...
Få all route från "myiothub" IoT Hub.
...
Hämta routeinformation från IoT-hubben i "myiothub".
