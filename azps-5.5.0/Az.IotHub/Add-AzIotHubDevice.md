...
## BESKRIVNING
Skapa en enhet med annan auktoriseringstyp i ett IoT-nav.
...
Skapa en IoT-enhet med rot-CA-auktorisering med inaktiverad status och orsak.
...
Skapa en Edge-aktiverad IoT-enhet och lägg till underordnade enheter till den.
...
Skapa en IoT-enhet och ställ in dess överordnade enhet.

## PARAMETERS

### -AuthMethod
Den auktoriseringstyp som en enhet ska skapas med.
...
### -Barn
Lägg till en underordnad enhetslista (kommaavgränsade) innehåller endast enheter som inte är edge-enheter.
