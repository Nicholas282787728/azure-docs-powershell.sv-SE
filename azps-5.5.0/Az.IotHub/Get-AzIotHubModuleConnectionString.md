...
ms.locfileid: "100219743"
---
# Get-AzIotHubModuleConnectionString

## SYNOPSIS
Hämta anslutningssträngen för en mål-IoT-enhetsmodul i ett Oot Hub.
...
## BESKRIVNING
Lista anslutningssträng för alla moduler eller en angiven modul av en mål-IoT-enhet som finns i en Azure IoT Hub.
...
Visa alla modulers anslutningssträng för en mål-IoT-enhet i ett Iot Hub.
...
Hämta den sekundära modulens anslutningssträng för en mål-IoT-enhet i ett Iot Hub.
