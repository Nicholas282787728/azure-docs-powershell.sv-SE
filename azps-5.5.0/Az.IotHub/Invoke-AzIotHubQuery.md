...
## BESKRIVNING
Skapa en fråga för ett IoT Hub med ett kraftfullt SQL-liknande språk för att hämta information om enhets- och moduldesigner, jobb och meddelandedirigering.
...
Fråga alla data om enheten i ett Azure IoT Hub.
...
Fråga de två första modulens data på en målenhet.
...
Som standard har frågan ingen ändelse.
