...
## BESKRIVNING
Konfigurationsinnehållet är små och varierar beroende på avsikten med enheten eller modulen. Enhetskonfigurationer är i form av {"deviceContent":{...}}
Modulkonfigurationer är i form av {"moduleContent":{...}}
Konfigurationer kan definieras med mått för användardata för utvärdering av efterfrågan.
Användarmått är json och i form av {"queries":{...}} eller {"metrics":{"queries":{...}}}.

Obs! Målvillkor för moduler måste börja med "från devices.modules where". Mer https://docs.microsoft.com/azure/iot-hub/iot-hub-automatic-device-management information finns i
...
Skapa en enhetskonfiguration med standardmetadata.
...
Skapa en enhetskonfiguration med användarstatistik.
...
Skapa en enhetskonfiguration med etiketter.
...
Skapa en enhetskonfiguration med innehåll.
...
### -Etikett
Karta med etiketter som ska tillämpas på målkonfigurationen.
...
### -Metric
Insamling av frågor för konfigurationsmåttdefinition.
...
### -Priority
Enhetskonfigurationens vikt om det finns konkurrerande regler (högsta vinsten).
...
### -TargetCondition
Målvillkor som en enhetskonfiguration gäller för.
