...
## BESKRIVNING
Anropa en direkt metod på en enhet. Mer https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods information finns i
...
### -ConnectionTimeOut
Antal sekunder som ska vänta tills en anslutning har skapats.
...
### -Name
Namnet på metoden som ska anropas på den här enheten.
...
### -Nyttolast
Nyttolasten för metoden som ska anropas på den här enheten.
