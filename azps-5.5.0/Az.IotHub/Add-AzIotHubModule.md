...
ms.locfileid: "100234214"
---
# Add-AzIotHubModule

## SYNOPSIS
Skapa en modul på en IoT-målenhet i ett IoT-nav.
...
## BESKRIVNING
Skapa en modul på en IoT-målenhet med annan auktoriseringstyp i ett IoT-nav.
...
Skapa en modul på en IoT-målenhet med standardauktorisering (delad privat nyckel).

## PARAMETERS

### -AuthMethod
Den auktoriseringstyp som en entitet ska skapas med.
...
### -PrimaryThumbprint
Explicit själv signerat certifikat tumavtryck för att använda som primärnyckel.
...
### -SecondaryThumbprint
Explicit själv signerat certifikat tumavtryck för att använda för sekundär nyckel.
