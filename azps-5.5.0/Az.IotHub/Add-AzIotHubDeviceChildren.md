...
## BESKRIVNING
Lägg till en kommaavgränsad lista med enhets-ID:n som inte är edge som underordnade till en viss edge-enhet.
...
Lägg till enheter som inte är edge-enheter som barn till edge-enheten oavsett om enheten som inte är en edge-enhet redan är underordnad en annan edge-enhet.

## PARAMETERS

### -Barn
Listan med underordnade enheter (kommaavgränsade) innehåller endast enheter som inte är edge-enheter.
