...
## BESKRIVNING
Utvärdera ett anpassat målmått eller systemmått som definierats i en IoT-enhetskonfiguration.
Det finns fördefinierade systemmått som beräknas med Iot Hub och kan inte anpassas.
- "Riktad" anger antalet enhetsmatchningar som matchar målvillkoret.
- "Applied" har angett antalet enhetsinställningar som har ändrats av konfigurationen. 
...
Utvärdera systemets "tillämpade" mått.
