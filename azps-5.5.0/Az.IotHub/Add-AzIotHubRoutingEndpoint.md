...
## BESKRIVNING
Lägg till en ny slutpunkt i IoT-hubben. Mer information om slutpunkter som stöds finns i https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-endpoints
...
Lägga till en ny slutpunkt "E2" av typen EventHub i en "myiothub"-IoT-hubben.
...
Lägg till en ny slutpunkt "S1" av typen AzureStorageContainer i ett "myiothub" IoT Hub.
...
Resursgrupp i Slutpunktsresursen
...
Prenumerationsid för Slutpunktsresursen
...
### -Encoding
Välj det format som du vill dirigera dina data i. Du kan välja JSON eller AVRO. Standardinställningen är AVRO.
