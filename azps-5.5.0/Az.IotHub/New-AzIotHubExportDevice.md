...
## BESKRIVNING
Skapar ett nytt exportenheterjobb för IotHub.
Då exporteras alla enheter till den angivna behållaren. Se följande artikel om hur du skapar SAS URI.
https://docs.microsoft.com/azure/iot-hub/iot-hub-bulk-identity-mgmt#get-the-container-sas-uri .

## EXEMPEL

### Exempel 1 Skapa en begäran om en exportenhet.
```
...
Skapar en ny begäran om exportenhet för "myiothub" i IotHub förutom nycklarna.
...
### -ExcludeKeys
Tillåter att exportera enheter utan nycklar.
...
### Microsoft.Azure.Commands.Management.IotHub.Models.PSIotHubResponse
