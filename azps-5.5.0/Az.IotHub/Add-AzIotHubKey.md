...
## BESKRIVNING
Skapar en nyckel för a provided IotHub.
KeyNames är inte unika och måste hanteras noggrant.

## EXEMPEL

### Exempel 1 Lägga till en nyckel i en IotHub
```
PS C:\> Add-AzIotHubKey -ResourceGroupName "myresourcegroup" -Name "myiothub" -KeyName "newkey" -PrimaryKey "primarykey" -SecondaryKey "secondarykey" -Rights RegistryRead
```

Skapar en nyckel med namnet "mykey" för iothub-"myiothub" med RegistryRead-behörigheter.
