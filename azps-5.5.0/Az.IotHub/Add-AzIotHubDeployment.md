...
## BESKRIVNING
Edge-distributioner kan skapas med användardefinierade mått för utvärdering av efterfrågan.
...
Skapa en Edge-distribution med prioritet 3 som gäller på villkor när en enhet taggas i byggnad 9 och miljön är test.
...
Skapa en Edge-distribution med användarstatistik.
...
### -ModulesContent
Distributionsinnehåll för moduler för IoT Edge-enheter.
