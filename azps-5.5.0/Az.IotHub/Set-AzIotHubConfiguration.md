...
## BESKRIVNING
Uppdatera angivna egenskaper för en automatisk IoT-konfiguration av enhetshantering.
...
Uppdatera mått och etiketter för en enhetskonfiguration
...
### -Force
Tillåter att konfigurationsobjektet ersätts även om det uppdaterades sedan det hämtades senast.
...
### -Priority
Vikt på enhetskonfigurationen om det finns konkurrerande regler (högsta vinster).
