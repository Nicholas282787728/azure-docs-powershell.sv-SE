...
Obs! Konfigurationsinnehållet är oföränderligt. Konfigurationsegenskaper som kan uppdateras är etiketter, mätvärden, prioritet och targetCondition.
...
Ändra prioriteten för distribution av IoT Edge och uppdatera målvillkoret.
...
Uppdatera mått och etiketter för distribution av IoT Edge.
...
### -Force
Tillåter att distributionsobjektet ersätts även om det uppdaterades sedan det hämtades senast.
...
### -Etikett
Karta över etiketter som ska tillämpas på måldistributionen.
...
### -Metric
Samling av frågor för definition av distributionsmått för IoT Edge.
...
### -Priority
Distributionens vikt vid tävlande regler (högsta vinster).
...
### -TargetCondition
Målvillkor där en Edge-distribution gäller för.
