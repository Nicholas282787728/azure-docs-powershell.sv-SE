...
## BESKRIVNING
Verifierar ett certifikat genom att ladda upp ett verifieringscertifikat som innehåller verifieringskoden som erhålls av cmdletEn Get-AzIotHubCertificateVerificationCode. Det här är det sista steget för att bevisa att du äger den.
En detaljerad förklaring av CA-certifikat i Azure IoT Hub finns i https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-x509ca-overview
...
Verifierar ägarskap för den privata MyCertificate-nyckeln. 
