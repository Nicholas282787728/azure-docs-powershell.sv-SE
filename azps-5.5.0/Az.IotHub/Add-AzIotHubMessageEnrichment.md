...
## BESKRIVNING
Lägg till upp till 10 meddelandeberikningar per IoT-hubb. Dessa läggs till som programegenskaper i meddelanden som skickas till valda slutpunkter.
...
Lägg till en ny vinst med nyckeln "newKey" och värdet "newValue". Den här nyaberikningen tillämpas på slutpunkterna "endpoint1" och "endpoint2".
...
### -Endpoint
Slutpunkter att tillämpa vinst på.
