...
## BESKRIVNING
Visa alla enheter som inte är kopplade till edge som kommaavgränsade listor över alla edge-enheter eller den angivna enheten.
...
Visa alla enheter som inte är kopplade till edge som kommaavgränsade enheter.
...
Visa alla tilldelade enheter som inte är edge-enheter som kommaavgränsade listor över alla edge-enheter.
...
### Microsoft.Azure.Commands.Management.IotHub.Models.PSDevice Engström

### Microsoft.Azure.Commands.Management.IotHub.Models.PSDevices Engström[]
