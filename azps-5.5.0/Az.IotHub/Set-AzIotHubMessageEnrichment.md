...
## BESKRIVNING
En detaljerad förklaring av meddelandeberikningar i Azure IoT Hub finns i https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
...
Uppdateringsberikandens värde till "updatedValue" för nyckeln "newKey".
En detaljerad förklaring av meddelandeberikningar i Azure IoT Hub finns i https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
...
Uppdaterar slutpunkten förberikning till "endpoint1, endpoint2, endpoint3" för nyckeln "newKey".
En detaljerad förklaring av meddelandeberikningar i Azure IoT Hub finns i https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
...
### -Endpoint
Slutpunkter att använda vinst på.
