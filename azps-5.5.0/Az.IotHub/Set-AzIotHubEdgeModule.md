...
## BESKRIVNING
Tillämpar konfigurationsinnehållet för de angivna modulerna på den angivna edge-enheten.
Obs! Vid körning av kommandot matas samlingen moduler som används på enheten ut.
...
Testa kantmoduler under utveckling genom att ställa in moduler på en målenhet.
...
### -ModulesContent
Konfigurationsinnehåll för moduler för IoT Edge-enheter.
