...
## BESKRIVNING
Skapar en ny IotHub.
Du kan skapa IotHub med standardegenskaper eller ange indataegenskaper.

## EXEMPEL

### Exempel 1 Skapa en ny IotHub med standardegenskaper
```
PS C:\> $tags = @{}
...
Skapar en ny IotHub med namnet "myiothub" av SKU:n "S1", kapacitet 1 och plats "northeurope" ingår i Taggar.

### Exempel 2 Skapa en ny IotHub med MaxDeliveryCount för CloudToDevice-kön inställt på 20
```
PS C:\> New-AzIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -SkuName "S1" -Units 1 -Location "northeurope" -Properties $properties
```

Skapar en ny IotHub med namnet "myiothub" för SKU:n "S1", kapacitet 1 och plats "northeurope" med avancerade indataegenskaper som representeras av $properties.
...
### -Plats
Plats där IoT-hubben måste skapas. 
...
### -Tag
Instanstaggar för IoT-hubben. Egenskapsbag i nyckelvärdespar i form av en hash-tabell.
