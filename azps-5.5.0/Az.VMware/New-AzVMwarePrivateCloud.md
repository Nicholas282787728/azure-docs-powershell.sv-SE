...
### -AcceptEULA
Godkänn LICENSAVTAL för AVS, den juridiska termen visas utan att den här parametern tillhandahålls
...
### -NetworkBlock
Blocket med adresser ska vara unikt för hela VNet i din prenumeration och lokalt.
Kontrollera att CIDR-formatet överensstämmer med (A.B.C.D/X) där A,B,C,D är mellan 0 och 255 och X är mellan 0 och 22
...
### -NsxtPassword
Du kan också ange NSX-T Manager-lösenordet när det privata molnet skapas
...
### -VcenterPassword
Du kan också ange administratörslösenordet för vCenter när det privata molnet skapas
