...
### Exempel 1: Skaffa auktorisering
```powershell
...
Den här cmdleten får `azps-test-auth` auktorisering under privat moln `azps-test-cloud`

### Exempel 2: Listauktorisering
```powershell
...
Den här cmdleten listar `azps-test-auth` auktorisering under privat moln `azps-test-cloud`
