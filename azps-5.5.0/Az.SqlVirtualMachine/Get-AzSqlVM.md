...
## BESKRIVNING
Den Get-AzSqlVM cmdleten får en eller flera virtuella SQL-datorer.
...
Det här kommandot hämtar information om alla virtuella Azure SQL-datorer i den aktuella prenumerationen.
...
Det här kommandot hämtar information om alla virtuella Azure SQL-datorer i den aktuella prenumerationen som tilldelats resursgruppen ResourceGroup01.
...
Det här kommandot hämtar information om den virtuella SQL-datorn "VM" som tilldelats resursgruppen ResourceGroup01.
...
### -ResourceId
ID för virtuell SQL-maskinresurs.
