...
ms.locfileid: "100231679"
---
# New-AzAvailabilityGroupListener

## SYNOPSIS
Skapar en ny tillgänglighetsgruppslyssnare.
...
## BESKRIVNING
Med New-AzAvailabilityGroupListener-cmdleten skapas en ny tillgänglighetsgruppslyssnare.
...
Skapar en ny tillgänglighetsgruppslyssare AgListener01 för tillgänglighetsgruppens tillgänglighetsgrupp01 i SQL Virtual Machine Group SQLVmGroup01.
...
### -Port
Portnummer för AG-lyssnaren. Standardvärdet är 1433.
...
### -SqlVirtualMachineId
Lista över SQL VM Resource-IDs
