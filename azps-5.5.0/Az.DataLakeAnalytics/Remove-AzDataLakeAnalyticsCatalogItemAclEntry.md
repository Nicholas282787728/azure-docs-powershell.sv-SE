...
## BESKRIVNING
Cmdleten **Remove-AzDataLakeAnalyticsCatalogItemAclEntry** tar bort en post (ACE) från åtkomstkontrolllistan (ACL) för en katalogpost i Data Lake Analytics.

## EXEMPEL

### Exempel 1: Ta bort användaren ACL för en katalog
```powershell
...
Det här kommandot tar bort katalogen ACL för Patti Fuller för contosoadla-kontot.

### Exempel 2: Ta bort användaren ACL för en databas
```powershell
...
Det här kommandot tar bort databasen ACL för Patti Fuller för contosoadla-kontot.
...
### -Grupp
Ta bort ACL-posten för katalogen för gruppen.
...
### -Användare
Ta bort ACL-post för användaren.
