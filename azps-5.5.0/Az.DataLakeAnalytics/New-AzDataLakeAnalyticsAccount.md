...
Med det här kommandot skapas ett Data Lake Analytics-konto med namnet ContosoAdlAccount som använder ContosoAdlStore Data Store i resursgruppen ContosoOrg.
...
### -Plats
Anger platsen där du kan skapa Data Lake Analytics-kontot.
Endast östra USA 2 stöds för närvarande.
...
### -MaxAnalyticsUnits
Det maximala maximala antal analysenheter som stöds för det här kontot.
...
### -MaxCount
Det maximala antalet jobb som stöds körs samtidigt under kontot. Om inget anges blir standard 3
...
### -QueryStoreRetention
Det valfria antalet dagar som metadata för jobbet behålls. Om inget anges är standardinställningen 30 dagar.
...
Om du vill skapa en resursgrupp använder New-AzResourceGroup-cmdleten.
...
### -Tag
En strängordlista med taggar kopplade till det här kontot
