...
ms.locfileid: "100215046"
---
# Add-AzDataLakeAnalyticsDataSource

## SYNOPSIS
Lägger till en datakälla till ett Data Lake Analytics-konto.
...
## BESKRIVNING
Cmdleten **Add-AzDataLakeAnalyticsDataSource** lägger till en datakälla till ett Azure Data Lake Analytics-konto.

## EXEMPEL

### Exempel 1: Lägga till en datakälla i ett konto
```powershell
PS C:\>Add-AzDataLakeAnalyticsDataSource -Account "ContosoAdlA" -DataLakeStore "ContosoAdlS"
```

Det här kommandot lägger till en Data Lake Store-datakälla till ett Data Lake Analytics-konto.

### Exempel 2

Lägger till en datakälla till ett Data Lake Analytics-konto. (autogenererat)
...
### -AccessKey
Anger åtkomstnyckeln för blobblagringskontot för Azure som ska läggas till.
...
### -Blob
Anger namnet på det Blob Storage-konto i Azure som ska läggas till.
...
### -DataLakeStore
Anger namnet på det Azure Data Lake Store-konto som ska läggas till.
