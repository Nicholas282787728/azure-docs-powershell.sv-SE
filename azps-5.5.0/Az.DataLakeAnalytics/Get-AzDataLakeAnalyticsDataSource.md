...
### Exempel 1: Hämta en datakälla från ett konto
```
PS C:\>Get-AzDataLakeAnalyticsDataSource -AccountName "ContosoAdlA" -DataLakeStore "ContosoAdls"
```

Det här kommandot hämtar datakällan För Data Lake Store med namnet ContosoAdls från ett Data Lake Analytics-konto.

### Exempel 2: Hämta listan med Data Lake Store-konton i ett Data Lake Analytics-konto
```
PS C:\>Get-AzDataLakeAnalyticsDataSource -AccountName "ContosoAdlA" -DataSource "DataLakeStore"
```

Med det här kommandot får du alla Data Lake Store-konton från ett Data Lake Analytics-konto.

## PARAMETERS

### -Konto
Anger det Data Lake Analytics-konto som den här cmdleten hämtar datakällor.
...
### -ResourceGroupName
Anger namnet på resursgruppen som innehåller datakällan.
