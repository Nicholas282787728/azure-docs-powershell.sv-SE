...
### Exempel 1: Ändra datakällan för ett konto
```powershell
PS C:\>Set-AzDataLakeAnalyticsAccount -Name "ContosoAdlAcct" -DefaultDataLakeStore "ContosoAdlStore01" -Tags @{"stage"="production"}
```

Det här kommandot ändrar standarddatakällan och egenskapen Taggar för kontot.

### Exempel 2

Ändrar ett Data Lake Analytics-konto. (autogenererat)
...
### -AllowAzureIpState
Om du vill kan du tillåta/blockera Azure-data med ursprung i brandväggen.
...
### -FirewallState
Du kan aktivera/inaktivera befintliga brandväggsregler.
...
### -MaxAnalyticsUnits
Det maximala maximala analysenheter som stöds för att uppdatera kontot.
...
### -MaxCount
Det maximala antal jobb som stöds som körs samtidigt under kontot.
...
### -QueryStoreRetention
Det valfria antal dagar som metadata för jobbet behålls för kontot.
...
### -ResourceGroupName
Anger resursgruppens namn för Data Lake Analytics-kontot.
...
### -Tag
En strängordlista med taggar kopplade till det här kontot som ska ersätta den aktuella uppsättningen taggar
