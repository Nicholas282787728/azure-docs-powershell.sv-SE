...
### Exempel 1: Hämta alla dedikerade HSM under en prenumeration
```powershell
...
Det här kommandot får all dedikerad HSM under en prenumeration

### Exempel 2: Få alla dedikerade HSM under en resursgrupp.
```powershell
...
Med det här kommandot hamnar alla dedikerade HSM under en resursgrupp.

### Exempel 3: Hämta en dedikerad HSM efter namn
```powershell
...
Det här kommandot får ett dedikerat HSM-namn.

### Exempel 4: Hämta en dedikerad HSM per objekt
```powershell
...
Det här kommandot får ett dedikerat HSM-objekt.
...
### -ResourceGroupName
Namnet på den resursgrupp som de dedikerade hsm tillhör.
...
INPUTOBJECT <IDedicatedHsmIdentity> : Identity Parameter
  ...
  - `[ResourceGroupName <String>]`: Namnet på den resursgrupp som resursen tillhör.
