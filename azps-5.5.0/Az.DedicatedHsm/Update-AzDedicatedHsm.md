...
ms.locfileid: "100232094"
---
# Update-AzDedicatedHsm

## SYNOPSIS
Uppdatera en dedikerad HSM i den angivna prenumerationen.
...
### Exempel 1: Uppdatera parametertaggen för den dedikerade HSM:en efter namn
```powershell
...
Det här kommandot uppdaterar parametertaggen för den dedikerade HSM efter namn

### Exempel 2: Uppdatera parametertaggen för det dedikerade HSM-objektet per objekt
```powershell
...
Det här kommandot uppdaterar parametertaggen för det dedikerade HSM-objektet efter objekt
