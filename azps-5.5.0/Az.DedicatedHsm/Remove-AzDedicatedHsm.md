...
ms.locfileid: "100211079"
---
# Remove-AzDedicatedHsm

## SYNOPSIS
Tar bort den angivna Azure Dedicated HSM.
...
### Exempel 1: Ta bort en dedikerad HSM med namn
```powershell
PS C:\> Remove-AzDedicatedHsm -Name hsm-7t2xaf -ResourceGroupName lucas-manual-test

```

Detta komm tar bort en maskinvarusäkerhetsmodul (HSM) med namn.

### Exempel 2: Ta bort ett dedikerat HSM-objekt
```powershell
...
Det här komm-objektet tar bort ett dedikerat HSM-objekt.
...
### -ResourceGroupName
Namnet på den resursgrupp som den dedikerade HSM tillhör.
