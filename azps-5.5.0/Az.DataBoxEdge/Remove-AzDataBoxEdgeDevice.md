...
ms.locfileid: "100215143"
---
# Remove-AzDataBoxEdgeDevice

## SYNOPSIS
Tar bort en Data Box Edge-enhet.
...
## BESKRIVNING
Cmdleten **Remove-AzDataBoxEdgeDevice** tar bort konfigurationen för en Data Box Edge-enhet.
Observera att enheten bara kan tas bort när du har gjort beställningen och innan enheten förbereds av Microsoft för leveransen.

Se dokumentationen om borttagning av resursen innan du använder den här [cmdleten](https://docs.microsoft.com/en-us/azure/databox-online/data-box-edge-return-device#delete-the-resource)
