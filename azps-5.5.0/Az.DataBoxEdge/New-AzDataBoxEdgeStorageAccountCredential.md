...
## BESKRIVNING
Cmdleten **New-AzDataBoxEdgeStorageAccountCredential** skapar en ny edge-lagringskontouppgifter för en Data Box Edge-enhet.
...
### -EncryptionKey
Krypteringsnyckel för Edge-enheten
...
### -StorageAccountType
Möjlig lagringsåtkomsttyp GeneralPurposeStorage, BlockStorage
