...
## BESKRIVNING
Cmdleten **New-AzDataBoxEdgeUser** skapar en ny användare för Data Box Edge-enheten. Endast skapande av användare av `Share` typen stöds.
...
### -Password
Lösenord, ange som en säker sträng
