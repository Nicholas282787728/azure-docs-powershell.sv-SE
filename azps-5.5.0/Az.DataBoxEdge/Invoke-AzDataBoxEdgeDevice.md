...
### Invoke RättForUpdateParameterSet (standard)
```
...
### Invoke RättForUpdateByResourceIdParameterSet
```
...
### Invoke RättForUpdateByDeviceObjectParameterSet
```
...
## BESKRIVNING
Cmdleten **Invoke-AzDataBoxEdgeDevice** anropar åtgärder för att söka, ladda ned och installera uppdateringarna på Edge-enheten Data Box. En automatisk genomsökning körs på enheten varje dag, du kan utlösa genomsökningen explicit genom att köra den här cmdleten.
...
### -FetchUpdate
Laddar ned uppdateringarna på en datarutas edge/gateway-enhet
...
### -InstallUpdate
Installerar uppdateringarna på datarutans kant/gatewayenhet
...
### -ScanForUpdate
Söker efter uppdateringar på en datarutas edge/gateway-enhet.
