...
## BESKRIVNING
Cmdleten **Remove-AzDataBoxEdgeStorageAccount** tar bort ett tillhörande Edge-lagringskonto för en Data Box Edge-enhet. Du kan ange namnet på Edge Storage Account som ska tas bort som parameter i cmdleten.
