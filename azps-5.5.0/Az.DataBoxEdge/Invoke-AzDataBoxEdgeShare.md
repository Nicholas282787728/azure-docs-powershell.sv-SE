...
## BESKRIVNING
Cmdleten **Invoke-AzDataBoxEdgeShare** anropar åtgärd för att uppdatera data på en delning på en Data Box Edge-enhet.
...
### -RefreshData
Uppdatera Dela metadata med data från molnet
