...
## BESKRIVNING
Cmdleten **Set-AzDataBoxEdgeStorageAccountCredential** uppdaterar autentiseringsuppgifterna för lagringskontot som motsvarar ett lagringskonto på Data Box Edge-enheten.
...
Underlättar rotering av snabbtangenter för ett lagringskonto
...
### -EncryptionKey
Krypteringsnyckeln för Edge-enheten
...
ange en nyckel för lagringskontoåtkomst
