...
## BESKRIVNING
Cmdleten **New-AzDataBoxEdgeOrder** skapar en ny order för en Data Box Edge-enhet. En enhetsresurs för Data Box Edge måste skapas innan en order kan skapas. Du kan ange detaljer som kontaktperson, företagsnamn, e-postadress osv. som parametrar för att skapa ordern.
...
### -E-post
Lista med e-postmeddelanden för att få uppdateringar, accepterar maximalt 10 e-postmeddelanden
