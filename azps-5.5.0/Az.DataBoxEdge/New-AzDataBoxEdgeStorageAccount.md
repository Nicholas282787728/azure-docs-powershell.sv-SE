...
## BESKRIVNING
Cmdleten **New-AzDataBoxEdgeStorageAccount** skapar ett nytt Edge Storage-konto på en Data Box Edge-enhet. För en enhet kan ett Edge-lagringskonto mappas högst till bara ett molnlagringskonto.
...
2 EdgeStorageAccounts på enheten kan inte dela fler än 1 Molnlagringskonto
...
### -Cloud
Ett CloudStorageAccount för nivåindelad användning
