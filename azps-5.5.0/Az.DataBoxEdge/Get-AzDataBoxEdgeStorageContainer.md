...
## BESKRIVNING
Cmdleten **Get-AzDataBoxEdgeStorageContainer** får lagringsbehållaren för ett Edge-lagringskonto på en Data Box Edge-enhet. Du kan ange namnet som en parameter i cmdleten för att hämta information om en viss lagringsbehållare. 
...
Ange befintliga EdgeStorageAccounts namn
