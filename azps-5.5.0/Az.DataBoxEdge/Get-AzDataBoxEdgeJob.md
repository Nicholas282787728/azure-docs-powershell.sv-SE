...
## BESKRIVNING
Cmdleten **Get-AzDataBoxEdge Engström** hämtar de aktiva jobben på en Data Box Edge-enhet. Du kan nämna parametern Name för att få information om ett visst jobb.
...
### -Name
Namn på jobbet, vanligtvis GUID
...
### Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.PSDataBoxEdge Eng
