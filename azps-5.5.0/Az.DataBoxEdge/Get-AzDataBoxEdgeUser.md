...
## BESKRIVNING
Cmdleten **Get-AzDataBoxEdgeUser** listar de användare som konfigurerats för en Data Box Edge-enhet. Du kan nämna namnet i parametrar för att få information om en viss användare.
