...
## BESKRIVNING
Cmdleten **Get-AzDataBoxEdgeTriger** hämtar utlösare för en enhet. Du kan ange namnet som en parameter i cmdleten för att hämta information om specifika utlösare
...
### Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.PSDataBoxEdgeTedgeer
