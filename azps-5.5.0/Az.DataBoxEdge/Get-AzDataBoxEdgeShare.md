...
## BESKRIVNING
Cmdleten **Get-AzDataBoxEdgeShare** hämtar tillgängliga resurser för en Data Box Edge-enhet. Om namn anges får detta delning med Namn.
