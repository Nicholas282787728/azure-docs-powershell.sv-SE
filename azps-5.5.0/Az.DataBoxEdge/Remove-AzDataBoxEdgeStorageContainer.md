...
## BESKRIVNING
Cmdleten **Remove-AzDataBoxEdgeStorageContainer** tar bort en tillhörande lagringsplats för Edge-lagringskontot på en Data Box Edge-enhet. Du kan ange namnet på lagringsbehållaren som ska tas bort som parameter.
