...
## BESKRIVNING
Cmdleten **Get-AzDataBoxEdgeStorageAccountCredential** hämtar autentiseringsuppgifterna för lagringskontot för motsvarande lagringskonto på Data Box Edge-enheten. Du kan ange parametrar för namn, resursgrupp och enhetsnamn om du vill få information om specifika autentiseringsuppgifter för lagringskonto.
