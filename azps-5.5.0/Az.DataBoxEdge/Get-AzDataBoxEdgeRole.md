...
## BESKRIVNING
Cmdleten **Get-AzDataBoxEdgeRole** hämtar tillgängliga IoT-roller för en Data Box Edge-enhet. Du kan nämna parametern Name för att få information om en specifik IoT-roll.
