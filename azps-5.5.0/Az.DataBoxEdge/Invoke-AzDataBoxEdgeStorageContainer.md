...
## BESKRIVNING
Cmdleten **Invoke-AzDataBoxEdgeStorageContainer** anropar åtgärder för att uppdatera data i en lagringsbehållare på en Edge-enhet med Data Box. 
...
### -RefreshData
Uppdatera behållarmetadata med data från molnet
