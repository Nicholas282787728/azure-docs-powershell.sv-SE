...
## BESKRIVNING
Cmdleten **Remove-AzDataBoxEdgeStorageAccountCredential** tar bort autentiseringsuppgifterna för lagringskontot för en Data Box Edge-enhet.
