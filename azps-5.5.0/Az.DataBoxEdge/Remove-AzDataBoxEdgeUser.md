...
## BESKRIVNING
Cmdleten **Remove-AzDataBoxEdgeUser** tar bort en användare på En Data Box Edge-enhet. Endast skapande av användare av `Share` typen stöds.
