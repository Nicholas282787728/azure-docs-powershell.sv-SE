...
Det senaste databasschemat hämtas från den verkliga databasen och används sedan för att uppdatera schemat som cachelagras av Synkronisera metadata-databas.
...
## BESKRIVNING
Cmdleten **Update-AzSqlSyncSchema** uppdaterar synkroniseringsschemat för en synkroniseringsmedlems databas eller en synkroniseringsnavdatabas.

## EXEMPEL

### Exempel 1: Uppdatera synkroniseringsschemat för en navdatabas
```
...
Det här kommandot uppdaterar synkroniseringsschemat för navdatabasen i synkroniseringsgruppen syncGroup01

### Exempel 2: Uppdatera synkroniseringsschemat för en medlemsdatabas
```
...
Det här kommandot uppdaterar synkroniseringsschemat för medlemsdatabasen i synkroniseringsmedlemmen syncMember01
...
### -PassThru
Anger om den här cmdleten ska returnera synkroniseringsgruppen
