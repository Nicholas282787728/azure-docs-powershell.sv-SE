...
## BESKRIVNING
Cmdleten **Set-AzSqlServerFirewallRule** ändrar en brandväggsregel i en Azure SQL Database-server.

## EXEMPEL

### Exempel 1: Ändra en brandväggsregel
```
...
Det här kommandot ändrar brandväggsregeln Rule01 på servern Server01.
Kommandot ändrar START- och slut-IP-adresserna.
...
### -FirewallRuleName
Anger namnet på brandväggsregeln som denna cmdlet ändrar.
