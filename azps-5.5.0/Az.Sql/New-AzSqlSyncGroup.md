...
### -SyncDatabaseName
Den databas som används för att lagra synkronisera relaterade metadata.
...
Använd en privat länkanslutning när du ansluter till navet i den här synkroniseringsgruppen.
