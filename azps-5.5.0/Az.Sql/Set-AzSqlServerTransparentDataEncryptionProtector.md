...
## BESKRIVNING
Med Set-AzSqlServerTransparentDataEncryptionProtector-cmdleten anges TDE-uttrycket för en SQL-server.
När du ändrar TDE-typen roteras den.

## EXEMPEL

### Exempel 1: Ställ in typ transparent datakryptering (TDE) på ServiceManaged
```
...
Det här kommandot uppdaterar TDE-typen för en server till Tjänst hanterad.
...
Det här kommandot uppdaterar en server som använder nyckeln för servernyckelvalv med Id https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 ' som TDE-deltagare.
ResourceGroupName ServerName Type ServerKeyVaultKeyName
----------------- ----------                   ---- ---------------------
...
### -Type
Typ av Azure Sql Database TDE-installation.
