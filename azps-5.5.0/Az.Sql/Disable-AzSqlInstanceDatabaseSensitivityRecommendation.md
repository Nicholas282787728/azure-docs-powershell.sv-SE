...
## BESKRIVNING
Med Disable-AzSqlInstanceDatabaseSensitivityRecommendation-cmdleten inaktiverar (stänger) känslighetsrekommendationer för kolumner i azure SQL-hanterade instansdatabasen.

## EXEMPEL

### Exempel 1: Inaktivera känslighetsrekommendationer för en viss kolumn i en Azure SQL-hanterad instansdatabas.
```powershell
...
### Exempel 2: Inaktivera känslighetsrekommendationer för kolumner som har känslighetsrekommendationer i en Azure SQL-hanterad instansdatabas med Piping.
```powershell
...
### Exempel 3: Inaktivera känslighetsrekommendationer för en viss kolumn i en Azure SQL-hanterad instansdatabas med Piping.
```powershell
