...
## BESKRIVNING
Cmdleten **Get-AzSqlServerDisasterRecoveryConfigurationActivity** hämtar aktivitet för en konfiguration för återställning av SQL-databasserversystem.
...
Anger namnet på konfigurationen för återställning av serversystem.
