...
## BESKRIVNING
Cmdleten **Stop-AzSqlElasticPoolActivity** avbryter asynkron uppdatering på en synkroniseringspool.

## EXEMPEL

### Exempel 1: Avbryta den asynkrona uppdateringsåtgärden på en pool med pooler med pooler
```
...
Det här kommandot avbryter den asynkrona uppdateringsåtgärden påpoolen med pooler.
...
### -PoolName
Namnet på azure SQL-spoolen för sniken.
...
### -OperationId
ID för åtgärden som ska hämtas.
...
### Microsoft.Azure.Commands.sql.PoolPool.Model.AzureSqlElasticPoolActivityModel
