...
## BESKRIVNING
**Cmdleten Start-AzSqlInstanceDatabaseLogReplay** initierar starten av uppspelningstjänsten.
...
Det här kommandot skapar en ny hanterad databas och återställer säkerhetskopior från den givna behållaren tills last_backup.bak har återställts.
...
Det här kommandot skapar en ny hanterad databas och återställer säkerhetskopior från den givna behållaren tills Complete-AzSqlInstanceDatabaseLogReplay anropas med den senaste säkerhetskopian som söks.
...
### -AutoCompleteRestore
Indikatorn om återställningen ska slutföras automatiskt vid slutförande eller inte.
...
### -Collation
Sorteringen av den instansdatabas som ska användas.
...
Sas token för lagringsbehållaren.
