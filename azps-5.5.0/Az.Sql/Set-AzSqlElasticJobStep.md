...
## BESKRIVNING
Cmdleten Set-AzSqlElasticJobStep ett jobbsteg

## EXEMPEL

### Exempel 1: Uppdaterar målgruppen för ett jobb i ett jobb
```powershell
...
### Exempel 2: Uppdaterar ett jobbstegs T-SQL-skript för ett jobb
```powershell
PS C:\> $jobStep = Get-AzSqlElasticJobStep -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -StepName step1
...
Uppdaterar ett jobbsteg från ett jobb
...
### -CredentialName
Namnet på autentiseringsnamnet
...
Sekunderna för de första försöksintervallen
...
Maximalt antal sekunder som försöksintervall
...
Namn på autentiseringsuppgifter för utdata
...
### -RemoveOutput
Flaggan som anger om utdata ska tas bort
...
### Microsoft.Azure.Commands.Sql.ElasticitKommandos.Model.AzureSqlElasticKommandoStepModel
