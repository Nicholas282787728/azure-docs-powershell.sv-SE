...
## BESKRIVNING
Den Get-AzSqlInstanceDatabaseSensitivityRecommendation cmdleten returnerar de rekommenderade informationstyperna och känslighetsetiketterna för kolumner i azure SQL-hanterade instansdatabasen.

## EXEMPEL

### Exempel 1: Hämta rekommenderade informationstyper och känslighetsetiketter för en Azure SQL-hanterad instansdatabas.
```powershell
...
### Exempel 2: Hämta rekommenderade informationstyper och känslighetsetiketter för en Azure SQL-hanterad instansdatabas med Piping.
```powershell
