...
### Exempel 1: Ta bort en synkroniseringsgrupp
```
PS C:\>Remove-AzSqlSyncGroup -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "database01" -Name "syncGroup01"
```

Med det här kommandot tas azure SQL Database Sync-gruppen bort med namnet syncGroup01.
...
### -PassThru
Definierar om den borttagna synkroniseringsgruppen ska returneras
