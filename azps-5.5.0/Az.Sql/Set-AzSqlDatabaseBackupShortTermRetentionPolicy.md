...
## BESKRIVNING
Cmdleten **Set-AzSqlDatabaseBackupShortTermRetentionPolicy** får den korta bevarandeprincipen registrerad i den här databasen.
...
Databasobjektet som principen ska skapas för.
...
### -RetentionDays
Lagringsinställningen för säkerhetskopior, i dagar.
