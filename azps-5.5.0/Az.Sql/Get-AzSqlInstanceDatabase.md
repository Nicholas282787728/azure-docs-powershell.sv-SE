...
## BESKRIVNING
Cmdleten **Get-AzSqlInstanceDatabase** hämtar en eller flera Azure SQL-databaser från en Hanterad Azure SQL-databasinstans.

## EXEMPEL

### Exempel 1: Hämta alla databaser i en instans
```
...
Med det här kommandot får du alla databaser på instansen med namnet managedInstance1.

### Exempel 2: Hämta en databas efter namn i en hanterad instans
```
...
Det här kommandot hämtar en databas med namnet managedDatabase1 från en instans med namnet managedInstance1.

### Exempel 3: Hämta alla databaser i en instans med hjälp av filtrering
```
...
Med det här kommandot får du alla databaser på instansen med namnet managedInstance1 som börjar med "managedDatabase".
...
### -InstanceObject
Instansobjektet som ska användas för att hämta en instansdatabas
...
### -InstanceResourceId
Resurs-ID för instansobjektet som ska fås
...
### -Name
Namnet på Azure SQL-instansdatabasen som ska hämtas.
