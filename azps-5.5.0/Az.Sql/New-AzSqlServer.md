...
### Exempel 1: Skapa en ny Azure SQL Database-server
```
...
Det här kommandot skapar en version 12 av Azure SQL Database-servern.
...
### -Plats
Anger platsen för det datacenter där den här cmdleten skapar servern.
...
### -ResourceGroupName
Anger namnet på den resursgrupp som cmdleten tilldelar servern.
...
### -ServerVersion
Anger versionen av den nya servern. De godtagbara värdena för den här parametern är: 2.0 och 12.0.
...
Anger sql-databasserverns administratörsautentiseringsuppgifter för den nya servern. Om du vill hämta **ett PSCredential-objekt** använder du Get-Credential cmdleten. Om du vill ha mer information skriver du `Get-Help
Get-Credential` .
