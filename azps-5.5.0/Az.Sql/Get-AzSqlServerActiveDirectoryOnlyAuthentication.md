...
ms.locfileid: "100225126"
---
# Get-AzSqlServerActiveDirectoryOnlyAuthentication

## SYNOPSIS
Hämtar Azure AD-autentisering endast för en viss SQL Server.
...
## BESKRIVNING
Cmdleten **Get-AzSqlServerActiveDirectoryOnlyAuthentication** får azure Active Directory (Azure AD) endast autentiseringskrav för AzureSQL Server i den aktuella prenumerationen.
...
Det här kommandot hämtar azure Active Directory (Azure AD) endast autentiseringskrav för en AzureSQL-server med namnet Server01 som är associerad med en resursgrupp med namnet ResourceGroup01.
