...
## BESKRIVNING
Cmdleten **Remove-AzSqlServerActiveDirectoryAdministrator** tar bort en Azure Active Directory-administratör (Azure AD) för AzureSQL Server i den aktuella prenumerationen.
...
Det här kommandot tar bort Azure AD-administratören för servern med namnet Server01 som är kopplat till resursgruppen ResourceGroup01.
...
### -Servernamn
Anger namnet på den SQL Server som cmdleten tar bort en administratör för.
