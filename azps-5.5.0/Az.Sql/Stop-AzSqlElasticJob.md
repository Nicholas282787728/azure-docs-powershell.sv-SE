...
## BESKRIVNING
Den Stop-AzSqlElasticJob cmdleten stoppar ett jobb med en körning som körs.
Returnerar den aktuella statusen för körningen av jobbet

## EXEMPEL

### Exempel 1: Stoppar ett jobb med en löpande körning av jobbet
```powershell
...
Stoppar en körning av jobb och returnerar dess aktuella status
