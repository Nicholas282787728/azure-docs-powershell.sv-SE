...
## BESKRIVNING
Cmdleten **Disable-AzSqlServerActiveDirectoryOnlyAuthentication** inaktiverar azure Active Directory (Azure AD) endast autentiseringskrav för AzureSQL Server i den aktuella prenumerationen.
...
Med det här kommandot inaktiveras endast azure Active Directory (Azure AD) autentiseringskrav för en AzureSQL-server med namnet Server01 som är associerad med en resursgrupp med namnet ResourceGroup01.
...
### -InputObject
SQL Server-objektet som ska användas.
...
### -Servernamn
Namnet på Azure SQL Server som endast används för Azure Active Directory-autentisering finns.
