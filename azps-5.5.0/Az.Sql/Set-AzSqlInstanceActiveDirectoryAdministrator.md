...
## BESKRIVNING
**Set-AzSqlInstanceActiveDirectoryAdministrator** tillhandahåller en Azure Active Directory-administratör (Azure AD) för AzureSQL Managed Instance i den aktuella prenumerationen.
Du kan bara tillhandahålla en administratör i taget.
Följande medlemmar i Azure AD kan tillhandahållas som SQL Managed Instance-administratör:
- Ursprungliga medlemmar i Azure AD 
- Externa medlemmar i Azure AD 
- Azure AD-grupper som skapats som säkerhetsgrupper Importerade medlemmar från andra Azure-AD:er stöds inte som administratörer.
Microsoft-konton, till exempel de i Outlook.com-, Hotmail.com- Live.com-domäner, stöds inte som administratörer.
...
### Exempel 1: Etablera en administratörsgrupp för en hanterad instans som är associerad med resursgrupp
```
...
Det här kommandot tillhandahåller azure AD-administratörsgruppen DBAs för den hanterade instansen ManagedInstance01.
Den här servern är kopplad till resursgruppen ResourceGroup01.

### Exempel 2: Etablera en administratörsanvändare med hjälp av hanterade instansobjekt
```
...
Det här kommandot tillhandahåller en Azure AD-användare som administratör från det hanterade instansobjektet.

### Exempel 3: Etablera en administratör med resursidentifierare för hanterade instanser
```
...
Det här kommandot tillhandahåller en Azure AD-användare som administratör med resursidentifieraren för hanterade instanser.
