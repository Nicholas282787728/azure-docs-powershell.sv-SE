...
Den får alla georeplikeringslänkar mellan den angivna Azure SQL-databasen och en resursgrupp eller AzureSQL Server.

## EXEMPEL

### Exempel 1

Hämtar georeplikeringslänkarna mellan en Azure SQL-databas och en resursgrupp eller SQL Server. (autogenererat)
...
### -DatabaseName
Anger namnet på den SQL-databas som länkar ska hämtas för.
...
Anger namnet på den resursgrupp som partnern är tilldelad till.
...
### -PartnerServerName
Anger namnet på Azure SQL Server för partnern.
...
### -ResourceGroupName
Anger namnet på Azure-resursgruppen för databasen som länkarna ska hämtas för.
...
### -Servernamn
Anger namnet på den SQL Server för databasen som länkarna ska hämtas för.
