...
## BESKRIVNING
Cmdleten **New-AzSqlServerCommunicationLink** skapar en kommunikationslänk för databastransaktionen med portaler och databaser mellan två logiska servrar i Azure SQL Database.
Transaktioner med databaser av databaser kan omfatta databaser i någon av de parade servrarna.
Du kan skapa mer än en länk på en server.
Därför kan transaktioner med databaser av en elasticitet spänna över ett större antal servrar.

## EXEMPEL

### Exempel 1: Skapa en kommunikationslänk
```
PS C:\>New-AzSqlServerCommunicationLink -ResourceGroupName "ResourceGroup01" -ServerName "ContosoServer17" -LinkName "Link01" -PartnerServer "ContosoServer02"
```

Det här kommandot skapar en länk med namnet Link01 mellan ContosoServer17 och ContosoServer02.
...
### -LinkName
Anger namnet på serverlänken som cmdleten skapar.
...
### -PartnerServer
Anger namnet på den andra servern som deltar i kommunikationslänken.
...
### -Servernamn
Anger namnet på den server där den här cmdleten uppsättningar av kommunikationslänken.
