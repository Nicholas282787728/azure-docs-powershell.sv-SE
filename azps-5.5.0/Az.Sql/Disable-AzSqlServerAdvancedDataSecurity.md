...
## BESKRIVNING
**Cmdleten Disable-AzSqlServerAdvancedDataSecurity** inaktiverar Avancerad datasäkerhet på en server.

## EXEMPEL

### Exempel 1
### Exempel 2: Inaktivera avancerad datasäkerhet för server
```powershell
...
### Exempel 3: Inaktivera serverns avancerade datasäkerhet från serverresurs
```powershell
