...
ms.locfileid: "100230319"
---
# Complete-AzSqlInstanceDatabaseLogReplay

## SYNOPSIS
Tjänsten slutför uppspelning av logg för den angivna databasen.
...
## BESKRIVNING
**Cmdleten Complete-AzSqlInstanceDatabaseLogReplay** slutför tjänsten Logguppspelning i den givna databasen.
...
Det här kommandot slutför tjänsten för uppspelning av logg för den givna databasen efter att den senaste säkerhetskopian återställts.
...
### -LastBackupName
Namnet på den senaste säkerhetskopian som ska återställas.
...
### -PassThru
Definierar om du vill returnera synkroniseringsgruppen.
