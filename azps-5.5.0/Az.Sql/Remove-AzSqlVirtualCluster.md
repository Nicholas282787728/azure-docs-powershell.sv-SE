...
## BESKRIVNING
Cmdleten **Remove-AzSqlVirtualCluster** tar bort ett virtuellt Azure SQL-kluster.
...
Det här kommandot tar bort det virtuella kluster med namnet VirtualCluster1 som tilldelats resursgruppen ResourceGroup01.
...
### -InputObject
Instansobjektet som ska tas bort
...
### -ResourceId
Resurs-ID för det instansobjekt som ska tas bort
