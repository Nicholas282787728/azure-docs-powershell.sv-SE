...
## BESKRIVNING
Cmdleten **Start-AzSqlSyncGroupSync** startar en synkroniseringsgruppssynkronisering.
...
Det här kommandot startar en omgång med synkronisering för synkroniseringsgruppen MySG.
...
### -PassThru
Definierar om synkroniseringsgruppen ska returneras
