...
## BESKRIVNING
Cmdleten **Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy** anger bevarandeprincipen för den hanterade databasen på lång sikt.
...
Konfigurerar databasens veckovisa bevarandeprincip på lång sikt till en vecka.
...
Det här kommandot tar bort den långsiktiga bevarandeprincipen från databasen.

### Exempel 3

Med Set-AzSqlInstanceDatabaseLongTermRetentionBackup cmdleten anges en hanterad databass bevarandeprincip på lång sikt. (autogenererat)
...
### -InstanceName
Namnet på azure-hanterade instansen som databasen tillhör.
...
### -RemovePolicy
Om den anges rensas principen för databasen.
...
### -WeekOfYear
Veckan på året, 1 till 52, för att spara för det årliga bevarandet.
