...
Lägga till TDE-certifikat till en SQL-server med resursgruppnamn och SQL Server-namn
...
Lägga till TDE-certifikat på servrarna med serverresurs-ID
...
Lägga till TDE-certifikat för alla SQL-servrar i en resursgrupp
