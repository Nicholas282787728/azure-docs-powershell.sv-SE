...
## BESKRIVNING
Den Get-AzSqlInstanceKeyVaultKey cmdleten hämtar information om nyckelvalvsnycklarna i en SQL-hanterad instans. Du kan visa alla nycklar i en hanterad instans eller visa en viss nyckel genom att ange KeyId.
...
Med det här kommandot får du alla tangenter i nyckelvalvet på en SQL-hanterad instans.

### Exempel 2: Hämta en specifik nyckel för nyckel för nyckel för ett nyckelvalv
```powershell
...
Det här kommandot får nyckeln för nyckelvalvet med Id ' https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 '.

### Exempel 3: Använda instansobjekt
```powershell
...
### Exempel 4: Använda instansresurs-ID
```powershell
PS C:\> $managedInstance = Get-AzSqlInstance -Name 'ContosoManagedInstanceName' -ResourceGroupName 'ContosoResourceGroup'
