...
## BESKRIVNING
Cmdleten **New-AzSqlInstancePool** skapar en Azure SQL-instanspool.
...
Med det här kommandot skapas en ny Azure SQL-instanspool.
...
### -ComputeGeneration
Beräkningsgenerering för instanspoolen.
...
### -Plats
Platsen där instanspoolen ska skapas.
...
### -SubnetId
Det undernäts-ID som ska användas för att skapa till exempel en pool.
...
### -VCore
Avgör hur mycket VCore som ska associeras med instansen.
