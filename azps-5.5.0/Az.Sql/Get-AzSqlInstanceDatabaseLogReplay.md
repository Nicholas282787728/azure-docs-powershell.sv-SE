...
## BESKRIVNING
Cmdleten **Get-AzSqlInstanceDatabaseLogReplay** får statusen för tjänsten Log Replay för den givna databasen.
...
Det här kommandot får statusen för uppspelning av loggtjänst för den angivna databasen.
