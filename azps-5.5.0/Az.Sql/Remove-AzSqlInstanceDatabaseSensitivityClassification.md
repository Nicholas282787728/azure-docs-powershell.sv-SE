...
## BESKRIVNING
Med Remove-AzSqlInstanceDatabaseSensitivityClassification cmdleten tas informationstyper och känslighetsetiketter för kolumner i den hanterade Azure SQL-instansdatabasen bort.

## EXEMPEL

### Exempel 1: Ta bort informationstyp och känslighetsetikett för en kolumn i en Azure SQL-hanterad instansdatabas.
```powershell
...
### Exempel 2: Ta bort aktuella informationstyper och känslighetsetiketter för kolumner i en Azure SQL-hanterad instansdatabas med Piping.
```powershell
...
### Exempel 3: Ta bort informationstyp och känslighetsetikett för en kolumn i en Azure SQL-hanterad instansdatabas med Piping.
```powershell
...
Ett objekt som representerar en känslighetsklassificeringsklassificering för SQL Managed Instance Database.
...
### -DatabaseName
Namnet på Azure SQL-hanterad instansdatabas.
...
### -DatabaseObject
Azure SQL-hanterade instansdatabasobjekt.
...
### -InstanceName
Namn på hanterad Azure SQL-instans.
