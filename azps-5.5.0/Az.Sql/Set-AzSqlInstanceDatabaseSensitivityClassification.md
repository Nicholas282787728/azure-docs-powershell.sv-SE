...
## BESKRIVNING
Med Set-AzSqlInstanceDatabaseSensitivityClassification-cmdleten anges informationstyper och känslighetsetiketter för kolumner i Azure SQL-hanterade instansdatabasen.

## EXEMPEL

### Exempel 1: Ange informationstyp och känslighetsetikett för en kolumn i en Azure SQL-hanterad instansdatabas.
```powershell
...
### Exempel 2: Ange rekommenderade informationstyper och känslighetsetiketter för kolumner i en Azure SQL-hanterad instansdatabas.
```powershell
...
### Exempel 3: Ange informationstyp och känslighetsetikett för en kolumn i en Azure SQL-hanterad instansdatabas med hjälp av rörledning.
```powershell
...
### -InformationType
Ett namn som beskriver informationstypen för de data som lagras i kolumnen.
...
### -Känslighetsetikett
Ett namn som beskriver känsligheten för data som lagras i kolumnen.
