...
## BESKRIVNING
Med Enable-AzSqlDatabaseSensitivityRecommendation-cmdleten kan du rekommendationer om känslighet för kolumner i databasen.

## EXEMPEL

### Exempel 1: Aktivera känslighetsrekommendationer för en viss kolumn i en Azure SQL-databas.
```powershell
...
### Exempel 2: Aktivera känslighetsrekommendationer för en viss kolumn i Azure SQL-databas med piping.
```powershell
...
### -PassThru
Anger om du vill mata ut modellen för känslighetsklassificering i slutet av cmdlet-körningen
