...
## BESKRIVNING
Cmdleten **Get-AzSqlElasticPoolActivity** får statusen för åtgärderna på en pool med pool för azure SQL.
Du kan se status för både skapande av pooler och konfigurationsuppdateringar.

## EXEMPEL

### Exempel 1: Hämta status för åtgärderna för en pool med pooler
```
PS C:\>Get-AzSqlElasticPoolActivity -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

Det här kommandot får statusen för åtgärderna för poolen med namnet ElasticitPool01.
