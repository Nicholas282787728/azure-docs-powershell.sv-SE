...
## BESKRIVNING
Cmdleten **Set-AzSqlServerAdvisorAutoExecuteStatus** anger egenskapen Auto execute för en Azure SQL Server Advisor.
...
Med det här kommandot kan du köra statusen automatiskt för en rådgivare med namnet CreateIndex.
...
### -AutoExecuteStatus
Anger värdet som cmdleten uppdaterar status för automatiskt.
