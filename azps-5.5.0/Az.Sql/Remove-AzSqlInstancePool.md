...
## BESKRIVNING
Cmdleten **Remove-AzSqlInstancePool** tar bort en Azure SQL-instanspool.

## EXEMPEL

### Exempel 1: Ta bort en instanspool
```powershell
PS C:\> Remove-AzSqlInstancePool -ResourceGroup resourcegroup01 -Name instancePool0
```

### Exempel 2: Ta bort en instanspool med resursidentifieraren
```powershell
...
### Exempel 3: Ta bort en instanspool med ett instanspoolobjekt
```powershell
...
Med det här kommandot tas en instanspool med namnet instancePool0 bort.
...
### -InputObject
Instanspoolobjektet som ska tas bort.
...
### -ResourceId
Det resurs-ID för instanspool som ska tas bort.
