...
## BESKRIVNING
**Cmdleten Remove-AzSqlDatabaseLongTermRetentionBackup** tar bort den angivna säkerhetskopian.

## EXEMPEL

### Exempel 1: Ta bort en enskild säkerhetskopia med resursgruppen
```powershell
...
Tar bort säkerhetskopian med namn 601061b7-d10b-46e0-bf77-a2bfb16a6add;131655666550000000

### Exempel 2: Ta bort en enskild säkerhetskopia utan resursgrupp
```powershell
...
### Exempel 3: Ta bort alla säkerhetskopior för en plats
```powershell
...
Med det här kommandot tas alla säkerhetskopior för bevarande på lång sikt bort för platsen northeurope.
...
### -InputObject
Det säkerhetskopiaobjekt för databaslagring som du vill ta bort.
...
### -ResourceId
Resurs-ID för databasens säkerhetskopia för långsiktigt bevarande som ska tas bort.
...
### -Servernamn
Namnet på Azure SQL Server som säkerhetskopian finns under.
