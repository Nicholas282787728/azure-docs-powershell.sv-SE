...
## BESKRIVNING
Cmdleten **Get-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy** får den långsiktiga bevarandeprincipen registrerad i den hanterade databasen.
...
Hämtar den aktuella versionen av den långsiktiga bevarandeprincipen för databasen

## PARAMETERS

### -DatabaseName
Namnet på azure-hanterad databas som ska användas.
...
### -InstanceName
Namnet på den Azure Managed Instance som databasen tillhör.
