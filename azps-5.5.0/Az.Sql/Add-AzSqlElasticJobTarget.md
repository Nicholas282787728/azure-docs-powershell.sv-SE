...
## BESKRIVNING
Med Add-AzSqlElasticJobTarget-cmdleten läggs en målresurs till i en målgrupp

## EXEMPEL

### Exempel 1: Lägga till ett servermål
```powershell
...
### Exempel 2: Lägga till ett databasmål
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### Exempel 3: Lägga till ett mål med en pool med pooler
```powershell
...
### Exempel 4: Lägga till ett fragmentt kartmål
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Lägger till ett mål (server, pool, databas och fragmentkarta) i en målgrupp
