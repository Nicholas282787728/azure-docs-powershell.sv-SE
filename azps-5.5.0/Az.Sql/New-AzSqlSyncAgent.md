...
## BESKRIVNING
Cmdleten **New-AzSqlSyncAgent** skapar en Azure SQL-synkroniseringsagent.

## EXEMPEL

### Exempel 1: Skapa en synkroniseringsagent för en Azure SQL-server.
```
...
Det här kommandot skapar en synkroniseringsagent för en Azure SQL-server.
...
### -SyncDatabaseResourceID
Resurs-ID för synkroniserings-metadata-databas.
