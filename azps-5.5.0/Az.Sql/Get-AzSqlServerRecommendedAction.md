...
## BESKRIVNING
Cmdleten **Get-AzSqlServerRecomaction** får en eller flera rekommenderade åtgärder för en Azure SQL Server-rådgivare.

## EXEMPEL

### Exempel 1: Visa en lista över alla rekommenderade åtgärder för en viss rådgivare
```
...
Med det här kommandot får du en lista över alla rekommenderade åtgärder för SQL Server-rådgivaren som heter CreateIndex tillgänglig för servern Wi-Runner-australia-east.
...
Det här kommandot hämtar en rekommenderad åtgärd IR_ \[ test_schema \] _ \[ test_table_0,0361551 \] _6C7AE8CC9C87E7FD5893 från rådgivaren som heter CreateIndex.

## PARAMETERS

### -AdvisorName
Anger namnet på den rådgivare som cmdleten begär åtgärder för.
...
### -ResourceGroupName
Anger namnet på resursgruppen på servern som innehåller den här servern.
...
### -Servernamn
Anger namnet på den server som rådgivaren tillhör.
