...
### WithDirigeringExecutionIdUsingParentObject
```
Get-AzSqlElasticJobExecution [-ParentObject] <AzureSqlElasticJobAgentModel> -JobName <String>
...
### WithSourceExecutionIdUsingParentResourceId
```
...
## BESKRIVNING
Cmdlet Get-AzSqlElasticJobExecution en eller flera jobbkörningar

## EXEMPEL

### Exempel 1: Får en eller flera jobbkörningar för alla jobb
```powershell
...
### Exempel 2: Får en eller flera jobbkörningar för ett jobb
```powershell
PS C:\> $agent = Get-AzSqlElasticJobAgent -ResourceGroupName rg -ServerName elasticjobserver -Name agent
...
Får en eller flera jobbkörningar. (autogenererat)
