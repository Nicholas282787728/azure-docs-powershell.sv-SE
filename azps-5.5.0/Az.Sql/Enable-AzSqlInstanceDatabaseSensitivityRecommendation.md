...
## BESKRIVNING
Med Enable-AzSqlInstanceDatabaseSensitivityRecommendation-cmdleten kan du rekommendationer om känslighet för kolumner i Azure SQL-hanterade instansdatabasen.

## EXEMPEL

### Exempel 1: Aktivera känslighetsrekommendationer för en viss kolumn i en Azure SQL-hanterad instansdatabas.
```powershell
...
### Exempel 2: Aktivera känslighetsrekommendationer för en viss kolumn i en Azure SQL-hanterad instansdatabas med Piping.
```powershell
