...
## BESKRIVNING
Den Get-AzSqlInstanceDatabaseSensitivityClassification cmdleten returnerar aktuella informationstyper och känslighetsetiketter för kolumner i azure SQL-hanterade instansdatabasen.

## EXEMPEL

### Exempel 1: Hämta aktuella informationstyper och känslighetsetiketter för en Azure SQL-hanterad instansdatabas.
```powershell
...
### Exempel 2: Hämta aktuella informationstyper och känslighetsetiketter för en Azure SQL-hanterad instansdatabas med Piping.
```powershell
...
### Exempel 3: Hämta aktuell informationstyp och känslighetsetikett för en viss kolumn i en Azure SQL-hanterad instansdatabas.
```powershell
...
### Exempel 4: Hämta aktuell informationstyp och känslighetsetikett för en viss kolumn i en Azure SQL-hanterad instansdatabas med Piping.
```powershell
