...
## BESKRIVNING
Cmdleten **Set-AzSqlDatabaseBackupLongTermRetentionPolicy** anger den långsiktiga bevarandeprincip som är registrerad för den här databasen.
Principen är en Azure Backup-resurs som används för att definiera en princip för säkerhetskopieringslagring.

## EXEMPEL

### Exempel 1: Ange det veckovisa bevarandet för den aktuella versionen av bevarandeprincipen för långsiktigt
```powershell
...
Det här anger den långsiktiga bevarandeprincipen för databas01 så att fullständig säkerhetskopiering sparas varje vecka i 2 veckor

### Exempel 2: Ange månatlig lagring för den aktuella versionen av bevarandeprincipen för lång period
```powershell
...
Det här anger den långsiktiga bevarandeprincipen för databas01 så att den första fullständiga säkerhetskopian för varje månad sparas i 5 år

### Exempel 3: Ange det årliga bevarandet för den aktuella versionen av bevarandeprincipen för långsiktigt
```powershell
...
Det här anger den långsiktiga bevarandeprincipen för databas01 för att spara den fullständiga säkerhetskopian från den 26:e veckan på året i 10 år

### Exempel 4: Ange varje bevarande för den aktuella versionen av bevarandeprincipen på lång sikt
```powershell
...
Det här anger den långsiktiga bevarandeprincipen för databas01, så att varje fullständig säkerhetskopiering sparas i 14 dagar, den första fullständiga säkerhetskopian av varje månad i 24 veckor och fullständig säkerhetskopiering, som är den 26:e veckan på året under tio år

### Exempel 5: Ta bort den långsiktiga bevarandeprincipen
```powershell
...
Tar bort principen för databas01 så att den inte längre sparar några långsiktiga säkerhetskopior.
Detta påverkar inte säkerhetskopior som redan har tagits

### Exempel 6: Ta bort den långsiktiga bevarandeprincipen
```powershell
...
Det här är ett annat sätt att ta bort principen för databas01 så att den inte längre sparar några säkerhetskopior med långsiktigt bevarande.
Detta påverkar inte säkerhetskopior som redan har tagits
...
### -MonthlyRetention
Månadslagring.
Om bara ett tal överförs i stället för en ISO 8601-sträng förutsätts dagar som enheter.
Det finns minst 7 dagar och högst 10 år.
...
### -RemovePolicy
Om den anges tas principen för databasen bort.
...
### -WeekOfYear
Veckan på året, 1 till 52, för att spara för den årliga lagringen.
