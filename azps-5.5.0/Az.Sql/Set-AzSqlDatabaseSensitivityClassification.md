...
## BESKRIVNING
Med Set-AzSqlDatabaseSensitivityClassification cmdleten anges informationstyper och känslighetsetiketter för kolumner i databasen.

## EXEMPEL

### Exempel 1: Ange informationstyp och känslighetsetikett för en kolumn i en Azure SQL-databas.
```powershell
...
### Exempel 2: Ange rekommenderade informationstyper och känslighetsetiketter för kolumner i en Azure SQL-databas.
```powershell
...
### Exempel 3: Ange informationstyp och känslighetsetikett för en kolumn i en Azure SQL-databas med hjälp av rörledning.
```powershell
