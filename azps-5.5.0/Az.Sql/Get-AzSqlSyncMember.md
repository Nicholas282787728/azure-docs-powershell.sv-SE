...
## BESKRIVNING
Cmdleten **Get-AzSqlSyncMember** returnerar information om en eller flera synkroniseringsmedlemmar i Azure SQL Database.
Ange namnet på en synkroniseringsmedlem om du bara vill visa information för den synkroniseringsmedlemmen.

## EXEMPEL

### Exempel 1: Hämta alla förekomster av Azure SQL Sync Member som tilldelats till en synkroniseringsgrupp
```
...
Med det här kommandot får du information om alla azure SQL Database Sync Member som tilldelats synkroniseringsgruppen SyncGroup01.

### Exempel 2: Få information om en synkroniseringsmedlem i Azure SQL Database
```
...
Det här kommandot hämtar information om Azure SQL Database Sync Member med namnet "SyncMember01"

### Exempel 3: Hämta alla förekomster av Azure SQL Sync Member som tilldelats till en synkroniseringsgrupp med hjälp av filtrering
```
...
Med det här kommandot får du information om alla azure SQL Database Sync Member som tilldelats synkroniseringsgruppen SyncGroup01 som börjar med "SyncMember".
