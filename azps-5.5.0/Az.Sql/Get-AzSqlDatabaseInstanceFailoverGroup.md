...
## BESKRIVNING
Hämtar en specifik instans redundansgrupp eller visar instansens redundansgrupper i en region under användarens prenumeration.

Endera region i instansen redundansgrupp kan användas för att köra kommandot. De returnerade värdena återspeglar de hanterade instanserna i den regionen i förhållande till instansens redundansgrupp.
...
Visar alla redundansgrupper i regionen
...
Skapa en specifik redundansgrupp för instans.
...
### -Name
Namnet på den redundansgrupp som ska hämtas.
