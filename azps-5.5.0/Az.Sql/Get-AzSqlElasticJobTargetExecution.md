...
## BESKRIVNING
Cmdlet Get-AzSqlElasticJobTargetExecution en eller flera jobbmålkörningar från en jobbkörning

## EXEMPEL

### Exempel 1: Får en eller flera jobbmålkörningar från en jobbkörning
```powershell
...
### Exempel 2: Får en eller flera jobbmålkörningar från en jobbkörning – filtrerar efter steg-namn
```powershell
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
...
### -Count
Antal returnerar det högsta antalet körningar.
...
### -CreateTimeMin
Filtrera genom att skapa tid min
...
### Microsoft.Azure.Commands.Sql.ElasticitKommandos.Model.AzureSqlElasticKommandoExecutionModel
