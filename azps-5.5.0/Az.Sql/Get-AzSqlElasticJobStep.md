...
### GetVersionUsing Det här är GetVersionUsing Entitetsobjekt
```
...
## BESKRIVNING
Den Get-AzSqlElasticJobStep-cmdleten får ett eller flera jobbsteg från ett jobb

## EXEMPEL

### Exempel 1: Får ett jobbsteg från ett jobb
```powershell
...
Får ett jobbsteg från ett jobb
