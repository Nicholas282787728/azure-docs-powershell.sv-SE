...
## BESKRIVNING
**Cmdleten Remove-AzSqlInstanceDatabase** tar bort en Azure SQL Managed Instance-databas.
...
Med det här kommandot tas databasen databas01 bort från instans managedInstance1.
...
### -InputObject
Instansdatabasobjektet som ska tas bort
...
### -Name
Namnet på Azure SQL-instansdatabasen som ska tas bort.
...
### -ResourceId
Resurs-ID för instansdatabasobjekt som ska tas bort
