...
## BESKRIVNING
Cmdleten **Get-AzSqlSyncSchema** returnerar information om synkroniseringsschemat för en medlemsdatabas eller en navdatabas.

## EXEMPEL

### Exempel 1: Hämta synkroniseringsschemat för en navdatabas
```powershell
...
Det här kommandot hämtar synkroniseringsschemat för navdatabasen i synkroniseringsgruppen syncGroup01.

### Exempel 2: Hämta synkroniseringsschemat för en navdatabas och expandera tabeller
```powershell
...
Det här kommandot hämtar synkroniseringsschemat för navdatabasen i synkroniseringsgruppen syncGroup01 och expanderar egenskapen Tabeller.

### Exempel 3: Hämta synkroniseringsschemat för en medlemsdatabas
```powershell
...
Det här kommandot hämtar synkroniseringsschemat för medlemsdatabasen i synkroniseringsmedlemmen syncMember01.
