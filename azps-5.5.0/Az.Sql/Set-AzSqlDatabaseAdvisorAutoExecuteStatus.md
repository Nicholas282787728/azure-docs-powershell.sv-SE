...
## BESKRIVNING
Cmdleten **Set-AzSqlDatabaseAdvisorAutoExecuteStatus** ändrar egenskapen Auto execute för en Azure SQL Database Advisor.
För närvarande har den här cmdleten stöd för värdena Aktiverad, Inaktiverad och Standard.
...
Med det här kommandot ändras statusen för automatisk körning av en rådgivare med namnet CreateIndex till Aktiverad.

## PARAMETERS

### -AdvisorName
Anger namnet på den rådgivare som denna cmdlet ändrar status för.
...
### -DatabaseName
Anger namnet på databasen som denna cmdlet ändrar status för.
...
### -Servernamn
Anger namnet på databasens server.
