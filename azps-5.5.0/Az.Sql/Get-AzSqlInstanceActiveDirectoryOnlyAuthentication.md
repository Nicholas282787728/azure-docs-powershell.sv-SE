...
## BESKRIVNING
Cmdleten **Get-AzSqlInstanceActiveDirectoryOnlyAuthentication** får azure Active Directory (Azure AD) endast autentiseringskrav för azureSQL-hanterade instanser i den aktuella prenumerationen.
...
Det här kommandot hämtar azure Active Directory (Azure AD) endast autentiseringskrav för en AzureSQL-hanterad instans med namnet ManagedInstance01 som är associerad med en resursgrupp med namnet ResourceGroup01.
