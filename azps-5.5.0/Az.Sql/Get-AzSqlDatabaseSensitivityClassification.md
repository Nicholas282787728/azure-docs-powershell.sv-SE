...
## BESKRIVNING
Den Get-AzSqlDatabaseSensitivityClassification cmdleten returnerar aktuella informationstyper och känslighetsetiketter för kolumner i Azure SQL-databasen.

## EXEMPEL

### Exempel 1: Hämta aktuella informationstyper och känslighetsetiketter för en Azure SQL-databas.
```powershell
...
### Exempel 2: Hämta aktuella informationstyper och känslighetsetiketter för en Azure SQL-databas med piping.
```powershell
...
### Exempel 3: Hämta aktuell informationstyp och känslighetsetikett för en viss kolumn i en Azure SQL-databas.
```powershell
...
### Exempel 4: Hämta aktuell informationstyp och känslighetsetikett för en viss kolumn i en Azure SQL-databas med piping.
```powershell
