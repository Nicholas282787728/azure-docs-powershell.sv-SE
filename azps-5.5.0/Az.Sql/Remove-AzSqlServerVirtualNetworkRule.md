...
## BESKRIVNING
Med det här kommandot tas en azure SQL Server Virtual Network-regel bort.
...
Tar bort en befintlig regel för virtuell Azure SQL Server-nätverk
...
Namn på Azure Sql Server Virtual Network-regel
