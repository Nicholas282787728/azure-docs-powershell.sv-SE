...
## BESKRIVNING
Cmdleten **Get-AzSqlSyncGroupLog** returnerar loggarna för en Azure SQL Database Sync Group.
...
Det här kommandot hämtar loggarna för en Azure SQL Sync Group.
...
### -EndTime
Sluttiden för loggarna som ska sökas.
...
### -StartTime
Starttiden för loggarna som ska sökas.
