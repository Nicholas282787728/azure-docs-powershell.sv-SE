...
## BESKRIVNING
Med det här kommandot tas instansens redundansgrupp bort med angivet namn och alla databaser förblir intakta. Slutpunkten för lyssnare avregistreras från DNS.

Instansens primärområde för redundansgruppen ska användas för att köra kommandot.
...
Ta bort en redundansgrupp för instans.
...
### -InputObject
Instansen Failover Group-objekt som ska tas bort
...
### -Name
Namnet på den redundansgrupp du vill ta bort.
...
### -PassThru
Anger om cmdlet-körningen ska överföras.
...
### -ResourceId
Resurs-ID för den redundansgrupp för instans som ska tas bort.
