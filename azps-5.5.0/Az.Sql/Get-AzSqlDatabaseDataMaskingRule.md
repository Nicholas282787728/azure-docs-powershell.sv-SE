...
## BESKRIVNING
Cmdleten **Get-AzSqlDatabaseDataMaskingRule** får antingen en specifik datamaskeringsregel eller alla datamaskeringsregler för en Azure SQL-databas.
Om du vill använda cmdleten använder du parametrarna *ResourceGroupName,* *ServerName* och *DatabaseName* för att identifiera databasen, och *RuleId-parametern* för att ange vilken regel cmdleten returnerar.
Om du inte anger *RuleId* returneras alla datamaskeringsregler för azure SQL-databasen.
Den här cmdleten stöds också av tjänsten Stretcha databas för SQL Server i Azure.

## EXEMPEL

### Exempel 1: Hämta alla datamaskeringsregler från en databas
```
...
### Exempel 2: Hämta datamaskregeln definierad i schemat "dbo", tabell "tabell1" och kolumn "kolumn1".
```
