...
## BESKRIVNING
Cmdleten **Get-AzSqlVirtualCluster** returnerar information om ett eller flera virtuella Azure SQL-kluster.
Ange namnet på ett virtuellt kluster om du vill visa information för endast det klustret.

## EXEMPEL

### Exempel 1: Få alla virtuella kluster tilldelade till en resursgrupp
```powershell
...
Det här kommandot hämtar information om alla virtuella kluster som tilldelats resursgruppen ResourceGroup01.

### Exempel 2: Få information om ett visst virtuellt kluster
```
...
Med det här kommandot får du information om det virtuella klustret VirtualCluster1 i resursgruppen ResourceGroup01.
...
### -ResourceId
Resurs-ID för instansobjekt som ska fås
