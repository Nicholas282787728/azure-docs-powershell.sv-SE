...
## BESKRIVNING
Cmdleten **Remove-AzSqlInstance** tar bort en Azure SQL Database Managed-instans.
...
Det här kommandot tar bort instansen med namnet managedInstance1.
