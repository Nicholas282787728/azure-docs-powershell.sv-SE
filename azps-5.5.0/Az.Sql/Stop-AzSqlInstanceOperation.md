...
## BESKRIVNING
CmdletStop-AzSqlInstanceOperation avbryter åtgärden med antaget åtgärdsnamn i en SQL-hanterad instans.

## EXEMPEL

### Exempel 1: Hämta en specifik åtgärd
```powershell
...
Det här kommandot avbryter åtgärden med namnet 'd0f5bef5-e2b1-4ef8-bb42-2e54073874f9' i en SQL-hanterad instans.

### Exempel 2: Använda åtgärdsresurs-ID
```powershell
...
Det här kommandot avbryter åtgärden med resurs-ID $managedInstanceOperation.Id.

### Exempel 3: Använda åtgärdsobjekt
```powershell
...
Det här kommandot avbryter åtgärden med $managedInstanceOperation.
...
### -ResourceId
Resurs-ID för åtgärdsobjektet som ska stoppas
