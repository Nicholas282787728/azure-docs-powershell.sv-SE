...
## BESKRIVNING
Cmdleten **Get-AzSqlServerAdvancedDataSecurityPolicy** hämtar en servers Advanced Data Security-policy.

## EXEMPEL

### Exempel 1: Får avancerad datasäkerhet för server
```powershell
...
### Exempel 2: Får serverns avancerade datasäkerhet från serverresurs
```powershell
