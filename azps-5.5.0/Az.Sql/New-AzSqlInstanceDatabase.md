...
## BESKRIVNING
**Cmdleten New-AzSqlInstanceDatabase** skapar en Azure SQL Managed-instansdatabas.

## EXEMPEL

### Exempel 1: Skapa en databas i en angiven instans
```
...
Med det här kommandot skapas en instansdatabas med namnet Databas01 på instans managedInstance1.
...
### -Collation
Sorteringen av den sortering av Azure SQL-instansdatabas som ska användas.
...
### -Name
Namnet på Azure SQL-instansdatabasen som ska skapas.
...
### -Tag
De taggar som ska associeras med Azure Sql Instance-databasen
