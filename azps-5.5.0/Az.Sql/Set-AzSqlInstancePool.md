...
## BESKRIVNING
Cmdleten **Set-AzSqlInstancePool** ändrar egenskaperna för en Azure SQL-instanspool.

## EXEMPEL

### Exempel 1: Ange en licenstyp för en instanspool
```powershell
...
Det här kommandot anger licenstyp och/eller taggar för en instanspool med namnet instancePool0.

### Exempel 2: Ange en licenstyp för instanspool med hjälp av ett instanspoolobjekt
```powershell
...
Det här kommandot anger licenstyp och/eller taggar för en instanspool med hjälp av ett instanspoolobjekt.

### Exempel 3: Ange en licenstyp för instanspool med hjälp av ett resurs-ID för instanspool
```powershell
...
### -LicenseType
Avgör vilken licenstyp som ska användas.
