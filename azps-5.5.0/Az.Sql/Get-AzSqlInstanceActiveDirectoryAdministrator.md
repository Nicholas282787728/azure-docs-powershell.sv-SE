...
## BESKRIVNING
**Cmdleten Get-AzSqlInstanceActiveDirectoryAdministrator** hämtar information om en Azure Active Directory-administratör (Azure AD) för en AzureSQL-hanterad instans i den aktuella prenumerationen.
...
Det här kommandot hämtar information om en Azure AD-administratör för en hanterad instans med namnet ManagedInstance01 som är associerad med en resursgrupp med namnet ResourceGroup01.
...
Det här kommandot hämtar information om en Azure AD-administratör från ett hanterat instansobjekt.
...
Med det här kommandot får du information om en Azure AD-administratör med resursidentifieraren för hanterade instanser.
