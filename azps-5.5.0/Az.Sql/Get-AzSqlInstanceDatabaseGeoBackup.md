...
## BESKRIVNING
**Cmdleten Get-AzSqlInstanceDatabaseGeoBackup** får en eller flera Azure SQL-databaser redundanta säkerhetskopior från en hanterad Azure SQL-databasinstans.

## EXEMPEL

### Exempel 1: Få alla databas redundanta säkerhetskopior på en instans
```
...
Med det här kommandot får du alla databas redundanta säkerhetskopior på instansen managedInstance1.

### Exempel 2: Få en databas redundant säkerhetskopia efter namn på en hanterad instans
```
...
Det här kommandot får en databas redundant säkerhetskopia med namnet managedDatabase1 från en instans med namnet managedInstance1.

### Exempel 3: Få alla databas redundanta säkerhetskopior på en instans med hjälp av filtrering
```
...
Med det här kommandot får du alla databas redundanta säkerhetskopior på instansen managedInstance1 som börjar med "managedDatabase".
...
### -Name
Namnet på den instansdatabas som ska hämtas.
