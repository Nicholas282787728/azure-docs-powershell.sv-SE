...
ms.locfileid: "100253576"
---
# Set-AzSqlDatabaseInstanceFailoverGroup

## SYNOPSIS
Ändrar konfigurationen av en instans redundansgrupp.
...
## BESKRIVNING
Det här kommandot ändrar konfigurationen av en instans redundansgrupp.

Instansens primära region för redundansgruppen ska användas för att köra kommandot.
...
Ställer in redundansgruppens redundansprincip till Manuell genom rörning i gruppen Redundans.
...
### -InputObject
Instansen Failover Group-objekt som ska anges
...
### -ResourceId
Resurs-ID för den redundansgrupp som ska anges.
