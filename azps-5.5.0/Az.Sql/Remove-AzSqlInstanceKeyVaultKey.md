...
## BESKRIVNING
Med Remove-AzSqlInstanceKeyVaultKey cmdleten tas nyckeln för nyckelvalv bort från den angivna hanterade instansen. Observera att den SQL-hanterade instansens behörigheter till nyckelns valv inte ändras. Om du vill ändra behörigheter använder du Set-AzKeyVaultAccessPolicy. Observera att denna cmdlet inte gör några ändringar av nyckelvalv. Om du vill ta bort en nyckel från nyckelvalv använder du Remove-AzureKeyVaultKey.
...
Det här kommandot tar bort nyckeln för nyckelvalv med Id ' https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 från den angivna hanterade instansen. 
