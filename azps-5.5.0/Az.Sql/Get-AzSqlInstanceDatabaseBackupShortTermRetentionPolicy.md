...
## BESKRIVNING
Cmdleten **Get-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy** får den korta bevarandeprincip som har registrerats i den databasen.
...
Det här kommandot hämtar den korta bevarandeprincipen för databas01.
...
Det här kommandot hämtar den korta bevarandeprincipen för databas01 via rörning i ett databasobjekt.
...
Det här kommandot hämtar den korta bevarandeprincipen för alla borttagna databaser med namnet databas01 via rörning i ett borttagna databasobjekt.
