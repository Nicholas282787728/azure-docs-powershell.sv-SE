...
## BESKRIVNING
Cmdleten **Get-AzSqlInstance** returnerar information om en eller flera Azure SQL Managed Instances.
Ange namnet på en instans om du bara vill visa information för den instansen.

## EXEMPEL

### Exempel 1: Hämta alla instanser tilldelade till en resursgrupp
```powershell
...
Med det här kommandot får du information om alla instanser som tilldelats resursgruppen ResourceGroup01.
...
Det här kommandot hämtar information om instansen managedInstance1.

### Exempel 3: Få alla instanser tilldelade till en resursgrupp med hjälp av filtrering
```powershell
...
Med det här kommandot får du information om alla instanser som tilldelats resursgruppen ResourceGroup01, som börjar med "managedInstance".

### Exempel 4: Hämta alla instanser i en instanspool
```powershell
...
Det här kommandot hämtar information om alla instanser i instanspoolen "instancePool0".

### Exempel 5: Hämta alla instanser i en instanspool med hjälp av instanspoolobjekt
```powershell
...
### Exempel 6: Hämta alla instanser i en instanspool med hjälp av resursidentifierare för instanspool
```powershell
...
### Exempel 7: Hämta en hanterad instans med resursidentifieraren
```powershell
...
### -ResourceId
Resursidentifieraren för hanterade instanser.
