...
## BESKRIVNING
Cmdleten **Get-AzSqlInstancePoolUsage** returnerar information som används av en Azure SQL-instanspool.

## EXEMPEL

### Exempel 1: Hämtar användningen av en Azure SQL-instanspool
```powershell
...
Hämtar användningen för Azure SQL-instanspoolinstanspool0.

### Exempel 2: Hämtar användningen av en Azure SQL-instanspool med ett instanspoolobjekt
```powershell
...
Hämtar användningen för Azure SQL-instanspoolinstanspool0 med ett instanspoolobjekt.

### Exempel 3: Hämtar användningen av en Azure SQL-instanspool med hjälp av ett resurs-ID för instanspool
```powershell
...
Hämtar användningen för Azure SQL-instanspoolinstanspool0 med en resursidentifierare för instanspool.

### Exempel 3: Hämtar användningen av en Azure SQL-instanspool med en uppdelning av de hanterade instansanvändningarna i poolen.
```powershell
...
Hämtar användningen för Azure SQL-instanspool för instanspool0 tillsammans med användningen av de hanterade instanserna i instancepool0.
...
### -Expand Engström
Flagga som anger om den här instanspoolen ska utökas med barnens användning.
...
### -InstancePool
Det överordnade instanspoolobjektet.
...
### -Name
Namnet på den hanterade instanspoolen.
