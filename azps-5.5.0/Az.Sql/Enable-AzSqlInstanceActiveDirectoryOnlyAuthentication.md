...
## BESKRIVNING
**Enable-AzSqlInstanceActiveDirectoryOnlyAuthentication-cmdleten** aktiverar azure Active Directory (Azure AD) endast autentiseringskrav för azureSQL-hanterade instanser i den aktuella prenumerationen.
...
Med det här kommandot aktiveras endast azure Active Directory (Azure AD) autentiseringskrav för en AzureSQL-hanterad instans med namnet ManagedInstance01 som är associerad med en resursgrupp som heter ResourceGroup01.
