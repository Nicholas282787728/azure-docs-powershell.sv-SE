...
## BESKRIVNING
Cmdleten **Get-AzSqlDatabaseAudit** hämtar granskningsinställningarna för en Azure SQL-databas.
...
### Exempel 1: Hämta granskningsinställningarna för en Azure SQL-databas
```
...
### Exempel 2: Via pipeline hämtar du granskningsinställningarna för en Azure SQL-databas
```
...
### Exempel 3: Hämta granskningsinställningarna för en Azure SQL-databas
```
PS C:\>Get-AzSqlDatabaseAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
ServerName                          : server01
DatabaseName                        : database01
