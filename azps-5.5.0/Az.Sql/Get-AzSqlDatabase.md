...
Med det här kommandot får du alla databaser på servern server01.
...
Det här kommandot hämtar en databas med namnet Databas02 från en server med namnet Server01.
...
Med det här kommandot får du alla databaser på servern server01 som börjar med "databas".
...
### -ResourceGroupName
Anger namnet på den resursgrupp som databasservern är tilldelad till.
...
### -Servernamn
Anger namnet på den server som databasen är tilldelad till.
