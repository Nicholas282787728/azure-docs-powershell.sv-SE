...
### -MemberDatabaseName
Azure SQL Database-namnet på medlemsdatabasen.
...
Resurs-ID för synkroniseringsmedlemsdatabasen, som används om UsePrivateLinkConnection är inställd på sant.
...
Använd en privat länkanslutning när du ansluter till den här synkroniseringsmedlemmen.
