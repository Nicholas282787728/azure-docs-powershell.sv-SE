...
## BESKRIVNING
Cmdleten **Update-AzSqlSyncGroup** ändrar egenskaperna för en synkroniseringsmedlem i Azure SQL Database.
...
Det här kommandot återställer administratörslösenordet för medlemsdatabasen.
...
Om du vill använda privat länk när du ansluter till den här synkroniseringsmedlemmen.
