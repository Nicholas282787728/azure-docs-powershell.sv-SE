...
## BESKRIVNING
Hämta specifika Azure SQL Server DNS-alias eller listor med alla server-DNS-alias för servern
...
Visar alla server-DNS-alias för den specifika servern
...
Får Server DNS-alias som anges av server- och aliasnamn
...
Visar alla server-DNS-alias för den specifika server som börjar med "dnsaliasname".
