...
### With EntstepNameUsingParentObject
```
...
### WithSourceStepNameUsingParentResourceId
```
...
## BESKRIVNING
Den Get-AzSqlElasticJobStepExecution cmdleten får en eller flera körningar av jobbsteg från en jobbkörning

## EXEMPEL

### Exempel 1 – Får en eller flera jobbstegskörningar från en jobbkörning
```
...
### Exempel 2 - Får en eller flera jobbstegskörningar från en jobbkörning, filtrerar efter steg-namn
```
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
