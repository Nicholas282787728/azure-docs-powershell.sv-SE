...
ms.locfileid: "100253560"
---
# Stop-AzSqlInstanceDatabaseLogReplay

## SYNOPSIS
Avbryter tjänsten för uppspelning av logg genom att släppa databasen.
...
## BESKRIVNING
**Cmdleten Stop-AzSqlInstanceDatabaseLogReplay** tar bort databasen och avbryter därför tjänsten Logguppspelning.
...
Det här kommandot avbryter uppspelningstjänsten för loggar för den givna databasen.
