...
Med det här kommandot aktiverar du TDE för databasen Databas01 på servern Server01.

## PARAMETERS

### -DatabaseName
Anger namnet på databasen som cmdleten ändrar.
...
### -Delstat
Anger värdet för TDE-egenskapen.
