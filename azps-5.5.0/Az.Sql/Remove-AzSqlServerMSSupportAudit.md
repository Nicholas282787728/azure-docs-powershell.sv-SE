...
## BESKRIVNING
Cmdleten **Remove-AzSqlServerMSSupportAudit** tar bort granskningsinställningarna för Microsoft-supportåtgärder för en Azure SQL-server.
Om du vill använda cmdleten använder du *parametrarna ResourceGroupName* *och ServerName* för att identifiera servern.

## EXEMPEL

### Exempel 1: Ta bort granskningsinställningarna för Microsoft-supportåtgärder för en Azure SQL-server
```powershell
PS C:\>Remove-AzSqlServerMSSupportAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01"
```

### Exempel 2: Ta bort, via pipeline, Microsofts granskningsinställningar för en Azure SQL-server
```
