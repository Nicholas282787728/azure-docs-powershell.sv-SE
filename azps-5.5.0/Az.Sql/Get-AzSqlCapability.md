...
## BESKRIVNING
Cmdleten **Get-AzSqlCapability** får Azure SQL Database-funktionerna som är tillgängliga i den aktuella prenumerationen för en region.
Om du anger *parametrarna ServerVersionName,* *EditionName* eller *ServiceObjectiveName* returnerar den här cmdleten de angivna värdena och deras föregående värden.

## EXEMPEL

### Exempel 1: Skaffa funktioner för den aktuella prenumerationen för en region
```
...
Det här kommandot returnerar funktionerna för SQL Database-instanser i den aktuella prenumerationen för regionen i centrala USA.
...
Det här kommandot returnerar standardfunktionerna för SQL-databaser i den aktuella prenumerationen i regionen centrala USA.

### Exempel 3: Få information om ett tjänstemål
```
...
Det här kommandot får standardfunktioner för SQL-databaser för det angivna tjänstmålet för den aktuella prenumerationen.
...
### -Standardvärden
Anger att denna cmdlet endast får standardinställningar.
...
### -EditionName
Anger namnet på databasversionen som cmdleten hämtar funktioner för.
...
### -LocationName
Anger namnet på den plats som cmdleten hämtar funktioner för.
...
### -ServerVersionName
Anger namnet på serverversionen som cmdleten hämtar funktioner för.
