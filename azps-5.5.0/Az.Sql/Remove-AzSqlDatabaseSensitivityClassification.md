...
## BESKRIVNING
Med Remove-AzSqlDatabaseSensitivityClassification cmdleten tas informationstyper och känslighetsetiketter för kolumner i databasen bort.

## EXEMPEL

### Exempel 1: Ta bort informationstyp och känslighetsetikett för en kolumn i en Azure SQL-databas.
```powershell
...
### Exempel 2: Ta bort aktuella informationstyper och känslighetsetiketter för kolumner i en Azure SQL-databas med hjälp av Piping.
```powershell
...
### Exempel 3: Ta bort informationstyp och känslighetsetikett för en kolumn i en Azure SQL-databas med hjälp av Piping.
```powershell
