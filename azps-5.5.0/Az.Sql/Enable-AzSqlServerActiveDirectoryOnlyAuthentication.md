...
## BESKRIVNING
**Enable-AzSqlServerActiveDirectoryOnlyAuthentication-cmdleten** aktiverar Azure Active Directory (Azure AD) endast autentiseringskrav för AzureSQL Server i den aktuella prenumerationen.
...
Med det här kommandot aktiveras endast azure Active Directory (Azure AD) autentiseringskrav för en AzureSQL-server med namnet Server01 som är associerad med en resursgrupp med namnet ResourceGroup01.
