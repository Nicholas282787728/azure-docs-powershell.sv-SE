...
### Exempel 1: Ta bort med regelnamn
```powershell
PS C:\> Remove-AzScheduledQueryRule -ResourceGroupName "MyResourceGroup" -Name "LogAlertRule1"
```

### Exempel 2: Ta bort med inmatningsobjekt
```powershell
PS C:\> Remove-AzScheduledQueryRule -InputObject $PSScheduledQueryRuleResource
```

### Exempel 3: Ta bort med resurs-ID
```powershell
...
Denna cmdlet genererar inte några utdata.
