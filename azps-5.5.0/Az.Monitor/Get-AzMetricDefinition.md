...
## BESKRIVNING
Cmdleten **Get-AzMetricDefinition** hämtar metriska definitioner.

## EXEMPEL

### Exempel 1: Hämta metriska definitioner för en resurs
```
...
Det här kommandot hämtar mätvärdesdefinitioner för den angivna resursen.

### Exempel 2: Hämta metriska definitioner med detaljerade utdata
```
...
Det här kommandot får mätetriska definitioner för webbplats2.
Utdata är detaljerad.

### Exempel 3: Hämta metriska definitioner efter namn
```
...
Det här kommandot hämtar definitioner för mätvärdena BytesSent och CpuTime.
Utdata är detaljerad.
...
### -MetricNamespace
Anger det metriska namnområdet för mätvärdesdefinitioner för frågan.
