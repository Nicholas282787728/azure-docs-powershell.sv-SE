...
## BESKRIVNING
Cmdleten **New-AzActionGroupReceiver** skapar en ny mottagare för åtgärdsgrupper i minnet.
...
### -AzureAppPiverReceiver
Skapa en AzureAppPiverReceiver
...
### -ConnectionId
den här mottagarens anslutnings-ID
...
### -CountryCode
Anger landskoden för SMS-mottagaren.
...
### -EmailReceiver
Anger för att skapa en e-postmottagare
...
### -ObjectId
webhook-appens objekt-ID för aad auth
...
### -PhoneNumber
Anger SMS-mottagarens telefonnummer.
...
### -ServiceUri
Anger URI:en för webhook-mottagaren.
...
### -SmsReceiver
Anger för att skapa en SMS-mottagare
...
### -TenantId
klientorganisations-ID för aad auth
...
### -UseAadAuth
flaggan som ska användas för att lägga till autentisering
...
Flaggan om gemensamma aviseringsscheman ska användas. Det här värdet kommer att vara en bra start för mottagaren av SMS, Azure App push, ITSM och Voice.
...
### -WebhookReceiver
Anger för att skapa en webhook-mottagare
...
### -WorkspaceId
den här mottagarens id för sin arbetsyta
