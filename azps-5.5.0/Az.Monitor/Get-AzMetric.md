...
## BESKRIVNING
Cmdleten **Get-AzMetric** hämtar mätvärdena för en viss resurs.

## EXEMPEL

### Exempel 1: Hämta ett mått med summerade utdata
```
...
Det här kommandot får mätvärdena för webbplats3 med ett tidskorn på 1 minut.

### Exempel 2: Få ett mått med detaljerade utdata
```
...
Det här kommandot får de metriska värdena för webbplats3 med ett tids grain på 1 minut.
Utdata är detaljerad.

### Exempel 3: Få detaljerade utdata för ett visst mått
```
...
Det här kommandot får detaljerade utdata för mätvärdet Begäranden.

### Exempel 4: Hämta sammanfattade utdata för ett angivet mått med angivet måttfilter
```
...
Det här kommandot får sammanfattade utdata för PageViews-måttet med angivet måttfilter och aggregeringstyp.

## PARAMETERS

### -AggregationType
Frågans aggregeringstyp
...
### -DetailedOutput
Anger att denna cmdlet visar detaljerade utdata.
Som standard summeras utdata.
...
### -MetricFilter
Anger det metriska dimensionsfiltret som du vill fråga mått för.
...
### -MetricNamespace
Anger det metriska namnområdet som frågemåtten ska anges för.
...
### -OrderBy
Anger aggregeringen som ska användas för att sortera resultat och sorteringsriktningen (Exempel: summa asc).
...
### -ResultType
Anger den resultattyp som ska returneras (metadata eller data).
...
### -TimeGrain
Anger tids grain för mätvärdet som ett **TimeSpan-objekt** i formatet hh:mm:ss.
...
### -Top
Anger det maximala antalet poster som ska hämtas (standard:10), som ska anges $filter.
...
Mer information om måtten som stöds finns på: https://docs.microsoft.com/en-us/azure/azure-monitor/platform/metrics-supported
