...
## BESKRIVNING
Skapar en aviseringsåtgärd för objekt av typen Det här objektet ska skickas till kommandot som skapar loggaviseringsregeln
...
### -Allvarlighetsgrad
Allvarlighetsgraden för den här aviseringen
...
### -BegränsningInMinutes
Den varaktighet i minuter som aviseringen ska begränsas för
...
### -Utlösare
Villkoret för aviseringsutlösaren
