...
Få diagnostikinställningskategorier som stöds för virtuellt nätverk.
...
### -Name
Namn på kategori för diagnostikinställningar
...
### Microsoft.Azure.Commands.Insights.OutputClasses.PSDiagticSettingCategory
