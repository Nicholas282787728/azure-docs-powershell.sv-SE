...
## BESKRIVNING
Cmdleten **New-AzAutoscaleProfile** skapar en profil för automatisk skalning.
...
Det första kommandot skapar en regel för automatisk skalning med namnet Requests (Begäranden) och lagrar den sedan $Rule variabeln.
...
Det första kommandot skapar en regel för automatisk skalning med namnet Requests (Begäranden) och lagrar den sedan $Rule variabeln.
Med det andra kommandot skapas en profil med namnet SecondProfileName med ett återkommande schema med hjälp av regeln i $Rule.
...
De två första kommandona skapar regler och lagrar dem i variablerna $Rule 1 och $Rule 2.
Det tredje kommandot skapar en profil med namnet ProfileName med hjälp av reglerna i Regel1 och Regel2, och lagrar sedan den i variabeln $Profile 1.
Det slutliga kommandot skapar en profil med namnet SecondProfileName med reglerna i Regel1 och Regel2 och lagrar sedan den i $Profile 2-variabeln.
...
Det första kommandot skapar en regel för automatisk skalning med namnet Requests (Begäranden) och lagrar den sedan $Rule variabeln.
Det andra kommandot skapar en profil utan ett schema eller ett fast datum och lagrar sedan den i $Profile variabeln.
...
### -RecurrenceFrequency
Anger hur ofta händelsen ska upprepas.
...
### -StartTimeWindow
Anger början av ett tidsfönster.
...
### -TimeWindowTimeZone
Anger tidszonen för ett tidsfönster.
