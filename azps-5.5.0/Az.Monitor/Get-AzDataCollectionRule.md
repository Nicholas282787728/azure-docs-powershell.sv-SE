...
ms.locfileid: "100214262"
---
# Get-AzDataCollectionRule

## SYNOPSIS
Hämtar datainsamlingsregel(er).
...
## BESKRIVNING
Cmdleten **Get-AzDataCollectionRule** får en eller flera datainsamlingsregler.
...
### Exempel 1: Hämta regler för datainsamling efter prenumerations-ID
```
...
Med det här kommandot visas alla datainsamlingsregler för den aktuella prenumerationen.

### Exempel 2: Hämta datainsamlingsregler för den givna resursgruppen
```
...
Det här kommandot listar datainsamlingsregler för den givna resursgruppen.

### Exempel 3: Hämta en regel för datainsamling
```
...
Det här kommandot listar en datainsamlingsregel (en lista med ett enda element).

### Exempel 4: Hämta en regel för datainsamling med hjälp av regel-ID
```
