...
ms.locfileid: "100237342"
---
# Get-AzAlertHistory

## SYNOPSIS
Hämtar historiken för klassiska aviseringsregler.
...
## BESKRIVNING
Cmdleten **Get-AzAlertHistory** får historiken för klassiska aviseringsregler när de aktiveras, inaktiveras, aktiveras, åtgärdas och så vidare.
