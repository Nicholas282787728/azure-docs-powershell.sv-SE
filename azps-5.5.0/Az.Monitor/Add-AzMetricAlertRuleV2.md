...
## BESKRIVNING
Lägger till eller uppdaterar **en metrisk aviseringsregel för V2 (icke-klassisk).** Den tillagda regeln är kopplad till en resursgrupp och har ett namn. Den här cmdleten implementerar mönstret ShouldProcess, dvs. den kan begära bekräftelse från användaren innan den faktiskt skapar, ändrar eller tar bort resursen.

## EXEMPEL

### Exempel 1: Lägga till en måttaviseringsregel på en virtuell dator
...
Det här kommandot skapar en måttaviseringsregel för en virtuell dator. $condition är resultatet av cmdleten [New-AzMetricAlertRuleV2Criteria](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azmetricalertrulev2criteria) och $act är resultatet av cmdleten [New-AzActionGroup](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azactiongroup)

### Exempel 2: Lägga till en måttaviseringsregel för alla virtuella datorer i en prenumeration
```powershell
...
Det här kommandot skapar en måttaviseringsregel för alla virtuella datorer i prenumerationen som är i öst

### Exempel 3: Inaktivera en måttaviseringsregel
```powershell
...
Med det här kommandot inaktiveras en måttaviseringsregel. Här visas pipingresultat för [Get-AzMetricAlertRuleV2](https://docs.microsoft.com/en-us/powershell/module/az.monitor/get-azmetricalertrulev2) till [Add-AzMetricAlertRuleV2](https://docs.microsoft.com/en-us/powershell/module/az.monitor/add-azmetricalertrulev2) 

### Exempel 4: Lägga till en måttaviseringsregel med mått
...
Om du vill skapa en mer komplex metrisk aviseringsregel som de som involverar att välja måttvärden eller ha flera villkor, kan du använda hjälp cmdlets [New-AzMetricAlertRuleV2DimensionSelection](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azmetricalertrulev2dimensionselection) och [New-AzMetricAlertRuleV2Criteria.](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azmetricalertrulev2criteria)

Ovanför uppsättningen cmdlets skapas en måttaviseringsregel med mått.

## PARAMETERS

### -ActionGroup
Åtgärdsgruppen för regel
...
### -Beskrivning
Beskrivning av måttaviseringsregeln
...
### -DisableRule
Flaggan Inaktivera regel (status)
...
### -Frekvens
Utvärderingsfrekvensen för regeln
...
### -Name
Namnet på måttaviseringsregeln
...
### -Allvarlighetsgrad
Allvarlighetsgrad för måttaviseringsregeln
...
### -TargetResourceScope
Regelns omfattning för målresurs
