...
ms.locfileid: "100224158"
---
# Set-AzDataCollectionRule

## SYNOPSIS
Uppdaterar (fullständig ersättning) en regel för datainsamling.
...
## BESKRIVNING
Cmdleten **Set-AzDataCollectionRule** ersätter en befintlig datainsamlingsregel.
...
Om du vill använda parametern -RuleFile skapar du en jsonfil som innehåller tre egenskaper: dataKällor, destinationer, dataFlows (se exempel #1).

Här hittar du [schemainformation.](https://docs.microsoft.com/en-us/rest/api/monitor/datacollectionrules/create)

Utdata från en DCR-serialiserad med cmdlet-ConvertTo-Json stöds också (exempel #2).

## EXEMPEL

### Exempel 1: Uppdatera datainsamlingsregeln, JSON från Rest API
```powershell
...
Det här kommandot ersätter befintliga regler för datainsamling för den aktuella prenumerationen.

### Exempel 2: Uppdatera datainsamlingsregeln JSON från PSDataCollectionRuleResource
```powershell
PS C:\>Set-AzDataCollectionRule -Location 'East US 2 EUAP'
...
### Exempel 3: Uppdatera datainsamlingsregel från objekt
```powershell
