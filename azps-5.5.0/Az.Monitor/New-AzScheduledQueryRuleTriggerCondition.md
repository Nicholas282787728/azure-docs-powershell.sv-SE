...
## BESKRIVNING
Skapar ett objekt av typen Utlösarvillkor.
Det här objektet ska skickas till kommandot som skapar objektet Aviseringsåtgärd
...
### -MetricT meter
Utlösarvillkor för metriska frågeregel
...
### -Threshold
Tröskelvärdet över vilken avisering kan uppmärksammas
...
### -ThresholdOperator
Tröskelvärdesoperatorn : Greater Det här kan vara mindre Eller lika
...
### Microsoft.Azure.Commands.Insights.OutputClasses.PSScheduledQueryRuleTquererCondition
