...
uppdatera omfånget för privata länkar med namnet "scope_name" under resursgruppen "rg_name" för att använda taggen "key:value"
...
uppdatera omfång för privata länkar med resurs-ID för att använda taggen "key:value"
...
uppdatera omfånget för privata länkar med indata för privat länkomfattning för att använda taggen "key:value"
