...
## BESKRIVNING
Cmdleten **Add-AzWebtestAlertRule** lägger till eller uppdaterar en aviseringsregel av typen metrisk, händelse eller webbtest.
...
### Exempel 1: Lägga till en aviseringsregel för webtest
```
...
Det här kommandot lägger till eller uppdaterar en aviseringsregel för webtest.
...
### -FailedLocationCount
Anger antalet platser som inte kunde anges för webtest-reglerna.
Det här liknar tröskelvärdet för andra typer av regler.
...
### -MetricNamespace
Anger metriska namnområdet för regeln.
