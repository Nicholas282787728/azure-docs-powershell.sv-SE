...
Den här cmdleten implementerar Börprocess-mönstret, det vill säga den kan begära bekräftelse från användaren innan den faktiskt skapar/ändrar resursen.
...
### Exempel 4: Ange en aktivitetsloggavisering baserat på Värdet ResourceId från pipe
```
...
### -ResourceId
Anger egenskapen ResourceId-taggar för samtalet för att extrahera obligatoriskt namn, namnegenskaper för resursgrupper.
