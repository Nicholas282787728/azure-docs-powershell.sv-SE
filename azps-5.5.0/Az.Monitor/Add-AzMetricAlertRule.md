...
## BESKRIVNING
Cmdleten **Add-AzMetricAlertRule** lägger till eller uppdaterar en metrisk baserad aviseringsregel.
Den tillagda regeln är kopplad till en resursgrupp och har ett namn.
...
### Exempel 1: Lägga till en måttaviseringsregel på en webbplats
```
...
Med det här kommandot skapas en måttaviseringsregel för en webbplats.
...
Med det här kommandot inaktiveras en regel.
Om regeln inte finns inaktiveras den.
Om regeln finns inaktiveras den bara.
...
### -DisableRule
Inaktiverar regeln.
Om du inte anger den här parametern aktiveras regeln.
...
### -Plats
Anger den plats där regeln definieras.
...
Ange endast den här parametern för metriska regler.
...
### -Operator
Anger relationsoperatorn för villkoret för regeln.
...
### -ResourceGroupName
Anger namnet på resursgruppen för regeln.
...
### -TargetResourceId
Anger ID för resursen som regeln övervakar. Obs! Den här egenskapen kan inte uppdateras för en befintlig aviseringsregel.
...
### -Threshold
Anger tröskelvärdet för regeln.
...
Anger vilken aggregeringsoperator som ska tillämpas på tidsperioden när regeln utvärderas.
...
### -WindowSize
Anger storleken på det tidsfönster som regeln ska använda för att beräkna data.
