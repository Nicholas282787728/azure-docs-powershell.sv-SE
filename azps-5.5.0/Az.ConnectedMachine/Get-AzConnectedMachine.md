...
### Exempel 1: Lista alla anslutna datorer i en prenumeration
```powershell
...
Visar alla anslutna datorer i en prenumeration.
Om prenumerationen inte anges används prenumerationen från ditt aktuella Azure PowerShell-sammanhang.

### Exempel 2: Lista alla anslutna datorer i en resursgrupp
```powershell
...
Lista alla anslutna datorer i en resursgrupp.

### Exempel 3: Byt namn på en ansluten dator i en resursgrupp
```powershell
...
Skaffa en ansluten dator i en resursgrupp efter namn.
