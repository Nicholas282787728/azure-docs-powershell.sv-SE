...
ms.locfileid: "100253933"
---
# Remove-AzConnectedMachine

## SYNOPSIS
Åtgärden för att ta bort en hybriddatoridentitet i Azure.
...
### Exempel 2: Ta bort anslutna datorer via rörledning
```powershell
PS C:\> Get-AzConnectedMachine -ResourceGroupName contoso-connected-machines | Remove-AzConnectedMachine

```

Tar bort alla datorer i `contoso-connected-machines` resursgruppen.
