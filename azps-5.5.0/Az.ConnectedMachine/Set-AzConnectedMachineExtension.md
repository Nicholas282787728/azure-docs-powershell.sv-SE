...
### Exempel 2: Ange ett tillägg med tilläggsparametrar angivna via pipelinen
```powershell
...
Detta anger ett tillägg med tilläggsparametrarna som tillhandahålls av objektet som överförs via pipelinen.
...
När tillägget har distribuerats uppgraderas inte delversioner om inte distribueras på nytt, även om den här egenskapen är inställd på sant.
...
EXTENSIONPARAMETER: <IMachineExtension> Beskriver ett datortillägg.
  ...
  - `[AutoUpgradeMinorVersion <Boolean?>]`: Anger om tillägget ska använda en nyare delversion om det finns en tillgänglig vid distributionen. När tillägget har distribuerats uppgraderas inte delversioner om inte distribueras på nytt, även om den här egenskapen är inställd på sant.
