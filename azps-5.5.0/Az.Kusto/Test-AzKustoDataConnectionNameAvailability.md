...
### Exempel 1: Kontrollera tillgängligheten för ett namn på dataanslutningen som används
```powershell
...
Kommandot ovan returnerar om en dataanslutning med namnet "mykungconnection" finns i databasen "mykustodatabase".

### Exempel 2: Kontrollera tillgängligheten för ett namn på en dataanslutning som inte används
```powershell
...
Kommandot ovan returnerar om en dataanslutning med namnet "mydataconnection" finns i databasen "mykustodatabase".
...
### -Type
Typen av resurs, Microsoft.Kusto/Clusters/Databases/dataConnections.
