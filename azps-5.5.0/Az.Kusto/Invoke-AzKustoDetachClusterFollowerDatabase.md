...
### Exempel 1: Koppla från en följardatabas
```powershell
...
Kommandot ovan löses upp i följardatabasen som definierats i AttachedDatabaseConfiguration "myfollowerconfiguration" från cluster "testnewkustoclusterf".
...
Resursnamn för den bifogade databaskonfigurationen i följarklustret.
...
### -ClusterResourceId
Resurs-ID för det kluster som följer en databas som ägs av det här klustret.
