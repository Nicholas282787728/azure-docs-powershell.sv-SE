...
Kommandot ovan skapar ett nytt Kusto-kluster med namnet "testnewkustocluster" i resursgruppen "testrg".
...
Skapa genom att gå till avsnittet ANTECKNINGAR för SPRÅKEXTENSIONVALUE-egenskaper och skapa en hash-tabell.
...
Ett booleskt värde som anger om funktionen för optimerad autoskala är aktiverad eller inte.
...
### -Zone
Klustrets tillgänglighetszoner.
...
LANGUAGEEXTENSIONVALUE <ILanguageExtension[]>: Listan över språktillägg.
  - `[Name <LanguageExtensionName?>]`: Språktilläggsnamnet.
