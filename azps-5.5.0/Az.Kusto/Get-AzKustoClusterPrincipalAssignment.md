...
### Exempel 1: Lista alla Kusto-klusterhuvudnamnTilldelas
```powershell
...
### Exempel 2: Hämtar ett Kusto-klusterhuvudnamn Efter namn
```powershell
...
Kommandot ovan returnerar Kusto-klusterhuvudnamnet "kustoprincipal1" i klustret "testnewkustocluster".
