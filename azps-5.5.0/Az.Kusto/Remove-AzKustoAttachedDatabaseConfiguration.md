...
### Exempel 1: Ta bort en befintlig AttachedDatabaseConfiguration med namn
```powershell
...
Kommandot ovan tar bort följardatabasen som definierats i attachedDatabaseConfiguration "myfollowerconfiguration" från cluster "testnewkustoclusterf".
