...
### Exempel 1: Ta bort ett befintligt Kusto-kluster principalAssignment efter namn
```powershell
...
Kommandot ovan tar bort PrincipalAssignment med namnet "kustoprincipal1" i Kusto-klustret "testnewkustocluster".
