...
Kommandot ovan uppdaterar den mjuka borttagningsperioden och snabbcacheperioden för Kusto-databasen "mykustodatabase" i klustret "testnewkustocluster" som finns i resursgruppen "testrg".
...
### Exempel 3: Uppdatera en befintlig ReadOnly-databas med namn
```powershell
PS C:\> $2ds = New-TimeSpan -Days 2
...
Kommandot ovan uppdaterar snabbcacheperioden för Kusto-databasen "mykustodatabase" i klustret "myfollowercluster" som finns i resursgruppen "testrg".
...
### -HotCachePeriod
Tiden då data ska lagras i cacheminnet för snabba frågor i TimeSpan.
...
### -SoftDeletePeriod
Tiden som data ska sparas innan de slutar vara tillgängliga för frågor i TimeSpan.
