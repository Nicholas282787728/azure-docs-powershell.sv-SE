...
### Exempel 1: Lista alla databaser du följer
```powershell
...
Kommandot ovan visar alla databaser som ägs av det här klustret och som följdes av ett annat kluster.
