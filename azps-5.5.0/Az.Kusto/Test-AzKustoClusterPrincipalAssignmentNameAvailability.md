...
### Exempel 1: Kontrollera tillgängligheten för ett klusterhuvudnamn som används
```powershell
...
Kommandot ovan returnerar om en PrincipalAssignment med namnet "myprincipal" finns i klustret "testnewkustocluster".

### Exempel 2: Kontrollera tillgängligheten för ett klusterhuvudnamn som inte används
```powershell
...
### -Name
Resursnamn för huvudtilldelning.
...
### -Type
Typen av resurs, Microsoft.Kusto/Clusters/principalAssignments.
