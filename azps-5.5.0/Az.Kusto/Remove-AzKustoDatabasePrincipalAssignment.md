...
### Exempel 1: Ta bort en befintlig Kusto-databas PrincipalAssignment efter namn
```powershell
...
Kommandot ovan tar bort PrincipalAssignment med namnet "kustoprincipal1" i Kusto-databasen "mykustodatabase".
