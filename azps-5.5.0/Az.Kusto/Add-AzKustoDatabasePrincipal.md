...
### Exempel 1: Lägg till behörigheter för databashuvudnamn
```powershell
...
Kommandot ovan lägger till behörigheter för databashuvudnamn
...
### -Värde
Listan över kustodatabasens huvudnamn.
Om du vill skapa en tabell kan du gå till avsnittet ANTECKNINGAR för VÄRDE-egenskaper och skapa en hash-tabell.
...
VALUE <IDatabasePrincipal[]>: Listan över Kusto-databashuvudnamn.
  - `Name <String>`: Databasens huvudnamn.
  - `Role <DatabasePrincipalRole>`: Databasens huvudroll.
  - `Type <DatabasePrincipalType>`: Databasens huvudtyp.
  - `[AppId <String>]`: Program-ID – endast relevant för programmets huvudtyp.
  - `[Email <String>]`: Databashuvud-e-post, om sådan finns.
  - `[Fqn <String>]`: Fullständigt kvalificerat namn för databasens huvudnamn.
