...
### Exempel 1: Skapa ett Kusto-klusterdatabashuvudnamnTilldela
```powershell
...
Kommandot ovan skapar ett Kusto-klusterdatabashuvudnamnTilldela
...
### -PrincipalId
Det huvud-ID som tilldelats databasens huvudnamn.
