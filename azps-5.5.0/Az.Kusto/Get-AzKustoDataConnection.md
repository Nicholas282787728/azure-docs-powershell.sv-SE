...
### Exempel 1: Lista alla dataanslutningar i en viss databas
```powershell
...
Kommandot ovan returnerar alla Kusto-databaser i klustret "testnewkustocluster" som finns i resursgruppen "testrg".

### Exempel 2: Hämta en specifik dataanslutning med namn
```powershell
...
Kommandot ovan returnerar dataanslutningen med namnet "mykuokconnection" i databasen "mykustodatabase" för det befintliga kluster "testnewkustocluster" som finns i resursgruppen "testrg".
