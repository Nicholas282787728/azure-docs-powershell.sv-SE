...
### Exempel 1: Kontrollera tillgängligheten för ett Kusto-klusternamn som används
```powershell
...
Kommandot ovan returnerar om ett Kusto-kluster med namnet "testnewkustocluster" finns i regionen "Östra USA" eller inte.

### Exempel 2: Kontrollera tillgängligheten för ett Kusto-klusternamn som inte används
```powershell
...
Kommandot ovan returnerar om ett Kusto-kluster med namnet "availablekustocluster" finns i regionen "Östra USA" eller inte.
...
### -Type
Typen av resurs, Microsoft.Kusto/kluster.
