...
### Exempel 1: Listar kvalificerade SKU:er
```powershell
...
Kommandot ovan listar kvalificerade SKU:er.

### Exempel 2: Listar kvalificerade SKU:er för ett visst kluster
```powershell
...
Kommandot ovan listar kvalificerade SKU:er för specifika kluster
