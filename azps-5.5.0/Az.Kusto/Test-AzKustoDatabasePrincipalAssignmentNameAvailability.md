...
### Exempel 1: Kontrollera tillgängligheten för ett databashuvudnamn som används
```powershell
...
Kommandot ovan returnerar om en PrincipalAssignment med namnet "myprincipal" finns i databasen "mykustodatabase" från cluster "testnewkustocluster".

### Exempel 2: Kontrollera tillgängligheten för ett databashuvudnamn som inte används
```powershell
...
### -Type
Typen av resurs, Microsoft.Kusto/Clusters/Databases/principalAssignments.
