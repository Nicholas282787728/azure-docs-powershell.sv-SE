...
### Exempel 1: Ta bort en lista över språktillägg från kluster
```powershell
PS C:\> Remove-AzKustoClusterLanguageExtension -ResourceGroupName testrg -ClusterName testnewkustocluster -Value (@{Name="R"})
```

Kommandot ovan tar bort en lista över språktillägg som kan köras i KQL-frågor.
...
VALUE <ILanguageExtension[]>: Listan över språktillägg.
  - `[Name <LanguageExtensionName?>]`: Namnet på språktillägget.
