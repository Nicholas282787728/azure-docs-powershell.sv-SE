...
### Exempel 1: Lista alla Kusto-databaser i ett kluster efter namn
```powershell
...
Kommandot ovan returnerar Kusto-databasen med namnet "mykustodatabase" i klustret "testnewkustocluster" som finns i resursgruppen "testrg".
