...
### -Destination
Sökväg för installation av kubectl.
Standardinställning för installation i ~/.azure-kubectl/
...
### -DownloadFromMirror
Ladda ned från spegelwebbplats: https://mirror.azure.cn/kubernetes/kubectl/
...
### -Force
Skriva över befintlig kubectl utan uppmaning
...
### -Version
Version av kubectl att installera, t.ex. 'v1.17.2'.
