...
### Importera och sammanfoga Kubectl-konfiguration
```
...
### -Admin
Skaffa kubectl-konfiguration för ClusterAdmin istället för standardinställningen ClusterUser.
...
### -ConfigPath
En kubectl-konfigurationsfil som kan skapas eller uppdateras.
Använd "-" för att skriva ut YAML till stdout i stället.
...
### -Force
Import av Kubernetes-konfiguration även om det är standardinställningen
...
### -PassThru
Returnerar Sant om importen lyckas
