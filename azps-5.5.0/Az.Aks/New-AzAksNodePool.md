...
### Skapa nodpool med standardparametrar
```powershell
...
### -ClusterObject
Ange klusterobjekt som nodpoolen ska skapas i.
...
### -Force
Skapa nodpool även om den redan finns
...
Standardinställningen är Linux.
...
ScaleSetEvictionPolicy ska användas för att ange en skalningsprincip för skalning med låg prioritet för en virtuell datorskalauppsättning.
Ta bort som standard.
...
### -ScaleSetPriority
ScaleSetPriority som ska användas för att ange prioritet för skala för virtuell dator.
...
### -VmSetType
Representerar typer av en nodpool.
