...
Aktivera `HttpApplicationRouting` tillägg, `Monitoring` `AzurePolicy` och `VirtualNode` för `KubeDashboard` tryckfärger.
...
### -WorkspaceResourceId
Resurs-ID för arbetsytan för övervakning.
