...
### Ändra mini antal till 5 för angiven nodpool
```powershell
...
### -Force
Uppdatera nodpool utan uppmaning
...
### -InputObject
Ett PSAgentPool-objekt som normalt passerar genom pipelinen.
