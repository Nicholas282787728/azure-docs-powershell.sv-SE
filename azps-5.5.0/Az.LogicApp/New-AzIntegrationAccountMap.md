...
ms.locfileid: "100237503"
---
# New-AzIntegrationAccountMap

## SYNOPSIS
Skapar en integrationskontokarta.
...
## BESKRIVNING
Cmdleten **New-AzIntegrationAccountMap** skapar en integrationskontokarta.
Den här cmdleten returnerar ett objekt som representerar kartan för integrationskontot.
Ange namnet på integrationskontot, resursgruppens namn, mappningsnamn och mappningsdefinition.
...
### Exempel 1: Skapa en mappning för ett integrationskonto
```powershell
...
Med det här kommandot skapas integrationskontomappningen i den angivna resursgruppen.
Kommandot anger en mappningsdefinition som lagras i $MapContent variabeln med ett tidigare kommando.

### Exempel 2

Skapar en integrationskontokarta. (autogenererat)
...
Ange antingen den här parametern *eller MapFilePath-parametern.*
...
### -MapFilePath
Anger filsökvägen för en definition för mappningen av integrationskontot. Ange antingen den här parametern *eller mapdefinitionsparametern.*
...
### -MapName
Anger ett namn för mappningen av integrationskontot.
...
### -Name
Anger ett namn för integrationskontot.
