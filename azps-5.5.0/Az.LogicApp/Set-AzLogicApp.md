...
ms.locfileid: "100228255"
---
# Set-AzLogicApp

## SYNOPSIS
Ändrar en logikapp i en resursgrupp.
...
## BESKRIVNING
Cmdleten **Set-Az AzureApp** ändrar en logikapp med hjälp av funktionen Logikappar.
...
Du kan ändra en logikapp genom att ange namn, plats, definition av logikapp, resursgrupp och plan.
...
Det här kommandot ändrar en logikapp.
...
### -UseConsumptionModel
Anger att den konsumtionsbaserade modellen används för fakturering i logikappen.
