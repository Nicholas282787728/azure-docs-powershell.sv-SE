...
ms.locfileid: "100228295"
---
# New-AzIntegrationAccount

## SYNOPSIS
Skapar ett integrationskonto.
...
## BESKRIVNING
Cmdleten **New-AzIntegrationAccount** skapar ett integrationskonto.
Den här cmdleten returnerar ett objekt som representerar integrationskontot. Ange namn, plats, resursgruppnamn och SKU-namn.
...
### Exempel 1: Skapa ett integrationskonto
```
...
Med det här kommandot skapas ett integrationskonto med namnet IntegrationAccount31 i den angivna resursgruppen.
