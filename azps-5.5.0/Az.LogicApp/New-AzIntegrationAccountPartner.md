...
ms.locfileid: "100237502"
---
# New-AzIntegrationAccountPartner

## SYNOPSIS
Skapar en partner för integrationskonto.
...
## BESKRIVNING
Cmdleten **New-AzIntegrationAccountPartner** skapar en partner för integrationskonto.
Den här cmdleten returnerar ett objekt som representerar partnern för integrationskontot.
Ange kontots namn för integrering, resursgruppnamn, partnernamn och partneridentiteter.
...
### Exempel 1: Skapa en partner för integrationskonto
```
...
Det här kommandot skapar integrationskontopartnern med namnet IntegrationAccountPartner22 i den angivna resursgruppen.
...
### -PartnerName
Anger ett namn för integrationskontopartnern.
