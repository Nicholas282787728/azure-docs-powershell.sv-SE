...
ms.locfileid: "100221686"
---
# New-AzLogicApp

## SYNOPSIS
Skapar en logikapp i en resursgrupp.
...
## BESKRIVNING
Cmdleten **New-Az AzureApp** skapar en logikapp med hjälp av funktionen Logikappar.
En logikapp är en samling åtgärder eller utlösare som definierats i logikappdefinitionen.
Den här cmdleten returnerar **ett arbetsflödesobjekt.**
Du kan skapa en logikapp genom att ange namn, plats, definition av logikapp, resursgrupp och plan.
En logikappdefinition och parametrar formateras i JavaScript Object Notation (JSON).
Du kan använda en logikapp som en mall för definition och parametrar.
...
### Exempel 1: Skapa en logikapp genom att använda filsökvägar för definition och parametrar
```
...
Det här kommandot skapar en logikapp i den angivna resursgruppen.
Logikappen inkluderar den definition och de parametrar som anges av filsökvägarna.

### Exempel 2: Skapa en logikapp genom att använda definition- och parameterobjekt
```
...
Det här kommandot skapar en logikapp i den angivna resursgruppens resursgrupp.

### Exempel 3: Skapa en logikapp genom att använda pipelinen för att ange resursgruppen
```
...
Det här kommandot hämtar resursgruppen med namnet ResourceGroup11 med hjälp Get-AzResourceGroup cmdleten.
Kommandot skickar resursgruppen till den aktuella cmdleten med hjälp av rörledningsoperatorn.
Den aktuella cmdleten skapar en logikapp i resursgruppen.
Logikappen inkluderar den definition och de parametrar som anges av filsökvägarna.

### Exempel 4: Skapa en logikapp baserat på en befintlig logikapp
```
...
Det första kommandot får logikappen LogicApp03 med hjälp av Get-AzLogicApp cmdleten.
Kommandot lagrar logikappen i den $Workflow variabeln.
Det andra kommandot skapar en ny logikapp som använder definitionen och parametrarna för logikappen som lagras i $Workflow.
...
### -Definition
Anger definitionen för logikappen som ett objekt eller en sträng i JavaScript Object Notation-format (JSON).
...
### -DefinitionFilePath
Anger definitionen av en logikapp som sökvägen till en definitionfil i JSON-format.
...
### -Parametrar
Anger ett samlingsobjekt för parametrar för Logikappen.
