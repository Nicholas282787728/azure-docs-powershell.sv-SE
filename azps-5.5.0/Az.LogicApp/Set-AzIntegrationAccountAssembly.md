...
ms.locfileid: "100224383"
---
# Set-AzIntegrationAccountAssembly

## SYNOPSIS
Ändrar sammansättningen av ett integrationskonto.
...
## BESKRIVNING
Cmdleten **Set-AzIntegrationAccountAssembly** ändrar en sammansättning av integrationskonto.

## EXEMPEL

### Exempel 1: Ändra en sammansättning med hjälp av lokal fil
```powershell
...
Ändrar sammansättningen med namnet "sampleAssembly" med hjälp av den lokala filen som finns på filsökvägen som finns i "$localAssemblyFilePath".

### Exempel 2: Ändra en sammansättning med bytedata
```powershell
...
Modifierar sammansättningen "sampleAssembly" med hjälp av en bytematris som finns i "$assemblyContent".

### Exempel 3: Ändra en sammansättning med hjälp av en innehållslänk
```powershell
...
Modifierar sammansättningen "sampleAssembly" med hjälp av en byte-data som finns på URL-adressen "$assemblyUrl". Det här är den rekommenderade metoden för att skapa stora sammansättningar.

## PARAMETERS

### -AssemblyData
Detta är sammansättningen av integrationskontots bytedata.
...
### -AssemblyFilePath
Sökväg för sammansättningen av integrationskontot.
...
### -ContentLink
En offentligt tillgänglig länk till sammansättningen av integrationskontot.
...
### -Metadata
Sammansättningen av integrationskontots metadata.
