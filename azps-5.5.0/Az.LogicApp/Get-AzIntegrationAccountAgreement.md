...
ms.locfileid: "100226383"
---
# Get-AzIntegrationAccountAgreement

## SYNOPSIS
Får ett avtal för integrationskonto.
...
## BESKRIVNING
Cmdleten **Get-AzIntegrationAccountAgreement** får ett avtal för integrationskonto från en Azure-resursgrupp.
...
### Exempel 1: Skaffa ett avtal för ett integrationskonto
```
...
Det här kommandot får ett avtal för integrationskonto med namnet IntegrationAccountAgreement06.

### Exempel 2: Hämta avtal för integrationskonto efter resursgruppnamn
```
...
Med det här kommandot får du integrationskontoavtalen efter resursgruppnamn.

## PARAMETERS

### -AgreementName
Anger namnet på ett avtal för ett integrationskonto.
