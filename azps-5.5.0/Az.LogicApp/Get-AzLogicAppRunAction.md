...
ms.locfileid: "100214438"
---
# Get-AzLogicAppRunAction

## SYNOPSIS

Hämtar en åtgärd från en logikapp som körs.
...
Cmdleten **Get-Az AzureAppRunAction** får en åtgärd från en logikapp som körs.
Den här cmdleten returnerar **ett WorkflowRunAction-objekt.**
...
### Exempel 1: Hämta en åtgärd från ett Logic App-program
...
Det här kommandot får en specifik logic app-åtgärd från logikappen som heter LogicApp05 för körningen med identifieraren 08585925184423369718380498702CU26.

### Exempel 2: Hämta alla åtgärder från en logikapp
...
Med det här kommandot får du alla Logic App-åtgärder från en körning med identifierare 08585925184423369718380498702CU26 i en logikapp med namnet LogicApp05.

## PARAMETERS

### -ActionName

Anger namnet på en åtgärd i en logikapp som körs.
Den här cmdleten får åtgärden som parametern anger.
...
Anger namnet på en logikapp för vilken den här cmdleten hämtar en åtgärd.
...
Anger namnet på en resursgrupp där den här cmdleten hämtar en åtgärd.
...
Anger namnet på en körning av en logikapp.
Den här cmdleten hämtar en åtgärd för körningen som den här parametern anger.
