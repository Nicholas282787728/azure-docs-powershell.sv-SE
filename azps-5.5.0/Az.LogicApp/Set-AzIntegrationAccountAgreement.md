...
ms.locfileid: "100214430"
---
# Set-AzIntegrationAccountAgreement

## SYNOPSIS
Ändrar ett avtal för integrationskonto.
...
## BESKRIVNING
Cmdleten **Set-AzIntegrationAccountAgreement** ändrar ett avtal för integrationskonto.
Denna cmdlet returnerar ett objekt som representerar avtalet för integrationskontot.
Ange namnet på integrationskontot, resursgruppens namn och avtalsnamnet.
...
### Exempel 1: Uppdatera ett avtal för ett integrationskonto
```powershell
...
Det här kommandot uppdaterar ett avtal för integrationskonto i den angivna Azure-resursgruppen.

### Exempel 2

Ändrar ett avtal för integrationskonto. (autogenererat)
...
### -AgreementName
Anger namnet på avtalet för integrationskontot.
...
### -AgreementType
Anger avtalstyp för integrationskonto.
