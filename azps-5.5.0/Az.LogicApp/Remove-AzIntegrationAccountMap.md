...
ms.locfileid: "100219231"
---
# Remove-AzIntegrationAccountMap

## SYNOPSIS
Tar bort en mappning av ett integrationskonto.
...
## BESKRIVNING
Cmdleten **Remove-AzIntegrationAccountMap** tar bort en mappning av ett integrationskonto från en resursgrupp.
...
### Exempel 1: Ta bort en mappning av ett integrationskonto
```
...
Med det här kommandot tas integreringskontokartan med namnet IntegrationAccountMap47 bort.
...
### -MapName
Anger namnet på mappningen av integrationskontot.
