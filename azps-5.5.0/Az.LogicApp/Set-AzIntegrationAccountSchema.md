...
ms.locfileid: "100221623"
---
# Set-AzIntegrationAccountSchema

## SYNOPSIS
Ändrar ett integrationskontoschema.
...
## BESKRIVNING
Cmdleten **Set-AzIntegrationAccountSchema** ändrar ett integrationskontoschema.
...
### Exempel 1: Ändra ett schema för ett integrationskonto
```
...
Det här kommandot ändrar schemat för integrationskonto med namnet IntegrationAccountSchema43.
...
### -SchemaName
Anger namnet på schemat för integrationskontot.
...
Den här parametern stöder xml som typ.
