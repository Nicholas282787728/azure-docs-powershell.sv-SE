...
ms.locfileid: "100226390"
---
# Get-AzIntegrationAccount

## SYNOPSIS
Hämtar integrationskonton.
...
## BESKRIVNING
Cmdleten **Get-AzIntegrationAccount** hämtar integrationskonton från en resursgrupp. Ange ett namn för integrationskontot och resursgruppens namn.
...
### Exempel 1: Skaffa ett integrationskonto med namn
```
...
Det här kommandot hämtar ett integrationskonto med namnet IntegrationAccount31 från den angivna resursgruppen.

### Exempel 2: Hämta integrationskonton i en resursgrupp
```
...
Det här kommandot hämtar integrationskonton från en resursgrupp med namnet ResourceGroup11.

### Exempel 3: Hämta alla integrationskonton
```
...
Med det här kommandot får du alla integrationskonton i din Azure-prenumeration.
