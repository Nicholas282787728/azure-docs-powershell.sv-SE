...
ms.locfileid: "100228270"
---
# Set-AzIntegrationAccountBatchConfiguration

## SYNOPSIS
Ändrar en konfiguration av ett integrationskonto.
...
## BESKRIVNING
Cmdleten **Set-AzIntegrationAccountBatchConfiguration** ändrar en konfiguration av integrationskontobatchen.

## EXEMPEL

### Exempel 1: Ändra en batchkonfiguration med hjälp av lokal fil
```powershell
...
Ändra en batchkonfiguration med namnet "sampleBatchConfig" med den lokala filen som finns på filsökvägen som finns i "$batchConfigurationFilePath".

### Exempel 2: Ändra en batchkonfiguration med hjälp av en JSON-sträng
```powershell
...
Ändra en batchkonfiguration med namnet "sampleBatchConfig" med hjälp av en JSON-sträng som finns i "$batchConfigurationContent".

### Exempel 3: Ändra en batchkonfiguration med hjälp av parametrar
```powershell
...
Ändra en batchkonfiguration med namnet "sampleBatchConfig" genom att ange alla nödvändiga parametrar manuellt.

## PARAMETERS

### -BatchConfigurationDefinition
Konfigurationsdefinitionen för integrationskontobatchen.
...
Sökväg till konfigurationsbatchen för integreringskontot.
...
### -BatchGroupName
Namnet på konfigurationsgruppen för integreringskontobatchen.
...
### -Batchstorlek
Batchstorleken för konfigurationsbatchen för integrationskonto.
...
### -InputObject
En konfiguration av ett integrationskonto.
...
### -MessageCount
Antalet konfigurationsmeddelanden för integrationskontot.
...
### -Metadata
Konfigurationsmetadata för integreringskontobatchen.
...
### -ResourceId
Batchkonfigurationsresurs-ID för integrationskonto.
...
### -ScheduleFrequency
Konfigurationsschemafrekvensen för integrationskontobatchen.
...
### -ScheduleInterval
Konfigurationsschemaintervallet för integrationskontobatchen.
...
### -ScheduleStartTime
Starttid för batchkonfigurationsschemat för integrationskonto.
...
### -ScheduleTimeZone
Tidszon för konfigurationsschemat för integrationskontobatchen.
