...
ms.locfileid: "100219271"
---
# Get-AzLogicAppTrigger

## SYNOPSIS
Hämtar utlösare för en logikapp.
...
## BESKRIVNING
Cmdleten **Get-AzItaAppT azureAppT azure** får utlösare från en logikapp.
Den här cmdleten returnerar **ett WorkflowT arbetsflödesobjekt.**
Ange arbetsflödet, resursgruppen och utlösaren.
...
### Exempel 1: Hämta en utlösare för en logikapp
```
...
Det här kommandot hämtar utlösaren med namnet Utlösare01 från logikappen LogicApp05.

### Exempel 2: Hämta alla utlösare för en logikapp
```
...
Det här kommandot hämtar utlösare för logikappen med namnet LogicApp07.
...
### -Name
Anger namnet på logikappen som den här cmdleten hämtar en utlösare från.
...
### -ResourceGroupName
Anger namnet på en resursgrupp där den här cmdleten hämtar en utlösare.
...
### -TriggerName
Anger namnet på den utlösare som cmdleten hämtar.
...
### Microsoft.Azure.Management.Logic.Models.Workflowt azure.Management.Models.Workflowt azure.Management.Logic.Models.Workflowt azure

## ANTECKNINGAR

## RELATERADE LÄNKAR

[Get-AzItaAppT azureerHistory](./Get-AzLogicAppTriggerHistory.md)
