...
ms.locfileid: "100214462"
---
# Get-AzIntegrationAccountGeneratedIcn

## SYNOPSIS
Denna cmdlet hämtar det aktuella värdet för det genererade överföringskontrollnumret per avtal.
...
## BESKRIVNING
Den här cmdleten är avsedd att användas för katastrofåterställningsscenarier för att hämta det aktuella värdet för det genererade överföringskontrollnumret så att du kan skriva tillbaka ett högre värde med Set-AzIntegrationAccountGeneratedIcn.
Överföringskontrollnumret bör ökas för att undvika dubbletter av överföringskontrollnummer för tal som ännu inte kunde replikeras till den passiva regionen när katastrofen inträffade i den aktiva regionen.
...
Det här kommandot får det integrationskonto som genereras av X12 överföringskontrollnummer med avtalsnamn. Kontrollera att avtalet som anges är av typen "X12"
...
Det här kommandot får det integrationskonto som genereras av Edifact interchange control number efter avtalsnamn. Kontrollera att det angivna avtalet är av typen "Edifact"
...
Det här kommandot hämtar alla genererade X12 överföringskontrollnummer efter integrationskontonamn.
