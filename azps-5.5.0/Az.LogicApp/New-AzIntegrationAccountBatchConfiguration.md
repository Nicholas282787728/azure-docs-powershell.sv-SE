...
ms.locfileid: "100237518"
---
# New-AzIntegrationAccountBatchConfiguration

## SYNOPSIS
Skapar en konfiguration av ett integrationskonto.
...
## BESKRIVNING
Cmdleten **Get-AzIntegrationAccountBatchConfiguration** skapar en ny batchkonfiguration i ett integrationskonto.

## EXEMPEL

### Exempel 1: Skapa ny batchkonfiguration med lokal fil
```powershell
...
Skapar en ny batchkonfiguration med hjälp av den lokala filen som finns på filsökvägen som finns i "$batchConfigurationFilePath".

### Exempel 2: Skapa ny batchkonfiguration med hjälp av en JSON-sträng
```powershell
...
Skapar en ny batchkonfiguration med hjälp av en JSON-sträng som finns i "$batchConfigurationContent".

### Exempel 3: Skapa ny batchkonfiguration med hjälp av parametrar
```powershell
...
Skapar en ny batchkonfiguration genom att ange alla nödvändiga parametrar manuellt.
...
### -Metadata
Metadata för konfiguration av integrationskontobatch.
