...
ms.locfileid: "100214479"
---
# Get-AzIntegrationAccountCertificate

## SYNOPSIS
Hämtar certifikat för integrationskonto från en resursgrupp.
...
## BESKRIVNING
Cmdleten **Get-AzIntegrationAccountCertificate** hämtar certifikat för integrationskonto från en resursgrupp.
Ange kontots namn för integrering, resursgrupp och certifikatnamn.
...
### Exempel 1: Hämta ett certifikat för integrationskonto
```
...
Det här kommandot får integrationskontocertifikatet IntegrationAccountCertificate01.

### Exempel 2: Hämta certifikat för integrationskonto genom integrationskontonamn
```
...
Det här kommandot hämtar integrationskontocertifikaten för integrationskontot IntegrationAccount31.
