...
ms.locfileid: "100237510"
---
# New-AzIntegrationAccountCertificate

## SYNOPSIS
Skapar ett integrationskontocertifikat.
...
## BESKRIVNING
Cmdleten **New-AzIntegrationAccountCertificate** skapar ett certifikat för integrationskonto.
Den här cmdleten returnerar ett objekt som representerar certifikatet för integrationskontot.
Ange namn på integrationskonto, resursgruppnamn, certifikatnamn, nyckelnamn, nyckelversion och nyckel-ID för valv.
...
### Exempel 1: Skapa ett certifikat för integrationskonto
```
...
Det här kommandot skapar integrationskontocertifikatet i den angivna resursgruppen.

## PARAMETERS

### -CertificateName
Anger ett namn för certifikatet för integrationskontot.
...
### -KeyName
Anger namnet på certifikatnyckeln i nyckelvalvet.
