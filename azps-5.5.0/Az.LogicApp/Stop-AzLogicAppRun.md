...
ms.locfileid: "100228247"
---
# Stop-AzLogicAppRun

## SYNOPSIS
Avbryter en körning av en logikapp.
...
## BESKRIVNING
Cmdleten **Stop-Az AzureAppRun** avbryter en körning av en logikapp.
Ange logikapp, resursgrupp och kör.
...
### -Name
Anger namnet på en logikapp för vilken den här cmdleten avbryter en körning.
...
### -ResourceGroupName
Anger namnet på en resursgrupp där den här cmdleten avbryter en körning.
...
### -RunName
Anger namnet på en logikapp som cmdleten avbryter.
