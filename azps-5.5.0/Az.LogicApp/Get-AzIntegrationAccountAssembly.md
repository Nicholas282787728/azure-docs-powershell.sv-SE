...
ms.locfileid: "100226375"
---
# Get-AzIntegrationAccountAssembly

## SYNOPSIS
Får en sammansättning av ett integrationskonto.
...
## BESKRIVNING
Cmdleten **Get-AzIntegrationAccountAssembly** får en sammansättning från ett integrationskonto.

## EXEMPEL

### Exempel 1: Hämta en sammansättning efter parametrar
```powershell
...
Hämta en sammansättning med namnet "sampleAssembly" på integrationskontot "sampleIntegrationAccount" som finns i resursgruppen "sampleResourceGroup".

### Exempel 2: Lista alla sammansättningar i ett integrationskonto efter parametrar
```powershell
...
Få alla sammansättningar placerade i integrationskontot "exempelintegrationAccount" som finns i resursgruppen "sampleResourceGroup".
