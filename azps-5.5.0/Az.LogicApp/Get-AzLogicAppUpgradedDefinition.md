...
## BESKRIVNING
Cmdleten **Get-AzLogiAppUpgradedDefinition** hämtar den uppgraderade definitionen för schemaversionen och logikappen från en resursgrupp.
Den här cmdleten returnerar ett objekt som representerar definitionen för den uppgraderade logikappen.
Ange resursgruppnamnet, logikappens namn och målschemaversionen.
...
Det första kommandot får definitionen för logikappen som uppgraderas till den angivna målschemaversionen.
Kommandot lagrar definitionen i den $UpgradedDefinition variabeln.
...
### -TargetSchemaVersion
Anger versionen av definitionen i målschemat.
