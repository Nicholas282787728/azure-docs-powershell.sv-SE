...
ms.locfileid: "100219222"
---
# Remove-AzIntegrationAccountPartner

## SYNOPSIS
Tar bort en partner för integrationskonto.
...
## BESKRIVNING
Cmdleten **Remove-AzIntegrationAccountPartner** tar bort en partner för integrationskonto från en resursgrupp.
...
### Exempel 1: Ta bort en partner för integrationskonto
```
...
Det här kommandot tar bort integrationskontopartner1.
