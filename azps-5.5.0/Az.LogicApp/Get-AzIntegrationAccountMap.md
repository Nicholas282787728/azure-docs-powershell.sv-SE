...
ms.locfileid: "100228326"
---
# Get-AzIntegrationAccountMap

## SYNOPSIS
Hämtar en mappning för integrationskonto.
...
## BESKRIVNING
Cmdleten **Get-AzIntegrationAccountMap** hämtar en mappning av integrationskontot från en resursgrupp.
...
### Exempel 1: Hämta en karta för ett integrationskonto
```
...
Det här kommandot får en integrationskontokarta med namnet IntegrationAccountMap47 i den angivna resursgruppen.

### Exempel 2: Hämta integrationskontokartor efter integrationskontonamn
```
...
Med det här kommandot får du mappningar av integrationskontot efter namnet på integrationskontot.
...
### -MapType
Typ av mappning av integrationskonto.
