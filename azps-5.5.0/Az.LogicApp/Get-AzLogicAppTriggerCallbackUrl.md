...
ms.locfileid: "100224390"
---
# Get-AzLogicAppTriggerCallbackUrl

## SYNOPSIS
Får en logikapp som utlösar callback-URL.
...
## BESKRIVNING
Cmdleten **Get-AzCallAppTpoolerCallbackUrl** får en Logic App-utlösar callback-URL från en resursgrupp.
Denna cmdlet returnerar **ett WorkflowTcallbackUrl-objekt** som representerar callback-URL:en.
Ange resursgruppnamn, logikappens namn och utlösarnamn.
...
### Exempel 1: Hämta en logikapp som utlöser callback-URL
```
...
Det här kommandot får en Logic App-utlösar callback-URL.
...
### Microsoft.Azure.Management.Logic.Models.WorkflowT azureerCallbackUrl
