...
ms.locfileid: "100219254"
---
# Remove-AzIntegrationAccountCertificate

## SYNOPSIS
Tar bort ett integrationskontocertifikat från en resursgrupp.
...
## BESKRIVNING
Cmdleten **Remove-AzIntegrationAccountCertificate** tar bort ett certifikat för integrationskonto från en resursgrupp.
...
### Exempel 1: Ta bort ett certifikat för integrationskonto
```
...
Det här kommandot tar bort integrationskontocertifikatet IntegrationAccount31.
