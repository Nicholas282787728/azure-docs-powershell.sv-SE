...
## BESKRIVNING
Cmdleten **Get-AzFrontDoorRulesEngine** får en specifik regelmotorkonfiguration eller får alla regelmotorkonfigurationer kopplade till en framsida. 
...
Skaffa specifika regelmotorkonfigurationer.
...
Få alla regelmotorns konfigurationer hos oss.
...
Förväntat utdata när du får en motor för regler som inte är inkonsekventa. 
