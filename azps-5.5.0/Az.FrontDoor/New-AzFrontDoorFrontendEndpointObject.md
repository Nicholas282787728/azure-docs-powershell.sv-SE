...
### -CertificateType
typ av certifikat som används för säkra anslutningar till en frontendEndpoint
...
### -HostName
Värdnamnet för frontendEndpoint.
Måste vara ett domännamn.
...
### -MinimumTlsVersion
Den lägsta TLS-versionen som krävs av klienterna för att upprätta en SSL-handskakning med Front Door.
...
### -ProtocolType
TLS-tilläggsprotokoll som används för säker leverans
...
### -SecretName
Namnet på nyckelvalvshemligheten som representerar den fullständiga PFX-certifikatet
...
### -SecretVersion
Den version av nyckelvalvshemligheten som representerar den fullständiga PFX-certifikatet
...
Om sessionstillhörighet ska tillåtas på den här värden.
...
TTL som ska användas i sekunder för sessionstillhörighet, om tillämpligt. Standardvärdet är 0
...
### -Vault
Nyckelvalv som innehåller SSL-certifikatet
...
### -WebApplicationFirewallPolicyLink
Resurs-ID för principen för webbprogramsbrandvägg för varje värd (om tillämpligt)
