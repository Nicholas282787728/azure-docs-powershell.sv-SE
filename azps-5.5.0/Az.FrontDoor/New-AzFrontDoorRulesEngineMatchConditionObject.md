...
### -MatchValue
Matcha värden som ska matchas mot.
Operatorn gäller för varje värde här med ELLER-semantik.
Om någon av dem matchar variabeln med den givna operatorn anses detta matchningsvillkor vara en matchning.
...
### -MatchVariable
Matcha variabel.
Möjliga värden är IsMobile, RemoteAddr, RequestMethod, QueryString, PostArg, RequestUri, RequestPath, RequestFileName, RequestfilenameExtension, RequestHeader, RequestScheme
...
### -NegateCondition
Här beskrivs om detta är ett negatevillkor eller inte
...
### -Operator
Här beskrivs operatorn som ska användas för matchningsvillkoret.
Möjliga värden är Any, IPMatch, GeoMatch, Equal, Contains, LessQual, GreaterQual, LessQualOrEqual, Greater HybridOrEqual, BeginsWith, EndsWith.
...
### -Selector
Namn på väljaren i RequestHeader eller RequestBegäran som ska matchas
...
### -Transform
Lista över vilka transformeringar som används innan de matchas. Möjliga enskilda transformeringsvärden är Gemener, Versaler, Rensa, UrlDecode, UrlEncode, RemoveNulls.
