...
## BESKRIVNING
Cmdleten **Update-AzFrontDoorWafPolicy** uppdaterar en befintlig WAF-princip. Om indataparametrar inte anges används gamla parametrar från den befintliga WAF-principen.
...
Uppdatera en befintlig anpassad statuskod för WAF-princip.
...
Uppdatera ett befintligt WAF-principläge.
...
Uppdatera en befintlig WAF-principaktiverad status och -läge.
...
### -InputObject
FireWallPolicy-objektet som ska uppdateras.
...
### -Name
Namnet på FireWallPolicy som ska uppdateras.
