...
## BESKRIVNING
**Enable-AzFrontDoorCustomDomainHttps** aktiverar HTTPS för en anpassad domän.

## EXEMPEL

### Exempel 1: Aktivera HTTPS för en anpassad domän med FrontDoorName och ResourceGroupName med det hanterade certifikatet Front Door.
```powershell
...
Aktivera HTTPS för en egen domän "frontendpointname1-custom-xyz" som är en del av front door "frontdoor1" i resursgruppen "resourcegroup1" med hanterat certifikat för front door.

### Exempel 2: Aktivera HTTPS för en anpassad domän med FrontDoorName och ResourceGroupName med egna certifikat i nyckelvalv.
```powershell
...
### Exempel 3: Aktivera HTTPS för en egen domän med PSFrontendEndpoint-objekt med det hanterade certifikatet Front Door.
```powershell
...
Aktivera HTTPS för en egen domän med PSFrontendEndpoint-objekt med det hanterade certifikatet Front Door.

### Exempel 4: Aktivera HTTPS för en anpassad domän med resurs-ID med det hanterade certifikatet Front Door.
```powershell
...
Aktivera HTTPS för en egen domän med ett hanterat certifikat för "frontendpointname1-custom-xyz" $resourceId resource id.
...
### -InputObject
Slutpunktsobjektet på framsidan som ska uppdateras.
...
### -ResourceId
Resurs-ID för framhjulsslutpunkten för att aktivera https
...
### -SecretVersion
Den version av nyckelns valv-hemlig som representerar det fullständiga certifikatet PFX
...
### -VaultId
Nyckelvalv-ID som innehåller SSL-certifikatet
