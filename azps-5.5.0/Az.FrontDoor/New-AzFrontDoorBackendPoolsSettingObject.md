...
## BESKRIVNING
Cmdleten **New-AzFrontDoorBackendpoolsSettingObject** skapar ett nytt PSBackendPoolsSettings-objekt för att skapa front door.

## EXEMPEL

### Exempel 1: Skapa BackendPoolsSettings-objekt med standardinställningar
```powershell
...
### Exempel 2: Skapa BackendPoolsSettings-objekt med användar angivna värden
```powershell
...
Om kontroll av certifikatnamn ska tillämpas på HTTPS-begäranden för alla serverbackendpooler.
...
Skicka och ta emot timeout vid vidarebefordran av begäran till backend. När tidsgränsen nås misslyckas begäran och returneras.
