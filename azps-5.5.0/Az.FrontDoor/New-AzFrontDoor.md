...
## BESKRIVNING
Cmdleten **New-AzFrontDoor** skapar en ny belastningsutjämnare för Azure Front Door i den angivna resursgruppen under aktuell prenumeration

## EXEMPEL

### Exempel 1: Skapa en dörr längst fram utifrån givna parametrar.
```powershell
...
Skapa en dörr utifrån givna parametrar.
...
### -EnabledState
AktiveradUtjämning av frontportens belastningsutjämning.
