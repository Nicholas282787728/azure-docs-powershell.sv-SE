...
Använd cmdleten "New-AzFrontDoorRulesEngineActionObject" för att skapa PSRulesEngineAction-objekt att överföra till parametern "-Action".
Använd cmdleten "New-AzFrontDoorRulesEngineMatchConditionObject" för att skapa PSRulesEngineMatchCondition-objekt som ska överföras till parametern "-MatchCondition".
...
Skapa nya PSRulesEngineRule-objekt och visa hur du ser underfälten.
...
Förvänta dig utdata när du passerar i ett ogiltigt prioritetsvärde.

## PARAMETERS

### -Åtgärd
Åtgärder som ska utföras för begäran och svar om alla matchningsvillkoren uppfylls.
...
### -MatchCondition
En lista med matchningsvillkor som måste uppfyllas för att åtgärder i den här regeln ska kunna köras. Om villkoren inte matchar kommer åtgärderna alltid att köras.
...
Om regeln är en matchning bör regelmotorn fortsätta att köra återstående regler eller stopp.
Möjliga värden är Fortsätt och Stopp.
Standardinställningen är Fortsätt om den inte finns.
...
### -Priority
Prioritet tilldelad till den här regeln.
