...
### -Operator
Operator som ska användas när väljaren matchas, innebär Lika MedAny ingen väljare (alla matchningsvariabler av den angivna typen)
...
### -Selector
Väljarmönster som ska matchas med operatorn (om operatorn inte är Lika medAny)
...
### -Variable
Matcha variabel. Möjliga värden är RequestHeaderNames, RequestCookieNames, QueryStringArgNames, RequestPostArgNames.
QueryStringArgNames är till exempel ett undantag från HÄMTA-parametrar som matchar väljaren med den givna operatorn.
