...
Inaktivera HTTPS för en anpassad domän som "frontendpointname1-custom-xyz" med FrontDoorName som "frontdoor1" och ResourceGroupName som "resourcegroup1".

### Exempel 2: Inaktivera HTTPS för en egen domän med PSFrontendEndpoint-objekt.
```powershell
...
Inaktivera HTTPS för en egen domän med PSFrontendEndpoint-objekt.
...
Inaktivera HTTPS för en egen domän "frontendpointname1-custom-xyz" med ResourceId som $resourceId.
...
### -ResourceId
Resurs-ID för framhjulsslutpunkten för att inaktivera https
