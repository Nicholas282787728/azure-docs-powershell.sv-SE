...
Använd cmdleten "New-AzFrontDoorRulesEngineRule" till att skapa regler för att överföra parametern "-Rules" till den här cmdleten.
...
Skapa en ny regelmotorkonfiguration för den angivna ytterporten.
...
### -Regel
En lista över regler som definierar en viss regelmotorkonfiguration.
