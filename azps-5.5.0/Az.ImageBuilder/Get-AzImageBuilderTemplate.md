...
### Exempel 1: Lista alla mallar under en prenumeration
```powershell
...
Det här kommandot listar alla mallar under en prenumeration.

### Exempel 2: Lista alla mallar under en resursgrupp
```powershell
...
Det här kommandot listar alla mallar under en resursgrupp.

### Exempel 3: Hämta en mall under en resursgrupp
```powershell
...
Det här kommandot får en mall under en resursgrupp.

### Exempel 4: Hämta en mall under en resursgrupp
```powershell
