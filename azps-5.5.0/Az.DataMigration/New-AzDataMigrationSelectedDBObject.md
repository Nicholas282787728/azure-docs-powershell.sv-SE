...
## BESKRIVNING
Med New-AzDataMigrationSelectedDB-cmdleten skapas ett databasinformationsobjekt som innehåller information om käll- och måldatabaser, samt tabellmappningarna, för migrering. Den här cmdleten kan användas som en parameter med New-AzDataMigrationTask cmdleten.
...
### -BackupFileShare
Filresurs där källserverdatabasfilerna för den här databasen ska säkerhetskopieras.
Använd den här inställningen för att åsidosätta filresursinformation för varje databas.
Använd fullständigt kvalificerat domännamn för servern.
...
Ställ in databasen i skrivskydd före migrering
...
Ställ in migreringstyp till SQL Server till SQL DB-migrering.
...
### -MigrateSqlServerSqlDbMi
Ställ in migreringstyp till SQL Server till SQL DB MI-migrering.
