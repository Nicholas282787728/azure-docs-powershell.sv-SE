...
## BESKRIVNING
Med Remove-AzDataMigrationService-cmdleten tas en instans av Azure-databasmigreringstjänsten bort från Azure. Om du anger parametern DeleteRunningTask tas alla Azure-databasmigreringstjänstaktiviteter som är kopplade till den tjänst som tas bort bort. 
...
Ovanstående exempel tar bort en instans av Azure-databasmigreringstjänsten med namnet TestService som finns i en Azure-resursgrupp med namnet MyResourceGroup.
...
### -Name
Namnet på databasmigreringstjänsten.
