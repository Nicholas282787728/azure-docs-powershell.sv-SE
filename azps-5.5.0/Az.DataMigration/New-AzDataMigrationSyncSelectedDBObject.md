...
Med New-AzDataMigrationSyncSelectedDB-cmdleten skapas ett databasinformationsobjekt som är specifikt för synkroniseringsscenariot och innehåller information om käll- och måldatabaser.
...
I det här exemplet skapas ett databasmetadataobjekt som beskriver migreringsinställningarna för $DatabaseName databasdata $DatabaseName.  
...
### -MigrationSetting
Migreringsinställningar som finjusterar migreringsbeteendet
...
### -SourceSetting
Källinställningar för att finjustera migrering av källslutpunkt
...
### -TargetSetting
Målinställningar för att finjustera hur målslutpunktsmigrering fungerar
