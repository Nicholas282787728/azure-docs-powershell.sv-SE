...
## BESKRIVNING
Med Stop-AzDataMigrationService-cmdleten stoppas en instans av Azure Database Migration Service som körs.
...
Ovanstående exempel stoppar en instans av Azure-databasmigreringstjänsten som kallas TestService baserat på tjänstnamn som skickas som indataparameter
...
I exemplet ovan stoppar vi en instans av Azure-databasmigreringstjänsten baserat på PSDataMigrationService-objekt som överförs som indataparameter.
