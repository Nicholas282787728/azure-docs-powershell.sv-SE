...
## BESKRIVNING
Med New-AzDataMigrationTask-cmdleten skapas datamigreringsuppgift. Den här cmdleten tar in parametrar för uppräkning av aktivitetstyp, Azure-resursgrupp, namnet på associerad Azure-databasmigreringstjänst och Project som indata. 
...
Det här exempelskriptet visar hur du skapar en ny datamigreringsuppgift med namnet MyMigrationTask i projektet myDMSProject och tjänsten TestService. 
...
### -MigrationValidation 
Uppgiftssvarsobjekt genom verifieringssamtal, valfritt men rekommenderas.
...
### -Wait
Om du vill vänta tills aktiviteten är klar. Om flaggan är inställd kontrollerar du var sekund tills aktiviteten avslutas och återgår till användaren de aktivitetsegenskaper där utdata eller fel kan kontrolleras. 
```yaml
