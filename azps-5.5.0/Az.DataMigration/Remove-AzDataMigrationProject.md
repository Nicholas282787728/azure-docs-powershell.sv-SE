...
## BESKRIVNING
Med Remove-AzDataMigrationProject-cmdleten tas ett Azure Database Migration Service-projekt bort från Azure. Om du anger parametern DeleteRunningTask tas alla Azure Database Migration Service-uppgifter som är kopplade till projektet bort. 
...
I exemplet ovan tas projektet för Azure-databasmigreringstjänsten för myDMProject bort från Azure baserat på namn som indataparameter
...
I exemplet ovan tas projektet med Azure-databasmigreringstjänsten bort baserat på PSProject-objekt som indataparameter.
