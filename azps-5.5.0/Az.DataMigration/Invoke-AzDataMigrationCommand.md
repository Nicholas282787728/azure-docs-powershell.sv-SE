...
## BESKRIVNING
Med Invoke-AzDataMigrationCommand-cmdleten skapas en ny kommandoaktivitet som ska köras på en befintlig migreringsuppgift.
...
I exemplen ovan används cmdlet Invoke-AzDataMigrationCommand för att skapa ett kommando för en befintlig tjänst, ett projekt och en aktivitet
...
### -TaskName
Namnet på aktiviteten som kommandot körs på.
...
```
### -ObjectName
Namnet på databasobjektet som kommandot körs mot.
