...
ms.locfileid: "100252680"
---
# New-AzWindowsIotServicesDevice

## SYNOPSIS
Skapa eller uppdatera metadata för en Windows IoT-enhetstjänst.
...
### Exempel 1: Skapa nya Windows IoT-tjänster
```powershell
...
Ange inte för att skapa en ny Windows IoT-enhetstjänst.
