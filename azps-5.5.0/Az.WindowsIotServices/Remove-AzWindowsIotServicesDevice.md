...
ms.locfileid: "100252677"
---
# Remove-AzWindowsIotServicesDevice

## SYNOPSIS
Ta bort en Windows IoT-enhetstjänst.
...
### Exempel 1: Ta bort en Windows IoT-tjänst med namn
```powershell
PS C:\> Remove-AzWindowsIotServicesDevice -Name wsi-t03 -ResourceGroupName azure-rg-test

```

Med det här kommandot tas en Windows IoT-tjänst bort med namn.

### Exempel 2: Ta bort en Windows IoT-tjänst genom pipeline
```powershell
...
Med det här kommandot tas en Windows IoT-tjänst bort via pipeline.
