...
ms.locfileid: "100233455"
---
# Get-AzCommunicationServiceKey

## SYNOPSIS
Hämta snabbtangenterna för resursen CommunicationService.
...
## BESKRIVNING
Hämta snabbnycklarna för resursen CommunicationService.

## EXEMPEL

### Exempel 1: Hämta nyckeln för den angivna kommunikationstjänsten
```powershell
...
Visar Anslutningssträng och Nyckel för den angivna kommunikationstjänsten.
