...
### Exempel 1: Uppdatera en befintlig ACS-resurs så att den har taggar
```powershell
...
Bifogar de givna taggarna till den angivna ACS-resursen.
...
### -Tag
Taggar för tjänsten som är en lista över nyckelvärdespar som beskriver resursen.
