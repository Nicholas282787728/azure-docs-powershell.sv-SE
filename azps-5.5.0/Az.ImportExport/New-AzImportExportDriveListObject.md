...
### Exempel 1: Skapa en ny DriveList för ImportExport-jobb
```powershell
...
Dessa cmdlets skapar en ny DriveList för ImportExport-jobb.

## PARAMETERS

### -BitLockerKey
BitLocker-nyckeln används för att kryptera enheten.
...
### -CopyStatus
Detaljerad status för dataöverföringsprocessen.
Det här fältet returneras inte i svaret förrän enheten är i överföringstillståndet.
...
### -DriveId
Enhetens maskinvaruserienummer, utan blanksteg.
...
### -ErrorLogUri
En URI som pekar på blobben som innehåller felloggen för dataöverföringsåtgärden.
...
### -ManifestFile
Den relativa sökvägen till manifestfilen på enheten.
...
### -ManifestHash
Base16-kodad MD5-hash av manifestfilen på enheten.
...
### -ManifestUri
En URI som pekar på blobben som innehåller manifestfilen för enheten.
...
### -UtförligLogUri
En URI som pekar på blobben som innehåller den utförliga loggen för dataöverföringsåtgärden.
