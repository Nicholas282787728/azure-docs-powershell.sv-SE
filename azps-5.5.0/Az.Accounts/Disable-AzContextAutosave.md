...
### Exempel 1: Inaktivera spara automatiskt kontext
```powershell
PS C:\> Disable-AzContextAutosave
```

Inaktivera spara automatiskt för den aktuella användaren.

### Exempel 2

Inaktivera automatiskt sparade Azure-autentiseringsuppgifter i den här PowerShell-sessionen. (autogenererat)
