...
## BESKRIVNING
Med Set-AzDefault cmdleten lägger till eller ändrar standardinställningarna i det aktuella sammanhanget.
...
Det här kommandot anger standardresursgruppen till den resursgrupp som anges av användaren.
...
### -Force
Skapa en ny resursgrupp om den angivna standardinställningen inte finns
...
### -ResourceGroupName
Namnet på den resursgrupp som anges som standard
