...
## BESKRIVNING
Cmdleten Import-AzContext autentiseringsinformation från en fil för att ange Azure-miljön och -kontexten.
...
### Exempel 1: Importera ett sammanhang från en AzureRmProfile
```
...
Det här exemplet importerar ett sammanhang från en PSAzureProfile som har passerat till cmdleten.

### Exempel 2: Importera ett sammanhang från en JSON-fil
```
...
I det här exemplet markeras ett sammanhang från en JSON-fil som går till cmdleten. Den här JSON-filen kan skapas från Save-AzContext.
...
### -Path
Anger sökvägen till kontextinformation som sparas med hjälp av Save-AzContext.
