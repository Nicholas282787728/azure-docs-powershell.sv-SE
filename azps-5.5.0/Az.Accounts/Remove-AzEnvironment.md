...
## BESKRIVNING
Med Remove-AzEnvironment-cmdleten tas slutpunkter och metadatainformation bort för anslutning till en viss Azure-instans.

## EXEMPEL

### Exempel 1: Skapa och ta bort en testmiljö
```
...
Det här exemplet visar hur du skapar en miljö med tillägget AzEnvironment och hur du tar bort miljön med Remove-AzEnvironment.
...
### -Name
Anger namnet på miljön som ska tas bort.
