...
### Exempel 1: Rensa globalt sammanhang
```powershell
PS C:\> Clear-AzContext -Scope CurrentUser
```

Ta bort all konto-, prenumerations- och autentiseringsinformation för powershell-sessioner.
...
### -Force
Ta bort alla användare och grupper från den globala omfattningen utan att fråga
