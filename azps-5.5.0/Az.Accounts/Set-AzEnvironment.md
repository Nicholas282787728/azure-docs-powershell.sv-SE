...
## BESKRIVNING
Med Set-AzEnvironment cmdleten anges slutpunkter och metadata för anslutning till en instans av Azure.
...
### -AzureAttestationServiceEndpointResourceId
Resursidentifieraren för Azure-tjänsten som är mottagaren av den begärda tokenen.
...
### -AzureSynapseAnalyticsEndpointSuffix
Dns-suffixet för Azure Synapse-analys.
...
Suffix till Azure Container Registry.
...
### -Name
Anger namnet på miljön som ska ändras.
...
### -ServiceEndpoint
Anger slutpunkten för RDFE-begäranden (Service Management).
