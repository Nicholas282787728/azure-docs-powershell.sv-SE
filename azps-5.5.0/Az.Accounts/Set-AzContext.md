...
## BESKRIVNING
Med Set-AzContext cmdleten anges autentiseringsinformation för cmdlets som du kör i den aktuella sessionen.
Kontexten omfattar klientorganisation, prenumeration och miljöinformation.

## EXEMPEL

### Exempel 1: Ange prenumerationskontexten
```
...
Med det här kommandot anger du kontexten för den angivna prenumerationen.

## PARAMETERS

### -Sammanhang
Anger kontexten för den aktuella sessionen.
...
### -DefaultProfile
Autentiseringsuppgifterna, klientorganisationen och prenumerationen som används för kommunikation med Azure.
...
### -ExtendedProperty
Ytterligare sammanhangsegenskaper
...
### -Force
Skriva över det befintliga sammanhanget med samma namn, om det finns något.
...
### -Prenumeration
Namnet eller ID för prenumerationen som kontexten ska ställas in på. Den här parametern har alias för -SubscriptionName och -SubscriptionId, så för tydlighetens skull kan någon av dessa användas i stället för -Prenumeration när namn respektive ID anges.
