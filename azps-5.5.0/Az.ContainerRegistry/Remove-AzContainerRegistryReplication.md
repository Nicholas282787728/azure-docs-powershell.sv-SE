...
## BESKRIVNING
Med Remove-AzContainerRegistryReplication-cmdleten tas en container registry replication bort.

## EXEMPEL

### Exempel 1: Tar bort en behållarregisterreplikering.
```powershell
...
Standardinställningen är platsnamnet.
