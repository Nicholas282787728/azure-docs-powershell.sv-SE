...
## BESKRIVNING
Med New-AzContainerRegistry-cmdleten skapas ett behållarregister.

## EXEMPEL

### Exempel 1: Skapa ett behållarregister med ett nytt lagringskonto.
```powershell
...
Det här kommandot skapar ett behållarregister med ett nytt lagringskonto i \` resursgruppen MyResourceGroup. \`

### Exempel 2: Skapa ett behållarregister med administratörsanvändare aktiverat.
```powershell
...
Med det här kommandot skapas ett behållarregister med administratörsanvändare aktiverat.
...
### -Tag
Container Registry Tags.Key-value pairs i form av en hash-tabell.
