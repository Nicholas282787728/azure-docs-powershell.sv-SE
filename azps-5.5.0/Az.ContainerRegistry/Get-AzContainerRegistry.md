...
## BESKRIVNING
För Get-AzContainerRegistry-cmdleten får du ett angivet behållarregister eller alla behållarregister i en resursgrupp eller prenumerationen.

## EXEMPEL

### Exempel 1: Hämta ett angivet behållarregister
```powershell
...
Det här kommandot hämtar det angivna behållarregistret.

### Exempel 2: Hämta alla behållarregister i en resursgrupp
```powershell
...
Med det här kommandot får du alla behållarregister i en resursgrupp.

### Exempel 3: Hämta alla behållarregister i prenumerationen
```powershell
...
Med det här kommandot får du alla behållarregister i prenumerationen.
...
### -IncludeDetail
Visa mer information om behållarregistret.
