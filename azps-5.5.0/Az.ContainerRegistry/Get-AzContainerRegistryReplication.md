...
## BESKRIVNING
Den Get-AzContainerRegistryReplication cmdleten får en angiven replikering av ett behållarregister eller alla replikeringar av ett behållarregister.

## EXEMPEL

### Exempel 1: Får en angiven replikering av ett behållarregister
```powershell
...
Får en angiven replikering av ett behållarregister

### Exempel 2: Hämtar alla replikeringar av ett behållarregister
```powershell
...
Hämtar alla replikeringar av ett behållarregister
...
### -ResourceId
Resurs-ID för registerreplikering i behållare
