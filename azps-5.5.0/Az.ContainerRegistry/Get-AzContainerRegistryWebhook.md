...
## BESKRIVNING
Den Get-AzContainerRegistryWebhook cmdleten hämtar en angiven webhook för container-registret eller alla webhooks för ett behållarregister.

## EXEMPEL

### Exempel 1: Hämta en viss webhook för ett behållarregister
```powershell
...
Hämta en angiven webhook för ett behållarregister

### Exempel 2: Hämta alla webhooks för ett behållarregister
```powershell
...
Hämta alla webhooks för ett behållarregister

### Exempel 3: Hämta en viss webhook för ett behållarregister med konfigurationsinformation
```powershell
...
Hämta en viss webhook för ett behållarregister med konfigurationsinformation
