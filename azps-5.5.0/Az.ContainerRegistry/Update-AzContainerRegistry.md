...
## BESKRIVNING
Med Update-AzContainerRegistry-cmdleten uppdateras ett behållarregister.

## EXEMPEL

### Exempel 1: Aktivera administratörsanvändare för ett angivet behållarregister
```powershell
...
Med det här kommandot aktiverar du administratörsanvändaren för den angivna behållarregistret.

### Exempel 2: Ange lagringskontot som används av ett angivet behållarregister
```powershell
...
Det här kommandot anger att det angivna behållarregistret ska använda ett befintligt \` lagringskonto för mitt konto \` i samma prenumeration.
...
### -DisableAdminUser
Aktivera administratörsanvändaren för behållarregistret.
...
### -NetworkRuleSet
Nätverksregeluppsättningen för ett behållarregister.
...
### -StorageAccountName
Namnet på ett befintligt lagringskonto.
...
### -Tag
Nyckelvärdepar i form av en hash-tabell.
Exempel: @{key0="value0";key1=$null;key2="value2"}
