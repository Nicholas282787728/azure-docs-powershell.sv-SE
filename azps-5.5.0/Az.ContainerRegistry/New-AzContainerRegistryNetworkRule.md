...
## BESKRIVNING
Skapa ett nätverksregelobjekt i den aktuella PowerShell-sessionen.
...
Skapa virtualnetwork-regeluppsättning.

## PARAMETERS

### -Åtgärd
Nätverksregelns åtgärd.
...
### -IPAddressOrRange
Anger IP- eller IP-intervallet i CIDR-format.
Endast IPV4-adress är tillåten.
...
### -VirtualNetworkRule
Ange att du vill skapa VirtualNetworkRule.
