...
## BESKRIVNING
Med Update-AzContainerRegistryCredential-cmdleten skapas en inloggningsinformation för ett behållarregister.

## EXEMPEL

### Exempel 1: Skapa om inloggningsuppgifter för ett behållarregister
```powershell
...
Det här kommandot återskapar en inloggningsuppgifterna för det angivna behållarregistret.
Administratörsanvändare måste aktiveras för containerregistret \` MyRegistry för \` att generera inloggningsuppgifter.
...
### -PasswordName
Namnet på lösenordet som ska återskapas.
Tillåtna värden: lösenord, lösenord2.
