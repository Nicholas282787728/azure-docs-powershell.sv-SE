...
## BESKRIVNING
Med New-AzContainerRegistryReplication-cmdleten skapas en ny behållarregisterreplikering.

## EXEMPEL

### Exempel 1: Skapa en ny behållarregisterreplikering.
```powershell
...
Skapa en ny registerreplikering för behållare.
