...
## BESKRIVNING
Skaffa eller lista ACR-tagg.
Om du vill använda den här cmdleten kör du `Update-AzContainerRegistryRepository -RegistryName XXX -Repository XXX -ReadEnable $true -ListEnable $true`
först.
...
Listtaggar för lagringsplatsens alpinea under register.
...
Hämta taggen senaste för lagringsplatsen i registret.
