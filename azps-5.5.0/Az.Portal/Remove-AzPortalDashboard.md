...
ms.locfileid: "100213231"
---
# Remove-AzPortalDashboard

## SYNOPSIS
Tar bort instrumentpanelen.
...
### Exempel 1: Ta bort en instrumentpanel
```powershell
PS C:\td\> Remove-AzPortalDashboard -ResourceGroupName my-rg -DashboardName dashbase02
```

Ta bort ett Streckbaord med resursgruppens namn och instrumentpanelens namn.

### Exempel 2: Ta bort en instrumentpanel med pipelinen
```powershell
PS C:\> Get-AzPortalDashboard -ResourceGroupName my-rg -DashboardName dashbase02 | Remove-AzPortalDashboard
```

Ta bort instrumentpanelen som returneras från Get-AzDashboard samtal.
