...
ms.locfileid: "100220711"
---
# Get-AzPortalDashboard

## SYNOPSIS
Hämtar instrumentpanelen.
...
### Exempel 1: Lista alla instrumentpaneler i en prenumeration
```powershell
...
Lista alla instrumentpaneler i en prenumeration

### Exempel 2: Få information om en enskild instrumentpanel på portalen
```powershell
...
Få information om en enskild instrumentpanel
