...
ms.locfileid: "100218087"
---
# Update-AzPortalDashboard

## SYNOPSIS
Uppdaterar en befintlig instrumentpanel.
...
### Exempel 1: Uppdatera taggarna för en instrumentpanel
```powershell
...
Uppdatera taggarna på en instrumentpanel.
Taggar representeras som en infogade hashtabell.

### Exempel 2: Uppdatera Instrumentpanelstaggar med hjälp av pipelinen
```powershell
...
Uppdatera taggarna i en instrumentpanel som uppdateras med Get-AzPortalDashboard.
Det här kan användas för att uppdatera taggarna över en enskild instrumentpanel eller flera instrumentpaneler.
...
### -Lens
Instrumentpanelen är en del av den.
...
INPUTOBJECT <IPortalIdentity> : Identity Parameter
  - `[DashboardName <String>]`: Namnet på instrumentpanelen.
