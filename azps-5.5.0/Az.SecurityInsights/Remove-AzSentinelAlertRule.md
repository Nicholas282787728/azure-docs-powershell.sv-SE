...
## BESKRIVNING
Cmdleten **Remove-AzSentinelAlertRule** tar permanent bort en aviseringsregel från en angiven arbetsyta.
Du kan skicka ett **Aviseringsobjekt** med hjälp av rörledningsoperatorn, eller så kan du ange de parametrar som krävs.
...
Med det här kommandot tas aviseringsregeln bort från arbetsytan.
