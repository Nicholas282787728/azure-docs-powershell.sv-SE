...
## BESKRIVNING
**Cmdleten Update-AzSentinelAlertRuleAction** uppdaterar bokmärket i den angivna arbetsytan.
Du kan skicka ett **AlertRuleAction-objekt** som en parameter eller med hjälp av rörledningsoperatorn, eller så kan du ange parametrarna *AlertRuleId* och *ActionId.*
...
Det här exemplet uppdaterar **en AlertRuleAction med** ett InputObject-objekt som ersätter en *befintlig åtgärd* med nya egenskaper.
