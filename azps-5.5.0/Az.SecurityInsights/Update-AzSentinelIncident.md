...
## BESKRIVNING
**Cmdleten Update-AzSentinelIncident** uppdaterar incidenten i den angivna arbetsytan.
Du kan överföra ett **incidentobjekt** som en parameter eller med hjälp av rörledningsoperatorn, eller så kan du ange de parametrar som krävs.
...
Kommandot får Incident by *IncidentId och* anger egenskapen *Allvarlighetsgrad* till *Hög.*  Alla andra egenskaper förblir desamma.
...
Incident Classificaiton-kommentar.
