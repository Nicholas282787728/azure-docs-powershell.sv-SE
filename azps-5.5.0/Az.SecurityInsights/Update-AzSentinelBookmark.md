...
ms.locfileid: "100232782"
---
# Update-AzSentinelBookmark

## SYNOPSIS
Uppdatera ett bokmärke.
...
## BESKRIVNING
**Cmdleten Update-AzSentinelBookmark** uppdaterar bokmärket i den angivna arbetsytan.
Du kan överföra ett **bokmärkesobjekt** som en parameter eller genom att använda en rörledningsoperator, eller så kan du ange de obligatoriska *BookmarkId-parametrarna.*
...
Kommandot uppdaterar bokmärket genom att ange *egenskapen* Anteckningar.  Alla andra funktioner förblir desamma.
...
Det första kommandot hämtar bokmärket med *BookmarkId* från den angivna arbetsytan och lagrar det sedan i den $Bookmark variabeln.
Det andra kommandot uppdaterar egenskapen Anteckningar.   Alla andra funktioner förblir desamma.
...
### -DisplayName
Visningsnamn för bokmärkesregel.
...
### -IncidentInfo
Information om bokmärkestillbud.
