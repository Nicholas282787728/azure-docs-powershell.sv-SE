...
ms.locfileid: "100223606"
---
# Set-AzApplicationGatewayRewriteRuleSet

## SYNOPSIS
Ändrar en omskrivningsregeluppsättning för en programgateway.
...
## BESKRIVNING
**Cmdleten Set-AzApplicationGatewayRewriteRuleSet** ändrar en routningsregel för begäran.
...
Med det andra kommandot ändras uppsättningen med omskrivningsregel för att programgatewayen ska använda omskrivningsregler som anges i $rule variabeln.
