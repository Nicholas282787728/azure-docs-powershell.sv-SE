...
ms.locfileid: "100236934"
---
# Get-AzVpnConnection

## SYNOPSIS
Får en vpn-anslutning efter namn eller visar alla VPN-anslutningar anslutna till en VpnGateway.
...
Ovanstående skapar en resursgrupp, virtuellt WAN, virtuellt nätverk, virtuellt nav och en VpnSite i västra USA i resursgruppen "testRG" i Azure. En VPN-gateway kommer därefter att skapas i det virtuella hubben med 2 skalenheter.
...
Den här cmdleten får alla anslutningar som börjar med "test".
