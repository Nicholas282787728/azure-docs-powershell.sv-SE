...
ms.locfileid: "100252276"
---
# Remove-AzNetworkProfile

## SYNOPSIS
Tar bort en nätverksprofil.
...
## BESKRIVNING
Med cmdleten **Remove-AzNetworkProfile** tas en nätverksprofil bort om inga gränssnitt för behållarnätverk (till skillnad från konfiguration av ett behållarnätverksnätverk) har skapats.
...
Då tas nätverksprofilen bort med namnet periodantal1 från resursgruppen rg1.
...
### -ResourceId
Resurs-ID för Azure-resurshanteraren för nätverksprofilen.
