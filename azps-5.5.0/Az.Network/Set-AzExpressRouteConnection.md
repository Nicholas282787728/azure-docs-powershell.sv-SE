...
ms.locfileid: "100218263"
---
# Set-AzExpressRouteConnection

## SYNOPSIS
Uppdaterar en express route-anslutning som skapats mellan en express routegateway och en lokal express route-peering.
...
## BESKRIVNING
**Set-AzExpressRouteConnection-cmdleten** uppdaterar en expressroute-anslutning som skapats mellan en expressroute-gateway och en lokal expressroute-peering.
...
Ovanstående skapar en resursgrupp, virtuellt WAN, virtuellt nätverk, virtuellt nav och en ExpressRouteSite i västra USA i resursgruppen "testRG" i Azure. En ExpressRoute-gateway kommer därefter att skapas i det virtuella hubben med 2 skalenheter.

När gatewayen har skapats är den ansluten till den lokala ExpressRoute-kretsens peering med hjälp New-AzExpressRouteConnection kommando.

Anslutningen uppdateras sedan till en annan RoutingWeight med hjälp av kommandot Set-AzExpressRouteConnection..
...
### -AuthorizationKey
Auktoriseringsnyckeln som ska användas för att skapa ExpressRoute-gatewayanslutningen.
...
Aktivera Internetsäkerhet för den här ExpressRoute Gateway-anslutningen
...
### -RoutingWeight
Den vikt som måste tilldelas till den här anslutningen för paketrering.
