...
ms.locfileid: "100220887"
---
# Set-AzVirtualHub

## SYNOPSIS
Ändrar ett virtuellt nav för att lägga till en virtuell HUb-routetabell i den.
...
Först skapar vi ett objekt för virtuell hubb-route och använder det för att skapa en tabellresurs för virtuell hubb-route. Sedan anger vi den här routetabellresursen till det virtuella navet med hjälp Set-AzVirtualHub postkommandot.
...
### -RouteTable
Routetabellerna som är kopplade till det här virtuella hubben.
