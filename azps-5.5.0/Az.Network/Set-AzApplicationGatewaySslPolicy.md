...
Det här andra kommandot ändrar SSL-principen till en principtyp fördefinierad och principnamn AppGwSslPolicy20170401.

## PARAMETERS

### -ApplicationGateway
Anger programgatewayen för SSL-principen som denna cmdlet ändrar.
...
Anger vilka protokoll som inaktiveras.
