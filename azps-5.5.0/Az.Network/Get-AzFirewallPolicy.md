...
ms.locfileid: "100227934"
---
# Get-AzFirewallPolicy

## SYNOPSIS
Får en Azure-brandväggsprincip
...
## BESKRIVNING
Cmdleten **Get-AzFirewallPolicy** får en eller flera brandväggar i en resursgrupp
...
Det här exemplet får en brandväggsprincip som heter "firewallPolicy" i resursgruppen "TestRg"
