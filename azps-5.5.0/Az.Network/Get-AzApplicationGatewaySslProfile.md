...
Det första kommandot hämtar programgatewayen med namnet ApplicationGateway01 i resursgruppen ResourceGroup01 och lagrar den i $AppGw variabeln. Det andra kommandot hämtar SSL-profilen SslProfile01 $AppGw den i variabeln $profile variabeln.
