...
## BESKRIVNING
**Cmdleten Set-AzApplicationGatewaySslProfile uppdaterar ssl-profilen** för en Azure-programgateway.
...
Det första kommandot hämtar programgatewayen med namnet ApplicationGateway01 som tillhör resursgruppen ResourceGroup01 och lagrar den i $AppGw variabeln. Det andra kommandot uppdaterar SSL-profilen för programgatewayen i variabeln $AppGw för att uppdatera konfigurationen för klientauth till det nya värdet som lagras i $newclientconfig.
