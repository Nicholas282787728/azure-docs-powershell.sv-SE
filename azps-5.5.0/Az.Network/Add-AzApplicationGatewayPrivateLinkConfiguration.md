...
ms.locfileid: "100224054"
---
# Add-AzApplicationGatewayPrivateLinkConfiguration

## SYNOPSIS
Lägger till en privat länkkonfiguration i en programgateway.
...
## BESKRIVNING
**Cmdleten Add-AzApplicationGatewayPrivateLinkConfiguration** lägger till en privat länkkonfiguration i en programgateway.
...
Det första kommandot skapar en privateLinkIpConfiguration och lagrar den i $PrivateLinkIpConfiguration variabeln.
...
Det tredje kommandot lägger till den privata länkkonfigurationen med namnet privateLinkConfig01 för gatewayen i $AppGw
