...
När webbplatsen har skapats tas den bort direkt med hjälp Remove-AzVpnSite kommandot.
...
Samma som i exempel 1, men här sker borttagningen med pipedutdata från Get-AzVpnSite.
...
### -InputObject
VpnSite-objektet som ska tas bort.
...
### -ResourceId
Azure-resurs-ID:t för vpnSiten som ska tas bort.
