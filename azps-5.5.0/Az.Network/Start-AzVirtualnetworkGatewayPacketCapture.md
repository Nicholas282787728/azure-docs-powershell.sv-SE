...
ms.locfileid: "100227375"
---
# Start-AzVirtualnetworkGatewayPacketCapture

## SYNOPSIS
Startar paketinspelningsåtgärden på en virtuell nätverksgateway.
...
```
### Exempel 3
Exempel på paketinspelning för att fånga alla inre och yttre paket
```powershell
...
### -FilterData
Filteralternativ för inspelning av startpaket på virtuell nätverksgateway.
...
### -Name
Namnet på den virtuella nätverksgatewayen där paketinspelning ska startas.
