...
ms.locfileid: "100252445"
---
# Get-AzNetworkWatcherConnectionMonitorReport

## SYNOPSIS
Skapa en fråga för en ögonblicksbild av de senaste anslutnings tillstånden.
...
## BESKRIVNING
Den Get-AzNetworkWatcherConnectionMonitorReport cmdleten returnerar rapporten med de senaste anslutnings tillstånden.

## EXEMPEL

### Exempel 1: Hämta den senaste ögonblicksbilden av anslutningens bildskärm efter namn på den angivna platsen
```
...
I det här exemplet frågar vi de senaste anslutnings tillstånden för den angivna anslutningsövervakningen.
...
### -ResourceId
Resurs-ID för anslutningsövervakningen.
...
## ANTECKNINGAR
Nyckelord: azure, azurerm, arm, resurs, anslutning, hantering, chef, nätverk, nätverk, nätverksbevakning, anslutningsövervakning
