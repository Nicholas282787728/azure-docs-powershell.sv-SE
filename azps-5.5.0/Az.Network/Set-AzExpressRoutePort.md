...
ms.locfileid: "100252236"
---
# Set-AzExpressRoutePort

## SYNOPSIS
Ändrar ett ExpressRoutePort.
...
## BESKRIVNING
**Set-AzExpressRoutePort-cmdleten** sparar den modifierade ExpressRoutePort till Azure.
...
Ändrar administratörstillståndet för en länk i ett ExpressRoutePort
