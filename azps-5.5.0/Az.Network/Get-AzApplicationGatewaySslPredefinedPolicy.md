...
ms.locfileid: "100252464"
---
# Get-AzApplicationGatewaySslPredefinedPolicy

## SYNOPSIS
Hämtar fördefinierade SSL-principer som tillhandahålls av Application Gateway.
...
## BESKRIVNING
Cmdleten **Get-AzApplicationGatewaySslPredefinedPolicy** får fördefinierade SSL-principer som tillhandahålls av Application Gateway.
...
Med de här kommandona returneras alla fördefinierade SSL-principer.
...
Med de här kommandona returneras en fördefinierad princip med namnet AppGwSslPolicy20170401.
...
Med de här kommandona returneras en fördefinierad princip med namn som börjar med "AppGwSslPolicy2017".
...
### -Name
Namn på ssl-fördefinierad princip
