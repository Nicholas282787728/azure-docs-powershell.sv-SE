...
ms.locfileid: "100218631"
---
# Get-AzVpnServerConfiguration

## SYNOPSIS
Hämtar en befintlig VpnServerConfiguration för punkt till webbplatsanslutning.
...
## BESKRIVNING
Cmdleten **Get-AzVpnServerConfiguration** returnerar den befintliga VpnServerConfiguration för Point to site connectivity.
...
Kommandot ovan hämtar den befintliga VpnServerConfiguration.
