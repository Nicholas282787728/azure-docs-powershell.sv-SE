...
ms.locfileid: "100218439"
---
# New-AzPrivateLinkServiceConnection

## SYNOPSIS
Skapar en konfiguration för privat länktjänstanslutning.
...
## BESKRIVNING
**Cmdleten New-AzPrivateLinkServiceConnection** skapar en konfiguration för privat länktjänstanslutning.
...
I det här exemplet skapas ett privat länktjänstanslutningsobjekt i minnet som du kan använda för att skapa en privat slutpunkt.

### Exempel 2

Skapar en konfiguration för privat länktjänstanslutning. (autogenererat)
