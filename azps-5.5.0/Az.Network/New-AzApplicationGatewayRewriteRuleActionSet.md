...
ms.locfileid: "100225951"
---
# New-AzApplicationGatewayRewriteRuleActionSet

## SYNOPSIS
Skapar en omskrivningsregelåtgärdsuppsättning för en programgateway.
...
## BESKRIVNING
**Cmdleten New-AzApplicationGatewayRewriteRuleActionSet** skapar en omskrivningsregelåtgärdsuppsättning för en Azure-programgateway.
...
Det här kommandot skapar en åtgärdsuppsättning för omskrivningsregel och lagrar resultatet i variabeln $action.
...
Lista över konfigurationer av begärandehuvuden
...
Lista över konfigurationer av svarshuvuden
...
### -UrlConfiguration
URL-konfiguration för åtgärdsuppsättning
