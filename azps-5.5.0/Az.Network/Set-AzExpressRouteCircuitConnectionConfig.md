...
## BESKRIVNING
Cmdleten **Set-AzExpressRouteCircuitConnectionConfig** uppdaterar en kretsanslutningskonfiguration som skapats i privat peering för en ExpressRoute-krets. Det gör det möjligt att peering två Express Route-kretsar mellan regioner eller prenumerationer.
Innan du kör **Set-AzExpressRouteCircuitConnectionConfig** måste du lägga till kretsanslutningen med **add-AzExpressRouteCircuitConnectionConfig.** När du har **kört Set-AzExpressRouteCircuitPeeringConfig** måste du anropa cmdleten Set-AzExpressRouteCircuit för att aktivera konfigurationen.
...
### Exempel 2: Konfigurera en kretsanslutningskonfiguration med Piping på en befintlig ExpressRoute-krets
```
$circuit_peer = Get-AzExpressRouteCircuit -Name $peeringCircuitName -ResourceGroupName $rg
...
### -AddressPrefix
Ett minsta /29 kundens adressutrymme för att skapa VxLan-tunnlar mellan Express routekretsar för IPv4-tunnlar.
eller minst /125 kundadressutrymme för att skapa VxLan-tunnlar mellan Express Route-kretsar för IPv6-tunnlar.
...
```
### -AddressPrefixType
Anger adressfamiljen som adressprefixet tillhör.
