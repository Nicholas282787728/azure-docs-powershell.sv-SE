...
## BESKRIVNING
Med New-AzDdosProtectionPlan-cmdleten skapas en DDoS-skyddsplan.

## EXEMPEL

### Exempel 1: Skapa och koppla en DDoS-skyddsplan till ett nytt virtuellt nätverk
```
...
Först skapar vi en ny DDoS **Protection-plan med kommandot New-AzDdosProtectionPlan.**
Sedan skapar vi ett nytt virtuellt nätverk med **New-AzVirtualNetwork** och vi anger ID för den nya planen i parametern **DdosProtectionPlanId.** I det här fallet kan vi ange parametern **EnableDdoSProtection** eftersom vi associerar det virtuella nätverket med en plan.

### Exempel 2: Skapa och koppla en DDoS-skyddsplan till ett befintligt virtuellt nätverk
```
D:\> $ddosProtectionPlan = New-AzDdosProtectionPlan -ResourceGroupName ResourceGroupName -Name DdosProtectionPlanName -Location "West US"
...
Först skapar vi en ny DDoS **Protection-plan med kommandot New-AzDdosProtectionPlan.**
För det andra får vi den mest uppdaterade versionen av det virtuella nätverket som vi vill associera med planen. Vi uppdaterar egenskapen **DdosProtectionPlan med** ett **PSResourceId-objekt** som innehåller en referens till ID:t för den nya planen. Om vi i det här fallet kopplar det virtuella nätverket till en DDoS-plan kan vi också ange att **flaggan EnableDdosProtection** ska sant.
Slutligen beständiga vi den nya statusen genom att pipa den lokala variabeln till **Set-AzVirtualNetwork.**
...
### -Plats
Anger platsen för det DDoS-skyddsplan som ska skapas.
...
### -Name
Anger namnet på det DDoS-skyddsplan som ska skapas.
...
### -ResourceGroupName
Anger resursgruppen för DDoS-skyddsplanen som ska skapas.
