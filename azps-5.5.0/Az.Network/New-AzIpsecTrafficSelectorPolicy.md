...
ms.locfileid: "100227726"
---
# New-AzIpsecTrafficSelectorPolicy

## SYNOPSIS
Skapar en princip för trafikväljare.
...
## BESKRIVNING
Med New-AzTrafficSelectorPolicy-cmdleten skapas ett principförslag från trafikväljaren som ska användas i en anslutning till en virtuell nätverksgateway.
...
Skapar en instans av en trafikväljarprincip och lägger till den som en parameter när du skapar en anslutning till virtuell nätverksgateway med ett IKEv2-protokoll.
