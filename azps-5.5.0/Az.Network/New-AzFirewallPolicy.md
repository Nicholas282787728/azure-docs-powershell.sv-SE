...
ms.locfileid: "100213767"
---
# New-AzFirewallPolicy

## SYNOPSIS
Skapar en ny Azure-brandväggsprincip
...
## BESKRIVNING
Cmdleten **New-AzFirewallPolicy** skapar en Azure-brandväggsprincip.
...
I det här exemplet skapas en Azure-brandväggsprincip
...
Det här exemplet skapar en Azure-brandväggsprincip med ett hotbilds intel-läge

### Exempel 3: 3. Skapa en tom princip med ThreatIntel Whitelist
```powershell
...
Det här exemplet skapar en Azure-brandväggsprincip med en hotbildslista från Intel

### Exempel 4: 4. Skapa princip med intrångsidentifiering, identitet och transportsäkerhet
```powershell
...
Det här exemplet skapar en Azure-brandväggsprincip med en intrångsidentifiering i lägesavisering, användar kopplad identitet och transportsäkerhet
...
### -BasePolicy
Den basprincip som ska ärva från
...
### -Identity
Brandväggsprincipidentitet som ska tilldelas till brandväggsprincipen.
...
### -IntrusionDetection
Inställningen Intrångsidentifiering
...
### -SkuTier
SKU-nivå för brandväggsprincip
...
### -ThreatIntelMode
Åtgärdsläge för hotinformation.
...
Hemligt ID för (base-64-kodad okrypterad pfx) "Hemligt" eller "Certificate"-objekt lagrat i KeyVault
...
ResourceId för den användare som tilldelats identiteten som ska tilldelas till brandväggsprincipen.
