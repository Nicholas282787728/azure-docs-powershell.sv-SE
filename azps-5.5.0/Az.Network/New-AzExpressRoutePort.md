...
ms.locfileid: "100252360"
---
# New-AzExpressRoutePort

## SYNOPSIS
Skapar ett Azure ExpressRoutePort.
...
### -BandwidthInGbps
Bandbredd för införskaffade portar i Gbit/s
...
### -Encapsulation
Sammanfattningsmetod för fysiska portar.
...
### -Identity
Användar kopplad identitet för läsning av MacSec-konfiguration
...
### -Länk
Uppsättningen fysiska länkar för ExpressRoutePort-resursen
...
### -PeeringLocation
Namnet på peeringplatsen som ExpressRoutePort mappas till fysiskt.
