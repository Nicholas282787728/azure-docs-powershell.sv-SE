...
ms.locfileid: "100227390"
---
# Start-AzVirtualNetworkGatewayConnectionPacketCapture

## SYNOPSIS
Startar paketinspelningsåtgärd på en anslutning till virtuell nätverksgateway.
...
### -FilterData
Filteralternativ för inspelning av startpaket för anslutning till virtuell nätverksgateway.
...
### -Name
Namn på anslutning till virtuell nätverksgateway där paketinspelningen ska startas.
