...
ms.locfileid: "100223614"
---
# Set-AzApplicationGatewayRequestRoutingRule

## SYNOPSIS
Ändrar en regel för begärandedirigering för en programgateway.
...
## BESKRIVNING
**Cmdleten Set-AzApplicationGatewayRequestRoutingRule** ändrar en regel för begärandedirigering.

## EXEMPEL

### Exempel 1: Uppdatera en routningsregel för begäran
```
...
Det första kommandot hämtar programgatewayen med namnet ApplicationGateway01 och lagrar den $AppGw variabeln.
Det andra kommandot ändrar routningsregeln för begäran för programgatewayen till att använda HTTP-inställningarna i serverslut som anges i variabeln $Setting, en HTTP-lyssnare som anges i variabeln $Listener och en adresspool för serverslut som anges i $Pool-variabeln.

## PARAMETERS

### -ApplicationGateway
Anger det programgatewayobjekt som denna cmdlet associerar en begärandedirigeringsregel med.
...
### -BackendAddressPool
Anger adresspoolen för programgatewayens adresspool.
...
Anger adresspool-ID för programgatewayens adresspool.
...
### -BackendHttpSettings
Anger HTTP-inställningarna för programgatewayens backend.
...
Anger HTTP-inställnings-ID för programgatewayens backend.
...
### -HttpListener
Anger PROGRAMMETs gateway-HTTP-lyssnare.
...
### -HttpListenerId
Anger HTTP-lyssnare-ID för programgatewayen.
...
### -Name
Anger namnet på routningsregeln som denna cmdlet ändrar.
...
### -RuleType
Anger typ av routningsregel för begäran.
