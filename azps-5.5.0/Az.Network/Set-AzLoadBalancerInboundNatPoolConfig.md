...
ms.locfileid: "100227447"
---
# Set-AzLoadBalancerInboundNatPoolConfig

## SYNOPSIS
Anger en konfiguration av en inkommande NAT-pool för en belastningsutjämare.
...
## BESKRIVNING
Cmdleten **Set-AzLoadBalancerInboundNatPoolConfig** anger en konfiguration av inkommande NAT-pool för en belastningsutjämare.

## EXEMPEL

### Exempel 1: Uppsättning
```powershell
