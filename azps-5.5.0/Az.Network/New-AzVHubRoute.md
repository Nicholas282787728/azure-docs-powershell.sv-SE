...
ms.locfileid: "100213655"
---
# New-AzVHubRoute

## SYNOPSIS
Skapar ett VHubRoute-objekt som kan skickas som parameter till New-AzVHubRouteTable kommando.
...
Kommandot ovan skapar ett VHubRoute-objekt med nextHop som den angivna brandväggen som sedan kan läggas till en VHubRouteTable-resurs.
...
Kommandot ovan skapar ett VHubRoute-objekt med nextHop som angiven hubVnetConnection som sedan kan läggas till en VHubRouteTable-resurs.
...
```
Med kommandona ovan får du RoutingConfiguration för en redan befintlig AzVHubRoute och lägger sedan till en statisk route i anslutningen. Alternativt, om du vill skapa en ny anslutning med den statiska vägen i den kan du se exempel 1 [här.](New-AzRoutingConfiguration.md)
## PARAMETERS
