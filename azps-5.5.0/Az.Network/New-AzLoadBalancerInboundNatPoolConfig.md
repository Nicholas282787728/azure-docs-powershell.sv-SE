...
ms.locfileid: "100213710"
---
# New-AzLoadBalancerInboundNatPoolConfig

## SYNOPSIS
Skapar en konfiguration av en inkommande NAT-pool för en belastningsutjämare.
...
## BESKRIVNING
**Cmdleten New-AzLoadBalancerInboundNatPoolConfig** skapar en konfiguration av inkommande NAT-pool för en belastningsutjämare.
...
### -EnableFloatingIP
Konfigurerar slutpunkten för en virtuell dator för den flytande IP-funktion som krävs för att konfigurera en tillgänglighetsgrupp i SQL AlwaysOn. Den här inställningen krävs när du använder SQL AlwaysOn-tillgänglighetsgrupper i SQL Server. Den här inställningen kan inte ändras när du har skapat slutpunkten.
...
### -EnableTcpReset
Få dubbelriktad TCP-återställning på inaktiv tidsgräns för TCP-flöde eller oväntade anslutningsavslut. Det här elementet används bara när protokollet är inställt på TCP.
...
Timeout för TCP-inaktivitetsanslutningen. Värdet kan ställas in mellan 4 och 30 minuter. Standardvärdet är 4 minuter. Det här elementet används bara när protokollet är inställt på TCP.
