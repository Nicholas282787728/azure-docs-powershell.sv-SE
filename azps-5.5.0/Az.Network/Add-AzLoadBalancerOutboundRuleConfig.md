...
ms.locfileid: "100228015"
---
# Add-AzLoadBalancerOutboundRuleConfig

## SYNOPSIS
Lägger till en utgående regelkonfiguration i en belastningsutjämare.
...
## BESKRIVNING
Cmdleten **Add-AzLoadBalancerOutboundRuleConfig** lägger till en utgående regelkonfiguration i en Azure-belastningsutjämnare.

## EXEMPEL

### Exempel 1: Lägga till en konfiguration av en utgående regel i en belastningsutjämare
```powershell
...
Det andra kommandot använder pipelineoperatorn för att överföra belastningsutjämningen i $slb till **Add-AzLoadBalancerOutboundRuleConfig,** som lägger till en utgående regelkonfiguration i belastningsutjämaren.
...
### -EnableTcpReset
Få dubbelriktad TCP-återställning på tcp-flödes tidsgräns för inaktivitet eller oväntad anslutningsavslut.
