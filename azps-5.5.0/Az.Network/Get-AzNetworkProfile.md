...
ms.locfileid: "100221198"
---
# Get-AzNetworkProfile

## SYNOPSIS
Hämtar en befintlig nätverksprofils resurs på den översta nivån
...
## BESKRIVNING
Cmdleten **Get-AzNetworkProfile** hämtar en befintlig resurs på den högsta nivån i nätverksprofilen
...
Då hämtas nätverksprofilen periodantal1 i resursgruppen rg1
...
Då hämtas de nätverksprofiler som börjar med "periodantal"
...
### -ResourceId
Azure-resurshanterarens ID för nätverksprofilen.
