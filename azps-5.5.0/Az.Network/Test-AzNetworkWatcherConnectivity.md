...
## BESKRIVNING
Cmdlet Test-AzNetworkWatcherConnectivity returnerar anslutningsinformation för en viss käll-VM och en destination. Om anslutningen mellan källan och målet inte kan upprättas returnerar cmdleten information om problemet.
