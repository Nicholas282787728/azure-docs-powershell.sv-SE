...
### Exempel 1: Skapa en brandväggskonfiguration för ett webbprogram för en programgateway
```
...
Det första kommandot skapar en ny inaktiverad regelgruppskonfiguration för regelgruppen med namnet "BEGÄR-942-APPLICATION-ATTACK-SQLI" med regel 942130 och regel 942140 inaktiverade.
Det andra kommandot skapar ytterligare en inaktiverad regelgruppskonfiguration för en regelgrupp med namnet "BEGÄR-921-PROTOCOL-ATTACK". Inga regler överförs specifikt och därför inaktiveras alla regler i regelgruppen.
Det senaste kommandot skapar sedan en WAF-konfiguration med brandväggsregler inaktiverade enligt $disabledRuleGroup 1 och $disabledRuleGroup 2. Den nya WAF-konfigurationen lagras i den $firewallConfig variabeln.
...
### -Enabled
Anger om WAF-värdet är aktiverat.
...
### -FileUploadLimitInMb
Maxgräns för filuppladdning i MB.
...
### -FirewallMode
Anger brandväggsläget för webbprogrammet.
...
### -MaxRequest DensizeInKb
Maximal storlek på begäran i KB.
...
### -Request Entcheck
Oavsett om brödtexten för begäran är markerad eller inte.
...
### -RuleSetType
Typen av brandväggsregel för webbprogram. De godtagbara värdena för den här parametern är: 
- OWASP
