...
ms.locfileid: "100236759"
---
# New-AzNetworkProfile

## SYNOPSIS
Skapar en ny nätverksprofil.
...
## BESKRIVNING
Cmdleten **New-AzNetworkProfile** skapar en ny nätverksprofil på den högsta nivån.
...
Då skapas en ny nätverksprofils resurs på den översta nivån

### Exempel 2

Skapar en ny nätverksprofil. (autogenererat)
...
### -ContainerNicConfig
Konfigurationerna av behållarnätverksgränssnittet som ska läggas till i den här nätverksprofilen.
