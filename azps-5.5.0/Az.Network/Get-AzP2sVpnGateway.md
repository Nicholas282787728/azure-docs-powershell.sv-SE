...
ms.locfileid: "100227854"
---
# Get-AzP2sVpnGateway

## SYNOPSIS
Hämtar en befintlig P2SVpnGateway i VirtualHub.
...
## BESKRIVNING
Med **cmdleten Get-AzP2sVpnGateway** kan du få en befintlig P2SVpnGateway under VirtualHub.
...
Med **cmdleten Get-AzP2sVpnGateway** kan du få en befintlig P2SVpnGateway under VirtualHub som används för Point to site connectivity.
