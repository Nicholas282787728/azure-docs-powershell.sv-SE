...
ms.locfileid: "100221086"
---
# New-AzRadiusServer

## SYNOPSIS
Skapar en konfiguration med en extern radieserver
...
## BESKRIVNING
Cmdlet New-AzRadiusServer skapar en konfiguration med extern radieserver som ska användas i virtuell nätverksgateway och VPN-serverkonfiguration.
...
Skapa flera konfigurationer av externa radieservrar som ska användas för att konfigurera P2S på en ny virtuell nätverksgateway.
