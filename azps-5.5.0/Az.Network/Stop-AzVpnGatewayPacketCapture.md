...
ms.locfileid: "100213375"
---
# Stop-AzVpnGatewayPacketCapture

## SYNOPSIS
Stoppar paketinspelning på en VPN-gateway.
...
## BESKRIVNING
Stoppar paketinspelningsåtgärden på en VPN-gateway och laddar upp resultatet för en given SasUrl för lagringsbehållare.
...
### -InputObject
Vpn Gateway-objektet där paketinspelning ska startas.
...
### -Name
Vpn Gateway-namnet där paketinspelning ska startas.
...
### -ResourceId
Azure-resurs-ID för VpnGateway där paketinspelningen ska startas.
...
### -SasUrl
SAS URL-paket fångas upp i Vpn Gateway.
