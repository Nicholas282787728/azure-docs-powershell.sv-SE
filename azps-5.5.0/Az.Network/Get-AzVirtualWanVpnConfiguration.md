...
ms.locfileid: "100226007"
---
# Get-AzVirtualWanVpnConfiguration

## SYNOPSIS
Hämtar VPN-konfigurationen för en delmängd av VpnSites som är anslutna till wan-nätverket via VpnConnections. Laddar upp den genererade Vpn-konfigurationen till en lagrings blob som anges av kunden.
...
Konfigurationen laddas sedan ned med den här kommandoleten.

Om kommandoleten lyckas skrivs nedladdningskonfigurationen till bloben som anges av SignSasUrl.
...
### -StorageSasUrl
SAS URL för lagringsplatsen där konfigurationen ska skapas.
...
### -VpnSite
Listan med VpnSite-resurs-ID:n som du kan skapa konfiguration för.
