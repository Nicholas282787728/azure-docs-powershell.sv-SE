...
ms.locfileid: "100218471"
---
# New-AzPrivateDnsZoneGroup

## SYNOPSIS
Skapar en privat DNS-zongrupp i den angivna privata slutpunkten.
...
## BESKRIVNING
Med **cmdleten New-AzPrivateDnsZoneGroup** kan du skapa en ny privat DNS-zongrupp.
...
När privat slutpunkt `test-pr-endpoint` skapas i exemplet ovan DNS-zongrupp under den privata slutpunkten.
...
En samling konfigurationer av privata DNS-zoner för den privata DNS-zongruppen.
