...
ms.locfileid: "100218446"
---
# New-AzPrivateLinkService

## SYNOPSIS
Skapar en privat länktjänst
...
## BESKRIVNING
Cmdleten **New-AzPrivateLinkService** skapar en privat länktjänst

## EXEMPEL

### Exempel 1

I följande exempel skapas en privat länktjänst.
...
### -AutoApproval
Automatiska godkännandeprenumerationer för privat länktjänst
...
### -EnableProxyProtocol
Aktivera proxyprotokoll för den privata länktjänsten.
...
Ip-konfigurationer på frontend
...
### -Visibility
Synlighetsprenumerationer för privat länktjänst
