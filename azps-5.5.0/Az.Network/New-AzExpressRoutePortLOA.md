...
ms.locfileid: "100221143"
---
# New-AzExpressRoutePortLOA

## SYNOPSIS
Hämta fullmakt för en express routeport.
...
## BESKRIVNING
New-AzExpressRoutePortLOA cmdlet laddar ned en fullmakt i PDF-format för en express routeport.
...
Ladda ned fullmakten för Express Route Port 'myPort' och lagra den i filen "loa.pdf".
...
### -Kundnamn
Kundnamnet som Express Route-port tilldelas till.
...
### -Destination
Den utdatafil som autentiseringsbrevet ska lagras på.
...
### -ResourceGroupName
Resursgruppnamnet för express routeporten.
