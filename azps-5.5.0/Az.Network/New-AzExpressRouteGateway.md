...
New-AzExpressRouteGateway skapar en skalbar ExpressRoute Gateway. Det här är programvarudefinierad anslutning lokalt till Azure i VirtualHub. 

Den här gatewayen kan skalas baserat på skalningsenheten som anges i den här Set-AzExpressRouteGateway-cmdleten. 

En anslutning konfigureras från en lokal ExpressRoute-krets till den skalbara gatewayen.

ExpressRouteGateway finns på samma plats som den refererade VirtualHub.
