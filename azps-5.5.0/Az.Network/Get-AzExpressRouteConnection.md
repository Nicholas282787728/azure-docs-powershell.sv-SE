...
ms.locfileid: "100221279"
---
# Get-AzExpressRouteConnection

## SYNOPSIS
Hämtar en ExpressRoute-anslutning efter namn eller visar alla ExpressRoute-anslutningar anslutna till en ExpressRouteGateway.
...
När gatewayen har skapats är den ansluten till den lokala ExpressRoute-kretsen med hjälp New-AzExpressRouteConnection kommando.

Anslutningen får då anslutningsnamnet.
