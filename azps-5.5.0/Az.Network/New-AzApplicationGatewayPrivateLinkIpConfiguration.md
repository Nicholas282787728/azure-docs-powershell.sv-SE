...
ms.locfileid: "100236855"
---
# New-AzApplicationGatewayPrivateLinkIpConfiguration

## SYNOPSIS
Skapar en IP-konfiguration som associeras med PrivateLink-konfiguration
...
## BESKRIVNING
Cmdleten **New-AzApplicationGatewayPrivateLinkIpConfiguration** skapar en Ip-konfiguration som associeras med PrivateLink Configuration för en Azure-programgateway.

## EXEMPEL

### Exempel 1: PrivateLink Ip Configuration
```powershell
PS C:\> $PrivateLinkIpConfiguration = New-AzApplicationGatewayPrivateLinkIpConfiguration -Name "ipConfig01" -Subnet $subnet -Primary
```

Med det här kommandot skapas en PrivateLink IP-konfiguration med namnet "ipConfig01" och resultatet lagras i variabeln $PrivateLinkIpConfiguration. 
...
### -PrivateIpAddress
Ip-adressen för ipConfiguration privat om du vill ha statisk tilldelning.
