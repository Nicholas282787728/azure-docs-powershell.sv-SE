...
Observera att en peeringlänk måste skapas från vnet1 till vnet2 och vice versa för att peering ska fungera.
...
Här är MyVnet1 i West Central i USA peered with 'myVnet2' i Central i Kanada.

## PARAMETERS

### -AllowForwardedTraffic
Anger att denna cmdlet tillåter vidarebefordrad trafik från virtuella datorer i det fjärranslutna virtuella nätverket.
...
Anger att denna cmdlet blockerar de virtuella maskinerna i det länkade virtuella nätverksutrymmet för att komma åt alla virtuella datorer i det lokala virtuella nätverksutrymmet.
...
### -Name
Anger namnet på det virtuella nätverkets peering.
...
### -UseRemoteGateway
Anger att den här cmdleten tillåter fjärrgateway i det här virtuella nätverket.
