...
ms.locfileid: "100227886"
---
# Get-AzNetworkSecurityGroup

## SYNOPSIS
Får en nätverkssäkerhetsgrupp.
...
## BESKRIVNING
Cmdleten **Get-AzNetworkSecurityGroup** får en Azure-nätverkssäkerhetsgrupp.

## EXEMPEL

### Exempel 1: Hämta en befintlig nätverkssäkerhetsgrupp
```powershell
...
Det här kommandot returnerar innehållet i Azure-nätverkssäkerhetsgruppen "nsg1" i resursgruppen "rg1"

### Exempel 2: Lista befintliga nätverkssäkerhetsgrupper med hjälp av filtrering
```powershell
...
Det här kommandot returnerar innehållet i Azure-nätverkssäkerhetsgrupper som börjar med "nsg"
...
### -Name
Anger namnet på den nätverkssäkerhetsgrupp som den här cmdleten hämtar.
...
### -ResourceGroupName
Anger namnet på den resursgrupp som nätverkssäkerhetsgruppen tillhör.
