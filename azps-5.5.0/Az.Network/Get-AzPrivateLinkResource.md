...
ms.locfileid: "100218790"
---
# Get-AzPrivateLinkResource

## SYNOPSIS
Hämtar en privat länkresurs.
...
## BESKRIVNING
Cmdleten **Get-AzPrivateLinkResource** hämtar alla länkresurser tillhör PrivateLinkResource.
...
I det här exemplet visas alla resurser för privata länkar som inte är längre än SQL-servern med namnet mySql.
...
Azure-resurshanterarens ID för den privata länkresursen.
