...
ms.locfileid: "100218287"
---
# Set-AzApplicationGatewayFrontendPort

## SYNOPSIS
Ändrar en frontend-port för en programgateway.
...
## BESKRIVNING
Cmdleten **Set-AzApplicationGatewayFrontendPort** ändrar en frontend-port för en programgateway.

## EXEMPEL

### Exempel 1: Ange 80 för en programgatewayport
```
...
Det andra kommandot ändrar gatewayen i $AppGw använda port 80 för frontend-porten med namnet FrontEndPort01.

## PARAMETERS

### -ApplicationGateway
Anger programmets gatewayobjekt som denna cmdlet associerar frontendporten med.
...
### -Port
Anger det portnummer som ska användas för frontend-porten.
