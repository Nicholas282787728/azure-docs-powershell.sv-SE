...
ms.locfileid: "100237038"
---
# Get-AzApplicationGatewayTrustedRootCertificate

## SYNOPSIS
Hämtar betrodda rotcertifikat med ett visst namn från Application Gateway.
...
## BESKRIVNING
Cmdleten **Get-AzApplicationGatewayTrustedRootCertificate** får ett specifikt namn från Application Gateway.
...
Det första kommandot hämtar Application Gateway och lagrar den i en $gw variabel.
Det andra kommandot får ett betrott rotcertifikat med ett angivet namn från Application Gateway.
