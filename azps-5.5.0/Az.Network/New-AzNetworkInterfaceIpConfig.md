...
## BESKRIVNING
Cmdleten **New-AzNetworkInterfaceIpConfig** skapar en IP-konfiguration för Azure-nätverksgränssnitt för ett nätverksgränssnitt.

## EXEMPEL

### 1: Skapa en IP-konfiguration med en offentlig IP-adress för ett nätverksgränssnitt
```
...
De två första kommandona får ett virtuellt nätverk som kallas myvnet och ett undernät som kallas mitt undernät och som har skapats tidigare. Dessa lagras $vnet $Subnet respektive. Det tredje kommandot får en tidigare skapad offentlig IP-adress med namnet PIP1. Det fjärde kommandot skapar en ny IP-konfiguration som kallas "IPConfig-1" som primär IP-konfiguration med en offentlig IP-adress kopplad till den.
Det senaste kommandot skapar sedan ett nätverksgränssnitt som kallas mynic1 med den här IP-konfigurationen.
...
De två första kommandona får ett virtuellt nätverk som kallas myvnet och ett undernät som kallas mitt undernät och som har skapats tidigare. Dessa lagras $vnet $Subnet respektive. Det tredje kommandot skapar en ny IP-konfiguration som kallas "IPConfig-2" med en privat IP-adress 10.0.0.5 som är kopplad till den.
Det senaste kommandot skapar sedan ett nätverksgränssnitt som kallas mynic1 med den här IP-konfigurationen.
...
Anger en samling av inkommande natregelreferenser för belastningsutjämning som detta nätverksgränssnitt IPConfiguration tillhör.
...
### -SubnetId
Anger en referens till ett undernät där den här IP-konfigurationen för nätverksgränssnittet skapas.
