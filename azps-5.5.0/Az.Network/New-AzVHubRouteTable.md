...
ms.locfileid: "100227647"
---
# New-AzVHubRouteTable

## SYNOPSIS
Skapar en tabellresurs till en hubb-route som är kopplad till en VirtualHub.
...
## BESKRIVNING
Skapar den angivna routetabellen som är associerad med det angivna virtuella navet med de angivna rutterna och etiketterna.
...
Det här kommandot skapar en hubb-routetabell för det virtuella navet.
...
### -ParentResourceId
Resurs-ID för den virtuella navresursen.
