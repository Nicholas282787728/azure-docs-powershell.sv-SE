...
ms.locfileid: "100227606"
---
# New-AzVpnGatewayNatRule

## SYNOPSIS
Skapar en NAT-regel på en VpnGateway som kan associeras med VpnSiteLinkConnection.
...
## BESKRIVNING
Skapar en NAT-regel på en VpnGateway som kan associeras med VpnGateway.
...
Ovanstående skapar en resursgrupp, virtuellt WAN, virtuellt nätverk och virtuellt nav. Sedan skapar vi VpnGateway under det virtuella hubben. Med det här kommandot: New-AzVpnGatewayNatRule kan NAT-regeln skapas och associeras med skapad VpnGateway.
...
### -ParentObject
Överordnad VpnGateway för den här NAT-regeln.
...
### -ParentResourceId
Resurs-ID för den överordnade VpnGateway för den här NAT-regeln.
