...
ms.locfileid: "100227775"
---
# Get-AzVirtualNetworkGatewayLearnedRoute

## SYNOPSIS
Listor med routes som lärts av en virtuell Azure-nätverksgateway
...
## BESKRIVNING
Räknar upp routes som lärts av en Virtuell Azure-nätverksgateway från olika källor. Det omfattar vägar som lärts via BGP samt statiska vägar. 
...
För Azure-virtuell nätverksgateway med namnet gatewaynamn i resursgruppresursgrupp hämtar du routes som Azure-gatewayen känner till. Azure-virtuell nätverksgateway har i det här fallet två statiska vägar (10.1.0.0/16 och 10.0.0.254/32), samt en rutt som lärts via BGP (10.0.0.0/16).
