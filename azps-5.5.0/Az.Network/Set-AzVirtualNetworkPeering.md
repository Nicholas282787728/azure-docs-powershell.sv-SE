...
ms.locfileid: "100225662"
---
# Set-AzVirtualNetworkPeering

## SYNOPSIS
Konfigurerar en virtuell nätverks-peering.
...
### Exempel 1: Ändra konfigurationen av vidarebefordrad trafik för en virtuell nätverks-peering
```
...
### Exempel 2: Ändra åtkomsten till virtuellt nätverk för en virtuell nätverks-peering
```
...
### Exempel 3: Ändra konfiguration av egenskapen överföring av gateway för en virtuell nätverks-peering
```
# Get the virtual network peering
$myVnet1TomyVnet2 = Get-AzVirtualNetworkPeering -VirtualNetworkName "myVnet1" -ResourceGroupName "myResourceGroup" -Name "myVnet1TomyVnet2"
...
### Exempel 4: Använda fjärrgateway i virtuellt nätverks-peering
```
# Get the virtual network peering 
...
Genom att ändra den här egenskapen $True kan peer-datorns VNet-gateway användas.
Peer VNet måste emellertid ha en gateway konfigurerad och **AllowGatewayTransit** måste ha värdet $True.
Den här egenskapen kan inte användas om en gateway redan har konfigurerats.
...
Anger peering för virtuellt nätverk.
