...
## BESKRIVNING
Cmdleten **Get-AzApplicationGatewayCustomError** får anpassade fel från en programgateway.
...
Det här kommandot hämtar och returnerar det anpassade felet för http-statuskod 502 från programmets gateway $appgw.
...
Det här kommandot hämtar och returnerar listan över alla anpassade fel från programmets gateway $appgw.
