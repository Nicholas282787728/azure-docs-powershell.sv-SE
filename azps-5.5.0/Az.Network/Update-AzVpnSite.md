...
Ovanstående skapar en resursgrupp, Virtual WAN i väst USA i resursgruppen "testRG" i Azure. 

Sedan skapas en VpnSite som representerar en kundgren och länkar den till det virtuella WAN:t.

När webbplatsen har skapats uppdaterar den webbplatsens IpAddress med hjälp av kommandot Set-AzVpnSite webbplats.

## PARAMETERS

### -AddressSpace
Adressprefix för det virtuella nätverket.
Använd detta eller AddressSpaceObject men inte båda.
...
### -InputObject
Vpn-webbplatsobjektet som ska ändras
...
### -O365Policy
Trafikbrytprincipen för Office 365 för den här VpnSite.
...
### -ResourceId
Azure-resurs-ID för vpn-webbplatsen.
