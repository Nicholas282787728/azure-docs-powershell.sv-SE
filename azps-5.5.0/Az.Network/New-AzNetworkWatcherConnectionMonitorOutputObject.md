...
ms.locfileid: "100218502"
---
# New-AzNetworkWatcherConnectionMonitorOutputObject

## SYNOPSIS
Skapa ett målobjekt för utdata från anslutningsövervakningen.
...
## BESKRIVNING
Med New-AzNetworkWatcherConnectionMonitorOutputObject-cmdleten skapas målobjektet anslutningsövervakningsresultat.
...
### -OutputType
Måltypen för utdata från anslutningsövervakningen. För närvarande stöds \" \" endast arbetsytan.
...
### -WorkspaceResourceId
Resurs-ID för logganalysarbetsyta.
