...
ms.locfileid: "100252460"
---
# Get-AzAvailableServiceDelegation

## SYNOPSIS
Skaffa tillgänglig tjänst i regionen.
...
## BESKRIVNING
Med **cmdleten Get-AzAvailableServiceDelegation** kan du hämta alla tillgängliga tjänsthämtningar för ett undernät på den angivna platsen. Den här cmdleten *beskriver* inte vilken av dem som kan finnas tillsammans på ett enda undernät.

## EXEMPEL

### 1: Få alla tillgängliga tjänster
```powershell
