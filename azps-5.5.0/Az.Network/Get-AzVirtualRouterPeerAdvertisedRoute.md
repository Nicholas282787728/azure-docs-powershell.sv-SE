...
ms.locfileid: "100218662"
---
# Get-AzVirtualRouterPeerAdvertisedRoute

## SYNOPSIS
Listrutter som annonseras av en specifik virtuell router-peer
...
## BESKRIVNING
Om du har en virtuell router som peer antingen efter namn eller efter objekt, räknar du upp routes som annonseras till den peer-routern av en specifik virtuell router.
...
### -InputObject
Peer-indataobjektet för den virtuella routern.
...
### -ResourceGroupName
Namn på peer-resursgrupp för virtuell router
