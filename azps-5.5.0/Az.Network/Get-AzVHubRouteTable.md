...
ms.locfileid: "100236982"
---
# Get-AzVHubRouteTable

## SYNOPSIS
Hämtar en tabellresurs till en hubb- route som är kopplad till en VirtualHub.
...
## BESKRIVNING
Hämtar den angivna hubb-routetabellen som är associerad med den angivna virtuella hubben.
...
Det här kommandot hämtar navets routetabell i det virtuella navet.
...
Det här kommandot visar alla hubb-routetabeller i den angivna VirtualHub.
...
### -ResourceId
Resurs-ID för den vhubroutetable resurs som ska hämtas.
