...
ms.locfileid: "100252504"
---
# Add-AzApplicationGatewayRewriteRuleSet

## SYNOPSIS
Lägger till en omskrivningsregeluppsättning i en programgateway.
...
## BESKRIVNING
Cmdleten **Add-AzApplicationGatewayRewriteRuleSet** lägger till en omskrivningsregeluppsättning i en programgateway.
...
Det andra kommandot lägger till regeln för omskrivning i programmets gateway.
