...
ms.locfileid: "100227638"
---
# New-AzVirtualApplianceSite

## SYNOPSIS
Skapa en webbplats som är ansluten till en virtuell nätverksinstallation.
...
## BESKRIVNING
Med New-AzVirtualApplianceSite skapar du en webbplats för virtuell utrustning som är ansluten till en nätverksresurs för virtuell utrustning.
...
Skapa en ny webbplats för virtuella utrustning i resursgruppen: testrg.

## PARAMETERS

### -AddressPrefix
Adressens prefix för webbplatsen.
...
### -O365Policy
Utbrytningsprincipen för Office 365.
