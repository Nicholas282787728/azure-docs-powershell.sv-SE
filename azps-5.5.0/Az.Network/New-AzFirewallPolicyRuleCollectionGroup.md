...
ms.locfileid: "100218526"
---
# New-AzFirewallPolicyRuleCollectionGroup

## SYNOPSIS
Skapa en ny regelsamlingsgrupp för Azure-brandväggsprincipen
...
## BESKRIVNING
**Cmdleten New-AzFirewallPolicyRuleCollectionGroup** skapar en regelsamlingsgrupp i en Azure-brandväggsprincip.
...
Det här exemplet skapar en regelsamlingsgrupp i brandväggsprincipen för $fp

### Exempel 2

Skapa en ny regelsamlingsgrupp för Azure-brandväggens brandväggsprincip. (autogenererat)
