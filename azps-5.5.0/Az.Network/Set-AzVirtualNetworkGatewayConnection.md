...
ms.locfileid: "100225679"
---
# Set-AzVirtualNetworkGatewayConnection

## SYNOPSIS
Konfigurerar en anslutning till virtuell nätverksgateway.
...
## BESKRIVNING
Cmdleten **Set-AzVirtualNetworkGatewayConnection** konfigurerar en virtuell nätverksanslutning.
...
### Exempel 2: Lägga till/uppdatera taggar i en befintlig VirtualNetworkGatewayConnection
```
$conn = Get-AzVirtualNetworkGatewayConnection -Name 1 -ResourceGroupName myRG
...
### -EnableBgp
Om du ska använda en BGP-session över en S2S VPN-tunnel
...
### -DpdTimeoutInSeconds
Timeout för identifiering av antalet peer-identifieringar för en dataidentifiering på bara några sekunder
...
En lista över trafikväljarprinciper.
...
Om privatIP ska användas för en S2S-anslutning
...
Om principbaserade trafikväljare ska användas för en S2S-anslutning
...
Anger psVirtualNetworkGatewayConnection-objektet som denna cmdlet använder för att ändra den virtuella nätverksanslutningen.
