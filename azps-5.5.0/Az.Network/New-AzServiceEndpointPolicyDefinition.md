...
ms.locfileid: "100213679"
---
# New-AzServiceEndpointPolicyDefinition

## SYNOPSIS
Skapar en principdefinition för tjänstslutpunktsprincip.
...
## BESKRIVNING
Cmdleten **New-AzServiceEndpointPolicyDefinition** skapar en principdefinition för tjänstslutpunkt.
...
Med det här kommandot skapas tjänstslutpunktsprincipdefinitionen med namnet ServiceEndpointPolicyDefinition1, tjänst Microsoft.Storage, tjänstresursprenumerationer/under1 och beskrivningen "Ny definition" som tillhör resursgruppen ResourceGroup01 och lagrar den i variabeln $policydef.

### Exempel 2

Skapar en principdefinition för tjänstslutpunktsprincip. (autogenererat)
