...
ms.locfileid: "100227615"
---
# New-AzVirtualHubRouteTable

## SYNOPSIS
Skapar ett Azure Virtual Hub Route-tabellobjekt.
...
Ovanstående skapar en routetabell som består av flera vägar och är kopplad till ett nytt virtuellt nav.

Det här är ett minnesobjekt som kan användas för att lägga till en Route-tabell i en ny eller befintlig VirtualHub.
