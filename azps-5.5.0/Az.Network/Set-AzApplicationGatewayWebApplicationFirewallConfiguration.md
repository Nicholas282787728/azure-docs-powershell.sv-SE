...
ms.locfileid: "100220950"
---
# Set-AzApplicationGatewayWebApplicationFirewallConfiguration

## SYNOPSIS
Ändrar WAF-konfigurationen av en programgateway.
...
## BESKRIVNING
Cmdleten **Set-AzApplicationGatewayWebApplicationFirewallConfiguration** ändrar konfigurationen av en programgateway i webbprogrambrandväggen (WAF).

## EXEMPEL

### Exempel 1: Uppdatera konfigurationen av programmets brandvägg för programmets gatewaywebbprogram
```
PS C:\> $AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
PS C:\> Set-AzApplicationGatewayWebApplicationFirewallConfiguration -ApplicationGateway $AppGw -Enabled $True -FirewallMode "Detection" -RuleSetType "OWASP" -RuleSetVersion "3.0"
```

Det första kommandot hämtar programgatewayen med namnet ApplicationGateway01 och lagrar den sedan $AppGw variabeln.
Det andra kommandot aktiverar brandväggskonfigurationen för programgatewayen som lagras i $AppGw och anger brandväggsläget till "Identifiering", RuleSetType till "OWASP" och RuleSetVersion till "3.0".
