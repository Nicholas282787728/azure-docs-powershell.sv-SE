...
ms.locfileid: "100213927"
---
# Get-AzVirtualNetwork

## SYNOPSIS
Hämtar ett virtuellt nätverk i en resursgrupp.
...
## BESKRIVNING
Cmdleten **Get-AzVirtualNetwork** får ett eller flera virtuella nätverk och en resursgrupp.
...
Det här kommandot hämtar det virtuella nätverket MyVirtualNetwork i resursgruppen TestResourceGroup

### 2: Lista virtuella nätverk med hjälp av filter
```
...
Det här kommandot hämtar alla virtuella nätverk som börjar med "MyVirtualNetwork".
...
### -Name
Anger namnet på det virtuella nätverket som den här cmdleten hämtar.
...
### -ResourceGroupName
Anger namnet på den resursgrupp som det virtuella nätverket tillhör.
