...
ms.locfileid: "100225927"
---
# New-AzFirewallPolicyNatRule

## SYNOPSIS
Skapa en ny NAT-regel för Azure-brandväggen
...
## BESKRIVNING
Cmdleten **New-AzFirewallPolicyNatRule** skapar en NAT-regel för en Azure-brandväggsprincip.
...
Det här exemplet skapar en NAT-regel med källadress, protokoll, måladress, målport, översatt adress och översatt port.
...
Det här exemplet skapar en NAT-regel med källadress, protokoll, måladress, målport, översatt fqdn och översatt port.
...
### -DestinationAddress
Regelns måladresser. Detta måste vara en offentlig IP för brandväggen.
...
### -TranslatedAddress
Den översatta adressen för den här NAT-regeln
...
### -TranslatedPort
Den översatta porten för den här NAT-regeln
