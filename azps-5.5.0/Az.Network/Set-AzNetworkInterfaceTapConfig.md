...
ms.locfileid: "100223519"
---
# Set-AzNetworkInterfaceTapConfig

## SYNOPSIS
Uppdaterar en tryckningskonfiguration för ett nätverksgränssnitt.
...
## BESKRIVNING
**Set-AzNetworkInterfaceTapConfig uppdaterar en** tryckningskonfiguration för ett nätverksgränssnitt.
...
Konfigurationen NetworkInterface Tap
