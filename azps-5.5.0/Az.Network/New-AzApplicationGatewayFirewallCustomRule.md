...
ms.locfileid: "100213862"
---
# New-AzApplicationGatewayFirewallCustomRule

## SYNOPSIS
Skapar en ny anpassad regel för brandväggsprincipen för programgateway.
...
Kommandot skapar en ny anpassad regel med namn på exempelregel, prioritet 1 och regeltypen matchas med villkor som definierats i villkorsvariabeln. Åtgärden tillåts. Den nya anpassade regeln sparas i en $customRule.
...
Regler med ett lägre värde utvärderas före regler med ett högre värde.
