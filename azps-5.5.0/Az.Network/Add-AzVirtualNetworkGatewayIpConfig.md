...
### -Name
Anger namnet på den gateway-IP-konfiguration som ska läggas till.
...
Den här cmdleten ändrar **det PSVirtualNetworkGateway-objekt** som du anger.
Du kan använda cmdleten Get-AzVirtualNetworkGateway för att hämta ett **PSVirtualNetworkGateway-objekt.**
