...
ms.locfileid: "100252200"
---
# Stop-AzVpnConnectionPacketCapture

## SYNOPSIS
Stoppar paketinspelningsåtgärd på en VPN-anslutning
...
## BESKRIVNING
Stoppar paketinspelningsåtgärden på en VPN-anslutning och laddar upp resultatet för en given SasUrl för lagringsbehållare.
...
### -SasUrl
SAS URL för stopppaketsinspelning på Vpn.
