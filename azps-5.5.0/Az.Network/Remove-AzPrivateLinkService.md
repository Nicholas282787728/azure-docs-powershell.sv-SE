...
ms.locfileid: "100252264"
---
# Remove-AzPrivateLinkService

## SYNOPSIS
Tar bort en privat länktjänst
...
## BESKRIVNING
Cmdleten **Remove-AzPrivateLinkService** tar bort en privat länktjänst
...
I det här exemplet tas en privat länktjänst med namnet TestPrivateLinkService bort.
...
### -ResourceGroupName
Resursgruppnamnet för den privata länktjänsten.
