...
ms.locfileid: "100218807"
---
# Get-AzExpressRouteCircuitPeeringConfig

## SYNOPSIS
Hämtar en ExpressRoute-krets-peeringkonfiguration.
...
## BESKRIVNING
Cmdleten **Get-AzExpressRouteCircuitPeeringConfig** hämtar konfigurationen av en peeringrelation för en ExpressRoute-krets.
