...
ms.locfileid: "100213871"
---
# Get-AzVirtualNetworkGatewayConnectionIkeSa

## SYNOPSIS
Få IKE-säkerhetsassociationer för en anslutning till virtuell nätverksgateway
...
## BESKRIVNING
Cmdleten **Get-AzVirtualNetworkGatewayConnectionTrappSa** returnerar IKE-säkerhetsassociationerna för anslutningen baserat på anslutningsnamnet och resursgruppens namn.
Om **cmdleten Get-AzVirtualNetworkGatewayConnection** utfärdas utan att ange parametern -Name visas inte IKE-säkerhetsassociationerna för utdata.
...
Returnerar IKE-säkerhetsassociationer för anslutning till virtuell nätverksgateway med namnet "myPool" i resursgruppen "myRG"
...
### -InputObject
Det virtuella nätverksgatewayanslutningsobjekt som IKE SAs måste hämtas för.
...
### -Name
Namnet på den virtuella nätverksgatewayanslutningen som IKE SAs måste hämtas för.
...
### -ResourceId
Azure-resurs-ID för anslutningen till virtuell nätverksgateway som IKE-SAs måste hämtas för.
...
### Microsoft.Azure.Commands.Network.Models.PSVirtualNetworkGatewayConnection Engström
