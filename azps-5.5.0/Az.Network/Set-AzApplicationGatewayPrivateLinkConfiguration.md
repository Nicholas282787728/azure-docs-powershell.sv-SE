...
## BESKRIVNING
Cmdleten **Set-AzApplicationGatewayPrivateLinkConfiguration** ändrar en privateLink-konfiguration för en Azure-programgateway.
...
Det andra kommandot anger privateLink-konfigurationen med namnet privateLinkConfig01 så att ip-konfigurationen som lagras i $privateLinkIpConfiguration 01 används
