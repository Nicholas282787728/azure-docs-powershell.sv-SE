...
ms.locfileid: "100225990"
---
# Get-AzVpnClientConfiguration

## SYNOPSIS
Gör att användare enkelt kan ladda ned vpn-profilpaketet som skapades med hjälp New-AzVpnClientConfiguration-kommandoleten.
...
## BESKRIVNING
Länken Get-AzVpnClientConfiguration URL som VPN-klienten kan hämtas från.
...
Hämtar URL:en för att ladda ned en VpnClient-profil som har skapats tidigare med hjälp New-AzVpnClientConfiguration kommando.
