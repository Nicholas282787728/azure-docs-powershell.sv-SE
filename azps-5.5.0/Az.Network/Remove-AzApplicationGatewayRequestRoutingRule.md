...
ms.locfileid: "100213615"
---
# Remove-AzApplicationGatewayRequestRoutingRule

## SYNOPSIS
Tar bort en regel för begärandedirigering från en programgateway.
...
## BESKRIVNING
**Cmdleten Remove-AzApplicationGatewayRequestRoutingRule** tar bort en regel för begärandedirigering från en Azure-programgateway.

## EXEMPEL

### Exempel 1: Ta bort en regel för begärandedirigering från en programgateway
```
...
Det andra kommandot tar bort routningsregeln med namnet Rule02 från programmets gateway som lagras $AppGw.

## PARAMETERS

### -ApplicationGateway
Anger den programgateway som en routningsregel ska tas bort från.
...
### -Name
Anger namnet på routningsregeln som cmdleten tar bort.
