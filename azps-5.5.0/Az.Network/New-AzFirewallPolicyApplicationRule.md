...
ms.locfileid: "100218567"
---
# New-AzFirewallPolicyApplicationRule

## SYNOPSIS
Skapa en ny Azure-brandväggsprincipprogramregel
...
## BESKRIVNING
Cmdleten **New-AzFirewallPolicyApplicationRule** skapar en programregel för en Azure-brandväggsprincip.
...
Det här exemplet skapar en programregel med källadressen, protokollet och mål-fqdn.
...
I det här exemplet skapas en programregel med källadress, protokoll och webbkategorier.
