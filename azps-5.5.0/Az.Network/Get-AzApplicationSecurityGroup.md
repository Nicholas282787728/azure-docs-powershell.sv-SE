...
ms.locfileid: "100227982"
---
# Get-AzApplicationSecurityGroup

## SYNOPSIS
Hämtar en programsäkerhetsgrupp.
...
## BESKRIVNING
Cmdleten **Get-AzApplicationSecurityGroup** får en programsäkerhetsgrupp.

## EXEMPEL

### Exempel 1: Hämta alla programsäkerhetsgrupper.
```
...
Kommandot ovan returnerar alla programsäkerhetsgrupper i prenumerationen.

### Exempel 2: Hämta programsäkerhetsgrupper i en resursgrupp.
```
...
Kommandot ovan returnerar alla programsäkerhetsgrupper som tillhör resursgruppen MyResourceGroup.

### Exempel 3: Hämta en specifik programsäkerhetsgrupp.
```
...
Kommandot ovan returnerar programsäkerhetsgruppen MyApplicationSecurityGroup under resursgruppen MyResourceGroup.

### Exempel 4: Hämta programsäkerhetsgrupper med hjälp av filtrering.
```
...
Kommandot ovan returnerar alla programsäkerhetsgrupper som börjar med "MyApplicationSecurityGroup".
