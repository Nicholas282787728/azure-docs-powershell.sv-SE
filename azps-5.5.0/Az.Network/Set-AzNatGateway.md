...
ms.locfileid: "100236495"
---
# Set-AzNatGateway

## SYNOPSIS
Uppdatera Nat Gateway-resurs med offentlig IP-adress, offentliga IP-prefix och IdleTimeoutInMinutes.
...
### -Name
Namnet på Nat Gateway-resursen.
...
### -ResourceId
Anger ID för natgatewayresursen.
