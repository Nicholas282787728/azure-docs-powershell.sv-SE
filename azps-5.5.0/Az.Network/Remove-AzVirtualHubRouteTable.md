...
ms.locfileid: "100252252"
---
# Remove-AzVirtualHubRouteTable

## SYNOPSIS
Ta bort en virtuell hubb- routetabellresurs som är kopplad till ett virtuellt nav.
...
## BESKRIVNING
Tar bort den angivna routetabellen som är associerad med det angivna virtuella navet.
...
Det här kommandot tar bort RouteTable1 för det virtuella navet westushub.
...
### -InputObject
Den virtualhubroutetable-resurs som ska tas bort.
