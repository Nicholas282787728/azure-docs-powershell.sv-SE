...
ms.locfileid: "100218862"
---
# Add-AzApplicationGatewayRequestRoutingRule

## SYNOPSIS
Lägger till en regel för begärandedirigering i en programgateway.
...
## BESKRIVNING
**Cmdleten Add-AzApplicationGatewayRequestRoutingRule** lägger till en regel för begärandedirigering i en programgateway.

## EXEMPEL

### Exempel 1: Lägga till en regel för begärandedirigering i en programgateway
```
...
Det andra kommandot lägger till routningsregeln för begäran i programmets gateway.

## PARAMETERS

### -ApplicationGateway
Anger en programgateway där denna cmdlet lägger till en regel för begärandedirigering.
...
### -BackendAddressPool
Anger ett backend-adresspoolobjekt för programgateway.
...
Anger ett adresspool-ID för programgateway i backend.
...
### -BackendHttpSettings
Anger ett HTTP-inställningsobjekt i backend för en programgateway.
...
Anger ett HTTP-inställnings-ID för en programgateway.
...
### -HttpListener
Anger HTTP-lyssnarobjekt för programgateway.
...
### -HttpListenerId
Anger HTTP-lyssnare-ID för programgateway.
...
### -Name
Anger namnet på routningsregeln som denna cmdlet lägger till.
...
### -UrlPathMapId
Anger URL-sökvägens mappnings-ID för routningsregeln.
