...
ms.locfileid: "100236750"
---
# New-AzNetworkVirtualAppliance

## SYNOPSIS
Skapa en virtuell nätverksresurs för utrustning.
...
## BESKRIVNING
Med New-AzNetworkVirtualAppliance skapas en virtuell nätverkspoolresurs i Azure.
...
Skapar en ny virtuell nätverksresurs för utrustning i resursgrupp: testrg.
...
Blob URL för Bootstrap-konfiguration.
...
Cloudinit-konfigurationen som oformaterad text.
...
Blob-lagrings-URL:en för Cloudinit-konfiguration.
...
### -Plats
Den offentliga IP-adressens plats.
...
### -SKU
SKU:n för den virtuella utrustningen.
...
### -VirtualApplianceAsn
ASN-numret för den virtuella utrustningen.
...
### -VirtualHubId
Resurs-ID för det virtuella hubben.
