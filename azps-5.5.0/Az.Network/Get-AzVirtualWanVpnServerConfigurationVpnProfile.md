...
ms.locfileid: "100225999"
---
# Get-AzVirtualWanVpnServerConfigurationVpnProfile

## SYNOPSIS
Genererar och laddar ned Vpn-profilen VirtualWan-VpnServerConfiguration för klientkonfigurationen av Pekar på plats.
...
## BESKRIVNING
Med cmdleten **Get-AzVirtualWanVpnServerConfigurationVpnProfile** kan du skapa och ladda ned Vpn-profilen på VirtualWan-VpnServerConfiguration-nivå för klientkonfigurationen av Punkt till webbplats. Detta krävs för point to site connectivity from Point to site client to Azure P2SVpnGateway.
...
Kommandot ovan genererar och returnerar SAS URL för kund för att ladda ned Vpn-profilen på VirtualWan-VpnServerConfiguration-nivå för klientkonfiguration för Punkt till webbplats.
...
### -ResourceId
Azure-resurs-ID för det virtuella wanet.
...
ID för VPN-serverkonfiguraiton-objektet som detta virtuella wan kommer att associeras med.
