...
ms.locfileid: "100223710"
---
# New-AzRouteFilterRuleConfig

## SYNOPSIS
Skapar en routefilterregel för ett routefilter.
...
## BESKRIVNING
Med New-AzRouteFilterRuleConfig-cmdleten skapas en routefilterregel för ett Azure-routefilter.
...
Kommandot skapar en ny routefilterregel och lagrar den i variabel $rule 1.

## PARAMETERS

### -Access
Access för routefilterregel.
Giltiga värden är Tillåt eller Neka.
...
### -Name
Anger ett namn på routefilterregeln.
