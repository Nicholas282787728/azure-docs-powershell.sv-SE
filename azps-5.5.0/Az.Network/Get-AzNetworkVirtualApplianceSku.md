...
ms.locfileid: "100227878"
---
# Get-AzNetworkVirtualApplianceSku

## SYNOPSIS
Hämta eller lista tillgängliga virtuella nätverksverktygs-SKU:er i inventeringen.
...
## BESKRIVNING
Den Get-AzNetworkVirtualApplianceSku hämtar eller visar tillgängliga SKU:er för nätverks virtuell utrustning i Microsoft Azure-inventeringen.
...
Lista alla tillgängliga SKU:er för virtuell nätverksinstallation.
