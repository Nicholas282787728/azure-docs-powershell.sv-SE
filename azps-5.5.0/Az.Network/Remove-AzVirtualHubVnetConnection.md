...
ms.locfileid: "100227503"
---
# Remove-AzVirtualHubVnetConnection

## SYNOPSIS
Med Remove-AzVirtualHubVnetConnection-cmdleten tas en Virtuell Azure-nätverksanslutning bort som peers ett fjärr-VNET till nav-VNET.
...
När den virtuella navanslutningen har skapats tas den virtuella nätverksanslutningen bort med resursgruppnamnet, navnamnet och anslutningsnamnet.
...
När den virtuella nätverksanslutningen till hubben har skapats tas den virtuella navanslutningen bort med powershell-rör på utdata från Get-AzHubVirtualNetworkConnection.
...
### -InputObject
Den hubvirtualnetworkconnection-resurs som ska ändras.
...
### -ResourceId
Resurs-ID för den hubvirtualnetworkconnection-resurs som ska ändras.
