...
ms.locfileid: "100218798"
---
# Get-AzPrivateEndpointConnection

## SYNOPSIS
Hämtar en privat anslutningsresurs för slutpunkten.
...
## BESKRIVNING
**Cmdleten Get-AzPrivateEndpointConnection** hämtar en privat slutpunktsanslutningsresurs.
...
Det här exemplet returnerar en lista över alla privata slutpunktsanslutningar som tillhör SQL Server med namnet Mysql.
...
Det här exemplet får en privat slutpunktsanslutning med namnet MyPrivateEndpointConnection1 tillhör den privata länktjänsten MyPrivateLinkService
...
Azure-resurshanterarens ID för den privata länkresursen som den privata slutpunktsanslutningen tillhör.
...
### -ResourceGroupName
Resursgruppnamnet för den privata slutpunktsanslutningen.
...
### -ServiceName
Namnet på tjänsten som den privata slutpunktsanslutningen tillhör.
