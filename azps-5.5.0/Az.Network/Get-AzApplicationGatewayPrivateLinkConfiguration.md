...
ms.locfileid: "100237062"
---
# Get-AzApplicationGatewayPrivateLinkConfiguration

## SYNOPSIS
Hämtar den privata länkkonfigurationen av en programgateway.
...
## BESKRIVNING
Cmdleten **Get-AzApplicationGatewayPrivateLinkConfiguration** får den privata länkkonfigurationen av en programgateway.

## EXEMPEL

### Exempel 1: Hämta en angiven konfiguration av en privat länk
```powershell
...
Det första kommandot hämtar en programgateway med namnet ApplicationGateway01 från resursgruppen ResourceGroup01 och lagrar den i $AppGw variabeln.
Det andra kommandot hämtar den privata länkkonfigurationen med namnet privateLinkConfig01 $AppGw sparar den i $PrivateLinkConfiguration variabeln.

### Exempel 2: Hämta en lista över konfiguration av privata länkar
```powershell
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
...
Det första kommandot hämtar en programgateway med namnet ApplicationGateway01 från resursgruppen ResourceGroup01 och lagrar den i $AppGw variabeln.
Det andra kommandot hämtar alla privata länkkonfigurationer från $AppGw och lagrar den i den $PrivateLinkConfigurations variabeln.
...
### -Name
Namnet på konfigurationen av programgatewayen privateLink
