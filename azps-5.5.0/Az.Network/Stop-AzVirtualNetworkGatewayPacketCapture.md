...
ms.locfileid: "100252204"
---
# Stop-AzVirtualNetworkGatewayPacketCapture

## SYNOPSIS
Stoppar inspelning av paket på en virtuell nätverksgateway.
...
## BESKRIVNING
Stoppar paketinspelningsåtgärden i en virtuell nätverksgateway och laddar upp resultatet för en given SasUrl för lagringsbehållare.
...
### -InputObject
Detta är det virtuella nätverksgatewayobjekt där paketinspelningen ska startas.
...
### -Name
Namnet på den virtuella nätverksgatewayen där paketinspelningen ska startas.
...
### -ResourceId
Azure-resurs-ID för VirtualNetworkGateway där paketinspelning ska startas.
...
### -SasUrl
SAS URL-paket fångas på virtuell nätverksgateway.
