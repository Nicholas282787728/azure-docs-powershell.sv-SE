...
ms.locfileid: "100213454"
---
# Set-AzApplicationGatewayHttpListenerCustomError

## SYNOPSIS
Uppdaterar ett anpassat fel i en http-lyssnare för en programgateway.
...
## BESKRIVNING
**Cmdleten Set-AzApplicationGatewayCustomError** uppdaterar ett anpassat fel i en http-lyssnare av en programgateway.
...
Det här kommandot uppdaterar det anpassade felet för http-statuskod 502 i http-lyssnaren i $listener 01 och returnerar den uppdaterade lyssnaren.
