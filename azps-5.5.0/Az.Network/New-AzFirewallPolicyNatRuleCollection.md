...
ms.locfileid: "100252337"
---
# New-AzFirewallPolicyNatRuleCollection

## SYNOPSIS
Skapa en ny Nat-regelsamling för Azure-brandväggsprincipen
...
## BESKRIVNING
Cmdleten **New-AzFirewallPolicyNatRuleCollection** skapar en Nat-regelsamling för en Azure-brandväggsprincip.
...
Det här exemplet skapar en nat-regelsamling med en nätverksregel

## PARAMETERS

### -ActionType
Typen av regelåtgärd
...
### -Name
Namnet på nätverksregelsamlingen
...
### -Priority
Prioriteten för regelsamlingen
