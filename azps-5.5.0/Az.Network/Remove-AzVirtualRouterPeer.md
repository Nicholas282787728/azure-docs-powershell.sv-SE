...
### -PeerName
Namnet på den virtuella routern Peer.
...
### -ResourceGroupName
Resursgruppnamnet för den virtuella routern/peer-datorn.
...
### -ResourceId
Peer-resurs-ID för virtuell router.
...
### -VirtualRouterName
Den virtuella routern där peer finns.
