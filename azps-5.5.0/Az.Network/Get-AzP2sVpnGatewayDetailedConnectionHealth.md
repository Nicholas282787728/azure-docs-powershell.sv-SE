...
ms.locfileid: "100227839"
---
# Get-AzP2sVpnGatewayDetailedConnectionHealth

## SYNOPSIS
Hämtar detaljerad information om aktuell punkt till webbplatsanslutningar från P2SVpnGateway.
...
## BESKRIVNING
Med cmdleten **Get-AzP2sVpnGatewayDetailedConnectionHealth** kan du hämta detaljerad information om aktuell punkt till webbplatsanslutningar från P2SVpnGateway. Kunden måste överföra SAS url där vi kan ange den här detaljerade hälsoinformationen.
...
Med cmdleten **Get-AzP2sVpnGatewayDetailedConnectionHealth** kan du hämta detaljerad information om aktuell punkt till webbplatsanslutningar från P2SVpnGateway. Kunden kan ladda ned hälsoinformation från skickade SAS URL-nedladdning. Då visas information om varje punkt på webbplatsens anslutning med användarnamn, byte in, byte ut, allokerad ip-adress osv.
...
### -OutputBlobSasUrl
OutputBlob Sas URL som hälsa för p2s vpn-anslutning kommer att skrivas till.
...
### -ResourceId
Azure-resurs-ID:t för P2SVpnGateway-portalen som ska ändras.
...
### -VpnUserNamesFilter
Listan med P2S vpn-användarnamn som ska filtreras.
