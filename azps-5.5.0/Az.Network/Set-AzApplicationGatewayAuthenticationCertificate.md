...
## BESKRIVNING
Cmdleten **Set-AzApplicationGatewayAuthenticationCertificate** uppdaterar ett autentiseringscertifikat för en Azure-programgateway.
...
Det andra kommandot uppdaterar autentiseringscertifikatet med namnet cert01 i programmets gateway.
Det tredje kommandot uppdaterar programmets gateway.

## PARAMETERS

### -ApplicationGateway
Anger namnet på programgatewayen för vilken den här cmdleten uppdaterar ett autentiseringscertifikat.
...
### -CertificateFile
Anger sökvägen till autentiseringscertifikatfilen som den här cmdleten uppdaterar certifikatet med.
...
### -Name
Anger namnet på det autentiseringscertifikat som den här cmdleten uppdaterar.
