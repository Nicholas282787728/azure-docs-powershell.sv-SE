...
ms.locfileid: "100226006"
---
# Get-AzVirtualWanVpnServerConfiguration

## SYNOPSIS
Hämtar listan över alla VpnServerConfigurations som är associerade med denna VirtualWan.
...
## BESKRIVNING
Cmdleten **Get-AzVirtualWanVpnServerConfiguration** returnerar listan över alla VpnServerConfigurations som är associerade med denna VirtualWan. Det vill säga alla VpnServerConfigurations som är kopplade till alla P2SVpnGateway under VirutalHubs of this VirtualWan.
