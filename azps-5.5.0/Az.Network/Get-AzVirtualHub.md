...
ms.locfileid: "100236958"
---
# Get-AzVirtualHub

## SYNOPSIS
Hämtar en Azure VirtualHub efter namn och ResourceGroupName eller visar alla virtuella hubbar efter ResourceGroupName/prenumeration.
...
Därefter får den virtuella hubben med dess ResourceGroupName och ResourceName.
...
Den här cmdleten får det virtuella navet med hjälp av filtrering.
