...
ms.locfileid: "100224006"
---
# Disconnect-AzP2sVpnGatewayVpnConnection

## SYNOPSIS
Koppla från den anslutna vpn-klientanslutningen med en viss p2s vpn-gateway
...
## BESKRIVNING
Med **cmdleten Disconnect-AzP2sVpnGatewayVpnConnection** kan du koppla från den aktuella punkten till webbplatsanslutningen från P2SVpnGateway.
...
### -ResourceId
Resurs-ID för P2S-virtuell nätverksgateway
