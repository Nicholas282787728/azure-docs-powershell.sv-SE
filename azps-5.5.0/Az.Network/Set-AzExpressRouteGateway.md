...
Med **cmdleten Set-AzExpressRouteGateway** kan du uppdatera skalningsenheterna för en befintlig ExpressRouteGateway eller uppdatera resurstaggarna.
...
Ovanstående skapar en resursgrupp, Virtuellt WAN, Virtuellt nätverk, Virtuellt nav i västra USA i resursgruppen "testRG" i Azure. En ExpressRoute-gateway kommer därefter att skapas i det virtuella hubben med 2 skalenheter som sedan ändras till 3 skalenheter
...
### -InputObject
ExpressRouteGateway som måste uppdateras.
...
### -MaxScaleUnits
Maximalt antal skalenheter för denna ExpressRouteGateway. Giltigt intervall > 2
...
### -MinScaleUnits
Lägsta antal skalenheter för denna ExpressRouteGateway. Giltigt intervall > 2
...
### -ResourceGroupName
Resursgruppnamnet för ExpressRouteGateway som ska uppdateras.
...
### -ResourceId
ID för ExpressRouteGateway som måste uppdateras.
