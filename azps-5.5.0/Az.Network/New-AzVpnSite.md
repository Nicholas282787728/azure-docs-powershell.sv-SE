...
ms.locfileid: "100225879"
---
# New-AzVpnSite

## SYNOPSIS
Skapar en ny Azure VpnSite-resurs. Det här är en RM-representation av kundens filialer som laddas upp till Azure för S2S-anslutning med ett virtuellt Nav med En virtuell hubb.

## SYNTAX

### ByVirtualWanNameByVpnSiteIpAddress (standard)
```
...
Ovanstående skapar en resursgrupp, Virtual WAN i östra USA, i resursgruppen "nonlinkSite" i Azure. 

Därefter skapas en VpnSite som representerar en kundgren och länkar den till det virtuella WAN-nätverket.

En IPSec-anslutning kan sedan konfigureras med den här grenen och en VpnGateway med New-AzVpnConnection kommando.
...
Ovanstående skapar en resursgrupp, Virtuell WAN och en VpnSite med 1 VpnSiteLinks i östra USA i resursgruppen "multilink" i Azure.

### Exempel 3

Skapar en ny Azure VpnSite-resurs. (autogenererat)
...
### -BgpPeeringAddress
BGP-peeringadressen för den här VpnSite.
...
### -BgpPeeringWeight
BGP-peeringvikten för den här VpnSite.
...
### -DeviceModel
Enhetsmodellen för fjärr-vpn-enheten.
...
### -DeviceVendor
Leverantör av fjärr-VPN-enheten.
...
### -O365Policy
Trafikbrytprincipen för Office 365 för den här VPN-platsen.
...
### -VirtualWan
VirtualWan denna VpnSite måste vara ansluten till.
...
### -VirtualWanId
ResourceId VirtualWan den här VPN-platsen måste vara ansluten till.
...
### -VirtualWanName
Namnet på VirtualWan den här VPN-platsen måste vara ansluten till.
...
Resursgruppnamnet för VirtualWan den här VpnSite-platsen måste vara anslutet till.
...
### -VpnSiteLink
Listan med VpnSiteLinks som den här VpnSite har.
