...
ms.locfileid: "100218286"
---
# Set-AzApplicationGatewayRedirectConfiguration

## SYNOPSIS
Anger omdirigeringskonfigurationen för en befintlig Application Gateway.
...
## BESKRIVNING
**Cmdleten Set-AzApplicationGatewayRequestRoutingRule** ändrar en omdirigeringskonfiguration.
...
Det andra kommandot ändrar omdirigeringskonfigurationen för programgatewayen till att omdirigera typen Permanent och använder en mål-URL.

### Exempel 2

Anger omdirigeringskonfigurationen för en befintlig Application Gateway. (autogenererat)
