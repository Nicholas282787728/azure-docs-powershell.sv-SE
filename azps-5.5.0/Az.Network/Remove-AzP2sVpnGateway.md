...
## BESKRIVNING
Med **cmdleten Remove-AzP2sVpnGateway** kan du ta bort en befintlig P2SVpnGateway under VirtualHub. Alla pekar på platsklienternas anslutning misslyckas när P2SVpnGateway har tagits bort.
...
### -InputObject
Det p2sVpnGateway-objekt som ska tas bort.
...
### -ResourceId
Azure-resurs-ID för p2sVpnGateway som ska tas bort.
