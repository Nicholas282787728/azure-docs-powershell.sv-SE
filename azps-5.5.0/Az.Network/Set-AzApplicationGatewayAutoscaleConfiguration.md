...
ms.locfileid: "100213455"
---
# Set-AzApplicationGatewayAutoscaleConfiguration

## SYNOPSIS
Uppdaterar automatisk skalkonfiguration av en programgateway.
...
## BESKRIVNING
**Cmdleten Set-AzApplicationGatewayAutoscaleConfiguration** ändrar den befintliga konfigurationen av automatisk skalning av en Application Gateway.
...
Det andra kommandot uppdaterar konfigurationen av automatisk skalning från programmets gateway.
Det tredje kommandot uppdaterar programmets gateway i Azure.
...
### -MaxCapacity
Maximal kapacitet för programgateway.
...
### -MinCapacity
Minsta kapacitet för programgateway.
