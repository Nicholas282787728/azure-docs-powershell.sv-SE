...
Cmdleten **Get-AzLocalNetworkGateway** returnerar det objekt som representerar den lokala gatewayen baserat på namn och resursgruppnamn.
...
Returnerar objektet för den lokala nätverksgatewayen med namnet "myLocalGW1" i resursgruppen "myRG"

### Exempel 2: Hämta lokala nätverksgateway med hjälp av filtrering
```powershell
...
Returnerar objektet för den lokala nätverksgatewayen med namn som börjar med "myLocalGW" i resursgruppen "myRG"
