...
ms.locfileid: "100227774"
---
# Get-AzVirtualNetworkPeering

## SYNOPSIS
Hämtar peering för det virtuella nätverket.
...
## BESKRIVNING
Cmdleten **Get-AzVirtualNetworkPeering** hämtar den virtuella nätverkspeningen.

## EXEMPEL

### Exempel 1: Få en peering mellan två virtuella nätverk
```
...
### Exempel 2: Hämta alla peerings i det virtuella nätverket
```
...
### -Name
Anger peeringnamnet för det virtuella nätverket.
...
### -ResourceGroupName
Anger namnet på resursgruppen som det virtuella nätverkets peering tillhör.
...
### -VirtualNetworkName
Anger namnet på det virtuella nätverket som cmdleten hämtar.
