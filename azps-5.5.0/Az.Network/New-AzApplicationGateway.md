...
Med det här kommandot skapas en frontend-port i port 80, namnet FrontEndPort01 och porten lagras i $FrontEndPort variabeln.
...
Listan över privateLink Configuration
...
### -Sonder
Anger sonder för programgatewayen.
...
### -RequestRoutingRules
Anger en lista över begärandedirigeringsregler för programgatewayen.
...
Listan över betrodda certifikatkedjor för klient-CERTIFIKATutfärdare
...
Listan med betrodda rotcertifikat
...
### -Zone
En lista med tillgänglighetsområden som anger varifrån programmets gateway måste komma.
