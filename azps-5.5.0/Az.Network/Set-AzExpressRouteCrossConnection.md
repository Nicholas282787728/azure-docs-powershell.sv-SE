...
ms.locfileid: "100223591"
---
# Set-AzExpressRouteCrossConnection

## SYNOPSIS
Ändrar en ExpressRoute-korsanslutning.
...
## BESKRIVNING
**Set-AzExpressRouteCrossConnection-cmdleten** sparar den modifierade ExpressRoute-korsanslutningen till Azure.

## EXEMPEL

### Exempel 1: Ändra tjänstleverantörens etableringstillstånd för en ExpressRoute-korsanslutning
```
...
Anger **expressRouteCrossConnection-objektet** som denna cmdlet ändrar.
...
### -Name
Namnet på tväranslutning med express route.
...
### -Peerings
Listan med peerings för korsanslutningen
...
De tjänstprovider anteckningarna
...
Den tjänstprovider etableringstillståndet som ska anges
...
Parametern ExpressRouteCrossConnection accepterar värdet för typen "PSExpressRouteCrossConnection" från pipelinen
