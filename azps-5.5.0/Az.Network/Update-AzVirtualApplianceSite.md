...
ms.locfileid: "100227343"
---
# Update-AzVirtualApplianceSite

## SYNOPSIS
Ändra en webbplats för virtuell utrustning som är ansluten till en virtuell nätverksresurs för utrustning.
...
## BESKRIVNING
Med Update-AzVirtualApplianceSite postkommandot ändras en webbplatsresurs för den virtuella utrustningen.
...
Ändra adressprefixet för en webbplatsresurs för virtuell utrustning.

## PARAMETERS

### -AddresssPrefix
Adressprefix för webbplatsen.
...
Den virtuella nätverksinstallationen som den här webbplatsen är kopplad till.
...
### -O365Policy
Utbrytningsprincip för Office 365.
