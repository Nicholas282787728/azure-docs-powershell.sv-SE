...
ms.locfileid: "100236663"
---
# New-AzVpnServerConfiguration

## SYNOPSIS
Skapa en ny VpnServerConfiguration för punkt till webbplatsanslutning.
...
## BESKRIVNING
Med cmdleten **New-AzVpnServerConfiguration** kan du skapa en ny VpnServerConfiguration med olika VpnProtocols, VpnAuthenticationTypes och IpsecPolicies och ange valda vpn-autentiseringstyprelaterade parametrar enligt kundens krav för Punkt till webbplatsanslutning.
...
Kommandot ovan skapar en ny VpnServerConfiguration med VpnAuthenticationType som certifikat.

### Exempel 2

Skapa en ny VpnServerConfiguration för punkt till webbplatsanslutning. (autogenererat)
...
### -Oavvislighet
AAD-målgrupp för P2S AAD-autentisering.
...
### -AadIssuer
AAD-utfärdare för P2S AAD-autentisering.
...
### -AadTenant
AAD-klientorganisation för P2S AAD-autentisering.
...
### -RadieClientRootCertificateFilesList
En lista med radieClientRootCertificate-filers sökvägar
...
### -RadieServerRootCertificateFilesList
En lista med radieClientRootCertificate-filers sökvägar
...
En lista med VpnClientCertificates som ska återkalla filernas sökvägar
...
En lista med VpnClientRootCertificates som ska läggas till filers sökvägar
