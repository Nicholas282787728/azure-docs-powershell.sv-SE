...
En Azure VPN-gateway är en programvara som definierats anslutning för webbplats-till-webbplatsanslutningar i VirtualHub. Den här gatewayen ändrar storlek och skalor baserat på den skalenhet som anges av användaren. En anslutning kan konfigureras från en gren/webbplats som kallas VPN-webbplats till den skalbara gatewayen. Varje anslutning består av 2 Active-Active tunnlar
...
När gatewayen har skapats använder den en Update-AzVpnGateway uppgradera gatewayen till tre skalenheter.
...
När gatewayen har skapats används den för Set-AzVpnGateway uppdatera BgpPeeringAddress.
...
### -BgpPeeringAddress
BGP-peeringadresserna för vpnGateway-bgpsettings.
...
### -InputObject
Vpn Gateway-objektet som ska ändras
...
### -ResourceId
Azure-resurs-ID för VpnGateway-portalen som ska ändras.
