...
ms.locfileid: "100225934"
---
# New-AzFirewallPolicyFilterRuleCollection

## SYNOPSIS
Skapa en ny regelsamling för Azure-brandväggsprincipfilter
...
## BESKRIVNING
**Cmdleten New-AzFirewallPolicyFilterRuleCollection** skapar en regelsamling för filter för en Azure-brandväggsprincip.
...
I det här exemplet skapas en filterregel med 2 regelvillkor
...
### -Name
Namnet på programregelsamlingen
