...
ms.locfileid: "100225910"
---
# New-AzVirtualHubVnetConnection

## SYNOPSIS
Med New-AzVirtualHubVnetConnection-cmdleten skapas en HubVirtualNetworkConnection-resurs som peers ett virtuellt nätverk till Azure Virtual Hub.
...
Ovanstående skapar en resursgrupp, Virtuellt WAN, Virtuellt nätverk, Virtuellt nav i centrala USA i den resursgruppen i Azure. Därefter skapas en virtuell nätverksanslutning som peer-to-peer-nätverket till det virtuella hubben.

### Exempel 2

Med New-AzVirtualHubVnetConnection-cmdleten skapas en HubVirtualNetworkConnection-resurs som peers ett virtuellt nätverk till Azure Virtual Hub. (autogenererat)
...
```
Ovanstående skapar en ny routningskonfiguration och skapar statiska vägar i routningskonfigurationen med nästa hopp som en angiven IP-adress. Den här routningskonfigurationen kan sedan skickas New-AzVirtualHubVnetConnection som parameter -RoutingConfiguration.
...
Det fjärranslutna virtuella nätverket som den virtuella nätverksanslutningen är ansluten till.
