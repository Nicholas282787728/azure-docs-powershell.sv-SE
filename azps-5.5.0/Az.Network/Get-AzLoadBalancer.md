...
ms.locfileid: "100213950"
---
# Get-AzLoadBalancer

## SYNOPSIS
Får en belastningsutjämning.
...
## BESKRIVNING
Cmdleten **Get-AzLoadBalancer** får en eller flera Azure-belastningsutjämnare som finns i en resursgrupp.

## EXEMPEL

### Exempel 1: Skaffa en belastningsutjämare
```
...
Det här kommandot hämtar belastningsutjämaren Med namnet MyLoadBalancer.
Det måste finnas en belastningsutjämnare innan du kan köra den här cmdleten.

### Exempel 2: Lista belastningsutjämnare med hjälp av filtrering
```
...
Med det här kommandot får alla belastningsutjämnare ett namn som börjar med "MyLoadBalancer"
