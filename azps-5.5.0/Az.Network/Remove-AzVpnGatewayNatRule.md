...
ms.locfileid: "100213470"
---
# Remove-AzVpnGatewayNatRule

## SYNOPSIS
Tar bort en NAT-regel som är kopplad till VpnGateway.
...
Ovanstående skapar en resursgrupp, Virtual WAN, Virtual Network, Virtual Hub, VpnGateway och NAT-regel som är kopplade till vpnGateway.
Sedan tas NAT-regeln bort med NAT-regelnamnet.
...
### -Force
Be inte om bekräftelse om du vill ta bort en resurs
