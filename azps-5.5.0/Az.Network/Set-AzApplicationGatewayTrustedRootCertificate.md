...
ms.locfileid: "100213446"
---
# Set-AzApplicationGatewayTrustedRootCertificate

## SYNOPSIS
Uppdaterar ett betrott rotcertifikat för en programgateway.
...
## BESKRIVNING
Cmdleten **Set-AzApplicationGatewayTrustedRootCertificate** ändrar det befintliga betrodda rotcertifikatet för en Application Gateway.
...
Ovanstående exempelscenarier visar hur du uppdaterar ett befintligt betrott rotcertifikat när ett rotcertifikat distribueras.
Det första kommandot hämtar en programgateway och lagrar den i $gw variabeln.
Det andra kommandot ändrar det befintliga betrodda rotcertifikatet med ett nytt rotcertifikat.
