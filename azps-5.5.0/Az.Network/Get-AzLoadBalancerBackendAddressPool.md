...
ms.locfileid: "100221214"
---
# Get-AzLoadBalancerBackendAddressPool

## SYNOPSIS
Get-AzLoadBalancerBackendAddressPool hämtar en eller flera backend-adresspooler som är kopplade till en belastningsutjämare. 
...
## BESKRIVNING
Get-AzLoadBalancerBackendAddressPool hämtar en eller flera backend-adresspooler som är associerade med en belastningsutjämare.
...
### -Name
Namnet på adresspoolen för backend.
