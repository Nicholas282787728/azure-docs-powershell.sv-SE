...
ms.locfileid: "100236670"
---
# New-AzVirtualWan

## SYNOPSIS
Skapar ett virtuellt WAN för Azure.
...
Ovanstående skapar en resursgrupp "testRG" i regionen "Västra USA" och en Virtuell Azure-WAN med branch-till-trafik som tillåts i den resursgruppen i Azure.
