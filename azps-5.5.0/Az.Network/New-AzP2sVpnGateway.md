...
ms.locfileid: "100218494"
---
# New-AzP2sVpnGateway

## SYNOPSIS
Skapa en ny P2SVpnGateway under VirtualHub för punkt till webbplatsanslutning.
...
## BESKRIVNING
Med New-AzP2sVpnGateway-cmdleten kan du skapa en ny P2SVpnGateway under VirtualHub för Point till webbplatsanslutning från Point till webbplatsklienter till Azure VirtualWan.
...
Med New-AzP2sVpnGateway-cmdleten kan du skapa en ny P2SVpnGateway under VirtualHub för Point to site connectivity.
...
### -VirtualHub
VirtualHub den här P2SVpnGateway-yta måste associeras med.
...
### -VirtualHubId
Id:t för VirtualHub-objektet som P2SVpnGateway måste associeras med.
...
Flagga för att aktivera routningsinställning internet på denna P2SVpnGateway.
