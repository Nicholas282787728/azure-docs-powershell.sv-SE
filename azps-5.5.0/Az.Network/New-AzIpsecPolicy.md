...
## BESKRIVNING
Cmdlet New-AzIpsecPolicy skapar ett IPSec-principförslag som ska användas i en anslutning till en virtuell nätverksgateway.
...
Skapa en IPSec-princip som ska användas för en ny anslutning till virtuell nätverksgateway.
...
### -DhGroup
DH-grupperna som används i IKE Fas 1 för inledande SA
...
### -IkeEncryption
Algoritmen för IKE-kryptering (IKE Fas 1)
...
### -IkeIntegrity
Algoritmen för IKE-integritet (IKE Fas 1)
...
### -IpsecEncryption
Algoritmen för IPSec-kryptering (IKE Fas 2)
...
### -Ipsec-integritet
Algoritmen för IPSec-integritet (IKE Fas 2)
...
### -PfsGroup
DH-grupperna som används i IKE Fas 2 för nya underordnade SA
...
### -SADataSizeKilobytes
Payload-storleken för IPSec Security Association (kallas även snabbläge eller fas 2 SA) i KB
...
### -SALifeTimeSeconds
Livslängden för IPSec-säkerhet (kallas även snabbläge eller fas 2 SA) i sekunder
