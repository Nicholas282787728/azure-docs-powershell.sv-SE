...
## BESKRIVNING
**Cmdleten New-AzApplicationGatewayRewriteRuleSet** skapar en omskrivningsregeluppsättning för en Azure-programgateway.
...
Det här kommandot skapar en omskrivningsregeluppsättning med namnet ruleset1 och lagrar resultatet i variabeln $ruleset.
