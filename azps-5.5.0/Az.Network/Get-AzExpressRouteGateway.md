...
ms.locfileid: "100221238"
---
# Get-AzExpressRouteGateway

## SYNOPSIS
Hämtar en ExpressRouteGateway-resurs med ResourceGroupName och GatewayName ELLER visar alla gateways efter ResourceGroupName eller SubscriptionId.
...
Ovanstående skapar en resursgrupp, Virtuellt WAN, Virtuellt nätverk, Virtuellt nav i Västra centrala USA i resursgruppen "testRG" i Azure. En ExpressRoute-gateway kommer därefter att skapas i det virtuella hubben med 2 skalenheter.

ExpressRouteGateway får sedan namnet på sin resourceGroupName och gatewayen.
...
Med det här kommandot får du alla ExpressRouteGateway som börjar med "test"
...
### -ResourceId
Azure-resurs-ID för expressRouteGateway som ska tas bort.
