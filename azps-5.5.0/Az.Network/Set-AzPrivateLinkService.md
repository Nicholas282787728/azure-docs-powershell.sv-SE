...
ms.locfileid: "100218238"
---
# Set-AzPrivateLinkService

## SYNOPSIS
Uppdaterar en privat länktjänst.
...
## BESKRIVNING
Cmdleten **Set-AzPrivateLinkService** uppdaterar en privat länktjänst.

## EXEMPEL

### 1: Skapar en privat länktjänst och uppdaterar dess
```
...
I det här exemplet skapas en privat länktjänst som kallas mypls. Sedan ersätter den dess ipConfigurations från det in-memory ipConfiguratiuon-objektet. Den Set-AzPrivateLinkService cmdleten används sedan för att skriva den ändrade statusen för den privata länktjänsten på tjänstsidan. 
...
### -PrivateLinkService
Anger ett privat länktjänstobjekt som representerar den delstat som den privata länktjänsten ska ställas in för.
