...
ms.locfileid: "100236831"
---
# New-AzApplicationGatewayRewriteRule

## SYNOPSIS
Skapar en omskrivningsregel för en programgateway.
...
## BESKRIVNING
**Cmdleten New-AzApplicationGatewayRewriteRule** skapar en omskrivningsregel för en Azure-programgateway.

## EXEMPEL

### Exempel 1: Skapa en omskrivningsregel för en programgateway
```powershell
PS C:\> $rule = New-AzApplicationGatewayRewriteRule -Name rule1 -ActionSet $action -RuleSequence 101 -Condition $condition
```

Det här kommandot skapar en omskrivningsregel med namnet regel1 och lagrar resultatet i variabeln $rule.

## PARAMETERS

### -ActionSet
Åtgärdsuppsättning för omskrivningsregeln
...
### -Villkor
Villkor för att omskrivningsregeln ska köras
...
### -RuleSequence
Regelordningen för den här omskrivningsregeln i uppsättningen med omskrivningsregel
