...
ms.locfileid: "100237079"
---
# Add-AzLoadBalancerProbeConfig

## SYNOPSIS
Lägger till en sonde konfiguration i en belastningsutjämare.
...
## BESKRIVNING
Cmdleten **Add-AzLoadBalancerProbeConfig** lägger till en sonderkonfiguration i en Azure-belastningsutjämnare.

## EXEMPEL

### Exempel 1: Lägga till en sonde konfiguration i en belastningsutjämare
```powershell
PS C:\>Get-AzLoadBalancer -Name "myLb" -ResourceGroupName "myRg" | Add-AzLoadBalancerProbeConfig -Name "probeName" -RequestPath healthcheck2.aspx -Protocol http -Port 81 -IntervalInSeconds 16 -ProbeCount 3 | Set-AzLoadBalancer
```

Det här kommandot hämtar belastningsutjämaren myLb, lägger till den angivna mätkonfigurationen och använder sedan cmdleten **Set-AzLoadBalancer** för att uppdatera belastningsutjämaren.
...
Den här cmdleten lägger till en sonde konfiguration i belastningsutjämaren som den här parametern anger.
...
### -Name
Anger namnet på den sonde konfiguration som ska läggas till.
