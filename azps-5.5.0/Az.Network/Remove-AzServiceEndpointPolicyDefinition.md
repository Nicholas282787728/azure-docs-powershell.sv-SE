...
ms.locfileid: "100252260"
---
# Remove-AzServiceEndpointPolicyDefinition

## SYNOPSIS
Tar bort en principdefinition för tjänstslutpunkt.
...
Det här kommandot tar bort en tjänstslutpunktsprincip med namnprincipdef1
...
### -InputObject
Tjänstslutpunktsprincipdefinitionsobjekt.
...
### -Name
Namnet på slutpunktsdefinitionen för tjänsten
...
### -ResourceId
ID för slutpunktsdefinitionen för tjänsten.
