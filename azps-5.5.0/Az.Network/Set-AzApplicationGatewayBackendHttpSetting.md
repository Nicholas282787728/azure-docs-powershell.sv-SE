...
ms.locfileid: "100252245"
---
# Set-AzApplicationGatewayBackendHttpSetting

## SYNOPSIS
Uppdaterar HTTP-inställningarna i backend för en programgateway.
...
## BESKRIVNING
Med Set-AzApplicationGatewayBackendHttpSetting-cmdleten uppdateras HTTP-inställningarna (Back-end Hypertext Transfer Protocol) för en Azure-programgateway.
HTTP-inställningarna i backend tillämpas på alla backend-servrar i en pool.

## EXEMPEL

### Exempel 1: Uppdatera HTTP-inställningarna för backend för en programgateway
```
...
Det andra kommandot uppdaterar HTTP-inställningarna för programgatewayen i variabeln $AppGw för att använda port 88, HTTP-protokollet och aktiverar cookiebaserad tillhörighet.
...
### -ApplicationGateway
Anger ett programgatewayobjekt som denna cmdlet associerar HTTP-inställningarna i backend-delen med.
...
### -ConnectionDraining
Anslutningsavkoppling av backend http inställningsresurs.
...
De godtagbara värdena för den här parametern är: Inaktiverade eller aktiverade.
...
### -Name
Anger namnet på HTTP-inställningsobjektets backend.
...
Flagga om värdrubriken ska väljas från servervärdnamnet.
...
### -Port
Anger vilken port som ska användas för varje server i serverpoolen för serverservern.
...
### -Sond
Anger en mätare som ska associeras med HTTP-inställningarna i backend.
...
### -Sondid
Anger ID för sonden som ska associeras med HTTP-inställningarna i backend.
...
### -Protocol
Anger det protokoll som ska användas för kommunikation mellan programmets gateway och serverslutsservrarna.
De godtagbara värdena för den här parametern är: http och https.
Den här parametern är fallkänslig.
