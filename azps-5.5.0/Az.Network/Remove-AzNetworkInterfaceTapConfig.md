...
ms.locfileid: "100213550"
---
# Remove-AzNetworkInterfaceTapConfig

## SYNOPSIS
Tar bort en tryckningskonfiguration från ett givet nätverksgränssnitt
...
## BESKRIVNING
Cmdleten **Remove-AzNetworkInterfaceTapConfig** tar bort en Konfiguration av Azure-tryckning från en lista med nätverksgränssnitt.

## EXEMPEL

### Exempel 1: Ta bort en tryckningskonfiguration
```
PS C:\>Remove-AzNetworkInterfaceTapConfig -Name "TapConfiguration" -NetworkInterfaceName "NetworkInterface1" -ResourceGroup "ResourceGroup1"
```

Med det här kommandot tas TapConfiguration bort från NetworkInterface1 i en resursgrupp ResourceGroup1.
...
### -Name
Det virtuella nätverks peeringnamnet.
