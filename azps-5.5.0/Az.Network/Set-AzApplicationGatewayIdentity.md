...
ms.locfileid: "100220966"
---
# Set-AzApplicationGatewayIdentity

## SYNOPSIS
Uppdaterar en identitet som tilldelats programmets gateway.
...
## BESKRIVNING
Cmdleten **Set-AzApplicationGatewayIdentity** uppdaterar en identitet tilldelad till programgateway.
...
I det här exemplet tilldelar vi en användare tilldelad identitet till en befintlig programgateway.
Obs! Den här identiteten bör ha åtkomst till nyckeln som certifikat/hemligheterna ska refereras till från.
