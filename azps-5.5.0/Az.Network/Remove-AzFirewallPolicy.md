...
ms.locfileid: "100252285"
---
# Remove-AzFirewallPolicy

## SYNOPSIS
Tar bort en Azure-brandväggsprincip
...
## BESKRIVNING
Cmdleten **Remove-AzFirewallPolicy** tar bort en Azure-brandväggsprincip.
...
Det här exemplet tar bort brandväggsprincipen med namnet "firewallpolicy" i resursgruppen "TestRg"
...
Det här exemplet tar bort brandväggsprincipen genom ID:t.
...
I det här exemplet tas brandväggsprincipen bort $fp
