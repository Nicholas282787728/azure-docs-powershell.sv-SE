...
ms.locfileid: "100237007"
---
# Get-AzCustomIpPrefix

## SYNOPSIS
Hämtar en AnpassadIpPrefix-resurs
...
## BESKRIVNING
Cmdleten **Get-AzCustomIpPrefix** hämtar en eller flera CustomIpPrefixs givet uppsättningen indataparametrar
...
Med det här kommandot får du en CustomIpPrefix-resurs med namnet myCustomIpPrefix i resursgruppen MyRg
