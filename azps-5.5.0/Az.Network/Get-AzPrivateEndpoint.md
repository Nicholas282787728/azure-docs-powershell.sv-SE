...
ms.locfileid: "100223790"
---
# Get-AzPrivateEndpoint

## SYNOPSIS
Skaffa en privat slutpunkt
...
## BESKRIVNING
Cmdleten **Get-AzPrivateEndpoint** får en eller flera privata slutpunkter.

## EXEMPEL

### Exempel 1: Hämta en privat slutpunkt
```powershell
...
Det här kommandot hämtar den privata slutpunkten med namnet MyPrivateEndpoint1 i resursgruppen TestResourceGroup

### Exempel 2: Lista alla privata slutpunkter i ResourceGroup
```powershell
...
Med det här kommandot får du alla privata ändpunkter i resursgruppen TestResourceGroup
