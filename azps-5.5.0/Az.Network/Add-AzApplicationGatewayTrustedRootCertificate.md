...
ms.locfileid: "100226102"
---
# Add-AzApplicationGatewayTrustedRootCertificate

## SYNOPSIS
Lägger till ett betrott rotcertifikat i en programgateway.
...
## BESKRIVNING
**Cmdleten Add-AzApplicationGatewayTrustedRootCertificate** lägger till ett betrott rotcertifikat i en Azure-programgateway.
...
Det andra kommandot lägger till ett nytt betrott rotcertifikat i Application Gateway som tar sökvägen till rotcertifikatet som indata.
Det tredje kommandot skapar ny serverserverserverinställning med hjälp av betrott rotcertifikat för serverservercertifikatet som serverservercertifikatet verifieras mot.
Det fjärde kommandot uppdaterar Application Gateway.
