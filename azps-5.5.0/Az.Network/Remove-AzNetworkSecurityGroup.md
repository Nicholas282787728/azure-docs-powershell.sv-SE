...
ms.locfileid: "100252273"
---
# Remove-AzNetworkSecurityGroup

## SYNOPSIS
Tar bort en nätverkssäkerhetsgrupp.
...
## BESKRIVNING
Cmdleten **Remove-AzNetworkSecurityGroup** tar bort en Azure-nätverkssäkerhetsgrupp.

## EXEMPEL

### Exempel 1: Ta bort en nätverkssäkerhetsgrupp
```
PS C:\>Remove-AzNetworkSecurityGroup -Name "NSG-FrontEnd" -ResourceGroupName "TestRG"
```

Det här kommandot tar bort säkerhetsgruppen med namnet NSG-FrontEnd i resursgruppen TestRG.
...
### -Name
Anger namnet på nätverkssäkerhetsgruppen som cmdleten tar bort.
...
### -ResourceGroupName
Anger namnet på en resursgrupp som cmdleten tar bort en nätverkssäkerhetsgrupp från.
