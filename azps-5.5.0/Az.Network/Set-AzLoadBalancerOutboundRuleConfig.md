...
ms.locfileid: "100213398"
---
# Set-AzLoadBalancerOutboundRuleConfig

## SYNOPSIS
Anger en utgående regelkonfiguration för en belastningsutjämare.
...
## BESKRIVNING
Cmdleten **Set-AzLoadBalancerOutboundRuleConfig** anger en utgående regelkonfiguration för en Azure-belastningsutjämnare.

## EXEMPEL

### Exempel 1: Ändra konfigurationen av utgående regler för en belastningsutjämare
```powershell
...
Det andra kommandot använder pipelineoperatorn för att överföra belastningsutjämningen i $slb till Add-AzLoadBalancerOutboundRuleConfig, som lägger till en utgående regelkonfiguration till den.
Det tredje kommandot skickar belastningsutjämningen till **Set-AzLoadBalancerOutboundRuleConfig,** som sparar och uppdaterar konfigurationen av utgående regler.
...
Timeout för TCP-inaktivitetsanslutningen
...
### -LoadBalancer
Referensen till belastningsutjämningsresursen.
