...
## BESKRIVNING
Cmdleten **Get-AzApplicationGateway** hämtar en programgateway.

## EXEMPEL

### Exempel 1: Hämta en viss programgateway
```
...
Det här kommandot hämtar programgateway med namnet ApplicationGateway01 som tillhör resursgruppen ResourceGroup01 och lagrar den i $AppGw variabeln.

### Exempel 2: Hämta en lista över programgateway i en resursgrupp
```
...
Det här kommandot hämtar en lista över alla programgateway i resursgruppen ResourceGroup01 och lagrar den i $AppGwList variabeln.

### Exempel 3: Hämta en lista över programgateway i en prenumeration
```
...
Med det här kommandot får du en lista över alla programgateway i prenumerationen och lagrar den $AppGwList variabeln.

### Exempel 4: Hämta en lista med programgateway i en prenumeration med hjälp av filtrering
```
...
Med det här kommandot får du en lista över alla programgateway i prenumerationen som börjar med "ApplicationGateway01" och lagrar den i $AppGwList variabeln.
