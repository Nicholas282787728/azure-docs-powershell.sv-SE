...
ms.locfileid: "100227983"
---
# Get-AzApplicationGatewayTrustedClientCertificate

## SYNOPSIS
Hämtar certifikatkedja för betrodd klient-CERTIFIKATutfärdare med ett specifikt namn från Application Gateway.
...
## BESKRIVNING
CmdletGet-AzApplicationGatewayTrustedClientCertificate-cmdleten hämtar certifikatkedja för betrodd klient-CERTIFIKATUTFÄRDARE med ett specifikt namn från Application Gateway.
...
Det första kommandot hämtar Application Gateway och lagrar den i en $gw variabel. Det andra kommandot får den betrodda certifikatutfärdaren med ett angivet namn från Application Gateway.
