...
ms.locfileid: "100223671"
---
# Remove-AzFirewallPolicyRuleCollectionGroup

## SYNOPSIS
Tar bort en regelsamlingsgrupp för Azure-brandväggsprincipen i en Azure-brandväggsprincip
...
## BESKRIVNING
Cmdleten **Remove-AzFirewallPolicyRuleCollectionGroup** tar bort en regelsamlingsgrupp från en Azure-brandväggsprincip.
...
Det här exemplet tar bort den grupp med brandväggsprincipregel som heter "testRcGroup" i $fp
...
Det här exemplet tar bort kolumngruppen för brandväggsprincip med namnet "testRcGroup" i brandväggen "fpName" frpm resursgruppens namn "testRg"
...
### -InputObject
Gruppobjekt för brandväggsprincipregel
...
### Microsoft.Azure.Commands.Network.Models.PSAzureFirewallPolicyruleCollectionGroupWrakommando
