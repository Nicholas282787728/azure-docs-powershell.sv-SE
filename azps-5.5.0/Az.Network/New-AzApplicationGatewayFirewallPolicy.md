...
ms.locfileid: "100221159"
---
# New-AzApplicationGatewayFirewallPolicy

## SYNOPSIS
Skapar en brandväggsprincip för programgateway.
...
## BESKRIVNING
**Cmdleten New-AzApplicationGatewayFirewallPolicy** skapar en brandväggsprincip för programgateway.
...
Det här kommandot skapar en ny brandväggsprincip för Azure-programgateway med namnet "wafResource1" i resursgruppen "rg1" på plats "westus" med anpassade regler definierade i variabeln $customRule
...
### -PolicySetting
Principinställningar för brandväggen för webbprogram
