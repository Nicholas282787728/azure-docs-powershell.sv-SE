...
## BESKRIVNING
Cmdleten **New-AzApplicationGatewaySku** skapar en aktielagringsenhet (SKU) för en Azure-programgateway.
...
Det här kommandot skapar en SKU Standard_Small för en Azure-programgateway och lagrar resultatet i variabeln $SKU.
