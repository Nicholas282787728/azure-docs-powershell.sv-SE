...
ms.locfileid: "100213390"
---
# Set-AzVirtualNetworkGatewayConnectionSharedKey

## SYNOPSIS
Konfigurerar den delade nyckeln för anslutning till virtuell nätverksgateway.
...
## BESKRIVNING
Cmdleten **Set-AzVirtualNetworkGatewayConnectionSharedKey** konfigurerar den delade nyckeln för den virtuella nätverksanslutningen.
...
### -Name
Anger namnet på den delade nyckeln för virtuell nätverksgateway.
...
### -ResourceGroupName
Anger namnet på resursgruppen som den virtuella nätverksgatewayen tillhör
...
### -Värde
Anger värdet för den delade nyckeln.
