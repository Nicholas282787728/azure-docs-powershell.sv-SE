...
## BESKRIVNING
Flyttar en åtagandeassociat verksamhetsresurs från dess överordnade åtagandeplan till en annan åtagandeplan.

## EXEMPEL

### Exempel 1: Flytta en åtagandeassociation
```
...
### -DestinationPlanId
Azure-resurs-ID för Azure ML-åtagandeplanens mål.
