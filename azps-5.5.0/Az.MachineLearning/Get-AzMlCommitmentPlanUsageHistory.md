...
## BESKRIVNING
Hämtar användningshistorikinformation för en angiven åtagandeplan, inklusive resurser som används och resurser som finns kvar i planen.

## EXEMPEL

### Exempel 1: Hämta användningshistorik för ett visst åtagandeabonnemang
```
