...
## BESKRIVNING
Skapar regionala egenskaper för Azure Machine Learning för en befintlig webbtjänst.

## EXEMPEL

### Exempel 1: Lägga till nya regionala egenskaper för Centrala USA

```
Add-AzMlWebServiceRegionalProperty -ResourceGroupName "myresourcegroup" -Name "mywebservicename" -Region westcentralus
```

Det här exempelkommandot skapar en regional egenskap för en webbtjänst i regionen "Västra centrala USA".
...
### -Region
Detta är den region där webbtjänstegenskaperna ska skapas.
...
### -ResourceGroupName
Resursgruppen som webbtjänsten tillhör.
