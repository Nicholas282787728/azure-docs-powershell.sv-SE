...
### Exempel 1: Uppdatera klientprotokoll
```powershell
...
Det här kommandot uppdaterar klientprotokoll för databasen för Redis Enterprise Cache med namnet MyCache.

### Exempel 2: Uppdatera klientprotokoll och avräkningsprincip
```powershell
...
Det här kommandot uppdaterar klientprotokoll- och ändringsprincipen för databasen för Redis Enterprise Cache med namnet MyCache.
...
### -ClusteringPolicy
Klusterprincip – standard är OSSCluster.
...
### -EvictionPolicy
Princip för omissning – standardvärdet är VolatileLRU
