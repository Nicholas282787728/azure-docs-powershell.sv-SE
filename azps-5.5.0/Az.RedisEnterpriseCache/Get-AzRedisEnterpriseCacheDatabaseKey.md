...
### Exempel 1: Hämta databasåtkomstnycklar
```powershell
...
Det här kommandot får de hemliga snabbåtkomstnycklarna som används för att autentisera anslutningar till databasen för Redis Enterprise-cachen med namnet MyCache.
