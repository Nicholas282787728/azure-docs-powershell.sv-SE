...
### Exempel 1: Uppdatera Redis Enterprise Cache
```powershell
...
Det här kommandot uppdaterar den lägsta TLS-versionen och lägger till en tagg i Redis Enterprise Cache med namnet MyCache.
...
Används som standard till 2 eller 3 beroende på SKU.
