...
### Exempel 1: Hämta information om instansvy för molntjänstrollinstans
```powershell
...
Den här cmdleten hämtar instansvyn för rollinstansen med namnet ContosoFrontEnd_IN_0 molntjänst med namnet ContosoCS som tillhör resursgruppen ContosOrg.
