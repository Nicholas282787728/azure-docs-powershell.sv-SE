...
Med det här kommandot får du alla molntjänster i resursgruppen ContosOrg
...
Det här kommandot får molntjänsten ContosoCS som tillhör resursgruppen ContosOrg.
