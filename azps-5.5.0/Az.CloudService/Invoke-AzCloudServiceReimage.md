...
### Exempel 1: Animera rollinstanser för molntjänsten
```powershell
...
Det här kommandot ger 2 rollinstanser ContosoFrontEnd_IN_0 och ContosoBackEnd_IN_1 molntjänst med namnet ContosoCS som tillhör resursgruppen ContosOrg.

### Exempel 2: Animera alla roller för molntjänsten
```powershell
PS C:\> Invoke-AzCloudServiceReimage -ResourceGroupName "ContosOrg" -CloudServiceName "ContosoCS" -RoleInstance "*"
```

Det här kommandot tar upp alla rollinstanser för molntjänsten ContosoCS som tillhör resursgruppen ContosOrg.
