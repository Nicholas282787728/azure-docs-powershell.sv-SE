...
### Exempel 1: Starta om rollinstans för en molntjänst
```powershell
PS C:\> Restart-AzCloudService -ResourceGroupName "ContosOrg" -CloudServiceName "ContosoCS" -RoleInstanceName "ContosoFrontEnd_IN_0"
```

Det här kommandot startar om rollinstansen ContosoFrontEnd_IN_0 med namnet ContosoCS som tillhör resursgruppen ContosOrg.
