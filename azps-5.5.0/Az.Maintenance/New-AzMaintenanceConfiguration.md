...
Skapa en underhållskonfiguration med omfattningsvärden
...
### -ExpirationDateTime
FörfallodatumTid för schemat i formatet YYYY-MM-DD hh:mm
...
### -Plats
Platsen för underhållskonfigurationen.
...
### -Name
Namnet på underhållskonfigurationen.
...
### -StartDateTime
StartDateTime för schemat i formatet YYYY-MM-DD hh:mm
