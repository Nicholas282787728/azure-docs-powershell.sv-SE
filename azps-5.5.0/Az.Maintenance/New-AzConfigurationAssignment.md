...
## BESKRIVNING
Registrera underhållskonfiguration för resurs.
...
Registrera underhållskonfiguration för dedikerad värd.
...
Namnet på konfigurationstilldelningen bör matcha MaintenanceConfigurationName.
...
### -Plats
Platsen utan blanksteg för resursen.
