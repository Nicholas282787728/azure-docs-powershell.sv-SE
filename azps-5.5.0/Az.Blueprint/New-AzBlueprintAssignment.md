...
## BESKRIVNING
Tilldela en skissdefinition till en prenumeration.
...
Skapa en ny skisstilldelning av skissdefinitionen `$blueprintObject` i den angivna prenumerationen med hjälp av den definierade parametern och resursgruppens ordlista. Använder system kopplad identitet. Platsen definierar region för att skapa den hanterade identiteten.
...
Skapa en ny skisstilldelning av skissdefinitionen i den angivna prenumerationen med hjälp av den definierade parametern och resursgruppens ordlista och konfigurera resurslåsning till `$blueprintObject` **AllResources.** Används som standard för att använda system tilldelad identitet.  Platsen definierar region för att skapa den hanterade identiteten.
...
Skapa en ny skisstilldelning av skissdefinitionen i den angivna prenumerationen med hjälp av den definierade parametern och resursgruppens ordlista med det `$blueprintObject` angivna användartilldelnings-ID:t.
...
Skapa en skiss över tilldelning via en uppgiftsfil. Formatet på tilldelningsfilen finns i exempel på begäran/svar på: https://github.com/Azure/azure-rest-api-specs/tree/master/specification/blueprint/resource-manager/Microsoft.Blueprint/preview/2018-11-01-preview/examples
...
Skapa en ny skisstilldelning av skissdefinitionen som `$blueprintObject` riktar sig till den angivna prenumerationen i den angivna hanteringsgruppen med hjälp av den definierade parametern.
...
### -SubscriptionId
Prenumerations-ID för att tilldela skissdefinitionen.
...
Användare tilldelad identitet (MSI) för att distribuera artefakterna.
