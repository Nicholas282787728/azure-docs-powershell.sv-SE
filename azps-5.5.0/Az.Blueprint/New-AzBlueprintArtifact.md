...
## BESKRIVNING
Skapa en ny artefakt. Det finns två sätt att skapa en artefakt: antingen genom en artefakt som en indatafil eller genom att ange infogade parametrar för artefakten. Även om JSON-metoden inte kräver att typ av artefakt anges som infogade parametermetoden måste användaren ange typ av artefakt via -Typ-parameter.
...
Skapa en ny artefakt via en JSON-fil.
...
### -ArtifactFile
Platsen för artefaktfilen i JSON-format på disken.
...
### -PolicyDefinitionId
Definition-ID för principdefinitionen.
...
Hashtabell med parametrar som ska överföras till principdefinitionsartefakteten.
...
### -ResourceGroupName
Namnet på resursgruppen som artefakten kommer att vara under.
...
Lista över huvud-ID:n för rolldefinitioner.
...
### -TemplateFile
Platsen för ARM-mallfilen på disken.
...
Platsen för den ARM parameterfilen för mall på disken.
