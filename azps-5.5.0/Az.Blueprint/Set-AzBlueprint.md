...
## BESKRIVNING
Uppdatera en skissdefinition och spara den i den angivna prenumerationen eller hanteringsgruppen.
...
Uppdatera en skissdefinition med nya parametrar.

## PARAMETERS

### -BlueprintFile
Sökväg till en Blueprint JSON-fil på disken.
...
### -ManagementGroupId
Hanteringsgrupp-ID där skissdefinitionen finns eller kommer att sparas.
...
### -SubscriptionId
Prenumerations-ID där skissdefinitionen finns eller kommer att sparas.
