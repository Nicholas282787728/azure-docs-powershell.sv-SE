...
## BESKRIVNING
Få en eller flera skissdefinitioner. Skissdefinitioner finns i hanteringsgruppen eller prenumerationsomfånget.
...
Få skissdefinitioner i den aktuella prenumerationen och hierarkin för hanteringsgruppen för prenumerationen.
...
Hämta skissdefinitionerna i den angivna hanteringsgruppen.
...
Få skissdefinitioner inom den angivna prenumerationen och hierarkin för hanteringsgruppen för prenumerationen.
...
Hämta skissdefinitionen med det givna namnet i den angivna prenumerationen.
...
Hämta skissdefinitionen med det givna namnet och versionen inom den angivna hanteringsgruppen.
...
Hämta den senaste publicerade skissdefinitionen med det angivna namnet i den angivna hanteringsgruppen.
...
### -LatestPublished
Den senaste publicerade skissdefinitionsflaggan.
När den anges returneras den senaste publicerade versionen av skissdefinitionen vid körning.
...
### -ManagementGroupId
Grupp-ID för hantering där skissdefinitionen sparas.
...
### -SubscriptionId
Prenumerations-ID där skissdefinitionen sparas.
...
### -Version
Publicerade skissdefinitionsversion.
