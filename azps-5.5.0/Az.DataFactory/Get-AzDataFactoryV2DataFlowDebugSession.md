...
## BESKRIVNING
Lista alla aktiva felsökningssessioner för dataflöde av Azure Data Factory med information.
...
Hämta alla aktiva felsökningssessioner för dataflöde i Azure Data Factory "WikiADF".
