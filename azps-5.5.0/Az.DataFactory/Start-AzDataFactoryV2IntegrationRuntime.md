...
## BESKRIVNING
**Cmdleten Start-AzDataFactoryV2IntegrationRuntime** startar en hanterad dedikerad integrationskörning. Resursen etableras och efter åtgärden är statusen Startad.

## EXEMPEL

### Exempel 1: Starta en integrationskörning
```
...
Den här cmdleten startar en hanterad dedikerad integrationskörning med namnet "test-dedicated-ir".
