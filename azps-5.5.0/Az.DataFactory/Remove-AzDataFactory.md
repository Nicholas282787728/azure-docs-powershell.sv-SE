...
## BESKRIVNING
Cmdleten **Remove-AzDataFactory** tar bort en data factory.

## EXEMPEL

### Exempel 1: Ta bort en data factory
```
...
Med det här kommandot tas datakällan med namnet WikiADF bort från resursgruppen ADF.
Det här kommandot returnerar värdet $True.

## PARAMETERS

### -DataFactory
Anger vilket **PSDataFactory-objekt** som ska tas bort.
...
### -Force
Anger att den här cmdleten tar bort en data factory utan att du uppmanas att bekräfta.
...
### -Name
Anger namnet på den data factory som ska tas bort.
...
Den här cmdleten tar bort en data factory från gruppen som den här parametern anger.
