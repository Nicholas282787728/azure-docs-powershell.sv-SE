...
## BESKRIVNING
Cmdleten **Remove-AzDataFactoryV2Tfactorer** tar bort en utlösare från en data factory. Om _force-parametern_ anges uppmanas inte cmdleten innan utlösaren tas bort.
...
Ta bort en utlösare med namnet "ScheduledTlfer" från data factory "WikiADF".
...
### -InputObject
Utlösarobjektet som ska tas bort.
