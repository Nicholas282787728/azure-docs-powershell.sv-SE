...
## BESKRIVNING
Cmdleten **New-AzDataFactoryV2IntegrationRuntimeKey** återskapar integrationskörningsnyckeln med nyckelnamnet som anges av parametern "KeyName". Föregående nyckel är ogiltig.

## EXEMPEL

### Exempel 1: Generera en ny nyckel för en integrationskörning
```
...
Cmdleten återskapar nyckeln 'authKey2' för integration runtime som heter "test-selfhost-ir".
...
### -KeyName
Autentiseringsnyckelnamnet för den själv värdbaserade integrationskörningen.
