...
## BESKRIVNING
**Cmdleten Get-AzDataFactoryV2IntegrationRuntimeNode** hämtar detaljinformationen för en körningsnod för integrering.

## EXEMPEL

### Exempel 1: Hämtar detaljinformationen för en körningsnod för integrering.
```
...
Cmdleten hämtar information om noden som heter "Node_1" i körningskörning för självvärdig integrering av test-selfhost-ir i Data Factory test-df-eu2.

### Exempel 2: Hämtar detaljinformationen för en körningsnod för integrering tillsammans med IP-adress.
```
...
Cmdleten får information om noden som heter "Node_1" i körningskörning för självvärdig integrering av test-selfhost-ir i Data Factory "test-df-eu2", inklusive IP-adressen.
...
### -IpAddress
IP-adressen för körningsnod för integrering.
...
### -Name
Namn på integrationskörningsnod.
