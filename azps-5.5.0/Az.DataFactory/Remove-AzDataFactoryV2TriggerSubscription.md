...
## BESKRIVNING
Det här kommandot avslutar händelseutlösaren för de angivna externa tjänsthändelserna från utlösaren.
...
Med det här kommandot avbryts BlobEnetT azure-utlösare för angivna händelser från avslutsutlösaren.
...
### -PassThru
Om detta anges returnerar cmdleten sant vid lyckad borttagning.
