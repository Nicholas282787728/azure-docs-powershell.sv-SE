...
## BESKRIVNING
Cmdleten **Update-AzDataFactoryV2** uppdaterar taggar eller identitetsegenskaper för en data factory.
...
Med det här kommandot uppdateras taggarna för wikiADF till en ordlista med taggen myNewTagName med värdet myTagValue.
