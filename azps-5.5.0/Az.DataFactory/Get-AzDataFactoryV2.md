...
## BESKRIVNING
Den Get-AzDataFactoryV2 cmdleten hämtar information om datafaktorer i en Azure-resursgrupp.
...
Visar information om alla datafaktorer i Azure-prenumerationen.
...
Det här kommandot visar information om data factoryn med namnet WikiADF i prenumerationen för resursgruppen som heter ADF och lagrar den sedan i $DataFactory variabeln.
Ange datafaktorparametern i efterföljande cmdlets om du vill använda data factoryen som lagras i $DataFactory.
...
Den här cmdleten hämtar information om datafaktorer som tillhör gruppen som parametern anger.
