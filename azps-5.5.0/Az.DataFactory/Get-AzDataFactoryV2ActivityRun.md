...
## BESKRIVNING
Cmdleten **Get-AzDataFactoryV2ActivityRun** får information om körningar i Azure Data Factory för den angivna pipelinekörningen som inträffade inom den angivna tidsperioden. Dessutom kan du ange filter för aktivitetsnamn, länkat tjänstnamn som körde körningen och status för körningen.

## EXEMPEL

### Exempel 1: Få all aktivitet att köras för en pipeline
```
...
Med det här kommandot får du information om all aktivitet som körs i pipelinen med ID "f288712d-fb08-4cb8-96ef-82d3b9b30621" som hände mellan "2017-09-01" och "2017-09-30".
...
### -RunStartedAfter
Den tid vid eller efter vilken pipelinen kördes.
...
### -RunStartedBefore
Den tid vid eller före vilken pipelinen kördes.
