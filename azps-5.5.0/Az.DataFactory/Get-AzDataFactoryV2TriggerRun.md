...
## BESKRIVNING
Kommandot **Get-AzDataFactoryV2TfactorerRun** returnerar detaljerad information om utlösare som körs för den angivna utlösaren inom en viss tidsperiod.

## EXEMPEL

### Exempel 1: Få information om utlösarkörning
```
...
Det här kommandot visar information om körningar för "WikiT wikipediaer" i fabriksyte "WikiADF" som startades mellan "2017-09-01" och "2019-09-30".
...
Den tid vid eller efter vilken utlösarkörningen började köras i ISO8601-format.
...
Tiden vid eller före vilken utlösarkörningen började köras i ISO8601-format.
...
### Microsoft.Azure.Commands.DataFactoryV2.Models.PSTanläggningenerRun
