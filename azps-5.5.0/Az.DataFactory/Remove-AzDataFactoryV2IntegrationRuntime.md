...
## BESKRIVNING
Med Remove-AzDataFactoryV2IntegrationRuntime-cmdleten tas en integrationskörning bort.

## EXEMPEL

### Exempel 1: Ta bort en integrationskörning
```
...
Det här kommandot tar bort integrationskörningen med namnet "test-reserved-ir" från data factory med namnet "test-df".
...
Det länkade data factory-namnet.
