...
ms.locfileid: "100215119"
---
# Invoke-AzDataFactoryV2TriggerRun

## SYNOPSIS
 Anropar en annan instans av en utlösare som körs.
...
## BESKRIVNING
Kommandot **Invoke-AzDataFactoryV2TfactorerRun** startar en annan instans av en utlösare med ett nytt körnings-ID för utlösare.
...
```
Startar en annan instans av en utlösare med ett nytt körnings-ID för utlösare som behåller samma windowStartTime och windowEndTime som den ursprungliga utlösaren körs.
...
### -InputObject
Informationen om utlösaren körs.
...
### -PassThru
Om du har angett att cmdleten skriv sant vid varje fel lyckas.
