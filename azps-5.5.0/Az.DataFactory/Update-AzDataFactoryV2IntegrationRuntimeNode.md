...
## BESKRIVNING
Cmdleten **Update-AzDataFactoryV2IntegrationRuntimeNode** uppdaterar egenskaper för körningsnod med själv värdbaserade integreringar i en data factory. Har för närvarande endast stöd för uppdatering av SamtidigAAvgränsning.

## EXEMPEL

### Exempel 1: Uppdateringar med körningsnod för självvärdig integration
```
...
Cmdleten uppdaterar "Concurrent Engström" till 3 för nod "Node_1" i självvärdig integration runtime test-selfhost-ir.

## PARAMETERS

### -ConcurrentLowsLimit
Antalet samtidiga jobb som tillåts köras på integrationskörningsnoden.
Värden mellan 1 och maxConcurrent Engström är tillåtna.
