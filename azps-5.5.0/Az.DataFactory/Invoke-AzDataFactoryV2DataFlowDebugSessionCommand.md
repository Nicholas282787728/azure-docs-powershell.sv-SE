...
## BESKRIVNING
Det här kommandot kör förhandsgranskning/förhandsgranskning av statistik/uttryck för olika dataflöden i felsökningssession.
PowerShell-kommandosekvensen för felsökning av dataflöde bör vara:
1. Start-AzDataFactoryV2DataFlowDebugSession
1. Add-AzDataFactoryV2DataFlowDebugSessionPackage
1. Invoke-AzDataFactoryV2DataFlowDebugSessionCommand (upprepa det här steget för olika kommandon/mål eller upprepa steg 2-3 för att ändra paketfilen)
...
Det här exemplet anropar kommandot för dataförhandsgranskning för felsökningssessionen "fd76cd0d-8b37-4dc0-a370-3f9d43ac686d" i data factory "WiKiADF" och konverterar sedan JSON-utdata till läsbar sträng.
...
### -Kolumner
Kolumnlistan för förhandsgranskning av dataflödesstatistik.
...
### -Kommando
Kommandot För felsökning av dataflöde. Valfritt är executePreviewQuery, executeStatisticsQuery och executeExpressionQuery
...
### -Expression
Uttrycket för förhandsgranskning av dataflödesuttryck.
...
### -RowLimits
Radgränsen för förhandsgranskning av dataflödesdata.
...
### -SessionId
Sessions-ID för felsökning av dataflöde.
...
### -StreamName
Dataflödets namn för strömmen för felsökning.
...
## ANTECKNINGAR
Nyckelord: azure, azurerm, arm, resource, management, manager, data, factoriesKeywords: azure, azurerm, arm, resource, management, manager, data, factories
