...
## BESKRIVNING
Cmdleten **Update-AzDataFactoryV2IntegrationRuntime** uppdaterar integrationsegenskaper vid körning. För närvarande stöder cmdleten endast uppdatering av AutoUpdate och AutoUpdateDelayOffset för själv värdbaserade integrationskörningar.

## EXEMPEL

### Exempel 1: Uppdaterar en integrationskörning
```
...
Tiden i timmen på dagen för automatisk uppdatering av den självvärdiga integreringen.
