...
### Exempel 1: Ange beskrivningen för en gateway
```
...
Det här kommandot anger en beskrivning för gatewayen ContosoGateway i data factory med namnet WikiADF.
Beskrivningsparametern anger den nya beskrivningen.

## PARAMETERS

### -DataFactory
Anger ett **PSDataFactory-objekt.**
Den här cmdleten anger beskrivningen för gatewayen i data factoryn som den här parametern anger.
...
### -Beskrivning
Anger en beskrivning för gatewayen.
...
### -Name
Anger namnet på gatewayen som du vill ange en beskrivning för.
...
Den här cmdleten anger beskrivningen för en gateway som tillhör gruppen som den här parametern anger.
