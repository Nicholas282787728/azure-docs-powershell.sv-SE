...
## BESKRIVNING
Med Remove-AzDataFactoryV2Pipeline-cmdleten tas en pipeline bort från Azure Data Factory.

## EXEMPEL

### Exempel 1: Ta bort en pipeline
```
...
Med den här cmdleten tas rörledning med namnet DPWikisample bort från data factory med namnet WikiADF.
...
Den här cmdleten tar bort en pipeline från data factoryn som den här parametern anger.
...
### -InputObject
Anger ett rörledningsobjekt.
Den här cmdleten tar bort den pipeline som parametern anger.
...
Den här cmdleten tar bort en pipeline från gruppen som den här parametern anger.
...
### -ResourceId
Azure-resurs-ID för den pipeline som ska tas bort.
