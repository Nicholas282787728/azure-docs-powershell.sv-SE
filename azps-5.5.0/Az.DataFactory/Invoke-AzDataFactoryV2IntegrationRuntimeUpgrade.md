...
## BESKRIVNING
Cmdleten **Invoke-AzDataFactoryV2IntegrationRuntimeUpgrade** uppgraderar integrering med självvärdig körning om den nya versionen är tillgänglig.

## EXEMPEL

### Exempel 1: Uppgraderar en självbetjänad integration runtime
```
...
Cmdleten uppgraderar fristående integrering runtime med namnet "test-selfhost-ir" i Data Factory test-df-eu2.
