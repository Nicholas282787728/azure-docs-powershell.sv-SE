...
## BESKRIVNING
Det här kommandot får statusen för prenumerationen för händelseutlösaren till de angivna externa tjänsthändelserna. Utlösaren kan inte startas förrän den returnerade statusen är "Aktiverad".
...
Det här kommandot hämtar status för underscribtion för BlobEnetTservice1-utlösare för de externa tjänsthändelserna.
