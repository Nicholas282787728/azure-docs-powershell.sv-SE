...
## BESKRIVNING
Den Get-AzDataFactoryV2Dataset cmdleten hämtar information om datauppsättningar i Azure Data Factory.
...
### -Name
Anger namnet på den datauppsättning som du vill hämta information om.
