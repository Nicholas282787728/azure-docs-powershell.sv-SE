...
## BESKRIVNING
Cmdleten **Set-AzDataFactoryV2** skapar en datakälla med angiven resursgruppsnamn och -plats.
Utför följande åtgärder i följande ordning: -- Skapa en data factory.
...
### Exempel 1: Skapa en data factory
```
...
### Exempel 2: Skapa en data factory med konfigurationsinformation för lagringsplatsen med ett befintligt fabriksobjekt.
```
...
Det här kommandot skapar en datakälla med namnet WikiADF i resursgruppen ADF på EastUS-platsen med Azure DevOps-källkontrollkonfigurationen.

### Exempel 3: Skapa en data factory med Konfigurationsinformation för GitHub-lagringsplatsen med ett nytt fabriksobjekt.
```
...
Med det här kommandot skapas en datakälla med namnet WikiADF i resursgruppen ADF på EastUS-platsen med GitHub-källkontrollkonfigurationen.

## PARAMETERS

### -AccountName
Kontonamnet för lagringsplatsens konfiguration.
...
### -CollaborationBranch
Samarbetsgrenen för lagringsplatsens konfiguration.
...
Ordlistan som innehåller de globala parametrarna i data factory.
...
### -HostName
Värdnamnet för GitHub-lagringskonfigurationen.
...
### -LastCommitId
Det senaste bekräfta id:t för lagringsplatsens konfiguration.
...
### -Plats
Data factory skapas i den här regionen.
...
### -Projektnamn
Projektnamnet Azure DevOps för lagringsplatsens konfiguration.
...
### -RepositoryName
Lagringsplatsnamnet för lagringsplatsens konfiguration.
...
### -ResourceId
Azure-resurs-ID för V2-data factory.
...
### -RootFolder
Rotmappen för konfiguration av lagringsplatsen.
...
### -TenantId
Klientorganisations-ID för konfiguration av Azure DevOps-lagringsplatsen.
