...
## BESKRIVNING
Cmdleten **New-AzDataFactoryHub** skapar ett nav för Azure Data Factory i den angivna Azure-resursgruppen och i den angivna data factoryen med den angivna fildefinitionen.
När du har skapat navet kan du använda det för att lagra och hantera länkade tjänster i en grupp, och du kan lägga till pipelines i navet.
...
Det här kommandot skapar ett nav med namnet ContosoDataHub i resursgruppen ADFResourceGroup och data factoryen ADFDataFactory.

## PARAMETERS

### -DataFactory
Anger ett **PSDataFactory-objekt.**
Den här cmdleten skapar ett nav för data factoryn som den här parametern anger.
...
### -Arkiv
Anger den fullständiga sökvägen till JavaScript Object Notation-filen (JSON) som innehåller beskrivningen av navet.
...
### -Force
Anger att denna cmdlet ersätter ett befintligt nav utan att du uppmanas att bekräfta.
...
Den här cmdleten skapar ett nav som tillhör gruppen som parametern anger.
