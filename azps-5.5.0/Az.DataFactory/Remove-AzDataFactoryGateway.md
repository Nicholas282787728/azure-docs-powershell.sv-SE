...
## BESKRIVNING
Cmdleten **Remove-AzDataFactoryGateway** tar bort den angivna gatewayen från Azure Data Factory.
...
Det här kommandot tar bort gatewayen ContosoGateway från data factory med namnet WikiADF.

## PARAMETERS

### -DataFactory
Anger ett **PSDataFactory-objekt.**
Den här cmdleten tar bort en gateway från data factoryn som parametern anger.
...
### -Force
Anger att denna cmdlet tar bort en gateway utan att du uppmanas att bekräfta.
...
### -Name
Anger namnet på gatewayen som ska tas bort.
...
Med den här cmdleten tar du bort en gateway som tillhör den grupp som parametern anger.
