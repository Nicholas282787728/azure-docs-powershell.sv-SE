...
## BESKRIVNING
Med Get-AzDataFactoryV2IntegrationRuntimeMetric-cmdleten får du mätdata om integrationskörning i en data factory.

## EXEMPEL

### Exempel 1: Hämta körningsmått för integrering
```
...
Det här kommandot visar mätdata om integrationskörningen med namnet "test-selfhost-ir" i prenumerationen för resursgruppen som heter 'rg-test-dfv2' och data factory med namnet 'test-df-eu2'.
