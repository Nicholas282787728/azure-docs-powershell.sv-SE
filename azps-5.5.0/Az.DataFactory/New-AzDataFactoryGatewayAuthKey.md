...
## BESKRIVNING
Cmdleten **New-AzDataFactoryGatewayAuthKey** skapar en gatewayauthnyckel för en viss Azure Data Factory-gateway.
Du registrerar gatewayen i en molntjänst med hjälp av den här nyckeln.

## EXEMPEL

### Exempel 1: Skapar en gatewayauthnyckel för Key1
```
...
Med det här kommandot skapas en gatewayauthnyckel av Key1 för Data Factory-gatewayen med namnet MyGateway.
...
### -GatewayName
Namnet på Data Factory Gateway.
...
### -KeyName
Namnet på gatewayauthnyckeln som ska återskapas, antingen "key1" eller "key2".
