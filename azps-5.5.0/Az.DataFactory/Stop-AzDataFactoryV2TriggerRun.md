...
ms.locfileid: "100228886"
---
# Stop-AzDataFactoryV2TriggerRun

## SYNOPSIS
Stoppar en utlösare som körs i en data factory.
...
## BESKRIVNING
Cmdleten **Stop-AzDataFactoryV2Trun stoppar** en utlösarkörning i en data factory som angetts med utlösarnamnet och kör-ID för utlösare.
Stöds för närvarande endast för TumlarWindowTlinders i WaitingOnDependency State.
...
Det här kommandot avbryter körningen av utlösaren med ID '08586002468005888497807248799CU16' i fabriks-WikiADF.
