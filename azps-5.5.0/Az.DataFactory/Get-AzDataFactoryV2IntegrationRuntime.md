...
## BESKRIVNING
Med Get-AzDataFactoryV2IntegrationRuntime-cmdleten får du information om integrationskörningar i en data factory.
Om du anger namnet på en integrationskörning får den här cmdleten information om den integrationskörningen.
Om du inte anger ett namn hämtar den här cmdleten information om alla integrationskörningar i en data factory.

## EXEMPEL

### Exempel 1: Lista alla integrationskörningar i en data factory
```
...
Lista alla integrationskörningar i datakällan "test-df-eu2".

### Exempel 2: Få dedikerad integrationskörning
```
...
Det här kommandot visar information om integrationskörningen med namnet "test-dedicated-ir" i prenumerationen för resursgruppen som heter "rg-test-dfv2" och data factory med namnet "test-df-eu2".

### Exempel 3: Få dedikerad körning av hanterad integrering med detaljerad status
```
...
### Exempel 4: Få körning för själv värdbaserade integreringar
```
...
### Exempel 5: Få körning med själv värdbaserade integreringar med detaljstatus
```
