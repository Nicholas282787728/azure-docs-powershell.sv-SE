...
## BESKRIVNING
Det här kommandot bifogar dataflödesresurs och dess beroenden till den specifika felsökningssessionen PowerShell-kommandosekvensen för felsökning av dataflöde ska vara:
...
Lägg till dataflödespaket i felsökningssessionen "550effe4-93a3-485c-8525-eaf25259efbd" av "WikiADF"-data factory.
Pakcage-filen innehåller felsökningsresurs för dataflöde, lista med datauppsättningsfelsökning, lista över länkad tjänstfelsökningsresurs, felsökningsinställning och sessions-ID. Till exempel:
...
SessionID-parametern används för att ersätta den befintliga sessionsidegenskapen i paketfilen.
