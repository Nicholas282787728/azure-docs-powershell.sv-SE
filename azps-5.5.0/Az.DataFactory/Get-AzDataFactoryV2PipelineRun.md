...
## BESKRIVNING
Kommandot **Get-AzDataFactoryV2PipelineRun returnerar** information om körningar för den angivna pipelinen. Om PipelineRunId har angetts visas information om körningen med det ID:t. Om PipelineRunId inte har angetts visas information om alla körningar för pipelines som inträffade mellan värdena för LastUpdatedAfter och LastUpdatedBefore.

## EXEMPEL

### Exempel 1: Hämta information om en rörledning
```
...
### -LastUpdatedAfter
Tiden då eller efter vilken rörledningskörningen uppdaterades i ISO8601-format.
...
### -LastUpdatedBefore
Tidpunkten då eller före vilken rörledningskörningen uppdaterades i ISO8601-format.
