...
## BESKRIVNING
Cmdleten **Sync-AzDataFactoryV2IntegrationRuntimeCredential** synkroniserar lokala autentiseringsuppgifter mellan integrationskörningsnoder, vilket tvingar autentiseringsuppgifterna att vara identiska i alla noder.

## EXEMPEL

### Exempel 1: Synkronisera en körningskörning för integrering

Synkroniserar autentiseringsuppgifter mellan körningsnoder för integrering. (autogenererat)
