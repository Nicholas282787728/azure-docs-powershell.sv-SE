...
### Exempel 1: Skaffa Spring Cloud App Deploymeng efter namn.
```powershell
...
Skaffa Spring Cloud App Deploymeng efter namn.

### Exempel 2: Lista alla distributioner under en viss vårmolnapp.
```powershell
...
Lista all distribution under ett visst vårmolnapp.
...
### -Version
Distributionsversion som ska listas
