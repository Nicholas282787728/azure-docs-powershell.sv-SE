...
### Exempel 1: Hämta Spring Cloud-appen efter namn.
```powershell
...
Skaffa Spring Cloud-appen efter namn.

### Exempel 2: Lista alla appar under en viss vårmolntjänst.
```powershell
...
Lista alla appar under en viss vårmolntjänst.
