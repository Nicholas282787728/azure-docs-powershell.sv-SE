...
ms.locfileid: "100216366"
---
# Remove-AzAppConfigurationStore

## SYNOPSIS
Tar bort ett konfigurationsarkiv.
...
### Exempel 1: Ta bort en appkonfigurationsbutik
```powershell
PS C:\> Remove-AzAppConfigurationStore -Name appconfig-test03 -ResourceGroupName lucas-manual-test

```

Med det här kommandot tas en appkonfigurationsbutik bort.

### Exempel 2: Ta bort en appkonfigurationsbutik
```powershell
