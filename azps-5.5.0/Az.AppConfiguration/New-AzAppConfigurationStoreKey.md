...
ms.locfileid: "100216367"
---
# New-AzAppConfigurationStoreKey

## SYNOPSIS
Återskapar en åtkomstnyckel för det angivna konfigurationsarkivet.
...
### Exempel 1: Generera nyckel för en appkonfigurationsbutik
```powershell
...
Det här kommandot återskapar nyckeln för en appkonfigurationsbutik.

### Exempel 2: Återskapa nyckeln för en appkonfigurationsbutik per objekt
```powershell
...
Det här kommandot återskapar nyckeln för en appkonfigurationsbutik per objekt.
