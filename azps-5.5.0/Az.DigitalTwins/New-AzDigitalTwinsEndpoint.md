...
### Exempel 1: Skapa ett AzDigitalTwinsEndpoint för Eventhub
```powershell
...
Skapa ett AzDigitalTwinsEndpoint för Eventhub med connectionStringPrimaryKey

### Exempel 2: Skapa ett AzDigitalTwinsEndpoint för EventGrid
```powershell
...
Skapa ett azDigitalTwinsEndpoint för Eventhub efter TopicEndpoint och accessKey1

### Exempel 3: Skapa ett AzDigitalTwinsEndpoint för ServiceBus
```powershell
...
Skapa ett AzDigitalTwinsEndpoint for ServicBus by PrimaryConnectionString
...
### -DeadLetterSecret
Hemlig lagringshemlighet.
Kommer att visas under läsningen.
...
### -EndpointDescription
Slutpunktsresursen DigitalTwinsInstance.
Skapa genom att gå till avsnittet ANTECKNINGAR för ENDPOINTDESCRIPTION-egenskaper och skapa en hash-tabell.
...
### -EndpointType
Typen av slutpunkt för Digital Id 100
...
ENDPOINTDESCRIPTION <IDigitalTwinsEndpointResource> : DigitalTwinsInstance-slutpunktsresurs.
  - `EndpointType <EndpointType>`: Typen av slutpunkt för Digital Endpoints
  - `[DeadLetterSecret <String>]`: Lagringshemlighet från ett privat brev. Kommer att visas under läsningen.
