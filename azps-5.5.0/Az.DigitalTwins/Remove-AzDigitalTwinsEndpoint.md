...
### Exempel 1: Delete the azDigitalTwinsEndPoint by EndPointName
```powershell
...
Ta bort azDigitalTwinsEndPoint by EndPointName ResourceGroupName och ResourceName

### Exempel 2: Delete the azDigitalTwinsEndPoint by Object
```powershell
...
Ta bort azDigitalTwinsEndPoint by Object
