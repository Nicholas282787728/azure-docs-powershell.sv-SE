...
## BESKRIVNING
Cmdleten **Set-AzServiceBusRule** uppdaterar beskrivningen för den angivna regeln för den givna prenumerationen.
...
Uppdaterar **sql-uttrycket mysqlexpression='condition'** för regeln `SBRule` i prenumerationen i `SBSubscription` Topic `SBTopic`
...
### -InputObject
Definition av ServiceBus-regler.
