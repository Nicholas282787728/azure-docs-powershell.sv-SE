...
## BESKRIVNING
Cmdleten **New-AzServiceBusRule** Skapar en ny regel för en viss prenumeration.
...
Den New-AzServiceBusRule cmdleten skapar en ny regel för den angivna prenumerationen.
...
Med New-AzServiceBusRule-cmdleten skapas en ny regel för den angivna prenumerationen med ActionFilter.

## PARAMETERS

### -ActionSqlExpression
SqlFilter-uttryck för Åtgärd
