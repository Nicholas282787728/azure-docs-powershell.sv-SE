...
## BESKRIVNING
Cmdleten **Test-AzServiceBusName** kontrollerar tillgängligheten för namnområdets namn eller alias (DR-konfigurationsnamn)
...
Returnerar statusen för tillgängligheten för namnområdets namn "MittNamnSapceName" som Sant
