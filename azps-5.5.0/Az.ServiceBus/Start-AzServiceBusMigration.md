...
## BESKRIVNING
Cmdleten **Start-AzServiceBusMigration** skapar en ny migreringskonfiguration och börjar migrera enheter från Standard till Premium-namnområden
...
Skapar en ny migreringskonfiguration för "TestingNamespaceStandardMigration" till "TestingNamespacePremiumMigration"-namnområden
...
### -PostMigrationName
Efter migreringens namn för standardnamnområdet i migrering
