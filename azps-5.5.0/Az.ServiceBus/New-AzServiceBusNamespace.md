...
## BESKRIVNING
Cmdleten **New-AzServiceBusNamespace** skapar ett nytt Service Bus-namnområde. När den har skapats är namnområdesresursmanifestet oföränderligt. Den här åtgärden är idem operation.
...
Skapar ett nytt namnområde för Service Bus i den angivna resursgruppen.
...
### -SkuCapacity
Service Bus premium-namnområdets namnområdesenheter, tillåtna värden 1 eller 2 eller 4
...
### -SKUName
SKU-namnet på Service Bus-namnområdet.
