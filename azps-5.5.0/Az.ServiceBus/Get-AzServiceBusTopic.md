...
## BESKRIVNING
Cmdleten **Get-AzServiceBusTopic** returnerar en ämnesbeskrivning för angivet Service Bus-namnområde.
...
Returnerar beskrivningen av det angivna avsnittet för det angivna Service Bus-namnområdet.
...
Returnerar en lista över ämnen för det angivna service busnamnområdet. Som standard returneras 100 ämnen. Använd -MaxCount-parameter om fler än 100 ämnen ska returneras.
...
Returnerar listan över de första 150 avsnitten för ett visst Service Bus-namnområde.
...
### -MaxCount
Fastställ det maximala antalet ämnen som ska returneras.
