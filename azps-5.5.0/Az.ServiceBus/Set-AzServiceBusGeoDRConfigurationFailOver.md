...
## BESKRIVNING
Cmdleten **Set-AzServiceBusGeoDRConfigurationFailOver** anropar GEO DR-redundans och konfigurerar om aliaset så att det pekar på det sekundära namnområdet
...
Anropar redundans över alias "SampleDRConfigName", konfigureras om och pekar på sekundärt namnområde "SampleNamespace_Secondary"
...
### -Namespace
Namnområdesnamn – sekundärt namnområde
