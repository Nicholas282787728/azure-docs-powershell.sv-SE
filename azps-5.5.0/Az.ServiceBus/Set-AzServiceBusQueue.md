...
## BESKRIVNING
Cmdleten **Set-AzServiceBusQueue** uppdaterar beskrivningen för kön Service bus i det angivna service busnamnområdet.
...
Uppdaterar den angivna kön med en ny beskrivning i det angivna namnområdet. I det här exemplet **uppdateras egenskapen DeadLetteringOnMessageExpiration** **till True** och **SupportOrdering** till **true.**
