...
## BESKRIVNING
Cmdlet:arna **Complete-AzServiceBusMigration** ställer in migreringen från Standard till premiumnamnområdet som komplett och anslutningssträngar i standardnamnområdet pekar nu på Premium-namnområdet
...
Anger migreringen av namnområdet StandardMigration som slutförd.
...
### -InputObject
Konfiguration av tjänst busmigrering – Standard Namespace-objekt
