...
ms.locfileid: "100253049"
---
# New-AzServiceBusAuthorizationRuleSASToken

## SYNOPSIS
Genererar en SAS-tolen för Azure servicebus-auktoriseringsregel för namnområde/kö/ämne. 
...
## BESKRIVNING
Cmdlet New-AzServiceBusAuthorizationRuleSASToken genererar en SAS-token (Shared Access Signature) för en Azure Eventhub-namneapce eller Azure Eventhub
