...
## BESKRIVNING
Cmdleten **New-AzServiceBusAuthorizationRule** skapar en ny auktoriseringsregel för det angivna service busnamnområdet eller kön eller ämnet.
...
Skapar `AuthoRule1` med **behörigheten** **Lyssna** och Skicka för `SB-Example1` namnområdet.
...
Skapar `AuthoRule1` med **behörigheten** **Lyssna och** Skicka för `SBQueue` kön.
...
Skapar `AuthoRule1` med **lyssna** och **skicka** rättigheter för `SBTopic` ämnet.
