...
## BESKRIVNING
Cmdleten **Remove-AzServiceBusNamespace** tar bort namnområdet från den angivna resursgruppen.
...
Tar bort namnområdet Service bus `SB-Example1` från den angivna `Default-ServiceBus-WestUS` resursgruppen.

### Exempel 2.1 – InputObject – Med variabel:
```
PS C:\> $inputobject = Get-AzServiceBusNamespace <params>
PS C:\> Remove-AzServiceBusNamespace -InputObject $inputobject
```

Tar bort namnområdet för Service Bus som visas via $inputobject.

### Exempel 2.2 – InputObject – med rörledning:
```
PS C:\> Get-AzServiceBusNamespace <params> | Remove-AzServiceBusNamespace
```

Tar bort namnområdet för Service bus med Piping.
...
Tar bort namnområdet för Service Bus som tillhandahålls via ARM-ID i $resourceid -ResourceId-parameter eller via rörning.
