...
## BESKRIVNING
Cmdleten **Set-AzServiceBusGeoDRConfigurationBreakPair** inaktiverar Katastrofåterställning och slutar replikera ändringar från primära till sekundära namnområden
