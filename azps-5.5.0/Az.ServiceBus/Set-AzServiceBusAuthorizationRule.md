...
## BESKRIVNING
Cmdleten **Set-AzServiceBusAuthorizationRule** uppdaterar beskrivningen för den angivna auktoriseringsregeln i det givna servicebusnamnområdet eller kön eller ämnet.
...
Tar bort **Hantera** från åtkomstbehörigheten för auktoriseringsregeln `AuthoRule1` i `SB-Example1` namnområdet.
...
Tar bort **Hantera** från åtkomstbehörigheten för auktoriseringsregeln `AuthoRule1` i `SBQueue` kön.
...
Tar bort **Hantera** från åtkomstbehörigheten för auktoriseringsregeln `AuthoRule1` i `SBTopic` avsnittet.
