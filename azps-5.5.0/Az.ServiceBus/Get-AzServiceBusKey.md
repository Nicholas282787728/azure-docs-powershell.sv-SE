...
## BESKRIVNING
Cmdleten **Get-AzServiceBusKey** returnerar de primära och sekundära anslutningssträngarna för det angivna namnområdet eller kön eller ämne eller alias (GeoDR-konfigurationer).
...
Primär och sekundär anslutningssträng till det angivna namnområdet.
...
Primär och sekundär anslutningssträng till den angivna kön.
...
Primär och sekundär anslutningssträng till det angivna ämnet.
...
Primär och sekundär anslutningssträng till angivet namnområde och alias.
