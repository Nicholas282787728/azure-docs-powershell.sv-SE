...
ms.locfileid: "100235671"
---
# Remove-AzServiceBusTopic

## SYNOPSIS
Tar bort avsnittet från angivet Service Bus-namnområde.
...
## BESKRIVNING
Cmdleten **Remove-AzServiceBusTopic** tar bort ämnet från det angivna service busnamnområdet.
...
Tar bort ämnet `SB-Topic_exampl1` från `SB-Example1` namnområdet.
...
### Exempel 5: ResourceId using String value
```powershell
