...
## BESKRIVNING
Cmdleten **Set-AzServiceBusSubscription** uppdaterar beskrivningen av prenumerationen för avsnittet Service bus i det angivna service busnamnområdet.
...
Uppdaterar beskrivningen för den angivna prenumerationen på det givna ämnet. I det här exemplet **uppdateras egenskapen DeadLetteringOnMessageExpiration** **till True** och **MaxDeliveryCount** till 9.
...
### -InputObject
Definition av ServiceBus-prenumeration.
