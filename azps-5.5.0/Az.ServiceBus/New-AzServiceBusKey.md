...
ms.locfileid: "100223183"
---
# New-AzServiceBusKey

## SYNOPSIS
Återskapar de primära eller sekundära anslutningssträngarna för Service Bus-namnområdet eller -kön eller ämnet.
...
## BESKRIVNING
Cmdleten **New-AzServiceBusKey** genererar nya primära eller sekundära anslutningssträngar för det angivna namnområdet eller kön eller ämnet och auktoriseringsregeln.
...
Återskapar de primära eller sekundära anslutningssträngarna med an angett nyckelvärde för namnområdet.
...
Återskapar de primära eller sekundära anslutningssträngarna för kön.
...
Återskapar de primära eller sekundära anslutningssträngarna med det angivna nyckelvärdet för kön.
...
Återskapar de primära eller sekundära anslutningssträngarna för ämnet.
...
Återskapar de primära eller sekundära anslutningssträngarna med det angivna nyckelvärdet för ämnet.
