...
## BESKRIVNING
Cmdleten **Set-AzServiceBusNamespace** uppdaterar beskrivningen av det angivna namnområdet för Service Bus i resursgruppen.
...
Uppdaterar namnområdet Service Bus med en ny beskrivning.
...
### -Bekräfta
Uppdaterar namnområdet Service Bus med den angivna informationen.
