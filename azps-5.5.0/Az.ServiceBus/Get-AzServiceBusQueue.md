...
Returnerar listan över köer för det angivna namnområdet. Som standard returneras 100 köer. Använd -MaxCount-parameter om fler än 100 köer ska returneras.
...
Returnerar listan över de första 150 köerna för ett givet namnområde
...
### -MaxCount
Fastställ det maximala antalet köer som ska returneras.
