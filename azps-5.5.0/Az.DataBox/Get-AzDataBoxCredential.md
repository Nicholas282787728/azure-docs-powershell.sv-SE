...
ms.locfileid: "100215206"
---
# Get-AzDataBoxCredential

## SYNOPSIS
Hämtar autentiseringsuppgifterna för datarutan för ett visst jobb
...
## BESKRIVNING
Cmdleten **Get-AzDataBoxCredential** får autentiseringsuppgifterna för datarutan för ett visst jobb. De interna egenskaperna för det returnerade autentiseringsobjektet kommer att vara olika för olika SKU-typer.
...
Det här gör så att jobbsekretsen för det angivna jobbet
...
Det här gör så att jobbsekretsen för det angivna jobbet blir nytt
