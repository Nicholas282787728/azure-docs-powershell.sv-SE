...
### Exempel 1: Visa information om ett programpaket i ett batchkonto
```
...
Det här kommandot hämtar information om version 1.0 av Litware-paketet.

## PARAMETERS

### -AccountName
Anger namnet på det batchkonto som cmdleten hämtar information från.
...
### Microsoft.Azure.Commands.Batkap. Models.PSApplicationPackage
