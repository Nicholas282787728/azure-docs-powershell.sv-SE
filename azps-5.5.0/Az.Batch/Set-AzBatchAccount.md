...
För närvarande kan den här cmdleten bara uppdatera taggar.

## EXEMPEL

### Exempel 1: Uppdatera taggarna för ett batchkonto
```
...
Det här kommandot uppdaterar taggarna på kontot pfuller.

## PARAMETERS

### -AccountName
Anger namnet på det batchkonto som cmdleten uppdaterar.
...
### -ResourceGroupName
Anger resursgruppen för kontot som den här cmdleten uppdaterar.
