...
## BESKRIVNING
Cmdleten **Get-AzBatchPoolStatistic** hämtar livstidsstatistik för alla pooler i det angivna kontot.
Statistik aggregeras över alla pooler som tidigare fanns i kontot, från att kontot skapades till den senaste uppdateringstiden för statistiken.

## EXEMPEL

### Exempel 1: Hämta resursstatistik för alla pooler i ett konto
```
...
Det andra kommandot hämtar statistik för alla pooler i det angivna kontot och lagrar dem sedan på $PoolStatistics.
Det slutliga kommandot visar egenskapen **Resursstatistor** $PoolStatistics.
...
### Microsoft.Azure.Commands.Batkap. Models.PSPoolStatistics
