...
## BESKRIVNING
Cmdleten **Enable-AzBatchChedSchedule** aktiverar ett Azure Batch-jobbschema.
När du har aktiverar ett jobbschema kan jobb skapas enligt det schemat.

## EXEMPEL

### Exempel 1: Aktivera ett jobbschema
```
PS C:\>Enable-AzBatchJobSchedule -Id "JobSchedule17" -BatchContext $Context
```

Det här kommandot aktiverar det jobbschema som har ID-schemaläggning17.
...
### -Id
Anger ID för det jobbschema som cmdleten aktiverar.
