...
Om du vill hämta ett visst certifikat anger du *parametrarna ThumbprintAlgoritm* *och Thumbprint.*
Ange *filterparametern* för att få certifikaten som matchar ett OData-filter (Open Data Protocol).

## EXEMPEL

### Exempel 1: Hämta ett certifikat med thumbprint
```
...
Det här kommandot får ett enda certifikat som har det angivna thumbprintet.
Algoritmen för tumavtryck för certifikat är sha1.
...
Med det här kommandot får du alla certifikat i aktivt tillstånd från batchkontot.
*Filterparametern* anger tillståndet.
...
Om du anger den här parametern får den här cmdleten certifikaten som matchar filtret.
...
### -MaxCount
Anger det maximala antalet certifikat som ska returneras.
...
### -Thumbprint
Anger thumbprintet för certifikatet som den här cmdleten hämtar.
...
### Microsoft.Azure.Commands.Batkap. Models.PSCertificate
