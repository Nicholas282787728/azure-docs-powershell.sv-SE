...
Det här kommandot skapar Litware-programmet i ContosoBatch-kontot.
Programmet innehåller först inga paket.

## PARAMETERS

### -AccountName
Anger namnet på det batchkonto där den här cmdleten lägger till ett program.
...
### Microsoft.Azure.Commands.Batkap. Models.PSApplication
