...
## BESKRIVNING
Cmdleten **Get-AzBatchSupportedImage** får bilder av virtuella maskiner som är tillgängliga i ett Azure Batch-konto.
Ange kontot med hjälp av *batchcontextparametern.*

## EXEMPEL

### Exempel 1: Hämta alla tillgängliga bilder som stöds
...
Det första kommandot får ett Batch-kontokontext som innehåller snabbnycklar för din prenumeration genom att använda **Get-AzBatchAccountKey.**
Kommandot lagrar kontexten i den $Context som ska användas i nästa kommando.
Det andra kommandot hämtar alla tillgängliga bilder som stöds för det Batch-kontot.
...
### -Filter
Anger en OData-filtersats för bilder som stöds.
Om du inte anger ett filter returnerar den här cmdleten alla bilder som batchkontot har stöd för.
...
### -MaxCount
Anger det maximala antalet bilder som kan returneras.
...
### Microsoft.Azure.Commands.Batkap. Models.PSImageInformation
