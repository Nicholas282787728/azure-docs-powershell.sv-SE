...
## BESKRIVNING
Cmdleten **Set-AzBatchComputeNodeUser** ändrar egenskaperna för ett användarkonto på en Azure Batch-beräkningsnod.

## EXEMPEL

### Exempel 1: Uppdatera ett användarkonto
```
...
Det här kommandot ändrar användarkontot PFuller på beräkningsnoden som har det angivna ID:t i poolen med namnet ContosoPool.
Kommandot ändrar kontots lösenord och utgångstid.
...
### -ComputeNodeId
Anger ID för beräkningsnoden som den här cmdleten arbetar på.
...
### -ExpiryTime
Anger utgångstiden för användarkontot.
...
### -Name
Anger namnet på användarkontot som cmdleten ändrar.
...
### -PoolId
Anger ID för poolen som innehåller beräkningsnoden som den här cmdleten arbetar på.
