...
## BESKRIVNING
Cmdleten **Test-AzBatchAutoScale** får resultatet av en automatisk skalningsformel på den angivna poolen.

## EXEMPEL

### Exempel 1: Utvärdera en formel för automatisk skalning i en pool
```
...
Det första kommandot lagrar en formel i $Formula variabeln för användning i exemplet.
Det andra kommandot utvärderar formeln för automatisk skalning på poolen som har ID ContosoPool.
Det slutliga kommandot visar resultatet **med** hjälp av standardsyntaxen för punkt.
...
### -Id
Anger objekt-ID för den pool för vilken automatisk skalning ska testas.
...
### Microsoft.Azure.Commands.Batkap. Models.PSAutoScaleRun
