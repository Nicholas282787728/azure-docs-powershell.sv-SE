...
## BESKRIVNING
Cmdleten **Set-AzBatchApplication** ändrar inställningarna för det angivna Azure Batch-programmet.

## EXEMPEL

### Exempel 1: Uppdatera ett program i ett batchkonto
```powershell
...
Det här kommandot ändrar om Litware-programmet i ContosoBatch-kontot tillåter uppdateringar.
Kommandot ändrar inte standardversionen eller visningsnamnet för programmet.

### Exempel 2

Uppdateringsinställningar för det angivna programmet. (autogenererat)
...
### -AccountName
Anger namnet på det batchkonto för vilket den här cmdleten ändrar ett program.
...
### -AllowUpdates
Anger om paket i programmet kan skrivas över med samma versionssträng.
...
### -DisplayName
Anger programmets visningsnamn.
