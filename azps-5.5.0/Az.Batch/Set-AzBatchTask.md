...
## BESKRIVNING
Cmdleten **Set-AzBatchTask** uppdaterar egenskaperna för en uppgift i Azure Batch-tjänsten.
Använd cmdleten Get-AzBatchTask för att hämta ett **PSCloudTask-objekt.**
...
Det första kommandot hämtar en uppgift med hjälp av **Get-AzBatchTask** och lagrar den sedan $Task variabeln.
De följande två kommandona ändrar villkoren för aktiviteten i $Task.
Det slutliga kommandot uppdaterar batchtjänsten så att den matchar det lokala objektet i $Task.
...
### -Uppgift
Anger den **PSCloudTask som** den här cmdleten uppdaterar batchtjänsten till.
