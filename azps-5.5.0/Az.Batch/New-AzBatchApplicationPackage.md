...
Det här kommandot skapar och aktiverar version 1.0 av Litware-programmet och laddar upp innehållet i litware.1.0.zip som innehåll i programpaketet.

## PARAMETERS

### -AccountName
Anger namnet på det batchkonto där den här cmdleten lägger till ett programpaket.
...
### -FilePath
Anger den fil som ska laddas upp som binär programpaketfil.
...
### -Format
Anger formatet på den binära programpaketets fil.
