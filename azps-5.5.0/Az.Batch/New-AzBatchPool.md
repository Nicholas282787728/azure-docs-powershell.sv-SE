...
## BESKRIVNING
Cmdleten **New-AzBatchPool** skapar en pool i Azure Batch-tjänsten under det konto som anges av *batchcontextparametern.*

## EXEMPEL

### Exempel 1: Skapa en ny pool med hjälp av TargetDedicated-parameteruppsättningen med CloudServiceConfiguration
```
...
Poolen är konfigurerad för att använda STANDARD_D1_V2 virtuella datorer med operativsystemversion av 4.

### Exempel 2: Skapa en ny pool med hjälp av VirtualMachineConfiguration
```
...
Det här kommandot skapar en ny pool med ID MyPool med parameteruppsättningen TargetDedicated.
Måltilldelningen är tre beräkningsnoder.
Poolen är konfigurerad för att STANDARD_D1_V2 virtuella datorer med operativsystemsbilden för Windows-2016-datacenter.
...
Med det här kommandot skapas en ny pool med ID AutoScalePool med parameteruppsättningen Autoskala.
Poolen är konfigurerad för att använda STANDARD_D1_V2 virtuella datorer med operativsystemsbilden för Windows-2016-datacenter, och målnumret för beräkningsnoder bestäms av formeln för automatisk skalning.
...
### -ApplicationLicenses
Listan med programlicenser som batchtjänsten gör tillgänglig för varje beräkningsnod i poolen.
...
Anger hur lång tid som förflutit i minuter innan poolens storlek justeras automatiskt enligt formeln För automatisk skalning.
...
Batchtjänsten installerar certifikaten som refereras på varje beräkningsnod i poolen.
...
Anger att den här cmdleten uppsättningar av poolen för direkt kommunikation mellan dedikerade beräkningsnoder.
...
Anger det maximala antalet aktiviteter som kan köras på en enskild beräkningsnod.
...
### -Metadata
Anger metadata, som nyckel-/värdepar, som ska läggas till i den nya poolen.
...
### -MountConfiguration
En lista med filsystem som ska fästs på varje nod i poolen. Det här har stöd för Azure-filer, NFS, CIFS/SMB och Blobfuse.
...
### -ResizeTimeout
Anger time-out för beräkning av beräkningsnoder till poolen.
...
### -StartTask
Anger startaktivitetsspecifikationen för poolen.
Startaktiviteten körs när en beräkningsnod ansluter till poolen, eller när beräkningsnoden startas om eller börjar om.
...
Anger målnumret för dedikerade beräkningsnoder som ska allokeras till poolen.
...
Anger målnumret för beräkningsnoder med låg prioritet som ska allokeras till poolen.
...
Anger schemaläggningsprincipen för aktiviteter, till exempel ComputeNodeFillType.
...
### -UserAccount
Listan med användarkonton som ska skapas på varje nod i poolen.
...
Anger konfigurationsinställningar för en pool på infrastrukturen för virtuella maskiner.
...
### -VirtualMachineSize
Anger storleken på virtuella datorer i poolen.
Mer information om storlekar för virtuella maskiner finns i Storlekar för virtuella datorer https://azure.microsoft.com/en-us/documentation/articles/virtual-machines-size-specs/ https://azure.microsoft.com/en-us/documentation/articles/virtual-machines-size-specs/) (på Microsoft Azure-webbplatsen.
