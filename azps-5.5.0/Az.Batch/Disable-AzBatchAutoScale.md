...
### Exempel 1: Inaktivera automatisk skalning för en pool
```
PS C:\>Disable-AzBatchAutoScale -Id "MyPool" -BatchContext $Context
```

Det här kommandot inaktiverar automatisk skalning för poolen MyPool.
