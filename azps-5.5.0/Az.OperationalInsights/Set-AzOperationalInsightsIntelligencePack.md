...
## BESKRIVNING
Cmdleten **Set-AzOperationalInsightsIntelligencePack** aktiverar det angivna Intelligence Pack om *Enabled* är inställt på $True och inaktiverar det om *Enabled* är inställt på $False.

## EXEMPEL

### Exempel 1: Ange informationspaket
```
PS C:\>Set-AzOperationalInsightsIntelligencePack -ResourceGroupName "ContosoResourceGroup" -WorkspaceName "ContosoWorkspace" -IntelligencePackName "ContosoWorkspace" -Enabled $True
```

Det här kommandot aktiverar det angivna Intelligence Pack.
...
Anger namnet på Intelligence Pack.
