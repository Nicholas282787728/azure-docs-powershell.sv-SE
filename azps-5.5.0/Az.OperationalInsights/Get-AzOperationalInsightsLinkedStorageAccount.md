...
## BESKRIVNING
Hämta länkat lagringskonto, visa alla länkade lagringskonton när "-DataSourceType" inte har angetts
...
lista länkad lagringsförseningar för arbetsytor {workspace-name}
