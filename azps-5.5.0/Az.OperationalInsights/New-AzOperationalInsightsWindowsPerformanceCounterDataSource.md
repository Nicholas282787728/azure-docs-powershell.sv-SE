...
## BESKRIVNING
Cmdleten **New-AzOperationalInsightsWindowsPerformanceCounterDataSource** lägger till en Windows-datakälla för prestandaräknare för anslutna datorer som kör Windows-operativsystemet.
...
### -UseLegacyCoctor
Använd den äldre insamlaren eller standardinsamlaren.
