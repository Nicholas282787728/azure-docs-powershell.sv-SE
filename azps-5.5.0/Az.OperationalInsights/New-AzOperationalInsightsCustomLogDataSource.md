...
## BESKRIVNING
**Cmdleten New-AzOperationalInsightsCustomLogDataSource** definierar en anpassad princip för loggsamling.
...
### -CustomLogRawJson
Anger den anpassade samlingsprincipen som en obearbetad JavaScript Object Notation-sträng (JSON).
