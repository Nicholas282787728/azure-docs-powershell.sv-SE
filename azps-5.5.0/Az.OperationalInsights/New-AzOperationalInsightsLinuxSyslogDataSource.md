...
## BESKRIVNING
Cmdleten **New-AzOperationalInsightsLinuxSyslogDataSource** lägger till en syslog-datakälla till anslutna Linux-datorer i en arbetsyta.
Azure Operational Insights kan samla in syslog-data.
...
### -CollectAlert
Anger att Operational Insights samlar in aviseringsmeddelanden.
...
### -CollectCritical
Anger att Operational Insights samlar in kritiska meddelanden.
...
### -CollectDebug
Anger att Operational Insights samlar in felsökningsmeddelanden.
...
### -CollectEmergency
Anger att Operational Insights samlar in nödsituationsmeddelanden.
...
### -CollectError
Anger att Operational Insights samlar in felmeddelanden.
...
### -CollectInformational
Anger att Operational Insights samlar in informationsmeddelanden.
...
### -CollectNotice
Anger att Operational Insights samlar in meddelande.
...
### -CollectWarning
Anger att syslogen innehåller varningsmeddelanden.
...
### -Name
Anger ett namn för datakällan. Namnet exponeras inte i Azure Portal och alla strängar kan användas så länge det är unikt.
