...
## BESKRIVNING
Cmdleten **Enable-AzOperationalInsightsLinuxPerformanceCollection** startar en samling prestandaräknare från anslutna Linux-datorer i en arbetsyta.
