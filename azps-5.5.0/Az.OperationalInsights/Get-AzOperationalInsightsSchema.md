...
## BESKRIVNING
Cmdleten **Get-AzOperationalInsightsSchema** returnerar schemat som är kopplat till den angivna arbetsytan i resursgruppen.

## EXEMPEL

### Exempel 1: Hämta scheman för en arbetsyta
```
PS C:\>Get-AzOperationalInsightsSchema -ResourceGroupName "ContosoResourceGroup" -WorkspaceName "ContosoWorkspace"
```

Med det här kommandot får du de scheman som är kopplade till en arbetsyta.
