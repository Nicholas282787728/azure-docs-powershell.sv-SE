...
## BESKRIVNING
Cmdleten **New-AzOperationalInsightsLinuxPerformanceObjectDataSource** lägger till prestandaräknare som Azure Operational Insights samlar in data till alla Linux-datorer i en arbetsyta.
...
### -ResourceGroupName
Anger namnet på en resursgrupp som innehåller Linux-datorer.
...
### -WorkspaceName
Anger namnet på en arbetsyta där denna cmdlet fungerar.
