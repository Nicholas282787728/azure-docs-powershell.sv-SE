...
Uppdatera kluster med egenskaper för nyckelvalv och SKU
...
### -KeyVaultUri
Key Vault Uri, "Purge Protection" och "Soft Delete" måste vara aktiverade för denna keyvault
...
### -SKUName
SKU Name, now can be 'CapacityServeration' only
