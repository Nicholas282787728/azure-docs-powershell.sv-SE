...
## BESKRIVNING
Med **cmdleten New-AzOperationalInsightsApplicationInsightsDataSource** kan du samla in loggar från ett visst Application-Insights program.

## EXEMPEL

### Exempel 1: Skapa datakälla med programinsikter i arbetsyta
```
...
Med det här kommandot skapas en datakälla för programinsikter för ett visst program i en viss arbetsyta för logganalys. Det här gör att loggar kan samla in från ett givet program till arbetsytan med logganalys.

### Exempel 2: Hämta arbetsyteobjekt och skapa datakällan för programinsikter genom programmets resurs-ID
```
...
Det här kommandot visar hur du får ett logganalysarbetsyta och sedan passerar resultatet för att skapa en associerad datakälla för programinsikter genom programmets resurs-ID. 
...
Resursgruppnamnet för det länkade programmet.
...
Det länkade programresurs-ID:t.
...
Prenumerations-ID för det länkade programmet.
...
### -Workspace
Arbetsytan som kommer att innehålla datakällan.
...
### -WorkspaceName
Namnet på den arbetsyta som kommer att innehålla datakällan.
