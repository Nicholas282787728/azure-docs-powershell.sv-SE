...
## BESKRIVNING
Cmdleten **Disable-AzOperationalInsightsIISLogCollection** stoppar en samling med Internet Information Services loggar (IIS) från anslutna datorer i en arbetsyta.
