...
### -ResourceId
Resurs-ID för resursen som ska länkas till arbetsytan.
Det här ska användas för att länka resurser som kräver läsbehörighet
...
Resurs-ID för resursen som ska länkas till arbetsytan.
Det här ska användas för att länka resurser som kräver skrivåtkomst.
Kluster måste ha etableringstillståndet "Lyckades" och giltiga nyckelresursegenskaper.
