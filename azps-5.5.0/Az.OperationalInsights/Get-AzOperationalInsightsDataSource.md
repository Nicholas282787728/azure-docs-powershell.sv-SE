...
## BESKRIVNING
Cmdleten **Get-AzOperationalInsightsDataSource** hämtar datakällor.
Du kan ange en datakälla som ska hämtas.
Du kan filtrera resultatet baserat på typen av datakälla.
...
### -Typ
Anger vilken typ av datakällor som ska hämtas.
...
### -Name
Anger namnet på den datakälla som ska hämtas.
...
### -ResourceGroupName
Anger namnet på en resursgrupp som innehåller de datakällor som ska hämtas.
