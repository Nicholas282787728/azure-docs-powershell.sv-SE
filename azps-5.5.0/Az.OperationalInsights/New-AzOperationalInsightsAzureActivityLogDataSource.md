...
## BESKRIVNING
På New-AzOperationalInsightsAzureActivityLogDataSource du aktivera logganalys för att samla in Azure-aktivitetsloggen från en viss prenumeration.
...
### -BackfillStartTime
Du kan välja att ifylla loggar för en vecka sedan.
