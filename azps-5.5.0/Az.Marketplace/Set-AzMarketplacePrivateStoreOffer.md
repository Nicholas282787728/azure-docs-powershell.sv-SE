...
ms.locfileid: "100214342"
---
# Set-AzMarketplacePrivateStoreOffer

## SYNOPSIS
Uppdaterar eller skapar erbjudande för privat lagring.
...
## BESKRIVNING
Uppdateringar eller skapar erbjudande för privat lagring som har skapats under klientorganisationens omfattning.
...
Skapar erbjudande med privata + offentliga planer för privat lagring som har skapats under innehavaromfattning. 
...
Skapar erbjudande med privata abonnemang endast för privat lagring som har skapats under prenumerations omfattning. 
...
Uppdateringserbjudande med privata + offentliga planer för privat lagring som har skapats under innehavaromfattning. Etag krävs.
...
Uppdateringserbjudande för privat lagring med enbart privata abonnemang som skapats under prenumerationsomfång. Etag krävs.
...
### -ETag
ETag för uppdatering för Azure Marketplace privateStore-erbjudandet
...
Obligatorisk azure Marketplace privateStore-erbjudandes specifika abonnemangs-ID:ns begränsning
