...
### Exempel 1: Skapa en brandväggsregel under en MariaDB
```powershell
...
Med det här kommandot skapas en brandväggsregel under mariadb.

### Exempel 2: Skapa en ny MariaDB-brandväggsregel med -ClientIPAddress.
```powershell
...
Denna cmdlets skapar en MariaDB-brandväggsregel med -ClientIPAddress.

### Exempel 3: Skapa en ny MariaDB-brandväggsregel för att tillåta alla IP-adresser
```powershell
...
Med dessa cmdlets kan du skapa en ny MariaDB-brandväggsregel som tillåter alla IP-adresser.
