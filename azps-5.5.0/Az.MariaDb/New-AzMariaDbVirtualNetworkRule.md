...
### Exempel 1: Skapa en virtuell nätverksregel för mariaDB
```powershell
...
Med det här kommandot skapas en virtuell nätverksregel för MariaDB.
...
### -SubnetId
Detta ARM för det virtuella nätverksundernätets resurs-ID.
