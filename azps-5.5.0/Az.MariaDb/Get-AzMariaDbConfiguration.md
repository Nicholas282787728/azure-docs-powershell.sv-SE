...
### Exempel 1: Lista alla konfigurationer under en MariaDB
```powershell
...
Det här kommandot listar all konfiguration under mariadb.

### Exempel 2: Skapa en konfiguration av MariaDB
```powershell
...
Det här kommandot får mariaDB-konfigurationen.
