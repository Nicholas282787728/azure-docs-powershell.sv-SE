...
ms.locfileid: "100226310"
---
# Update-AzMariaDbConfiguration

## SYNOPSIS
Uppdaterar en konfiguration av en server.
Använd Update-AzMariaDbServer istället om du vill uppdatera AdministratorLoginPassword, sKU osv.
...
### Exempel 1: Uppdatera MariaDB-konfigurationen
```powershell
