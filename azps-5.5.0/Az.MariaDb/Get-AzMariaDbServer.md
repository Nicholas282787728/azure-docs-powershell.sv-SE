...
### Exempel 2: Lista alla MariaDB under en resursgrupp
```powershell
...
Med det här kommandot visas alla MariaDB under en resursgrupp.

### Exempel 3: Skaffa ett MariaDB
```powershell
