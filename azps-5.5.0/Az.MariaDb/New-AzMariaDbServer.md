...
### Exempel 1: Skapa ett nytt MariaDB
```powershell
...
Med det här kommandot skapas en ny MariaDB.

## PARAMETERS

### -AdministratorLoginPassword
Administratörslösenordet bör vara SecureString.
...
Användarnamn för administratör.
...
### -GeoRedundantBackup
Aktivera Geo-redundant eller inte för säkerhetskopiering av servern.
