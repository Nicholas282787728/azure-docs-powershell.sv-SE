...
ms.locfileid: "100224335"
---
# Get-AzUserAssignedIdentity

## SYNOPSIS
Får användar tilldelad identitet/identiteter.
...
## BESKRIVNING
**Get-AzUserAssignedIdentity** får befintliga användartilldelade identiteter.

## EXEMPEL

### Exempel 1
Den här exempel cmdleten får den användar tilldelade identiteten med **namn-ID1** under resursgruppen **PSRG**
...
### Exempel 2
Den här exempel cmdleten hämtar alla användar tilldelade identiteter under resursgruppen **PSRG**
...
### Exempel 3
Den här exempel cmdleten får alla användar tilldelade identiteter under prenumerationen.
