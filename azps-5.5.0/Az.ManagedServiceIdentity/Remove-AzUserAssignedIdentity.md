...
ms.locfileid: "100221566"
---
# Remove-AzUserAssignedIdentity

## SYNOPSIS
Tar bort en användar kopplad identitet.
...
## BESKRIVNING
**Remove-AzUserAssignedIdentity** tar bort den angivna användartilldelade identiteten.
...
I det här exempel cmdleten tas **identitets-ID1** bort under **resursgruppen PSRG.**
True
