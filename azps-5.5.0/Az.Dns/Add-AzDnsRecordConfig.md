...
### Exempel 1: Lägga till en A-post i en postuppsättning
```
...
I det här exemplet läggs en A-post till i en befintlig postuppsättning.

### Exempel 2: Lägga till en AAAA-post i en postuppsättning
```
...
I det här exemplet läggs en AAAA-post till i en befintlig postuppsättning.

### Exempel 3: Lägga till en CNAME-post i en postuppsättning
```
...
I det här exemplet läggs en CNAME-post till i en befintlig postuppsättning.
Eftersom en CNAME-postuppsättning kan innehålla minst en post måste det först vara en tom postuppsättning eller så måste befintliga poster tas bort med Remove-AzDnsRecordConfig.

### Exempel 4: Lägga till en MX-post i en postuppsättning
```
...
I det här exemplet läggs en MX-post till i en befintlig postuppsättning.
Postnamnet "@" anger en post inställd på zon apex.

### Exempel 5: Lägga till en NS-post i en postuppsättning
```
...
I det här exemplet läggs en NS-post till i en befintlig postuppsättning.

### Exempel 6: Lägga till en PTR-post i en postuppsättning
```
...
I det här exemplet läggs en PTR-post till i en befintlig postuppsättning.

### Exempel 7: Lägga till en SRV-post i en postuppsättning
```
...
I det här exemplet läggs en SRV-post till i en befintlig postuppsättning.

### Exempel 8: Lägga till en TXT-post i en postuppsättning
```
...
I det här exemplet läggs en TXT-post till i en befintlig postuppsättning.
...
### -RecordSet
Anger **recordset-objektet** som ska redigeras.
