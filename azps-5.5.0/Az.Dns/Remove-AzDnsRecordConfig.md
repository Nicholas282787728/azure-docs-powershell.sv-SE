...
## BESKRIVNING
Cmdleten **Remove-AzDnsRecordConfig** tar bort en DNS-post (Domain Name System) från en postuppsättning.
**RecordSet-objektet** är ett offlineobjekt och ändringar i det ändrar inte DNS-svaren förrän du har kört cmdleten Set-AzDnsRecordSet för att beständiga ändringen av Microsoft Azure DNS-tjänsten.
Om du vill ta bort en post måste alla fält för den posttypen matcha exakt.
...
Du kan överföra **RecordSet-objektet** till den här cmdleten som en parameter eller med hjälp av rörledningsoperatorn.

## EXEMPEL

### Exempel 1: Ta bort en post från en postuppsättning
```
...
I det här exemplet tas en A-post bort från en befintlig postuppsättning.
Om det här är den enda posten i postuppsättningen blir resultatet en tom postuppsättning.
Om du vill ta bort en postuppsättning helt, se Remove-AzDnsRecordSet.
...
I det här exemplet tas en AAAA-post bort från en befintlig postuppsättning.
Om det här är den enda posten i postuppsättningen blir resultatet en tom postuppsättning.
Om du vill ta bort en postuppsättning helt, se Remove-AzDnsRecordSet.
...
I det här exemplet tas en CNAME-post bort från en befintlig postuppsättning.
Eftersom en CNAME-postuppsättning kan innehålla minst en post blir resultatet en tom postuppsättning.
...
I det här exemplet tas en MX-post bort från en befintlig postuppsättning.
Postnamnet "@" anger en postuppsättning vid zon apex.
Om det här är den enda posten i postuppsättningen blir resultatet en tom postuppsättning.
Om du vill ta bort en postuppsättning helt, se Remove-AzDnsRecordSet.

### Exempel 5: Ta bort en NS-post från en postuppsättning
```
...
I det här exemplet tas en NS-post bort från en befintlig postuppsättning.
Om det här är den enda posten i postuppsättningen blir resultatet en tom postuppsättning.
Om du vill ta bort en postuppsättning helt, se Remove-AzDnsRecordSet.

### Exempel 6: Ta bort en PTR-post från en postuppsättning
```
...
I det här exemplet tas en PTR-post bort från en befintlig postuppsättning.
Om det här är den enda posten i postuppsättningen blir resultatet en tom postuppsättning.
Om du vill ta bort en postuppsättning helt, se Remove-AzDnsRecordSet.

### Exempel 7: Ta bort en SRV-post från en postuppsättning
```
...
I det här exemplet tas en SRV-post bort från en befintlig postuppsättning.
Om det här är den enda posten i postuppsättningen blir resultatet en tom postuppsättning.
Om du vill ta bort en postuppsättning helt, se Remove-AzDnsRecordSet.

### Exempel 8: Ta bort en TXT-post från en postuppsättning
```
...
I det här exemplet tas en TXT-post bort från en befintlig postuppsättning.
Om det här är den enda posten i postuppsättningen blir resultatet en tom postuppsättning.
Om du vill ta bort en postuppsättning helt, se Remove-AzDnsRecordSet.
...
### -Nsdname
Anger namnservern för en namnserverpost (NS-post).
...
### -Ptrdname
Anger måldomännamnet för en pekarpost (PTR).
...
### -RecordSet
Anger **recordset-objektet** som innehåller posten som ska tas bort.
