...
ms.locfileid: "100229559"
---
# Get-AzWebAppSlotPublishingProfile

## SYNOPSIS
Hämtar en publiceringsprofil för Azure Web App-plats.
...
## BESKRIVNING
Cmdleten **Get-AzWebAppSlotPublishingProfile** hämtar Web App-publiceringsprofilen för den angivna platsen.
...
Det här kommandot hämtar publiceringsprofilen i Ftp-format för slot001 som är kopplad till Web App ContosoWebApp som är kopplad till resursgruppen Default-Web-WestUS och lagrar den i den angivna utdatafilen.
...
Inkludera slutpunkter för katastrofåterställning om sant
