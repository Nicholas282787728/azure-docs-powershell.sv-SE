...
ms.locfileid: "100231278"
---
# Set-AzWebAppSlotConfigName

## SYNOPSIS
Ange namn på Slot-konfiguration för Web App
...
## BESKRIVNING
Cmdleten **Set-AzWebAppSlotConfigName** markerar appinställningar och anslutningssträngar som platsinställningar
...
Det här kommandot tar bort alla appinställningar och anslutningssträngar för Web App ContosoWebApp som är kopplade till resursgruppen Default-Web-WestUS

### Exempel 2

Ange namn på Slot-konfiguration för Web App. (autogenererat)
...
### -AppSettingNames
Strängmatris för appinställningars namn
...
Strängmatris för anslutningssträngnamn
...
Alternativet Ta bort alla namn på appinställningar
...
Alternativet Ta bort alla anslutningssträngnamn
