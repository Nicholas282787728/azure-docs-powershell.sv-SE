...
## BESKRIVNING
Cmdleten **Remove-AzWebAppBackup** tar bort den angivna säkerhetskopian av en Azure Web App.
...
Med det här kommandot tas säkerhetskopian bort med säkerhetskopian med ID för "12345" från webbappen WebAppStandard som tillhör resursgruppen Default-Web-WestUS.

## PARAMETERS

### -BackupId
Säkerhetskopierings-ID
