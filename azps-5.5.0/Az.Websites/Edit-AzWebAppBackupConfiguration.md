...
## BESKRIVNING
**Cmdleten Edit-AzWebAppBackupConfiguration** redigerar den aktuella säkerhetskopian av konfigurationen för en Azure Web App.

## EXEMPEL

### Exempel 1

Med Edit-AzWebAppBackupConfiguration cmdleten redigeras den aktuella säkerhetskopian av konfigurationen för en Azure Web App. (autogenererat)
...
Alternativet Behåll minst ett alternativ för säkerhetskopiering
