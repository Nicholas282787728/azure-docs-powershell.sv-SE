...
ms.locfileid: "100253392"
---
# Remove-AzWebAppTrafficRouting

## SYNOPSIS
Ta bort en routningsregel från plats.
...
## BESKRIVNING
**Cmdleten Remove-AzWebAppTrafficRouting** tar bort en routningsregel från en Azure Web App-plats.

## EXEMPEL

### Exempel 1 Tar bort den specifika routningsregeln från webapp-plats
```powershell
PS C:\> Remove-AzWebAppTrafficRouting -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite"  -RuleName 'Stg'
```

Det här kommandot tar bort en routningsregel för en viss webapp-plats.
