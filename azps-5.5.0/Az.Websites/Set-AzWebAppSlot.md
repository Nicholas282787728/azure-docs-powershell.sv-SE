...
## BESKRIVNING
Cmdleten **Set-AzWebApp** anger en Azure Web App Slot.
...
Med det här kommandot ändras den appserviceplan som är kopplad till Slot001, på den Webapp ContosoWebApp som är kopplad till resursgruppen Default-Web-WestUS. Använd länken om du vill veta mer om hur du ändrar planen för tjänsten och begränsningar som hör till den.
...
Det här kommandot anger httpLoggingEnabled till true för Slot Slot001 som gäller Web App ContosoWebApp som är kopplad till resursgruppen Default-Web-WestUS

### Exempel 3

Ändrar en Azure Web App-plats. (autogenererat)
...
### -AssignIdentity
Aktivera/inaktivera MSI på en befintlig plats [FÖRHANDSVERSION]
...
### -HttpsOnly
Aktivera/inaktivera omdirigering av all trafik till HTTPS på en befintlig plats
...
### -NumberOfWorkers
Antalet anställda som ska tilldelas
...
Boolesk för begärandespårning aktiverad
