...
ms.locfileid: "100229535"
---
# New-AzWebAppContainerPSSession

## SYNOPSIS
New-AzWebAppContainerPSSession skapar en ny fjärr-PowerShell-session i windows-behållaren som anges på en viss webbplats eller en viss plats och en given resursgrupp
...
Detta skapar en ny fjärr-PowerShell-session i Windows Container-appen ContosoASP och visar de processer som körs på behållaren ContosoASP
