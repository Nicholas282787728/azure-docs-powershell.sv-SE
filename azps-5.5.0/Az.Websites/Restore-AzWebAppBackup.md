...
## BESKRIVNING
Cmdleten **Restore-AzWebAppBackup** återställer en säkerhetskopiering av Azure Web App.
...
Återställer en säkerhetskopia av den angivna appen ContosoWebApp som finns inom resursgruppen Default-Web-WestUS i blob "myBlob" som finns på https://storageaccount.file.core.windows.net

### Exempel 2

Med Restore-AzWebAppBackup-cmdleten återställs en säkerhetskopiering av Azure Web App. (autogenererat)
...
### -AppServicePlan
Namnet på apptjänstplanen för det återställda programmet. Om den lämnas tom används appens aktuella serviceplan för appen.
...
Alternativet Ignorera värdnamn i konflikt
