...
I följande exempel skapas en anslutningssträng med namnet myConnectionString för Web App ContosoWebApp. Detta ersätter alla befintliga anslutningssträngar för Web App ContosoWebApp.
...
### -AzureStoragePath
Azure Storage för att sätta fast i en Web App för behållare. Använda New-AzureRmWebAppAzureStoragePath för att skapa den
...
### -FtpsState
Ange värdet för ftpstillståndet för ett program. Tillåtna värden [Tillåtna | Inaktiverad | FtpsOnly].
