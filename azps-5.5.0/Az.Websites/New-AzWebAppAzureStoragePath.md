...
ms.locfileid: "100216519"
---
# New-AzWebAppAzureStoragePath

## SYNOPSIS
Skapar ett objekt som representerar en Azure Storage-sökväg som skamonteras i en Web App. Den är avsedd att användas som parameter (-AzureStoragePath) för att Set-AzWebApp och Set-AzWebAppSlot
...
## BESKRIVNING
Skapar ett objekt som representerar en Azure Storage-sökväg som ska placeras i en Web App.
...
### -AccessKey
Access-nyckel till Azure Storage-kontot
...
Till exempel: myfilestorageaccount.file.core.windows.net
...
### -MountPath
Sökväg i behållaren där resursen som anges av ShareName exponeras
...
### -Name
Identifieraren för Azure Storage-egenskapen.
Måste vara unikt i Web App eller Slot
...
### -ShareName
Namn på delningsresursen som ska vara fäst i behållaren
...
Windows Containers har endast stöd för Azure-filer
