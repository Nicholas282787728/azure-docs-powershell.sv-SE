...
ms.locfileid: "100224574"
---
# Import-AzWebAppKeyVaultCertificate

## SYNOPSIS
Importera ett SSL-certifikat till en webbapp från nyckelvalv.
...
## BESKRIVNING
Cmdleten **Import-AzWebAppKeyVaultCertificate** importerar ett SSL-certifikat till en webbapp från nyckelvalv.
...
Det här kommandot importerar ett SSL-certifikat till en webbapp från nyckelvalv.
...
Det här kommandot Importera ett SSL-certifikat till en webbapp från nyckelvalv med resurs-ID (vanligtvis om nyckelvalv finns i en annan prenumeration).

## PARAMETERS

### -CertName
KeyVaultCertName för certifikatet som skapades i keyvault
...
### -ResourceGroupName
Namnet på resursgruppen webapp.
