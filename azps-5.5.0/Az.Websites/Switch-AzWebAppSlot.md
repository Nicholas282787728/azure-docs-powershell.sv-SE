...
ms.locfileid: "100252696"
---
# Switch-AzWebAppSlot

## SYNOPSIS
Byta två platser med en webbapp
...
## BESKRIVNING
**Switch-AzWebAppSlot växlar** två platser kopplade till en Azure Web App.
...
Det här kommandot byter plats "sourceslot" med "destinationslot" webappen ContosoWebApp som är kopplad till resursgruppen Default-Web-WestUS
...
Växla med förhandsgranskningsåtgärd
