...
ms.locfileid: "100216566"
---
# Enter-AzWebAppContainerPSSession

## SYNOPSIS
Öppnar en fjärr-PowerShell-session i windowsbehållaren som anges på en viss webbplats eller en viss plats och en given resursgrupp
...
Med det här kommandot öppnas en PowerShell-fjärrsession i Windows Container-appen ContosoASP
