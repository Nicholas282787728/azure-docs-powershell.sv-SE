...
ms.locfileid: "100252704"
---
# Set-AzAppServicePlan

## SYNOPSIS
Anger ett Azure App Service-abonnemang.
...
## BESKRIVNING
Cmdleten **Set-AzAppServicePlan** anger ett Azure App Service-abonnemang.

## EXEMPEL

### Exempel 1: Ändra en apptjänstplan
```powershell
PS C:\>Set-AzAppServicePlan -ResourceGroupName "Default-Web-WestUS" -Name "ContosoASP" -PerSiteScaling $true
```

Med det här kommandot anger du sant för alternativet PerSiteScaling i App Service-abonnemanget ContosoASP som tillhör resursgruppen Default-Web-WestUS.

### Exempel 2

Anger ett Azure App Service-abonnemang. (autogenererat)
...
### -AdminSiteName
Administratörswebbplatsens namn
...
### -PerSiteScaling
Boolesk skalning per webbplats
