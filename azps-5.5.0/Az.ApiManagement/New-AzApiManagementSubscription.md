...
### Exempel 1: Prenumerera på en användare på en produkt
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>New-AzApiManagementSubscription -Context $apimContext -UserId "777" -ProductId "999"
```

Med det här kommandot prenumereras en befintlig användare på en produkt.

### Exempel 2: Skapa en prenumeration för all API-omfattning
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### -AllowTracing
Flagga som avgör om spårning kan aktiveras på prenumerationsnivå. Det här är en valfri parameter och $null.
...
Om parametern inte anges genereras nyckeln automatiskt.
...
### -ProductId
Anger ID för den produkt som du prenumererar på.
...
Den här parametern genereras om den inte anges.
