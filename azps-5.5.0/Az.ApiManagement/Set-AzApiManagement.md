...
Cmdleten **Set-AzApiManagement** uppdaterar en Azure API Management-tjänst.

## EXEMPEL

### Exempel 1: Hämta en API-hanteringstjänst och skala den till Premium och Lägg till en region
```powershell
...
I det här exemplet får du en Api Management-instans, skalar den till fem premiumenheter och lägger sedan till ytterligare tre enheter i premiumområdet.

### Exempel 2: Uppdatera distribution (extern VNET)
```powershell
...
Det här kommandot uppdaterar en befintlig API Management-distribution och ansluter till en extern *VpnType.*

### Exempel 3: Skapa och initiera en instans av PsApiManagementCustomHostNameConfiguration med en hemligt från KeyVault-resurs
```powershell
...
### Exempel 4: Uppdatera e-post i Publisher, e-postaviseringar och organisationsnamn
```powershell
...
### -PassThru
Skickar uppdaterad PsApiManagement till pipeline om åtgärden lyckas.
