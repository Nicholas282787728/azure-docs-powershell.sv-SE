...
## BESKRIVNING
Cmdleten **New-AzApiManagementPipelineDiagnosticSetting** skapar diagnostikinställningar för inkommande/utgående HTTP-meddelanden till gatewayen.
...
Skapa en pipelinediagnostik som ska användas i antingen FrontEnd eller Backend i Diagnostikenhet.
...
### -Begär
Diagnostikinställning för begäran.
...
### -Svar
Diagnostikinställning för Svar.
Den här parametern är valfri.
