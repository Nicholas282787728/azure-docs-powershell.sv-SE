...
## BESKRIVNING
Cmdleten **Get-AzApiManagementAuthorizationServerClientSecret** får klienthemligheten med Azure API Management-auktoriseringsservern.

## EXEMPEL

### Exempel 1: Få en angiven auktoriseringsserverklienthemlighet med ID
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementAuthorizationServerClientSecret -Context $ApiMgmtContext -ServerId "0123456789"
```

Det här kommandot får den angivna auktoriseringsservern avancerad hemligt.
...
### -ResourceId
Arm Resource Identifier för auktoriseringsservern.
Om den anges försöker du hitta auktoriseringsservern med identifieraren.
Den här parametern är obligatorisk.
...
Om autentiseringsservern identifieras av identifieraren.
