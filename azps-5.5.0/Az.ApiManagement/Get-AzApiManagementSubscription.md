...
## BESKRIVNING
Cmdleten **Get-AzApiManagementSubscription** får en angiven prenumeration, eller alla prenumerationer, om ingen prenumeration anges.
Nycklar inkluderas inte i resultatinformationen. Om du vill hämta nycklar **använder du Get-AzApiManagementSubscriptionKey.**
...
### Exempel 2: Skaffa en prenumeration med ett angivet ID
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-East-US" -ServiceName "contoso"
PS C:\>Get-AzApiManagementSubscription -Context $apimContext -SubscriptionId "0123456789"
```

Det här kommandot får en prenumeration via ID.
...
### Exempel 5: Hämta alla prenumerationer för en omfattning
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-East-US" -ServiceName "contoso"
...
Det här kommandot hämtar alla prenumerationer som är konfigurerade för global API-omfattning

### Exempel 6: Hämta alla prenumerationer för en produkt och användaromfattning
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-East-US" -ServiceName "contoso"
...
### -ProductId
Anger en produktidentifierare.
Om den här cmdleten anges hittar den här cmdleten alla prenumerationer med produktidentifieraren.
...
### -Omfattning
Omfattningsidentifierare. Prenumerationens omfattning, oavsett om det är API-omfattning /apis/{apiId} eller produktomfattning /produkter/{productId} eller global API-omfattning /apis eller global omfattning /.
...
### -SubscriptionId
Anger en prenumerationsidentifierare.
Om den här cmdleten anges hittar den prenumerationen med identifieraren.
...
### -UserId
Anger en användaridentifierare.
Om den här cmdleten anges hittar den här cmdleten alla prenumerationer med hjälp av användaridentifieraren.
