...
## BESKRIVNING
**Cmdleten Add-AzApiManagementApiToProduct** lägger till ett Azure API Management API till en produkt.

## EXEMPEL

### Exempel 1: Lägga till ett API i en produkt
```
...
### -ApiId
Anger ID för ett API som ska läggas till i en produkt.
...
### -ProductId
Anger ID för produkten som API:t ska läggas till i.
