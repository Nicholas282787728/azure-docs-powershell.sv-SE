...
## BESKRIVNING
**Cmdleten Set-AzApiManagementSubscription** anger befintlig prenumerationsinformation.

## EXEMPEL

### Exempel 1: Ange status och primärnycklar och sekundära nycklar för en prenumeration
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Set-AzApiManagementSubscription -Context $apimContext -SubscriptionId -0123456789 -PrimaryKey "80450f7d0b6d481382113073f67822c1" -SecondaryKey "97d6112c3a8f48d5bf0266b7a09a761c" -State "Active"
```

Det här kommandot anger primär- och sekundärnycklar för en prenumeration och aktiverar den.
...
### -ExpiresOn
Anger ett förfallodatum för prenumerationen.
...
### -InputObject
Instans av PsApiManagementSubscription. Den här parametern är obligatorisk.
...
### -PrimaryKey
Anger primärnyckeln för prenumerationen.
Den här parametern genereras automatiskt om den inte anges.
Den här parametern måste vara 1 till 300 tecken lång.
...
### -Omfattning
Prenumerationens omfattning, oavsett om det är API-omfattning /apis/{apiId} eller produktomfattning /produkter/{productId} eller global API-omfattning /apis eller global omfattning /. Den här parametern är obligatorisk.
...
### -SecondaryKey
Anger den sekundära prenumerationsnyckeln.
Den här parametern genereras automatiskt om den inte anges.
Den här parametern måste vara 1 till 300 tecken lång.
...
### -StateComment
Anger prenumerationens tillståndskommentar.
Standardvärdet för den här parametern är $Null.
...
### -UserId
Ägaren av prenumerationen. Den här parametern är valfri.
