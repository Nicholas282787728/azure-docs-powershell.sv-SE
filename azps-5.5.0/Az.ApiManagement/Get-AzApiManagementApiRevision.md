...
## BESKRIVNING
**Cmdleten Get-AzApiManagementApiRevision** får information om alla ändringar av ett API

## EXEMPEL

### Exempel 1: Hämta alla API-revisioner av ett API
```powershell
...
Det här kommandot hämtar hela API-revideringen av angivet API för en viss ApiManagement-kontext.

## PARAMETERS

### -ApiId
API-identifierare vars ändringar vi vill lista.
