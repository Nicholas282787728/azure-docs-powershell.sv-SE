...
ms.locfileid: "100216446"
---
# New-AzApiManagementGatewayHostnameConfiguration

## SYNOPSIS
Skapar ett värdnamnskonfiguratin för den befintliga gatewayen.
...
### Exempel 1: Skapa en värdnamnskonfiguration för den befintliga gatewayen
```powershell
...
Det här kommandot skapar en "h01"-värdnamnskonfiguration för en "g01"-gateway.

## PARAMETERS

### -CertificateResourceId
En resursidentifierare för det befintliga certifikat-ID:t. Den här parametern är obligatorisk.
...
Identifierare för värdnamn för ny gateway.
...
Flagga för att framtvinga NegotiateClientCertificate.
Den här parametern är valfri.
