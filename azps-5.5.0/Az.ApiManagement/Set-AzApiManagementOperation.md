...
## BESKRIVNING
Cmdleten **Set-AzApiManagementOperation** anger information om API-åtgärden.

## EXEMPEL

### Exempel 1: Ange åtgärdsinformation
```powershell
...
Det här kommandot anger åtgärdsinformationen för API-hantering.

### Exempel 2

Anger information om API-åtgärden. (autogenererat)
...
### -ApiId
Anger IDENTIFIERARen för API:t.
...
### -ApiRevision
Identifierare för API-revidering. Den här parametern är valfri. Om det inte anges uppdateras åtgärden i den aktuella aktiva api-ändringen.
...
### -Beskrivning
Anger beskrivningen av den nya åtgärden.
...
### -Name
Anger visningsnamnet för den nya åtgärden.
...
### -Begär
Anger information om begäran om åtgärden.
...
### -Responses
Anger en matris med möjliga åtgärdssvar.
...
### -TemplateParameters
Anger en matris eller parametrar som definierats i *parametern UrlTemplate.*
Om du inte anger ett värde genereras ett standardvärde baserat på UrlTemplate.
Använd parametern för att ge mer information om parametrar, till exempel beskrivning, typ och andra möjliga värden.
...
### -UrlTemplate
Anger URL-mallen.
Till exempel: kunder/{cid}/orders/{oid}/?date={date}.
