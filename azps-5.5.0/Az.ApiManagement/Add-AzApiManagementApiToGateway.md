...
## BESKRIVNING
**Cmdleten Add-AzApiManagementApiToGateway** lägger till ett Azure API Management API till en gateway.
...
Det här kommandot lägger till angivet API i den angivna gatewayen.
