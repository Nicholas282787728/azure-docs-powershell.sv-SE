...
### Exempel 2: Hämta alla API-versionsuppsättningar
```powershell
...
Det här kommandot hämtar alla API-versionsuppsättningar för det angivna sammanhanget.

### Exempel 3: Hämta en API-version som angetts av ID
```powershell
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
