...
Om du vill uppdatera en distribution av en API-hantering använder du den ändrade **PsApiManagementInstance** till Set-AzApiManagement-cmdleten.
...
Det här kommandot får API Management Premium-SKU-tjänsten med regioner i södra centrala USA och centrala USA. Sedan ökar kapaciteten i området i centrala USA till 2 med hjälp **av Set-AzApiManagement.** Nästa cmdlet **Set-AzApiManagement** använder konfigurationsändringen för tjänsten Api Management.

### Exempel 2

Uppdaterar befintlig distributionsregion i PsApiManagement-instansen. (autogenererat)
