...
Med det här kommandot skapas en **OpenID-anslutningsleverantör** med namnet Contoso OpenID Connect Provider

### Exempel 2

Skapar en OpenID Connect-leverantör. (autogenererat)
