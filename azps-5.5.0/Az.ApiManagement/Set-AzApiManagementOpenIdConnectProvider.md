...
## BESKRIVNING
Cmdleten **Set-AzApiManagementOpenIdConnectProvider** ändrar en OpenID Connect-leverantör i Azure API Management.

## EXEMPEL

### Exempel 1: Ändra klienthemligheten för en leverantör
```powershell
...
Det här kommandot ändrar providern som har ID OICProvider01.
Kommandot anger en klienthemlighet för leverantören.

### Exempel 2

Ändrar en OpenID Connect-leverantör. (autogenererat)
...
### -MetadataEndpointUri
Anger en metadataslutpunkts-URI för leverantören.
...
Anger ett ID för leverantören som cmdleten ändrar.
Om du inte anger ett ID genererar cmdleten ett.
