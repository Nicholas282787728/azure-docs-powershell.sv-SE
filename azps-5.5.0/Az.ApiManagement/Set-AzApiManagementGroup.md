...
## BESKRIVNING
Cmdleten **Set-AzApiManagementGroup** konfigurerar en API-hanteringsgrupp.
...
Med det här kommandot konfigureras en hanteringsgrupp med namnet Group0001.
...
### -GroupId
Anger identifieraren för hanteringsgruppen.
