...
## BESKRIVNING
**Cmdleten Remove-AzApiManagementGateway** avger ett API från en gateway.
...
Med det här kommandot tas en befintlig gateway bort och användaren uppmanas inte att bekräfta.
