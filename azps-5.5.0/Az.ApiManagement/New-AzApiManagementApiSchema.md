...
### Exempel 1: Create new Schema for Swagger Petstore Extensive API
```powershell
...
Cmdleten **New-AzApiManagementApiSchema** skapar eller uppdaterar schemat för `swagger-petstore-extensive` aPI.

## PARAMETERS

### -ApiId
Identifierare för api. Den här parametern är obligatorisk.
...
ContentType för api-schemat. Den här parametern är obligatorisk.
