...
ms.locfileid: "100231246"
---
# Remove-AzApiManagementProduct

## SYNOPSIS
Tar bort en befintlig produkt för API Management.
...
## BESKRIVNING
**Cmdleten Remove-AzApiManagementProduct** tar bort en befintlig API Management-produkt.

## EXEMPEL

### Exempel 1: Ta bort en befintlig produkt och alla prenumerationer
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementProduct -Context $apimContext -ProductId "0123456789" -DeleteSubscriptions
```

Med det här kommandot tas en befintlig produkt och alla prenumerationer bort.
...
Om du inte anger den här parametern och det finns prenumerationer, gäller ett undantag.
...
### -PassThru
Anger att denna cmdlet returnerar värdet $True, om det lyckas eller värdet $False, om det misslyckas.
...
### -ProductId
Anger identifieraren för den befintliga produkten.
