...
## BESKRIVNING
Hämtar nätverksstatus för api-hanteringstjänsten
...
Hämtar anslutningsstatus för de olika resurser som ApiManagement-tjänsten är beroende av.
...
### -Plats
Plats för API-hanteringstjänsten.
...
### -ResourceGroupName
Namn på resursgrupp där API-hantering finns.
