...
## BESKRIVNING
Cmdleten **Remove-AzApiManagementSchema** från Api.

## EXEMPEL

### Exempel 1: Tar bort API-schemat från API:t
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzAzureRmApiManagementApiSchema -Context $apimContext -ApiId "echo-api" -SchemaId "2"
```

Skriptet tar bort schemat från `2` API:t `echo-api` om det inte refereras till.

### Exempel 2

Skriptet tar bort Schema 2 från Api echo-api om det inte refereras till. (autogenererat)
...
### -ResourceId
Arm ResourceId för ApiSchema. Den här parametern är obligatorisk.
