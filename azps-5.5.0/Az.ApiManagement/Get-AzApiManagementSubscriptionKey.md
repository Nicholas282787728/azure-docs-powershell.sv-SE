...
## BESKRIVNING
Cmdleten **Get-AzApiManagementSubscriptionKey** får en nyckel för en viss prenumeration.

## EXEMPEL

### Exempel 1: Hämta en prenumerationsnyckel med ett angivet ID
```
