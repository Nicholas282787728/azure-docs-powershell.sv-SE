...
Med det här kommandot tas en befintlig API-åtgärd bort.
...
### -ApiRevision
Identifierare för API-revidering. Den här parametern är valfri. Om det inte anges tas åtgärden bort från den aktiva api-ändringen.
