...
## BESKRIVNING
Cmdleten **New-AzApiManagementProduct** skapar en API Management-produkt.

## EXEMPEL

### Exempel 1: Skapa en produkt som inte kräver en prenumeration
```
...
Med det här kommandot skapas en API Management-produkt.
Ingen prenumeration krävs.

### Exempel 2: Skapa en produkt som kräver en prenumeration och godkännande
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Med det här kommandot skapas en produkt.
En prenumeration och godkännande krävs.
Med det här kommandot anges meddelandeperioden till 10 dagar.
Prenumerationens varaktighet är inställt på ett år.

## PARAMETERS

### -ApprovalRequired
Anger om prenumerationen på produkten kräver godkännande eller inte.
Som standard är den här **parametern $False.**
...
### -LegalTerms
Anger de juridiska användningsvillkoren för produkten.
...
### -ProductId
Anger identifieraren för den nya produkten.
Om du inte anger den här parametern skapas en ny produkt.
...
psdx_paramvalues
- NotPublished
- Publicerades standardvärdet är Ej publicerat.
...
Anger om produkten kräver en prenumeration.
...
### -SubscriptionsLimit
Anger det maximala antalet samtidiga prenumerationer.
