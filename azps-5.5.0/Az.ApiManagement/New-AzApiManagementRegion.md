...
## BESKRIVNING
Hjälpkommando för att skapa en instans av PsApiManagementRegion.
...
Skapar en ApiManagement-tjänst för extern VpnType i region Väst usa, med en ytterligare region i centrala USA.

## PARAMETERS

### -Kapacitet
SKU-kapacitet för Azure API Management-tjänstens ytterligare region.
Standardvärdet är 1.
...
### -VirtualNetwork
Distributionsregion för virtuell nätverkskonfiguration av Azure API Management.
