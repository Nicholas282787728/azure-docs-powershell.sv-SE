...
Med det här kommandot skapas en logger med namnet ContosoSdkEventHub med den angivna anslutningssträngen.

### Exempel 2

Skapar en API Management Logger. (autogenererat)
...
### -ConnectionString
Anger en Azure Event Hubs-anslutningssträng som börjar med följande: `Endpoint=endpoint and key from Azure classic portal`
Nyckeln med Skicka rättigheter i anslutningssträngen måste vara konfigurerad.
...
### -IsBuffered
Anger om posterna i loggern är buffrade före publicering.
