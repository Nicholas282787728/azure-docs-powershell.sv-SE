...
## BESKRIVNING
Cmdleten **Remove-AzApiManagementApiFromProduct** tar bort ett Azure API Management API från en produkt.
...
### -PassThru
Anger att denna cmdlet returnerar värdet $True om det lyckas eller om $False annat.
...
### -ProductId
Anger ID för produkten som API:t ska tas bort från.
