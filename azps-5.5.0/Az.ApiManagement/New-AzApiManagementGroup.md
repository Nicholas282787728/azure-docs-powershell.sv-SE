...
## BESKRIVNING
Cmdleten **New-AzApiManagementGroup** skapar en API-hanteringsgrupp.

## EXEMPEL

### Exempel 1: Skapa en hanteringsgrupp
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>New-AzApiManagementGroup -Context $apimContext -Name "Group0001"
```

Med det här kommandot skapas en hanteringsgrupp.

### Exempel 2

Skapar en API-hanteringsgrupp. (autogenererat)
...
### -Beskrivning
Anger beskrivningen av hanteringsgruppen.
...
### -ExternalId
För externa grupper innehåller den här egenskapen gruppens ID från den externa identitetsleverantören, till exempel Azure Active Directory aad://contoso5api.onmicrosoft.com/groups/12ad42b1-592f-4664-a77b4250-2f2e82579f4c; annars är värdet null.
...
### -GroupId
Anger identifieraren för den nya hanteringsgruppen.
...
### -Type
Grupptyp. Anpassad grupp är en användardefinierad grupp. System Group includes Administrator, Developers and Guests. Du kan inte skapa eller uppdatera en systemgrupp.  Extern grupp är grupper från en extern identitetsprovider som Azure Active Directory. Den här parametern är valfri och antas som standard vara en anpassad grupp.
