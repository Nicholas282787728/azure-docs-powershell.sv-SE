...
## BESKRIVNING
**Cmdleten Remove-AzApiManagementGatewayHostnameConfiguration** tar bort en värdnamnskonfiguration från den befintliga gatewayen.

## EXEMPEL

### Exempel 1: Ta bort en befintlig gatewayvärdnamnskonfiguration
```powershell
...
Med det här kommandot tas en befintlig gatewayvärdnamnkonfiguration bort och användaren uppmanas inte att bekräfta.
...
Identifierare för befintlig gatewayvärdnamnskonfiguration.
Den här parametern är obligatorisk.
...
### -InputObject
Instans av PsApiManagementGatewayHostnameConfiguration. Den här parametern är obligatorisk.
...
### -ResourceId
Arm ResourceId för GatewayHostnameConfiguration. Den här parametern är obligatorisk.
