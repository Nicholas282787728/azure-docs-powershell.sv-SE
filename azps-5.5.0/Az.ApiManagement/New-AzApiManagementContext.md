...
Kontexten används för alla cmdlets för TJÄNSTEN API-hantering.
...
### -ResourceGroupName
Anger namnet på den resursgrupp där en API-hanteringstjänst distribueras.
...
### -ResourceId
Arm Resource Identifier för en ApiManagement-tjänst. Den här parametern är obligatorisk.
...
### -ServiceName
Anger namnet på den distribuerade API-hanteringstjänsten.
