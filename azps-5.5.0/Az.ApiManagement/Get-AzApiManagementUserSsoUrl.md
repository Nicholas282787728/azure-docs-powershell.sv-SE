...
## BESKRIVNING
Cmdleten **Get-AzApiManagementUserSsoUrl** genererar en SSO-URL (enkel inloggning) för en användare.

## EXEMPEL

### Exempel 1: Hämta en användares SSO-URL
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementUserSsoUrl -Context $apimContext -UserId "0123456789"
```

Det här kommandot hämtar en användares SSO-URL.
