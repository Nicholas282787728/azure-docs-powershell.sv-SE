...
## BESKRIVNING
Cmdleten **Restore-AzApiManagement** återställer en API-hanteringstjänst från den angivna säkerhetskopian som finns i en Azurestorage-blob.

## EXEMPEL

### Exempel 1: Återställa en API-hanteringstjänst
```
...
Det här kommandot återställer en API-hanteringstjänst från Azure-lagrings blob.
...
### -Name
Anger namnet på API-hanteringsinstansen som ska återställas med säkerhetskopian.
...
### -SourceBlobName
Anger namnet på blobben för säkerhetskopieringskälla för Azure-lagring.
...
### -SourceContainerName
Anger namnet på behållaren för säkerhetskopieringskällor för Azure-lagring.
...
### -StorageContext
Anger sammanhanget för lagringsanslutningen.
