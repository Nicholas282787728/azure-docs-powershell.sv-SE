...
**Cmdleten Set-AzApiManagementApiVersionSet** ändrar en versionuppsättning av Azure API Management API.
...
Det här kommandot uppdaterar en befintlig API-versionuppsättning med versionsschema `Header` och rubrikparameter. `api-version`
...
Om sidhuvudet för versionshantering har valts måste det här värdet anges.
...
### -InputObject
Instans av PsApiManagementApiVersionSet. Den här parametern är obligatorisk.
...
### -PassThru
Om den anges skrivs instansen av typen Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementApiVersionSet som representerar den modifierade apiVersionSet till utdata.
