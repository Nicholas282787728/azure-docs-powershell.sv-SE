...
### Exempel 1: Hämta konfiguration för klientåtkomst
```powershell
...
Det här kommandot hämtar konfigurationsnycklarna för Git-åtkomst för det angivna sammanhanget.
