...
Med det här kommandot får du alla API-hanteringscertifikat.

### Exempel 2: Hämta ett certifikat med dess ID
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementCertificate -Context $ApiMgmtContext -CertificateId "0123456789"
```

Det här kommandot får API Management-certifikatet med det angivna ID:t.

## PARAMETERS

### -CertificateId
Anger ID för det certifikat som ska hämtas.
...
### -ResourceId
Arm Resource Identifier för certifikatet. Om det anges försöker du hitta certifikatet med identifieraren. Den här parametern är obligatorisk.
