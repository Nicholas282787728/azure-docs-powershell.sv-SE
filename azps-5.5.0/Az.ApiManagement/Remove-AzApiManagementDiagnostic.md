...
## BESKRIVNING
Cmdleten **Remove-AzApiManagementDiagnostic** tar bort den diagnostikenhet som anges från `DiagnosticId` global omfattning eller en `ApiId` omfattning

## EXEMPEL

### Exempel 1: Ta bort diagnostikentitet
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementDiagnostic -Context $apimContext -DiagnosticId "applicationinsights"
```

Det här exemplet tar bort `applicationinsights` diagnostiken från tjänsten Api Management.
...
### -InputObject
Instans av PsApiManagementDiagnostic. Den här parametern är obligatorisk.
...
### -ResourceId
Arm ResourceId för diagnostik. Den här parametern är obligatorisk.
