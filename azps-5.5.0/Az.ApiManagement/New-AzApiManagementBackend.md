...
## BESKRIVNING
Skapar en ny backend-enhet i Api Management.

## EXEMPEL

### Exempel 1: Skapa Backend 123 med ett grundläggande auktoriseringsschema
```powershell
...
### -Proxy
Proxyserverinformation som ska användas när begäran skickas till backend-servern.
Den här parametern är valfri.
