...
## BESKRIVNING
Cmdleten **Get-AzApiManagementGatewayKey** hämtar nycklar till befintlig gateway

## EXEMPEL

### Exempel 2: Hämta en gateway via ID
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGatewayKey -Context $apimContext -GatewayId "0123456789"
```

Det här kommandot hämtar nycklar för en 0123456789-gateway.
