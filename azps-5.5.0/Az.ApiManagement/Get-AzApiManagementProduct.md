...
## BESKRIVNING
Cmdleten **Get-AzApiManagementProduct** får en lista eller en viss produkt.
...
Med det här kommandot får du alla API Management-produkter.

### Exempel 2: Hämta en produkt med HJÄLP av ID
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementProduct -Context $apimContext -ProductId "0123456789"
```

Med det här kommandot får du en API Management-produkt med ID.

## PARAMETERS

### -ApiId
Api-id för API:t för att hitta de korrelerade produkterna. Den här parametern är valfri.
...
### -ProductId
Anger identifieraren för produkten som ska sökas efter.
...
### -Titel
Anger namnet på den produkt som ska sökas efter.
Om den anges försöker cmdleten hämta produkten med namn.
