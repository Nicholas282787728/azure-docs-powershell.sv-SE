...
**Cmdleten Remove-AzAzureRmApiManagementApiVersionSet** tar bort en befintlig API-versionuppsättning.

## EXEMPEL

### Exempel 1: Ta bort en API-versionsuppsättning
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementApiVersionSet -Context $apimContext -ApiVersionSetId "query-param-set"
```

Med det här kommandot tas API-versionsuppsättningen bort med angivet ApiVersionSetId.

## PARAMETERS

### -ApiVersionSetId
Identifierare för API-versionsuppsättningen.
...
### -ResourceId
Arm ResourceId för ApiVersionSet. Den här parametern är obligatorisk.
