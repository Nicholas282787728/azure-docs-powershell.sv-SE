...
## BESKRIVNING
**Cmdleten Update-AzApiManagementGateway** konfigurerar en API-hanteringsgateway.

## EXEMPEL

### Exempel 1: Konfigurera en hanteringsgrupp
```powershell
...
### -InputObject
Instans av PsApiManagementGateway. Den här parametern är obligatorisk.
...
### -PassThru
Om angivet då instans av Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementGateway-typ som representerar den ändrade gatewayen.
...
### -ResourceId
Arm ResourceId för gatewayen. Den här parametern är obligatorisk.
