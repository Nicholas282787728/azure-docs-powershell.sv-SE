...
ms.locfileid: "100254124"
---
# Set-AzApiManagementProduct

## SYNOPSIS
Anger produktinformationen för API-hantering.
...
## BESKRIVNING
Cmdleten **Set-AzApiManagementProduct** anger produktinformation för API Management.

## EXEMPEL

### Exempel 1: Uppdatera produktinformationen
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Set-AzApiManagementProduct -Context $apimContext -ProductId "0123456789" -Title "Starter" -Description "Starter Product" -LegalTerms "Free for all" -SubscriptionRequired $True -State "NotPublished"
```

Det här kommandot uppdaterar produktinformationen för API-hantering, kräver en prenumeration och avpublicerar sedan.
...
### -Titel
Anger produktnamnet som cmdleten uppsättningar.
