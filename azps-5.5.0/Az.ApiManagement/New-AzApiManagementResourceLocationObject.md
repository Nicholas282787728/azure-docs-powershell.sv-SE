...
## BESKRIVNING
**Cmdleten New-AzApiManagementResourceLocationObject** skapar ett nytt resursplatskontrakt (används i Gateways).

## EXEMPEL

### Exempel 1: Skapa ett resursplatsavtal
```powershell
PS C:\>$location = New-AzApiManagementResourceLocationObject -Name "n1" -City "c1" -District "d1" -CountryOrRegion "r1"
```

Med det här kommandot skapas en resursplats.
