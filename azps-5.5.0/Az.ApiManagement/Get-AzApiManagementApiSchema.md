...
### Exempel 1: Visa information om alla API-scheman för ett API
```powershell
...
Med det här kommandot får du alla API-scheman som är kopplade till ett API `swagger-petstore-extensive` för en viss ApiManagement-kontext.
...
Med det här kommandot får du det `5cc9cf67e6ed3b1154e638bd` API-schema som är kopplat till ett API `swagger-petstore-extensive` för en viss ApiManagement-kontext.

## PARAMETERS

### -ApiId
API-identifierare att leta efter.
Om detta anges försöker du få API:t av ID:t.
...
### -ResourceId
Arm Resource Identifier för ett API-schema. Om detta anges försöker du hitta api-schemat med identifieraren. Den här parametern är obligatorisk.
