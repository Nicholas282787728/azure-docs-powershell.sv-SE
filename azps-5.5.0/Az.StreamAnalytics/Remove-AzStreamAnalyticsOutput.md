...
## BESKRIVNING
Cmdleten **Remove-AzStreamAnalyticsOutput** asynkront tar bort en utdata från ett Stream Analytics-jobb i Azure.

## EXEMPEL

### EXEMPEL 1: Ta bort utdata från ett jobb
```
PS C:\>Remove-AzStreamAnalyticsOutput -ResourceGroupName "StreamAnalytics-Default-West-US" -JobName "StreamingJob" -Name "Output"
```

Det här kommandot tar bort utdatadata i jobbet StreamingKommando.
