...
### Exempel 1: Lista alla händelsekällor under den angivna miljön
```powershell
...
Med det här kommandot visas alla händelsekällor i de angivna miljöerna.

### Exempel 2: Hämta en angiven händelsekälla efter namn
```powershell
...
Det här kommandot får en viss händelsekälla.

### Exempel 3: Hämta en viss händelsekälla per objekt
```powershell
...
### -Name
Namnet på händelsekällan Tidserieinsikter som är associerad med den angivna miljön.
