...
### Exempel 1: Lista alla åtkomstprinciper under en angiven miljö
```powershell
...
Det här kommandot visar alla åtkomstprinciper i en angiven miljö.

### Exempel 2: Hämta en angiven åtkomstprincip efter namn
```powershell
...
Det här kommandot får en angiven åtkomstprincip.

### Exempel 3: Hämta en angiven åtkomstprincip per objekt
```powershell
...
### -Name
Namnet på åtkomstprincipen Time Series Insights som är associerad med den angivna miljön.
