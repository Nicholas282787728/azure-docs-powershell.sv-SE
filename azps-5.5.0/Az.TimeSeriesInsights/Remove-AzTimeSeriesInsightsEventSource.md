...
### Exempel 1: Ta bort en angiven händelsekälla med namn
```powershell
PS C:\> Remove-AzTimeSeriesInsightsEventSource -EnvironmentName tsitest001 -Name iots001 -ResourceGroupName testgroup

```

Då tas en viss händelsekälla bort.

### Exempel 2: Ta bort en viss händelsekälla efter objekt
```powershell
