...
### Exempel 1: Ta bort en miljö med tidsserieinsikter efter namn
```powershell
PS C:\> Remove-AzTimeSeriesInsightsEnvironment -ResourceGroupName testgroup -Name tsill

```

Det här kommandot tar bort en miljö med tidsserieinsikter.

### Exempel 2: Ta bort en miljö med tidsserieinsikter per objekt
```powershell
