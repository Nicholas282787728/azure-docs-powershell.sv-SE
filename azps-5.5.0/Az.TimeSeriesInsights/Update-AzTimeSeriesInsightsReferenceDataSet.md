...
### Exempel 1: Uppdatera en angiven referensdatauppsättning med namn
```powershell
...
Det här kommandot uppdaterar en angiven referensdatauppsättning.

### Exempel 2: Uppdatera en angiven referensdatauppsättning per objekt
```powershell
...
### -Name
Namnet på referensdatauppsättningen Tidserieinsikter som är associerad med den angivna miljön.
...
### -Tag
Nyckelvärdepar av ytterligare egenskaper för referensdatauppsättningen.
