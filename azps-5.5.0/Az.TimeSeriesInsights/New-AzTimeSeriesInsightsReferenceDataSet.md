...
### Exempel 1: Skapa en referensdatauppsättning för en viss miljö  
```powershell
...
Med det här kommandot skapas en referensdatauppsättning för en viss miljö.

## PARAMETERS

### -DataStringComparrisBehavior
Du kan ställa in jämförelsebeteendet för referensdata med den här egenskapen.
Som standard är värdet "Ordinal" – vilket innebär att jämförelse av viktiga fall utförs när referensdata sammanfogas med händelser eller när nya referensdata läggs till.
När "OrdinalIgnoreCase" har angetts används en okänslig jämförelse av gemener/VERSALER.
...
### -KeyProperty
Listan med viktiga egenskaper för referensdatauppsättningen.
Skapa genom att gå till avsnittet NOTES för KEYPROPERTY-egenskaper och skapa en hash-tabell.
...
### -Name
Namnet på referensdatauppsättningen.
...
### -Tag
Nyckelvärdepar med ytterligare egenskaper för resursen.
...
KEYPROPERTY <IReferenceDataSetKeyProperty[]>: Listan med nyckelegenskaper för referensdatauppsättningen.
  - `[Name <String>]`: Namnet på nyckelegenskapen.
  - `[Type <ReferenceDataKeyPropertyType?>]`: Typ av nyckelegenskap.
