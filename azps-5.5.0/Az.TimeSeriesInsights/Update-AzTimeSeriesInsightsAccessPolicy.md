...
### Exempel 1: Uppdatera en angiven åtkomstprincip med namn
```powershell
...
Det här kommandot uppdaterar en angiven åtkomstprincip.

### Exempel 2: Uppdatera en angiven åtkomstprincip per objekt
```powershell
...
### -Role
Listan över roller som huvudmannen tilldelas i miljön.
