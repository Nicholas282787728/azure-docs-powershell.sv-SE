...
### Exempel 1: Lista alla referensdatauppsättningar under den angivna miljön
```powershell
...
Det här kommandot listar alla referensdatauppsättningar under den angivna miljön.

### Exempel 2: Hämta en angiven referensdatauppsättning med namn
```powershell
...
Det här kommandot hämtar en angiven referensdatauppsättning.

### Exempel 3: Hämta en specifik referensdatauppsättning per objekt
```powershell
...
### -Name
Namnet på referensdatauppsättningen tidsserieinsikter som är associerad med den angivna miljön.
