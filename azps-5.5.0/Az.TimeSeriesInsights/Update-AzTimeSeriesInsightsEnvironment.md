...
### Exempel 1: Uppdatera en Insikter-miljö för gen1-tidsserier
```powershell
...
Det här kommandot uppdaterar en Gen1-miljö med tidsserieinsikter.

### Exempel 2: Uppdatera en Gen1-miljö för tidsserieinsikter
```powershell
...
### -Tag
Nyckelvärdepar av ytterligare egenskaper för miljön.
