...
### Exempel 1: Ta bort en angiven referensdatauppsättning med namn
```powershell
PS C:\> Remove-AzTimeSeriesInsightsReferenceDataSet -EnvironmentName tsitest001 -Name dstest001 -ResourceGroupName testgroup

```

Med det här kommandot tas en angiven referensdatauppsättning bort.

### Exempel 2: Ta bort en angiven referensdatauppsättning per objekt
```powershell
