...
### Exempel 1: Ta bort en angiven åtkomstprincip med namn
```powershell
PS C:\> Remove-AzTimeSeriesInsightsAccessPolicy -EnvironmentName tsitest001 -Name policy001 -ResourceGroupName testgroup

```

Med det här kommandot tas en angiven åtkomstprincip bort.

### Exempel 2: Ta bort en angiven åtkomstprincip per objekt
```powershell
...
### -Name
Namnet på åtkomstprincipen Tidserieinsikter som är associerad med den angivna miljön.
