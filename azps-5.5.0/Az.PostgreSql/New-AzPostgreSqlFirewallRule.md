...
### Exempel 1: Skapa en ny PostgreSql server-brandväggsregel
```powershell
...
Denna cmdlets skapar en PostgreSql-serverbrandväggsregel.

### Exempel 2: Skapa en ny PostgreSql-brandväggsregel med -ClientIPAddress.
```powershell
...
Denna cmdlets skapar en PostgreSql-brandväggsregel med -ClientIPAddress.

### Exempel 3: Skapa en ny PostgreSql-brandväggsregel för att tillåta alla IP-adresser
```powershell
...
Denna cmdlets skapar en ny PostgreSql-brandväggsregel för att tillåta alla IP-adresser.
