...
### Exempel 1: Återställa PostgreSql-server med GeoReplica Restore
```powershell
...
Med den här cmdleten återställs PostgreSql-servern med GeoReplica Restore.

### Exempel 2: Återställa PostgreSql-server med PointInTime Restore
```powershell
