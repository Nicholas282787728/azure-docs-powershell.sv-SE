...
### Exempel 3: Uppdatera postgreSql-brandväggsregeln efter -ClientIPAddress.
```powershell
...
Dessa cmdlets uppdaterar postgreSql-brandväggsregeln efter -ClientIPAddress.
