...
### Exempel 1: Ta bort PostgreSql server Virtual Network Rule med namn
```powershell
PS C:\> Remove-AzPostgreSqlVirtualNetworkRule -Name vnet -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Denna cmdlet tar bort PostgreSql server Virtual Network Rule med namn.

### Exempel 2: Ta bort PostgreSql server Virtual Network Rule med identitet
```powershell
...
Dessa cmdlets tar bort PostgreSql server Virtual Network Rule efter identitet.
