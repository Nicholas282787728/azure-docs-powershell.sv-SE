...
### Exempel 1: Starta om PostgreSql-server efter resursgrupp och servernamn
```powershell
PS C:\> Restart-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

Den här cmdleten startar om PostgreSql-servern efter resursgrupp och servernamn.

### Exempel 2: Starta om PostgreSql-server efter identitet
```powershell
...
Dessa cmdlets startar om PostgreSql-server efter identitet.
