...
### Exempel 1: Updatae specified PostgreSql configuration by name
```powershell
...
Den här cmdleten uppdaterar den angivna PostgreSql-konfigurationen med namn.

### Exempel 1: Updatae specified PostgreSql configuration by identity
```powershell
...
Den här cmdleten uppdaterar angiven PostgreSql-konfiguration efter identitet.
