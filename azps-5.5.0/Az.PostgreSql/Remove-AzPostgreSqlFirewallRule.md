...
ms.locfileid: "100227182"
---
# Remove-AzPostgreSqlFirewallRule

## SYNOPSIS
Tar bort en regel för serverbrandväggen.
...
### Exempel 1: Ta bort postgreSql-brandväggsregeln efter namn
```powershell
PS C:\> Remove-AzPostgreSqlFirewallRule -Name rule -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Med den här cmdleten tas PostgreSql-brandväggsregeln bort med namn.

### Exempel 2: Ta bort postgreSql-brandväggsregeln efter identitet
```powershell
...
Dessa cmdlets tar bort PostgreSql-brandväggsregeln efter identitet.
