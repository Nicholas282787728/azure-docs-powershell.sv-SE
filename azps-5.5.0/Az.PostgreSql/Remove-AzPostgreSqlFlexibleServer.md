...
### Exempel 1: Ta bort PostgreSql-server efter resourceGroup och servernamn
```powershell
PS C:\> Remove-AzPostgreSqlFlexibleServer -ResourceGroupName PowershellPostgreSqlTest -Name postgresql-test

```

Med den här cmdleten tas PostgreSql-servern bort av resourceGroup och servernamn.

### Exempel 2: Ta bort PostgreSql-server efter identitet
```powershell
...
Dessa cmdlets tar bort PostgreSql-server med identitet.
