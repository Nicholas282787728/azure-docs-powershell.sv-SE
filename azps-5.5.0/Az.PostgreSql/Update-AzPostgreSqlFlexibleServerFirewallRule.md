...
### Exempel 1: Uppdatera postgreSql-brandväggsregeln efter namn
```powershell
...
Den här cmdleten uppdaterar postgreSql-brandväggsregeln efter namn.

### Exempel 2: Uppdatera postgreSql-brandväggsregeln efter identitet.
```powershell
...
Dessa cmdlets uppdaterar postgreSql-brandväggsregeln efter identitet.
...
### -StartIPAddress
IP-adressen för serverbrandväggsregelns startadress.
Måste vara IPv4-format.
