...
### Exempel 1: Skapa en ny PostgreSql server-regel för virtuellt nätverk
```powershell
...
Dessa cmdlets skapar en PostgreSql server Virtual Network Rule.
