...
### Exempel 1: Visar alla regler för virtuellt nätverk i angiven PostgreSql-server
```powershell
...
Den här cmdleten listar alla regler för virtuellt nätverk i angiven PostgreSql-server.

### Exempel 2: Hämta en regel för virtuellt nätverk med namn
```powershell
