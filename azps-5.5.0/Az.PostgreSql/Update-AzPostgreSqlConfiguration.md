...
### Exempel 1: Uppdatera PostgreSql-konfigurationen efter namn
```powershell
...
Den här cmdleten uppdaterar PostgreSql-konfigurationen efter namn.
...
De här cmdlets uppdatera PostgreSql-konfigurationen efter identitet.
