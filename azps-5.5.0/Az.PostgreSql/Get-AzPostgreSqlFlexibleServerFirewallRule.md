...
### Exempel 1: Hämta brandväggsregler efter namn
```powershell
...
Den här cmdleten får brandväggsregler efter namn.

### Exempel 2: Hämta brandväggsregler efter identitet
```powershell
...
Den här cmdleten får brandväggsregler efter identitet.

### Exempel 3: Visar alla brandväggsregler i den angivna PostgreSql-servern
```powershell
...
Den här cmdleten listar hela brandväggsregeln i den angivna PostgreSql-servern.
