...
Använd Update-AzPostSqlFlexibleServerConfiguration i stället om du vill uppdatera serverparametrar som wait_timeout eller net_retry_count.
...
Den här cmdleten uppdaterar PostgreSql-server efter identitet.
