...
## BESKRIVNING
Med det här kommandot skapas en azure-slutpunkt för filsynkronisering i molnet. En molnslutpunkt är en referens till en befintlig Azure-filresurs. Den representerar filresursen och definierar att den ska delta i synkronisering av alla filer som en del av synkroniseringsgruppen som molnslutpunkten har skapats i.
...
En molnslutpunkt är en integrerad medlem i en synkroniseringsgrupp, det här är ett exempel på att skapa en i en befintlig synkroniseringsgrupp som kallas "mySyncGroupName".
...
### -AzureFileShareName
Namn på lagringskontoresurs (Azure-filresursnamn)
...
### -Name
Namn på molnslutpunkten. När namnet skapas via Azure-portalen anges namnet på azure-filresursen som den refererar till.
...
Klientorganisations-ID för lagringskonto (företagskatalog-ID)
