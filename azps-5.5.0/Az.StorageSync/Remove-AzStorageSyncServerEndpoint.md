...
## BESKRIVNING
Att ta bort en serverslutpunkt är en skadligt åtgärd. Den här serverplatsen slutar synkroniseras. Den här åtgärden bör inte utföras för att lösa synkroniseringsproblem. Om den här serverplatsen (inklusive dess filer) läggs till i samma synkroniseringsgrupp som en serverslutpunkt kan det leda till konflikter och andra oavsiktliga konsekvenser. Det här kommandot är endast avsett för inaktivering.
...
Med det här kommandot tas serverslutpunkten bort.
...
### -InputObject
ServerEndpoint Input Object, som normalt passerar genom pipelinen.
