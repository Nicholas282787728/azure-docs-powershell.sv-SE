...
## BESKRIVNING
Med det här kommandot avregistreras en server från lagringssynkroniseringstjänsten. Varning! Om du avregistrerar en server kan det resultera i sammanhängande borttagningar av alla serverslutpunkter på den här servern. Den bör endast anropas när du är säker på att ingen sökväg på den här servern ska synkroniseras längre.
...
Det här kommandot avregistrerar servern, vilket orsakar sammanhängande borttagningar av alla serverslutpunkter på den här servern.
...
### -InputObject
RegisteredServer Input Object, vanligtvis genom pipelinen.
