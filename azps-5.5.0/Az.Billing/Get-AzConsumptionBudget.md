...
## BESKRIVNING
Med Get-AzConsumptionBudget-cmdleten får du en lista med budgetar i en prenumeration eller en resursgrupp.

## EXEMPEL

### Exempel 1: Få en lista över budgetar på prenumerationsnivå
```powershell
...
### Exempel 2: Hämta en lista över budgetar på resursgruppnivå
```powershell
...
### Exempel 3: Få en budget med budgetnamnet på prenumerationsnivå
```powershell
...
### Exempel 4: Få en budget med budgetnamnet på resursgruppnivå
```powershell
