...
## BESKRIVNING
Cmdleten **Get-AzInvoiceSection** får fakturaavsnitt under den angivna faktureringsprofilen. 
...
Få alla fakturaavsnitt under den angivna faktureringsprofilen.
...
### -Name
Namnet på ett visst fakturaavsnitt.
