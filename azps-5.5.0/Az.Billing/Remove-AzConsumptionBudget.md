...
## BESKRIVNING
Med Remove-AzConsumptionBudget-cmdleten tas en budget bort i antingen en prenumeration eller en resursgrupp.

## EXEMPEL

### Exempel 1: Ta bort en budget med ett budgetnamn på prenumerationsnivå
```powershell
PS C:\> Remove-AzConsumptionBudget -Name PSBudget -PassThru
True
```

### Exempel 2: Ta bort en budget med ett budgetnamn på resursgruppnivå
```powershell
PS C:\> Remove-AzConsumptionBudget -ResourceGroupName RGBudgets -Name PSBudgetRG -PassThru
True
```

### Exempel 3: Ta bort en budget med rörledning på prenumerationsnivå
```powershell
