...
## BESKRIVNING
Cmdleten **Get-AzConsumptionServerationDetail** hämtar bokningsinformation för det angivna datumintervallet.

## EXEMPEL

### Exempel 1: Hämta information om reservationsbeställningen med boknings-ID för det angivna datumintervallet
```powershell
...
### Exempel 2: Hämta information om reservationen med bokningsbeställnings-ID och reservations-ID för det angivna datumintervallet
```powershell
...
### -EndDate
Slutdata (KYYY-MM-DD i UTC) för reservationsinformationen.
...
### -Startdatum
Startdata (YYYY-MM-DD i UTC) för reservationsinformationen.
...
### Microsoft.Azure.Commands.Consumption.Models.PSServerationDetail
