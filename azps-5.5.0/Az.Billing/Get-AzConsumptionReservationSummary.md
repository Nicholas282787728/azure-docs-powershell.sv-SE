...
## BESKRIVNING
Cmdleten **Get-AzConsumptionServerationSummary** får reservationsammanfattningar för dagliga eller månatliga grain.

## EXEMPEL

### Exempel 1: Hämta reservationsammanfattningar med bokningsorder-ID för månatlig grain
```powershell
...
### Exempel 2: Hämta reservationsammanfattningar med reservationsbeställnings-ID och reservations-ID för månatlig grain
```powershell
...
### Exempel 3: Hämta reservationsammanfattningar med bokningsorder-ID för dagligt intervall som angetts
```powershell
...
### Exempel 4: Hämta reservationssammanfattningar med bokningsorder-ID och reservations-ID för dagligt intervall som angetts
```powershell
...
### -EndDate
Slutdata (YYYY-MM-DD i UTC) i sammanfattningen av reservationen, som endast krävs för dagliga grain.
...
### -Grain
Tids grain för sammanfattningen av reservationen kan vara dagligen eller månadsvis.
...
### -ReservationId
Identifieraren för en reservation inom en reservationsbeställning.
...
### -ReservationOrderId
Identifieraren för ett reservationsköp.
...
### -Startdatum
Startdata (YYYY-MM-DD i UTC) i sammanfattningen av reservationen, som endast krävs för dagliga grain.
...
### Microsoft.Azure.Commands.Consumption.Models.PSServerationSummary
