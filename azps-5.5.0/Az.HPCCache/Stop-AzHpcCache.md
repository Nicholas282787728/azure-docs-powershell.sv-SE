...
## BESKRIVNING
**Stopp-AzHpcCache-cmdleten** stoppar en Azure HPC-cache.
...
### -Force
Anger att cmdleten inte uppmanar dig att bekräfta. Som standard uppmanar den här cmdleten dig att bekräfta att du vill stoppa cachen.
...
### -ResourceGroupName
Namn på resursgrupp som du vill stoppa cachen för.
