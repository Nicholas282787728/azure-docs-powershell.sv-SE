...
## BESKRIVNING
**Cmdleten New-AzHpcCacheStorageTarget** lägger till ett lagringsmål i Azure HPC-cachen.
...
### -Force
Anger att cmdleten inte uppmanar dig att bekräfta. Som standard uppmanar den här cmdleten dig att bekräfta att du vill tömma cachen.
...
### -ResourceGroupName
"Namn på resursgrupp för vilken du vill skapa lagringsmål för en viss cache.
