...
## BESKRIVNING
**Cmdleten Remove-AzHpcCacheStorageTarget** tar bort ett lagringsmål från Azure HPC-cache.
...
### -Force
Anger att cmdleten inte uppmanar dig att bekräfta. Som standard uppmanar den här cmdleten dig att bekräfta att du vill ta bort lagringsmålet.
...
### -ResourceGroupName
Namn på resursgrupp där du vill ta bort lagringsmålet från cachen.
