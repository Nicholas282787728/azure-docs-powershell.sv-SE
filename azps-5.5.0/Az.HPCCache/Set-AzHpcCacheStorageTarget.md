...
## BESKRIVNING
Cmdleten **Set-AzHpcCacheStorageTarget** uppdaterar ett lagringsmål som är kopplat till Azure HPC-cache.
...
### -ResourceGroupName
Namn på resursgrupp som du vill uppdatera lagringsmålet för.
