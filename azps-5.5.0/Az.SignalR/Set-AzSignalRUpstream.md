...
Följande JSON representerar den faktiska malluppsättningen. 
...
### Ta bort alla inställningar som är överordnade
```powershell
...
### -Rensa
Ta bort alla överordnade inställningar.
...
### -Mall
Mallobjekt för överordnade inställningar.
Obligatorisk nyckel: UrlTemplate.
Valfria nycklar: HubPattern, EventPattern, CategoryPattern.
Exempel med splattingssyntax för att överföra mallparameter: @{UrlTemplate=' http://host-connections1.com ', HubPattern= 'chat'; EventPattern='broadcast' },@{UrlTemplate=' http://host-connections2.com '}
...
[Använda splatting för att överföra parametrar till kommandon i PowerShell](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_splatting?view=powershell-7)
