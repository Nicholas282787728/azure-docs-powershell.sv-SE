...
### Få alla SignalR-tjänster i prenumerationen
```
PS C:\> Get-AzSignalR
...
### Hämta alla signalr-tjänster i en resursgrupp
```
...
### Skaffa en särskild signaltjänst
```
...
### Hämta en specifik signaltjänst från standardresursgruppen
```
...
Standardresursgruppen kan ställas in med \` Set-AzDefault -ResourceGroupName myResourceGroup. \`
