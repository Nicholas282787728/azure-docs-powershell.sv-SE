...
## BESKRIVNING
Generera API-nycklarna för en blockchainmedlem.

## EXEMPEL

### Exempel 1: Generera API-nycklar för en blockringsmedlem med namn
```powershell
...
Det här kommandot återskapar API-nycklar för en blockchainmedlem med namn, resursgrupp.

### Exempel 2: Generera API-nycklar för en blockchainmedlem med idenity
```powershell
PS C:\> $keyPair = Get-AzBlockchainMemberApiKey -BlockchainMemberName myblockchainhlqc92 -ResourceGroupName bc-rg
...
Det här kommandot återskapar API-nycklar för en blockchainmedlem med identitet.
...
### -KeyName
Hämtar eller anger API-nyckelns namn.
