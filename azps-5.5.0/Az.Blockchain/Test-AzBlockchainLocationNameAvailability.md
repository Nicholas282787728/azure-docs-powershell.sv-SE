...
### Exempel 1: Kontrollera om ett resursnamn är tillgängligt
```powershell
...
Kommandot kontrollerar om ett resursnamn är tillgängligt.

### Exempel 2: Kontrollera om ett resursnamn är tillgängligt
```powershell
...
### -Name
Hämtar eller anger namnet som ska kontrolleras.
...
### -Type
Hämtar eller anger vilken typ av resurs som ska kontrolleras.
