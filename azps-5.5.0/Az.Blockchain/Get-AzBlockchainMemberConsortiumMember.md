...
### Exempel 1: Listar konsortialmedlemmarna för en blockringsmedlem.
```powershell
...
Det här kommandot listar konsortialmedlemmarna för en blockringsmedlem.
