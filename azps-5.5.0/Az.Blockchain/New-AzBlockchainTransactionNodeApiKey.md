...
### Exempel 1: Generera API-nycklar för en transaktionsnod med namn.
```powershell
...
Det här kommandot genererar API-nycklar för en transaktionsnod med namn, resursgrupp.

### Exempel 2: Generera API-nycklar för en transaktionsnod
```powershell
PS C:\> $keyPair = Get-AzBlockchainTransactionNodeApiKey -BlockchainMemberName dolauli001 -ResourceGroupName testgroup -TransactionNodeName tranctionnode001 
...
Det här kommandot genererar API-nycklar för en transaktionsnod med idenity.
