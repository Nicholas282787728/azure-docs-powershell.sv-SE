...
### Exempel 1: Lista transaktionsnoder för en blockringsmedlem
```powershell
...
Det här kommandot visar transaktionsnoder för en blockringsmedlem.

### Exempel 2: Hämta en transaktionsnod
```powershell
...
Det här kommandot får en transaktionsnod.

### Exempel 3: Hämta en transaktionsnod
```powershell
