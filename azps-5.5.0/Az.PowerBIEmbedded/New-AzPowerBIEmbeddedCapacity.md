...
## BESKRIVNING
Med New-AzPowerBIEmbeddedCapacity-cmdleten skapas en ny Inbäddad PowerBI-kapacitet
...
Skapar en kapacitet med namnet testkapacitet i Azure-regionen Västra centrala USA och i resursgrupptestRG. SKU-nivån för kapaciteten blir A1.

## PARAMETERS

### -Administratör
Kommaavgränsade namn för att ange som administratör för kapaciteten
...
### -Plats
Azure-regionen där PowerBI-inbäddad kapacitet finns
