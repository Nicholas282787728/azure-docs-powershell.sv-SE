...
## BESKRIVNING
Med Get-AzPowerBIEmbeddedCapacity-cmdleten får du information om en PowerBI-inbäddad kapacitet.

## EXEMPEL

### Exempel 1: Hämta resursgruppkapacitet
```
...
Med det här kommandot får du all Inbäddad Azure PowerBI-kapacitet i resursgruppen testRG

### Exempel 2: Få en kapacitet
```
...
Det här kommandot får azure PowerBI-inbäddad kapacitet med namnet testcapacity i resursgruppen testRG.
