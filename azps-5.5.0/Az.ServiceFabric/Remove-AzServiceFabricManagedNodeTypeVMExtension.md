...
## BESKRIVNING
Ta bort vm-tillägg från nodtypen efter namn. Använd [Get-AzServiceFabricManagedNodeType](./Get-AzServiceFabricManagedNodeType.md) och titta på egenskapen VmExtensions för att visa det aktuella tillägget på nodtypen.
...
Ta bort tillägg från nodtyp efter namn.
...
Ta bort tillägg från nodtyp efter namn, med rörledning.
