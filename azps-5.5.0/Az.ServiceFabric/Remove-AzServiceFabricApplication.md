...
ms.locfileid: "100217543"
---
# Remove-AzServiceFabricApplication

## SYNOPSIS
Ta bort ett program från klustret. Då tas alla tjänster i programmet bort. Stöder endast ARM distribuerade program.
...
## BESKRIVNING
Den här cmdleten tar bort ett programformulär för klustret. Då tas alla tjänster, om några, bort under programresursen.
...
Det här exemplet tar bort programmet "testApp" under resursgruppen "testRG" och cluster "testCluster".
