...
## BESKRIVNING
Använd **Set-AzServiceFabricSetting till att** lägga till eller uppdatera inställningar för Service Fabric i ett kluster.
...
Det här kommandot utlöser en uppgradering för att ange flera strukturinställningar med parametern SettingsSectionDescription.
...
### -Parameter
Parameternamn för strukturinställningen
...
### -Section
Avsnittsnamn för fabric-inställningen
...
En matris med strukturinställningar
...
### -Värde
Parametervärde för strukturinställningen
