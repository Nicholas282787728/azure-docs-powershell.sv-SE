...
Uppdatera dns-namn och klientanslutningsport för klustret.
...
Uppdatera dns-namn och klientanslutningsport för klustret med rörledning.
...
### -CodeVersion
Klusterkodsversion. Använd endast om uppgraderingsläget är manuellt.
...
Slutpunkt som används av omvänd proxyserver.
...
### -UpgradeMode
Uppgraderingsläge för klusterkodsversion. Automatisk eller manuell.
