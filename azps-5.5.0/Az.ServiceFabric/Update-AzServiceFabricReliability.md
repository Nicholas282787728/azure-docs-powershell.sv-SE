...
## BESKRIVNING
Använd **Update-AzServiceFabricReliability för att** uppdatera tillförlitligheten för primärnodtypen i ett kluster.
...
Med det här kommandot ändras tillförlitlighetsnivån för den primära nodtypen till silver.

### Exempel 2

Uppdatera tillförlitlighetsnivån för primärnodstypen i ett kluster. (autogenererat)
...
### -AutoAddNode
Lägga till nodantal automatiskt när du ändrar tillförlitlighet
