...
Kommandot **New-AzServiceFabricCluster** använder certifikat som du tillhandahåller eller systemgenererade själv signerade certifikat för att skapa ett nytt tjänstkluster. Mallen som används kan vara en standardmall eller en anpassad mall som du anger. Du kan ange en mapp för att exportera själv signerade certifikat eller hämta dem senare från nyckelvalvet.
Om du anger en anpassad mall och parameterfil behöver du inte ange certifikatinformationen i parameterfilen. Systemet fyller i dessa parametrar.
De fyra alternativen anges nedan. Rulla nedåt för information om var och en av parametrarna.
...
### Exempel 3: Skapa ett nytt kluster med hjälp av en anpassad mall. Ange ett annat namn för resursgruppen för nyckelvalvet och be systemet ladda upp ett nytt certifikat till det
...
Med det här kommandot skapas ett nytt kluster med en anpassad mall. Ange ett annat namn för resursgruppen för nyckelvalvet och be systemet ladda upp ett nytt certifikat till det
...
Tumuttryck för certifikatutfärdare, avgränsade med kommatecken om det är mer än ett
...
Ämnesnamnet för det certifikat som ska skapas
...
Azure-nyckelvalvnamn, om det inte anges kommer att anges som resursgruppnamn
...
Azure-nyckelvalv resursgruppnamn, om det inte ges det kommer att anges som standard resursgruppnamn
...
Ange namnet på klustret om det inte anges som resursgruppnamn
...
Operativsystemet för de virtuella maskinerna som utgör klustret.
...
Den befintliga hemliga URL:en för Azure-nyckelvalv, till exempel https://mykv.vault.azure.net:443/secrets/mysecrets/55ec7c4dc61a462bbc645ffc9b4b225f '
...
### -Thumbprint
Tumutskriften för certifikatkorrespoinding till SecretIdentifier. Använd det här om certifikatet inte hanteras eftersom nyckelvalv bara skulle ha certifikatet lagrat som en hemlig och cmdleten inte kan retreive the thumbprint.
...
Användarnamnet för loggning till Vm
...
### Microsoft.Azure.Commands.ServiceFabric.Models.PSDepdistributionResult
