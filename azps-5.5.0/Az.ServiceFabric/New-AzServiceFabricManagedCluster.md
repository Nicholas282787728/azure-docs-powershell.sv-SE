...
## BESKRIVNING
Den här cmdleten skapar en hanterad klusterresurs utan nodtyper. Om du vill att bootstrap klustret en primär nodtyp måste läggas till använder [du New-AzServiceFabricManagedNodeType.](./New-AzServiceFabricManagedNodeType.md)
...
Med det här kommandot skapas en klusterresurs med grundläggande standard-SKU.
...
### -AdminPassword
Administratörslösenord som används för virtuella datorer.
...
Det vanliga namnet på klientcertifikatet.
...
### -ClientCertIsAdmin
Används för att ange om klientcertifikatet har administratörsnivå.
...
Lista över utfärdares tumutskrifter för klientcertifikatet.
Används endast i kombination med ClientCertCommonName.
...
Tumuttryck för klientcertifikat.
...
Port som används för klientanslutningar till klustret.
Standard: 19000.
...
Använd endast om uppgraderingsläget är manuellt.
...
Slutpunkt som används av omvänd proxy.
...
### -SKU
Klusterens SKU, alternativen är grundläggande: den har minst 3 startnoder och tillåter bara 1 nodtyp och Standard: den har minst 5 startnoder och tillåter flera nodtyper.
...
### -UseTestExtension
Om Ange klustret kommer att kröras med tillägget Service test VMSS.
