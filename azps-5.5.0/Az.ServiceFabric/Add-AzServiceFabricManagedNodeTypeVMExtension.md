...
## BESKRIVNING
Lägg till vm-tillägg till nodtypen. Då kommer tillägget att läggas till för den underliying-resurs för virtual machine Scale Set.
...
Det här kommandot lägger till ett tillägg till nodtypen med piping.
...
### -ForceUpdateTag
Om ett värde har angetts och skiljer sig från det föregående värdet tvingas tilläggshanteraren att uppdatera även om tilläggskonfigurationen inte har ändrats.
...
Det här kan använda Get-AzVMImagePublisher cmdlet för att hämta utgivaren.
...
Du kan använda Get-AzVMExtensionImageType cmdlet för att hämta tilläggstyp.
