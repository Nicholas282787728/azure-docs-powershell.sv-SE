...
## BESKRIVNING
Använd **Remove-AzServiceFabricClientCertificate** för att ta bort ett klientcertifikat eller certifikatämnesnamn från att användas för klientautentisering till klustret.
...
Det här kommandot tar bort klientcertifikat med thumbprintet '5F3660C715EBBDA31DB1FFDCF508302348DE8E7A' från klustret.
...
### -CommonName
Ange ett gemensamt namn för klientcertifikat
...
### -IssuerThumbprint
Ange thumbprint av utfärdare av klientcertifikat
