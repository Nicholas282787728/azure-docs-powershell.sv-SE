...
ms.locfileid: "100231902"
---
# Get-AzServiceFabricService

## SYNOPSIS
Hämta tjänstinformation för Service Fabric under det angivna programmet och klustret. Stöder endast ARM distribuerade tjänster.
...
I det här exemplet hämtar vi information om tjänstresursen för tjänsten "testApp~testService".
...
I det här exemplet visas en lista över tjänsterna under programmet "testApp".
