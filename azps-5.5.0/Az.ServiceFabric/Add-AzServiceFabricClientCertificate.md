...
## BESKRIVNING
Använd **Add-AzServiceFabricClientCertificate** för att lägga till ett vanligt namn och utfärdares tumavtryck eller certifikat tumavtryck i klustret, så att klienten kan använda det för autentisering.
...
Det här kommandot lägger till certifikatet med thumbprintet '5F3660C715EBBDA31DB1FFDCF508302348DE8E7A' i klustret, så att klienten kan använda certifikatet som administratör för att kommunicera med klustret.
...
Det här kommandot lägger till ett skrivskyddat klientcertifikat som är det vanliga namnet är "Contoso.com" och utfärdarens thumbprint är "5F3660C715EBBDA31DB1FFDCF508302348DE8E7A" i klustret.

## PARAMETERS

### -Admin
Klientautentiseringstyp
...
Ange thumbprint för klientcertifikat som bara har administratörsbehörighet
...
Ange klientens vanliga namn, utfärdares tumuttryck och autentiseringstyp
...
### -CommonName
Ange ett gemensamt namn för klientcertifikatet
...
### -IssuerThumbprint
Ange thumbprintet för klientens certifikatsutfärdare
...
Ange thumbprint för klientcertifikat som bara har skrivskyddsbehörighet
...
### -Thumbprint
Ange tumavtryck för klientcertifikat
