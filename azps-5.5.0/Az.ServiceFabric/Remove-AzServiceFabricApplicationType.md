...
ms.locfileid: "100217542"
---
# Remove-AzServiceFabricApplicationType

## SYNOPSIS
Ta bort tjänstkluster och programtyper från klustret. Då tas alla typer av versioner under resursen bort. Stöder endast ARM distribuerade programtyper.
...
## BESKRIVNING
Den här cmdleten tar bort ett programtypsformulär för klustret och tar bort alla typer av versioner under den här resursen, men alla program under den bör tas bort innan du kör det här kommandot.
...
I det här exemplet tas programtypen "testAppType" och all version under den bort. Om det finns program som har skapats med den här typen, ger kommandot ett undantag.
...
### -ResourceId
Arm ResourceId av programtypen.
