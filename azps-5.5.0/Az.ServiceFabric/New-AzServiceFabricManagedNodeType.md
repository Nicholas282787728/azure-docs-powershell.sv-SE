...
ms.locfileid: "100252984"
---
# New-AzServiceFabricManagedNodeType

## SYNOPSIS
Skapa ny nodtypsresurs.
...
## BESKRIVNING
Skapa en ny nodtypsresurs för ett visst kluster.
...
### -Capacity
Kapacitetstaggar som används på noder i nodtypen som nyckel-/värdepar använder klusterresurshanteraren de här taggarna för att förstå hur mycket resursen en nod har.
Om du uppdaterar det åsidosätts de aktuella värdena.
...
### -DiskSize
Diskstorlek för varje vm i nodtypen i GBs.
Standard 100.
...
På den här nodtypen körs systemtjänster.
Endast en nodtyp ska markeras som primär.
Primär nodtyp kan inte tas bort eller ändras för befintliga kluster.
...
### -VmImageOffer
Offer-typen av Azure Virtual Machines Marketplace-bild.
...
### -VmImagePublisher
Bild på utgivaren av Azure Virtual Machines Marketplace.
...
### -VmImageSku
Bild på SKU för Azure Virtual Machines Marketplace.
...
### -VmImageVersion
Bild på versionen av Azure Virtual Machines Marketplace.
Standard: senaste.
