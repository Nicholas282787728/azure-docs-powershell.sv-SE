...
ms.locfileid: "100232711"
---
# Remove-AzServiceFabricService

## SYNOPSIS
Ta bort en tjänst från klustret. Stöder endast ARM distribuerade tjänster.
...
## BESKRIVNING
Den här cmdleten tar bort ett tjänstformulär för klustret.
...
I det här exemplet tas tjänsten "testApp~testService1" bort.
