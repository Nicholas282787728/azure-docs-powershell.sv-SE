...
Det här kommandot lägger till en ny NodeType 'n2" med kapacitet på 5 och det virtuella administratörsnamnet är adminName.
...
### -Level
Ange varaktighetsnivån för NodeType.
...
### -VmPassword
Lösenordet för inloggning till Vm
...
### Microsoft.Azure.Commands.serviceFabric.Models.Level
