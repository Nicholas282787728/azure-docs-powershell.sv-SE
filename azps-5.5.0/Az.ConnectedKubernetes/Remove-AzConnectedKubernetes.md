...
ms.locfileid: "100228998"
---
# Remove-AzConnectedKubernetes

## SYNOPSIS
Ta bort ett anslutet kluster och ta bort den spårade resursen i Azure Resource Manager (ARM).
...
Med det här kommandot tas ett anslutet kubernetes bort från objekt
...
INPUTOBJECT <IConnectedKubernetesIdentity> : Identity Parameter
  - `[ClusterName <String>]`: Namnet på Kubernetes-klustret som hämtar anropas.
