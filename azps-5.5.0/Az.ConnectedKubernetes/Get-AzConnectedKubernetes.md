...
### Exempel 1: Få alla anslutna kubernät under en prenumeration
```powershell
...
Med det här kommandot får du alla anslutna kubernät under en prenumeration.

### Exempel 2: Få alla anslutna kubernät under resursgruppen
```powershell
...
Med det här kommandot hamnar alla anslutna kubernät under resursgruppen.
...
Det här kommandot får ett anslutet kubernät.

### Exempel 4: Hämta en ansluten kubernetes efter objekt
```powershell
...
Med det här kommandot får du ett anslutet kubernetes per objekt.
...
INPUTOBJECT <IConnectedKubernetesIdentity> : Identity Parameter
  - `[ClusterName <String>]`: Namnet på Kubernetes-klustret som hämtar kallas.
