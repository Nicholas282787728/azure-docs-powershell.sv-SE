...
ms.locfileid: "100229007"
---
# New-AzConnectedKubernetes

## SYNOPSIS
API för att registrera ett nytt K8s-kluster och därmed skapa en spårad resurs i ARM
...
### Exempel 1: Skapa en ansluten kubernät
```powershell
...
Med det här kommandot skapas ett anslutet kubernät.
...
Med det här kommandot skapas en ansluten kubernetes med parametrarna kubeConfig och kubeContext.

## PARAMETERS

### -ClusterName
Namnet på Kubernetes-klustret som hämtar kallas.
...
### -ResourceGroupName
Namnet på den resursgrupp som kubernetes-klustret är registrerat för.
...
### -SubscriptionId
ID för prenumerationen som kubernetes-klustret är registrerat för.
