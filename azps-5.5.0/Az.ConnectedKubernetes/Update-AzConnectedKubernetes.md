...
ms.locfileid: "100228990"
---
# Update-AzConnectedKubernetes

## SYNOPSIS
API för att uppdatera vissa egenskaper för den anslutna klusterresursen
...
### Exempel 1: Uppdatera anslutna kubernät
```powershell
...
Det här kommandot uppdaterar anslutna kubernät.
