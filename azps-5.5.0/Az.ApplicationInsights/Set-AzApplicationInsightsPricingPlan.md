...
## BESKRIVNING
Ange prisplan och daglig datavolyminformation för en resurs med programinsikter.
Prisplanen för programinsikter som skapats efter april 2018 kan inte anges av denna cmdlet: https://docs.microsoft.com/en-us/azure/azure-monitor/app/pricing#legacy-enterprise-per-node-pricing-tier

## EXEMPEL

### Exempel 1 Ange prisplan och daglig datavolyminformation för en resurs med programinsikter
```
...
Ställ in prisplanen på "Grundläggande", ange att den dagliga datavolymen ska vara 400 GB per dag och sluta skicka ett meddelande när resurs "test" har satts upp i resursgruppen "testgrupp"
