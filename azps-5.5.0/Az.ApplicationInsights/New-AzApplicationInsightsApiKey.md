...
## BESKRIVNING
Skapa API-nycklar för programinsikter för en resurs med programinsikter

## EXEMPEL

### Exempel 1 Skapa en ny API-nyckel för en resurs med programinsikter
```
...
Skapa API-nyckelbeskrivningar för programinsikter som "testapiKey" med behörigheter "ReadTelemetry", "WriteAnnotations" för resurs "test" i resursgruppen "testGroup".
...
### -Beskrivning
Beskrivning för att identifiera API-nyckeln.
...
### -Behörigheter
Behörigheter som API-nyckeln tillåter att appar gör.
