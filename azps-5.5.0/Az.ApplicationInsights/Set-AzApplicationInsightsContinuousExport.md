...
Uppdatera kontinuerlig exportkonfiguration "jlTFEiBg1rkDXOCIeJQ2mB2TxZg=" för resurs "test" i resursgruppen "testgrupp" för att exportera "Begäran" och "Spåra" dokument till lagringsbehållaren "testcontainer" i "teststorageaccount". SAS-token måste vara giltigt och ha skrivbehörighet till behållaren, annars fungerar inte funktionen för kontinuerlig export. Om SAS token har upphört att gälla slutar funktionen för kontinuerlig export att fungera.
...
Inaktivera kontinuerlig export eller inte.
