...
### Exempel 1 Skapa en ny resurs för programinsikter
```
...
Lägga till en ny resurs för programinsikter som heter "test" i resursgruppen "testgrupp" med typen "java"
...
Nätverksåtkomsttypen för åtkomst till programinsikter igestion. Värdet ska vara Aktiverat eller Inaktiverat
...
Nätverksåtkomsttypen för åtkomst till frågan Programinsikter. Värdet ska vara Aktiverat eller Inaktiverat
