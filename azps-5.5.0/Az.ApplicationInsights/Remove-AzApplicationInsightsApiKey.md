...
### Exempel 1 Ta bort en API-nyckel för programinsikter
```
...
Ta bort api-nyckeln för specifika programinsikter som id är "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" för resurs "test" i resursgruppen "testGroup".
...
### -PassThru
Om angiven kommer att skrivas som sant om åtgärden lyckas. Den här parametern är valfri. Standardvärdet är falskt.
