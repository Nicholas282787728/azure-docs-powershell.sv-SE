...
### Exempel 1 Hämta API-nycklar för en resurs med programinsikter
```
...
Hämta API-nycklar med programinsikter för resursens "test" i resursgruppen "testGroup".

### Exempel 2 Hämta specifik API-nyckel för en resurs med programinsikter
```
...
Få specifik API-nyckel för programinsikter som id är "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" för resurs "test" i resursgruppen "testGroup".

## PARAMETERS

### -ApiKeyId
Api-nyckel-ID för Application Insights API.
