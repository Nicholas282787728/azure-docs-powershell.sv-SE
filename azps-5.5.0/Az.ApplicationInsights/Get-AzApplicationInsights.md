...
## BESKRIVNING
Få resurser för programinsikter i en resursgrupp eller specifik resurs

## EXEMPEL

### Exempel 1 Hämta resurs med programinsikter
```
...
Hämta resurs med namnet "test" i resursgruppen "testgrupp"

### Exempel 2 Hämta resurs med information om programinsikter med information om prisplanen
```
...
Hämta resurs med programinsikter och ta med prisplansinformation för resursen med namnet "test" i resursgruppen "testgrupp"
...
### -Full
Om detta anges får programmet en prisplan/daglig gräns och status för programmets informationskomponent.
