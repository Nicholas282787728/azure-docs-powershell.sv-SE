...
### Exempel 1 Ta bort en löpande exportkonfiguration i en resurs med information om ett program
```
PS C:\> Remove-AzApplicationInsightsContinuousExport -ResourceGroupName "testgroup" -Name "test" -ExportId "uGOoki0jQsyEs3IdQ83Q4QsNr4=" -PassThru
True
```

Ta bort konfiguration med kontinuerlig export med export-ID "uGOoki0jQsyEs3IdQ83Q4QsNr4=" för resurs med namnet "test" i resursgruppen "testgrupp"
...
### -ExportId
Kontinuerlig export-ID för Programinsikter.
