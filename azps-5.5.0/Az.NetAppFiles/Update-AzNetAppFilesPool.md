...
Det här kommandot ändrar ANF-poolen "MyAnfPool" till att ha den angivna storleken och QosType.
...
### -AccountObject
Kontoobjektet som innehåller poolen som ska uppdateras
...
### -InputObject
Poolobjektet som ska uppdateras
...
### -QosType
QOS-typen för poolen. Möjliga värden är: "Auto", "Manuellt"
