...
Det här kommandot tar bort den nya ANF Active Directory-konfigurationen med namnet "MyADName".
...
### -PassThru
Returnera om angiven Active Directory har tagits bort
