...
## BESKRIVNING
Cmdleten **Get-AzNetAppFilesBackupPolicy** får information om en säkerhetskopieringsprincip för ANF.
...
Det här kommandot hämtar säkerhetskopieringsprincipen med namnet "MyBackupPolicy" för kontot "MyAnfAccount".
...
### -AccountObject
Kontoobjektet som innehåller den säkerhetskopieringsprincip som ska returneras
