...
## BESKRIVNING
Cmdleten **Get-AzNetAppFilesActiveDirectory** hämtar information om ACTIVEF-kontons Active Directory-konfiguration.
...
Det här kommandot hämtar AD-konfigurationen med namnet MyADConfigName för Azure NetApp-kontot (ANF) med namnet MyAnfAccount.
