...
## BESKRIVNING
Cmdleten **Get-AzNetAppFilesBackup** får information om en ANF-säkerhetskopia.
...
Med det här kommandot får du problem med namnet "MyAnfAccount" från volymen "MyVolume".
