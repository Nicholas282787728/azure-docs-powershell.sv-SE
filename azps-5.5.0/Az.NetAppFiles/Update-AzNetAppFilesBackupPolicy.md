...
## BESKRIVNING
Cmdleten **Update-AzNetAppFilesBackupPolicy** ändrar en princip för ANF-säkerhetskopiering.
...
Det här kommandot ändrar ANF-säkerhetskopieringsprincipen "MyBackupPolicy" så att den givna DailyBackupsToKeep.
...
### -AccountObject
Kontoobjektet som innehåller den säkerhetskopieringsprincip som ska uppdateras
...
### -InputObject
BackupPolicy-objektet som ska tas bort
...
### -ResourceId
Resurs-ID för principen för säkerhetskopiering av ANF
...
### -YearlyBackupsToKeep
Årssäkerhetskopior som ska behållas
