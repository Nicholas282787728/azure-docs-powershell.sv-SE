...
Det här kommandot utför en uppdatering på den givna Active Directory-konfigurationen som ändrar användarnamnet som visas.
...
### -Dns
Kommaavgränsad lista med DNS-serverns IP-adresser (endast IPv4) för Active Directory-domänen
...
### -InputObject
Active Directory-objektet som ska tas bort
