...
## BESKRIVNING
Cmdleten **Get-AzNetAppFilesSnapshot** får information om en ANF-ögonblicksbild.
...
Det här kommandot får ögonblicksbilden Med namnet MyAnfSnapshot från volymen "MinAnfVolume".
