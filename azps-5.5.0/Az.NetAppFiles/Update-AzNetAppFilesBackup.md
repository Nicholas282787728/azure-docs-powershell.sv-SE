...
## BESKRIVNING
Cmdleten **Update-AzNetAppFilesBackup** ändrar en ANF-säkerhetskopia.
...
Det här kommandot utför en uppdatering på den givna säkerhetskopian som ändrar användarnamnet som visas.
...
### -ResourceId
Resurs-ID för säkerhetskopian av ANF
...
### -VolumeObject
Volymobjektet som innehåller säkerhetskopian som ska returneras
