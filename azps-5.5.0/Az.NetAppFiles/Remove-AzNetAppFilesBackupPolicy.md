...
## BESKRIVNING
Cmdleten **Remove-AzNetAppFilesBackupPolicy** tar bort en princip för ANF-säkerhetskopiering.
...
### -AccountObject
Kontoobjektet som innehåller den säkerhetskopieringsprincip du vill ta bort
