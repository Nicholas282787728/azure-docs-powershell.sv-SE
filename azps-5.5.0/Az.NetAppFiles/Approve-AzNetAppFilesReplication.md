...
## BESKRIVNING
Godkänna replikeringsanslutningen för källvolymen
...
### -AccountName
Namnet på ANF-kontot för replikeringskällans volym
...
Filsystem-ID för måldataskyddsvolymen
...
### -InputObject
ANF-källvolymobjektet för auktorisera replikeringsdestinationen
...
### -Name
Namnet på ANF-replikeringskällans volym
...
### -PassThru
Returnera om replikeringsauktoriseringen av den angivna volymen utfördes
...
### -PoolName
Namnet på ANF-poolen för replikeringskällans volym
...
### -ResourceGroupName
Resursgruppen för ANF-replikeringskällans volym
...
### -ResourceId
Resurs-ID för ANF-replikeringskällans volym
