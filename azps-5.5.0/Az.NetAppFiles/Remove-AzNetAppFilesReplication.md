...
Det här kommandot tar bort ANF-replikeringsanslutningen för volym "MyDestinationAnfVolume".
...
### -InputObject
ANF-målvolymen med replikeringen som ska tas bort
...
### -PassThru
Returnera om den angivna ANF-replikeringen har tagits bort
