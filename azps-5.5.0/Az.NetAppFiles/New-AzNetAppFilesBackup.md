...
## BESKRIVNING
Cmdleten **New-AzNetAppFilesBackup** skapar en säkerhetskopia för en ANF-volym.
...
Det här kommandot skapar den nya ANF-säkerhetskopian för volym med namnet konto "MyVolume".
...
### -VolumeObject
Volymen för det nya säkerhetskopian
