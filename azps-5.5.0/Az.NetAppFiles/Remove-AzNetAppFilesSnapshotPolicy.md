...
## BESKRIVNING
**Cmdleten Remove-AzNetAppFilesSnapshotPolicy** tar bort en ANF-ögonblicksbildsprincip.
...
Det här kommandot tar bort den nya ANF-säkerhetskopieringsprincipen med namnet "MyBackupPolicy" för kontot "MyAccount".
...
### -AccountObject
Kontot för det nya ögonblicksbildsprincipobjektet
...
### -InputObject
Ögonblicksbildspolicy-objektet som ska tas bort
...
### -Name
Namnet på ANF-ögonblicksbildsprincipen
...
### -ResourceId
Resurs-ID för ögonblicksbildsprincipen för ANF
