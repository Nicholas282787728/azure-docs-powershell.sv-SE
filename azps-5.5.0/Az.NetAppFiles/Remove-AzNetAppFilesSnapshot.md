...
## BESKRIVNING
Cmdleten **Remove-AzNetAppFilesSnapshot** tar bort en ANF-ögonblicksbild.
...
Det här kommandot tar bort ANF-ögonblicksbilden "MyAnfSnapshot".
...
### -ResourceGroupName
Resursgruppen av ögonblicksbilden av ANF
...
### -ResourceId
Resurs-ID för ögonblicksbilden av ANF
...
### -VolumeObject
Volymobjektet som innehåller ögonblicksbilden som ska tas bort
