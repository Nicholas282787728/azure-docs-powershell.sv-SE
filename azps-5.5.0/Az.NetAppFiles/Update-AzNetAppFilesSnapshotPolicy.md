...
## BESKRIVNING
**Cmdleten Update-AzNetAppFilesSnapshotPolicy** ändrar en PRINCIP för ANF-ögonblicksbild.
...
Det här kommandot ändrar ANF-säkerhetskopieringsprincipen "MySnapshotPolicy" så att den angivna timplansschemat anges.
...
### -DailySchedule
En hashtabellmatris som representerar det dagliga schemat
...
### -HourlySchedule
En hashtabellmatris som representerar timschemat
...
### -InputObject
Ögonblicksbildsobjektet som ska tas bort
...
### -MonthlySchedule
En hashtabellmatris som representerar montly-schemat
