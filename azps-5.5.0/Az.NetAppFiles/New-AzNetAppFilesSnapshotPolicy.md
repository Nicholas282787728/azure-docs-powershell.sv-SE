...
## BESKRIVNING
Cmdleten **New-AzNetAppFilesActiveDirectory** skapar en ny ögonblicksbildsprincip för ett ANF-konto.
...
Det här kommandot skapar den nya ANF-ögonblicksbildsprincipen för ANF-konto med namnet konto "MyAccount".
