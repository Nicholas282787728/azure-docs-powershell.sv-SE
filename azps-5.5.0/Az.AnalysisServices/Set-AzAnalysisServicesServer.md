...
## BESKRIVNING
Med Set-AzAnalysisServicesServer-cmdleten ändras en instans av Analysis Services-servern
...
Ändrar servern med namnet testserver i resourcegroup-testgrupp för att ange taggarna som key1:value1 och key2:value2 och administratör till testuser1@contoso.com

## PARAMETERS

### -Administratör
En sträng som representerar en kommaavgränsad lista över användare eller grupper som ska anges som administratörer på servern.
Användarna eller grupperna måste anges som UPN-format, t.ex. user@contoso.com eller groups@contoso.com
...
Blob container Uri för säkerhetskopia av Analysis Services-servern
...
### -DisableBackup
Bytet för att inaktivera blob-behållare för säkerhetskopiering.
Om du vill återaktivera blob-behållaren för säkerhetskopiering anger du blob-behållaren Uri som -BackupBlobContainerUri.
...
### -DisassociateGateway
Avassociera gatewayresursen från en analysserver
