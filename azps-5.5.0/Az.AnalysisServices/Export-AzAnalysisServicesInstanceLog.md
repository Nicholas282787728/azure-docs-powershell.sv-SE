...
## BESKRIVNING
Cmdlet Export-AzAnalysisServicesInstance logg från en instans av Azure Analysis Services-server till fil
...
Det här kommandot exporterar loggen från serverns testserver i miljön som anges i Add-AzAnalysisServicesAccount-kommandot och sparar den till en fil som anges i OutputPath 'C:\path\to\log\testserver.log'

## PARAMETERS

### -Force
Skriva över filen om den finns utan att fråga
...
### -OutputPath
Utdatasökväg till fil för exportlogg
