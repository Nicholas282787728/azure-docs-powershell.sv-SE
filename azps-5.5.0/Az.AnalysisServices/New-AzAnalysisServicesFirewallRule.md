...
## BESKRIVNING
Den New-AzAnalysisServicesFirewallRule skapar ett nytt brandväggsregelobjekt.
...
Skapar en brandväggsregel med namnet regel1 med startintervallet 0.0.0.0 och slutområdet 255.255.255.255
...
### -RangeEnd
Intervallets slut på en brandväggsregel
...
### -RangeStart
Intervallets början av en brandväggsregel
