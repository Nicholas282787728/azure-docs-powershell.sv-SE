...
## BESKRIVNING
Cmdlet Resume-AzAnalysisServicesServer återupptar en instans av Analysis Services-servern
...
Det här kommandot återupptar en pausad server med namnet testserver i resursgruppens testgrupp
...
### -PassThru
Returnerar den borttagna serverinformationen om åtgärden slutförs korrekt
