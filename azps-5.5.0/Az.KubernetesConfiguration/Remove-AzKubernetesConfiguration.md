...
ms.locfileid: "100219391"
---
# Remove-AzKubernetesConfiguration

## SYNOPSIS
Då tas DEN YAML-fil som användes för att konfigurera konfigurationen av källkontrollen bort och därmed stoppas framtida synkronisering från källplatsen.
...
### Exempel 1: Ta bort en konfiguration av kubernetes-kluster efter namn
```powershell
...
Med det här kommandot tas en konfiguration av kubernetes-kluster bort efter namn.

### Exempel 2: Ta bort en konfiguration av kubernetes-kluster efter objekt
```powershell
...
Med det här kommandot tas en konfiguration av kubernetes-kluster efter objekt bort.
...
INPUTOBJECT <IKubernetesConfigurationIdentity> : Identity Parameter
  ...
  - `[ClusterResourceName <String>]`: Kubernetes-klusterresursnamnet – hanteradeClusters (för AKS-kluster) eller anslutnaClusters (för OnPrem K8S-kluster).
  - `[ClusterRp <String>]`: Kubernetes cluster RP – antingen Microsoft.ContainerService (för AKS-kluster) eller Microsoft.Kubernetes (för OnPrem K8S-kluster).
  - `[Id <String>]`: Resursidentitetssökväg
  - `[ResourceGroupName <String>]`: Namnet på resursgruppen.
  - `[SourceControlConfigurationName <String>]`: Namn på konfigurationen av källkontrollen.
  - `[SubscriptionId <String>]`: Azure-prenumerations-ID. Det här är en GUID-formaterad sträng (t.ex. 00000000-0000-0000-0000-000000000000)
