...
ms.locfileid: "100219415"
---
# Get-AzKubernetesConfiguration

## SYNOPSIS
Hämtar information om konfigurationen av källkontrollen.
...
### Exempel 1: Hämta alla konfigurationer av kubernetes-kluster
```powershell
...
Det här kommandot hämtar alla konfigurationer av kubernetes-kluster.

### Exempel 2: Skapa en konfiguration av kubernetes-kluster efter namn
```powershell
...
### Exempel 3: Skapa en konfiguration av kubernetes-kluster efter objekt
```powershell
...
### Exempel 4: Få en konfiguration av kubernetes-kluster efter rörledning
```powershell
...
Det här kommandot får en konfiguration av kubernetes-kluster efter pipeline.
...
### -ClusterRp
Kubernetes kluster-RP – antingen Microsoft.ContainerService (för AKS-kluster) eller Microsoft.Kubernetes (för OnPrem K8S-kluster).
...
INPUTOBJECT <IKubernetesConfigurationIdentity> : Identity Parameter
  ...
  - `[ClusterResourceName <String>]`: Kubernetes-klusterresursnamnet – antingen managedClusters (för AKS-kluster) eller anslutnaClusters (för OnPrem K8S-kluster).
