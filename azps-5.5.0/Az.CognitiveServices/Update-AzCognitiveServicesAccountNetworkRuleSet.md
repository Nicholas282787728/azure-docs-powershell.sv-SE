...
## BESKRIVNING
**Cmdleten Update-AzCognitiveServicesAccountNetworkRuleSet** uppdaterar egenskapen NetworkRule för ett Kognitiv Services-konto
...
### Exempel 3: Rensa regler i NetworkRule för ett kognitivt services-konto
```
...
Det här kommandot rensar upp regler i NetworkRule för ett kognitivt services konto (andra egenskaper ändras inte).

## PARAMETERS

### -DefaultAction
Cognitive Services Account NetworkRule DefaultAction. `Deny`Standardvärde.
