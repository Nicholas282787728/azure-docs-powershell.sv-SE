...
## BESKRIVNING
Cmdleten **Get-AzCognitiveServicesAccountUsage** får aktuella användningar för ett kognitivt services-konto.
...
### -InputObject
Kontoobjekt för kognitiva tjänster.
...
### -ResourceId
Kontoresurs-ID för kognitiva tjänster.
