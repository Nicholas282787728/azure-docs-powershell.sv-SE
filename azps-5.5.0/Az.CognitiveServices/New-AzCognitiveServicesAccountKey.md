...
## BESKRIVNING
**Cmdleten New-AzCognitiveServicesAccountKey** återskapar en API-nyckel för ett kognitivt services-konto.
...
### -KeyName
Anger namnet på nyckeln som ska återskapas.
...
### -ResourceGroupName
Anger namnet på den resursgrupp som kontot har tilldelats.
