...
ms.locfileid: "100211871"
---
# Add-AzCognitiveServicesAccountNetworkRule

## SYNOPSIS
Lägga till IpRules eller VirtualNetworkRules i egenskapen NetworkRule för ett Cognitive Services-konto
...
## BESKRIVNING
Cmdleten **Add-AzCognitiveServicesAccountNetworkRule** lägger till IpRules eller VirtualNetworkRules i egenskapen NetworkRule för ett kognitivt services-konto
