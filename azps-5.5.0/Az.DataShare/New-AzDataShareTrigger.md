...
## BESKRIVNING
Cmdleten **New-AzDataShareT arbetsbok** skapar en utlösare för delningsprenumeration under det angivna upprepningsintervallet och synkroniseringstiden under azure-dataresurskontot.
...
Det här kommandot skapar en ny utlösare för att dela prenumerationen AdsShareSubscription med ett dagligt upprepningsintervall på 09:00.
...
### -Name
Namn på Azure-dataresursutlösare
...
### -RecurrenceInterval
Upprepningsintervallet för utlösaren (dag eller timme)
...
### -SynchronizationTime
Starttiden för den schemalagda synkroniseringen för utlösaren
