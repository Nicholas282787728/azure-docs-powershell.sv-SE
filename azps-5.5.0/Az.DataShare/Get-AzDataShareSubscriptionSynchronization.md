...
## BESKRIVNING
Cmdleten **Get-AzDataShareSubscriptionSynchronization** ger informaiton om all synkronisering körs i en delningsprenumeration under ett konto för dataresurs på konsumenter.
...
Det här kommandot ger information om all synkronisering körs för en Share-prenumeration AdsShareSubscription under Data Share Account WikiAds.
