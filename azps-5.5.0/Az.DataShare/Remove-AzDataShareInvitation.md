...
## BESKRIVNING
Cmdleten **Remove-AzDataShareInvitation** tar bort en inbjudan om dataresurs.
...
Med dessa kommandon tas en inbjudan med namnet ADSInvite bort från Share AdsShare. 
...
### -InputObject
Azure Data Share Invitation-objekt
