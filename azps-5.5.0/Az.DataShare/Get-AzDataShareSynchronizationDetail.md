...
## BESKRIVNING
Cmdleten **Get-AzDataShareSynchronizationDetail** innehåller information om synkroniseringen som initierats för en delning.
...
Det här kommandot innehåller information om synkroniseringsinformationen för alla datauppsättningar som motsvarar det angivna synkroniserings-ID:t.
...
### -SynchronizationId
Synkroniserings-ID för delningssynkronisering
