...
## BESKRIVNING
Cmdleten **Get-AzDataShareDataSet** hämtar information om datauppsättningar som läggs till i en delning i ett Azure-dataresurskonto. Om du anger namnet på datauppsättningen hämtar den här cmdleten information om datauppsättningen. Om du inte anger ett namn hämtar den här cmdleten information om alla datauppsättningar i en resurs. I
...
Det här kommandot visar information om datauppsättningen AdsDataSet i dela AdsShare i Azure-dataresurskonto WikiAdsAccount och ads för resursgrupper.
