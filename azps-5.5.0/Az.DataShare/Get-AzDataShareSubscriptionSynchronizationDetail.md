...
## BESKRIVNING
Cmdleten **Get-AzDataShareSubscriptionSynchronizationDetail** innehåller information om synkroniseringen som initierats för en delningsprenumeration.
...
Det här kommandot ger information om synkronisering initierad för delning av prenumeration AdsShareSubscription under Data Share Account WikiAds.
...
### -SynchronizationId
Synkroniserings-ID för delning av synkronisering av prenumeration
