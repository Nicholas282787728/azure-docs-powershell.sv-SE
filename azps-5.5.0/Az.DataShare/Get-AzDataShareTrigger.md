...
## BESKRIVNING
Cmdleten **Get-AzDataShareT arbetsbok hämtar** information om utlösare för delning av prenumeration under dataresurskonto.
...
Det här kommandot hämtar information om utlösare För att dela prenumeration adsShareSubscription under dataresurskonto WikiAds.
...
### Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.PSDataShareTbiller
