...
## BESKRIVNING
Cmdleten **Remove-AzDataShareSynchronizationSetting** tar bort en synkroniseringsinställning för datashare
...
Med de här kommandona tas en synkroniseringsinställning med namnet AdsShareSynchronizationSetting bort från Share AdsShare. 
...
### -InputObject
Synkroniseringsinställningen för Azure Data Share.
...
### -ResourceId
Resurs-ID för synkroniseringsinställningen
