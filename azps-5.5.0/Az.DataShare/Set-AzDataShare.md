...
## BESKRIVNING
Cmdleten **Set-AzDataShare** uppdaterar en dataresurs som finns i ett angivet Azure-dataresurskonto.
...
Det här kommandot uppdaterar en befintlig dataresurs med namnet AdsShare
...
### -TermsOfUse
Användningsvillkor för dataresurs
