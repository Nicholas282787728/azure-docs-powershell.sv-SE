...
## BESKRIVNING
**New-AzDataShareSynchronizationSetting** skapar en synkroniseringsinställning för delning i delningskonto för ett återkommande intervall, antingen dagligen eller varje timme vid en viss tidpunkt.
...
Med de här kommandona skapas en synkroniseringsinställning vid dagligt upprepningsintervall kl. 09:00 för att dela AdsShare i WikiAds-konton för dataresurs.
...
### -Name
Namn på synkroniseringsinställning
...
### -RecurrenceInterval
Upprepningsintervallet för synkroniseringsinställningen (dag eller timme)
...
### -ResourceGroupName
Resursgruppnamn för azure-dataresurskonto
...
### -SynchronizationTime
Starttiden för den schemalagda synkroniseringsinställningen
