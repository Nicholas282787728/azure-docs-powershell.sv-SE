...
## BESKRIVNING
**Cmdleten New-AzDataShareAccount** skapar ett datasharekonto i den angivna Azure-resursgruppen.
...
Skapar ett konto med namnet "WikiADS" i resursgruppen "ANNONSER"
...
### -Plats
Platsen där du skapar kontot för dataresurs.
...
### -ResourceGroupName
Resursgruppnamnet för azure-kontot för dataresurs skapas i.
