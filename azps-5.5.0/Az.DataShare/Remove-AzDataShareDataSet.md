...
## BESKRIVNING
Cmdleten **Remove-AzDataShareDataSet** tar bort en datauppsättning.
...
Med de här kommandona tas datauppsättningen DS bort från dela WikiAds. 
