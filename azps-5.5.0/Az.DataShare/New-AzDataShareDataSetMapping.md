...
## BESKRIVNING
Cmdleten **New-AzDataShareDataSetMapping** skapar en datauppsättningsmappning mellan källdatauppsättningarna och lagringskontot för lagring av lagring på plats i en prenumeration.
...
Med det här kommandot skapas en datauppsättningsmappning AdsDataSetMapping till lagringskontot AdsStorage för delningsprenumeration AdsShareSubscription i wikiAdsAccount för dataresurskonto.
...
### -DataSetId
Id för konsumentdatauppsättning
...
### -Name
Mappningsnamn för Azure-datauppsättning
