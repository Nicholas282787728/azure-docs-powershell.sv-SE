...
## BESKRIVNING
Cmdleten **Get-AzDataShareSynchronization** tillhandahåller information om alla synkroniseringsinställningar som finns för en delning under ett dataresurskonto.
...
Med de här kommandona får du information om alla synkroniseringsinställningar som finns i Share AdsShare i WikiAds-dataresurskontot.
...
### -ResourceId
Resurs-ID för Azure-dataresurs
...
### Microsoft.Azure.PowerShell.Cmdlets.DataShare.Models.PSDataShare-synkronisering
