...
## BESKRIVNING
Cmdleten **Get-AzDataShareDataSetMapping** hämtar information om en viss datauppsättningsmappning om namnet har angetts. Annars får den information om alla datauppsättningsmappningar i en prenumeration för delning. 
...
```
 ...
 Det här kommandot visar information om alla datauppsättningsmappningar i delningsprenumerationen.
...
### -ResourceId
Resurs-ID för azure-datauppsättningsmappningen.
