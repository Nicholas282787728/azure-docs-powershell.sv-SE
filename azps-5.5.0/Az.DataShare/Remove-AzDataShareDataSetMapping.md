...
ms.locfileid: "100232111"
---
# Remove-AzDataShareDataSetMapping

## SYNOPSIS
Tar bort en datauppsättningsmappning
...
## BESKRIVNING
Cmdleten **Remove-AzDataShareDataSetMapping** tar bort en datauppsättningsmappning.
...
Med de här kommandona tas datauppsättningen DSM bort från sharesubscription WikiAds. 
...
### -InputObject
Mappningsobjektet azure-datauppsättning
...
### -ResourceId
Resurs-ID för mappning av Azure-datauppsättning
