...
## BESKRIVNING
Cmdleten **Get-AzDataShareSourceDataSet** innehåller information om källdatauppsättningarna i delningsprenumerationen. 
...
Hämtar datauppsättningar tillgängliga i källresursen
