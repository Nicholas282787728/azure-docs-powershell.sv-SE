...
## BESKRIVNING
Cmdleten **Revoke-AzDataShareSubscriptionAccess beviljar** åtkomst till källresurs för delningsprenumeration
...
Återkallar åtkomsten för delningsprenumeration som identifieras med id 8ee6e6fd-b4a1-49a4-bb66-f187f38e0e12
...
### -ShareSubscriptionId
Delningsprenumerations-ID för leverantörens prenumerationsresurs
