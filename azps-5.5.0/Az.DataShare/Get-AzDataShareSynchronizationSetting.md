...
## BESKRIVNING
Cmdleten **Get-AzDataShareSynchronizationSetting** tillhandahåller information om synkronisering aktiverad på en delning. 
...
Det här kommandot ger information om synkronisering av ShareSynkronisering aktiverad för delning av AdsShare under WikiAds-dataresurskonto.
...
### -ResourceId
Resurs-ID för synkroniseringsinställningen för Azure Data Share
