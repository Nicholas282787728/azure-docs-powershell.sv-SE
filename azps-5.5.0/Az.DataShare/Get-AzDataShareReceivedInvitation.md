...
## BESKRIVNING
Cmdleten **Get-AzDataShareReceivedInvitation** innehåller information om alla inbjudningar som konsument har fått igen. Om du anger plats- eller inbjudnings-ID innehåller den här cmdleten information om inbjudan på en viss plats eller har ett inbjudnings-ID. Annars visas en lista med inbjudningar som skickas till konsumenter.
...
Denna commant tillhandahåller information om konsumentinbjudningar.
...
### -InvitationId
Azure DataShare-inbjudnings-ID.
