...
## BESKRIVNING
Lista med startmenyalternativ i den givna programgruppen.

## EXEMPEL

### Exempel 2: Lista startmenyobjekt för Virtuellt skrivbord för Windows
```powershell
...
Det här kommandot Listar Start-menyobjekt för Windows Virtual Desktop i en appgrupp.
