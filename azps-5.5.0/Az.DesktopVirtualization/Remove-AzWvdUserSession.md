...
### Exempel 1: Ta bort en Windows Virtual Desktop UserSession med namn
```powershell
...
Med det här kommandot tas en Windows Virtual Desktop UserSession bort hos en sessionsvärd.
...
### -Force
Tvinga flagga för inloggning utanför userSession.
