...
### Exempel 1: Ta bort ett Windows Virtual Desktop Application med namn
```powershell
PS C:\> Remove-AzWvdApplication -ResourceGroupName ResourceGroupName -ApplicationGroupName ApplicationGroupName -Name ApplicationName
```

Med det här kommandot tas en Windows Virtual Desktop Application bort i en appgrupp.
