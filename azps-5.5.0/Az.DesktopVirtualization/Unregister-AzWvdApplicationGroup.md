...
### Exempel 1: Avregistrera en Windows Virtual Desktop Application Group
```powershell
...
Med det här kommandot avregistreras en Windows Virtual Desktop Application Group på en arbetsyta.

## PARAMETERS

### -ApplicationGroupPath
Sökväg för ResourceGroupName
