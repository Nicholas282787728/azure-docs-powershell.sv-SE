...
### Exempel 1: Ta bort en Windows Virtual Desktop SessionHost med namn
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Det här kommandot tar bort en Windows Virtual Desktop SessionHost i en värdpool.
