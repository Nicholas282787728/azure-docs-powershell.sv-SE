...
### Exempel 1: Ta bort en Windows Virtual Desktop-arbetsyta med namn
```powershell
PS C:\> Remove-AzWvdWorkspace -ResourceGroupName ResourceGroupName -Name WorkspaceName
```

Det här kommandot tar bort en Windows-arbetsyta för virtuella skrivbord i en resursgrupp.
