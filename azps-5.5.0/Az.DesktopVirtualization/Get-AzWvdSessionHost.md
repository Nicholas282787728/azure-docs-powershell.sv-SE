...
Det här kommandot får en Windows Virtual Desktop SessionHost i en värdpool.

### Exempel 2: Lista Windows Virtual Desktop SessionHosts
```powershell
...
Det här kommandot listar en Windows Virtual Desktop SessionHosts i en värdpool.
