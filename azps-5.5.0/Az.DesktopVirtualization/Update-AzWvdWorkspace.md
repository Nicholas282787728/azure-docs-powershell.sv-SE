...
### Exempel 1: Uppdatera en Windows Virtual Desktop-arbetsyta med namn
```powershell
...
Det här kommandot uppdaterar en Windows Virtual Desktop-arbetsyta i en resursgrupp.

## PARAMETERS

### -ApplicationGroupReference
Lista med applicationGroup-länkar.
