...
### Exempel 2: Skapa en Windows Virtual Desktop ApplicationGroup med namn
```powershell
PS C:\> New-AzWvdApplicationGroup -ResourceGroupName ResourceGroupName `
                            -Name ApplicationGroupName `
                            -Location 'eastus' `
...
Resurstyp för ApplicationGroup.
...
### -HostPoolArmPath
HostPool-armsökvägen för ApplicationGroup.
