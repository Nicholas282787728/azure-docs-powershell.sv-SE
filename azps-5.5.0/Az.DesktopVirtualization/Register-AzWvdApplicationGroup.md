...
### Exempel 1: Registrera en Windows Virtual Desktop Application Group
```powershell
...
Med det här kommandot registreras en Windows Virtual Desktop Application Group på en arbetsyta.
