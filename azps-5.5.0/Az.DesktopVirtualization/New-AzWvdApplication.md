...
### Exempel 1: Skapa ett virtuellt Windows-skrivbordsprogram
```powershell
...
Det här kommandot skapar en Windows Virtual Desktop Application i en appgrupp.

## PARAMETERS

### -AppAlias
Appalias från Start-menyn
...
### -CommandLineArgument
Kommandoradsargument för programmet.
...
### -CommandLineSetting
Anger om det publicerade programmet kan startas med kommandoradsargument som tillhandahålls av klienten, kommandoradsargument som angetts vid publiceringen eller inga kommandoradsargument alls.
...
Anger paketprogram-ID för MSIX-program
...
Anger paketfamiljenamnet för MSIX-program
...
### -ShowInPortal
Anger om RemoteApp-programmet ska visas på RD Web Access-servern.
