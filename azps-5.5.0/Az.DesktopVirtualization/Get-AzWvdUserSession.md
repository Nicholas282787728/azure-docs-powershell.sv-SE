...
Det här kommandot får en Windows Virtual Desktop UserSession till en sessionsvärd.

### Exempel 2: Lista Windows Virtual Desktop UserSessions
```powershell
...
Det här kommandot listar en Windows Virtual Desktop UserSessions som en sessionsvärd.

### Exempel 3: Lista Windows Virtual Desktop UserSessions i värdpool
```powershell
...
Det här kommandot listar en Windows Virtual Desktop UserSessions i en sessionsvärd i en värdpool.
