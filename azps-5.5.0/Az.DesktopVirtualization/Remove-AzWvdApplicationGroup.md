...
### Exempel 1: Ta bort en Windows Virtual Desktop ApplicationGroup med namn
```powershell
PS C:\> Remove-AzWvdApplicationGroup -ResourceGroupName ResourceGroupName -Name ApplicationGroupName
```

Med det här kommandot tas en Windows Virtual Desktop ApplicationGroup bort i en resursgrupp.
