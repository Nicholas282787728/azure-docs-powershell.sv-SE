...
### Exempel 1: Skaffa en registreringstoken för virtuell skrivbordsversionen av Windows
```powershell
...
Det här kommandot får en Windows Virtual Desktop-registreringstoken i en värdpool.
