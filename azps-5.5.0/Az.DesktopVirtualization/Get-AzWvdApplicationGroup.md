...
Det här kommandot får en Windows Virtual Desktop ApplicationGroup i en resursgrupp.

### Exempel 2: Lista Windows Virtual Desktop ApplicationGroups
```powershell
...
Det här kommandot listar en Windows Virtual Desktop ApplicationGroups i en resursgrupp.
