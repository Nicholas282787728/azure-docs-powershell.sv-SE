...
### Exempel 1: Ta bort en Windows Virtual Desktop HostPool med namn
```powershell
PS C:\> Remove-AzWvdHostPool -ResourceGroupName ResourceGroupName -Name HostPoolName
```

Det här kommandot tar bort en Windows Virtual Desktop HostPool i en resursgrupp.
...
### -Force
Tvinga flagga för att ta bort sessionHost.
