...
Med det här kommandot skapas en SAP-bildskärm.
...
Värdet som anger om analyser ska skickas till Microsoft
...
Arbetsyte-ID för den arbetsyta för logganalys som ska användas för övervakning
...
Id ARM logganalysarbetsyta som används för övervakning
...
Den delade nyckeln för arbetsytan med logganalys som används för övervakning
...
Undernätet som SAP-bildskärmen ska distribueras i.
Det bör vara samma undernät till HANA-databasen.
