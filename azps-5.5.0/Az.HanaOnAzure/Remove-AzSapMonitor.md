...
### Exempel 1: Ta bort en SAP-bildskärm med namn
```powershell
PS C:\> Remove-AzSapMonitor -ResourceGroupName nancyc-hn1 -Name ps-sapmonitor-t02

```

Med det här kommandot tas en SAP-bildskärm bort med namnet.

### Exempel 2: Ta bort en SAP-bildskärm efter objekt
```powershell
...
Med det här kommandot tas en SAP-bildskärm bort från objekt.
