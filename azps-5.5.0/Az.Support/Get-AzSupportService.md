...
ms.locfileid: "100224727"
---
# Get-AzSupportService

## SYNOPSIS
Få tjänster som det finns support för. 
...
## BESKRIVNING
Hämtar den aktuella listan över Azure-tjänster som det finns support för. Varje tjänst kan innehålla en eller flera Azure resurshanterarens (ARM) resurstyper. Resurstyper (exempel: 'microsoft.compute/virtualmachines') kan vara användbara för att mappa rätt produkt och ARM resurs när du skapar ett supportärende för teknisk support. Varje Azure-tjänst har en egen uppsättning kategorier som kallas problemklassificering. Hämta den aktuella listan med problemklassificering för en tjänst med Get-AzSupportProblemClassification. Du kan använda tjänsten och problemklassificerings-GUID för att skapa ett nytt supportärende med hjälp av New-AzSupportTicket.
...
### Exempel 2: Få information om en enskild tjänst med tillgängligt ID för support
```powershell
