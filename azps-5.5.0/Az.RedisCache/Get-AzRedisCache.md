...
## BESKRIVNING
Cmdleten **Get-AzRedisCache** får den angivna Azure Redis-cachen.
Om du inte anger några parametrar får den här åtgärden varje Redis-cache för den aktuella prenumerationen.
...
Det här kommandot får Redis-cachen med namnet myexists.

### Exempel 2: Hämta varje Redis-cache i en resursgrupp
```
...
Det här kommandot får varje Redis-cache i den angivna resursgruppen.

### Exempel 3: Få varje Redis-cache i den aktuella prenumerationen
```
...
Det här kommandot får varje Redis-cache i den aktuella prenumerationen.
...
### -Name
Anger namnet på redis-cachen som ska hämtas.
...
### -ResourceGroupName
Anger namnet på den resursgrupp som innehåller Redis-cachen som ska hämtas.
Om du bara anger *parametern ResourceGroupName* får den här åtgärden varje Redis-cache i den angivna resursgruppen.
