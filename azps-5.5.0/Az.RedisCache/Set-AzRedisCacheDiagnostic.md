...
## BESKRIVNING
Cmdleten **Set-AzRedisCacheDiagnostic** aktiverar diagnostik för Azure Redis-cache.
...
Det här kommandot aktiverar diagnostik för en Azure Redis-cache.
Det här kommandot aktiverar diagnostik eller uppdaterar lagringskontot för alla Azure Redis-cacheminnen i samma region för prenumerationen.
...
### -StorageAccountId
Anger resurs-ID för lagringskontot som används för att lagra diagnostikdata.
