...
## BESKRIVNING
Cmdleten **Reset-AzRedisCache** startar om noder i en Azure Redis-cacheinstans.

## EXEMPEL

### Exempel 1: Starta om båda noder
```
PS C:\>Reset-AzRedisCache -ResourceGroupName "ResourceGroup13" -Name "RedisCache06" -RebootType "AllNodes" -Force
```

Det här kommandot startar om båda noder för cachen med namnet RedisCache06.
...
### -RebootType
Anger vilken nod eller noder som ska startas om.
...
### -ShardId
Anger ID för det fragmenterade fel som cmdleten startar om för en premiumcache med kluster aktiverat.
