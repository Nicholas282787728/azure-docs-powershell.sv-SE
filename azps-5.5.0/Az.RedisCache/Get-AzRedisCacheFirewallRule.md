...
## BESKRIVNING
Om **parametern RuleName** visas får cmdleten **Get-AzRedisCacheFirewallRule** information om den angivna brandväggsregeln i Azure Redis Cache. Om endast **Namn** anges blir alla brandväggsregler tillgängliga på den Redis-cachen.

## EXEMPEL

### Exempel 1: Skapa en enda brandväggsregel
```
...
Det här kommandot får brandväggsregeln som heter ruleone från Redis Cache med namnet mycache.
...
Med det här kommandot får du alla brandväggsregler från Redis Cache med namnet mycache.
