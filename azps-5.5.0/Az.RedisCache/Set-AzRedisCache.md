...
## BESKRIVNING
**Set-AzRedisCache-cmdleten** ändrar en Azure Redis-cache.
...
Det här kommandot uppdaterar maxmemory-principen för Redis-cachen med namnet MyCache.
...
### -Name
Anger namnet på redis-cachen som ska uppdateras.
...
Den här egenskapen kan bara konfigureras när cachen skapas.
Standard- och Premium-nivåer.
