...
## BESKRIVNING
Cmdleten **Get-AzPolicyRemediation** hämtar alla principreparationer i en omfattning eller en viss åtgärd.

## EXEMPEL

### Exempel 1: Hämta alla principreparationer i den aktuella prenumerationen
```
PS C:\> Select-AzSubscription -Subscription "My Subscription"
PS C:\> Get-AzPolicyRemediation
```

Med det här kommandot får du alla åtgärder som skapats på eller under en prenumeration med namnet "Min prenumeration".

### Exempel 2: Få en specifik principreparation och distributionsinformationen
```
PS C:\> Get-AzPolicyRemediation -ResourceGroupName "myResourceGroup" -Name "remediation1" -IncludeDetail
```

Med det här kommandot får du åtgärdsnamnet "remediation1" från resursgruppen myResourceGroup. Information om de resurser som åtgärdas visas.

### Exempel 3: Hämta 10 principreparationer i en hanteringsgrupp med valfria filter
```
...
Det här kommandot får maximalt 10 principreparationer från en hanteringsgrupp som heter 'mg1'. Endast principreparationer för den givna principtilldelningen kommer att hämtas.
...
### -IncludeDetail
Inkludera information om distributionerna som skapats av korrigeringen.
...
### -Omfattning
Resursens omfattning. Till exempel '/subscriptions/{subscriptionId}/resourceGroups/{rgName}'.
