...
## BESKRIVNING
Cmdleten **Get-AzKeyVaultCertificatePolicy** får principen för ett certifikat i ett nyckelvalv i Azure Key Vault.

## EXEMPEL

### Exempel 1: Hämta en certifikatprincip
```powershell
...
Det här kommandot hämtar certifikatprincipen för TestCert01-certifikatet i contosoKV01-nyckelvalvet.
