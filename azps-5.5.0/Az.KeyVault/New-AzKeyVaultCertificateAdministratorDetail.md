...
ms.locfileid: "100234086"
---
# New-AzKeyVaultCertificateAdministratorDetail

## SYNOPSIS
Skapar ett informationsobjekt för en minnesadministratör.
...
## BESKRIVNING
Cmdleten **New-AzKeyVaultCertificateAdministratorDetail** skapar ett informationsobjekt för in-memory certificate administrator.

## EXEMPEL

### Exempel 1: Skapa ett informationsobjekt för certifikatadministratör
```
...
Det här kommandot skapar ett informationsobjekt för en administratör med ett minnescertifikat och lagrar det sedan $AdminDetails variabeln.
...
### -EmailAddress
Anger certifikatadministratörens e-postadress.
...
### -FirstName
Anger certifikatadministratörens förnamn.
...
### -LastName
Anger certifikatadministratörens efternamn.
...
### -PhoneNumber
Anger telefonnumret till certifikatadministratören.
