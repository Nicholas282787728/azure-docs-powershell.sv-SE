...
## BESKRIVNING
Cmdleten **Get-AzKeyVaultCertificateOperation** får statusen för en certifikatåtgärd.

## EXEMPEL

### Exempel 1: Hämta status för en certifikatåtgärd
```powershell
...
Det här kommandot får statusen för certifikatåtgärden för TestCert01 på contosoKV01-nyckelvalvet.
