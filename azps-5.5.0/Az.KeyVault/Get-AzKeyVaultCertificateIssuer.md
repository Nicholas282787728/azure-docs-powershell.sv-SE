...
## BESKRIVNING
Cmdleten **Get-AzKeyVaultCertificateIssuer** får en viss certifikatutfärdare eller alla certifikatutfärdare för ett nyckelvalv i Azure Key Vault.

## EXEMPEL

### Exempel 1: Skaffa en certifikatutfärdare
```powershell
...
Det här kommandot får certifikatutfärdaren TestIssuer01.

### Exempel 2: Lista certifikatutfärdare med filtrering
```powershell
...
Det här kommandot får certifikatutfärdare som börjar med "test".
...
### -Name
Anger namnet på certifikatutfärdaren som ska fås.
