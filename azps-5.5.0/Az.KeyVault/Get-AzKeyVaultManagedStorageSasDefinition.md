...
## BESKRIVNING
Hämtar en SAS Definition för nyckelvalv hanterat lagring om namnet på definitionen har angetts. Om definitionsnamnet inte anges visas alla SAS-definitioner som är kopplade till det angivna hanterade lagringskontot för nyckelvalvet.

## EXEMPEL

### Exempel 1: Lista alla SAS-definitioner för key vault managed Storage
```powershell
...
Visar alla SAS-definitioner som är kopplade till nyckelvalv hanterat lagringskonto "mystorageaccount" som hanteras av valv 'myvault'

### Exempel 2: Skaffa ett hanterat lagringskonto för nyckelvalv
```powershell
...
Hämtar information om SAS Definition "accountsas" som är kopplade till key vault managed Storage Account 'mystorageaccount' som hanteras av valv 'myvault'.

### Exempel 3: Lista alla SAS-definitioner för nyckelvalv hanterade lagring med hjälp av filtrering
```powershell
...
Visar alla SAS-definitioner som är kopplade till nyckelvalv hanterat lagringskonto "mystorageaccount" som hanteras av valv "myvault" som börjar med "konto".
...
### -InRemovedState
Anger om sas definitioner för tidigare borttagna lagring ska visas i utdata.
...
### -Name
Sas definitionnamn för lagring.
Cmdlet skapar FQDN för en sas definition för lagring från valvnamn, för närvarande vald miljö, namn på lagringskonto och sas definition.
