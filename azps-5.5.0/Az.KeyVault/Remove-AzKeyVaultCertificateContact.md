...
## BESKRIVNING
Cmdleten **Remove-AzKeyVaultCertificateContact** tar bort en kontakt som är registrerad för certifikatmeddelanden från ett nyckelvalv.

## EXEMPEL

### Exempel 1: Ta bort en certifikatkontakt
```powershell
...
Det här kommandot tar bort Patti Fuller som certifikatkontakt för Contoso01-nyckelvalvet.  Om PassThru har angetts returnerar cmdleten listan över återstående certifikatkontakter.
