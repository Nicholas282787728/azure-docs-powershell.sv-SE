...
## BESKRIVNING
Cmdleten **Add-AzKeyVaultCertificateContact** lägger till en kontakt för ett nyckelvalv för certifikatmeddelanden i Azure Key Vault.
Kontakten får uppdateringar om händelser, till exempel certifikat som upphör att gälla, certifikat förnyat och så vidare.
Dessa händelser bestäms av certifikatprincipen.

## EXEMPEL

### Exempel 1: Lägga till en nyckel valv certifikat kontakt
```powershell
...
Det här kommandot lägger till Patti Fuller som certifikatkontakt för contosoKV01-nyckelvalvet och returnerar listan med kontakter för "ContosoKV01"-valvet.
