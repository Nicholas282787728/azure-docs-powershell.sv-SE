...
## BESKRIVNING
Cmdleten **Undo-AzKeyVaultCertificateRemoval** återställer ett tidigare borttaget certifikat.
Det återställda certifikatet blir aktivt och kan användas för alla åtgärder.
...
Det här kommandot återställer certifikatet "MyCertificate" som tidigare togs bort till ett aktivt och användbart tillstånd.
...
### -Name
Certifikatnamn.
Cmdlet skapar FQDN för ett certifikat från valvnamn, för närvarande vald miljö och certifikatnamn.
