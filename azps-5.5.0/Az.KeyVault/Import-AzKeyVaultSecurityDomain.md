...
## BESKRIVNING
Denna cmdlet importerar tidigare exporterade säkerhetsdomändata till en hanterad HSM.
...
Först måste nyckeln tillhandahållas för att dekryptera data i säkerhetsdomänen.
Kommandot **Import-AzKeyVaultSecurityDomain** återställer tidigare säkerhetskopierade säkerhetsdomändata till ett hanterat HSM med hjälp av dessa nycklar.
...
### -Keys
Information om de nycklar som används för att dekryptera säkerhetsdomändata.
Se exempel på hur den är uppbyggd.
...
### -SecurityDomainPath
Ange sökvägen till krypterade säkerhetsdomändata.
