...
## BESKRIVNING
Cmdleten **Set-AzKeyVaultCertificatePolicy** skapar eller uppdaterar principen för ett certifikat i ett nyckelvalv.

## EXEMPEL

### Exempel 1: Ange en certifikatprincip
```powershell
...
Det här kommandot anger principen för TestCert01-certifikatet i contosoKV01-nyckelvalvet.

## PARAMETERS

### -CertificateTransparency
Anger om certifikattransparens är aktiverat för det här certifikatet/utfärdaren. om detta inte anges är standardvärdet "true".
`-IssuerName` måste anges när du anger den här egenskapen.
...
### -Curve
Anger namnet på certifikatets ellipskurva.
...
### -EmailAtNumberOfDaysBeforeExpiry
Anger antalet dagar före förfallodatumet när automatisk förnyelse ska starta.
