...
## BESKRIVNING
Den här cmdleten uppdaterar statusen för en Azure-hanterad HSM.

## EXEMPEL

### Exempel 1: Uppdatera ett hanterat Hsm direkt
```powershell
...
Uppdateringstaggar för den hanterade Hsm `$hsmName` som namnges i resursgruppen. `$resourceGroupName`

### Exempel 2: Uppdatera en hanterad Hsm med rörledning
```powershell
...
Uppdaterar taggar för den hanterade Hsm med syntax för rörledning.
...
### -ResourceId
Resurs-ID för den hanterade HSM.
