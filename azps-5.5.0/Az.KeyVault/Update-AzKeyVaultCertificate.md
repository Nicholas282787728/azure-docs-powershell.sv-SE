...
## BESKRIVNING
Cmdleten **Update-AzKeyVaultCertificate** ändrar de redigerbara attributen för ett certifikat.

## EXEMPEL

### Exempel 1: Ändra taggarna som är kopplade till ett certifikat
```powershell
...
Det första kommandot tilldelar en matris med nyckel-/värdepar till den $Tags variabeln.
Det andra kommandot anger att märkningsvärdet för certifikatet TestCert01 ska $Tags.

### Exempel 2

Ändrar redigerbara attribut för ett certifikat. (autogenererat)
...
### -Enable
Aktivera i så fall ett certifikat om värdet är sant.
Inaktivera ett certifikat om värdet är falskt.
Om det inte anges ändras inte det befintliga värdet av certifikatets aktiverade/inaktiverade tillstånd.
...
Returnera certifikatobjekt om den här växeln har angetts.
...
### -Tag
En hashtabell som representerar certifikattaggar.
Om de inte anges ändras inte de befintliga taggarna i sertificate.
...
### -Version
Certifikatversion.
Cmdlet skapar FQDN för ett certifikat från valvnamn, för närvarande markerad miljö, certifikatnamn och certifikatversion.
