...
## BESKRIVNING
Cmdleten **Stop-AzKeyVaultCertificateOperation** avbryter en certifikatåtgärd i Azure-nyckelvalvtjänsten.

## EXEMPEL

### Exempel 1: Avbryta en certifikatåtgärd
```powershell
...
Det här kommandot avbryter certifikatåtgärden TestCert02.
