...
## BESKRIVNING
Kommandot **Undo-AzKeyVaultManagedStorageSasDefinitionRemoval** återställer en tidigare borttagna SAS-definition för hanterad lagring, förutsatt att mjuk borttagning har aktiverats för det här valvet och att försöket att återställa uppstår under återställningsintervallet.
...
Den här sekvensen med kommandon bestämmer om den angivna SAS-definitionen för lagring finns i valvet i ett borttagna tillstånd. Det efterföljande kommandot återställer den borttagna sas-definitionen och återställer det till aktivt läge.

## PARAMETERS

### -AccountName
KeyVault-hanterat lagringskontonamn.
Cmdlet skapar FQDN för en SAS-definition för hanterad lagring från valv-namn, för närvarande vald miljö och namn på hanterad lagringskonto.
...
### -InputObject
SAS Definition-objekt för borttagna hanterade lagring
...
### -Name
Namn på SAS-definitionen KeyVault-hanterad lagring.
Cmdlet skapar FQDN för målet från valvnamn, den valda miljön, namnet på kontot för hanterad lagring och namnet på SAS-definitionen.
