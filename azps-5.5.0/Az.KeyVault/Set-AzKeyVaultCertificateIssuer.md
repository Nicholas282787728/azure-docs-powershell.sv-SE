...
## BESKRIVNING
Med Set-AzKeyVaultCertificateIssuer-cmdleten anges en certifikatutfärdare i ett nyckelvalv.

## EXEMPEL

### Exempel 1: Ange en certifikatutfärdare
```powershell
...
Det här kommandot anger egenskaperna för en certifikatutfärdare.

## PARAMETERS

### -AccountId
Anger konto-ID för certifikatutfärdaren.
...
### -ApiKey
Anger API-nyckeln för certifikatutfärdaren.
...
### -InputObject
Anger vilken certifikatutfärdare som ska anges.
...
### -IssuerProvider
Anger typ av certifikatutfärdare.
...
Organisationsinformation som ska användas med utfärdaren.
