...
## BESKRIVNING
Använd kommandot `New-AzKeyVaultRoleAssignment` för att bevilja åtkomst.
Åtkomst beviljas genom att tilldela lämplig RBAC-roll till dem med rätt omfattning.
...
Den roll som tilldelas måste anges med parametern RoleDefinitionName pr RoleDefinitionId. Omfattningen för vilken åtkomst beviljas kan specificeras. Den valda prenumerationen väljs som standard.
...
I det här exemplet tilldelas rollen "Hanterad HSM-principadministratör" till user1@microsoft.com användaren " högst upp.
...
### -RoleDefinitionId
Det roll-ID som huvudbeloppet är tilldelat till.
