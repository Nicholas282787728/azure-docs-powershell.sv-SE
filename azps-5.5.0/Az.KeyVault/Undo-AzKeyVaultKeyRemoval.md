...
## BESKRIVNING
Cmdleten **Undo-AzKeyVaultKeyRemoval** återställer en tidigare borttagna nyckel.
Den återskapade nyckeln är aktiv och kan användas för alla vanliga nyckelåtgärder.
...
Det här kommandot återställer nyckeln "MyKey" som tidigare togs bort till ett aktivt och användbart läge.
