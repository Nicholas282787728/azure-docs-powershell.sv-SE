...
### Exempel 1: Skapa ReplicaSet för AdDomain
```powershell
...
Skapa ReplicaSet för AdDomain

## PARAMETERS

### -Plats
Virtuell nätverksplats.
...
### -SubnetId
Namnet på det virtuella nätverk som Domain Services ska distribueras på.
ID för det undernät som Domain Services ska distribueras på.
