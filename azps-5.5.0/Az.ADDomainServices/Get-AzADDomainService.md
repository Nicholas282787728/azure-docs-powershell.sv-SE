...
### Exempel 1: Hämta Alla ADDomainService som standard
```powershell
...
### Exempel 2: Hämta ADDomainService efter resursgrupp och namn
```powershell
...
Hämta ADDomainService efter resursgrupp och namn

### Exempel 3: Hämta alla ADDomainService by ResourceGroup
```powershell
...
Hämta alla ADDomainService by ResourceGroup

### Exempel 4: Skaffa ADDomainService med InputObject
```powershell
...
Skaffa ADDomainService By InputObject
