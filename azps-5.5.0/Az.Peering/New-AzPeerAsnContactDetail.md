...
## BESKRIVNING
Skapa en PeerAsn-kontaktinformation i minnet.

## EXEMPEL

### Skapa kontaktinformation och lägga till i PeerAsn
```powershell
...
Roll och e-post krävs. Telefon är valfritt. Telefonen har stöd för +-() eller blanksteg. En PeerAsn måste innehålla minst en kontaktinformation av typen "Noc"
...
### -E-post
E-postadresser som används för att kontakta om ärenden vanligtvis är ett nätverks driftcenter
...
### -Telefon
Telefon som används för att kontakta om ärenden vanligtvis är ett nätverkscenter
...
### -Role
Välj den roll som passar bäst för kontaktinformationen.
NOC-kontakt krävs.
