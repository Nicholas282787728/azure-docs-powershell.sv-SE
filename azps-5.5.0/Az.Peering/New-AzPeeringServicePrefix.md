...
## BESKRIVNING
Skapar peeringtjänstprefix som associeras med ett peeringtjänstobjekt.
...
Skapar ett prefix från ett peeringtjänstobjekt
...
Skapar ett prefix från ett peeringtjänstresurs-ID.
...
Skapar ett prefix från namn och namn på en peeringtjänstresursgrupp
...
### -PeeringServiceName
Peeringtjänstnamnet.
Använd New-AzPeeringService cmdlet för en ny peeringtjänst eller Get-AzPeeringService för en lista.
...
### -ServiceKey
Det här är en unik GUID som tillhandahålls av din tjänstprovider
