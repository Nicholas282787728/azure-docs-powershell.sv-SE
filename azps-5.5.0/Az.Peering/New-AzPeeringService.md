...
Skapar ett peeringtjänstobjekt med leverantör och peeringplats. Använd i konjuction med `Get-AzPeeringServiceProvider` och `Get-AzPeeringServiceLocation`
...
### -PeeringLocation
Den fysiska platsen skiljer sig från Azure Region. Använd Get-AzPeeringServiceLocation [-Country <country> ]
...
### -Tag
De taggar som ska associeras med Microsoft InputObject-tjänsten.
