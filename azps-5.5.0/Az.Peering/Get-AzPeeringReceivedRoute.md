...
ms.locfileid: "100218118"
---
# Get-AzPeeringReceivedRoute

## SYNOPSIS
Visar de mottagna rutterna för en peering.
...
## BESKRIVNING
Listor med mottagna routes från en peering

## EXEMPEL

### Lista de 100 mottagna rutterna för en peering
```powershell
PS C:\> Get-AzPeeringReceivedRoute -ResourceGroupName $resourceGroupName -Name $peeringName
```

Visar alla mottagna vägar för peering

### Filtrera efter AS-sökväg
```powershell
PS C:\> Get-AzPeeringReceivedRoute -ResourceGroupName $resourceGroupName -Name $peeringName -AsPath "1234 5674 9834"
```

Visar alla mottagna vägar för en peering med ett filter i AS 
...
Visar alla mottagna vägar för en peering med ett filter på RPKIValidationState
...
Visar alla mottagna routes för en peering med ett filter på OriginAsValidationState

## PARAMETERS

### -AsPath
Filtrera efter AS Path.
...
Filtrera efter ursprung AS-verifieringstillstånd.
...
### -RPKIValidationState
Filtrera efter RPKI-validering.
