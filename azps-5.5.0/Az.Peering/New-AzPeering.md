...
Skapa en ny direkt peering med en enda anslutning i Seattle-möjligheten med PeerAsn 65000
...
### Konvertera äldre peering till ARM-peering
```powershell
#Gets the ASN
PS C:> $asn = Get-AzPeerAsn -PeerName Contoso
...
### -DirectConnection
Skapa nya direktanslutningar med hjälp av New-AzExchangePeeringConnection och ledning till det här kommandot.
...
### -ExchangeConnection
Skapa en ny Exchange-anslutning med hjälp New-AzExchangePeeringConnection kontroll till det här kommandot.
...
### -InputObject
Använd Get-AzLegacyPeering för att hämta objektet.
...
### -MicrosoftNetwork
Välj det Microsoft-nätverk du vill arbeta med.
...
### -PeerAsnResourceId
Resurs-ID för Peer Asn. Get-AzPeerAsn när du vill hämta ID:t.
...
### -PeeringLocation
Den fysiska platsen skiljer sig från Azure Region.
Använd Get-AzPeeringLocation -Typ \<kind\> om du vill använda ortnamn som nyckel.
...
### -SKU
Välj Basic_Direct_Free eller Premium_Direct_Free inte uttryckligen vill välja ett annat alternativ.
...
### -Tag
De taggar som ska associeras med Microsoft-peeringtjänsten.
