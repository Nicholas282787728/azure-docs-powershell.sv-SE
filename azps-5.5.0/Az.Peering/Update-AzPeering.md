...
ms.locfileid: "100236302"
---
# Update-AzPeering

## SYNOPSIS
Ställer in peering. Använd det här kommandot tillsammans med `Set-AzDirectPeeringConnectionObject` eller `Set-AzExchangePeeringConnectionObject` .
...
## BESKRIVNING
Anger PSPeering-objektet

## EXEMPEL

### Uppdatera Md5-autentiseringsnyckel
```powershell
...
Anger autentiseringsnyckeln Md5

### Uppdatera UseForPeeringService
```powershell
...
Anger flaggan Användning för peeringtjänst

### Uppdatera IPv4-adress för Exchange-peering
```powershell
...
Anger Ipv4-adressen för en Exchange-peering med ResourceId
...
### -DirectConnection
Skapa nya direktanslutningar med hjälp av New-AzDirectPeeringConnectionObject och ledning till det här kommandot.
...
### -ExchangeConnection
Skapa en ny Exchange-anslutning med hjälp New-AzExchangePeeringConnectionObject och ledning till det här kommandot.
