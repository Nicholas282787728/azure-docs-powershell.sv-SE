...
## BESKRIVNING
Hämtar peerings från en prenumeration, resursgrupp eller efter namn.
...
Hämtar alla resurser för prenumerationen.
...
Får Exchange-peeringnamnet `myExchangePeering1`
...
Hämtar Exchange-peeringen `myExchangePeering1` baserat på resurs-ID: t.
