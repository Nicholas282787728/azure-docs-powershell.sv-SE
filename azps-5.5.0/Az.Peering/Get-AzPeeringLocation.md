...
## BESKRIVNING
Får peeringutrustningen där användarna kan ansluta till ARM.
...
Det är en lång lista över platser. Får alla direkt peeringresurser.
...
Hämtar exchange-peeringplatsen för Honolulu. 
...
Hämtar exchange-peeringplatsen för peeringfunktions-id 71. 
...
### -PeeringDbFacilityId
Det PeeringDB.com funktionsnummer
