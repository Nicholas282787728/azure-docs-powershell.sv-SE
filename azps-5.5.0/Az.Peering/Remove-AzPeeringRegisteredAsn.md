...
## BESKRIVNING
Tillåter borttagning av registrerade ASN från överordnad peeringresurs.
...
Ta bort ett registrerat ASN med resurs-ID.
...
### -Name
Namnet på den registrerade ASN
