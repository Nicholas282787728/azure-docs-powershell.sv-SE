...
## BESKRIVNING
Lista peeringtjänstprefix för peeringtjänstobjekt
...
Hämtar prefix för en peeringtjänst baserat på rörkommandon.
...
Hämtar ett specifikt prefix för en peeringtjänst efter resurs-ID.
...
Hämtar ett specifikt prefix för en peeringtjänst med utökade attribut
...
### -Expand
Visa händelser för ett peering-tjänstprefix
...
### -PeeringServiceName
Peeringtjänstnamnet. Använd New-AzPeeringService cmdlet för en ny peeringtjänst eller Get-AzPeeringService för en lista.
