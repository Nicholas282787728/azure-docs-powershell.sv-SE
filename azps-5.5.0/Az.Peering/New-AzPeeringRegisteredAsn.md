...
## BESKRIVNING
Skapa registrerade ASN för peeringobjekt.

## EXEMPEL

### Få peering och skapa ett registrerat ASN
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredAsn -Name $asnName -Asn $asn
```

Få den peering du vill lägga till en registrerad ASN. Skicka sedan det till kommandoleten.
