...
### Få peering och skapa ett registrerat prefix
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredPrefix -Name $asnName -Asn $asn
```

Få den peering du vill lägga till ett registrerat prefix. Skicka sedan det till kommandoleten.
