...
Skapa direkt peeringanslutning med användning för peeringtjänst aktiverad och Microsofts angivna IP-adresser
...
Skapa direkt peeringanslutning med användning för peeringtjänst som är aktiverad och peer-angivna IP-adresser
...
Skapa direkt peeringanslutning utan IP-adresser för bgp-session. Peer-peer måste ange IP-adresserna innan bgp-sessionen kan konfigureras.

## PARAMETERS

### -BandwidthInMbps
Bandbredden som erbjuds på den här platsen med Mbit/s.
