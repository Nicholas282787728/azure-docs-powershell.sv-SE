...
### -InputObject
Anger den replikerande server som migreringen måste initieras för.
...
### -TargetObjectID
Anger den ominitieringsserver som migreringen måste initieras för.
...
### -TurnOffSourceServer
Anger om källservern ska inaktiveras efter migreringen.
...
INPUTOBJECT: <IMigrationItem> Anger den replikerande server för vilken migreringen måste initieras. Serverobjektet kan hämtas med hjälp av Get-AzMigrateServerReplication cmdlet.
