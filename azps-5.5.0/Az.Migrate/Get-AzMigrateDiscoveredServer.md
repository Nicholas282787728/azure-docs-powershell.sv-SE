...
ms.locfileid: "100219182"
---
# Get-AzMigrateDiscoveredServer

## SYNOPSIS
Hämta alla identifierade servrar i ett migreringsprojekt.
...
Hämta Alla servrar i ett migreringsprojekt.
...
Hämta en server i ett migreringsprojekt efter namn.
Namnet är en unik paramenter för en server.

### Exempel 3: Lista i en utrustning
```powershell
...
Lista alla servrar för en utrustning i ett projekt.

### Exempel 4: Hämta en enhet
```powershell
...
Hämta en server för en utrustning i ett projekt.
Namnet är en unik paramenter för en server.

### Exempel 5: Lista och filtrera efter visningsnamn
```powershell
...
Listservrar i ett migrera projekt och filtrera svar med visningsnamn.

### Exempel 6: Lista i en utrustning och filtrera efter visningsnamn
```powershell
...
Listservrar för en utrustning i ett migrera projekt och filtrera svar med visningsnamn.

## PARAMETERS

### -</a0>
Anger namnet på utrustningen.
Det här mappar internt till en webbplats.
...
### -DisplayName
Anger visningsnamnet för VMware-datorn.
...
### -Name
Anger namnet på VMware-datorn.
Det här är ett internt namn.
Använd visningsnamn för användarna.
