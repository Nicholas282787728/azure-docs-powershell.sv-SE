...
ms.locfileid: "100237422"
---
# Get-AzMigrateServerReplication

## SYNOPSIS
Hämtar informationen om den replikerande servern.
...
### Exempel 1: Visa information efter id
```powershell
...
### Exempel 2: Lista alla i projektet efter ID.
```powershell
...
### Exempel 2: Lista alla i projekt efter namn.
```powershell
...
### -DiscoveredMachineId
Anger dator-ID för den identifierade servern.
...
### -MachineName
Anger visningsnamnet för den replikerande datorn.
...
### -Projektnamn
Anger Azure Migrate-projektet i den aktuella prenumerationen.
