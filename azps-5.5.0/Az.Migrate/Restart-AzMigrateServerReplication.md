...
ms.locfileid: "100219118"
---
# Restart-AzMigrateServerReplication

## SYNOPSIS
Startar om replikeringen för den angivna servern.
...
### -TargetObjectID
Anger den ominitieringsserver som du vill initiera omsynkroniseringsservern för.
