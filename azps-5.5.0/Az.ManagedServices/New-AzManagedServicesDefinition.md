...
Skapar en registreringsdefinition med hjälp av roleDefinitionId och principalId-värden som anges direkt.
...
Skapar eller uppdaterar en registreringsdefinition med auktoriseringsinformation.
...
Uppdaterar en registreringsdefinition med auktoriseringsinformation och namn på registreringsdefinitionen.

## PARAMETERS

### -Auktorisering
Listan över auktoriseringsmappningar med principalId - roleDefinitionId.
...
### -Beskrivning
Beskrivning av registreringsdefinitionen.
...
### -DisplayName
Visningsnamnet för registreringsdefinitionen.
...
### -ManagedByTenantId
Identifierare för ManagedBy-klientorganisationen.
...
### -RoleDefinitionId
Rolldefinitionsidentifieraren som beviljar behörigheter till huvudidentifieraren.
