...
Skapar en registreringstilldelning i standardomfattningen med hjälp av identifieraren för registreringsdefinition.
...
Skapar en registreringstilldelning med ett registreringsdefinitionsobjekt som indata.
...
Uppdaterar en registreringstilldelning med en identifierare och ett namn för registreringsdefinition.
...
Indataobjektet för registreringsdefinition.
...
Det fullständigt kvalificerade resurs-ID:t för registreringsdefinitionen.
...
### -Omfattning
Omfattningen där registreringstilldelningen ska skapas.
