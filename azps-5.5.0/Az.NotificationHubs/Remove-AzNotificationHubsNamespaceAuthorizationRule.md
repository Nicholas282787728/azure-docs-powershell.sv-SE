...
## BESKRIVNING
Cmdleten **Remove-AzNotificationHubsNamespaceAuthorizationRule** tar bort en SAS-auktoriseringsregel (Shared Access Signature) från ett meddelandehubbens namnområde.
Auktoriseringsregler hanterar åtkomst till ett namnområde.
Det gör du genom att skapa länkar, som URI:er, baserat på olika behörighetsnivåer.
Behörighetsnivåer kan vara av följande: 
- Lyssna
- Skicka
...
### Exempel 1: Ta bort en auktoriseringsregel från ett namnområde
```
PS C:\>Remove-AzNotificationHubNamespaceAuthorizationRule -Namespace "ContosoNamespace" -ResourceGroup "ContosoNotificationsGroup" -AuthorizationRule "ListenRule"
```

Det här kommandot tar bort auktoriseringsregeln med namnet ListenRule från namnområdet ContosoNamespace.
När du kör det här kommandot måste du ange den resursgrupp som namnområdet är tilldelat till.

## PARAMETERS

### -AuthorizationRule
Anger namnet på SAS-autentiseringsregeln som ska tas bort.
