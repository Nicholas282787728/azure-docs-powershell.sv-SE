...
### Exempel 1: Uppdatera en lösning för bildskärmslogganalys efter namn
```powershell
...
Med det här kommandot uppdateras en lösning för bildskärmslogganalys efter namn.

### Exempel 2: Uppdatera en lösning för bildskärmslogganalys per objekt
```powershell
...
Det här kommandot uppdaterar en lösning för bildskärmslogganalys per objekt.
