...
ms.locfileid: "100237921"
---
# Set-AzEventGridTopic

## SYNOPSIS
Anger egenskaperna för ett avsnitt i händelserutnätet.
...
## BESKRIVNING
Anger egenskaperna för ett avsnitt i händelserutnätet. Det här kan användas för att ersätta taggarna i ett avsnitt i händelserutnätet.
...
Anger egenskaperna för ämnet Händelserutnät ämne1 i resursgruppen MyResourceGroupName för att ersätta taggarna med de angivna taggarna \` \` \` \` "Avdelning" och "Miljö".
...
### -Tag
Hashtabeller som representerar resurstagg.
