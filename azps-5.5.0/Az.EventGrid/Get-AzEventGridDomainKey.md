...
ms.locfileid: "100253777"
---
# Get-AzEventGridDomainKey

## SYNOPSIS
Hämtar de delade snabbtangenterna som används för att publicera händelser i en domän i ett händelserutnät.
...
Hämtar delade snabbtangenter för domändomänen \` \` Händelserutnät1 i \` resursgruppen MyResourceGroupName. \`
