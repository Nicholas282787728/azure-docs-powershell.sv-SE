...
ms.locfileid: "100222559"
---
# New-AzEventGridTopicKey

## SYNOPSIS
Återskapar den delade åtkomstnyckeln för ett Azure Event Grid-ämne.
...
Återskapa nyckeln som motsvarar key \' key1'\ för ämnet Event Grid \` Topic1 \` i resursgruppen \` MyResourceGroupName. \`
