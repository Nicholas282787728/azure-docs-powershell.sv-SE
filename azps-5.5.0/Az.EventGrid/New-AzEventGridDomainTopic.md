...
ms.locfileid: "100228462"
---
# New-AzEventGridDomainTopic

## SYNOPSIS
Skapar ett nytt domänämne i Azure Event Grid.
...
Skapar ett ämne för domänen \` Händelserutnät1 \` i \` domändomän1 \` under \` resursgruppen MyResourceGroupName. \`
