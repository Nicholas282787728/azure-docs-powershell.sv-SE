...
## BESKRIVNING
**Ny-AzSearchSharedPrivateLinkResource** skapar en delad privat länkresurs för tjänsten Azure Cognitive Search.
...
Det här exemplet skapar en delad privat länkresurs till blob-tjänsten för ett lagringskonto för Azure Cognitive Search-tjänsten.
...
### -GroupId
Grupp-ID för delad privat länkresurs
...
Målresurs-ID för delad privat länk
...
### -ResourceRegion
(Valfritt) Resursregion för delad privat länk
