...
## BESKRIVNING
Den **nya cmdleten AzSearchAdminKey** återskapar en administratörsnyckel i tjänsten Azure Cognitive Search.
...
Exemplet återskapar primärnyckeln för tjänsten Azure Cognitive Search.
...
### -KeyKind
Azure Cognitive Search Service – administratörsnyckel sorts (primär/sekundär).
