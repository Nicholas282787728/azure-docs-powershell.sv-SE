...
## BESKRIVNING
Cmdleten **Remove-AzSearchQueryKey** tar bort frågenyckeln från tjänsten Azure Cognitive Search.
...
I exemplet tas frågenyckeln bort från tjänsten Azure Cognitive Search.
...
### -KeyValue
Nyckelvärde för Azure-kognitiva söktjänster.
