...
## BESKRIVNING
**Set-AzSearchPrivateEndpointConnection** uppdaterar den privata slutpunktsanslutningen till tjänsten Azure Cognitive Search.
...
Det här exemplet uppdaterar en privat slutpunktsanslutnings status för tjänsten Azure-kognitiv sökning till "Avvisad".
...
### -Beskrivning
Beskrivning av anslutning till privat slutpunkt
...
### -Status
Status för privat länktjänstanslutning
