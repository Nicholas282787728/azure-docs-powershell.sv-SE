...
## BESKRIVNING
Cmdleten **New-AzSearchService** skapar en Azure Cognitive Search-tjänst med angivna parametrar.
...
Med kommandot skapas en Azure-kognitivsökningstjänst.
...
### -HostingMode
Azure Cognitive Search Service hosting-läge.
...
### -Plats
Azure Cognitive Search-tjänstens plats.
...
### -PartitionCount
Azure Cognitive Search Service- partitionsräkning.
...
### -ReplicaCount
Azure-kognitiva söktjänstrepliker.
