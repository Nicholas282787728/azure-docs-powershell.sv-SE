...
## BESKRIVNING
Cmdleten **Get-AzSearchQueryKey** får frågenyckel(er) för tjänsten Azure Cognitive Search.
...
I exemplet returneras alla frågenyckel(er) för tjänsten Azure Cognitive Search.
