...
## BESKRIVNING
Cmdleten **Get-AzSearchPrivateLinkResource** får information om privata länkar till tjänsten Azure Cognitive Search.
...
Exemplet visar hur du hämtar information om den privata länkresursen (i JSON-formuläret för enkelhetens skull) för tjänsten Azure Cognitive Search.
