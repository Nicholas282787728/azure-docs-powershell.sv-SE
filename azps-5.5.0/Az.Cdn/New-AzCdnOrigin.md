...
## BESKRIVNING
Den New-AzCdnOrigin skapar ett nytt CDN-ursprung i den angivna slutpunkten.
...
Denna cmdlet skapar ett nytt CDN-ursprung för den angivna slutpunkten. Det angivna värdnamnet används som ursprung. 

## PARAMETERS

### -CdnOrigin
CDN-ursprungsobjektet.
