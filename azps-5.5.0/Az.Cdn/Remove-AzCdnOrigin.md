...
## BESKRIVNING
Remove-AzCdnOrigin ett CDN-ursprung från den angivna slutpunkten. Om ursprunget är det enda ursprunget i den angivna slutpunkten kommer borttagningen att misslyckas eftersom minst 1 ursprung krävs. 
...
```
Den här cmdleten tar bort det angivna ursprunget från den angivna slutpunkten. 
