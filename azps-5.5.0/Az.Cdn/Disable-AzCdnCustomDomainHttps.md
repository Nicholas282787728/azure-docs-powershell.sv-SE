...
## BESKRIVNING
Cmdleten **Disable-AzCdnCustomDomainHttps** inaktiverar säker HTTPS-leverans av en anpassad CDN-domän.
...
Inaktivera säker leverans av den anpassade domänen.

## PARAMETERS

### -CustomDomainName
Azure CDN-anpassat domännamn.
