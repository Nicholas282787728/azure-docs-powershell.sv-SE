...
## BESKRIVNING
Cmdleten **New-AzCdnCustomDomain** skapar en egen domän för slutpunkten Azure Content Delivery Network (CDN).
...
### -CdnEndpoint
Anger CDN-slutpunktsobjektet som den anpassade domänen läggs till i.
...
### -CustomDomainName
Anger resursnamnet för den anpassade domänen.
