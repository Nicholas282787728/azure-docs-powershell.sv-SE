...
ms.locfileid: "100229246"
---
# Get-AzCdnProfileSupportedOptimizationType

## SYNOPSIS
Hämtar de optimeringstyper som stöds för en CDN-profil.
...
## BESKRIVNING
Cmdleten **Get-AzCdnProfileSupportedOptimizationType** får de optimeringstyper som stöds för den aktuella profilen. En användare kan skapa en slutpunkt med en optimeringstyp från de listade värdena.
...
Hämta de optimeringstyper som stöds för en CDN-profil.
