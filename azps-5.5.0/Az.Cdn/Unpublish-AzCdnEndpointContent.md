...
## BESKRIVNING
**Cmdleten Avpublicera-AzCdnEndpointContent** rensar innehållet från en Slutpunkt för Azure Content Delivery Network (CDN).
...
### -CdnEndpoint
Anger slutpunkten som den här cmdleten tömer.
...
### -EndpointName
Anger namnet på slutpunkten som den här cmdleten tömer.
...
### -PurgeContent
Anger en matris med relativa sökvägar för innehållet på ursprungsservern som den här cmdleten rensar bort.
