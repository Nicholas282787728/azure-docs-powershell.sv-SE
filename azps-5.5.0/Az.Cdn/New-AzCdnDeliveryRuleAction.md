...
ms.locfileid: "100211942"
---
# New-AzCdnDeliveryRuleAction

## SYNOPSIS
Skapar en leveransåtgärd.
...
## BESKRIVNING
Cmdleten **New-AzCdnDeliveryRule** skapar en leveransregel för skapande av CDN-slutpunkt.
...
### -CacheBehavior
Cachelagringsbeteende för åtgärden
...
### -CacheDuration
Den varaktighet som innehållet måste cachelagras för.
...
? och & läggs till automatiskt så inkludera dem inte.
...
### -Destination
Definiera den relativa URL som ovanstående begäranden skrivs om till.
...
### -HeaderActionType
Om sidhuvudet eller svarshuvudet ska ändras
...
### -HeaderName
Namnet på sidhuvudet som ska ändras.
...
### -PreservePath
Om en omatchad sökväg ska bevaras.
...
### -QueryParameter
Frågeparametrar som ska inkludera eller exkludera (kommaavgränsade).
...
### -QueryStringBehavior
QueryString-beteende för begärandena
...
### -RedirectType
Omdirigeringstypen som regeln kommer att använda när du omdirigerar trafik
...
### -SourcePattern
Definiera ett URI-mönster för begäran som identifierar vilken typ av begäranden som kan skrivas om. Om värdet är tomt matchas alla strängar.
