...
ms.locfileid: "100229230"
---
# Remove-AzCdnOriginGroup

## SYNOPSIS
Tar bort en CDN-ursprungsgrupp
...
## BESKRIVNING
Remove-AzCdnOriginGroup en CDN-ursprungsgrupp från den angivna slutpunkten. 
...
Den här cmdleten tar bort den angivna ursprungsgruppen från den angivna slutpunkten. 
...
### -ResourceId
Resurs-ID för Azure CDN-ursprungsgruppen.
