...
ms.locfileid: "100229254"
---
# Enable-AzCdnCustomDomain

## SYNOPSIS
Aktiverar anpassad domän HTTPS (inaktuell).
...
## BESKRIVNING
Cmdleten **Enable-AzCdnCustomDomain** möjliggör säker HTTPS-leverans av en anpassad CDN-domän.
