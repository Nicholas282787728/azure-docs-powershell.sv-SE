...
## BESKRIVNING
Cmdleten **New-AzCdnProfile** skapar en Profil för Azure Content Delivery Network (CDN).

## EXEMPEL

### Exempel 1

Skapar en CDN-profil. (autogenererat)
...
### -Plats
Anger resursplatsen för profilen.
...
### -Tag
De taggar som ska associeras med Azure CDN-profilen.
