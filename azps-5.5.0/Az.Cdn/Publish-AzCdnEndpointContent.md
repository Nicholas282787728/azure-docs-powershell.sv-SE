...
ms.locfileid: "100234839"
---
# Publish-AzCdnEndpointContent

## SYNOPSIS
Läser in innehåll till en slutpunkt.
...
## BESKRIVNING
**Cmdleten Publish-AzCdnEndpointContent** läser in innehåll från en ursprungsserver för slutpunkten Azure Content Delivery Network (CDN).
...
### -LoadContent
Anger en matris med relativa sökvägar för innehållet på ursprungsservern som denna cmdlet publicerar.
...
[Avpublicera-AzCdnEndpointContent](./Unpublish-AzCdnEndpointContent.md)
