...
ms.locfileid: "100235079"
---
# New-AzAutomationUpdateManagementAzureQuery

## SYNOPSIS
Skapar azure automation software update configuration azure query object.
...
## BESKRIVNING
Skapar en azure-frågeobjekt för programvaruuppdatering som används för att skapa en konfiguration för programvaruuppdatering som körs på ett schema för att uppdatera en lista med dynamiskt lösta listor över virtuella Azure-datorer.
...
### -Tag
Tagg för virtuella Azure-datorer.
