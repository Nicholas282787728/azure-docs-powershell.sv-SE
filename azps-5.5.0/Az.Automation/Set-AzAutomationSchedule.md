...
## BESKRIVNING
Cmdleten **Set-AzAutomationSchedule** ändrar ett schema i Azure Automation.
...
Det här kommandot ändrar beskrivningen av schemat med namnet Schedule01.

## PARAMETERS

### -AutomationAccountName
Anger namnet på ett automatiseringskonto för vilket denna cmdlet ändrar ett schema.
...
### -Beskrivning
Anger en beskrivning för schemat.
...
### -IsEnabled
Anger om den här cmdleten aktiverar schemat.
...
### -Name
Anger namnet på schemat som cmdleten ändrar.
...
### -ResourceGroupName
Anger namnet på en resursgrupp för vilken denna cmdlet ändrar ett schema.
