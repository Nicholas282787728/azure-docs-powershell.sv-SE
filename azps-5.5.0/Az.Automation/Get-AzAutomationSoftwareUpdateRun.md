...
## BESKRIVNING
Den Get-AzAutomationSoftwareUpdateRun cmdleten returnerar en lista med programuppdatering. Eftersom en konfiguration av programuppdateringen har ett associerat schema kan den utlösas flera gånger. Varje gång ett schema utlöses resulterar det i att en uppdateringskörning skapas. Uppdateringskörningen är en mängd av resultatet av alla datorkörningar. Du kan få körningar för specifik konfiguration av programuppdateringar genom att skicka parametern SoftwareUpdateConfigurationName. Om du vill få en specifik körning måste du överföra namnparametern. Du kan också lista som körs med specifik status, kör riktad mot specifikt operativsystem eller som körs igång efter en viss tid genom att skicka lämplig parameter.

## EXEMPEL

### Exempel 1
I det här exemplet visas alla uppdateringar som körs av en viss konfiguration för programuppdateringar.
...
### -Id
Id för konfigurationen av programuppdateringen körs.
...
### -OperatingSystem
Operativsystemet för körningen.
...
Konfigurationen av programuppdateringen utlöste körningen.
...
Namnet på konfigurationen av programuppdateringen som utlöste körningen.
