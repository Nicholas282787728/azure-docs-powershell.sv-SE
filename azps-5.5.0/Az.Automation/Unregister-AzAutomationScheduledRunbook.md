...
## BESKRIVNING
**Cmdleten Unregister-AzAutomationScheduledRunbook** tar bort kopplingen mellan en Azure Automation-runbook och ett schema.
Schemat startar inte längre runbooken.
...
Det här kommandot tar bort kopplingen mellan runbooken med namnet Runbk01 och schemat Runbk01Sched.
...
### -JobScheduleId
Anger ID för en schemalagd körningsbok.
...
### -RunbookName
Anger namnet på den runbook som den här cmdleten avblockerar från ett schema.
...
### -ScheduleName
Anger namnet på det schema från vilket den här cmdleten avblockerar en runbook.
