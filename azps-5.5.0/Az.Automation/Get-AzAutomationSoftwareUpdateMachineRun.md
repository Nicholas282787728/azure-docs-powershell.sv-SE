...
## BESKRIVNING
Den här cmdleten returnerar en lista över maskin körs. Varje programuppdatering som körs utlöser en datorkörning för var och en av måldatorn för programuppdateringskonfigurationen. Om du vill köra en specifik dator skickar du Id-parametern. Du kan lista alla körs på datorn, alla körs på en viss dator och alla körs med specifik status genom att skicka motsvarande parametrar.

## EXEMPEL

### Exempel 1
I det här exemplet returneras alla misslyckade datorer körs för den angivna virtuella Azure-datorn.
...
### -Id
ID för programuppdateringsdatorns körning.
...
### -SoftwareUpdateRunId
Id för programuppdateringen körs.
...
### -TargetComputer
måldator för datorkörningen.
Kan vara ett icke-az-datornamn eller ett azure VM-resurs-ID.
