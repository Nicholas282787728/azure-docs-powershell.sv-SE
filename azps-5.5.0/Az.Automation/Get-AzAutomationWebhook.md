...
## BESKRIVNING
Cmdleten **Get-AzAutomationWebhook** får webhooks.
Om du vill hämta specifika webhooks anger du ett webhook-namn eller anger namnet på en Azure Automation-runbook så att webhooks ansluts till den.

## EXEMPEL

### Exempel 1: Hämta alla webhooks för en runbook
```
PS C:\>Get-AzAutomationWebhook -RunbookName "Runbook03" -ResourceGroup "ResourceGroup01" -AutomationAccountName "AutomationAccount01"
```

Det här kommandot hämtar alla webhooks för en runbook med namnet Runbook03 i automatiseringskontot AutomationAccount01 i resursgruppen ResourceGroup01.

## PARAMETERS

### -AutomationAccountName
Anger namnet på ett automatiseringskonto där den här cmdleten hämtar en webhook.
...
### -Name
Anger namnet på den webhook som den här cmdleten hämtar.
...
### -ResourceGroupName
Anger namnet på resursgruppen som den här cmdleten hämtar webhooks för.
...
### -RunbookName
Anger namnet på en runbook som den här cmdleten hämtar webhooks för.
