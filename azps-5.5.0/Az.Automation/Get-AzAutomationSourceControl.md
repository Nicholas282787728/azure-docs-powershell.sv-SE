...
## BESKRIVNING
Den Get-AzAutomationSourceControl cmdleten får kontroller för automatiseringskälla.
Om du vill ha en viss källkontroll anger du dess namn.

## EXEMPEL

### Exempel 1
Det här kommandot får en automationskälla med namnet VSTSNative i kontot devAccount.
