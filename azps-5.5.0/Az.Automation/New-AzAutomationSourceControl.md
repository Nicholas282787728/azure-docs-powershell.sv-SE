...
## BESKRIVNING
Med New-AzAutomationSourceControl-cmdleten skapas en konfiguration som länkar mitt Azure Automation-konto till vsts TFVC, VSTS Git eller GitHub.

## EXEMPEL

### Exempel 1
Skapa en konfiguration för källkontroll för att länka mitt Azure Automation-konto till mitt VSTS TFVC-projekt. TFVC-projekt har inga filialer och därför anges inte parametern Branch.
...
### Exempel 2
Skapa en konfiguration för källkontroll för att länka mitt Azure Automation-konto till ditt VSTS Git-projekt.
...
### Exempel 3
Skapa en konfiguration för källkontroll för att länka mitt Azure Automation-konto till mitt GitHub-projekt.
...
### -AccessToken
Åtkomsttoken för källkontrollen.
...
### -DoNotPublishRunbook
Egenskapen publishRunbook för källkontrollen.
Om DoNotPublishRunbook har angetts innebär det att användar runbooks importeras som "Utkast".
...
### -EnableAutoSync
Egenskapen autoSync för källkontrollen.
...
### -FolderPath
Sökvägen till mappen för källkontrollen.
...
### -RepoUrl
Url:en för källkontrollens lagringsplatsen.
