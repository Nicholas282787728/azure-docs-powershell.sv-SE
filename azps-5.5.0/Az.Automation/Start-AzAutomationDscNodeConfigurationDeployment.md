...
### Exempel 2: Schemalägga konfiguration av en Azure DSC-nod i Automation
```
...
Kommandot ovan schemalägger en distribution av en DSC-nodkonfiguration med namnet "Config01.Node1" till den givna tvådimensionella matrisen med Nodnamn. Distributionen sker på ett stegat sätt och kommer att utföras baserat på schemat.
...
Anger namnet på DSC-nodkonfigurationen som den här cmdleten distribuerar.
...
### -NodeName
Anger namnen på noderna som nodkonfigurationen ska distribueras till.
...
### -Schemalägg
Automationsschemaobjekt för att schemalägga distributionsjobbet.
