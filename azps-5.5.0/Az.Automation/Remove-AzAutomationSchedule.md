...
Det här kommandot tar bort schemat schedule01 i automationskontot Contoso17 i resursgruppen ResourceGroup01.

## PARAMETERS

### -AutomationAccountName
Anger namnet på ett automatiseringskonto för vilket denna cmdlet tar bort ett schema.
...
### -Name
Anger namnet på schemat som cmdleten tar bort.
...
### -ResourceGroupName
Anger namnet på en resursgrupp för vilken denna cmdlet tar bort ett schema.
