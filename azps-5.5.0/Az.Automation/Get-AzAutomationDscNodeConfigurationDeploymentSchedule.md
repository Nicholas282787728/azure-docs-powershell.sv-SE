...
### Exempel 1: Hämta alla distributionsscheman
```
...
### Exempel 2: Hämta ett distributionsschema
```
...
### -JobScheduleId
Anger ID för jobbschemat för ett befintligt schemalagt distributionsjobb.
