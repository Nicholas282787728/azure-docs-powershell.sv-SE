...
## BESKRIVNING
Med Update-AzAutomationSourceControl-cmdleten ändras värdet för ett fält i en källkontroll i Azure Automation.

## EXEMPEL

### Exempel 1
Med dessa kommandon anger du fältet PublishRunbook till falskt för Azure Automation-källkontrollen VSTSNative i kontot devAccount.
...
Uppdaterar en Azure Automation-källkontroll. (autogenererat)
