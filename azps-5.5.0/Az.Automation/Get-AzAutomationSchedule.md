...
### Exempel 1: Skapa ett schema
```
PS C:\>Get-AzAutomationSchedule -AutomationAccountName "Contoso17" -Name "DailySchedule08" -ResourceGroupName "ResourceGroup01"
```

Med det här kommandot får schemat namnet DailySchedule08.

## PARAMETERS

### -AutomationAccountName
Anger namnet på ett automatiseringskonto för vilket den här cmdleten hämtar ett schema.
...
### -Name
Anger namnet på ett schema som cmdleten hämtar.
...
### -ResourceGroupName
Anger namnet på en resursgrupp för vilken den här cmdleten hämtar ett schema.
