...
## BESKRIVNING
**Cmdleten Get-AzAutomationSourceControlSyncOutput** får resultatet för ett synkroniseringsjobb för källkontroll av Azure Automation.

## EXEMPEL

### Exempel 1
Det här kommandot får utdata från synkroniseringsjobbet för källkontroll med id 08d6d266-27b6-463c-beea-bc48a67ace15 för källkontrollen VSTSNative. 
...
### -Stream
Strömtypen.
Standardinställningen är Valfri.
...
### Microsoft.Azure.Commands.Automation.Model.SourceControlSyncStreamStreamRecord
