...
Med det första kommandot tilldelas en hash-tabell med fältvärden till $FieldValue variabeln.
Det andra kommandot skapar en Azure-anslutning med namnet Connection12 i automationskontot AutomationAccount01.
Kommandot använder anslutningsfältvärdena i $FieldValues.
...
Kommandot skapar en Azure-anslutning med namnet Connection13 i automationskontot AutomationAccount01 med $RunAsAccountConnectionFieldValues och ConnectionTypeName=AzureServicePrincipal.
Denna ConnectionTypeName=AzureServicePrincipal används huvudsakligen för Azure Run As Account.
...
Kommandot skapar en Azure-anslutning med namnet Connection14 i automationskontot AutomationAccount01 med $ClassicRunAsAccountConnectionFieldValues och ConnectionTypeName=AzureClassicCertificate.
Denna ConnectionTypeName=AzureClassicCertificate används huvudsakligen för Azure Classic Run As Account.

## PARAMETERS

### -AutomationAccountName
Anger namnet på det automatiseringskonto för vilket den här cmdleten skapar en anslutning.
...
Anger en hash-tabell som innehåller nyckel-/värdepar.
Nycklarna representerar kopplingsfälten för den angivna anslutningstypen.
Värdena representerar de specifika värdena för varje anslutningsfält för anslutningsinstansen.
...
### -ConnectionTypeName
Anger namnet på anslutningstypen.
...
### -ResourceGroupName
Anger namnet på resursgruppen som cmdleten skapar en anslutning för.
