...
## BESKRIVNING
Cmdleten **New-AzAutomationCredential** skapar ett autentiseringsobjekt som ett **PSCredential-objekt** i Azure Automation.

## EXEMPEL

### Exempel 1: Skapa en autentisering
```
...
Det slutliga kommandot skapar en automatiserings credential med namnet ContosoCredential som använder $Credential.

## PARAMETERS

### -AutomationAccountName
Anger namnet på det automatiseringskonto där den här cmdleten lagrar autentiseringsnamnen.
...
### -Beskrivning
Anger en beskrivning för autentiserings referensen.
...
### -Name
Anger ett namn för autentiseringsnamnen.
...
### -ResourceGroupName
Anger en beskrivning för den resursgrupp för vilken den här cmdleten skapar en autentiseringsuppgifter.
