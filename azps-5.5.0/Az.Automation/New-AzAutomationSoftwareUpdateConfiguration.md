...
## BESKRIVNING
Skapar en konfiguration av programuppdateringen som körs på ett schema för att uppdatera en lista över datorer. Datorer innehåller både virtuella Azure-datorer och datorer som inte är az.

## EXEMPEL

### Exempel 1
Skapar en konfiguration för programvaruuppdatering för att installera kritiska uppdateringar på två virtuella Windows Azure-datorer en gång per lördag 21.00. Uppdateringsvaraktighet anges till 2 timmar i det här exemplet.
...
Linux paketklassificering ingår.
...
Windows Update-klassificeringar ingår.
...
### -Linux
Anger att konfigurationen av programuppdateringen är riktad mot Linux-operativsystemdatorer.
...
### -NonAzureQuery
Dynamisk grupp som inte är Azure-fråga.
...
### -RebootOnly
Anger att konfigurationen av programuppdateringen endast startar om datorer.
...
### -Schemalägg
Schemaobjekt som används för konfiguration av programuppdatering.
...
### -Windows
Anger att programvaran uppdaterar konfigurationsanpassning för windows-operativsystemdatorer.
