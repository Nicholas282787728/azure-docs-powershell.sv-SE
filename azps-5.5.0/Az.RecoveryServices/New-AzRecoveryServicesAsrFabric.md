...
Startar arbetet med det godkända namnet och returnerar DET ASR-jobb som används för att spåra åtgärden för att skapa material.
...
Startar skapande av azure-struktur med det godkända namnet och returnerar DET ASR-jobb som används för att spåra strukturskapandet.

## PARAMETERS

### -Azure
Växelparametern anger för att skapa azure-struktur.
...
### -Plats
Anger Azure-regionen som motsvarar det Fabric-objekt som skapas. Strukturen för Azure-webbplatsåterställning representerar en region. För virtuella datorer som replikeras mellan två Azure-regioner representerar en primär struktur den primära Azure-regionen och återställningsmaterialet.
...
### -Type
Anger typ av återställning av Azure-webbplats.
