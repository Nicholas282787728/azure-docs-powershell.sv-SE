...
## BESKRIVNING
Cmdleten **Remove-AzRecoveryServicesAsrvCenter** tar bort vCenter-servern från ASR-strukturen och stoppar identifieringen av virtuella datorer från vCenter-servern.
...
Tar bort vCenter-servern från ASR-materialet.

### Exempel 2

Tar bort vCenter-servern från ASR-materialet och stoppar identifieringen av virtuella maskiner från vCenter-servern. (autogenererat)
...
### -Fabric
ASR-strukturobjekt som representerar Konfigurationsservern.
...
### -ResourceId
Anger resurs-ID för vCenter som ska tas bort.
