...
## BESKRIVNING
**Cmdleten Resume-AzRecoveryServicesAsrServicesAsr En** pausad Azure-webbplatsåterställningsjobb återupptas.
...
Återuppta det angivna jobbet om det är i väntande eller inaktiverat tillstånd och returnera det uppdaterade ASR-jobbobjektet som motsvarar ASR-jobbet.

## PARAMETERS

### -Kommentar
Kommentarer för jobbloggen.
...
### -InputObject
Inmatningsobjektet till cmdleten: ASR-jobbobjektet som motsvarar det jobb som ska återupptas.
