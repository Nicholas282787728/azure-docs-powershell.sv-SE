...
## BESKRIVNING
Cmdleten **Get-AzRecoveryServicesAsrStorageClassificationMapping** hämtar information om en ASR-lagringsklassificeringsmappning.
...
Lista alla mappningar av lagringsklassificeringar som motsvarar den angivna lagringsklassificering.
...
### -Name
Anger namnet på den mappning av lagringsklassificering som ska hämtas.
...
Anger ett ASR-lagringsklassificeringsobjekt. Cmdleten får ASR-lagringsklassificeringsmappningar som motsvarar den angivna lagringsklassificering 
