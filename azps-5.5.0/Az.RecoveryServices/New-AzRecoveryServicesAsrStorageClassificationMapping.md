...
## BESKRIVNING
**Cmdleten New-AzRecoveryServicesAsrStorageClassificationMapping** skapar en lagringsklassificeringsmappning av Recovery Services-valvet.
...
Startar åtgärden för att skapa mappning av lagringsklassificering med angivna parametrar och returnerar ASR-jobbet som använts för att spåra åtgärden.
...
### -Name
Anger ett namn för ASR-lagringsklassificeringsmappningen.
...
Anger det primära ASR-lagringsklassificeringsobjektet för mappningen.
...
Anger återställnings-ASR-lagringsklassificeringsobjektet för mappningen.
