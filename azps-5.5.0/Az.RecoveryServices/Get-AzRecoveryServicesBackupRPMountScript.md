...
## BESKRIVNING
Med Get-AzRecoveryServicesBackupRPMountScript-cmdleten laddas ett skript ned som hämtar volymen av återställningspunkten på den dator där den körs.

## EXEMPEL

### Exempel 1: Sätta fast en återställningspunkt
```powershell
...
När skriptet körs fästs filerna i återställningspunkten på $rp \[ 0\]

### Exempel 2

Laddar ned ett skript för att installera alla filer på återställningspunkten. (autogenererat)
...
### -Path
Plats där filen ska laddas ned vid filåterställning. Om -Path inte anges laddas skriptfilen ned i den aktuella katalogen.
