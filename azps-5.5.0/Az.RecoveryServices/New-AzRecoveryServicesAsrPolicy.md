...
## BESKRIVNING
Cmdleten **New-AzRecoveryServicesAsrPolicy** skapar en Azure Site Recovery-replikeringsprincip.
Replikeringsprincipen används för att ange replikeringsinställningar som replikeringsfrekvens och antal återställningspunkter.
...
Startar skapandet av replikeringsprincipen med de angivna parametrarna och returnerar det ASR-jobb som använts för att spåra åtgärden.
...
### -AzureToAzure
Växelparametern anger scenariot för skapande av Azure-princip till Azure-princip.
...
### -HyperVToAzure
Växla parameter för att ange principen ska användas för att replikera virtuella Hyper-V-datorer till Azure
...
Behåll återställningspunkterna för en viss tid i timmar.
...
### -VmmToVmm
Växla parameter för att ange principen ska användas för att replikera mellan Hyper-V-webbplatser som hanteras av en VMM-server.
...
### -VMwareToAzure
Växelparameter som anger att den replikeringsprincip som skapas kommer att användas för att replikera virtuella VMware-datorer och/eller fysiska servrar till Azure.
