...
## BESKRIVNING
Kommandot returnerar null/tom om den angivna resursen inte är skyddad under något Recovery Services-valv i prenumerationen. Om den är skyddad returneras relevant valvinformation.

## EXEMPEL

### Exempel 1

Kontrollerar om ARM säkerhetskopieras eller inte. (autogenererat)
...
### -Name
Namnet på Azure-resursen vars representativa objekt behöver kontrolleras om den redan är skyddad av vissa Recovery Services-valv i prenumerationen.
...
### -ResourceGroupName
Namn på resursgruppen för Azure-resursen vars representativa objekt behöver kontrolleras om den redan skyddas av vissa RecoveryServices-valv i prenumerationen.
...
### -ResourceId
ID för azure-resursen vars representativa objekt behöver kontrolleras om det redan är skyddat av vissa RecoveryServices-valv i prenumerationen.
...
### -Type
Typ av Azure-resurs vars representativa objekt behöver kontrolleras om den redan skyddas av vissa Recovery Services-valv i prenumerationen.
