...
## BESKRIVNING
Cmdleten **Get-AzRecoveryServicesBackupProtectionPolicy** får Azure Backup Protection-principer för ett valv.
...
Det här kommandot hämtar alla skyddsprinciper som skapats i valvet.

### Exempel 2: Skapa en viss princip
```
PS C:\> $Pol= Get-AzRecoveryServicesBackupProtectionPolicy -Name "DefaultPolicy"
```

Det här kommandot hämtar skyddsprincipen med namnet DefaultPolicy och lagrar den sedan $Pol variabeln.

## PARAMETERS

### -BackupManagementType
Den resursklass som skyddas. De värden som stöds för denna cmdlet är för närvarande AzureVM, AzureStorage, AzureWorkload
...
### -WorkloadType
Typ av arbetsbelastning för resursen. De aktuella värdena som stöds är AzureVM, AzureFiles, MSSQL
