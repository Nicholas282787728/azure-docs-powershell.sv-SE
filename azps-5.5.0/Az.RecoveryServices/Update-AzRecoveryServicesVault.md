...
ms.locfileid: "100217887"
---
# Update-AzRecoveryServicesVault

## SYNOPSIS
Uppdaterar MSI för valv för återställningstjänster.
...
## BESKRIVNING
Den här cmdleten används för att lägga till eller ta bort MSI-programmet från återställningstjänster. Använd -IdentityType-param för att tilldela EN SystemAssigned-identitet till RSVault. Använd IdentityType None för att ta bort MSI-data från valvet.
...
Den här cmdleten används för att lägga till en SystemAssigned-identitet i ett valv för återställningstjänster.
...
Anger namnet på det återställningstjänster som ska uppdateras.
...
Anger namnet på azure-resursgruppen där valv för återställningstjänster finns.
...
### -IdentityType
MSI-typen som tilldelats Recovery Services Vault.
