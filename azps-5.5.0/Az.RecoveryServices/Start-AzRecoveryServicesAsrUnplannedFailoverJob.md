...
## BESKRIVNING
Cmdleten **Start-AzRecoveryServicesAsrUnplannedFailover Starts** oplanerad redundans för ett skyddat objekt eller en återställningsplan för Azure-webbplatsåterställning.
...
Startar den oplanerade redundansåtgärden för återställningsplanen med angivna parametrar och returnerar det ASR-jobb som använts för att spåra åtgärden.

### Exempel 2

Startar en oplanerad redundansåtgärd. (autogenererat)
...
Anger den primära sökvägen till den primära datakrypteringsfilen för redundans för skyddat objekt.
...
Anger den sekundära sökvägen till den sekundära datakrypteringsfilen för redundans för skyddat objekt.
...
Utför en åtgärd på källsidan innan du startar oplanerad redundans.
...
### -RecoveryPoint
Anger en anpassad återställningspunkt som den skyddade datorn ska redundans för.
...
### -RecoveryTag
Anger vilken återställningstagg som redundans ska återställas.
...
Anger ett skyddat Azure Site Recovery-objekt.
