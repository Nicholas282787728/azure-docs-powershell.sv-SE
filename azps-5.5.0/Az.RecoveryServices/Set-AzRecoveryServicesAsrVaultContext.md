...
## BESKRIVNING
**Cmdleten Set-AzRecoveryServicesAsrVaultContext** anger valvkontexten för Azure-webbplatsåterställning för ytterligare åtgärder.
...
Anger valvkontexten till det angivna Recovery Services-valvet för efterföljande Azure Site Recovery-åtgärder i den aktuella PowerShell-sessionen.
...
### -Vault
Recovery Services-valvobjektet som motsvarar Recovery Services-valvet.
