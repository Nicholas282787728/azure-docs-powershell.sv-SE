...
## BESKRIVNING
Cmdleten **New-AzRecoveryServicesAsrProtectionContainerMapping** skapar en mappning av Azure-webbplatsåterställningsbehållare genom att associera den angivna replikeringsprincipen till den angivna skyddsbehållaren.
...
Startar skapandet av mappningen av skyddbehållaren med de angivna parametrarna och returnerar det ASR-jobb som använts för att spåra åtgärden.
...
### -Name
Anger namnet på mappningen av skyddbehållaren.
...
### -Policy
Anger ASR-replikeringsprincipens objekt för den replikeringsprincip som ska användas i mappningen.
...
Anger ASR-skyddsbehållareobjektet för den primära skyddsbehållaren som ska användas i mappningen.
...
Anger ASR-skyddsbehållareobjektet för den återställningsskyddsbehållare som ska användas i mappningen (används om den replikerar till en återställningsplats som inte är Azure.)
