...
## BESKRIVNING
Cmdleten **Get-AzRecoveryServicesAsrProtectionContainerMapping** hämtar information om skyddbehållaren till replikeringsprincipmappningar(association) i valvet för den angivna ASR-skyddsbehållaren.
...
Lista över mappningar av skyddbehållare för behållaren.
...
Hämtar alla mappningar av skyddbehållare för den angivna skyddbehållaren.
...
### -Name
Anger namnet på den mappning av skyddbehållaren som ska hämtas.
...
### -ProtectionContainer
Hämta mappningar av skyddbehållare som motsvarar det angivna ASR-skyddsbehållareobjektet.
