...
Lägger till en grupp i den befintliga Azure-webbplatsåterställningsplanen och returnerar den uppdaterade återställningsplanen för det lokala minnet. 

### Exempel 2

Redigerar en plan för webbplatsåterställning. (autogenererat)
...
### -AddProtectedItem
Lista över ASR-replikeringsskyddade objekt som ska läggas till i gruppen för återställningsplaner i återställningsplanobjektet.
...
### -AppendGroup
Byt parameter för att lägga till en återställningsplangrupp till återställningsplanobjektet.
...
### -Grupp
Anger en återställningsplansgrupp.
...
### -InputObject
Återställningsplanobjektet för ASR som ska redigeras (i minnesåtgärden. Om du vill uppdatera återställningsplanen Update-AzASRRecoveryPlan med det redigerade återställningsplanobjektet.)
...
### -RemoveGroup
Tar bort den angivna gruppen från återställningsplanobjektet.
...
### -RemoveProtectedItem
Lista över ASR-replikeringsskyddade objekt som ska tas bort från gruppen återställningsplan i återställningsplanobjektet.
