...
## BESKRIVNING
Cmdleten **Remove-AzRecoveryServicesAsrProtectionContainerMapping** tar bort den angivna mappningen av azure-webbplatsåterställningsbehållaren.
...
Startar borttagningen av angiven mappning av skyddbehållare och returnerar ASR-jobbet som användes för att spåra åtgärden.
...
### -InputObject
Inmatningsobjektet till cmdleten: ASR-skyddbehållaren som motsvarar den skyddbehållare som ska tas bort.
