...
## BESKRIVNING
Cmdleten **Stop-AzRecoveryServicesAsr Engström** stoppar det angivna Azure-webbplatsåterställningsjobbet.
...
Försöker stoppa det angivna jobbet och returnerar ett uppdaterat ASR-jobbobjekt.
...
### -InputObject
Indataobjekt: Ange det ASR-jobbobjekt som motsvarar ASR-jobbet som ska stoppas
...
### -Name
Ange asr-jobbet som ska stoppas av ASR-jobbnamnet.
