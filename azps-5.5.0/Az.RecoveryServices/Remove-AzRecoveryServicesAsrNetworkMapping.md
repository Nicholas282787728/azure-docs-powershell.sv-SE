...
## BESKRIVNING
Cmdleten **Remove-AzRecoveryServicesAsrNetworkMapping** tar bort den angivna ASR-nätverksmappningen.
...
Startar borttagningen av angiven ASR-nätverksmappning och returnerar ASR-jobbet som användes för att spåra åtgärden.
...
### -InputObject
Inmatningsobjektet till cmdleten: ASR-nätverksmappningsobjektet som motsvarar ASR-nätverksmappningen som ska tas bort.
