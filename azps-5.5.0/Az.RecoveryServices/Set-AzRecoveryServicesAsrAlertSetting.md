...
## BESKRIVNING
Cmdleten **Set-AzRecoveryServicesAsrNotificationSetting** konfigurerar meddelandeinställningarna för Azure Site Recovery (e-postavisering) för valvet.
...
Ange aviseringar för anpassade e-postadresser och för prenumerationsägare.

### Exempel 3

Konfigurera aviseringsinställningar för Azure-webbplatsåterställning (e-postavisering) för valvet. (autogenererat)
...
### -CustomEmailAddress
Avisering/avisering som skickas till e-postmeddelanden.
...
### -DisableNotification
Flagga för att inaktivera alla meddelanden.
...
### -LocaleID
E-postspråk för avisering /avisering till användare (kulturkoder som stöds från microsoft). 
