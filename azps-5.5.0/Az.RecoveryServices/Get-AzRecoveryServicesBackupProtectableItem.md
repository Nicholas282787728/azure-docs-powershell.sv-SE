...
## BESKRIVNING
Cmdleten **Get-AzRecoveryServicesBackupProtectableItem** hämtar listan med skyddbara objekt i en behållare och objektens skyddsstatus.
...
Det första kommandot får behållaren av typen MSSQL och lagrar den sedan i $Container variabeln.
Det andra kommandot hämtar det säkerhetskopierade skyddbara objektet i $Container och lagrar det sedan i den $Item variabeln.
...
### -ItemType
Anger vilken typ av skyddbart objekt det är. Tillämpliga värden: (SQLDataBase, SQLInstance, SQLAvailabilityGroup).
...
### -Name
Anger namnet på databasen, instansen eller tillgänglighetsgruppen.
...
### -ParentID
Angav ARM instansens eller AG:s ARM.
