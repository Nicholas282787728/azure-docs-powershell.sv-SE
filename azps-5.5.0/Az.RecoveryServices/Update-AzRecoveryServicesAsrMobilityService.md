...
## BESKRIVNING
Cmdleten **Update-AzRecoveryServicesAsrMobilityService försöker push-uppdatera** mobilitetstjänstagenter till skyddade datorer (om det finns en uppdatering.)
...
### -Konto
Kör som konto-ID som ska användas för att skicka uppdateringen. Måste finnas med i listan med körning som konton i ASR-strukturen som motsvarar den dator som uppdateras.
...
Skyddat objekt i Azure Site Recovery som ska uppdateras.
