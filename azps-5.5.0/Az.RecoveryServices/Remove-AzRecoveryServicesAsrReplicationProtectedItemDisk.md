...
Starta åtgärden för att ta bort den angivna hårddisken från skydd av VM för ohanterad disk.
...
Starta åtgärden för att ta bort den angivna hårddisken från skydd av VM för hanterad disk.
...
Startar åtgärden för att ta bort den angivna hårddisken och returnerar det ASR-jobb som används för att spåra borttagningen av den skyddade disken.
...
### -DiskId
Anger listan över hanterade disk-ID:n.
...
### -InputObject
Indataobjektet till cmdleten: ASR-replikeringsskyddat objekt som motsvarar den disk som ska tas bort.
