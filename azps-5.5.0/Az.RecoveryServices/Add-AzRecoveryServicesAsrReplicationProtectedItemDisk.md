...
ms.locfileid: "100213071"
---
# Add-AzRecoveryServicesAsrReplicationProtectedItemDisk

## SYNOPSIS
Lägg till disken som skydd för den redan skyddade virtuella Azure-datorn.
...
## BESKRIVNING
**Cmdleten Add-AzRecoveryServicesAsrReplicationProtectedItemDisk** lägger till disken för skydd för redan skyddade virtuella Azure-datorer.
...
Starta åtgärden för att lägga till specifik diskkonfiguration för skydd.
...
Starta åtgärden för att lägga till specifik diskkonfiguration för skydd. Replikeringsskyddat objekt för pipingindata.

## PARAMETERS

### -AzureToAzureDiskReplicationConfiguration
Anger den diskkonfiguration som ska användas för diskskydd för azure till Azure-katastrofåterställning.
...
### -InputObject
Indataobjektet till cmdleten: ASR-replikeringsskyddat objekt som motsvarar vilket ny disk ska skyddas.
