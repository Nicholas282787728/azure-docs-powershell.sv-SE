...
## BESKRIVNING
Cmdleten **Get-AzRecoveryServicesAsrReplicationProtectedItem** hämtar egenskaperna för alla eller det angivna ASR-replikeringsskyddade objektet från den angivna ASR-skyddsbehållaren.
...
Visar alla replikeringsskyddade objekt i den angivna ASR-skyddsbehållaren.

### Exempel 2

Hämtar egenskaperna för skyddade objekt i Azure Site Recovery Replication. (autogenererat)
...
### -FriendlyName
Anger eget namn för det replikeringsskyddade objektet som ska hämtas.
...
### -Name
Anger namnet på det replikeringsskyddade objektet som ska hämtas.
...
### -ProtectableItem
Anger ett ASR-objekt som kan skyddas. Cmdleten hämtar det ASR-replikeringsskyddade objektet som motsvarar det angivna ASR-skyddbara objektet om objektet är skyddat.
...
### -ProtectionContainer
Anger ASR-skyddbehållareobjektet för ASR-skyddsbehållaren som motsvarar det replikeringsskyddade objektet. 
