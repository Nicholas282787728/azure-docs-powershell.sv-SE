...
## BESKRIVNING
**Cmdleten Update-AzRecoveryServicesAsrProtectionContainerMapping** uppdaterar den angivna behållarmappningen för Azure-webbplatsåterställning.
...
### -AutomationAccountId
Anger det automatiseringskonto-ID som används för automatisk udpate.
...
### -AzureToAzure
Anger Azure till Azure-skyddbehållaren.
...
### -InputObject
Objekt för mappning av säkerhetsbehållare.
