...
## BESKRIVNING
Cmdleten **Start-AzRecoveryServicesAsrTestFailoverCleanupService** startar rensningen av test redundans för ett replikeringsskyddat objekt eller en återställningsplan för vilken en test redundans har utförts.

## EXEMPEL

### Exempel 1

Jobb för att spåra rensning av test redundans för en Återställningsplan för Azure-webbplatsåterställning.
...
Startar rensningen av test redundans. (autogenererat)
...
### -Kommentar
Användarkommentar för redundans för test.
...
### -RecoveryPlan
Återställningsplan för att utföra redundansrensningen för testet.
...
Replikeringsskyddat objekt för att utföra redundansrensningen för test.
...
### -ResourceId
Resurs-ID för replikeringsskyddat objekt/återställningsplan för redundans för redundans för rensningstest.
