...
## BESKRIVNING
**Cmdleten Remove-AzSynapseTtrapperSubscription** avslutar händelseutlösaren för de angivna externa tjänsthändelserna från utlösaren.
...
Det här kommandot avslutar avslut av utlösare som kallas ContosoTringen för de angivna händelserna från utlösaravslutet.
...
Det här kommandot avslutar avslut av utlösare som kallas ContosoTringen för de angivna händelserna från utlösardefintion genom pipeline.
