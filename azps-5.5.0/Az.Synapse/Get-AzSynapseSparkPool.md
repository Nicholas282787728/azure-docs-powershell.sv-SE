...
ms.locfileid: "100222871"
---
# Get-AzSynapseSparkPool

## SYNOPSIS
Får en Miniatyrpool för Synapse-analys.
...
## BESKRIVNING
Cmdleten **Get-AzSynapseSparkPool** hämtar information om en Azure Synapse Analytics-miniatyrpool.
...
Med det här kommandot får du alla Miniatyr-pooler under en arbetsyta.
...
Det här kommandot får miniatyrpoolen under arbetsytan ContosoWorkspace med namnet ContosoSparkPool.
...
Med det här kommandot får du alla Miniatyr-pooler under en arbetsyta under rörledning.
...
Det här kommandot får miniatyrpoolen med det angivna resurs-ID:t.
