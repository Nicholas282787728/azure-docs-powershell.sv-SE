...
## BESKRIVNING
Cmdleten **Get-AzSynapseRoleDefinition** får en Azure Synapse Analytics-rolldefinition.
Om du inte anger ett rollnamn eller ett roll-ID får den här cmdleten alla rolldefinitioner.
...
Med det här kommandot får du alla rolldefinitioner under en arbetsyta.
...
Det här kommandot får rolldefinitionen under arbetsytan ContosoWorkspace med namnet ContosoRole.
...
Med det här kommandot får du alla rolldefinitioner under en arbetsyta via pipeline.
