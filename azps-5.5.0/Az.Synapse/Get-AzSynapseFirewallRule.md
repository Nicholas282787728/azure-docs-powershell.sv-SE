...
## BESKRIVNING
Cmdleten **Get-AzSynapseFirewallRule** får en Brandväggsregel för Azure Synapse Analytics.
Om du inte anger ett regelnamn får den här cmdleten alla regler.
...
Med det här kommandot hamnar alla brandväggsregler under en arbetsyta.
...
Det här kommandot får brandväggsregeln under arbetsytan ContosoWorkspace med namnet ContosoFirewallRule.
...
Med det här kommandot förs alla brandväggsregler under en arbetsyta via pipeline.
