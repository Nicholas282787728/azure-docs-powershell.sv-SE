...
## BESKRIVNING
Cmdleten **Update-AzSynapseIntegrationRuntimeNode** uppdaterar egenskaper för körningsnod med självvärdig integration i en arbetsyta. Har för närvarande endast stöd för uppdatering av SamtidigAAvgränsning.
...
Värden mellan 1 och maxConcurrent Standardvärden är tillåtna.
