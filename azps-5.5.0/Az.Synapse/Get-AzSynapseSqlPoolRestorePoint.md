...
## BESKRIVNING
Cmdleten **Get-AzSynapseSqlPoolRestorePoint** hämtar de distinkta återställningspunkterna som en Azure Synapse Analytics SQL-pool kan återställas från.
...
Det här kommandot returnerar alla tillgängliga återställningspunkter för SQL-poolen för Azure Synapse Analytics med namnet ContosoSqlPool.
