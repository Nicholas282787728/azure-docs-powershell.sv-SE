...
## BESKRIVNING
Cmdleten **Invoke-AzSynapseIntegrationRuntimeUpgrade** uppgraderar integrering med självvärdig körning om den nya versionen är tillgänglig.
...
Cmdleten uppgraderar integrering med egen värd som heter "test-selfhost-ir" i workspace ContosoWorkspace.
