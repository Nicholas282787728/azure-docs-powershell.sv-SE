...
### RunSpark ParameterParameterSetName (standard)
```
...
### RunSpark ParameterByParentObjectParameterSet
```
...
## BESKRIVNING
Cmdleten **Submit-AzSynapseSpark Ett** Synapse Analytics Spark-jobb skickas.
...
### -CommandLineArgument
Valfria argument till jobbet. t.ex. "--iteration 10000 --timeout 20s"
...
### -Configuration
Få konfigurationsegenskaper att gnistra.
...
### -ExecutorCount
Antalet körbara filer som ska tilldelas i den angivna miniatyrpoolen för jobbet.
...
### -ExecutorSize
Antal kärnor och minne som ska användas för körbara filer som tilldelats i den angivna miniatyrpoolen för jobbet.
...
### -Language
Språket för jobbet som ska skickas.
...
### -MainClassName
Den fullt kvalificerade identifieraren eller huvudklassen som finns i huvuddefinitionsfilen.
Krävs för miniatyrjobb och .NET Spark-jobb.
t.ex. "org.apache.spark.examples.SparkPi"
...
### -MainDefinitionFile
Huvudfilen som används för jobbet.
t.ex. " abfss://filesystem@account.dfs.core.windows.net/mySpark.jar "
...
### -ReferenceFile
Ytterligare filer som används för referens i huvuddefinitionsfilen. Kommaavgränsad lagrings-URI-lista. t.ex. " abfss://filesystem@account.dfs.core.windows.net/file1.txt , abfss://filesystem@account.dfs.core.windows.net/result/ "
