...
### DisableByNameParameterSet (standard)
```
...
## BESKRIVNING
Cmdleten **Disable-AzSynapseSqlAdvancedDataSecurity** inaktiverar Avancerad datasäkerhet på en arbetsyta.
...
Med det här kommandot inaktiveras Avancerad datasäkerhet på arbetsytan ContosoWorkspace.
...
Med det här kommandot inaktiveras Avancerad datasäkerhet på arbetsytan ContosoWorkspace via pipeline.
