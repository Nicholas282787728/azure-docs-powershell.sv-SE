...
## BESKRIVNING
Cmdleten **Set-AzSynapseT azureer** skapar en utlösare i en arbetsyta. Utlösare skapas i läget "Stoppad", vilket innebär att de inte omedelbart börjar starta pipelines som de refererar till.
...
Skapa en ny utlösare som kallas ContosoTspireer i arbetsytan ContosoWorkspace. Utlösaren skapas med statusen Stoppad, vilket innebär att den inte startar direkt. En utlösare kan komma igång med `Start-AzDataFactoryV2Trigger` cmdleten.
...
Skapa en ny utlösare som kallas ContosoTspireer i arbetsytan ContosoWorkspace via pipeline. Utlösaren skapas med statusen Stoppad, vilket innebär att den inte startar direkt. En utlösare kan komma igång med `Start-AzDataFactoryV2Trigger` cmdleten.
...
### Microsoft.Azure.Commands.Synapse.Models.PSTsourceer
