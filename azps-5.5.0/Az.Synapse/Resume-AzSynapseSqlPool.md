...
## BESKRIVNING
Cmdleten **Resume-AzSynapseSqlPool** återupptar en SQL-pool för Azure Synapse Analytics.
...
Det här kommandot återupptar en in pausad SQL-pool för Azure Synapse Analytics.
