...
ms.locfileid: "100253497"
---
# Get-AzSynapseSqlPoolAdvancedThreatProtectionSetting

## SYNOPSIS
Hämtar avancerade inställningar för skydd av hot för en SQL-pool.
...
## BESKRIVNING
Cmdleten **Get-AzSynapseSqlPoolAdvancedThreatProtectionSetting** får de avancerade inställningarna för skydd mot hot i en SQL-pool för Azure Synapse Analytics.
...
Med det här kommandot får du avancerade skyddsinställningar för en SQL-pool med namnet ContosoSqlPool under arbetsytan ContosoWorkspace.
