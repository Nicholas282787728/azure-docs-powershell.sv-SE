...
ms.locfileid: "100252789"
---
# Remove-AzSynapseSqlDatabase

## SYNOPSIS
Tar bort en SQL-databas för Synapse Analytics.
...
Med det här kommandot tas en Azure Synapse Analytics SQL-databas bort.
...
Med det här kommandot tas en Azure Synapse Analytics SQL-databas bort via pipeline.
...
Med det här kommandot tas en Azure Synapse Analytics SQL-databas bort med det angivna resurs-ID:t.
...
### -InputObject
SQL Database-indataobjekt som vanligtvis passerar genom pipelinen.
