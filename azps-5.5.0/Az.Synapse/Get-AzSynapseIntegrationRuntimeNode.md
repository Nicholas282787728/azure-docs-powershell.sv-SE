...
## BESKRIVNING
**Cmdleten Get-AzSynapseIntegrationRuntimeNode** hämtar detaljinformationen för en körningsnod för integrering.
...
Cmdleten hämtar information om noden som heter "Node_1" i körningskörning för självvärdig integrering av test-selfhost-ir i arbetsytan ContosoWorkspace.
...
Cmdleten får information om noden som heter "Node_1" i körningskörning för självvärdig integrering av test-selfhost-ir i workspace "test-df-eu2", inklusive IP-adressen.
