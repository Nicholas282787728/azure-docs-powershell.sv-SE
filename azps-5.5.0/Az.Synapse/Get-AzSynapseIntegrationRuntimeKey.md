...
## BESKRIVNING
Cmdleten **Get-AzSynapseIntegrationRuntimeKey** får nycklar för en integrationskörning. Nycklarna används för att registrera en körningsnod för integrering.
