...
## BESKRIVNING
Cmdleten **Get-AzSynapseIntegrationRuntime** får information om integrationskörningar på en arbetsyta.
Om du anger namnet på en integrationskörning får den här cmdleten information om den integrationskörningen.
Om du inte anger ett namn hämtar den här cmdleten information om alla integrationskörningar i en arbetsyta.
...
Lista alla integrationskörningar i arbetsytan ContosoWorkspace.
...
Det här kommandot visar information om integrationskörningen som heter "test-selfhost-ir" i arbetsytan ContosoWorkspace.
...
Det här kommandot visar detaljerad status om integrationskörningen som heter "test-selfhost-ir" i arbetsytan ContosoWorkspace.
...
### -Status
Detaljerad status för integrationskörningen.
