...
## BESKRIVNING
Cmdleten **Remove-AzSynapseSqlActiveDirectoryAdministrator** tar bort en Azure Active Directory-administratör (Azure AD) för Azure Synapse Analytics Workspace.
...
Det här kommandot tar bort Azure AD-administratören för arbetsytan ContosoWorkspace.
