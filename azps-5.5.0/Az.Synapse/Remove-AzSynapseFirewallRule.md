...
## BESKRIVNING
Cmdleten **Remove-AzSynapseFirewallRule** tar permanent bort en azure Synapse Analytics-brandväggsregel.
...
Det här kommandot tar bort brandväggsregeln contosoFirewallRule under arbetsytan ContosoWorkspace med namnet ContosoFirewallRule.
...
Det här kommandot tar bort brandväggsregeln med namnet ContosoFirewallRule under en arbetsyta via pipeline.
