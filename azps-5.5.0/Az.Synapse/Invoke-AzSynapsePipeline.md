...
## BESKRIVNING
Kommandot **Invoke-AzSynapsePipeline** startar en körning på den angivna pipelinen och returnerar ett ID för den körningen. Detta GUID kan skickas till **Get-AzSynapsePipelineRun** eller **Get-AzSynapseActivityRun** för att få ytterligare information om den här körningen.
...
Det här kommandot startar en körning för pipelinen ContosoPipeline i arbetsytan ContosoWorkspace.
...
Det här kommandot startar en körning för pipeline med namnet ContosoPipeline i arbetsytan ContosoWorkspace via pipeline.
...
### -IsRecovery
Flagga för återställningsläge.
Om återställningsläge är inställt på sant, körs den angivna refererade pipelinen och den nya körningen grupperas under samma groupId.
...
Pipelinen kör ID för kör igen.
Om körnings-ID anges används parametrarna för den angivna körningen för att skapa en ny körning.
...
### -StartActivityName
I återställningsläge startar omkörningen från den här aktiviteten.
