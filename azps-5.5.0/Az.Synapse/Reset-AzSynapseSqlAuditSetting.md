...
## BESKRIVNING
**Cmdleten Reset-AzSynapseSqlAuditSetting** tar bort granskningsinställningarna för en Azure Synapse Analytics-arbetsyta.
...
Det här kommandot tar bort granskningsinställningarna för en Azure Synapse Analytics-arbetsyta med namnet ContosoWorkspace.
...
Det här kommandot tar bort granskningsinställningarna för en Azure Synapse Analytics-arbetsyta med namnet ContosoWorkspace via pipeline.
