...
## BESKRIVNING
Cmdleten **New-AzSynapseSparkPool** skapar en Azure Synapse Analytics-miniatyrpool.
...
Med det här kommandot skapas en miniatyrpool för Azure Synapse-analys.
...
Med det här kommandot skapas en miniatyrpool för Azure Synapse-analys med automatisk skalning aktiverat.
...
Med det här kommandot skapas en azure Synapse Analytics-miniatyrpool via pipeline.
...
Med det här kommandot skapas en miniatyrpool för Azure Synapse-analys med automatisk skalning aktiverat i pipeline.
