...
## BESKRIVNING
Den Get-AzSynapseSqlPoolSensitivityRecommendation cmdleten returnerar de rekommenderade informationstyperna och känslighetsetiketterna för kolumner i SQL-poolen.

## EXEMPEL

### Exempel 1: Hämta rekommenderade informationstyper och känslighetsetiketter för en Azure Synapse SQL-pool.
```powershell
...
### Exempel 2: Hämta rekommenderade informationstyper och känslighetsetiketter för en Azure Synapse SQL-pool med Piping.
```powershell
