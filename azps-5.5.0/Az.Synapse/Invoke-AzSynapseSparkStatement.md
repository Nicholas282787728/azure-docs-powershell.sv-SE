...
## BESKRIVNING
**Invoke-AzSynapseSparkStatement-cmdleten** anropar en Synapse Analytics Spark-instruktion.
...
Dessa kommandon startar en miniatyrsession och anropar sedan ett direkt miniatyrdiagram via pipeline.
...
Dessa kommandon startar en miniatyrsession och anropar sedan ett direkt miniatyrdiagram.
...
Dessa kommandon startar en miniatyrsession och anropar sedan Miniatyr-uttryck i en fil.
...
### -FilePath
Anger en lokal sökväg som innehåller körningskoden.
