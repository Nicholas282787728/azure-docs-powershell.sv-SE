...
## BESKRIVNING
Cmdleten **Get-AzSynapseSparkStatement** hämtar information om en Azure Synapse Analytics Spark-instruktion.
...
Det här kommandot får alla Miniatyr-uttryck under en miniatyrsession.
...
Det här kommandot får miniatyrutdraget med det angivna livy-ID:t.
...
Med det här kommandot får du alla Miniatyr-uttryck under en miniatyrsession via pipeline.
...
### -LivyId
Identifierare för Miniatyr-uttrycket.
