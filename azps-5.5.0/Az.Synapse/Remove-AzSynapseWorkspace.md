...
## BESKRIVNING
Cmdleten **Remove-AzSynapseWorkspace** tar bort en Azure Synapse-analysarbetsyta permanent.
...
Det här kommandot tar bort en arbetsyta för Azure Synapse-analys.
...
Med det här kommandot tas en arbetsyta för Azure Synapse Analytics bort via pipeline.
...
Det här kommandot tar bort en arbetsyta i Azure Synapse Analytics via pipeline med det angivna resurs-ID:t.
