...
## BESKRIVNING
Cmdleten **Update-AzSynapseSqlPoolAdvancedThreatProtectionSetting** ställer in en avancerad säkerhetsinställning för hot på en SQL-pool för Azure Synapse Analytics.
För att kunna aktivera avancerat skydd för en SQL-pool måste en granskningsinställning vara aktiverad på den SQL-poolen.
...
Det här kommandot anger avancerade skyddsinställningar för en SQL-pool med namnet ContosoSqlPool under arbetsytan ContosoWorkspace.
...
### -EmailAdmin
Definierar om e-postadministratörer ska kunna göra det.
...
Identifieringstyper som ska undantas.
...
Ett semikolonavgränsat antal e-postadresser som aviseringarna ska skickas till.
