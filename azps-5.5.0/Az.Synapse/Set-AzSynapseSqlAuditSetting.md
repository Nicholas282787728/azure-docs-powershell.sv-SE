...
## BESKRIVNING
**Cmdleten Set-AzSynapseSqlAuditSetting** ändrar granskningsinställningarna för en Azure Synapse Analytics-arbetsyta.
...
Aktivera principen för blob-lagringsgranskning i en Azure Synapse Analytics-arbetsyta med namnet ContosoWorkspace.
...
Inaktivera principen för blob-lagringsgranskning för en Azure Synapse Analytics-arbetsyta med namnet ContosoWorkspace.
...
Aktivera principen för blob-lagringsgranskning i en Azure Synapse Analytics-arbetsyta med namnet ContosoWorkspace med avancerad filtrering med ett predikat för T-SQL.
...
Ta bort den avancerade filtreringsinställningen från granskningsprincipen för en Azure Synapse Analytics-arbetsyta med namnet ContosoWorkspace.
...
Inaktivera principen för blob-lagringsgranskning för en Azure Synapse Analytics-arbetsyta med namnet ContosoWorkspace via pipeline.
...
De här grupperna omfattar alla SQL-uttryck och lagrade procedurer som körs mot databasen och ska inte användas i kombination med andra grupper eftersom det leder till dubbletter av granskningsloggar.
