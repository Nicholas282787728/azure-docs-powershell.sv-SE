...
ms.locfileid: "100216823"
---
# New-AzSynapseSqlDatabase

## SYNOPSIS
Skapar en SQL-databas för Synapse Analytics.
...
Med det här kommandot skapas en Azure Synapse Analytics SQL-databas.
...
### -Collation
Sortering definierar de regler som sorterar och jämför data och kan inte ändras när SQL-pool har skapats.
Standardin collation är SQL_Latin1_General_CP1_CI_AS.
