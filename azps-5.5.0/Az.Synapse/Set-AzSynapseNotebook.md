...
## BESKRIVNING
Cmdleten **Set-AzSynapseNotebook** skapar eller uppdaterar en anteckningsbok i en arbetsyta.
...
Med det här kommandot skapas eller uppdateras en anteckningsbok från notebook file notebook.ipynb i arbetsytan ContosoWorkspace.
...
Med det här kommandot skapas eller uppdateras en anteckningsbok från notebook file notebook.ipynb i arbetsytan ContosoWorkspace via pipeline.
...
Med det här kommandot skapas eller uppdateras en anteckningsbok från notebook file notebook.ipynb som bifogas till ContosoSparkPool och använder 2 körbara filer i arbetsytan ContosoWorkspace.
