...
### WaitSpark EttaByIdParameterSet (standard)
```
...
## BESKRIVNING
Cmdleten **Wait-AzSynapseSpark En** cmdlet väntar på att ett Azure Synapse-analysjobb ska slutföras.
...
Det här kommandot väntar på att jobbet med det angivna ID:t ska slutföras.
...
### -TimeoutInSeconds
Den maximala tid som ska vänta innan du felar ut. Standardvärdet är att ingen tidsgräns används.
...
Avsökningsintervallet mellan kontroller för jobbstatus, i sekunder.
