...
Det här kommandot får alla miniatyrsessioner under den angivna miniatyrpoolen.
...
Det här kommandot får sparksessionen med det angivna livy-ID:t.
...
Det här kommandot får alla miniatyrsessioner under den angivna miniatyrpoolen via pipeline.
