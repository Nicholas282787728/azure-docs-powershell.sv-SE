...
## BESKRIVNING
Cmdleten **Remove-AzSynapseDataFlow** tar bort ett dataflöde från arbetsytan.
...
Det här kommandot tar bort dataflödet ContosoDataFlow från arbetsytan ContosoWorkspace.
