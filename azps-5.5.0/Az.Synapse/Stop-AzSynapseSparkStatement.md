...
## BESKRIVNING
**Cmdleten Stop-AzSynapseSparkStatement** avbryter en Synapse Analytics Spark-instruktion.
...
Det här kommandot avbryter miniatyrutdraget med det angivna livy-ID:t.
...
Det här kommandot avbryter miniatyrutdraget med det angivna livy-ID:t via pipeline.
...
### -LivyId
Identifierare för miniatyrdiagramsatsen.
...
### -SessionId
Identifierare för miniatyrsession.
