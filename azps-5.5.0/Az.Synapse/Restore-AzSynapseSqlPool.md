...
## BESKRIVNING
Cmdleten **Restore-AzSynapseSqlPool** återställer en Azure Synapse Analytics SQL-pool från en säkerhetskopia eller en återställningspunkt i en SQL-pool.
...
Med det här kommandot skapas en AZURE Synapse Analytics SQL-pool genom att återställa från den senaste säkerhetskopian av en SQL-pool i den här prenumerationen.
...
Det här kommandot skapar en SQL-pool för Azure Synapse Analytics genom att dra nytta av en återställningspunkt från en SQL-pool i den här prenumerationen för att återställa eller kopiera från ett tidigare tillstånd.
...
Med det här kommandot skapas en AZURE Synapse Analytics SQL-pool genom att återställa från den senaste säkerhetskopian av en SQL-pool i den här prenumerationen med resurs-ID.
...
Det här kommandot skapar en SQL-pool för Azure Synapse Analytics genom att dra nytta av en återställningspunkt från en SQL-pool i den här prenumerationen för att återställa eller kopiera från ett tidigare tillstånd med resurs-ID.
...
### -FromBackup
Anger att du vill återställa från den senaste säkerhetskopian av en SQL-pool i den här prenumerationen.
...
### -FromRestorePoint
Anger att du vill utnyttja en återställningspunkt från en SQL-pool i den här prenumerationen för att återställa eller kopiera från ett tidigare tillstånd.
...
### -ResourceId
Resurs-ID för databasen som ska återställas.
...
### -RestorePoint
Ögonblicksbild av tiden att återställa.
