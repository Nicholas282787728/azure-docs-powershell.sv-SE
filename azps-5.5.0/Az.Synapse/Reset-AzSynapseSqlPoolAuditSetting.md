...
## BESKRIVNING
Cmdleten **Reset-AzSynapseSqlPoolAuditSetting** tar bort granskningsinställningarna för en SQL-pool med Azure Synapse Analytics.
...
Det här kommandot tar bort granskningsinställningarna för en SQL-pool med namnet ContosoSqlPool i arbetsytan ContosoWorkspace.
...
Det här kommandot tar bort granskningsinställningarna för en SQL-pool med namnet ContosoSqlPool i arbetsytan ContosoWorkspace via pipeline.
