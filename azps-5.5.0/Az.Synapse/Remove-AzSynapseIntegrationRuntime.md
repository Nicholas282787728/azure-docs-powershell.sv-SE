...
## BESKRIVNING
**Cmdleten Remove-AzSynapseIntegrationRuntime** tar bort en integrationskörning.
...
Det här kommandot tar bort integrationskörningen med namnet "test-reserved-ir" från arbetsytan ContosoWorkspace.
