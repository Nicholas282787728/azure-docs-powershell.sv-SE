...
## BESKRIVNING
Cmdleten **Suspend-AzSynapseSqlPool** stänger av en SQL-pool för Azure Synapse Analytics.
...
Det här kommandot stänger av en aktiv SQL-pool för Azure Synapse Analytics.
