...
## BESKRIVNING
Med Set-AzSynapseSqlPoolSensitivityClassification-cmdleten anges informationstyper och känslighetsetiketter för kolumner i SQL-poolen.

## EXEMPEL

### Exempel 1: Ange informationstyp och känslighetsetikett för en kolumn i en Azure Synapse SQL-pool.
```powershell
...
### Exempel 2: Ange rekommenderade informationstyper och känslighetsetiketter för kolumner i en Azure Synapse SQL-pool.
```powershell
...
### Exempel 3: Ange informationstyp och känslighetsetikett för en kolumn i en Azure Synapse SQL-pool med hjälp av rörning.
```powershell
