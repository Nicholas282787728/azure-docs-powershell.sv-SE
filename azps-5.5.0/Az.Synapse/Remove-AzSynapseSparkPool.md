...
## BESKRIVNING
Cmdleten **Remove-AzSynapseSparkPool** tar permanent bort en Azure Synapse Analytics-miniatyrpool.
...
Det här kommandot tar bort en miniatyrpool för Azure Synapse-analys.
...
Det här kommandot tar bort en miniatyrpool för Azure Synapse-analys via pipeline.
...
Det här kommandot tar bort en miniatyrpool för Azure Synapse-analys med ett resurs-ID.
...
### -ResourceId
Resursidentifierare för Synapse-miniatyrpoolen.
