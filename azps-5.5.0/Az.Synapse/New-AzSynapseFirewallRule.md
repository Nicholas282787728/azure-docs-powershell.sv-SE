...
Med det här kommandot skapas brandväggsregeln ContosoFirewallRule under arbetsytan ContosoWorkspace med namnet ContosoFirewallRule.
...
Med det här kommandot skapas brandväggsregeln ContosoFirewallRule under en arbetsyta via pipeline.
...
Det här kommandot skapar brandväggsregel som tillåter alla Azure IP-adresser under en arbetsyta.

## PARAMETERS

### -AllowAllAzureIP
Skapar en särskild brandväggsregel som tillåter att alla Azure-IP:er har åtkomst.
...
### -EndIpAddress
Brandväggsregelns slut-IP-adress.
...
### -Name
Namnet på firerwall-regeln för arbetsytan.
...
### -StartIpAddress
Ip-adressen för brandväggsregelns startadress.
Måste vara IPv4-format.
