...
## BESKRIVNING
Cmdleten **Add-AzSynapseTskriptionSubscription** prenumererar på händelseutlösaren på angivna externa tjänsthändelser från avslutsutlösaren.
...
Det här kommandot prenumererar utlösare som kallas ContosoTkommandot för de angivna händelserna från avslutsutlösaren.
...
Det här kommandot prenumererar utlösare som kallas ContosoTkommandot för de angivna händelserna från utlösardefintion genom pipeline.
