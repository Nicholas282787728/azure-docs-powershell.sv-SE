...
## BESKRIVNING
Cmdleten **Update-AzSynapseSqlAdvancedThreatProtectionSetting** uppdaterar en avancerad säkerhetsinställning för hot på en Azure Synapse Analytics-arbetsyta. För att kunna aktivera avancerat skydd på en arbetsyta måste granskningsinställningar vara aktiverade på den arbetsytan.
...
Det här kommandot uppdaterar avancerade skyddsinställningar för en arbetsyta med namnet ContosoWorkspace.
