...
## BESKRIVNING
Cmdleten **Remove-AzSynapseDataset** tar bort en datauppsättning från arbetsytan.
...
Med det här kommandot tas datauppsättningen ContosoDataset bort från arbetsytan ContosoWorkspace.
