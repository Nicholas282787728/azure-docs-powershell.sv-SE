...
## BESKRIVNING
**Cmdleten Update-AzSynapseFirewallRule** ändrar en brandväggsregel för Azure Synapse Analytics.
...
Det här kommandot uppdaterar brandväggsregeln med namnet ContosoFirewallRule under arbetsytan ContosoWorkspace med namnet ContosoFirewallRule.
...
Det här kommandot uppdaterar brandväggsregeln med namnet ContosoFirewallRule under en arbetsyta via pipeline.
