...
## BESKRIVNING
Med Enable-AzSynapseSqlPoolSensitivityRecommendation-cmdleten kan du rekommendera känslighet för kolumner i SQL-poolen.

## EXEMPEL

### Exempel 1: Aktivera känslighetsrekommendationer för en viss kolumn i en Azure Synapse SQL-pool.
```powershell
...
### Exempel 2: Aktivera känslighetsrekommendationer för en viss kolumn i Azure Synapse SQL-pool med Piping.
```powershell
...
### -InputObject
Ett objekt som representerar en SQL-poolkänslighetsklassificering.
