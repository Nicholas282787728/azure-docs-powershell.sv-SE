...
### NewByWorkspaceNameAndServiceServicePrincipalNameParameterSet
```
...
## BESKRIVNING
Cmdleten **New-AzSynapseRoleAssignment** skapar en azure Synapse Analytics-rolltilldelning.
...
Det här kommandot tilldelar ContosoRole till användaren vars huvudnamn är ContosoName.
...
Det här kommandot tilldelar ContosoRole till användaren vars huvudnamn är ContosoName via pipeline.
