...
## BESKRIVNING
Cmdleten **Remove-AzSynapseSqlPoolRestorePoint** tar permanent bort en azure Synapse Analytics SQL-poolåterställningspunkt.
...
Det här kommandot tar bort en återställningspunkt i Azure Synapse Analytics SQL-pool.
...
Det här kommandot tar bort en azure Synapse Analytics SQL-pool med återställningspunkt genom pipeline.
...
Med det här kommandot tas en återställningspunkt för Azure Synapse Analytics SQL-pool bort med det angivna resurs-ID:t.
...
### -InputObject
Tidsobjekt för att skapa en SQL-poolåterställningspunkt, vanligtvis genom pipelinen.
...
Namn på Synapse SQL Restore Point Creation Date.
...
### -SqlPoolObject
Sql Pool-inmatningsobjekt som vanligtvis passerar genom pipelinen.
