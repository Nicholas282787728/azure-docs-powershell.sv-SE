...
## BESKRIVNING
**Cmdleten Start-AzSynapseT azure- eller** Windows-klickar på en utlösare i en arbetsyta. Om utlösaren är i läget "Stoppad" startar cmdleten utlösaren och så småningom anropar den pipelines baserat på dess definition. Om utlösaren redan är i läget "Startad" har den här cmdleten ingen effekt.
...
Startar en utlösare med namnet ContosoT groove på arbetsytan ContosoWorkspace.
...
Startar en utlösare med namnet ContosoT groove på arbetsytan ContosoWorkspace via pipeline.
