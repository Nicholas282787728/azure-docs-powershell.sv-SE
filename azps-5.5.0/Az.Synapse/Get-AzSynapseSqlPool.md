...
## BESKRIVNING
Cmdleten **Get-AzSynapseSqlPool** hämtar information om en SQL-pool för Azure Synapse Analytics.
...
Med det här kommandot får du alla SQL-pooler under en arbetsyta.
...
Med det här kommandot hamnar SQL-poolen under arbetsytan ContosoWorkspace med namnet ContosoSqlPool.
...
Med det här kommandot får du alla SQL-pooler under en arbetsyta via pipeline.
...
Det här kommandot får SQL-poolen med det angivna resurs-ID:t.
...
### -Version
[Den här funktionen är i en begränsad förhandsversion, som först bara är tillgänglig för vissa prenumerationer.] Version av Synapse SQL-pool. Till exempel 2 eller 3.
