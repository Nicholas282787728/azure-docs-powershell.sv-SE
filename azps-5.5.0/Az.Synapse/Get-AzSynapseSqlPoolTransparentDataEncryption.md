...
## BESKRIVNING
Cmdleten **Get-AzSynapseSqlPoolTransparentDataEncryption** får statusen Transparent Data Encryption (TDE) för en AZURE Synapse Analytics SQL-pool.
...
Det här kommandot får statusen för TDE för SQL-poolen ContosoSqlPool under arbetsytan ContosoWorkspace.
