...
## BESKRIVNING
Cmdleten **Reset-AzSynapseSqlAdvancedThreatProtectionSetting** tar bort de avancerade inställningarna för skydd mot hot från en Azure Synapse Analytics-arbetsyta.
...
Det här kommandot tar bort avancerade inställningar för skydd mot hot från en arbetsyta med namnet ContosoWorkspace.
