...
## BESKRIVNING
Med Remove-AzSynapseSqlPoolSensitivityClassification cmdleten tas informationstyper och känslighetsetiketter för kolumner i SQL-poolen bort.

## EXEMPEL

### Exempel 1: Ta bort informationstyp och känslighetsetikett för en kolumn i en Azure Synapse SQL-pool.
```powershell
...
### Exempel 2: Ta bort aktuella informationstyper och känslighetsetiketter för kolumner i en Azure Synapse SQL-pool med Piping.
```powershell
...
### Exempel 3: Ta bort informationstyp och känslighetsetikett för en kolumn i en Azure Synapse SQL-pool med Piping.
```powershell
