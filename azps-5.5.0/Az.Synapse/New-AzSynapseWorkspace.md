...
Med det här kommandot skapas en Synapse-analysarbetsyta med namnet ContosoWorkspace som använder ContosoAdlGenStorage Data Store i resursgruppen ContosoResourceGroup.
...
Standardnamnet för lagringskontot ADLS Gen2.
...
### -Plats
Azure-region där resursen ska skapas.
...
Namn på ett virtuellt Synapse-nätverk som är avsett för Azure Synapse-arbetsytan.
...
Autentiseringsuppgifter som SQL-administratör.
