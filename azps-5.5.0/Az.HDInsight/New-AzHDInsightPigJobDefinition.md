...
## BESKRIVNING
**Cmdleten New-AzHDInsightPigDefinition definierar** ett Jobobjekt som kan användas med ett Azure HDInsight-kluster.

## EXEMPEL

### Exempel 1: Skapa en definition för ett jobb
```
PS C:\># Cluster info
...
Det här kommandot skapar en Definition för En Job-jobb.
...
### -Query
Anger frågedesignen för frågedesignen.
...
### Microsoft.Azure.Commands.HDInsight.Models.AzureHDInsightPigDefinition
