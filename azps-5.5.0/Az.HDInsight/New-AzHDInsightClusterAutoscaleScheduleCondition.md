...
## BESKRIVNING
**Cmdleten New-AzHDInsightClusterAutoscaleScheduleCondition** skapar schemabaserat villkor för automatisk skalning.
...
Det här kommandot skapar ett villkor där grupper med automatisk skalning till 5 arbetsnoder klockan 09:00 varje måndag, onsdag.

### Exempel 2: Aktivera schemabaserad automatisk skalning av ett kluster med villkor för automatisk skalning.
```powershell
...
### -Dag
Hämtar eller anger dagarna för schemavillkor för automatisk skalning.
...
### -Tid
Hämtar eller anger tiden för schemavillkor för automatisk skalning.
...
### -WorkerNodeCount
Hämtar eller anger antalet anställda i schemat för schema med automatisk skalning.
