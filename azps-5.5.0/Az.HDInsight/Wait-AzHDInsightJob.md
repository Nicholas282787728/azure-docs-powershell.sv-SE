...
## BESKRIVNING
Cmdleten **Wait-AzHDInsight En** cmdlet väntar på att ett Azure HDInsight-jobb slutförs eller misslyckas.

## EXEMPEL

### Exempel 1: Vänta tills ett jobb har slutförts eller misslyckats
```
PS C:\># Cluster info
...
Det här kommandot väntar på slutförande eller fel för ett jobb.
...
### -TimeoutInSeconds
Den totala tiden som ska vänta på slutförande av jobbet, i sekunder.
...
Den tid det tar att vänta mellan jobbstatuskontrollerna i sekunder.
