...
## BESKRIVNING
Säkerhetsprofilen används för att skapa ett säkert kluster genom att kerbera det.
Säkerhetsprofilen innehåller konfigurationsrelaterad anslutning till klustret i Active Directory-domänen.

## EXEMPEL

### Exempel 1: Lägga till en säkerhetsprofil i klusterkonfigurationsobjektet
```
...
Det här kommandot lägger till ett värde för säkerhetsprofilen i klustret med namnet ditt-hadoop-001.

## PARAMETERS

### -ClusterUsersGroupDNs
Unika namn på Active Directory-grupper som blir tillgängliga i Ambari och Ranger
...
### -DomainResourceId
Active Directory-domänresurs-ID för klustret.
...
En autentiseringsbehörighet för domänanvändarkonto med tillräcklig behörighet för att skapa klustret.
Användarnamnet ska vara i user@domain format
...
### -LdapsUrls
URL:er för en eller flera LDAPS-servrar för Active Directory
...
Unikt namn på organisationsenheten i Active Directory där användar- och datorkonton skapas
