...
## BESKRIVNING
Cmdleten **Set-AzHDInsightGatewayCredential** anger gateway credential för ett Azure HDInsight-kluster.
...
Det här kommandot anger gateway-autentiseringsuppgifter för klustret med namnet namnparameteruppsättningen ditt-hadoop-001.
...
Det här kommandot anger gateway-autentiseringsuppgifter för klustret med parameteruppsättningen your-hadoop-001 by ResourceId.
...
Det här kommandot anger gateway credential för klustret med namnet your-hadoop-001 av InputObject-parameteruppsättningen.
...
### -httpCredential
Hämtar eller anger inloggningen för klusteranvändaren.
