...
## BESKRIVNING
**Cmdleten New-AzHDInsightMapReduce Endefinition** definierar ett nytt MapReduce-jobb som ska användas med ett Azure HDInsight-kluster.
...
### -JarFile
Anger den JAR-fil som ska användas för jobbet.
...
### Microsoft.Azure.Commands.HDInsight.Models.AzureHDInsightMapReduceDefinition
