...
## BESKRIVNING
Cmdleten **Get-AzHDInsightClusterAutoscaleConfiguration** får automatisk skalkonfiguration av HDInsight-kluster.

## EXEMPEL

### Exempel 1: Hämta automatisk skalkonfiguration av HDInsight-kluster.
```powershell
...
Det här kommandot får automatisk skalkonfiguration för HDInsight-kluster.
