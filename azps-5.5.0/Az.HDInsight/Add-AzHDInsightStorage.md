...
## BESKRIVNING
Cmdleten **Add-AzHDInsightStorage** lägger till en post för ett Azure Storage-konto i konfigurationsobjektet Azure HDInsight som skapas av cmdleten New-AzHDInsightClusterConfig Azure HDInsight.

## EXEMPEL

### Exempel 1: Lägga till en Azure-lagringsnyckel i klusterkonfigurationsobjektet
```
...
Det här kommandot lägger till en blob-lagringskontopost i HDInsight-konfigurationen med namnet ditt-hadoop-001.
...
### -StorageAccountKey
Anger lagringskontonyckeln för lagringskontot som ska läggas till i det nya klustret.
...
### -StorageAccountName
Anger lagringskontonamnet för lagringskontot som ska läggas till i klustret.
