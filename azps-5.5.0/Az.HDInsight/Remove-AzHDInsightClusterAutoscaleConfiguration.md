...
## BESKRIVNING
Cmdleten **Remove-AzHDInsightClusterAutoscaleConfiguration** tar bort konfigurationen av automatisk skalning av HDInsight-klustret.

## EXEMPEL

### Exempel 1: Ta bort automatisk skalkonfiguration för HDInsight-kluster.
```powershell
...
Det här kommandot tar bort automatisk skalkonfiguration för HDInsight-klustret.
