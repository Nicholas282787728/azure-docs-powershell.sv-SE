...
## BESKRIVNING
Cmdleten **New-AzHDInsightClusterConfig** skapar ett objekt som inte finns kvar och beskriver en Konfiguration av Azure HDInsight-kluster.
...
### -EncryptionAtHost
Hämtar eller anger flaggan som anger om du vill aktivera kryptering på värdnivå eller inte.
...
### -MetaMetastore
Anger metastore som ska lagra metadata för metadata om metadata för arkivet.
...
### -OonéMetastore
Anger vilken metastore som ska lagra Oo metadata.
...
Hämtar eller anger resurs-ID för lagringskonto.
...
### -StorageAccountType
Hämtar eller anger typ av standardlagringskonto.
...
### -KeeperNodeSize
Anger storleken på den virtuella datorn för tidevaktnoden.
Använd Get-AzVMSize för godtagbara storlekar för virtuella maskiner och se HDInsights prissida.
