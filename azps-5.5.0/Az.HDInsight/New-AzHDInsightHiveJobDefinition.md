...
## BESKRIVNING
**Cmdleten New-AzHDInsightHiveRunDefinition** definierar ett Registreringsjobbobjekt som ska användas med ett Azure HDInsight-kluster.

## EXEMPEL

### Exempel 1: Skapa en definition för registreringsjobb
```
PS C:\># Cluster info
...
Det här kommandot skapar en definition för en registreringsjobb.
...
### -Definierar
Anger de Hadoop-konfigurationsvärden som ska anges när jobbet körs.
...
### -Arkiv
Anger sökvägen till en fil som innehåller frågan som ska köras.
Filen måste vara tillgänglig på det lagringskonto som är kopplat till klustret.
...
### -Files
Anger en samling filer som är associerade med ett platsjobb.
...
Du kan använda den här funktionen för att hantera specialtecken som procenttecken (%) det skulle misslyckas när ett jobb skickas in via Templeton, eftersom Templeton tolkar en fråga med ett procenttecken som URL-parameter.
...
### Microsoft.Azure.Commands.HDInsight.Models.AzureHDInsightHiveDefinition
