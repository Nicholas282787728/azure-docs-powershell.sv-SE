...
## BESKRIVNING
Cmdleten **Start-AzHDInsight En** cmdlet startar ett definierat Azure HDInsight-jobb på ett angivet kluster.
Det här kan vara ett MapReduce-jobb, ett Streaming MapReduce-jobb, ett Jobb på jobbet, eller ett Jobbjobb.

## EXEMPEL

### Exempel 1: Starta ett jobb på det angivna klustret
```
PS C:\># Cluster info
...
Det här kommandot startar ett jobb i klustret med namnet ditt-hadoop-001.
...
### -Jobbdefinition
Anger jobbet som ska börja på Azure HDInsight-klustret.
...
### Microsoft.Azure.Commands.HDInsight.Models.AzureHDInsightDefinition
