...
## BESKRIVNING
**Cmdleten New-AzHDInsightStreamingMapReduce Endlet** definierar ett Streaming MapReduce-jobbobjekt som ska användas med ett Azure HDInsight-kluster.

## EXEMPEL

### Exempel 1: Skapa en streaming MapReduce-jobbdefinition
```
PS C:\># Cluster info
...
Det här kommandot skapar en jobdefinition för Streaming MapReduce.
...
### -CommandEnvironment
Anger en matris med kommandoradsbaserade miljövariabler som ska anges när ett jobb körs på arbetsnoder.
...
### Microsoft.Azure.Commands.HDInsight.Models.AzureHDInsightStreamingMapReduceDefinition
