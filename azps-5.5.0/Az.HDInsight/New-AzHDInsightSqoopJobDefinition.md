...
## BESKRIVNING
**Cmdleten New-AzHDInsightSqoopDefinition definierar** ett Sqoop-jobbobjekt som ska användas med ett Azure HDInsight-kluster.

## EXEMPEL

### Exempel 1: Skapa en sqoop-jobbdefinition
```
PS C:\># Cluster info
...
Det här kommandot skapar en Sqoop-jobdefinition.

## PARAMETERS

### -Kommando
Anger Sqoop-kommandot.
...
### -LibDir
Anger bibliotekskatalogen för Sqoop-jobbet.
...
### Microsoft.Azure.Commands.HDInsight.Models.AzureHDInsightSqoopDefinition
