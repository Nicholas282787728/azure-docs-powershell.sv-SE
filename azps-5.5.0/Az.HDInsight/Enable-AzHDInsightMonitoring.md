...
## BESKRIVNING
**Cmdleten Enable-AzHDInsightMonitoring** möjliggör övervakning i ett Azure HDInsight-kluster.
...
Övervakning aktiveras i HDInsight-klustret och relevanta loggar skickas till övervakningsarbetsytan med id 1d364e89-bb71-4503-aa3d-a23535aea7bd
...
### -PrimaryKey
Huvudnyckeln för arbetsytan för övervakning.
