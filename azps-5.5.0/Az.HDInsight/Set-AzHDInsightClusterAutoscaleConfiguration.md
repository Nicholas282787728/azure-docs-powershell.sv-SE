...
## BESKRIVNING
Denna cmdlet **Set-AzHDInsightClusterAutoscaleConfiguration** anger automatisk skalkonfiguration av ett Azure HDInsight-kluster.

## EXEMPEL

### Exempel 1: Ange den belastningsbaserade automatisk skalkonfigurationen av HDInsight-kluster
```powershell
...
Det här kommandot anger den belastningsbaserade konfigurationen av automatisk skalning av ett Azure HDInsight-kluster.

### Exempel 2: Ange den schemabaserade autoskalan för HDInsight-kluster
```powershell
...
Det här kommandot anger den schemabaserade konfigurationen av automatisk skalning av HDInsight-klustret.

### Exempel 3: Ange automatisk skalkonfiguration för HDInsight-kluster som baseras på ett annat kluster som har ställt in automatisk skalkonfiguration
```powershell
...
Det här kommandot anger automatisk skalkonfiguration för HDInsight-kluster som baseras på ett annat kluster.
...
### -Villkor
Hämtar eller anger villkoret för schemabaserad automatisk skala.
...
### -InputObject
Hämtar eller anger inmatningsobjektet.
