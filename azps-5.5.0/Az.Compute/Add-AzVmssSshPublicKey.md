...
## BESKRIVNING
Cmdleten **Add-AzVmssSshPublicKey** lägger till offentliga nycklar som du kan använda för att ansluta till virtuella maskiner i Virtual Machine Scale Set (VMSS) via SSH (Secure Shell).

## EXEMPEL

### Exempel 1: Lägga till en offentlig SSH-nyckel i VMSS
```
...
Det här exemplet lägger till en offentlig SSH-nyckel till VMSS.
...
Det andra kommandot lägger till en SSH-nyckel med angivna nyckeldata och lagrar nyckeln på den angivna sökvägen på den virtuella datorn.
...
### -KeyData
Anger en offentlig SSH RSA-nyckeldata.
