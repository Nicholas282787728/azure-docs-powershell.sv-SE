...
## BESKRIVNING
Cmdleten **Add-AzImageDataDisk** lägger till en datadisk till ett bildobjekt.
...
Följande tre kommandon tilldelar sökvägar för operativsystemskiva och två datadiskar till variablerna $osDiskVhdUri, $dataDiskVhdUri 1 och $dataDiskVhdUri 2.
Den här metoden är endast läsbar för följande kommandon.
De följande tre kommandona lägger till en operativsystemskiva och två datadiskar till bilden som lagras i $imageConfig.
...
### -BlobUri
Anger länken, som en URI, för blob.
...
### -Cachelagring
Anger hårddiskens cachelagringsläge.
...
### -DiskSizeGB
Anger hårddiskens storlek i GIGABYTE (GB).
...
### -StorageAccountType
Lagringskontotyp för databilddisken
