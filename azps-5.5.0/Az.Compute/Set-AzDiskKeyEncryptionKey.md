...
ms.locfileid: "100233270"
---
# Set-AzDiskKeyEncryptionKey

## SYNOPSIS
Anger nyckelkrypteringsnyckelegenskaperna för ett diskobjekt.
...
## BESKRIVNING
Cmdleten **Set-AzDiskKeyEncryptionKey** anger egenskaper för krypteringsnyckeln för ett diskobjekt.
...
Med det första kommandot skapas ett lokalt tomt diskobjekt med en storlek på 5 GB Standard_LRS en lagringskontotyp.  Den ställer också in Windows OS-typ och aktiverar krypteringsinställningar.
Andra och tredje kommandona anger inställningarna för diskkrypteringsnyckeln och nyckelkrypteringsnyckeln för diskobjektet.
Det senaste kommandot tar diskobjektet och skapar en disk med namnet 'Disk01' i resursgruppen 'ResourceGroup01'.
