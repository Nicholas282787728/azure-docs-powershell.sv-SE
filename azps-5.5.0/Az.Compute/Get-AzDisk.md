...
Det här kommandot får egenskaperna för disken med namnet 'Disk01' i resursgruppen 'ResourceGroup01'.
...
Med det här kommandot får du egenskaperna för alla diskar i resursgruppen Resursgrupp01.
...
Det här kommandot hämtar egenskaperna för alla diskar under prenumerationen.
...
Det här kommandot hämtar egenskaperna för alla diskar under prenumerationsnamnet med början från win1_OsDisk.
