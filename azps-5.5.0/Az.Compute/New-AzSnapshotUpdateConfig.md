...
## BESKRIVNING
**Cmdleten New-AzSnapshotUpdateConfig** skapar ett konfigurerbart ögonblicksbildsuppdateringsobjekt.
...
Det första kommandot skapar ett lokalt tomt ögonblicksbildsuppdateringsobjekt med storlek 10 GB Premium_LRS lagringskontotyp. Den ställer också in Windows OS-typ och aktiverar krypteringsinställningar. Andra och tredje kommandona ställer in inställningarna för diskkrypteringsnyckeln och nyckelkrypteringsnyckeln för ögonblicksbilden av uppdateringsobjektet. Det senaste kommandot tar ögonblicksbilden av uppdateringsobjektet och uppdaterar en befintlig ögonblicksbild med namnet Ögonblicksbild01 i resursgruppen Resursgrupp01.
