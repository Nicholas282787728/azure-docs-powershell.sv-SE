...
## BESKRIVNING
Cmdleten **Add-AzVmssDiagnosticsExtension** lägger till ett diagnostiktillägg till instansen Virtual Machine Scale Set (VMSS).

## EXEMPEL

### Exempel 1: Lägg till ett diagnostiktillägg till VMSS
```
PS C:\> Add-AzVmssDiagnosticsExtension -VirtualMachineScaleSet $VMSS -SettingFilePath $publicConfigPath -ProtectedSettingFilePath $privateConfigPath -Name $extName -TypeHandlerVersion $typeVersion -AutoUpgradeMinorVersion $True -Force
```

Det här kommandot lägger till ett diagnostiktillägg till VMSS.
...
Anger sökvägen till den privata konfigurationsfilen.
...
### -SettingFilePath
Anger sökvägen till den offentliga konfigurationsfilen.
...
### -TypeHandlerVersion
Anger versionen av tillägget som ska användas för den här VMSS.
Om du vill hämta versionen kör du cmdleten [Get-AzVMExtensionImage](./Get-AzVMExtensionImage.md) med värdet Microsoft.Azure.Diagnostics för *parametern PublisherName* och IaaSDiagnostics för parametern *Type.*
