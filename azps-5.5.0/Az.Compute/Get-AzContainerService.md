...
## BESKRIVNING
Cmdleten **Get-AzContainerService** får en behållartjänst.
Du kan visa egenskaperna för en behållartjänst, som omfattar status, antal huvud och agenter samt fullständigt kvalificerat domännamn för master och agent.

## EXEMPEL

### Exempel 1: Hämta en behållartjänst
```
...
Det här kommandot hämtar en behållartjänst med namnet CSResourceGroup17.

### Exempel 2: Hämta alla behållartjänster
```
...
Med det här kommandot får du alla behållartjänster i prenumerationen.

### Exempel 3: Hämta alla behållartjänster i resursgruppen
```
...
Med det här kommandot får du alla behållartjänster i ResourceGroup17.

### Exempel 4: Hämta alla behållartjänster med hjälp av filter
```
...
Med det här kommandot får du alla behållartjänster som börjar med "CSResourceGroup1".
...
### -Name
Anger namnet på behållartjänsten som den här cmdleten hämtar.
...
### -ResourceGroupName
Anger resursgruppen för behållartjänsten som den här cmdleten hämtar.
