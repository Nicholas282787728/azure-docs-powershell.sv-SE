...
## BESKRIVNING
Cmdleten **Get-AzSnapshot** hämtar egenskaperna för en ögonblicksbild.
...
Det här kommandot får egenskaperna för alla ögonblicksbilder av prenumerationen.
...
Det här kommandot får egenskaperna för alla ögonblicksbilder i resursgruppen med namnet "ResourceGroupName1"
...
Det här kommandot får egenskaperna för ögonblicksbilden med namnet "Ögonblicksbildsnamn1" i resursgruppen med namnet "ResourceGroupName1"
...
Det här kommandot hämtar alla ögonblicksbilder som börjar med "Ögonblicksbildsnamn"
