...
## BESKRIVNING
Cmdleten **Set-AzVmssStorageProfile** anger egenskaper för lagringsprofilen för VMSS (Virtual Machine Scale Set).

## EXEMPEL

### Exempel 1: Ange egenskaper för lagringsprofilen för VMSS
```
...
Det här kommandot anger egenskaper för lagringsprofilen för VMSS med namnet ContosoVMSS.
...
### -ManagedDisk
Anger den hanterade hårddisken.
...
### -OsDiskCreateOption
Anger hur den här cmdleten skapar virtuella VMSS-datorer.
De godtagbara värdena för den här parametern är:
- Bifoga: Det här värdet används när du använder en särskild disk för att skapa den virtuella VMSS-datorn. 
- FromImage: Det här värdet används när du använder en bild för att skapa den virtuella VMSS-datorn.
Om du använder en plattformsbild använder du även *parametern imageReference.*
...
### -OsDiskOsType
Anger vilken typ av operativsystem som används på disken.
Det här behövs bara för användarbildscenarier och inte för en plattformsbild.
...
Anger VMSS-objektet.
För att hämta objektet använder du New-AzVmssConfig objekt.
