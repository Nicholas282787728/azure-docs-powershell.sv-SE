...
## BESKRIVNING
Den här cmdleten tar bort resurs för närhetsplaceringsgrupp.
...
Med det här kommandot tas den angivna gruppen för närhetsplacering bort.

### Exempel 2

Med det här kommandot tas den angivna gruppen för närhetsplacering bort. (autogenererat)
...
### -InputObject
Gruppobjektet PS Proximity Placement
