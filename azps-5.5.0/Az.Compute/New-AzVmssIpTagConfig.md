...
## BESKRIVNING
Cmdleten **New-AzVmssIpTagConfig** skapar ett IP-taggkonfigurationsobjekt för ett nätverksgränssnitt i en VMSS (Virtual Machine Scale Set).
Ange konfigurationen från den här cmdleten som *IPTag-parameter* för cmdleten New-AzVmssIpConfig.
...
Det här kommandot skapar en lokal IP-tagg med typen FirstPartyUsage och Sql-taggen och skapar sedan en IP-konfiguration med den här IP-taggen.
