...
## BESKRIVNING
Den här cmdleten får en värd i en värdgrupp.
Den här cmdleten listar också alla värdar i en värdgrupp om inget värdnamn anges.
...
Det här kommandot returnerar instansvyn för en värd.
...
Det här kommandot returnerar alla värdar i den givna värdgruppen.
...
### -InstanceView
Anger att denna cmdlet endast hämtar instansvyn för värden.
