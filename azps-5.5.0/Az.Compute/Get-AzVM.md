...
## BESKRIVNING
Cmdleten **Get-AzVM** hämtar modellvyn eller instansvyn för en virtuell Azure-dator.
...
Ange *statusparametern* för att hämta instansvyn för en virtuell dator i stället för modellvyn, som är standardinställningen.

## EXEMPEL

### Exempel 1: Hämta egenskaper för modell- och instansvy
```
...
Det här kommandot hämtar modellvyn och instansvyegenskaperna för den virtuella datorn med namnet VirtualMachine07.

### Exempel 2: Hämta egenskaper för instansvy
```
...
Det här kommandot hämtar egenskaperna för den virtuella datorn med namnet VirtualMa machinee07.
Det här kommandot anger *statusparametern.*
Därför får kommandot endast egenskaperna för instansvyn.

### Exempel 3: Hämta egenskaper för alla virtuella maskiner i en resursgrupp
```
...
Det här kommandot hämtar egenskaper för alla virtuella datorer i resursgruppen ResourceGroup11.

### Exempel 4: Hämta alla virtuella datorer i din prenumeration
```
PS C:\> Get-AzVM
...
Med det här kommandot får du alla virtuella datorer i din prenumeration.
...
Med det här kommandot får du alla virtuella datorer i regionen Väst USA.
...
Med det här kommandot får du alla virtuella datorer i prenumerationen som börjar med "test".
...
### -DisplayHint
Avgör hur det virtuella datorobjektet visas.
Giltiga värden är: -- Kompakt: visar endast egenskaper på den översta nivån – Expandera: visar alla egenskaper på alla nivåer
...
### -Plats
Anger en plats för de virtuella maskinerna som ska listas.
...
### -Name
Anger namnet på den virtuella datorn som ska hämtas.
