...
## BESKRIVNING
Cmdleten **Remove-AzVMDscExtension** tar bort en DSC-tilläggshanterare (Desired State Configuration) från en virtuell dator i en resursgrupp.
...
### -Name
Anger namnet på DSC-tillägget som cmdleten tar bort.
Med Set-AzVMDscExtension-cmdleten anges namnet till Microsoft.Powershell.DSC, som är standardvärdet som används av **Remove-AzVMDscExtension.**
...
### -VMName
Anger namnet på en virtuell dator som denna cmdlet tar bort DSC-tillägget från.
