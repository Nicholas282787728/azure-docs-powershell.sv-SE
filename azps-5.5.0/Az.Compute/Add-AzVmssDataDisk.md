...
## BESKRIVNING
Cmdleten **Add-AzVmssDataDisk** lägger till en datadisk i instansen Virtual Machine Scale Set (VMSS).

## EXEMPEL

### Exempel 1: Lägga till en dataskiva
```
...
Det här kommandot lägger till en tom dataskiva till VMSS-objektet.

## PARAMETERS

### -Cachelagring
Anger cachelagringstyp för disken.
...
### -CreateOption
Anger alternativet skapa för disken.
...
### -DiskIOPSReadWrite
Anger Read-Write IOPS för den hanterade disken. Bör endast användas när StorageAccountType är UltraSSD_LRS. Om det inte anges tilldelas ett standardvärde baserat på diskSizeGB.
...
### -DiskMBpsReadWrite
Anger bandbredden i MB per sekund för den hanterade hårddisken. Bör endast användas när StorageAccountType är UltraSSD_LRS. Om det inte anges tilldelas ett standardvärde baserat på diskSizeGB.
...
### -Lun
Anger diskens logiska enhetsnummer.
...
### -StorageAccountType
Anger lagringskontotypen för disken.
