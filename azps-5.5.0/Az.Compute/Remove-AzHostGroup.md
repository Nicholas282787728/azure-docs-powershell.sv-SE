...
## BESKRIVNING
Denna cmdlet tar bort en värdgrupp
...
Det här kommandot hämtar och tar bort den givna värdgruppen.
...
Det här kommandot tar bort den givna värdgruppen.
