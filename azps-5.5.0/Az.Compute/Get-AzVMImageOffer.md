...
## BESKRIVNING
Cmdleten **Get-AzVMImageOffer** hämtar offertyperna VMImage.
...
Det här kommandot hämtar erbjudandetyperna för den angivna utgivaren i regionen centrala USA.
