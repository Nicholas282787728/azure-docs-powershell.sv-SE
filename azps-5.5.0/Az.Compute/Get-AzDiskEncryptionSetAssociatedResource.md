...
ms.locfileid: "100215790"
---
# Get-AzDiskEncryptionSetAssociatedResource

## SYNOPSIS
Hämtar listan över resurser som är associerade med den angivna diskkrypteringsuppsättningen.
...
## BESKRIVNING
Cmdleten **Get-AzDiskEncryptionSetAssociatedResource** hämtar listan med resurser som är kopplade till den angivna diskkrypteringsuppsättningen.
...
Cmdleten hämtar de två resurserna exampleDisk01 och exampleDisk02 som är kopplade till den angivna diskkrypteringsuppsättningen
