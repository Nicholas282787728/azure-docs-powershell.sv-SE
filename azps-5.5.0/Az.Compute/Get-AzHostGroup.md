...
## BESKRIVNING
Den här cmdleten får en värdgrupp.
Den här cmdleten visar även alla värdgrupper i en resursgrupp om inget värdgruppnamn anges.
Den här cmdleten listar också alla värdgrupper i en prenumeration om varken värdgruppsnamn eller resursgruppnamn anges.
...
Det här kommandot returnerar en värdgrupp.
...
Det här kommandot returnerar alla värdgrupper i den givna resursgruppen.
...
Det här kommandot returnerar alla värdgrupper i prenumerationen.
...
### -InstanceView
Expandera det returnerade objektet för att även visa värdens instansvyer. 
