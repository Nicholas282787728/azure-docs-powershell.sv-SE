...
## BESKRIVNING
Cmdleten **Remove-AzVMNetworkInterface** tar bort ett nätverksgränssnitt från en virtuell dator.
...
### -NetworkInterfaceIDs
Anger en matris med nätverksgränssnitts-IDs som denna cmdlet tar bort.
...
### -VM
Anger den virtuella datorn som cmdleten tar bort ett nätverksgränssnitt från.
