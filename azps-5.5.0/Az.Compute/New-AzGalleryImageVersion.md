...
Skapa en bildversion av galleriet med kryptering av diskbilder.
...
### -DataDiskImage
Datadiskbilder.   t.ex. @{Source = @{Id=<source_id>}; Lun=1; SizeInGB = 100; HostCaching = "ReadOnly" }
...
### -OSDiskImage
OS-diskavbildning t.ex. @{Source = @{Id=<source_id>}; SizeInGB = 100; HostCaching = "ReadOnly" }
...
### -SourceImageId
ID för källbilden som bildversionen ska skapas från.
...
### -StorageAccountType
Anger vilken typ av lagringskonto som ska användas för att lagra bilden. Den här egenskapen kan inte uppdateras. Tillgängliga värden anges Standard_LRS, Standard_ZRS och Premium_LRS.
