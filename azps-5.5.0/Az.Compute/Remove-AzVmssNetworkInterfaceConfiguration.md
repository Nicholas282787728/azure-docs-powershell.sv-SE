...
## BESKRIVNING
**Cmdleten Remove-AzVmssNetworkInterfaceConfiguration** tar bort en nätverksgränssnittskonfiguration från en VMSS (Virtual Machine Scale Set).

## EXEMPEL

### Exempel 1: Ta bort en gränssnittskonfiguration
```
PS C:\> $VMSS = Get-AzVmss -ResourceGroupName "ResourceGroup11" -VMScaleSetName "ContosoVMSS14"
PS C:\> Remove-AzVmssNetworkInterfaceConfiguration -VirtualMachineScaleSet $VMSS -Name "ContosoVmssInterface02"
```

Det första kommandot får en VMSS med hjälp Get-AzVmss-cmdleten och lagrar den sedan i $VMSS variabeln.
Med det andra kommandot tas nätverksgränssnittskonfigurationen ContosoVmssInterface02 bort från uppsättningen i $VMSS.
...
### -Id
Anger ID för nätverksgränssnittskonfigurationen som cmdleten tar bort.
...
### -Name
Anger namnet på nätverksgränssnittskonfigurationen som cmdleten tar bort.
