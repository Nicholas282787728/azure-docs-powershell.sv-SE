...
ms.locfileid: "100254032"
---
# Disable-AzVmssDiskEncryption

## SYNOPSIS
Inaktiverar diskkryptering på en VM-skaluppsättning.
...
Inaktiverar diskkryptering på den VM-skaluppsättning med namnet VMSS001 som tillhör resursgruppen med namnet Group001.

### Exempel 2

Inaktiverar diskkryptering på en VM-skaluppsättning. (autogenererat)
...
### -ExtensionName
Filnamnet.
Om parametern inte anges är standardvärdena som används AzureDiskEncryption för windows VMs och AzureDiskEncryptionForLinux för Linux VMs.
...
### -Force
Tvinga borttagning av tillägget från den virtuella datorn.
...
### -VolumeType
Typ av volym (OS eller Data) för att utföra kryptering
