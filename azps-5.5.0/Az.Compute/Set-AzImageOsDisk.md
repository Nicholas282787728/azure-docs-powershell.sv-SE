...
## BESKRIVNING
Cmdleten **Set-AzImageOsDisk** anger diskegenskaper för operativsystemet för ett bildobjekt.
...
De följande tre kommandona tilldelar sökvägar för os-disk och två datadiskar till $osDiskVhdUri, $dataDiskVhdUri 1 och $dataDiskVhdUri 2 variabler.
...
### -OsState
Anger operativsystemets status.
...
### -StorageAccountType
Lagringskontotyp för os-bilddisk
