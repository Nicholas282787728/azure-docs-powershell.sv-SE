...
## BESKRIVNING
Cmdleten **Get-AzImage** får egenskaperna för en bild.
...
Det här kommandot får egenskaperna för bilden med namnet 'Bild01' i resursgruppen 'ResourceGroup01'.
...
Med det här kommandot får du egenskaperna för alla bilder i resursgruppen Resursgrupp01.
...
Det här kommandot hämtar egenskaperna för alla bilder under prenumerationen.
...
Det här kommandot hämtar egenskaperna för alla bilder under prenumerationen som börjar med "Bild".
