...
## BESKRIVNING
Cmdleten **Set-AzVMSourceImage** anger vilken plattformsbild som ska användas för en virtuell dator.
...
Det slutliga kommandot anger värden för utgivarens namn, erbjudande, SKU och version.
Cmdletsen **Get-AzVMImagePublisher,** **Get-AzVMImageOffer,** **Get-AzVMImageSku** och **Get-AzVMImage** kan identifiera de här inställningarna.
...
Om du vill skaffa SKU:er använder Get-AzVMImageSku-cmdleten.
...
### -Version
Anger en version av ett VMImage.
...
### -VM
Anger det lokala virtuella datorobjektet som ska konfigureras.
