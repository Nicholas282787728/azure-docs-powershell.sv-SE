...
## BESKRIVNING
**Cmdleten Set-AzSnapshotDiskEncryptionKey** anger egenskaper för diskkrypteringsnyckel för ett ögonblicksbildsobjekt.
...
Med det första kommandot skapas ett lokalt tomt ögonblicksbildsobjekt med storleken 5 GB Standard_LRS en lagringskontotyp.  Den ställer också in Windows OS-typ och aktiverar krypteringsinställningar.
Andra och tredje kommandona ställer in inställningarna för diskkrypteringsnyckeln och nyckelkrypteringsnyckeln för ögonblicksbildsobjektet.
Det senaste kommandot tar ögonblicksbildsobjektet och skapar en ögonblicksbild med namnet 'Ögonblicksbild01' i resursgruppen 'Resursgrupp01'.
...
### -Ögonblicksbild
Anger ett lokalt ögonblicksbildsobjekt.
