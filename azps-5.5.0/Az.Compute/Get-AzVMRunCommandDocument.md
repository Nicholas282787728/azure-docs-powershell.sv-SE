...
Hämtar ett specifikt körningskommandodokument för KörPowerShellScript i "westus".
...
Visar alla tillgängliga körningskommandon i "westus".
...
### -Plats
Den plats där kommandon körs tillfrågas.
