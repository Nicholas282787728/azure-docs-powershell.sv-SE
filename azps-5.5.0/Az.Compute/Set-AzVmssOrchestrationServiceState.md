...
Det här kommandot stänger av tjänsten Automatisk reparation på VMSS "vmss1" i resursgruppen "rg".
...
Det här kommandot återupptar tjänsten Automatisk reparation på VMSS "vmss1" i resursgruppen "rg".

## PARAMETERS

### -Åtgärd
Åtgärden som ska utföras.  Möjliga värden är: Återuppta, Avbryt.
...
### -InputObject
Det lokala objektet i skaluppsättningen för den virtuella datorn.
...
### -VMScaleSetName
Namnet på den virtuella datorskaleuppsättningen.
