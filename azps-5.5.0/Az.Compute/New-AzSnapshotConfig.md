...
## BESKRIVNING
Cmdleten **New-AzSnapshotConfig** skapar ett konfigurerbart ögonblicksbildsobjekt.
...
Med det första kommandot skapas ett lokalt tomt ögonblicksbildsobjekt med en storlek på 5 GB Standard_LRS en lagringskontotyp.  Den ställer också in Windows OS-typ och aktiverar krypteringsinställningar.
...
Skapar ett konfigurerbart ögonblicksbildsobjekt. (autogenererat)
...
### -DiskEncryptionKey
Anger diskkrypteringsnyckelns objekt för en ögonblicksbild.
...
### -DiskAccessId
Hämtar eller ARM id för DiskAccess-resursen för att använda privata slutpunkter på.
...
### -ImageReference
Anger bildreferensen för en ögonblicksbild.
...
### -Stegvis
Anger en stegvis ögonblicksbild. Stegvisa ögonblicksbilder på samma disk tar mindre plats än fullständiga ögonblicksbilder och kan vara svårt.
...
### -KeyEncryptionKey
Anger nyckelns krypteringsnyckel för en ögonblicksbild.
