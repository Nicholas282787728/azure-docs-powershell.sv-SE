...
## BESKRIVNING
Cmdleten **Set-AzDiskImageReference** anger bildreferensegenskaperna för ett diskobjekt.
...
Med det första kommandot skapas ett lokalt diskobjekt med en storlek på 10 GB Premium_LRS en lagringskontotyp.  Den ställer också in Windows OS-typ.
Med det andra kommandot anger du bild-ID och det logiska enhetsnumret 0 för diskobjektet.
