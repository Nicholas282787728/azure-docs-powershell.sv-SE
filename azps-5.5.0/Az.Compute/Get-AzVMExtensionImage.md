...
## BESKRIVNING
Cmdleten **Get-AzVMExtensionImage** hämtar alla versioner för ett Azure-tillägg.

## EXEMPEL

### Exempel 1: Hämta versioner av en tilläggsbild
```
...
Med det här kommandot får du alla versioner av tilläggsbilden för den angivna platsen, utgivaren och typen.

### Exempel 2: Hämta versioner av en tilläggsbild med filter över version
```
...
Med det här kommandot får du alla versioner av tilläggsbilden för den angivna platsen, utgivaren, typen och versionen från och med 12.

### Exempel 3: Hämta versioner av en tilläggsbild med filter över version
```
...
Med det här kommandot får du alla versioner av tilläggsbilden för den angivna platsen, utgivaren, typen och versionen.
...
### -PublisherName
Anger namnet på en utgivare av tillägget.
Om du vill hämta en tilläggsutgivare använder Get-AzVMImagePublisher-cmdleten.
...
### -Type
Anger typ av filnamnstillägg.
Om du vill hämta en typ av tillägg använder du Get-AzVMExtensionImageType cmdlet.
...
### -Version
Anger versionen av tillägget som cmdleten hämtar.
