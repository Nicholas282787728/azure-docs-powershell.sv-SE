...
ms.locfileid: "100234687"
---
# Start-AzVmssRollingExtensionUpgrade

## SYNOPSIS
Den här cmdleten startar en rullningsuppgradering för alla tillägg på den givna Virtual Machine Scale Set till den senaste tillgängliga versionen. 
...
## BESKRIVNING
Startar en rullningsuppgradering för att flytta alla tillägg på den här virtuella datorskalan till den senaste tillgängliga versionen.
Tillägg som redan kör den senaste tillgängliga versionen påverkas inte.
...
Det här exemplet hämtar den befintliga VM-skalskalan "MyVmssName" och lägger till ett tillägg till den. Det slutliga kommandot kör den rullningsna uppgraderingen av tillägget. 
...
### -ResourceId
Resurs-ID för VM-skalningsuppsättningsobjektet. 
...
Vm-skalornas uppsättningsobjekt.
...
### -VMScaleSetName
Namnet på den vm-skalningsuppsättningen.
