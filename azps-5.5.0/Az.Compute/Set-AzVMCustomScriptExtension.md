...
## BESKRIVNING
Cmdleten **Set-AzVMCustomScriptExtension** lägger till ett anpassat skripttillägg för Virtual Machine-tillägg till en virtuell dator.
Med det här tillägget kan du köra egna skript på den virtuella datorn.

## EXEMPEL

### Exempel 1: Lägga till ett anpassat skript
```powershell
PS C:\> Set-AzVMCustomScriptExtension -ResourceGroupName "ResourceGroup11" -Location "Central US" -VMName "VirtualMachine07" -Name "ContosoTest" -TypeHandlerVersion "1.1" -StorageAccountName "Contoso" -StorageAccountKey <StorageKey> -FileName "ContosoScript.exe" -ContainerName "Scripts"
```

Det här kommandot lägger till ett anpassat skript på den virtuella datorn med namnet VirtualMa machinee07.
Skriptfilen är contososcript.exe.

### Exempel 2

Lägger till ett tillägg för anpassat skript på en virtuell dator. (autogenererat)
...
### -Argument
Anger argumenten som skripttillägget skickar till skriptet.
...
### -ContainerName
Anger namnet på Azure-lagringsbehållaren där den här cmdleten lagrar skriptet.
...
### -FileName
Anger namnet på skriptfilen. Om filen lagras i Blob-lagring i Azure är filnamnsvärdet det case-sensitive. Filnamnen på filer som lagras i Azure-fillagring är inte case-sensitive.
...
### -Run
Anger vilket kommando som ska användas för att köra skriptet.
...
### -SecureExecution
Anger att denna cmdlet ser till att *värdet* för parametern Kör inte loggas på servern eller returneras till användaren med hjälp av GET-tilläggs-API: t.
Värdet för *Kör kan* innehålla hemligheter eller lösenord som ska skickas till skriptfilen på ett säkert sätt.
...
### -StorageAccountKey
Anger nyckeln för Azure-lagringsbehållaren.
...
### -StorageAccountName
Anger namnet på det Azure Storage-konto där denna cmdlet lagrar skriptet.
...
Om du vill hämta versionen kör du Get-AzVMExtensionImage-cmdleten med värdet Microsoft.Compute för *PublisherName-parametern* och CustomScriptExtension för parametern *Type.*
...
Den här cmdleten lägger till tillägget för anpassat skript för den virtuella datorn som den här parametern anger.
