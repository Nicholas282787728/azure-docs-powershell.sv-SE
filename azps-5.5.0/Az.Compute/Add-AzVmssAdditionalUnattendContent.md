...
## BESKRIVNING
**Cmdleten Add-AzVmssAdditionalUnattendContent** lägger till information i svarsfilen för obevakat Windows-installationsprogram.

## EXEMPEL

### Exempel 1: Lägga till information i svarsfilen för obevakat Windows-installationsprogram
```
PS C:\> Add-AzVmssAdditionalUnattendContent -VirtualMachineScaleSet $VMSS -ComponentName  $AUCComponentName -Content  $AUCContent -PassName $AUCPassName -SettingName  $AUCSetting
```

Det här kommandot lägger till information i svarsfilen för obevakat Windows-installationsprogram.

## PARAMETERS

### -ComponentName
Anger namnet på komponenten som ska konfigureras med det tillagda innehållet.
...
### -Innehåll
Anger det XML-formaterade innehåll som läggs till i unattend.xml för den angivna sökvägen och komponenten.
...
### -PassName
Anger namnet på passet som innehållet gäller för.
...
Ange det virtuella **datorskaleuppsättningsobjektet.**
