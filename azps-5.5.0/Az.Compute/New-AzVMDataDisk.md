...
## BESKRIVNING
Cmdleten **New-AzVMDataDisk** skapar ett lokalt data diskobjekt för en virtuell dator eller en Vmss VM.
...
Nästa kommando skapar ett data diskobjekt med den hanterade hårddisken.
Nästa kommando får en befintlig Vmss VM givet av resursgruppnamnet, vmss-namnet och instans-ID.
Det slutliga kommandot uppdaterar Vmss VM genom att lägga till en ny datadisk.

### Exempel 2

Skapar ett lokalt data diskobjekt för en virtuell dator eller en Vmss VM. (autogenererat)
...
### -Cachelagring
Cachelagringen av den virtuella datordatadisken.
...
### -CreateOption
Alternativet för att skapa datadisken på den virtuella datorn.
...
### -DiskEncryptionSetId
Id för den virtuella dator hanterade diskkrypteringsuppsättningen.
...
### -DiskSizeInGB
Datadiskens storlek på den virtuella datorn i GB.
...
### -Lun
Lun på den virtuella datordatadisken.
...
### -ManagedDiskId
Id för den virtuella datorn hanterad disk.
...
### -Name
Namnet på den virtuella datordatadisken.
...
### -SourceImageUri
Källavbildningen Uri för den virtuella datorns OS-disk.
...
### -StorageAccountType
Kontotypen för den virtuella dator hanterade disken.
...
### -VhdUri
Den virtuella datordatadiskens Vhd Uri.
