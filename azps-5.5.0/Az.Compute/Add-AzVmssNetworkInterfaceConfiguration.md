...
## BESKRIVNING
**Cmdleten Add-AzVmssNetworkInterfaceConfiguration** lägger till en nätverksgränssnittskonfiguration i VMSS (Virtual Machine Scale Set).

## EXEMPEL

### Exempel 1: Lägga till en konfiguration för nätverksgränssnitt i VMSS
```
PS C:\> Add-AzVmssNetworkInterfaceConfiguration -VirtualMachineScaleSet $VMSS -Name "Test" -Primary $True -IPConfiguration $IPCfg
```

Det här kommandot lägger till en konfiguration av nätverksgränssnittet i VMSS.
...
Lista med DNS-server-IP-adresser för DNS-inställningar.
...
### -EnableAcce abetsnetworking
Anger om nätverksgränssnittet påskyndar nätverksaktiverat nätverk.
...
### -EnableIPForwarding
Anger om IP-vidarebefordran är aktiverad för detta NIC.
...
### -Name
Anger namnet på nätverksgränssnittskonfigurationen.
...
Id för nätverkssäkerhetsgruppen.
...
### -Primary
Anger om nätverksgränssnitt som skapats från konfigurationen av nätverksgränssnittet kommer att vara den virtuella datorns primära nätverksinformationscenter (NIC).
...
Anger VMSS-objektet.
Du kan skapa [objektet med cmdleten New-AzVmssConfig.](./New-AzVmssConfig.md)
