...
Lista alla principer för delad åtkomst i "myiotdps".
...
Visa information om principen för delad åtkomstpolicy i en Azure IoT Hub-enhetsetableringstjänst.
