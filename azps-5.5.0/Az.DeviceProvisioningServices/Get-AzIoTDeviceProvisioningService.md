...
Lista alla Azure IoT Hub-enhetsetableringstjänster i en prenumeration.
...
Lista alla etableringstjänster för Azure IoT Hub-enheter i resursgruppen Myresourcegroup.
...
Visa information om en Azure IoT Hub-enhetsetableringstjänst (myiotdps).
