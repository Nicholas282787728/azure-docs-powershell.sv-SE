...
Lägg till en ny princip för delad åtkomst i en Azure IoT Hub-enhetsetableringstjänst med behörigheterna EnrollmentWrite och ServiceConfig.
...
Lägg till en ny princip för delad åtkomst i en azure IoT Hub-enhetsetableringstjänst med registreringsläsarbehörighet.
