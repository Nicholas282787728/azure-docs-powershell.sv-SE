...
Länkat IoT-nav till en Azure IoT Hub-enhetsetableringstjänst med AllocationWeight och ApplyAllocationPolicy.

## PARAMETERS

### -AllocationWeight
Tilldelningsvikt för IoT-hubben
...
### -ApplyAllocationPolicy
En boolesk som anger om tilldelningsprincipen ska tillämpas på IoT-hubben
...
Anslutningssträng för resursen Iot Hub.
