...
## BESKRIVNING
Uppdatera en enhetsregistrering i en Azure IoT Hub-enhetsetableringstjänst.
...
Uppdatera tilldelningsprincipen och naven för en registreringspost.
...
Uppdatera den första statusen för en registrering.
