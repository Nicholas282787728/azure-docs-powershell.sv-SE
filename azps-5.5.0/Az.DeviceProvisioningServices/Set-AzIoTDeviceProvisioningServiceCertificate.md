...
## BESKRIVNING
Verifiera ett certifikat genom att ladda upp ett verifieringscertifikat som innehåller verifieringskoden som erhålls genom att anropa generera verifieringskod. Det här är det sista steget för att bevisa att du äger den.
En detaljerad förklaring av CA-certifikat i Azure IoT Hub-enhetsetableringstjänsten finns i https://docs.microsoft.com/en-us/azure/iot-dps/how-to-verify-certificates
...
Verifiera ägarskap för den privata nyckeln "mycertificate".
...
Verifiera ägarskap för den privata "mycertificate"-nyckeln med hjälp av pipeline.

## PARAMETERS

### -CertificateName
Namn på Iot-tjänstcertifikatet för enhetsetablering
