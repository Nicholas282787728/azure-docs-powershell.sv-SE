...
Ta bort länkat IoT-nav "myiothub" i en Azure IoT Hub-enhetsetableringstjänst.
...
Ta bort länkad IoT-hubb "myiothub" i en Azure IoT Hub-enhetsetableringstjänst med pipeline.
