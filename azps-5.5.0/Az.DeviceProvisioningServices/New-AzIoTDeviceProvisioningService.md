...
Skapa en Tjänst för enhetsetablering i Azure IoT Hub med standardprisnivå S1 och taggar i resursgruppens region.
...
Skapa en Azure IoT Hub-enhetsetableringstjänst med standardprisnivån S1 i regionen "eastus".
...
### -Tag
Instanstaggar för IoT Device Provisioning Service. Egenskapsbag i nyckelvärdespar i form av en hash-tabell.
