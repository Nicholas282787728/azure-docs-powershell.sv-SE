...
ms.locfileid: "100228542"
---
# Update-AzIoTDeviceProvisioningService

## SYNOPSIS
Uppdatera en tjänst för enhetsetablering i Azure IoT Hub.
...
Uppdatera tilldelningsprincipen till "GeoLatency" för en Azure IoT Hub-enhetsetableringstjänst "myiotdps".
...
Ta bort tagg och lägga till nya taggar i en Azure IoT Hub-enhetsetableringstjänst (myiotdps) med hjälp av pipeline.
...
### -Reset
Återställa tjänsttaggar för IoT-enhetsetablering
