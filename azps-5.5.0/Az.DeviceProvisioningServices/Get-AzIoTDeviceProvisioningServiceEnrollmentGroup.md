...
## BESKRIVNING
Få information om en registreringsgrupp eller lista över alla registreringsgrupper i en Azure IoT Hub-enhetsetableringstjänst.
...
Hämta gruppen för enhetsregistrering i en Azure IoT Hub-enhetsetableringstjänst.
...
Lista alla grupper för enhetsregistrering i en Azure IoT Hub-enhetsetableringstjänst.
