...
## BESKRIVNING
Uppdatera en registreringsgrupp i en Azure IoT Hub-enhetsetableringstjänst.
...
Uppdatera tilldelningspolicy och nav för en registreringsgrupp.
...
Uppdatera den första statusen för en registreringsgrupp.
