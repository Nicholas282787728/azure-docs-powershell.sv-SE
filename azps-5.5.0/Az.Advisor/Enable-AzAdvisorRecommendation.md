...
ms.locfileid: "100233983"
---
# Enable-AzAdvisorRecommendation

## SYNOPSIS
Aktiverar rekommendationerna för Azure Advisor.
...
## BESKRIVNING
Den här cmdleten ger en tidigare rekommendation som inte fanns. Du kan även ta bort alla kostnader som är associerade med en rekommendation.
...
Tar bort alla rekommendationer som gäller för den givna rekommendationen med namnet "recommendation_id".
...
Tar bort alla rekommendationer som gäller för givna rekommendationer som godkänts från pipelinen.
