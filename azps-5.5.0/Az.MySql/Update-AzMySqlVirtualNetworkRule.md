...
### Exempel 1: Uppdatera regeln för det virtuella nätverket i MySql med namn
```powershell
...
Den här cmdleten uppdaterar regeln för MySql Virtual Network med namn.

### Exempel 2: Uppdatera regeln för virtuellt nätverk i MySql med identitet.
```powershell
...
Med dessa cmdlets uppdateras regeln för MySql Virtual Network med identitet.
