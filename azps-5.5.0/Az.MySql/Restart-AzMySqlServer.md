...
### Exempel 1: Starta om MinQL-server efter resursgrupp och servernamn
```powershell
PS C:\> Restart-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Den här cmdleten startar om MySql-servern efter resursgrupp och servernamn.

### Exempel 2: Starta om MinQL-server efter identitet
```powershell
...
Dessa cmdlets startar om MySql-servern med identitet.
