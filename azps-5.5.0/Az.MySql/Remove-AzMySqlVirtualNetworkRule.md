...
### Exempel 1: Ta bort mySql server Virtual Network Rule med namn
```powershell
PS C:\> Remove-AzMySqlVirtualNetworkRule -Name vnet -ResourceGroupName PowershellMySqlTest-ServerName mysql-test

```

Med den här cmdleten tas MySql server Virtual Network Rule bort med namn.

### Exempel 2: Ta bort mySql server virtual network rule by identity
```powershell
...
Dessa cmdlets tar bort MySql server Virtual Network Rule med identitet.
