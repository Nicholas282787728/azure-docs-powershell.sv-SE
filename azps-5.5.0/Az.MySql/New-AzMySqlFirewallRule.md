...
### Exempel 1: Skapa en ny mySql serverbrandväggsregel
```powershell
...
Denna cmdlets skapar en MySql-serverbrandväggsregel.

### Exempel 2: Skapa en ny MySql-brandväggsregel med -ClientIPAddress.
```powershell
...
Denna cmdlets skapar en mySql-brandväggsregel med -ClientIPAddress.

### Exempel 3: Skapa en ny MySql-brandväggsregel för att tillåta alla IP-adresser
```powershell
...
Denna cmdlets skapar en ny mySql-brandväggsregel för att tillåta alla IP-adresser.

## PARAMETERS

### -AllowAll
Presentera för att tillåta alla ip-adresser inom intervallet, från 0.0.0.0 till 255.255.255.255.
...
### -ClientIPAddress
Klient angiven enskild IP för serverns brandväggsregel.
...
### -EndIPAddress
Slut-IP-adressen för serverns brandväggsregel.
Måste vara IPv4-format.
...
### -Name
Namnet på regeln för serverbrandväggen.
Om standardvärdet inte anges är det odefinierat.
Om TillåtAll finns används standardnamnet AllowAll_yyyy-MM-dd_HH-mm-ss.
...
### -StartIPAddress
Start-IP-adressen för serverns brandväggsregel.
Måste vara IPv4-format.
