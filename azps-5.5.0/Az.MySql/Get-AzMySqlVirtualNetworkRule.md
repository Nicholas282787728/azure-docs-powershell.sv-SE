...
### Exempel 1: Visar alla regler för virtuellt nätverk i angiven MySql-server
```powershell
...
Den här cmdleten listar alla regler för virtuellt nätverk i angiven MySql-server.

### Exempel 2: Hämta en regel för virtuellt nätverk efter namn
```powershell
...
Den här cmdleten får en regel för virtuellt nätverk efter namn.

### Exempel 3: Skaffa en identitetsregel för virtuellt nätverk
```powershell
...
Den här cmdleten får en identitetsregel för virtuellt nätverk.
