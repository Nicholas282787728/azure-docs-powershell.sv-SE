...
### Exempel 1: Ta bort brandväggsregeln för MySql med namn
```powershell
PS C:\> Remove-AzMySqlFirewallRule -Name rule -ResourceGroupName PowershellMySqlTest -ServerName mysql-test

```

Med den här cmdleten tas regeln för MySql-brandväggen bort med namn.

### Exempel 2: Ta bort regeln för MySql-brandväggen efter identitet
```powershell
...
Dessa cmdlets tar bort mySql-brandväggsregeln efter identitet.
