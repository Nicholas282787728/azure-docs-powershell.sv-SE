...
### Exempel 3: Visar alla brandväggsregler på den angivna MySql-servern
```powershell
...
Den här cmdleten visar alla brandväggsregel i angiven MySql-server.
