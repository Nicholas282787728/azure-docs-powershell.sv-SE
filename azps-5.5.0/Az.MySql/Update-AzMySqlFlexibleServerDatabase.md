...
### Exempel 1: Uppdatera en MySql-serverdatabas med namn
```powershell
...
Uppdatera en databas efter resursnamn.

### Exempel 2: Uppdatera MinQL-databas efter parameter.
```powershell
...
Uppdatera en databas per parameter
