...
### Exempel 1: Visar alla brandväggsregler i angiven MySql-server
```powershell
...
Den här cmdleten listar alla brandväggsregel i angiven MySql-server.
...
Den här cmdleten får en identitetsregel för brandväggen.
