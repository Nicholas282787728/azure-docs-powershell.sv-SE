...
### Exempel 1: Skapa en ny flexibel MySql-server med argument
```powershell
...
### Exempel 2: Skapa en ny MinQL-flexibel server med standardinställning
```powershell
...
Den här cmdleten skapar MinQL-flexibel server med standardparametervärden och etablerar servern i ett nytt virtuellt nätverk och har ett undernät delegerat till servern.
Standardvärdena för platsen är West US 2, SKU är Standard_B1ms, SKU-nivån är sekvenserbar och lagringsstorleken är 10GiB.
...
### Exempel 3: Skapa en ny flexibel MySql-server med virtuellt nätverk
```powershell
PS C:\> $Vnet = 'vnetname'
...
Med den här cmdleten skapas MySql-flexibel server med vnet-ID eller vnet-namn som tillhandahålls av en användare.
Om det virtuella nätverket inte finns skapar cmdleten en.

### Exempel 4: Skapa en ny MinQL-flexibel server med namn på virtuellt nätverk och undernät
```powershell
...
Med den här cmdleten skapas MySql-flexibel server med vnet-namn, undernätsnamn, vnet-prefix och undernätsprefix.
Om det virtuella nätverket och undernätet inte finns skapar cmdleten ett.

### Exempel 7: Skapa en ny MinQL-flexibel server med offentlig åtkomst till alla IP-adresser
```powershell
...
Med den här cmdleten skapas MySql-flexibel server som är öppen för alla IP-adresser.

### Exempel 8: Skapa en ny MySql-flexibel server med brandväggen
```powershell
...
Med den här cmdleten skapas MySql-flexibel server som är öppen för angivna IP-adresser.
...
När den är aställt kan den inte ändras.
...
Observera att undernätet kommer att delegeras till Microsoft.DBforMySQL/flexibleServers.
...
### -VnetPrefix
Ip-adressprefixet som ska användas när ett nytt vnet skapas i CIDR-format.
