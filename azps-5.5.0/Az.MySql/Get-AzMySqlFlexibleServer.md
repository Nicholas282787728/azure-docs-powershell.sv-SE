...
Den här cmdleten får MySql-servrar med standardkontext.
...
Den här cmdleten får MySql-servrar efter resursgrupp och servernamn.
...
Den här cmdlet-listorna får MySql-servrar efter identitet.
