...
### Exempel 1: Starta servern med resursnamn
```powershell
PS C:\> Start-AzMySqlFlexibleServer -ResourceGroupName PowershellMySqlTest -Name mysql-test
```

Starta servern med namn

### Exempel 2: Starta servern med identitet
```powershell
