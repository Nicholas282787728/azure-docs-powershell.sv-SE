...
Den här cmdleten visar alla konfigurationer i angiven MySql-server.

### Exempel 2: Få angiven MySql-konfiguration efter namn
```powershell
...
Den här cmdleten får angivet MySql-konfiguration efter namn.

### Exempel 3: Listkonfiguration efter identitet
```powershell
...
Den här cmdleten får angivet MySql-konfiguration efter identitet.
