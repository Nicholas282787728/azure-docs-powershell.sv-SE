...
### Exempel 1: Uppdatera minQL-konfiguration med namn
```powershell
...
Med den här cmdleten uppdateras MySql-konfigurationen efter namn.

### Exempel 2: Uppdatera minQL-konfiguration efter identitet.
```powershell
...
Dessa cmdlets uppdaterar MySql-konfigurationen efter identitet.
...
### -Källa
Källan till uppdateringsvärdet.
Standardvärdet är åsidosättning av användare
