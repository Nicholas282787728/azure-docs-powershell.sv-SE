...
### Exempel 1: Uppdatera brandväggsregeln för MySql efter namn
```powershell
...
Den här cmdleten uppdaterar regeln för MySql-brandväggen efter namn.

### Exempel 2: Uppdatera regeln för MySql-brandväggen efter identitet.
```powershell
...
Dessa cmdlets uppdaterar regeln för MySql-brandväggen efter identitet.

### Exempel 3: Uppdatera brandväggsregeln för MySql med -ClientIPAddress.
```powershell
PS C:\> $ID = "/subscriptions/<SubscriptionId>/resourceGroups/PowershellMySqlTest/providers/Microsoft.DBforMySQL/servers/mysql-test/firewallRules/rule"
...
Dessa cmdlets uppdaterar regeln för MySql-brandväggen efter -ClientIPAddress.
...
### -ClientIPAddress
Klienten angav en IP för serverns brandväggsregel.
