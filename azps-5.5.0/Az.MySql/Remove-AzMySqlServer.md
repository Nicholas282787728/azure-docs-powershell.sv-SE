...
### Exempel 1: Ta bort MinQL-server med resourceGroup och servernamn
```powershell
PS C:\> Remove-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Med den här cmdleten tas MySql-servern bort av resourceGroup och servernamnet.

### Exempel 2: Ta bort MinQL-server med identitet
```powershell
...
Dessa cmdlets tar bort MySql-servern med identitet.
