...
### Exempel 1: Hämta en MySql-databas efter resursnamn
```powershell
...
Den här cmdleten får MySql-servern efter resursnamn.

### Exempel 2: Hämta minaQL-databaser efter identitet
```powershell
...
Den här cmdleten får en MySql-server med identitet.

### Exempel 3: Visar alla MySql-databaser på den angivna servern
```powershell
...
Den här cmdleten visar alla MySql-servrar på den angivna servern.
