...
ms.locfileid: "100238441"
---
# Remove-AzCosmosDBSqlUserDefinedFunction

## SYNOPSIS
Tar bort Sql Sql UserDefinedFunction.
...
## BESKRIVNING
Cmdleten **Remove-AzCosmosDBSqlUserDefinedFunction** tar bort den Sql Sql UserDefinedFunction som motsvarar given ResourceGroupName, AccountName och DatabaseName.
...
### -InputObject
Användardefinierat sql-funktionsobjekt
...
### -PassThru
Detta är inställt på Sant om användaren vill få ett utdatadata.
