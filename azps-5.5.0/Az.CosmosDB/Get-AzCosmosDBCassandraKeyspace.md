...
ms.locfileid: "100233135"
---
# Get-AzCosmosDBCassandraKeyspace

## SYNOPSIS
Får ett Tangentandra Keyspace, Eller Så är det Inte längre ett av de första som kan använda det.
...
## BESKRIVNING
Cmdleten **Get-AzCosmosDBCassandraKeyspace** skapar en ny eller uppdaterar en befintlig BlanksDB- och Blankandra-nyckelområde.
...
Get-AzCosmosDBCassandraKeyspace hämtar egenskaperna för ett befintligt BlankandraKeyspace. Du kan expandera resursen för att få information _etag, _ts, _rid egenskaper.
