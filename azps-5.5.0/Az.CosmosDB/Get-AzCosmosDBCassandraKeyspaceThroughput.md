...
ms.locfileid: "100233134"
---
# Get-AzCosmosDBCassandraKeyspaceThroughput

## SYNOPSIS
Hämtar dataflödets värde för Keyspace förTangentandra.
...
## BESKRIVNING
Cmdleten **Get-AzCosmosDBCassandraKeyspaceThroughput** hämtar dataflödesobjektet som motsvarar ett visst nyckelområde.
...
### Microsoft.Azure.Commands.TidsDB.Models.PSThroughputSettingsGetResults
