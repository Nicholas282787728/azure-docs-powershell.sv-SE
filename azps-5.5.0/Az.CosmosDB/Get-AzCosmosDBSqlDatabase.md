...
ms.locfileid: "100233079"
---
# Get-AzCosmosDBSqlDatabase

## SYNOPSIS
Hämtar Sql-databasen Avsdb.
...
## BESKRIVNING
Cmdleten **Get-AzCosmosDBSqlDatabase** hämtar listan över alla befintliga Sql-databaser för En given ResourceGroupName, AccountName och får en enda Sql-databas för ResourceGroupName, AccountName och en viss ResourceGroupName, AccountName, DatabaseName och ContainerName.
