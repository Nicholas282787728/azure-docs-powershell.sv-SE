...
ms.locfileid: "100215462"
---
# Get-AzCosmosDBMongoDBDatabase

## SYNOPSIS
Hämtar Databasen GetssDB MongoDB
...
## BESKRIVNING
Cmdleten **Get-AzCosmosDBMongoDBDatabase** får Den första databasen , Eller Så här använder du Den första databasen:
...
Resursobjektet innehåller _rid, _ts, _etag egenskaper.
