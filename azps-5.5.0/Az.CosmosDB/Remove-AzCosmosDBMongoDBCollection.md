...
ms.locfileid: "100211303"
---
# Remove-AzCosmosDBMongoDBCollection

## SYNOPSIS
Tar bort en AvdsDB MongoDB-samling.
...
## BESKRIVNING
**Cmdleten Remove-AzCosmosDBMongoDBCollection** tar bort en MattsDB MongoDB-samling.
...
Cmdleten returnerar ett objekt av typen bool(när -PassThru överförs) vilket är sant, om borttagningen lyckades.
...
### -PassThru
Detta är inställt på Sant om användaren vill få en utdata.
Resultatet är sant om åtgärden lyckades och ett fel uppstår om det inte skulle det.
...
### Microsoft.Azure.Commands.SarsDB.Models.PSMongoDBCollectionGetResults
