...
ms.locfileid: "100215470"
---
# Get-AzCosmosDBAccount

## SYNOPSIS
Skaffa Det här kontot– Så här gör du:
...
## BESKRIVNING
Cmdleten **Get-AzCosmosDBAccount** hämtar listan över alla befintliga AzureSDB-konton för ett visst ResourceGroupName och får ett enda SättsDB-konto för ett visst ResourceGroupName- och AccountName-konto.
...
Skaffa AnvändarkontonDB-databas med namndatabasenAccountName i ResourceGroup resourceGroupName.
