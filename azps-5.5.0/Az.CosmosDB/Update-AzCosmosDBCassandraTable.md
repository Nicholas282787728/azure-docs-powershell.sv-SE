...
ms.locfileid: "100232999"
---
# Update-AzCosmosDBCassandraTable

## SYNOPSIS
Uppdaterar Tabell för Sådrar, Så här ser det ut om det inte går att göra ändringar i tabellerna, t.ex. Utför en korrigering på klientsidan genom att läsa den befintliga tabellen.
