...
ms.locfileid: "100215463"
---
# Get-AzCosmosDBMongoDBCollectionThroughput

## SYNOPSIS
Hämtar dataflödesegenskaperna för Det amerikanska dataflödet för MongoDB-samlingen.
...
## BESKRIVNING
Cmdleten **Get-AzCosmosDBMongoDBCollectionThroughput** hämtar dataflödesegenskaperna för MongoDB-samlingen.
...
### -InputObject
Om detta anges returnerar cmdleten samlingen med motsvarande dataflödesvärde.
