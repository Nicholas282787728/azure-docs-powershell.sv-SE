...
ms.locfileid: "100238461"
---
# Remove-AzCosmosDBSqlStoredProcedure

## SYNOPSIS
Tar bort Sql StoredProcedure för Sql.
...
## BESKRIVNING
Cmdleten **Remove-AzCosmosDBSqlStoredProcedure** tar bort Sql StoredProcedure för Den angivna databasen ResourceGroupName, AccountName och DatabaseName.
