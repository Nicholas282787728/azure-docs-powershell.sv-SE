...
ms.locfileid: "100238471"
---
# Remove-AzCosmosDBSqlDatabase

## SYNOPSIS
Tar bort Sql Sql-databasen För det här företaget.
...
## BESKRIVNING
Cmdleten **Remove-AzCosmosDBSqlDatabase** tar bort Sql Sql-databasen För den angivna databasen ResourceGroupName, AccountName och DatabaseName.
