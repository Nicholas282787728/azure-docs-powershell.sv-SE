...
ms.locfileid: "100215447"
---
# Get-AzCosmosDBSqlTrigger

## SYNOPSIS
Får Sql-utlösaren Avd och Så här använder du Sql Sql-utlösaren.
...
## BESKRIVNING
Cmdleten **Get-AzCosmosDBSqlT original** hämtar listan över alla befintliga Sql TriggersDb för en viss ResourceGroupName, AccountName, DatabaseName och ContainerName och får en enda Sql-utlösare för ResourceGroupName, AccountName, DatabaseName, ContainerName och TriggerName.
