...
ms.locfileid: "100238448"
---
# Remove-AzCosmosDBSqlTrigger

## SYNOPSIS
Tar bort Sql-utlösaren För sql-databasen.
...
## BESKRIVNING
Cmdleten **Remove-AzCosmosDBSqlT cmdlet** tar bort Sql-utlösaren Fördr eller mer som motsvarar den angivna ResourceGroupName, AccountName och DatabaseName.
