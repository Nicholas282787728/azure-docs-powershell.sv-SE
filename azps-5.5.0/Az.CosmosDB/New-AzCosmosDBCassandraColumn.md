...
ms.locfileid: "100233054"
---
# New-AzCosmosDBCassandraColumn

## SYNOPSIS
Skapar en ny FörnamnsDB Ochandra-kolumn.
...
## BESKRIVNING
Den **nya azcosmosDBCassandraColumn** skapar en ny Sätt sig in i den nya kolumnkolumnen Så här ser det ut:
...
### Microsoft.Azure.Commands.SarsDB.Models.PSColumn
