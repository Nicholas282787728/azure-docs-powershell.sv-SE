...
ms.locfileid: "100238498"
---
# Remove-AzCosmosDBSqlContainer

## SYNOPSIS
Tar bort Sql Container, Eller Så här använder du Sql-behållaren.
...
## BESKRIVNING
Cmdleten **Remove-AzCosmosDBSqlContainer** tar bort sql-behållaren För den angivna Sql-behållaren ResourceGroupName, AccountName, DatabaseName och ContainerName.
