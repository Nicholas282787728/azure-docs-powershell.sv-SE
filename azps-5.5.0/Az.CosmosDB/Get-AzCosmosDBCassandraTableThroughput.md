...
ms.locfileid: "100233111"
---
# Get-AzCosmosDBCassandraTableThroughput

## SYNOPSIS
Hämtar dataflödesvärdet för Tabellen Sandra.
...
## BESKRIVNING
Cmdleten **Get-AzCosmosDBCassandraTableThroughput** hämtar dataflödesobjektet som motsvarar ett visst nyckelområde.
