...
ms.locfileid: "100233110"
---
# Get-AzCosmosDBGremlinDatabase

## SYNOPSIS
Hämtar Databasen Det första han vill göra är Att få databasen Gremlin.Det gör du genom att skapa en databas av den nya databasen.
...
## BESKRIVNING
Cmdleten **Get-AzCosmosDBGremlinDatabase** får DatabasernaDb Gremlin-databasen.
...
Resursobjektet innehåller _rid, _ts, _etag.
