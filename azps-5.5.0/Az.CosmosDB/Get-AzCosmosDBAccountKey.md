...
ms.locfileid: "100233150"
---
# Get-AzCosmosDBAccountKey

## SYNOPSIS
Get Keys{"ConnectionKeys", "PrimaryReadOnly" eller "Keys"} för det givna Datordatabaskontot. 
...
## BESKRIVNING
Hämta listan med anslutningsnycklar.
...
Visar tangenterna för SDB-kontot. Nyckeltypen kan vara ett värde från : ConnectionStrings, Keys och ReadOnlyKeys. Standardvärdet är Nycklar.
...
### -Type
Värde från: {ConnectionStrings, Keys, ReadOnlyKeys}.
Standardvärdet är Nycklar.
