...
ms.locfileid: "100233070"
---
# Get-AzCosmosDBSqlDatabaseThroughput

## SYNOPSIS
Hämtar de dataflödesinställningar som motsvarar en Sql Sql-databas för SDB.
...
## BESKRIVNING
Cmdleten **Get-AzCosmosDBSqlDatabaseThroughput** hämtar de dataflödesinställningar som motsvarar en Sql-databas från Azure Sql Database.
