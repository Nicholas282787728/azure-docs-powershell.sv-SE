...
ms.locfileid: "100230878"
---
# New-AzCosmosDBGremlinIncludedPathIndex

## SYNOPSIS
Skapar ett nytt objekt av typen PSIndex. Det kan skickas som ett parametervärde för Set-AzCosmosDBGremlinIncludedPath.
...
## BESKRIVNING
Objekt som motsvarar Gremlin API:s IncludedPath-index.
