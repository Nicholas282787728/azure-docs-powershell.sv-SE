...
ms.locfileid: "100215455"
---
# Get-AzCosmosDBMongoDBDatabaseThroughput

## SYNOPSIS
Hämtar dataflödesegenskaperna för ViaDb för MongoDB-databasen.
...
## BESKRIVNING
**Cmdleten Get-AzCosmosDBMongoDBDatabaseThroughput** hämtar dataflödesegenskaperna för MongoDB-databasen.
