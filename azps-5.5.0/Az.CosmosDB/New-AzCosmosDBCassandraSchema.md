...
ms.locfileid: "100211366"
---
# New-AzCosmosDBCassandraSchema

## SYNOPSIS
Skapar ett nytt Tidedb Ellerandra-schema.
...
## BESKRIVNING
**New-AzCosmosDBCassandraSchema** skapar ett nytt Schema för TidsDB OchAndra.
...
### -ClusterKey
Matris med PSClusterKey-objekt.
...
### -PartitionKey
Matris med strängar som innehåller Partitionsnycklar.
...
### Microsoft.Azure.Commands.SarsDB.Models.PSCassandraSchema
