...
ms.locfileid: "100253901"
---
# New-AzCosmosDBSqlIncludedPath

## SYNOPSIS
Skapar ett nytt objekt av typen PSIncludedPath. Det kan skickas som ett parametervärde för Set-AzCosmosDBSqlContainer.
...
## BESKRIVNING
Objekt som motsvarar Sql API:s IncludedPath.
