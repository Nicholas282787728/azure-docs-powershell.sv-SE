...
ms.locfileid: "100233031"
---
# New-AzCosmosDBGremlinConflictResolutionPolicy

## SYNOPSIS
Skapar ett nytt objekt av typen PSConflictResolutionPolicy. Det kan skickas som ett parametervärde för Set-AzCosmosDBGremlinGraph.
...
## BESKRIVNING
Objekt som motsvarar Gremlin API:s ConflictResolutionPolicy.
