...
ms.locfileid: "100238531"
---
# New-AzCosmosDBLocationObject

## SYNOPSIS
Skapa ett nytt SäkerhetssDB Location Object(PSLocation).
...
### -FailoverPriority
Redundansprioritet för platsen.
...
### -IsZoneRedundant
Boolesk för att ange om det här området är en tillgänglighetszon.
...
### Microsoft.Azure.Commands.Uppd.SDB.Models.PSLocation
