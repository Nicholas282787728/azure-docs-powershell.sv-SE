...
FailoverPolicies uppdaterades med region1 som FailoverPriority 1, region2 som FailoverPriority 2 och region3 som FailoverPriority 3.
...
### -FailoverPolicy
Matris med strängar med regionnamn sorterade efter redundansprioritet.
T.ex. eastus, westus
