...
ms.locfileid: "100215446"
---
# Get-AzCosmosDBSqlUserDefinedFunction

## SYNOPSIS
Hämtar den användardefinierade Sql Sql-funktionen Avb0Db.
...
## BESKRIVNING
Cmdleten **Get-AzCosmosDBSqlUserDefinedFunction** hämtar listan över alla befintliga Sql UserDefinedFunctions för en viss ResourceGroupName, AccountName, DatabaseName och ContainerName och får en enda Sql UserDefinedFunction för en viss ResourceGroupName, AccountName, DatabaseName, ContainerName och UserDefinedFunctionName.
...
### -Name
Användardefinierat funktionsnamn.
...
### Microsoft.Azure.Commands.MDB.Models.PSSqlUserDefinedFunctionGetResults
