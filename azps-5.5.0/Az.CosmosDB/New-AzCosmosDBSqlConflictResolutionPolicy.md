...
ms.locfileid: "100233030"
---
# New-AzCosmosDBSqlConflictResolutionPolicy

## SYNOPSIS
Skapar ett nytt objekt av typen PSSqlConflictResolutionPolicy. Det kan skickas som ett parametervärde för Set-AzCosmosDBSqlContainer.
...
## BESKRIVNING
Objekt som motsvarar Sql API:s ConflictResolutionPolicy.
