...
ms.locfileid: "100233103"
---
# Get-AzCosmosDBGremlinDatabaseThroughput

## SYNOPSIS
Hämtar dataflödet för en SDB Gremlin-databas.
...
## BESKRIVNING
Cmdleten **Get-AzCosmosDBGremlinDatabaseThroughput** hämtar dataflödet för en GirsDB Gremlin-databas.
