...
ms.locfileid: "100230887"
---
# New-AzCosmosDBGremlinIncludedPath

## SYNOPSIS
Skapar ett nytt objekt av typen PSIncludedPath. Det kan skickas som ett parametervärde för Set-AzCosmosDBGremlinGraph.
...
## BESKRIVNING
Objekt som motsvarar Gremlin API:s IncludedPath.
...
### Microsoft.Azure.Commands.Tidedb.Models.PSIncludedPath
