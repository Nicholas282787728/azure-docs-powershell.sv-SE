...
ms.locfileid: "100238561"
---
# Get-AzCosmosDBMongoDBCollection

## SYNOPSIS
Hämtar InsamlingsDB MongoDB.
...
## BESKRIVNING
Cmdleten **Get-AzCosmosDBMongoDBCollection** får Den SDB MongoDB-samlingen.
...
Resursobjektet innehåller MongoIndex, _rid, _ts, _etag egenskaper.
...
Det här exemplet får ShardKey för den hämtade samlingen
