...
ms.locfileid: "100230895"
---
# New-AzCosmosDBGremlinGraph

## SYNOPSIS
Skapar en ny OchdareDb Gremlin Graph.
...
ConflictResolutionPolicy-objektet av typen PSConflictResolutionPolicy, när det anges som ConflictResolutionPolicy för behållaren.
...
### -IndexingPolicy
Indexeringsprincipobjekt av typen Microsoft.Azure.Commands.KommandosDB.PSIndexingPolicy.
...
### -Throughput
Dataflödet för Gremlin Graph (RU/s).
...
### -UniqueKeyPolicy
UniqueKeyPolicy-objektet av typen Microsoft.Azure.Commands.KommandosDB.PSUniqueKeyPolicy.
...
### Microsoft.Azure.Commands.KeysDB.Models.PSUniqueKeyPolicy

### Microsoft.Azure.Commands.KortkommandonDB.Models.PSConflictResolutionPolicy

### Microsoft.Azure.Commands.MDB.Models.PSGremlinDatabaseGetResults

## UTDATA

### Microsoft.Azure.Commands.Uppd.MDB.Models.PSGremlinGraphGetResults
