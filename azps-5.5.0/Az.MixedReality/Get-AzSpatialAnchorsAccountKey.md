...
ms.locfileid: "100228142"
---
# Get-AzSpatialAnchorsAccountKey

## SYNOPSIS
Hämta nycklar för kontot Rumsliga anchors
...
Få utvecklarnycklar för kontot "exempel" för Rumsliga anchors från aktuell prenumerations- och resursgrupp "rg1".
...
Få utvecklarnycklar för kontot "exempel" för Rumsliga anchors från aktuell prenumerations- och resursgrupp "rg1" med rörning.
