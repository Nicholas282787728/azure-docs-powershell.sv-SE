...
ms.locfileid: "100214271"
---
# New-AzRemoteRenderingAccountKey

## SYNOPSIS
Återskapa nyckel för fjärråtergivningskonto
...
## BESKRIVNING
Generera primärnyckel eller sekundär nyckel för fjärrrenderingskonto.
...
Generera sekundär nyckel av "exempel" för fjärrrenderingskonto i resursgruppen "rg1". 
...
Generera sekundär nyckel av "exempel" för fjärrrenderingskonto från aktuell prenumeration och resursgrupp "rg1" med rörning.
...
### -Primary
Generera primärnyckel för fjärrrenderingskonto.
...
### -ResourceId
Resurs-ID för fjärrrenderingskonto.
