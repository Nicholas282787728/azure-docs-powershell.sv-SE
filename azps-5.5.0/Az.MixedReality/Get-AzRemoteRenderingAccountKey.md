...
ms.locfileid: "100228159"
---
# Get-AzRemoteRenderingAccountKey

## SYNOPSIS
Hämta nycklar för fjärråtergivningskonto
...
Hämta utvecklarnycklar för "exempel" för fjärrrenderingskonto från aktuell prenumeration och resursgrupp "rg1".
...
Få utvecklarnycklar för Remote Rendering Account som "exempel" från aktuell prenumeration och resursgrupp "rg1" med rörning.
