...
ms.locfileid: "100219086"
---
# New-AzSpatialAnchorsAccountKey

## SYNOPSIS
Återskapa nyckel för kontot Rumsliga fästpunkter
...
## BESKRIVNING
Generera primärnyckel eller sekundär nyckel för kontot Rumsliga fästpunkter.
...
Generera sekundär nyckel av kontot Rumsliga anchors "exempel" i resursgruppen "rg1". 
...
Generera sekundär nyckel av kontot Rumsliga anchors "exempel" från aktuell prenumeration och resursgrupp "rg1" med rör.
...
### -Primary
Generera primärnyckel för kontot Rumsliga fästpunkter.
