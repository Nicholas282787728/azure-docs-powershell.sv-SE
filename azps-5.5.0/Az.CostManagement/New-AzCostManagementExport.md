...
### Exempel 1: Skapa ett AzCostManagementExport
```powershell
...
Skapa ett AzCostManagementExport
...
### -DefinitionType
Typen av export.
Observera att "Användning" motsvarar ActualCost och gäller för exporter som ännu inte tillhandahåller data för debiteringar eller amorteringar för servicebokningar.
