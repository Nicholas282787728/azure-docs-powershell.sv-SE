...
Ta bort azCostManagementExport efter omfattning och exportnamn

### Exempel 2: Delete the AzCostManagementExport by Export Object
```powershell
...
Ta bort AzCostManagementExport By InputObject
