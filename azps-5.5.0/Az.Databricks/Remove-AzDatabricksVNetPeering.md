...
ms.locfileid: "100214887"
---
# Remove-AzDatabricksVNetPeering

## SYNOPSIS
Tar bort arbetsytans vNetPeering.
...
### Exempel 1: Ta bort en vnet-peering av databricks med namn
```powershell
PS C:\> Remove-AzDatabricksVNetPeering -WorkspaceName databricks-test01 -ResourceGroupName lucas-manual-test -Name vnetpeering-t01

```

Det här kommandot tar bort en vnet-peering av databricks med namn

### Exempel 2: Ta bort en vnet-peering av databricks per objekt
```powershell
PS C:\> Get-AzDatabricksVNetPeering -ResourceGroupName lucas-manual-test -WorkspaceName databricks-test01 -PeeringName MyPeering-test01 | Remove-AzDatabricksVNetPeering

```

Det här kommandot tar bort en vnet-peering av databricks by object
