...
ms.locfileid: "100253857"
---
# Update-AzDatabricksVNetPeering

## SYNOPSIS
Uppdatera vNet-peering för arbetsyta.
...
### Exempel 2: Uppdatera AllowForwardedTraffic av vnet-peering efter objekt
```powershell
...
Det här kommandot uppdaterar AllowForwardedTraffic av vnet-peering efter objekt.

## PARAMETERS

### -AllowForwardedTraffic
[System.Management.Automation.SwitchParameter] Om vidarebefordrad trafik från virtuella maskiner i det lokala virtuella nätverket tillåts/tillåts inte i fjärranslutna virtuella nätverk.
...
### -AllowGatewayTransit
[System.Management.Automation.SwitchParameter] Om gatewaylänkar kan användas i fjärranslutna virtuella nätverk för att länka till det här virtuella nätverket.
...
[System.Management.Automation.SwitchParameter] Om virtuella maskiner i det lokala virtuella nätverksutrymmet ska kunna komma åt virtuella maskiner i fjärranslutna virtuella nätverksutrymmet.
...
### -UseRemoteGateway
[System.Management.Automation.SwitchParameter] Om fjärrgateway kan användas i det här virtuella nätverket.
Om flaggan är inställd på sant, och allowGatewayTransit på fjärr-peering också är sant, kommer det virtuella nätverket att använda gateways i fjärranslutna virtuella nätverk för överföring.
Endast en peering kan ha denna flagga inställd på Sant.
Den här flaggan kan inte anges om virtuellt nätverk redan har en gateway.
