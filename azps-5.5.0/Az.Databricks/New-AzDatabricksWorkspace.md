...
ms.locfileid: "100238121"
---
# New-AzDatabricksWorkspace

## SYNOPSIS
Skapar en ny arbetsyta.
...
Det här kommandot skapar en Databricks-arbetsyta med anpassat virtuellt nätverk i en resursgrupp.

### Exempel 3: Skapa en Databricks-arbetsyta med möjliggöra kryptering
```powershell
...
Det här kommandot skapar en Databricks-arbetsyta och förbereder kryptering.
Mer information om kryptering finns Update-AzDatabricksWorkspace exempel på kryptering.
...
### -EnableNoPublicIP
Det värde som ska användas för det här fältet.
...
### -PrepareEncryption
Förbered arbetsytan för kryptering.
Aktiverar den hanterade identiteten för ett hanterat lagringskonto.
...
### -PrivateSubnetName
Namnet på det privata undernätet i det virtuella nätverket.
...
En boolesk indikerar om DBFS-rotfilsystemet aktiveras med sekundär krypteringslager med plattform hanterade nycklar för data i vila.
