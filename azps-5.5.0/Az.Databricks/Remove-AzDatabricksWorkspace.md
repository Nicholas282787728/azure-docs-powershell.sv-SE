...
### Exempel 1: Ta bort en Databricks-arbetsyta
```powershell
PS C:\> Remove-AzDatabricksWorkspace -ResourceGroupName testgroup -Name databricks-test
```

Med det här kommandot tas en Databricks-arbetsyta bort från en resursgrupp.

### Exempel 2: Ta bort en Databricks-arbetsyta efter objekt
```powershell
...
INPUTOBJECT <IDatabricksIdentity> : Identity Parameter
  ...
  - `[PeeringName <String>]`: Namnet på arbetsytans vNet-peering.
