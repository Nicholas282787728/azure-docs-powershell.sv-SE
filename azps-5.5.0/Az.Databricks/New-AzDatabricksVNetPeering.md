...
ms.locfileid: "100238128"
---
# New-AzDatabricksVNetPeering

## SYNOPSIS
Skapar vNet-peering för arbetsyta.
...
Om vidarebefordrad trafik från virtuella maskiner i det lokala virtuella nätverket tillåts/tillåts inte i fjärr virtuellt nätverk.
...
Om virtuella maskiner i det lokala virtuella nätverksutrymmet skulle kunna komma åt virtuella maskiner i fjärranslutna virtuella nätverksutrymmet.
...
ID för det virtuella databricks-nätverket.
...
### -Name
Namnet på arbetsytans vNet-peering.
...
### -UseRemoteGateway
Om fjärrgateway kan användas i det här virtuella nätverket.
Om flaggan är inställd på sant, och allowGatewayTransit på fjärr-peering också är sant, kommer det virtuella nätverket att använda gateways i det fjärranslutna virtuella nätverket för överföring.
