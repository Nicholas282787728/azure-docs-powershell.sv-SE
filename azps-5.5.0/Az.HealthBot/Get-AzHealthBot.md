...
### Exempel 2: Get all HealthBot by ResourceGroupName
```powershell
...
### Exempel 3: Get HealthBot by ResourceGroupName och Name
```powershell
...
Get HealthBot av ResourceGroupName och Name

### Exempel 4: Get HealthBot by InputObject
```powershell
