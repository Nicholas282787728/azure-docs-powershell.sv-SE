...
ms.locfileid: "100233750"
---
# Get-AzAttestationPolicySigners

## SYNOPSIS
Hämtar betrodda principtecken från en klientorganisation i Azure-brickor.
...
## BESKRIVNING
Med Get-AzAttestationPolicySigners-cmdleten får du signeringarna av den betrodda principen från en klientorganisation i Azure-bepansering.
...
Hämtar betrodda principtecken för *pshtest* för attestationsprovidern *i Resursgrupp psh-test-rg.*  Observera att det inte finns några betrodda undertecknare för den här attestationsprovidern.
...
Hämtar betrodda principtecken för attestationsprovidern *pshtest2* i *Resursgrupp psh-test-rg.*  Observera att det finns en betrodd undertecknare för den här attestationsprovidern.
...
Hämtar betrodda principtecken för standardprovidern för attestation i Location *Central USA.*  Observera att det inte finns några betrodda undertecknare för standardprovidern för attestation.
...
### -DefaultProvider
Anger att det här är begäran till en standardprovider.
...
### -Plats
Anger standardproviderns plats.
...
### -Name
Anger namnet på en attestationsprovider.
