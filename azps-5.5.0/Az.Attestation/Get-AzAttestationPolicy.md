...
ms.locfileid: "100254089"
---
# Get-AzAttestationPolicy

## SYNOPSIS
Hämtar principen från en klientorganisation i Azure-stationen.
...
## BESKRIVNING
Cmdlet Get-AzAttestationPolicy-cmdleten hämtar principen från en klientorganisation i Azure-attestation.
...
Hämtar principen för attestation provider *pshtest för* tee-typen *SgxEndiae.*
...
Hämtar principen för Attestation Default Provider från Location *UK South* för Tee-typen *SgxEngivaren.*
...
Den här cmdleten får principen för attestation för den klientorganisation som parametern anger.
