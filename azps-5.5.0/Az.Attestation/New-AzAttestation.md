...
ms.locfileid: "100229343"
---
# New-AzAttestation

## SYNOPSIS
Skapar en attestation
...
## BESKRIVNING
Den New-AzAttestation cmdleten skapar en beestation i den angivna resursgruppen.
...
Skapa en ny instans av en attestationsprovider med namnet *pshtest4* med ett par taggar och använd AAD-förtroende för att hantera TEE-principen.
...
Skapa en ny instans av en attestationsprovider med namnet *pshtest3*' som använder Isoladed-förtroende för att bemästra TEE-principen genom att ange en uppsättning betrodda signeringsnycklar via en PEM-fil.
...
### -Plats
Anger den Azure-region där du ska skapa attestationsprovidern. Använd kommandokommandot Get-AzResourceProvider ProviderNamespace-parametern för att visa dina val.
...
Anger uppsättningen med betrodda signeringsnycklar för utfärdningsprincipen i en enda certifikatfil.
...
### -ResourceGroupName
Anger namnet på en befintlig resursgrupp där du vill skapa stationen.
