...
ms.locfileid: "100216270"
---
# Remove-AzAttestationPolicySigner

## SYNOPSIS
Tar bort en betrodd principtecken för en klientorganisation i Azure-stationen.
...
## BESKRIVNING
Med Remove-AzAttestationPolicySigner-cmdleten tas en betrodd principtecken bort för en klientorganisation i Azure- därför attestation.
...
Ta bort en betrodd undertecknare för attestationsprovidern *pshtest.*
...
### -Undertecknaren
Anger RFC7519 JSON Web Token som innehåller ett anspråk med namnet "maa-policyCertificate" vars värde är en RFC7517 JSON Web Key som innehåller en betrodd signeringsnyckel att ta bort.
RFC7519 JWT måste vara signerat med en av de befintliga betrodda signeringsnycklarna.
