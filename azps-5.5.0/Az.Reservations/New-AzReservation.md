...
## BESKRIVNING
Köp en reservationsinstans och få förmånen
...
När priset har beräknats kan kunden tömma som RI tillhandahåller med beräknaPris
...
### -ReservationOrderId
ID för reservationsbeställning att köpa, generera med az reservations reservation-order beräkna.
