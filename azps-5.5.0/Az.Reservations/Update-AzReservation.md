...
## BESKRIVNING
Uppdaterar de tillämpade omfattningarna för `Reservation` .
...
Uppdaterar AppliedScopeType för angiven `Reservation` till Single och InstanceFlexibility till On.
...
Uppdaterar AppliedScopeType för angiven till `Reservation` Shared och InstanceFlexibility till Av.

## PARAMETERS

### -AppliedScope
SubscriptionId för detta `Reservation` ska tillämpas
...
### -InstanceFlexibility
Om det finns en uppdatering uppdaterar du instansflexibilitetsvärdet `Reservation` för . Om det inte anges ändras inte det befintliga värdet.
...
### -ReservationId
Id för att `Reservation` uppdatera
...
### -ReservationOrderId
Id för att `ReservationOrder` uppdatera
