...
## BESKRIVNING
Sammanfoga angivna `Reservation` s till ett `Reservation` nytt. De två `Reservation` som sammanfogas måste ha samma egenskaper.
...
Sammanfoga de två angivna `Reservation` s till ett `Reservation`
...
### -Reservation
Kommaavgränsade strängar med två ReservationId för att sammanfoga
...
### -ReservationId
ReservationOrderId för `ReservationOrder` det som innehåller de två `Reservation` s
