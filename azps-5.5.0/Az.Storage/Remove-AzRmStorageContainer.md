...
## BESKRIVNING
Cmdleten **Remove-AzRmStorageContainer** tar bort en blob-behållare för lagring

## EXEMPEL

### Exempel 1: Ta bort en blob-behållare för lagring med namn på lagringskonto och behållarnamn
```
PS C:\>Remove-AzRmStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" -ContainerName "myContainer"
```

Det här kommandot tar bort en blob-behållare för lagring med lagringskontonamn och behållarnamn.

### Exempel 2: Ta bort en blob-behållare för lagring med lagringskontoobjekt och behållarnamn
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount"
PS C:\>Remove-AzRmStorageContainer -StorageAccount $accountObject -ContainerName "myContainer"
```

Det här kommandot tar bort en blob-behållare för lagring med lagringskontoobjekt och behållarnamn.

### Exempel 3: Ta bort alla blob-behållare för lagring i ett lagringskonto med en pipeline
```
PS C:\>Get-AzStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" | Remove-AzRmStorageContainer -Force
```

Med det här kommandot tas alla blob-behållare för lagring bort i ett lagringskonto med en pipeline.
...
### -Force
Tvinga fram borttagning av behållaren och allt innehåll i den
