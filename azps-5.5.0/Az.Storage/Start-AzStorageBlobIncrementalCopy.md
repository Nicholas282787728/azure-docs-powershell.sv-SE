...
### Exempel 1: Starta stegvis kopieringsåtgärd med blob-namn och ögonblicksbildstid
```
...
Det här kommandot startar stegvis kopieringsåtgärd med blob-namn och ögonblicksbildstid

### Exempel 2: Starta stegvis kopiering med hjälp av käll-uri
```
...
Det här kommandot startar stegvis kopieringsåtgärd med käll-uri

### Exempel 3: Starta stegvis kopiering med hjälp av rörledning från GetAzureStorageContainer
```
...
Det här kommandot startar stegvis kopieringsåtgärd med rörledning från GetAzureStorageContainer

### Exempel 4: starta stegvis kopieringsåtgärd från CloudPageBlob-objekt till mål blob med blob-namn
```
...
Med det här kommandot startar du stegvis kopieringsåtgärd från CloudPageBlob-objekt till mål blob med blob-namn

## PARAMETERS

### -AbsoluteUri
Absolut Uri för källan. Observera att autentiserings uppgifter ska tillhandahållas i Uri, om källan kräver några.
...
### -CloudBlob
CloudBlob-objekt från Azure Storage Client-biblioteket. Du kan skapa den eller Get-AzStorageBlob en cmdlet.
...
### -CloudBlobContainer
CloudBlobContainer-objekt från Azure Storage Client-biblioteket. Du kan skapa den eller Get-AzStorageContainer en cmdlet.
...
### -Sammanhang
Käll-Azure Storage-kontext. Du kan skapa den med New-AzStorageContext cmdlet.
...
### -DestContext
Mål för Azure Storage-kontext. Du kan skapa den med New-AzStorageContext cmdlet.
...
### -SrcBlobSnapshotTime
Blob-ögonblicksbildstid på källsidan.
