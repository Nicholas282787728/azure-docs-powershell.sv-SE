...
## BESKRIVNING
Cmdleten **Get-AzDataLakeGen2Item** hämtar information om en fil eller katalog i ett Filesystem i ett Azure-lagringskonto.
...
### Exempel 1: Hämta en katalog från ett filsystem och visa informationen
```
...
Det här kommandot hämtar en katalog från ett Filesystem och visar informationen.
...
Det här kommandot hämtar information om en fil från ett Filesystem. 
...
Ange inte den här parametern för att få rotkatalogen för Filesystem.
