...
## BESKRIVNING
Cmdleten **New-AzRmStorageContainer** skapar en blob-behållare för lagring

## EXEMPEL

### Exempel 1: Skapa en blob-behållare för lagring med namn på lagringskonto och behållare, med metadata
```
PS C:\>New-AzRmStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" -ContainerName "myContainer" -Metadata @{tag0="value0";tag1="value1";tag2="value2"}
```

Med det här kommandot skapas en blob-behållare för lagring med lagringskontonamn och behållarnamn, med metadata.

### Exempel 2: Skapa en blob-behållare för lagring med lagringskontoobjekt och behållarnamn, med offentlig åtkomst som blob
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount"
PS C:\>New-AzRmStorageContainer -StorageAccount $accountObject -ContainerName "myContainer" -PublicAccess Blob
```

Det här kommandot skapar en blob-behållare för lagring med lagringskontoobjekt och behållarnamn, med offentlig åtkomst som blob.

### Exempel 3: Skapa en lagringsbehållare med EncryptionScope-inställningen
```
...
Det här kommandot skapar en lagringsbehållare med ett defalt encryptionScope och blockerar åsidosättning av krypteringsomfånget från standardinställningen för behållaren.
Visa sedan relaterade egenskaper för behållaren.
