...
## BESKRIVNING
**Cmdleten Enable-AzStorageBlobDeleteRetentionPolicy** aktiverar borttagning av bevarandeprincip för Azure Storage Blob-tjänsten.
...
Med det här kommandot kan du ta bort bevarandeprincip för Blob-tjänsten och ange borttagningsdagar för blob-bevarande till 4.
