...
## BESKRIVNING
Cmdleten **Get-AzStorageServiceProperty** hämtar egenskaperna för Azure Storage-tjänster.

## EXEMPEL

### Exempel 1: Hämta Azure Storage Services-egenskapen för Blob-tjänsten
```
