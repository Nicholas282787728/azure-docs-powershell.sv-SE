...
## BESKRIVNING
Cmdleten **New-AzStorageTableStoredAccessPolicy** skapar en lagrad åtkomstprincip för en Azure-lagringstabell.

## EXEMPEL

### Exempel 1: Skapa en lagrad åtkomstprincip i en tabell
```
PS C:\>New-AzStorageTableStoredAccessPolicy -Table "MyTable" -Policy "Policy02"
```

Med det här kommandot skapas en åtkomstprincip med namnet Policy02 i lagringstabellen MinTabell.
...
### -Behörighet
Anger behörigheter i principen för lagrad åtkomst till lagringstabellen.
Det är viktigt att observera att det här är en sträng, som `raud` (för Läsa, Lägg till, Uppdatera och Ta bort).
