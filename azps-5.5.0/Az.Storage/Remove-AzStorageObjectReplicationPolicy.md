...
## BESKRIVNING
Cmdleten **Remove-AzStorageObjectReplicationPolicy** tar bort den angivna objektreplikeringsprincipen från ett lagringskonto.

## EXEMPEL

### Exempel 1: Ta bort en princip för objektreplikering med ett visst policyId från ett lagringskonto.
```
Remove-AzStorageObjectReplicationPolicy -ResourceGroupName "myresourcegroup" -AccountName "mystorageaccount" -PolicyId $policyId
```

Med det här kommandot tas en objektreplikeringsprincip bort med ett specifikt policyId från ett lagringskonto.
...
### -InputObject
Objektreplikeringsprincipobjekt till Delete.
...
### -PolicyId
Princip-ID för objektreplikeringsprincip.
