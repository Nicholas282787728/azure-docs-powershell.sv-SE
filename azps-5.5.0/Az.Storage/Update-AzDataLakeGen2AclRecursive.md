...
## BESKRIVNING
Cmdleten **Update-AzDataLakeGen2AclRecursive** uppdaterar ACL-rekursivt på den angivna sökvägen. Med indata-ACL sammanfogas den ursprungliga ACL: Om ACL-posten med samma AccessControlType/EntityId/DefaultScope finns uppdaterar du behörigheten. lägger du till en ny ACL-post.

## EXEMPEL

### Exempel 1: Uppdatera ACL-rekursivt i rotsystem
```
...
Med det här kommandot skapas först ett ACL-objekt med 3 acl-poster och sedan uppdateras ACL-rekursivt i en rotkatalog i ett filsystem.

### Exempel 2: Uppdatera ACL rekursivt för en katalog och återuppta från fel med ContinuationToken
```
...
Det här kommandot uppdaterade först ACL rekursivt till en katalog och misslyckades och återupptar sedan med ContinuationToken när användaren har åtgärdat den misslyckade filen.

### Exempel 3: Uppdatera ACL rekursivt per segment
```
...
Det här skriptet uppdaterar ACL rescursively på katalog segment efter segment, med segmentstorlek som BatchSize * MaxBatchCount. Segmentstorleken är 5 000 i det här skriptet.

### Exempel 4: Uppdatera ACL rekursivt för en katalog och ContinueOnFailure, och återuppta sedan från fel ett i följd
```
...
Med det här kommandot uppdateras först ACL rekursivt till en katalog med ContinueOnFailure och vissa objekt misslyckades, och sedan återupptar du de misslyckade objekten en och en.
