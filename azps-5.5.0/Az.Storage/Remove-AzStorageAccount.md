...
## BESKRIVNING
Cmdleten **Remove-AzStorageAccount** tar bort ett Storage-konto från Azure.

## EXEMPEL

### Exempel 1: Ta bort ett lagringskonto
```
PS C:\>Remove-AzStorageAccount -ResourceGroupName "RG01" -AccountName "mystorageaccount"
```

Det här kommandot tar bort det angivna lagringskontot.
...
### -Name
Anger namnet på lagringskontot som ska tas bort.
...
### -ResourceGroupName
Anger namnet på den resursgrupp som innehåller lagringskontot som ska tas bort.
