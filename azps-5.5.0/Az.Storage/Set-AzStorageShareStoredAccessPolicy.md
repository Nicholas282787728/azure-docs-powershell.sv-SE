...
## BESKRIVNING
Cmdleten **Set-AzStorageShareStoredAccessPolicy** uppdaterar lagrad åtkomstprincip på en Azure Storage-delning.

## EXEMPEL

### Exempel 1: Uppdatera en lagrad åtkomstprincip i lagringsresurs
```
PS C:\>Set-AzStorageShareStoredAccessPolicy -ShareName "ContosoShare" -Policy "GeneralPolicy" -Permission "rwdl"
```

Det här kommandot uppdaterar en lagrad åtkomstprincip som har fullständig behörighet för en resurs.
...
### -NoExpiryTime
Anger att den här cmdleten tar bort **egenskapen ExpiryTime** i principen för lagrad åtkomst.
...
### -NoStartTime
Anger att den här cmdleten tar bort **Egenskapen StartTime** i principen för lagrad åtkomst.
...
### -Behörighet
Anger behörigheter i principen för lagrad åtkomst för åtkomst till delning eller filer under den.
