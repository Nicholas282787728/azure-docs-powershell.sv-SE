...
## BESKRIVNING
Cmdleten **Set-AzStorageTableStoredAccessPolicy** anger principen för lagrad åtkomst för en Azure-lagringstabell.

## EXEMPEL

### Exempel 1: Ange en lagrad åtkomstprincip i en tabell med fullständig behörighet
```
PS C:\>Set-AzStorageTableStoredAccessPolicy -Table "MyTable" -Policy "Policy08" -Permission raud
```

Med det här kommandot anger du en åtkomstprincip med namnet Policy08 för lagringstabell med namnet Mintabell.
...
### -ExpiryTime
Anger när den lagrade åtkomstprincipen förfaller.
...
### -NoStartTime
Anger att starttiden är inställd på $Null.
...
### -Behörighet
Anger behörigheter i principen för lagrad åtkomst för åtkomst till lagringstabellen.
