...
## BESKRIVNING
Cmdleten **Get-AzRmStorageShare** hämtar eller visar en lista över lagringsfiler.

## EXEMPEL

### Exempel 1: Hämta en lagringsfilresurs med lagringskontonamn och delningsnamn
```
...
Det här kommandot hämtar en lagringsfilresurs med lagringskontonamn och delningsnamn.

### Exempel 2: Lista alla lagringsfiler i ett lagringskonto
```
...
Det här kommandot listar alla lagringsfiler i ett lagringskonto med namnet på lagringskontot.

### Exempel 3: Hämta en blob-behållare för lagring med lagringskontoobjekt och behållarnamn.
```
...
Det här kommandot får en blob-behållare för lagring med lagringskontoobjekt och behållarnamn.

### Exempel 4: Hämta en delning av en lagringsfil med delningsanvändningen i byte
```
...
Det här kommandot hämtar en lagringsfilresurs med namn på lagringskonto och delningsnamn, och tar med delningsanvändningen i byte.

### Exempel 5: Lista alla lagringsfiler i ett lagringskonto, inklusive borttagna resurser
```
...
Det här kommandot listar alla lagringsfilresurser med de borttagna lagringsresurser i ett lagringskonto med namnet på lagringskontot.
...
### -GetShareUsage
Ange den här parametern för att få dela användning i byte.
...
### -IncludeDeleted
Inkludera borttagna resurser. Som standard omfattar inte listresurser borttagna resurser
