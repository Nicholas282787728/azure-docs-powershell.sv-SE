...
## BESKRIVNING
Cmdleten **New-AzStorageContainerStoredAccessPolicy** skapar en lagrad åtkomstprincip för en Azure-lagringsbehållare.

## EXEMPEL

### Exempel 1: Skapa en lagrad åtkomstprincip i en lagringsbehållare
```
PS C:\>New-AzStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy01"
```

Med det här kommandot skapas en åtkomstprincip med namnet Policy01 i lagringsbehållaren MyContainer.
...
### -Behörighet
Anger behörigheter i principen för lagrad åtkomst till behållaren.
