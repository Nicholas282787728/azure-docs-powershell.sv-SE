...
## BESKRIVNING
Cmdleten **Remove-AzDataLakeGen2Item** tar bort en fil eller katalog från ett lagringskonto.
...
Med det här kommandot tas en katalog bort från ett Filesystem.

### Exempel 2: Tar bort en fil utan att fråga
```
PS C:\>Remove-AzDataLakeGen2tem -FileSystem "filesystem1" -Path "dir1/file1" -Force
```

Med det här kommandot tas en katalog bort från ett Filesystem utan uppmaning.

### Exempel 3: Ta bort alla objekt i ett filsystem med rörledning
```
PS C:\>Get-AzDataLakeGen2ChildItem -FileSystem "filesystem1" | Remove-AzDataLakeGen2Item -Force
```

Med det här kommandot tas alla objekt i ett Filesystem bort med en pipeline.
...
### -Force
Tvinga fram borttagning av Filesystem och allt innehåll i det
...
### -InputObject
Azure Datalake Gen2-objektobjekt att ta bort.
