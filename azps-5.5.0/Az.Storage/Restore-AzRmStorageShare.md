...
## BESKRIVNING
Cmdleten **Restore-AzRmStorageShare** återställer en borttagna filresurs inom en giltig bevarandeperiod om mjuk borttagning har aktiverats.

## EXEMPEL

### Exempel 1: Ta bort och återställa en delning
```powershell
...
Med det här kommandot tar du först bort en filresurs och sedan listresurser och ser den borttagna delningsversionen, och återställer den till en normal delning. Måste ha aktiverad mjuk borttagning av delning med Update-AzStorageFileServiceProperty innan du tar bort resursen.
...
### -DeletedShareVersion
Borttagna delningsversion, som kommer att återställas från.
...
### -Name
Borttagna delningsnamn, som kommer att återställas.
