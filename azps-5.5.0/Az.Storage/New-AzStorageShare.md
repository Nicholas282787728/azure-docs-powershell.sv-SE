...
## BESKRIVNING
Cmdleten **New-AzStorageShare** skapar en filresurs.

## EXEMPEL

### Exempel 1: Skapa en filresurs
```
PS C:\>New-AzStorageShare -Name "ContosoShare06"
```

Med det här kommandot skapas en filresurs med namnet ContosoShare06.
...
### -Name
Anger namnet på en filresurs.
Den här cmdleten skapar en filresurs med det namn som parametern anger.
