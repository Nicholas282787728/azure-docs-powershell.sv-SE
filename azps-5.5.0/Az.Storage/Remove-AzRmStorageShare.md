...
## BESKRIVNING
Cmdleten **New-AzRmStorageShare** tar bort en lagringsresurs.

## EXEMPEL

### Exempel 1: Ta bort en lagringsfilresurs med lagringskontonamn och delningsnamn
```
PS C:\>Remove-AzRmStorageShare -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount" -Name "myshare"
```

Med det här kommandot tas en lagringsresurs bort med lagringskontonamn och delningsnamn.

### Exempel 2: Ta bort en lagringsfilresurs med lagringskontoobjekt och delningsnamn
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount"
PS C:\>Remove-AzRmStorageShare -StorageAccount $accountObject -Name "myshare"
```

Med det här kommandot tas en lagringsfilresurs bort med lagringskontoobjekt och delningsnamn.

### Exempel 3: Ta bort alla lagringsfiler i ett lagringskonto med pipeline
```
PS C:\>Get-AzStorageShare -ResourceGroupName "myResourceGroup" -StorageAccountName "myStorageAccount" | Remove-AzRmStorageShare -Force
```

Med det här kommandot tas alla lagringsfiler i ett lagringskonto bort med en pipeline.
...
### -Force
Tvinga fram borttagning av dela och allt innehåll i den
