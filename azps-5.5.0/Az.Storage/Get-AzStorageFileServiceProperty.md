...
## BESKRIVNING
Cmdleten **Get-AzStorageFileServiceProperty** får tjänstegenskaperna för Azure Storage File Services.

## EXEMPEL

### Exempel 1: Hämta Azure Storage File Services-egenskapen för ett visst lagringskonto
```powershell
...
Det här kommandot hämtar egenskapen Filtjänster för ett visst lagringskonto.
