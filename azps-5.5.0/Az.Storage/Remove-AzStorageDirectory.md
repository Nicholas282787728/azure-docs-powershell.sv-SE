...
Det här kommandot tar bort mappen ContosoWorkingFolder från filresursen ContosoShare06.
...
Den här cmdleten tar bort den mapp som parametern anger.
...
### -PassThru
Anger att om cmdleten lyckas returneras värdet $True.
Om du anger den här parametern, och om cmdleten misslyckas på grund av ett olämpligt värde för sökvägsparametern, returnerar cmdleten ett fel. 
...
Om mappen som parametern anger är tom tar den här cmdleten bort mappen.
Om mappen inte är tom gör den här cmdleten ingen ändring och returnerar ett fel.
...
Den här cmdleten tar bort en mapp under filresursen som den här parametern anger.
