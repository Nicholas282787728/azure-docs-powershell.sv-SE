...
## BESKRIVNING
Cmdleten **Remove-AzStorageShare** tar bort en filresurs.

## EXEMPEL

### Exempel 1: Ta bort en filresurs
```
PS C:\>Remove-AzStorageShare -Name "ContosoShare06"
```

Med det här kommandot tas filresursen med namnet ContosoShare06 bort.

### Exempel 2: Ta bort en filresurs och alla dess ögonblicksbilder
```
PS C:\>Remove-AzStorageShare -Name "ContosoShare06" -IncludeAllSnapshot
```

Med det här kommandot tas filresursen med namnet ContosoShare06 och alla dess ögonblicksbilder bort.
...
### -Force
Tvinga fram att ta bort resursen med alla dess ögonblicksbilder och allt innehåll.
...
### -IncludeAllSnapshot
Ta bort filresurs med alla dess ögonblicksbilder
...
Den här cmdleten tar bort filresursen som parametern anger.
...
Den här cmdleten tar bort det objekt som parametern anger.
