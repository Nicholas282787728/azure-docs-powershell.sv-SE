...
## BESKRIVNING
Cmdleten **Get-AzStorageBlobContent** laddar ned den angivna lagrings blobben.
Om blob-namnet inte är giltigt för den lokala datorn löser den här cmdleten automatiskt det om det är möjligt.
...
### Exempel 2: Ladda ned blob-innehåll med hjälp av pipelinen
```
PS C:\>Get-AzStorageBlob -Container containername -Blob blobname | Get-AzStorageBlobContent
```

Det här kommandot använder pipelinen för att hitta och ladda ned blob-innehåll.

### Exempel 3: Ladda ned blob-innehåll med hjälp av pipelinen och ett jokertecken
```
PS C:\>Get-AzStorageContainer container* | Get-AzStorageBlobContent -Blob "cbox.exe" -Destination "C:\test"
```

Det här exemplet använder asterisken för jokertecken och pipeline för att hitta och ladda ned blob-innehåll.

### Exempel 4: Hämta ett blob-objekt och spara det i en variabel, och ladda sedan ned blob-innehåll med blob-objektet
```
PS C:\>$blob = Get-AzStorageBlob -Container containername -Blob blobname 
PS C:\>Get-AzStorageBlobContent -CloudBlob $blob.ICloudBlob -Destination "C:\test"
```

I det här exemplet får du först ett blob-objekt, sparar det i en variabel och laddar sedan ned blob-innehåll med blob-objektet. 
...
### -Blob
Anger namnet på blobben som ska laddas ned.
...
### -CloudBlobContainer
Anger ett **CloudBlobContainer-objekt** från Azure-lagringsklientbiblioteket.
Du kan skapa den eller använda Get-AzStorageContainer-cmdleten.
...
### -Container
Anger namnet på behållaren som har blobben du vill ladda ned.
...
## ANTECKNINGAR
* Om blob-namnet är ogiltigt för den lokala datorn arkiverar den här cmdleten automatiskt det om det är möjligt.
