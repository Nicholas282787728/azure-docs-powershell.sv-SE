...
## BESKRIVNING
Cmdleten **Set-AzStorageObjectReplicationPolicy** skapar eller uppdaterar den angivna objektreplikeringsprincipen i ett lagringskonto.

## EXEMPEL

### Exempel 1: Ange objektreplikeringsprincip till både mål- och källkonto.
```
...
Med det här kommandot anges objektreplikeringsprincipen till både mål- och källkontot.
Skapa först två objektreplikeringsprincipregler och ange principen med de 2 reglerna till målkontot. Ange sedan objektreplikeringsprincipen från målkontot till källkontot.
...
### -DestinationAccount
DestinationAccount för Object Replication Policy.
...
### -InputObject
Objektreplikeringsprincipobjekt som ska ställas in på det angivna kontot.
...
### -PolicyId
Princip-ID för objektreplikeringsprincip. Det ska vara ett GUID eller "standard".
Om du inte matar in policy-ID:t används standard, vilket innebär att skapa en ny princip och id:t för den nya principen returneras i den skapade principen.
...
### -Regel
Principregler för objektreplikeringsprincip.
...
### -SourceAccount
SourceAccount för Object Replication Policy.
