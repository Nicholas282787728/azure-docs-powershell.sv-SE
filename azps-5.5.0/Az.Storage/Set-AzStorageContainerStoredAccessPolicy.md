...
## BESKRIVNING
Cmdleten **Set-AzStorageContainerStoredAccessPolicy** anger en lagrad åtkomstprincip för en Azure-lagringsbehållare.

## EXEMPEL

### Exempel 1: Ange en lagrad åtkomstprincip i en lagringsbehållare med fullständig behörighet
```
PS C:\>Set-AzStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy06" -Permission rwdl
```

Det här kommandot anger en åtkomstprincip med namnet Policy06 för lagringsbehållare med namnet MyContainer.
...
### -NoExpiryTime
Anger att åtkomstprincipen inte har något utgångsdatum.
...
### -NoStartTime
Anger den starttid som ska $Null.
...
### -Behörighet
Anger behörigheter i principen för lagrad åtkomst till lagringsbehållaren.
...
### -Policy
Anger namnet på principen för lagrad åtkomst.
