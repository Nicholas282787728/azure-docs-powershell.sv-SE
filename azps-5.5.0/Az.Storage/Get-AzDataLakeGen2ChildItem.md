...
## BESKRIVNING
Cmdleten **Get-AzDataLakeGen2 Upptaget** listas underkataloger och filer i en katalog eller ett Filesystem i ett Azure-lagringskonto.
...
### Exempel 1: Lista direkta underobjekt från ett filesystem
```
...
Det här kommandot listar de direkta underobjekten från ett Filesystem
...
Det femte kommandot anger en **Do-While-instruktion** som använder cmdleten **Get-AzDataLakeGen2KommandoItem** till listobjekt.
...
### -FetchProperty
Hämta datalakeobjektegenskaperna och ACL.
...
### -MaxCount
Det maximala antalet blobbar som kan returneras.
...
Om den här parametern förstoras omvandlas användaridentitetsvärdena som returneras i fälten ägare och grupp för varje listpost från Azure Active Directory-objekt-ID:t till användarnas huvudnamn. Om den här parametern inte förstoras returneras värdena som Azure Active Directory-objekt-ID: er. Observera att grupp- och programobjekt-ID:t inte översätts eftersom de inte har unika visningsnamn.
...
### -Path
Sökvägen i det angivna filesystem som ska hämtas.
Ska vara en katalog i formatet "katalog1/katalog2/".
...
### -Recurse
Anger om objektet ska rekursivt skaffas.
