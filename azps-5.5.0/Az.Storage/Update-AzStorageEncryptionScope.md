...
## BESKRIVNING
Cmdleten **Update-AzStorageEncryptionScope** ändrar en krypteringsomfång för ett lagringskonto.

## EXEMPEL

### Exempel 1: Inaktivera en krypteringsomfång
```
...
Det här kommandot inaktiverar en krypteringsomfång.

### Exempel 2: Aktivera en krypteringsomfång
```
...
Det här kommandot aktiverar en krypteringsomfång.

### Exempel 3: Uppdatera en krypteringsomfång för att använda lagringskryptering
```
...
Det här kommandot uppdaterar en krypteringsomfång för att använda lagringskryptering.

### Exempel 4: Uppdatera en krypteringsomfång för att använda Keyvault-kryptering
```
...
Med det här kommandot utvidgas en krypteringsomfång för att använda Keyvault-kryptering.
Identiteten för lagringskontot behöver få,wrapkey,unwrapkey-behörigheter till tangenten keyvault.
...
### -EncryptionScopeName
Azure Storage EncryptionScope-namn
...
### -KeyvaultEncryption
Skapa krypteringsomfång med keySource som Microsoft.Keyvault
...
### -Delstat
Uppdateringsomfång för kryptering, möjliga värden är bland annat: "Aktiverad", "Inaktiverad".
...
### -StorageEncryption
Skapa krypteringsomfång med keySource som Microsoft.Storage.
