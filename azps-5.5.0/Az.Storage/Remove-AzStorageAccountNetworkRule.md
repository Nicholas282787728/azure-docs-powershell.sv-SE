...
## BESKRIVNING
Cmdleten **Remove-AzStorageAccountNetworkRule** tar bort IpRules eller VirtualNetworkRules från egenskapen NetWorkRule för ett lagringskonto
...
### Exempel 2: Ta bort en VirtualNetworkRule med VirtualNetworkRule-objektindata med JSON
```
...
### -IPAddressOrRange
Matrisen för IpAddressOrRange tar bort IpRule med samma IpAddressOrRange från egenskapen NetWorkRule.
...
### -IPRule
Den matris med IpRule-objekt som ska tas bort från egenskapen NetWorkRule.
...
Matrisen för VirtualNetworkResourceId tar bort VirtualNetworkRule med samma VirtualNetworkResourceId från egenskapen NetWorkRule.
