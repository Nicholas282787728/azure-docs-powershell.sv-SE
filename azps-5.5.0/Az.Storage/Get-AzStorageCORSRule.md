...
## BESKRIVNING
Cmdleten **Get-AzStorageCORSRule** får KORS-regler (Cross-Origin Resource Sharing) för en tjänsttyp i Azure Storage.

## EXEMPEL

### Exempel 1: Hämta CORS-regler för blob-tjänst
```
PS C:\>Get-AzStorageCORSRule -ServiceType Blob
```

Det här kommandot hämtar CORS-regler för blob-tjänsttypen.
...
### -ServiceType
Anger den Azure Storage-tjänsttyp som cmdleten hämtar CORS-regler för.
