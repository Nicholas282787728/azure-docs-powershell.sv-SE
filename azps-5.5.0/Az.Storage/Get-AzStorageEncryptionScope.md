...
## BESKRIVNING
Cmdleten **Get-AzStorageEncryptionScope** hämtar eller visar krypteringsomfattningar från ett lagringskonto.

## EXEMPEL

### Exempel 1: Få en enda krypteringsomfång
```
...
Det här kommandot får en enda krypteringsomfång.

### Exempel 2: Lista alla krypteringsomfattningar för ett lagringskonto
```
...
Det här kommandot listar alla krypteringsomfattningar för ett lagringskonto.
