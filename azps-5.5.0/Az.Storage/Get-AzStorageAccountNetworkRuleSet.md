...
## BESKRIVNING
Cmdleten **Get-AzStorageAccountNetworkRuleSet** får egenskapen NetworkRule för ett lagringskonto

## EXEMPEL

### Exempel 1: Egenskapen Hämta NetworkRule för ett visst lagringskonto
```
PS C:\> Get-AzStorageAccountNetworkRuleSet  -ResourceGroupName "rg1" -AccountName "mystorageaccount"
```

Det här kommandot får egenskapen NetworkRule för ett visst lagringskonto
