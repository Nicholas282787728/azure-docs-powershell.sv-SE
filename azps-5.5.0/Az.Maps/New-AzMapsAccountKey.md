...
## BESKRIVNING
Cmdleten New-AzMapsAccountKey om en API-nyckel för ett Azure Maps-konto.
...
Återskapar den primära API-nyckeln för kontot MyAccount i resursgruppen MyResourceGroup.
...
Återskapar den sekundära API-nyckeln för det angivna Azure Maps-kontot.
...
### -InputObject
Kartkonto i rör från Get-AzMapsAccount.
