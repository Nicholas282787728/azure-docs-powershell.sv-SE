...
ms.locfileid: "100215558"
---
# Remove-AzContainerGroup

## SYNOPSIS
Tar bort en behållargrupp.
...
## BESKRIVNING
Cmdleten **Remove-AzContainerGroup** tar bort en behållargrupp.

## EXEMPEL

### Exempel 1: Tar bort en behållargrupp
```
PS C:\> Remove-AzContainerGroup -ResourceGroupName MyResourceGroup -Name MyContainer
```

Med det här kommandot tas den angivna behållargruppen bort.

### Exempel 2: Tar bort en behållargrupp genom rörning
```
PS C:\> Get-AzContainerGroup -ResourceGroupName MyResourceGroup -Name MyContainer | Remove-AzContainerGroup
```

Med det här kommandot tas en behållargrupp bort genom rörning.

### Exempel 3: Tar bort en behållargrupp med resurs-ID.
```
PS C:\> Find-AzResource -ResourceGroupEquals MyResourceGroup -ResourceNameEquals MyContainer | Remove-AzContainerGroup
```

Med det här kommandot tas en behållargrupp bort med resurs-ID.
...
### -InputObject
Den behållargrupp som ska tas bort.
