...
ms.locfileid: "100230998"
---
# Get-AzContainerGroup

## SYNOPSIS
Hämtar behållargrupper.
...
## BESKRIVNING
Cmdleten **Get-AzContainerGroup** får en angiven behållargrupp eller alla behållargrupper i en resursgrupp eller prenumeration.

## EXEMPEL

### Exempel 1: Hämtar en angiven behållargrupp
```
...
Kommandot hämtar den angivna behållargruppen.

### Exempel 2: Hämtar behållargrupper i en resursgrupp
```
...
Kommandot hämtar behållargrupperna i `demo` resursgruppen.

### Exempel 3: Hämtar behållargrupper i den aktuella prenumerationen
```
...
Kommandot hämtar behållargrupperna i den aktuella prenumerationen.

### Exempel 4: Hämtar behållargrupper med resurs-ID.
```
...
Kommandot hämtar behållargruppen med resurs-ID: t.
