...
ms.locfileid: "100215574"
---
# New-AzContainerGroup

## SYNOPSIS
Skapar en behållargrupp.
...
## BESKRIVNING
**Cmdlet:arna New-AzContainerGroup** skapar en behållargrupp.
...
Med de här kommandona skapas en behållargrupp med den senaste nginx-bilden och begär en offentlig IP-adress med öppningsport 8000.
...
Med de här kommandona skapas en behållargrupp och ett anpassat skript körs i behållaren.

### Exempel 3: Skapar en behållare för körning till slutförande.
```
...
Med de här kommandona skapas en behållargrupp som skriver ut "hej" och stannar till.

### Exempel 4: Skapar en behållargrupp med bild i Azure Container Registry
```
...
Med de här kommandona skapas en behållargrupp med en nginx-bild i Azure Container Registry.

### Exempel 5: Skapar en behållargrupp med bild i anpassad containerbildsregister
```
PS C:\> $secpasswd = ConvertTo-SecureString "PlainTextPassword" -AsPlainText -Force
...
Med de här kommandona skapas en behållargrupp med en anpassad bild från ett anpassat containerbildregister.

### Exempel 6: Skapar en behållargrupp som fattning av Azure-filvolym
```
PS C:\> $secpasswd = ConvertTo-SecureString "PlainTextPassword" -AsPlainText -Force
PS C:\> $mycred = New-Object System.Management.Automation.PSCredential ("username", $secpasswd)
...
Med de här kommandona skapas en behållargrupp som fäster den angivna Azure-filresursen `/mnt/azfile` till.
...
Med de här kommandona skapas en behållargrupp med system tilldelat identitet med den senaste nginx-bilden och begär en offentlig IP-adress med öppningsport 8000.
...
Med de här kommandona skapas en behållargrupp med system tilldelat och tilldelad användaridentitet med den senaste nginx-bilden och begär en offentlig IP-adress med öppningsport 8000.

## PARAMETERS

### -AssignIdentity
Aktivera system tilldelat identitet
...
Autentiseringsnyckeln för lagringskontot för Azure-filresursen för att sätta fast där användarnamnet är lagringskontots namn och nyckeln är lagringskontonyckeln.
...
Fästsökvägen för Azure-filvolymen.
...
Namnet på Azure-filresursen som ska fästs.
...
### -EnvironmentVariable
Container environment-variablerna.
...
### -IdentityId
Den användare som tilldelats identitets-ID:t
...
### -Plats
Behållargruppen Plats.
Resursgruppens plats som standard.
...
### -OsType
Operativsystemet för behållaren.
Standard: Linux
...
### -RegistryCredential
Register credential för anpassad behållare.
...
Registerinloggningsservern för den anpassade behållaren.
...
### -RestartPolicy
Principen för omstart av behållaren. Standard: Alltid
