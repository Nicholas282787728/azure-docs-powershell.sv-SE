...
## BESKRIVNING
Cmdleten **Stop-AzDeploymentManagerRollout** stoppar en pågående rollout och returnerar ett objekt som representerar den aktuella statusen för återställningen.
Ange rollouten efter dess namn och resursgruppnamn. Alternativt kan du ange rollout-objektet eller Resurs-ID:t.

Observera att när en rollout stoppas kan den inte återupptas eller startas om. Du kan bara skapa en ny utrullning.
...
Det här kommandot avbryter en utrullning med namnet ContosoRollout i ContosoResourceGroup. 

### Exempel 2: Stoppa en utrullning med resursidentifieraren
```powershell
...
### Exempel 3: Stoppa en utrullning med hjälp av rollout-objektet.
```powershell
PS C:\> Get-AzDeploymentManagerRollout -InputObject $rolloutObject
```

Det här kommandot stoppar en rollout vars namn och Resursgrupp matchar egenskaperna Namn och ResourceGroupName för $rolloutObject respektive.
