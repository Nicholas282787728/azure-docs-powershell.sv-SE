...
## BESKRIVNING
Cmdleten **Get-AzDeploymentManagerService** får en tjänst i en tjänsttopologi och returnerar ett objekt som representerar den tjänsten.
...
Du kan ändra objektet lokalt och sedan tillämpa ändringar på tjänsten med hjälp av Set-AzDeploymentManagerService cmdleten.
