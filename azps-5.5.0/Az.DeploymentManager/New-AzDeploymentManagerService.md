...
## BESKRIVNING
Cmdleten **New-AzDeploymentManagerService** skapar en tjänst i en tjänsttopologi och returnerar ett objekt som representerar den tjänsten.
Ange tjänsten efter dess namn, tjänsttopologi som den finns i och resursgruppnamnet. 

Cmdleten returnerar ett serviceobjekt. Du kan ändra objektet lokalt och sedan tillämpa ändringar på tjänsten med hjälp av Set-AzDeploymentManagerService cmdleten.
...
Skapar en ny tjänst med namnet ContosoService1 under tjänsttopologi ContosoServiceTopology i Resource Group ContosoResourceGroup, i platsen i centrala USA. Egenskapen TargetLocation anger att tjänsten ContosoService1 ska distribueras till regionen östra USA i den angivna prenumerationen.
...
### -TargetLocation
Fastställer platsen där resurser under tjänsten ska distribueras.
...
Bestämmer vilken prenumeration som resurser under tjänsten ska distribueras till.
