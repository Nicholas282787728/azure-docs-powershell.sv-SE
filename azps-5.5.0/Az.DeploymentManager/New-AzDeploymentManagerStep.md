...
## BESKRIVNING
Cmdleten **New-AzDeploymentManagerStep** skapar ett distributionssteg som kan refereras i distributioner.
Ange *namn,* *ResourceGroupName och* obligatoriska egenskaper.

Du kan ändra det returnerade objektet lokalt och sedan tillämpa ändringarna på steget med hjälp Set-AzDeploymentManagerStep cmdleten.
...
Skapar ett steg i ContosoResourceGroup med namnet ContosoService1WaitStep med centrala USA som resursplats. Egenskapen Varaktighet ger den varaktighet som utrullningen kommer att vänta innan nästa steg körs.
...
### -Duration
Varaktigheten som ska vänta i ISO 8601-format.
T.ex. : PT30M, PT1H
...
Sökvägen till filen där egenskaper för hälsokontroll definieras.
