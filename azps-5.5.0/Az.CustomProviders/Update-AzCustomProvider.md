...
ms.locfileid: "100215207"
---
# Update-AzCustomProvider

## SYNOPSIS
Uppdaterar en befintlig anpassad resursleverantör.
Det enda värde som kan uppdateras via KORRIGERING är för närvarande taggarna.
...
### Exempel 1: Lägga till taggar i en anpassad leverantör
```powershell
...
### Exempel 2: Uppdatera anpassad leverantör med rörledning
```powershell
...
Uppdatera en anpassad leverantör med rörledning.
