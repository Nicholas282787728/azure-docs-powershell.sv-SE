...
### Exempel 1: Ta bort en anpassad leverantörsassociation.
```powershell
PS C:\> PS C:\> Remove-AzCustomProviderAssociation -Scope $id -Name Namespace.Type
```

Ta bort en anpassad leverantörsassociatidering.

### Exempel 2: Ta bort en anpassad leverantörsassociation med Piping
```powershell
...
Ta bort en anpassad providerassociatering genom att använda piping och passThru-funktionen för att indikera framgång eller fel.
