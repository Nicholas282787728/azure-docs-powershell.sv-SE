...
ms.locfileid: "100215230"
---
# Get-AzCustomProvider

## SYNOPSIS
Hämtar manifestet för den anpassade resursleverantören.
...
### Exempel 1: Lista alla anpassade leverantörer i en prenumeration
```powershell
...
Visar alla anpassade leverantörer i en prenumeration
...
Hämtar information för en enskild anpassad leverantör.
Använd Format-List för att visa objektinformation på skärmen.
...
INPUTOBJECT <ICustomProvidersIdentity> : Identity Parameter
  - `[AssociationName <String>]`: Namnet på associationen.
  - `[Id <String>]`: Resursidentitetssökväg
  - `[ResourceGroupName <String>]`: Namnet på resursgruppen.
  - `[ResourceProviderName <String>]`: Namnet på resursleverantören.
