...
## BESKRIVNING
Cmdleten **Invoke-AzResourceAction** anropar en åtgärd för en angiven Azure-resurs.
Om du vill visa en lista över åtgärder som stöds använder du verktyget Azure Resource Explorer.

## EXEMPEL

### Exempel 1: Starta en VM med ResourceId
...
### Exempel 2: Starta en VM med ResourceName
...
Kommandot anger *force-parametern* och uppmanar dig därför inte att bekräfta.

### Exempel 3: Anropa att registrera en resursleverantör med ResourceId
...
Det här kommandot registrerar en resursleverantör "Microsoft.Network".
Kommandot anger *force-parametern* och uppmanar dig därför inte att bekräfta.

## PARAMETERS

### -Åtgärd
Anger namnet på åtgärden som ska anropas.
...
Anger namnet på en tilläggsresurs för resursen som cmdleten anropar en åtgärd för.
...
Anger typ för tilläggsresursen.
...
### -Parametrar
Anger parametrar, som en hash-tabell, för åtgärden som den här cmdleten anropar.
...
### -ResourceGroupName
Anger namnet på en resursgrupp där den här cmdleten anropar en åtgärd.
...
### -ResourceId
Anger det fullständigt kvalificerade resurs-ID för resursen som denna cmdlet anropar en åtgärd för.
...
### -ResourceName
Anger namnet på resursen för resursen som cmdleten anropar en åtgärd för.
