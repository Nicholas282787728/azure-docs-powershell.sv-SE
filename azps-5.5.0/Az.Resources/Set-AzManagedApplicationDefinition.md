...
## BESKRIVNING
Cmdleten **Set-AzManagedApplicationDefinition** uppdaterar hanterade programdefinitioner

## EXEMPEL

### Exempel 1: Uppdatera beskrivningen av hanterade programdefinitioner
```powershell
...
Det här kommandot uppdaterar beskrivningen av den hanterade programdefinitionen

### Exempel 2

Uppdateringar för definition av hanterade program. (autogenererat)
...
### -Auktorisering
Auktoriseringen för den hanterade programdefinitionen.
Kommaavgränsade auktoriseringspar i ett format \<principalId\> av:\<roleDefinitionId\>
...
### -Beskrivning
Beskrivning av hanterade programdefinitioner.
...
### -DisplayName
Visningsnamnet för definition av hanterat program.
...
### -Id
Det fullständigt kvalificerade hanterade programdefinitions-ID:t, inklusive prenumerationen. t.ex. /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName
...
### -Name
Namnet på den hanterade programdefinitionen.
...
### -PackageFileUri
URI-filen för de hanterade programdefinitionspaketen.
