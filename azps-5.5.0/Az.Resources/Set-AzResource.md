...
## BESKRIVNING
Cmdleten **Set-AzResource** ändrar en befintlig Azure-resurs.
Ange en resurs som ska ändras med namn och typ eller efter ID.

## EXEMPEL

### Exempel 1: Ändra en resurs
```
...
Det första kommandot får resursen ContosoSite med hjälp av cmdleten Get-AzResource och lagrar den sedan i den $Resource variabeln.
Det andra kommandot ändrar en egenskap för $Resource.
Det slutliga kommandot uppdaterar resursen så att den $Resource.

### Exempel 2: Ändra alla resurser i en viss resursgrupp
```
...
Det första kommandot hämtar resurserna i testrgresursgruppen och lagrar dem sedan i den $Resource variabeln.

Det andra kommandot itererar över var och en av dessa resurser i resursgruppen och lägger till en ny tagg i dem.

Det slutliga kommandot uppdaterar var och en av dessa resurser.
...
Anger namnet på en tilläggsresurs för resursen.
...
Om tilläggsresursen till exempel är en databas anger du följande: `Microsoft.Sql/Servers/Databases`
...
### -InputObject
Objektrepresentationen av resursen som ska uppdateras.
...
### -Plan
Anger egenskaper för resursplanen, som en hash-tabell, för resursen.
...
### -Properties
Anger resursens resursegenskaper.
...
### -ResourceGroupName
Anger namnet på resursgruppen där den här cmdleten ändrar resursen.
...
### -SKU
Anger resursens SKU-objekt som en hash-tabell.
...
### -UsePatchSemantics
Anger att den här cmdleten använder en HTTP-KORRIGERING för att uppdatera objektet, i stället för en HTTP PUT.
