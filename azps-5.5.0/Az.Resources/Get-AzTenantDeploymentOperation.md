...
## BESKRIVNING
Cmdleten **Get-AzTenantDeploymentOperation** visar alla åtgärder som var en del av distributionen i den aktuella klientorganisationens omfattning för att hjälpa dig att identifiera och ge mer information om exakt vilka åtgärder som misslyckades för en viss distribution.
...
Hämtar distributionsåtgärder med namnet "Distribuera01" i den aktuella klientorganisationens omfattning.

### Exempel 2: Hämta en distribution och få distributionsåtgärder
```
PS C:\>Get-AzTenantDeployment -Name Deploy01 | Get-AzTenantDeploymentOperation
```

Det här kommandot får distributionen "Distribuera01" på den aktuella klientorganisationens omfattning och hämtar distributionsåtgärderna.
