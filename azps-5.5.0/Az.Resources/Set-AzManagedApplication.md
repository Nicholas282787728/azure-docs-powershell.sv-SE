...
## BESKRIVNING
Cmdleten **Set-AzManagedApplication** uppdaterar hanterade program
...
Det här kommandot uppdaterar beskrivningen av det hanterade programmet
...
### -Id
Det fullständigt kvalificerade hanterade program-ID:t, inklusive prenumerationen. t.ex. /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName
...
### -Sort
Den hanterade program sorten.
En av marknadsplatser eller servicecatalog
...
### -Parameter
Den JSON-formaterade strängen med parametrar för det hanterade programmet.
Det kan antingen vara en sökväg till ett filnamn eller en uri som innehåller parametrarna, eller parametrarna som en sträng.
...
### -Abonnemang
En hash-tabell som representerar egenskaper för hanterade programplan.
