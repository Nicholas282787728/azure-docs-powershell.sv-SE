...
Lägger till användaren med objekt-ID 'D9076BBC-D62C-4105-9C78-A7F5BC4A3405' till gruppen med objekt-ID '85F89C90-780E-4AA6-9F4F-6F268D322EEE'.

### Exempel 2: Lägga till en användare i en grupp genom att pipa

```powershell
PS C:\> Get-AzADGroup -ObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE | Add-AzADGroupMember -MemberObjectId D9076BBC-D62C-4105-9C78-A7F5BC4A3405
```

Hämtar gruppen med objekt-ID '85F89C90-780E-4AA6-9F4F-6F268D322EEE' och rör den till cmdleten Add-AzADGroupMember för att lägga till användaren i den gruppen.

### Exempel 3: Lägga till en användare i en grupp efter huvudnamn
...
Lägger till en användare i en grupp och listar medlemmarna i gruppen.
...
UPN för de medlemmar som ska läggas till i gruppen.
...
Visningsnamnet för den grupp där medlemmar ska läggas till.
...
### -TargetGroupObject
Objektrepresentationen för gruppen du vill lägga till medlemmar till.
...
### -TargetGroupObjectId
Objekt-ID för gruppen som ska läggas till medlem(arna).
