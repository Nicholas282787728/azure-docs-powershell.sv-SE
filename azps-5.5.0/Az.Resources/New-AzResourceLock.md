...
## BESKRIVNING
Cmdleten **New-AzResourceLock** skapar ett resurslås.

## EXEMPEL

### Exempel 1: Skapa ett resurslås på en webbplats
```
...
Med det här kommandot skapas ett resurslås på en webbplats.

### Exempel 2: Skapa ett resurslås i en databas
```
...
Med det här kommandot skapas ett resurslås på en Azure-databas.
...
### -LockNotes
Anger anteckningarna för låset.
...
### -ResourceGroupName
Anger namnet på en resursgrupp som låset gäller för eller som innehåller resursgruppen som låset gäller för.
...
Om du till exempel vill ange en databas använder du följande format: namnservernamn för resursgrupp för prenumerations-ID för resursgrupp för databasnamn Använd följande format för att ange en resursgrupp: namn på resursgrupp för `/subscriptions/` `/resourceGroups/` prenumerations-ID `/providers/Microsoft.Sql/servers/` `/databases/` `/subscriptions/` `/resourceGroups/`
