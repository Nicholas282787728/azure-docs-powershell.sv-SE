...
## BESKRIVNING
Cmdleten **Remove-AzManagementGroupDeployment** tar bort en Azure-distribution till en hanteringsgrupp och alla associerade åtgärder.

## EXEMPEL

### Exempel 1: Ta bort en distribution med ett visst namn
```
PS C:\>Remove-AzManagementGroupDeployment -ManagementGroupId "myMG" -Name "RolesDeployment"
```

Det här kommandot tar bort distributionen "RolesDeployment" i hanteringsgruppen "myMG".

### Exempel 2: Hämta en distribution och ta bort den
```
PS C:\>Get-AzManagementGroupDeployment -ManagementGroupId "myMG" -Name "RolesDeployment" | Remove-AzManagementGroupDeployment
```

Det här kommandot hämtar "RolesDeployment" för distributionen till hanteringsgruppen "myMG" och tar bort den.
