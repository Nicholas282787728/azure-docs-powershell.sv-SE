...
## BESKRIVNING
**Cmdleten Test-AzTenantDeployment** avgör om en distributionsmall och dess parametervärden är giltiga i den aktuella klientorganisationen.

## EXEMPEL

### Exempel 1: Testa distribution med en anpassad mall och parameterfil
```
...
Med det här kommandot testas en distribution i den aktuella klientorganisationen med hjälp av den angivna mallfilen och parametersfilen.

### Exempel 2: Testa distribution med ett anpassat mallobjekt och en parameterfil
```
...
Det här kommandot testar en distribution i den aktuella klientorganisationens omfattning med hjälp av en hashtabell för minne som skapats från den givna mallfilen och en parameterfil.
