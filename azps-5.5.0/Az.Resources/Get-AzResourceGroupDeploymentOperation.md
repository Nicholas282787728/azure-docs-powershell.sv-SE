...
## BESKRIVNING
Cmdleten **Get-AzResourceGroupDeploymentOperation** visar alla åtgärder som ingick i en distribution för att hjälpa dig att identifiera och ge mer information om exakta åtgärder som misslyckades för en viss distribution.
...
Om du vill hämta begäran och svarsinnehållet aktiverar du inställningen när du skickar en distribution via **New-AzResourceGroupDeployment.**
...
Mer information om den här inställningen och hur du aktiverar den finns i New-AzResourceGroupDeployment och felsöka ARM distribution av mallar
...
Hämtar distributionsåtgärden med "test" under "test" för resursgruppen
...
### -SubscriptionId
Prenumerationen som ska användas.
