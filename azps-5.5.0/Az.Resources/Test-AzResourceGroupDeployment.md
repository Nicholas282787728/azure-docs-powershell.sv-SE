...
## BESKRIVNING
**Cmdleten Test-AzResourceGroupDeployment** avgör om en distributionsmall för Azure-resursgrupper och dess parametervärden är giltiga.

## EXEMPEL

### Exempel 1: Testa distribution med ett anpassat mallobjekt och en parameterfil
...
Det här kommandot testar en distribution i den givna resursgruppen med hjälp av en hashtabell i minnet som skapats från den givna mallfilen och en parameterfil.

### Exempel 2: Testa distribution via mallfil och parameterfil
...
Det här kommandot testar en distribution i den givna resursgruppen och resursen med hjälp av den angivna mallfilen och en parameterfil.
...
### -ResourceGroupName
Anger namnet på den resursgrupp som ska testas.
