...
### Exempel 2: Ta bort en användare från en grupp genom att pipa

```powershell
PS C:\> Get-AzADGroup -ObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE | Remove-AzADGroupMember -MemberObjectId D9076BBC-D62C-4105-9C78-A7F5BC4A3405
```

Hämtar gruppen med objekt-ID '85F89C90-780E-4AA6-9F4F-6F268D322EEE' och rör den till cmdleten Remove-AzADGroupMember för att ta bort användaren till den gruppen.
...
### -GroupDisplayName
Visningsnamnet för den grupp som medlemmar ska tas bort från.
...
### -GroupObject
Objektrepresentationen för gruppen som medlemmen ska tas bort från.
...
### -GroupObjectId
Objekt-ID för den grupp som medlemmen ska tas bort från.
...
UPN för den eller de medlemmar som ska tas bort.
