...
## BESKRIVNING
Cmdleten **Update-AzManagementGroup** uppdaterar **ParentId** eller **DisplayName** för en hanteringsgrupp.

## EXEMPEL

### Exempel 1: Uppdatera visningsnamnet för en hanteringsgrupp
```
...
### Exempel 2: Uppdatera överordnade i en hanteringsgrupp
```
...
### Exempel 3: Uppdatera en hanteringsgrupp genom att piping PSManagementGroup-objekt
```
...
### Exempel 4: Uppdatera en hanteringsgrupps överordnade med parentObject
```
...
### -InputObject
Input-objekt från samtalet Hämta
