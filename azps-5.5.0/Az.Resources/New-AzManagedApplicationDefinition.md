...
## BESKRIVNING
**Cmdleten New-AzManagedApplicationDefinition** skapar en hanterad programdefinition.
...
Det här kommandot skapar en hanterad programdefinition
...
### -CreateUiDefinition
Definition av hur hanterade program skapas
...
### -LockLevel
Nivån för låsning för definition av hanterade program.
...
### -MainTemplate
Huvudmallen för huvudmallen för definition av hanterat program
