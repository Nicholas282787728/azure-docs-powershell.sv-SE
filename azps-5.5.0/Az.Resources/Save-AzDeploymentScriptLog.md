...
## BESKRIVNING
**Save-AzDeploymentScriptLog** sparar loggen för körning av ett distributionsskript på disken.
...
Sparar loggen för ett distributionsskript med det angivna namnet och resursgruppen.
...
Sparar de sista tre raderna i loggen för ett distributionsskript med det givna namnet och resursgruppen.
...
### -Force
Tvingar överskrivningen av den befintliga filen.
...
### -OutputPath
Katalogsökvägen för att spara distributionsskriptsloggen.
...
### Microsoft.Azure.Commands.ResourceManager.Cmdlets.SdkModels.PsDepdistributionScriptLogPath
