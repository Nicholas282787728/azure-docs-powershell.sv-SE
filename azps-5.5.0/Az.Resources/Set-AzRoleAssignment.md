...
ms.locfileid: "100217702"
---
# Set-AzRoleAssignment

## SYNOPSIS
Uppdatera en befintlig rolltilldelning.
...
## BESKRIVNING
Använd kommandot New-AzRoleAssignment ändra en befintlig tilldelning.  
Beskrivningar kan vara vilken giltig sträng som helst och använda den för att avdiferentera från varandra.  
om villkor har angetts måste även version anges, men om du uppdaterar ett villkor som inte är nödvändigt.
Villkorsversionen kan uppgraderas från 1.0 till 2.0, men den kan inte nedgraderas. Var försiktig eftersom 2.0 inte är möjligt att komplettera med 1.0.
...
Uppdatera en befintlig rolltilldelning genom att ändra ett objekt
...
Uppdatera en befintlig rolltilldelning med hjälp av en fil
...
### -InputFile
Filnamn som innehåller en enda rolldefinition.
...
### -PassThru
Om den har angetts visas den uppdaterade rolltilldelningen
