...
## BESKRIVNING
Cmdleten **Remove-AzResourceLock** tar bort ett Azure-resurslås.
...
Det här kommandot tar bort låset ContosoSiteLock.

### Exempel 2

Tar bort ett resurslås. (autogenererat)
...
### -LockId
Anger ID för låset som cmdleten tar bort.
...
### -LockName
Anger namnet på låset som cmdleten tar bort.
...
### -ResourceGroupName
Anger namnet på resursgruppen som låset gäller för.
...
Om du till exempel vill ange en databas ska du använda följande format: `/` Serverdatabas
...
### -ResourceType
Anger resurstypen för den resurs som låset gäller för.
...
### -Omfattning
Anger omfånget som låset gäller för.
