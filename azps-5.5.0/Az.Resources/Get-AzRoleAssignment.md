...
## BESKRIVNING
Använd kommandot Get-AzRoleAssignment att lista alla rolltilldelningar som gäller för en omfattning.
Utan parametrar returnerar det här kommandot alla rolltilldelningar som gjorts under prenumerationen.
...
Då filtreras tilldelningar som är gällande vid just den omfattningen, det vill säga alla tilldelningar i omfattningen och högre.
b.
ResourceGroupName – Namnet på en resursgrupp under prenumerationen.
Då filtreras tilldelningar som börjar gälla i den angivna resursgruppen c.
ResourceName, ResourceType, ResourceGroupName och (eventuellt) ParentResource – Identifierar en viss resurs under prenumerationen och filtrerar tilldelningar som gäller vid den resursomfattningen.
Om du vill ta reda på vilken åtkomst en viss användare har i prenumerationen använder du växeln ExpandPrincipalGroups.
Här listas alla roller som tilldelats användaren och till de grupper där användaren är medlem.
Använd IncludeClassicAdministrators för att även visa abonnemangsadministratörer och medadministratörer.
...
Lista alla rolltilldelningar i prenumerationen
...
Hämtar alla rolltilldelningar som gjorts till användare och de grupper där han är john.doe@contoso.com medlem, i testRG-omfattningen eller högre.
...
Hämtar alla rolltilldelningar för den angivna tjänstens huvudnamn
...
Hämtar rolltilldelningar på webbplatsens område "webbplats1".
...
Om detta anges returneras roller som är direkt tilldelade till användaren och till de grupper där användaren är medlem (transitivt).
...
Om detta anges visas även den klassiska prenumerationsadministratören (medadministratörer, tjänstadministratörer osv.).
...
Filtrerar alla tilldelningar som görs till det angivna huvudbeloppet.
...
### -ResourceGroupName
Resursgruppens namn.
Visar rolltilldelningar som gäller för den angivna resursgruppen.
När det används tillsammans med parametrarna ResourceName, ResourceType och ParentResource visar kommandot tilldelningar som är effektiva på resurser inom resursgruppen.
...
### -RoleDefinitionId
Id för den roll som har tilldelats till huvudmannen.
...
### -RoleDefinitionName
Roll som har tilldelats till huvudkontot, dvs. läsare, deltagare, virtuell nätverksadministratör osv.
...
Kommandot filtrerar alla tilldelningar som gäller för den omfattningen.
...
Filtrerar alla tilldelningar som görs i det angivna Azure AD-programmet.
...
Filtrerar alla tilldelningar som görs till den angivna användaren.
