...
## BESKRIVNING
Cmdleten **Get-AzResourceProvider** får en Azure-resursleverantör.

## EXEMPEL

### Exempel 1: Registrera alla resursleverantörer med den aktuella prenumerationen
...
Det här kommandot hämtar alla resursleverantörer från prenumerationen.

### Exempel 2: Hämta all information om resursleverantören från det angivna ProviderNamespace
...
Det här kommandot Hämtar alla resursleverantörer under "Microsoft.Compute".

### Exempel 3: Hämta all information om resursprovidern från den givna ProviderNamespace-matrisen
...
Det här kommandot hämtar alla resursleverantörer under "Microsoft.Compute" och "Microsoft.Network".
...
### -ListAvailable
Anger att den här åtgärden hämtar alla tillgängliga resursleverantörer.
...
### -Plats
Anger resursleverantörens plats.
...
### -ProviderNamespace
Anger resursleverantörens namnområde.
