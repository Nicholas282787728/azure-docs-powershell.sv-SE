...
## BESKRIVNING
Den Get-AzManagementGroup cmdleten Hämtar alla eller en viss hanteringsgrupp.

## EXEMPEL

### Exempel 1: Hämta alla hanteringsgrupper
```
...
### Exempel 2: Hämta en specifik hanteringsgrupp
```
...
### Exempel 3: Hämta en specifik hanteringsgrupp och den första hierarkinivån
```
...
Med flaggan `Expand` kan man navigera genom matrisen och få information om varje `Children` barn. Till exempel `Children[0]` innehåller information om gruppen med visningsnamn. `TestGroup1DisplayName`

### Exempel 4: Hämta en specifik hanteringsgrupp och alla hierarkinivåer
```
...
### -Expand
Expandera utdata för att lista underordnade till hanteringsgruppen
...
### -Recurse
Lista underordnade till hanteringsgruppen rekursivt
