...
## BESKRIVNING
Cmdleten **Remove-AzManagementGroupSubscription** tar bort en prenumeration från en hanteringsgrupp.

## EXEMPEL

### Exempel 1: Ta bort prenumeration från en hanteringsgrupp
```powershell
