...
### Exempel 1: Ta bort hanterade program genom resurs-ID
```
PS C:\>$Application = Get-AzManagedApplication -Name "myApp" -ResourceGroupName "myRG"
PS C:\>Remove-AzManagedApplication -Id $Application.ResourceId -Force
```

Det första kommandot får ett hanterat program med namnet myApp med hjälp av Get-AzManagedApplication cmdleten.
Kommandot lagrar det i den $Application variabeln.
