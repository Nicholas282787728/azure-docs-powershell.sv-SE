...
## BESKRIVNING
Cmdleten **Save-AzTenantDeploymentTemplate**  sparar en distributionsmall till en JSON-fil för en distribution i klientorganisationens omfattning.
...
Det här kommandot får distributionen "RolesDeployment" på den aktuella klientorganisationens omfattning och sparar mallen.
