...
## BESKRIVNING
Cmdleten **Get-AzStackEdgeStorageAccount** får Edge Storage-konton tillgängliga på en Stack Edge-enhet. Du kan ange namnet som en parameter i cmdleten om du vill få information om ett specifikt Edge Storage-konto.
