...
## BESKRIVNING
Cmdleten **Remove-AzStackEdgeStorageAccount** tar bort ett tillhörande Edge-lagringskonto för en Stack Edge-enhet. Du kan ange namnet på Edge Storage Account som ska tas bort som parameter i cmdleten.
