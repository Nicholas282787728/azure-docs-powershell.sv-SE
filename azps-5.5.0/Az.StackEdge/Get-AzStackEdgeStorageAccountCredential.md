...
## BESKRIVNING
Cmdleten **Get-AzStackEdgeStorageAccountCredential** får autentiseringsuppgifterna för lagringskontot för motsvarande lagringskonto på stack edge-enheten. Du kan ange parametrar för namn, resursgrupp och enhetsnamn om du vill få information om specifika autentiseringsuppgifter för lagringskonto.
