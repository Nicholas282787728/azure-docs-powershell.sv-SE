...
## BESKRIVNING
Cmdleten **Get-AzStackEdgeUser** listar de användare som konfigurerats för en Stack Edge-enhet. Du kan nämna namnet i parametrar för att få information om en viss användare.
