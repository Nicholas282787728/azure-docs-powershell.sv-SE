...
## BESKRIVNING
**Cmdleten Get-AzStackEdgeBandwidthSchedule** hämtar information om Bandbreddsscheman. Du kan ange namnet på ett schema tillsammans med resursgruppens namn och enhetsnamn för att få information om ett visst bandbreddsschema
