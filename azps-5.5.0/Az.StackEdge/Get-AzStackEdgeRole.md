...
## BESKRIVNING
Cmdleten **Get-AzStackEdgeRole** hämtar tillgängliga IoT-roller för en Stack Edge-enhet. Du kan nämna parametern Name för att få information om en specifik IoT-roll.
