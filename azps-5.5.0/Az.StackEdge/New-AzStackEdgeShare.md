...
## BESKRIVNING
Cmdleten **New-AzStackEdgeShare** skapar en ny delning på Stack Edge-enheten.
...
### -ClientAccessRight
Läs-/skrivåtkomst för klient-ID:n, för ex:@(@{"ClientId"="192.168.10.10";" AccessRight"="NoAccess"}, @{"ClientId"="192.168.10.11";" AccessRight"="ReadOnly"})
...
### -CloudShare
Ange resursens namn för det befintliga StorageAccountCredential
...
### -ContainerName
Behållarnamn (baserat på det angivna dataformatet representerar detta namnet på Azure-filer/Pageblob/Block blob)
...
### -Dataformat
Ange dataformat, t.ex. PageBlob, BlobBlob
...
### -NFS
AccessProtocol när du skapar Dela
...
### -UserAccessRight
ge åtkomst direkt tillsammans med befintliga användarnamn för åtkomst till SMB-delningstyper, Till exempel: @(@{"Username"="user-name-1";" AccessRight"="Read"}, @{"Username"="user-name-2";" AccessRight"="Read"}, @{"Username"="user-name-3";" AccessRight"="Custom"})
