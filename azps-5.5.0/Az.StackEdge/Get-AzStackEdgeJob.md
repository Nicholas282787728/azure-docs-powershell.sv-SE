...
## BESKRIVNING
Cmdleten **Get-AzStackEdge Engström** hämtar de aktiva jobben på en Stack Edge-enhet. Du kan nämna parametern Name för att få information om ett visst jobb.
...
### Microsoft.Azure.PowerShell.cmdlets.StackEdge.Models.PSStackEdge Engström
