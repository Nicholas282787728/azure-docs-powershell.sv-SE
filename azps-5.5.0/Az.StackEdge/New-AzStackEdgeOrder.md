...
## BESKRIVNING
Cmdleten **New-AzStackEdgeOrder** skapar en ny order för en Stack Edge-enhet. En Stack Edge-enhetsresurs måste skapas först innan du skapar en order. Du kan ange detaljer som kontaktperson, företagsnamn, e-postadress osv. som parametrar för att skapa ordern.
