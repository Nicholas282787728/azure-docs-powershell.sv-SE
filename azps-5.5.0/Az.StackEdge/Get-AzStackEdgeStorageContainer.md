...
## BESKRIVNING
Cmdleten **Get-AzStackEdgeStorageContainer** hämtar lagringsbehållaren för ett Edge-lagringskonto på en Stack Edge-enhet. Du kan ange namnet som en parameter i cmdleten för att hämta information om en viss lagringsbehållare. 
...
Ange det befintliga EdgeStorageAccounts namn
