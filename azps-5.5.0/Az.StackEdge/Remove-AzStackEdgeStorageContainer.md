...
## BESKRIVNING
Cmdleten **Remove-AzStackEdgeStorageContainer** tar bort en tillhörande lagringsplats för Edge-lagringskontot på en Stack Edge-enhet. Du kan ange namnet på lagringsbehållaren som ska tas bort som parameter.
