...
## BESKRIVNING
Den Get-AzIotSecurityAnalyticsAggregatedAlert cmdleten returnerar en eller flera aggregerade rekommendationer på enheter med iot-hubben. Namnet på en samlad rekommendation är dess typ
...
Få den samlade rekommendationen "IoT_OpenPorts" i säkerhetslösningen "MySolution" och resursgruppen "MyResourceGroup"
...
Hämta en lista med aggregerade rekommendationer i säkerhetslösningen "MySolution" och resursgruppen "MyResourceGroup"
