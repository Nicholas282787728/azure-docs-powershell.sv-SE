...
## BESKRIVNING
Säkerhetslösningar upptäcks automatiskt av Azure Säkerhetscenter. Använd denna cmdlet för att visa de identifierade säkerhetslösningarna
...
Få alla de upptäckta säkerhetslösningarna i prenumerationen
...
Skaffa en specifik, upptäckd säkerhetslösning
