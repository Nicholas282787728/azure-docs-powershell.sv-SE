...
Hämtar alla säkerhetsvarningar som upptäckts för resurser i en prenumeration
...
Hämtar alla säkerhetsvarningar som har upptäckts för resurser i resursgruppen "minTjänst1"
...
Får en specifik säkerhetsvarning som har upptäckts för resurser i resursgruppen "minTjänst1"
