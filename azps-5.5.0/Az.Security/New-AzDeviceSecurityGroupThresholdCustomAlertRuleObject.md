...
## BESKRIVNING
Med New-AzDeviceSecurityGroupThresholdCustomAlertRuleObject-cmdleten skapas en ny lista med anpassade aviseringsregler för tröskelvärden för enhetssäkerhetsgruppen i IoT-säkerhetslösning.
...
Skapa ny anpassad aviseringsregel för tröskelvärde från typen "SomeRuleType" med statusaktiverade ant-värden för lägsta och högsta tröskelvärde
