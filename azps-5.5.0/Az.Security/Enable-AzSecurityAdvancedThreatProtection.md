...
## BESKRIVNING
`Enable-AzSecurityAdvancedThreatProtection`Cmdleten aktiverar skyddsprincipen för ett lagrings-/säkerhetsdb-konto.
...
Det här kommandot aktiverar den avancerade policyn för skydd av hot för `"/subscriptions/xxxxxxx-xxxx-xxxx-xxxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.Storage/storageAccounts/myStorageAccount/"` resurs-ID.
...
Med det här kommandot aktiveras den avancerade policyn för skydd av hot för ` "/subscriptions/xxxxxxx-xxxx-xxxx-xxxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.DocumentDb/databaseAccounts/myCosmosDBAccount/"` resurs-ID.
