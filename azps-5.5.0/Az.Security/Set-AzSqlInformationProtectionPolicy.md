...
### -FilePath
Anger en sökväg till en .json-fil som innehåller SQL Information Protection Policy Definition.
...
### -Policy
Anger en principdefinition för SQL Information Protection Policy. Du kan ange en sökväg till en Json-fil eller en JSON-formatsträng som definierar principen.
