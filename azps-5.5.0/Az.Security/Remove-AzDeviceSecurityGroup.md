...
## BESKRIVNING
Med Remove-AzDeviceSecurityGroup cmdleten tas en säkerhetsgrupp för enheter som definierats i en så här enkel säkerhetslösning bort.
...
Ta bort enhetssäkerhetsgruppen MySecurityGroup för iot-hubben med resurs-ID "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub"
