...
ms.locfileid: "100212671"
---
# Get-AzRegulatoryComplianceStandard

## SYNOPSIS
Får efterlevnadsstandarder av standarderna för regelefterlevnad av standarderna för dag- och tidsstandard
...
## BESKRIVNING
Få information om standardefterlevnad för regelverk eller lista alla standarder för regelefterlevnad under en viss prenumeration.
...
Få alla standarder för regelefterlevnad under en prenumeration.
...
Få information om specifik standard för regelefterlevnad enligt resurs-ID.
...
### Microsoft.Azure.Commands.SecurityCenter.Models.RegulatoryCompliance.PSSecurityRegulatorComplianceStandard
