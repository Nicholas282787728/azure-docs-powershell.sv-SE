...
ms.locfileid: "100253144"
---
# Get-AzSecurityAssessment

## SYNOPSIS
Får säkerhetsutvärderingar och deras resultat i en prenumeration
...
## BESKRIVNING
Hämtar säkerhetsbedömning och deras resultat i prenumerationen. Säkerhetsutvärderingar gör att du får veta vilka metodtips som återcommageras av Azure Säkerhetscenter för att minimeras för Azure-prenumerationen.
...
Hämtar all säkerhetsbedömning i en prenumeration
