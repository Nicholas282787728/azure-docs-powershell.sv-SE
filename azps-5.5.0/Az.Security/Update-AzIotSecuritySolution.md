...
Endast de angivna egenskaperna uppdateras i den t.ex. säkerhetslösningen.
IoT-säkerhetslösningen samlar in säkerhetsdata och händelser från iot-enheter och iot hub för att förhindra och upptäcka hot.
...
Uppdatera iot-säkerhetslösningen "MySample" från resursgruppen "MyResourceGroup" med konfiguration av rekommendation och användardefinierade resurser
