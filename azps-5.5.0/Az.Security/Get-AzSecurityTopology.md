...
ms.locfileid: "100232799"
---
# Get-AzSecurityTopology

## SYNOPSIS
Får en lista över säkerhets topologier för en prenumeration
...
## BESKRIVNING
Säkerhets topologier upptäcks automatiskt av Azure Säkerhetscenter. Använd denna cmdlet för att visa säkerhets topologier.
...
Visa alla säkerhets topologier i en prenumeration
...
Få specifika säkerhets topologier
