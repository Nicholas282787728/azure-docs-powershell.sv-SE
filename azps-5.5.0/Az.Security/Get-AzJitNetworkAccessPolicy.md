...
## BESKRIVNING
Med principer för JIT-nätverk (Just In Time) kan du definiera en princip som gör att enkla användare kan skapa en tillfällig nätverksanslutning till en VM.
Principen definierar vilka portar, protokoll- och käll-IP-adresser som kan begära en anslutning till en VM och maximal varaktighet innan anslutningen stängs automatiskt.
I principen visas även anslutningsbegäran som gjorts med den här principen. 
...
Få all JIT-nätverksåtkomst-information på en prenumeration
...
Hämta alla JIT-nätverksåtkomst-grupprinciper i resursgruppen "minTjänst1"
...
Hämtar en specifik JIT-nätverksåtkomstprincip
...
### -ResourceId
Resurs-ID för principresursen jit Network Access.
