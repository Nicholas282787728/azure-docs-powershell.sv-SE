...
ms.locfileid: "100253117"
---
# Remove-AzSecurityAssessmentMetadata

## SYNOPSIS
Tar bort metadata för säkerhetsbedömningen från en prenumeration.
...
## BESKRIVNING
Tar bort metadata för säkerhetsbedömningen från en prenumeration. Den här åtgärden tar bort utvärderingstypen och alla relevanta utvärderingsresultat från prenumerationen.
...
Tar bort en bedömningstyp från en prenumeration
