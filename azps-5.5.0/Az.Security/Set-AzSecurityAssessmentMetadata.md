...
ms.locfileid: "100253089"
---
# Set-AzSecurityAssessmentMetadata

## SYNOPSIS
Skapar eller uppdaterar en säkerhetsutvärderingstyp.
...
## BESKRIVNING
Skapar eller uppdaterar metadata för säkerhetsbedömning, kan användas för att skapa och hantera olika bedömningsegenskaper.
Efter den här åtgärden kommer du att kunna rapportera utvärderingsresultat för alla resurser i den här prenumerationen.
...
Skapa en ny bedömningstyp i en prenumeration.
...
### -Beskrivning
Detaljerad sträng som hjälper användarna att förstå innebörden av den här utvärderingen och hur den beräknades.
...
### -DisplayName
Det här objektets läsbara rubrik.
...
Detaljerad sträng som hjälper användarna att förstå olika sätt att minimera eller åtgärda säkerhetsproblemet.
...
### -Allvarlighetsgrad
Anger hur viktig säkerhetsrisken är om utvärderingen inte är fel.
