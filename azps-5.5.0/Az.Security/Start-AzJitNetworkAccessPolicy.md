...
## BESKRIVNING
Anropar en tillfällig nätverksåtkomstbegäran.
Begäran valideras mot den konfigurerade JIT-principen för nätverksåtkomst och om det är tillåtet öppnas en nätverksanslutning enligt användarens begäran.
Begäran loggas i principen för senare granskning och avslutas när den angivna varaktigheten överskrids.
...
Öppnar en nätverksanslutning i 1 timme via port 22 från min offentliga IP (visas inte).
