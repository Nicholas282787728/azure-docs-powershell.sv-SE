...
ms.locfileid: "100212678"
---
# Get-AzAllowedConnection

## SYNOPSIS
Används för att visa tillåten trafik mellan resurser för prenumerationen
...
## BESKRIVNING
Hämtar listan med all möjlig trafik mellan resurser för prenumerationen och platsen, baserat på anslutningstyp.
