...
## BESKRIVNING
Hämtar säkerhetskontakter som har konfigurerats för den här prenumerationen.
Säkerhetskontakten kan få aviseringar om säkerhetsvarningar för prenumerationen.
...
Hämtar alla konfigurerade säkerhetskontakter i prenumerationen
