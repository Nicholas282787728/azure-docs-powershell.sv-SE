...
## BESKRIVNING
Med New-AzDeviceSecurityGroupTimeWindowRuleObject-cmdleten skapas en ny lista med aviseringsregler för tidsfönster för enhetens säkerhetsgrupp i IoT-säkerhetslösning.
...
Skapa en ny regel för ett tidsfönster från typen "ActiveConnectionsNotInAllowedRange"
