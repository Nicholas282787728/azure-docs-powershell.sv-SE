...
## BESKRIVNING
Tar bort en princip för bara i tid-nätverksåtkomst.
Efter den här åtgärden kan en användare inte begära tillfällig nätverksanslutning på de virtuella maskinerna som har konfigurerats i principen borttagna.
