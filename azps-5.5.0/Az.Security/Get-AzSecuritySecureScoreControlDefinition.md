...
ms.locfileid: "100223207"
---
# Get-AzSecuritySecureScoreControlDefinition

## SYNOPSIS
Får definitioner av säkerhetssäkerhetspoängkontroll för en prenumeration
...
Får alla definitioner av säkerhetssäkerhetspoängkontroll i en prenumeration
