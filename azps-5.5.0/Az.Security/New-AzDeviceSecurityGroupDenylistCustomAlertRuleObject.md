...
## BESKRIVNING
Med New-AzDeviceSecurityGroupDenylistCustomAlertRuleObject-cmdleten skapas en ny lista över nekade anpassade aviseringsregler för enhetens säkerhetsgrupp i IoT-säkerhetslösning.
...
Skapa ny anpassad aviseringsregel för nekad lista med rulltyp "SomeRuleType" och status inställd på desable
