...
ms.locfileid: "100253120"
---
# Remove-AzSecurityAssessment

## SYNOPSIS
Tar bort ett säkerhetsutvärderingsresultat från en prenumeration.
...
## BESKRIVNING
Tar bort ett säkerhetsutvärderingsresultat från en prenumeration, som vanligtvis används när en resoruce tas bort eller när utvärderingen inte längre är relevant för en viss resurs
...
Tar bort ett utvärderingsresultat för en prenumeration
