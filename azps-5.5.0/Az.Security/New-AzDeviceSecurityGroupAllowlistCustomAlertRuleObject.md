...
## BESKRIVNING
Med New-AzDeviceSecurityGroupAllowlistCustomAlertRuleObject-cmdleten skapas en ny lista med tillåtna anpassade aviseringsregler för enhetens säkerhetsgrupp i IoT-säkerhetslösning.
...
Skapa en ny anpassad avisering för lista över tillåtna av typen "LocalUserNotAllowed" med status inställd på inaktiverad
