...
## BESKRIVNING
Med den här cmdleten kan du upptäcka den konfigurerade arbetsytan som innehåller säkerhetsdata som samlades in av säkerhetsagenten som är installerad i virtuella maskiner i den här prenumerationen.
...
Hämtar inställningar för arbetsytan för en prenumeration.
