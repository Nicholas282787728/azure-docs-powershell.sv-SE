...
ms.locfileid: "100223254"
---
# Get-AzSecurityPricing

## SYNOPSIS

Hämtar Azure Defender-abonnemangen för en prenumeration i Azure Säkerhetscenter.
...
Du kan visa varje Azure Defender-abonnemang per prenumeration med hjälp av den här cmdleten.
...
Får status för varje Azure Defender-abonnemang för prenumerationen.
...
Hämtar prisinformation för det specifika resurs-ID:t. Där ResourceId är ett av de ID som returneras `Get-AzSecurityPricing` av.
...
Hämtar prisinformation för det namngivna Azure Defender-abonnemanget. Var `name` finns ett av namnen som returneras av `Get-AzSecurityPricing` .
