...
ms.locfileid: "100217623"
---
# Set-AzSecuritySetting

## SYNOPSIS
Uppdatera en säkerhetsinställning i Azure Säkerhetscenter
...
## BESKRIVNING
Den Set-AzSecuritySetting cmdleten uppdaterar en specifik säkerhetsinställning i Azure Säkerhetscenter.
...
Uppdaterar en inställning för MCAS-dataexport   
...
### -SettingKind
Inställnings sort. (DataExportSettings)
