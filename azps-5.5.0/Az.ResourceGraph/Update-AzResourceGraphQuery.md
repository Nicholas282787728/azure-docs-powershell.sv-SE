...
ms.locfileid: "100210438"
---
# Update-AzResourceGraphQuery

## SYNOPSIS
Uppdaterar en diagramfråga som redan har lagts till.
...
### Exempel 1: Uppdatera parameterfrågan och tagga efter namn
```powershell
...
Det här kommandot uppdaterar parameterfrågan och taggen efter namn.

### Exempel 2: Uppdatera parameterfilen efter objekt
```powershell
...
Det här kommandot uppdaterar parameterfrågan och tagga efter objekt.
...
### -Beskrivning
Beskrivning av en diagramfråga.
...
### -Query
KQL-fråga som ska vara diagram.
