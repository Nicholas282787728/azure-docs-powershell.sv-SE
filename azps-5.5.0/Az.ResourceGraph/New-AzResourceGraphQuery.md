...
ms.locfileid: "100210486"
---
# New-AzResourceGraphQuery

## SYNOPSIS
Skapa en ny diagramfråga.
...
### Exempel 1: Skapa en resursdiagramfråga med frågeparametern
```powershell
...
Med det här kommandot skapas en resursdiagramfråga av frågeparametern.

### Exempel 2: Skapa en resursdiagramfråga med filparametern
```powershell
...
Med det här kommandot skapas en resursdiagramfråga av filparametern.
