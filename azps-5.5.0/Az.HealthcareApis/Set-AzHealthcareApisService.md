...
ms.locfileid: "100226543"
---
# Set-AzHealthcareApisService

## SYNOPSIS
Uppdaterar en befintlig sjukvårdsapis fhir-tjänst.
...
### Exempel 1: Uppdaterar den befintliga sjukvårdstjänsten med namnet MyService i resursgruppen MyResourceGroup med offerThroughput -databasen = 500.
...
### Exempel 2: Uppdaterar den befintliga sjukvårdstjänsten med namnet MyService i resursgruppen MyResourceGroup med offerThroughput - 500 och nyckelvalvsnyckeln uri "https:// \<my-keyvault> .vault.azure.net/keys/ \<my-key> "
...
Lista över objekt-ID:er för åtkomstprinciper.
...
### -CorsHeader
HealthcareApis FhirService List med Cors Headers.
Ange HTTP-rubriker som kan användas under begäran.
...
Ange hur länge ett resultat från en begäran kan cachelagras i sekunder.
Exempel: 600 innebär 10 minuter.
...
### -CorsMethod
HealthcareApis FhirService List över Cors-metoder.
...
Ange URL:er för ursprungswebbplatser som kan komma åt detta API, eller använd " * " för att tillåta åtkomst från en webbplats.
...
### -KeysKeyVaultKeyUri
HealthcareApis Fhir Service EllersKeyVaultKeyUri.
URI:en för den kund hanterade nyckeln för backingdatabasen.
...
### -OfferThroughput
HealthcareApis FhirService OchsOfferThroughput.
...
### -Disable SmartProxy
HealthcareApis FhirService Disable SmartProxy.
...
### -Enable SmartProxy
HealthcareApis FhirService Enable SmartProxy.
...
### -InputObject
HealthcareApis fhir service piped from Get-AzHealthserviceApisFhirService.
...
### -PublicNetworkAccess
Nätverksåtkomsttypen för Fhir-tjänsten. Ofta `Enabled` eller `Disabled` .
...
### -ResourceGroupName
Namn på resursgrupp för sjukvårdapistjänst.
...
### Microsoft.Azure.Commands.HealthcareApis.Models.PSHealthserviceApisService
