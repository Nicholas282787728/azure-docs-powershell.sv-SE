...
## BESKRIVNING
Får befintliga sjukvårdskonton för hir-tjänster som skapats inom den angivna prenumerationen eller en resursgrupp.
...
Hämtar metadata för alla Sjukvårdsapis-tjänster i den angivna resursgruppen.
...
Hämtar metadata för alla Sjukvårdsapis-tjänster i den givna prenumerationen
