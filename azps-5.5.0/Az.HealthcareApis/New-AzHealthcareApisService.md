...
ms.locfileid: "100230335"
---
# New-AzHealthcareApisService

## SYNOPSIS
Skapar metadata för en tjänstinstans.
...
## BESKRIVNING
Skapar eller uppdaterar metadata för en tjänstinstans.

## EXEMPEL

### Exempel 1: Skapar en ny Azure healthcareapis fhir-tjänst med namnet MyService i resursgruppen MyResourceGroup på en plats westus2 med s.k. offer throughput = 400
```powershell
...
### Exempel 2: Skapar en ny Azure healthcareapis fhir-tjänst med namnet MyService i resursgruppen MyResourceGroup på en plats westus2 med s.k. offer throughput = 400 och nyckelvalvsnyckeln uri "https:// \<my-keyvault> .vault.azure.net/keys/ \<my-key> "
```powershell
...
### -OfferThroughput
HealthcareApis Fhir Service OchsOfferThroughput.
...
### -Enable SmartProxy
HealthcareApis Fhir Service Enable SmartProxy.
...
### -Typ
Typ av Sjukvårdsservice.
Standardvärdet är Hir
