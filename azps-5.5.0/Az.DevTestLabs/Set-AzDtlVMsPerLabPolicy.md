...
ms.locfileid: "100228566"
---
# Set-AzDtlVMsPerLabPolicy

## SYNOPSIS
Anger virtuella maskiner per labprincip för ett labb i DevTest Labs.
...
## BESKRIVNING
Den **AzDtlVMsPerLabPolicy-cmdleten Set-AzDtlVMsPerLabPolicy** ställer in virtuella maskiner per labprincip för ett labb, vilket anger det totala antalet virtuella maskiner som tillåts i ett lab.
...
### -Disable
Anger att denna cmdlet inaktiverar labprincipen.
...
### -Enable
Anger att denna cmdlet aktiverar principen för labbet.
...
### -LabName
Anger namnet på det lab som den här cmdleten anger virtuella maskiner per labprincip.
...
### -MaxVMs
Anger det maximala antalet virtuella datorer som kan skapas i labbet.
