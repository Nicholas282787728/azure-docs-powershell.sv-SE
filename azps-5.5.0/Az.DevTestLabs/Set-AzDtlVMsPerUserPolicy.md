...
## BESKRIVNING
Cmdleten **Set-AzDtlVMsPerUserPolicy** anger virtuella maskiner per användarprincip för ett labb, vilket anger det maximala antalet virtuella maskiner per användare.
...
### -Disable
Anger att denna cmdlet inaktiverar principen för labbet.
...
### -Enable
Anger att den här cmdleten aktiverar principen för labbet.
...
### -LabName
Anger namnet på det lab som den här cmdleten anger virtuella datorer per användarprincip.
