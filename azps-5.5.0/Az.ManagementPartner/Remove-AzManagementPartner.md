...
ms.locfileid: "100219199"
---
# Remove-AzManagementPartner

## SYNOPSIS
Ta bort Microsoft Partner Network(MPN)-ID för den aktuella autentiserade användaren eller tjänstens huvudnamn.
