...
ms.locfileid: "100214326"
---
# Set-AzMarketplaceTerms

## SYNOPSIS
Acceptera eller avvisa villkor för ett visst utgivar-ID(Publisher), erbjudande-ID(Produkt) och abonnemangs-ID(Namn). Använd Get-AzMarketplaceTerms för att få avtalsvillkoren.
...
## BESKRIVNING
Cmdleten **Set-AzMarketplaceTerms** sparar termobjektet för ett visst utgivar-ID(Publisher), offer id(Product) och plan-id(Name).

## EXEMPEL

### Exempel 1
Avtal för marketplace-utgivare
...
### Exempel 2
Ställ in utgivareavtalet på Acceptera. Hämta värdet för parametern Villkor från cmdleten Get-AzMarketplaceTerms
...
### -Acceptera
Godkänn de juridiska villkoren.
...
### -InputObject
Termobjekt som returneras Get-AzMarketplaceTerms cmdlet. Det här är en obligatorisk parameter om godkänd parameter är sant.
...
### -Name
Planidentifierarsträng för bild som distribueras.
...
### -Produkt
Erbjudande identifierarsträng för bild som distribueras.
...
### -Publisher
Identifierarsträng för bild som distribueras i Publisher.
...
### -Avvisa
Vidarebefordra detta för att avvisa de juridiska villkoren.
