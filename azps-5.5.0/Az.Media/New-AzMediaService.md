...
## BESKRIVNING
Cmdleten **New-AzMediaService** skapar en medietjänst.
Om medietjänsten redan finns uppdaterar den här cmdleten dess egenskaper.

## EXEMPEL

### Exempel1: Skapa en medietjänst endast med primärt lagringskonto
```
PS C:\># Variables
## Global
...
Det här exemplet visar hur du skapar en medietjänst med endast det primära lagringskontot.
Det här skriptet använder flera andra cmdlets.

### Exempel 2: Skapa en medietjänst med flera lagringsmedia
```
PS C:\># Variables
...
Det här exemplet visar hur du skapar en medietjänst med flera lagringskonton.
Det här skriptet använder flera andra cmdlets.

## PARAMETERS

### -AccountName
Anger namnet på medietjänsten som cmdleten skapar.
...
### -Plats
Anger i vilken region den här cmdleten skapar medietjänsten.
...
### -ResourceGroupName
Anger namnet på resursgruppen som medietjänsten är tilldelad till.
...
### -StorageAccountId
Anger det lagringskonto som är kopplat till medietjänstkontot.
...
### -StorageAccounts
Anger en matris med lagringskonton som ska associeras med medietjänsten.
...
### -Tag
Taggarna som är kopplade till medietjänstens konto.
