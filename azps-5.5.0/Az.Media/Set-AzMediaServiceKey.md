...
## BESKRIVNING
Set-AzMediaServiceKey-cmdleten återskapar en nyckel som används för åtkomst till **REST-slutpunkten** (Representational State Transfer) som är kopplad till medietjänsten.
