...
## BESKRIVNING
Cmdleten **Sync-AzMediaServiceStorageKey** synkroniserar lagringskontonycklar för ett lagringskonto som är kopplat till medietjänsten.

## EXEMPEL

### Exempel 1: Synkronisera lagringskontonycklar för ett lagringskonto som är kopplat till medietjänsten
```
...
Det första kommandot använder cmdleten Get-AzStorageAccount för att få lagringskontot Storage135 som tillhör ResourceGroup001 och lagrar resultatet i variabeln $StorageAccount.
Det andra kommandot synkroniserar lagringskontonycklarna för medietjänsten med  namnet MediaService001 med id-egenskapen som finns i $StorageAccount variabeln.

## PARAMETERS

### -AccountName
Anger namnet på medietjänsten som cmdleten synkroniserar.
...
### -StorageAccountId
Anger det lagringskonto-ID som är kopplat till medietjänstkontot.
