...
ms.locfileid: "100253700"
---
# Get-AzFunctionApp

## SYNOPSIS
Hämtar funktionsappar i en prenumeration.
...
### Exempel 1: Hämta alla funktionsappar.
```powershell
...
### Exempel 2: Hämta funktionsappar efter namn.
```powershell
...
### Exempel 3: Hämta funktionsappar efter resursgruppnamn.
```powershell
...
### Exempel 4: Hämta funktionsappar för de givna prenumerationerna.
```powershell
...
### Exempel 5: Hämta funktionsappar efter plats.
```powershell
...
### -IncludeSlot
Används för att ange om platser för distribution ska inkluderas i resultat.
