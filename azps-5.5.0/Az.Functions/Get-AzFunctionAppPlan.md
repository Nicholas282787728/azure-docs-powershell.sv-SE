...
ms.locfileid: "100226550"
---
# Get-AzFunctionAppPlan

## SYNOPSIS
Skaffa abonnemang för funktionsappar i en prenumeration.
...
### Exempel 1: Hämta alla funktionsappplaner.
```powershell
...
Med det här kommandot får du alla funktionsappplaner.

### Exempel 2: Hämta funktionsappplaner efter resursgruppnamn.
```powershell
...
Med det här kommandot returneras funktionsappplaner efter resursgruppnamn.

### Exempel 3: Hämta abonnemang för funktionsappen för de givna prenumerationerna.
```powershell
...
Det här kommandot hämtar abonnemang för funktionsappen för de givna prenumerationerna.

### Exempel 4: Hämta appplaner för funktioner efter plats.
```powershell
...
Det här kommandot hämtar abonnemang för funktionsappen efter plats.
...
### -Plats
Platsen för funktionsappens plan.
