...
ms.locfileid: "100253696"
---
# Get-AzFunctionAppAvailableLocation

## SYNOPSIS
Hämtar platsen där en funktionsapp för operativsystemet och abonnemangstypen finns tillgänglig.
...
Det här kommandot hämtar de platser där Premium är tillgängligt för Windows.

### Exempel 2: Hämta de platser där Premium är tillgängligt för Linux.
```powershell
...
Det här kommandot hämtar de platser där Premium är tillgängligt för Linux.
...
Med det här kommandot får du de platser där Förbrukning är tillgänglig för Windows.
...
### -PlanType
Plantypen.
Giltiga indata: Förbrukning eller Premium
