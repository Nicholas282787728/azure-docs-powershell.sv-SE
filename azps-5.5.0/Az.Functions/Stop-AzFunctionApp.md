...
ms.locfileid: "100252664"
---
# Stop-AzFunctionApp

## SYNOPSIS
Stoppar en funktionsapp.
...
### Exempel 1: Hämta en funktionsapp med namn och stoppa den.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Stop-AzFunctionApp -Force
```

Det här kommandot hämtar en funktionsapp efter namn och stoppar den.

### Exempel 2: Stoppa en funktionsapp efter namn.
```powershell
PS C:\> Stop-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName -Force
```

Med det här kommandot stoppas en funktionsapp efter namn.
...
### -Force
Tvingar cmdleten att stoppa funktionsappen utan att behöva bekräfta.
