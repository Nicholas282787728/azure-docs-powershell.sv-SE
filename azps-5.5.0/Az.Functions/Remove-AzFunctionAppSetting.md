...
ms.locfileid: "100222479"
---
# Remove-AzFunctionAppSetting

## SYNOPSIS
Tar bort appinställningarna från en funktionsapp.
...
### Exempel 1: Ta bort appinställningar i en funktionsapp.
```powershell
...
Med det här kommandot tas appinställningarna i en funktionsapp bort.

## PARAMETERS

### -AppSettingName
Lista över inställningar för funktionsappen som ska tas bort från funktionsappen.
...
### -Force
Tvingar cmdleten att ta bort funktionsappinställningen utan att bekräfta.
...
INPUTOBJECT: <ISite> 
  ...
  - `[Config <ISiteConfig>]`: Konfiguration av appen.
    ...
    - `[ActionMinProcessExecutionTime <String>]`: Den minsta tiden som processen måste köras innan åtgärden vidtas
    ...
    - `[SlowRequestTimeTaken <String>]`: Tidstagen.
