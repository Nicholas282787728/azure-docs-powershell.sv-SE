...
ms.locfileid: "100221751"
---
# Restart-AzFunctionApp

## SYNOPSIS
Startar om en funktionsapp.
...
### Exempel 1: Hämta en funktionsapp med namn och starta om den.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Restart-AzFunctionApp -Force
```

Med det här kommandot får du en funktionsapp med namn och startar om den.

### Exempel 2: Starta om en funktionsapp efter namn.
```powershell
PS C:\> Restart-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName -Force
```

Med det här kommandot startas en funktionsapp om efter namn.
...
### -Force
Tvingar cmdleten att starta om funktionsappen utan att behöva bekräfta.
