...
# AZS. Commerce. admin
## Problembeskrivning
För hands version av AzureStack Commerce operatörs modul som du kan använda för att Visa mängd data användning i din AzureStack-stämpel.

## AZS. Commerce. admin-cmdletar
