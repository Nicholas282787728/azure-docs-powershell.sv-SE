...
## PROBLEMBESKRIVNING
Cmdleten **New-AzFirewallPolicyNatRule** skapar en NAT-regel för en Azure Firewall-princip.
...
I det här exemplet skapas en NAT-regel med käll adress, protokoll, mål adress, målport, översatt adress och översatt port.
...
I det här exemplet skapas en NAT-regel med käll adress, protokoll, mål adress, målport, översatt FQDN och översatt port.
...
### -DestinationAddress
Mål adresser för regeln. Detta måste vara en offentlig IP-brand vägg.
...
### -Namn
Namnet på listan över NAT-regler
...
### -TranslatedAddress
Den översatta adressen för denna NAT-regel
...
### -TranslatedPort
Den översatta porten för denna NAT-regel
