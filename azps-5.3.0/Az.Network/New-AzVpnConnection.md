...
Ovanstående skapar en resurs grupp, virtuellt WAN, virtuellt nätverk, virtuellt nav och en VpnSite med 1 VpnSiteLinks i västra USA i resurs gruppen "testRG" i Azure.
En VPN-gateway skapas därefter i det virtuella navet.
När gatewayen har skapats är den ansluten till VpnSite med hjälp av kommandot New-AzVpnConnection med 1 VpnSiteLinkConnections till VpnSiteLink för VpnSite.
...
Bandbredden som måste hanteras av den här anslutningen i Mbps.
...
Aktivera Internet säkerhet för den här anslutningen
...
### -SharedKey
Den delade nycklar som krävs för att konfigurera den här anslutningen.
...
Använd lokal Azure-IP-adress som käll adress när anslutningen upprättas.
...
Använd principbaserad Traffic Selector för den här anslutningen.
...
Gateway-anslutnings protokoll: IKEv1/IKEv2
...
### -VpnSite
VPN-webbplatsen som den här nav-nätverks anslutningen är ansluten till.
...
Listan med VpnSiteLinkConnections som denna VpnConnection har.
