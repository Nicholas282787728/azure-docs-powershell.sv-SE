...
New-AzVirtualHubVnetConnection cmdlet skapar en HubVirtualNetworkConnection-resurs som peererar ett virtuellt nätverk med det virtuella Azure-navet. (automatiskt genererat)
...
```
Ovanstående skapar en ny konfigurering av Routning och skapar statiska vägar i konfigurationen för routning med nästa hopp som angiven IP-adress. Denna konfiguration av routning kan sedan överföras till kommandot New-AzVirtualHubVnetConnection som parametern-RoutingConfiguration.
