...
## PROBLEMBESKRIVNING
Cmdleten **Deny-AzPrivateEndpointConnection** nekar en privat slut punkts anslutning.
...
Det här exemplet nekar en privat slut punkts anslutning.
...
### -ServiceName
Namnet på tjänsten som den privata slut punkts anslutningen tillhör.
