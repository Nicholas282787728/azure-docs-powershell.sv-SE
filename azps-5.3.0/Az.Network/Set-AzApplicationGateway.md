...
## PROBLEMBESKRIVNING
Cmdleten **set-AzApplicationGateway** uppdaterar en Azure Application Gateway.
...
Dessa kommandon uppdaterar programgatewayen med inställningarna i $AppGw variabel och lagrar den uppdaterade gatewayen i $UpdatedAppGw-variabeln.
