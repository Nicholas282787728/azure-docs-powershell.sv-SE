...
## Sammanfattning
Lägger till en kedja med betrodda klient certifikat utfärdare till en Programgateway.
...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzApplicationGatewayTrustedClientCertificate** lägger till en betrodd klient certifikat utfärdares certifikat kedja till en Azure Application Gateway.
...
Med det första kommandot hämtas programgatewayen och lagras i $gw variabel. Det andra kommandot skapar en ny kedja av certifikat certifikat utfärdare som tar vägen till klient certifikat utfärdarens certifikat som indata. Det tredje kommandot skapar en SSL-profil med certifikat för betrodda klienter. Det fjärde kommandot uppdaterar programgatewayen.
