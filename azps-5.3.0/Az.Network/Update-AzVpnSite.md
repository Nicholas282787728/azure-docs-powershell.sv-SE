...
### ByVpnSiteNameNoVirtualWanUpdate (standard)
```
...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzVpnSite** uppdaterar en VPN-webbplats.
...
När webbplatsen har skapats uppdaterar den IpAddress för webbplatsen med kommandot Set-AzVpnSite.

## MALLPARAMETRAR

### -AddressSpace
Adressprefix för det virtuella nätverket.
Använd den här eller AddressSpaceObject, men inte båda.
...
### -ResourceId
Azure Resource ID för VPN-webbplatsen.
