...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzApplicationGatewayRedirectConfiguration** lägger till en konfiguration för omdirigering till en Programgateway.
...
Det andra kommandot lägger till omdirigeringsvariabler i programgatewayen.

### Exempel 2

Lägger till en konfiguration för omdirigering till en Programgateway. (automatiskt genererat)
