...
## Sammanfattning
Påbörjar paket registrerings åtgärd på en VPN-gateway.
...
### -FilterData
Filter alternativ för start paket avbildning på VPN gateway.
...
### -Namn
Namnet på den VPN-gateway där Packet Capture ska startas.
...
[Stopp-AzVpnGatewayPacketCapture](./Stop-AzVpnGatewayPacketCapture.md)