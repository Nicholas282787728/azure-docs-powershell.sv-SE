...
## PROBLEMBESKRIVNING
Cmdleten **New-AzExpressRouteCircuit** skapar en Azure Express Route-kretsen.
...
### -BandwidthInGbps
Bandbredden för kretsen när kretsen etableras på en ExpressRoutePort-resurs.
...
### -ServiceProviderName
Namnet på kretskorts tjänste leverantören. Måste matcha ett namn som visas i Get-AzExpressRouteServiceProvider cmdlet.
...
### -SkuTier
Tjänst nivån för kretsen. Möjliga värden för den här parametern är: `Standard` , `Premium` eller `Local` .
