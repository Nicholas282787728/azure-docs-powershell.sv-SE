...
## PROBLEMBESKRIVNING
Cmdleten **New-AzPrivateLinkService** skapar en privat länk tjänst

## BESKRIVS

### Exempel 1

I följande exempel skapas en privat länk tjänst.
...
### -Autogodkännande
Automatiska godkännande abonnemang för privata länkar
...
### -EnableProxyProtocol
Aktivera Proxy Protocol för den privata länk tjänsten.
...
Klient konfigurationerna front
...
### -Synlighet
Synlighets abonnemang för privat länk tjänst
