...
## PROBLEMBESKRIVNING
Cmdleten **New-AzApplicationGatewayRewriteRuleActionSet** skapar en åtgärd för att skriva om en regel för en Azure Application Gateway.
...
Det här kommandot skapar en instruktion för att skriva om en regel och lagrar resultatet i variabeln som heter $action.
...
Lista med konfigurationer för begärandehuvuden
...
Lista med konfigurationer för svarshuvuden
...
### -UrlConfiguration
URL-konfiguration för åtgärds uppsättning
...
### Microsoft. Azure. commands. Networks. Models. PSApplicationGatewayRewriteRuleActionSet
