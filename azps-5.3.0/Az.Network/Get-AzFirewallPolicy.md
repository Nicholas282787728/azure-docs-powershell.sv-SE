...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzFirewallPolicy** hämtar en eller flera brand väggar i en resurs grupp
...
I det här exemplet får du en brand Väggs princip med namnet "firewallPolicy" i resurs gruppen "TestRg"
