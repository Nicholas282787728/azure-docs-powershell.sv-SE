...
## PROBLEMBESKRIVNING
Med den här New-AzRadiusServer cmdleten skapar du en extern RADIUS-serverkonfiguration för att använda den virtuella Nätverksgatewayen och VPN-serverkonfigurationen.
...
Skapa flera externa RADIUS-serverkonfigurationer som ska användas för att konfigurera P2S på en ny virtuell nätverksgateway.
...
### -RadiusServerScore
Poäng för extern RADIUS-server
...
### Microsoft. Azure. commands. Networks. Models. PSRadiusServer
