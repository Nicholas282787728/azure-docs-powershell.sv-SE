...
## PROBLEMBESKRIVNING
Cmdleten **New-AzLoadBalancerFrontendIpConfig** skapar en front-IP-konfiguration för en Azure-belastningsutjämnare.
...
### Exempel 2: skapa en front-IP-konfiguration för belastningsutjämnaren med prefix
```
...
Det första kommandot skapar ett offentlig IP-prefix med namnet MyPublicIP med längden 28 i resurs gruppen med namnet MyResourceGroup och lagrar sedan den i $publicipprefix variabel.
Det andra kommandot skapar en front-IP-konfiguration med namnet FrontendIpConfig01 med hjälp av det offentliga IP-prefixet i $publicipprefix.
