...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzServiceEndpointPolicy** hämtar en policy för tjänst slut punkter.
...
Det här kommandot får en lista över alla tjänst slut punkts principer som börjar med "ServiceEndpointPolicy".
