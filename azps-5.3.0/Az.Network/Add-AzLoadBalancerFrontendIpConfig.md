...
### Exempel 4 lägga till en front-IP-konfiguration med ett offentlig IP-prefix
```
...
Det första kommandot får det offentliga Azure Public IP-prefixet MyPubPrefix och lagrar resultatet i variabeln som heter $PublicIpPrefix.
Det andra kommandot får belastningsutjämnaren med namnet MyLB och skickar resultatet till cmdleten **Add-AzLoadBalancerFrontendIpConfig** som lägger till en front-IP-konfiguration till belastningsutjämnaren med offentlig IP-prefix som lagras i variabeln som heter $PublicIpPrefix.
...
Anger det offentliga IP-adressprefix som ska kopplas till en front-IP-konfiguration.
...
Anger ID för det offentliga IP-adressprefixet objekt som ska kopplas till en front-IP-konfiguration.
