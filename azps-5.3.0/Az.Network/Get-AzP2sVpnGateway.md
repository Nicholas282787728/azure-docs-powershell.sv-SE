...
## PROBLEMBESKRIVNING
Med cmdleten **Get-AzP2sVpnGateway** kan du hämta en befintlig P2SVpnGateway under VirtualHub.
...
Med cmdleten **Get-AzP2sVpnGateway** kan du hämta en befintlig P2SVpnGateway under VirtualHub som används för att peka på webbplats anslutningar.
