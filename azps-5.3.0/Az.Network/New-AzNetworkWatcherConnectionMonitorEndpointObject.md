...
Namn: workspaceEndpoint: MMAWorkspaceMachine ResourceId:/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myresourceGroup/providers/Microsoft.OperationalInsights/workspaces/myworkspace adress: scope: {"include": [{"Address": "WIN-P0HGNDO2S1B"}]}
...
### -AzureSubnet
Slut punkts brytare för Azure under nätet.
...
### -AzureVM
Virtuell dator slut punkts brytare för Azure.
...
### -AzureVNet
Slut punkts brytare för Azure VNet.
...
### -CoverageLevel
Testa täckning för slut punkten.
Värden som stöds är standard, lågt, BelowAverage, Average, AboveAvergae, full.
...
### -ExcludeItem
Lista över objekt som ska undantas från slut punktens omfattning.
...
### -ExternalAddress
Slut punkts brytare för extern adress.
...
### -IncludeItem
Lista över objekt som måste ingå i endpont scope.
...
### -MMAWorkspaceMachine
Slut punkts brytare för MMA-arbetsyta.
...
### -MMAWorkspaceNetwork
Slut punkts brytare för nätverks MMA.
