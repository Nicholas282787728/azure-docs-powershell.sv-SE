...
## Sammanfattning
Skapar en IP-konfiguration som associeras med PrivateLink-konfigurationen
...
## PROBLEMBESKRIVNING
Cmdleten **New-AzApplicationGatewayPrivateLinkIpConfiguration** skapar en IP-konfiguration som associeras med PrivateLink-konfigurationen för en Azure Application Gateway.

## BESKRIVS

### Exempel 1: PrivateLink IP-konfiguration
```powershell
PS C:\> $PrivateLinkIpConfiguration = New-AzApplicationGatewayPrivateLinkIpConfiguration -Name "ipConfig01" -Subnet $subnet -Primary
```

Det här kommandot skapar en PrivateLink IP-konfiguration med namnet "ipConfig01" lagrar resultatet i variabeln som heter $PrivateLinkIpConfiguration. 
...
### -Primär
Ange att IP-konfigurationen är primär.
...
### -PrivateIpAddress
Den privata IP-adressen för ipConfiguration om statisk tilldelning önskas.
...
### Microsoft. Azure. commands. Networks. Models. PSApplicationGatewayPrivateLinkIpConfiguration
