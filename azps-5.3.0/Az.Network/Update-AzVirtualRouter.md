...
## PROBLEMBESKRIVNING
Uppdaterar virtuell router för att aktivera eller inaktivera gren till gren trafik.
...
Uppdaterar den virtuella routern för att tillåta filial till gren trafik
...
Uppdaterar den virtuella routern för att blockera gren till gren trafik

## MALLPARAMETRAR

### -AllowBranchToBranchTraffic
Flagga för att tillåta filial till gren trafik för virtuell router.
...
### -ResourceId
ResourceId för den virtuella routern.
