...
### Exempel 3: skaffa nätverks gränssnitt med filter
```
...
Det här kommandot får alla nätverks gränssnitt för det aktuella abonnemanget som börjar med "test".
...
### -ResourceId
Azure Resource Manager-ID för nätverks gränssnittet.
