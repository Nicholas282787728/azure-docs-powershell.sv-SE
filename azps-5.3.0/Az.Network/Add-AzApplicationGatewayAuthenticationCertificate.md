...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzApplicationGatewayAuthenticationCertificate** lägger till ett autentiseringscertifikat i en Azure Application Gateway.

## BESKRIVS

### Exempel 1: lägga till autentiseringscertifikat i en Programgateway
```
...
Det andra kommandot lägger till autentiseringscertifikatet med namnet cert01 i programgatewayen.
Det tredje kommandot uppdaterar programgatewayen.

## MALLPARAMETRAR

### -ApplicationGateway
Anger namnet på den Programgateway som denna cmdlet lägger till ett autentiseringscertifikat för.
...
### -CertificateFile
Anger sökvägen för det autentiseringscertifikat som denna cmdlet lägger till.
...
### -Namn
Anger namnet på ett certifikat som denna cmdlet lägger till i programgatewayen.
