...
Först skapar vi ett objekt för virtuell hubb och använder det för att skapa en tabell resurs för virtuell hubb. Därefter angav vi den här väg tabell resursen till det virtuella navet med kommandot Set-AzVirtualHub.
...
### -RouteTable
De väg tabeller som är kopplade till det virtuella navet.
