...
### Exempel 1: Hämta PostgreSql Server replik efter resurs grupp och Server namn
```powershell
...
Denna cmdlet får PostgreSql Server replik efter resurs grupp och Server namn.
