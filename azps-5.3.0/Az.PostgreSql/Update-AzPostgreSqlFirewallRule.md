...
### Exempel 1: uppdatera PostgreSql brand Väggs regel efter namn
```powershell
...
Denna cmdlet uppdaterar PostgreSql efter namn.

### Exempel 2: uppdatera PostgreSql brand Väggs regel efter identitet.
```powershell
...
Dessa cmdletar uppdaterar PostgreSql brand Väggs regel efter identitet.

### Exempel 3: uppdatera PostgreSql brand Väggs regel by-ClientIPAddress.
```powershell
...
Dessa cmdletar uppdaterar PostgreSql Firewall by-ClientIPAddress.
