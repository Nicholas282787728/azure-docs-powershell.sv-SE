...
### Exempel 1: uppdatera PostgreSql-konfigurationen utifrån namn
```powershell
...
Denna cmdlet uppdaterar PostgreSql-konfigurationen efter namn.

### Exempel 2: uppdatera PostgreSql-konfigurationen efter identitet.
```powershell
...
Dessa cmdletar uppdaterar PostgreSql-konfigurationen efter identitet.
...
### Microsoft. Azure. PowerShell. cmdletar. PostgreSql. Models. Api20171201. IConfiguration
