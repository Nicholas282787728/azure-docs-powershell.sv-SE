...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSentinelIncident** tar bort en incident permanent från en angiven arbets yta.
Du kan skicka ett **incident** objekt med hjälp av en pipeline-operator eller så kan du ange de parametrar som krävs.
...
Det här kommandot tar bort incidenten från arbets ytan.
