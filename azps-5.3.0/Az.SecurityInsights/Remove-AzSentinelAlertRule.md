...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSentinelAlertRule** tar permanent bort en notifieringsregel från en angiven arbets yta.
Du kan skicka ett **AlertRule** -objekt med pipeline-operatorn eller så kan du ange de parametrar som krävs.
