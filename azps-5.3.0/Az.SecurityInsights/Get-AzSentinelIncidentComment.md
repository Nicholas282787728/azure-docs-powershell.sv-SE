...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSentinelIncidentComment** får en incident kommentar från den angivna arbets ytan.
Om du anger parametrarna *IncidentCommentId* och *IncidentId* returneras ett enskilt **IncidentComment** -objekt.
Om du inte anger parametern *IncidentCommentId* returneras en matris med alla incident kommentarer för den angivna incidenten på den angivna arbets ytan.
...
I det här exemplet hämtas alla **IncidentComments** för angiven incident på den angivna arbets ytan och sparas sedan i $IncidentComments variabel.
...
Det här exemplet får en **IncidentComment** för den angivna incidenten på den angivna arbets ytan och lagrar den sedan i $IncidentComment variabel.
