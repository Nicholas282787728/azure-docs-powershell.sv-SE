...
## PROBLEMBESKRIVNING
Cmdleten **New-AzSentinelIncident** skapar en incident från den angivna arbets ytan.
...
I det här exemplet skapas en **incident** på den angivna arbets ytan och den lagras sedan i $incident variabel.
