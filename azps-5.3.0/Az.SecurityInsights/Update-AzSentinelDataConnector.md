...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzSentinelDataConnector** uppdaterar data kopplingen på den angivna arbets ytan.
Du kan skicka ett **DataConnector** -objekt som en parameter eller med hjälp av pipeline-operatorn eller så kan du ange de parametrar som krävs.
...
Kommandot hämtar data kopplingen genom *DataConnectorId* och anger läget för *aviseringar* till *inaktive rad*.  Alla andra egenskaper förblir desamma.
