...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSentinelDataConnector** tar bort en data koppling permanent från en angiven arbets yta.
Du kan skicka ett **DataConnector** -objekt med pipeline-operatorn eller så kan du ange de parametrar som krävs.
...
Det här kommandot tar bort DataConnector från arbets ytan.
