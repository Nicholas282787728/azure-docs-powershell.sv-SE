...
De två första kommandona använder [New-AzAutoscaleRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscalerule) för att skapa två Autoskala-regler, $Rule 1 och $Rule 2.
De tredje och fjärde kommandona använder [nya-AzAutoscaleProfile](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscaleprofile) för att skapa autoskale profiler, $Profile 1 och $Profile 2, med hjälp av $Rule 1 och $Rule 2.
...
### System. Collections. Generic. list ' 1 [[Microsoft. Azure. Management. Monitoring. Management. Models. AutoscaleNotification, Microsoft. Azure. PowerShell. cmdletar. Monitor, version = 1.0.0.0, Culture = neutralt, PublicKeyToken = null]]
