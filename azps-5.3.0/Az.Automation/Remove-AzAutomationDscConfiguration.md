...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzAutomationDscConfiguration** tar bort DSC-konfigurationer (Desired State Configuration) från Azure Automation.

## BESKRIVS

### Exempel 1

Tar bort DSC-konfigurationer från Automation. (automatiskt genererat)
...
Anger namnet på det Automation-konto som innehåller DSC-konfigurationer som den här cmdleten tar bort.
...
### -Namn
Anger namnet på den DSC-konfiguration som denna cmdlet tar bort.
