...
### Exempel 7: generera en KEK för nyckeln "skaffa en egen nyckeln" (BYOK)

```powershell
PS C:\> $key = Add-AzKeyVaultKey -VaultName $vaultName -Name $keyName -Destination HSM -Size 2048 -KeyOps "import"
```

Skapar en snabb kurs (kallas KEK). KEK måste vara en RSA-HSM som bara har åtgärden Importera. Endast nyckel valv Premium SKU har stöd för RSA-HSM-nycklar.
...
- Logga in
- kontroll
- Importera (endast för KEK, se exempel 7)
