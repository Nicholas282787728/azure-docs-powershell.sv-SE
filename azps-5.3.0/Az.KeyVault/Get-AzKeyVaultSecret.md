...
Cmdleten returnerar hemligheten som en sträng när `-AsPlainText` används.
...
### -Klar text
När den är aktive rad konverteras hemligheten i en säker sträng till den dekrypterade oformaterade text strängen som utdata.
