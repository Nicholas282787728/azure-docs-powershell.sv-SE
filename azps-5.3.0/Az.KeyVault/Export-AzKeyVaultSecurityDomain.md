...
## PROBLEMBESKRIVNING
Exporterar säkerhets domän data för en hanterad HSM för import på en annan HSM.
...
Det här kommandot hämtar den hanterade HSM som heter testmhsm och sparar en säkerhets kopia av den hanterade HSM-säkerhets domänen i den angivna utdatafilen.

## MALLPARAMETRAR

### -Certifikat
Sökvägar till de certifikat som används för att kryptera säkerhets domän data.
...
### -Force
Ange om du vill skriva över den befintliga filen.
...
### -OutputPath
Ange sökvägen till säkerhets domän data som ska hämtas till.
...
### -Kvorum
Det minsta antalet resurser som behövs för att dekryptera säkerhets domänen för återställning.
