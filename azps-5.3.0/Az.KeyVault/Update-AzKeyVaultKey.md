...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzKeyVaultKey** uppdaterar de redigerbara attributen för en Key i ett nyckelord.
...
### -Version
Huvud version.
Cmdlet konstruerar FQDN för en Key från valv namnet, den valda miljön, namn och huvud version.
