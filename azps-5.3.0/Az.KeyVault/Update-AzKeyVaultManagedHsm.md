...
## PROBLEMBESKRIVNING
Denna cmdlet uppdaterar tillståndet för en Azure Managed HSM.

## BESKRIVS

### Exempel 1: uppdatera en hanterad HSM direkt
```powershell
...
Uppdaterar taggar för den hanterade HSM som heter `$hsmName` i resurs gruppen `$resourceGroupName` .

### Exempel 2: uppdatera en hanterad HSM med hjälp av
```powershell
...
Uppdaterar taggar för hanterad HSM med rör-syntax.
