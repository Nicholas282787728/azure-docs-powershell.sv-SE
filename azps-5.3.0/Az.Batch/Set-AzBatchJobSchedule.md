...
## PROBLEMBESKRIVNING
Cmdleten **set-AzBatchJobSchedule** anger ett schema i Azure Batch-tjänsten.

## BESKRIVS

### Exempel 1: uppdatera ett jobb schema
```
...
Det första kommandot får jobbet genom att använda **Get-AzBatchJobSchedule** och lagrar det sedan i $JobSchedule variabel.
Det andra kommandot ändrar upprepnings intervallet för `$JobSchedule.Schedule` objektet.
Det sista kommandot uppdaterar kommando tjänsten för att matcha det lokala objektet i $JobSchedule.
...
För att hämta ett **PSCloudJobSchedule** -objekt, Använd cmdleten Get-AzBatchJobSchedule.
