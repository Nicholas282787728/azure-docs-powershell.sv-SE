...
## PROBLEMBESKRIVNING
Cmdleten **set-AzOperationalInsightsWorkspace** ändrar arbets ytans konfiguration.
...
Det här kommandot använder cmdleten Get-AzOperationalInsightsWorkspace för att hämta arbets ytan som heter min arbets yta och skickar den till cmdleten **set-AzOperationalInsightsWorkspace** genom att använda pipeline-operatorn för att ange SKU till Premium.
