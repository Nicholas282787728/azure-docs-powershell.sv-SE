...
## PROBLEMBESKRIVNING
Cmdleten **Invoke-AzOperationalInsightsQuery** returnerar Sök resultaten baserat på angivna parametrar.
...
Kontrol lera att det allmänna antalet frågor är begränsat https://docs.microsoft.com/en-us/azure/azure-monitor/service-limits#log-queries-and-language här:
...
### Exempel 2: konvertera $results. Generera IEnumerable till en matris
```
PS C:\> $queryResults = Invoke-AzOperationalInsightsQuery -WorkspaceId "63613592-b6f7-4c3d-a390-22ba13102111" -Query "union * | take 10"
