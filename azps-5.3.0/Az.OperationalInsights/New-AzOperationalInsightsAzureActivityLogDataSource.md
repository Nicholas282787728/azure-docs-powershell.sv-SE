...
## PROBLEMBESKRIVNING
New-AzOperationalInsightsAzureActivityLogDataSource Aktivera logg analys för att samla in Azure aktivitets logg från angiven prenumeration.
...
### -BackfillStartTime
Du kan välja att använda alla slutfyllnings loggar från en vecka sedan.
