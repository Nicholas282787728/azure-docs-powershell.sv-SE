...
## PROBLEMBESKRIVNING
**New-AzOperationalInsightsLinuxSyslogDataSource** cmdlet lägger till en syslog-datakälla på anslutna Linux-datorer på en arbets yta.
Användnings information för Azure kan samla in syslog-data.

## BESKRIVS

### Exempel 1: skapa syslog-datakällor
```
$FacilityNames       = @()
$FacilityNames      += 'auth'
...
### -CollectAlert
Anger att operativa insikter samlar in aviseringar.
...
### -CollectCritical
Visar att operativa insikter samlar in kritiska meddelanden.
...
### -CollectDebug
Anger att operativa insikter samlar in fel söknings meddelanden.
...
### -CollectEmergency
Anger att funktions insikter samlar in nödsamtal.
...
### -CollectInformational
Visar att operativa insikter samlar in informations meddelanden.
...
### -CollectNotice
Visar att operativa insikter samlar in meddelanden.
...
### -CollectWarning
Anger att syslog inkluderar varnings meddelanden.
