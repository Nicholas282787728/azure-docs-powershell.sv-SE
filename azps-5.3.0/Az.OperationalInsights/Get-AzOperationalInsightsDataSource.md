...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzOperationalInsightsDataSource** hämtar data källor.
Du kan ange en data källa att hämta.
Du kan filtrera resultaten baserat på typen av data källa.
...
### -Sort
Anger vilken typ av data källor som ska visas.
...
### -Namn
Anger namnet på en data källa som ska visas.
...
### -ResourceGroupName
Anger namnet på en resurs grupp som innehåller data källor som ska visas.
