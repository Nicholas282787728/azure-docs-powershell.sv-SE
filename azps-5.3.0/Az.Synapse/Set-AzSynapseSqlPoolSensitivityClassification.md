...
## Sammanfattning
Anger etiketterna för informations typer och känslighet för kolumner i SQL-poolen.
...
## PROBLEMBESKRIVNING
I Set-AzSynapseSqlPoolSensitivityClassification cmdlet anges etiketterna för informations typer och känslighet för kolumner i SQL-poolen.

## BESKRIVS

### Exempel 1: Ange informations typ och känslighets etikett för en kolumn i en Azure Synapse SQL-pool.
```powershell
...
### Exempel 2: Ange rekommenderade informations typer och känslighets etiketter för kolumner i en Azure Synapse SQL-pool.
```powershell
...
### Exempel 3: Ange informations typ och känslighets etikett för en kolumn i en Azure Synapse SQL-pool, med dragning.
```powershell
