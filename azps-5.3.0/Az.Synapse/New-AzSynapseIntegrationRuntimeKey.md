...
### NewByNameParameterSet (standard)
```
...
## PROBLEMBESKRIVNING
Cmdlet **New-AzSynapseIntegrationRuntimeKey** återskapar integrerings körnings nyckeln med det nycklar som anges med parametern "värde namn". Den föregående knappen är ogiltig.
