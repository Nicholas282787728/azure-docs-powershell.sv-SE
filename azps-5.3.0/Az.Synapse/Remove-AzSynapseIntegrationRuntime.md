...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSynapseIntegrationRuntime** tar bort en integrations körning.
...
Det här kommandot tar bort integrations körningen "test-reserverad-IR" från arbets ytan med namnet ContosoWorkspace.
