...
## Sammanfattning
Ställer in avancerade inställningar för skydd mot SQL-pooler.
...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzSynapseSqlPoolAdvancedThreatProtectionSetting** anger ett avancerat skydds inställningar för en Azure SYNAPSE Analytics SQL-pool.
För att aktivera avancerat skydd för en SQL-pool måste gransknings inställningarna vara aktiverade på den SQL-poolen.
...
Det här kommandot anger de avancerade inställningarna för skydd mot en SQL-pool som heter ContosoSqlPool under arbets ytan med namnet ContosoWorkspace.
