...
## Sammanfattning
Hämtar inställningar för avancerat skydd för en arbets yta.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSynapseSqlAdvancedThreatProtectionSetting** får avancerade skydds inställningar för en Azure Synapse Analytics-arbetsyta.
...
Det här kommandot får avancerade skydds inställningar för en arbets yta med namnet ContosoWorkspace.
