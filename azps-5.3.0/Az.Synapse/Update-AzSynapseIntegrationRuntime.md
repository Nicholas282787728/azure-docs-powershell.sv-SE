...
## PROBLEMBESKRIVNING
**Update-AzSynapseIntegrationRuntime** cmdlet uppdaterar egenskaperna för integrations körning. För närvarande stöds endast cmdleten för uppdatering av "AutoUpdate" och "AutoUpdateDelayOffset" för integrations körning med egen värd.
...
Tiden på dagen för automatisk uppdatering av integrations körning med självvärd.
