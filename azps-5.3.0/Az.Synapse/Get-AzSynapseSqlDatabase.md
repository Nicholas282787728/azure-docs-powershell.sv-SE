...
## Sammanfattning
Hämtar en Synapse Analytics SQL-databas.
...
## PROBLEMBESKRIVNING
[Den här funktionen är endast tillgänglig för vissa prenumerationer från början.] Cmdleten **Get-AzSynapseSqlDatabase** hämtar information om en Azure SYNAPSE Analytics SQL-databas.
...
Det här kommandot får alla SQL-databaser under en arbets yta.
...
Det här kommandot får SQL-databasen under arbets ytans ContosoWorkspace med namnet ContosoSqlDatabase.
...
Det här kommandot får alla SQL-databaser under en arbets yta genom pipeline.
...
Det här kommandot får SQL-databasen med angivet resurs-ID.
