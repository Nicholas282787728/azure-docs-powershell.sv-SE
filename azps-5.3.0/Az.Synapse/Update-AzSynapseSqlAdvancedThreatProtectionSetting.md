...
## Sammanfattning
Uppdaterar ett avancerat skydd på en arbets yta.
...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzSynapseSqlAdvancedThreatProtectionSetting** uppdaterar ett avancerat skydds inställningar på en Azure Synapse Analytics-arbetsyta. För att aktivera avancerat skydd för en arbets yta måste gransknings inställningar vara aktiverade på den arbets ytan.
...
Det här kommandot uppdaterar inställningarna för avancerat skydd för en arbets yta med namnet ContosoWorkspace.
...
### -EmailAdmin
Anger om du vill skicka e-postadministratörer.
...
Identifierings typer som ska undantas.
...
En semikolonavgränsad lista med e-postadresser som aviseringar skickas till.
