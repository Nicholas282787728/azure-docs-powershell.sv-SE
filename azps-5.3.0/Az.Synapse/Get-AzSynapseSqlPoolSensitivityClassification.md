...
## Sammanfattning
Hämtar de aktuella informations typerna och känslighets etiketterna för kolumnerna i SQL-poolen.
...
## PROBLEMBESKRIVNING
Get-AzSynapseSqlPoolSensitivityClassification cmdlet returnerar de aktuella informations typerna och känslighets etiketterna för kolumnerna i Azure Synapse SQL-poolen.

## BESKRIVS

### Exempel 1: hämta aktuella informations typer och känslighets etiketter för en Azure Synapse SQL-pool.
```powershell
...
### Exempel 2: hämta aktuella informations typer och känslighets etiketter för en Azure Synapse SQL-pool med rör.
```powershell
...
### Exempel 3: Hämta aktuell informations typ och känslighets etikett för en viss kolumn i en Azure Synapse SQL-pool.
```powershell
...
### Exempel 4: Hämta aktuell informations typ och känslighets etikett för en viss kolumn i en Azure Synapse SQL-adresspool med dragning.
```powershell
