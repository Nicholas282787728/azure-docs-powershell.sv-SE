...
## Sammanfattning
Återställer en Synapse för SQL-pool.
...
## PROBLEMBESKRIVNING
Med cmdleten **restore-AzSynapseSqlPool** återställs en Azure SYNAPSE-SQL-adresspool från en säkerhets kopia eller en återställnings punkt för en SQL-pool.
Den återställda SQL-poolen skapas som en ny SQL-pool.
