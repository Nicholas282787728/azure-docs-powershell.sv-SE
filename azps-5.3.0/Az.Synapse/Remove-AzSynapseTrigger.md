...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSynapseTrigger** tar bort en utlösare från en arbets yta.
...
Ta bort en trigger som heter ContosoTrigger från arbets ytans ContosoWorkspace.
...
Ta bort en utlösare som heter ContosoTrigger från arbets ytan ContosoWorkspace via pipeline.
