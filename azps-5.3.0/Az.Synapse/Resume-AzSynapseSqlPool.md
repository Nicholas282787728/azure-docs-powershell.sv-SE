...
## Sammanfattning
Återupptar en Synapse för SQL-poolen.
...
## PROBLEMBESKRIVNING
Cmdleten **Resume-AzSynapseSqlPool** återupptar en Azure SYNAPSE Analytics SQL-pool.
...
Det här kommandot återupptar en inaktiverad Azure Synapse Analytics SQL-pool.
