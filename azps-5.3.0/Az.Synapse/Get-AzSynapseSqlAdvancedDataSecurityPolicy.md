...
## Sammanfattning
Hämtar avancerade data säkerhets principer för en arbets yta.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSynapseSqlAdvancedDataSecurityPolicy** hämtar den avancerade data säkerhets policyn för en arbets yta.
...
Det här kommandot får avancerad data säkerhet på arbets ytan med namnet ContosoWorkspace.
...
Det här kommandot får avancerad data säkerhet på arbets ytan som heter ContosoWorkspace via pipeline.
