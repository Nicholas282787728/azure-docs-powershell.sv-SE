...
## Sammanfattning
Inaktiverar avancerad data säkerhet på en arbets yta.
...
## PROBLEMBESKRIVNING
Cmdleten **disable-AzSynapseSqlAdvancedDataSecurity** inaktiverar avancerad data säkerhet på en arbets yta.
...
Det här kommandot inaktiverar avancerad data säkerhet på arbets ytan med namnet ContosoWorkspace.
...
Det här kommandot inaktiverar avancerad data säkerhet på arbets ytan som heter ContosoWorkspace via pipeline.
