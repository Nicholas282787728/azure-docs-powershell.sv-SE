...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSynapseIntegrationRuntimeMetric** hämtar mått data om integrerings körningen på en arbets yta.
...
Det här kommandot visar Metric-uppgifter om integrations körningen med namnet ' test-selfhost-IR ' i arbets ytan med namnet ContosoWorkspace.
