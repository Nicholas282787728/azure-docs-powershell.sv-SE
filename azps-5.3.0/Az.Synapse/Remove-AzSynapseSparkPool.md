...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSynapseSparkPool** tar bort en Azure Synapse Analytics Spark-pool permanent.
...
Det här kommandot tar bort en Azure Synapse Analytics Spark-pool.
...
Det här kommandot tar bort en Azure Synapse Analytics Spark-pool via pipeline.
...
Det här kommandot tar bort en Azure Synapse Analytics Spark-pool med ett resurs-ID.
