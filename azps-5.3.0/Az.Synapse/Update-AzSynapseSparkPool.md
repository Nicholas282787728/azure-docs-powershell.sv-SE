...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzSynapseSparkPool** uppdaterar en Azure Synapse Analytics Spark-pool.
...
Det här kommandot uppdaterar en Azure Synapse Analytics Spark-pool.
...
Det här kommandot uppdaterar en Azure Synapse Analytics Spark-pool via pipeline.
...
Det här kommandot uppdaterar en Azure Synapse Analytics Spark-pool med resurs-ID.
...
Det här kommandot aktiverar automatisk skalning för en Azure Synapse Analytics Spark-pool.
...
Det här kommandot inaktiverar automatisk skalning för en Azure Synapse Analytics Spark-pool.
...
Det här kommandot aktiverar automatisk paus för en Azure Synapse Analytics Spark-pool.
...
Det här kommandot inaktiverar automatisk paus för en Azure Synapse Analytics Spark-pool.
...
Antal overksamma minuter. Den här parametern måste anges när Auto-paus är aktiverat.
...
Maximalt antal noder som ska tilldelas till den angivna Spark-poolen.
Den här parametern måste anges när Autoskala är aktiverat.
...
Det minsta antalet noder som ska tilldelas till den angivna Spark-poolen.
Den här parametern måste anges när Autoskala är aktiverat.
...
### -EnableAutoPause
Anger om Auto-paus ska aktive ras.
...
### -EnableAutoScale
Anger om automatisk skalning ska aktive ras
...
Konfigurations fil för miljön ("PIP Freeze"-utdata).
...
### -NodeCount
Antalet noder som ska tilldelas i den angivna Spark-poolen.
...
### -NodeSize
Antal kärnor och minne som ska användas för noder som tilldelats i den angivna Spark-poolen.
Den här parametern måste anges när Autoskala är inaktiverat
...
### -ResourceId
Resurs-ID för Synapse Spark-pool.
