...
## Sammanfattning
Tar bort de avancerade skydds inställningarna från en SQL-pool.
...
## PROBLEMBESKRIVNING
Cmdleten **Reset-AzSynapseSqlPoolAdvancedThreatProtectionSetting** tar bort de avancerade skydds inställningarna från en Azure SYNAPSE Analytics SQL-pool.
...
Det här kommandot tar bort de avancerade skydds inställningarna från en SQL-pool med namnet ContosoSqlPool under arbets ytan med namnet ContosoWorkspace.
