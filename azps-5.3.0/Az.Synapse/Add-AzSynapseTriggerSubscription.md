...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzSynapseTriggerSubscription** abonnerar på händelse utlösaren för angivna externa tjänst händelser från utlösaren defintion.
...
Det här kommandot abonnerar på utlösaren ContosoTrigger till angivna händelser från utlösaren defintion.
...
Det här kommandot prenumererar på utlösaren ContosoTrigger till angivna händelser från utlösaren defintion via pipeline.
