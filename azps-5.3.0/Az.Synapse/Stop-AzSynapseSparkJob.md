...
### StopSparkJobByIdParameterSet (standard)
```
...
## PROBLEMBESKRIVNING
Cmdleten **Stop-AzSynapseSparkJob** avbryter ett Synapse Analytics Spark-jobb.
...
Det här kommandot avbryter ett Synapse Analytics Spark-jobb genom pipeline.
