...
## Sammanfattning
Hämtar de rekommenderade informations typerna och känslighets etiketterna för kolumnerna i SQL-poolen.
...
## PROBLEMBESKRIVNING
Get-AzSynapseSqlPoolSensitivityRecommendation cmdlet returnerar de rekommenderade informations typerna och känslighets etiketterna för kolumnerna i SQL-poolen.

## BESKRIVS

### Exempel 1: Hämta rekommenderade informations typer och känslighets etiketter för en Azure Synapse SQL-pool.
```powershell
...
### Exempel 2: Hämta rekommenderade informations typer och känslighets etiketter för en Azure Synapse SQL-adresspool med dragning.
```powershell
