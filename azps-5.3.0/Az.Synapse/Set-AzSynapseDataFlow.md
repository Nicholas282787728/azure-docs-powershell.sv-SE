...
## PROBLEMBESKRIVNING
Cmdleten **set-AzSynapseDataFlow** skapar ett data flöde eller uppdaterar ett befintligt data flöde i arbets ytan.
...
Det här kommandot skapar ett data flöde med namnet ContosoDataFlow i arbets ytan med namnet ContosoWorkspace.
Kommandot baserar data flödet på informationen i DataFlow.jsi filen.
