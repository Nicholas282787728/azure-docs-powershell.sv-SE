...
## Sammanfattning
Skapar en Synapse Analytics SQL-databas.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSynapseSqlDatabase** hämtar information om en Azure SYNAPSE Analytics SQL-databas.
...
Det här kommandot skapar en Azure Synapse Analytics SQL-databas.
