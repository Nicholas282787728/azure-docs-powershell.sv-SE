...
## Sammanfattning
Tar bort gransknings inställningar för en Azure Synapse-BA SQL-pool.
...
## PROBLEMBESKRIVNING
Cmdleten **Reset-AzSynapseSqlPoolAuditSetting** tar bort gransknings inställningarna för en Azure SYNAPSE Analytics SQL-pool.
...
Det här kommandot tar bort gransknings inställningarna för en SQL-pool med namnet ContosoSqlPool i arbets ytans ContosoWorkspace.
...
Det här kommandot tar bort gransknings inställningarna för en SQL-pool som heter ContosoSqlPool i arbets ytans ContosoWorkspace via pipeline.
