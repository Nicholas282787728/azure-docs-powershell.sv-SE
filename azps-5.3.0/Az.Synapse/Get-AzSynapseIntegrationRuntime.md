...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSynapseIntegrationRuntime** hämtar information om integrerings körningar på en arbets yta.
Om du anger namnet på en integrations körning får denna cmdlet information om integrations körningen.
Om du inte anger ett namn hämtas den här cmdleten information om alla integrerings körningar på en arbets yta.
...
Visa alla integrerings körningar i arbets ytan med namnet ContosoWorkspace.
...
Det här kommandot visar information om integrations körningen med namnet ' test-selfhost-IR ' i arbets ytan med namnet ContosoWorkspace.
...
Det här kommandot visar detalj status för integrations körningen med namnet ' test-selfhost-IR ' i arbets ytan med namnet ContosoWorkspace.
