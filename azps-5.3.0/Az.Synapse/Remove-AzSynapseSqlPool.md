...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSynapseSqlPool** tar bort en Azure SYNAPSE Analytics SQL-pool permanent.
...
Det här kommandot tar bort en Azure Synapse-BA SQL-pool.
...
Det här kommandot tar bort en Azure Synapse-BA-pool via pipeline.
...
Det här kommandot tar bort en Azure Synapse-BA-pool med angivet resurs-ID.
