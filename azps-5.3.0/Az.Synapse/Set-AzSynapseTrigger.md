...
## PROBLEMBESKRIVNING
Cmdleten **set-AzSynapseTrigger** skapar en utlösare på en arbets yta. Utlösare skapas i tillståndet "stoppad", vilket innebär att de inte omedelbart påbörjar samtals ledningar som de refererar till.
...
Skapa en ny utlösare som heter ContosoTrigger i arbets ytans ContosoWorkspace. Utlösaren skapas i tillståndet "stoppad", vilket innebär att den inte startas omedelbart. En utlösare kan börja använda `Start-AzDataFactoryV2Trigger` cmdleten.
...
Skapa en ny utlösare som heter ContosoTrigger i arbets ytans ContosoWorkspace via pipeline. Utlösaren skapas i tillståndet "stoppad", vilket innebär att den inte startas omedelbart. En utlösare kan börja använda `Start-AzDataFactoryV2Trigger` cmdleten.
