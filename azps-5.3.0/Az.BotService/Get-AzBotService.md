...
### Exempel 1: Hämta alla BotServices
```powershell
...
Skaffa alla BotServices

### Exempel 2: Hämta BotService genom ResourceGroupName och Name
```powershell
...
Hämta BotService genom ResourceGroupName och namn

### Exempel 3: Hämta alla BotServices genom ResourceGroupName
```powershell
...
Skaffa alla BotServices genom ResourceGroupName

### Exempel 4: Hämta BotService genom inputObject
```powershell
...
Skaffa BotService genom inputObject
