...
### Exempel 1: uppdatera roboten med namn och ResourceGroupName
```powershell
...
Uppdatera roboten med namn och ResourceGroupName

### Exempel 2: uppdatera roboten med InputObject
```powershell
...
Uppdatera roboten med InputObject
...
API-tangenten för Application Insights
...
App-ID för Application Insights
...
### -Sort
Kunna.
Hämtar eller anger typen av resurs.
...
### -ResourceGroupName
Namnet på robot resurs gruppen i användar abonnemanget.
...
### -Tagg
Innehåller resursfiler som definierats som nycklar/värde par.
...
### Microsoft. Azure. PowerShell. cmdletar. BotService. Models. IBotServiceIdentity

## VÄRDEN

### Microsoft. Azure. PowerShell. cmdletar. BotService. Models. Api20180712. IBot
...
INPUTOBJECT <IBotServiceIdentity> : identitets parameter
  - `[ChannelName <ChannelName?>]`: Namnet på kanal resursen.
  - `[ConnectionName <String>]`: Namnet på resursen för bot tjänstens anslutnings inställning
  - `[Id <String>]`: Sökväg till resurs identitet
  - `[ResourceGroupName <String>]`: Namnet på den här resurs gruppen för bot i användar abonnemanget.
  - `[ResourceName <String>]`: Namnet på bot-resursen.
