...
## Sammanfattning
Tar bort ett IoT Central program.
...
## PROBLEMBESKRIVNING
Tar bort ett befintligt IoT Central program.

## BESKRIVS

### Exempel 1 Delete och IoT Central Application
```powershell
PS C:\> Remove-AzIotCentralApp -ResourceGroupName "MyResourceGroupName" -Name "MyAppResourceName"
```

Tar bort det tillhandahållna IoT Central-programmet.
