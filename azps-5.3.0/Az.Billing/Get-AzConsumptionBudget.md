...
## PROBLEMBESKRIVNING
Get-AzConsumptionBudget-cmdleten får en lista med budgetar i antingen en prenumeration eller en resurs grupp.

## BESKRIVS

### Exempel 1: Hämta en lista med budgetar på abonnemangs nivå
```powershell
...
### Exempel 2: Hämta en lista med budgetar på resurs grupp nivå
```powershell
...
### Exempel 3: få en budget med budget namnet på abonnemangs nivån
```powershell
...
### Exempel 4: få en budget med budget namnet på resurs grupp nivå
```powershell
