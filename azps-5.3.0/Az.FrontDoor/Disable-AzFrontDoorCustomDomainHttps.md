...
## PROBLEMBESKRIVNING
**Disable-AzFrontDoorCustomDomainHttps** inaktiverar https för en anpassad domän.

## BESKRIVS

### Exempel 1: inaktivera HTTPS för en anpassad domän med FrontDoorName och ResourceGroupName.
```powershell
...
Inaktivera HTTPS för en anpassad domän "frontendpointname1-Custom-XYZ" med FrontDoorName som "frontdoor1" och ResourceGroupName som "resourcegroup1".

### Exempel 2: inaktivera HTTPS för en anpassad domän med PSFrontendEndpoint-objekt.
```powershell
...
Inaktivera HTTPS för en anpassad domän med PSFrontendEndpoint-objekt.

### Exempel 3: inaktivera HTTPS för en anpassad domän med ResourceId.
```powershell
...
Inaktivera HTTPS för en anpassad domän "frontendpointname1-Custom-XYZ" med ResourceId som $resourceId.
...
### -ResourceId
Resurs-ID för front dörrens slut punkt för att inaktivera https
