...
## PROBLEMBESKRIVNING
Set-AzIotSecuritySolution cmdlet skapar eller uppdaterar en specifik IoT-säkerhetslösning. IoT-säkerhetslösningen samlar in säkerhets data från IoT-enheter och IoT Hub för att förhindra och upptäcka hot.
Namnet på IoT-säkerhetslösningen bör vara identiskt med namnet på IoT-navet.
...
Skapa ny IoT-säkerhetslösning "exempel" för IoT Hub med Resource ID "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MichalResourceGroup/providers/Microsoft.Devices/IotHubs/MySample" (namnet på lösningen ska vara identiskt med namnet på IoT Hub)
...
Status för avaskerad IP-loggning.
