...
Hämtar principen för avancerat skydd för en lagrings-cosmosDB.
...
Hämtar pris data för Azure Defender-abonnemangen i Azure Security Center för ett abonnemang.
...
Ställer in pris data för Azure Defender-abonnemangen i Azure Security Center för ett abonnemang.
...
Anger den effektiva policyn för informations skydd i klient organisationen.
...
Uppdatera en eller flera av följande egenskaper i IoT-säkerhetslösningen: taggar, rekommendations konfiguration, användardefinierade resurser
...
Hämtar säkerhets inställningar i Azure Security Center

### [Set-AzSecuritySetting](Set-AzSecuritySetting.md)
Ställer in en säkerhets inställning i Azure Security Center

### [Get-AzSecurityTopology](Get-AzSecurityTopology.md)
Hämtar en lista med säkerhetstopologier för ett abonnemang
