...
## PROBLEMBESKRIVNING
New-AzDeviceSecurityGroupAllowlistCustomAlertRuleObject cmdlet skapar en ny lista över tillåtna anpassade notifieringsregler för säkerhets gruppen enhet i IoT-säkerhetslösningen.
...
Skapa en ny lista för att tillåta anpassad avisering rull från typen "LocalUserNotAllowed" med status inställd på Disable
