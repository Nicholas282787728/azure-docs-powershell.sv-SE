...
## PROBLEMBESKRIVNING
New-AzDeviceSecurityGroupTimeWindowRuleObject-cmdleten skapar en ny lista över notifieringsregler för säkerhets gruppen enhet i IoT-säkerhetslösning.
...
Skapa en ny tidsfönster regel från typen "ActiveConnectionsNotInAllowedRange"
