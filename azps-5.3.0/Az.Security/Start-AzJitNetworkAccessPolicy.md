...
## PROBLEMBESKRIVNING
Anropar en tillfällig begäran om nätverks åtkomst.
Begäran verifieras mot den konfigurerade principen för JIT-nätverksanslutning och om det är tillåtet öppnas en nätverks anslutning enligt användarens begäran.
Begäran kommer att loggas i policyn för senare granskning och avslutas när den angivna varaktigheten överskrids.
...
Öppnar en nätverks anslutning för 1 timme via port 22 från min offentliga IP-adress (visas inte).
...
### Microsoft. Azure. kommandon. Security. cmdletar. JitNetworkAccessPolicies. PSSecurityJitNetworkAccessPolicyInitiateInputObject
