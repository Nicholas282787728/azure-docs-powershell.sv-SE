...
## PROBLEMBESKRIVNING
Få information om spcific myndighets efterlevnad eller lista alla regler för efterlevnad under specifika abonnemang.
...
Få alla regler för efterlevnad under ett abonnemang.
...
Få detaljerad information om den särskilda standarden för efterlevnad enligt standard namnet.
...
Få detaljerad information om specifika regler för regelefterlevnad enligt resurs-ID.
