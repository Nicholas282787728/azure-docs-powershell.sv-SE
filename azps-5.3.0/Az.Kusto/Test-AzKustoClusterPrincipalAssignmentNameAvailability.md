...
### Exempel 1: kontrol lera tillgänglighet för ett kluster principalassignment namn som används
```powershell
...
Kommandot ovan returnerar om en PrincipalAssignment med namnet "UPN" finns i klustret "testnewkustocluster".

### Exempel 2: kontrol lera tillgänglighet för ett kluster principalassignment namn som inte används
```powershell
...
Kommandot ovan returnerar om en PrincipalAssignment med namnet "NewPrincipal" finns i klustret "testnewkustocluster".
...
### -Namn
Resurs namn för huvud tilldelning.
...
### – Skriv
Typ av resurs, Microsoft. Kusto/Clusters/principalAssignments.
...
### Microsoft. Azure. PowerShell. cmdletar. Kusto. Models. Api20200918. ICheckNameResult
