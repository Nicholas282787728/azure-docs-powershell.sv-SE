...
### Exempel 1: skapa en ny Kusto-databas med namn
```powershell
...
Kommandot ovan skapar en ny Kusto-databas med namnet "mykustodatabase" i det befintliga klustret "testnewkustocluster" i resurs gruppen "testrg".
