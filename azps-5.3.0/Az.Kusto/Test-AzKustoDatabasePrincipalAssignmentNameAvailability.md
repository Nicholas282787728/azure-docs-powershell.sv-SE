...
### Exempel 1: kontrol lera tillgänglighet för ett databas principalassignment namn som används
```powershell
...
Kommandot ovan returnerar om en PrincipalAssignment med namnet "UPN" finns i databasen "mykustodatabase" från kluster "testnewkustocluster".

### Exempel 2: kontrol lera tillgänglighet för ett databas principalassignment namn som inte används
```powershell
...
### – Skriv
Typ av resurs, Microsoft. Kusto/kluster/databaser/principalAssignments.
