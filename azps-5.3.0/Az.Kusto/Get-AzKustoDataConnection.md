...
### Exempel 1: lista alla data anslutningar i en viss databas
```powershell
...
Kommandot ovan returnerar alla Kusto-databaser i klustret "testnewkustocluster" som finns i resurs gruppen "testrg".

### Exempel 2: Hämta en specifik data anslutning utifrån namn
```powershell
...
Kommandot ovan returnerar data anslutningen "mykustodataconnection" i databasen "mykustodatabase" för det befintliga klustret "testnewkustocluster" i resurs gruppen "testrg".
...
### Microsoft. Azure. PowerShell. cmdletar. Kusto. Models. Api20200918. IDataConnection
