...
### Exempel 1: kontrol lera tillgänglighet för ett Kusto databas namn som används
```powershell
...
Kommandot ovan returnerar om en Kusto-databas med namnet "mykustodatabase" finns i "testnewkustocluster"-klustret.

### Exempel 2: kontrol lera tillgänglighet för ett Kusto-databas namn som inte används
```powershell
...
Kommandot ovan returnerar om en Kusto-databas med namnet "mykustodatabase2" finns i "testnewkustocluster"-klustret.
...
### – Skriv
Typ av resurs, till exempel Microsoft. Kusto/kluster/databaser.
