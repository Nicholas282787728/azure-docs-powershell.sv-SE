...
### Exempel 1: skapa ett Kusto kluster principalAssignment
```powershell
...
Med kommandot ovan skapas ett Kusto kluster-principalAssignment
...
### -PrincipalId
Huvud-ID som tilldelats till klustrets huvud konto.
...
### Microsoft. Azure. PowerShell. cmdletar. Kusto. Models. Api20200918. IClusterPrincipalAssignment
