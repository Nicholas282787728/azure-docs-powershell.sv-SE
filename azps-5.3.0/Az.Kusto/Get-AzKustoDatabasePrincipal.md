...
### Exempel 1: lista över databas huvud konton för angivet Kusto-kluster och databas
```powershell
...
Kommandot ovan returnerar en lista över databasens huvud namn för angivet Kusto-kluster och-databas
...
### Microsoft. Azure. PowerShell. cmdletar. Kusto. Models. Api20200918. IDatabasePrincipal
