...
### Exempel 1: ta bort en uppföljnings databas
```powershell
...
Kommandot ovan kopplar bort följar-databasen som definierats i AttachedDatabaseConfiguration "myfollowerconfiguration" från kluster "testnewkustoclusterf".
...
Resurs namn för den anslutna databas konfigurationen i uppslags klustret.
...
### -ClusterResourceId
Resurs-ID för klustret som följer en databas som ägs av detta kluster.
