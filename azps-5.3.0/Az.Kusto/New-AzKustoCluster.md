...
### Exempel 1: skapa ett nytt Kusto-kluster
```powershell
...
Med kommandot ovan skapas ett nytt Kusto-kluster med namnet "testnewkustocluster" i resurs gruppen "testrg".
...
### -Zone
Klustrets tillgänglighets zoner.
