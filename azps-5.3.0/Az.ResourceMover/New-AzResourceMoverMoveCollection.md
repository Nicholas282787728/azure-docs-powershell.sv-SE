...
### Exempel 1: skapa en ny flytt samling.
```powershell
...
Skapa en ny drag samling i ett abonnemang.
...
### -IdentityType
Den typ av identitet som används för regionens flytt tjänst.
...
### -SourceRegion
Hämtar eller anger käll området.
...
### -TargetRegion
Hämtar eller anger mål området.
