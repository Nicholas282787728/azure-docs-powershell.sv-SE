...
### Exempel 1: verifiera dependecies innan du genomför resurserna
```powershell
...
Verifiera dependecies innan du genomför resurserna.

### Exempel 2: bekräfta uppsättningen med resurser i flytt samlingen med "MoveResource Name" som indata
```powershell
...
Bekräfta uppsättningen av resurser i flytt samlingen med "MoveResource Name" som indata

### Exempel 3: genomföra en uppsättning resurser i flytt mängden med "SourceARMID" som indata
```powershell
...
Bekräfta uppsättningen av resurser i flytt samlingen med "SourceARMID" som indata
