...
## Sammanfattning
Skapar ett Redis Enterpise-kluster och en associerad databas
...
### Exempel 1: skapa en Redis företags-cache
```powershell
...
Det här kommandot skapar en Redis företags-cache med namnetin cache.

### Exempel 2: skapa en Redis företags-cache med några valfria parametrar
```powershell
...
Det här kommandot skapar en Redis företags-cache som heterin med vissa valfria parametrar.
...
Giltiga värden är (2, 4, 6,...) för företags lager enheter och (3, 9, 15,...) för Flash-SKU: er.
...
### -MinimumTlsVersion
Den minsta TLS-versionen för klustret som stöds, till exempel 1,2
...
### -SKU
Den typ av RedisEnterprise-kluster som ska distribueras.
Möjliga värden: (Enterprise_E10 EnterpriseFlash_F300 etc.)
...
### -Zone
Zonerna där klustret ska distribueras.
