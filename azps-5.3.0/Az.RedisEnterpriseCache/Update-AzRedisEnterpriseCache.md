...
### Exempel 1: uppdatera Redis företags-cache
```powershell
...
Det här kommandot uppdaterar den minsta TLS-versionen och lägger till en tagg i Redis företags-cache med namnet mina cacheminne.
