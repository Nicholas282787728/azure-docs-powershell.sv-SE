...
### Exempel 1: ta bort en Redis företags-cache och returnera resultatet
```powershell
PS C:\> Remove-AzRedisEnterpriseCache -Name "MyCache" -ResourceGroupName "MyGroup" -PassThru
True
```

Det här kommandot tar bort en Redis företags-cache och visar om åtgärden lyckades.

### Exempel 2: ta bort en Redis företags-cache och Visa inte resultatet
```powershell
PS C:\> Remove-AzRedisEnterpriseCache -Name "MyCache" -ResourceGroupName "MyGroup"
```

Det här kommandot tar bort en Redis.
