...
### Exempel 1: Hämta åtgärds status
```powershell
...
### -Plats
Regionen som operationen befinner sig i.
...
### Microsoft. Azure. PowerShell. cmdletar. RedisEnterpriseCache. Models. Api20201001Preview. IOperationStatus
