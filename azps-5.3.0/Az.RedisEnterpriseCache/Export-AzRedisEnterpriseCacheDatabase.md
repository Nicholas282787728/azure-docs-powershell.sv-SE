...
Det här kommandot exporterar databasen för Redis företags-cache med namnet mina cacheminne till en databas fil.
...
### -SasUri
SAS URI för mål katalogen att exportera till
