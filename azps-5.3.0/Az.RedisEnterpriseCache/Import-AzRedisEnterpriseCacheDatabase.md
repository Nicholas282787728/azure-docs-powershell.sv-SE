...
Det här kommandot importerar en databas fil till databasen i Redis företags-cache med namnet mina cacheminne.

### Exempel 2: importera databas (med exempel fil namn)
```powershell
#[SuppressMessage("Microsoft.Security", "CS002:SecretInNextLine", Justification="Invalid SAS token")]
...
### -SasUri
SAS URI för mål-BLOB att importera från
