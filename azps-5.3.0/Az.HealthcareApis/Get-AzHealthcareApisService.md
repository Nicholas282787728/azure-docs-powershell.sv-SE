...
## PROBLEMBESKRIVNING
Hämtar befintliga healthcareApis FHIR-tjänst konton som har skapats i det angivna abonnemanget eller en resurs grupp.
...
Hämtar metadata för alla HealthcareApis tjänster i den tillhandahållna resurs gruppen.
...
Hämtar metadata för alla HealthcareApis tjänster i den angivna prenumerationen
