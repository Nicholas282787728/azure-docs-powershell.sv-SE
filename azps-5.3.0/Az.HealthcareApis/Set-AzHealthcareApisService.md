...
### Exempel 2: uppdaterar den befintliga healthcareapis-tjänsten i resurs gruppen MyResourceGroup med cosmosdb OfferThroughput = 500 och Key valv Key URI "https:// \<my-keyvault> . Vault.Azure.net/Keys/ \<my-key> "
...
### -CorsHeader
HealthcareApis FhirService lista med CORS-rubriker.
...
### -CorsMaxAge
Maximal ålder för HealthcareApis FhirService-CORS.
...
### -CorsOrigin
HealthcareApis FhirService lista med CORS-ursprung.
