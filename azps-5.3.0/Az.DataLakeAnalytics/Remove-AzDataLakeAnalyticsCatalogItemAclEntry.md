...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzDataLakeAnalyticsCatalogItemAclEntry** tar bort en post (ACE) från åtkomst kontrol listan (ACL) för en katalog eller katalog objekt i data Lake Analytics.
