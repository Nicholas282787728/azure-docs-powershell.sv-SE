...
## Sammanfattning
Skapa en ny instans DataMigration för Azure ActiveDirectory.
...
```
ApplicationId: "ditt huvud program för AppId/service här" AppKey: system. Security. SecureString TenantId: "klient-ID"

## MALLPARAMETRAR

### -AppKey
Azure Active Directory-register
