...
### Exempel 1: uppdatera en MySql Server-databas efter namn
```powershell
...
Uppdatera en databas efter resurs namn.

### Exempel 2: uppdatera MySql-databasen per parameter.
```powershell
...
Uppdatera en databas efter parameter
