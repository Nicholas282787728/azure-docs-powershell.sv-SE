...
### Exempel 1: Hämta brand Väggs regler efter namn
```powershell
...
Denna cmdlet får brand Väggs regler efter namn.

### Exempel 2: Hämta brand Väggs regler efter identitet
```powershell
...
Denna cmdlet får brand Väggs regler efter identitet.

### Exempel 3: visar alla brand Väggs regler i den angivna MySql-servern
```powershell
...
Denna cmdlet visar alla brand Väggs regler i angiven MySql-Server.
