...
### Exempel 1: skapa en ny server brand Väggs regel för MySql
```powershell
...
Denna cmdlets skapar en server brand Väggs regel för MySql.

### Exempel 2: skapa en ny MySql Firewall-regel med-ClientIPAddress.
```powershell
...
Denna cmdletar skapar en MySql-brandväggsregel med-ClientIPAddress.

### Exempel 3: skapa en ny MySql Firewall-regel för att tillåta alla IP-adresser
```powershell
...
Denna cmdlets skapar en ny MySql Firewall-regel som tillåter alla IP-adresser.

## MALLPARAMETRAR

### -AllowAll
Finns för att tillåta alla IP-adresser, från 0.0.0.0 till 255.255.255.255.
...
### -ClientIPAddress
Klienten angav en IP-adress för Server brand Väggs regeln.
Måste vara IPv4-format.
...
### -EndIPAddress
Sista IP-adressen för Server brand Väggs regeln.
Måste vara IPv4-format.
...
Om inget anges är standardvärdet odefinierat.
Om AllowAll finns är standard namnet AllowAll_yyyy-MM-dd_HH-mm-SS.
...
### -StartIPAddress
Den första IP-adressen för Server brand Väggs regeln.
Måste vara IPv4-format.
...
### Microsoft. Azure. PowerShell. cmdletar. MySql. Models. Api20171201. IFirewallRule
