...
### Exempel 2: skapa en ny MySql-server med standardinställningen
```powershell
PS C:\> New-AzMySqlFlexibleServer -Name mysql-test -ResourceGroupName PowershellMySqlTest \
...
Skapa MySql server med standardvärden.
Standardvärden för plats är västra US 2, SKU är Standard_B1ms, SKU-nivån är burst-och lagrings storleken är 10GiB.

## MALLPARAMETRAR

### -AdministratorLoginPassword
Lösen ordet för administratören.
Minst 8 tecken och maximalt 128 tecken.
Lösen ordet måste innehålla tecken från tre av följande kategorier: versaler, gemener, siffror och icke-alfanumeriska tecken.
...
Administratörs användar namn för servern.
Den kan inte ändras när den är aktive rad.
...
### -SKU
Namnet på SKU: n, vanligt vis nivå + Family + cores, till exempel Standard_B1ms Standard_D2ds_v4.
...
### -SkuTier
Serverns beräknings nivå.
Godkända värden: Burst, GeneralPurpose, Minnesoptimerade.
Standard: Burstable.
