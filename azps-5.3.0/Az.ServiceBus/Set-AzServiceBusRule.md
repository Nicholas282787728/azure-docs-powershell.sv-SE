...
## PROBLEMBESKRIVNING
Cmdleten **set-AzServiceBusRule** uppdaterar beskrivningen för den angivna regeln för angiven prenumeration.
...
Uppdaterar SQL-uttrycket **mysqlexpression = ' villkor '** för regeln `SBRule` för abonnemanget `SBSubscription` i ämnet `SBTopic`
