...
## PROBLEMBESKRIVNING
Cmdleten **set-AzSqlServer** ändrar egenskaper för en Azure SQL Database-Server.
...
Ändrar egenskaper för en SQL-databasserver. (automatiskt genererat)
...
### -Taggar
Anger en ord lista med taggar som denna cmdlet associerar med servern. Par med nyckelord i en hash-tabell som taggar på servern. Till exempel: @ {key0 = "value0"; KEY1 = $null; key2 = "värde2"}
