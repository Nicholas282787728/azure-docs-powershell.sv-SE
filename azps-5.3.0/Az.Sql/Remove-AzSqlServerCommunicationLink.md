...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSqlServerCommunicationLink** tar bort en länk för en server-till-server-kommunikation för elastiska databas transaktioner i Azure SQL-databasen.
