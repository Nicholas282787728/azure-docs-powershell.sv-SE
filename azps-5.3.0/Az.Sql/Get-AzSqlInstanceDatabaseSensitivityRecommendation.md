...
## PROBLEMBESKRIVNING
Get-AzSqlInstanceDatabaseSensitivityRecommendation cmdlet returnerar de rekommenderade informations typerna och känslighets etiketterna för kolumner i den SQL-hanterade instans-databasen.

## BESKRIVS

### Exempel 1: Hämta rekommenderade informations typer och känslighets etiketter för en Azure SQL-hanterad instans-databas.
```powershell
...
### Exempel 2: Hämta rekommenderade informations typer och känslighets etiketter för en Azure SQL-hanterad instans med dragning.
```powershell
