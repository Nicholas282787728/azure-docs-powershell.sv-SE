...
## PROBLEMBESKRIVNING
Cmdleten **disable-AzSqlServerAdvancedDataSecurity** inaktiverar avancerad data säkerhet på en server.

## BESKRIVS

### Exempel 1
### Exempel 2: inaktivera avancerad data säkerhet för servrar
```powershell
...
### Exempel 3: inaktivera avancerad data säkerhet för servrar från Server resurs
```powershell
