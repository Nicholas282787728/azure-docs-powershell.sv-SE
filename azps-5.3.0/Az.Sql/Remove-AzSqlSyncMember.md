...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSqlSyncMember** tar bort en synkroniserad Azure SQL-databas.

## BESKRIVS

### Exempel 1: ta bort en synkroniserad medlem
```
...
Det här kommandot tar bort synkroniserings medlem för Azure SQL Database med namnet syncMember01.
...
### -PassThru
Definierar om den borttagna medlemmen ska returneras
