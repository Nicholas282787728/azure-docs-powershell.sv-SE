...
## PROBLEMBESKRIVNING
Cmdleten **New-AzSqlDatabaseExport** exporterar en Azure SQL-databas som en. bacpac-fil till ett lagrings konto.
...
> [!IMPORTANT]
> För att du ska kunna använda denna cmdlet måste brand väggen på Azure SQL Server konfigureras till "Tillåt Azure-tjänster och-resurser att få åtkomst till den här servern". Om det inte har kon figurer ATS kommer GatewayTimeout-fel att uppstå.
