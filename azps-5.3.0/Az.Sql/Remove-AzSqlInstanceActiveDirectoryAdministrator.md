...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSqlInstanceActiveDirectoryAdministrator** tar bort en Azure Active Directory-administratör (Azure AD) för AzureSQL-hanterad instans i den aktuella prenumerationen.
...
Det här kommandot tar bort Azure AD-administratören för den hanterade instans som heter ManagedInstanceName01 associerad med ResourceGroup01 för resurs gruppen.
...
Det här kommandot tar bort Azure AD-administratören från det hanterade instans-objektet.
...
Det här kommandot tar bort Azure AD-administratören med resurs-ID för hanterad instans.
...
### -PassThru
Definierar om den borttagna AD-administratören ska returneras
