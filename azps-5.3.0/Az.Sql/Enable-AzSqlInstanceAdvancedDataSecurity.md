...
### Exempel 2: Aktivera hantera instans avancerad data säkerhet från Server resurs
```powershell
...
Aktiverar avancerad data säkerhet för en hanterad instans. (automatiskt genererat)
