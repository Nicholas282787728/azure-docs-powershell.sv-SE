...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlServerMSSupportAudit** får Microsofts support åtgärder gransknings inställningar för en Azure SQL Server.
Ange parametrarna *ResourceGroupName* och *servername* för att identifiera servern.

## BESKRIVS

### Exempel 1: Hämta gransknings inställningar för Microsoft Support för en Azure SQL Server
```
...
### Exempel 2: gå till pipeline, gransknings inställningar för Microsoft-supporten för en Azure SQL-Server
```
...
### Exempel 3: Hämta gransknings inställningar för Microsoft Support för en Azure SQL Server
```
PS C:\>Get-AzSqlServerMSSupportAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
