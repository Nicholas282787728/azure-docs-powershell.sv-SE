...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSqlSyncAgent** tar bort en Azure SQL Sync-agent.
...
Det här kommandot tar bort Azure SQL Sync-agenten med namnet syncAgent01.
...
### -PassThru
Definierar om returnera den borttagna synkroniseringsresursen
