...
## PROBLEMBESKRIVNING
Disable-AzSqlDatabaseSensitivityRecommendation cmdlet inaktiverar (missar) känslighets rekommendationer för kolumner i databasen.

## BESKRIVS

### Exempel 1: inaktivera känslighets rekommendationer för en viss kolumn i en Azure SQL-databas.
```powershell
...
### Exempel 2: inaktivera känslighets rekommendationer för kolumner med känslighets rekommendationer i en Azure SQL-databas med dragning.
```powershell
