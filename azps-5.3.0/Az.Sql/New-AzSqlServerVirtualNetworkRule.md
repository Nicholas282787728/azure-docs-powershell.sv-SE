...
## PROBLEMBESKRIVNING
Skapar en regel för ett Azure SQL Server-nätverk. Regler för virtuella nätverk används för att ansluta Azure SQL-servern till ett specifikt virtuellt nätverk för att begränsa åtkomsten på Azure SQL-servern så att den endast är tillgänglig i det virtuella nätverket. 
...
Det virtuella nätverkets nät-ID som anger Microsoft. Network-uppgifter
