...
## PROBLEMBESKRIVNING
Cmdleten **set-AzDtlVMsPerUserPolicy** anger de virtuella datorerna per användar princip för ett labb som anger det högsta antalet virtuella datorer som tillåts per användare.
...
### -Inaktivera
Anger att denna cmdlet inaktiverar policyn för laboratoriet.
...
### -LabName
Anger namnet på den Lab för vilken denna cmdlet ställer in principen för virtuella datorer per användare.
