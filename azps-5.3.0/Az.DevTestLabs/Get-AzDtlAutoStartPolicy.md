...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDtlAutoStartPolicy** för ett labb som schemalägger virtuella laboratorie datorer för automatisk start.
...
Hämtar policyn för automatisk start för ett labb i DevTest Labs. (automatiskt genererat)
