...
## Sammanfattning
Få en enda kurva-fråga per resourceName.
...
### Exempel 1: Hämta alla resurs diagram frågor under en resurs grupp
```powershell
...
Det här kommandot får alla resurs diagram frågor under en resurs grupp.

### Exempel 2: Hämta en resurs diagram fråga efter namn
```powershell
...
Det här kommandot får en resurs diagram fråga efter namn.

### Exempel 2: Hämta en resurs diagram fråga genom objecy
```powershell
...
Det här kommandot får en resurs diagram fråga efter objekt.
