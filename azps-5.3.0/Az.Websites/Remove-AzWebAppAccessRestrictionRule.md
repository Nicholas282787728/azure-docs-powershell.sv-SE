...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzWebAppAccessRestrictionRule** tar bort en begränsnings regel för åtkomst från en Azure Web App

## BESKRIVS

### Exempel 1: ta bort en begränsnings regel för webb program
```
PS C:\>Remove-AzWebAppAccessRestrictionRule -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite" -Name IpRule
```

Det här kommandot tar bort regeln för begränsning av IpRule från Azure Web App med namnet ContosoSite som tillhör resurs gruppen med namnet default-Web-West.

### Exempel 2: ta bort en begränsnings regel för webb programmet för Service märke
```
...
Det här kommandot tar bort regeln för åtkomst begränsning med ServiceTag är lika med AzureFrontDoor. backend från Azure Web App som heter ContosoSite som tillhör resurs gruppen som heter default-West.
...
### -Namn
Namn på regel för åtkomst begränsning
...
### -VirtualNetworkName
Namn på virtuellt nätverk (måste finnas i samma resurs grupp som Web App).
