...
I följande exempel skapas en anslutnings sträng som heter ' ConnectionString för Web App ContosoWebApp. Detta ersätter alla befintliga anslutnings strängar för Web App-ContosoWebApp.
