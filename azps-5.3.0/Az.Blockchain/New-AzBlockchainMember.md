...
### Exempel 1: skapa en ny blockchain-medlem
```powershell
...
Det här kommandot skapar en ny blockchain-medlem.
...
### -Konsortium
Hämtar eller anger konsortiet för blockchain-medlemmen.
...
Anger lösen ordet för hanterings konto för hanterade konsortier.
...
Hämtar visnings namnet för medlemmen i konsortiet.
...
### -ConsortiumRole
Får rollen som medlem i konsortiet.
...
### -FirewallRule
Hämtar eller anger brand Väggs regler att skapa, se avsnittet anteckningar för FIREWALLRULE-egenskaper och skapa en hash-tabell.
...
### -Plats
GEO-platsen för blockchain-tjänsten.
...
### -Lösen ord
Anger lösen ordet för grundläggande autentisering för blockchain medlem.
...
### -Protokoll
Hämtar eller anger protokollet blockchain.
...
### -Tagg
Taggar för tjänsten som är en lista över viktiga värde par som beskriver resursen.
...
Hämtar eller anger nodernas kapacitet.
