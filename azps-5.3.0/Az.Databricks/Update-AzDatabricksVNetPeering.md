...
## Sammanfattning
Uppdatera vNet-peering för arbets ytan.
...
### Exempel 1: uppdatera AllowForwardedTraffic av VNet peering
```powershell
...
Det här kommandot uppdaterar AllowForwardedTraffic av VNet-peering.

### Exempel 2: uppdatera AllowForwardedTraffic för VNet peering efter objekt
```powershell
...
Det här kommandot uppdaterar AllowForwardedTraffic för VNet-peering efter objekt.

## MALLPARAMETRAR

### -AllowForwardedTraffic
[System. Management. Automation. SwitchParameter] om den vidarebefordrade trafiken från datorerna i det lokala virtuella nätverket tillåts/är inte tillåten i virtuellt fjärr nätverk.
...
### -AllowGatewayTransit
[System. Management. Automation. SwitchParameter] om Gateway-länkar kan användas i virtuella fjärrnätverk för att länka till det här virtuella nätverket.
...
[System. Management. Automation. SwitchParameter] om datorerna i det lokala virtuella nätverks utrymmet skulle kunna komma åt de virtuella datorerna i det virtuella fjärrnätverket.
...
### -UseRemoteGateway
[System. Management. Automation. SwitchParameter] om du kan använda Fjärrgateways på det här virtuella nätverket.
Om flaggan är inställd på True och allowGatewayTransit på fjärr-peering också är sant, använder virtuella nätverk gateways för fjärrnätverk för överföring.
Endast en peering kan ha den här flaggan inställd på True.
Det går inte att ange den här flaggan om det redan finns en gateway för det virtuella nätverket.
...
### Microsoft. Azure. PowerShell. cmdletar. Databricks. Models. Api20180401. IVirtualNetworkPeering
