...
## PROBLEMBESKRIVNING
Med den här Get-AzContainerRegistryReplication cmdleten får du en angiven replikering av ett behållar-register eller alla replikeringar av ett behållar register.

## BESKRIVS

### Exempel 1: hämtar en angiven replikering av ett behållar register
```powershell
...
Hämtar en angiven replikering av ett behållar register

### Exempel 2: hämtar alla replikeringar av en behållar register
```powershell
...
Hämtar alla replikeringar av en behållar register
...
### -ResourceId
Resurs-ID för behållar registrering
