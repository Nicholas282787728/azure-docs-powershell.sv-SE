...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzTrafficManagerIpAddressRange** tar bort ett IP-adressintervall från ett lokalt objekt i Azure Traffic Manager.
...
### Exempel 1: ta bort IP-adressintervall från en slut punkt
```
...
Det andra kommandot tar bort ett IP-adressintervall från slut punkten som lagras i $TrafficManagerEndpoint.
...
### -Först
Anger den första IP-adressen i det område som ska tas bort.
