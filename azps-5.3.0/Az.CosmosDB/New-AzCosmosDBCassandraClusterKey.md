...
## Sammanfattning
Skapar en ny CosmosDB Cassandra-kluster.
...
## PROBLEMBESKRIVNING
**New-AzCosmosDBCassandraClusterKey** skapar en ny CosmosDB Cassandra.
...
### -Namn
Namn på Cassandra kluster nycklar.
...
### -OrderBy
Sortering av kluster Cassandra.
Möjliga värden är: "ASC", "DESC"
