...
## Sammanfattning
Skapar ett nytt objekt av typen PSSpatialSpec. Det kan skickas som ett parameter värde för set-AzCosmosDBGremlinIndexingPolicy.
...
## PROBLEMBESKRIVNING
Skapar objekt som motsvarar Gremlin API-SpatialSpec.
