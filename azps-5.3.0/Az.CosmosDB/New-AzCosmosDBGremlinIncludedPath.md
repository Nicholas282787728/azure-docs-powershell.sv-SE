...
## Sammanfattning
Skapar ett nytt objekt av typen PSIncludedPath. Det kan skickas som ett parameter värde för set-AzCosmosDBGremlinGraph.
...
## PROBLEMBESKRIVNING
Objekt som motsvarar Gremlin API-IncludedPath.
