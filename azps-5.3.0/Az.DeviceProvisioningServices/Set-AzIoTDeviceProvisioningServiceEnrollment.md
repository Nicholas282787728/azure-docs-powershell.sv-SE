...
## PROBLEMBESKRIVNING
Uppdatera en enhets registrering i en Azure IoT Hub-enhet för etablering.
...
Uppdatera tilldelnings principer och hubbar för en registrerings post.
...
Uppdatera registreringens initialer.
