...
Uppdatera allokeringsregeln till "lång laten" för en Azure IoT Hub-enhet "myiotdps".
...
Lägga till taggar till en Azure IoT Hub-enhet för etablerings tjänsten "myiotdps".
...
Ta bort märkord och Lägg till nya taggar i en Azure IoT Hub-enhet för etablerings tjänsten "myiotdps" med pipeline.
...
### -Återställ
Återställ IoT-enhetens etablerings service märken
...
### -Tagg
IoT Device Revisioning service-insamling
