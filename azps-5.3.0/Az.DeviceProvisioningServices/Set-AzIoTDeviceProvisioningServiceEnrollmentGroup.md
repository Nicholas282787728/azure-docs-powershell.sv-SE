...
## PROBLEMBESKRIVNING
Uppdatera en registrerings grupp i en Azure IoT Hub-enhets etablerings tjänst.
...
Uppdatera tilldelnings principer och nav för en registrerings grupp.
...
Uppdatera en registrerings grupps initiala status.
