...
Länkad IoT Hub till en Azure IoT Hub-enhet med AllocationWeight och ApplyAllocationPolicy.

## MALLPARAMETRAR

### -AllocationWeight
Tilldelnings vikt för IoT Hub
...
### -ApplyAllocationPolicy
Ett booleskt värde som anger om tilldelnings policy ska tillämpas på IoT Hub
...
Anslutnings sträng för IoT Hub-resursen.
