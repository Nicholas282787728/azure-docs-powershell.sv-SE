...
Lista alla tjänste etablerings tjänster för Azure IoT Hub-enheter i ett abonnemang.
...
Lista alla konfigurations tjänster för Azure IoT Hub-enheter i resurs gruppen ' myresourcegroup '.
...
Visa information om en Azure IoT Hub-enhets etablerings tjänst ' myiotdps '.
