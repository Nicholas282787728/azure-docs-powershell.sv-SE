...
## PROBLEMBESKRIVNING
Få information om en registrerings grupp eller lista alla registrerings grupper i en Azure IoT Hub-enhets etablerings tjänst.
...
Skaffa en enhets registrerings grupp i en Azure IoT Hub-enhet.
...
Lista alla enheter för registrerings grupper i en Azure IoT Hub-enhet.
