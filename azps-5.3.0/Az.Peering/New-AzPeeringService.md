...
Skapar ett peering service-objekt med leverantör och peering-plats. Använda i conjuction med `Get-AzPeeringServiceProvider` och `Get-AzPeeringServiceLocation`
...
### -PeeringLocation
Den fysiska platsen skiljer sig från Azure-regionen. Använd Get-AzPeeringServiceLocation [-Country <country> ]
...
Peering service leverantörens namn.
Använda Get-AzPeeringServiceProvider cmdlet för en lista
...
### -Tagg
Taggarna som ska kopplas till Microsoft InputObject-tjänsten.
