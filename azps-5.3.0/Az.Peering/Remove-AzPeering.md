...
## PROBLEMBESKRIVNING
Perminently ta bort en peering-resurs.
...
Ta bort en peering efter resurs-ID.
...
### -InputObject
Använd Get-AzPeering för att hämta det här objektet.
