...
### Använda peering och skapa ett registrerat prefix
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredPrefix -Name $asnName -Asn $asn
```

Skaffa den peering du vill lägga till ett registrerat prefix. Överför sedan till cmdleten.
...
### Microsoft. Azure. PowerShell. cmdletar. peering. Models. PSPeeringRegisteredPrefix
