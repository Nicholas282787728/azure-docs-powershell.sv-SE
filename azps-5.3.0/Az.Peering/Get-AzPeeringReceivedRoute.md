...
## PROBLEMBESKRIVNING
Visar en lista över mottagna vägar från en peering

## BESKRIVS

### Lista över 100 mottagna vägar för en peering
```powershell
PS C:\> Get-AzPeeringReceivedRoute -ResourceGroupName $resourceGroupName -Name $peeringName
```

Visar alla mottagna vägar för en peering

### Filtrera efter som sökväg
```powershell
PS C:\> Get-AzPeeringReceivedRoute -ResourceGroupName $resourceGroupName -Name $peeringName -AsPath "1234 5674 9834"
```

Visar en lista över alla mottagna vägar för en peering med ett filter aktiverat som 

### Filtrera efter RPKIValidationState
```powershell
PS C:\> Get-AzPeeringReceivedRoute -ResourceGroupName $resourceGroupName -Name $peeringName -RPKIValidationState "Valid"
```

Visar en lista över alla mottagna vägar för en peering med ett filter på RPKIValidationState

### Filtrera efter OriginAsValidationState
```powershell
PS C:\> Get-AzPeeringReceivedRoute -ResourceGroupName $resourceGroupName -Name $peeringName -OriginAsValidationState "Valid"
```

Visar en lista över alla mottagna vägar för en peering med ett filter på OriginAsValidationState

## MALLPARAMETRAR

### -Behållning
Filtrera efter som sökväg.
Exempel: ' 9342 1234 4567 '
...
Filtrera efter ursprung som validerings tillstånd.
...
### -RPKIValidationState
Filtrera efter RPKI verifierings tillstånd.
...
### Microsoft. Azure. PowerShell. cmdletar. peering. Models. PSPeeringReceivedRoute
