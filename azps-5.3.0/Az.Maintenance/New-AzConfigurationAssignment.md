...
## PROBLEMBESKRIVNING
Registrera underhålls konfiguration för resursen.
...
Registrera underhålls konfiguration för dedikerad värd.
...
Konfigurations tilldelningens namn ska matcha MaintenanceConfigurationName.
...
### -Plats
Platsen utan utrymmen för resursen.
...
Den fullständigt kvalificerade MaintenanceConfiguration.
