...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzVmssDataDisk** lägger till en datadisk till instansen för virtuell dator Scale set (VMSS).
...
### -DiskIOPSReadWrite
Anger Read-Write IOPS för den hanterade disken. Bör endast användas när StorageAccountType är UltraSSD_LRS. Om inget anges tilldelas ett standardvärde baserat på diskSizeGB.
...
### -DiskMBpsReadWrite
Anger bandbredden i MB per sekund för den hanterade disken. Bör endast användas när StorageAccountType är UltraSSD_LRS. Om inget anges tilldelas ett standardvärde baserat på diskSizeGB.
