...
## PROBLEMBESKRIVNING
Utvärderar korrigerings status för en virtuell dator och rapporterar alla upptäckta korrigeringsfiler som är tillgängliga för installation.
...
### -VM
Objekt för virtuell dator i PowerShell
