...
## Sammanfattning
Hämtar listan över resurser som är kopplade till den angivna disk krypterings uppsättningen.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDiskEncryptionSetAssociatedResource** hämtar listan över resurser som är kopplade till den angivna disk krypterings uppsättningen.
...
Cmdleten hämtar de två resurserna, "exampleDisk01" och "exampleDisk02", associerade med angiven disk krypterings uppsättning
