...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDisk** hämtar egenskaperna för en hanterad disk.
...
Det här kommandot får egenskaperna för alla diskar under prenumerations namnet från win1_OsDisk.
