...
### -StorageAccountType
Anger den typ av lagrings konto som ska användas för att lagra bilden. Det går inte att uppdatera den här egenskapen. Tillgängliga värden är Standard_LRS, Standard_ZRS och Premium_LRS.
