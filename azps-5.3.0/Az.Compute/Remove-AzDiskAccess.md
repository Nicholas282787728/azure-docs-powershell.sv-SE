...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzDiskAccess** tar bort en disk åtkomst resurs.

## BESKRIVS

### Exempel 1: ta bort disk åtkomst med standard parameter uppsättning
```
PS C:\> Remove-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01"
```

Det här kommandot tar bort disk åtkomsten med namnet "DiskAccess01" i resurs gruppen "ResourceGroup01"

### Exempel 2: ta bort disk åtkomst med resurs-ID
```
...
Det här kommandot tar bort disk åtkomst via resurs-ID

### Exempel 3: ta bort disk åtkomst med hjälp av indata
```
PS C:\> $myDiskAccess = Get-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01"
PS C:\> Remove-AzDiskAccess -InputObject $myDiskAccess
```

Det här kommandot tar bort disk åtkomst via InputObject

### Exempel 4: ta bort disk åtkomst efter indatamängds objekt
```
PS C:\> Get-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01" | Remove-AzDiskAccess 
```

Det här kommandot tar bort disk åtkomst genom rör InputObject
