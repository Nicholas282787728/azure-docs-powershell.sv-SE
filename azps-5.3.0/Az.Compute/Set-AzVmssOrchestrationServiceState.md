...
Det här kommandot gör om tjänsten för automatisk reparation på VMSS "vmss1" i resurs gruppen "RG".
...
Det här kommandot återupptar tjänsten för automatisk reparation på VMSS "vmss1" i resurs gruppen "RG".

## MALLPARAMETRAR

### -Åtgärd
Den åtgärd som ska utföras.  Möjliga värden är: Resume, Suspend.
...
### -InputObject
Det lokala objektet för den virtuella datorns skal uppsättning.
