...
Hämtar statusen för DSC-filtillägg för en virtuell dator. (automatiskt genererat)
...
### -VM
Anger det virtuella dator objekt som tillägget är aktiverat.
