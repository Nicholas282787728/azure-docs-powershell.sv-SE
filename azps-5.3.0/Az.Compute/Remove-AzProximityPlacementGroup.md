...
## PROBLEMBESKRIVNING
Denna cmdlet tar bort gruppen närhet till placering.
...
Det här kommandot tar bort gruppen närhets placering.

### Exempel 2

Det här kommandot tar bort gruppen närhets placering. (automatiskt genererat)
