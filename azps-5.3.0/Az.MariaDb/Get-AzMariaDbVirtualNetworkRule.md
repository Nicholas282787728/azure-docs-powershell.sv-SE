...
### Exempel 1: lista alla virtuella nätverks regler under en MariaDB
```powershell
...
Det här kommandot visar alla virtuella nätverks regler under en MariaDB.

### Exempel 2: Hämta ett virtuellt nätverks uttryck under en MariaDB
```powershell
...
Det här kommandot hämtar regeln för virtuella nätverk under en MariaDB.
...
### Microsoft. Azure. PowerShell. cmdletar. MariaDb. Models. Api20180601Preview. IVirtualNetworkRule
