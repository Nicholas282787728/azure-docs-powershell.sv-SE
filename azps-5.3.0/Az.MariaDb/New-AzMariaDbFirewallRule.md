...
### Exempel 1: skapa en brand Väggs regel under en MariaDB
```powershell
...
Det här kommandot skapar en brand Väggs regel under en MariaDB.

### Exempel 2: skapa en ny MariaDB brand Väggs regel med-ClientIPAddress.
```powershell
...
Denna cmdlets skapar en MariaDB med-ClientIPAddress.

### Exempel 3: skapa en ny MariaDB för att tillåta alla IP-adresser
```powershell
...
Denna cmdlets skapar en ny MariaDB för att tillåta alla IP-adresser.
