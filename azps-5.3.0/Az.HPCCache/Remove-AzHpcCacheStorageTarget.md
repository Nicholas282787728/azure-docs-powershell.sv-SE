...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzHpcCacheStorageTarget** tar bort ett lagrings mål från Azure HPC-cachen.
...
### -Force
Anger att cmdleten inte ber dig bekräfta. Denna cmdlet uppmanar dig som standard att bekräfta att du vill ta bort lagrings målet.
...
### -ResourceGroupName
Namnet på den resurs grupp under vilket du vill ta bort lagrings målet från cachen.
