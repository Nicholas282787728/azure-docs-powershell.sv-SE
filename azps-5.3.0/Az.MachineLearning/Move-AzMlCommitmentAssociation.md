...
## PROBLEMBESKRIVNING
Flyttar en åtagande Associations resurs från en överordnad åtagande plan till en annan åtagande plan.

## BESKRIVS

### Exempel 1: flytta en åtagande Association
```
...
### -DestinationPlanId
Azure-resurs-ID för mål gruppen Azure ML-åtagande.
