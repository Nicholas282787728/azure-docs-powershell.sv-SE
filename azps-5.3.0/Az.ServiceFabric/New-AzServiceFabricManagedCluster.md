...
## PROBLEMBESKRIVNING
Denna cmdlet skapar en hanterad kluster resurs utan nodtyper. Om du vill starta klustret måste du lägga till en primär nodtyp med den [nya-AzServiceFabricManagedNodeType](./New-AzServiceFabricManagedNodeType.md).
...
Det här kommandot skapar en kluster resurs med standard-Basic-SKU.
...
Det här kommandot skapar en kluster resurs i centraluseuap med ett första administratörs klient certifikat och standard-SKU.

## MALLPARAMETRAR

### -AdminPassword
Administratörs lösen ord som används för de virtuella datorerna.
...
Klient certifikatets nätverks namn.
...
### -ClientCertIsAdmin
Används för att ange om klient certifikatet har administratörs nivå.
...
Lista över utgivare thumbprints för klient certifikatet.
Används bara i kombination med ClientCertCommonName.
...
Tumavtryck för klient certifikat.
...
Port som används för klient anslutningar till klustret.
Standard: 19000.
...
### -CodeVersion
Kluster tjänstens Fabric-kod version.
Använd endast om uppgraderings läget är manuell.
...
Port som används för HTTP-anslutningar till klustret.
Standard: 19080.
...
Slut punkt som används av omvänd proxy.
...
### -SKU
I klusterets SKU är alternativen grundläggande: det får minst tre startnoder och tillåter bara en nodtyp och standard: det får minst fem startnoder och tillåter flera nodtyper.
...
### -UpgradeMode
Kluster tjänst Fabric Code version uppgraderings läge.
...
### -UseTestExtension
Om du anger att klustret ska ställas in med service test VMSS tillägget.
