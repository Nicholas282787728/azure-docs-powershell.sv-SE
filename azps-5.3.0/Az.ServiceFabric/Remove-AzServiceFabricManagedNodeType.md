...
## PROBLEMBESKRIVNING
Ta bort nodtypen eller specifika noder inom nodtypen. Om paremter-nodnamn används kommer bara noder som är angivna att tas bort.
...
Ta bort två noder från nodtypen.
...
Ta bort två noder från nodtypen med rör dragningen.
...
Använd med försiktighet eftersom det här kan leda till förlust av data om tillstånds känslig arbets belastning körs på noderna, eller kan ta bort klustret om det inte finns tillräckligt många dirigeringsroutrar efter opearion.
