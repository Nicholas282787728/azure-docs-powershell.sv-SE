...
## PROBLEMBESKRIVNING
Ta bort virtuellt dator tillägg från nodtypen efter namn. Använd [Get-AzServiceFabricManagedNodeType](./Get-AzServiceFabricManagedNodeType.md) och titta på egenskapen VmExtensions för att se det aktuella tillägget för nodtypen.
...
Ta bort tillägget från nodtyp efter namn.
...
Ta bort tillägget från nodtyp med namn, med rör dragning.
