...
## PROBLEMBESKRIVNING
Använd **set-AzServiceFabricSetting** för att lägga till eller uppdatera tjänstens Fabric-inställningar i ett kluster.
...
Med det här kommandot utlöses en uppgradering för att ange flera infrastruktur inställningar med SettingsSectionDescription parameter.
...
### -Parameter
Parameter namn för Fabric-inställningen
...
### -Avsnitt
Avsnitts namn för Fabric-inställningen
...
En matris med Fabric-inställningar
...
### -Värde
Parameter värde för Fabric-inställningen
