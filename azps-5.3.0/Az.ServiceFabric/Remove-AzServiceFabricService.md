...
## Sammanfattning
Ta bort en tjänst från klustret. Stöder endast funktioner som distribueras av ARM.
...
## PROBLEMBESKRIVNING
Denna cmdlet tar bort en tjänst från klustret.
...
I det här exemplet tas tjänsten bort "testApp ~ testService1".
