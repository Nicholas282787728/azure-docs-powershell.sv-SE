...
### Exempel 1: Ange endast kluster storleken, certifikatets ämnes namn och operativ systemet för att distribuera ett kluster
...
Befintlig sökväg till certifikat filen för det primära kluster certifikatet
...
Befintlig sökväg till certifikat filen för det sekundära kluster certifikatet
...
### -Tumavtryck
Tumavtrycket för certifikatet correspoinding till SecretIdentifier. Använd det här alternativet om certifikatet inte är hanterat eftersom nyckel valvet bara har certifikatet lagrat som hemligt och cmdleten inte kan hämta tumavtrycket.
...
Användar namn för loggning till VM
