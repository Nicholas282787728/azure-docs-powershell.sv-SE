...
---
# Modulen AZ. AlertsManagement
## Problembeskrivning
Hanterar aviseringar, smarta grupper och konfiguration av åtgärds regler för plattformen för aviserings hantering.

## AZ. AlertsManagement-cmdletar
...
Hämtar smarta grupp information

### [Get-AzSmartGroupHistory](Get-AzSmartGroupHistory.md)
Hämtar smart grupp historik

### [Mått – AzAlertStatistic](Measure-AzAlertStatistic.md)
...
Uppdaterar egenskaper för åtgärds regler.

### [Update-AzAlertState](Update-AzAlertState.md)
Uppdaterar aviserings tillståndet

### [Update-AzSmartGroupState](Update-AzSmartGroupState.md)
Uppdaterar smart grupp status
