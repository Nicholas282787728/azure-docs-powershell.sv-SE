...
## PROBLEMBESKRIVNING
**Update-AzSmartGroupState** cmdlet uppdaterar smart grupp status.
...
Denna cmdlet uppdaterar den smarta gruppen till Acknowleged.
...
### -SmartGroupId
Unikt ID för smart grupp/ResourceId för smart grupp.
...
### -State
Uppdaterat läge för smart grupp
