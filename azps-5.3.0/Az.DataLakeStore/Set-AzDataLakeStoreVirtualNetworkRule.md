...
## PROBLEMBESKRIVNING
Cmdleten **set-AzDataLakeStoreVirtualNetworkRule** ändrar den angivna regeln för virtuella nätverk i den angivna data Lake Store.
...
Uppdaterar under nätets ID för regeln "myVNET" i kontot "DLS" till "updatedId"

## MALLPARAMETRAR

### -Konto
Kontot för data Lake Store för att uppdatera regeln för virtuella nätverk i
...
### -SubnetId
Början på det giltiga IP-adressintervallet för regeln för virtuella nätverk
