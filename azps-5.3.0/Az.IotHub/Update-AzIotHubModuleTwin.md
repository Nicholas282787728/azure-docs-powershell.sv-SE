...
## PROBLEMBESKRIVNING
Uppdaterar eller ersätter en enhet. Mer https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-module-twins information finns i.
...
Returnerar den uppdaterade enhets modulens dubbla objekt.
...
Returnerar enhets modulens dubbla objekt med uppdaterade egenskaper.
...
Returnerar den enhets modulens dubbla objekt med uppdaterade märknings egenskaper.
...
Returnerar den ersatta enhets modulens dubbla objekt.
...
### -Önskat
Lägga till eller uppdatera önskad egenskap i en modul, dubbel.
...
### -Delvis
Tillåter endast delvis uppdatering av taggar och önskade egenskaper för en modul.
...
### -Tagg
Lägga till eller uppdatera egenskapen Taggar i en modul med två.
