...
## PROBLEMBESKRIVNING
Anropa en metod för Edge-modul. Mer https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods information finns i.
...
### -Namn
Namnet på den metod som ska anropas för den här modulen.
...
### -Nyttolast
Nytto lasten för metoden att starta i den här modulen.
