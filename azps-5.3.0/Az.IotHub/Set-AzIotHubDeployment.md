...
Ändra prioriteten för IoT Edge Deployment och uppdatera dess mål villkor.
...
Uppdatera måtten och etiketterna för en IoT Edge-distribution.
...
### -Force
Gör det möjligt att ersätta distributions objekt även om det har uppdaterats sedan det hämtades förra gången.
