...
## PROBLEMBESKRIVNING
Skapa en modul på en mål-IoT-enhet med en annan autentiseringstyp i en IoT-hubb.
...
Skapa en modul på en mål-IoT-enhet med standard verifiering (delad privat telefon).
