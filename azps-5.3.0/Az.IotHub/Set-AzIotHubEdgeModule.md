...
## PROBLEMBESKRIVNING
Tillämpar det tillhandahållna modulens konfigurations innehåll på den angivna Edge-enheten.
Obs! när kommandot körs skapas en samling av moduler som används för enheten.
...
Testa moduler under utveckling genom att ange moduler på en målen het.
...
### -ModulesContent
Konfigurations innehåll för moduler för IoT Edge-enheter.
