...
## PROBLEMBESKRIVNING
Fråga en IoT-hubb med ett kraftfullt SQL-liknande språk för att hämta information om enheter och moduler till en och samma jobb och meddelanderoutning.
Mer https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language information finns i.
...
Fråga alla enheter med dubbla data i ett Azure IoT-hubb.
...
Fråga Top 2-modul med dubbla data på en målen het.
...
### -Fråga
Användar fråga som ska utföras.
...
### -Överst
Maximalt antal element som ska returneras.
Som standard har frågan inget Cap.
