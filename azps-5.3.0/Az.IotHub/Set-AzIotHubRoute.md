...
## PROBLEMBESKRIVNING
Redigera ett flöde. Du kan uppdatera alla fält i en väg inklusive data källan, slut punkten, operationsföljden och även aktivera och inaktivera flödet.
...
Uppdaterar routningsinformation.
...
### -Villkor
Villkor som utvärderas för att tillämpa regeln för routning
