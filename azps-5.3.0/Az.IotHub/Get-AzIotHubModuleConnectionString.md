...
## PROBLEMBESKRIVNING
Lista anslutnings sträng för alla moduler eller en angiven modul för en mål-IoT-enhet i ett Azure IoT-hubb.
...
Visa alla moduler anslutnings strängar för en mål-IoT-enhet i en IoT-hubb.
...
Hämta den sekundära modulens anslutnings sträng för en mål-IoT-enhet i en IoT-hubb.
