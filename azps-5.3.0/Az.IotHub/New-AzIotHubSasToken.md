...
## PROBLEMBESKRIVNING
För enhetens SAS-token används princip parametern endast för att komma åt enhets registret. Därför bör policyn ha Läs behörighet till registret.
För IoT Hub-token är principen en del av SAS.
...
Skapa en IoT Hub SAS-token med hjälp av iothubowner-principen och primär nyckeln.
...
Skapa en IoT Hub SAS-token med registryRead policy och sekundär nyckel.
...
Skapa en enhets-SAS-token med hjälp av iothubowner policy för att få åtkomst till {iothub_name} enhets registret.
...
Skapa en modul SAS-token med hjälp av iothubowner policy för att få åtkomst till {iothub_name} enhets registret.
...
### -Varaktighet
Framtida slut för ande (i sekunder) för token som ska skapas.
Standardvärdet är 3600.
