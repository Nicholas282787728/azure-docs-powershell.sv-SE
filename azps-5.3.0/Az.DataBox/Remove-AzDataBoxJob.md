...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzDataBoxJob** används för att ta bort ett slutfört data-jobb från listan över datavyer.
...
Tar bort det angivna datamappen
...
Tar bort det angivna inmatnings jobbet för data
