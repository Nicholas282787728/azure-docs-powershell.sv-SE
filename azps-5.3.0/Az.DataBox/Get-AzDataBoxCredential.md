...
## Sammanfattning
Hämtar autentiseringsuppgifterna för data i ett visst jobb
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDataBoxCredential** hämtar autentiseringsuppgifterna för data rutan för ett specifikt jobb. De interna egenskaperna för det returnerade objektet är olika för olika SKU-typer.
...
Det här retuns JobSecrets för det angivna jobbet
...
### System. Collections. Generic. IEnumerable ' 1 [[Microsoft. Azure. Management. data. UnencryptedCredentials, Microsoft. Azure. Management. data, version = 1.0.0.0, Culture = neutral, PublicKeyToken = 31bf3856ad364e35]]
