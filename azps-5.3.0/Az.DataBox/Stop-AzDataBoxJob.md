...
## Sammanfattning
Avbryter ett pågående data jobb om jobbet är avbrutet.
...
## PROBLEMBESKRIVNING
Cmdleten **Stop-AzDataBoxJob** används för att avbryta ett Datalist jobb.
...
Avbryter det angivna datamappen
...
Avbryter framtvingad utan bekräftelse
...
### -InputObject
InputObject av typen PSDataBoxJob
