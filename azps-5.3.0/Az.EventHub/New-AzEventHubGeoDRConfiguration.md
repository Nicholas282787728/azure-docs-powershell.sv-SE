...
## PROBLEMBESKRIVNING
Cmdleten **New-AzEventHubGeoDRConfiguration** skapar ett nytt alias (konfiguration för katastrof återställning)
...
### -AlternateName
AlternateName krävs när DR-konfigurationsfilen är samma som det primära namn området
...
### -PartnerNamespace
PartnerNamespace ARM-ID för DR-konfiguration
