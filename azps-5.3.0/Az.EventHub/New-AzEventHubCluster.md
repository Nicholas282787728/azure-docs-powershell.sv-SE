...
## Sammanfattning
Skapar ett nytt dedikerat eventhub-kluster
...
## PROBLEMBESKRIVNING
New-AzEventHubCluster-cmdleten skapar det dedikerade eventhub-klustret i den angivna resurs gruppen
...
Skapar ett dedicerat kluster av typen Eventhub-Cluster-5557 i resourcegroup ' RSG-Cluster27651 ' med platsen southcentralus och Capacity as 1

## MALLPARAMETRAR

### -Kapacitet
Kluster kapacitet (CU), curerntrly, tillåtet värde = 1
...
### -Tagg
Hashtables som representerar resurs märken för kluster
