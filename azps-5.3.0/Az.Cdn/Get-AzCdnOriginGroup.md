...
## PROBLEMBESKRIVNING
I Get-AzCdnOriginGroup cmdlet hämtas en CDN-ursprung.
...
Det här kommandot hämtar ursprungs gruppen inom den angivna slut punkten.
...
### -ResourceId
Resurs-ID för gruppen ursprung
