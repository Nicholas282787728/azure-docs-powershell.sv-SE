...
## PROBLEMBESKRIVNING
Godkänna replikeringsanslutning på käll volymen
...
Det här kommandot godkänner replikeringen på MyAnfVolume.

## MALLPARAMETRAR

### -AccountName
Namnet på ANF-kontot för volymens replikeringskälla
...
Fil systemets ID för mål data skydds volymen
...
### -PassThru
Ange om replikeringstillståndet för den angivna volymen utfördes
...
### -PoolName
Namnet på ANF-poolen för volym för replikeringskälla
