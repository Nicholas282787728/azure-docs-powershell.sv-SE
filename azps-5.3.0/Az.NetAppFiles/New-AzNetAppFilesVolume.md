...
### -Säkerhets kopiering
En hash-tabell som representerar det säkerhetskopierade objektet
...
### -BackupId
Säkerhetskopiera ID. UUID v4 eller resurs-ID som används för att identifiera säkerhets kopian
...
### -KerberosEnabled
Beskriv om en volym är Kerberos-aktiverad
...
### -ReplicationObject
En hash-tabell som representerar målobjektet
...
### -SecurityStyle
Säkerhets formatet för volym. Möjliga värden är: ' NTFS ', ' Unix '
...
### -Stillbild
En hash-tabell som representerar ett SnapShot-objekt
...
Om den är aktive rad (true) volymen kommer att innehålla skrivskyddad. snapshot-katalog som ger åtkomst till var och en av volymens stillbilder (standard är sant)
...
### -SnapshotId
Skapa volym från en ögonblicks bild. UUID v4 eller resurs-ID som används för att identifiera ögonblicks bilden
...
### -ThroughputMibps
Maximalt genomflöde i Mibps som kan uppnås av den här volymen
