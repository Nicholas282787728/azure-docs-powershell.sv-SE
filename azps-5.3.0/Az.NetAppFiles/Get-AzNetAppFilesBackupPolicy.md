...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzNetAppFilesBackupPolicy** hämtar information om en ANF säkerhets kopierings princip.
...
### -AccountObject
Det konto objekt som innehåller säkerhets kopierings principen som ska returneras
