...
## PROBLEMBESKRIVNING
Cmdleten **New-AzNetAppFilesPool** skapar en ANF-pool.

## BESKRIVS

### Exempel 1: skapa en ANF-pool
```
...
Det här kommandot skapar den nya ANF-poolen "MyAnfPool" i kontot "MyAnfAccount".
...
### -AccountObject
Kontot för det nya programpoolskontot
