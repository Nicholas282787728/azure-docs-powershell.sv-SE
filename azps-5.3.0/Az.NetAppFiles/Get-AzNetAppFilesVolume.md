...
Det här kommandot får volymen som heter MyAnfVolume från poolen "MyAnfPool". 
...
### -PoolObject
Det pool-objekt som innehåller volymen som ska returneras
