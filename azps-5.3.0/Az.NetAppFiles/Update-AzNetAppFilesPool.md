...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzNetAppFilesPool** ändrar en ANF-pool.

## BESKRIVS

### Exempel 1: ändra en ANF-pool
```
...
Det här kommandot ändrar ANF-poolen "MyAnfPool" till den angivna storleken och QosType.
...
### -AccountObject
Det konto objekt som innehåller poolen som ska uppdateras
...
### -InputObject
Pool-objekt som ska uppdateras
...
### -QosType
QoS-typen för poolen. Möjliga värden är: ' auto ', ' Manual '
