...
Det här kommandot avaktiverar ANF på volymen "MyDestinationAnfVolume".

## MALLPARAMETRAR

### -AccountName
Namnet på ANF-kontot för replikeringstjänsten
...
### -ForceBreak
Om replikeringen befinner sig i status överföring och du vill tvinga fram en paus
...
### -InputObject
ANF mål volym objekt med replikering för att brytas
...
### -PassThru
Returnera om rasten för den angivna volym replikeringen utfördes
...
### -PoolName
Namnet på ANF-poolen för replikeringstjänsten
