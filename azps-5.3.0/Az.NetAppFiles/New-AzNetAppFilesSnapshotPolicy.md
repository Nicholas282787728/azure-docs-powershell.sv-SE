...
## PROBLEMBESKRIVNING
Cmdleten **New-AzNetAppFilesActiveDirectory** skapar en ny ögonblicks bild princip för ett ANF-konto.
...
Det här kommandot skapar den nya ANF Snapshot-principen för ANF-kontot "konto".
