...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzNetAppFilesBackupPolicy** ändrar en ANF säkerhets kopierings princip.
...
Det här kommandot ändrar säkerhets kopierings princip för ANF "MyBackupPolicy" så att angiven DailyBackupsToKeep visas.
...
### -AccountObject
Det konto objekt som innehåller säkerhets kopierings principen
...
### -DailyBackupsToKeep
Dagliga säkerhets kopior för att hålla
...
### -InputObject
BackupPolicy-objekt som ska tas bort
...
Månads vis säkerhets kopior för att hålla
...
### -Namn
Namnet på ANF säkerhets kopierings princip
...
### -ResourceId
Resurs-ID för ANF säkerhets kopierings princip
...
### -WeeklyBackupsToKeep
Vecko antal säkerhets kopior som ska behållas
...
### -YearlyBackupsToKeep
Årlig säkerhets kopiering för att hålla
