...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzCognitiveServicesAccountNetworkRuleSet** uppdaterar egenskapen NetworkRule för ett konto för kognitiva tjänster
...
### Exempel 3: Rensa regler med NetworkRule för ett konto för kognitiva tjänster
```
...
Det här kommandot rensar bort NetworkRule för ett konto för kognitiva tjänster (andra egenskaper inte ändras).

## MALLPARAMETRAR

### -DefaultAction
Kognitiva tjänster-NetworkRule DefaultAction. Standardvärde `Deny` .
...
### -IpRule
Kognitiva tjänster-NetworkRule IpRules.
...
### -Namn
Konto namn för kognitiva tjänster.
...
### -VirtualNetworkRule
Kognitiva tjänster-NetworkRule VirtualNetworkRules.
