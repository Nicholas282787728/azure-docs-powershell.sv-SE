...
## PROBLEMBESKRIVNING
**New-AzCognitiveServicesAccountKey** cmdlet återskapar en API-nyckeln för ett kognitivt-konto.
...
### -Namn
Anger namnet på den som ska återskapas.
...
### Microsoft. Azure. Management. CognitiveServices. Models. Name
