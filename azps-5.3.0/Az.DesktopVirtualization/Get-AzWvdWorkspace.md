...
### Exempel 1: Hämta en Windows Virtual Desktop-arbetsyta med namn
```powershell
...
Det här kommandot får en Windows-arbetsyta för virtuella skriv bord i en resurs grupp.

### Exempel 2: lista arbets ytor för virtuella skriv bord i Windows
```powershell
...
Det här kommandot listar arbets ytor för Windows virtuella skriv bord i en resurs grupp.
...
### Microsoft. Azure. PowerShell. cmdletar. DesktopVirtualization. Models. Api20201102Preview. IWorkspace
