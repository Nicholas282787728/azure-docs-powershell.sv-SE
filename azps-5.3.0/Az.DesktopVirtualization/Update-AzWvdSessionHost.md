...
### Exempel 1: uppdatera en Windows Virtual Desktop-SessionHost efter namn
```powershell
...
Det här kommandot uppdaterar en Windows Virtual Desktop-SessionHost i en adresspool.
...
### -AssignedUser
Användare tilldelad SessionHost.
...
### Microsoft. Azure. PowerShell. cmdletar. DesktopVirtualization. Models. Api20201102Preview. ISessionHost
