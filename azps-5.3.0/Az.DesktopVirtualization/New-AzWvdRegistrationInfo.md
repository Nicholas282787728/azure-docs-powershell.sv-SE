...
### Exempel 1: skapa ett registrerings-token för ett virtuellt skriv bord i Windows
```powershell
...
Det här kommandot skapar ett registrerings-token för Windows virtuella skriv bord i en adresspool.
...
### Microsoft. Azure. PowerShell. cmdletar. DesktopVirtualization. Models. Api20201102Preview. IRegistrationInfo
