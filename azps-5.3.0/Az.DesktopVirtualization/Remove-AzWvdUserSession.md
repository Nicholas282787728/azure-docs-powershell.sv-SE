...
### Exempel 1: ta bort en Windows Virtual Desktop UserSession efter namn
```powershell
...
Det här kommandot tar bort en Windows Virtual Desktop-UserSession i en sessionsnyckel.
...
### -Force
Tvinga flaggan att logga ut userSession.
