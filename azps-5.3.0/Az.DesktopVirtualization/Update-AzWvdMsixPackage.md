...
Det här kommandot uppdaterar ett MSIX-paket i ett HostPool.
...
### -DisplayName
Visnings namn för MSIX-paketet.
...
### -IsActive
Ange att en version av paketet ska aktive ras på hostpool.
...
Ange registrerings läge.
Vanligt eller försenat.
...
### Microsoft. Azure. PowerShell. cmdletar. DesktopVirtualization. Models. Api20201102Preview. IMsixPackage
