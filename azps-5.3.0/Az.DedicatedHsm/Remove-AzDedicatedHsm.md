...
## Sammanfattning
Tar bort den angivna Azure-dedikerade HSM.
...
### Exempel 1: ta bort en dedikerad HSM efter namn
```powershell
PS C:\> Remove-AzDedicatedHsm -Name hsm-7t2xaf -ResourceGroupName lucas-manual-test

```

Med den här commnad tas en HSM bort med namn.

### Exempel 2: ta bort en dedicerad HSM efter objekt
```powershell
...
Denna commnad tar bort en dedicerad HSM efter objekt.
...
### -Namn
Namnet på den dedikerade HSM som ska tas bort
