...
### Exempel 1: ta bort en instans av SAP Monitor utifrån namn
```powershell
PS C:\> Remove-AzSapMonitorProviderInstance -ResourceGroupName nancyc-hn1 -SapMonitorName ps-spamonitor-t01 -Name ps-sapmonitorins-t02

```

Det här kommandot tar bort en instans av SAP monitor med namn.

### Exempel 2: ta bort instans av SAP Monitor by-objekt
```powershell
...
Det här kommandot tar bort en instans av SAP Monitor by objekt.
