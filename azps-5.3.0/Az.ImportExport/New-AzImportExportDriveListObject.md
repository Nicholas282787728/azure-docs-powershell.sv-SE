...
### Exempel 1: skapa en ny DriveList för ImportExport-jobbet
```powershell
...
Dessa cmdletar skapar en ny DriveList för ImportExport-jobb.

## MALLPARAMETRAR

### -BitLockerKey
Den BitLocker-nyckel som används för att kryptera enheten.
...
### -BytesSucceeded
Byte som lyckats överföras för enheten.
...
### -CopyStatus
Detaljerad status om data överförings processen.
Det här fältet returneras inte i svaret förrän enheten är i överförings läget.
...
### -DriveHeaderHash
Hash-värdet för enhetens huvud.
...
### -DriveId
Enhetens serie nummer utan mellanslag.
...
### -ErrorLogUri
En URI som pekar på blobben som innehåller fel loggen för data överförings åtgärden.
...
### -ManifestFile
Den relativa sökvägen till manifest filen på enheten.
...
### -ManifestHash
Den Base16iska MD5-hashen för manifest filen på enheten.
...
### -ManifestUri
En URI som pekar på blobben som innehåller enhetens manifest fil.
...
### -VerboseLogUri
En URI som pekar på blobben som innehåller utförlig loggen för data överförings åtgärden.
...
### Microsoft. Azure. PowerShell. cmdletar. ImportExport. Models. Api20161101. IDriveStatus
