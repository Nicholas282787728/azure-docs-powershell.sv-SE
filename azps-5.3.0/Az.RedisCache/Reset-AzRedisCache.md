...
## PROBLEMBESKRIVNING
Cmdleten **Reset-AzRedisCache** startar om noder för en Azure Redis-cachepost.

## BESKRIVS

### Exempel 1: starta om båda noderna
```
PS C:\>Reset-AzRedisCache -ResourceGroupName "ResourceGroup13" -Name "RedisCache06" -RebootType "AllNodes" -Force
```

Med det här kommandot startas båda noderna för cacheminnet som heter RedisCache06.
...
### -RebootType
Anger vilken nod eller vilka noder som ska startas om.
...
### -ShardId
Anger ID för den Shard som denna cmdlet startar om för en Premium-cache med kluster aktiverat.
