...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzRedisCachePatchSchedule** tar bort uppdaterings schema från cachen i Azure Redis-cachen.

## BESKRIVS

### Exempel 1: ta bort uppdaterings schema
```
PS C:\>Remove-AzRedisCachePatchSchedule -ResourceGroupName "ResourceGroup13" -Name "RedisCache06"
```

Det här kommandot tar bort uppdaterings schema från cachen som heter RedisCache06.
