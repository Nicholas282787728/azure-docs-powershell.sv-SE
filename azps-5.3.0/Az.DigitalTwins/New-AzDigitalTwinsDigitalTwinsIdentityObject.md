...
### Exempel 1: skapa en DigitalTwinsIdentityObject
```powershell
...
Skapa en DigitalTwinsIdentityObject utifrån ID och plats
...
### Microsoft. Azure. PowerShell. cmdletar. DigitalTwins. Models. DigitalTwinsIdentity
