...
### Exempel 1: kontrol lera namnet efter plats och namn.
```powershell
...
Kontrol lera tillgängligheten för namnet efter plats och namn.

### Exempel 2: kontrol lera namnet med DigitalTwinsObject och CheckNameObject.
```powershell
...
Hämta en DigitalTwinsInstance och skapa ett Requset-objekt för att testa tillgängligheten för namnet.
...
Resultatet som returneras från en begäran om namn tillgänglighet för databas kontroll.
För att konstruera kan du läsa avsnittet anteckningar för DIGITALTWINSINSTANCECHECKNAME-egenskaper och skapa en hash-tabell.
...
### -Plats
Plats för DigitalTwinsInstance.
...
### Microsoft. Azure. PowerShell. cmdletar. DigitalTwins. Models. Api20201031. ICheckNameRequest

### Microsoft. Azure. PowerShell. cmdletar. DigitalTwins. Models. IDigitalTwinsIdentity

## VÄRDEN

### Microsoft. Azure. PowerShell. cmdletar. DigitalTwins. Models. Api20201031. ICheckNameResult
...
DIGITALTWINSINSTANCECHECKNAME <ICheckNameRequest> : resultatet returneras från en begäran om namn tillgänglighet för databasen.
  - `Name <String>`: Resurs namn.
