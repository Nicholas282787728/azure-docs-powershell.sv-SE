...
### Exempel 1: ta bort ett AzDigitalTwinsInstance efter namn
```powershell
...
Det här kommandot tar bort ett AzDigitalTwinsInstance efter namn

### Exempel 2: ta bort en AzDigitalTwinsInstance från InputObject
```powershell
