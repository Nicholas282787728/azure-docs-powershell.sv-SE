...
## PROBLEMBESKRIVNING
Det här kommandot avabonnerar händelse utlösaren för angivna externa tjänst händelser från trigger defintion.
...
Det här kommandot avbryter prenumerationen på BlobEnetTrigger1 för angivna händelser från utlösaren defintion.
...
### -PassThru
Om det här värdet anges returnerar cmdlet return true vid lyckad borttagning.
