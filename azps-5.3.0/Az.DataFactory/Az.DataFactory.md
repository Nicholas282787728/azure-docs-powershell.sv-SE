...
Få alla aktiva data flödes debug-sessioner av Azure Data Factory.
...
### [Spara – AzDataFactoryLog](Save-AzDataFactoryLog.md)
...
Startar en data flödes debug-session i Azure Data Factory.

### [Stopp-AzDataFactoryV2IntegrationRuntime](Stop-AzDataFactoryV2IntegrationRuntime.md)
Stoppar en hanterad dedikerad integrerings körning.

### [Stopp-AzDataFactoryV2PipelineRun](Stop-AzDataFactoryV2PipelineRun.md)
Stoppar en pipeline-körning i en data fabrik.

### [Stopp-AzDataFactoryV2Trigger](Stop-AzDataFactoryV2Trigger.md)
...
Avbryter en data flödes-debug-session i Azure Data Factory.
