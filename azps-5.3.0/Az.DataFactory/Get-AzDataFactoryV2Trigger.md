...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDataFactoryV2Trigger** hämtar information om utlösare i en data fabrik. Om du anger namnet på en utlösare får cmdleten information om den utlösaren. Om du inte anger ett namn får cmdleten information om alla utlösare i data fabriken.

## BESKRIVS

### Exempel 1: få information om alla utlösare
```
...
### Exempel 2: få information om en viss utlösare
```
