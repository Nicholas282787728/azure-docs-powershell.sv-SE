...
## PROBLEMBESKRIVNING
Cmdleten **Start-AzDataFactoryV2Trigger** startar en utlösare i en data fabrik. Om utlösaren är i tillståndet "stoppad" startar cmdleten utlösaren och kommer slutligen till att ligga på grund val av dess definition. Om utlösaren redan är i tillståndet start har denna cmdlet ingen effekt. Om parametern Force anges frågar inte cmdleten innan utlösaren startas.

## BESKRIVS

### Exempel 1: starta en utlösare
```
...
Startar en utlösare som heter "ScheduledTrigger" i data fabriken "WikiADF".
