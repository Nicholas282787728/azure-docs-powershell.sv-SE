...
Skapar en registrerings definition genom roleDefinitionId-och principalId-värden som ges direkt.
...
Skapar eller uppdaterar en registrerings definition med auktoriseringsinformation.
...
Uppdaterar en registrerings definition med auktoriseringsinformation och namnet på registrerings definitionen.

## MALLPARAMETRAR

### -Auktorisering
Listan för auktorisering med principalId-roleDefinitionId.
...
### -Beskrivning
Beskrivning av registrerings definitionen.
...
### -DisplayName
Visnings namnet för registrerings definitionen.
...
### -RoleDefinitionId
Roll Definitions-ID för att tilldela behörigheter till huvud-ID.
