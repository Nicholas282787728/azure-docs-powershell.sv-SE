...
## Sammanfattning
Uppdaterar MSI till Recovery Services-valvet.
...
## PROBLEMBESKRIVNING
Denna cmdlet används för att lägga till eller ta bort MSI från Recovery Services-valvet. Använd-IdentityType parameter för att tilldela en SystemAssigned-identitet till RSVault. Använd IdentityType none för att ta bort MSI från valvet.
...
Denna cmdlet används för att lägga till en SystemAssigned-identitet i ett Recovery Services-valv.
...
Anger namnet på det Recovery-valv som ska uppdateras.
...
Anger namnet på Azure Resource Group där Recovery Services-valvet finns.
...
### Microsoft. Azure. Management. RecoveryServices. Models. valv
