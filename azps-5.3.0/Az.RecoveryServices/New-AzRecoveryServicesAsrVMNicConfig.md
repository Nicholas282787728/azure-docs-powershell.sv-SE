...
Skapar ett ASRVmNicConfig-objekt med test faiover nätverks inställningar som har kon figurer ATS för att byta namn på NÄTVERKSKORTet. Eventuella egenskaper som inte skickades ovan hämtas från det skyddade objektet.


### Exempel 3

Skapar en ASR NIC-konfiguration som innehåller redundans-och testredundans-relaterade konfigurations uppgifter. (automatiskt genererat)
...
### -RecoveryNicName
Anger namnet på återställnings kortet.
...
Anger namnet på resurs gruppen för Recovery NIC.
...
### -ReuseExistingNic
Anger om ett befintligt nätverkskort kan användas under redundans.
...
### -TfoNicName
Anger namnet på testredundans NIC.
...
Anger namnet på resursen för testa redundans-NIC.
...
### -TfoReuseExistingNic
Anger om ett befintligt nätverkskort kan användas under testning av redundans.
