...
## PROBLEMBESKRIVNING
Cmdleten **New-AzRecoveryServicesAsrRecoveryPlan** skapar en Azure Site Recovery, återställnings plan i Recovery Services-valvet.
...
Startar åtgärden för att skapa återställnings plan för Azure Zone till replikerade objekt och returnerar det ASR-jobb som används för att spåra åtgärden.

## MALLPARAMETRAR

### -Azure
Switch parameter anger scenariot för återställning av en Azure-till-Azure-krasch, återställnings plan.
...
### -AzureZoneToZone
Switch parameter anger att det replikerade objektet ska skapas i scenariot för Azure Zone till Zone.
...
### -PrimaryZone
Anger den primära Availabilty Zone för de replikerade objekt som kommer att ingå i denna återställnings plan.
