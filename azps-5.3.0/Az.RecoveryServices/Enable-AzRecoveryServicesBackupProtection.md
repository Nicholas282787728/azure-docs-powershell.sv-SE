...
## PROBLEMBESKRIVNING
Cmdleten **Enable-AzRecoveryServicesBackupProtection** aktiverar säkerhets kopian genom att koppla en skydds princip till objektet.
...
Den andra cmdleten anger vilka disk enheter som ska säkerhets kopie ras och lagrar dem i $inclusionDiskLUNS variabel.
Den tredje cmdleten ställer in säkerhets kopierings skydds principen för den virtuella dator ARM med namnet V2VM med principen i $Pol.

### Exempel 2

Aktiverar säkerhets kopiering av ett objekt med en angiven säkerhets policy för säkerhet. (automatiskt genererat)
...
### -ExcludeAllDataDisks
Alternativet endast för att ange säkerhets kopiering av OS-diskar
...
### -ExclusionDisksList
Lista över disk-LUN som ska uteslutas i säkerhets kopiering och resten ingår automatiskt.
...
### -InclusionDisksList
Lista över diskar som är logiska för säkerhets kopiering och resten utesluts automatiskt förutom OS-diskar.
...
### -ProtectableItem
Anger det objekt som ska skyddas med den angivna policyn.
...
Anger att inställningen för disk uteslutning är kopplad till objektet
