...
## Sammanfattning
Tar bort diskar för att replikera ett skyddat objekt.
...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzRecoveryServicesAsrReplicationProtectedItemDisk** tar bort disken från det skyddade objektet för ASR-replikering.
...
Starta åtgärden för att ta bort den angivna disken från en skyddad virtuell dator för en ohanterad disk.
...
Starta åtgärden för att ta bort den angivna disken från en skyddad virtuell dator för hanterade diskar.
...
### -DiskId
Anger listan med hanterade disk-ID: n.
...
### -InputObject
Indatavärdet till cmdleten: objektet skyddat objekt för ASR som motsvarar den disk som ska tas bort.
