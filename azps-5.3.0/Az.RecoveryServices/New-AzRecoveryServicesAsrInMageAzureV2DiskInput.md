...
## PROBLEMBESKRIVNING
Skapar ett disk kart objekt som mappar en virtuell dator disk för vMWare till det lagrings konto och mål som hanteras för att hantera disken.
...
Skapa ett disk kart objekt för virtuella dator diskar för vMWare för att replikeras. Används under Aktivera skydd för vMWare-datorn.
...
### -DiskId
Ange DiskId för den disk som den här mappningen motsvarar.
...
### -DiskType
Anger typ av återställnings diskett.
