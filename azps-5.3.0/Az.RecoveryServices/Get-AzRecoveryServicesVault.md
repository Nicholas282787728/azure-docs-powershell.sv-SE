...
Den första cmdleten får valvet i resurs gruppen med angivet namn. Då kommer vi åt MSI-informationen från valvet.
...
Anger taggarna som ska sökas efter
...
Anger tangenten för tagg att fråga efter
...
Anger värdet för taggen som du vill fråga efter
...
## ANMÄRKNINGAR
Get-AzRecoveryServicesVault i den gamla versionen av AZ. RecoveryServices (<= 2.10.0) kan inte fungera med AZ. accounts (>= 1.8.1) på grund av fel sammansättnings referens. Modulen AZ. RecoveryServices måste uppgraderas till 2.11.0 eller senare om du använder de senaste AZ eller AZ. accounts.
