...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDataShareProviderSubscription** hämtar information om klient prenumerationer på leverantörens sida. Om du anger Share abonnemang ID får denna cmdlet information om Share-prenumerationen. Om du inte anger ID för delad prenumeration får denna cmdlet information om alla klient prenumerationer för konsument delning som är associerade med resursen.
...
Det här kommandot innehåller information om klient prenumerationen för resurser som är kopplad till Share AdsShare i WikiAds för data delning.

## MALLPARAMETRAR

### -AccountName
Namn på Azure DataShare.
...
### -ResourceGroupName
Resurs gruppen för Azure DataShare-kontot.
...
### -ShareSubscriptionId
ID för konsument delnings abonnemang
