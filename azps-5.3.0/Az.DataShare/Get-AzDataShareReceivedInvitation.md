...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDataShareReceivedInvitation** innehåller information om alla inbjudningar som klienten har receieved. Om du tillhandahåller plats-eller Inbjudnings-ID ger denna cmdlet information om inbjudan, särskilt plats eller efter Inbjudnings-ID. Annars visas en lista med inbjudningar till mottagaren.
...
Detta ger information om konsument inbjudningar.
...
### -InvitationId
Inbjudan-ID för Azure dataShare.
...
### -Plats
Plats för inbjudan till Azure Data delning.
