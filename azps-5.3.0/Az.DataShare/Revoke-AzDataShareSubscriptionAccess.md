...
## PROBLEMBESKRIVNING
Med cmdleten **REVOKE-AzDataShareSubscriptionAccess** tilldelas en åtkomst till käll resursen för dela prenumeration
...
Återkalla åtkomsten till Share-prenumerationen som identifieras av ID 8ee6e6fd-b4a1-49a4-bb66-f187f38e0e12
...
### -ShareSubscriptionId
ID för Share-Subscription för leverantörens delnings abonnemang
