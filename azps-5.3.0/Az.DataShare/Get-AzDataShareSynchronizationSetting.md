...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDataShareSynchronizationSetting** innehåller information om synkronisering aktive rad på en resurs. 
...
Det här kommandot innehåller information om synkronisering ShareSynchronization aktive rad på Share AdsShare under data Share Account WikiAds.
...
### -ResourceId
Resurs-ID för Azure Data Share-synkronisering
