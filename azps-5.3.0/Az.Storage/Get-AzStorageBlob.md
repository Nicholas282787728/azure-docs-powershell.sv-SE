...
### Exempel 5: Hämta alla BLOB i en container inkluderar blob-version
```
...
Det här kommandot får alla blobbar i en container inklusive BLOB-versionen.

### Exempel 6: skaffa en enda blob-version
```
...
Det här kommandot får en verion med VersionId.

### Exempel 7: skaffa en enda BLOB-stillbild
```
...
Det här kommandot får en enda blobbar med SnapshotTime.
...
Om du anger ett värde för den här parametern visar cmdleten alla blobbar med namn som matchar den här parametern. Den här parametern stöder jokertecken var som helst i strängen.
...
### -IncludeVersion
BLOB-versioner visas bara om den här parametern finns, som standard innehåller endast BLOB-versioner.
