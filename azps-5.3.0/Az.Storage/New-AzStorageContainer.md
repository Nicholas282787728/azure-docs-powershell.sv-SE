...
## PROBLEMBESKRIVNING
Cmdleten **New-AzStorageContainer** skapar en Azure Storage-behållare.
...
### Exempel 3: skapa en Azure-lagringsenhet med krypterings omfång
```
...
Det här kommandot skapar en lagrings behållare med standard krypterings omfattning som myencryptscope och förverterad BLOB-uppladdning med olika krypterings omfång till den här behållaren.
...
Använd den angivna krypterings omfattningen för alla skrivningar.
...
Blockera åsidosättning av krypterings omfång från standard behållare.
