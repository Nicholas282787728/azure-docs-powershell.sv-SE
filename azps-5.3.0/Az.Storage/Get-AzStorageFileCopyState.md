...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzStorageFileCopyState** får statusen för en Azure Storage File Copy-åtgärd.
Den bör köras på kopian.

## BESKRIVS

### Exempel 1: Hämta kopierings status efter fil namn
```
PS C:\>Get-AzStorageFileCopyState -ShareName "ContosoShare" -FilePath "ContosoFile"
```

Det här kommandot får statusen för kopierings åtgärden för en fil som har det angivna namnet.

### Exempel 2: Starta kopiering och pipeline för att få kopierings status
```
...
Det första kommandot börjar kopiera filen "contosofile" till "contosofile_copy" och spara destiantion-filobjektet. Det andra kommandot kan använda destiantion-filobjektet för att hämta-AzStorageFileCopyState för att få fil kopierings status.
