...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDataLakeGen2Item** hämtar information om en fil eller katalog i ett fil system i ett Azure Storage-konto.
...
### Exempel 1: Hämta en katalog från ett filesystem och Visa informationen
```
...
Det här kommandot får en katalog från ett filesystem och visar informationen.

### Exempel 2: Hämta en fil från ett filesystem
```
...
Det här kommandot får information om en fil från ett fil system. 
...
Inte ange den här parametern för att hämta fil systemets rot Katalog.
