...
## Sammanfattning
Hämta eller lista krypterings omfattningar från ett lagrings konto.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzStorageEncryptionScope** hämtar eller visar krypterings områden från ett lagrings konto.

## BESKRIVS

### Exempel 1: skaffa en enda krypterings omfattning
```
...
Det här kommandot får en enda krypterings omfattning.

### Exempel 2: lista alla krypterings områden för ett lagrings konto
```
...
Det här kommandot listar alla krypterings områden för ett lagrings konto.
