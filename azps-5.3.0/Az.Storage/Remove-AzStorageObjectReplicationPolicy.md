...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzStorageObjectReplicationPolicy** tar bort den angivna resursallokeringsprincipen från ett lagrings konto.

## BESKRIVS

### Exempel 1: ta bort en resursallokeringsprincip med specifika policyId från ett lagrings konto.
```
Remove-AzStorageObjectReplicationPolicy -ResourceGroupName "myresourcegroup" -AccountName "mystorageaccount" -PolicyId $policyId
```

Det här kommandot tar bort en resursallokeringsprincip med specifika policyId från ett lagrings konto.
...
### -InputObject
Principobjektet objekt som ska tas bort.
