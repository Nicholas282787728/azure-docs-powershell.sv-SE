...
## Sammanfattning
Skapar en krypterings omfattning för ett lagrings konto.
...
## PROBLEMBESKRIVNING
Cmdleten **New-AzStorageEncryptionScope** skapar en krypterings omfattning för ett lagrings konto.

## BESKRIVS

### Exempel 1: skapa ett krypterings omfång med lagrings kryptering
```
...
Det här kommandot skapar ett krypterings omfång med lagrings kryptering.

### Exempel 2: skapa en krypterings omfattning med valv kryptering
```
...
Det här kommandot skapar en krypterings omfattning med valv kryptering.
