...
### Exempel 3: skapa en lagrings behållare med EncryptionScope inställning
```
...
Det här kommandot skapar en lagrings behållare med en defalt-encryptionScope och blockerar blockering av krypterings omfång från standard behållaren.
Visa sedan de relaterade egenskaperna för behållaren.
