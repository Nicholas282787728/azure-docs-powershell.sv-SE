...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzApiManagementPolicy** hämtar den angivna omfattnings principen.
...
### Exempel 5: Hämta principer för klient organisations omfattning i RawXml-format
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Det här kommandot hämtar principer för klient organisations omfattning i icke-XML-avbrotts format.
...
### -ApiRevision
Identifierare för API-revision. Denna parameter är valfri. Om det inte anges hämtas policyn från den för tillfället aktiva API-ändringen.
...
Standardvärdet för den här parametern är "XML".
