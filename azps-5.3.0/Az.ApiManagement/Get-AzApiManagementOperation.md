...
## PROBLEMBESKRIVNING
**Get-AzApiManagementOperation** får en lista eller en angiven API-åtgärd.
...
### -ApiRevision
Identifierare för API-revision. Denna parameter är valfri. Om det inte anges hämtas åtgärden från den för tillfället aktiva API-ändringen.
