...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzApiManagementApiFromGateway** bifogar ett API till en gateway.

## BESKRIVS

### Exempel 1: ta bort ett API från en gateway
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementApiFromGateway -Context $ApiMgmtContext -GatewayId "0123456789" -ApiId "0001" -PassThru
```

Det här kommandot tar bort angivet API från en gateway.

## MALLPARAMETRAR

### -ApiId
Identifierare för befintliga API: er som ska tas bort från gatewayen.
...
### -GatewayId
Identifierare för befintlig gateway att ta bort API från.
Denna parameter är obligatorisk.
