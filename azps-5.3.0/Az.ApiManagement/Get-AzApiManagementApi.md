...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzApiManagementApi** har en eller flera API: er för Azure API-hantering.
...
### Exempel 4: skaffa ett Management API genom GatewayId
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementApi -Context $ApiMgmtContext -GatewayId "g01"
```

Det här kommandot får API: t för angiven GatewayId.
...
### -GatewayId
Om det här är angivet försöker alla gateway API: er.
