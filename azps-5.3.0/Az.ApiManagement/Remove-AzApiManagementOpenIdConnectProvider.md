...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzApiManagementOpenIdConnectProvider** tar bort en OpenID Connect-leverantör för Azure API Management.
...
Det här kommandot tar bort en Provider med ID-OICProvider01.
