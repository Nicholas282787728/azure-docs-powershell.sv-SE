...
## PROBLEMBESKRIVNING
Cmdleten **set-AzApiManagementOperation** anger API-åtgärd.

## BESKRIVS

### Exempel 1: Ange åtgärds uppgifter
```powershell
...
Det här kommandot anger åtgärds informationen för API-hantering.

### Exempel 2

Anger information om API-åtgärd. (automatiskt genererat)
...
### -ApiRevision
Identifierare för API-revision. Denna parameter är valfri. Om det inte anges uppdateras åtgärden i den för tillfället aktiva API-ändringen.
...
### -Beskrivning
Anger beskrivningen för den nya åtgärden.
...
### -Metod
Anger HTTP-metoden för den nya åtgärden.
...
### -Namn
Anger visnings namnet på den nya åtgärden.
...
### -Begäran
Anger information om betalningsbegäran.
...
### -Svar
Anger en matris med möjliga åtgärds svar.
...
### -TemplateParameters
Anger en matris eller parametrar som definierats i parameter *UrlTemplate*.
Om du inte anger något värde genereras ett standardvärde baserat på UrlTemplate.
Använd parametern för att ge mer information om parametrar som beskrivning, typ och andra möjliga värden.
...
### -UrlTemplate
Anger URL-mallen.
Till exempel: kunder/{CID}/order/{OID}/? date = {date}.
