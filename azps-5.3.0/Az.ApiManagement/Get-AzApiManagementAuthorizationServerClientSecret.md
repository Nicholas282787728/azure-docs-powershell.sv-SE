...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzApiManagementAuthorizationServerClientSecret** hämtar klient hemligheten för Azure API Management Authorization Server.

## BESKRIVS

### Exempel 1: skaffa en angiven klient hemlighet per ID för en server
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementAuthorizationServerClientSecret -Context $ApiMgmtContext -ServerId "0123456789"
```

Det här kommandot får den angivna cient hemlighet.
...
### -ResourceId
Arm-resurs-ID för auktoriseringsservern.
Om det här alternativet anges görs ett försök att hitta auktoriseringsservern med identifieraren.
Denna parameter är obligatorisk.
...
Om det här alternativet anges visas en Authorization Server enligt ID.
