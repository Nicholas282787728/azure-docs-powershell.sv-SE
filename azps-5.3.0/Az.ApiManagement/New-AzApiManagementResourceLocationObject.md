...
## PROBLEMBESKRIVNING
**New-AzApiManagementResourceLocationObject-** cmdleten skapa ett nytt resurs plats avtal (används i gateways).

## BESKRIVS

### Exempel 1: skapa ett resurs plats kontrakt
```powershell
PS C:\>$location = New-AzApiManagementResourceLocationObject -Name "n1" -City "c1" -District "d1" -CountryOrRegion "r1"
```

Det här kommandot skapar en resurs plats.
