...
## PROBLEMBESKRIVNING
Cmdleten **New-AzApiManagementProduct** skapar en API-hanterings produkt.

## BESKRIVS

### Exempel 1: skapa en produkt som inte kräver ett abonnemang
```
...
Det här kommandot skapar en API-produktnyckel.
Det krävs inget abonnemang.

### Exempel 2: skapa en produkt som kräver ett abonnemang och godkännande
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Det här kommandot skapar en produkt.
Ett abonnemang och godkännande krävs.
Det här kommandot anger meddelandets tids period till 10 dagar.
Abonnemangets längd är inställd på ett år.

## MALLPARAMETRAR

### -ApprovalRequired
Anger om prenumerationen på produkten kräver godkännande eller inte.
Denna parameter är **$false**.
...
### -Produktnr
Anger identifieraren för ny produkt.
Om du inte anger den här parametern genereras en ny produkt.
...
psdx_paramvalues
- NotPublished
- Publicerade standardvärdet är NotPublished.
...
### System. Nullable ' 1 [[Microsoft. Azure. commands. ApiManagement. ServiceManagement. Models. PsApiManagementProductState, Microsoft. Azure. PowerShell. cmdletar. ApiManagement. ServiceManagement, version = 1.0.0.0, Culture = neutralt, PublicKeyToken = null]]
