...
## PROBLEMBESKRIVNING
Cmdleten **New-AzApiManagementAuthorizationServer** skapar en auktoriseringsprincip för Azure API Management.
...
Skapar en auktoriseringsprincip. (automatiskt genererat)
