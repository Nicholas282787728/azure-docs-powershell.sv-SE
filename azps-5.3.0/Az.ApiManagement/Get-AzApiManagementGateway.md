...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzApiManagementGateway** hämtar alla eller specifika API-hanterings-Gateway.

## BESKRIVS

### Exempel 1: Hämta alla gateways
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGateway -Context $apimContext
```

Det här kommandot får alla gateways.

### Exempel 2: skaffa en gateway utifrån ID
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGateway -Context $apimContext -GatewayId "0123456789"
```

Det här kommandot får Gateway 0123456789.
...
### -GatewayId
Identifierare för en gateway.
Om det här alternativet anges kommer gatewayen att hittas.
