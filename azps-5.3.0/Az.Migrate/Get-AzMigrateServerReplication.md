...
## Sammanfattning
Hämtar information om den replikerande servern.
...
### Exempel 1: hämta uppgifter utifrån ID
```powershell
...
### Exempel 2: Visa alla i Project med ID.
```powershell
...
### Exempel 2: Visa alla i Project med namn.
```powershell
...
### -DiscoveredMachineId
Anger dator-ID för den upptäckta servern.
...
### -InputObject
Anger datorobjektet för den replikerande servern.
...
### -Projektetsnamn
Anger Azure Migrate-projektet i det aktuella abonnemanget.
...
### -TargetObjectID
Anger den replikerande servern.
...
### Microsoft. Azure. PowerShell. cmdletar. Migrate. Models. Api20180110. IMigrationItem
...
INPUTOBJECT <IMigrationItem> : anger datorobjektet för den replikerande servern.
