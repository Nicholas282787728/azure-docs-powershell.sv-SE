...
## Sammanfattning
Hämta alla upptäckta servrar i ett migrera projekt.
...
Hämta alla servrar i ett migrera projekt.
...
Skaffa en server i ett migrera projekt efter namn.
Name är ett unikt paramenter för en server.

### Exempel 3: lista i en apparat
```powershell
...
Lista alla servrar för en apparat i ett projekt.

### Exempel 4: skaffa en apparat
```powershell
...
Skaffa en server för en apparat i ett projekt.
Name är ett unikt paramenter för en server.

### Exempel 5: lista och filtrera efter visnings namn
```powershell
...
Visa servrar i ett migrera projekt och filtrera svar med visnings namn.

### Exempel 6: lista i en apparat och filtrera efter visnings namn
```powershell
...
Lista servrar för en enhet i ett migrera projekt och filtrera svar med visnings namn.

## MALLPARAMETRAR

### -ApplianceName
Anger namnet på apparaten.
Det här kan mappas internt till en webbplats.
...
### -DisplayName
Anger visnings namnet för VMware-datorn.
...
### -Namn
Anger VMware-datorns namn.
Det här är ett internt namn.
För användare, Använd visnings namn.
...
### -Projektetsnamn
Anger det migrerande projekt namnet.
...
### Microsoft. Azure. PowerShell. cmdletar. Migrate. Models. Api202001. IVMwareMachine
