...
## PROBLEMBESKRIVNING
Cmdleten **New-AzHDInsightSqoopJobDefinition** definierar ett Sqoop Job-objekt som ska användas med ett Azure HDInsight-kluster.

## BESKRIVS

### Exempel 1: skapa en Sqoop
```
PS C:\># Cluster info
...
Det här kommandot skapar en Sqoop.

## MALLPARAMETRAR

### -Kommando
Anger kommandot Sqoop.
...
### -LibDir
Anger biblioteks katalogen för Sqoop-jobbet.
