...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzHDInsightClusterAutoscaleConfiguration** hämtar autoskalan för HDInsight-klustret.

## BESKRIVS

### Exempel 1: Hämta autoskalan för HDInsight-klustret.
```powershell
...
Det här kommandot hämtar autoskalans konfiguration för HDInsight-klustret.
