...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzDeploymentManagerServiceTopology** tar bort en tjänst sto pol Ogin.
...
Det här kommandot tar bort en tjänst sto pol ContosoServiceTopology i ContosoResourceGroup.

### Exempel 2: ta bort en tjänst sto pol Ogin med resurs-ID.
```powershell
...
### Exempel 3: ta bort en tjänst topologi med hjälp av objektet tjänst Topology.
```powershell
PS C:\> Remove-AzDeploymentManagerService -InputObject $serviceTopologyObject
```

Det här kommandot tar bort en tjänst sto pol Ogin vars namn och ResourceGroup matchar $serviceTopologyObjectens namn och ResourceGroupName-egenskaper.
