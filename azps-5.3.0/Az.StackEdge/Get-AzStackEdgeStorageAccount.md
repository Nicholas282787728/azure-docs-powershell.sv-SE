...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzStackEdgeStorageAccount** hämtar de lagrings konton som finns tillgängliga på en grupp Edge-enhet. Du kan ange namnet som en parameter i cmdleten för att hämta information om ett specifikt lagrings konto för Edge.
