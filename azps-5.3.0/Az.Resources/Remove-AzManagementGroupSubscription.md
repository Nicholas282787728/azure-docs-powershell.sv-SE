...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzManagementGroupSubscription** tar bort ett abonnemang från en hanterings grupp.

## BESKRIVS

### Exempel 1: ta bort abonnemang från en hanterings grupp
```powershell
...
### -SubscriptionId
Prenumerations-ID för abonnemanget som är kopplat till hanteringen
