...
### Exempel 3: uppdatera metadata för en princip definition
```
...
Det här kommandot uppdaterar metadata för en princip definition med namnet VMPolicyDefinition för att visa att kategorin är "virtuell dator".
...
### -InputObject
Det princip definitions objekt som ska uppdateras från en annan cmdlet.
