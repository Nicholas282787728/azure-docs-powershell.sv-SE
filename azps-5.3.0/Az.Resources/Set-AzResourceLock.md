...
## PROBLEMBESKRIVNING
Cmdleten **set-AzResourceLock** ändrar resurs låset.

## BESKRIVS

### Exempel 1: uppdatera anteckningar för ett lås
```
PS C:\>Set-AzResourceLock -LockLevel CanNotDelete -LockNotes "Updated note" -LockName "ContosoSiteLock" -ResourceName "ContosoSite" -ResourceType "microsoft.web/sites" -ResourceGroupName "ResourceGroup11"
```

Det här kommandot uppdaterar anteckningen för ett lås med namnet ContosoSiteLock.
...
### -LockId
Anger det lås som den här cmdleten ändrar.
...
För närvarande är det enda giltiga värdet CanNotDelete.
...
### -LockName
Anger namnet på det lås som denna cmdlet ändrar.
...
### -ResourceType
Anger den resurs typ som låset gäller för.
