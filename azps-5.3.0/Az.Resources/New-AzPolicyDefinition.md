...
### Exempel 5: skapa en princip definitions rad med ett läge
```
...
Det här kommandot skapar en princip definition med namnet TagsPolicyDefinition med läget "indexerat" som anger att principen bara ska utvärderas för resurs typer som stöder taggar och plats.
