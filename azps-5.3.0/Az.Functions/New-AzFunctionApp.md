...
### Exempel 1: skapa en PowerShell-funktion för användning i Central USA.
```powershell
...
Det här kommandot skapar en PowerShell-funktion för förbrukning i Central USA.

### Exempel 2: skapa ett PowerShell-Function-program som finns i en tjänste plan.
```powershell
PS C:\> New-AzFunctionApp -Name MyUniqueFunctionAppName `
                          -ResourceGroupName MyResourceGroupName `
                          -PlanName MyPlanName `
...
Det här kommandot skapar ett PowerShell-Function-program som finns i en tjänste plan.

### Exempel 3: skapa ett funktions program med hjälp av en privat ACR-bild.
```powershell
PS C:\> New-AzFunctionApp -Name MyUniqueFunctionAppName `
                          -ResourceGroupName MyResourceGroupName `
                          -PlanName MyPlanName `
...
Det här kommandot skapar ett funktions program med hjälp av en privat ACR-bild.

## MALLPARAMETRAR

### -ApplicationInsightsKey
Instrumentation-tangenten för App Insights för att läggas till.
...
Namnet på det befintliga App Insights-projektet som ska läggas till i programmets funktion.
...
### -AppSetting
Inställningar för programmets funktion.
...
### -AsJob
Kör cmdleten som ett bakgrunds jobb.
...
Inaktivera att skapa Application Insights-resursen under generering av funktions program.
...
### -DockerImageName
Endast Linux.
Namn på behållar bilden från docknings registret, till exempel Publisher/Image-Name: tagg.
...
Användar namn och lösen ord för behållar registret.
...
### -IdentityID
Anger listan över användar identiteter som är kopplade till programmet funktion.
...
### -IdentityType
Anger den typ av identitet som används för funktionen.
De acceptabla värdena för denna parameter är:-SystemAssigned-UserAssigned
...
### -Plats
Platsen för förbruknings planen.
...
### -Nowait
Startar operationen och returnerar omedelbart innan operationen är slutförd.
Använd en annan mekanism för att avgöra om åtgärden har slutförts.
...
### -OSType
Operativ systemet som ska fungera som funktion.
