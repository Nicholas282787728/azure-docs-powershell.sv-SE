...
## PROBLEMBESKRIVNING
Cmdleten registrerar en Azure VM för AzureWorkloads med specifika workloadType.
...
Cmdleten registrerar en Azure VM för arbets belastnings tjänsten MSSQL.

## MALLPARAMETRAR

### -BackupManagementType
Säkerhets kopierings hanterings typen för Azure Backup-behållaren
