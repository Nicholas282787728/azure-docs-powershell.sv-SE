...
Använd Get-AzRecoveryServicesBackupRecoveryPoint cmdlet för att få ett **AzureRmRecoveryServicesBackupRecoveryPoint** -objekt.
...
### -TargetFolder
Den mapp där fil resursen måste återställas i targetFileShareName. lämna variabeln tom om du vill återställa under rotmappen.
