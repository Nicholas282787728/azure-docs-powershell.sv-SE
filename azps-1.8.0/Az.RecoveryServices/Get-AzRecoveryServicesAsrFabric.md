...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzRecoveryServicesAsrFabric** hämtar egenskaperna för en angiven Azure Site Recovery-infrastruktur eller alla Azure Site Recovery-Fabric i ett valv för återhämtnings tjänst.
...
Returnera Azure Site Recovery Fabric med namn xxxx.
...
Returnera Azure Site Recovery Fabric med vänligt namn xxxx.
