...
### -IsEnabled
Anger om denna cmdlet aktiverar schemat.
...
### -Namn
Anger namnet på det schema som den här cmdleten ändrar.
...
### -ResourceGroupName
Anger namnet på en resurs grupp för vilken denna cmdlet ändrar ett schema.
