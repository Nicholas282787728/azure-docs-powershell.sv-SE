...
## PROBLEMBESKRIVNING
Cmdleten **Start-AzAutomationDscNodeConfigurationDeployment** distribuerar en konfiguration för DSC-nodkonfigurationer (önskad tillstånds konfiguration) i Azure Automation.
