...
### -Backend
Uppsättningen av bakände för denna pool.
...
Namn på Inställningar för hälso avsökning för den här backend-poolen
...
Namn på Inställningar för belastnings utjämning för den här backend-poolen
