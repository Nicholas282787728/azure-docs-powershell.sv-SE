...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzFrontDoorFireWallPolicy** tar bort en WAF-princip under den aktuella prenumerationen
...
Ta bort WAF policy $policyName i $resourceGroupName.
...
Ta bort alla WAF-principer i $resourceGroupName.
...
### -InputObject
WAF princip objekt som ska tas bort.
...
### -ResourceGroupName
Resurs gruppen som WAF policy tillhör.
...
### -ResourceId
Resurs-ID för WAF princip som ska tas bort
