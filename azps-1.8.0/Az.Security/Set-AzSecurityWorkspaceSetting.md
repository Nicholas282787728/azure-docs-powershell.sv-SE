...
## PROBLEMBESKRIVNING
Uppdaterar arbets ytans inställningar för abonnemanget.
Den konfigurerade arbets ytan innehåller säkerhets data som samlats in av säkerhets agenten som är installerad på virtuella datorer i det här abonnemanget.
...
Ställer in alla säkerhets data som samlats in av säkerhets agenterna i arbets ytan "min arbets yta".
