...
Det här kommandot skapar en brand Väggs regel med namnet ruleone i Redis cache med namnet noncache.
...
### -InputObject
objekt av typen RedisCacheAttributes
