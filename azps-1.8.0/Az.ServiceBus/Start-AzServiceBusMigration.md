...
Skapar en ny migrerings konfiguration för ' TestingNamespaceStandardMirgation ' till ' TestingNamespacePremiumMirgation '-namn områden
...
### -PostMigrationName
Publicera namn på migrering för standrad namn område i migrering
