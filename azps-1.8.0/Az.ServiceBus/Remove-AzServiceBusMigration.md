...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzServiceBusMigration** tar bort migreringsguiden som standard för premie namn områden
...
Tar bort konfigurationen för TestingNamespaceStandardMirgation
...
### -InputObject
Service Bus migration standard namn på objekt
...
### -ResourceId
Service Bus migration standard resurs-ID för namn område
