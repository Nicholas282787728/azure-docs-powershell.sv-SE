...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzServiceBusAuthorizationRule** hämtar beskrivningen av den angivna auktoriseringsregeln i det angivna namn området, i kön eller i ett ämne (GeoDR-konfigurationer).
...
Returnerar den angivna beskrivningen för auktoriseringsregeln för en viss namnrymd och ett alias.

## MALLPARAMETRAR

### -AliasName
GeoDR konfigurations namn
