...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzIntegrationAccountCertificate** tar bort ett integrerings konto certifikat från en resurs grupp.
...
### Exempel 1: ta bort ett integrerings konto certifikat
```
...
Det här kommandot tar bort integrerings konto certifikatet med namnet IntegrationAccount31.
