...
Skapar en server med namnet testserver i Azure-regionen West-US och i resurs grupp testresrourcegroup. SKU-nivån för servern blir S1.
...
### -GatewayResourceId
Gateway-resurs-ID för assocaite till en analys Server
