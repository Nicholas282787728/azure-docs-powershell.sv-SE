...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzDataFactoryV2Trigger** tar bort en utlösare från en data fabrik. Om parametern _Force_ anges frågar inte cmdleten innan utlösaren tas bort.

## BESKRIVS

### Exempel 1: ta bort en utlösare
```
...
Ta bort en utlösare som heter "ScheduledTrigger" från data fabriken "WikiADF".
...
### -InputObject
Det Utlös ande objekt som ska tas bort.
