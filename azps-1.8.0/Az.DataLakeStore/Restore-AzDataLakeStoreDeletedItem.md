...
## PROBLEMBESKRIVNING
Cmdleten **restore-AzDataLakeStoreDeletedItem** återställer en borttagen fil eller mapp i data Lake Store. Kräver att sökvägen till borttaget objekt i pappers korgen retunred med AzDataLakeStoreDeletedItem.
