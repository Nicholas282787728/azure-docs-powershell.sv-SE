...
## Sammanfattning
Exporterar egenskaperna (disk användning och ACL) för hela trädet från den angivna sökvägen till en Ouput-sökväg
...
## PROBLEMBESKRIVNING
**Exportera-AzDataLakeStoreChildItemProperty** används för att rapportera ADLS för användning eller/och ACL för den angivna katalogen och under kataloger och filer.

## BESKRIVS

### Exempel 1: få disk användning och ACL-användning för alla under kataloger och filer
```
...
Få disk användning och ACL-användning för alla under kataloger och filer under/a. IncludeFile säkerställer att användningen rapporteras för filer också

### Exempel 2: Hämta ACL-användning för alla under kataloger och filer med den enhetliga åtkomst kontrol listan dold
```
...
Hämta ACL-användning för alla under kataloger och filer under/a. IncludeFile säkerställer att användningen rapporteras för filer också. HideconsistentAcl i det här fallet visas ACL för/a, inte till barn eftersom alla underordnade har samma ACL som/a. Den här flaggan hoppar över ACL-Ouput för under träd om alla dess åtkomst kontrol listor är samma som roten.
...
### -GetAcl
Hämtar åtkomst kontroll filen från rot Sök vägen
...
### -GetDiskUsage
Hämtar disk användning från rot Sök vägen
...
### -IncludeFile
Visa statistik på filnivå (standard är att visa endast information på katalog nivå)
...
### -MaximumDepth
Maximalt djup från den rot katalog där disk användning eller ACL visas
...
### -OutputPath
Sökvägen till utdatafilen. Kan vara en lokal sökväg eller ADL sökväg. Den är som standard lokal. Om SaveToAdl är pecified är det en ADL sökväg till samma konto
...
### -SaveToAdl
Om du har godkänt den sparas dumpfilen i ADL.
DumpFile få vara en ADL-bana i det fallet
