...
---
# Modulen AZ. DataLakeStore
## Problembeskrivning
I det här avsnittet beskrivs Azure PowerShell cmdlets för Azure Data Lake Store i ramverket Azure Resource Manager (ARM). Det finns cmdlets i Microsoft. Azure. commands. DataLakeStore-namnrymd.

## AZ. DataLakeStore-cmdletar
...
### [Exportera-AzDataLakeStoreChildItemProperty](Export-AzDataLakeStoreChildItemProperty.md)
...
Tar bort den angivna regeln för virtuella nätverk i den angivna data Lake Store.
...
Ändrar den angivna regeln för virtuella nätverk i den angivna data Lake Store.
