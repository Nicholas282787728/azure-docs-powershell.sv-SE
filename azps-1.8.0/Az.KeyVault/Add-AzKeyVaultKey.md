...
Mer information finns i Skapa [och överföra HSM-Protected nyckelnycklar för Azure Key Vault.](https://go.microsoft.com/fwlink/?LinkId=522252)
...
Obs! Om du vill använda HSM som destination måste du ha ett nyckelvalv som har stöd för HSMs. Mer information om tjänstnivåer och funktioner för Azure-nyckelvalv finns på webbplatsen för priser för [Azure-nyckelvalv.](https://go.microsoft.com/fwlink/?linkid=512521)
...
Godtagbara värden för den här parametern är en kommaavgränsad lista med nyckelåtgärder som definieras i [specifikationen JSON Web Key (JWK):](https://go.microsoft.com/fwlink/?LinkID=613300)
- Kryptera
- Dekryptera
- Radbryt
- Ta bort brytningar
