...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzKeyVaultCertificate** tar bort ett certifikat från ett nyckelord.
...
### Exempel 2: ta bort det borttagna certifikatet från Key Vault permanent
```powershell
...
### -InRemovedState
Om det finns någon tar bort det tidigare borttagna certifikatet permanent
