...
### Exempel 2: skapa ett mer komplext mått för statistik avisering
...
### -DynamicThreshold
Tröskelvärdet dynamiskt för regel villkor
...
### -FailingPeriod
Den misslyckade perioden för regel villkor
...
### -TotalPeriod
Den totala perioden för regel villkor
