...
Det här kommandot ändrar det AppService-abonnemang som är associerat med Slot001, på webapp-ContosoWebApp som är kopplad till resurs gruppens standard-väst. Använd länken för att rensa mer om hur du ändrar AppService plan och vilka villkor som är associerade med den.
