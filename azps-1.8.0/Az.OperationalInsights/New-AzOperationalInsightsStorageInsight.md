...
Det andra kommandot skickar lagrings kontot i $Storage till Get-AzStorageAccountKey-cmdlet genom att använda pipeline-operatorn för att hämta den angivna lagrings konto och sedan lagra den i den $StorageKey variabeln.
...
Det tredje kommandot skickar lagrings kontot i $Storage till Get-AzStorageAccountKey-cmdlet genom att använda pipeline-operatorn för att hämta angiven nycklar och sedan lagra det i den $StorageKey variabeln.
