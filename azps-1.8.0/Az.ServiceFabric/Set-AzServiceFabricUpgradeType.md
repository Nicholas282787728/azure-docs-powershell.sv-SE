...
## PROBLEMBESKRIVNING
Använd **set-AzServiceFabricUpgradeType** för att ange uppgraderings typen till automatisk eller manuell med specifik Service Fabric-kod.
...
Det här kommandot anger kluster uppgraderings läget till automatisk.
