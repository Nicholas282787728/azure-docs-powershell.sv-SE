...
Med kommandot ovan skapas ett nytt Kusto-kluster med namnet "mykustocluster" i resurs gruppen "testrg".
...
### -Plats
Azure region där klustret ska skapas.
...
### -Namn
Namn på det kluster som ska skapas.
...
### -ResourceGroupName
Namnet på den resurs grupp under vilket du vill skapa klustret.
...
### -Tagg
En sträng, en sträng ord lista med flaggor associerade till det här klustret
