...
New-AzVpnGateway skapar en skalbar VPN-gateway. Det här är program varu definierad anslutning för webbplatsen till plats anslutningar i VirtualHub. 

Denna gateway ändrar storlek på och skalar baserat på den enhet som anges i denna eller Set-AzVpnGateway cmdlet. 

En anslutning skapas från en filial/webbplats som kallas VPNSite till den utbyggbara gatewayen. Varje anslutning består av 2 Active-Active tunnlar.

VpnGateway kommer att finnas på samma plats som refererade VirtualHub.
