...
Hämtar alla tillgängliga servervariabler, Request och Response-rubriker.
...
Skapar backend HTTP-inställningar för en Programgateway.
...
Skapar en actionset för att skriva om en Programgateway.
...
Skapar ett nytt användar profil objekt för nätverks konfiguration. Det här objektet används för att begränsa nätverks-confiuration under en diagnostisk session med de angivna villkoren.
...
Uppdaterar en VpnSite som representerar en kund filial till en avsedd mål status.
