...
## PROBLEMBESKRIVNING
Cmdleten **New-AzContainerNicConfig** skapar ett nytt konfigurations objekt för behållaren för nätverks gränssnitt. Det här objektet bestämmer egenskaperna för behållar nätverks-interfacs som skapats som refererar till den överordnade nätverks profilen.
