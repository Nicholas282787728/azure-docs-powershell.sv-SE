...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzApplicationGatewayUrlPathMapConfig** lägger till en matris med URL-sökvägar till en adresspool Server.

## BESKRIVS

### Exempel 1: lägga till en URL-sökväg till en Programgateway.
```
...
Det första kommandot får en Programgateway som heter appGwName och lagrar den i $appgw variabel.
Det andra kommandot får Server delens adresspool och lagrar det i $pool variabel.
Det tredje kommandot för in-http-inställningar och lagrar det i $poolSettings variabel.
Det fjärde kommandot Skapa en ny Sök vägs regel konfiguration med namnet rule01 och lagrar det i $pathRule variabel.
Det femte kommandot lägger till URL-sökväg för mappning med namnet url01 till Application Gateway.
Det sjätte kommandot uppdaterar programgatewayen.

## MALLPARAMETRAR

### -ApplicationGateway
Anger den Programgateway till vilken denna cmdlet lägger till en konfiguration för URL-sökvägar.
...
### -Namn
Anger namnet på URL-sökvägen som denna cmdlet lägger till i Server delen.
...
Sök vägs reglerna är ordnings känsliga, de används i angiven ordning.
