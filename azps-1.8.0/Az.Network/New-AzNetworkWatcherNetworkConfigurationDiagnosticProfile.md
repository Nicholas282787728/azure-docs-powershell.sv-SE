...
ms.locfileid: "100400186"
---
# New-AzNetworkWatcherNetworkConfigurationDiagnosticProfile

## SYNOPSIS
Skapar ett nytt profilobjekt för nätverkskonfiguration. Det här objektet används för att begränsa nätverkskonfigurationen under en diagnostiksession med hjälp av de angivna villkoren.
...
## BESKRIVNING
Med New-AzNetworkWatcherNetworkConfigurationDiagnosticProfile-cmdleten skapas ett nytt diagnostikprofilobjekt. Det här objektet används för att begränsa nätverkskonfigurationen under en diagnostiksession för nätverkskonfiguration med de angivna villkoren.
