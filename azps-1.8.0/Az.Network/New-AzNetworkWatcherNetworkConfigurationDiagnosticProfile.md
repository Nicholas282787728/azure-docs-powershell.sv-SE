...
## PROBLEMBESKRIVNING
New-AzNetworkWatcherNetworkConfigurationDiagnosticProfile-cmdleten skapar ett nytt diagnostiskt profil objekt. Det här objektet används för att begränsa nätverks-confiuration under en diagnostisk session med nätverks konfiguration med de angivna villkoren.
