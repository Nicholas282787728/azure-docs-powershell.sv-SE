...
### Exempel 1: Hämta en specifik regel uppsättning för att skriva över
```
...
Det andra kommandot hämtar regel uppsättningen för omskrivning som heter RuleSet01 från den Application Gateway som lagras i variabeln som heter $AppGW.
