...
## BESKRIVNING
Den Get-AzNetworkWatcherNextHop cmdleten får nästa hopp från en VM.
Med nästa hopp kan du visa typen av Azure-resurs, den associerade IP-adressen för resursen och routningstabellregeln som ansvarar för routningen.
...
Hämta nästa hopp för utgående kommunikation från det primära nätverksgränssnittet på den angivna virtuella Vachine till 204.79.197.200 (www.bing.com)
