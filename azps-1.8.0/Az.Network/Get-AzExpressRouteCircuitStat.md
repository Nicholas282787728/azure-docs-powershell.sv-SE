...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzExpressRouteCircuitStat** hämtar trafik statistik för en ExpressRoute-krets. Statistiken innehåller antalet byte som skickas och tas emot via både primära och sekundära vägar.

## BESKRIVS

### Exempel 1: Visa trafik statistik för en ExpressRoute-peer
```
...
### Microsoft. Azure. commands. Networks. Models. PSExpressRouteCircuitStats
