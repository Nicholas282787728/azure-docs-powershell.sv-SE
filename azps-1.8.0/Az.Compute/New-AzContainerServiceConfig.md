...
## PROBLEMBESKRIVNING
Cmdleten **New-AzContainerServiceConfig** skapar ett lokalt konfigurations objekt för en behållar tjänst.
Skapa en behållar tjänst genom att lägga till det här objektet i New-AzContainerService cmdlet.
...
Kommandot anger olika inställningar för behållar tjänst konfigurationen. Kommandot skickar konfigurationsobjektet till Add-AzContainerServiceAgentPoolProfile cmdlet genom att använda pipeline-operatorn. Denna cmdlet lägger till en cacheprofil för poolen.
Ange ett objekt i $Container för parametern *ContainerService* för **New-AzContainerService**.
...
Lägga till en profil med hjälp av Add-AzContainerServiceAgentPoolProfile cmdlet.
...
### System. Nullable ' 1 [[Microsoft. Azure. Management. Compute. Models. ContainerServiceOrchestratorTypes, Microsoft. Azure. Management. Compute, version = 23.0.0.0, Culture = neutralt, PublicKeyToken = 31bf3856ad364e35]]
