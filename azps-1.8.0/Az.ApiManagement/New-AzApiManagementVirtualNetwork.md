...
Det här kommandot används med **Update-AzApiManagementDeployment** cmdlet.
...
I det här exemplet skapas ett virtuellt nätverk och sedan anropas cmdleten **Update-AzApiManagementDeployment** .
