...
Värdnamn för den hanterade tjänsten.
...
Port nummer för den hanterade tjänsten.
...
Token för den hanterade tjänst inloggningen.
...
Använd enhets kod i stället för en webb läsar kontroll. Det här är standard autentiseringstypen för PowerShell version 6 och högre.
