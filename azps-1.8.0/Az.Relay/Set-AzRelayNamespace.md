...
## PROBLEMBESKRIVNING
Cmdleten **set-AzRelayNamespace** uppdaterar beskrivningen av angivet relä namn område i resurs gruppen.
...
Uppdaterar namn området för relät med en ny beskrivning.
