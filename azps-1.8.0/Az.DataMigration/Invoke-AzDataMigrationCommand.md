...
## PROBLEMBESKRIVNING
Invoke-AzDataMigrationCommand-cmdleten skapar en ny kommando aktivitet som ska köras på en befintlig migrering.
...
I exemplen ovan används Invoke-AzDataMigrationCommand cmdlet för att skapa ett kommando för en befintlig tjänst, projekt och aktivitet
...
```
### -ObjectName
Namnet på det databas objekt som kommandot körs på.
