...
Det här kommandot skapar en princip uppsättnings definition med namnet VMPolicyDefinition som innehåller de princip definitioner som anges i C:\VMPolicy.jspå. Exempel på innehållet i VMPolicy.jsär aktiverat ovan.
...
Det här kommandot skapar en parameter uppsättnings definition med namnet VMPolicyDefinition som innehåller de princip definitioner som anges i C:\VMPolicy.jspå. Exempel på innehållet i VMPolicy.jsär aktiverat ovan.
