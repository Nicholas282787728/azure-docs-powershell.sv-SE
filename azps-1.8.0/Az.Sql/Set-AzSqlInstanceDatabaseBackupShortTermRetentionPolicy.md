...
## PROBLEMBESKRIVNING
Cmdleten **set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy** hämtar den kortsiktiga bevarande principen som är registrerad för den här databasen.
...
Det här kommandot anger den kortsiktiga bevarande principen för alla borttagna databaser med namnet DB1 via överföring i ett borttaget databas objekt. Obs! Du kan bara minska bevarande perioden för borttagna databaser.
...
### -RetentionDays
Dagars lagrings tid för säkerhets kopior.
