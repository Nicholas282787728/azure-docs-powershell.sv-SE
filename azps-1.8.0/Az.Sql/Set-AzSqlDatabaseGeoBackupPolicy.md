...
## PROBLEMBESKRIVNING
Cmdleten **set-AzSqlDatabaseGeoBackupPolicy** anger den geo säkerhets kopierings princip som registrerats för en databas.
...
### -DatabaseName
Anger namnet på den databas som den här cmdleten ställer in princip för geo-säkerhets kopiering för.
...
### -State
Anger tillståndet för geo backup-principen.
