...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlDatabaseAuditing** hämtar gransknings inställningarna för en Azure SQL-databas.
...
### Exempel 1: Hämta gransknings inställningar för blob-lagring för en Azure SQL-databas
```
...
### Exempel 2: Hämta gransknings inställningar för blob-lagring för en Azure SQL-databas
```
...
### Exempel 3: Hämta och gå igenom pipeline, gransknings inställningar för en Azure SQL-databas
```
...
### Exempel 4: Hämta gransknings inställningar för en Azure SQL-databas till Event Hub
```
...
### Exempel 5: Hämta, genom pipeline, gransknings inställningar för en Azure SQL-databas
```
...
### Exempel 6: Hämta gransknings inställningar för logganalys för en Azure SQL-databas
```
