...
Med det här kommandot får du säkerhets kopior för alla databaser (som kan vara levande eller borttagna) i northeurope.

### Exempel 2: skaffa en särskild säkerhets kopia för långsiktigt bevarande
```powershell
...
### Exempel 3: Hämta alla långsiktiga säkerhets kopior för en databas
```powershell
...
### Exempel 4: få säkerhets kopior på lång sikt med filtrering
```powershell
