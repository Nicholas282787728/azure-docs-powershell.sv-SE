...
## PROBLEMBESKRIVNING
Cmdleten **New-AzSqlDatabaseRestorePoint** skapar en ny återställnings punkt som ett Azure SQL data-lager kan återställas från.
Denna cmdlet stöds för närvarande för Azure SQL Data Warehouse.

## BESKRIVS

### Exempel 1: skapa en återställnings punkt
```
...
Det här kommandot skapar en återställnings punkt för Azure SQL Data Warehouse och returnerar information om återställnings punkten.
...
### -RestorePointLabel
Anger etiketten för återställnings punkten så att den blir lätt att identifiera.
