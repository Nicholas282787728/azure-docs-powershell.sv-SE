...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlServerAuditing** hämtar gransknings inställningarna för en Azure SQL Server.
...
### Exempel 1: Hämta gransknings inställningar för en Azure SQL-Server för blob-lagring
```
...
### Exempel 2: Hämta gransknings inställningar för blob-lagring för en Azure SQL Server
```
...
### Exempel 3: Hämta, genom pipeline, gransknings inställningar för blob-lagring för en Azure SQL Server
```
...
### Exempel 4: Hämta gransknings inställningar för en Azure SQL-Server för Event Hub
```
...
### Exempel 5: Hämta, genom pipeline, gransknings inställningar för en Azure SQL-Server i Event Hub
```
...
### Exempel 6: Hämta gransknings inställningar för logganalys för en Azure SQL Server
```
