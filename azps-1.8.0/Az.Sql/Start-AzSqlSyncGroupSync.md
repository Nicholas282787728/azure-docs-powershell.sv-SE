...
## PROBLEMBESKRIVNING
Cmdleten **Start-AzSqlSyncGroupSync** startar en synkronisering av synkroniseringsresursen.
...
Det här kommandot startar en rund synkronisering för gruppen Sync Group mysg.
