...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureStorageContainer** tar bort den angivna lagrings behållaren i Azure.

## BESKRIVS

### Exempel 1: ta bort en behållare
```
PS C:\>Remove-AzureStorageContainer -Name "MyTestContainer"
```

I det här exemplet tas en container bort med namnet MyTestContainer.
...
### -Kontext
Anger en kontext för den behållare som du vill ta bort.
Du kan använda New-AzureStorageContext cmdlet för att skapa den.
...
### -Namn
Anger namnet på den behållare som ska tas bort.
