...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureStorageShareStoredAccessPolicy har** en lagrad åtkomst princip på en Azure lagrings plats.

## BESKRIVS

### Exempel 1: uppdatera en lagrad åtkomst princip i lagrings resursen
```
PS C:\>Set-AzureStorageShareStoredAccessPolicy -ShareName "ContosoShare" -Policy "GeneralPolicy" -Permission "rwdl"
```

Det här kommandot uppdaterar en sparad åtkomst princip med fullständig behörighet i en resurs.
...
### -NoExpiryTime
Anger att den här cmdleten rensar egenskapen **ExpiryTime** i den lagrade åtkomst principen.
...
### -NoStartTime
Anger att denna cmdlet rensar egenskapen **StartTime** i den lagrade åtkomst policyn.
...
### -Tillstånd
Anger behörigheter i den lagrade åtkomst principen för att komma åt den delade resursen eller filerna under den.
