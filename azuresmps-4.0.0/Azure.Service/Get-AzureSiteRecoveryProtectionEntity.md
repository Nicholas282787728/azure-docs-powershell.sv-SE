...
## Sammanfattning
Får skydds bara eller skyddade enheter i ett återställnings valv för webbplatser.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureSiteRecoveryProtectionEntity** får skydd bara eller skyddade enheter, till exempel virtuella datorer, i det aktuella Azure Site Recovery-valvet.

## BESKRIVS

### Exempel 1: Visa en skyddad virtuell dator i en behållare
```
...
Det andra kommandot hämtar den skyddade virtuella datorn som tillhör behållaren i $Container och visar den.

## MALLPARAMETRAR

### -ID
Anger ID för en skydds enhet att hämta.
...
### -Namn
Anger namnet på en skydds enhet som ska erhållas.
