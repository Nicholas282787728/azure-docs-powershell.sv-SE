...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureApplicationGateway** skapar en Programgateway.
...
Det här kommandot skapar en Programgateway som heter ApplicationGateway06.
Kommandot distribuerar gatewayen i VirtualNetwork17 och i de angivna under näten.
...
### -Namn
Anger ett namn för den nya programgatewayen.
