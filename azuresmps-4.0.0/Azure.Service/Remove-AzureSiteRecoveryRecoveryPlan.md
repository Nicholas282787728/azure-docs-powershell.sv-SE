...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureSiteRecoveryRecoveryPlan** tar bort en plan för webbplats återställning från den aktuella Azure Site Recovery.
...
I det första kommandot används cmdleten **Get-AzureSiteRecoveryRecoveryPlan** för att hämta webbplatsen för webbplats återställning och sedan lagras den i $RecoveryPlan variabel.
...
### -ID
Anger ID för återställnings planen som ska tas bort.
...
### -RecoveryPlan
Anger vilken återställnings plan som ska tas bort.
