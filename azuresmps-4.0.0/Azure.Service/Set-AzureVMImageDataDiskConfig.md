...
## Sammanfattning
Anger data disk egenskaper för den virtuella dator avbildningen.
...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureVMImageDataDiskConfig** anger data disk egenskaper för den virtuella dator avbildningen.

## BESKRIVS

### Exempel 1: ange data disk egenskaper på en virtuell dator bild
```
...
Det här kommandot anger data disk egenskaper på en virtuell dator och uppdaterar sedan den virtuella dator avbildningen.

## MALLPARAMETRAR

### -DataDiskName
Anger namnet på den data disk som denna cmdlet konfigurerar.
