...
## Sammanfattning
Migrerar en nätverks säkerhets grupp till Azure Resource Manager-stacken.
...
## PROBLEMBESKRIVNING
Cmdleten **Move-AzureNetworkSecurityGroup** migrerar en nätverks säkerhets grupp till en resurs grupp i Azure Resource Manager-stacken.
...
### -Avbryt
Anger att denna cmdlet avbryter migreringen av nätverks säkerhets grupper.
...
### -Commit
Anger att denna cmdlet startar nätverks säkerhets gruppmigreringen.
...
Anger namnet på den nätverks säkerhets grupp som denna cmdlet migrerar.
...
### -Förbered
Anger att denna cmdlet förbereder nätverks säkerhets gruppen för migrering.
...
### -Validera
Anger att denna cmdlet verifierar nätverks säkerhets gruppen för migrering.
