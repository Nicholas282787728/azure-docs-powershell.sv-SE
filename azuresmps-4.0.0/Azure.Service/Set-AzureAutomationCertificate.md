...
Cmdleten **set-AzureAutomationCertificate** ändrar konfigurationen för ett certifikat i Microsoft Azure Automation.
...
Dessa kommandon uppdaterar ett befintligt certifikat som heter mina certifikat i Automation.
Det första kommandot skapar lösen ordet för den certifikat fil som används i det andra kommandot som uppdaterar certifikatet.
