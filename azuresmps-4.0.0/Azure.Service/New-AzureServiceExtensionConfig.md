...
## Sammanfattning
Skapar en konfiguration för moln tjänst tillägg för en distribution.
...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureServiceExtensionConfig** skapar en konfiguration för moln tjänst tillägg för distribution.

## BESKRIVS

### Exempel 1: skapa en tilläggs konfiguration
```
...
Det här kommandot anger en tilläggs konfiguration.

### Exempel 2: skapa en tilläggs konfiguration för en roll
```
...
Det här kommandot anger en tilläggs konfiguration för rollen WebRole1.
...
### -ExtensionState
Anger tillståndet för tillägget.
...
### -ProviderNamespace
Anger tillägget leverantörens namn område.
