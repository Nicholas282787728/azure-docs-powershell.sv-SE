...
## Sammanfattning
Hämtar logiska nätverks objekt.
...
Cmdleten **Get-WAPackLogicalNetwork** hämtar logiska nätverks objekt.

## BESKRIVS

### Exempel 1: skaffa ett logiskt nätverk genom att använda ett namn
```
PS C:\> Get-WAPackLogicalNetwork -Name "ContosoLogicalNetwork01"
```

Det här kommandot får ett logiskt nätverk som heter ContosoLogicalNetwork01.

### Exempel 2: Hämta alla logiska nätverk
```
PS C:\> Get-WAPackLogicalNetwork
```

Det här kommandot får alla logiska nätverk.

## MALLPARAMETRAR

### -Namn
Anger namnet på ett logiskt nätverk.
