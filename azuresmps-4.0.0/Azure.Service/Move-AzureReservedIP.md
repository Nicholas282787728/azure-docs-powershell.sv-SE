...
## Sammanfattning
Migrerar en reserverad IP-adress till Azure Resource Manager-stacken.
...
## PROBLEMBESKRIVNING
Cmdleten **Move-AzureReservedIP** migrerar en reserverad IP-adress till en resurs grupp i Azure Resource Manager-stacken.
...
### -Avbryt
Anger att denna cmdlet avbryter den reserverade IP-adressen.
...
### -Commit
Anger att den här cmdleten startar den reserverade IP-adressen.
...
### -Förbered
Anger att denna cmdlet förbereder den reserverade IP-adressen för migrering.
...
### -ReservedIPName
Anger namnet på den reserverade IP-adressen som den här cmdleten migrerar.
...
### -Validera
Anger att denna cmdlet verifierar den reserverade IP-adressen för migrering.
