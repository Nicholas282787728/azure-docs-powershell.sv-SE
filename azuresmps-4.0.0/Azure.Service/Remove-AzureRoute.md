...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRoute** tar bort en väg från en route-tabell.
...
Den aktuella cmdleten tar bort en väg som heter InternetRoute.
...
### -RouteName
Anger ett namn för den nya vägen som tas bort med denna cmdlet.
...
### -RouteTable
Anger den routningstabell som den här cmdleten tar bort en väg från.
