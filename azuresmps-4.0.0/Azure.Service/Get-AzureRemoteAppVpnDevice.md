...
## Sammanfattning
Hämtar information om en VPN-enhet.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRemoteAppVpnDevice** hämtar information om en VPN-enhet (virtuellt privat nätverk).

## BESKRIVS

### Exempel 1: returnera tillgängliga VPN-enheter för ett virtuellt nätverk
```
...
Det här kommandot returnerar de tillgängliga VPN-enhetsobjektet för det angivna virtuella nätverket.
