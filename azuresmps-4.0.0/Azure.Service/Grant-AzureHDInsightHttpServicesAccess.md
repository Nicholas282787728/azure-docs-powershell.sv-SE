...
## Sammanfattning
Ger HTTP-åtkomst till ett kluster.
...
**Grant-AzureHDInsightHttpServicesAccess** cmdlet beviljar http-åtkomst till ett Azure HDInsight-kluster med ODBC, Ambari, Oozie och webb tjänster.
...
Anger ett användar namn och lösen ord för HTTP-åtkomst.
...
Denna cmdlet beviljar HTTP-åtkomst till det kluster som den här parametern anger.
...
[Återkalla-AzureHDInsightHttpServicesAccess](./Revoke-AzureHDInsightHttpServicesAccess.md)
