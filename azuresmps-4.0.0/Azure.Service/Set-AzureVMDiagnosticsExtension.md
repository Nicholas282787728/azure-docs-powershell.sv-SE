...
### Exempel 1: skapa en virtuell dator med Azure Diagnostics-tillägget installerat
```
...
De här kommandona aktiverar Azure Diagnostics-tillägget på en virtuell dator.
...
Det andra kommandot använder cmdleten **set-AzureVMDiagnosticsExtension** för att uppdatera den virtuella dator konfigurationen så att den inkluderar Azure Diagnostics-tillägget.
...
Anger en sökväg för diagnostikverktyget.
...
### -Inaktivera
Anger att denna cmdlet inaktiverar tillägget Diagnostics på den virtuella datorn.
...
### -ReferenceName
Anger referens namnet för tillägget.
...
### -Version
Anger tilläggs versionen som en sträng.
