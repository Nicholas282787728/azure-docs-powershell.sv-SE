...
Cmdleten **Remove-AzureSBNamespace** tar bort ett tjänst namn område för Service Bus.
...
### -Force
Om den är aktive rad tar du bort namn området utan att behöva bekräfta.
...
### -Namn
Anger namnet på namn området som ska tas bort.
...
### -PassThru
Gör att åtgärden returnerar true om den lyckas.
