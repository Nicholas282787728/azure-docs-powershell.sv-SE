...
## Sammanfattning
Hämtar egenskaperna för ett eller flera publicerade Azure RemoteApp-program för en samling.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRemoteAppProgram** hämtar egenskaperna för ett eller flera publicerade Azure RemoteApp-program för en samling.

## BESKRIVS

### Exempel 1: Hämta egenskaper för ett program
```
...
Det här kommandot visar egenskaperna för ett Azure RemoteApp-program.
Programmet "ekonomi program" finns i Azure RemoteApp-samlingen med namnet ContosoApps.

## MALLPARAMETRAR

### -Alias
Anger alias för det program som du vill hämta egenskaper för.
...
### -RemoteAppProgram
Anger namnet på det program som du vill hämta egenskaper för.
...
[Publicera – AzureRemoteAppProgram](./Publish-AzureRemoteAppProgram.md)
