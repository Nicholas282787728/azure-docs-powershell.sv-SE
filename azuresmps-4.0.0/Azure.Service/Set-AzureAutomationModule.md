...
Cmdleten **set-AzureAutomationModule** importerar en ny version av en modul eller ändrar konfigurationen för modulen i Azure Automation.
...
Det här kommandot importerar en uppdaterad version av en befintlig modul som heter ContosoModule till det Azure Automation-konto som heter Contoso17.

## MALLPARAMETRAR

### -AutomationAccountName
Anger namnet på Automation-kontot med modulen.
...
### -ContentLinkUri
Anger sökvägen till modul filen.
...
### -ContentLinkVersion
Anger vilken version av modulen det är.
