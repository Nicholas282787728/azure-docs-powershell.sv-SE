...
## Sammanfattning
Hämtar tillgängliga platser för schemaläggare.
...
Cmdleten **Get-AzureSchedulerLocation** hämtar tillgängliga platser för schemaläggare.

## BESKRIVS

### Exempel 1: Hämta tillgängliga platser för Schemaläggaren
```
PS C:\> Get-AzureSchedulerLocation
```

Det här kommandot hämtar tillgängliga platser för schemaläggare.
