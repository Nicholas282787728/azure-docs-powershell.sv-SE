...
Hämtar utdata från ett Azure Automation-jobb.
...
Cmdleten **Get-AzureAutomationJobOutput** hämtar utdata från ett Microsoft Azure Automation-jobb.

## BESKRIVS

### Exempel 1: få utdata från ett Azure Automation-jobb
```
