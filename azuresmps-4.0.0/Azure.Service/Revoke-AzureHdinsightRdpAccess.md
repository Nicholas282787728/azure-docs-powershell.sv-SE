...
## Sammanfattning
Inaktiverar RDP-åtkomst till ett HDInsight-kluster.
...
Med cmdleten **REVOKE-AzureHDInsightRdpAccess** inaktive ras RDP-åtkomst (Remote Desktop Protocol) till ett Azure HDInsight-kluster.
...
Denna cmdlet återkallar RDP-åtkomst (Remote Desktop Protocol) för det abonnemang som den här parametern anger.
