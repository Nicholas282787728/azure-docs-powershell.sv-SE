...
Cmdleten **suspend-AzureAutomationJob** avbryter ett Microsoft Azure Automation-jobb.
Ange ett automatiserings jobb som körs.

Om du vill återuppta ett avbrutet jobb använder du cmdleten **Resume-AzureAutomationJob** .
