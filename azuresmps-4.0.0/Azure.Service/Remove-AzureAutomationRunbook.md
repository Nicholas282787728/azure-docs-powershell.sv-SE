...
Cmdleten **Remove-AzureAutomationRunbook** tar bort en Runbook från Microsoft Azure Automation.
...
Det här kommandot tar bort Runbook-flödet som heter MyRunbook i Automation-kontot med namnet Contoso17.
...
### -Namn
Anger namnet på den Runbook som ska tas bort.
