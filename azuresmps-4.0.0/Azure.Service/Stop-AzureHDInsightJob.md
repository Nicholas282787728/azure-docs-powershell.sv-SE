...
Cmdleten **Stop-AzureHDInsightJob** stoppar ett Azure HDInsight-jobb i angivet kluster.
...
### -Kluster
Anger ett kluster.
Denna cmdlet stoppar ett jobb som körs på det kluster som den här parametern anger.
...
### -JobId
Anger ID: t för HDInsight-jobbet som ska stoppas.
...
Denna cmdlet stoppar ett jobb för det abonnemang som den här parametern anger.
