...
## Sammanfattning
Skapar en virtuell Azure-nätverksgateway.
...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureVirtualNetworkGateway** skapar en Azure Virtual Network Gateway.
...
### -Force
Bekräfta inte att Azure Virtual Network Gateway-skapande skapas
...
### -VnetId
Anger ID för ett virtuellt nätverk.
