...
## Sammanfattning
Skapar en icke beständig HDInsight-kluster konfiguration.
...
Cmdleten **New-AzureHDInsightClusterConfig** skapar en icke-beständig Azure HDInsight-kluster konfiguration.

## BESKRIVS

### Exempel 1: skapa en kluster konfiguration
```
...
### -HeadNodeVMSize
Anger den virtuella dator storleken på huvudnoden för klustret.
...
### -ZookeeperNodeVMSize
Anger storleken på den virtuella datorn för ZooKeeper-noden för ett HBase-eller Storm-kluster.
