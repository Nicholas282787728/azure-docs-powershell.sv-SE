...
## Sammanfattning
Aktiverar nedladdning av. VHD-bilder.
...
## PROBLEMBESKRIVNING
Med cmdleten **Save-AzureVhd** kan du ladda ned en VHD-avbildning från en BLOB där de lagras till en fil.
Den har parametrar för att konfigurera nedladdningen genom att ange antalet Hämta trådar som används eller skriva över filen som redan finns i den angivna sökvägen.

**Save-AzureVhd** gör inte något format konvertering för VHD och blobben laddas ner.

## BESKRIVS

### Exempel 1: Ladda ned en VHD-fil
```
...
Det här kommandot laddar ned en VHD-fil.

### Exempel 2: Ladda ned en VHD-fil och skriv över den lokala filen
```
...
Det här kommandot laddar ned en VHD-fil och skriver över en fil i mål Sök vägen.

### Exempel 3: Ladda ned en VHD-fil och ange antalet trådar
```
...
Det här kommandot laddar ned en VHD-fil och anger antalet trådar.

### Exempel 4: Ladda ned en VHD-fil och ange lagrings plats
```
...
### -Skriver över
Anger att denna cmdlet tar bort filen som anges av *LocalFilePath* -filen om den finns.
...
Om det inte anges försöker **Spara-AzureVhd** att bestämma lagrings namnet på kontot i *SourceUri* från Azure.
