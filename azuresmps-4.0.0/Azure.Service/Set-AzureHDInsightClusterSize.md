...
## Sammanfattning
Anger antalet datanoder för ett HDInsight-kluster.

## FRÅGESYNTAXEN

### Ange kluster storlek i noder med namn.
```
Set-AzureHDInsightClusterSize -ClusterSizeInNodes <Int32> -Name <String> [-Force] [-Profile <AzureSMProfile>]
 [<CommonParameters>]
```

### Ange kluster storlek i noder med kluster från pipeline.
```
...
Cmdleten **set-AzureHDInsightClusterSize** anger antalet datanoder för ett Azure HDInsight-kluster.
...
### -Kluster
Anger vilket kluster du vill ändra storlek på.
...
### -Namn
Anger namnet på HDInsight-klustret att ändra storlek på.
...
Denna cmdlet anger kluster storleken för det abonnemang som den här parametern anger.
