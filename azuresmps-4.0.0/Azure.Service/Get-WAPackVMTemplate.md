...
## Sammanfattning
Hämtar mallar för virtuella datorer.
...
Cmdleten **Get-WAPackVMTemplate** hämtar mallar för virtuella datorer.

## BESKRIVS

### Exempel 1: Hämta en virtuell dator-mall genom att använda ett namn
```
PS C:\> Get-WAPackVMTemplate -Name "ContosoTemplate04"
```

Det här kommandot hämtar mallen för virtuell dator med namnet ContosoTemplate04.

### Exempel 2: Hämta en virtuell dator-mall genom att använda ett ID
```
PS C:\> Get-WAPackVMTemplate -Id 66242D17-189F-480D-87CF-8E1D749998C8
```

Det här kommandot hämtar mallen för virtuell dator med angivet ID.

### Exempel 3: Hämta alla mallar för virtuell dator
```
PS C:\> Get-WAPackVMTemplate
```

Det här kommandot får alla mallar för virtuell dator.

## MALLPARAMETRAR

### -ID
Anger ett unikt ID för en mall.
