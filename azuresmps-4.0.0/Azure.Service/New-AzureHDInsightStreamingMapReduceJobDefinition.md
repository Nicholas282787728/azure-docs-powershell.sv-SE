...
## Sammanfattning
Definierar ett nytt strömmande MapReduce-jobb.
...
Cmdleten **New-AzureHDInsightStreamingMapReduceJobDefinition** definierar ett nytt jobb definitions objekt som representerar parametrarna för ett Hadoop-strömningen.
...
Det här kommandot skapar den angivna jobb definitionen för strömnings MapReduce och lagrar den sedan i $StreamingWordCount variabel.
...
### -CmdEnv
Anger en matris med kommando rads miljövariabler som ska anges när ett jobb körs på datanoder.
...
### -Kombinerare
Anger ett kombinations fil namn.
...
### -Filer
Anger en matris med filer som krävs för ett jobb.
...
### -JobName
Anger namnet på den nya MapReduce.
...
### -OutputPath
Anger WASB-sökvägen för jobb utskriften.
...
### -StatusFolder
Anger den mapp som innehåller standardutdata och fel utdata för jobbet, inklusive slutkod och aktivitets loggar.
