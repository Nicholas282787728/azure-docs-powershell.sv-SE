...
Cmdleten **Get-AzureHDInsightCluster** hämtar Azure HDInsight-tjänstens kluster för det aktuella abonnemanget.
Du kan använda parametern *Name* för att skaffa ett visst kluster.

## BESKRIVS

### Exempel 1: skaffa klustret i ett abonnemang
```
PS C:\> Get-AzureHDInsightCluster
```

Med det här kommandot får du information om HDInsight-klustren i det aktuella abonnemanget.
...
### -Namn
Anger namnet på ett HDInsight-kluster att hämta.
