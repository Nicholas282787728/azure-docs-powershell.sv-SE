...
## Sammanfattning
Visar en lista över användare i en Azure RemoteApp-samling.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRemoteAppUser** visar användarna i en Azure RemoteApp-samling.

## BESKRIVS

### Exempel 1: lista användare av en samling
```
PS C:\> Get-AzureRemoteAppUser -CollectionName "Contoso"
```

Det här kommandot visar de användare som har åtkomst till Azure RemoteApp-samlingen contoso.
...
### -UserUpn
Anger användarens huvud namn (UPN) för en användare som ska visa information om.
Till exempel PattiFuller@contoso.com .
