...
## Sammanfattning
Skapar ett jobb i schemaläggare med en HTTP-åtgärd.
...
Cmdleten **New-AzureSchedulerHttpJob** skapar ett jobb i schemaläggare som har en HTTP-åtgärd.

## BESKRIVS

### Exempel 1: skapa ett HTTP-jobb
```
...
Det här kommandot skapar ett HTTP-jobb för Schemaläggaren i jobb samlingen med namnet JobCollection01.
Kommandot anger en URI och anger GET som metod.

### Exempel 2: skapa ett HTTP-jobb för ett visst antal körningar
```
...
Det här kommandot skapar Schemaläggarens http-jobb i jobb samlingen med namnet JobCollection01.
Kommandot anger en URI och anger GET som metod.
Detta kommando gör att jobbet körs 20 gånger.
...
### -Rubriker
Anger rubriker som en hash-tabellen.
