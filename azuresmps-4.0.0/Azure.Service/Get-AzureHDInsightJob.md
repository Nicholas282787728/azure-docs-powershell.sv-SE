...
Cmdleten **Get-AzureHDInsightJob** får senaste Azure HDInsight-jobb för ett angivet kluster och visar dem i omvänd kronologisk ordning.
...
### -Kluster
Anger ett kluster.
Denna cmdlet hämtar HDInsight-jobb som körs på klustret som den här parametern anger.
...
### -Abonnemang
Anger den prenumeration som innehåller de HDInsight-jobb som du vill hämta.
