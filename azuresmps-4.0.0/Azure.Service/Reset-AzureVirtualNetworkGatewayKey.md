...
## Sammanfattning
Återställer en virtuell nätverksgateway-nyckeln.
...
## PROBLEMBESKRIVNING
Cmdleten **Reset-AzureVirtualNetworkGatewayKey** återställer en virtuell nätverksgateway för gateway.
