...
Cmdleten **Remove-AzureAutomationConnectionType** tar bort en Anslutnings typ för Azure Automation.
...
### -Namn
Anger namnet på den typ av anslutning som ska tas bort.
