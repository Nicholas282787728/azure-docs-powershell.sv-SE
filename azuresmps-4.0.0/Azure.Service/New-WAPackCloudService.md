...
Cmdleten **New-WAPackCloudService** skapar en moln tjänst.

## BESKRIVS

### Exempel 1: skapa en moln tjänst
```
PS C:\> New-WAPackCloudService -Name "ContosoCloudService01" -Label "A label"
```

Kommandot skapar en moln tjänst med namnet ContosoCloudService01 med en etikett.

## MALLPARAMETRAR

### -Etikett
Anger en etikett för moln tjänsten.
...
### -Namn
Anger ett namn för cloudservice.
