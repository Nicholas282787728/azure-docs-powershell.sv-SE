...
### Exempel 1: skapa en auktoriseringsregel med genererad primär Key
```
PS C:\> New-AzureSBAuthorizationRule -Name MyRule -Namespace MyNamespace -Permission $("Send")
```

Skapar en ny auktoriseringsregel på namn områdes nivå med Send-behörighet.

### Exempel 2: skapar en auktoriseringsregel genom att ange primär nycklar
```
...
Skapar en ny auktoriseringsregel på kön med alla behörigheter.
...
### -Namnrymd
Anger namn området för att tillämpa auktoriseringsregeln.
...
### -PrimaryKey
Anger primär nycklarna för signaturen för delad åtkomst.
...
### -SecondaryKey
Anger den sekundära tangenten för signaturen för delad åtkomst.
