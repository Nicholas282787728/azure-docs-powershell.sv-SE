...
## Sammanfattning
Hämtar inställningarna för DSC-tillägget på en virtuell dator.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureVMDscExtension** hämtar inställningarna för DSC-tillägget på en virtuell dator.

## BESKRIVS

### Exempel 1: Hämta DSC-tillägget på en virtuell dator
```
...
Det här kommandot får DSC-tilläggets inställningar på en virtuell dator.
...
### Microsoft. WindowsAzure. kommandon. ServiceManagement. IaaS. Extensions. VirtualMachineDscExtensionContext
