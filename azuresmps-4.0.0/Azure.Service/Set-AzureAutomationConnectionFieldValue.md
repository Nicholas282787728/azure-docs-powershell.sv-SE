...
Ändrar värdet för ett fält för en anslutning.
...
Cmdleten **set-AzureAutomationConnectionFieldValue** ändrar värdet för ett fält för en anslutning i Azure Automation.
...
Anger namnet på Automation-kontot med anslutningen.
...
### -Värde
Anger ett värde för att lagra i fältet Connection.
