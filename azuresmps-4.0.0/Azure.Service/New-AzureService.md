...
Det här kommandot skapar en ny tjänst som heter MySvc01 på platsen Central amerikanska.

### Exempel 2: skapa en tjänst i en tillhörighets grupp
```
PS C:\> New-AzureService -ServiceName "MySvc01" -AffinityGroup NorthRegion
```

Det här kommandot skapar en ny tjänst som heter MySvc01 med hjälp av NorthRegion-tillhörighets gruppen.

## MALLPARAMETRAR

### -AffinityGroup
Anger den tillhörighets grupp som är kopplad till prenumerationen.
Om du inte anger *plats* parametern krävs en tillhörighets grupp.
...
### -Plats
Anger platsen för tjänsten.
En plats krävs om det inte finns någon angiven tillhörighets grupp.
...
### -ServiceName
Anger namnet på den nya tjänsten.
