...
Cmdleten **Resume-AzureAutomationJob** fortsätter att ha stoppat Microsoft Azure Automation-jobb.
Använd parametern *ID* för att ange det upphävda jobbet.

Om du vill pausa ett jobb kan du använda Suspend-AzureAutomationJob cmdlet.
