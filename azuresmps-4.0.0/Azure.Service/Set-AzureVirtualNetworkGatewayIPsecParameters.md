...
## Sammanfattning
Anger IPsec-parametrar för en virtuell nätverksgateway.
...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureVirtualNetworkGatewayIPsecParameters** anger IPsec-parametrar för en virtuell nätverksgateway.
