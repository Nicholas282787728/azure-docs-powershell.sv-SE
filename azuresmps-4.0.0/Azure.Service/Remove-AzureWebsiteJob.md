...
## Sammanfattning
Tar bort ett befintligt webb jobb för en webbplats.
...
### Exempel 1: ta bort ett befintligt webb jobb för en webbplats
```
PS C:\> Remove-AzureWebsiteJob -Name MyWebsite -JobName MyWebJob -JobType Continuous
```

Tar bort ett webb jobb som heter MyWebJob för webbplatsen.

## MALLPARAMETRAR

### -Force
Anger att denna cmdlet tar bort webb jobbet utan att du behöver bekräfta.
