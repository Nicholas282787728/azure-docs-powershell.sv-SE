...
## PROBLEMBESKRIVNING
Cmdleten **Enable-AzureRmOperationalInsightsLinuxCustomLogCollection** startar en samling med anpassade loggar från anslutna Linux-datorer på en arbets yta.
