...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmDataLakeAnalyticsDataSource** tar bort en data Källa från ett Azure Data Lake Analytics-konto.

## BESKRIVS

### Exempel 1: ta bort en data Källa
```
PS C:\>Remove-AzureRmDataLakeAnalyticsDataSource -Account "ContosoAdlAccount" -Blob "AzureStorage01"
```

Det här kommandot tar bort data källan som heter AzureStorage01 från kontot som heter ContosoAdlAccount.
...
### -BLOB
Anger namnet på AzureBlob lagrings konto som ska tas bort.
...
### -DataLakeStore
Anger namnet på den AzureData Lake Store-konto som ska tas bort.
