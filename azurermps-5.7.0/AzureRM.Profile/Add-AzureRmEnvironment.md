...
## PROBLEMBESKRIVNING
Add-AzureRmEnvironment cmdlet lägger till slut punkter och metadata för att aktivera Azure Resource Manager-cmdlets för att ansluta till en ny instans av Azure Resource Manager.
...
I det här exemplet skapar vi en ny Azure-miljö med exempel slut punkter med Add-AzureRmEnvironment och sedan ändrar vi värdet för attributen ActiveDirectoryEndpoint och GraphEndpoint för den skapade miljön med cmdlet Set-AzureRmEnvironment.
...
### -AzureDataLakeStoreFileSystemEndpointSuffix
DNS-suffix för Azure Data Lake Store-filsystem.
Exempel: azuredatalake.net
...
### -AzureKeyVaultDnsSuffix
Anger domän namn för viktiga valv tjänster.
...
### -AzureKeyVaultServiceEndpointResourceId
Anger mål gruppen för de åtkomsttoken som tillåter begäran om nyckel valv tjänster.
...
### -DefaultProfile
Credeetnails, klient organisation och abonnemang som används för kommunikation med Azure
...
Anger slut punkten för funktionen för användnings frågor. 
...
Anger mål grupp för de åtkomsttoken som ger begäran om tjänster för drifts Insights.
...
### PSAzureEnvironment
Denna cmdlet returnerar den uppsättning slut punkter och metadata som behövs för att kommunicera med en instans av Azure.
