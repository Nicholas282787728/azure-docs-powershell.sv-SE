...
## PROBLEMBESKRIVNING
Med Set-AzureRMEnvironment cmdlet anges slut punkter och metadata för anslutning till en instans av Azure.
...
### -ARMEndpoint
Slut punkten för Azure Resource Manager.
...
### -Namn
Anger namnet på den miljö som ska ändras.
