...
### – Skriv
Anger vilken typ av konto som ska skapas. Aktuella acceptabla värden för denna parameter är:

- Bing. föreslå v7
- Bing. CustomSearch
- Bing. search. v7
- Bing. Speech
- Bing. stavnings kontroll. v7
- ComputerVision
- ContentModerator
- CustomSpeech
- CustomVision. förutsägelse
- CustomVision. utbildning
- Emotion
- Sidan
- LUIS
- QnAMaker
