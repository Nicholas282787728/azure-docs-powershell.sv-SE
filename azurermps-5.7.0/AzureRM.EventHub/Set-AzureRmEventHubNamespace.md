...
## PROBLEMBESKRIVNING
Set-AzureRmEventHubNamespace cmdlet uppdaterar egenskaperna för de angivna namn områdena för händelse nav.
...
Uppdaterar tillståndet för namespace \` MyNamespaceName \` till skapad.
...
System.Nullable` 1 [[Microsoft. Azure. commands. eventhub. remodels. NamespaceState, Microsoft. Azure. commands. EventHub, version = 0.5.0.0, Culture = neutralt, PublicKeyToken = null]] system. Collections. hash
