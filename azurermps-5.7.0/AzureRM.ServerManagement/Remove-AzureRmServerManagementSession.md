...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmServerManagementSession** tar bort en Azure Server Management-session.
...
### -Nodnamn
Anger namnet på den nod där denna cmdlet tar bort sessionen.
...
### -ResourceGroupName
Anger namnet på den resurs grupp som sessionen tillhör.
...
### -Session
Anger den session som denna cmdlet tar bort.

Den här parametern kan användas i stället för parametrarna *ResourceGroupName* , *nodnamn* och *sessionsnamn* .
...
### -Sessionsnamn
Anger namnet på den session som denna cmdlet tar bort.
