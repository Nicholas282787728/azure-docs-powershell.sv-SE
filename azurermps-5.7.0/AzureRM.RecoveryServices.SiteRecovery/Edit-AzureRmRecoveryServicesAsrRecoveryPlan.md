...
## PROBLEMBESKRIVNING
Cmdleten **Edit-AzureRmRecoveryServicesAsrRecoveryPlan** redigerar en Azure Site Recovery-plan.
...
### -InputObject
Det objekt för ASR-återställning som ska redige ras (i minnes operation. Om du vill uppdatera återställnings planen kör Update-AzureRmASRRecoveryPlan med det redigerade objektet för återställnings plan.)
