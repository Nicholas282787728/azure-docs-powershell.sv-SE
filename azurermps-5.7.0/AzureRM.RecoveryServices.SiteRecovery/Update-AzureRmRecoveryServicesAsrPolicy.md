...
### -AzureToAzure
Växla parameter som anger att den replikeringsprincip som används för att replikera Azure Virtual-datorer mellan två Azure-regioner kommer att uppdateras.
...
### -AzureToVMware
Switch parameter anger att specfied-principen används för att replikera misslyckade över virtuella datorer som körs i Azure tillbaka till en lokal VMware-webbplats.
