...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmRecoveryServicesAsrPolicy** skapar en Azure Site Recovery Replication-replikeringsprincip.
...
### -AzureToAzure
Switch parameter som anger att den replikeringsprincip som skapas ska användas för replikerade Azure Virtual-datorer mellan två Azure-regioner.
...
### -AzureToVMware
Switch parameter som anger att den replikeringsprincip som skapas ska användas för att återföra replikeringen misslyckades via VMware Virtual Machines och fysiska servrar som körs i Azure tillbaka till en lokal VMware-webbplats.
