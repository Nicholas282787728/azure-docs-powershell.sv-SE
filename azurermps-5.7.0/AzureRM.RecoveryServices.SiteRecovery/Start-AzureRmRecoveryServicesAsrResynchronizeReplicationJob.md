...
## PROBLEMBESKRIVNING
**Start-AzureRmRecoveryServicesAsrResynchronizeReplicationJob** cmdlet starta omsynkronisering av replikering för det angivna skyddade objektet om det skyddade fältet är i ett obligatoriskt tillstånd för omsynkronisering.
