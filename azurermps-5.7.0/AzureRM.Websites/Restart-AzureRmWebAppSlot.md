...
## PROBLEMBESKRIVNING
Cmdleten **restart-AzureRmWebAppSlot** stoppar och startar sedan en Azure Web App-plats.
Om Web App-platsen är i ett stoppat tillstånd kan du använda Start-AzureRmWebAppSlot cmdlet.
