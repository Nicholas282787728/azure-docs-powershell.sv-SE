...
## Sammanfattning
Tar bort ett konto för platsbaserade tjänster.
...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmLocationBasedServicesAccount** tar bort det angivna platsbaserade tjänst kontot.
...
Tar bort det angivna platsbaserade tjänst kontot.
