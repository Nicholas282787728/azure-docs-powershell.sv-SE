...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmRelayNamespace** skapar ett nytt relä namn. När namn rymds resursens manifest har skapats är det oföränderligt.
...
Skapar ett nytt relä namn område i den angivna resurs gruppen.
