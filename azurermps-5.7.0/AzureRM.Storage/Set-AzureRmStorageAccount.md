...
### -KeyvaultEncryption
Om du vill ange Storage Account Encryption-källkod till Microsoft.-valv eller inte.
Om du anger namn, värde versions-och KeyvaultUri för lagrings konto till Microsoft. radiovalv väder den här parametern har ställts in.
```yaml
Type: SwitchParameter
Parameter Sets: KeyvaultEncryption
Aliases:
