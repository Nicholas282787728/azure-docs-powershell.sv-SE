...
## PROBLEMBESKRIVNING
Cmdleten **Start-AzureRmSiteRecoveryPolicyDissociationJob** initierar ett länkat jobb på den replikeringsprincip som är kopplad till en Azure Site Recovery-behållare.
...
### -Princip
Anger ett Azure Site Recovery-princip objekt.
