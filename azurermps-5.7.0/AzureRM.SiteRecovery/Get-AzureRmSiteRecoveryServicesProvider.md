...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmSiteRecoveryServicesProvider** hämtar information om Azure Site Recovery-leverantörer i valvet.
...
### -FriendlyName
Anger det egna namnet på Azure Site Recovery-providern som denna cmdlet får.
...
### -Namn
Anger namnet på Azure Site Recovery-providern som denna cmdlet får.
...
### System. Collections. Generic. IEnumerable ' 1 [[Microsoft. Azure. commands. SiteRecovery. ASRRecoveryServicesProvider, Microsoft. Azure. commands. SiteRecovery, version = 2.0.1.0; Culture = neutralt, PublicKeyToken = null]]
