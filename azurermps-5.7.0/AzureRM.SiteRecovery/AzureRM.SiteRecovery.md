...
---
# Modulen AzureRM. SiteRecovery
## Problembeskrivning
I det här avsnittet visas hjälp avsnitt för Azure Site Recovery-cmdletar.

## AzureRM. SiteRecovery-cmdletar
...
Hämtar en lista över oskyddade eller skyddade enheter i det aktuella Site Recovery-valvet.
...
Hämtar information om Azure Site Recovery-leverantörer i valvet.

### [Get-AzureRmSiteRecoverySite](Get-AzureRmSiteRecoverySite.md)
Hämtar Hyper-V-webbplatserna från Site Recovery-valvet.
...
Hämtar inställningar för det aktuella återställnings valvet för webbplatsen.
...
Tar bort en nätverks mappning från det aktuella återställnings valvet för webbplatsen.
...
Tar bort en plan för webbplats återställning från webbplats återställning.
...
Tar bort en webbplats återställnings webbplats från det aktuella valvet.

### [Remove-AzureRmSiteRecoveryStorageClassificationMapping](Remove-AzureRmSiteRecoveryStorageClassificationMapping.md)
Tar bort en mappning av lagrings klassificering från webbplats återställning.
...
Anger återställnings egenskaper som mål nätverk och virtuell dator storlek för ett replikerat objekt.
...
{{Skriv in Update-AzureRmSiteRecoveryPolicy Beskrivning manuellt}}
