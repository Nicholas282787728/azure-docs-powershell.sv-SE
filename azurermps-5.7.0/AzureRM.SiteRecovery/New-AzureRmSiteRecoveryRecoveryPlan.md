...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmSiteRecoveryRecoveryPlan** skapar en återställnings plan i Azure Site Recovery.
...
### ASRProtectionEntity[]
Parametern ' ProtectionEntityList ' godkänner värdet av typen ' ASRProtectionEntity [] ' från pipeline
