...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRMSiteRecoveryNetworkMapping** tar bort en nätverks mappning från det aktuella Azure Site Recovery-valvet.
...
### -NetworkMapping
Anger objektet nätverks mappning.
...
### ASRNetworkMapping
Parametern ' NetworkMapping ' godkänner värdet av typen ' ASRNetworkMapping ' från pipeline
