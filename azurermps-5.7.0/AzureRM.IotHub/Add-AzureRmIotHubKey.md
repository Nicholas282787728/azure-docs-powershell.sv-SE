...
## PROBLEMBESKRIVNING
Skapar en för angiven IotHub.
De här namnen är inte unika och måste hanteras noggrant.

## BESKRIVS

### Exempel 1 lägga till en IotHub
```
...
Skapar en Key med namnet "MyKey" för iothub "myiothub" med RegistryRead-behörigheter.
...
### -Rättigheter
Behörigheterna för den här IOTHub
...
System. Collections. Generic. list \` 1 \[ \[ Microsoft. Azure. kommandon. Management. IotHub. Models. PSSharedAccessSignatureAuthorizationRule, Microsoft. Azure. commands. IotHub, version = 1.0.0.0, Culture = neutralt, PublicKeyToken = null\]\]
