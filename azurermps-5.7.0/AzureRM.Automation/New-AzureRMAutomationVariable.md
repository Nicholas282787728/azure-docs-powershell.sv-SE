...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmAutomationVariable** skapar en variabel i Azure Automation.
...
Det första kommandot får en virtuell dator med hjälp av Get-AzureVM cmdlet.
