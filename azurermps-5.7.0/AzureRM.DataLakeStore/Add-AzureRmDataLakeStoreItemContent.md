...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzureRmDataLakeStoreItemContent** lägger till innehåll i ett objekt i en Azure Data Lake Store.

## BESKRIVS

### Exempel 1: lägga till innehåll i en fil
```
PS C:\>Add-AzureRmDataLakeStoreItemContent -AccountName "ContosoADLS" -Path /abc/myFile.txt -Value "My content here"
```

Det här kommandot lägger till innehåll i filen myFile.txt.
...
### -Värde
Anger vilket innehåll som ska läggas till objektet.
