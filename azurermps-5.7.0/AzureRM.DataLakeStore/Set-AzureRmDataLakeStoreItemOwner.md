...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmDataLakeStoreItemOwner** ändrar ägaren till en fil eller mapp i data Lake Store.

## BESKRIVS

### Exempel 1: ange ägare för ett objekt
```
...
Det här kommandot ställer in rot katalogen på Patti Nilsson.
...
### -ID
Anger objekt-ID: t för AzureActive katalog användare, grupp eller tjänstens huvud namn som ska användas som ägare.
...
### -PassThru
Anger att den resulterande uppdaterade ägaren ska returneras.
...
### -Path
Anger data Lake Store-sökvägen för det objekt som ska ändras, från rot katalogen (/).
...
### – Skriv
Anger typen av ägare som ska ställas in.
...
### strängvärdet
Om PassThru anges returnerar den uppdaterade ägaren.
