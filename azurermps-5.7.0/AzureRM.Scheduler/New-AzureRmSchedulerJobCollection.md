...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmSchedulerJobCollection** skapar en jobb samling i Azure Scheduler.
...
### -JobCollectionName
Anger ett namn för jobb samlingen.
...
### -Plats
Anger det Azure-område där den här cmdleten skapar jobb samlingen.
