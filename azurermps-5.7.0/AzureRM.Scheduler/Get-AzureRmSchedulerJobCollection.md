...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmSchedulerJobCollection** hämtar jobb samlingar i Azure Scheduler.
...
### -ResourceGroupName
Anger resurs gruppen som den här cmdleten hämtar jobb samlingar från.
