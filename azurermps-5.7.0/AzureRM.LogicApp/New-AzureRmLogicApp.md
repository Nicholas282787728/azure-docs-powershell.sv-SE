...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmLogicApp** skapar ett logiskt program med hjälp av funktionen logiska appar.
...
Det här kommandot får resurs gruppen "ResourceGroup11" genom att använda Get-AzureRmResourceGroup cmdlet.
...
Det första kommandot får till gång till logik programmet med namnet LogicApp03 med hjälp av Get-AzureRmLogicApp cmdlet.
...
### -Definition
Anger definitionen för din logik-app som ett objekt eller en sträng i JSON-objekt (Notataion).
