...
## PROBLEMBESKRIVNING
Cmdleten **use-AzureRmHDInsightCluster** väljer Azure HDInsight-klustret för den Invoke-AzureRmHDInsightHiveJob cmdlet som ska användas för att skicka struktur jobb.
