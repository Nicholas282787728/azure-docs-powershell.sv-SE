...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmHDInsightPigJobDefinition** definierar ett gris-jobb-objekt som ska användas med ett Azure HDInsight-kluster.

## BESKRIVS

### Exempel 1: skapa en jobb definition för gris
```
PS C:\># Cluster info
...
Det här kommandot skapar en jobb definition för gris.
