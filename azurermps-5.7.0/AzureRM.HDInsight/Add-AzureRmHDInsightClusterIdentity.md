...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzureRmHDInsightClusterIdentity** lägger till en kluster identitet i Azure HDInsight-konfigurationsobjektet som skapas av New-AzureRmHDInsightClusterConfig cmdlet.
...
### Ande
Parametern ' ObjectId ' godkänner värdet av typen ' GUID ' från pipeline
