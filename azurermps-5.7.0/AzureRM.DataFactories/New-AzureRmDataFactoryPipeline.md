...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmDataFactoryPipeline** skapar en pipeline i Azure Data Factory.
...
### -Fil
Anger den fullständiga sökvägen till den JavaScript-fil som innehåller en beskrivning av pipeline.
