...
### Filtrerar grupper med objekt-ID
```
PS C:\> Get-AzureRmADGroup -ObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE
```

Hämtar grupp med 85F89C90-780E-4AA6-9F4F-6F268D322EEE-ID

### Filtrerar grupper med Sök sträng
```
PS C:\> Get-AzureRmADGroup -SearchString Joe
```

Filtrerar alla AD-grupper som har Joe i visnings namnet.

### Visa en lista över AD-grupper
```
