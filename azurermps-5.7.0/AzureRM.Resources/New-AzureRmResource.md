...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmResource** skapar en Azure-resurs, till exempel en webbplats, en Azure SQL-databas eller en Azure SQL-databas, i en resurs grupp.
...
Anger namnet på en tilläggs resurs för resursen. Om du till exempel vill ange en databas använder du följande format:
...
Om tilläggs resursen till exempel är en databas anger du följande typ:
...
Du kan lägga till en resurs på alla platser som stöder resurser av den typen. Resurs grupper kan innehålla resurser från olika platser. Om du vill ta reda på vilka platser som har stöd för varje resurs typ använder du Get-AzureLocation cmdlet.
...
### -ResourceName
Anger namnet på resursen. Om du till exempel vill ange en databas använder du följande format:
