...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmCdnOrigin** hämtar en Origine-Server och dess konfigurations data.
...
### -CdnEndpoint
Anger det CDN-slutobjekt som ursprunget tillhör.
...
### -EndpointName
Anger namnet på den slut punkt som ursprungs servern tillhör.
...
### -OriginName
Anger namnet på ursprungs servern.
...
###  
Denna cmdlet returnerar ett Origine Server-objekt.
