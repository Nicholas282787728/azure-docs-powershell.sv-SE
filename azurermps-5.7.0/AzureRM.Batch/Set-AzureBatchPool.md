...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureBatchPool** uppdaterar egenskaperna för en pool i Azure Batch-tjänsten.
Använd Get-AzureBatchPool cmdlet för att hämta ett **PSCloudPool** -objekt.
...
Det första kommandot får en pool genom att använda **Get-AzureBatchPool** och lagrar den sedan i $pool variabel.

Nästa tre kommandon ändrar specifikationen för start uppgiften för $Pool-objektet.

Det sista kommandot uppdaterar kommando tjänsten för att matcha det lokala objektet i $Pool.
...
### -Pool
Anger den **PSCloudPool** som den här cmdleten uppdaterar.
...
### PSCloudPool
Parametern ' pool ' godkänner värdet av typen ' PSCloudPool ' från pipeline
