...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureBatchComputeNode** tar emot Azure Batch-datornoder från en pool.
...
Det här kommandot får poolen med ID-Pool07 med hjälp av Get-AzureBatchPool cmdlet.
...
För att hämta ett **PSCloudPool** -objekt, Använd cmdleten Get-AzureBatchPool.
