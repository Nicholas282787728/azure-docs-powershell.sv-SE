...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmDiskUpdateImageReference** anger bild referens egenskaperna för ett disk uppdaterings objekt.
...
Det första kommandot skapar ett uppdaterings objekt för lokala diskar med storleken 10 GB i Premium_LRS lagrings konto.  Den anger också Windows OS-typ.
Det andra kommandot ställer in bild-ID och det logiska enhets numret 0 för disk uppdaterings objekt.
