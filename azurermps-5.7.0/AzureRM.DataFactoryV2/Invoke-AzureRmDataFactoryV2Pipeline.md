...
## PROBLEMBESKRIVNING
Kommandot **Invoke-AzureRmDataFactoryV2Pipeline** startar en körning på den angivna pipeline och returnerar ett ID för den. Detta GUID kan överföras till **Get-AzureRmDataFactoryV2PipelineRun** eller **Get-AzureRmDataFactoryV2ActivityRun** för att få mer information om den här körningen.
