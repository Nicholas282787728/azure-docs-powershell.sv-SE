...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmSqlDatabaseRecommendedAction** har en eller flera rekommenderade åtgärder för en Azure SQL-databas rådgivare.
...
Det här kommandot får en lista över alla rekommenderade åtgärder hos den rådgivare som heter CreateIndex tillgänglig för databasen som heter Wi-löpare – Australien-öst.
...
Med det här kommandot får du den rekommenderade åtgärden som heter IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893 för rådgivaren CreateIndex.
...
### -DatabaseName
Anger namnet på den databas som den här cmdleten begär åtgärder för.
