...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy** anger den långsiktiga bevarande princip som är registrerad för den här databasen.
...
### Exempel 4: ta bort den långsiktiga bevarande principen
```powershell
...
Det finns en minumum på 7 dagar och högst 10 år.
...
### -ResourceId
Resurs-ID för säkerhets kopiering av princip för lång tids period.
...
### -State
Tillståndet för säkerhets kopierings principen för långsiktig lagring, "Enabled" eller "Disabled"
