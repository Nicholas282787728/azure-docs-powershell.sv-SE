...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmSqlServerActiveDirectoryAdministrator** tar bort en Azure Active Directory (Azure AD-administratör) för AzureSQL-servern i den aktuella prenumerationen.
