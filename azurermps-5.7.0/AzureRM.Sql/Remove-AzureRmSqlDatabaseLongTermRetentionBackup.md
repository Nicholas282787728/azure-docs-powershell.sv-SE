...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmSqlDatabaseLongTermRetentionBackup** tar bort den angivna säkerhets kopian.

## BESKRIVS

### Exempel 1: ta bort en enda säkerhets kopia
```powershell
...
### Exempel 2: ta bort alla säkerhets kopior för en plats
```powershell
