...
{{Skriv in Add-AzureRmLoadBalancerInboundNatPoolConfig Beskrivning manuellt}}
...
{{Skriv in Get-AzureRmBgpServiceCommunity Beskrivning manuellt}}
...
{{Skriv in Get-AzureRmLoadBalancerInboundNatPoolConfig Beskrivning manuellt}}
...
Hämtar en anslutnings skärm

### [Get-AzureRmNetworkWatcherConnectionMonitorReport](Get-AzureRmNetworkWatcherConnectionMonitorReport.md)
Får en ögonblicks bild av de senaste anslutnings tillstånden
...
{{Skriv in Get-AzureRmVirtualNetworkGatewayConnectionSharedKey Beskrivning manuellt}}
...
Gör det enkelt att ladda ned VPN-profilen som genererades med New-AzureRmVpnClientConfiguration cmdleten.
...
{{Skriv in New-AzureRmLoadBalancerInboundNatPoolConfig Beskrivning manuellt}}
...
Skapar en ny anslutnings övervaknings resurs.
...
{{Skriv in New-AzureRmVirtualNetworkGatewayConnection Beskrivning manuellt}}
...
{{Skriv in Remove-AzureRmLoadBalancerInboundNatPoolConfig Beskrivning manuellt}}
...
{{Skriv in Remove-AzureRmVirtualNetworkGatewayIpConfig Beskrivning manuellt}}

### [Remove-AzureRmVirtualNetworkPeering](Remove-AzureRmVirtualNetworkPeering.md)
{{Skriv in Remove-AzureRmVirtualNetworkPeering Beskrivning manuellt}}
...
{{Skriv in Reset-AzureRmVirtualNetworkGateway Beskrivning manuellt}}

### [Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey](Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey.md)
{{Skriv in Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey Beskrivning manuellt}}
...
{{Skriv in Set-AzureRmLoadBalancerInboundNatPoolConfig Beskrivning manuellt}}
...
Anger mål tillstånd för en regel för belastnings utjämning.
...
Ändrar en anslutnings övervakare.
...
Anger mål tillstånd för ett flöde.
...
Anger mål tillstånd för en väg tabell.
...
Konfigurerar mål tillstånd för en under nätverks konfiguration i ett virtuellt nätverk.
...
Startar en anslutnings övervakning.
...
Stoppar en pågående anslutnings övervakning
...
{{Skriv in Test-AzureRmDnsAvailability Beskrivning manuellt}}
