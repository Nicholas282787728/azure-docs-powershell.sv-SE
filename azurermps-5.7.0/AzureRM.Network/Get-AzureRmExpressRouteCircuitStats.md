...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureRmExpressRouteCircuitStats** hämtar trafik statistik för en ExpressRoute-krets. Statistiken innehåller antalet byte som skickas och tas emot via både primära och sekundära vägar.
