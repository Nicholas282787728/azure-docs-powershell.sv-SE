...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureRmLoadBalancerRuleConfig** anger mål tillstånd för en regel konfiguration för belastnings utjämning.

## BESKRIVS

### Exempel 1: ändra en regel för belastnings Utjämnings regler
```
...
I det andra kommandot används pipeline-operatorn för att överföra belastningsutjämnaren i $slb till Add-AzureRmLoadBalancerRuleConfig, som lägger till en regel som heter NewRule.

Det tredje kommandot skickar belastningsutjämnaren till **set-AzureRmLoadBalancerRuleConfig** , som anger den nya regel konfigurationen.
Observera att konfigurationen inte aktiverar en flytande IP-adress, som har Aktiver ATS av föregående kommando.

## MALLPARAMETRAR

### -BackendAddressPool
Anger ett **BackendAddressPool** -objekt som ska kopplas till en regel för belastnings utjämning.
...
Denna cmdlet anger regel konfigurationen för mål tillstånd för belastningsutjämnaren som den här parametern anger.
...
De acceptabla värdena för den här parametern är: SourceIP och SourceIPProtocol.
...
### -Namn
Anger namnet på en belastningsutjämnare.
