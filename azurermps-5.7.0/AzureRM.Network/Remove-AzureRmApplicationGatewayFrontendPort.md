...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzureRmApplicationGatewayFrontendPort** tar bort en front port från en Azure Application Gateway.

## BESKRIVS

### Exempel: ta bort en klient port från en Programgateway
```
PS C:\>$AppGw = Get-AzureRmApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
PS C:\> Remove-AzureRmApplicationGatewayFrontendPort -ApplicationGateway $AppGw -Name "FrontEndPort02"
```

Det första kommandot får en Programgateway som heter ApplicationGateway01 som tillhör resurs gruppen med namnet ResourceGroup01 och lagrar gatewayen i $AppGw variabel.

Det andra kommandot tar bort porten som heter FrontEndPort02 från Application Gateway.

## MALLPARAMETRAR

### -ApplicationGateway
Anger den Programgateway från vilken du vill ta bort en front port.
...
### -Namn
Anger namnet på klient delen som ska tas bort.
