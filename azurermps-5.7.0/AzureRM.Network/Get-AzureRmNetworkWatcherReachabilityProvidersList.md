...
## PROBLEMBESKRIVNING
I Get-AzureRmNetworkWatcherReachabilityProvidersList listas alla tillgängliga Internet leverantörer för ett angivet Azure-område.
...
Här listas alla tillgängliga providrar i Seattle, WA för Azure Data Center i västra USA.
...
System. String system. Collections. Genered. list ' 1 [[system. String, mscorlib, version = 4.0.0.0, Culture = neutral, PublicKeyToken = b77a5c561934e089]]

## VÄRDEN

### Microsoft. Azure. commands. Networks. Models. PSAvailableProvidersList
