...
## PROBLEMBESKRIVNING
Set-AzureRmApplicationGatewayBackendHttpSettings cmdleten uppdaterar serverns HTTP-inställningar (backend Hypertext Transfer Protocol) för en Azure Application Gateway.
