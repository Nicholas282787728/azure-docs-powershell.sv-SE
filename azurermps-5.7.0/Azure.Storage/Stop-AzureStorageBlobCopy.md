...
## PROBLEMBESKRIVNING
Cmdleten **Stop-AzureStorageBlobCopy** stoppar en kopierings åtgärd till angiven destinations-blob.

## BESKRIVS

### Exempel 1: stoppa kopierings åtgärd efter namn
```
PS C:\>Stop-AzureStorageBlobCopy -Container "ContainerName" -Blob "BlobName" -CopyId "CopyID"
```

Det här kommandot stoppar kopierings åtgärden efter namn.

### Exempel 2: Stoppa kopieringen genom att använda pipeline
```
PS C:\>Get-AzureStorageContainer container* | Stop-AzureStorageBlobCopy -Blob "BlobName"
```

Det här kommandot stoppar kopieringen genom att skicka behållaren i pipeline från **Get-AzureStorageContainer**.

### Exempel 3: Stoppa kopieringen med hjälp av pipeline och Get-AzureStorageBlob
```
PS C:\>Get-AzureStorageBlob -Container "ContainerName" | Stop-AzureStorageBlobCopy -Force
```

I det här exemplet avbryts kopieringen genom att behållaren skickas från Get-AzureStorageBlob cmdlet.
...
Du kan skapa objektet eller använda Get-AzureStorageContainer cmdlet.
...
Du kan skapa kontexten med hjälp av New-AzureStorageContext cmdlet.
...
### -Force
Stoppar den aktuella kopierings aktiviteten för angiven BLOB utan att behöva bekräfta.
