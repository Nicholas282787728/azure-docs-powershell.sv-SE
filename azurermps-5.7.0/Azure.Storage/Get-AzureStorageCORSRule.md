...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzureStorageCORSRule** får CORS-regler (Cross-Resource Sharing) för en Azure Storage Service-typ.

## BESKRIVS

### Exempel 1: Hämta CORS-regler för Blob-tjänsten
```
PS C:\>Get-AzureStorageCORSRule -ServiceType Blob
```

Det här kommandot får CORS-reglerna för typen blob-tjänst.
...
### -ServiceType
Anger typen för Azure Storage-tjänsten för vilken denna cmdlet får CORS-regler.
...
###  
Denna cmdlet returnerar en matris med **PSCORSRule** -objekt som representerar CORS-reglerna för närvarande i en tjänst.
