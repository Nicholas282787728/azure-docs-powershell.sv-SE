...
## PROBLEMBESKRIVNING
Cmdleten **set-AzureStorageQueueStoredAccessPolicy** anger en lagrad åtkomst princip för en Azure Storage-kö.

## BESKRIVS

### Exempel 1: Ange en lagrad åtkomst princip i kön med fullständig behörighet
```
PS C:\> Set-AzureStorageQueueStoredAccessPolicy -Queue "MyQueue" -Policy "Policy07" -Permission arup
```

Det här kommandot anger en åtkomst princip med namnet Policy07 för lagringsmappen som heter min kö.
...
### -NoStartTime
Anger att den här cmdleten ställer in start tiden som ska $Null.
...
Parametern ' Queue ' godkänner värdet för typen String från pipeline
