...
## PROBLEMBESKRIVNING
Cmdleten **set-AzStorageContainerAcl** anger offentlig åtkomst behörighet för den angivna lagrings behållaren i Azure.
...
De godkända värdena för den här parametern är:--container.
