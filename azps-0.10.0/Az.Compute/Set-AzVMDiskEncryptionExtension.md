...
### AADClientSecretParameterSet (standard)
```
...
## PROBLEMBESKRIVNING
Cmdleten **set-AzVMDiskEncryptionExtension** aktiverar kryptering på en infrastruktur som körs som en tjänst (IaaS) virtuell dator i Azure.
