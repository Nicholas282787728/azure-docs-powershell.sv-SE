...
## PROBLEMBESKRIVNING
Cmdleten **set-AzDiskImageReference** anger bild referens egenskaperna för ett disk objekt.
...
Det andra kommandot ställer in bild-ID och det logiska enhets numret 0 för obejct.
