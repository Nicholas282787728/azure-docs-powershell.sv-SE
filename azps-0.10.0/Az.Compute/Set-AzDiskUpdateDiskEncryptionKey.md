...
## Sammanfattning
Anger egenskaper för disk krypterings nycklar på disk uppdaterings objekt.
...
## PROBLEMBESKRIVNING
Cmdleten **set-AzDiskUpdateDiskEncryptionKey** anger egenskaperna för disk krypterings nycklar på ett disk uppdaterings objekt.
