...
## PROBLEMBESKRIVNING
New-AzNetworkWatcherConnectionMonitor cmdlet rcreates en anslutnings Övervakare för en viss källa och mål.

## BESKRIVS

### ---------------Exempel 1: skapa en anslutnings Övervakare för en VM-och Internet mål---------------
```
...
Med den New-AzNetworkWatcherConnectionMonitor cmdleten skapas en anslutnings Övervakare för en viss källa och mål.
