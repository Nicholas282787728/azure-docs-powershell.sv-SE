...
**Add-AzExpressRouteCircuitAuthorization** accepterar pipeline-instanser av objektet **Microsoft. Azure. commands. Network. Models. PSExpressRouteCircuit** .

## VÄRDEN

### PSExpressRouteCircuit
**Add-AzExpressRouteCircuitAuthorization** ändrar instanser av **Microsoft. Azure. commands. Network. Models. PSExpressRouteCircuit** .
