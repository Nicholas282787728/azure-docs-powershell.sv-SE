...
## PROBLEMBESKRIVNING
Cmdleten **set-AzVirtualNetworkVpnClientConfig** konfigurerar klient-adresspoolen för en virtuell nätverksgateway.
...
I det andra kommandot i exemplet används cmdleten **set-AzVirtualNetworkGatewayVpnClientConfig** för att tilldela adresspoolen 10.0.0.0/16 till ContosoVirtualGateway.
...
I det andra kommandot i exemplet används cmdleten **set-AzVirtualNetworkGatewayVpnClientConfig** för att tilldela adresspoolen 10.0.0.0/16 till ContosoVirtualGateway. Den konfigurerar också den externa RADIUS-servern "TestRadiusServer" för att användas för serverautentisering.
