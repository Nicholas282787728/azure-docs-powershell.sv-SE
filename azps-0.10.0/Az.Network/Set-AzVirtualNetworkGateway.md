...
Det första kommandot får en virtuell nätverksgateway som heter Gateway01 som tillhör resurs gruppen ResourceGroup001 och lagrar den på variabeln som heter $Gateway

Det andra kommandot ställer in mål tillståndet för den virtuella Nätverksgatewayen som lagras i variabeln $Gateway.
...
Du kan använda Get-AzVirtualNetworkGateway cmdlet för att hämta det virtuella nätverkets gateway-objekt.
