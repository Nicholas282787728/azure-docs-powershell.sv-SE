...
### -Password
Lösenordet som ska kopplas till tjänstens huvudnamn. Om inget lösenord anges genereras en slumpmässig GUID och används som lösenord.
...
## ANTECKNINGAR
Nyckelord: azure, Az, arm, resource, management, manager, resource, group, template, deployment
