...
## PROBLEMBESKRIVNING
Cmdleten **Stop-AzResourceGroupDeployment** avbryter en Azure Resource Group-distribution som har startat men inte slutförts.
...
Använd New-AzResourceGroupDeployment cmdlet för att distribuera en resurs grupp.
New-AzResource-cmdleten skapar en ny resurs men den utlöser inte en distributions åtgärd för en resurs grupp som denna cmdlet kan stoppa.
Denna cmdlet stoppar bara en drift sättning.
Använd parametern *namn* för att stoppa en specifik distribution.
Om du utelämnar parametern *Name* söker **Stop-AzResourceGroupDeployment** efter en pågående installation och stoppar den.
...
Använd Get-AzResourceGroupDeployment cmdlet för att få distributions namnet.
