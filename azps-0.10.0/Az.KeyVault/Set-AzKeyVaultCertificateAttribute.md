...
## PROBLEMBESKRIVNING
Cmdleten **set-AzKeyVaultCertificateAttribute** ändrar ett certifikats redigerbara attribut.
...
Det sista kommandot visar TestCert01-certifikatet genom att använda Get-AzKeyVaultCertificate cmdlet för att verifiera åtgärden.
