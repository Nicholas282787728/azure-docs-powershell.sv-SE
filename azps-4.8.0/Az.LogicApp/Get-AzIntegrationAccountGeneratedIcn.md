...
## PROBLEMBESKRIVNING
Denna cmdlet är avsedd att användas vid katastrof återställning för att hämta det aktuella värdet för det genererade utbytes kontroll numret så att du kan skriva tillbaka ett ökat värde med set-AzIntegrationAccountGeneratedIcn.
