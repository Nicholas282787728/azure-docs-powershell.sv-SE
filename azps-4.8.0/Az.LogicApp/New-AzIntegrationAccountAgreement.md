...
## PROBLEMBESKRIVNING
**New-AzIntegrationAccountAgreement-** cmdleten skapar ett integrerings konto avtal.
Denna cmdlet returnerar ett objekt som representerar integrerings konto avtalet.
Ange integrerings konto namn, resurs grupp namn, avtals namn, typ, partner namn, partner kvalificerare och avtals innehåll.
...
### Exempel 1: skapa ett integrerings konto avtal
```powershell
...
Det här kommandot skapar ett integrerings konto avtal i den angivna Azure resurs gruppen.

### Exempel 2

Skapar ett integrerings konto avtal. (automatiskt genererat)
...
### -AgreementContent
Anger avtalets innehåll i JSON-format (Java Object Notation) för avtalet.
Ange antingen den här parametern eller parametern *AgreementContentFilePath* .
...
Anger fil Sök vägen för avtalets innehåll.
Ange antingen den här parametern eller parametern *AgreementContent* .
...
### -AgreementName
Anger ett namn för integrerings konto avtalet.
...
### -AgreementType
Anger avtals typen för integrerings kontot. De acceptabla värdena för den här parametern är:
- X12 
- AS2
- Edifact
...
Anger en namn avgränsare för företags identitet för gäst partnern.
...
Integrations konto avtalets värde för gäst identitet.
...
Anger en namn avgränsare för företags identitet för värd partnern.
...
Integrerings värde för värden för värd identitet för integrations konto avtal.
...
### -Metadata
Anger ett metadataobjekt för avtalet.
