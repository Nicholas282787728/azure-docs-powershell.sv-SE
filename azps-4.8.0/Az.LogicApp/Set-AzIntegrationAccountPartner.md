...
## PROBLEMBESKRIVNING
Cmdleten **set-AzIntegrationAccountPartner** ändrar en integrations konto partner.
...
### Exempel 1: ändra en integrations konto partner
```powershell
...
Det här kommandot ändra integrerings konto partnern med namnet IntegrationAccountPartner22 i den angivna resurs gruppen.

### Exempel 2

Ändrar en integrerings konto partner. (automatiskt genererat)
