...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzManagementGroupDeployment** tar bort en Azure-distribution i en hanterings grupp och tillhör ande åtgärder.
...
Det här kommandot tar bort distributionen "RolesDeployment" i hanterings gruppen "myMG".
...
Det här kommandot får distributionen "RolesDeployment" i hanterings gruppen "myMG" och tar bort den.
