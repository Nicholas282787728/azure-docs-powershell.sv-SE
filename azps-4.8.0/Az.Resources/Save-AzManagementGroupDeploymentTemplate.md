...
## PROBLEMBESKRIVNING
Cmdleten **Save-AzManagementGroupDeploymentTemplate**  sparar en distributionsmall till en JSON-fil för en distribution i en hanterings grupp.
...
Det här kommandot får distributionen "RolesDeployment" i hanterings gruppen "myMG" och sparar dess mall.
