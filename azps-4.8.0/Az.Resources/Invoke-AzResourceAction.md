...
## PROBLEMBESKRIVNING
Cmdleten **Invoke-AzResourceAction** anropar en åtgärd på en angiven Azure-resurs.
Använd Azure Resource Explorer-verktyget för att få en lista över vilka åtgärder som stöds.

## BESKRIVS

### Exempel 1: Invoke starta en virtuell dator med ResourceId
...
Det här kommandot startar den virtuella datorn med {ResourceId}.

### Exempel 2: anropa poweroffing en virtuell dator med ResourceName
...
Det här kommandot stoppar den virtuella datorn med {ResourceId}.
Kommandot anger parametern *Force* och ber därför inte dig att bekräfta.

### Exempel 3: anropa registrering av en resurs leverantör med ResourceId
...
Det här kommandot registrerar en resurs leverantör "Microsoft. Network".
Kommandot anger parametern *Force* och ber därför inte dig att bekräfta.
