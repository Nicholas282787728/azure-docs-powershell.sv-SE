...
## PROBLEMBESKRIVNING
Remove-AzRoleDefinition cmdlet tar bort en anpassad roll i Azure Role-Based Access-kontroll.
Ange ID-parametern för en befintlig anpassad roll för att ta bort den anpassade rollen.
Remove-AzRoleDefinition uppmanar dig att bekräfta.
...
### -InputObject
Objektet som representerar den roll definition som ska tas bort.
