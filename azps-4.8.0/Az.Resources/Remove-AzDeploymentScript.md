...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzDeploymentScript** tar bort ett distributions skript och dess associerade resurser.
...
Tar bort ett distributions skript med namnet MyDeploymentScript i resurs gruppen DS-TestRG.
