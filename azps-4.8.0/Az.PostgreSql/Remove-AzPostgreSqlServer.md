...
### Exempel 1: ta bort PostgreSql Server genom resourceGroup och Server namn
```powershell
PS C:\> Remove-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

Denna cmdlet tar bort PostgreSql-servern genom resourceGroup och Server namn.

### Exempel 2: ta bort PostgreSql-servern efter identitet
```powershell
...
Dessa cmdlets tar bort PostgreSql-servern efter identitet.
