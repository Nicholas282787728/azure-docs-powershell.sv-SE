...
### Exempel 1: lista alla konfigurationer i PostgreSql Server
```powershell
...
Denna cmdlet visar alla konfigurationer i angiven PostgreSql-Server.

### Exempel 2: Hämta angiven PostgreSql-konfiguration efter namn
```powershell
...
Denna cmdlet anger PostgreSql-konfigurationen efter namn.
