...
Denna cmdlets skapar en PostgreSql.

### Exempel 2: skapa en ny PostgreSql brand Väggs regel med-ClientIPAddress.
```powershell
...
Denna cmdlets skapar en PostgreSql med-ClientIPAddress.

### Exempel 3: skapa en ny PostgreSql för att tillåta alla IP-adresser
```powershell
...
Denna cmdlets skapar en ny PostgreSql för att tillåta alla IP-adresser.
