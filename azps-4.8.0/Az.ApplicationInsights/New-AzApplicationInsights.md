...
### Exempel 1 Skapa en ny Application Insights-resurs
```
...
Lägga till en ny Application Insights-resurs med namnet "test" i resurs gruppen "testgroup" med typen "Java"
...
### -Plats
Resurs plats för Application Insights.
...
Nätverks åtkomst typen för att få åtkomst till program insikter. Värdet ska vara Enabled eller disabled
...
Typen nätverks åtkomst för åtkomst till Application Insights-fråga. Värdet ska vara Enabled eller disabled
...
### -RetentionInDays
Bevarande i dagar, 90 som standard.
