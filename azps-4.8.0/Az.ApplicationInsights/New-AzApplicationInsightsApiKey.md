...
## PROBLEMBESKRIVNING
Skapa en Application Insights-API-nycklar för en Application Insights-resurs

## BESKRIVS

### Exempel 1 Skapa en ny API-Server för en Application Insights-resurs
```
...
Skapa Application Insights API-beskrivning som "testapiKey" med behörigheter "ReadTelemetry", "WriteAnnotations" för resurs "test" i resurs gruppen "testGroup".
...
### -Beskrivning
Beskrivning som hjälper dig att identifiera denna API-funktion.
...
### -Behörigheter
Behörigheter som API-nycklar tillåter att appar gör.
