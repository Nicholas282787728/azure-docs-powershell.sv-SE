...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzRecoveryServicesAsrReplicationProtectedItemDisk** lägger till disken för att skydda redan skyddade Azure-datorer.
...
Starta åtgärden för att lägga till angiven disk konfiguration.
...
Starta åtgärden för att lägga till angiven disk konfiguration. Rör om skyddat objekt för artikelinleverans.

## MALLPARAMETRAR

### -AzureToAzureDiskReplicationConfiguration
Anger vilken disk konfiguration som ska användas för disk skydd för Azure för katastrof återställnings scenario.
...
### -InputObject
Indatavärdet till cmdlet: objektet skyddat objekt för ASR-replikering för vilken ny disk ska skyddas.
