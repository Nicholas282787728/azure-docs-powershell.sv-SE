...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzRecoveryServicesBackupProtectableItem** hämtar listan över objekt som skyddas i en behållare och objektets skydds status.
...
Det andra kommandot skyddar det skyddade objektet för säkerhets kopiering i $Container och lagrar det sedan i $Item-variabeln.
