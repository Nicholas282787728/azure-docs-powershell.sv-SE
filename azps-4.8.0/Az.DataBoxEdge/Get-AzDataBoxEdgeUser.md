...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDataBoxEdgeUser** visar de användare som har kon figurer ATS för en Edge-enhet. Du kan nämna namnet i parametrar för att få information om en viss användare.
