...
### Exempel 1: lista alla mallar under ett abonnemang
```powershell
...
Det här kommandot visar alla mallar under ett abonnemang.

### Exempel 2: lista alla mallar under en resurs grupp
```powershell
...
Det här kommandot visar alla mallar under en resurs grupp.

### Exempel 3: Hämta en mall under en resurs grupp
```powershell
...
Det här kommandot får en mall under en resurs grupp.

### Exempel 4: Hämta en mall under en resurs grupp
```powershell
