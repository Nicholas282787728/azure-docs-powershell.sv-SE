...
Hämtar åtkomst begränsningar för Azure Web App.

### [Update-AzWebAppAccessRestrictionConfig](Update-AzWebAppAccessRestrictionConfig.md)
Uppdatera webb tjänst för webbplats arvs konfiguration för en Azure Web App.

### [Add-AzWebAppAccessRestrictionRule](Add-AzWebAppAccessRestrictionRule.md)
Lägger till en åtkomst begränsning till en Azure Web App.

### [Remove-AzWebAppAccessRestrictionRule](Remove-AzWebAppAccessRestrictionRule.md)
Tar bort en åtkomst begränsning till en Azure Web App