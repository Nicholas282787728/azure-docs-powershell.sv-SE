...
Hämta stillbilder för ett webb program med namnet "ContosoApp" med en plats med namnet "mellanlagring" i resurs gruppen "default-Web-West"
...
### -UseDisasterRecovery
Läs stillbilderna från en sekundär skala.
