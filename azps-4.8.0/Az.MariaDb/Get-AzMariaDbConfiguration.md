...
ms.locfileid: "94102787"
---
# <span data-ttu-id="6af44-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="6af44-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="6af44-102">Sammanfattning</span><span class="sxs-lookup"><span data-stu-id="6af44-102">SYNOPSIS</span></span>
<span data-ttu-id="6af44-103">Hämtar information om en Server konfiguration.</span><span class="sxs-lookup"><span data-stu-id="6af44-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="6af44-104">FRÅGESYNTAXEN</span><span class="sxs-lookup"><span data-stu-id="6af44-104">SYNTAX</span></span>

### <span data-ttu-id="6af44-105">Lista (standard)</span><span class="sxs-lookup"><span data-stu-id="6af44-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="6af44-106">Lära</span><span class="sxs-lookup"><span data-stu-id="6af44-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="6af44-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="6af44-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="6af44-108">PROBLEMBESKRIVNING</span><span class="sxs-lookup"><span data-stu-id="6af44-108">DESCRIPTION</span></span>
<span data-ttu-id="6af44-109">Hämtar information om en Server konfiguration.</span><span class="sxs-lookup"><span data-stu-id="6af44-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="6af44-110">BESKRIVS</span><span class="sxs-lookup"><span data-stu-id="6af44-110">EXAMPLES</span></span>

### <span data-ttu-id="6af44-111">Exempel 1: lista all konfiguration under en MariaDB</span><span class="sxs-lookup"><span data-stu-id="6af44-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="6af44-112">Det här kommandot listar all konfiguration under en MariaDB.</span><span class="sxs-lookup"><span data-stu-id="6af44-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="6af44-113">Exempel 2: få en konfiguration av MariaDB</span><span class="sxs-lookup"><span data-stu-id="6af44-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="6af44-114">Det här kommandot får en konfiguration av MariaDB.</span><span class="sxs-lookup"><span data-stu-id="6af44-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="6af44-115">MALLPARAMETRAR</span><span class="sxs-lookup"><span data-stu-id="6af44-115">PARAMETERS</span></span>

### <span data-ttu-id="6af44-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="6af44-116">-DefaultProfile</span></span>
<span data-ttu-id="6af44-117">Autentiseringsuppgifter, konto, klient organisation och abonnemang som används för kommunikation med Azure.</span><span class="sxs-lookup"><span data-stu-id="6af44-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="6af44-118">-InputObject</span><span class="sxs-lookup"><span data-stu-id="6af44-118">-InputObject</span></span>
<span data-ttu-id="6af44-119">Identitets parameter för att konstruera, se avsnittet anteckningar för INPUTOBJECT-egenskaper och skapa en hash-tabell.</span><span class="sxs-lookup"><span data-stu-id="6af44-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="6af44-120">-Namn</span><span class="sxs-lookup"><span data-stu-id="6af44-120">-Name</span></span>
<span data-ttu-id="6af44-121">Server konfigurationens namn.</span><span class="sxs-lookup"><span data-stu-id="6af44-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="6af44-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="6af44-122">-ResourceGroupName</span></span>
<span data-ttu-id="6af44-123">Namnet på resurs gruppen som innehåller resursen.</span><span class="sxs-lookup"><span data-stu-id="6af44-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="6af44-124">Det här värdet kan hämtas från Azure Resource Manager API eller till portalen.</span><span class="sxs-lookup"><span data-stu-id="6af44-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="6af44-125">-ServerName</span><span class="sxs-lookup"><span data-stu-id="6af44-125">-ServerName</span></span>
<span data-ttu-id="6af44-126">Namnet på servern.</span><span class="sxs-lookup"><span data-stu-id="6af44-126">The name of the server.</span></span>
...
### <span data-ttu-id="6af44-127">-SubscriptionId</span><span class="sxs-lookup"><span data-stu-id="6af44-127">-SubscriptionId</span></span>
<span data-ttu-id="6af44-128">Det prenumerations-ID som identifierar en Azure-prenumeration.</span><span class="sxs-lookup"><span data-stu-id="6af44-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="6af44-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="6af44-129">CommonParameters</span></span>
<span data-ttu-id="6af44-130">Den här cmdleten har stöd för de gemensamma parametrarna:-debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-disvariable,-utbuffer,-PipelineVariable,-verbose,-WarningAction och-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="6af44-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="6af44-131">Mer information finns i [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="6af44-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="6af44-132">KOSTNADS</span><span class="sxs-lookup"><span data-stu-id="6af44-132">INPUTS</span></span>

### <span data-ttu-id="6af44-133">Microsoft. Azure. PowerShell. cmdletar. MariaDb. Models. IMariaDbIdentity</span><span class="sxs-lookup"><span data-stu-id="6af44-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="6af44-134">VÄRDEN</span><span class="sxs-lookup"><span data-stu-id="6af44-134">OUTPUTS</span></span>

### <span data-ttu-id="6af44-135">Microsoft. Azure. PowerShell. cmdletar. MariaDb. Models. Api20180601Preview. IConfiguration</span><span class="sxs-lookup"><span data-stu-id="6af44-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="6af44-136">ANMÄRKNINGAR</span><span class="sxs-lookup"><span data-stu-id="6af44-136">NOTES</span></span>

<span data-ttu-id="6af44-137">ALIAS</span><span class="sxs-lookup"><span data-stu-id="6af44-137">ALIASES</span></span>

<span data-ttu-id="6af44-138">KOMPLEXA PARAMETER EGENSKAPER</span><span class="sxs-lookup"><span data-stu-id="6af44-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="6af44-139">Skapa en hash-tabell som innehåller lämpliga egenskaper för att lägga till de parametrar som beskrivs nedan.</span><span class="sxs-lookup"><span data-stu-id="6af44-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="6af44-140">Om du vill ha information om hash-tabeller kör Get-Help about_Hash_Tables.</span><span class="sxs-lookup"><span data-stu-id="6af44-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="6af44-141">INPUTOBJECT <IMariaDbIdentity> : identitets parameter</span><span class="sxs-lookup"><span data-stu-id="6af44-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="6af44-142">`[ConfigurationName <String>]`: Server konfigurationens namn.</span><span class="sxs-lookup"><span data-stu-id="6af44-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="6af44-143">`[DatabaseName <String>]`: Namnet på databasen.</span><span class="sxs-lookup"><span data-stu-id="6af44-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="6af44-144">`[FirewallRuleName <String>]`: Namnet på Server brand Väggs regeln.</span><span class="sxs-lookup"><span data-stu-id="6af44-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="6af44-145">`[Id <String>]`: Sökväg till resurs identitet</span><span class="sxs-lookup"><span data-stu-id="6af44-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="6af44-146">`[LocationName <String>]`: Namnet på platsen.</span><span class="sxs-lookup"><span data-stu-id="6af44-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="6af44-147">`[ResourceGroupName <String>]`: Namnet på resurs gruppen som innehåller resursen.</span><span class="sxs-lookup"><span data-stu-id="6af44-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="6af44-148">Det här värdet kan hämtas från Azure Resource Manager API eller till portalen.</span><span class="sxs-lookup"><span data-stu-id="6af44-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="6af44-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: Namnet på säkerhets varnings principen.</span><span class="sxs-lookup"><span data-stu-id="6af44-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="6af44-150">`[ServerName <String>]`: Namnet på servern.</span><span class="sxs-lookup"><span data-stu-id="6af44-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="6af44-151">`[SubscriptionId <String>]`: Det prenumerations-ID som identifierar en Azure-prenumeration.</span><span class="sxs-lookup"><span data-stu-id="6af44-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="6af44-152">`[VirtualNetworkRuleName <String>]`: Namnet på den virtuella nätverks regeln.</span><span class="sxs-lookup"><span data-stu-id="6af44-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="6af44-153">RELATERADE LÄNKAR</span><span class="sxs-lookup"><span data-stu-id="6af44-153">RELATED LINKS</span></span>
