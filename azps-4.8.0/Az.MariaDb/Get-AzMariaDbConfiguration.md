...
### Exempel 1: lista all konfiguration under en MariaDB
```powershell
...
Det här kommandot listar all konfiguration under en MariaDB.

### Exempel 2: få en konfiguration av MariaDB
```powershell
...
Det här kommandot får en konfiguration av MariaDB.
