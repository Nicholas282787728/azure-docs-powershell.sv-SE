...
### Exempel 1: lista alla MariaDB under en prenumeration
```powershell
...
Det här kommandot listar alla MariaDB under en prenumeration.

### Exempel 2: lista alla MariaDB under en resurs grupp
```powershell
...
Det här kommandot listar alla MariaDB under en resurs grupp.

### Exempel 3: skaffa en MariaDB
```powershell
...
Det här kommandot får en MariaDB.
