...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzAutomationCertificate** tar bort ett certifikat från Azure Automation.
...
Anger namnet på det Automation-konto som denna cmdlet tar bort ett certifikat för.
...
### -Namn
Anger namnet på det certifikat som denna cmdlet tar bort.
...
### -ResourceGroupName
Anger namnet på den resurs grupp som den här cmdleten tar bort ett certifikat för.
