...
## PROBLEMBESKRIVNING
Cmdleten **set-AzAutomationWebhook** ändrar en webhook för en Azure Automation-Runbook.
...
Det här kommandot anger värdet för kör för webhook och tvingar Runbook-flödet att köras på en hybrid Worker-grupp som heter Windows.
...
Det här kommandot uppdaterar värdet för kör för webhook och tvingar Runbook-flödet att köras på en Azure Runbook Worker. 
