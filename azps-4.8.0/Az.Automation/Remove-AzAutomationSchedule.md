...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzAutomationSchedule** tar bort ett schema från Azure Automation.

## BESKRIVS

### Exempel 1: ta bort ett schema
```
PS C:\>Remove-AzAutomationSchedule -AutomationAccountName "Contoso17" -Name "Schedule01" -ResourceGroupName "ResourceGroup01"
```

Det här kommandot tar bort schemat med namnet Schedule01 i Automation-konto Contoso17 i resurs grupp ResourceGroup01.

## MALLPARAMETRAR

### -AutomationAccountName
Anger namnet på ett Automation-konto som denna cmdlet tar bort ett schema för.
...
### -Namn
Anger namnet på det schema som den här cmdleten tar bort.
...
### -ResourceGroupName
Anger namnet på en resurs grupp för vilken denna cmdlet tar bort ett schema.
