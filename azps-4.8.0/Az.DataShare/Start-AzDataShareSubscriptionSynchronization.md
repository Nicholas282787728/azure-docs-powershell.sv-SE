...
## PROBLEMBESKRIVNING
Cmdleten **Start-AzDataShareSubscriptionSynchronization** initierar synkronisering för en resurs prenumeration
...
Det här kommandot initierar synkronisering för en sharesubscription som heter AdsShareSubscription i Account WikiAds. 
...
### -ResourceId
Resurs-ID för Azure Share-prenumerationen
...
### -SynchronizationMode
Synkroniseringsläge (FullSync eller stegvis)
