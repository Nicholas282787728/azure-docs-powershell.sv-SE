...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDataShareInvitation** hämtar information om inbjudningar som lagts till i data resursen. Om du anger namnet på inbjudan får denna cmdlet information om inbjudan. Om du inte anger ett namn hämtas den här cmdleten information om alla inbjudningar i en resurs.
...
Det här kommandot ger information om inbjudan AdsInvitation finns i data Share AdsShare.
...
### -Namn
Namn på Azure Data-delningsinbjudan
...
### -ResourceId
Resurs-ID för Azure Data Share-inbjudan
