...
### Exempel 1: visar konsortiet medlemmar för en blockchain medlem.
```powershell
...
Det här kommandot visar konsortiet medlemmar för en blockchain medlem.
...
### Microsoft. Azure. PowerShell. cmdletar. blockchain. Models. Api20180601Preview. IConsortiumMember
