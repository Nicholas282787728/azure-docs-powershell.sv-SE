...
### Exempel 1: återskapa API-nycklar för en blockchain-medlem med namn
```powershell
...
Det här kommandot återskapar API-nycklar för en blockchain-medlem med namn, resurs grupp.

### Exempel 2: återskapa API-nycklar för en blockchain-medlem med Idenity
```powershell
PS C:\> $keyPair = Get-AzBlockchainMemberApiKey -BlockchainMemberName myblockchainhlqc92 -ResourceGroupName bc-rg
...
Det här kommandot återskapar API-nycklar för en blockchain-medlem med identitet.
...
### -Värde
Hämtar eller anger API-nyckelvärdet.
...
### Microsoft. Azure. PowerShell. cmdletar. blockchain. Models. Api20180601Preview. IApiKey
