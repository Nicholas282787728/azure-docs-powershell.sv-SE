...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzSubscription** uppdaterar en Azure-prenumeration
...
```
Uppdaterar abonnemanget

## MALLPARAMETRAR

### -Åtgärd
Åtgärd att utföra med abonnemang
...
### -SubscriptionId
Prenumerations-ID att uppdatera
