...
## Sammanfattning
Skapa eller uppdatera en åtgärds regel.
...
## PROBLEMBESKRIVNING
**Set-AzActionRule** skapar eller uppdaterar en åtgärds regel.
...
Denna cmdlet skapar en åtgärds regel för Supression, med en prenumerations omfattning.
...
Den här cmdleten skapar en åtgärds regel för gruppen åtgärd med en lista över omfattningen för resurs grupper.
...
Denna cmdlet skapar en åtgärds regel för diagnostikinställningar med en resurs omfattning.

## MALLPARAMETRAR

### -ActionGroupId
Åtgärds grupp-ID som ska meddelas.
...
Förväntat format-{ \<operation\> : \<comma separated list of values\> } för tex.
Innehåller: smartgroups
...
Förväntat format-{ \<operation\> : \<comma separated list of values\> } för tex.
Lika med:/abonnemang/ad825170-845c-47db-8f00-11978947b089/resourceGroups/abvarma/leverantörer/Microsoft. insikter/metricAlerts/test-mrmc-VM-abvarma
...
Förväntat format-{ \<operation\> : \<comma separated list of values\> } för tex.
Lika med: plattform, logg analys
...
### -ReccurenceType
Anger hur länge undersökning ska göras.
...
### -ReccurentValue
Reccurent-värden, om tillämpligt. För varje vecka – \[ 1, \] 3 för varje månad- \[ 1,3\]
...
### -Omfattning
Kommaseparerad lista med värden
...
### -SuppressionEndTime
Undertrycks slut tid.
Format 12/09/2018 06:00:00 + bör nämnas i händelse av Reccurent Supression schema-en gång, varje dag, varje vecka eller varje månad.
...
Förväntat format-{ \<operation\> : \<comma separated list of values\> } för tex.
Innehåller: virtuella datorer, lagrings konto
