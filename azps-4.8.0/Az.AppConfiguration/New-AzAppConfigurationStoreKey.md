...
## Sammanfattning
Återskapar en åtkomst-nyckeln för det angivna konfigurations arkivet.
...
### Exempel 1: återskapa nyckeln för ett program konfigurations Arkiv
```powershell
...
Det här kommandot återskapar en lagrings plats.

### Exempel 2: återskapa nyckeln för ett program konfigurations Arkiv per objekt
```powershell
...
Det här kommandot återskapar en lagrings plats för en app-konfiguration per objekt.
...
### -ID
ID för nyckeln som ska återskapas.
...
### Microsoft. Azure. PowerShell. cmdletar. AppConfiguration. Models. Api20200601. IApiKey
