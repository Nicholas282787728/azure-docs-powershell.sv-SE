...
### Exempel 1: Hämta vår moln app via namn.
```powershell
...
Skaffa vår moln app efter namn.

### Exempel 2: Visa alla program under en viss fjäder moln tjänst.
```powershell
...
Visa alla program under en viss fjäder moln tjänst.
...
### -SyncStatus
Anger om synkroniseringsstatus
