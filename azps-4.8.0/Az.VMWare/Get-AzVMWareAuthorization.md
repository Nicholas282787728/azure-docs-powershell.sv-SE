...
Denna cmdlet får tillstånd `azps-test-auth` under privata moln `azps-test-cloud`

### Exempel 2: lista godkännande
```powershell
...
Denna cmdlet visar auktorisering `azps-test-auth` under privat moln `azps-test-cloud`
