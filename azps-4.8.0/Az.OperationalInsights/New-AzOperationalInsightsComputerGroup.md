...
## PROBLEMBESKRIVNING
Cmdleten **New-AzOperationalInsightsComputerGroup** skapar en dator grupp i en resurs grupp och plats.

## BESKRIVS

### Exempel 1

Skapar en dator grupp. (automatiskt genererat)
...
### -Kategori
Anger kategorin för dator gruppen.
...
### -DisplayName
Anger visnings namnet för dator gruppen.
...
### -Fråga
Anger frågan för dator gruppen.
...
Cmdleten skapar dator gruppen i den här resurs gruppen.
