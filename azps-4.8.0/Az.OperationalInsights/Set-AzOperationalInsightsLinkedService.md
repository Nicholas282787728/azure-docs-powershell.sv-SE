...
### -ResourceId
Resurs-ID för resursen som ska länkas till arbets ytan.
Detta bör användas för att länka resurser som kräver Läs åtkomst
...
Resurs-ID för resursen som ska länkas till arbets ytan.
Detta bör användas för att länka resurser som kräver skriv åtkomst.
Klustret måste ha etablerings status "lyckades" och giltiga egenskaper för valv.
