...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzOperationalInsightsSchema** returnerar det schema som är kopplat till den angivna arbets ytan i den resurs gruppen.

## BESKRIVS

### Exempel 1: Hämta scheman för en arbets yta
```
PS C:\>Get-AzOperationalInsightsSchema -ResourceGroupName "ContosoResourceGroup" -WorkspaceName "ContosoWorkspace"
```

Det här kommandot får scheman som är associerade med en arbets yta.
