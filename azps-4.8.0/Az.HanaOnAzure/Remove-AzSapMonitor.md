...
### Exempel 1: ta bort en SAP-övervakare efter namn
```powershell
PS C:\> Remove-AzSapMonitor -ResourceGroupName nancyc-hn1 -Name ps-sapmonitor-t02

```

Det här kommandot tar bort en SAP-skärm med namn.

### Exempel 2: ta bort en SAP-övervakare efter objekt
```powershell
...
Det här kommandot tar bort en SAP-skärm efter objekt.
