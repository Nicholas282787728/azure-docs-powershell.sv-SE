...
Lägg till " @tags " i taggen för en Azure IoT Hub-enhet "myiotdps".
...
Ta bort taggen och Lägg till ny " @tags " till taggen för en Azure IoT Hub-enhet "myiotdps" med pipeline.
