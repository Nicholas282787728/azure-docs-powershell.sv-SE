...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzPrivateDnsZone** har en privat DNS-zon (Domain Name System) från den angivna resurs gruppen.
Om du anger parametern *Name* returneras ett enskilt **PrivateDnsZone** -objekt.
Om du inte anger parametern *Name* returneras en matris med alla zoner i den angivna resurs gruppen.
Du kan använda **PrivateDnsZone** -objektet för att uppdatera zonen, till exempel att du kan lägga till **Recordset** -objekt i den.
...
Det här exemplet får alla de privata DNS-zonerna i den angivna resurs gruppen och lagrar dem sedan i $Zones variabel.
...
Det här exemplet får alla de privata DNS-zonerna i det aktuella Azure-abonnemanget och lagrar dem i $Zones variabel.
...
### -Namn
Anger namnet på den privata DNS-zon som ska visas.
Om du inte anger ett värde för parametern *Name* får denna cmdlet alla privata DNS-zoner i den angivna resurs gruppen.
Om du också utelämnar parametern *ResourceGroupName* blir denna cmdlet alla privata DNS-zoner i det aktuella Azure-abonnemanget.
...
### -ResourceGroupName
Anger namnet på den resurs grupp som innehåller den privata DNS-zon som ska visas.
Om du inte anger *ResourceGroupName* måste du också utelämna parametern *Name* .
I det här fallet hämtar denna cmdlet alla privata DNS-zoner i det aktuella Azure-abonnemanget.
