...
## PROBLEMBESKRIVNING
Cmdleten **Enable-AzCdnCustomDomainHttps** aktiverar den SÄKERSTÄLLda https-leveransen av en anpassad CDN-domän.
...
Aktivera säker leverans av den anpassade domänen.
