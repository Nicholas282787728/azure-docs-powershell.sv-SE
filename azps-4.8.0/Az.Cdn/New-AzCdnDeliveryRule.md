...
Skapa en enkel regel.

## MALLPARAMETRAR

### -Åtgärd
En lista med åtgärder som utförs när alla villkor för en regel uppfylls.
...
### -Villkor
En lista med villkor som måste matchas för att åtgärderna ska utföras.
