...
### -Force
Anger att cmdleten inte ber dig bekräfta. Som standard ber denna cmdlet dig att bekräfta att du vill starta cacheminnet.
...
### -ResourceGroupName
Namnet på den resurs grupp som du vill starta cache för.
