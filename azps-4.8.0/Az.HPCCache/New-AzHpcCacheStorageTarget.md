...
## PROBLEMBESKRIVNING
Cmdleten **New-AzHpcCacheStorageTarget** lägger till ett lagrings mål för Azure HPC-cachen.
...
### -ResourceGroupName
"Namnet på den resurs grupp som du vill skapa ett lagrings mål för.
