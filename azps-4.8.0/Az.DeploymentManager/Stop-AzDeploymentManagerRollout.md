...
## PROBLEMBESKRIVNING
Cmdleten **Stop-AzDeploymentManagerRollout** stoppar en pågående installation och returnerar ett objekt som representerar det aktuella tillståndet för installationen.
...
### -InputObject
Installations filen ska tas bort.
