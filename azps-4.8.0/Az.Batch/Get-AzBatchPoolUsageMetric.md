...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzBatchPoolUsageMetric** hämtar användnings måtten som aggregeras per pool under enskilda tidsintervall för det angivna kontot.
...
### -Filter
Anger en OData filter-sats som ska användas för att filtrera de mät värden som returneras av denna cmdlet.
...
### Microsoft.Azure.Commands.BatCH. Modeller. PSPoolUsageMetrics
