...
Det här kommandot får statusen för replikering på MyVol

## MALLPARAMETRAR

### -AccountName
Namnet på ANF-kontot för replikeringens målvolym
...
### -InputObject
ANF för att få replikeringsstatus
...
### -PoolName
Namnet på ANF-poolen för replikeringens målvolym
