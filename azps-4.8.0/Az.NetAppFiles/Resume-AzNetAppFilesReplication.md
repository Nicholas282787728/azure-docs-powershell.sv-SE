...
## PROBLEMBESKRIVNING
Återuppta/synkronisera anslutningen på mål volymen
...
Det här kommandot återupptar ANF på volymen "MyDestinationAnfVolume".
...
### -PassThru
Återvänd till omsynkronisering av den angivna replikeringstjänsten
