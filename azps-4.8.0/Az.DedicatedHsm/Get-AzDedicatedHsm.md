...
## Sammanfattning
Hämtar den angivna Azure-dedikerade HSM.
...
### Exempel 1: Hämta alla dedikerade HSM under ett abonnemang
```powershell
...
Det här kommandot får alla dedikerad HSM under ett abonnemang

### Exempel 2: Hämta alla dedikerade HSM under en resurs grupp.
```powershell
...
Det här kommandot får alla dedikerad HSM under en resurs grupp.

### Exempel 3: skaffa en dedikerad HSM efter namn
```powershell
...
Det här kommandot får en dedikerad HSM efter namn.

### Exempel 4: Hämta en dedikerad HSM efter objekt
```powershell
...
Det här kommandot får en dedikerad HSM efter objekt.
...
### -ResourceGroupName
Namnet på resurs gruppen som den dedikerade HSM tillhör.
