...
## PROBLEMBESKRIVNING
Få en eller flera utkast. Skissa definitioner finns i hanterings gruppen eller prenumerations omfattningen.
...
Få skiss-definitionerna i det aktuella abonnemanget och hierarkin för hanterings grupp för abonnemanget.
...
Få skiss-definitionerna i den angivna hanterings gruppen.
...
Få skiss-definitionerna i det angivna abonnemanget och grupphierarkin i hanterings gruppen.
...
Få skiss-definitionen med det angivna namnet inom det angivna abonnemanget.
...
Få ritnings definitionen med angivet namn och version i den angivna hanterings gruppen.
...
### -LatestPublished
Den senaste publicerade utkasts flaggan.
När funktionen är aktive rad returnerar exekvering den senaste publicerade versionen av ritnings definitionen.
...
### -ManagementGroupId
Hanterings grupp-ID där utkastet sparas.
...
### -SubscriptionId
Abonnemangs-ID där ritnings definitionen sparas.
