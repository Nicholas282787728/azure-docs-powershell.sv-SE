...
### -IncludeSubFolders
När du har angett värdet sant inkluderas artefakt i undermappar.
...
### -PassThru
När den är aktive rad returnerar cmdleten ett objekt som representerar den importerade utkasts definitionen. Denna cmdlet genererar som standard inga utdata.
