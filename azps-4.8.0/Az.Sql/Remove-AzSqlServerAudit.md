...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSqlServerAudit** tar bort gransknings inställningarna för en Azure SQL Server.
Ange parametrarna *ResourceGroupName* och *servername* för att identifiera servern.

## BESKRIVS

### Exempel 1: ta bort gransknings inställningarna för en Azure SQL Server
```
PS C:\>Remove-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
```

### Exempel 2: ta bort, genom pipeline, gransknings inställningarna för en Azure SQL-Server
```
