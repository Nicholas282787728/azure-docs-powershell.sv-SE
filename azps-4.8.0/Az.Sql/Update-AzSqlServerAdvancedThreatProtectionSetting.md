...
## BESKRIVNING
**Cmdleten Update-AzSqlServerAdvancedThreatProtectionSetting** ställer in en avancerad inställning för skydd mot hot på en Azure SQL-server.
För att kunna aktivera avancerat skydd på en server måste granskningsinställningarna vara aktiverade på servern.
...
Det här kommandot anger avancerade inställningar för skydd mot hot för en server med namnet Server01.

### Exempel 2

Anger en avancerad inställning för skydd mot hot på en server. (autogenererat)
...
### -StorageAccountName
Anger namnet på lagringskontot som ska användas. Jokertecken tillåts inte. Den här parametern är inte obligatorisk. När den här parametern inte tillhandahålls använder cmdleten det lagringskonto som definierades tidigare som en del av de avancerade inställningarna för skydd mot hot i databasen. Om det är första gången en inställning för identifiering av hot för databasen har definierats och den här parametern inte tillhandahålls kommer cmdleten att misslyckas.
