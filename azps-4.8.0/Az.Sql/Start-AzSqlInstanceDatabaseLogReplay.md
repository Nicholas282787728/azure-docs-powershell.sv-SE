...
## PROBLEMBESKRIVNING
Cmdleten **Start-AzSqlInstanceDatabaseLogReplay** Start of the logganalys service.
...
Det här kommandot skapar en ny hanterad databas och börjar återställa säkerhets kopior från den angivna behållaren tills last_backup. bak återställs.
...
Det här kommandot skapar en ny hanterad databas och börjar återställa säkerhets kopior från den angivna behållaren tills Complete-AzSqlInstanceDatabaseLogReplay anropas med den senaste säkerhets kopian.

## MALLPARAMETRAR

### -AutoCompleteRestore
Indikatorn som automatiskt Slutför återställning vid slut för ande.
...
### -Sortering
Sortering av instans databasen som ska användas.
...
### -LastBackupName
Namnet på den senaste säkerhets kopian som ska återställas.
...
### -PassThru
Definierar om synkroniseringsresursen ska returneras.
...
SAS-token för lagrings behållare.
