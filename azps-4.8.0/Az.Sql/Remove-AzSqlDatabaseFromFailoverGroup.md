...
## PROBLEMBESKRIVNING
Tar bort en eller flera databaser från den angivna failover-gruppen för Azure SQL Database. Databaserna och replikeringsrelationen är oförändrade, men de kommer inte längre att vara tillgängliga via slut punkter för gruppen failover.
...
Det här kommandot tar bort en databas från en failover-grupp genom att flytta den.
...
Det här kommandot tar bort alla databaser från en failover-grupp.
...
Det här kommandot tar bort alla databaser i en elastisk pool från en failover-grupp.

## MALLPARAMETRAR

### -Databas
En eller flera Azure SQL-databaser på failover-gruppens primär server som ska tas bort från failover-gruppen.
