...
## PROBLEMBESKRIVNING
Remove-AzSqlElasticJobTarget cmdlet tar bort en mål resurs till en mål grupp

## BESKRIVS

### Exempel 1: ta bort ett Server mål
```powershell
...
### Exempel 2: ta bort ett databas mål
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### Exempel 3: ta bort ett elastiskt pool-mål
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### Exempel 4: ta bort ett Shard kart mål
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Tar bort ett mål (Server, elastisk pool, databas och Shard karta) från en mål grupp
...
### -AgentServerName
Namn på Server för SQL-databaser.
