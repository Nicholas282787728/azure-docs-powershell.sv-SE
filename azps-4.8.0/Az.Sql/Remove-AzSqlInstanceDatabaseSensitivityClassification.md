...
## PROBLEMBESKRIVNING
Med Remove-AzSqlInstanceDatabaseSensitivityClassification cmdlet tas informations typerna och känslighets etiketterna för kolumner i Azure SQL-hanterade instans databasen bort.

## BESKRIVS

### Exempel 1: ta bort informations typ och känslighets etikett för en kolumn i en Azure SQL-hanterad instans-databas.
```powershell
...
### Exempel 2: ta bort aktuella informations typer och känslighets etiketter för kolumner i en Azure SQL-hanterad instans-databas med rör.
```powershell
...
### Exempel 3: ta bort informations typ och känslighets etikett för en kolumn i en Azure SQL-hanterad instans-databas med rör.
```powershell
...
Ett objekt som representerar en känslighets klassificering för SQL-hanterad instans.
