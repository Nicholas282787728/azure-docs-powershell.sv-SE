...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlInstance** returnerar information om ett eller flera Azure SQL-hanterade instanser.
Ange namnet på en instans för att visa information för endast den instansen.

## BESKRIVS

### Exempel 1: Hämta alla instanser kopplade till en resurs grupp
```powershell
...
Med det här kommandot får du information om alla instanser tilldelade till resurs gruppen ResourceGroup01.

### Exempel 2: Hämta information om en instans
```powershell
...
Det här kommandot får information om förekomsten som heter managedInstance1.

### Exempel 3: Hämta alla instanser tilldelade till en resurs grupp med hjälp av filtrering
```powershell
...
Med det här kommandot får du information om alla instanser tilldelade till resurs gruppen ResourceGroup01 som börjar med "managedInstance".

### Exempel 4: Hämta alla instanser i en instans
```powershell
...
Det här kommandot får information om alla instanser i instansen "instancePool0".

### Exempel 5: Hämta alla instanser i en instans med hjälp av objektet för en instans
```powershell
...
### Exempel 6: Hämta alla instanser i en instans med hjälp av resurs-ID för en pool
```powershell
...
### Exempel 7: Hämta en hanterad instans med dess resurs-ID
```powershell
