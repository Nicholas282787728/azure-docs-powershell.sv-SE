...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy** hämtar den långsiktiga bevarande principen för den här hanterade databasen.
...
Hämtar den aktuella versionen av principen för långsiktigt bevarande för databasen
