...
### AddAzureRmSqlServerTransparentDataEncryptionCertificateDefaultParameterSet (standard)
```
...
## PROBLEMBESKRIVNING
Add-AzSqlManagedInstanceTransparentDataEncryptionCertificate lägger till ett transparent data krypterings certifikat för den angivna SQL Server-instansen
...
Lägga till TDE-certifikat till en SQL-Server med resurs grupp namn och SQL Server-namn
...
Lägga till TDE-certifikat till servrarna med Server-resourceId
...
Lägga till TDE-certifikat till alla SQL-servrar i en resurs grupp
