...
### Exempel 1: hämtar en eller flera jobb mål körningar från ett jobb arbete
```powershell
...
### Exempel 2: hämtar en eller flera jobb mål körningar från ett jobb körning-filtrering enligt steget namn
```powershell
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
