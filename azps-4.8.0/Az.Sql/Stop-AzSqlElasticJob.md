...
## PROBLEMBESKRIVNING
Stop-AzSqlElasticJob-cmdleten stoppar ett jobb med pågående körning.
Returnerar aktuell status för jobb körningen

## BESKRIVS

### Exempel 1: stoppar ett jobb med körnings jobb
```powershell
...
Stoppar en pågående jobb körning och returnerar den aktuella statusen
...
### -ParentObject
Serverobjektet för agent kontroll
