...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlServerDisasterRecoveryConfigurationActivity** hämtar aktivitet för en konfiguration för en SQL-databasserver för återställning av server system.
...
Anger namnet på konfigurationen för återställning av server system.
