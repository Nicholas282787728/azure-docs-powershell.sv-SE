...
## PROBLEMBESKRIVNING
Det här kommandot visar alla servrar registrerade till en given synkroniseringstjänst för lagring. Den kan även användas för att visa attributen för varje registrerad Server.
...
Med det här kommandot hämtas alla servrar registrerade till en specifik synkroniseringstjänst för lagring.
