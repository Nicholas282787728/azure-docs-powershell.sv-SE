...
## PROBLEMBESKRIVNING
Det här kommandot tar bort den angivna synkroniseringsresursen. En synkroniseringsresurs kan bara tas bort när alla slut punkter tas bort först.
...
Det här kommandot tar bort synkroniseringsresursen.
