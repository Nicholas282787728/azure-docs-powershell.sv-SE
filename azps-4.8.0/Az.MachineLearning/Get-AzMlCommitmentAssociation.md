...
Beroende på vilka parametrar som skickas returnerar cmdleten en specifik åtagande Association eller en samling åtagande organisationer för den angivna åtagande planen.
...
### Exempel 2: få alla åtagande associationer för den angivna åtagande planen
```
