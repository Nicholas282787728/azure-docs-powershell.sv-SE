...
## PROBLEMBESKRIVNING
New-AzAnalysisServicesServer-cmdleten skapar en ny Analysis Services-server
...
Skapar en server med namnet testserver i Azure-regionen West-US och i resurs grupp testresourcegroup. SKU-nivån för servern blir S1.

### Exempel 2

Skapar en ny Analysis Services-server. (automatiskt genererat)
...
### -Administratör
En sträng som representerar en kommaseparerad lista över användare eller grupper som ska anges som administratörer på servern. Användare eller grupper måste ange UPN-format, t. ex. user@contoso.comgroups@contoso.com
...
### -GatewayResourceId
Gateway-resurs-ID som associeras med en analys Server
...
De värden som stöds är 0 ', ' 1 ', ' är 4 ', ' s 8 ', är "8v2", är 9v2 "för standard nivån; "B1", "B2" för bas nivån och "d" för utvecklings nivån.
