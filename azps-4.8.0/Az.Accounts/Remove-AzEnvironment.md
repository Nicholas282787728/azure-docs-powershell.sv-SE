...
## PROBLEMBESKRIVNING
Remove-AzEnvironment cmdlet tar bort slut punkter och metadatainformation för anslutning till en viss Azure-instans.

## BESKRIVS

### Exempel 1: skapa och ta bort en test miljö
```
...
Det här exemplet visar hur du skapar en miljö med Add-AzEnvironment och hur du tar bort miljön med Remove-AzEnvironment.
