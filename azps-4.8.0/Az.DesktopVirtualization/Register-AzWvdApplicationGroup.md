...
### Exempel 1: registrera en Windows Virtual Desktop-gruppgrupp
```powershell
...
Det här kommandot registrerar en Windows Virtual Desktop-programgrupp på en arbets yta.

## MALLPARAMETRAR

### -ApplicationGroupPath
ApplicationGroupPath sökväg
