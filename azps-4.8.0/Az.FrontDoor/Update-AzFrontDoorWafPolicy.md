...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzFrontDoorWafPolicy** uppdaterar en befintlig WAF-princip. Om indataparametrarna inte anges används gamla parametrar från den befintliga WAF-principen.
...
Uppdatera en befintlig anpassad WAF-kod för en policy.
...
Uppdatera en befintlig policy för WAF aktiverat tillstånd och läge.
...
Uppdatera alla WAF-principer i $resourceGroupName
