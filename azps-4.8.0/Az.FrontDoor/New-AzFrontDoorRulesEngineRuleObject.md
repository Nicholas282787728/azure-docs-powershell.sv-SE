...
Använd cmdlet "New-AzFrontDoorRulesEngineActionObject" för att skapa PSRulesEngineAction-objekt som ska överföras till parametern "-Action".
Använd cmdlet "New-AzFrontDoorRulesEngineMatchConditionObject" för att skapa PSRulesEngineMatchCondition-objekt som ska överföras till parametern "-MatchCondition".
...
Skapa nytt PSRulesEngineRule-objekt och visa hur du kan se under fält.
...
Utdata förväntas när ett ogiltigt prioritets värde överförs.

## MALLPARAMETRAR

### -Åtgärd
Åtgärder att utföra i begäran och svar om alla matchnings villkor uppfylls.
...
### -MatchCondition
En lista över matchnings villkor som måste uppfyllas för att åtgärderna i regeln ska fungera. Åtgärderna kommer alltid att köras.
...
Om den här regeln är en matchning bör regel motorn fortsätta köra de återstående reglerna eller stoppa.
Möjliga värden är Fortsätt och stoppa.
Om det inte finns någon kan du fortsätta.
