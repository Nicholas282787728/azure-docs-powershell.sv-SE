...
## PROBLEMBESKRIVNING
Skapar PSHeaderAction-objekt för att skapa PSRulesEngineAction-objekt.
...
### -HeaderActionType
Vilken typ av manipulering som ska gälla för rubriken.
...
### -HeaderName
Namnet på den rubrik som åtgärden ska gälla för.
...
### -Värde
Värdet som du vill uppdatera det angivna huvud namnet med.
