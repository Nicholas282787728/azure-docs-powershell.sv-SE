...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzApiManagementOpenIdConnectProvider** hämtar OpenID Connect-leverantörer i Azure API Management.
ClientSecret tas inte med i resultatet. Använd **Get-AzApiManagementOpenIdConnectProviderClientSecret** för att få klient hemlighet.
...
Det här kommandot får leverantören med ID-OICProvider01.
