...
Cmdleten **set-AzApiManagement** uppdaterar en Azure API Management Service.

## BESKRIVS

### Exempel 1: skaffa en API-hanterings tjänst och utöka den till Premium och lägga till en region
```powershell
...
### Exempel 2: uppdaterings distribution (externt virtuellt nätverk)
```powershell
...
### Exempel 3: skapa och initiera en instans av PsApiManagementCustomHostNameConfiguration med en hemlighet från en nyckel valv resurs
```powershell
...
### Exempel 4: uppdatera e-post i Publisher, NotificationSender e-post och organisations namn
```powershell
...
### -PassThru
Skickar uppdaterade PsApiManagement till pipeline om åtgärden lyckades.
