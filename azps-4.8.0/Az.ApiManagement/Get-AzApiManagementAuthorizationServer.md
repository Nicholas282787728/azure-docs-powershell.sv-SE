...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzApiManagementAuthorizationServer** får alla auktoriseringsregler för Azure API Management eller den angivna auktoriseringsservern.
ClientSecret tas inte med i resultatet. Använd **Get-AzApiManagementAuthorizationServerClientSecret** för att få klient hemlighet.
...
### -ResourceId
Arm-resurs-ID för auktoriseringsservern. Om det här alternativet anges görs ett försök att hitta auktoriseringsservern med identifieraren. Denna parameter är obligatorisk.
