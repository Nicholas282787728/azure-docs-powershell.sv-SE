...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzApiManagementGatewayHostnameConfiguration** tar bort en värd konfiguration från den befintliga gatewayen.

## BESKRIVS

### Exempel 1: ta bort en befintlig gateway hostname-konfiguration
```powershell
...
Med det här kommandot tas en befintlig gateway-konfiguration bort och användaren uppmanas inte att bekräfta.
...
Identifierare för befintlig gateway-värdnamn-konfiguration.
Denna parameter är obligatorisk.
...
### -InputObject
Instans av PsApiManagementGatewayHostnameConfiguration. Denna parameter är obligatorisk.
...
### -ResourceId
GatewayHostnameConfiguration. Denna parameter är obligatorisk.
