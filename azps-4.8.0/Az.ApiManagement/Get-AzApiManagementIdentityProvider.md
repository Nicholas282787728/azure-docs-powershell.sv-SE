...
## PROBLEMBESKRIVNING
Hämta information om identitets leverantörens konfiguration.
ClientSecret tas inte med i resultatet. Använd **Get-AzApiManagementIdentityProviderClientSecret** för att få klient hemlighet.
...
### Exempel 2: Hämta ID för AAD-typ
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### Exempel 3: Hämta ID för AAD-B2C
```powershell
