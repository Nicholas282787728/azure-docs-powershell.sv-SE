...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzApiManagementProduct** hämtar en lista eller en viss produkt.
...
### -ApiId
ApiId av API för att hitta de korrelerade produkterna. Denna parameter är valfri.
