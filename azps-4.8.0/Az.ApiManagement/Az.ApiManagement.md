...
---
# Modulen AZ. ApiManagement
## Problembeskrivning
I det här avsnittet visas hjälp avsnitt om API-cmdlets för Azure-hantering.

## AZ. ApiManagement-cmdletar
...
### [Exportera-AzApiManagementApi](Export-AzApiManagementApi.md)
...
Hämtar klient hemlighet för ett API-Management-gruppserver.
...
Hämtar alla eller specifika API-hanterings-Gateway.

### [Get-AzApiManagementGatewayHostnameConfiguration](Get-AzApiManagementGatewayHostnameConfiguration.md)
Hämtar all eller specifik värd konfiguration för den befintliga gatewayen.

### [Get-AzApiManagementGatewayKey](Get-AzApiManagementGatewayKey.md)
Hämtar nycklar för den befintliga gatewayen
...
Skaffa klient hemlighet för identitets leverantör.
...
Hämtar ett hemligt värde för det specifika namngivna värdet.
...
Hämtar konfigurations nycklarna för åtkomst till en klient organisation.
...
Hämtar inställningar för git-åtkomst för en klient organisation.
...
Skapar en API-version av en API-revision

### [New-AzApiManagementApiRevision](New-AzApiManagementApiRevision.md)
Skapar en ny version av ett befintligt API.
...
Skapar ett API-Management-certifikat som används vid autentisering med Server delen.
...
Skapar en instans av **PsApiManagementHttpMessageDiagnostic** som är en diagnostisk inställning för HTTP-meddelanden
...
Skapar en API-hanterings åtgärd.
...
Skapar en API-hanterings produkt.
...
Skapa ett nytt resurs plats avtal (används i gateways).

### [New-AzApiManagementSamplingSetting](New-AzApiManagementSamplingSetting.md)
Skapa en ny samplings inställning för diagnostiken
...
### [Publicera – AzApiManagementTenantGitConfiguration](Publish-AzApiManagementTenantGitConfiguration.md)
Publicerar ändringar från en git-gren till konfigurations databasen.

### [Remove-AzApiManagement](Remove-AzApiManagement.md)
Tar bort en API-hanterings tjänst.
...
Ta bort den diagnostiska enheten från globalt område eller API-nivå.
...
Tar bort en värd konfiguration från den befintliga gatewayen.

### [Remove-AzApiManagementGroup](Remove-AzApiManagementGroup.md)
Tar bort en befintlig API-hanterings grupp.

### [Remove-AzApiManagementIdentityProvider](Remove-AzApiManagementIdentityProvider.md)
Tar bort en befintlig identitets leverantörs konfiguration.
...
Tar bort ett API-Management-namngivet värde.
...
Tar bort API-hanteringskonsolen från ett angivet scope.
...
Tar bort ett befintligt abonnemang.
...
### [Spara – AzApiManagementTenantGitConfiguration](Save-AzApiManagementTenantGitConfiguration.md)
...
Uppdaterar en API-version i API-hanterings kontexten.
...
Ändrar ett API-Management-certifikat som är konfigurerat för ömsesidig autentisering med Server delen.

### [Set-AzApiManagementDiagnostic](Set-AzApiManagementDiagnostic.md)
Ändrar en API-hanterings diagnos vid global or API-omfattning.

### [Set-AzApiManagementGroup](Set-AzApiManagementGroup.md)
Konfigurerar en API-hanterings grupp.
...
Ändrar ett API-Management-namngivet värde.
...
Anger information om API-åtgärd.
