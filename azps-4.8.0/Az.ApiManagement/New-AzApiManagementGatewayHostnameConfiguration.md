...
## PROBLEMBESKRIVNING
Cmdleten **New-AzApiManagementGatewayHostnameConfiguration** skapar ett värdnamn configuratin för den befintliga gatewayen.

## BESKRIVS

### Exempel 1: skapa en hostname-konfiguration för den befintliga gatewayen
```powershell
...
Det här kommandot skapar en "h01"-konfiguration för en "G01"-Gateway.

## MALLPARAMETRAR

### -CertificateResourceId
En resurs-ID för det befintliga certifikat-ID: t. Denna parameter är obligatorisk.
...
ID för ny Gateway-värdnamn confiuration.
...
Flagga för att tvinga NegotiateClientCertificate.
Denna parameter är valfri.
