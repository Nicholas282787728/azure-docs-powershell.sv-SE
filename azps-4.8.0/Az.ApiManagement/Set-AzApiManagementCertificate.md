...
## PROBLEMBESKRIVNING
Cmdleten **set-AzApiManagementCertificate** ändrar ett certifikat för Azure API Management.
...
Det här kommandot ändrar angivet API-Management-certifikat.

## MALLPARAMETRAR

### -CertificateId
Anger ID för det certifikat som ska ändras.
