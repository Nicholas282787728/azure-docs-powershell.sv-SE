...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzMetricDefinition** hämtar mått definitioner.

## BESKRIVS

### Exempel 1: Hämta mått definitioner för en resurs
```
...
Det här kommandot får Mät definitioner för den angivna resursen.

### Exempel 2: Hämta mått definitioner med detaljerad utskrift
```
...
Det här kommandot hämtar mått definitioner för webbplats2.
Resultatet är detaljerat.

### Exempel 3: Hämta mått definitioner efter namn
```
...
Det här kommandot får definitioner för måtten BytesSent och CpuTime.
Resultatet är detaljerat.
...
### -MetricNamespace
Anger mått namn området för att fråga efter mått definitioner för.
