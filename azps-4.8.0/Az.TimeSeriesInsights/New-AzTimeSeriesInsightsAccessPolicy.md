...
### Exempel 1: skapa en åtkomst princip för en angiven miljö
```powershell
...
Det här kommandot skapar en åtkomst princip för en angiven miljö.
...
### -PrincipalObjectId
Objektets objectId i Azure Active Directory.
