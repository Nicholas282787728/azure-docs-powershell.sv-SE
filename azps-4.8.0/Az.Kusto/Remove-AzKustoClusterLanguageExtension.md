...
### Exempel 1: ta bort en lista över språk tillägg från klustret
```powershell
PS C:\> Remove-AzKustoClusterLanguageExtension -ResourceGroupName testrg -ClusterName testnewkustocluster -Value (@{Name="R"})
```

Med kommandot ovan tar du bort en lista över språk tillägg som kan köras i Keyword-frågor.
...
VÄRDE <ILanguageExtension [] >: listan med språk tillägg.
