...
### Exempel 1: lista alla följda databaser
```powershell
...
Kommandot ovan visar alla databaser som ägs av detta kluster och följs av ett annat kluster.
...
### Microsoft. Azure. PowerShell. cmdletar. Kusto. Models. Api20200614. IFollowerDatabaseDefinition
