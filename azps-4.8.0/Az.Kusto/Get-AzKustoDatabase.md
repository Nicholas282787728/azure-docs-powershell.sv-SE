...
### Exempel 2: Hämta en specifik Kusto-databas med namn
```powershell
...
Kommandot ovan returnerar Kusto-databasen med namnet "mykustodatabase" i klustret "testnewkustocluster" i resurs gruppen "testrg".
