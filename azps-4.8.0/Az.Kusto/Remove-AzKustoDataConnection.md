...
### Exempel 1: ta bort en befintlig data anslutning med namn
```powershell
...
Kommandot ovan tar bort data anslutningen "mykustodataconnection" i databasen "mykustodatabase" för det befintliga klustret "testnewkustocluster" i resurs gruppen "testrg"
