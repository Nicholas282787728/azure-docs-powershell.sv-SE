...
## Sammanfattning
Hämtar arbets ytans vNet-peering.
...
### Exempel 1: lista alla VNet-peering under en databricks
```powershell
...
Det här kommandot listar all VNet-peering under en databricks.

### Exempel 2: skaffa en VNet-peering
```powershell
...
Det här kommandot får en VNet-peering.

### Exempel 3: Hämta ett virtuellt nätverk med objekt
```powershell
...
Det här kommandot får en VNet-peering med objekt.
