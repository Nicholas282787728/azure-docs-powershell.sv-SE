...
## Sammanfattning
Återställa en borttagen fil eller mapp i Azure Data Lake.
...
## PROBLEMBESKRIVNING
Cmdleten **restore-AzDataLakeStoreDeletedItem** återställer en borttagen fil eller mapp i data Lake Store. Kräver att sökvägen till borttaget objekt i pappers korgen returneras av Get-AzDataLakeStoreDeletedItem.
...
### Exempel 1: återställa en fil från alternativet Använd-Force för data Lake Store
```
...
### -Mål
Mål Sök vägen dit den borttagna filen eller mappen ska återställas. 
...
### -PassThru
Returnerar boolesk sant vid framgång.
...
### -Path
Sökvägen till den borttagna filen eller mappen i pappers korgen.
...
### -RestoreAction
Åtgärd att vidta för mål namn konflikter – "Kopiera" eller "överskrivning"
