...
---
# Modulen AZ. ConnectedKubernetes
## Problembeskrivning
Microsoft Azure PowerShell: ConnectedKubernetes-cmdletar

## AZ. ConnectedKubernetes-cmdletar
...
API för att uppdatera vissa egenskaper för den anslutna kluster resursen
