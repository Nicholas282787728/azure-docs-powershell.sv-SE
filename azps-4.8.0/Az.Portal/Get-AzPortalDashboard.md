...
### Exempel 1: lista alla instrument paneler i ett abonnemang
```powershell
...
Visa en lista med alla instrument paneler i ett abonnemang

### Exempel 2: få information om en enda portal instrument panel
```powershell
...
Få information om en enda instrument panel
