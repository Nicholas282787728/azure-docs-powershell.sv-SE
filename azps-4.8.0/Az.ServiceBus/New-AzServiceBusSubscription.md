...
## PROBLEMBESKRIVNING
Cmdleten **New-AzServiceBusSubscription** skapar ett nytt abonnemang för den angivna tjänst Bus artikeln.
...
Värde som anger om ett abonnemang har stöd för obeställbara meddelanden om undantag för filter utvärdering.
...
### -RequiresSession
RequiresSession-det värde som anger om den här kön kräver dubblettidentifiering.
