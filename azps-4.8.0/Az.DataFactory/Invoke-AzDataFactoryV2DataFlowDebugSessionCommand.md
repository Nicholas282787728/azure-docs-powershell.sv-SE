...
## Sammanfattning
Kör fel söknings åtgärd i data flödets debug-session.
...
## PROBLEMBESKRIVNING
Med det här kommandot körs för hands versionen av data för förhands granskning/förhands granskning för olika strömmar med data flöden i felsökningssessionen.
PowerShell-Kommandotolken för arbets flödet för data flödes sökning ska vara:
...
I det här exemplet anropas kommandot för förhands granskning för debug-session "fd76cd0d-8b37-4DC0-A370-3f9d43ac686d" i Data Factory "WiKiADF" och konverterar sedan JSON-utdata till läsbar sträng.
...
### -Kolumner
Kolumn listan för förhands granskning av statistik för data flöde.
...
### -Kommando
Kommandot debug för data flöde. Alternativen är executePreviewQuery, executeStatisticsQuery och executeExpressionQuery
...
### -Uttryck
Uttrycket för förhands granskning av data flödes uttryck.
...
### -RowLimits
Rad gränsen för förhands granskning av data flöde.
...
### -StreamName
Strömmens namn för data flödet för fel sökning.
...
## ANMÄRKNINGAR
Nyckelord: Azure, azurerm, arm, resurs, hantering, chef, data, factoriesKeywords: Azure, azurerm, arm, resurs, hantering, chef, data, fabriker
