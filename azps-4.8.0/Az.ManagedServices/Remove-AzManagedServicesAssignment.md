...
Tar bort registrerings tilldelningen under standard omfattningen.
...
Tar bort registrerings tilldelningen med det fullständigt kvalificerade resurs-ID: t.
...
Tar bort registrerings tilldelningen med hjälp av angivet objekt.
...
### -ID
GUID för registrerings tilldelningen (till exempel b0c052e5-c437-4771-a476-8b1201158a57)
```yaml
Type: System.String
...
### -InputObject
Objektet för registrerings tilldelning.
...
### -ResourceId
Fullständigt resurs-ID för registrerings tilldelningen (till exempel/subscriptions/bb6d49b2-603d-489f-b6ca-ca4dc497c749/providers/Microsoft.ManagedServices/registrationAssignments/b0c052e5-c437-4771-a476-8b1201158a57).
