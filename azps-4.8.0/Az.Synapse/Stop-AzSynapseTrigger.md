...
## PROBLEMBESKRIVNING
Cmdleten **Stop-AzSynapseTrigger** stoppar en trigger på en arbets yta. Om utlösaren är i läget startat stoppar cmdleten utlösaren och är inte längre aktive rad. Om utlösaren redan är i tillståndet ' stoppad har denna cmdlet ingen effekt.
...
Stoppar en utlösare som heter ContosoTrigger i arbets ytans ContosoWorkspace.
...
Stoppar en utlösare som heter ContosoTrigger i arbets ytans ContosoWorkspace genom pipeline.
...
Stoppa en utlösare som heter ContosoTrigger i arbets ytan ContosoWorkspace via pipeline.
