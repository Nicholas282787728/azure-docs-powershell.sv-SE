...
## PROBLEMBESKRIVNING
Cmdleten **New-AzSynapseFirewallRule** skapar en Azure Synapse Analytics-brandväggsregel.
...
Det här kommandot skapar en brand Väggs regel med namnet ContosoFirewallRule under arbets ytan ContosoWorkspace med namnet ContosoFirewallRule.
...
Det här kommandot skapar en brand Väggs regel med namnet ContosoFirewallRule under en arbets yta via pipeline.
...
Det här kommandot skapar en brand Väggs regel som tillåter alla Azure IP-adresser under en arbets yta.

## MALLPARAMETRAR

### -AllowAllAzureIP
Skapar en brand Väggs regel som gör att alla Azure IP-adresser får åtkomst.
...
### -EndIpAddress
Sista IP-adressen för brand Väggs regeln.
Måste vara IPv4-format.
Måste vara större än eller lika med startIpAddress.
...
### -StartIpAddress
Start-IP-adressen för brand Väggs regeln.
Måste vara IPv4-format.
