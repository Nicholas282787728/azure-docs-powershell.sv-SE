...
### WaitSparkJobByIdParameterSet (standard)
```
...
## PROBLEMBESKRIVNING
Cmdleten **wait-AzSynapseSparkJob** väntar på att ett Azure Synapse-analys jobb ska slutföras.
...
Det här kommandot väntar på jobbet med det ID som ska slutföras.
...
### -SparkJobObject
Ingångs objekt för Spark-jobb, vanligt vis passerar genom pipeline.
...
### -TimeoutInSeconds
Den maximala vänte tiden innan felet uppstår. Standardvärdet är att aldrig tids gräns.
...
Avsöknings intervall mellan kontroller för jobb status, i sekunder.
