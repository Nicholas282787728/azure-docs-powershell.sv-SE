...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSynapseFirewallRule** tar bort en Azure Synapse Analytics-brandväggsregel.
...
Det här kommandot tar bort brand Väggs regeln med namnet ContosoFirewallRule under arbets ytan ContosoWorkspace med namnet ContosoFirewallRule.
...
Det här kommandot tar bort brand Väggs regeln med namnet ContosoFirewallRule under en arbets yta via pipeline.
