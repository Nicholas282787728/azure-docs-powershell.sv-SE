...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSynapseWorkspace** tar bort en Azure Synapse Analytics-arbetsyta permanent.
...
Det här kommandot tar bort en Azure Synapse-arbetsyta.
...
Det här kommandot tar bort en Azure Synapse-arbetsyta via pipeline.
...
Det här kommandot tar bort en Azure Synapse-arbetsyta via pipeline med angivet resurs-ID.
