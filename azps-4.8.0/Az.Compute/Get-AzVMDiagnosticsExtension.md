...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzVMDiagnosticsExtension** hämtar inställningarna för Azure Diagnostics-tillägget på en virtuell dator.
...
Hämtar inställningarna för tillägget diagnostik på en virtuell dator. (automatiskt genererat)
