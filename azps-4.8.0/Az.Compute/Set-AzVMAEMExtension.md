...
## PROBLEMBESKRIVNING
Cmdleten **set-AzVMAEMExtension** uppdaterar konfigurationen av en virtuell dator för att aktivera eller uppdatera supporten för övervakning för SAP-system som är installerade på den virtuella datorn.
...
### -InstallNewExtension
Installera den nya virtuella dator tillägget för SAP.
...
Ställer in åtkomst för den virtuella dator identiteten till de enskilda resurserna, till exempel data diskar i stället för hela resurs gruppen.
