...
### Exempel 1: Hämta ett program för en funktion med namn och starta om det.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Restart-AzFunctionApp -Force
```

Det här kommandot får en programfunktion med namn och startar om det.

### Exempel 2: starta om ett funktions program efter namn.
```powershell
PS C:\> Restart-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName -Force
```

Det här kommandot startar om en Function-app efter namn.
...
### -Force
Tvingar cmdleten att starta om programmet utan att behöva bekräfta.
