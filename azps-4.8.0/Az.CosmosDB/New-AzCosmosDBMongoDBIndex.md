...
## Sammanfattning
Skapar ett nytt CosmosDB MongoDB-index.
...
## PROBLEMBESKRIVNING
**New-AzCosmosDBMongoDBIndex** skapar ett nytt CosmosDB MongoDB-index.
...
### -Viktiga
Matris med nyckeltal som strängar.
...
### -TtlInSeconds
Antal sekunder efter vilket indexet går ut.
