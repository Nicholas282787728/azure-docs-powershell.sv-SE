...
Nya nycklar skapas för kontot med konto namn dbname i ResourceGroup rg.

### Exempel 2

Återskapa en given CosmosDB-konto. (automatiskt genererat)
...
### -Sort
Snabb tangenten för att återskapa.
Godkända värden: primär, primaryReadonly, sekundär, secondaryReadonly
