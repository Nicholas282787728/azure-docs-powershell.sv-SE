...
## Sammanfattning
Skapar ett nytt CosmosDB UniqueKeyPolicy-objekt.
...
## PROBLEMBESKRIVNING
**New-AzCosmosDBGremlinUniqueKeyPolicy-** cmdleten skapar ett nytt objekt av typen PSUniqueKeyPolicy.
...
### -UniqueKey
Matris med objekt av typen PSUniqueKey.
