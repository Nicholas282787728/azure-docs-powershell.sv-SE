...
## Sammanfattning
Skapar ett nytt objekt av typen PSIncludedPath. Det kan skickas som ett parameter värde för set-AzCosmosDBSqlContainer.
...
## PROBLEMBESKRIVNING
Objekt som motsvarar SQL API-IncludedPath.
