...
## Sammanfattning
Hämtar CosmosDB genomflöde-egenskaper för MongoDB-samlingen.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzCosmosDBMongoDBCollectionThroughput** hämtar genomflödet-egenskaperna för MongoDB-samlingen.
...
### -InputObject
Om den anges returnerar cmdleten samlingen med motsvarande genomflöde-värde.
