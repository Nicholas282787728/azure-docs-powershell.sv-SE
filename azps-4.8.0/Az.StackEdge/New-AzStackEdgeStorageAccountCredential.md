...
## PROBLEMBESKRIVNING
**New-AzStackEdgeStorageAccountCredential-** cmdleten skapar en ny autentiseringsuppgift för lagrings utrymme för en stack Edge-enhet.
...
### -StorageAccountType
Möjlig lagrings åtkomst typ GeneralPurposeStorage, BlockStorage
