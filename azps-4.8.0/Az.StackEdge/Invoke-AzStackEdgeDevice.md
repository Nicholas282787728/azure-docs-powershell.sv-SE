...
## PROBLEMBESKRIVNING
Cmdleten **Invoke-AzStackEdgeDevice** anropar åtgärder för genomsökning, nedladdning och installation av uppdateringarna på stack Edge-enheten. En automatisk genomsökning körs på enheten dagligen, du kan aktivera genomsökningen genom att köra den här cmdleten.
...
### -FetchUpdate
Laddar ned uppdateringarna på en stapel Edge/gateway-enhet
...
### -InstallUpdate
Installerar uppdateringarna på stack Edge/gateway-enheten
...
### -ScanForUpdate
Söker efter uppdateringar på en stapel Edge/gateway-enhet.
