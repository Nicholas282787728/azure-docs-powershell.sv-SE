...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzRmStorageShare** hämtar eller visar en lista över lagrings fil resurser.

## BESKRIVS

### Exempel 1: Hämta en lagrings fil med lagrings konto namn och resurs namn
```
...
Det här kommandot får en lagrings fil resurs med namn på lagrings konto och resurs namn.

### Exempel 2: lista alla lagrings fil resurser för ett lagrings konto
```
...
Det här kommandot visar alla lagrings fil resurser för ett lagrings konto med lagrings konto namn.
...
### Exempel 4: Hämta en lagrings fil med delnings funktionen i byte
```
...
Det här kommandot får en lagrings fil resurs med namn på lagrings konto och resurs namn och inkluderar delnings användning i byte.

### Exempel 5: lista alla lagrings fil resurser för ett lagrings konto, inklusive borttagna resurser
```
...
Det här kommandot listar alla lagrings fil resurser inkluderar borttagna delar av ett lagrings konto med lagrings konto namn.
...
### -GetShareUsage
Ange den här parametern för att få delnings användning i byte.
...
### -IncludeDeleted
Ta med borttagna resurser, som standard innehåller inte borttagna resurser
