...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzStorageObjectReplicationPolicy** hämtar eller listar objektets replikeringsprincip för ett lagrings konto.

## BESKRIVS

### Exempel 1: Hämta en princip för lösenordsreplikering med specifika princip-ID och visa dess regler.
```
...
Det här kommandot får en lösenordsreplikeringsprincip med ett visst princip-ID och visar dess regler.

### Exempel 2: Visa en lista över objekt replikeringsprinciper från ett lagrings konto
```
...
Det här kommandot listar en lösenordsreplikeringsprincip från ett lagrings konto.
...
### -PolicyId
ID för principobjektet för objekt.
