...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzStorageFileServiceProperty** ändrar tjänst egenskaperna för Azure Storage File-tjänsten.

## BESKRIVS

### Exempel 1: aktivera fil resursen softdelete
```powershell
...
Med det här kommandot kan fil resursen softdelete ta bort med bevarande dagar som 5
...
Aktivera dela borttagnings princip för lagrings kontot genom att ange $true och inaktivera dela ta bort bevarande princip genom att ange $false.
...
### -ShareRetentionDays
Anger antalet bevarande dagar för Share DeleteRetentionPolicy.
Värdet bör bara anges när du aktiverar ta bort lagrings princip för delning.
