...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDataLakeGen2ItemContent** laddar ned en fil i ett fil system i ett Azure Storage-konto.
...
### Exempel 1: Ladda ned en fil utan att fråga
```
...
Det här kommandot laddar ned en fil till en lokal fil utan att fråga.

### Exempel 2: Hämta en fil, och sedan ladda ned filen till en lokal fil
```
...
Kommandot får först en fil och sedan kan du ladda ned filen till en lokal fil.
...
### -Force
Tvinga att skriva över befintlig BLOB eller fil
...
### -InputObject
Azure Datalake Gen2 objekt för nedladdning.
