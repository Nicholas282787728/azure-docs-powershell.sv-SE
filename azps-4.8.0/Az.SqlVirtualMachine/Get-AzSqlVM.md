...
## PROBLEMBESKRIVNING
Med den Get-AzSqlVM cmdleten hämtas en eller flera virtuella SQL-datorer.
...
Det här kommandot får information om alla virtuella Azure SQL-datorer i det aktuella abonnemanget.
...
Med det här kommandot får du information om alla virtuella Azure SQL-datorer i den aktuella prenumerationen som har tilldelats till resurs gruppen ResourceGroup01.
...
Med det här kommandot får du information om den virtuella SQL-datorn som har tilldelats till resurs gruppen ResourceGroup01.
...
### -ResourceId
Resurs-ID för virtuell dator i SQL.
