...
## Sammanfattning
Uppdatera nätverks-ACL för en signal tjänst.
...
## PROBLEMBESKRIVNING
Uppdatera nätverks-ACL för en signal tjänst, inklusive standard åtgärden och nätverks åtkomst kontrol listor för offentliga och privata anslutningar.

## BESKRIVS

### Tillåt RESTAPI, ClientConnection för det offentliga nätverket och ange att standard åtgärd ska nekas
```powershell
...
### Tillåt klient anslutning och server anslutning för en privat slut punkts anslutning
```powershell
...
### Neka klient anslutning för både offentliga och privata anslutningar till slut punkter
```powershell
...
### -DefaultAction
Standard åtgärd hos en Signalare nätverks-ACL: er, antingen tillåta eller neka. Den bestämmer om neka nätverks-ACL eller Tillåt att nätverks åtkomst kontrol listor träder i kraft. Om standard åtgärden är Tillåt är det bara att neka ACL-frågor.
...
### -Neka
Nekade nätverks åtkomst kontrol listor
...
### -PrivateEndpointName
Namn på privata slut punkter som ska uppdateras
...
### -PublicNetwork
Uppdatera åtkomst kontrol listor för offentliga nätverk
...
### Microsoft. Azure. commands. signaler. Models. PSSignalRNetworkAcls
