...
## PROBLEMBESKRIVNING
Set-AzConsumptionBudget cmdlet uppdaterar en budget i antingen en prenumeration eller en resurs grupp.

## BESKRIVS

### Exempel 1: uppdatera en budget med ett nytt belopp med ett budget namn på abonnemangs nivå
```powershell
...
### Exempel 2: uppdatera en budget med ett meddelande när kostnad eller användning når en tröskel på 90 procent av beloppet på prenumerations nivå
```powershell
...
### Exempel 3: uppdatera en budget med ett nytt belopp med ett budget namn på resurs grupp nivå
```powershell
...
### -NotificationEnabled
Meddelandet är aktiverat.
Om inget anges är aviseringen inaktive rad som standard.
