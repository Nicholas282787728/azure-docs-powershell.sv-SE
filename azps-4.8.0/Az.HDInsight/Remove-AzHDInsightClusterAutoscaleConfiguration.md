...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzHDInsightClusterAutoscaleConfiguration** tar bort autoskalan för HDInsight-klustret.

## BESKRIVS

### Exempel 1: ta bort autoskalan för HDInsight-klustret.
```powershell
...
Det här kommandot tar bort autoskalans konfiguration för HDInsight-klustret.
