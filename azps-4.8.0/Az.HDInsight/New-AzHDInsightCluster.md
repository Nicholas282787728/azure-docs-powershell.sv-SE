...
### Exempel 4: skapa ett Azure HDInsight-kluster med funktionen privat länk
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountName = "yourstorageacct001"
...
Hämtar eller anger typen av utgående åtkomst till det offentliga nätverket.
...
Hämtar eller anger den offentliga nätverks åtkomst typen.
