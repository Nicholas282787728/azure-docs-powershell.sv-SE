...
## PROBLEMBESKRIVNING
Verifiera ett certifikat genom att överföra ett verifierings certifikat som innehåller verifierings koden som hämtas av cmdlet Get-AzIotHubCertificateVerificationCode. Det här är det sista steget i det beskrivna processen.
...
Verifierar ägandet av min certifikats privata nycklar. 
