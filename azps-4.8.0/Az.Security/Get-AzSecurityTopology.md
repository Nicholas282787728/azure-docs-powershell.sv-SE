...
## Sammanfattning
Hämtar en lista över säkerhetstopologier för ett abonnemang
...
## PROBLEMBESKRIVNING
Säkerhetstopologier identifieras automatiskt av Azure Security Center, Använd denna cmdlet för att Visa säkerhets topologier.
...
Visa alla säkerhetstopologier i ett abonnemang
