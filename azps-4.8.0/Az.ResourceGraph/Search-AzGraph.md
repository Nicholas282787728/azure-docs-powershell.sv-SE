...
```
En fråga med alla virtuella datorer som inte använder hanterade diskar och som innehåller visnings namn för abonnemang.
...
```
En fråga som visar antalet resurser efter visnings namn för klient och abonnemang.
