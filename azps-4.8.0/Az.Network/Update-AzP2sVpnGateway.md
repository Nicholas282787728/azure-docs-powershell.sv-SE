...
Uppdatera en befintlig P2SVpnGateway under VirtualHub för webbplats anslutningar. (automatiskt genererat)
...
Inaktivera Internet säkerhets flaggan för dessa P2SVpnGateway-anslutningar
