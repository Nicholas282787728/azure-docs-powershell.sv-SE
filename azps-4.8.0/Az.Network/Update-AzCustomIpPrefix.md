...
## PROBLEMBESKRIVNING
Med cmdleten **Update-AzCustomIpPrefix** kan användaren antingen provision eller prosig deras CustomIpPrefix eller redigera taggarna för resursen.

## BESKRIVS

### Exempel 1: provision The CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Commission
```

Kommandot ovan kommer att inleda CustomIpPrefix.

### Exempel 2: avprovision CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Decommission
```

Med kommandot ovan kommer den första processen för CustomIpPrefix att starta.

### Exempel 3: uppdatera taggar för CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Tag $tags
```

Kommandot ovan uppdaterar taggarna för CustomIpPrefix.
