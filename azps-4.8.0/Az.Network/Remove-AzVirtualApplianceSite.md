...
## Sammanfattning
Ta bort en virtuell enhets webbplats från en virtuell enhets resurs för nätverk.
...
## PROBLEMBESKRIVNING
Med kommandot Remove-AzVirtualApplianceSite tas en virtuell enhet bort från en virtuell enhets resurs för nätverk.
...
Ta bort en webbplats resurs för en virtuell enhet. 
...
Resurs-ID för den virtuella nätverks enhet som är kopplad till den här webbplatsen.
...
Objektet för den virtuella apparaten.
