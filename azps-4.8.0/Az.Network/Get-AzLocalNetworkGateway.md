...
### Exempel 1: skaffa en lokal nätverksgateway
```powershell
...
Returnerar objektet för den lokala Nätverksgatewayen med namnet "myLocalGW1" i resurs gruppen "myRG"

### Exempel 2: skaffa lokala nätverks-gateways med hjälp av filtrering
```powershell
...
Returnerar objektet för den lokala Nätverksgatewayen med namn som börjar med "myLocalGW" i resurs gruppen "myRG"
