...
Ovanstående skapar en väg tabell som består av flera vägar och är anslutna till ett nytt virtuellt nav.

Det här är ett objekt i minnet som kan användas för att lägga till en routningstabell i en ny eller befintlig VirtualHub.
