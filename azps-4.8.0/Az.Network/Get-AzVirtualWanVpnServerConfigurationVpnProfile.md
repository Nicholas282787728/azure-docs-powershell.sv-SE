...
### ByVirtualWanNameByVpnServerConfigurationObject (standard)
```
...
## PROBLEMBESKRIVNING
Med cmdleten **Get-AzVirtualWanVpnServerConfigurationVpnProfile** kan du skapa och ladda ned VPN-profilen på VirtualWan-VpnServerConfiguration nivå för klient installation med punkt till webbplats. Det här krävs för att peka på webbplats anslutningen från peka på webbplats klient till Azure P2SVpnGateway.
...
Med kommandot ovan skapas och returneras SAS-URL: en för kund för att ladda ned VPN-profilen på VirtualWan-VpnServerConfiguration nivå för klient installationen för Point-to-Site.
...
VpnServerConfiguration som den här VirtualWan är associerad med.
...
ID för VPN-servern configuraiton detta virtuella WAN-objekt associeras med.
...
### System. String
Microsoft. Azure. commands. Networks. Models. PSVirtualWan Microsoft. Azure. commands. Network. Models. PSVpnServerConfiguration
