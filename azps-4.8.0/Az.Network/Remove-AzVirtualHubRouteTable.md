...
### ByVirtualHubRouteTableName (standard)
```
...
## PROBLEMBESKRIVNING
Tar bort den angivna routningstabellen som är kopplad till det virtuella navet.
...
Det här kommandot tar bort routeTable1 för den virtuella nav westushub.
...
### -InputObject
Virtualhubroutetable-resursen som ska tas bort.
...
### -ResourceId
Resurs-ID för den virtualhubroutetable-resurs som ska tas bort.
