...
## PROBLEMBESKRIVNING
Cmdleten **set-AzExpressRouteConnection** uppdaterar en Express-vägs anslutning som skapas mellan en ExpressRoute-gateway och lokal ExpressRoute-kretsen.
...
Anslutningen uppdateras då till en annan RoutingWeight med hjälp av kommandot Set-AzExpressRouteConnection.
...
### -AuthorizationKey
Den auktoriseringsregel som ska användas för att skapa ExpressRoute Gateway-anslutning.
...
Aktivera Internet säkerhet för denna ExpressRoute Gateway-anslutning
...
### -InputObject
ExpressRouteConnection-objekt som ska uppdateras.
...
### -ResourceId
Resurs-ID för det ExpressRouteConnection-objekt som ska tas bort.
...
### -RoutingWeight
Den vikt som måste kopplas till den här anslutningen för paket dirigering.
