...
## PROBLEMBESKRIVNING
Med cmdleten New-AzNetworkWatcherConnectionMonitorTestGroupObject skapar du en test grupp för anslutnings övervakning.

## BESKRIVS

### Exempel 1: skapa en test grupp med 2 testConfigurations, w Source och 2 mål slut punkter
...
### -Inaktivera
Flagga som anger om test gruppen är inaktive rad.
...
### Microsoft. Azure. commands. Networks. Models. PSNetworkWatcherConnectionMonitorTestGroupObject
