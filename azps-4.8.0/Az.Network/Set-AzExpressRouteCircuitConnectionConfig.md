...
## PROBLEMBESKRIVNING
Cmdleten **set-AzExpressRouteCircuitConnectionConfig** uppdaterar en konfiguration för kretsar som har skapats i privat peering för en ExpressRoute-krets. Det gör att du kan använda två olika ExpressRoute-kretsar mellan regioner och abonnemang.
Observera att innan du kör **set-AzExpressRouteCircuitConnectionConfig** måste du lägga till kabel anslutningen med **Add-AzExpressRouteCircuitConnectionConfig**. När du har kört **set-AzExpressRouteCircuitPeeringConfig** måste du också anropa Set-AzExpressRouteCircuit cmdlet för att aktivera konfigurationen.


## BESKRIVS

### Exempel 1: uppdatera en resurs till en befintlig ExpressRoute-krets
```
...
### Exempel 2: Ange en anslutnings konfiguration för en krets med ledning till en befintlig ExpressRoute-krets
```
$circuit_peer = Get-AzExpressRouteCircuit -Name $peeringCircuitName -ResourceGroupName $rg
...
### -AddressPrefix
Ett minimum/29 kund adress utrymme för att skapa VxLan-tunnlar mellan ExpressRoute-kretsar för IPv4-tunnlar.
eller ett minimum av/125 kund adress utrymme för att skapa VxLan-tunnlar mellan ExpressRoute-kretsar för IPv6-tunnlar.
...
```
### -AddressPrefixType
Anger den adress familj som adressprefix ska tillhöra.
