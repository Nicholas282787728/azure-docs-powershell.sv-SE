...
## Sammanfattning
Stoppar paket registrerings åtgärd på en VPN-anslutning
...
## PROBLEMBESKRIVNING
Stoppar paket registrerings åtgärden på en VPN-anslutning och laddar upp resultatet på en given SasUrl.
...
### -Namn
Namnet på den VPN-anslutning där Packet Capture ska startas.
...
### -SasUrl
SAS-URL för stopp paket registrering på VPN.
...
### Microsoft. Azure. commands. Networks. Models. PSVpnPacketCaptureResult
