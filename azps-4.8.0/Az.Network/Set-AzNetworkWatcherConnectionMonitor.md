...
## PROBLEMBESKRIVNING
Set-AzNetworkWatcherConnectionMonitor cmdlet uppdaterar anslutnings övervaknings resursen.

## BESKRIVS

### Exempel 1: uppdatera en anslutnings bildskärm
```
...
I det här exemplet uppdaterar vi den befintliga anslutnings övervakningen genom att ändra destinationAddress och lägga till taggar.
