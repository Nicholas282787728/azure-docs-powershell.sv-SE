...
## Sammanfattning
Skapar en tabell resurs för en hubb som är associerad med en VirtualHub.
...
## PROBLEMBESKRIVNING
Skapar den angivna routningstabellen som är kopplad till det virtuella navet med de angivna vägarna och etiketterna.
...
Det här kommandot skapar en nav väg tabell för det virtuella navet.
...
### -ParentResourceId
Resurs-ID för den virtuella nav resursen.
