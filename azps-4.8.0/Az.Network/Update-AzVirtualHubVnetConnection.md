...
Ovanstående skapar en resurs grupp, virtuellt WAN, virtuellt nätverk, virtuellt nav i den här resurs gruppen i Azure. En virtuell nätverks anslutning skapas också som är peer det virtuella nätverket till det virtuella navet. Den här virtuella nätverks anslutningen uppdateras sedan för att aktivera Internet säkerhet.
