...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzVirtualWanVpnServerConfiguration** returnerar listan med alla VpnServerConfigurations som är kopplade till den här VirtualWan. d.v.s. alla VpnServerConfigurations som är kopplade till valfri P2SVpnGateways under VirutalHubs i denna VirtualWan.
...
### Microsoft. Azure. commands. Networks. Models. PSVpnServerConfigurationsResponse
