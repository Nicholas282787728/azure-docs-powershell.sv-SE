...
## PROBLEMBESKRIVNING
Cmdleten **New-AzLoadBalancerInboundNatPoolConfig** skapar en inkommande konfiguration för NAT-pool för en belastnings utjämning.
...
### -EnableFloatingIP
Konfigurerar en virtuell dators slut punkt för den flytande IP-kapaciteten som krävs för att konfigurera en SQL AlwaysOn-tillgänglighetsgruppen. Den här inställningen krävs vid användning av SQL AlwaysOn-tillgänglighetsgruppen i SQL Server. Den här inställningen kan inte ändras när du har skapat slut punkten.
...
Timeout för TCP-inaktiv anslutning. Värdet kan anges mellan 4 och 30 minuter. Standardvärdet är 4 minuter. Det här elementet används bara när protokollet är inställt på TCP.
