...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzNetworkInterfaceTapConfig** skapar en TapConfiguration-resurs som är kopplad till en NetworkInterface. Detta hänvisar till en befintlig VirtualNetworkTap-resurs.
