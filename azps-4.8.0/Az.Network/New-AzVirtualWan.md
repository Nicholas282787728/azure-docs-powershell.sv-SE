...
## PROBLEMBESKRIVNING
Skapar en ny Azure VirtualWAN-resurs.
...
Ovanstående skapar en resurs grupp "testRG" i regionen "West" och ett Azure Virtual WAN med gren till filial trafik som tillåts i den resurs gruppen i Azure.
...
### -Plats
Platsen för VirtualWAN-resursen.
