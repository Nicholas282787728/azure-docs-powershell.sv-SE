...
## PROBLEMBESKRIVNING
Cmdleten **set-AzExpressRouteCrossConnection** sparar den ändrade ExpressRoute-kors anslutningen till Azure.

## BESKRIVS

### Exempel 1: ändra etablerings tillståndet för tjänste leverantören för en ExpressRoute-kors anslutning
```
...
Anger det **ExpressRouteCrossConnection** -objekt som denna cmdlet ändrar.
...
### -Peers
Listan över peers för kors anslutningen
...
Tjänst leverantörens etablerings tillstånd ska ställas in
