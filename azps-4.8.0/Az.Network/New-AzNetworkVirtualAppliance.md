...
## Sammanfattning
Skapa en resurs för virtuella nätverk enheter.
...
## PROBLEMBESKRIVNING
Med kommandot New-AzNetworkVirtualAppliance skapas en resurs för virtuella nätverk enheter i Azure.
...
Skapar en ny virtuell nätverks utrustnings resurs i resurs gruppen: testrg.
...
Start konfigurationens BLOB-URL.
...
Cloudinit konfiguration som oformaterad text.
...
Cloudinit-URL för BLOB för konfiguration.
...
### -VirtualHubId
Resurs-ID för det virtuella navet.
