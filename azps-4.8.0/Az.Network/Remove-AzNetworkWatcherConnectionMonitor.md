...
## PROBLEMBESKRIVNING
Cmdleten Remove-AzNetworkWatcherConnectionMonitor tar bort den angivna anslutnings övervakaren.

## BESKRIVS

### Exempel 1: ta bort den angivna anslutnings övervakaren
```powershell
PS C:\> Remove-AzNetworkWatcherConnectionMonitor -Location centraluseuap -Name cm
```

I det här exemplet tar vi bort anslutnings övervakaren som anges av plats och namn.

### Exempel 2

Ta bort anslutnings övervakning. (automatiskt genererat)
