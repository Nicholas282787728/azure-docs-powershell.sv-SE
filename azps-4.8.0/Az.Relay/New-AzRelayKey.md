...
## PROBLEMBESKRIVNING
Cmdleten **New-AzRelayKey** skapar de primära och sekundära anslutnings strängarna för angivna relä enheter (namnrymd/WcfRelay/HybridConnection).
...
Återskapar primära eller sekundära anslutnings strängar för angiven Relay-Namespace-enhet.

### Exempel på 1,1-namn områdes-nyckelvärdet
```
...
skapar de primära eller sekundära anslutnings strängarna för den angivna Relay-Namespace-enheten med nyckelvärdet
...
Återskapar primära eller sekundära anslutnings strängar för angiven Relay-WcfRelay-enhet.

### Exempel på 2,1-WcfRelay angivet värde
```
...
skapar de primära eller sekundära anslutnings strängarna för den angivna Relay-WcfRelay-enheten med nyckelvärdet
...
### Exempel på 3,1-HybridConnection angivet värde
```
...
skapar de primära eller sekundära anslutnings strängarna för den angivna Relay-HybridConnection-enheten med nyckelvärdet
