...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzRelayAuthorizationRule** tar bort auktoriseringsregeln för angivna relä enheter (namnrymd/WcfRelay/HybridConnection).
...
Tar bort auktoriseringsregeln `AuthoRule1` för namn området `TestNameSpace-Relay1` .
...
Tar bort auktoriseringsregeln `AuthoRule1` för WcfRelay `TestWcfRelay` från namn området `TestNameSpace-Relay1` .
...
Tar bort auktoriseringsregeln `AuthoRule1` för HybridConnection `TestHybridConnection` från namn området `TestNameSpace-Relay1` .
