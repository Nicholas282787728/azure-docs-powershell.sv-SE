...
## PROBLEMBESKRIVNING
Den Set-AzEventHubConsumerGroup cmdleten uppdaterar den angivna konsument gruppen Event Hubs.
...
Anger användarnas metadata för konsument gruppen \` MyConsumerGroupName \` till "testar".
...
### -UserMetadata
Användarens metadata för ConsumerGroup
