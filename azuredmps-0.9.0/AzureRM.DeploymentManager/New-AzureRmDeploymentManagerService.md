...
## PROBLEMBESKRIVNING
Cmdleten **New-AzureRmDeploymentManagerService** skapar en tjänst under en tjänstmall och returnerar ett objekt som representerar den tjänsten.
Ange tjänsten med dess namn, topologi den är i och resurs gruppens namn. 

Cmdleten returnerar ett tjänst objekt. Du kan ändra det här objektet lokalt och sedan tillämpa ändringarna på tjänsten genom att använda Set-AzureRmDeploymentManagerService cmdlet.
