...
## PROBLEMBESKRIVNING
Returnerar en lista över tjänstens status. Egenskapen AlertSummary innehåller information om antalet varningar och fel.
...
Returnerar tjänstens status.

## MALLPARAMETRAR

### -Namn
Tjänstens hälso namn.
...
### -ResourceGroupName
Namnet på resurs gruppen, valfritt.
