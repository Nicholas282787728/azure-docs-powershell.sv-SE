...
Använd en allmänt tillgänglig länk för att ange platsen för tillägget, eller URI till en Azure Blob med SasUri.
...
### -Anknytning
Parametrar som används för att skapa en ny tilläggs bild för virtuell dator.
Om du vill skapa läser du avsnittet anteckningar för tilläggs egenskaper och skapar en hash-tabell.
...
### -IsSystemExtension
Anger om fil namns tillägget är för systemet.
...
### -ProvisioningState
Etablerings status för tillägget.
...
### -SourceBlob
URI till Azure eller AzureStack blob.
...
True om det har stöd för flera tillägg.
...
### -VmOsType
Typ av operativ system för virtuell dator som behövs för att distribuera tilläggs hanteraren.
...
### -VMScaleSetEnabled
Värde som anger om tillägget är aktiverat för stöd för virtuell dators skala.
...
### Microsoft. Azure. PowerShell. cmdletar. ComputeAdmin. Models. Api20151201Preview. IVMExtensionParameters
...
TILLÄGG <IVMExtensionParameters> : parametrar som används för att skapa en ny virtuell dator tilläggs bild.
  - `[ComputeRole <String>]`: Compute Role
  - `[IsSystemExtension <Boolean?>]`: Anger om fil namns tillägget är för systemet.
  - `[ProvisioningState <ProvisioningState?>]`: Etablerings tillståndet för tillägget.
  - `[Publisher <String>]`: Utgivaren av VM-tillägget
  - `[SourceBlobUri <String>]`: URI till Azure eller AzureStack blob.
  - `[SupportMultipleExtension <Boolean?>]`: Sant om stöder flera tillägg.
  - `[VMScaleSetEnabled <Boolean?>]`: Värde som anger om tillägget är aktiverat för stöd för virtuell dators skala.
  - `[VmosType <OSType?>]`: Operativ system typ för mål virtuell dator som behövs för att distribuera tilläggs hanteraren.
