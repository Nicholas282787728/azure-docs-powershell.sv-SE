...
## PROBLEMBESKRIVNING
Skapar ett peering service-prefix som är associerat med ett peering service-objekt.
...
Skapar ett prefix från ett peering service-objekt
...
Skapar ett prefix från ett resurs-ID för peering service.
...
Skapar ett prefix från en resurs grupp för peering service och namn
...
### -PeeringServiceName
Namn på peering-tjänsten.
Använd New-AzPeeringService cmdlet för en ny peering-tjänst eller Get-AzPeeringService för en lista.
...
Använda en Get-AzPeeringService
...
### -ServiceKey
Det här är ett unikt GUID från din tjänste leverantör
...
### Microsoft. Azure. PowerShell. cmdletar. peering. Models. PSPeeringService
