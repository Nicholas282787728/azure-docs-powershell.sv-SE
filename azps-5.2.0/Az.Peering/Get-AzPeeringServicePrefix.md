...
## PROBLEMBESKRIVNING
List prefix för peering service för peering service-objekt
...
Hämtar prefixen för en peering-tjänst baserad på rör-kommandon.
...
Hämtar ett specifikt prefix för en peering service efter resurs-ID.
...
Hämtar ett specifikt prefix för en peering-tjänst med utökade attribut
...
### -Expandera
Visa händelserna för ett peering service-prefix
...
### -PeeringServiceName
Namn på peering-tjänsten. Använd New-AzPeeringService cmdlet för en ny peering-tjänst eller Get-AzPeeringService för en lista.
