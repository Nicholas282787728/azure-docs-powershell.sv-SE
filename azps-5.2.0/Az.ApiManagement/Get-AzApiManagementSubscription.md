...
Nycklarna tas inte med i resultatet. Använd **Get-AzApiManagementSubscriptionKey** för att få nycklar.
...
### Exempel 5: Hämta alla abonnemang för ett scope
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-East-US" -ServiceName "contoso"
...
Det här kommandot får alla prenumerationer som har kon figurer ATS för globalt API-scope

### Exempel 6: Hämta alla abonnemang för en produkt och en användare
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-East-US" -ServiceName "contoso"
...
### -Omfattning
Omfattnings identifierare. Omfattningen av prenumerationen, vare sig det är API-omfattning/apis/{apiId} eller produkt omfattning/products/{productId} eller globalt API-scope/Apis eller globalt scope/.
