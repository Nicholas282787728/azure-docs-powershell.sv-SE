...
## PROBLEMBESKRIVNING
Cmdleten **set-AzApiManagementOpenIdConnectProvider** ändrar en OpenID Connect-leverantör i Azure API-hanteringen.

## BESKRIVS

### Exempel 1: ändra klient hemligheten för en leverantör
```powershell
...
Det här kommandot ändrar den provider som har ID-OICProvider01.
Kommandot anger en klient hemlighet för leverantören.

### Exempel 2

Ändrar en OpenID Connect-leverantör. (automatiskt genererat)
...
### -ClientId
Anger klient-ID för Developer Console.
...
### -ClientSecret
Anger utvecklarens klient hemlighet.
...
### -MetadataEndpointUri
Anger en URI för metadata-slutpunkt för providern.
...
### -Namn
Anger ett eget namn för leverantören.
...
Anger ett ID för den provider som denna cmdlet ändrar.
...
### -PassThru
Anger att denna cmdlet returnerar **PsApiManagementOpenIdConnectProvider** som denna cmdlet ändrar.
