...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzApiManagementApiSchema** hämtar information om API-schemat

## BESKRIVS

### Exempel 1: få information om allt API-schema för ett API
```powershell
...
Det här kommandot får alla API-scheman som är kopplade till ett API `swagger-petstore-extensive` för en viss ApiManagement kontext.

### Exempel 2: Hämta det specifika schema som är kopplat till ett API
```powershell
PS D:\github\azure-powershell> $context = New-AzApiManagementContext -ResourceId /subscriptions/subid/resourceGroups/resourceGroupName/providers/Microsoft.ApiManagement/service/sdktestapim4163
...
Det här kommandot får det API-schema `5cc9cf67e6ed3b1154e638bd` som är kopplat till ett API `swagger-petstore-extensive` för en viss ApiManagement-kontext.
...
### -ResourceId
Arm-resurs-ID för ett API-schema. Om det här alternativet anges kommer API-schema att hittas med identifieraren. Denna parameter är obligatorisk.
