...
## PROBLEMBESKRIVNING
Cmdleten **New-AzDeploymentManagerStep** skapar ett distributions steg som kan hänvisas till i installations processen.
Ange *namn*, *ResourceGroupName* och obligatoriska egenskaper.

Du kan ändra det objekt som returneras lokalt och sedan tillämpa ändringarna på steget genom att använda Set-AzDeploymentManagerStep cmdlet.
...
Sökvägen till filen där egenskaper för hälso kontroll har definierats.
