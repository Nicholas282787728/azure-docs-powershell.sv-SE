...
## PROBLEMBESKRIVNING
Cmdleten **set-AzHpcCacheStorageTarget** uppdaterar ett lagrings mål som är kopplat till Azure HPC-cachen.
...
### -Force
Anger att cmdleten inte ber dig bekräfta. Denna cmdlet uppmanar dig som standard att bekräfta att du vill tömma cacheminnet.
...
### -NFS
Uppdatera typen av NFS-lagring.
...
### -ResourceGroupName
Namnet på den resurs grupp under vilket du vill uppdatera lagrings målet.
