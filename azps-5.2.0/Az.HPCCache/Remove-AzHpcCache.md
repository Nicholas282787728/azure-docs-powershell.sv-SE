...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzHpcCache** tar bort en Azure HPC-cache.
...
### -Force
Anger att cmdleten inte ber dig bekräfta. Denna cmdlet uppmanar dig som standard att bekräfta att du vill ta bort cacheminnet.
...
### -ResourceGroupName
Namnet på den resurs grupp under vilket du vill ta bort cacheminnet.
