...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzStreamAnalyticsJob** asynkron tar bort ett specifikt ström analys jobb i Azure.

## BESKRIVS

### EXEMPEL 1: ta bort ett jobb
```
PS C:\>Remove-AzStreamAnalyticsJob -ResourceGroupName "StreamAnalytics-Default-West-US" -Name "StreamingJob"
```

Det här kommandot tar bort jobbets StreamingJob.
...
### -Namn
Anger namnet på Azure Stream Analytics-jobbet som ska tas bort.
