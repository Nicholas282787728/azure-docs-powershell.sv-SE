...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzIntegrationAccountMap** tar en integrerings konto mappning från en resurs grupp.
Ange integrerings konto namn, resurs grupps namn och kart namn.
...
### Exempel 1: Hämta en integrerings konto karta
```
...
Det här kommandot får en integrerings konto översikt med namnet IntegrationAccountMap47 i den angivna resurs gruppen.

### Exempel 2: Hämta integrerings konto mappningar utifrån integrerings konto namn
```
...
Det här kommandot får integrerings konto översikter med namn på integrations konto.
...
### -MapName
Anger namnet på en integrerings konto karta.
...
### -MapType
Typ av integrerings konto karta.
