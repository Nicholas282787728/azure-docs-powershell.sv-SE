...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzIntegrationAccountAssembly** hämtar en sammansättning från ett integrations konto.

## BESKRIVS

### Exempel 1: Hämta en montering efter parametrar
```powershell
...
Skaffa en sammansättning med namnet "sampleAssembly" som finns i integrations kontot, "sampleIntegrationAccount", som finns i resurs gruppen "sampleResourceGroup".

### Exempel 2: lista alla sammansättningar i ett integrations konto utifrån parametrar
```powershell
...
Hämta alla sammansättningar i integrations kontot "sampleIntegrationAccount" som finns i resurs gruppen "sampleResourceGroup".
