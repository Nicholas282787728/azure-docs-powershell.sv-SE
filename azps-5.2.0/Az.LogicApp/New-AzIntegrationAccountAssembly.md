...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzIntegrationAccountAssembly** skapar en ny sammansättning i ett integrations konto.

## BESKRIVS

### Exempel 1: skapa ny sammansättning med lokal fil
```powershell
...
Skapar en ny sammansättning med den lokala filen som finns på fil Sök vägen i $localAssemblyFilePath.

### Exempel 2: skapa ny sammansättning med byte data
```powershell
...
Skapar en ny sammansättning med en byte mat ris med "$assemblyContent".

### Exempel 3: skapa ny sammansättning med hjälp av en innehålls länk
```powershell
...
Skapar en ny sammansättning med en byte-data som finns på URL-adressen "$assemblyUrl". Det här är den rekommenderade metoden för att skapa paket med stor storlek.
