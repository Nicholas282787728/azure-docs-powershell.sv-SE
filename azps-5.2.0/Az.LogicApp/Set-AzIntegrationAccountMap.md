...
## PROBLEMBESKRIVNING
Cmdleten **set-AzIntegrationAccountMap** ändrar en integrations konto karta.
...
### Exempel 1: ändra översikt över en integrerings konto
```powershell
...
Det här kommandot ändrar mappnings konto översikten i den angivna resurs gruppen.
Kommandot anger en kart definition som lagras i $MapContent-variabeln med ett föregående kommando.

### Exempel 2

Ändrar en integrations konto karta. (automatiskt genererat)
...
### -MapFilePath
Anger sökvägen till en definition för integrerings konto översikten.
