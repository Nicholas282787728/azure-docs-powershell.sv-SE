...
### Exempel 1: uppdatera en gen1-miljö med Time Series
```powershell
...
Det här kommandot uppdaterar en gen1 tids serie miljö.

### Exempel 2: uppdatera en gen1-miljö med Time Series
```powershell
...
### -Tagg
Nyckeltal för fler egenskaper för miljön.
