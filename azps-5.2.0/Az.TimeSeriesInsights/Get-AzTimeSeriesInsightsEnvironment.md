...
### Exempel 1: skaffa en miljö för tids serier
```powershell
...
Det här kommandot får en miljö för Time Series Insights.

### Exempel 2: lista alla miljöer med tids serier
```powershell
...
Det här kommandot visar alla miljöer med olika tids serier i en resurs grupp.

### Exempel 3: skaffa en miljö med insikter för tids serier
```powershell
...
Det här kommandot får en serie miljöer med Time Series.
...
### -Expandera
Om du anger $expand = status tas statusen för de interna tjänsterna för miljön i tjänsten Time Series Insights.
