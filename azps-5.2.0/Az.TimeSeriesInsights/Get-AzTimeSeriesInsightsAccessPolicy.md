...
### Exempel 1: lista alla åtkomst principer under en angiven miljö
```powershell
...
Det här kommandot visar alla åtkomst principer under en angiven miljö.

### Exempel 2: Hämta en angiven åtkomst princip med namn
```powershell
...
Det här kommandot får en angiven åtkomst policy.

### Exempel 3: Hämta en angiven åtkomst princip efter objekt
```powershell
