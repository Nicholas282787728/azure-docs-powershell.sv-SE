...
### Exempel 1: ta bort en angiven åtkomst princip utifrån namn
```powershell
PS C:\> Remove-AzTimeSeriesInsightsAccessPolicy -EnvironmentName tsitest001 -Name policy001 -ResourceGroupName testgroup

```

Det här kommandot tar bort en angiven åtkomst princip.

### Exempel 2: ta bort en specifik åtkomst princip efter objekt
```powershell
