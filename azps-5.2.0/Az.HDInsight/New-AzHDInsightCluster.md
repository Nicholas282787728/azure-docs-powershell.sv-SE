...
### Exempel 2: skapa kluster med hanterad kryptering av nycklar
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Exempel 3: skapa ett Azure HDInsight-kluster som möjliggör kryptering i transit
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Exempel 4: skapa ett Azure HDInsight-kluster med funktionen för utgående och ta bort relä
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Exempel 6: skapa ett Azure HDInsight-kluster som aktiverar Autoskala.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Exempel 9: skapa ett Azure HDInsight-kluster med ett företags säkerhets paket (ESP) och aktivera stöd för HDInsight-ID.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
Hämtar eller anger den autoskalningsinställning
...
### -EnableIDBroker
Aktiverar funktionen för HDInsight Identity Broker.
...
### -EncryptionAtHost
Hämtar eller anger flaggan som anger om Aktivera kryptering på värden eller inte.
...
### -EncryptionInTransit
Hämtar eller anger flaggan som anger om Aktivera kryptering i transit eller inte.
...
### -KafkaClientGroupId
Hämtar eller anger klient grupp-ID: t för Kafka rest-gruppåtkomst.
...
Hämtar eller anger klient grupp namnet för Kafka rest-gruppåtkomst.
...
Hämtar eller anger storleken på Kafka.
...
### -PrivateLink
Hämtar eller anger den privata länk typen.
...
Hämtar eller anger anslutnings typen för resurs leverantör.
...
### -StorageAccountKey
Hämtar eller anger lagrings konto åtkomst för lagrings konto.
...
Hämtar eller anger den hanterade identiteten för lagrings konto.
...
Hämtar eller anger lagrings resurs-ID för lagrings kontot.
...
### -StorageAccountType
Hämtar eller anger typen av lagrings konto.
...
### -StorageContainer
Hämtar eller anger StorageContainer namn för standard kontot för Azure-lagring
...
### -StorageFileSystem
Hämtar eller anger fil systemet för standard-Gen2 för Azure Data Lake Storage.
...
### -StorageRootPath
Hämtar eller anger sökvägen till klustrets rot i standard kontot för data Lake Store.
...
### -SubnetName
Hämtar eller anger under nätets namn för det här HDInsight-klustret.
