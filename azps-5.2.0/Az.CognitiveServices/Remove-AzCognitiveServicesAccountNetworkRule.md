...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzCognitiveServicesAccountNetworkRule** tar bort IpRules eller VirtualNetworkRules från egenskapen NetWorkRule för ett konto för kognitiva tjänster
...
### -IpAddressOrRange
Kognitiva tjänst konton NetworkRule IpRules IpAddressOrRange i strängen.
...
Kognitiva tjänst konton NetworkRule VirtualNetworkRules VirtualNetworkResourceId i strängen.
