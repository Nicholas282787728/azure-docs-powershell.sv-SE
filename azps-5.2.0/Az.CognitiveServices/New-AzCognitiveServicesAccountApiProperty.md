...
## Sammanfattning
Skapa en ny instans av ett konto för kognitiva ApiProperties
...
ApiProperties är obligatoriskt för vissa konto typer.
...
Ovan skapas ett QnAMaker-konto med API-egenskapen "QnaRuntimeEndpoint".
