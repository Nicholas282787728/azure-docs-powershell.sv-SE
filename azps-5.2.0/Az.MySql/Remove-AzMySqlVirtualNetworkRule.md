...
### Exempel 1: ta bort den virtuella nätverks regeln för MySql server med namn
```powershell
PS C:\> Remove-AzMySqlVirtualNetworkRule -Name vnet -ResourceGroupName PowershellMySqlTest-ServerName mysql-test

```

Denna cmdlet tar bort MySql Server-regeln per namn.

### Exempel 2: ta bort regeln för det virtuella nätverket för MySql-servern efter identitet
```powershell
...
De här cmdletarna tar bort regeln för det virtuella nätverket för MySql-servern efter identitet.
