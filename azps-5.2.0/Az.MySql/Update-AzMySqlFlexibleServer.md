...
### Exempel 1: uppdatera MySql-servern efter resurs grupp och Server namn
```powershell
...
Denna cmdlet uppdaterar MySql-servern efter resurs grupp och Server namn.

### Exempel 2: uppdatera MySql-servern efter identitet.
```powershell
...
Denna cmdlet uppdaterar MySql-servern efter identitet.
