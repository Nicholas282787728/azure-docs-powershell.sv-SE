...
### Exempel 1: ta bort MySql-databasen efter namn
```powershell
PS C:\> Remove-AzMySqlFlexibleServerDatabase -Name databasetest -ResourceGroupName PowershellMySqlTest -ServerName mysql-test
```

Denna cmdlet tar bort MySql-databasen efter namn.

### Exempel 2: ta bort MySql-databasen efter identitet
```powershell
...
De här cmdletarna tar bort MySql-databasen efter identitet.
