...
### Exempel 1: starta om MySql-servern efter resurs grupp och Server namn
```powershell
PS C:\> Restart-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Denna cmdlet startar om MySql-servern efter resurs grupp och Server namn.

### Exempel 2: starta om MySql-servern efter identitet
```powershell
...
Dessa cmdletar startar om MySql-servern efter identitet.
