...
## PROBLEMBESKRIVNING
Cmdleten **set-AzSynapseNotebook** skapar eller uppdaterar en antecknings bok på en arbets yta.
...
Det här kommandot skapar eller uppdaterar en antecknings bok från anteckningsbok för antecknings boken. ipynb i arbets ytan med namnet ContosoWorkspace.
...
Det här kommandot skapar eller uppdaterar en antecknings bok från fil antecknings boken för antecknings böcker. ipynb i arbets ytan ContosoWorkspace via pipeline.
...
Det här kommandot skapar eller uppdaterar en antecknings bok från antecknings bok för bifogad fil
