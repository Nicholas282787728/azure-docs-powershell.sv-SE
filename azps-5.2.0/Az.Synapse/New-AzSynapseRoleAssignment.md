...
## PROBLEMBESKRIVNING
Cmdleten **New-AzSynapseRoleAssignment** skapar en Azure Synapse-roll tilldelning.
...
Det här kommandot tilldelar ContosoRole till den användare vars huvud namn är ContosoName.
...
Det här kommandot tilldelar ContosoRole till den användare vars huvud namn är ContosoName genom pipeline.
