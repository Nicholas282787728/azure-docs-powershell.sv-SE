...
## Sammanfattning
Hämtar de distinkta återställnings punkter från vilka en Synapse Analytics SQL-pool kan återställas.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSynapseSqlPoolRestorePoint** hämtar de distinkta återställnings punkter som en Azure SYNAPSE Analytics SQL-pool kan återställas från.
...
Det här kommandot returnerar alla tillgängliga återställnings punkter för Azure Synapse Analytics SQL-poolen med namnet ContosoSqlPool.
