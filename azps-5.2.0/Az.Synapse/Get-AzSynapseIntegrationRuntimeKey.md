...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSynapseIntegrationRuntimeKey** hämtar nycklar för en integrations körning. Nycklarna används för att registrera en nod för integration Runtime.
