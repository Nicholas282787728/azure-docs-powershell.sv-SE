...
## PROBLEMBESKRIVNING
Cmdleten **Stop-AzSynapseSparkStatement** avbryter ett Synapse Analytics Spark-uttryck.
...
Det här kommandot avbryter Spark-instruktionen med angivet livy-ID.
...
Det här kommandot avbryter Spark-satsen med angivet livy-ID via pipeline.
