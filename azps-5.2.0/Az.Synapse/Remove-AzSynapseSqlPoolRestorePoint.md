...
## Sammanfattning
Tar bort en återställnings punkt för Synapse Analytics SQL-pool.
...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSynapseSqlPoolRestorePoint** tar bort en återställnings punkt för Azure SYNAPSE Analytics SQL-poolen.
...
Det här kommandot tar bort en återställnings punkt för Azure Synapse Analytics SQL-poolen.
...
Det här kommandot tar bort en återställnings punkt för Azure Synapse Analytics SQL-pool via pipeline.
...
Det här kommandot tar bort en återställnings punkt för Azure Synapse Analytics SQL-pool med angivet resurs-ID.
...
### -InputObject
Tids objekt för återställning av återställnings punkter för SQL-pool, vanligt vis passerar genom pipeline.
...
Namn på Synapse SQL återställnings punkt.
