...
## Sammanfattning
Tar bort en Azure AD-administratör för Synapse Analytics-arbetsyta.
...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSynapseSqlActiveDirectoryAdministrator** tar bort en Azure Active Directory-administratör (Azure AD) för Azure Synapse Analytics-arbetsyta.
...
Det här kommandot tar bort Azure AD-administratören för arbets ytan med namnet ContosoWorkspace.
