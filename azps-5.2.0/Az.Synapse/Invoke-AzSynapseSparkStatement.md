...
### RunSparkStatementByCodePathParameterSet (standard)
```
...
## PROBLEMBESKRIVNING
Cmdleten **Invoke-AzSynapseSparkStatement** anropar en Synapse Analytics Spark-instruktion.
...
De här kommandona startar en spark-session och anropar sedan en inline Spark-programsats via pipeline.
...
De här kommandona startar en spark-session och anropar sedan en inline Spark-programsats.
...
Dessa kommandon startar en spark-session och anropar sedan Spark-uttryck i en fil.
...
### -Sökväg
Anger en lokal fil Sök väg som innehåller körnings koden.
...
### -Svar
Anger att fullständigt svar ska returneras.
...
### -SessionObject
Spark session-objekt som normalt passerar genom pipeline.
