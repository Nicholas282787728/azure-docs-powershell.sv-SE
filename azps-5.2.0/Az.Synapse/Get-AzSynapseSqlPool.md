...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSynapseSqlPool** hämtar information om en Azure Synapse-BA SQL-pool.
...
Det här kommandot får alla SQL-pooler under en arbets yta.
...
Det här kommandot får SQL-poolen under arbets ytans ContosoWorkspace med namnet ContosoSqlPool.
...
Det här kommandot får alla SQL-pooler under en arbets yta genom pipeline.
...
Det här kommandot får SQL-poolen med angivet resurs-ID.
...
### -Version
[Den här funktionen är endast tillgänglig för vissa prenumerationer från början.] Version av Synapse SQL-pool. Till exempel 2 eller 3.
