...
## Sammanfattning
Avbryter en Synapse för SQL-pool.

## FRÅGESYNTAXEN

### SuspendByNameParameterSet (standard)
```
...
## PROBLEMBESKRIVNING
Cmdleten **suspend-AzSynapseSqlPool** inaktive ras en Azure SYNAPSE Analytics SQL-pool.
...
Det här kommandot gör att en aktiv Azure Synapse-BA-pool stoppas.
