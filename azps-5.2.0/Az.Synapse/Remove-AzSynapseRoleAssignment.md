...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSynapseRoleAssignment** tar bort en Azure Synapse-roll tilldelning.
...
Det här kommandot tar bort en Azure Synapse med ett roll tilldelnings-ID.
...
Det här kommandot tar bort en Azure Synapse med ett rollnamn och ett huvud namn för användaren.
...
Det här kommandot tar bort en Azure Synapse-roll tilldelning med ett roll tilldelnings-ID via pipeline.
