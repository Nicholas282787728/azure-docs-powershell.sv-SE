...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSynapseSparkStatement** hämtar information om ett Azure Synapse Analytics Spark-uttryck.
...
Det här kommandot får alla Spark-instruktioner under en spark-session.
...
Det här kommandot får Spark-instruktionen med angivet livy-ID.
...
Det här kommandot får alla Spark-instruktioner under en spark-session genom pipeline.
...
### -LivyId
Identifierare för Spark-instruktionen.
