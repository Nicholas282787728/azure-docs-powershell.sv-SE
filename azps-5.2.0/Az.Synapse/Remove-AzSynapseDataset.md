...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSynapseDataset** tar bort en data uppsättning från arbets ytan.
...
Det här kommandot tar bort den data uppsättning som heter ContosoDataset från arbets ytan med namnet ContosoWorkspace.
