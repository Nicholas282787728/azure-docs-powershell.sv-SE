...
## Sammanfattning
Kontrollerar om det finns en Synapse Analytics SQL-databas.
...
## PROBLEMBESKRIVNING
**Test-AzSynapseSqlDatabase-** cmdleten söker efter en SYNAPSE Analytics SQL-databas.
...
Det här kommandot kontrollerar förekomsten av angiven SQL-databas.
