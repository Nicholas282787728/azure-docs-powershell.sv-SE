...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSynapseTriggerSubscription** avabonnerar händelse utlösaren för angivna externa tjänst händelser från utlösaren defintion.
...
Det här kommandot avbryter prenumerations utlösaren som heter ContosoTrigger till angivna händelser från utlösaren defintion.
...
Det här kommandot avbryter prenumerations utlösaren som heter ContosoTrigger till angivna händelser från utlösaren defintion via pipeline.
