...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSynapseDataFlow** tar bort ett data flöde från arbets ytan.
...
Det här kommandot tar bort data flödet med namnet ContosoDataFlow från arbets ytan med namnet ContosoWorkspace.
