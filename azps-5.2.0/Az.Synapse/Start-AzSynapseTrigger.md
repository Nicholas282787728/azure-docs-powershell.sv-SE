...
## PROBLEMBESKRIVNING
Cmdleten **Start-AzSynapseTrigger** startar en utlösare på en arbets yta. Om utlösaren är i tillståndet "stoppad" startar cmdleten utlösaren och kommer slutligen till att ligga på grund val av dess definition. Om utlösaren redan är i tillståndet start har denna cmdlet ingen effekt.
...
Startar en trigger som heter ContosoTrigger i arbets ytans ContosoWorkspace.
...
Startar en utlösare som heter ContosoTrigger i arbets ytans ContosoWorkspace via pipeline.
