...
Skapa en underhålls konfiguration med scope-värden
...
### -ExpirationDateTime
ExpirationDateTime i schemat i formatet ÅÅÅÅ-MM-DD hh: mm
...
### -ExtensionProperty
Anknytnings egenskaper per resurs.
...
### -Plats
Platsen för underhålls konfiguration.
...
### -Namn
Konfigurations namn för underhåll.
...
### -StartDateTime
StartDateTime i schemat i formatet ÅÅÅÅ-MM-DD hh: mm
