...
### Exempel 1: kontrol lera om det finns ett resurs namn
```powershell
...
Kommandot kontrollerar om det finns ett resurs namn.

### Exempel 2: kontrol lera om ett resurs namn är tillgängligt
```powershell
...
### -Namn
Hämtar eller anger namnet som ska kontrol leras.
...
### – Skriv
Hämtar eller anger typen av resurs som ska kontrol leras.
...
### Microsoft. Azure. PowerShell. cmdletar. blockchain. Models. Api20180601Preview. INameAvailability
