...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzDataLakeAnalyticsDataSource** lägger till en data källa i ett Azure Data Lake Analytics-konto.

## BESKRIVS

### Exempel 1: lägga till en data källa till ett konto
```powershell
PS C:\>Add-AzDataLakeAnalyticsDataSource -Account "ContosoAdlA" -DataLakeStore "ContosoAdlS"
```

Det här kommandot lägger till data källor för data Lake Store i ett data Lake Analytics-konto.

### Exempel 2

Lägger till en data källa i ett data Lake Analytics-konto. (automatiskt genererat)
...
### -AccessKey
Anger åtkomst tangenten för det Azure Blob Storage-konto som ska läggas till.
...
### -BLOB
Anger namnet på det Azure Blob Storage-konto som ska läggas till.
...
### -DataLakeStore
Anger namnet på Azure Data Lake Store-kontot som ska läggas till.
