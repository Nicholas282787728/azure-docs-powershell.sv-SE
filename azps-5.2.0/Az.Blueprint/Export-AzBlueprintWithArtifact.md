...
### -PassThru
När den är aktive rad returnerar cmdleten ett objekt som representerar den exporterade utkasts definitionen. Denna cmdlet genererar som standard inga utdata.
