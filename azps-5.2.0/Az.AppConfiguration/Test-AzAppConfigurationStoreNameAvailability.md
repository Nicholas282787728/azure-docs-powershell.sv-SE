...
### Exempel 1: testa tillgänglighet för app Configuration Store-namnet
...
Det här kommandot testar tillgänglighet för app Configuration Store-namnet.
...
### -Namn
Namnet för att kontrol lera tillgänglighet.
...
### Microsoft. Azure. PowerShell. cmdletar. AppConfiguration. Models. Api20200601. INameAvailabilityStatus
