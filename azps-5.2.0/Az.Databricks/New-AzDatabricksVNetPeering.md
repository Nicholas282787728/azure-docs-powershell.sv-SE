...
## Sammanfattning
Skapar virtuellt nätverk för arbets yta.
...
### Exempel 1: skapa en VNet-peering för databricks
```powershell
...
Det här kommandot skapar en VNet-peering för databricks.

## MALLPARAMETRAR

### -AllowForwardedTraffic
Om den vidarebefordrade trafiken från datorerna i det lokala virtuella nätverket tillåts/inte är tillåten i det virtuella fjärrnätverket.
...
### -AllowGatewayTransit
Om Gateway-länkar kan användas i virtuella fjärrnätverk för att länka till det här virtuella nätverket.
...
Om de virtuella datorerna i det lokala virtuella nätverks utrymmet skulle kunna komma åt virtuella datorer i det virtuella fjärrnätverket.
...
En lista över adress block som reserveras för det här virtuella nätverket i CIDR-notation.
...
ID för det databricks virtuella nätverket.
...
### -Namn
Namnet på arbets ytans vNet-peering.
...
ID för det virtuella fjärrnätverket.
...
### -UseRemoteGateway
Om du kan använda Fjärrgateways i det här virtuella nätverket.
