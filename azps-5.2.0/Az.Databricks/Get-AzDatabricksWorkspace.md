...
### Exempel 1: skaffa en Databricks-arbetsyta med namn
```powershell
...
Det här kommandot får en Databricks-arbetsyta i en resurs grupp.

### Exempel 2: lista alla Databricks-arbetsytor i ett abonnemang
```powershell
...
Det här kommandot visar alla Databricks arbets ytor i ett abonnemang.

### Exempel 3: lista alla Databricks-arbetsytor i en resurs grupp
```powershell
...
Det här kommandot visar alla Databricks arbets ytor i en resurs grupp.
