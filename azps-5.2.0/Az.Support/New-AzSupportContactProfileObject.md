...
## Sammanfattning
Skapar ett profil objekt för support kontakt.
...
## PROBLEMBESKRIVNING
Det här är en hjälp-cmdlet som du kan använda för att skapa ett profil objekt för support kontakt när du skapar eller uppdaterar ett support ärende. Du måste ange följande parametrar som är obligatoriska för att skapa ett support ärende: 
...
### Exempel 1: skapa ett kontakt objekt
```powershell
