...
### Exempel 2: Hämta alla behållar tjänster
```
...
Det här kommandot får alla behållar tjänster i prenumerationen.

### Exempel 3: Hämta alla behållar tjänster i resurs gruppen
```
...
Det här kommandot får alla behållar tjänster i ResourceGroup17.

### Exempel 4: Hämta alla behållar tjänster med filter
```
...
Det här kommandot får alla behållar tjänster som börjar med "CSResourceGroup1".
