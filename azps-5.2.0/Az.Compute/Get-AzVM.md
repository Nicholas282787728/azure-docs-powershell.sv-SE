...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzVM** hämtar modellen eller instans vyn för en virtuell Azure-dator.
...
Ange en *status* parameter för att få instans visningen av en virtuell dator i stället för vyn modell som är standard.
...
### Exempel 5: Hämta alla virtuella datorer på platsen.
```
...
Det här kommandot får alla virtuella datorer i västra USA-regionen.

### Exempel 6: Hämta alla virtuella datorer med hjälp av filtrering
```
...
Det här kommandot får alla virtuella datorer i ditt abonnemang som börjar med "test".
...
Giltiga värden är:--Compact: visar endast de högsta nivå egenskaperna--Expand: visar alla egenskaper på alla nivåer
...
### -Plats
Anger en plats för de virtuella datorerna som ska visas.
