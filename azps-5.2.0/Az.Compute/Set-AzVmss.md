...
## PROBLEMBESKRIVNING
Cmdleten **set-AzVmss** anger specifika åtgärder på den virtuella datorns skal uppsättning (VMSS).
...
Ställer in specifika åtgärder på ett angivet VMSS. (automatiskt genererat)
...
### -PerformMaintenance
Anger att denna cmdlet utför underhåll på en eller flera virtuella datorer i VMSS.
...
### -Omdistribuera
Anger att cmdleten återdistribuerar en eller flera virtuella datorer i VMSS.
...
### -TempDisk
Anger om du vill att bilden ska visas igen.
