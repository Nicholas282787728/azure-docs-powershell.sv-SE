...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzVmss** hämtar modellen och instans vyn för en virtuell dators skal uppsättning (VMSS).
...
### Exempel 2: Hämta alla VMSS i en resurs grupp
```
...
Hämta alla VMSS i resurs gruppen "Group001"

### Exempel 3: Hämta alla VMSS i ett abonnemang
```
PS C:\> Get-AzVmss
...
Skaffa alla VMSS i prenumerationen.

### Exempel 4: Hämta alla VMSS med hjälp av filtrering
```
...
Hämta alla VMSS i prenumerationen som börjar med "VMSS00".
