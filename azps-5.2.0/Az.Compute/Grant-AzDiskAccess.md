...
## PROBLEMBESKRIVNING
**Grant-AzDiskAccess** cmdlet ger en åtkomst till en disk.
...
Ge "Read"-åtkomst till disken med namnet "Disk01" i resurs gruppen med namnet "ResourceGroup01" för 60 sekunder.
