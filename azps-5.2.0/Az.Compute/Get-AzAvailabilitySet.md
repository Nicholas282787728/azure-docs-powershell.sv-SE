...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzAvailabilitySet** hämtar Azure Availability-uppsättningar i en resurs grupp.
...
Det här kommandot får tillgänglighets uppsättningen som heter AvailabilitySet03 i resurs gruppen med namnet ResourceGroup11.
...
### Exempel 3: Hämta alla tillgänglighets uppsättningar med filtrering
```
...
Det här kommandot får alla tillgänglighets uppsättningar i resurs gruppen "ResourceGroup11" som börjar med "AvailabilitySet0".

### Exempel 4: Hämta alla tillgänglighets uppsättningar med namn som börjar på AvailabilitySet0
```
...
Det här kommandot får alla tillgänglighets uppsättningar som börjar med "AvailabilitySet0".
