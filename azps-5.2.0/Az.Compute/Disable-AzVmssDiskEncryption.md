...
Inaktiverar disk kryptering på den virtuella datorns skal uppsättning med namnet VMSS001 som tillhör resurs gruppen med namnet Group001.

### Exempel 2

Inaktiverar disk kryptering på en virtuell dators skala. (automatiskt genererat)
...
### -Force
För att framtvinga borttagning av tillägget från den virtuella datorn.
