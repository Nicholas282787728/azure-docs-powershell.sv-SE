...
## PROBLEMBESKRIVNING
Cmdleten **New-AzDiskUpdateConfig** skapar ett konfigurerbart disk uppdaterings objekt.
...
### -DiskMBpsReadOnly
Det totala genomflödet (MBps) som kommer att tillåtas för alla datorer som monterar den delade disken som ReadOnly. MBps betyder miljon tals byte per sekund-MB här använder ISO-notationen med 10.
...
### -MaxSharesCount
Maximalt antal virtuella datorer som kan ansluta till disken samtidigt. Värdet större än en anger en disk som kan monteras på flera virtuella datorer samtidigt.
