...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzVMExtensionImage** hämtar alla versioner av ett Azure-tillägg.
...
### Exempel 2: Hämta versionerna av en tilläggs bild med filter över version
```
...
Det här kommandot får alla versioner av tilläggs bilden för den angivna platsen, den andra typen och versionen som börjar med 12.

### Exempel 3: Hämta versionerna av en tilläggs bild med filter över version
```
...
Med det här kommandot får du alla versioner av tilläggs bilden för den angivna platsen, Publisher, typ och version.
...
För att få en tilläggs typ, Använd cmdleten Get-AzVMExtensionImageType.
