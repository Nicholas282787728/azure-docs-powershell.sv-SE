...
## PROBLEMBESKRIVNING
Cmdleten **New-AzAvailabilitySet** skapar en Azure Availability-uppsättning.
...
Det här kommandot skapar en tillgänglighets uppsättning med namnet AvailabilitySet03 i resurs gruppen med namnet ResourceGroup11.
...
Resurs-ID för närhets gruppen som ska användas med den här tillgänglighets uppsättningen.
