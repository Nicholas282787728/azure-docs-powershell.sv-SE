...
### Exempel 1: skapa ett privat moln
```powershell
...
### -NetworkBlock
Adress blocket ska vara unikt mellan VNet i ditt abonnemang och lokal.
Kontrol lera att CIDR-formatet är förenligt med (A. B. C. D/X) där A, B, C, D är mellan 0 och 255 och X är mellan 0 och 22
...
### -NsxtPassword
Du kan också ange lösen ordet för NSX-T Manager när det privata molnet skapas
...
### -VcenterPassword
Du kan också ange lösen ordet för vCenter-administratörer när det privata molnet skapas
