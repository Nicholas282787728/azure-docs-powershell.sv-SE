...
## Sammanfattning
Hämtar de tillförlitliga princip-undertecknarna från en klient organisation i Azure-attestering.
...
## PROBLEMBESKRIVNING
Med den här Get-AzAttestationPolicySigners cmdleten får de betrodda princip undertecknarna från en klient organisation i Azure-attestering.
...
Hämtar de tillförlitliga princip-undertecknarna för *pshtest* i resurs gruppen *PSH-test-RG*.  Observera att det inte finns några betrodda undertecknare för denna attesterings tjänst.
...
Hämtar de tillförlitliga princip-undertecknarna för *pshtest2* i resurs gruppen *PSH-test-RG*.  Observera att det finns en betrodd undertecknare för denna attesterings tjänst.
...
Hämtar de tillförlitliga princip-undertecknarna för standar-leverantören i plats *centralen*.  Observera att det inte finns några betrodda undertecknare för standardprovidern för attestering.
...
### -DefaultProvider
Anger det här begäran till en standardprovider för attestering.
...
### -Plats
Anger platsen för standard leverantören för attestering.
...
### -Namn
Anger namnet på en attesterings leverantör.
...
### -ResourceGroupName
Anger namnet på en attesterings leverantörs resurs grupp.
...
### -ResourceId
Anger ResourceID för en attesterings leverantör.
...
### Microsoft. Azure. commands. attestering. Models. PSPolicySigners
