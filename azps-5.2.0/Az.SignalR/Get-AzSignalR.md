...
### Hämta alla signal tjänster i prenumerationen
```
PS C:\> Get-AzSignalR
...
### Hämta alla signal tjänster i en resurs grupp
```
...
### Skaffa en specifik signal tjänst
```
...
### Skaffa en specifik signal tjänst från standard resurs gruppen
```
...
Standard resurs gruppen kan anges via \` set-AzDefault-ResourceGroupName myResourceGroup \` .
