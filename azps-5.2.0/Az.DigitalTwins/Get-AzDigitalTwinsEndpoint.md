...
### Exempel 1: list AzDigitalTwinsEndpoint i ResourceGroup
```powershell
...
Lista alla AzDigitalTwinsEndpoints med ResourceGroupName
...
Få AzDigitalTwinsEndpoint via EndpointName i ResourceGroup

### Exempel 3: get AzDigitalTwinsEndpoint by ' AzDigitalTwinsEndpoint '-objekt
```powershell
...
Hämta AzDigitalTwinsEndpoint via ' AzDigitalTwinsEndpoint '-objekt
