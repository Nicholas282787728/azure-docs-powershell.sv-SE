...
### Exempel 1: skapa en AzDigitalTwinsEndpoint för Eventhub
```powershell
...
Skapa en AzDigitalTwinsEndpoint för Eventhub by connectionStringPrimaryKey

### Exempel 2: skapa en AzDigitalTwinsEndpoint för EventGrid
```powershell
...
Skapa en AzDigitalTwinsEndpoint för Eventhub by TopicEndpoint och accessKey1

### Exempel 3: skapa en AzDigitalTwinsEndpoint för ServiceBus
```powershell
...
Skapa en AzDigitalTwinsEndpoint för ServicBus efter PrimaryConnectionString
...
### -DeadLetterSecret
Lagring hemligt för obeställbara meddelanden.
Kommer att vara Obfuscated under läsning.
...
### -EndpointDescription
Slut punkts resursen DigitalTwinsInstance.
För att konstruera kan du läsa avsnittet anteckningar för ENDPOINTDESCRIPTION-egenskaper och skapa en hash-tabell.
...
### -EndpointType
Typen av avsluts änd punkt för digital
...
ENDPOINTDESCRIPTION <IDigitalTwinsEndpointResource> : DigitalTwinsInstance-slutpunkt-resurs.
  - `EndpointType <EndpointType>`: Typen av avsluts änd punkt för digital
  - `[DeadLetterSecret <String>]`: Hemligt lagrings utrymme. Kommer att vara Obfuscated under läsning.
