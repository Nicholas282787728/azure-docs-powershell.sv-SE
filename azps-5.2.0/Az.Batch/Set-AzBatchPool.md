...
Använd Get-AzBatchPool cmdlet för att hämta ett **PSCloudPool** -objekt.
...
Det första kommandot får en pool genom att använda **Get-AzBatchPool** och lagrar den sedan i $pool variabel.
