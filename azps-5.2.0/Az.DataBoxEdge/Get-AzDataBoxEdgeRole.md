...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDataBoxEdgeRole** hämtar de tillgängliga IoT-rollerna för en Edge-enhet. Du kan nämna parametern name för att få information om en specifik IoT-roll.
