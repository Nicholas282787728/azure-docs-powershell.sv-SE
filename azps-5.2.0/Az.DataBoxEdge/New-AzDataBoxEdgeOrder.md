...
## PROBLEMBESKRIVNING
**New-AzDataBoxEdgeOrder-** cmdleten skapar en ny order för en Edge-enhet. En data Box Edge-resurs måste skapas först innan en beställning skapas. Du kan ange information som kontakt person, företags namn, e-post, adress etc. som parametrar för att skapa beställningen.
