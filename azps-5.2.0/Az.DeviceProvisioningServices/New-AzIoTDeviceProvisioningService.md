...
Skapa en Azure IoT Hub-enhet med en standard pris nivå S1 och-taggar, i området i resurs gruppen.
...
### -Tagg
IoT enheter för etablerings tjänst instans. Egenskaps uppsättning i nyckel värde par i form av en hash-tabell.
