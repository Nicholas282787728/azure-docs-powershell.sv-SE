...
Ta bort principen "policy" för delad åtkomst i en konfigurations tjänst för en Azure IoT Hub-enhet.
...
Ta bort principen "policy" för delad åtkomst i en tjänste etablerings tjänst från en Azure IoT Hub-enhet med pipeline.
