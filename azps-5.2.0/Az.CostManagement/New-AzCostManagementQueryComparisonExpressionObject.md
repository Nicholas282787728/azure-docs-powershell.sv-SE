...
### Exempel 1: skapa ett jämförelse uttryck för fråga för export av kostnads hantering
```powershell
...
Det här kommandot skapar ett jämförelse uttryck för fråga för export av kostnads hantering.

## MALLPARAMETRAR

### -Namn
Namnet på den kolumn som ska användas vid jämförelse.
...
### -Operatör
Den operator som ska användas för jämförelse.
...
### Microsoft. Azure. PowerShell. cmdletar. CostManagement. Models. Api20200601. QueryComparisonExpression
