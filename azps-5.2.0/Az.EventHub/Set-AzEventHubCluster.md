...
## PROBLEMBESKRIVNING
Set-AzEventHubCluster cmdlet uppdaterar taggar för det angivna klustret
...
Uppdaterar taggar för det angivna klustret. 
...
### -Tagg
Hashtables som representerar resurs tag gen för kluster
