...
## Sammanfattning
Inaktivera en Azure Advisor-rekommendation.
...
## PROBLEMBESKRIVNING
En Undertryckning för rekommendation (er) skapas gör det möjligt för en särskild rekommendation att senareläggas under en viss varaktighet eller oändligt.
...
Skapa en Undertryckning för den angivna rekommendations namnet med standard-SuppressionName och standard dagar som-1.
...
En Undertryckning skapas för angiven rekommendation-ID.
...
Skapa en Undertryckning, rör dragning från Get-AzAdvisorRecommendation till Disable-AzAdvisorRecommendation.
...
### Microsoft. Azure. commands. rådgivare. cmdlets. Models. PsAzureAdvisorSuppressionContract
