...
## Sammanfattning
Hämtar Custom Resource Provider-manifestet.
...
### Exempel 1: lista alla anpassade leverantörer i ett abonnemang
```powershell
...
Visar alla anpassade leverantörer i ett abonnemang

### Exempel 2: skaffa en enda anpassad leverantör
```powershell
...
Hämtar information för en anpassad leverantör.
Använd Format-List för att visa objekt information på skärmen.
...
### Microsoft. Azure. PowerShell. cmdletar. CustomProviders. Models. ICustomProvidersIdentity
...
INPUTOBJECT <ICustomProvidersIdentity> : identitets parameter
  - `[AssociationName <String>]`: Namnet på kopplingen.
  - `[Id <String>]`: Sökväg till resurs identitet
  - `[ResourceGroupName <String>]`: Namnet på resurs gruppen.
  - `[ResourceProviderName <String>]`: Resurs leverantörens namn.
  - `[Scope <String>]`: Associationens omfattning.
