...
## Sammanfattning
Uppdaterar en befintlig anpassad resurs leverantör.
Det enda värde som kan uppdateras med PATCH är för tillfället märkningarna.
...
### Exempel 1: lägga till taggar till en anpassad leverantör
```powershell
...
Uppdatera taggarna för en anpassad leverantör.

### Exempel 2: uppdatera en anpassad leverantör med rör
```powershell
...
Uppdatera en anpassad leverantör med rör.
