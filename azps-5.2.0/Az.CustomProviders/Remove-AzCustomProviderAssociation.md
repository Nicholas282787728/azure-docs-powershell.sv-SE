...
### Exempel 1: ta bort en anpassad leverantörs koppling.
```powershell
PS C:\> PS C:\> Remove-AzCustomProviderAssociation -Scope $id -Name Namespace.Type
```

Ta bort en anpassad leverantörs koppling.

### Exempel 2: ta bort en anpassad operatör med rör
```powershell
...
Ta bort en anpassad leverantörs koppling genom att använda ledning och PassThru-funktionen för att indikera framgång eller misslyckande.
