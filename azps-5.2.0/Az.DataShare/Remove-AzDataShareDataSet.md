...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzDataShareDataSet** tar bort en data mängd.
...
De här kommandona tar bort den dataset som heter DS från Share WikiAds. 
