...
## PROBLEMBESKRIVNING
Cmdleten **New-AzDataShare** skapar en data resurs i ett angivet Azure Data Share-konto genom att ange resurs grupp namn, konto namn, resurs namn och delnings typ. Beskrivning och användnings villkor är valfria parametrar som kan anges när data resursen skapas.

## BESKRIVS

### Exempel 1: skapa en data resurs
```
...
Det här kommandot skapar en data resurs med namnet AdsShare of Natura CopyBased i data Share-kontot WikiAdsAccount under resurs gruppens annonser med beskrivning och användnings villkor.
...
### -Beskrivning
Beskrivning av Azure Data Share
...
### -TermsOfUse
Användnings villkor för Azure Data Share
