...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDataShareDataSetMapping** hämtar information om en viss data uppsättnings mappning om namnet har angetts. Annars får du information om alla data uppsättnings mappningar i en resurs prenumeration. 
...
```
 ...
 Det här kommandot visar information om alla data uppsättnings mappningar i Share-prenumerationen.
...
### -ResourceGroupName
Resurs grupp namnet för Azure Data Share-konto.
...
### -ResourceId
Resurs-ID för Azure Data Set-mappningen.
