...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzDataShareSynchronizationSetting** tar bort synkroniseringsinställningarna för datashare
...
Med det här kommandot tas en synkroniseringsresurs bort som heter AdsShareSynchronizationSetting från Share AdsShare. 
...
### -InputObject
Inställningen för synkronisering av Azure Data Share.
...
### -ResourceId
Resurs-ID för synkroniseringsinställningarna
