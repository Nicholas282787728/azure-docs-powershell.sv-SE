...
## PROBLEMBESKRIVNING
**New-AzDataShareDataSet-** cmdleten lägga till data uppsättningar i Azure Data Share för data delnings konto. Du kan lägga till data uppsättningar av typen BLOB, ADLS Gen2 och ADLS gen1.
...
Det här kommandot lägger till en data mängd som heter AdsDataSet av typen BLOB-behållare i Azure Data Share AdsShare.
...
### -AdlsGen1FolderPath
Azure Storage ADLS gen1-mappsökväg
...
### -FileName
Azure Storage ADLS gen1 fil namn
