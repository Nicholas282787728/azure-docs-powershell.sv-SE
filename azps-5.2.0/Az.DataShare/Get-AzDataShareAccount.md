...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzDataShareAccount** hämtar information om datashare-konton i en Azure-prenumeration/resurs grupp.
Om du anger namnet på ett konto får denna cmdlet information om det datshare-kontot.
Om du inte anger ett namn hämtas den här cmdleten information om alla datashare-konton i en Azure-prenumeration/resurs grupp.
