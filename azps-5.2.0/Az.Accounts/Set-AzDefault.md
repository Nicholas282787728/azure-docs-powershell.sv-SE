...
## PROBLEMBESKRIVNING
Set-AzDefault cmdlet lägger till eller ändrar standardvärden i den aktuella kontexten.
...
Det här kommandot anger standard resurs gruppen till den resurs grupp som användaren angett.
...
### -Force
Skapa en ny resurs grupp om det angivna standardvärdet inte finns
...
### -ResourceGroupName
Namnet på den resurs grupp som ska anges som standard
