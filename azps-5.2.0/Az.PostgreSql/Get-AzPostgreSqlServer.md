...
### Exempel 1: skaffa PostgreSql-server med standard kontext
```powershell
...
Denna cmdlet får PostgreSql server med standard kontext.

### Exempel 2: skaffa PostgreSql Server efter resurs grupp och Server namn
```powershell
...
Denna cmdlet får PostgreSql Server genom resurs grupp och Server namn.

### Exempel 3: listar alla PostgreSql-servrar i angiven resurs grupp
```powershell
...
Denna cmdlet visar alla PostgreSql-servrar i angiven resurs grupp.

### Exempel 4: skaffa PostgreSql-servern efter identitet
```powershell
...
Med denna cmdlet-lista får du PostgreSql Server.
