...
### Exempel 3: skapa en instans av SAP Monitor efter ord lista för PrometheusHaCluster
```powershell
...
Det här kommandot skapar en instans av SAP Monitor efter ord lista för PrometheusHaCluster.

### Exempel 4: skapa en instans av SAP Monitor efter ord lista för PrometheusOS
```powershell
...
Det här kommandot skapar en instans av SAP Monitor efter ord lista för PrometheusOS.

### Exempel 5: skapa en instans av SAP Monitor efter ord lista för MsSqlServer
```powershell
...
Det här kommandot skapar en instans av SAP Monitor efter ord lista för MsSqlServer.

### Exempel 6: skapa en instans av SAP Monitor efter ord lista för SapHana
```powershell
...
Det här kommandot skapar en instans av SAP Monitor efter ord lista för SapHana.
