...
Det här kommandot skapar en SAP-skärm.
...
Värdet som anger om analys ska skickas till Microsoft
...
Arbets ytans ID för den logganalys-arbetsyta som ska användas för övervakning
...
ARM-ID för den logganalys-arbetsyta som används för övervakning
...
Den delade knappen i den logganalys-arbetsyta som används för övervakning
...
Det undernät som SAP-övervakaren ska distribueras till.
Det ska vara samma undernät i HANA-databasen.
