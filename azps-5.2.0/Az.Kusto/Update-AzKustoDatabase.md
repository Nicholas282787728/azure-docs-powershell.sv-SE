...
### Exempel 1: uppdatera en befintlig databas med namn
```powershell
...
Kommandot ovan uppdaterar den mjuka borttagnings perioden och Kusto-databasen "mykustodatabase" i klustret "testnewkustocluster" i resurs gruppen "testrg".

### Exempel 2: uppdatera en befintlig databas via identitet
```powershell
...
### Exempel 3: uppdatera en befintlig skrivskyddad databas efter namn
```powershell
PS C:\> $2ds = New-TimeSpan -Days 2
...
Kommandot ovan uppdaterar under tiden för cacheminnet för Kusto-databasen "mykustodatabase" i klustret "myfollowercluster" i resurs gruppen "testrg".

### Exempel 4: uppdatera en befintlig ReadOnly-databas via identitet
```powershell
...
### -HotCachePeriod
Tiden som data ska behållas i cacheminnet för snabba frågor i TimeSpan.
...
### -SoftDeletePeriod
Den tid då informationen ska behållas innan den inte längre är tillgänglig för frågor i TimeSpan.
...
### Microsoft. Azure. PowerShell. cmdletar. Kusto. Models. Api20200614. IDatabase
