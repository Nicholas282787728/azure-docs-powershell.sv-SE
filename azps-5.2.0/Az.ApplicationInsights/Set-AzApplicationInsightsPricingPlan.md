...
## PROBLEMBESKRIVNING
Ange prissättnings-och daglig data volym information för en Application Insights-resurs.
Pris plan för insikter från program som skapats efter april 2018 kan inte anges av denna cmdlet: https://docs.microsoft.com/en-us/azure/azure-monitor/app/pricing#legacy-enterprise-per-node-pricing-tier
...
Ställ in prissättningen på "grundläggande", ange daglig data volym Cap till 400 GB per dag och stoppa skicka-avisering när du är på resurs "test" i resurs gruppen "testgroup"
