...
## PROBLEMBESKRIVNING
Få Application Insights-resurser i en resurs grupp eller specifik resurs

## BESKRIVS

### Exempel 1 få Application Insights-resursen
```
...
Få Application Insights-resursen "test" i resurs gruppen "testgroup"

### Exempel 2 få Application Insights-resurs med information om pris plan
```
...
Resursen Application Insights och inkludera information om pris plan för resursen "test" i resurs gruppen "testgroup"
...
### -Fullständig
Om det här alternativet anges får du tillbaka prissättnings plan/daglig Kap och status för komponenten Application Insights.
...
### -Namn
Resurs namn för Application Insights.
