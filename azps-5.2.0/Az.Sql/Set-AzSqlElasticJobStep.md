...
## PROBLEMBESKRIVNING
Set-AzSqlElasticJobStep cmdlet uppdaterar ett jobb steg

## BESKRIVS

### Exempel 1: uppdaterar mål gruppen för ett jobb för ett jobb
```powershell
...
### Exempel 2: uppdaterar ett jobb-SQL-skript för ett jobb
```powershell
PS C:\> $jobStep = Get-AzSqlElasticJobStep -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -StepName step1
...
Uppdaterar ett jobb steg från ett jobb
...
### -CredentialName
Namnet på autentiseringsuppgiften
...
Det första återförsöksintervall för försök
...
Maximalt antal sekunder för försök
...
### -RemoveOutput
Flagga som anger om utdata ska tas bort
...
Återförsöksintervall backoff multiplikator
