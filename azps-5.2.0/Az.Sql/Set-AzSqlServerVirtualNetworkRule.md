...
Använd "Add-AzSqlServerVirtualNetworkRule" och "Remove-AzSqlServerVirtualNetworkRule" i stället för att styra uppsättningen med regler för virtuella nätverk på servern.
