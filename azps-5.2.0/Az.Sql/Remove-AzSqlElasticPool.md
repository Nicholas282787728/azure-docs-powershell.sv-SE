...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSqlElasticPool** tar bort en elastisk Azure SQL-databas.

## BESKRIVS

### Exempel 1: ta bort en elastisk pool
```
PS C:\>Remove-AzSqlElasticPool -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -ElasticPoolName "ElasticPool01"
```

Det här kommandot tar bort en elastisk pool med namnet ElasticPool01.
...
### -ElasticPoolName
Anger namnet på den elastiska pool som tas bort av denna cmdlet.
