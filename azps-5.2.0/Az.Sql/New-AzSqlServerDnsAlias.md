...
## PROBLEMBESKRIVNING
Skapar ett nytt DNS-alias för Azure SQL Server som pekar på angiven server.
...
Det här kommandot skapar DNS-aliaset för Azure SQL Server med namnet aliasName som pekar på Server namn
