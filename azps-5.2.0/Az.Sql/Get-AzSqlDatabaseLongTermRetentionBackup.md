...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlDatabaseLongTermRetentionBackup** alla säkerhets kopior för en lagrings plats, server eller databas eller en särskild säkerhets kopia av den långsiktiga tids perioden.

## BESKRIVS

### Exempel 1: Hämta alla säkerhets kopior för en plats
```powershell
...
Det här kommandot får alla säkerhets kopior på lång sikt för alla databaser (som kan vara levande eller borttagna) i northeurope endast om servern är Live.

### Exempel 2: Hämta alla säkerhets kopior för en plats under en resurs grupp
```powershell
...
Med det här kommandot får du säkerhets kopior för alla databaser (som kan vara levande eller borttagna) under en resurs grupp i northeurope.

### Exempel 3: skaffa en särskild säkerhets kopia av en lång tids period
```powershell
...
Det här kommandot får säkerhets kopian med namnet 601061b7-d10b-46e0-bf77-a2bfb16a6add; 131655666550000000

### Exempel 4: Hämta alla långsiktiga säkerhets kopior för en databas
```powershell
...
Det här kommandot får alla säkerhets kopior på lång sikt för database01

### Exempel 5: få säkerhets kopior på lång sikt med filtrering
```powershell
...
Det här kommandot får alla säkerhets kopior med namn som börjar med "601061b7"
...
### -DatabaseState
Tillståndet för den databas vars säkerhets kopior du vill hitta, använda, ta bort eller alla.
Standardvärden för alla
...
### -InputObject
Databasobjektet för att hämta säkerhets kopior.
...
Om du vill få den senaste säkerhets kopian per databas eller inte.
...
### -ResourceId
Databas resurs-ID som du kan använda för att hämta säkerhets kopior för.
...
### -ServerName
Namnet på Azure SQL-servern som säkerhets kopiorna är under.
