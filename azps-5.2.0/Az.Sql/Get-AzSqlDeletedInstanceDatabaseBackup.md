...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlDeletedInstanceDatabaseBackup** hämtar en angiven säkerhets kopia av borttagen SQL instans-databas som du kan återställa eller alla borttagna säkerhets kopior som du kan återställa.
Denna cmdlet stöds också av SQL-serverinstansen utsträckt databas tjänst på Azure.
