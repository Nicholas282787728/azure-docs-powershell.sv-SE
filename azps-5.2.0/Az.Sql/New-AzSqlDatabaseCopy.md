...
## PROBLEMBESKRIVNING
Cmdleten **New-AzSqlDatabaseCopy** skapar en kopia av en Azure SQL-databas som använder ögonblicks bilden av data vid aktuell tidpunkt. Använd denna cmdlet i stället för Start-AzSqlDatabaseCopy-cmdleten för att skapa en databas kopia av en gång. Denna cmdlet returnerar kopians **databas** objekt.
Obs! Använd cmdleten New-AzSqlDatabaseSecondary för att konfigurera geo-replikering för en databas.
...
Skapar en kopia av en SQL-databas där ögonblicks bilden används för tillfället. (automatiskt genererat)
...
### -ComputeGeneration
Skapa en ny kopia av beräkningen.
...
### -ResourceGroupName
Anger namnet på den resurs grupp som innehåller databasen som ska kopieras.
...
### -Taggar
Anger de viktigaste par i formen av en hash-tabell som ska kopplas till din kopia av Azure SQL-databasen. Till exempel: @ {key0 = "value0"; KEY1 = $null; key2 = "värde2"}
...
### -VCore
VCore-nummer i Azure SQL-databasfilen.
