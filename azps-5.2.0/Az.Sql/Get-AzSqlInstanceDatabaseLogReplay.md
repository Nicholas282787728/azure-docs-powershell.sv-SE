...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlInstanceDatabaseLogReplay** hämtar statusen för loggnings tjänsten för en viss databas.
...
Det här kommandot får statusen för loggnings tjänsten för den angivna databasen.
