...
## PROBLEMBESKRIVNING
Cmdleten **set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy** anger den långsiktiga bevarande principen för den här hanterade databasen.
...
Konfigurerar vecko principen för långsiktigt bevarande av en veckodag till en vecka.
...
Det här kommandot tar bort den långsiktiga bevarande principen för databasen.

### Exempel 3

Den Set-AzSqlInstanceDatabaseLongTermRetentionBackup cmdleten ställer in en beställnings princip för en hanterad databas. (automatiskt genererat)
...
### -DatabaseName
Namnet på den Azure-hanterade databasen som ska användas.
...
### -InstanceName
Namnet på den Azure-hanterade instans databasen tillhör.
...
### -RemovePolicy
Om det finns en princip för databasen rensas den.
