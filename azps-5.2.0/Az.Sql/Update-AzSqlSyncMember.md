...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzSqlSyncGroup** ändrar egenskaper för en Azure SQL Database Sync-medlem.
...
Det här kommandot återställer administratörs lösen ordet för medlems databasen.
...
Resurs-ID för den synkroniserade medlems databasen, används om UsePrivateLinkConnection är inställt på True.
...
Om du vill använda privat länk när du ansluter till den här synkroniserade medlemmen.
