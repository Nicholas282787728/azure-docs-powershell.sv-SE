...
### [<span data-ttu-id="aa934-111">Add-AzSqlInstanceKeyVaultKey</span><span class="sxs-lookup"><span data-stu-id="aa934-111">Add-AzSqlInstanceKeyVaultKey</span></span>](Add-AzSqlInstanceKeyVaultKey.md)
...
### [<span data-ttu-id="aa934-123">Clear-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="aa934-123">Clear-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Clear-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
...
### [<span data-ttu-id="aa934-135">Complete-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="aa934-135">Complete-AzSqlInstanceDatabaseLogReplay</span></span>](Complete-AzSqlInstanceDatabaseLogReplay.md)
...
### [<span data-ttu-id="aa934-147">Disable-AzSqlInstanceDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="aa934-147">Disable-AzSqlInstanceDatabaseSensitivityRecommendation</span></span>](Disable-AzSqlInstanceDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="aa934-159">Enable-AzSqlInstanceAdvancedDataSecurity</span><span class="sxs-lookup"><span data-stu-id="aa934-159">Enable-AzSqlInstanceAdvancedDataSecurity</span></span>](Enable-AzSqlInstanceAdvancedDataSecurity.md)
...
### [<span data-ttu-id="aa934-171">Get-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="aa934-171">Get-AzSqlDatabase</span></span>](Get-AzSqlDatabase.md)
...
### [<span data-ttu-id="aa934-185">Get-AzSqlDatabaseDataMaskingPolicy</span><span class="sxs-lookup"><span data-stu-id="aa934-185">Get-AzSqlDatabaseDataMaskingPolicy</span></span>](Get-AzSqlDatabaseDataMaskingPolicy.md)
...
### [<span data-ttu-id="aa934-199">Get-AzSqlDatabaseIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="aa934-199">Get-AzSqlDatabaseIndexRecommendation</span></span>](Get-AzSqlDatabaseIndexRecommendation.md)
...
### [<span data-ttu-id="aa934-213">Get-AzSqlDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="aa934-213">Get-AzSqlDatabaseSensitivityRecommendation</span></span>](Get-AzSqlDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="aa934-225">Get-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="aa934-225">Get-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Get-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
...
### [<span data-ttu-id="aa934-239">Get-AzSqlElasticJobStep</span><span class="sxs-lookup"><span data-stu-id="aa934-239">Get-AzSqlElasticJobStep</span></span>](Get-AzSqlElasticJobStep.md)
...
### [<span data-ttu-id="aa934-253">Get-AzSqlElasticPoolDatabase</span><span class="sxs-lookup"><span data-stu-id="aa934-253">Get-AzSqlElasticPoolDatabase</span></span>](Get-AzSqlElasticPoolDatabase.md)
...
### [<span data-ttu-id="aa934-267">Get-AzSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="aa934-267">Get-AzSqlInstanceDatabase</span></span>](Get-AzSqlInstanceDatabase.md)
...
### [<span data-ttu-id="aa934-281">Get-AzSqlInstanceDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="aa934-281">Get-AzSqlInstanceDatabaseSensitivityRecommendation</span></span>](Get-AzSqlInstanceDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="aa934-293">Get-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="aa934-293">Get-AzSqlInstancePool</span></span>](Get-AzSqlInstancePool.md)
...
### [<span data-ttu-id="aa934-307">Get-AzSqlServerAdvancedDataSecurityPolicy</span><span class="sxs-lookup"><span data-stu-id="aa934-307">Get-AzSqlServerAdvancedDataSecurityPolicy</span></span>](Get-AzSqlServerAdvancedDataSecurityPolicy.md)
...
### [<span data-ttu-id="aa934-319">Get-AzSqlServerDisasterRecoveryConfigurationActivity</span><span class="sxs-lookup"><span data-stu-id="aa934-319">Get-AzSqlServerDisasterRecoveryConfigurationActivity</span></span>](Get-AzSqlServerDisasterRecoveryConfigurationActivity.md)
...
### [<span data-ttu-id="aa934-333">Get-AzSqlServerUpgradeHint</span><span class="sxs-lookup"><span data-stu-id="aa934-333">Get-AzSqlServerUpgradeHint</span></span>](Get-AzSqlServerUpgradeHint.md)
...
### [<span data-ttu-id="aa934-347">Get-AzSqlSyncMember</span><span class="sxs-lookup"><span data-stu-id="aa934-347">Get-AzSqlSyncMember</span></span>](Get-AzSqlSyncMember.md)
...
### [<span data-ttu-id="aa934-361">New-AzSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="aa934-361">New-AzSqlDatabaseCopy</span></span>](New-AzSqlDatabaseCopy.md)
...
### [<span data-ttu-id="aa934-375">New-AzSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="aa934-375">New-AzSqlDatabaseSecondary</span></span>](New-AzSqlDatabaseSecondary.md)
...
### [<span data-ttu-id="aa934-389">New-AzSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="aa934-389">New-AzSqlInstanceDatabase</span></span>](New-AzSqlInstanceDatabase.md)
...
### [<span data-ttu-id="aa934-403">New-AzSqlServerVirtualNetworkRule</span><span class="sxs-lookup"><span data-stu-id="aa934-403">New-AzSqlServerVirtualNetworkRule</span></span>](New-AzSqlServerVirtualNetworkRule.md)
...
### [<span data-ttu-id="aa934-419">Remove-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="aa934-419">Remove-AzSqlDatabaseFailoverGroup</span></span>](Remove-AzSqlDatabaseFailoverGroup.md)
...
### [<span data-ttu-id="aa934-433">Remove-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="aa934-433">Remove-AzSqlElasticJob</span></span>](Remove-AzSqlElasticJob.md)
...
### [<span data-ttu-id="aa934-447">Remove-AzSqlInstance</span><span class="sxs-lookup"><span data-stu-id="aa934-447">Remove-AzSqlInstance</span></span>](Remove-AzSqlInstance.md)
...
### [<span data-ttu-id="aa934-461">Remove-AzSqlServer</span><span class="sxs-lookup"><span data-stu-id="aa934-461">Remove-AzSqlServer</span></span>](Remove-AzSqlServer.md)
...
### [<span data-ttu-id="aa934-475">Remove-AzSqlServerKeyVaultKey</span><span class="sxs-lookup"><span data-stu-id="aa934-475">Remove-AzSqlServerKeyVaultKey</span></span>](Remove-AzSqlServerKeyVaultKey.md)
...
### [<span data-ttu-id="aa934-489">Återställ-AzSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="aa934-489">Restore-AzSqlInstanceDatabase</span></span>](Restore-AzSqlInstanceDatabase.md)
...
### [<span data-ttu-id="aa934-503">Set-AzSqlDatabaseDataMaskingPolicy</span><span class="sxs-lookup"><span data-stu-id="aa934-503">Set-AzSqlDatabaseDataMaskingPolicy</span></span>](Set-AzSqlDatabaseDataMaskingPolicy.md)
...
### [<span data-ttu-id="aa934-505">Set-AzSqlDatabaseDataMaskingRule</span><span class="sxs-lookup"><span data-stu-id="aa934-505">Set-AzSqlDatabaseDataMaskingRule</span></span>](Set-AzSqlDatabaseDataMaskingRule.md)
<span data-ttu-id="aa934-506">Anger egenskaper för en data masknings regel för en databas.</span><span class="sxs-lookup"><span data-stu-id="aa934-506">Sets the properties of a data masking rule for a database.</span></span>

### [<span data-ttu-id="aa934-507">Set-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="aa934-507">Set-AzSqlDatabaseFailoverGroup</span></span>](Set-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="aa934-508">Ändrar konfigurationen för en failover-grupp för Azure SQL-databasen.</span><span class="sxs-lookup"><span data-stu-id="aa934-508">Modifies the configuration of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="aa934-509">Set-AzSqlDatabaseGeoBackupPolicy</span><span class="sxs-lookup"><span data-stu-id="aa934-509">Set-AzSqlDatabaseGeoBackupPolicy</span></span>](Set-AzSqlDatabaseGeoBackupPolicy.md)
<span data-ttu-id="aa934-510">Ställer in en databas princip för säkerhets kopiering av databasen.</span><span class="sxs-lookup"><span data-stu-id="aa934-510">Sets a database geo backup policy.</span></span>

### [<span data-ttu-id="aa934-511">Set-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="aa934-511">Set-AzSqlDatabaseInstanceFailoverGroup</span></span>](Set-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="aa934-512">Ändrar konfigurationen för en instans av en failover-grupp.</span><span class="sxs-lookup"><span data-stu-id="aa934-512">Modifies the configuration of an Instance Failover Group.</span></span>

### [<span data-ttu-id="aa934-513">Set-AzSqlDatabaseRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="aa934-513">Set-AzSqlDatabaseRecommendedActionState</span></span>](Set-AzSqlDatabaseRecommendedActionState.md)
<span data-ttu-id="aa934-514">Uppdaterar tillståndet för en rekommenderad Azure SQL-databas.</span><span class="sxs-lookup"><span data-stu-id="aa934-514">Updates the state of an Azure SQL Database recommended action.</span></span>

### [<span data-ttu-id="aa934-515">Set-AzSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="aa934-515">Set-AzSqlDatabaseSecondary</span></span>](Set-AzSqlDatabaseSecondary.md)
<span data-ttu-id="aa934-516">Växlar en sekundär databas till primärt för att initiera redundans.</span><span class="sxs-lookup"><span data-stu-id="aa934-516">Switches a secondary database to be primary in order to initiate failover.</span></span>

### [<span data-ttu-id="aa934-517">Set-AzSqlDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="aa934-517">Set-AzSqlDatabaseSensitivityClassification</span></span>](Set-AzSqlDatabaseSensitivityClassification.md)
<span data-ttu-id="aa934-518">Anger etiketterna för informations typer och känslighet för kolumner i databasen.</span><span class="sxs-lookup"><span data-stu-id="aa934-518">Sets the information types and sensitivity labels of columns in the database.</span></span>

### [<span data-ttu-id="aa934-519">Set-AzSqlDatabaseTransparentDataEncryption</span><span class="sxs-lookup"><span data-stu-id="aa934-519">Set-AzSqlDatabaseTransparentDataEncryption</span></span>](Set-AzSqlDatabaseTransparentDataEncryption.md)
<span data-ttu-id="aa934-520">Ändrar egenskapen TDE för en databas.</span><span class="sxs-lookup"><span data-stu-id="aa934-520">Modifies TDE property for a database.</span></span>

### [<span data-ttu-id="aa934-521">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="aa934-521">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="aa934-522">Anger bas linje för regel för sårbarhets utvärdering.</span><span class="sxs-lookup"><span data-stu-id="aa934-522">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="aa934-523">Set-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="aa934-523">Set-AzSqlElasticJob</span></span>](Set-AzSqlElasticJob.md)
<span data-ttu-id="aa934-524">Uppdaterar ett jobb</span><span class="sxs-lookup"><span data-stu-id="aa934-524">Updates a job</span></span>

### [<span data-ttu-id="aa934-525">Set-AzSqlElasticJobAgent</span><span class="sxs-lookup"><span data-stu-id="aa934-525">Set-AzSqlElasticJobAgent</span></span>](Set-AzSqlElasticJobAgent.md)
<span data-ttu-id="aa934-526">Uppdaterar en elastisk jobb agent</span><span class="sxs-lookup"><span data-stu-id="aa934-526">Updates an elastic job agent</span></span>

### [<span data-ttu-id="aa934-527">Set-AzSqlElasticJobCredential</span><span class="sxs-lookup"><span data-stu-id="aa934-527">Set-AzSqlElasticJobCredential</span></span>](Set-AzSqlElasticJobCredential.md)
<span data-ttu-id="aa934-528">Uppdaterar autentiseringsuppgifterna för jobbet</span><span class="sxs-lookup"><span data-stu-id="aa934-528">Updates a job credential</span></span>

### [<span data-ttu-id="aa934-529">Set-AzSqlElasticJobStep</span><span class="sxs-lookup"><span data-stu-id="aa934-529">Set-AzSqlElasticJobStep</span></span>](Set-AzSqlElasticJobStep.md)
<span data-ttu-id="aa934-530">Uppdaterar ett jobb steg</span><span class="sxs-lookup"><span data-stu-id="aa934-530">Updates a job step</span></span>

### [<span data-ttu-id="aa934-531">Set-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="aa934-531">Set-AzSqlElasticPool</span></span>](Set-AzSqlElasticPool.md)
<span data-ttu-id="aa934-532">Ändrar egenskaper för en Elastic Database-pool i Azure SQL-databasen.</span><span class="sxs-lookup"><span data-stu-id="aa934-532">Modifies properties of an elastic database pool in Azure SQL Database.</span></span>

### [<span data-ttu-id="aa934-533">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="aa934-533">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span></span>](Set-AzSqlElasticPoolAdvisorAutoExecuteStatus.md)
<span data-ttu-id="aa934-534">Uppdaterar status för automatisk körning av en Azure SQL-Elastic pool rådgivare.</span><span class="sxs-lookup"><span data-stu-id="aa934-534">Updates auto execute status of an Azure SQL Elastic Pool Advisor.</span></span>

### [<span data-ttu-id="aa934-535">Set-AzSqlElasticPoolRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="aa934-535">Set-AzSqlElasticPoolRecommendedActionState</span></span>](Set-AzSqlElasticPoolRecommendedActionState.md)
<span data-ttu-id="aa934-536">Uppdaterar tillståndet för en rekommenderad action för Azure SQL-poolen.</span><span class="sxs-lookup"><span data-stu-id="aa934-536">Updates the state of an Azure SQL Elastic Pool recommended action.</span></span>

### [<span data-ttu-id="aa934-537">Set-AzSqlInstance</span><span class="sxs-lookup"><span data-stu-id="aa934-537">Set-AzSqlInstance</span></span>](Set-AzSqlInstance.md)
<span data-ttu-id="aa934-538">Anger egenskaper för en hanterad instans av en Azure SQL-databas.</span><span class="sxs-lookup"><span data-stu-id="aa934-538">Sets properties for an Azure SQL Database Managed Instance.</span></span>

### [<span data-ttu-id="aa934-539">Set-AzSqlInstanceActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="aa934-539">Set-AzSqlInstanceActiveDirectoryAdministrator</span></span>](Set-AzSqlInstanceActiveDirectoryAdministrator.md)
<span data-ttu-id="aa934-540">Etablerar en Azure AD-administratör för SQL-hanterad instans.</span><span class="sxs-lookup"><span data-stu-id="aa934-540">Provisions an Azure AD administrator for SQL Managed Instance.</span></span>

### [<span data-ttu-id="aa934-541">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="aa934-541">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy.md)
<span data-ttu-id="aa934-542">Cmdleten **set-AzSqlInstanceDatabaseLongTermRetentionBackup** anger en bevarad bevarande princip för en hanterad databas.</span><span class="sxs-lookup"><span data-stu-id="aa934-542">The **Set-AzSqlInstanceDatabaseLongTermRetentionBackup** cmdlet sets a managed database's long term retention policy.</span></span>

### [<span data-ttu-id="aa934-543">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="aa934-543">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="aa934-544">Anger en säkerhets kopierings princip för kortvarigt bevarande.</span><span class="sxs-lookup"><span data-stu-id="aa934-544">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="aa934-545">Set-AzSqlInstanceDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="aa934-545">Set-AzSqlInstanceDatabaseSensitivityClassification</span></span>](Set-AzSqlInstanceDatabaseSensitivityClassification.md)
<span data-ttu-id="aa934-546">Anger etiketterna för informations typer och känslighet för kolumner i Azure SQL-hanterade instans databasen.</span><span class="sxs-lookup"><span data-stu-id="aa934-546">Sets the information types and sensitivity labels of columns in the Azure SQL managed instance database.</span></span>

### [<span data-ttu-id="aa934-547">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="aa934-547">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="aa934-548">Anger bas linje för regel för sårbarhets utvärdering.</span><span class="sxs-lookup"><span data-stu-id="aa934-548">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="aa934-549">Set-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="aa934-549">Set-AzSqlInstancePool</span></span>](Set-AzSqlInstancePool.md)
<span data-ttu-id="aa934-550">Anger egenskaper för en Azure SQL-instanskonstruktor.</span><span class="sxs-lookup"><span data-stu-id="aa934-550">Sets properties for an Azure SQL Instance pool.</span></span>

### [<span data-ttu-id="aa934-551">Set-AzSqlInstanceTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="aa934-551">Set-AzSqlInstanceTransparentDataEncryptionProtector</span></span>](Set-AzSqlInstanceTransparentDataEncryptionProtector.md)
<span data-ttu-id="aa934-552">Ställer in skydd mot transparent data kryptering (TDE) för en SQL-hanterad instans.</span><span class="sxs-lookup"><span data-stu-id="aa934-552">Sets the Transparent Data Encryption (TDE) protector for a SQL managed instance.</span></span>

### [<span data-ttu-id="aa934-553">Set-AzSqlServer</span><span class="sxs-lookup"><span data-stu-id="aa934-553">Set-AzSqlServer</span></span>](Set-AzSqlServer.md)
<span data-ttu-id="aa934-554">Ändrar egenskaper för en SQL-databasserver.</span><span class="sxs-lookup"><span data-stu-id="aa934-554">Modifies properties of a SQL Database server.</span></span>

### [<span data-ttu-id="aa934-555">Set-AzSqlServerActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="aa934-555">Set-AzSqlServerActiveDirectoryAdministrator</span></span>](Set-AzSqlServerActiveDirectoryAdministrator.md)
<span data-ttu-id="aa934-556">Etablerar en Azure AD-administratör för SQL Server.</span><span class="sxs-lookup"><span data-stu-id="aa934-556">Provisions an Azure AD administrator for SQL Server.</span></span>

### [<span data-ttu-id="aa934-557">Set-AzSqlServerAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="aa934-557">Set-AzSqlServerAdvisorAutoExecuteStatus</span></span>](Set-AzSqlServerAdvisorAutoExecuteStatus.md)
<span data-ttu-id="aa934-558">Uppdaterar status för automatisk körning för en Azure SQL Server Advisor.</span><span class="sxs-lookup"><span data-stu-id="aa934-558">Updates the auto execute status of an Azure SQL Server Advisor.</span></span>

### [<span data-ttu-id="aa934-559">Set-AzSqlServerAudit</span><span class="sxs-lookup"><span data-stu-id="aa934-559">Set-AzSqlServerAudit</span></span>](Set-AzSqlServerAudit.md)
<span data-ttu-id="aa934-560">Ändrar gransknings inställningarna för en Azure SQL-Server.</span><span class="sxs-lookup"><span data-stu-id="aa934-560">Changes the auditing settings of an Azure SQL server.</span></span>

### [<span data-ttu-id="aa934-561">Set-AzSqlServerDisasterRecoveryConfiguration</span><span class="sxs-lookup"><span data-stu-id="aa934-561">Set-AzSqlServerDisasterRecoveryConfiguration</span></span>](Set-AzSqlServerDisasterRecoveryConfiguration.md)
<span data-ttu-id="aa934-562">Ändrar en konfiguration för återställning av databas server.</span><span class="sxs-lookup"><span data-stu-id="aa934-562">Modifies a database server recovery configuration.</span></span>

### [<span data-ttu-id="aa934-563">Set-AzSqlServerDnsAlias</span><span class="sxs-lookup"><span data-stu-id="aa934-563">Set-AzSqlServerDnsAlias</span></span>](Set-AzSqlServerDnsAlias.md)
<span data-ttu-id="aa934-564">Ändrar den server som DNS-aliaset för Azure SQL Server pekar på</span><span class="sxs-lookup"><span data-stu-id="aa934-564">Modifies the server to which Azure SQL Server DNS Alias is pointing</span></span>

### [<span data-ttu-id="aa934-565">Set-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="aa934-565">Set-AzSqlServerFirewallRule</span></span>](Set-AzSqlServerFirewallRule.md)
<span data-ttu-id="aa934-566">Ändrar en brand Väggs regel i Azure SQL Database Server.</span><span class="sxs-lookup"><span data-stu-id="aa934-566">Modifies a firewall rule in Azure SQL Database server.</span></span>

### [<span data-ttu-id="aa934-567">Set-AzSqlServerRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="aa934-567">Set-AzSqlServerRecommendedActionState</span></span>](Set-AzSqlServerRecommendedActionState.md)
<span data-ttu-id="aa934-568">Uppdaterar tillståndet för en rekommenderad Azure SQL Server-åtgärd.</span><span class="sxs-lookup"><span data-stu-id="aa934-568">Updates the state of an Azure SQL Server recommended action.</span></span>

### [<span data-ttu-id="aa934-569">Set-AzSqlServerTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="aa934-569">Set-AzSqlServerTransparentDataEncryptionProtector</span></span>](Set-AzSqlServerTransparentDataEncryptionProtector.md)
<span data-ttu-id="aa934-570">Ställer in skydd mot transparent data kryptering (TDE) för en SQL-Server.</span><span class="sxs-lookup"><span data-stu-id="aa934-570">Sets the Transparent Data Encryption (TDE) protector for a SQL server.</span></span>

### [<span data-ttu-id="aa934-571">Set-AzSqlServerVirtualNetworkRule</span><span class="sxs-lookup"><span data-stu-id="aa934-571">Set-AzSqlServerVirtualNetworkRule</span></span>](Set-AzSqlServerVirtualNetworkRule.md)
<span data-ttu-id="aa934-572">Ändrar konfigurationen för en Azure SQL Server-regel.</span><span class="sxs-lookup"><span data-stu-id="aa934-572">Modifies the configuration of an Azure SQL Server Virtual Network Rule.</span></span>

### [<span data-ttu-id="aa934-573">Start-AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="aa934-573">Start-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Start-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="aa934-574">Startar arbets flödet som kör en rekommenderad index åtgärd.</span><span class="sxs-lookup"><span data-stu-id="aa934-574">Starts the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="aa934-575">Start-AzSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="aa934-575">Start-AzSqlDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="aa934-576">Startar en utvärderings sökning för sårbarhet.</span><span class="sxs-lookup"><span data-stu-id="aa934-576">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="aa934-577">Start-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="aa934-577">Start-AzSqlElasticJob</span></span>](Start-AzSqlElasticJob.md)
<span data-ttu-id="aa934-578">Startar ett jobb och returnerar ett ID för jobb körning som kan avsökas för att visa att det är status</span><span class="sxs-lookup"><span data-stu-id="aa934-578">Starts a job, returning a job execution id that can be polled to view it's status</span></span>

### [<span data-ttu-id="aa934-579">Start-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="aa934-579">Start-AzSqlInstanceDatabaseLogReplay</span></span>](Start-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="aa934-580">Startar en logg-Replay med angivna parametrar.</span><span class="sxs-lookup"><span data-stu-id="aa934-580">Starts a Log Replay service with the given parameters.</span></span>

### [<span data-ttu-id="aa934-581">Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="aa934-581">Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="aa934-582">Startar en utvärderings sökning för sårbarhet.</span><span class="sxs-lookup"><span data-stu-id="aa934-582">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="aa934-583">Start-AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="aa934-583">Start-AzSqlSyncGroupSync</span></span>](Start-AzSqlSyncGroupSync.md)
<span data-ttu-id="aa934-584">Startar en synkronisering av en synkroniseringsresurs.</span><span class="sxs-lookup"><span data-stu-id="aa934-584">Starts a sync group synchronization.</span></span>

### [<span data-ttu-id="aa934-585">Stopp-AzSqlDatabaseActivity</span><span class="sxs-lookup"><span data-stu-id="aa934-585">Stop-AzSqlDatabaseActivity</span></span>](Stop-AzSqlDatabaseActivity.md)
<span data-ttu-id="aa934-586">Avbryter den asynkrona uppdateringen av databasen.</span><span class="sxs-lookup"><span data-stu-id="aa934-586">Cancels the asynchronous updates operation on the database.</span></span>

### [<span data-ttu-id="aa934-587">Stopp-AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="aa934-587">Stop-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Stop-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="aa934-588">Stoppar arbets flödet som kör en rekommenderad index åtgärd.</span><span class="sxs-lookup"><span data-stu-id="aa934-588">Stops the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="aa934-589">Stopp-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="aa934-589">Stop-AzSqlElasticJob</span></span>](Stop-AzSqlElasticJob.md)
<span data-ttu-id="aa934-590">Stoppar ett jobb får det jobb körnings-ID</span><span class="sxs-lookup"><span data-stu-id="aa934-590">Stops a job given it's job execution id</span></span>

### [<span data-ttu-id="aa934-591">Stopp-AzSqlElasticPoolActivity</span><span class="sxs-lookup"><span data-stu-id="aa934-591">Stop-AzSqlElasticPoolActivity</span></span>](Stop-AzSqlElasticPoolActivity.md)
<span data-ttu-id="aa934-592">Avbryter den asynkrona uppdateringen på en elastisk pool.</span><span class="sxs-lookup"><span data-stu-id="aa934-592">Cancels the asynchronous update operation on an elastic pool.</span></span>

### [<span data-ttu-id="aa934-593">Stopp-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="aa934-593">Stop-AzSqlInstanceDatabaseLogReplay</span></span>](Stop-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="aa934-594">Avbryter loggen genom att släppa databasen.</span><span class="sxs-lookup"><span data-stu-id="aa934-594">Cancels the Log Replay service by dropping the database.</span></span>

### [<span data-ttu-id="aa934-595">Stopp-AzSqlInstanceOperation</span><span class="sxs-lookup"><span data-stu-id="aa934-595">Stop-AzSqlInstanceOperation</span></span>](Stop-AzSqlInstanceOperation.md)
<span data-ttu-id="aa934-596">Stoppar en SQL-hanterad instanss operationer.</span><span class="sxs-lookup"><span data-stu-id="aa934-596">Stops a SQL managed instance's operations.</span></span>

### [<span data-ttu-id="aa934-597">Stopp-AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="aa934-597">Stop-AzSqlSyncGroupSync</span></span>](Stop-AzSqlSyncGroupSync.md)
<span data-ttu-id="aa934-598">Stoppar en synkronisering av en synkroniseringsresurs.</span><span class="sxs-lookup"><span data-stu-id="aa934-598">Stops a sync group synchronization.</span></span>

### [<span data-ttu-id="aa934-599">Suspend-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="aa934-599">Suspend-AzSqlDatabase</span></span>](Suspend-AzSqlDatabase.md)
<span data-ttu-id="aa934-600">Avbryter en SQL Data Warehouse-databas.</span><span class="sxs-lookup"><span data-stu-id="aa934-600">Suspends a SQL Data Warehouse database.</span></span>

### [<span data-ttu-id="aa934-601">Switch-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="aa934-601">Switch-AzSqlDatabaseFailoverGroup</span></span>](Switch-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="aa934-602">Kör en redundansväxling av en failover-grupp för Azure SQL-databas.</span><span class="sxs-lookup"><span data-stu-id="aa934-602">Executes a failover of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="aa934-603">Switch-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="aa934-603">Switch-AzSqlDatabaseInstanceFailoverGroup</span></span>](Switch-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="aa934-604">Kör en redundans för en instans av en failover-grupp.</span><span class="sxs-lookup"><span data-stu-id="aa934-604">Executes a failover of an Instance Failover Group.</span></span>

### [<span data-ttu-id="aa934-605">Update-AzSqlDatabaseAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="aa934-605">Update-AzSqlDatabaseAdvancedThreatProtectionSetting</span></span>](Update-AzSqlDatabaseAdvancedThreatProtectionSetting.md)
<span data-ttu-id="aa934-606">Anger ett avancerat skydds inställningar för en databas.</span><span class="sxs-lookup"><span data-stu-id="aa934-606">Sets a advanced threat protection settings on a database.</span></span>

### [<span data-ttu-id="aa934-607">Update-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="aa934-607">Update-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="aa934-608">Uppdaterar inställningarna för sårbarhets utvärdering för en databas.</span><span class="sxs-lookup"><span data-stu-id="aa934-608">Updates the vulnerability assessment settings of a database.</span></span>

### [<span data-ttu-id="aa934-609">Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="aa934-609">Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="aa934-610">Uppdaterar inställningarna för sårbarhets utvärdering för en hanterad databas.</span><span class="sxs-lookup"><span data-stu-id="aa934-610">Updates the vulnerability assessment settings of a managed database.</span></span>

### [<span data-ttu-id="aa934-611">Update-AzSqlInstanceVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="aa934-611">Update-AzSqlInstanceVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceVulnerabilityAssessmentSetting.md)
<span data-ttu-id="aa934-612">Uppdaterar inställningarna för sårbarhets utvärdering för en hanterad instans.</span><span class="sxs-lookup"><span data-stu-id="aa934-612">Updates the vulnerability assessment settings of a managed instance.</span></span>

### [<span data-ttu-id="aa934-613">Update-AzSqlServerAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="aa934-613">Update-AzSqlServerAdvancedThreatProtectionSetting</span></span>](Update-AzSqlServerAdvancedThreatProtectionSetting.md)
<span data-ttu-id="aa934-614">Anger ett avancerat skydd på en server.</span><span class="sxs-lookup"><span data-stu-id="aa934-614">Sets a advanced threat protection settings on a server.</span></span>

### [<span data-ttu-id="aa934-615">Update-AzSqlServerVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="aa934-615">Update-AzSqlServerVulnerabilityAssessmentSetting</span></span>](Update-AzSqlServerVulnerabilityAssessmentSetting.md)
<span data-ttu-id="aa934-616">Uppdaterar inställningarna för sårbarhets utvärdering för en server.</span><span class="sxs-lookup"><span data-stu-id="aa934-616">Updates the vulnerability assessment settings of a server.</span></span>

### [<span data-ttu-id="aa934-617">Update-AzSqlSyncGroup</span><span class="sxs-lookup"><span data-stu-id="aa934-617">Update-AzSqlSyncGroup</span></span>](Update-AzSqlSyncGroup.md)
<span data-ttu-id="aa934-618">Uppdaterar en synkroniseringsresurs för en Azure SQL-databas.</span><span class="sxs-lookup"><span data-stu-id="aa934-618">Updates an Azure SQL Database Sync Group.</span></span>

### [<span data-ttu-id="aa934-619">Update-AzSqlSyncMember</span><span class="sxs-lookup"><span data-stu-id="aa934-619">Update-AzSqlSyncMember</span></span>](Update-AzSqlSyncMember.md)
<span data-ttu-id="aa934-620">Uppdaterar en synkroniserad Azure SQL-databas.</span><span class="sxs-lookup"><span data-stu-id="aa934-620">Updates an Azure SQL Database Sync Member.</span></span>

### [<span data-ttu-id="aa934-621">Update-AzSqlSyncSchema</span><span class="sxs-lookup"><span data-stu-id="aa934-621">Update-AzSqlSyncSchema</span></span>](Update-AzSqlSyncSchema.md)
<span data-ttu-id="aa934-622">Uppdatera synkroniseringsschemat för en synkroniserad medlems databas eller en databas för Lösenordssynkronisering.</span><span class="sxs-lookup"><span data-stu-id="aa934-622">Update the sync schema for a sync member database or a sync hub database.</span></span>
<span data-ttu-id="aa934-623">Den senaste databas schema från den riktiga databasen hämtas och sedan används den för att uppdatera schemat i databasen.</span><span class="sxs-lookup"><span data-stu-id="aa934-623">It will get the latest database schema from the real database and then use it refresh the schema cached by Sync metadata database.</span></span>
<span data-ttu-id="aa934-624">Om "SyncMemberName" anges uppdaterar det databasschemat för medlems databasen; Om du inte gör det kommer det att uppdatera Hub-databasschemat.</span><span class="sxs-lookup"><span data-stu-id="aa934-624">If "SyncMemberName" is specified, it will refresh the member database schema; if not, it will refresh the hub database schema.</span></span>
