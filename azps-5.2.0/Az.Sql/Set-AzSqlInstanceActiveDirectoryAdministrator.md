...
## PROBLEMBESKRIVNING
Cmdleten **set-AzSqlInstanceActiveDirectoryAdministrator** etablerar en Azure AD-administratör för AzureSQL-hanterad instans i den aktuella prenumerationen.
Du kan endast etablera en administratör åt gången.
Följande medlemmar i Azure AD kan etableras som en SQL-hanterad instans administratör:
- Egna medlemmar i Azure AD 
- Sammanslagna medlemmar i Azure AD 
- Azure AD-grupper som skapats som säkerhets grupper importerade medlemmar från andra Azure-annonser stöds inte som administratörer.
...
### Exempel 1: etablera en administratörs grupp för en hanterad instans som är associerad med resurs gruppen
```
...
Det här kommandot etablerar en Azure AD-administratörs grupp med namnet DBAs för den hanterade instans som heter ManagedInstance01.
Den här servern är kopplad till resurs gruppen ResourceGroup01.

### Exempel 2: etablera en administratörs användare med hanterat instans objekt
```
...
Det här kommandot etablerar en Azure AD-användare som administratör från den hanterade instans-objekt.

### Exempel 3: etablera en administratör med resurs-ID för hanterade instanser
```
...
Det här kommandot etablerar en Azure AD-användare som administratör med resurs-ID för hanterad instans.
