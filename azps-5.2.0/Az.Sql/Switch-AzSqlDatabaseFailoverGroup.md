...
Om parametern AllowDataLoss inte anges väntar det här kommandot tills båda rollerna har bytts. Om parametern AllowDataLoss anges väntar kommandot bara på den nya primära rollen.
