...
## PROBLEMBESKRIVNING
Cmdleten **Enable-AzSqlServerActiveDirectoryOnlyAuthentication** aktiverar Azure Active Directory (Azure AD) autentiseringskrav för en AzureSQL-server i den aktuella prenumerationen.
...
Med det här kommandot aktive ras Azure Active Directory (Azure AD) autentiseringskrav för en AzureSQL-server som heter Server01 och som är kopplad till en resurs grupp med namnet ResourceGroup01.
