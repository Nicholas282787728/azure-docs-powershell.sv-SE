...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzSqlInstancePool** tar bort en Azure SQL instance-pool.

## BESKRIVS

### Exempel 1: ta bort en instans
```powershell
PS C:\> Remove-AzSqlInstancePool -ResourceGroup resourcegroup01 -Name instancePool0
```

### Exempel 2: ta bort en instans med dess resurs identifierare
```powershell
...
### Exempel 3: ta bort en instans med ett instans objekt
```powershell
...
Det här kommandot tar bort en instans med namnet instancePool0.
...
### -InputObject
Den instans av entitetsinstansen som ska tas bort.
...
### -ResourceId
Resurs-ID för entitetsinstansen som ska tas bort.
