...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlInstanceActiveDirectoryOnlyAuthentication** får Azure Active Directory (Azure AD) autentiseringskrav endast för en AzureSQL-hanterad instans i den aktuella prenumerationen.
...
Det här kommandot får Azure Active Directory (Azure AD) autentiseringskrav endast för en AzureSQL-hanterad instans som heter ManagedInstance01 som är kopplad till en resurs grupp med namnet ResourceGroup01.
