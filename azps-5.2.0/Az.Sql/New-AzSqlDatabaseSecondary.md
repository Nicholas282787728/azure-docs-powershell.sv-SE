...
## PROBLEMBESKRIVNING
**New-AzSqlDatabaseSecondary** cmdlet ersätter Start-AzSqlDatabaseCopy cmdlet när den används för att konfigurera geo-replikering för en databas. Det returnerar det geo-replikeringslänk som är länkat till den sekundära databasen.

## BESKRIVS

### Exempel 1: etablera Active Geo-Replication
```powershell
$database = Get-AzSqlDatabase -DatabaseName $databasename -ResourceGroupName $primaryresourcegroupname -ServerName $primaryservername
$database | New-AzSqlDatabaseSecondary -PartnerResourceGroupName $secondaryresourcegroupname -PartnerServerName $secondaryservername -AllowConnections "All"
```

### Exempel 2: etablera Active Geo-Replication och ange partner databasens namn som inte är käll databasens namn
```powershell
$database = Get-AzSqlDatabase -DatabaseName $databasename -ResourceGroupName $primaryresourcegroupname -ServerName $primaryservername
...
### -PartnerDatabaseName
Namnet på den sekundära databasen som ska skapas.
