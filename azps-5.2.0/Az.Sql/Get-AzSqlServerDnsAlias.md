...
## PROBLEMBESKRIVNING
Hämta det specifika DNS-aliaset för Azure SQL Server eller en lista över alla Server-DNS-alias för servern
...
Visar alla DNS-alias för servrar för den specifika servern
...
Hämtar Server-DNS-alias som anges av Server-och aliasnamn
...
Visar alla DNS-alias för servrar för den specifika server som börjar med "dnsaliasname".
