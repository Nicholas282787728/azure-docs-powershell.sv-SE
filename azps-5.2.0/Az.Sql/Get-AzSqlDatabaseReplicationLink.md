...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzSqlDatabaseReplicationLink** ersätter cmdleten **Get-AzSqlDatabaseCopy** .
...
Hämtar Länkar för geo-replikering mellan en Azure SQL-databas och en resurs grupp eller SQL Server. (automatiskt genererat)
