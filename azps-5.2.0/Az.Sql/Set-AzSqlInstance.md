...
## PROBLEMBESKRIVNING
Cmdleten **set-AzSqlInstance** ändrar egenskaper för en hanterad Azure SQL-databas.

## BESKRIVS

### Exempel 1: Ange befintlig instans med nya värden för-AdministratorPassword,-LicenseType,-StorageSizeInGB,-VCore och-Edition
```powershell
...
### Exempel 2: ändra befintlig instans maskin varu generation med nytt värde för-ComputeGeneration
```powershell
...
Det här kommandot anger en befintlig instans med nya värden för-AdministratorPassword,-LicenseType,-StorageSizeInGB och-VCore

### Exempel 3: Ange befintlig instans med nya värden för-AdministratorPassword,-LicenseType,-StorageSizeInGB och-VCore för en instans i en instans
```powershell
PS C:\>$InstancePassword = "Newpassword1234"
PS C:\> $SecureString = ConvertTo-SecureString $InstancePassword -AsPlainText -Force
...
Det här kommandot anger en befintlig instans med nya värden för-AdministratorPassword,-LicenseType,-StorageSizeInGB och-VCore för en instans i en instans

## MALLPARAMETRAR

### -AdministratorPassword
Det nya administratörs lösen ordet för instansen.
...
### -AssignIdentity
Skapa och tilldela en Azure Active Directory-identitet för den här instansen för användning med Key Management Services som Azure-valv.
...
### -Utgåva
Den version som ska kopplas till instansen.
...
ID-konfigurationsfilen för den SQL Azure-hanterade instansen.
...
### -ResourceId
ID för den instans som ska tas bort
...
### -Tagg
De taggar som ska kopplas till förekomsten.
