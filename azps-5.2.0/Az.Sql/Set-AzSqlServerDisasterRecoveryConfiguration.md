...
## PROBLEMBESKRIVNING
Cmdleten **set-AzSqlServerDisasterRecoveryConfiguration** ändrar en återställnings konfiguration för SQL-serverdatabasen.
...
### -AllowDataLoss
Visar att Redundansåtgärden tillåter data förlust.
