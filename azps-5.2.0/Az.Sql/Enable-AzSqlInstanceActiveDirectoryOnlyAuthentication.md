...
## PROBLEMBESKRIVNING
Cmdleten **Enable-AzSqlInstanceActiveDirectoryOnlyAuthentication** aktiverar Azure Active Directory (Azure AD) autentiseringskrav endast för en AzureSQL-hanterad instans i den aktuella prenumerationen.
...
Det här kommandot aktiverar endast Azure Active Directory (Azure AD) autentiseringskrav för en AzureSQL-hanterad instans som heter ManagedInstance01 som är kopplad till en resurs grupp med namnet ResourceGroup01.
