...
## PROBLEMBESKRIVNING
Med Enable-AzSqlInstanceDatabaseSensitivityRecommendation cmdlet aktive ras känslighets rekommendationer för kolumner i Azure SQL-hanterade instans databasen.

## BESKRIVS

### Exempel 1: Aktivera känslighets rekommendationer för en viss kolumn i en Azure SQL-hanterad instans-databas.
```powershell
...
### Exempel 2: Aktivera känslighets rekommendationer för en viss kolumn i en Azure SQL-hanterad instans med rör.
```powershell
