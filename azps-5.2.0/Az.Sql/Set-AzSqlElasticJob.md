...
## PROBLEMBESKRIVNING
Set-AzSqlElasticJob cmdlet uppdaterar ett jobb

## BESKRIVS

### Exempel 1: uppdaterar ett jobb för att starta en timme från och med Upprepa 1 timme
```powershell
...
### -Aktivera
Flaggan som visar vilken kund som ska vara aktive rad.
...
### -IntervalCount
Intervallet för återkommande schema
...
### -IntervalType
Det återkommande intervallet för schema – kan vara minut, timme, dag, vecka, månad
...
### -RunOnce
Flaggan som visar att jobbet körs en gång
