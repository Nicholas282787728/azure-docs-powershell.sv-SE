...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzInvoiceSection** hämtar faktura avsnitt under den angivna fakturerings profilen. 
...
Hämta alla faktura avsnitt under den angivna fakturerings profilen.
...
Gå till avsnittet faktura med angivet namn.
...
### -BillingProfileName
Namnet på den specifika fakturerings profilen.
...
### -Namn
Namn på ett specifikt faktura avsnitt.
