...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzConsumptionReservationDetail** hämtar information om reservationer för angivet datum intervall.

## BESKRIVS

### Exempel 1: Hämta reservations uppgifter med reservations order-ID för angivet datum intervall
```powershell
...
### Exempel 2: Hämta reservations uppgifter med reservations order-ID och reservations-ID för det datum intervall som anges
```powershell
...
### -EndDate
Slutdatumet (ÅÅÅÅ-MM-DD i UTC) av reservations informationen.
...
### -StartDate
Start data (ÅÅÅÅ-MM-DD i UTC) av reservations informationen.
...
### Microsoft. Azure. commands. förbrukning. Models. PSReservationDetail
