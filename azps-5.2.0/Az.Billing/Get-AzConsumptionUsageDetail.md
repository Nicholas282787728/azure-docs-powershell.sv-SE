...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzConsumptionUsageDetail** hämtar användnings information för abonnemanget. 

## BESKRIVS

### Exempel 1: Hämta information om användning med MeterDetails
```powershell
...
### Exempel 2: Hämta information om användning med datum intervall
```powershell
...
### Exempel 3: Hämta information om användning av BillingPeriodName med filtret InstanceName
```powershell
...
### -EndDate
Slutdatumet (i UTC) för de användningar som ska filtreras.
...
### -Expandera
Utöka användningarna baserat på MeterDetails eller AdditionalInfo.
...
### -InstanceId
Instans-ID för de användningar som ska filtreras.
...
### -InstanceName
Instans namnet på den användning som ska filtreras.
...
### -ResourceGroup
Resurs gruppen för de användningar som ska filtreras.
...
### -StartDate
Start datumet (i UTC) för de användningar som ska filtreras.
...
### Microsoft. Azure. commands. förbrukning. Models. PSUsageDetail
