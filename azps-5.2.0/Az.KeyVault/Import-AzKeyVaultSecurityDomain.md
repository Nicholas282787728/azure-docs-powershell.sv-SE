...
## PROBLEMBESKRIVNING
Denna cmdlet importerar tidigare exporterade säkerhets domän data till en hanterad HSM.
...
Först måste nycklarna tillhandahållas för att dekryptera säkerhets domän data.
Då återställer kommandot **import-AzKeyVaultSecurityDomain** säkerhets domän data som har säkerhetskopierats till en hanterad HSM med de här nycklarna.
...
### -Tangenter
Information om de nycklar som används för att dekryptera säkerhets domän data.
Se exempel på hur den är konstruerad.
...
### -SecurityDomainPath
Ange sökvägen till den krypterade säkerhets domän informationen.
