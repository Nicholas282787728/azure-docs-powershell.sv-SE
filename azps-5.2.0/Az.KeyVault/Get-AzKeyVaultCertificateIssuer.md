...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzKeyVaultCertificateIssuer** hämtar en angiven certifikat utfärdare eller alla certifikat utfärdare för ett nyckeltal i Azure Key Vault.
...
### Exempel 2: Visa en lista med certifikat utfärdare med hjälp av filtrering
```powershell
...
Det här kommandot får de certifikat utfärdare som börjar med "test".
