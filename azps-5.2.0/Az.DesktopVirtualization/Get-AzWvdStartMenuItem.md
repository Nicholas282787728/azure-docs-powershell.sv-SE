...
### Exempel 2: lista objekt på Start-menyn i Windows Virtual Desktop
```powershell
...
Det här kommandot visar objekt på Start-menyn i en applicaton-grupp.
...
### Microsoft. Azure. PowerShell. cmdletar. DesktopVirtualization. Models. Api20201019Preview. IStartMenuItem
