...
### Exempel 1: ta bort en Windows Virtual Desktop SessionHost efter namn
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Det här kommandot tar bort en Windows Virtual Desktop-SessionHost i en adresspool.
...
### -Force
Tvinga flaggan att tvinga sessionHost borttagning även när userSession finns.
