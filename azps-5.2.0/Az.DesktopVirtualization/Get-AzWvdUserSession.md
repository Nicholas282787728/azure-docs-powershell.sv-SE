...
### Exempel 1: skaffa en Windows Virtual Desktop-UserSession med namn
```powershell
...
Det här kommandot får en Windows Virtual Desktop-UserSession i en sessionsnyckel.

### Exempel 2: lista UserSessions för virtuella skriv bord i Windows
```powershell
...
Det här kommandot listar en UserSessions för Windows Virtual Desktop i en sessionsnyckel.

### Exempel 3: lista UserSessions virtuella skriv bord i Windows i pool
```powershell
...
Det här kommandot listar en Windows Virtual Desktop-UserSessions i en sessionsnyckel i en adresspool.
...
Giltiga egenskaper för filtrering är userPrincipalName och sessionState.
...
### Microsoft. Azure. PowerShell. cmdletar. DesktopVirtualization. Models. Api20201019Preview. IUserSession
