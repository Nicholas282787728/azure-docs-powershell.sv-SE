...
### Exempel 1: skapa ett virtuellt Skriv bords program för Windows
```powershell
...
Det här kommandot skapar ett virtuellt Windows-program i en applicaton-grupp.

## MALLPARAMETRAR

### -AppAlias
Program Ali Aset från Start-menyn
...
### -CommandLineArgument
Kommando rads argument för programmet.
...
### -CommandLineSetting
Anger om det här publicerade programmet kan startas med kommando rads argument som tillhandahålls av klienten, kommando rads argument som angetts vid publicerings tillfället eller inga kommando rads argument alls.
...
### -Sökväg
Anger en sökväg till den körbara filen för programmet.
...
Anger paket programmets ID för MSIX-program
...
Anger namnet på paket familjen för MSIX-program
...
### -ShowInPortal
Anger om RemoteApp-programmet ska visas i servern för webb åtkomst för fjärr skrivbord.
...
### Microsoft. Azure. PowerShell. cmdletar. DesktopVirtualization. Models. Api20201019Preview. IApplication
