...
### -CloudBlob
CloudBlob-objekt från klient bibliotek för Azure-lagring. Du kan skapa det eller använda Get-AzStorageBlob cmdlet.
...
### -CloudBlobContainer
CloudBlobContainer-objekt från klient bibliotek för Azure-lagring. Du kan skapa det eller använda Get-AzStorageContainer cmdlet.
...
### -Kontext
Käll Azure-lagringsplatsen. Du kan skapa den via New-AzStorageContext cmdlet.
...
### -DestContext
Mål Azure-lagrings kontext. Du kan skapa den via New-AzStorageContext cmdlet.
