...
## PROBLEMBESKRIVNING
Cmdleten **set-AzStorageShareQuota** anger lagrings kapaciteten för en viss resurs.
...
Se kvot begränsningen i https://docs.microsoft.com/en-us/azure/azure-subscription-service-limits#azure-files-limits . 
