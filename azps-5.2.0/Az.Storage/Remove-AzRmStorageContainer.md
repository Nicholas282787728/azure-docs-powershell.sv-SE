...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzRmStorageContainer** tar bort en lagrings-BLOB-behållare

## BESKRIVS

### Exempel 1: ta bort en lagrings-BLOB-behållare med lagrings konto namn och container namn
```
PS C:\>Remove-AzRmStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" -ContainerName "myContainer"
```

Det här kommandot tar bort en lagrings-BLOB med lagrings konto namn och container namn.

### Exempel 2: ta bort en lagrings-BLOB-behållare med lagrings konto objekt och container namn
```
PS C:\>$accountObject = Get-AzStorageAccount -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount"
PS C:\>Remove-AzRmStorageContainer -StorageAccount $accountObject -ContainerName "myContainer"
```

Det här kommandot tar bort en lagrings-BLOB-behållare med lagrings konto objekt och container namn.

### Exempel 3: ta bort alla lagrings-BLOB-behållare i ett lagrings konto med pipeline
```
PS C:\>Get-AzStorageContainer -ResourceGroupName "myResourceGroup" -AccountName "myStorageAccount" | Remove-AzRmStorageContainer -Force
```

Det här kommandot tar bort alla lagrings-BLOB-behållare i ett lagrings konto med pipeline.
...
### -Force
Tvinga att ta bort behållaren och allt innehåll i den
