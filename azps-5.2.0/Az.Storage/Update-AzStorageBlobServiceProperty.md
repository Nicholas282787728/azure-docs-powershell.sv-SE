...
### Exempel 2: Aktivera Changefeed i Blob-tjänsten för ett lagrings konto
```
...
Det här kommandot aktiverar Changefeed för Blob-tjänsten för ett lagrings konto för byte av feed-stöd i Azure Blob Storage för att avlyssna ett GPv2-eller BLOB lagrings konto för att skapa, ändra eller ta bort BLOB-händelser. Sedan sparas en ordnad logg över händelser för de blob som lagras i $blobchangefeed-behållaren i lagrings kontot. De Serialiserade ändringarna bevaras som en Apache avro-fil och kan behandlas asynkront och stegvis.

### Exempel 3: Aktivera versions hantering för Blob-tjänsten för ett lagrings konto
```
...
Det här kommandot aktiverar versions hantering för Blob-tjänsten för ett lagrings konto
...
### -EnableChangeFeed
Aktivera ändra feed-loggning för lagrings kontot genom att ange $true och inaktivera ändra feed-loggning genom att ange $false.
...
### -IsVersioningEnabled
Hämtar eller anger versions hantering är aktiverat om värdet är true.
