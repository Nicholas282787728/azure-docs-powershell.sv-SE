...
## PROBLEMBESKRIVNING
Cmdleten **set-AzWebApp** anger en Azure Web App-plats.
...
Det här kommandot ändrar det AppService-abonnemang som är associerat med Slot001, på webapp-ContosoWebApp som är kopplad till resurs gruppens standard-väst. Använd länken för att lära dig mer om hur du ändrar AppService plan och vilka villkor som är associerade med den.
...
Det här kommandot anger HttpLoggingEnabled till sant för fack Slot001 som hör till Web App-ContosoWebApp som är kopplad till resurs gruppens standard-väst

### Exempel 3

Ändrar en Azure Web App-plats. (automatiskt genererat)
...
### -AssignIdentity
Aktivera/inaktivera MSI på en befintlig plats [för hands version]
...
### -HttpsOnly
Aktivera/inaktivera all trafik till HTTPS på en befintlig plats
...
Begäran om spårning aktiverat boolesk
