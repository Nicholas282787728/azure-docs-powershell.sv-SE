...
## PROBLEMBESKRIVNING
Cmdleten **New-AzAppServicePlan** skapar en Azure App Service-plan på en given Geo-plats med den angivna nivån, arbetarens arbets storlek och antalet arbetare.
...
### -HyperV
Ange detta program tjänst abonnemang kör Windows-behållare
