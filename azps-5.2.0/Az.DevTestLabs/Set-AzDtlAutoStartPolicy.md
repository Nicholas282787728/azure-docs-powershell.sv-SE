...
## PROBLEMBESKRIVNING
Cmdleten **set-AzDtlAutoStartPolicy** anger den automatiska start principen för ett labb som tillåter att virtuella laboratorie datorer schemaläggs för automatisk start.
...
Ställer in en policy för automatisk start för ett labb i DevTest Labs. (automatiskt genererat)
...
### -Dagar
Anger, i en matris, veckans vecko dagar när de virtuella datorerna i Lab måste startas.
...
### -Inaktivera
Anger att denna cmdlet inaktiverar principen för de virtuella datorerna i laboratoriet.
...
### -Aktivera
Anger att denna cmdlet aktiverar principen för de virtuella datorerna i laboratoriet.
...
### -LabName
Anger namnet på den Lab för vilken den här cmdleten ställer in principen för automatisk start.
...
### -Tid
Anger den tid då de virtuella datorerna i laboratoriet måste startas.
