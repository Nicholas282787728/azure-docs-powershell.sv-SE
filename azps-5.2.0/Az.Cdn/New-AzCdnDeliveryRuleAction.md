...
### -Mål
Definiera den relativa URL-adressen som de ovanstående begäranden kommer att återskrivas av.
...
### -PreservePath
Om omatchad sökväg ska bevaras.
...
### -QueryParameter
Frågeparametrar som ska inkluderas eller exkluderas (kommaavgränsad).
...
### -QueryStringBehavior
QueryString-beteende för begär Anden
...
### -SourcePattern
Definiera ett URI-mönster för begärande som identifierar typen av begär Anden som kan skrivas över. Om värde är tomt matchas alla strängar.
