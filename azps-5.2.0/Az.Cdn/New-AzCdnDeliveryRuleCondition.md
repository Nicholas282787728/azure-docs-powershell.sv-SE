...
### -MatchValue
Lista med möjliga matchnings värden.
...
### -NegateCondition
Här beskrivs hur det här villkoret ska negeras.
...
### -Selector
Namn på väljaren som ska matchas
...
### -Omvandla
Omvandla för att tillämpas före matchning.
Möjliga värden är gemener och versaler
