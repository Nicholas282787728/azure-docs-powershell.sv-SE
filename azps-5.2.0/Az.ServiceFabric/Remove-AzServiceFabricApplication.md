...
## Sammanfattning
Ta bort ett program från klustret. Detta tar bort alla tjänster under programmet. Stöder endast program som distribueras av armar.
...
## PROBLEMBESKRIVNING
Denna cmdlet tar bort ett program från klustret. Detta tar bort alla tjänster under program resursen.
...
I det här exemplet tas programmet "testApp" bort under resurs gruppen "testRG" och kluster "testCluster".
