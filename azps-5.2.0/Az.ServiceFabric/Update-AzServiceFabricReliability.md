...
## PROBLEMBESKRIVNING
Använd **Update-AzServiceFabricReliability** för att uppdatera tillförlitligheten för den primära nodtypen i ett kluster.
...
Det här kommandot ändrar Tillförlitlighets nivån för den primära nodtypen till silver.

### Exempel 2

Uppdatera Tillförlitlighets nivån för den primära nodtypen i ett kluster. (automatiskt genererat)
...
### -AutoAddNode
Lägga till antal regioner automatiskt när du ändrar pålitlighet
