...
## Sammanfattning
Hämta versions information för Service Fabric program typ. Det går endast att använda program typer som distribueras av ARM.
...
I det här exemplet hämtas program typen "testAppType" med version "v1", om den inte hittar den resurs som det ger upphov till.
...
I det här exemplet visas en lista med de program typer som definierats för klustret och typen.
...
### -Version
Ange versionen för program typen.
