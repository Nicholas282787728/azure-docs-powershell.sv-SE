...
Uppdatera DNS-namn och klient anslutnings port för klustret.
...
Uppdatera DNS-namn och klient anslutnings portar för klustret med rör dragning.
...
Port som används för klient anslutningar till klustret. Standard: 19000.
...
### -CodeVersion
Kluster kod version. Använd endast om uppgraderings läget är manuell.
...
### -UpgradeMode
Uppgraderings läge för kluster kod version. Automatisk eller manuell.
