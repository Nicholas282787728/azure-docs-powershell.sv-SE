...
## PROBLEMBESKRIVNING
Använd **Add-AzServiceFabricNode** för att lägga till noder till den specifika nodtypen. Du behöver bara ange antalet noder som du vill lägga till i en nodtyp.
