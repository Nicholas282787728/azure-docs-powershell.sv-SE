...
## PROBLEMBESKRIVNING
New-AzSqlVMGroup cmdlet skapar en virtuell Azure SQL-dator grupp.
...
Skapar en ny virtuell dator grupp för Azure SQL med test-gruppdatorn i resurs gruppen ResourceGroup01.
$profile är ett objekt av typen Microsoft. Azure. Management. SqlVirtualMachine. Models. WsfcDomainProfile
...
Namn som används för att skapa kluster
...
Namn som används för operativ kluster
...
### -DomainFqdn
Fullständigt kvalificerat namn på domänen
...
Valfri sökväg för fileshare-vittne
...
### -Plats
Plats för virtuell dator grupp i SQL.
...
### -OuPath
Sökväg till Organisationsenhet där noder och kluster visas
...
### -SKU
Typ av virtuell SQL-dator-grupp.
...
### -SqlServiceAccount
Det namn som SQL-tjänsten körs på för alla deltagande SQL-datorer i klustret
...
Primärt för vittnes lagrings kontot
...
### -Tagg
De taggar som ska kopplas till den virtuella SQL-gruppen.
