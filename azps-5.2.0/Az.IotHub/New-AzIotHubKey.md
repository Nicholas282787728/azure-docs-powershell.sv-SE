...
### Exempel 1 återskapa primär nyckeln
```
...
Den omgenererade primär nyckeln för auktoriseringsprincipen "testKey" i ett Azure IoT Hub.

### Exempel 2 byter nycklar
```
...
Utbytes nycklar för auktoriseringsprincipen "testKey" i ett Azure IoT Hub.
