...
## PROBLEMBESKRIVNING
Få information om vägen. Du kan hämta alla vägar från en IoT Hub, Hämta vägar till en typ av slut punkt eller hämta vägar till en viss slut punkt.
...
Få vägen från "myiothub" IoT Hub.
...
Få väg information från "myiothub" IoT Hub.
