...
## PROBLEMBESKRIVNING
Skapa en enhet med olika godkännande typer i en IoT-hubb.
...
Skapa en Edge-aktiverad IoT-enhet med standard verifiering (delad privat telefon).
...
Skapa en IoT-enhet med certifikat utfärdarens verifiering med inaktiverat status och orsak.
...
Skapa en underordnad IoT-enhet och Lägg till underenheter till den.
...
Skapa en IoT-enhet och ange överordnad enhet.
...
### -Underordnade
Lägga till underordnad enhets lista (kommaavgränsad) inkluderar bara icke-Edge-enheter.
...
### -Force
Skriver över den överordnade enheten för den icke-fristående enheten.
