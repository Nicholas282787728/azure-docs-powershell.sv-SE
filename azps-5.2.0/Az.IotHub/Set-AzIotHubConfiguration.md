...
## PROBLEMBESKRIVNING
Uppdatera angivna egenskaper för en IoT-konfiguration för automatisk enhets hantering.
Obs! konfigurations innehåll ändras inte. Konfigurations egenskaper som kan uppdateras är ' etiketter ', ' mått ', ' Priority ' och ' targetCondition '.
...
Ändra prioriteten för en enhets konfiguration och uppdatera dess mål villkor
...
Uppdatera måtten och etiketterna för en enhets konfiguration
...
### -Force
Tillåter att konfigurations objekt byts ut även om det har uppdaterats sedan det hämtades förra gången.
