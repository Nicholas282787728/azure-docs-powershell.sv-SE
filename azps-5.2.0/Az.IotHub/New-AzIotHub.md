...
## PROBLEMBESKRIVNING
Skapar en ny IotHub.
Du kan skapa IotHub med antingen standard egenskaperna eller ange indata.
...
Skapar en ny IotHub med namnet "myiothub" för SKU: n "S1", Capacity 1 och location "northeurope" med taggar.
...
### -Tagg
IoT Hub instance-taggar. Egenskaps uppsättning i nyckel värde par i form av en hash-tabell.
