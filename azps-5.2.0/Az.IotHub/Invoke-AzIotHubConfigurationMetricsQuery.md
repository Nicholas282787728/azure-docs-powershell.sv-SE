...
## PROBLEMBESKRIVNING
Utvärdera en anpassad mål-eller system mått definition i en IoT-enhets konfiguration.
Det finns fördefinierade system värden som beräknas av IoT Hub och inte kan anpassas.
- "Riktat" anger antalet enheter som matchar mål villkoret.
- "Använt" angivet antal enheter som har ändrats med konfigurationen. 
...
Utvärdera systemet som "tillämpat"-mått.
