...
ConflictResolutionPolicy-objekt av typen PSConflictResolutionPolicy om det här är angivet som ConflictResolutionPolicy för behållaren.
...
### -IndexingPolicy
Indexerings princip objekt av typen Microsoft. Azure. commands. CosmosDB. PSIndexingPolicy.
...
### -UniqueKeyPolicy
UniqueKeyPolicy-objekt av typen Microsoft. Azure. commands. CosmosDB. PSUniqueKeyPolicy.
