...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzCosmosDBSqlUserDefinedFunction** tar bort den CosmosDB SQL-UserDefinedFunction som motsvarar angivet ResourceGroupName, AccountName och databasename.
...
### -InputObject
SQL-användardefinierat funktions objekt
