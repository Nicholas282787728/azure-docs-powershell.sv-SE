...
## Sammanfattning
Hämtar genomflödet-värdet för Cassandra-tecken.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzCosmosDBCassandraKeyspaceThroughput** hämtar det genomflöde-objekt som motsvarar ett givet tecken.
