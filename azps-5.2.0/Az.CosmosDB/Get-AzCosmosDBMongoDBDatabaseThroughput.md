...
## Sammanfattning
Hämtar CosmosDB genomflöde-egenskaper för MongoDB-databas.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzCosmosDBMongoDBDatabaseThroughput** hämtar genomflödet-egenskaperna för MongoDB-databasen.
