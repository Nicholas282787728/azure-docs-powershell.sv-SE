...
## Sammanfattning
Hämtar värdet för data flödet i Cassandra-tabellen.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzCosmosDBCassandraTableThroughput** hämtar det genomflöde-objekt som motsvarar ett givet tecken.
