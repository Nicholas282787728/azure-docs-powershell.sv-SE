...
Skapar ett nytt CosmosDB Cassandra.
...
Skapar en ny CosmosDB Cassandra-tabell.
...
Skapar en ny CosmosDB Gremlin-databas.

### [New-AzCosmosDBGremlinGraph](New-AzCosmosDBGremlinGraph.md)
Skapar ett nytt CosmosDB Gremlin-diagram.
...
Skapar en ny CosmosDB MongoDB-samling.

### [New-AzCosmosDBMongoDBDatabase](New-AzCosmosDBMongoDBDatabase.md)
Skapar en ny CosmosDB MongoDB-databas.
...
Skapar en ny CosmosDB SQL-behållare.

### [New-AzCosmosDBSqlDatabase](New-AzCosmosDBSqlDatabase.md)
Skapar en ny CosmosDB SQL-databas.
...
Skapar en ny CosmosDB SQL-StoredProcedure.

### [New-AzCosmosDBSqlTrigger](New-AzCosmosDBSqlTrigger.md)
Skapar en ny CosmosDB SQL-utlösare.
...
Skapar en ny CosmosDB SQL-UserDefinedFunction.

### [New-AzCosmosDBTable](New-AzCosmosDBTable.md)
Skapar en ny CosmosDB-tabell.
...
Uppdaterar CosmosDB MongoDB-samlingen. Utför en klient uppdaterings åtgärd genom att läsa den befintliga samlingen.
...
Uppdaterar CosmosDB MongoDB-databasen. Utför en klient uppdaterings åtgärd genom att läsa den befintliga databasen.

### [Update-AzCosmosDBMongoDBDatabaseThroughput](Update-AzCosmosDBMongoDBDatabaseThroughput.md)
Uppdaterar genomflödet för en CosmosDB MongoDB-databas.

### [Update-AzCosmosDBSqlContainer](Update-AzCosmosDBSqlContainer.md)
Uppdaterar SQL-containern för CosmosDB. Utför en klient uppdaterings åtgärd genom att läsa den befintliga behållaren.

### [Update-AzCosmosDBSqlContainerThroughput](Update-AzCosmosDBSqlContainerThroughput.md)
Uppdaterar genomflödet för en CosmosDB SQL-behållare.

### [Update-AzCosmosDBSqlDatabase](Update-AzCosmosDBSqlDatabase.md)
Uppdaterar SQL-databasen CosmosDB. Utför en klient uppdaterings åtgärd genom att läsa den befintliga databasen.
...
Uppdaterar CosmosDB SQL-StoredProcedure. Utför en klient uppdaterings åtgärd genom att läsa de befintliga StoredProcedure.

### [Update-AzCosmosDBSqlTrigger](Update-AzCosmosDBSqlTrigger.md)
Uppdaterar SQL-utlösaren CosmosDB. Utför en klient uppdaterings åtgärd genom att läsa den befintliga utlösaren.

### [Update-AzCosmosDBSqlUserDefinedFunction](Update-AzCosmosDBSqlUserDefinedFunction.md)
Uppdaterar CosmosDB SQL-UserDefinedFunction. Utför en klient uppdaterings åtgärd genom att läsa de befintliga UserDefinedFunction.

### [Update-AzCosmosDBTable](Update-AzCosmosDBTable.md)
Uppdaterar tabellen CosmosDB. Utför en klient uppdaterings åtgärd genom att läsa den befintliga tabellen.

### [Update-AzCosmosDBTableThroughput](Update-AzCosmosDBTableThroughput.md)
Uppdaterar genomflödet för en CosmosDB-tabell.