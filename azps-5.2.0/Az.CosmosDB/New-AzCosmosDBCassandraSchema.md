...
## Sammanfattning
Skapar ett nytt CosmosDB Cassandra-schema.
...
## PROBLEMBESKRIVNING
**New-AzCosmosDBCassandraSchema** skapar ett nytt CosmosDB Cassandra-schema.
...
### -PartitionKey
Matris med strängar som innehåller partitionsalternativ.
