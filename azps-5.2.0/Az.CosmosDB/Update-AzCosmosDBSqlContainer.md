...
ConflictResolutionPolicy-objekt av typen PSSqlConflictResolutionPolicy om det här är angivet som ConflictResolutionPolicy för behållaren.
...
Om det anges tillsammans med parametern ConflictResolutionPolicy ignoreras den.
...
### -IndexingPolicy
Indexerings princip objekt av typen Microsoft. Azure. commands. CosmosDB. PSSqlIndexingPolicy.
...
### -PartitionKeyKind
Den typ av algoritm som används för att partitionera.
Möjliga värden är: ' hash ', ' område '
...
### -PartitionKeyPath
Sökväg till partitionsnyckel, till exempel "/Address/zipcode".
...
### -PartitionKeyVersion
Versionen av partitionsnyckel-definitionen
...
Om värdet saknas eller är-1 går det inte att utgå från objekt.
Om värdet är inställt på n kommer artiklar att gå ut n sekunder efter den senaste ändringen.
...
### -UniqueKeyPolicy
UniqueKeyPolicy-objekt av typen Microsoft. Azure. commands. CosmosDB. PSSqlUniqueKeyPolicy.
