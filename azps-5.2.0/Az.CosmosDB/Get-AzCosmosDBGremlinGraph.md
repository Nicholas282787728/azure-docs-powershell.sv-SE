...
## Sammanfattning
Hämtar diagrammet CosmosDB Gremlin.
...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzCosmosDBGremlinGraph** hämtar diagram egenskaperna för CosmosDB Gremlin.
...
Resource-objekt innehåller IndexingPolicy, PartitionKey, DefaultTtl, UniqueKeyPolicy, ConflictResolutionPolicy, _rid, _ts, _etag.
