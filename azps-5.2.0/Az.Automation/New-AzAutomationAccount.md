...
## PROBLEMBESKRIVNING
Cmdleten **New-AzAutomationAccount** skapar ett Azure Automation-konto i en resurs grupp.
...
Skapar ett Automation-konto. (automatiskt genererat)
...
Använd Get-AzLocation cmdlet för att få giltiga platser.
