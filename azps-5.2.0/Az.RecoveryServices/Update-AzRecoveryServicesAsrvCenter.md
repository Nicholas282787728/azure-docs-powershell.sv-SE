...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzRecoveryServicesAsrvCenter** uppdaterar identifierings information för en registrerad vCenter.
...
### -Konto
konto för inloggnings uppgifter för vCenter.
...
### -InputObject
VCenter-serverobjektet för att uppdatera identifierings information för.
