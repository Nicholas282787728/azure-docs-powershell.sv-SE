...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzRecoveryServicesVaultProperty** returnerar egenskaperna för ett Recovery Services-valv.

## BESKRIVS

### Exempel 1: Hämta egenskaper för ett valv
```
...
Det andra kommandot får egenskaperna för valvet.
