...
## PROBLEMBESKRIVNING
Cmdleten **Start-AzRecoveryServicesAsrUnplannedFailoverJob** startar oplanerad redundans av ett skyddat objekt eller en återställnings plan för Azure Site Recovery.
Du kan kontrol lera om jobbet lyckades med Get-AzRecoveryServicesAsrJob cmdlet.
...
Startar den oplanerade redundansväxlingen för återställnings planen med de angivna parametrarna och returnerar det ASR-jobb som används för att spåra åtgärden.

### Exempel 2

Startar en oplanerad redundansväxling. (automatiskt genererat)
...
Anger sökvägen till primär certifikat för data kryptering för redundansväxling av skyddat objekt.
...
Anger sökvägen till den sekundära certifikat filen för data kryptering för redundansväxling av skyddat objekt.
...
Utför åtgärden på käll sidan innan oplanerad redundans startas.
...
### -RecoveryPoint
Anger en anpassad återställnings punkt för att redundansväxla den skyddade datorn till.
...
### -RecoveryTag
Anger återställnings tag gen till redundans.
...
Anger ett skyddat objekt i Azure Site Recovery-objektet.
