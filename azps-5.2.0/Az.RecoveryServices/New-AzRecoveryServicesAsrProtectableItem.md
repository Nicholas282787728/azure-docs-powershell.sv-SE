...
## PROBLEMBESKRIVNING
**New-AzRecoveryServicesAsrProtectableItem** lägger till ett nytt skydd bara objekt i listan över identifierade skydds bara objekt i en skydds behållare i en ASR-Fabric (gäller endast för VMware Fabric-typen).

## BESKRIVS

### Exempel 1

Lägga till (upptäcka) en fysisk server i listan över skydd bara objekt. (automatiskt genererat)
