...
Lägger till en vCenter-Server för att upptäcka objekt som skyddas från. (automatiskt genererat)
...
### -Konto
Konto för inloggnings uppgifter för användare.
