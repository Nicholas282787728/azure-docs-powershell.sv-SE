...
### Exempel 2: uppdatera metadata för en princip uppsättnings definition
```
...
Det här kommandot uppdaterar metadata för en princip uppsättnings definition med namnet VMPolicySetDefinition för att visa att kategorin är "virtuell dator".

### Exempel 3: uppdatera grupperna i en definition för princip uppsättningar
```
...
Det här kommandot uppdaterar grupperna för en princip uppsättnings definition med namnet VMPolicySetDefinition.

### Exempel 4: uppdatera gruppens grupper med hjälp av en hash-tabell
```
$groupsJson = ConvertTo-Json @{ name = "group1", displayName = "Virtual Machine Security" }, @{ name = "group2" }
PS C:\> Set-AzPolicySetDefinition -Name 'VMPolicySetDefinition' -GroupDefinition $groupsJson
```

Det här kommandot uppdaterar grupperna för en princip uppsättnings definition med namnet VMPolicySetDefinition med hjälp av en hash-tabell för att skapa grupper.
...
### -GroupDefinition
Princip definitions grupperna för den uppdaterade definitionen för princip uppsättningar. Det kan antingen vara en sökväg till en fil som innehåller grupperna eller grupperna som en JSON-sträng.
...
### -InputObject
Det definitions objekt för princip uppsättning att uppdatera som skapades från en annan cmdlet.
...
### -Metadata
Metadata för den uppdaterade definitionen för princip uppsättningar. Det kan vara en sökväg till ett fil namn som innehåller metadata, eller metadata som en JSON-sträng.
...
### -Parameter
Parameter deklarationen för den uppdaterade definitionen för princip uppsättningar. Det kan antingen vara en sökväg till ett fil namn eller en URI som innehåller parameter deklarationen eller parameter deklarationen som en JSON-sträng.
