...
## PROBLEMBESKRIVNING
Cmdleten **Save-AzResourceGroupDeploymentTemplate**  sparar en mall för distribution av resurs grupper i en JSON-fil.
...
Sparar en mall för distribution av resurs grupper i en fil. (automatiskt genererat)
