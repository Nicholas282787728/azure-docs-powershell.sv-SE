...
## PROBLEMBESKRIVNING
Cmdleten **set-AzManagedApplication** -hanterade program
...
Det här kommandot uppdaterar beskrivningen av hanterad program
...
### -ID
Fullständigt kvalificerat program-ID, inklusive prenumerationen. till exempel/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName
...
### -Sort
Den hanterade program typen.
En av Marketplace eller servicecatalog
...
### -Parameter
JSON-formaterad sträng för parametrar för hanterat program.
Det kan vara en sökväg till ett fil namn eller en URI som innehåller parametrarna, eller parametrarna som sträng.
...
### -Planera
En hash-tabell som representerar hanterade program planerings egenskaper.
