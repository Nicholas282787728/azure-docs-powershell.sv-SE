...
## PROBLEMBESKRIVNING
Cmdleten **New-AzManagementGroupDeployment** lägger till en distribution i en hanterings grupp.

Om du vill lägga till en distribution i en hanterings grupp anger du hanterings grupp, plats och en mall.
...
Om du vill lägga till resurser i klient omfattningen använder du den **nya-AzTenantDeployment** som skapar en distribution med klientens omfång.
...
Det här kommandot skapar en ny distribution i gruppen "myMG" genom att använda en anpassad mall och en mallfil på disk, med en definierad parameter.
...
Det här kommandot skapar en ny distribution i gruppen "myMG" genom att använda en anpassad mall och en mallfil på en disk som har konverterats till en hash-gruppgrupp.
