...
### Exempel 1: ta bort en användare från en grupp efter objekt-ID
...
Tar bort användaren med objekt-ID ' D9076BBC-D62C-4105-9C78-A7F5BC4A3405 ' från gruppen med objekt-ID ' 85F89C90-780E-4AA6-9F4F-6F268D322EEE '.

### Exempel 2: ta bort en användare från en grupp efter ledning

```powershell
PS C:\> Get-AzADGroup -ObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE | Remove-AzADGroupMember -MemberObjectId D9076BBC-D62C-4105-9C78-A7F5BC4A3405
```

Hämtar gruppen med objekt-ID ' 85F89C90-780E-4AA6-9F4F-6F268D322EEE ' och rör den till Remove-AzADGroupMember cmdlet för att ta bort användaren till gruppen.
...
### -GroupDisplayName
Visnings namnet på gruppen som du vill ta bort medlemmen/medlemmarna från.
...
### -GroupObject
Objekt representation för gruppen som medlemmen ska tas bort från.
...
### -GroupObjectId
Objekt-ID för gruppen som medlemmen ska tas bort från.
...
UPN för de medlemmar som ska tas bort.
