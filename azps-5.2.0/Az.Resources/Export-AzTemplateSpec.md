...
## PROBLEMBESKRIVNING
Exporterar en specifik mall-version till det lokala fil systemet.

## BESKRIVS

### Exempel 1: exportera med namn
```powershell
PS C:\> Export-AzTemplateSpec -ResourceGroupName 'myRG' -Name 'MyTemplateSpec' -Version 'v1.0' -OutputFolder 'v1'
```

Exporterar version ' v 1.0 ' för mallnamnet med namnet "MyTemplateSpec" i resurs gruppen "myRG" till den lokala utdatafilen "v1".

### Exempel 2: exportera per resurs-ID
```powershell
...
Exporterar version ' v 1.0 ' för mallnamnet med namnet "MyTemplateSpec" i resurs gruppen "myRG" i prenumerationen \{ subId \} till den lokala utdatafilen "v1".
...
### -OutputFolder
Sökvägen till mappen där versions information för mallen ska sparas.
...
### -Version
Den version av mallen som ska exporteras.
