...
### Exempel 1: lägga till en användare i en grupp efter objekt-ID

```powershell
PS C:\> Add-AzADGroupMember -MemberObjectId D9076BBC-D62C-4105-9C78-A7F5BC4A3405 -TargetGroupObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE
```

Lägger till användaren med objekt-ID ' D9076BBC-D62C-4105-9C78-A7F5BC4A3405 ' i gruppen med objekt-ID ' 85F89C90-780E-4AA6-9F4F-6F268D322EEE '.

### Exempel 2: lägga till en användare i en grupp efter ledning

```powershell
PS C:\> Get-AzADGroup -ObjectId 85F89C90-780E-4AA6-9F4F-6F268D322EEE | Add-AzADGroupMember -MemberObjectId D9076BBC-D62C-4105-9C78-A7F5BC4A3405
```

Hämtar gruppen med objekt-ID ' 85F89C90-780E-4AA6-9F4F-6F268D322EEE ' och rör den till Add-AzADGroupMember cmdlet för att lägga till användaren i gruppen.

### Exempel 3: lägga till en användare i en grupp efter huvud namn
...
Lägger till en användare i en grupp och visar medlemmar i gruppen.
...
UPN för den eller de medlemmar som ska läggas till i gruppen.
...
Visnings namnet på gruppen som du vill lägga till medlemmar i.
...
### -TargetGroupObject
Objekt representation för gruppen som du vill lägga till medlemmar i.
...
### -TargetGroupObjectId
Objekt-ID för gruppen som du vill lägga till medlemmar i.
