...
## PROBLEMBESKRIVNING
Med cmdleten New-AzADAppCredential kan du lägga till en ny autentiseringsuppgift eller ställa in autentiseringsuppgifter för ett program.
Programmet identifieras genom att ange antingen programobjekt-ID eller program-ID.

## BESKRIVS

### Exempel 1 – Skapa en ny programautentisering med ett lösen ord
...
En ny lösen ords identifiering läggs till i det befintliga programmet med objekt-ID ' 1f89cf81-0146-4f4e-BEAE-2007d0668416 '.

### Exempel 2 – Skapa en ny programautentisering med ett certifikat
...
Det tillhandahållna base64-kodade X509-certifikatet ("MyApp. cer") läggs till i det befintliga programmet med program-ID ' 4589cd6b-3d79-4bb4-93b8-a0b99f3bfc58 '.

### Exempel 3 – skapa en ny programautentisering genom att använda ledning
...
Hämtar programmet med objekt-ID ' 1f89cf81-0146-4f4e-BEAE-2007d0668416 ' och rör till New-AzADAppCredential för att skapa en ny programautentisering för det programmet med angivet lösen ord.

## MALLPARAMETRAR

### -ApplicationId
Program-ID för programmet som du vill lägga till autentiseringsuppgifter för.
...
### -ApplicationObject
Application-objektet som du vill lägga till autentiseringsuppgifter för.
...
### -CertValue
Värdet för autentiseringstypen "asymmetrisk". Den representerar det grundläggande 64-kodade certifikatet.
...
### -EndDate
Slutdatum för användning av autentiseringsuppgifter. Standardvärdet för slutdatumet är ett år från idag.  För en "asymmetrisk" typ autentiseringsuppgift måste detta ställas in på eller före det datum då X509-certifikatet är giltigt.
...
### -StartDate
Start datum för användning av autentiseringsuppgifter. Standardvärdet för start datum är idag. För en "asymmetrisk" typ autentiseringsuppgift måste detta ställas in på eller efter det datum då X509-certifikatet är giltigt från.
