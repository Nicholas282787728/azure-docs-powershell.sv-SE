...
## Sammanfattning
 Anropar en annan instans av en trigger-körning.
...
## PROBLEMBESKRIVNING
Med kommandot **Invoke-AzDataFactoryV2TriggerRun** startas en instans av en trigger med ett nytt Utlös ande kör-ID.
...
```
Startar en annan instans av en Utlös ande kör-ID, och behåller samma windowStartTime och windowEndTime som den ursprungliga utlösaren.
