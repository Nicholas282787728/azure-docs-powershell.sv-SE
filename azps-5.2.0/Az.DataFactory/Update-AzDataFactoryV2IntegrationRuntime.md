...
## PROBLEMBESKRIVNING
**Update-AzDataFactoryV2IntegrationRuntime** cmdlet uppdaterar egenskaperna för integrations körning. För närvarande stöds endast cmdleten för uppdatering av "AutoUpdate" och "AutoUpdateDelayOffset" för integrations körning med egen värd.

## BESKRIVS

### Exempel 1: uppdaterar en integrations körning
```
...
Cmdleten uppdaterar den självvärdbaserade integrations körningen "test-selfhost-IR".

## MALLPARAMETRAR

### -AutoUpdate
Aktivera eller inaktivera automatisk uppdatering för integrering med automatisk värd.
...
Tid i timme för dagen för automatisk uppdatering av integrations körningen med självvärd.
