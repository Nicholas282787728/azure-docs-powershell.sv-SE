...
## PROBLEMBESKRIVNING
Skapa ett nätverks regel objekt i den aktuella PowerShell-sessionen.
...
Skapa en VirtualNetwork-regel uppsättning.

## MALLPARAMETRAR

### -Åtgärd
Nätverks regelns funktion.
...
### -IPAddressOrRange
Anger IP-eller IP-adressintervallet i CIDR-format.
Endast IPV4-adresser tillåts.
...
Resurs-ID för ett undernät, till exempel:/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/subnets/{subnetName}.
...
### -VirtualNetworkRule
Ange för att skapa VirtualNetworkRule.
