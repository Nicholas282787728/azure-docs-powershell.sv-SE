...
### Exempel 1: ta bort en Windows IoT-tjänst utifrån namn
```powershell
PS C:\> Remove-AzWindowsIotServicesDevice -Name wsi-t03 -ResourceGroupName azure-rg-test

```

Detta kommando tar bort en Windows IoT-tjänst med namn.

### Exempel 2: ta bort en Windows IoT-tjänst via pipeline
```powershell
...
Det här kommandot tar bort en Windows IoT-tjänst via pipeline.
