...
## Sammanfattning
Hämta icke-säkerhetsrelaterade metadata för en Windows IoT-enhet.
...
### Exempel 1: Hämta alla Windows IoT-tjänster under ett abonnemang
```powershell
...
Det här kommandot får alla Windows IoT-tjänster under ett abonnemang.

### Exempel 2: Hämta alla Windows IoT-tjänster under en resurs grupp
```powershell
...
Det här kommandot får alla Windows IoT-tjänster under en resurs grupp.

### Exempel 3: skaffa en Windows IoT-tjänst utifrån namn
```powershell
...
Det här kommandot får en Windows IoT-tjänst med namn.
...
Det här kommandot får en Windows IoT-tjänst via objekt.
...
Det här kommandot får en Windows IoT-tjänst via pipeline.
...
### Microsoft. Azure. PowerShell. cmdletar. WindowsIotServices. Models. IWindowsIotServicesIdentity
...
INPUTOBJECT <IWindowsIotServicesIdentity> : identitets parameter
  - `[DeviceName <String>]`: Namnet på Windows IoT Device-tjänsten.
  - `[Id <String>]`: Sökväg till resurs identitet
  - `[ResourceGroupName <String>]`: Namnet på resurs gruppen som innehåller Windows IoT-tjänsten.
