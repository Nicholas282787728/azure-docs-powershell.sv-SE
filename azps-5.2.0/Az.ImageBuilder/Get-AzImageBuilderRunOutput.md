...
### Exempel 1: Visa alla resultat under en mall
```powershell
...
Det här kommandot visar alla kör resultat under en mall.

### Exempel 2: få ett kör-resultat under en mall
```powershell
...
Det här kommandot får ett kör-resultat under en mall.

### Exempel 3: få ett kör-resultat under en mall
```powershell
...
### Microsoft. Azure. PowerShell. cmdletar. ImageBuilder. Models. Api20200214. IRunOutput
