...
### Exempel 2: Hämta programfunktionen efter namn.
```powershell
...
### Exempel 3: Hämta program efter resurs grupp namn.
```powershell
...
### Exempel 4: Hämta programfunktioner för de angivna abonnemangen.
```powershell
...
### Exempel 5: Hämta program efter plats.
```powershell
...
### -IncludeSlot
Används för att ange om distributions platser ska ingå i resultaten.
...
### -Plats
Platsen för funktionen funktion.
