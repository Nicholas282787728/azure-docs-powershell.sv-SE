...
### Exempel 1: Hämta alla providrar i valvet
```powershell
...
### -ProviderName
Leverantörs namn för Recovery Services
...
### Microsoft. Azure. PowerShell. cmdletar. Migrate. Models. Api20180110. IRecoveryServicesProvider
