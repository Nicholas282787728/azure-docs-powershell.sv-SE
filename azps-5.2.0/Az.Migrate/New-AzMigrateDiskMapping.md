...
Ladda ner diskar för att ange indata för New-AzMigrateServerReplication
...
### -DiskID
Anger disk-ID för den disk som är ansluten till den upptäckta server som ska migreras.
...
### -IsOSDisk
Anger om disken innehåller operativ systemet för käll servern som ska migreras.
...
### Microsoft. Azure. PowerShell. cmdletar. Migrate. Models. Api20180110. IVMwareCbtDiskInput
