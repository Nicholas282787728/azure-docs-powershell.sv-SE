...
## Sammanfattning
Startar testmigreringen för den replikerande servern.
...
### -InputObject
Anger den replikerade server som testmigreringen måste initieras för.
...
### -TestNetworkID
Uppdaterar det virtuella nätverks-ID: t i mål Azure-prenumerationen som ska användas för testning av migrering.
...
INPUTOBJECT <IMigrationItem> : anger den replikerade server som testmigreringen måste initieras för. Serverobjektet kan hämtas med Get-AzMigrateServerReplication cmdlet.
