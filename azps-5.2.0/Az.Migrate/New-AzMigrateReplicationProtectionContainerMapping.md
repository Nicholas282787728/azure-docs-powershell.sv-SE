...
### -MappingName
Mappnings namn för skydds behållare.
...
Leverantör specifik inmatning för ihopparning.
För att konstruera kan du läsa avsnittet anteckningar för PROVIDERSPECIFICINPUT-egenskaper och skapa en hash-tabell.
...
Namnet på unikt mål för skydds behållare.
...
### Microsoft. Azure. PowerShell. cmdletar. Migrate. Models. Api20180110. IProtectionContainerMapping
...
PROVIDERSPECIFICINPUT <IReplicationProviderSpecificContainerMappingInput> : leverantörsspecifik specifik inmatning för ihopparning.
  - `[InstanceType <String>]`: Klass typen.
