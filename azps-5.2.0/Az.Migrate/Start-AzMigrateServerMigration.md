...
### -InputObject
Anger den replikerade Server för vilken migrering måste initieras.
...
### -TargetObjectID
Anger den replcating-Server för vilken migrering måste initieras.
...
### -TurnOffSourceServer
Anger om käll servern ska stängas av efter migreringen.
...
INPUTOBJECT <IMigrationItem> : anger den replikerade Server för vilken migrering måste initieras. Serverobjektet kan hämtas med Get-AzMigrateServerReplication cmdlet.
