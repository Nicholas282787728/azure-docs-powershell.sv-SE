...
### Exempel 1: lägga till en ny anknytning till en dator
```powershell
...
### Exempel 2: lägga till ett nytt tillägg med parametrar för tillägg som anges via pipeline
```powershell
...
Detta skapar ett nytt tillägg med de tilläggs parametrar som tillhandahålls av objektet som skickas via pipeline.
Det är bra om du vill ta fram parametrarna på en dator och använda den på en annan dator.

### Exempel 3: Lägg till ett nytt tillägg med platsen som anges via pipeline
```powershell
...
Detta skapar ett nytt dator tillägg med den identitet som tillhandahålls via pipeline.
Du kommer troligen inte att göra det, men det är möjligt.

### Exempel 4: lägga till ett nytt fil namns tillägg med ett objekt som både plats och parametrar för uppdatering
```powershell
...
Detta skapar ett nytt dator tillägg med den identitet som tillhandahålls via pipeline och tilläggs informationen som tillhandahålls av det överförda tillägget.
Du kommer troligen inte att göra det, men det är möjligt.
...
EXTENSIONPARAMETER <IMachineExtension> : beskriver ett dator tillägg.
  ...
  - `[MachineExtensionType <String>]`: Anger typen av tillägget. ett exempel är "CustomScriptExtension".
  ...
  - `[Setting <IMachineExtensionPropertiesSettings>]`: JSON-formaterade offentliga inställningar för tillägget.
