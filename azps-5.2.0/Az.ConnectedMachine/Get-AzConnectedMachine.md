...
## Sammanfattning
Hämtar information om modell läget eller instans visningen av en hybrid dator.
...
### Exempel 1: lista alla anslutna datorer i ett abonnemang
```powershell
...
Visar en lista över alla anslutna datorer i ett abonnemang.
Om abonnemang inte anges används prenumerationen från din nuvarande Azure PowerShell-kontext.

### Exempel 2: lista alla anslutna datorer i en resurs grupp
```powershell
...
Visa en lista med alla anslutna datorer i en resurs grupp.

### Exempel 3: skaffa en ansluten dator i en resurs grupp efter namn
```powershell
...
Skaffa en ansluten dator i en resurs grupp efter namn.
...
### Microsoft. Azure. PowerShell. cmdletar. ConnectedMachine. Models. Api20200802. IMachine
