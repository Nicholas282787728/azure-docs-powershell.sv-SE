...
## PROBLEMBESKRIVNING
**New-AzSearchAdminKey** cmdlet återskapar en administratörs nyckeln för Azure Search-tjänsten.
...
Exemplet återskapar primär nyckeln för Azure Search-tjänsten.
...
### -Sort
Sök tjänstens administratörs typ (primär/sekundär).
