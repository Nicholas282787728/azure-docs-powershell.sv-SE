...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzNetAppFilesBackupPolicy** tar bort en ANF säkerhets kopierings princip.
...
### -AccountObject
Det konto objekt som innehåller säkerhets kopierings principen som ska tas bort
...
### -PassThru
Returnera om den angivna säkerhets kopierings principen har tagits bort
