...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzNetAppFilesBackup** ändrar en ANF-säkerhets kopiering.
...
Det här kommandot utför en uppdatering av den angivna säkerhets kopian som ändrar det angivna användar namnet.
...
### -Etikett
Etikett för säkerhets kopiering
