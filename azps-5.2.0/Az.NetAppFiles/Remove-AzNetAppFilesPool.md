...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzNetAppFilesPool** tar bort en ANF-pool.
...
Det här kommandot tar bort ANF-poolen "MyAnfPool".
...
### -AccountObject
Det konto objekt som innehåller poolen som ska tas bort
...
### -PassThru
Returnera om den angivna poolen har tagits bort
