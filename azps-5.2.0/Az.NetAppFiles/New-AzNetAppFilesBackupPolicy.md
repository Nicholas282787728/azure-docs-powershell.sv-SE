...
## PROBLEMBESKRIVNING
Cmdleten **New-AzNetAppFilesActiveDirectory** skapar en ny säkerhets kopierings princip för ett ANF-konto.
...
Det här kommandot skapar den nya ANF säkerhets kopierings princip för ANF-kontot "mitt konto".
...
### -AccountObject
Konto objekt för den nya säkerhets kopierings principen
