...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzNetAppFilesBackup** hämtar information om en ANF säkerhets kopiering.
...
Det här kommandot får backcup med namnet "MyAnfAccount" från volymen "volym".
