...
## PROBLEMBESKRIVNING
Återställa eller återställa en volym till den ögonblicks bild som anges i SnapshotId parameter
...
Det här kommandot återställer/återställer volymen volym till en av sina stillbilder med snapshotId för 7d6e4069-6c78-6c61-7bf6-c60968e45fbf
...
### -InputObject
Volume-objekt som ska tas bort
...
### -PassThru
Returnera om den angivna volymen har återställts eller återställts
...
### -PoolObject
Det pool-objekt som innehåller volymen som ska tas bort
...
### -SnapshotId
SnapshotId av ögonblicks bilden.
UUID v4 som används för att identifiera ögonblicks bilden
