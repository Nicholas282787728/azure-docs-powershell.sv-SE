...
## PROBLEMBESKRIVNING
Cmdleten **New-AzNetAppFilesBackup** skapar en säkerhets kopia för en ANF volym.
...
Det här kommandot skapar den nya ANF säkerhets kopiering för volymen "volym".
...
### -VolumeObject
Volymen för det nya säkerhetskopierade objektet
