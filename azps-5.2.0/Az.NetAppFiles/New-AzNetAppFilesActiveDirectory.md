...
Det här kommandot får AD-lösenordet från Promt till en secreates den nya Active Directory-konfigurationen för ANF-kontot "MyAnfAccount".
...
### -AccountObject
Kontot för den nya säkerhets kopierings principens objekt
