...
Då ändras poolens adresspool till en med ID: t för 7d6e4069-6c78-6c61-7bf6-c60968e45fbf
...
### -NewPoolResourceId
ResourceId för kapacitets gruppen att flytta till.
UUID v4 som används för att identifiera poolen
...
### -PoolObject
Det pool-objekt som innehåller volymen
