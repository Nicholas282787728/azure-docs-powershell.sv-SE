...
## PROBLEMBESKRIVNING
Skapar ett objekt av typen varnings åtgärd det här objektet måste skickas till det kommando som skapar en varnings regel för loggning
...
### – Allvarlighets grad
Allvarlighets graden för den här aviseringen
...
### -ThrottlingInMinutes
Varaktigheten i minuter för vilken avisering ska begränsas
