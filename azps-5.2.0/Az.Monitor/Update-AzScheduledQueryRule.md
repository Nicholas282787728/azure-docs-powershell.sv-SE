...
## PROBLEMBESKRIVNING
Uppdaterar en regel för loggnings varningar, uppdatering av endast "aktiverat"-egenskapen stöds av det här kommandot.
Om du vill uppdatera andra egenskaper läser du kommandot [set-AzScheduledQueryRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/set-azscheduledqueryrule) .

## BESKRIVS

### Exempel 1: uppdatera efter regel namn
```powershell
...
### Exempel 2: Update med indatavärdet
```powershell
...
### -Aktiverad
Azure Alert State – giltiga värden-$true $false
...
### -InputObject
Resursen för regel för schemaläggning
