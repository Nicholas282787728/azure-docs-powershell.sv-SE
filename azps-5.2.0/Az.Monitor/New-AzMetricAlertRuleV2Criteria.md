...
## PROBLEMBESKRIVNING
Cmdleten **New-AzMetricAlertRuleV2Criteria** skapar ett objekt för lokal mätning som kan användas som [en cmdlet för att skapa en](https://docs.microsoft.com/en-us/powershell/module/az.monitor/add-azmetricalertrulev2) ny regel för mått.
...
### Exempel 4: skapa tillgänglighets villkor för en webtest
...
Det här kommandot skapar ett tillgänglighets villkor för webtest som kan användas i en regel för att varna
...
### -FailedLocationCount
Minsta antal misslyckade platser för att utlösa en avisering.
...
Gör det möjligt att skapa en notifieringsregel på ett anpassat mått som ännu inte har utlevererats, genom att orsaka att mät verifieringen hoppas över
...
### -Webtest
Byt parameter för användning av tillgänglighets villkors typ
...
### -WebTestId
ID för webb test för Application Insights.
