...
## PROBLEMBESKRIVNING
Uppdaterar en loggnings varnings regel genom att ange semantik

## BESKRIVS

### Exempel 1: Ange som regel namn
```powershell
...
### Exempel 2: uppsättning med indata-objekt
```powershell
...
### -Åtgärd
Varnings åtgärden för den schemalagda frågekomponenten
...
### -Beskrivning
Beskrivning för den här aviseringen
...
### – Schema
Schemat för den schemalagda regeln
...
### -Källa
Den schemalagda frågekomponenten
