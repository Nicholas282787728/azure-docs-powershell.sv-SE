...
## PROBLEMBESKRIVNING
Med cmdleten **Enable-AzActivityLogAlert** kan du aktivera en aktivitets loggs avisering och ange dess taggar.
...
### Exempel 1: Aktivera en aktivitets logg varning
```
