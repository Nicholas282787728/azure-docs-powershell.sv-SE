...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzLoadBalancerOutboundRuleConfig** lägger till en regel för utgående trafik i en Azure-belastningsutjämnare.
...
I det andra kommandot används pipeline-operatorn för att överföra belastningsutjämnaren i $slb till **Add-AzLoadBalancerOutboundRuleConfig**, som lägger till en regel för utgående trafik till belastningsutjämnaren.
