...
### Exempel 2: skapa ett nytt globalt offentlig IP-prefix
```powershell
...
Det här kommandot skapar en ny global offentlig IP-prefixlängd. 
...
### -CustomIpPrefix
Den CustomIpPrefix som denna PublicIpPrefix ska kopplas till
...
### -Tier
SKU-nivån för offentlig IP-prefix.
