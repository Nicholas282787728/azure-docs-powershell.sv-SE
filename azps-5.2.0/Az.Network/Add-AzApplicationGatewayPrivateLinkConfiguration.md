...
## Sammanfattning
Lägger till en privat länk konfiguration till en Programgateway.
...
## PROBLEMBESKRIVNING
Cmdleten **Add-AzApplicationGatewayPrivateLinkConfiguration** lägger till en privat länk konfiguration till en Programgateway.
...
Det första kommandot skapar en privateLinkIpConfiguration och lagrar den i variabeln $PrivateLinkIpConfiguration.
...
Det tredje kommandot lägger till den privata länk konfigurationen som heter privateLinkConfig01 för gatewayen i $AppGw
