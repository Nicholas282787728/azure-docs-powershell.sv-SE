...
## Sammanfattning
Ändrar SSL-principen för en Application Gateway SSL-profil.
...
## PROBLEMBESKRIVNING
Cmdleten **set-AzApplicationGatewaySslProfilePolicy** ändrar SSL-principen för en SSL-profil för Application Gateway.
...
Det första kommandot får den Programgateway som heter ApplicationGateway01 i resurs gruppen som heter ResourceGroup01 och lagrar den i $AppGw variabeln. Det andra kommandot får den SSL-profil som heter SslProfile01 för $AppGw och lagrar inställningarna i $profile-variabeln. Det senaste kommandot ändrar SSL-principen för det SSL-profil objekt som lagras i $profile.

## MALLPARAMETRAR

### -CipherSuite
SSL-chiffersviter kan aktive ras i angiven ordning för Programgateway
...
Lista över SSL-protokoll som ska inaktive ras
...
### -MinProtocolVersion
Minsta version av SSL-protokoll som stöds på Application Gateway
