...
## PROBLEMBESKRIVNING
Cmdleten **New-AzFirewallPolicy** skapar en Azure Firewall-princip.

## BESKRIVS

### Exempel 1:1. Skapa en tom princip
```powershell
PS C:\> New-AzFirewallPolicy -Name fp1 -ResourceGroupName TestRg
```

I det här exemplet skapas en Azure Firewall-princip

### Exempel 2:2. Skapa en tom princip med ThreatIntel-läge
```powershell
PS C:\> New-AzFirewallPolicy -Name fp1 -ResourceGroupName TestRg -ThreatIntelMode "Deny"
```

I det här exemplet skapas en Azure Firewall-princip med ett hot Intel-läge

### Exempel 3:3. Skapa en tom princip med ThreatIntel Lägg
```powershell
...
I det här exemplet skapas en Azure Firewall-princip med ett hot Intel Lägg
