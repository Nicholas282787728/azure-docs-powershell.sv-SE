...
## Sammanfattning
Ändra eller ändra en virtuell enhets webbplats som är ansluten till en resurs för virtuella nätverk enheter.
...
## PROBLEMBESKRIVNING
Kommandot Update-AzVirtualApplianceSite ändrar en webbplats resurs för en virtuell enhet.
...
Ändra adressprefixet för en resurs för en virtuell enhets webbplats.
...
Virtuell nätverks apparat som den här webbplatsen är kopplad till.
