...
## PROBLEMBESKRIVNING
Stoppar paket registrerings åtgärden på en virtuell nätverksgateway och laddar upp resultatet på angiven SasUrl.
...
### -InputObject
Det virtuella nätverkets gateway-objekt där paket upptagningen ska startas.
...
### -Namn
Namnet på den virtuella Nätverksgatewayen där paket upptagningen ska startas.
...
### -ResourceId
Azure Resource ID för den VirtualNetworkGateway där paket upptagningen ska startas.
...
### -SasUrl
SAS URL-paketfiltrering från virtuell nätverksgateway.
