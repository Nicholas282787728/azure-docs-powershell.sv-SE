...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzPrivateEndpoint** hämtar en eller flera privata slut punkter.

## BESKRIVS

### Exempel 1: Hämta en privat slut punkt
```powershell
...
Det här kommandot får den privata slut punkten som heter MyPrivateEndpoint1 i resurs gruppen TestResourceGroup

### Exempel 2: lista alla privata slut punkter i ResourceGroup
```powershell
...
Det här kommandot får alla privata slut punkter i resurs gruppen TestResourceGroup
...
### -ExpandResource
Resurs referensen som ska expanderas.
