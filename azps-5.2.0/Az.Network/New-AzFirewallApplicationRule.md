...
## PROBLEMBESKRIVNING
Cmdleten **New-AzFirewallApplicationRule** skapar en program regel för Azure Firewall.
...
### Exempel 2: skapa en regel för att tillåta WindowsUpdate för 10.0.0.0/24 under nätet
```powershell
...
Asterisken, "*', accepteras endast som det första tecknet i ett FQDN i listan. När den används matchar asterisken ett obegränsat antal tecken. (till exempel "* MSN.com" matchar MSN.com och alla dess under domäner)
...
### Microsoft. Azure. commands. Networks. Models. PSAzureFirewallApplicationRule
