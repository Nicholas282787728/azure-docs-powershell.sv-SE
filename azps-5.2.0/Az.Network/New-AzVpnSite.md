...
Ovanstående skapar en resurs grupp, virtuella WAN i öst-USA i resurs gruppen "nonlinkSite" i Azure. 

Därefter skapas en VpnSite för att representera en kund gren och länkar den till den virtuella WAN-tjänsten.

En IPSec-anslutning kan sedan installeras med den här grenen och en VpnGateway med kommandot New-AzVpnConnection.
...
Ovanstående skapar en resurs grupp, en virtuell WAN-och en VpnSite med 1 VpnSiteLinks i öst-resurs gruppen "Multilink" i Azure.

### Exempel 3

Skapar en ny Azure VpnSite-resurs. (automatiskt genererat)
...
### -O365Policy
Översikten policy för Office 365 för denna VpnSite.
...
### -VpnSiteLink
Listan med VpnSiteLinks som denna VpnSite har.
