...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzExpressRouteCircuitPeeringConfig** hämtar konfigurationen för en peering-relation för en ExpressRoute-krets.

## BESKRIVS

### Exempel 1: Visa peering-konfigurationen för en ExpressRoute-krets
```
...
### -ExpressRouteCircuit
Det ExpressRoute-krets-objekt som innehåller peering-konfigurationen.
