...
## PROBLEMBESKRIVNING
Cmdleten **New-AzApplicationGatewayRewriteRule** skapar en ny Skriv regel för en Azure Application Gateway.

## BESKRIVS

### Exempel 1: skapa en Rewrite-regel för en Programgateway
```powershell
PS C:\> $rule = New-AzApplicationGatewayRewriteRule -Name rule1 -ActionSet $action -RuleSequence 101 -Condition $condition
```

Det här kommandot skapar en omskrivnings regel med namnet rule1 och lagrar resultatet i variabeln som heter $rule.

## MALLPARAMETRAR

### -ActionSet
ActionSet av den omskrivna regeln
...
### -Villkor
Villkor för att den omanvändade regeln ska utföras
...
### -RuleSequence
Regel ordningen för den här omskrivning-regeln i regeln för att skriva om
...
### Microsoft. Azure. commands. Networks. Models. PSApplicationGatewayRewriteRule
