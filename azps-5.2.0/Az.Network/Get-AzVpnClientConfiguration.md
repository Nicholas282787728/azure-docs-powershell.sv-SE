...
## PROBLEMBESKRIVNING
Get-AzVpnClientConfiguration returnerar URL-adressen där VPN-klienten kan laddas ned från.
...
Hämtar URL-adressen för att hämta en VpnClient-profil som tidigare genererats med kommandot New-AzVpnClientConfiguration.
