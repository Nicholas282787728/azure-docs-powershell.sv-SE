...
## PROBLEMBESKRIVNING
Cmdleten **Update-AzVpnConnection** uppdaterar en VPN-anslutning.  
VPN-anslutning skapar en IPsec-anslutning som ansluter en VPN-gateway till en fjärran sluten kund filial som visas i Azure som en VPN-plats.
...
Anslutningen uppdateras då till en ny IpSecPolicy med hjälp av kommandot Set-AzVpnConnection.
...
Anslutningen uppdateras då och har en ny delad säkerhets nycklar med hjälp av säker sträng konstruktion.
...
### -InputObject
VpnConnection-objekt som ska uppdateras.
...
### -ResourceId
Resurs-ID för det VpnConnection-objekt som ska tas bort.
...
Listan med VpnSiteLinkConnections som den här VpnConnection måste ha.
