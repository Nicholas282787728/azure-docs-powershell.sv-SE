...
```
### Exempel 3
Exempel på Packet-insamling för att fånga alla inre och yttre paket
```powershell
...
### -FilterData
Filter alternativ för att hämta start paket från anslutningar för virtuell nätverksgateway.
