...
## PROBLEMBESKRIVNING
Cmdleten **New-AzLoadBalancerRuleConfig** skapar en regel konfiguration för en Azure-belastningsutjämnare.

## BESKRIVS

### Exempel 1: skapa en regel konfiguration för en Azure-belastningsutjämnare
```powershell
