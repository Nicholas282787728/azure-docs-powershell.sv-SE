...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzExpressRoutePortIdentity** tar bort identiteten från ett lokalt Azure ExpressRoutePort-objekt. Använd **Remove-AzExpressRoutePort** för att ta bort den från ExpressRoutePort.
