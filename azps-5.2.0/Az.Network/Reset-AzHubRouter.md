...
## PROBLEMBESKRIVNING
Återställer statusen för en befintlig VirtualHub-resurs endast om Dirigerings statusen för det virtuella navet inte har etablerats.
...
Återställ statusen för en virtuell hubb med dess ResourceGroupName och ResourceName.
...
Återställ statusen för den virtuella hubben till dess ResourceId.
...
Återställ statusen för den virtuella hubben för det virtuellt navet med ett indatavärde. Indatavärdet är av typen PSVirtualHub.
...
Ett befintligt virtuellt nav-objekt kan hämtas och sedan skickas som indatafil-AzHubRouter.
