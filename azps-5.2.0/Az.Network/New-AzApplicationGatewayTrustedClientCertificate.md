...
## Sammanfattning
Skapar en betrodd klient certifikat utfärdares certifikat kedja för en Programgateway.
...
## PROBLEMBESKRIVNING
New-AzApplicationGatewayTrustedClientCertificate-cmdleten skapar en betrodd klient certifikat utfärdares certifikat kedja för en Programgateway.
...
```
Kommandot skapar en ny betrodd klient certifikat utfärdarens certifikatutfärdarcertifikat som tar vägen till klient certifikat utfärdarens certifikat som indata.
