...
## Sammanfattning
Ladda ned rem bur handlingen för en Express-vägs port.
...
## PROBLEMBESKRIVNING
New-AzExpressRoutePortLOA cmdlet laddar ned ett brev i PDF-format för en Express-vägs port.
...
Hämta rem bur handlingen för Express Route port "min port" och lagra den i filen "loa.pdf".
...
### -Kundnamn
Kund namnet som den här Express flödes porten är tilldelad till.
...
### -Mål
Utgångs filen som ska spara godkännande brevet.
...
### -ResourceGroupName
Namnet på den uttryckliga vägen i resurs gruppen.
