...
Ovanstående skapar en resurs grupp, en virtuell WAN-och en VpnSite med 1 VpnSiteLinks i västra USA i resurs gruppen "testRG" i Azure.

### Exempel 2

Skapar ett Azure VpnSiteLink-objekt. (automatiskt genererat)
...
### -BGPPeeringAddress
BGP peering-adressen för denna VpnSiteLink.
