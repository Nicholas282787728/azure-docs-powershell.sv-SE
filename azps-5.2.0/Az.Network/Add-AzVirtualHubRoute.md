...
## PROBLEMBESKRIVNING
Skapar ett VirtualHubRoute-objekt.
...
Med kommandot ovan skapas ett VirtualHubRoute-objekt som sedan kan läggas till i en VirtualHubRouteTable-resurs och ställas in på en VirtualHub.
