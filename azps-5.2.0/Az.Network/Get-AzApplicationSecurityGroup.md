...
### Exempel 4: Hämta säkerhets grupper för program med hjälp av filtrering.
```
...
Kommandot returnerar alla program säkerhets grupper som börjar med "MyApplicationSecurityGroup".
