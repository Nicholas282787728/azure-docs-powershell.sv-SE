...
## PROBLEMBESKRIVNING
**New-AzApplicationGatewayIdentity** cmdlet skapar ett Identity-objekt för Application Gateway.
...
I det här exemplet skapar vi en användare tilldelad identitet och refererar den sedan till Identity-objekt som används med Application Gateway.
