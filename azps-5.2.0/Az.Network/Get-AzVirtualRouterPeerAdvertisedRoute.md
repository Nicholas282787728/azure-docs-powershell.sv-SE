...
## Sammanfattning
Visa vägar som annonseras av viss peer med virtuella routrar
...
## PROBLEMBESKRIVNING
Med en virtuell router-peer med namn eller efter objekt räknas vägarna som annonseras till den motparten av en viss virtuell router.
...
### -ResourceGroupName
Namn på peer-resurs grupp för virtuell router
...
### Microsoft. Azure. commands. Networks. Models. PSPeerRoute
