...
## Sammanfattning
Skapa en webbplats som är ansluten till en virtuell nätverks apparat.
...
## PROBLEMBESKRIVNING
Med kommandot New-AzVirtualApplianceSite skapas en virtuell enhets webbplats som är ansluten till en resurs för virtuella nätverk enheter.
...
Skapa en ny virtuell apparat-webbplats i resurs gruppen: testrg.

## MALLPARAMETRAR

### -AddressPrefix
Webbplatsens adressprefix.
...
Den virtuella nätverks enhet som den här webbplatsen är kopplad till.
