...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzPrivateDnsZoneGroup** får en eller flera privata DNS-zonfiler.

## BESKRIVS

### Exempel 1: Hämta gruppen privata DNS-zoner
```powershell
...
Ovan exemplet får du en privat DNS-zonfil som heter dnsgroup1 i RG resurs grupp.
