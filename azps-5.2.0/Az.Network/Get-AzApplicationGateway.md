...
### Exempel 4: Hämta en lista med programgateways i ett abonnemang med hjälp av filtrering
```
...
Det här kommandot får en lista över alla programgateways i prenumerationen som börjar med "ApplicationGateway01" och lagrar den i $AppGwList variabel.
