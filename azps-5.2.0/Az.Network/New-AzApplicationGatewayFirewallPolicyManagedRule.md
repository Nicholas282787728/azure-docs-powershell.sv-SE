...
## PROBLEMBESKRIVNING
Den **nya-AzApplicationGatewayFirewallPolicyManagedRule** skapar ett hanterat-regler för en brand Väggs princip.
...
Kommandot skapar hanterade regler en lista med ManagedRuleSet med $managedRuleSet och en undantags lista med poster som $exclusion 1, $exclusion 2.
