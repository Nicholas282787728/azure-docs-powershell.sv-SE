...
## PROBLEMBESKRIVNING
Med den här Add-AzApplicationGatewayBackendHttpSetting cmdleten läggs Server-HTTP-inställningar till i en Programgateway.
...
Lägger till backend HTTP-inställningar till en Programgateway. (automatiskt genererat)
