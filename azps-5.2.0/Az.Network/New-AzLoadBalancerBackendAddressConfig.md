...
## Sammanfattning
Returnerar en server för belastnings Utjämnings adresser. 
...
### Exempel 1: ny Loadbalancer-adress konfiguration med virtuell nätverks referens
```powershell
PS C:\> $virtualNetwork = Get-AzVirtualNetwork -Name $vnetName -ResourceGroupName $resourceGroup
New-AzLoadBalancerBackendAddressConfig -IpAddress "10.0.0.5" -Name "TestVNetRef" -VirtualNetworkId $virtualNetwork.Id
```

### Exempel 2: ny Loadbalancer-adress config med IP-konfiguration Reference för klient delen
```powershell
...
### -IpAddress
Den IP-adress som ska läggas till i backend-poolen
...
Belastningsutjämnarens IP-konfiguration för belastningsutjämnare med Server dels adress konfiguration
...
### -Namn
Namnet på Server delens konfiguration
...
### -VirtualNetworkId
Det virtuella nätverk som är kopplat till Server dels adress konfiguration
...
### Microsoft. Azure. commands. Networks. Models. PSLoadBalancerBackendAddress
