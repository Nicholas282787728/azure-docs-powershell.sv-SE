...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzStackEdgeUser** visar de användare som har kon figurer ATS för en stack Edge-enhet. Du kan nämna namnet i parametrar för att få information om en viss användare.
