...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzStackEdgeUser** tar bort en användare på stack Edge-enheten. Det går bara att skapa en typ av användare `Share` .
...
### Microsoft. Azure. PowerShell. cmdletar. StackEdge. Models. PSStackEdgeUser
