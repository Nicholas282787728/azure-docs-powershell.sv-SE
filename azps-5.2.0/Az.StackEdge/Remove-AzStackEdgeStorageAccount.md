...
## PROBLEMBESKRIVNING
Cmdleten **Remove-AzStackEdgeStorageAccount** tar bort ett tillhör ande lagrings konto för en stack Edge-enhet. Du kan ange namnet på lagrings kontot för Edge som ska tas bort som en parameter i cmdleten.
