...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzStackEdgeTriger** hämtar utlösare för en enhet. Du kan ange namnet som en parameter i cmdleten för att hämta information om specifika utlösare
