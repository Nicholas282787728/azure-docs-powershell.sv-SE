...
## PROBLEMBESKRIVNING
Cmdleten **New-AzStackEdgeOrder** skapar en ny order för en trave Edge-enhet. Du måste först skapa en enhets resurs för att skapa en beställning. Du kan ange information som kontakt person, företags namn, e-post, adress etc. som parametrar för att skapa beställningen.
...
### -E-postadress
Lista över e-postmeddelanden för att ta emot uppdateringar, accepterar max 10 e-postmeddelanden
...
### -Telefon
Kontakt personens telefonnummer
