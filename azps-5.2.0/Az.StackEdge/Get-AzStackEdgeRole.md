...
## PROBLEMBESKRIVNING
Cmdleten **Get-AzStackEdgeRole** hämtar de tillgängliga IoT-rollerna för en stack Edge-enhet. Du kan nämna parametern name för att få information om en specifik IoT-roll.
...
### Microsoft. Azure. PowerShell. cmdletar. StackEdge. Models. PSStackEdgeRole
