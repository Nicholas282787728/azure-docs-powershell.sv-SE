...
### Skapa en noduppsättning med standard parametrar
```powershell
...
### -Kluster namn
Namnet på den hanterade kluster resursen.
...
### -ClusterObject
Ange Cluster-objekt som du vill skapa en resurspool för.
...
### -Force
Skapa en noduppsättning även om den redan finns
...
### -OsType
OsType som ska användas för att ange OS-typ.
Välj från Linux och Windows.
Standard för Linux.
...
ScaleSetEvictionPolicy ska användas för att ange borttagnings princip för skalnings uppsättning för den virtuella datorns Pro.
Standard för att ta bort.
...
### -ScaleSetPriority
ScaleSetPriority används för att ange prioritet för den virtuella datorns skalnings uppsättning.
Standard är normal.
...
### -VmSetType
Representerar typer av en noduppsättning.
Möjliga värden är: ' VirtualMachineScaleSets ', ' AvailabilitySet '
