...
## PROBLEMBESKRIVNING
AzIotSecuritySolutionRecommendationConfigurationObject skapar ett nytt rekommendations konfigurations objekt för IoT-säkerhetslösning.
På så sätt konfigureras statusen för en rekommendation, oavsett om den är aktive rad eller inaktive rad.
...
Skapa en ny rekommendations konfiguration för rekommendations typ "IoT_ACRAuthentication" med status inställd på Disable
