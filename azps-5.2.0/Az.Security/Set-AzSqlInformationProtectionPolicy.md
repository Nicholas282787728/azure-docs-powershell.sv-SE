...
### -Sökväg
Anger en sökväg till en. JSON-fil som innehåller princip definitionen för SQL information Protection.
...
### -Princip
Anger en SQL policy-definition för informations skydd. Du kan ange en sökväg till en. JSON-fil eller en JSON format-sträng som definierar principen.
