...
## PROBLEMBESKRIVNING
New-AzDeviceSecurityGroupThresholdCustomAlertRuleObject cmdlet skapar en ny lista över anpassade varnings regler för säkerhets grupp i IoT-säkerhetslösning.
...
Skapa en ny tröskel anpassad varnings regel från typen "SomeRuleType" med status aktiverat ANT-värden för minimum-och Max tröskel
