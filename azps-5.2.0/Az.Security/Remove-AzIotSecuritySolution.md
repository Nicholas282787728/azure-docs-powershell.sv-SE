...
## PROBLEMBESKRIVNING
Remove-AzIotSecuritySolution cmdlet tar bort en specifik IoT-säkerhetslösning. IoT-säkerhetslösningen samlar in säkerhets data från IoT-enheter och IoT Hub för att förhindra och upptäcka hot.
...
Delete IoT Security Solution "testprov" med resurs gruppen "MyResourceGroup"
