...
## PROBLEMBESKRIVNING
Tar bort en princip för nätverks åtkomst i tid.
Efter den här åtgärden kan användaren inte begära tillfälliga nätverks anslutningar på de virtuella datorerna som har kon figurer ATS i den borttagna principen.
