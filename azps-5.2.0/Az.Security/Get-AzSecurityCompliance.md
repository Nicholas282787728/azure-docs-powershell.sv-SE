...
## PROBLEMBESKRIVNING
Hämtar säkerhetsfunktioner för ett abonnemang baserat på det aktuella alternativet för felfri och ej säkra resurser för det här abonnemanget.
Säkerhetskompatibiliteten beräknas varje dag och historiken sparas.
...
Får ett abonnemangs säkerhets krav för de senaste 14 dagarna
...
Hämtar ett abonnemangs säkerhets krav för ett visst datum
...
### Microsoft. Azure. kommandon. Security. Models. efterföljare. PSSecurityCompliance
