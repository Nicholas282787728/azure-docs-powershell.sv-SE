...
Azure PowerShell fungerar med PowerShell 5.x på Windows 7 eller senare, eller med PowerShell 6.x på valfri plattform.
...
Om du använder PowerShell 5.x i Windows måste du även ha .NET Framework 4.7.2 installerat. Anvisningar för hur du uppdaterar eller installerar en ny version av .NET Framework finns i [installationsguiden till .NET Framework](/dotnet/framework/install).
