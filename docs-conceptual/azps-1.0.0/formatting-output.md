...
## <a name="format-examples"></a>Formatexempel

I det här exemplet får vi en lista över virtuella Azure-datorer i standardprenumerationen.  Kommandot `Get-AzVM` formaterar som standard utdata i tabellformat.
