...
* AzureRm.Resources
    * Den nya Resources-modulen har stöd för API-versionen 2018-05-01 med profilen 2019-03-01-hybrid
    * Åtgärderna PolicyDefinition(2016-12-01) och PolicyAssisgment (2017-06-01-preview) använder fortfarande äldre API-versioner
* AzureRm.Compute
    * Ny beräkningsmodul med stöd för API-versionen 2017-12-01.


* Den här versionen motsvarar API-profilen 2019-03-01-hybrid som är specifik för Azure Stack
