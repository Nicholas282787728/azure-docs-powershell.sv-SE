...
De objekt som visas i följande utdata kommer inte att uppgraderas automatiskt utan att problemen först korrigeras manuellt.
...
* För närvarande stöds endast AZ PowerShell-modul version 5.2.0 som mål.
