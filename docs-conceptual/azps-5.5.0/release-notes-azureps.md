...
* Spårad CloudError-kod i undantag
* Utlöst "ContextCleared"-händelse när "Clear-AzContext" kördes

#### <a name="azaks"></a>Az.Aks
* Raffinerade fel meddelanden vid cmdlet-fel.
* Uppgradering av undantags hantering för att använda Azure PowerShell relaterade undantag.
* Åtgärdade problemet att användaren inte kunde använda det angivna tjänst huvud namnet för att skapa Kubernetes-kluster. [#13938]

#### <a name="azautomation"></a>Az.Automation
* Har åtgärdat problemet med att bearbeta "PSCustomObject" och "matris".

#### <a name="azcompute"></a>Az.Compute
* Parametern-EnableAutomaticUpgrade har lagts till i set-AzVmExtension och Add-AzVmssExtension.
* FilterExpression-parametern har tagits bort från get-AzVMImage-cmdlet-dokumentationen. 
* Ett utfasnings meddelande har lagts till i container service-cmdlets:
...
* Parametern-BurstingEnabled har lagts till i New-AzDiskConfig och New-AzDiskUpdateConfig
* Parametrarna-GroupByApplicationId och-GroupByUserAgent har lagts till i cmdletarna Export-AzLogAnalyticThrottledRequest och export-AzLogAnalyticRequestRateByInterval.
* Parametern "VMParameterSet" har lagts till i cmdleten "Get-AzVMExtension". Den nya parametern-VM har lagts till i den här parameter uppsättningen. 

#### <a name="azcontainerregistry"></a>Az.ContainerRegistry
* Cmdletar har lagts till för databas-, manifest-och tagg åtgärder som stöds:
...
Stöds-EnableNoPublicIP när du skapar en Databricks-arbetsyta

#### <a name="azfrontdoor"></a>Az.FrontDoor
* Lade till FrontDoorId i egenskaper
* Stöd för JSON-undantag och RequestBodyCheck har lagts till i hanterade regler

#### <a name="azhdinsight"></a>Az.HDInsight
* Den nya parametern-EnableComputeIsolation och-ComputeIsolationHostSku har lagts till i cmdleten New-AzHDInsightCluster för att stödja beräknings isolerings funktionen
* Egenskapen "ComputeIsolationProperties" och "ConnectivityEndpoints" lades till i klassen AzureHDInsightCluster.

#### <a name="azkeyvault"></a>Az.KeyVault
* Stöd för att ange nyckel typ och kurv namn vid import av nycklar via en BYOK-fil

#### <a name="aznetwork"></a>Az.Network
* Nya cmdletar har lagts till för att ersätta det gamla produkt namnet "virtuell router" med det nya namnet "Route Server" i framtiden.
    - "New-AzRouteServer"
    - "Get-AzRouteServer"
    ...
    - Varningen för utfasnings-attributet har lagts till i de gamla cmdletarna.
* Fel korrigering i ExpressRouteLink MacSecConfig. Den nya egenskapen SciState har lagts till i PSExpressRouteLinkMacSecConfig
* Uppdaterade format lista och formatera tabellvyer för Get-AzVirtualNetworkGatewayConnectionIkeSa

#### <a name="azpolicyinsights"></a>Az.PolicyInsights
* Återkallade ändringar som gjorts i PowerShell och som ökade begär ande rad gränsen. Tog bort felaktig instruktion av stöd sid indelning

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* ändrade princip validerings gränser per säkerhets kopierings tjänst.
* Zon redundans har lagts till för Recovery Service-valv. 
* Azure Site Recovery stöd för närhets placerings grupp för VMware till Azure och HyperV till Azure-leverantörer.
* Azure Site Recovery stöd för tillgänglighets zon för VMware till Azure och HyperV till Azure-leverantörer.
* Azure Site Recovery stöd för UseManagedDisk för HyperV till Azure-providern

#### <a name="azresources"></a>Az.Resources
* Objekt typen har tagits bort på New-AzRoleAssignment och Set-AzRoleAssignment eftersom den aktuella mappningen har brutit vissa scenarier

#### <a name="azsql"></a>Az.Sql
* Lade till MaintenanceConfigurationId till "New-AzSqlDatabase", "Set-AzSqlDatabase", "New-AzSqlElasticPool" och "Set-AzSqlElasticPool"
* Fast regression i ' set-AzSqlServerAudit ' när PredicateExpression-argumentet anges

#### <a name="azstorage"></a>Az.Storage
* RoutingPreference-inställningar som stöds i lagrings kontot för att skapa/uppdatera
    - 'New-AzStorageAccount'
    - 'Set-AzStorageAccount'
* Uppgraderade Azure. Storage. blobar till 12.8.0
* Uppgraderade Azure. Storage. files. deresurser till 12.6.0
* Uppgraderade Azure. Storage. files. DataLake till 12.6.0

#### <a name="azwebsites"></a>Az.Websites
* Stöd för import av ett Key Vault-certifikat till WebApp har lagts till.

### <a name="thanks-to-our-community-contributors"></a>Tack till våra community-deltagare
* @atul-ram, Uppdatera Set-AzEventHub.md (#13921)
* Christoph Bergmeister [MVP] ( @bergmeister ), set-AzDataLakeGen2AclRecursive.MD-Fix skrivning (directiry-> Directory) (#14082)
* Alexander Schmidt ( @devdeer-alex ), fast bruten länk till bidrags rikt linjerna (#14009)
* @JiangYuchun, Uppdatera Get-AzApplicationGatewayAuthenticationCertificate.md (#13972)
* Sebastian Olsen ( @Spacebjorn ), korrigerat exempel kommando (#13901)

## <a name="540---january-2021"></a>5.4.0 – 2021 januari
#### <a name="azaccounts"></a>Az.Accounts
* Visar korrekt ID för klientbegäran i fel söknings meddelande [#13745]
* Vanlig Azure PowerShell av undantags typ har lagts till
* Lagrings-API som stöds 2019-06-01

#### <a name="azautomation"></a>Az.Automation
* Fast problem där beskrivning inte har fyllts i för uppdaterings hanterings scheman

#### <a name="azcosmosdb"></a>AZ. CosmosDB
* Allmän tillgänglighet för modulen "AZ. CosmosDB"
* Begränsa New-AzCosmosDBAccount cmdlet för att göra uppdaterings anrop till befintliga databas konton.
* Introduktion av AnalyticalStorageTTL i SqlContainer.

#### <a name="aziothub"></a>Az.IotHub
* Fast en regression för generering av SAS-token

#### <a name="azkeyvault"></a>Az.KeyVault
* Åtgärdat ett problem i modulen för hemliga hantering

#### <a name="azlogicapp"></a>Az.LogicApp
* Ett fast problem som "Get-AzLogicAppTriggerHistory" och "Get-AzLogicAppRunAction" hämtar endast den första sidan med resultat [#9141]

#### <a name="azmonitor"></a>Az.Monitor
* Cmdletar har lagts till för data insamlings regler: 
    - "Get-AzDataCollectionRule"
    - "New-AzDataCollectionRule"
    - ' Set-AzDataCollectionRule '
    - "Update-AzDataCollectionRule"
    - ' Remove-AzDataCollectionRule '
* Cmdletar för associationer för data insamlings regler har lagts till
    - "Get-AzDataCollectionRuleAssociation"
    - "New-AzDataCollectionRuleAssociation"
    - ' Remove-AzDataCollectionRuleAssociation '

#### <a name="aznetwork"></a>Az.Network
* Nya cmdletar har lagts till för CRUD av VpnGatewayNATRule.
    - "New-AzVpnGatewayNatRule"
    - "Update-AzVpnGatewayNatRule"
    - "Get-AzVpnGatewayNatRule"
    - ' Remove-AzVpnGatewayNatRule '  
* Uppdaterade cmdletar för att ange NATRule på VpnGateway-resursen och koppla den till VpnSiteLinkConnection-resursen.
    - "New-AzVpnGateway"
    - "Update-AzVpnGateway" 
    - "New-AzVpnSiteLinkConnection"
* Uppdaterade cmdletar för att aktivera inställningen av ConnectionMode på Virtual Network Gateway-anslutningar.
    - 'New-AzVirtualNetworkGatewayConnection'
    - 'Set-AzVirtualNetworkGatewayConnection'
* Uppdaterade cmdleten "New-AzFirewallPolicyApplicationRule":
    - Parametern TargetUrl har lagts till
    - Parametern TerminateTLS har lagts till
* Nya cmdletar har lagts till för Azure Firewall Premium-funktioner
    - "New-AzFirewallPolicyIntrusionDetection"
    - "New-AzFirewallPolicyIntrusionDetectionBypassTraffic"
    - "New-AzFirewallPolicyIntrusionDetectionSignatureOverride"
* Uppdaterad New-AzFirewallPolicy-cmdlet:
    - Parametern-SkuTier har lagts till
    - Parameter-ID har lagts till
    - Parametern-UserAssignedIdentityId har lagts till
    - Parametern-IntrusionDetection har lagts till
    - Parametern-TransportSecurityName har lagts till
    - Parametern-TransportSecurityKeyVaultSecretId har lagts till
* En ny cmdlet har lagts till för att hämta IKE-säkerhets associationer för Virtual Network Gateway-anslutningar.
    - "Get-AzVirtualNetworkGatewayConnectionIkeSa"
* Stöd för flera autentiseringar har lagts till för p2sVpnGateway
    - Uppdaterade New-AzVpnServerConfiguration och Update-AzVpnServerConfiguration för att tillåta att flera autentiseringsmetoder anges.
* Uppdaterade cmdleten New-AzVpnGateway och New-AzP2sVpnGateway:
    - Parametern EnableRoutingPreferenceInternetFlag har lagts till

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Funktionen återställning av kors region har lagts till.  
* Blockerade hämtning av arbets belastnings konfiguration när mål objekt är en tillgänglighets grupp.

#### <a name="azresources"></a>Az.Resources
* Stöd har lagts till för parametern-QueryString i New-AZ *-cmdletar för distributioner

#### <a name="azsql"></a>Az.Sql
* Gjort "Start-AzSqlInstanceDatabaseLogReplay"-cmdlet synkron, tillagd-AsJob flagga

#### <a name="azstorage"></a>Az.Storage
* Åtgärda ContinuationToken aldrig null vid List-BLOB med-IncludeVersion
    - ”Get-AzStorageBlob”

#### <a name="azwebsites"></a>Az.Websites
* Stöd har lagts till för App Service hanterade certifikat
    - "New-AzWebAppCertificate"
    - ' Remove-AzWebAppCertificate '
* Åtgärdat problem som gör att Docker-lösenordet tas bort från appSettings i set-AzWebApp och set-AzWebAppSlot

### <a name="thanks-to-our-community-contributors"></a>Tack till våra community-deltagare
* Ivan Akcheurov ( @ivanakcheurov ), uppdatera set-AzSecurityWorkspaceSetting.MD (#13877)
* @javiermarasco, Uppdaterings exempel (#13837)
* @jhaprakash26, Uppdatera Set-AzVirtualNetwork.md (#13857)
* Michael Holmes ( @MichaelHolmesWP ), uppdatera New-AzStorageTableStoredAccessPolicy.MD (#13871)
* Michael Jonas ( @mikejwhat ), tillåt Get-AzLogicAppTriggerHistory och Get-AzLogicAppRunAction att returnera fler än 30 resultat (#13846)
* @Willem-J-an, Korrigera fel som orsakar Docker-lösenord att tas bort från appSettings i set-AzWebApp (fack) (#13866)

## <a name="530---december-2020"></a>5.3.0 – december 2020
#### <a name="azaccounts"></a>Az.Accounts
* Åtgärdat problemet med att http-proxy inte iakttas i Windows PowerShell [#13647]
* Förbättrad felsökningslogg för tidskrävande åtgärder i genererade moduler

#### <a name="azautomation"></a>Az.Automation
* Åtgärdat problemet med att parametrar för start-AzAutomationRunbook inte kan konvertera PSObject-omsluten sträng till JSON-sträng [#13240]
* Åtgärdade platsifyllning för cmdleten New-AzAutomationUpdateManagementAzureQuery

#### <a name="azcompute"></a>Az.Compute
* Den nya parametern VM i den nya parameteruppsättningen VMParameterSet har lagts till i cmdletarna Get-AzVMDscExtensionStatus och Get-AzVMDscExtension. 

#### <a name="azdatabricks"></a>Az.Databricks
* Åtgärdade ett problem som kan få New-AzDatabricksVNetPeering att returneras innan den etablerats helt (https://github.com/Azure/autorest.powershell/issues/610)

#### <a name="azdatafactory"></a>Az.DataFactory
* Åtgärdat problemet med kommandot Invoke-AzDataFactoryV2Pipeline för SupportsShouldProcess

#### <a name="azdesktopvirtualization"></a>Az.DesktopVirtualization
* Egenskapen StartVMOnConnect har lagts till i värdpool.

#### <a name="azhdinsight"></a>Az.HDInsight
* Lade till egenskaperna: Fqdn och EffectiveDiskEncryptionKeyUrl i klassen AzureHDInsightHostInfo.

#### <a name="azkeyvault"></a>Az.KeyVault
* Lade till nya parametern -AsPlainText till Get-AzKeyVaultSecret för att direkt returnera hemligheten i klartext [#13630]
* Stöd för selektiv återställning av nyckel från en hanterad fullständig HSM-säkerhetskopia [#13526]
* Några mindre problem har åtgärdats [#13583] [#13584]
* Lade till saknade returnerade objekt för Get-Secret i SecretManagement-modulen
* Åtgärdade ett problem som kan leda till att valvet skapas utan standardåtkomstprincip [#13687]

#### <a name="azkusto"></a>Az.Kusto
* API-versionen har uppdaterats till 2020-09-18.

#### <a name="aznetwork"></a>Az.Network
* Åtgärdade problem med att ta bort peering- och anslutnings-cmdlet för ExpressRouteCircuit-scenario
    - Remove-AzExpressRouteCircuitPeeringConfig och Remove-AzExpressRouteCircuitConnectionConfig

#### <a name="azpolicyinsights"></a>Az.PolicyInsights
* Lade till stöd för att returnera sidnumrerade resultat för Get-AzPolicyState

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Funktionen mjuk borttagning har aktiverats för SQL.
* Åtgärdade SQL AG-återställning och tog bort containernamnskontrollen.
* Ändrade containernamnsformatet för Azure Files-säkerhetskopieringsobjekt.
* Stöd för CMK-funktioner har lagts till i Recovery Services-valvet.

#### <a name="azresources"></a>Az.Resources
* Åtgärdade ett NullRef-undantagsproblem i New-AzureManagedApplication och Set-AzureManagedApplication.
* Uppdaterade Azure Resource Manager SDK för att använda den senaste DeploymentScripts GA API-versionen: 2020-10-01.

#### <a name="azservicefabric"></a>Az.ServiceFabric
* Åtgärdade Add-AzServiceFabricNodeType. Lade till nodtypen till Service Fabric-kluster innan VM-skalningsuppsättningar skapas.

#### <a name="azsql"></a>Az.Sql
* Parameterbeskrivningen för kommandot InstanceFailoverGroup har åtgärdats.
* Uppdaterade logiken där schemaName, tableName och columnName extraheras från ID:t för SQL-dataklassificeringskommandon.
* Uppdaterade fälten Status och StatusMessage i Get-AzSqlDatabaseImportExportStatus så att de överensstämmer med dokumentationen
* Lade till gransknings-cmdletar för Microsoft-supportåtgärder (DevOps): Get-AzSqlServerMSSupportAudit, Set-AzSqlServerMSSupportAudit, Remove-AzSqlServerMSSupportAudit

#### <a name="azstorage"></a>Az.Storage
* Stöd för att skapa/uppdatera/hämta/lista EncryptionScope för ett lagringskonto
    - New-AzStorageEncryptionScope
    - Update-AzStorageEncryptionScope
    - Get-AzStorageEncryptionScope
* Stöd för att skapa container och ladda upp blob med inställning för krypteringsomfång
    - New-AzRmStorageContainer
    - New-AzStorageContainer
    - ”Set-AzStorageBlobContent”

### <a name="thanks-to-our-community-contributors"></a>Tack till våra community-deltagare
* Andreas Wolter (@AndreasWolter), tog bort marknadsföringsspråk, bättre exempelfilter (#13671)
* Tidjani Belmansour (@BelRarr), uppdatera Get-AzBillingInvoice.md (#13634)
* David Klempfner (@DavidKlempfner)
  * Åtgärdade stavfel (#13677)
  * Uppdatera PSMetricNoDetails.cs (#13676)
* @kilobyte97, felsökning för borttagning av cmdlet för att ta bort konfiguration (#13655)
* @kongou-ae, uppdatera Set-AzFirewall.md (#13727)
* @MasterKuat, åtgärda växling mellan rubrik och kod i dokumentationen (#13666)
* NickT (@nukeulis), uppdatera Set-AzContext.md (#13702)
* @PaulHCode, uppdatera Start-AzJitNetworkAccessPolicy.md – åtgärda exemplet för att visa rätt cmdlet (#13713)
* Ryan Borstelmann (@ryanborMSFT), tog bort prenumerations-ID (#13715)
* Shashikant Shakya (@shshakya), uppdatera Set-AzSqlDatabase.md (#13674)
* Sebastian Olsen (@Spacebjorn), uppdatera Get-AzRecoveryServicesBackupItem.md (#13719)

## <a name="520---december-2020"></a>5.2.0 – December 2020
#### <a name="azaccounts"></a>Az.Accounts
* Det gick att parsa ExpiresOn-tiden från rådatatoken om den inte kunde hämtas från det underliggande biblioteket
* Förbättrat varningsmeddelande om interaktiv autentisering inte är tillgängligt

#### <a name="azapimanagement"></a>Az.ApiManagement
* [Icke-bakåtkompatibel ändring] New-AzApiManagementProduct har som standard ingen prenumerationsgräns.

#### <a name="azcompute"></a>Az.Compute
* Redigerade get-AzVm för att filtrera efter -Name innan du kontrollerar begränsning på grund av för många resurser. 
* Ny cmdlet Start-AzVmssRollingExtensionUpgrade.

#### <a name="azcontainerregistry"></a>Az.ContainerRegistry
* Parametern Name och värdet från pipeline-indata stöds för Get-AzContainerRegistryUsage [#13605]
* Korrigerade undantag för Connect-AzContainerRegistry

#### <a name="azdatafactory"></a>Az.DataFactory
* Uppdaterade ADF .Net SDK-versionen till 4.13.0

#### <a name="azhealthcareapis"></a>Az.HealthcareApis
* Stöd har lagts till för kundhanterade nycklar

#### <a name="aziothub"></a>Az.IotHub
* Ett problem med SAS-token har åtgärdats.

#### <a name="azkeyvault"></a>Az.KeyVault
* Stöder All som ett alternativ när du ställer in åtkomstprinciper för nyckelvalv
* Ny version av SecretManagement-modulen stöds [#13366]
* Stöder ByteArray, String, PSCredential och Hashtable för SecretValue i SecretManagementModule [#12190]
* [Icke-bakåtkompatibel ändring] Omdesignat API-ytan för cmdletar som är relaterade till hanterad HSM.

#### <a name="azmonitor"></a>Az.Monitor
* Parametern Rule i New-AzAutoscaleProfile har ändrats för att godkänna en tom lista. [#12903]
* Nya cmdletar har lagts till för att stöda skapande av mer flexibla diagnostikinställningar:
    * Get-AzDiagnosticSettingCategory
    * New-AzDiagnosticSetting
    * New-AzDiagnosticDetailSetting

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Ändrat hjälptext och parameteruppsättningsnamn till cmdleten Restore-AzRecoveryServicesBackupItem.

#### <a name="azresources"></a>Az.Resources
* Stöd för parametern -Tag har lagts till i Set-AzTemplateSpec och New-AzTemplateSpec
* Stöd för taggvisning har lagts till som standard för formatering av Mallspecifikationer 

#### <a name="azservicefabric"></a>Az.ServiceFabric
* Lade till exempel i Set-AzServiceFabricSetting med parametern SettingsSectionDescription
* Uppdaterade programrelaterade cmdletar för att anropa att stöd endast finns för ARM-distribuerade resurser
* Markerat för cmdletarna Add-AzureRmServiceFabricClusterCertificate och Remove-AzureRmServiceFabricClusterCertificate med utfasningsklustercertifikat

#### <a name="azsql"></a>Az.Sql
* Lade till SecondaryType till följande: 
    - New-AzSqlDatabase
    - Set-AzSqlDatabase
    - New-AzSqlDatabaseSecondary
* Lade till HighAvailabilityReplicaCount till följande: 
    - New-AzSqlDatabase
    - Set-AzSqlDatabase
* Gjorde ReadReplicaCount till ett alias för HighAvailabilityReplicaCount i följande: 
    - New-AzSqlDatabase
    - Set-AzSqlDatabase

#### <a name="azstorage"></a>Az.Storage
* Stöder överföring av Azure-filstorlek på upp till 4 TiB
    - ”Set-AzStorageFileContent”
* Uppgraderade Azure.Storage.Blobs till 12.7.0
* Uppgraderade Azure.Storage.Files.Shares till 12.5.0
* Uppgraderade Azure.Storage.Files.DataLake till 12.5.0

#### <a name="azstoragesync"></a>Az.StorageSync
* Principfunktionen för synkronisering av nivåer har lagts till med hämtningsprincip och lokalt cacheläge

#### <a name="azwebsites"></a>Az.Websites
* Förhindra dubbletter av åtkomstbegränsningsregler

### <a name="thanks-to-our-community-contributors"></a>Tack till våra community-deltagare
* Andrew Dawson (@dawsonar802), uppdatera Get-AzKeyVaultCertificate.md – hämta certifikat och spara det som pfx-avsnitt som fungerar med PowerShell Core (#13557)
* @iviark, sjukvårds-API:er PowerShell BYOK-uppdateringar (#13518)
* John Duckmanton (@johnduckmanton), korrigera stavning av TagPatchOperation (#13508)
* Michael James (@mikejwhat)
  * Hjälp till att fixa Get-AzLogicAppRunHistory (#13513)
* Richard de Zwart (@mountain65)
  * Uppdatera Update-AzAppConfigurationStore.md (#13485)
  * Uppdatera New-AzCosmosDBAccount.md (#13490)
* @SteppingRazor, New-AzApiManagementProduct: Ändra standardvärdet för parametern SubscriptionsLimit till None (#13457)
* Steve Burkett (@SteveBurkettNZ), korrigera skrivfel för parametern WorkspaceResourceId i exemplet (#13589)

## <a name="510---november-2020"></a>5.1.0 – November 2020
#### <a name="azaccounts"></a>Az.Accounts
* Korrigerade ett problem där TenantId kanske inte kan respekteras när ”Connect-AzAccount -DeviceCode” används [#13477]
* Lade till en ny cmdlet: ”Get-AzAccessToken”
* Korrigerade ett problem som uppstår om det inte går att komma åt sökvägen till användarprofilen
* Korrigerade ett problem som orsakar ett skriv-objektfel under Connect-AzAccount [#13419]
* Lade till parametern ”ContainerRegistryEndpointSuffix” för: ”Add-AzEnvironment”, ”Set-AzEnvironment” 
* Stöd för att avbryta inloggning genom att trycka på <kbd>CTRL</kbd>+<kbd>C</kbd>
* Korrigerade ett problem som gjorde att ”Connect-AzAccount -KeyVaultAccessToken” inte fungerade [#13127]
* Korrigerade null-referens och skiftlägesokänslig metod i ”Invoke-AzRestMethod”

#### <a name="azaks"></a>Az.Aks
* Korrigerade problemet att användaren inte kunde använda tjänstens huvudnamn för att skapa ett nytt Kubernetes-kluster. [#13012]

#### <a name="azappconfiguration"></a>Az.AppConfiguration
* Allmän tillgänglighet för modulen ”Az.AppConfiguration”

#### <a name="azdatafactory"></a>Az.DataFactory
* Förbättrade felmeddelandet för kommandot ”New-AzDataFactoryV2LinkedServiceEncryptedCredential”

#### <a name="azdatalakestore"></a>Az.DataLakeStore
* Uppdaterade SDK för ADLS-dataplanen till 1.2.4-alpha. Ändringar: https://github.com/Azure/azure-data-lake-store-net/blob/preview-alpha/CHANGELOG.md#version-124-alpha

#### <a name="azdesktopvirtualization"></a>Az.DesktopVirtualization
* Lade till nya cmdletar för MSIX-paket och uppdaterade program-cmdletar.

#### <a name="azeventhub"></a>Az.EventHub
* Korrigerade klusterkommandon för EventHub-kluster utan taggar
* Uppdaterade hjälptext för PartnerNamespace i AzEventHubGeoDRConfiguration-kommandon 

#### <a name="azhdinsight"></a>Az.HDInsight
* Lade till parametrarna ”ResourceProviderConnection” och ”PrivateLink” till cmdleten ”New-AzHDInsightCluster” för att stödja funktionen för att vidarebefordra utgående och privata länkar
* Lade till parametern ”AmbariDatabase” till cmdleten ”New-AzHDInsightCluster” för att stödja en anpassad Ambari-databasfunktion
* Lade till det accepterade värdet ”AmbariDatabase” till parametern ”MetastoreType” för cmdleten ”Add-AzHDInsightMetastore”

#### <a name="aziothub"></a>Az.IotHub
* Tillät taggar i cmdlet för att skapa i IoT Hub.

#### <a name="azkeyvault"></a>Az.KeyVault
* Stöd för att uppdatera nyckelvalvstagg

#### <a name="azlogicapp"></a>Az.LogicApp
* Korrigerade så att Get-AzLogicAppRunHistory endast hämtar den första sidan med resultat

#### <a name="aznetwork"></a>Az.Network
* Uppdaterade cmdletarna här under 
    - ”New-AzLoadBalancerFrontendIpConfigCommand”, ”Set-AzLoadBalancerFrontendIpConfigCommand”, ”Add-AzLoadBalancerFrontendIpConfigCommand”:
        - Lade till egenskapen PublicIpAddressPrefix
        - Lade till egenskapen PublicIpAddressPrefixId
* Lade till nya egenskaper till i följande cmdletar för att möjliggöra global belastningsutjämning:
    - ”New-AzLoadBalancer”:
        - Lade till egenskapen SKU-nivå
    - ”New-AzPuplicIpAddress”:
        - Lade till egenskapen SKU-nivå
    - ”New-AzPublicIpPrefix”:
        - Lade till egenskapen SKU-nivå
    - ”New-AzLoadBalancerBackendAddressConfig”:
        - Lade till egenskapen LoadBalancerFrontendIPConfigurationId
* Uppdaterade planer att göra varningar för följande cmdletar inaktuella: -”New-AzVirtualHubRoute”, -”New-AzVirtualHubRouteTable”, -”Add-AzVirtualHubRoute”, -”Add-AzVirtualHubRouteTable” -”Get-AzVirtualHubRouteTable” och -”Remove-AzVirtualHubRouteTable”
* Lade till planer att göra varningar för argumentet ”RouteTable” inaktuella för följande cmdletar: -”New-AzVirtualHub”, -”Set-AzVirtualHub” och -”Update-AzVirtualHub”
* Gjorde argumenten ”-MinScaleUnits” och ”-MaxScaleUnits” valfria i ”Set-AzExpressRouteGateway”
* Lade till nya cmdletar för att stödja ömsesidig autentisering och SSL-profiler på Application Gateway
...
#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Specificera att principen BackupTime är i UTC.
* Ändra varning för icke-bakåtkompatibel ändring i cmdleten Get-AzRecoveryServicesBackupJobDetails.
* Uppdaterar exempelskriptets hjälptext för cmdleten Set-AzRecoveryServicesBackupProtectionPolicy.

#### <a name="azresources"></a>Az.Resources
* Korrigerade ett problem där konsekvensgranskning visade två omfång för resursgrupper med olika skiftlägen
* Uppdaterade ”Export-AzResourceGroup” för att använda SDK.
* Lade till kulturinformation för att parsa metoder

#### <a name="azsql"></a>Az.Sql
* Korrigerade problem där Set-AzSqlDatabaseAudit inte hade stöd för databas i hyperskala och databasversionen inte kunde fastställas
* Lade till MaintenanceConfigurationId för ”New-AzSqlInstance” och ”Set-AzSqlInstance”
* Korrigerade en bugg i GetAzureSqlDatabaseReplicationLink.cs där parametern PartnerServerName kontrollerades efter värde i stället för nyckel

#### <a name="azwebsites"></a>Az.Websites
* Lade till stöd för nya funktioner för åtkomstbegränsning: ServiceTag, flera IP-adresser och HTTP-rubriker

### <a name="thanks-to-our-community-contributors"></a>Tack till våra community-deltagare
* John Q. Martin (@johnmart82), lägger till nödvändig brandväggsinformation (#13385)
* Manikandan Duraisamy (@madurais-msft), korrigerade argumentet PublicSubnetName (#13417)
* @mahortas, uppdatera parametervärden för -HostName (#13349)
* @MariachiForHire, lade till TrafficAnalyticsInterval-värden som stöds (#13304)
* Michael Jonas (@mikejwhat), tillåt att Get-AzLogicAppRunHistory returnerar fler än 30 poster (#13393)
* Shashikant Shakya (@shshakya), uppdatera Restore-AzSqlInstanceDatabase.md (#13404)

## <a name="500---october-2020"></a>5.0.0 – Oktober 2020
#### <a name="azaccounts"></a>Az.Accounts
* [Icke-bakåtkompatibel ändring] Tog bort ”Get-AzProfile” och ”Select-AzProfile”
* Ersatte Azure Directory Authentication Library med Microsoft Authentication Library (MSAL)

#### <a name="azaks"></a>Az.Aks
* [Icke-bakåtkompatibel ändring] Tog bort aliaset ”ClientIdAndSecret” i ”New-AzAksCluster” och ”Set-AzAksCluster”.
* [Icke-bakåtkompatibel ändring] Ändrade standardvärdet för ”NodeVmSetType” i ”New-AzAksCluster” från ”AvailabilitySet” till ”VirtualMachineScaleSets”.
* [Icke-bakåtkompatibel ändring] Ändrade standardvärdet för ”NetworkPlugin” i ”New-AzAksCluster” från ”None” till ”azure”.
* [Icke-bakåtkompatibel ändring] Tog bort parametern ”NodeOsType” i ”New-AzAksCluster” eftersom den endast har stöd för Linux med ett värde.

#### <a name="azbilling"></a>Az.Billing
* Lade till cmdleten ”Get-AzBillingAccount”
* Lade till cmdleten ”Get-AzBillingProfile”
* Lade till cmdleten ”Get-AzInvoiceSection”
* Lade till nya parametrar i cmdleten ”Get-AzBillingInvoice”
* Tog bort egenskaperna ”DownloadUrlExpiry”, ”Type” och ”BillingPeriodNames” från svaret för cmdleten ”Get-AzBillingInvoic”

#### <a name="azcdn"></a>Az.Cdn
* Lade till cmdletar för att stödja funktioner för flera ursprung och privat länk 

#### <a name="azcognitiveservices"></a>Az.CognitiveServices
* Uppdaterade SDK till 7.4.0-preview.

#### <a name="azcompute"></a>Az.Compute
* Lade till parametern ”-VmssId” till ”New-AzVm”
* Lade till parametern ”PlatformFaultDomainCount” till cmdleten ”New-AzVmss”.
* Ny cmdlet: ”Get-AzDiskEncryptionSetAssociatedResource”
* Lade till de valfria parametrarna ”Tier” och ”LogicalSectorSize” till cmdleten ”New-AzDiskConfig”. 
...
#### <a name="azdatabricks"></a>Az.Databricks
* Korrigerade en bugg som kunde leda till att en uppdatering av en Databricks-arbetsyta utan `-EncryptionKeyVersion` misslyckades.

#### <a name="azdatafactory"></a>Az.DataFactory
* Uppdaterade ADF .Net SDK-versionen till 4.12.0
* Uppdaterade ADF-krypteringsklientens SDK-version till 4.14.7587.7
* Lade till kommandona ”Stop-AzDataFactoryV2TriggerRun” och ”Invoke-AzDataFactoryV2TriggerRun”

#### <a name="azdesktopvirtualization"></a>Az.DesktopVirtualization
* Kräv egenskapen Plats för att skapa ARM-objekt på högsta nivån.
        * Gjorde så att `ApplicationGroupType` krävs för `New-AzWvdApplicationGroup`.
        * Gjorde så att `HostPoolArmPath` krävs för `New-AzWvdApplicationGroup`.
        * `PreferredAppGroupType` har lagts till för `New-AzWvdHostPool`.

#### <a name="azfunctions"></a>Az.Functions
* [Icke-bakåtkompatibel ändring] Tog bort växelparametern ”IncludeSlot” från alla förutom en parameteruppsättning i ”Get-AzFunctionApp”. Cmdleten stöder nu hämtning av distributionsfack i resultaten när ”-IncludeSlot” anges. 
* Uppdaterade ”New-AzFunctionApp”:
  - Korrigerade ”-DisableApplicationInsights” så att inga Application Insights-projekt skapas när det här alternativet har angetts. [#12728]
  - [Icke-bakåtkompatibel ändring] Tog bort stöd för att skapa PowerShell 6.2-funktionsappar.
  - [Icke-bakåtkompatibel ändring] Ändrade körningsversionen som är standard i Functions version 3 i Windows för PowerShell-funktionsappar från 6.2 till 7.0 när parametern RuntimeVersion inte har angetts.
  - [Icke-bakåtkompatibel ändring] Ändrade körningsversionen som är standard i Functions version 3 i Windows och Linux för Node-funktionsappar från 10 till 12 när parametern RuntimeVersion inte har angetts.
  - [Icke-bakåtkompatibel ändring] Ändrade körningsversionen som är standard i Functions version 3 i Linux för Python-funktionsappar från 3.7 till 3.8 när parametern RuntimeVersion inte har angetts.

#### <a name="azhdinsight"></a>Az.HDInsight
 * För cmdleten New-AzHDInsightCluster:
     - Ersatte parametern ”DefaultStorageAccountName” med ”StorageAccountResourceId”
     - Ersatte parametern ”DefaultStorageAccountKey” med ”StorageAccountKey”
     - Ersatte parametern ”DefaultStorageAccountType” med ”StorageAccountType”
     - Tog bort parametern ”PublicNetworkAccessType”
     - Ta bort parametern ”OutboundPublicNetworkAccessType”
     - Lade till nya parametrar: ”StorageFileSystem” och ”StorageAccountManagedIdentity” för att stödja ADLSGen2
     - Lade till den nya parametern ”EnableIDBroker” för att stödja ID-förmedlaren i HDInsight
     - Lade till nya parametrar: ”KafkaClientGroupId”, ”KafkaClientGroupName” och ”KafkaManagementNodeSize” för att stödja Kafka REST-proxy
 * För cmdleten New-AzHDInsightClusterConfig:
     - Ersatte parametern ”DefaultStorageAccountName” med ”StorageAccountResourceId”
     - Ersatte parametern ”DefaultStorageAccountKey” med ”StorageAccountKey”
     - Ersatte parametern ”DefaultStorageAccountType” med ”StorageAccountType”
     - Tog bort parametern ”PublicNetworkAccessType”
     - Ta bort parametern ”OutboundPublicNetworkAccessType”
* För cmdleten Set-AzHDInsightDefaultStorage:
    - Ersatte parametern ”StorageAccountName” med ”StorageAccountResourceId”
* För cmdleten Add-AzHDInsightSecurityProfile:
    - Ersatte parametern ”Domain” med ”DomainResourceId”
    - Tog bort det obligatoriska kravet för parametern ”OrganizationalUnitDN”

#### <a name="azkeyvault"></a>Az.KeyVault
* [Icke-bakåtkompatibel ändring] Parametrarna DisableSoftDelete i ”New-AzKeyVault” och EnableSoftDelete i ”Update-AzKeyVault” har gjorts inaktuella
* [Icke-bakåtkompatibel ändring] Tog bort attributet SecretValueText för att undvika att SecretValue visas direkt [#12266]
* Stöd för ny resurstyp: hanterad HSM
    - CRUD för hanterad HSM och cmdleter för att köra nycklar på hanterad HSM
    - Fullständig HSM-säkerhetskopiering/återställning, skapande av AES-nyckel, säkerhetskopiering/återställning av domän, RBAC

#### <a name="azmanagedservices"></a>Az.ManagedServices
* [Icke-bakåtkompatibel ändring] Uppdaterade namngivningskonventioner för parametrar och associerade exempel

#### <a name="aznetwork"></a>Az.Network
* [Icke-bakåtkompatibel ändring] Tog bort parametern ”HostedSubnet” och lade till ”Subnet” i stället
* Lade till nya cmdletar för peeringvägar för virtuella routrar
    - ”Get-AzVirtualRouterPeerLearnedRoute”
    - ”Get-AzVirtualRouterPeerAdvertisedRoute”
* Cmdleten New-AzFirewall har uppdaterats:
    - Lade till parametern ”-SkuTier”
    - Lade till parametern ”-SkuName” och gjorde Sku till ett alias för den
    - Tog bort parametern ”-Sku”
* [Icke-bakåtkompatibel ändring] Gjorde argumentet ”Connectionlink” obligatoriskt i ”Start-AzVpnConnectionPacketCapture” och ”Stop-AzVpnConnectionPacketCapture”
* [Icke-bakåtkompatibel ändring] Uppdaterade ”New-AzNetworkWatcherConnectionMonitorEndPointObject” för att ta bort parametern ”-Filter”
* [Icke-bakåtkompatibel ändring] Ersatte cmdleten ”New-AzNetworkWatcherConnectionMonitorEndpointFilterItemObject” med ”New-AzNetworkWatcherConnectionMonitorEndpointScopeItemObject”
* Uppdaterade cmdleten ”New-AzNetworkWatcherConnectionMonitorEndPointObject”:
    - Lade till parametern ”-Type”
    - Lade till parametern ”-CoverageLevel”
    - Lade till parametern ”-Scope”
* Uppdaterade cmdleten ”New-AzNetworkWatcherConnectionMonitorProtocolConfigurationObject” med den nya parametern ”-DestinationPortBehavior”

#### <a name="azrecoveryservices"></a>Az.RecoveryServices
* Korrigerar återställning av arbetsbelastningar för behörigheter för deltagare.
* Lade till nya parameteruppsättningar och valideringar för cmdleten ”Restore-AzRecoveryServicesBackupItem”.

#### <a name="azresources"></a>Az.Resources
* Korrigerade en bugg vid parsning
* Uppdaterade What-If-cmdletar i ARM-mall för att ta bort förhandsgranskningsmeddelandet från resultaten
* Korrigerade ett problem där cmdletar för mall-distribution kraschar om ”-WhatIf” har ställts in på ett högre omfång [#13038]
* Korrigerade ett problem där cmdletar för malldistribution inte bevarar skiftläget för mallparametrar
* Lade till en standard-API-version som kan användas i cmdleten ”Export-AzResourceGroup”
* Lade till cmdletar för mallspecifikationer (”Get-AzTemplateSpec”, ”Set-AzTemplateSpec”, ”New-AzTemplateSpec”, ”Remove-AzTemplateSpec”, ”Export-AzTemplateSpec”)
* Lade till stöd för att distribuera mallspecifikationer med befintliga cmdletar för distribution (via den nya parametern ”-TemplateSpecId”) 
* Uppdaterade ”Get-AzResourceGroupDeploymentOperation” för att använda SDK.
* Tog bort parametern ”ApiVersion” från cmdletarna ”*-AzDeployment”.

#### <a name="azsql"></a>Az.Sql
* Korrigerade ett problem där New-AzSqlDatabaseExport misslyckas om networkIsolation inte har angetts [#13097]
* Korrigerade ett problem där New-AzSqlDatabaseExport och New-AzSqlDatabaseImport inte returnerade OperationStatusLink i resultatobjektet [#13097]
* Uppdatera webbadresser för Azure-kopplade regioner i redundansvarningar för Backup Storage 

#### <a name="azstorage"></a>Az.Storage
* Tog bort den föråldrade egenskapen RestorePolicy.LastEnabledTime
    - "Enable-AzStorageBlobRestorePolicy"
    - "Disable-AzStorageBlobRestorePolicy"
    - ”Get-AzStorageBlobServiceProperty”
    - ”Update-AzStorageBlobServiceProperty”
* Vill du ändra typen av DaysAfterModificationGreaterThan från int till int?
    - "Set-AzStorageAccountManagementPolicy"
    - "Get-AzStorageAccountManagementPolicy"
    - "Add-AzStorageAccountManagementPolicyAction"
    - "New-AzStorageAccountManagementPolicyRule"
* Stöd för skapa/uppdatera filresurs med åtkomstnivå
    - ”New-AzRmStorageShare”
    - ”Update-AzRmStorageShare”
* Stöd för att konfigurera/uppdatera/ta bort ACL som stöds rekursivt på Datalake Gen2-objekt 
    -  ”Set-AzDataLakeGen2AclRecursive” 
    -  ”Update-AzDataLakeGen2AclRecursive” 
    -  ”Remove-AzDataLakeGen2AclRecursive”
* Stöd för åtkomstprincip för containrar med de nya behörigheterna x, t
    -  ”New-AzStorageContainerStoredAccessPolicy”
    -  "Set-AzStorageContainerStoredAccessPolicy"
* Ändrade utdata från cmdleten hämta/ange åtkomstprincip för containrar genom att ändra behörighetstypen för den underordnade egenskapen från uppräkning till sträng
    -  "Get-AzStorageContainerStoredAccessPolicy"
    -  "Set-AzStorageContainerStoredAccessPolicy"
* Korrigerade ett problem med exempelskript för att ange hanteringsprincip med JSON
    -  "Set-AzStorageAccountManagementPolicy"

#### <a name="azwebsites"></a>Az.Websites
* Lade till stöd för Premium V3-prisnivån
* Uppdaterade SDK för WebSites till 3.1.0

### <a name="thanks-to-our-community-contributors"></a>Tack till våra community-deltagare
* @atul-ram, uppdatera Get-AzDelegation.md (#13176)
* @dineshreddy007, hämta approller som har tilldelats korrekt om Stack HCI-registrering använder WAC-token. (#13249)
* @kongou-ae, uppdatera New-AzOffice365PolicyProperty.md (#13217)
* Lohith Chowdary Chilukuri (@Lochiluk), uppdatera Set-AzApplicationGateway.md (#13150)
* Matthew Burleigh (@mburleigh)
  * Lägg till länkar till de PowerShell-cmdletar som refereras i dokumentet (#13203)
  * Lägg till länkar till de PowerShell-cmdletar som refereras i dokumentet (#13190)
  * Lägg till länkar till de PowerShell-cmdletar som refereras i dokumentet (#13189)
  * lägg till länkar till cmdletar som refereras (#13137)
  * Lägg till länkar till de PowerShell-cmdletar som refereras i dokumentet (#13204)
  * Lägg till länkar till de PowerShell-cmdletar som refereras i dokumentet (#13205)
