...
Cmdleten `Get-AzApiManagementProperty` har tagits bort och inget alias hittades för det ursprungliga cmdlet-namnet.

### `New-AzApiManagementProperty`

Cmdleten `New-AzApiManagementProperty` har tagits bort och inget alias hittades för det ursprungliga cmdlet-namnet.

### `Remove-AzApiManagementProperty`

Cmdleten `Remove-AzApiManagementProperty` har tagits bort och inget alias hittades för det ursprungliga cmdlet-namnet.

### `Set-AzApiManagementProperty`

Cmdleten `Set-AzApiManagementProperty` har tagits bort och inget alias hittades för det ursprungliga cmdlet-namnet.
...
Cmdleten `Get-AzOperationalInsightsSavedSearchResult` har tagits bort och inget alias hittades för det ursprungliga cmdlet-namnet.

### `Get-AzOperationalInsightsSearchResult`

Cmdleten `Get-AzOperationalInsightsSearchResult` har tagits bort och inget alias hittades för det ursprungliga cmdlet-namnet.
...
Cmdleten `Get-AzOperationalInsightsLinkTarget` har tagits bort och inget alias hittades för det ursprungliga cmdlet-namnet.
