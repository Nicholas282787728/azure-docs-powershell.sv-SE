...
#### <a name="azurermcompute"></a><span data-ttu-id="b963c-111">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b963c-111">AzureRM.Compute</span></span>
...
## <a name="6100---october-2018"></a><span data-ttu-id="b963c-126">6.10.0 – Oktober 2018</span><span class="sxs-lookup"><span data-stu-id="b963c-126">6.10.0 - October 2018</span></span>
...
* <span data-ttu-id="b963c-140">Funktionalitet för NetworkProfile har lagts till.</span><span class="sxs-lookup"><span data-stu-id="b963c-140">Added NetworkProfile functionality.</span></span> <span data-ttu-id="b963c-141">nya cmdletar har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-141">new cmdlets added</span></span>
    ...
    - <span data-ttu-id="b963c-147">New-AzureRmContainerNicConfigIpConfig</span><span class="sxs-lookup"><span data-stu-id="b963c-147">New-AzureRmContainerNicConfigIpConfig</span></span>
...
#### <a name="azurermwebsites"></a><span data-ttu-id="b963c-162">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="b963c-162">AzureRM.Websites</span></span>
...
#### <a name="azurermcompute"></a><span data-ttu-id="b963c-177">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b963c-177">AzureRM.Compute</span></span>
...
* <span data-ttu-id="b963c-192">Ändringar i LoadBalancer-cmdletar</span><span class="sxs-lookup"><span data-stu-id="b963c-192">Changes to LoadBalancer cmdlets</span></span>
  ...
  - <span data-ttu-id="b963c-196">LoadBalancerProbeConfig: stöd för värdet ”Https” för parameterprotokoll har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-196">LoadBalancerProbeConfig: added support for value "Https" for parameter Protocol</span></span>
...
* <span data-ttu-id="b963c-215">Stöd för betrott rotcertifikat och konfiguration för autoskalning har lagts till i Application Gateway</span><span class="sxs-lookup"><span data-stu-id="b963c-215">Added support for Trusted Root certificate and Autoscale configuration in Application Gateway</span></span>
  - <span data-ttu-id="b963c-216">Nya cmdletar har lagts till:</span><span class="sxs-lookup"><span data-stu-id="b963c-216">New Cmdlets added:</span></span>
      ...
      - <span data-ttu-id="b963c-221">Set-AzureRmApplicationGatewayTrustedRootCertificate</span><span class="sxs-lookup"><span data-stu-id="b963c-221">Set-AzureRmApplicationGatewayTrustedRootCertificate</span></span>
...
* <span data-ttu-id="b963c-235">Stöd för flera adressprefix i ett undernät har lagts till.</span><span class="sxs-lookup"><span data-stu-id="b963c-235">Added support for multiple address prefixes in a subnet.</span></span> <span data-ttu-id="b963c-236">Uppdaterade cmdletar:</span><span class="sxs-lookup"><span data-stu-id="b963c-236">Updated cmdlets:</span></span>
  ...
  - <span data-ttu-id="b963c-247">Set-AzureRmApplicationGatewayIPConfiguration</span><span class="sxs-lookup"><span data-stu-id="b963c-247">Set-AzureRmApplicationGatewayIPConfiguration</span></span>
...
#### <a name="azurermwebsites"></a><span data-ttu-id="b963c-290">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="b963c-290">AzureRM.Websites</span></span>
...
* <span data-ttu-id="b963c-307">Åtgärdat problem https://github.com/Azure/azure-powershell/issues/6814</span><span class="sxs-lookup"><span data-stu-id="b963c-307">Fixed issue https://github.com/Azure/azure-powershell/issues/6814</span></span>
...
#### <a name="azurermtrafficmanager"></a><span data-ttu-id="b963c-323">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="b963c-323">AzureRM.TrafficManager</span></span>
...
#### <a name="azurermiothub"></a><span data-ttu-id="b963c-340">AzureRM.IotHub</span><span class="sxs-lookup"><span data-stu-id="b963c-340">AzureRM.IotHub</span></span>
...
#### <a name="azurermwebsites"></a><span data-ttu-id="b963c-358">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="b963c-358">AzureRM.Websites</span></span>
...
#### <a name="azurermapimanagement"></a><span data-ttu-id="b963c-373">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="b963c-373">AzureRM.ApiManagement</span></span>
...
#### <a name="azurermcognitiveservices"></a><span data-ttu-id="b963c-387">AzureRM.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="b963c-387">AzureRM.CognitiveServices</span></span>
...
#### <a name="azurermdatafactories"></a><span data-ttu-id="b963c-401">AzureRM.DataFactories</span><span class="sxs-lookup"><span data-stu-id="b963c-401">AzureRM.DataFactories</span></span>
...
#### <a name="azurermeventgrid"></a><span data-ttu-id="b963c-416">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="b963c-416">AzureRM.EventGrid</span></span>
...
#### <a name="azurermmachinelearningcompute"></a><span data-ttu-id="b963c-432">AzureRM.MachineLearningCompute</span><span class="sxs-lookup"><span data-stu-id="b963c-432">AzureRM.MachineLearningCompute</span></span>
...
#### <a name="azurermnotificationhubs"></a><span data-ttu-id="b963c-447">AzureRM.NotificationHubs</span><span class="sxs-lookup"><span data-stu-id="b963c-447">AzureRM.NotificationHubs</span></span>
...
#### <a name="azurermscheduler"></a><span data-ttu-id="b963c-484">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="b963c-484">AzureRM.Scheduler</span></span>
...
* <span data-ttu-id="b963c-493">Har uppdaterats till den senaste versionen av Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="b963c-493">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermstreamanalytics"></a><span data-ttu-id="b963c-494">AzureRM.StreamAnalytics</span><span class="sxs-lookup"><span data-stu-id="b963c-494">AzureRM.StreamAnalytics</span></span>
* <span data-ttu-id="b963c-495">Har uppdaterats till den senaste versionen av Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="b963c-495">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermtags"></a><span data-ttu-id="b963c-496">AzureRM.Tags</span><span class="sxs-lookup"><span data-stu-id="b963c-496">AzureRM.Tags</span></span>
* <span data-ttu-id="b963c-497">Har uppdaterats till den senaste versionen av Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="b963c-497">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="b963c-498">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="b963c-498">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="b963c-499">Har uppdaterats till den senaste versionen av Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="b963c-499">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermusageaggregates"></a><span data-ttu-id="b963c-500">AzureRM.UsageAggregates</span><span class="sxs-lookup"><span data-stu-id="b963c-500">AzureRM.UsageAggregates</span></span>
* <span data-ttu-id="b963c-501">Har uppdaterats till den senaste versionen av Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="b963c-501">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="b963c-502">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="b963c-502">AzureRM.Websites</span></span>
* <span data-ttu-id="b963c-503">Har uppdaterats till den senaste versionen av Azure ClientRuntime.</span><span class="sxs-lookup"><span data-stu-id="b963c-503">Updated to the latest version of the Azure ClientRuntime.</span></span>

## <a name="660---july-2018"></a><span data-ttu-id="b963c-504">6.6.0 – juli 2018</span><span class="sxs-lookup"><span data-stu-id="b963c-504">6.6.0 - July 2018</span></span>
#### <a name="general"></a><span data-ttu-id="b963c-505">Allmänt</span><span class="sxs-lookup"><span data-stu-id="b963c-505">General</span></span>
* <span data-ttu-id="b963c-506">Alla hjälpfiler har uppdaterats för att ta med fullständiga parametertyper och korrekta indata-/utdatatyper.</span><span class="sxs-lookup"><span data-stu-id="b963c-506">Updated all help files to include full parameter types and correct input/output types.</span></span>

#### <a name="azurermprofile"></a><span data-ttu-id="b963c-507">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="b963c-507">AzureRM.Profile</span></span>
* <span data-ttu-id="b963c-508">Common.Strategy-biblioteket har uppdaterats för att kunna verifiera att den aktuella konfigurationsfilen för en resurs är kompatibel med målresursen.</span><span class="sxs-lookup"><span data-stu-id="b963c-508">Updated Common.Strategy library to be able to validate that the current config for a resource is compatible with the target resource.</span></span>
* <span data-ttu-id="b963c-509">ps1xml-typer har lagts till i Common.Storage</span><span class="sxs-lookup"><span data-stu-id="b963c-509">Added ps1xml types to Common.Storage</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="b963c-510">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="b963c-510">Azure.Storage</span></span>
* <span data-ttu-id="b963c-511">Lade till stöd för hämtning av lagringskontext från DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="b963c-511">Added support for getting Storage Context from DefaultProfile</span></span>
* <span data-ttu-id="b963c-512">Lade till Ps1XmlAttribute till utdatatypegenskaper för cmdletar.</span><span class="sxs-lookup"><span data-stu-id="b963c-512">Added Ps1XmlAttribute to cmdlets output types properties.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="b963c-513">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="b963c-513">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="b963c-514">Åtgärdat problem https://github.com/Azure/azure-powershell/issues/6370</span><span class="sxs-lookup"><span data-stu-id="b963c-514">Fixed issue https://github.com/Azure/azure-powershell/issues/6370</span></span>
    - <span data-ttu-id="b963c-515">En bugg har åtgärdats i Automapper för att översätta PsApiManagementApi till ApiContract</span><span class="sxs-lookup"><span data-stu-id="b963c-515">Fixed bug in Automapper to translate PsApiManagementApi to ApiContract</span></span>
* <span data-ttu-id="b963c-516">Åtgärdat problem https://github.com/Azure/azure-powershell/issues/6515</span><span class="sxs-lookup"><span data-stu-id="b963c-516">Fixed issue https://github.com/Azure/azure-powershell/issues/6515</span></span>
    - <span data-ttu-id="b963c-517">En bugg har åtgärdats i File.Save för att inte överbelasta kodningstypen</span><span class="sxs-lookup"><span data-stu-id="b963c-517">Fixed bug in File.Save to not overload with Encoding Type</span></span>
* <span data-ttu-id="b963c-518">Åtgärdat problem https://github.com/Azure/azure-powershell/issues/6560</span><span class="sxs-lookup"><span data-stu-id="b963c-518">Fixed issue https://github.com/Azure/azure-powershell/issues/6560</span></span>
    - <span data-ttu-id="b963c-519">Har uppgraderats till Nuget-versionen 4.0.3 vilket åtgärdar mönsterundantaget på apiId</span><span class="sxs-lookup"><span data-stu-id="b963c-519">Upgraded to 4.0.3 Nuget version which fixes the pattern exception on apiId</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="b963c-520">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b963c-520">AzureRM.Compute</span></span>
* <span data-ttu-id="b963c-521">Åtgärda problem med fel vid skapandet av en virtuell dator med hjälp av DiskFileParameterSet i New-AzureRmVm på grund av namnbyte på PremiumLRS-lagringskontotypen.</span><span class="sxs-lookup"><span data-stu-id="b963c-521">Fix issue with creating a vm using DiskFileParameterSet in New-AzureRmVm failing because of PremiumLRS storage account type renaming.</span></span>
* <span data-ttu-id="b963c-522">Åtgärda cmdleten Invoke-AzureRmVMRunCommand</span><span class="sxs-lookup"><span data-stu-id="b963c-522">Fix Invoke-AzureRmVMRunCommand cmdlet</span></span>
* <span data-ttu-id="b963c-523">Uppdatera Get-AzureRmAvailabilitySet för att aktivera funktionen för att lista alla tillgänglighetsuppsättningar i en prenumeration.</span><span class="sxs-lookup"><span data-stu-id="b963c-523">Update Get-AzureRmAvailabilitySet to enable list all availability sets in a subscription.</span></span>  <span data-ttu-id="b963c-524">(Parametern ResouceGroupName är nu frivillig.)</span><span class="sxs-lookup"><span data-stu-id="b963c-524">(ResouceGroupName parameter is now optional.)</span></span>
* <span data-ttu-id="b963c-525">Uppdatera SimpleParameterSet för "New-AzureRmVm" för att aktivera accelererat nätverk på berättigade virtuella datorer.</span><span class="sxs-lookup"><span data-stu-id="b963c-525">Update SimpleParameterSet of 'New-AzureRmVm' to enable Accelerated Network on qualifying vms.</span></span>
* <span data-ttu-id="b963c-526">Uppdatera den enkla parameteruppsättningen för New-AzureRmVmss så att det inte går att skapa de virtuella datorerna när en användarangiven lastbalanserare redan finns.</span><span class="sxs-lookup"><span data-stu-id="b963c-526">Update New-AzureRmVmss simple parameter set to fail creating the vmss when a user specified LB already exists.</span></span>
* <span data-ttu-id="b963c-527">Uppdatera exempel för New-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="b963c-527">Update example for New-AzureRmDisk</span></span>
* <span data-ttu-id="b963c-528">Lägg till exempel för "New-AzureRmVM"</span><span class="sxs-lookup"><span data-stu-id="b963c-528">Add example for 'New-AzureRmVM'</span></span>
* <span data-ttu-id="b963c-529">Uppdatera beskrivning för Set-AzureRmVMOSDisk</span><span class="sxs-lookup"><span data-stu-id="b963c-529">Update description for Set-AzureRmVMOSDisk</span></span>
* <span data-ttu-id="b963c-530">Uppdatera Exempel 1 för Set-AzureRmVMBginfoExtension för stavningskontroll och prefix.</span><span class="sxs-lookup"><span data-stu-id="b963c-530">Update Example 1 for Set-AzureRmVMBginfoExtension to correct spelling and prefix.</span></span> 

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="b963c-531">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="b963c-531">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="b963c-532">ADF .Net SDK-versionen har uppdaterats till 1.1.0.</span><span class="sxs-lookup"><span data-stu-id="b963c-532">Updated the ADF .Net SDK version to 1.1.0.</span></span>
* <span data-ttu-id="b963c-533">Stöd för delning av Integration Runtime (lokal installation) mellan datafabriker.</span><span class="sxs-lookup"><span data-stu-id="b963c-533">Support self-hosted integration runtime sharing across data factories.</span></span>
     - <span data-ttu-id="b963c-534">Lägg till ny parameter – SharedIntegrationRuntimeResourceId i cmdleten Set-AzureRmDataFactoryV2IntegrationRuntime.</span><span class="sxs-lookup"><span data-stu-id="b963c-534">Add new parameter -SharedIntegrationRuntimeResourceId to Set-AzureRmDataFactoryV2IntegrationRuntime cmdlet.</span></span>
     - <span data-ttu-id="b963c-535">Lägg till ny valfri parameter – LinkedDataFactoryName i cmdleten Remove-AzureRmDataFactoryV2IntegrationRuntime.</span><span class="sxs-lookup"><span data-stu-id="b963c-535">Add new optional parameter -LinkedDataFactoryName to Remove-AzureRmDataFactoryV2IntegrationRuntime cmdlet.</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="b963c-536">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="b963c-536">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="b963c-537">DataPlane SDK-versionen (Microsoft.Azure.DataLake.Store) har uppdaterats till 1.1.9</span><span class="sxs-lookup"><span data-stu-id="b963c-537">Updated the DataPlane SDK (Microsoft.Azure.DataLake.Store) version to 1.1.9</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="b963c-538">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="b963c-538">AzureRM.EventHub</span></span>
* <span data-ttu-id="b963c-539">Piping för InputObject and ResourceId i borttagna cmdletar har uppdaterats</span><span class="sxs-lookup"><span data-stu-id="b963c-539">Updated piping for InputObject and ResourceId in remove cmdlets</span></span>

#### <a name="azurerminsights"></a><span data-ttu-id="b963c-540">AzureRM.Insights</span><span class="sxs-lookup"><span data-stu-id="b963c-540">AzureRM.Insights</span></span>
* <span data-ttu-id="b963c-541">Formatering har åtgärdats för OutputType i hjälpfiler</span><span class="sxs-lookup"><span data-stu-id="b963c-541">Fixed formatting of OutputType in help files</span></span>
* <span data-ttu-id="b963c-542">Använda Microsoft.Azure.Management.Monitor SDK 0.19.1-preview</span><span class="sxs-lookup"><span data-stu-id="b963c-542">Using Microsoft.Azure.Management.Monitor SDK 0.19.1-preview</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="b963c-543">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b963c-543">AzureRM.KeyVault</span></span>
* <span data-ttu-id="b963c-544">Åtgärda problem med piping i Set-AzureRmKeyVaultAccessPolicy</span><span class="sxs-lookup"><span data-stu-id="b963c-544">Fix piping issue in Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="b963c-545">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="b963c-545">AzureRM.Network</span></span>
* <span data-ttu-id="b963c-546">Exempel har lagts till för LoadBalancerInboundNatPoolConfig-cmdletar.</span><span class="sxs-lookup"><span data-stu-id="b963c-546">Added examples for LoadBalancerInboundNatPoolConfig cmdlets.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="b963c-547">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="b963c-547">AzureRM.Resources</span></span>
* <span data-ttu-id="b963c-548">Åtgärda problem när både taggnamn och värde anges för "Get-AzureRmResource"</span><span class="sxs-lookup"><span data-stu-id="b963c-548">Fix issue when providing both tag name and value for 'Get-AzureRmResource'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6765
* <span data-ttu-id="b963c-549">Åtgärda pipingscenario med "Set-AzureRmResource"</span><span class="sxs-lookup"><span data-stu-id="b963c-549">Fix piping scenario with 'Set-AzureRmResource'</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="b963c-550">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="b963c-550">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="b963c-551">Piping för InputObject and ResourceId i borttagna cmdletar har uppdaterats</span><span class="sxs-lookup"><span data-stu-id="b963c-551">Updated piping for InputObject and ResourceId in remove cmdlets</span></span>
* <span data-ttu-id="b963c-552">några problem har åtgärdats</span><span class="sxs-lookup"><span data-stu-id="b963c-552">fixed few issues</span></span>
    - https://github.com/Azure/azure-powershell/issues/3780
    - https://github.com/Azure/azure-powershell/issues/4340

#### <a name="azurermsql"></a><span data-ttu-id="b963c-553">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b963c-553">AzureRM.Sql</span></span>
* <span data-ttu-id="b963c-554">Lägg till stöd för Server Advanced Threat Protection med följande cmdletar:</span><span class="sxs-lookup"><span data-stu-id="b963c-554">Adding Server Advanced Threat Protection support with the following cmdlets:</span></span>
    - <span data-ttu-id="b963c-555">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span><span class="sxs-lookup"><span data-stu-id="b963c-555">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span></span>
* <span data-ttu-id="b963c-556">Lägg till stöd för Sårbarhetsbedömning med följande cmdletar:</span><span class="sxs-lookup"><span data-stu-id="b963c-556">Adding Vulnerability Assessment support with the following cmdlets:</span></span>
    - <span data-ttu-id="b963c-557">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span><span class="sxs-lookup"><span data-stu-id="b963c-557">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span></span>
    - <span data-ttu-id="b963c-558">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="b963c-558">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>
    - <span data-ttu-id="b963c-559">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="b963c-559">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span></span>
* <span data-ttu-id="b963c-560">Exempel i Remove-AzureRmSqlServerFirewallRule har åtgärdats</span><span class="sxs-lookup"><span data-stu-id="b963c-560">Fixed example in Remove-AzureRmSqlServerFirewallRule</span></span>
* <span data-ttu-id="b963c-561">Åtgärda felaktig hantering av datum och tid för andra kulturer än usa-baserade kulturer i Get-AzureSqlSyncGroupLog</span><span class="sxs-lookup"><span data-stu-id="b963c-561">Fix datetime handling incorrectly for non-us base culture in Get-AzureSqlSyncGroupLog</span></span>

#### <a name="azurermstorage"></a><span data-ttu-id="b963c-562">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="b963c-562">AzureRM.Storage</span></span>
* <span data-ttu-id="b963c-563">Lägg till Ps1XmlAttribute i utdatatypegenskaper för cmdletar</span><span class="sxs-lookup"><span data-stu-id="b963c-563">Add Ps1XmlAttribute to cmdlets output types properties</span></span>
* <span data-ttu-id="b963c-564">Visa utdata för cmdleten StorageAccount i tabellvyn</span><span class="sxs-lookup"><span data-stu-id="b963c-564">Show StorageAccount cmdlet output in table view</span></span>
    - <span data-ttu-id="b963c-565">Get-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="b963c-565">Get-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="b963c-566">New-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="b963c-566">New-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="b963c-567">Set-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="b963c-567">Set-AzureRmStorageAccount</span></span>

#### <a name="azurermtags"></a><span data-ttu-id="b963c-568">AzureRM.Tags</span><span class="sxs-lookup"><span data-stu-id="b963c-568">AzureRM.Tags</span></span>
* <span data-ttu-id="b963c-569">Ta bort felaktig instruktion från hjälpen för cmdleten Tag</span><span class="sxs-lookup"><span data-stu-id="b963c-569">Remove incorrect statement from Tag cmdlet help</span></span>
    - https://github.com/Azure/azure-powershell/issues/3878

## <a name="650---july-2018"></a><span data-ttu-id="b963c-570">6.5.0 – juli 2018</span><span class="sxs-lookup"><span data-stu-id="b963c-570">6.5.0 - July 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="b963c-571">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="b963c-571">AzureRM.Profile</span></span>
* <span data-ttu-id="b963c-572">Hjälp för ”Get-AzureRmContextAutosaveSetting” har uppdaterats</span><span class="sxs-lookup"><span data-stu-id="b963c-572">Updated help for 'Get-AzureRmContextAutosaveSetting'</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="b963c-573">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="b963c-573">Azure.Storage</span></span>
* <span data-ttu-id="b963c-574">Stöd för uppladdning av blob eller fil med lässkyddad SAS-token</span><span class="sxs-lookup"><span data-stu-id="b963c-574">Support Upload Blob or File with write only Sas token</span></span>
- <span data-ttu-id="b963c-575">Set-AzureStorageBlobContent</span><span class="sxs-lookup"><span data-stu-id="b963c-575">Set-AzureStorageBlobContent</span></span>
- <span data-ttu-id="b963c-576">Set-AzureStorageFileContent</span><span class="sxs-lookup"><span data-stu-id="b963c-576">Set-AzureStorageFileContent</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="b963c-577">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="b963c-577">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="b963c-578">Lägg till den nödvändiga egenskapen ResourceGroupName i AS.</span><span class="sxs-lookup"><span data-stu-id="b963c-578">Add required property ResourceGroupName to AS.</span></span>

#### <a name="azurermautomation"></a><span data-ttu-id="b963c-579">AzureRM.Automation</span><span class="sxs-lookup"><span data-stu-id="b963c-579">AzureRM.Automation</span></span>
* <span data-ttu-id="b963c-580">Uppdatera hjälp och lägg till exempel för ”New-AzureRMAutomationSchedule”</span><span class="sxs-lookup"><span data-stu-id="b963c-580">Update help and add example for 'New-AzureRMAutomationSchedule'</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="b963c-581">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b963c-581">AzureRM.Compute</span></span>
* <span data-ttu-id="b963c-582">Lägg till parametern -Tag förUpdate/New-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="b963c-582">Add -Tag parameter to Update/New-AzureRmAvailabilitySet</span></span>
* <span data-ttu-id="b963c-583">Lägg till exempel för ”Add-AzureRmVmssExtension”</span><span class="sxs-lookup"><span data-stu-id="b963c-583">Add example for 'Add-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="b963c-584">Lägg till exempel för ”Remove-AzureRmVmssExtension”</span><span class="sxs-lookup"><span data-stu-id="b963c-584">Add examples for 'Remove-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="b963c-585">Uppdatera hjälp för ”Set-AzureRmVMAccessExtension”</span><span class="sxs-lookup"><span data-stu-id="b963c-585">Update help for 'Set-AzureRmVMAccessExtension'</span></span>
* <span data-ttu-id="b963c-586">Uppdatera SimpleParameterSet för New-AzureRmVmss för att ställa in SinglePlacementGroup på falskt som standard och lägg till växlingsparametern ”SinglePlacementGroup” som gör att användare kan skapa VMSS i en enda placeringsgrupp.</span><span class="sxs-lookup"><span data-stu-id="b963c-586">Update SimpleParameterSet for New-AzureRmVmss to set SinglePlacementGroup to false by default and add switch parameter 'SinglePlacementGroup' that enables the user to create the VMSS in a single placement group.</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="b963c-587">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="b963c-587">AzureRM.EventHub</span></span>
* <span data-ttu-id="b963c-588">En skrivskyddad egenskap, ”PendingReplicationOperationsCount”, har lagts till för klassen PSEventHubDRConfigurationAttributes som anger antalet väntande replikeringsåtgärder medan replikeringen pågår</span><span class="sxs-lookup"><span data-stu-id="b963c-588">Added a readonly property 'PendingReplicationOperationsCount' to PSEventHubDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="b963c-589">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b963c-589">AzureRM.KeyVault</span></span>
* <span data-ttu-id="b963c-590">Uppdatera felmeddelande för Set-AzureRmKeyVaultAccessPolicy</span><span class="sxs-lookup"><span data-stu-id="b963c-590">Update error message for Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermlogicapp"></a><span data-ttu-id="b963c-591">AzureRM.LogicApp</span><span class="sxs-lookup"><span data-stu-id="b963c-591">AzureRM.LogicApp</span></span>
* <span data-ttu-id="b963c-592">Felet ”parameteruppsättningen gick inte att matcha” har korrigerats i New-AzureRmLogicApp</span><span class="sxs-lookup"><span data-stu-id="b963c-592">Fixed "parameter set could not be resolved" error in New-AzureRmLogicApp</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="b963c-593">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="b963c-593">AzureRM.Network</span></span>
* <span data-ttu-id="b963c-594">Aktivera peering mellan virtuella nätverk i flera klienter för Set/Add-AzureRmVirtualNetworkPeering</span><span class="sxs-lookup"><span data-stu-id="b963c-594">Enable peering across Virtual Networks in multiple Tenants for Set/Add-AzureRmVirtualNetworkPeering</span></span>
* <span data-ttu-id="b963c-595">Nedanstående cmdletar för Application Gateway har uppdaterats</span><span class="sxs-lookup"><span data-stu-id="b963c-595">Updated below cmdlets for Application Gateway</span></span>
    - <span data-ttu-id="b963c-596">New-AzureRmApplicationGateway: EnableFIPS-flagga har lagts till för stöd för zoner</span><span class="sxs-lookup"><span data-stu-id="b963c-596">New-AzureRmApplicationGateway : Added EnableFIPS flag and Zones support</span></span>
    - <span data-ttu-id="b963c-597">New-AzureRmApplicationGatewaySku: nya SKU:er, Standard_v2 och WAF_v2, har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-597">New-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
    - <span data-ttu-id="b963c-598">Set-AzureRmApplicationGatewaySku: nya SKU:er, Standard_v2 och WAF_v2, har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-598">Set-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
* <span data-ttu-id="b963c-599">RouteTable-cmdletar har återskapats med den senaste versionen av generatorn</span><span class="sxs-lookup"><span data-stu-id="b963c-599">Regenerated RouteTable cmdlets with the latest generator version</span></span>

#### <a name="azurermrelay"></a><span data-ttu-id="b963c-600">AzureRM.Relay</span><span class="sxs-lookup"><span data-stu-id="b963c-600">AzureRM.Relay</span></span>
* <span data-ttu-id="b963c-601">Markdown-filer har uppdaterats och korrigerar problem med parameternamn i exemplet</span><span class="sxs-lookup"><span data-stu-id="b963c-601">Updated markdown files, fix for the parameter name issue in example</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="b963c-602">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="b963c-602">AzureRM.Resources</span></span>
* <span data-ttu-id="b963c-603">Uppdatera cmdletar för rolltilldelning och rolldefinition:</span><span class="sxs-lookup"><span data-stu-id="b963c-603">Update Roleassignment and roledefinition cmdlets:</span></span>
    - <span data-ttu-id="b963c-604">Ta bort extra anrop för rolldefinitioner som görs som en del av sidindelning.</span><span class="sxs-lookup"><span data-stu-id="b963c-604">Remove extra roledefinition calls done as part of paging.</span></span>
* <span data-ttu-id="b963c-605">Åtgärda Get-AzureRMRoleAssignment-cmdlet</span><span class="sxs-lookup"><span data-stu-id="b963c-605">Fix Get-AzureRmRoleAssignment cmdlet</span></span>
    - <span data-ttu-id="b963c-606">Åtgärda parameterfunktioner för kommandot -ExpandPrincipalGroups</span><span class="sxs-lookup"><span data-stu-id="b963c-606">Fix -ExpandPrincipalGroups command parameter functionality</span></span>
* <span data-ttu-id="b963c-607">Åtgärda problem med ”Get-AzureRmResource” där ”-ResourceType”-parametern var skiftlägeskänsligt</span><span class="sxs-lookup"><span data-stu-id="b963c-607">Fix issue with 'Get-AzureRmResource' where '-ResourceType' parameter was case sensitive</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="b963c-608">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="b963c-608">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="b963c-609">Parametrar för att stoppa och hoppa över har lagts till i listan över cmdletar</span><span class="sxs-lookup"><span data-stu-id="b963c-609">Added top and skip parameter to list cmdlets</span></span>
* <span data-ttu-id="b963c-610">Cmdletar för migrering från Standard- till Premium-namnområden har lagts till:</span><span class="sxs-lookup"><span data-stu-id="b963c-610">Added Standard to Premium NameSpace migration cmdlets :</span></span>
    - <span data-ttu-id="b963c-611">Start-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="b963c-611">Start-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="b963c-612">Get-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="b963c-612">Get-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="b963c-613">Complete-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="b963c-613">Complete-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="b963c-614">Stop-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="b963c-614">Stop-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="b963c-615">Remove-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="b963c-615">Remove-AzureRmServiceBusMigration</span></span>
* <span data-ttu-id="b963c-616">En skrivskyddad egenskap, ”PendingReplicationOperationsCount” har lagts till för klassen PSServiceBusDRConfigurationAttributes som anger antalet väntande replikeringsåtgärder medan replikeringen pågår</span><span class="sxs-lookup"><span data-stu-id="b963c-616">Added a readonly property 'PendingReplicationOperationsCount' to PSServiceBusDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="b963c-617">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="b963c-617">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="b963c-618">Uppdatera exempel för ”New-AzureRmServiceFabricCluster”</span><span class="sxs-lookup"><span data-stu-id="b963c-618">Update example for 'New-AzureRmServiceFabricCluster'</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="b963c-619">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b963c-619">AzureRM.Sql</span></span>
* <span data-ttu-id="b963c-620">Nya cmdletar för Management.Sql som gör att kunderna kan lägga till certifikat för transparent datakryptering till SQL Server-instans eller en hanterad instans har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-620">Adding new Cmdlets for Management.Sql to allow customers to add TDE Certificate to Sql Server instance or a Managed Instance</span></span>
    - <span data-ttu-id="b963c-621">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="b963c-621">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span></span>
    - <span data-ttu-id="b963c-622">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="b963c-622">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="b963c-623">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="b963c-623">AzureRM.Websites</span></span>
* <span data-ttu-id="b963c-624">När `Set-AzureRmWebApp -AssignIdentity` och `Set-AzureRmWebAppSlot -AssignIdentity` är inställda på falskt tar de nu bort identitetsegenskapen från platsobjektet. Även förhandsgranskningstaggen tas bort.</span><span class="sxs-lookup"><span data-stu-id="b963c-624">`Set-AzureRmWebApp -AssignIdentity` and  `Set-AzureRmWebAppSlot -AssignIdentity` when set to false will now remove the Identity property from the site object.Removing preview tag as well.</span></span>
* <span data-ttu-id="b963c-625">`Get-AzureRmWebAppMetrics`, `Get-AzureRmAppServicePlanMetrics`-exempel har uppdaterats</span><span class="sxs-lookup"><span data-stu-id="b963c-625">`Get-AzureRmWebAppMetrics`,`Get-AzureRmAppServicePlanMetrics` example updated</span></span>
* <span data-ttu-id="b963c-626">`Set-AzureRmWebApp -PhpVersion` har stöd för ”av” som en giltig php-version</span><span class="sxs-lookup"><span data-stu-id="b963c-626">`Set-AzureRmWebApp -PhpVersion` supports off as a valid php version</span></span>

## <a name="640---july-2018"></a><span data-ttu-id="b963c-627">6.4.0 – juli 2018</span><span class="sxs-lookup"><span data-stu-id="b963c-627">6.4.0 - July 2018</span></span>
#### <a name="general"></a><span data-ttu-id="b963c-628">Allmänt</span><span class="sxs-lookup"><span data-stu-id="b963c-628">General</span></span>
* <span data-ttu-id="b963c-629">Formatering av OutputType i hjälpfiler har korrigerats för de flesta moduler</span><span class="sxs-lookup"><span data-stu-id="b963c-629">Fixed formatting of OutputType in help files for most modules</span></span>

#### <a name="azurermprofile"></a><span data-ttu-id="b963c-630">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="b963c-630">AzureRM.Profile</span></span>
* <span data-ttu-id="b963c-631">Ps1Xml-attribut har lagts till för grundläggande utdatatyper</span><span class="sxs-lookup"><span data-stu-id="b963c-631">Ps1Xml attribute added to the basic output types</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="b963c-632">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b963c-632">AzureRM.Compute</span></span>
* <span data-ttu-id="b963c-633">IP-tagg-funktioner för VMSS</span><span class="sxs-lookup"><span data-stu-id="b963c-633">IP Tag feature for VMSS</span></span>
    - <span data-ttu-id="b963c-634">"New-AzureRmVmssIpTagConfig"-cmdlet har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-634">'New-AzureRmVmssIpTagConfig' cmdlet is added</span></span>
    - <span data-ttu-id="b963c-635">IpTag-parameter har lagts till för New-AzureRmVmssIpConfig</span><span class="sxs-lookup"><span data-stu-id="b963c-635">IpTag parameter is added to New-AzureRmVmssIpConfig</span></span>
* <span data-ttu-id="b963c-636">Automatisk återställningsfunktion för operativsystem för VMSS</span><span class="sxs-lookup"><span data-stu-id="b963c-636">Auto OS Rollback feature for VMSS</span></span>
    - <span data-ttu-id="b963c-637">DisableAutoRollback-parametrar har lagts till för New-AzureRmVmssConfig och Update-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b963c-637">DisableAutoRollback parameters are added to New-AzureRmVmssConfig and Update-AzureRmVmss</span></span>
* <span data-ttu-id="b963c-638">Funktion för uppgraderingshistorik för operativsystem för Vmss</span><span class="sxs-lookup"><span data-stu-id="b963c-638">OS Upgrade History feature for Vmss</span></span>
    - <span data-ttu-id="b963c-639">OSUpgradeHistory-växlingsparametern har lagts till för Get-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b963c-639">OSUpgradeHistory switch parameter is added to Get-AzureRmVmss</span></span>

#### <a name="azurermdatalakeanalytics"></a><span data-ttu-id="b963c-640">AzureRM.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="b963c-640">AzureRM.DataLakeAnalytics</span></span>
* <span data-ttu-id="b963c-641">Lägg till stöd för katalog-ACL:er med hjälp av följande kommandon:</span><span class="sxs-lookup"><span data-stu-id="b963c-641">Add support for Catalog ACLs through the following commands:</span></span>
    - <span data-ttu-id="b963c-642">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="b963c-642">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="b963c-643">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="b963c-643">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="b963c-644">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="b963c-644">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="b963c-645">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="b963c-645">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="b963c-646">Lägg till stöd för annullering och förloppsspårning för Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl</span><span class="sxs-lookup"><span data-stu-id="b963c-646">Add cancellation support and progress tracking for Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl</span></span>
* <span data-ttu-id="b963c-647">Lägg till stöd för annullering för Export-AzureRmDataLakeStoreChildItemProperties</span><span class="sxs-lookup"><span data-stu-id="b963c-647">Add cancellation support for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="b963c-648">Åtgärda tömning av felsökningsmeddelanden för cmdletar som gör rekursiva åtgärder</span><span class="sxs-lookup"><span data-stu-id="b963c-648">Fix flushing of debug messages for cmdlets that does recursive operations</span></span>
* <span data-ttu-id="b963c-649">Åtgärda platsen för testning av DataLake-cmdletar</span><span class="sxs-lookup"><span data-stu-id="b963c-649">Fix location of test of DataLake cmdlets</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="b963c-650">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="b963c-650">AzureRM.EventHub</span></span>
* <span data-ttu-id="b963c-651">Parametrar för optimalt maxantal har lagts till i liståtgärds-cmdletarna Get-AzureRmEventHub och Get-AzureRmEventHubConsumerGroup</span><span class="sxs-lookup"><span data-stu-id="b963c-651">Added Optional MaxCount parameter to List Operations cmdlet Get-AzureRmEventHub and Get-AzureRmEventHubConsumerGroup</span></span>
* <span data-ttu-id="b963c-652">Ett problem i New-AzureRmEventHub-cmdleten har åtgärdats där minst en parameter behövdes när du skapade en ny EventHub.</span><span class="sxs-lookup"><span data-stu-id="b963c-652">Fixed issue in New-AzureRmEventHub cmdlet where at least one parameter needed while creating New EventHub.</span></span> <span data-ttu-id="b963c-653">Angiven standardparameter har ställts in.</span><span class="sxs-lookup"><span data-stu-id="b963c-653">Provided Default Parameter set.</span></span>
* <span data-ttu-id="b963c-654">Valfri parameter för KeyValue har lagts till för New-AzureRmEventHubKey-cmdleten, vilket gör det möjligt att ange KeyValue.</span><span class="sxs-lookup"><span data-stu-id="b963c-654">Added optional Parameter -KeyValue to New-AzureRmEventHubKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="b963c-655">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b963c-655">AzureRM.KeyVault</span></span>
* <span data-ttu-id="b963c-656">Åtgärda problem där alla resurser returnerades av Get-AzureRmKeyVault-taggen</span><span class="sxs-lookup"><span data-stu-id="b963c-656">Fix issue where all resources were being returned by Get-AzureRmKeyVault -Tag</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="b963c-657">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="b963c-657">AzureRM.Network</span></span>
* <span data-ttu-id="b963c-658">Gör nya SKU:er tillgängliga för zonredundanta VirtualNetworkGateways</span><span class="sxs-lookup"><span data-stu-id="b963c-658">Expose new Skus for Zone-Redundant VirtualNetworkGateways</span></span>
* <span data-ttu-id="b963c-659">Nya kommandon har lagts till för funktionen: ExpressRoute Partner APIs via ARM</span><span class="sxs-lookup"><span data-stu-id="b963c-659">Added new commands for feature: ExpressRoute Partner APIs via ARM</span></span>
    - <span data-ttu-id="b963c-660">Get-AzureRmExpressRouteCrossConnection har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-660">Added Get-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="b963c-661">Set-AzureRmExpressRouteCrossConnection har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-661">Added Set-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="b963c-662">Add-AzureRmExpressRouteCrossConnectionPeering har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-662">Added Add-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="b963c-663">Get-AzureRmExpressRouteCrossConnectionPeering har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-663">Added Get-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="b963c-664">Remove-AzureRmExpressRouteCrossConnectionPeering har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-664">Added Remove-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="b963c-665">Get-AzureRMExpressRouteCrossConnectionArpTable har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-665">Added Get-AzureRMExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="b963c-666">Get-AzureRMExpressRouteCrossConnectionRouteTable har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-666">Added Get-AzureRMExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="b963c-667">Get-AzureRMExpressRouteCrossConnectionRouteTableSummary har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-667">Added Get-AzureRMExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="b963c-668">AzureRM.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="b963c-668">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="b963c-669">Get-AzureRmRecoveryServicesBackupStatus-cmdlet har lagts till.</span><span class="sxs-lookup"><span data-stu-id="b963c-669">Added Get-AzureRmRecoveryServicesBackupStatus cmdlet.</span></span> <span data-ttu-id="b963c-670">Denna cmdlet tar ett ID för virtuell dator och kontrollerar om den virtuella datorn skyddas av ett valv i prenumerationen.</span><span class="sxs-lookup"><span data-stu-id="b963c-670">This cmdlet takes a VM ID and checks if the VM is protected by some vault in the subscription.</span></span> <span data-ttu-id="b963c-671">Om ett sådant valv finns returnerar cmdleten valvinformationen.</span><span class="sxs-lookup"><span data-stu-id="b963c-671">If there exists such a vault, the cmdlet outputs the vault details.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="b963c-672">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="b963c-672">AzureRM.Resources</span></span>
* <span data-ttu-id="b963c-673">Uppdatera Get-AzureRmPolicyAssignment-cmdletar:</span><span class="sxs-lookup"><span data-stu-id="b963c-673">Update Get-AzureRmPolicyAssignment cmdlets:</span></span>
    - <span data-ttu-id="b963c-674">Lägg till stöd för att lista -Scope-värden på hanteringsgruppsnivå</span><span class="sxs-lookup"><span data-stu-id="b963c-674">Add support for listing -Scope values at management group level</span></span>
    - <span data-ttu-id="b963c-675">Lägg till stöd för hämtning av enskilda tilldelningar med -Scope-värden på hanteringsgruppsnivå.</span><span class="sxs-lookup"><span data-stu-id="b963c-675">Add support for retrieving individual assignments with -Scope values at management group level</span></span>
    - <span data-ttu-id="b963c-676">Lägg till växlar för -Effective och -All till kontrollparametrar</span><span class="sxs-lookup"><span data-stu-id="b963c-676">Add -Effective and -All switches to control  parameter</span></span>
* <span data-ttu-id="b963c-677">Uppdatera Get/New/Remove/Set-AzureRmPolicyDefinition-cmdletar</span><span class="sxs-lookup"><span data-stu-id="b963c-677">Update Get/New/Remove/Set-AzureRmPolicyDefinition cmdlets</span></span>
    - <span data-ttu-id="b963c-678">Lägg till parameter för -ManagementGroupName om du vill tillämpa åtgärder för en viss hanteringsgrupp</span><span class="sxs-lookup"><span data-stu-id="b963c-678">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="b963c-679">Lägg till parameter för -SubscriptionId om du vill tillämpa åtgärder för en viss prenumeration</span><span class="sxs-lookup"><span data-stu-id="b963c-679">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="b963c-680">Uppdatera Get/New/Remove/Set-AzureRmPolicySetDefinition-cmdletar</span><span class="sxs-lookup"><span data-stu-id="b963c-680">Update Get/New/Remove/Set-AzureRmPolicySetDefinition cmdlets</span></span>
    - <span data-ttu-id="b963c-681">Lägg till parameter för -ManagementGroupName om du vill tillämpa åtgärder för en viss hanteringsgrupp</span><span class="sxs-lookup"><span data-stu-id="b963c-681">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="b963c-682">Lägg till parameter för -SubscriptionId om du vill tillämpa åtgärder för en viss prenumeration</span><span class="sxs-lookup"><span data-stu-id="b963c-682">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="b963c-683">Lägg till stöd för hemliga KeyVault-referenser i parametrar när du använder "TemplateParameterObject" i "New-AzureRmResourceGroupDeployment"</span><span class="sxs-lookup"><span data-stu-id="b963c-683">Add KeyVault secret reference support in parameters when using 'TemplateParameterObject' in 'New-AzureRmResourceGroupDeployment'</span></span>
* <span data-ttu-id="b963c-684">Åtgärda problem med att "-EndDate"-parametern ignorerades på grund av "New-AzureRmADAppCredential"</span><span class="sxs-lookup"><span data-stu-id="b963c-684">Fix issue where '-EndDate' parameter was ignored for 'New-AzureRmADAppCredential'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6505
* <span data-ttu-id="b963c-685">Åtgärda problem med att felaktig URL användes i "New-AzureRmADAppCredential" vid begäran</span><span class="sxs-lookup"><span data-stu-id="b963c-685">Fix issue where 'Add-AzureRmADGroupMember' used incorrect URL to make request</span></span>
    - https://github.com/Azure/azure-powershell/issues/6485

#### <a name="azurermservicebus"></a><span data-ttu-id="b963c-686">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="b963c-686">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="b963c-687">Valfri parameter för -KeyValue har lagts till för New-AzureRmServiceBusKey-cmdleten, vilket gör det möjligt att ange KeyValue.</span><span class="sxs-lookup"><span data-stu-id="b963c-687">Added optional Parameter -KeyValue to New-AzureRmServiceBusKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="b963c-688">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b963c-688">AzureRM.Sql</span></span>
* <span data-ttu-id="b963c-689">Användardefinierade återställningspunkter har klargjorts för SQLDW i New-AzureRmSqlDatabaseRestorePoint-hjälpen</span><span class="sxs-lookup"><span data-stu-id="b963c-689">Clarified User-Defined Restore Points for SQLDW in New-AzureRmSqlDatabaseRestorePoint help</span></span>
* <span data-ttu-id="b963c-690">Dokumentationen om parametern -ComputeGeneration har uppdaterats i fler cmdletar</span><span class="sxs-lookup"><span data-stu-id="b963c-690">Updated documentation of -ComputeGeneration parameter in several cmdlets</span></span>

## <a name="630---june-2018"></a><span data-ttu-id="b963c-691">6.3.0 – juni 2018</span><span class="sxs-lookup"><span data-stu-id="b963c-691">6.3.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="b963c-692">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="b963c-692">AzureRM.Profile</span></span>
* <span data-ttu-id="b963c-693">Uppdaterade felmeddelanden för Enable-AzureRmContextAutoSave</span><span class="sxs-lookup"><span data-stu-id="b963c-693">Updated error messages for Enable-AzureRmContextAutoSave</span></span>
* <span data-ttu-id="b963c-694">Skapa en kontext för varje prenumeration när du kör ”Connect-AzureRmAccount” utan tidigare kontext</span><span class="sxs-lookup"><span data-stu-id="b963c-694">Create a context for each subscription when running 'Connect-AzureRmAccount' with no previous context</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="b963c-695">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="b963c-695">Azure.Storage</span></span>
* <span data-ttu-id="b963c-696">Ytterligare information om parametern -Permissions har lagts till i hjälpfilerna.</span><span class="sxs-lookup"><span data-stu-id="b963c-696">Added additional information about -Permissions parameter in help files.</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="b963c-697">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b963c-697">AzureRM.Compute</span></span>
* <span data-ttu-id="b963c-698">”Get-AzureRmVmDiskEncryptionStatus” korrigerar ett problem för virtuella datorer utan datadiskar</span><span class="sxs-lookup"><span data-stu-id="b963c-698">'Get-AzureRmVmDiskEncryptionStatus' fixes an issue observed for VMs with no data disks</span></span> 
* <span data-ttu-id="b963c-699">Uppdatera version av klientbibliotek för Compute för att korrigera följande cmdletar</span><span class="sxs-lookup"><span data-stu-id="b963c-699">Update Compute client library version to fix following cmdlets</span></span>
    - <span data-ttu-id="b963c-700">Grant-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="b963c-700">Grant-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="b963c-701">Grant-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="b963c-701">Grant-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="b963c-702">Save-AzureRmVMImage</span><span class="sxs-lookup"><span data-stu-id="b963c-702">Save-AzureRmVMImage</span></span>
* <span data-ttu-id="b963c-703">Följande cmdletar har åtgärdats för att visa ”Åtgärds-ID” och ”Åtgärdsstatus” på ett korrekt sätt:</span><span class="sxs-lookup"><span data-stu-id="b963c-703">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    - <span data-ttu-id="b963c-704">Start-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="b963c-704">Start-AzureRmVM</span></span>
    - <span data-ttu-id="b963c-705">Stop-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="b963c-705">Stop-AzureRmVM</span></span>
    - <span data-ttu-id="b963c-706">Restart-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="b963c-706">Restart-AzureRmVM</span></span>
    - <span data-ttu-id="b963c-707">Set-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="b963c-707">Set-AzureRmVM</span></span>
    - <span data-ttu-id="b963c-708">Remove-AzuerRmVM</span><span class="sxs-lookup"><span data-stu-id="b963c-708">Remove-AzuerRmVM</span></span>
    - <span data-ttu-id="b963c-709">Set-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b963c-709">Set-AzureRmVmss</span></span>
    - <span data-ttu-id="b963c-710">Start-AzureRmVmssRollingOSUpgrade</span><span class="sxs-lookup"><span data-stu-id="b963c-710">Start-AzureRmVmssRollingOSUpgrade</span></span>
    - <span data-ttu-id="b963c-711">Stop-AzureRmVmssRollingUpgrade</span><span class="sxs-lookup"><span data-stu-id="b963c-711">Stop-AzureRmVmssRollingUpgrade</span></span>
    - <span data-ttu-id="b963c-712">Start-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b963c-712">Start-AzureRmVmss</span></span>
    - <span data-ttu-id="b963c-713">Restart-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b963c-713">Restart-AzureRmVmss</span></span>
    - <span data-ttu-id="b963c-714">Stop-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b963c-714">Stop-AzureRmVmss</span></span>
    - <span data-ttu-id="b963c-715">Remove-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="b963c-715">Remove-AzureRmVmss</span></span>
    - <span data-ttu-id="b963c-716">ConvertTo-AzureRmVMManagedDisk</span><span class="sxs-lookup"><span data-stu-id="b963c-716">ConvertTo-AzureRmVMManagedDisk</span></span>
    - <span data-ttu-id="b963c-717">Revoke-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="b963c-717">Revoke-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="b963c-718">Remove-AzureRmSnapshot</span><span class="sxs-lookup"><span data-stu-id="b963c-718">Remove-AzureRmSnapshot</span></span>
    - <span data-ttu-id="b963c-719">Revoke-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="b963c-719">Revoke-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="b963c-720">Remove-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="b963c-720">Remove-AzureRmDisk</span></span>
    - <span data-ttu-id="b963c-721">Remove-AzureRmContainerService</span><span class="sxs-lookup"><span data-stu-id="b963c-721">Remove-AzureRmContainerService</span></span>
    - <span data-ttu-id="b963c-722">Remove-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="b963c-722">Remove-AzureRmAvailabilitySet</span></span>

#### <a name="azurermeventgrid"></a><span data-ttu-id="b963c-723">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="b963c-723">AzureRM.EventGrid</span></span>
* <span data-ttu-id="b963c-724">Ta bort verifieringsvillkoren ValidateNotNullOrEmpty för SubjectBeginsWith/SubjectEndsWith i cmdleten Update-AzureRmEventGridSubscription för att ändra de här parametrarna till en tom sträng om det behövs.</span><span class="sxs-lookup"><span data-stu-id="b963c-724">Remove ValidateNotNullOrEmpty validation conditions for SubjectBeginsWith/SubjectEndsWith in Update-AzureRmEventGridSubscription cmdlet to allow changing these parameters to empty string if needed.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="b963c-725">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b963c-725">AzureRM.KeyVault</span></span>
* <span data-ttu-id="b963c-726">Åtgärda problem där inga taggar returneras när Get-AzureRmKeyVault -Tag körs</span><span class="sxs-lookup"><span data-stu-id="b963c-726">Fix issue where no Tags are being returned when Get-AzureRmKeyVault -Tag is run</span></span>

#### <a name="azurermpolicyinsights"></a><span data-ttu-id="b963c-727">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="b963c-727">AzureRM.PolicyInsights</span></span>
* <span data-ttu-id="b963c-728">Offentlig lansering av cmdletar för Policy Insights</span><span class="sxs-lookup"><span data-stu-id="b963c-728">Public release of Policy Insights cmdlets</span></span>
    - <span data-ttu-id="b963c-729">Använd API-version 2018-04-04</span><span class="sxs-lookup"><span data-stu-id="b963c-729">Use API version 2018-04-04</span></span>
    - <span data-ttu-id="b963c-730">Lägg till PolicyDefinitionReferenceId i resultaten för Get-AzureRmPolicyStateSummary</span><span class="sxs-lookup"><span data-stu-id="b963c-730">Add PolicyDefinitionReferenceId to the results of Get-AzureRmPolicyStateSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="b963c-731">AzureRM.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="b963c-731">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="b963c-732">Parametern -Vault har lagts till i cmdletarna för RecoveryServices.Backup.</span><span class="sxs-lookup"><span data-stu-id="b963c-732">Added -Vault parameter to RecoveryServices.Backup cmdlets.</span></span> <span data-ttu-id="b963c-733">När den godkänns åsidosätts cmdleten Set-AzureRmRecoveryServicesContext.</span><span class="sxs-lookup"><span data-stu-id="b963c-733">When passed, this will override the Set-AzureRmRecoveryServicesContext cmdlet.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="b963c-734">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b963c-734">AzureRM.Sql</span></span>
* <span data-ttu-id="b963c-735">Exemplet i hjälpfilen för Get-AzureRmSqlDatabaseExpanded har uppdaterats</span><span class="sxs-lookup"><span data-stu-id="b963c-735">Updated example in the help file for Get-AzureRmSqlDatabaseExpanded</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="b963c-736">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="b963c-736">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="b963c-737">Hjälpfilen för Add-AzureRmTrafficManagerEndpointConfig har uppdaterats</span><span class="sxs-lookup"><span data-stu-id="b963c-737">Updated the help file for Add-AzureRmTrafficManagerEndpointConfig</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="b963c-738">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="b963c-738">AzureRM.Websites</span></span>
* <span data-ttu-id="b963c-739">”Set-AzureRmWebApp” har uppdaterats så att den inte skriver över appinställningarna när du använder -AssignIdentity</span><span class="sxs-lookup"><span data-stu-id="b963c-739">'Set-AzureRmWebApp' is updated to not overwrite the AppSettings when using -AssignIdentity</span></span>
* <span data-ttu-id="b963c-740">”New-AzureRMWebAppSlot” har uppdaterats för att visa att AppServicePlan är en valfri parameter</span><span class="sxs-lookup"><span data-stu-id="b963c-740">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="b963c-741">6.2.1 – juni 2018</span><span class="sxs-lookup"><span data-stu-id="b963c-741">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="b963c-742">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="b963c-742">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="b963c-743">PSWorkspace-modellen har uppdaterats för att tillåta att nätverket använder typ som en parameter</span><span class="sxs-lookup"><span data-stu-id="b963c-743">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="b963c-744">6.2.0 – juni 2018</span><span class="sxs-lookup"><span data-stu-id="b963c-744">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="b963c-745">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="b963c-745">AzureRM.Profile</span></span>
* <span data-ttu-id="b963c-746">Åtgärda problemet med att version 10.0.3 av Newtonsoft.Json inte lästes in vid modulimporten</span><span class="sxs-lookup"><span data-stu-id="b963c-746">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="b963c-747">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="b963c-747">AzureRM.Compute</span></span>
* <span data-ttu-id="b963c-748">VMSS VM-uppdateringsfunktion</span><span class="sxs-lookup"><span data-stu-id="b963c-748">VMSS VM Update feature</span></span>
    - <span data-ttu-id="b963c-749">Cmdletarna Update-AzureRmVmssVM och New-AzureRmVMDataDisk har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-749">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="b963c-750">Lägg till parametern VirtualMachineScaleSetVM till cmdleten Add-AzureRmVMDataDisk så att det går att lägga till en datadisk i den virtuella Vmss-datorn.</span><span class="sxs-lookup"><span data-stu-id="b963c-750">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="b963c-751">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="b963c-751">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="b963c-752">SDK:n för ADF .Net har uppdaterats till version 0.8.0-preview som innehåller följande ändringar:</span><span class="sxs-lookup"><span data-stu-id="b963c-752">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="b963c-753">Åtgärden för att konfigurera fabrikslagringsplatsen har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-753">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="b963c-754">QuickBooks LinkedService har uppdaterats för att visa egenskaperna consumerKey och consumerSecret</span><span class="sxs-lookup"><span data-stu-id="b963c-754">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="b963c-755">Flera modelltyper från SecretBase till Object har uppdaterats</span><span class="sxs-lookup"><span data-stu-id="b963c-755">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="b963c-756">Utlösaren Blob Events har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-756">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="b963c-757">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="b963c-757">AzureRM.KeyVault</span></span>
* <span data-ttu-id="b963c-758">Uppdatera dokumentation med exempel på utdata</span><span class="sxs-lookup"><span data-stu-id="b963c-758">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="b963c-759">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="b963c-759">AzureRM.Network</span></span>
* <span data-ttu-id="b963c-760">Aktivera Trafikanalys-parametrar på Network Watcher-cmdletar</span><span class="sxs-lookup"><span data-stu-id="b963c-760">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="b963c-761">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="b963c-761">AzureRM.Resources</span></span>
* <span data-ttu-id="b963c-762">Åtgärda problemet med egenskapen "Properties" för objekt(en) "PSResource" som returneras från "Get-AzureRmResource"</span><span class="sxs-lookup"><span data-stu-id="b963c-762">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="b963c-763">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="b963c-763">AzureRM.Scheduler</span></span>
* <span data-ttu-id="b963c-764">Åtgärda problemet med att nya autentiseringsvärden inte anges vid uppdatering av ServiceBusQueueJob</span><span class="sxs-lookup"><span data-stu-id="b963c-764">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="b963c-765">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b963c-765">AzureRM.Sql</span></span>
* <span data-ttu-id="b963c-766">Följande cmdletar har uppdaterats med valfri LicenseType-parameter</span><span class="sxs-lookup"><span data-stu-id="b963c-766">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="b963c-767">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="b963c-767">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="b963c-768">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="b963c-768">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="b963c-769">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="b963c-769">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="b963c-770">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="b963c-770">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="b963c-771">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="b963c-771">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="b963c-772">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="b963c-772">AzureRM.Websites</span></span>
* <span data-ttu-id="b963c-773">New-AzureRMWebApp har uppdaterats för att använda vanliga algoritmer från biblioteket Strategy.</span><span class="sxs-lookup"><span data-stu-id="b963c-773">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="b963c-774">6.1.0 – maj 2018</span><span class="sxs-lookup"><span data-stu-id="b963c-774">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="b963c-775">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="b963c-775">AzureRM.Profile</span></span>
* <span data-ttu-id="b963c-776">Åtgärda problem där en körning av Clear-AzureRmContext skulle bevara en tom kontext med namnet på den föregående standardkontexten som gjorde att användaren inte kunde skapa en ny kontext med det gamla namnet</span><span class="sxs-lookup"><span data-stu-id="b963c-776">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="b963c-777">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="b963c-777">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="b963c-778">Aktivera Gateway associerings- och avassocieringsåtgärder på AS.</span><span class="sxs-lookup"><span data-stu-id="b963c-778">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="b963c-779">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="b963c-779">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="b963c-780">Stöd för ApiVersions, ApiReleases och ApiRevisions har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-780">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="b963c-781">Stöd för serverdelen på ServiceFabric har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-781">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="b963c-782">Stöd för Application Insights-loggare har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-782">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="b963c-783">Stöd för att identifiera SKU:n ”Basic” som en giltig SKU för Api Management-tjänsten har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-783">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="b963c-784">Stöd för att installera certifikat som utfärdats av privata certifikatutfärdare som rot eller certifikatutfärdare har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-784">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="b963c-785">Stöd för att godkänna anpassade SSL-certifikat via KeyVault och flera proxy-värdnamn har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-785">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="b963c-786">Stöd för MSI-identitet har lagts till</span><span class="sxs-lookup"><span data-stu-id="b963c-786">Added support for MSI identity</span></span>
* <span data-ttu-id="b963c-787">Stöd för att godkänna principer via URL har lagts till. Obs! Följande cmdletar blir inaktuella i framtida versioner</span><span class="sxs-lookup"><span data-stu-id="b963c-787">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="b963c-788">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="b963c-788">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="b963c-789">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="b963c-789">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="b963c-790">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="b963c-790">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="b963c-791">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="b963c-791">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="b963c-792">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="b963c-792">AzureRM.Batch</span></span>
* <span data-ttu-id="b963c-793">Släpp nya cmdleten Get-AzureBatchPoolNodeCounts</span><span class="sxs-lookup"><span data-stu-id="b963c-793">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="b963c-794">Släpp nya cmdleten Start-AzureBatchComputeNodeServiceLogUpload</span><span class="sxs-lookup"><span data-stu-id="b963c-794">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="b963c-795">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="b963c-795">AzureRM.Consumption</span></span>
* <span data-ttu-id="b963c-796">Lägg till nya parametrar Expand, ResourceGroup, InstanceName, InstanceId, Tags och Top på cmdleten Get-AzureRmConsumptionUsageDetail</span><span class="sxs-lookup"><span data-stu-id="b963c-796">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="b963c-797">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="b963c-797">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="b963c-798">Åtgärda exempel för Export AzureRmDataLakeStoreChildItemProperties</span><span class="sxs-lookup"><span data-stu-id="b963c-798">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="b963c-799">Åtgärda undantag för null-parameter för rekursivt ärende i Set-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="b963c-799">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="b963c-800">Åtgärda hjälpfilerna för Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="b963c-800">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="b963c-801">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="b963c-801">AzureRM.Network</span></span>
* <span data-ttu-id="b963c-802">Öka nätverkets SDK-version från förhandsversionen 18.0.0 till förhandsversionen 19.0.0</span><span class="sxs-lookup"><span data-stu-id="b963c-802">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="b963c-803">Cmdlet har lagts till för att skapa protokollinformation</span><span class="sxs-lookup"><span data-stu-id="b963c-803">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="b963c-804">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="b963c-804">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="b963c-805">Cmdlet har lagts till för att lägga till en ny kretsanslutning till en befintlig expressroute-krets.</span><span class="sxs-lookup"><span data-stu-id="b963c-805">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="b963c-806">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="b963c-806">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="b963c-807">Cmdlet har lagts till för att ta bort en kretsanslutning från en befintlig expressroute-krets.</span><span class="sxs-lookup"><span data-stu-id="b963c-807">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="b963c-808">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="b963c-808">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="b963c-809">Cmdlet har lagts till för att hämta en kretsanslutning</span><span class="sxs-lookup"><span data-stu-id="b963c-809">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="b963c-810">Get-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="b963c-810">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="b963c-811">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="b963c-811">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="b963c-812">Användning med serverautentisering med genererade certifikat (problem #5998) har åtgärdats</span><span class="sxs-lookup"><span data-stu-id="b963c-812">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="b963c-813">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="b963c-813">AzureRM.Sql</span></span>
* <span data-ttu-id="b963c-814">Cmdletar för granskning för att ta bort AuditActions eller AuditActionGroups har uppdaterats</span><span class="sxs-lookup"><span data-stu-id="b963c-814">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="b963c-815">Åtgärdade problem med Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy vid konfigurering av en ny flexibel bevarandeprincip där kommandot misslyckas med ett meddelande om att konfigurering av långsiktig bevarandeprincip med Azure Recovery Service-valv och principen inte längre stöds,</span><span class="sxs-lookup"><span data-stu-id="b963c-815">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="b963c-816">och att en begäran med den nya flexibla bevarandeprincipen ska skickas.</span><span class="sxs-lookup"><span data-stu-id="b963c-816">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="b963c-817">Uppdatera alla Azure Sql Database/ElasticPool Creation/Update-relaterade cmdletar för att använda det nya databas-API:et som stöder SKU-egenskaper för skalnings- och nivårelaterade egenskaper.</span><span class="sxs-lookup"><span data-stu-id="b963c-817">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="b963c-818">Cmdletar har uppdaterats, inklusive:</span><span class="sxs-lookup"><span data-stu-id="b963c-818">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="b963c-819">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="b963c-819">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="b963c-820">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="b963c-820">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="b963c-821">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="b963c-821">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="b963c-822">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="b963c-822">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="b963c-823">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="b963c-823">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="b963c-824">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="b963c-824">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="b963c-825">Uppdatera parametrarna för Get-AzureRmTrafficManagerProfile så att ResourceGroupName-parametern blir obligatorisk när du använder Name-parametern.</span><span class="sxs-lookup"><span data-stu-id="b963c-825">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
