...
### <a name="certificate-based-authentication"></a><span data-ttu-id="f6a87-135">Certifikatbaserad autentisering</span><span class="sxs-lookup"><span data-stu-id="f6a87-135">Certificate-based authentication</span></span>
