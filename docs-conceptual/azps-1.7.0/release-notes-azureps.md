...
* Åtgärda problem med ändring av JSON-datatyp vid körning `Set-AzResource`
...
#### <a name="azsql"></a>Az.Sql
* Stöd för nivån SQL DB-hyperskal har lagts till
...
### <a name="azresources"></a>Az.Resources
* Uppdatera hjälpdokumentationen för resursidentitet kopplad till parametrar i `New-AzureRmPolicyAssignment` och `Set-AzureRmPolicyAssignment`
