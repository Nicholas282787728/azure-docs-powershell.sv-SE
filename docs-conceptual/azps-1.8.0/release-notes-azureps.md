...
#### <a name="azaccounts"></a><span data-ttu-id="6a1d9-113">Az.Accounts</span><span class="sxs-lookup"><span data-stu-id="6a1d9-113">Az.Accounts</span></span>
...
#### <a name="azeventgrid"></a><span data-ttu-id="6a1d9-129">Az.EventGrid</span><span class="sxs-lookup"><span data-stu-id="6a1d9-129">Az.EventGrid</span></span>
...
#### <a name="azmonitor"></a><span data-ttu-id="6a1d9-144">Az.Monitor</span><span class="sxs-lookup"><span data-stu-id="6a1d9-144">Az.Monitor</span></span>
...
#### <a name="azrecoveryservices"></a><span data-ttu-id="6a1d9-161">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="6a1d9-161">Az.RecoveryServices</span></span>
...
#### <a name="azwebsites"></a><span data-ttu-id="6a1d9-178">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="6a1d9-178">Az.Websites</span></span>
...
#### <a name="azanalysisservices"></a><span data-ttu-id="6a1d9-194">Az.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="6a1d9-194">Az.AnalysisServices</span></span>
...
#### <a name="azresources"></a><span data-ttu-id="6a1d9-209">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="6a1d9-209">Az.Resources</span></span>
...
## <a name="160---march-2019"></a><span data-ttu-id="6a1d9-231">1.6.0 – mars 2019</span><span class="sxs-lookup"><span data-stu-id="6a1d9-231">1.6.0 - March 2019</span></span>
...
#### <a name="azkeyvault"></a><span data-ttu-id="6a1d9-248">Az.KeyVault</span><span class="sxs-lookup"><span data-stu-id="6a1d9-248">Az.KeyVault</span></span>
...
* <span data-ttu-id="6a1d9-262">Stöd för att hämta/ange/ta bort hanteringsprincip på ett lagringskonto</span><span class="sxs-lookup"><span data-stu-id="6a1d9-262">Support Get/Set/Remove Management Policy on a Storage account</span></span>
    ...
    - <span data-ttu-id="6a1d9-267">New-AzStorageAccountManagementPolicyFilter</span><span class="sxs-lookup"><span data-stu-id="6a1d9-267">New-AzStorageAccountManagementPolicyFilter</span></span>
...
#### <a name="azdatafactory"></a><span data-ttu-id="6a1d9-283">Az.DataFactory</span><span class="sxs-lookup"><span data-stu-id="6a1d9-283">Az.DataFactory</span></span>
...
#### <a name="azsql"></a><span data-ttu-id="6a1d9-301">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="6a1d9-301">Az.Sql</span></span>
...
* <span data-ttu-id="6a1d9-319">Get-AzVmssVM utan instans-ID och med InstanceView kan visa virtuella VMSS-datorer med instansvyn.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-319">Get-AzVmssVM without instance ID and with InstanceView can list VMSS VMs with instance view.</span></span>
...
#### <a name="azmonitor"></a><span data-ttu-id="6a1d9-340">Az.Monitor</span><span class="sxs-lookup"><span data-stu-id="6a1d9-340">Az.Monitor</span></span>
...
#### <a name="azwebsites"></a><span data-ttu-id="6a1d9-356">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="6a1d9-356">Az.Websites</span></span>
...
#### <a name="azsql"></a><span data-ttu-id="6a1d9-374">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="6a1d9-374">Az.Sql</span></span>
...
#### <a name="azaks"></a><span data-ttu-id="6a1d9-390">Az.Aks</span><span class="sxs-lookup"><span data-stu-id="6a1d9-390">Az.Aks</span></span>
...
#### <a name="aziothub"></a><span data-ttu-id="6a1d9-409">Az.IotHub</span><span class="sxs-lookup"><span data-stu-id="6a1d9-409">Az.IotHub</span></span>
...
## <a name="110---january-2019"></a><span data-ttu-id="6a1d9-446">1.1.0 – januari 2019</span><span class="sxs-lookup"><span data-stu-id="6a1d9-446">1.1.0 - January 2019</span></span>
...
* <span data-ttu-id="6a1d9-458">Uppdaterade följande cmdletar för att stödja nytt scenario i API-versionen 2019-01-01</span><span class="sxs-lookup"><span data-stu-id="6a1d9-458">Update the following cmdlets to support new scenario in 2019-01-01 API version</span></span>
    ...
    - <span data-ttu-id="6a1d9-463">Update-AzureRmEventGridSubscription: Lade till ny valfria parametrar för att ange:</span><span class="sxs-lookup"><span data-stu-id="6a1d9-463">Update-AzureRmEventGridSubscription: Add new optional parameters for specifying:</span></span>
        ...
        - <span data-ttu-id="6a1d9-466">Slutpunkt för obeställbar meddelanden.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-466">Dead letter endpoint.</span></span>
...
#### <a name="azsql"></a><span data-ttu-id="6a1d9-482">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="6a1d9-482">Az.Sql</span></span>
* <span data-ttu-id="6a1d9-483">Konverterade lagringshanteringsklientens beroende av den normala SDK-implementeringen.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-483">Converted the Storage management client dependency to the common SDK implementation.</span></span>

#### <a name="azstorage"></a><span data-ttu-id="6a1d9-484">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="6a1d9-484">Az.Storage</span></span>
* <span data-ttu-id="6a1d9-485">Angav StorageAccountName för lagringskontext som det verkliga namnet på lagringskontot när det skapas med Sas Token, OAuth eller Anonymous</span><span class="sxs-lookup"><span data-stu-id="6a1d9-485">Set the StorageAccountName of Storage context as the real Storage Account Name, when it's created with Sas Token, OAuth or Anonymous</span></span>
    - <span data-ttu-id="6a1d9-486">New-AzStorageContext</span><span class="sxs-lookup"><span data-stu-id="6a1d9-486">New-AzStorageContext</span></span>
* <span data-ttu-id="6a1d9-487">Skapade Sas Token för Blob Snapshot-objekt med parametern -FullUri, åtgärdade den returnerade URI:n så att den blir URI för ögonblicksbild</span><span class="sxs-lookup"><span data-stu-id="6a1d9-487">Create Sas Token of Blob Snapshot Object with '-FullUri' parameter, fix the returned Uri to be the sanpshot Uri</span></span>
    - <span data-ttu-id="6a1d9-488">New-AzStorageBlobSASToken</span><span class="sxs-lookup"><span data-stu-id="6a1d9-488">New-AzStorageBlobSASToken</span></span>

#### <a name="azwebsites"></a><span data-ttu-id="6a1d9-489">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="6a1d9-489">Az.Websites</span></span>
* <span data-ttu-id="6a1d9-490">Åtgärdade en bugg i datumparsningen i Get-AzDeletedWebApp</span><span class="sxs-lookup"><span data-stu-id="6a1d9-490">Fixed a date parsing bug in 'Get-AzDeletedWebApp'</span></span>
* <span data-ttu-id="6a1d9-491">Åtgärdade problemet med bakåtkompatibilitet med modulen Az.Accounts</span><span class="sxs-lookup"><span data-stu-id="6a1d9-491">Fix backward compatibility issue with Az.Accounts module</span></span>

## <a name="100---december-2018"></a><span data-ttu-id="6a1d9-492">1.0.0 – december 2018</span><span class="sxs-lookup"><span data-stu-id="6a1d9-492">1.0.0 - December 2018</span></span>
### <a name="general"></a><span data-ttu-id="6a1d9-493">Allmänt</span><span class="sxs-lookup"><span data-stu-id="6a1d9-493">General</span></span>

- <span data-ttu-id="6a1d9-494">Allmän tillgänglighet för Az-modulen</span><span class="sxs-lookup"><span data-stu-id="6a1d9-494">General Availability of Az Module</span></span>
- <span data-ttu-id="6a1d9-495">Onlinehjälp för varje modul</span><span class="sxs-lookup"><span data-stu-id="6a1d9-495">Online help for each module</span></span>
- <span data-ttu-id="6a1d9-496">Mer information och en översikt finns på [Az-informationssidan](https://aka.ms/azps-announce)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-496">For more details and a roadmap, see the [Az Announcement page](https://aka.ms/azps-announce)</span></span>
- <span data-ttu-id="6a1d9-497">Information om hur du migrerar från AzureRM finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-497">See the [Migration Guide](https://aka.ms/azps-migration-guide) for information on migrating from AzureRM</span></span>

### <a name="azaccounts"></a><span data-ttu-id="6a1d9-498">Az.Accounts</span><span class="sxs-lookup"><span data-stu-id="6a1d9-498">Az.Accounts</span></span>
- <span data-ttu-id="6a1d9-499">Har ändrats från Az.Profile</span><span class="sxs-lookup"><span data-stu-id="6a1d9-499">Changed from Az.Profile</span></span>
- <span data-ttu-id="6a1d9-500">Fasta tabellformat för profil- och kontexttyper</span><span class="sxs-lookup"><span data-stu-id="6a1d9-500">Fixed table formats for profile and context types</span></span>

### <a name="azapimanagement"></a><span data-ttu-id="6a1d9-501">Az.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="6a1d9-501">Az.ApiManagement</span></span>
- <span data-ttu-id="6a1d9-502">Korrigeringar för #7002</span><span class="sxs-lookup"><span data-stu-id="6a1d9-502">Fixes for #7002</span></span>
- <span data-ttu-id="6a1d9-503">Mer information om mindre icke-bakåtkompatibla ändringar finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-503">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azbatch"></a><span data-ttu-id="6a1d9-504">Az.Batch</span><span class="sxs-lookup"><span data-stu-id="6a1d9-504">Az.Batch</span></span>
- <span data-ttu-id="6a1d9-505">Lade till möjligheten att se vilken version av Azure Batch Node Agent som körs på var och en av de virtuella datorerna i en pool, via den nya egenskapen `NodeAgentInformation` på `PSComputeNode`.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-505">Added the ability to see what version of the Azure Batch Node Agent is running on each of the VMs in a pool, via the new `NodeAgentInformation` property on `PSComputeNode`.</span></span>
- <span data-ttu-id="6a1d9-506">Standarden `Caching` för `PSDataDisk` är nu `ReadWrite` i stället för `None`.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-506">The `Caching` default for `PSDataDisk` is now `ReadWrite` instead of `None`.</span></span>
- <span data-ttu-id="6a1d9-507">Mer information om mindre icke-bakåtkompatibla ändringar finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-507">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azbilling"></a><span data-ttu-id="6a1d9-508">Az.Billing</span><span class="sxs-lookup"><span data-stu-id="6a1d9-508">Az.Billing</span></span>
- <span data-ttu-id="6a1d9-509">Kombinerar cmdletarna för fakturering, förbrukning och UsageAggregates. Mer information finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-509">Combines Billing, Consumption, and UsageAggregates cmdlets, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azcognitivservices"></a><span data-ttu-id="6a1d9-510">Az.CognitivServices</span><span class="sxs-lookup"><span data-stu-id="6a1d9-510">Az.CognitivServices</span></span>
- <span data-ttu-id="6a1d9-511">Lade till kompletterare för SkuName och Typem som är tillgängliga i New-AzureRmCognitiveServicesAccount</span><span class="sxs-lookup"><span data-stu-id="6a1d9-511">Add completers for SkuName and Typem available on New-AzureRmCognitiveServicesAccount operation</span></span>
- <span data-ttu-id="6a1d9-512">Tog bort parameteruppsättningen GetSkusWithAccountParamSetName från Get-AzCognitiveServicesAccountSkus</span><span class="sxs-lookup"><span data-stu-id="6a1d9-512">Removed GetSkusWithAccountParamSetName parameter set from Get-AzCognitiveServicesAccountSkus</span></span>

### <a name="azcontainerinstance"></a><span data-ttu-id="6a1d9-513">Az.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="6a1d9-513">Az.ContainerInstance</span></span>
- <span data-ttu-id="6a1d9-514">Stöd för ManagedIdentity</span><span class="sxs-lookup"><span data-stu-id="6a1d9-514">Added ManagedIdentity support</span></span>

### <a name="azdatalakeanalytics"></a><span data-ttu-id="6a1d9-515">Az.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="6a1d9-515">Az.DataLakeAnalytics</span></span>
- <span data-ttu-id="6a1d9-516">Mer information om mindre icke-bakåtkompatibla ändringar finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-516">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azdatalakestore"></a><span data-ttu-id="6a1d9-517">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="6a1d9-517">Az.DataLakeStore</span></span>
- <span data-ttu-id="6a1d9-518">Mer information om mindre icke-bakåtkompatibla ändringar finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-518">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azmonitor"></a><span data-ttu-id="6a1d9-519">Az.Monitor</span><span class="sxs-lookup"><span data-stu-id="6a1d9-519">Az.Monitor</span></span>
- <span data-ttu-id="6a1d9-520">Döpte om Az.Insights till Az.Monitor och andra mindre icke-bakåtkompatibla ändringar. Mer information finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-520">Renamed Az.Insights to Az.Monitor and other minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azkeyvault"></a><span data-ttu-id="6a1d9-521">Az.KeyVault</span><span class="sxs-lookup"><span data-stu-id="6a1d9-521">Az.KeyVault</span></span>
- <span data-ttu-id="6a1d9-522">Tog bort den inaktuella egenskapen PurgeDisabled från utdatatyper</span><span class="sxs-lookup"><span data-stu-id="6a1d9-522">Removed the deprecated 'PurgeDisabled' property from output types</span></span>

### <a name="azmachinelearning"></a><span data-ttu-id="6a1d9-523">Az.MachineLearning</span><span class="sxs-lookup"><span data-stu-id="6a1d9-523">Az.MachineLearning</span></span>
- <span data-ttu-id="6a1d9-524">Inkluderade cmdletarna från modulen Az.MachineLearningCompute</span><span class="sxs-lookup"><span data-stu-id="6a1d9-524">Included cmdlets from Az.MachineLearningCompute module</span></span>

### <a name="azmedia"></a><span data-ttu-id="6a1d9-525">Az.Media</span><span class="sxs-lookup"><span data-stu-id="6a1d9-525">Az.Media</span></span>
- <span data-ttu-id="6a1d9-526">Tog bort inaktuella -Tags-alias från New-AzMediaService</span><span class="sxs-lookup"><span data-stu-id="6a1d9-526">Remove deprecated -Tags alias from New-AzMediaService</span></span>

### <a name="aznetwork"></a><span data-ttu-id="6a1d9-527">Az.Network</span><span class="sxs-lookup"><span data-stu-id="6a1d9-527">Az.Network</span></span>
<span data-ttu-id="6a1d9-528">Stöd har lagts till för konfiguration av RewriteRuleSets i Application Gateway</span><span class="sxs-lookup"><span data-stu-id="6a1d9-528">Added support for the configuring RewriteRuleSets in the Application Gateway</span></span>
    - <span data-ttu-id="6a1d9-529">Nya cmdletar har lagts till:</span><span class="sxs-lookup"><span data-stu-id="6a1d9-529">New cmdlets added:</span></span>
        - <span data-ttu-id="6a1d9-530">Add-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="6a1d9-530">Add-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="6a1d9-531">Get-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="6a1d9-531">Get-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="6a1d9-532">New-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="6a1d9-532">New-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="6a1d9-533">Remove-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="6a1d9-533">Remove-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="6a1d9-534">Set-AzureRmApplicationGatewayRewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="6a1d9-534">Set-AzureRmApplicationGatewayRewriteRuleSet</span></span>
        - <span data-ttu-id="6a1d9-535">New-AzureRmApplicationGatewayRewriteRule</span><span class="sxs-lookup"><span data-stu-id="6a1d9-535">New-AzureRmApplicationGatewayRewriteRule</span></span>
        - <span data-ttu-id="6a1d9-536">New-AzureRmApplicationGatewayRewriteRuleActionSet</span><span class="sxs-lookup"><span data-stu-id="6a1d9-536">New-AzureRmApplicationGatewayRewriteRuleActionSet</span></span>
        - <span data-ttu-id="6a1d9-537">New-AzureRmApplicationGatewayRewriteRuleHeaderConfiguration</span><span class="sxs-lookup"><span data-stu-id="6a1d9-537">New-AzureRmApplicationGatewayRewriteRuleHeaderConfiguration</span></span>
    - <span data-ttu-id="6a1d9-538">Cmdletar har uppdaterats med den valfria parametern -RewriteRuleSet</span><span class="sxs-lookup"><span data-stu-id="6a1d9-538">Cmdlets updated with optional parameter -RewriteRuleSet</span></span>
        - <span data-ttu-id="6a1d9-539">New-AzureRmApplicationGateway</span><span class="sxs-lookup"><span data-stu-id="6a1d9-539">New-AzureRmApplicationGateway</span></span>
        - <span data-ttu-id="6a1d9-540">New-AzureRmApplicationGatewayRequestRoutingRule</span><span class="sxs-lookup"><span data-stu-id="6a1d9-540">New-AzureRmApplicationGatewayRequestRoutingRule</span></span>
        - <span data-ttu-id="6a1d9-541">Add-AzureRmApplicationGatewayRequestRoutingRule</span><span class="sxs-lookup"><span data-stu-id="6a1d9-541">Add-AzureRmApplicationGatewayRequestRoutingRule</span></span>
        - <span data-ttu-id="6a1d9-542">New-AzureRmApplicationGatewayPathRuleConfig</span><span class="sxs-lookup"><span data-stu-id="6a1d9-542">New-AzureRmApplicationGatewayPathRuleConfig</span></span>
        - <span data-ttu-id="6a1d9-543">Add-AzureRmApplicationGatewayUrlPathMapConfig</span><span class="sxs-lookup"><span data-stu-id="6a1d9-543">Add-AzureRmApplicationGatewayUrlPathMapConfig</span></span>
        - <span data-ttu-id="6a1d9-544">New-AzureRmApplicationGatewayUrlPathMapConfig har lagt till KeyVault-stöd för Application Gateway med Identity.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-544">New-AzureRmApplicationGatewayUrlPathMapConfig Added KeyVault Support to Application Gateway using Identity.</span></span>
    - <span data-ttu-id="6a1d9-545">Cmdletar har uppdaterats med den valfria parametern -KeyVaultSecretId, -KeyVaultSecret</span><span class="sxs-lookup"><span data-stu-id="6a1d9-545">Cmdlets updated with optonal parameter -KeyVaultSecretId, -KeyVaultSecret</span></span>
        - <span data-ttu-id="6a1d9-546">Add-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="6a1d9-546">Add-AzApplicationGatewaySslCertificate</span></span>
        - <span data-ttu-id="6a1d9-547">New-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="6a1d9-547">New-AzApplicationGatewaySslCertificate</span></span>
        - <span data-ttu-id="6a1d9-548">Set-AzApplicationGatewaySslCertificate</span><span class="sxs-lookup"><span data-stu-id="6a1d9-548">Set-AzApplicationGatewaySslCertificate</span></span>
    - <span data-ttu-id="6a1d9-549">Cmdleten New-AzApplicationGateway har uppdaterats med den valfria parametern -UserAssignedIdentity</span><span class="sxs-lookup"><span data-stu-id="6a1d9-549">New-AzApplicationGateway cmdlet updated with optional parameter -UserAssignedIdentity</span></span>
- <span data-ttu-id="6a1d9-550">Mer information om mindre icke-bakåtkompatibla ändringar finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-550">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azoperationalinsights"></a><span data-ttu-id="6a1d9-551">Az.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="6a1d9-551">Az.OperationalInsights</span></span>
- <span data-ttu-id="6a1d9-552">Mer information om mindre icke-bakåtkompatibla ändringar finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-552">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azprofile"></a><span data-ttu-id="6a1d9-553">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="6a1d9-553">Az.Profile</span></span>
- <span data-ttu-id="6a1d9-554">Modulnamnet har ändrats till Az.Accounts</span><span class="sxs-lookup"><span data-stu-id="6a1d9-554">Changed module name to Az.Accounts</span></span>

### <a name="azrecoveryservices"></a><span data-ttu-id="6a1d9-555">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="6a1d9-555">Az.RecoveryServices</span></span>
- <span data-ttu-id="6a1d9-556">Mer information om mindre icke-bakåtkompatibla ändringar finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-556">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azresources"></a><span data-ttu-id="6a1d9-557">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="6a1d9-557">Az.Resources</span></span>
- <span data-ttu-id="6a1d9-558">Mer information om mindre icke-bakåtkompatibla ändringar finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-558">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azservicefabric"></a><span data-ttu-id="6a1d9-559">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="6a1d9-559">Az.ServiceFabric</span></span>
- <span data-ttu-id="6a1d9-560">Stöd för specificering av certifikat efter eget namn och tumavtryck</span><span class="sxs-lookup"><span data-stu-id="6a1d9-560">Support specfying certificate by common name and thumbprint</span></span>
- <span data-ttu-id="6a1d9-561">Information om fler icke-bakåtkompatibla ändringar finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-561">Mnor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azsignalr"></a><span data-ttu-id="6a1d9-562">Az.SIgnalR</span><span class="sxs-lookup"><span data-stu-id="6a1d9-562">Az.SIgnalR</span></span>
- <span data-ttu-id="6a1d9-563">Allmän tillgänglighet för PowerShell-cmdletar för SIgnalR</span><span class="sxs-lookup"><span data-stu-id="6a1d9-563">General Availability for PowerShell cmdlets for SIgnalR</span></span>

### <a name="azsql"></a><span data-ttu-id="6a1d9-564">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="6a1d9-564">Az.Sql</span></span>
- <span data-ttu-id="6a1d9-565">Lade till de nya identifieringstyperna Data_Exfiltration och Unsafe_Action i Threat Detection-cmdletar</span><span class="sxs-lookup"><span data-stu-id="6a1d9-565">Added new Data_Exfiltration and Unsafe_Action detection types to Threat Detection's cmdlets</span></span>
- <span data-ttu-id="6a1d9-566">Uppdaterade dokumentationsexempel för Sql Auditing-cmdletar</span><span class="sxs-lookup"><span data-stu-id="6a1d9-566">Updated documentation examples for Sql Auditing cmdlets</span></span>
- <span data-ttu-id="6a1d9-567">Mer information om mindre icke-bakåtkompatibla ändringar finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-567">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azstorage"></a><span data-ttu-id="6a1d9-568">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="6a1d9-568">Az.Storage</span></span>
- <span data-ttu-id="6a1d9-569">Mer information om mindre icke-bakåtkompatibla ändringar finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-569">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

### <a name="azwebsites"></a><span data-ttu-id="6a1d9-570">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="6a1d9-570">Az.Websites</span></span>
- <span data-ttu-id="6a1d9-571">Mer information om mindre icke-bakåtkompatibla ändringar finns i [Migreringsguiden](https://aka.ms/azps-migration-guide)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-571">Minor breaking changes, see the [Migration Guide](https://aka.ms/azps-migration-guide)  for details</span></span>

## <a name="070---december-2018"></a><span data-ttu-id="6a1d9-572">0.7.0 – december 2018</span><span class="sxs-lookup"><span data-stu-id="6a1d9-572">0.7.0 - December 2018</span></span>

### <a name="general"></a><span data-ttu-id="6a1d9-573">Allmänt</span><span class="sxs-lookup"><span data-stu-id="6a1d9-573">General</span></span>

* <span data-ttu-id="6a1d9-574">Mindre ändringar för kommande övergång från AzureRM till Az</span><span class="sxs-lookup"><span data-stu-id="6a1d9-574">Minor changes for upcoming AzureRM to Az transition</span></span>

### <a name="azcompute"></a><span data-ttu-id="6a1d9-575">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="6a1d9-575">Az.Compute</span></span>

* <span data-ttu-id="6a1d9-576">Lade till stöd för UltraSSD och Galleriavbildningar i de enkla parameteruppsättningarna för `New-AzVm(ss)`-cmdletar.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-576">Add support for UltraSSD and Gallery Images in the simple param sets for `New-AzVm(ss)` cmdlets.</span></span>

### <a name="azdatalakestore"></a><span data-ttu-id="6a1d9-577">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="6a1d9-577">Az.DataLakeStore</span></span>

* <span data-ttu-id="6a1d9-578">Åtgärdade avslutande snedstreck i domänen för adls-konto</span><span class="sxs-lookup"><span data-stu-id="6a1d9-578">Fix the trailing slash of the domain of adls account</span></span>

### <a name="azfrontdoor"></a><span data-ttu-id="6a1d9-579">Az.FrontDoor</span><span class="sxs-lookup"><span data-stu-id="6a1d9-579">Az.FrontDoor</span></span>

* <span data-ttu-id="6a1d9-580">Brutna länkar korrigerades</span><span class="sxs-lookup"><span data-stu-id="6a1d9-580">Fixed some broken links</span></span>
    - <span data-ttu-id="6a1d9-581">I artiklarna New-AzureRmFrontDoor och Set-AzureRmFrontDoor artiklar korrigerades länken till artikeln om cmdleten New-AzureRmFrontDoorHealthProbeSettingObject.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-581">In the New-AzureRmFrontDoor and Set-AzureRmFrontDoor articles, fixed the link to the New-AzureRmFrontDoorHealthProbeSettingObject cmdlet article.</span></span>
    - <span data-ttu-id="6a1d9-582">I artikeln New-AzureRmFrontDoorManagedRuleObject korrigerades länken till artikeln om cmdleten New-AzureRmFrontDoorRuleGroupOverrideObject.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-582">In the New-AzureRmFrontDoorManagedRuleObject article, fixed the link to the New-AzureRmFrontDoorRuleGroupOverrideObject cmdlet article.</span></span>

### <a name="azrecoveryservices"></a><span data-ttu-id="6a1d9-583">Az.RecoveryServices</span><span class="sxs-lookup"><span data-stu-id="6a1d9-583">Az.RecoveryServices</span></span>

* <span data-ttu-id="6a1d9-584">Lade till valideringar på klientsidan för Azure-filresurs med återställningsåtgärder.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-584">Added client side validations for Azure File Share restore operations.</span></span>
* <span data-ttu-id="6a1d9-585">Gjorde storageAccountName och storageAccountResourceGroupName valfritt för afs-återställning.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-585">Made storageAccountName and storageAccountResourceGroupName optional for afs restore.</span></span>

### <a name="azresources"></a><span data-ttu-id="6a1d9-586">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="6a1d9-586">Az.Resources</span></span>

* <span data-ttu-id="6a1d9-587">Korrigering för https://github.com/Azure/azure-powershell/issues/7679</span><span class="sxs-lookup"><span data-stu-id="6a1d9-587">Fix for https://github.com/Azure/azure-powershell/issues/7679</span></span>
    - <span data-ttu-id="6a1d9-588">Uppdaterade Get-AzureRmRoleAssignment så att prenumerationsomfattningen används om den anges vid begäran om klassiska administratörer.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-588">Update Get-AzureRmRoleAssignment to use the subscription scope if it is provided when requesting classic administrators.</span></span>

### <a name="azsql"></a><span data-ttu-id="6a1d9-589">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="6a1d9-589">Az.Sql</span></span>

* <span data-ttu-id="6a1d9-590">Mindre ändringar för kommande övergång från AzureRM till Az</span><span class="sxs-lookup"><span data-stu-id="6a1d9-590">Minor changes for upcoming AzureRM to Az transition</span></span>
* <span data-ttu-id="6a1d9-591">Korrigerade ett problem med Get-AzureRmSqlDatabaseVulnerabilityAssessment med DotNet-kärna</span><span class="sxs-lookup"><span data-stu-id="6a1d9-591">Fixed issue with using Get-AzureRmSqlDatabaseVulnerabilityAssessment with DotNet core</span></span>
* <span data-ttu-id="6a1d9-592">Ändrade dokumentationen för hjälpmeddelanden som rör SQL Auditing-cmdletar.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-592">Modified documentation of help messages related to SQL Auditing cmdlets.</span></span>

### <a name="azstorage"></a><span data-ttu-id="6a1d9-593">Az.Storage</span><span class="sxs-lookup"><span data-stu-id="6a1d9-593">Az.Storage</span></span>

* <span data-ttu-id="6a1d9-594">Lade till -EnableHierarchicalNamespace i New-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="6a1d9-594">Add -EnableHierarchicalNamespace to New-AzureRmStorageAccount</span></span>
* <span data-ttu-id="6a1d9-595">Åtgärdade problemet med att cmdleten Copy File inte kunde återanvända källkontexten på målet om inte -DestContext angetts</span><span class="sxs-lookup"><span data-stu-id="6a1d9-595">Fix issue that Copy File cmdlet can't reuse source context in destination when not input -DestContext</span></span>
    - <span data-ttu-id="6a1d9-596">Start-AzureStorageFileCopy</span><span class="sxs-lookup"><span data-stu-id="6a1d9-596">Start-AzureStorageFileCopy</span></span>
* <span data-ttu-id="6a1d9-597">Stöd för statisk webbplatskonfiguration</span><span class="sxs-lookup"><span data-stu-id="6a1d9-597">Support Static Website configuration</span></span>
    - <span data-ttu-id="6a1d9-598">Enable-AzureStorageStaticWebsite</span><span class="sxs-lookup"><span data-stu-id="6a1d9-598">Enable-AzureStorageStaticWebsite</span></span>
    - <span data-ttu-id="6a1d9-599">Disable-AzureStorageStaticWebsite</span><span class="sxs-lookup"><span data-stu-id="6a1d9-599">Disable-AzureStorageStaticWebsite</span></span>

### <a name="azwebsites"></a><span data-ttu-id="6a1d9-600">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="6a1d9-600">Az.Websites</span></span>

* <span data-ttu-id="6a1d9-601">Set-AzureRmWebApp och Set-AzureRmWebAppSlot</span><span class="sxs-lookup"><span data-stu-id="6a1d9-601">Set-AzureRmWebApp and Set-AzureRmWebAppSlot</span></span>
    - <span data-ttu-id="6a1d9-602">Ny parameter (-AzureStoragePath) har lagts till för att ange att Azure Storage-sökvägar ska monteras i containerappar i Windows och Linux.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-602">New parameter (-AzureStoragePath) added to specify Azure Storage paths to be mounted in Windows and Linux container apps.</span></span> <span data-ttu-id="6a1d9-603">Använder utdata från den nya cmdleten New-AzureRmWebAppAzureStoragePath som en parameter för att ange sökvägar för Azure Storage.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-603">Use the output of the new cmdlet New-AzureRmWebAppAzureStoragePath as a parameter to set the Azure Storage paths.</span></span>

## <a name="061---november-2018"></a><span data-ttu-id="6a1d9-604">0.6.1 – november 2018</span><span class="sxs-lookup"><span data-stu-id="6a1d9-604">0.6.1 - November 2018</span></span>

### <a name="azapimanagement"></a><span data-ttu-id="6a1d9-605">Az.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="6a1d9-605">Az.ApiManagement</span></span>
* <span data-ttu-id="6a1d9-606">Uppdatera beroenden för problemet med typmappning</span><span class="sxs-lookup"><span data-stu-id="6a1d9-606">Update dependencies for type mapping issue</span></span>

### <a name="azautomation"></a><span data-ttu-id="6a1d9-607">Az.Automation</span><span class="sxs-lookup"><span data-stu-id="6a1d9-607">Az.Automation</span></span>
* <span data-ttu-id="6a1d9-608">Swagger baserade Azure Automation-cmdletar</span><span class="sxs-lookup"><span data-stu-id="6a1d9-608">Swagger based Azure Automation cmdlets</span></span>
* <span data-ttu-id="6a1d9-609">Cmdletar för Uppdateringshantering har lagts till</span><span class="sxs-lookup"><span data-stu-id="6a1d9-609">Added Update Management cmdlets</span></span>
* <span data-ttu-id="6a1d9-610">Cmdletar för källkontroll har lagts till</span><span class="sxs-lookup"><span data-stu-id="6a1d9-610">Added Source Control cmdlets</span></span>
* <span data-ttu-id="6a1d9-611">Remove-AzureRmAutomationHybridWorkerGroup-cmdlet har lagts till</span><span class="sxs-lookup"><span data-stu-id="6a1d9-611">Added Remove-AzureRmAutomationHybridWorkerGroup cmdlet</span></span>
* <span data-ttu-id="6a1d9-612">Kommandot för DSC-registreringsnod har åtgärdats</span><span class="sxs-lookup"><span data-stu-id="6a1d9-612">Fixed the DSC Register Node command</span></span>

### <a name="azcompute"></a><span data-ttu-id="6a1d9-613">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="6a1d9-613">Az.Compute</span></span>
* <span data-ttu-id="6a1d9-614">Problem med SystemAssigned-identitet har åtgärdats</span><span class="sxs-lookup"><span data-stu-id="6a1d9-614">Fixed identity issue for SystemAssigned identity</span></span>
* <span data-ttu-id="6a1d9-615">Uppdatera beroenden för problemet med typmappning</span><span class="sxs-lookup"><span data-stu-id="6a1d9-615">Update dependencies for type mapping issue</span></span>

### <a name="azcontainerinstance"></a><span data-ttu-id="6a1d9-616">Az.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="6a1d9-616">Az.ContainerInstance</span></span>
* <span data-ttu-id="6a1d9-617">Uppdatera beroenden för problemet med typmappning</span><span class="sxs-lookup"><span data-stu-id="6a1d9-617">Update dependencies for type mapping issue</span></span>

### <a name="azmarketplaceordering"></a><span data-ttu-id="6a1d9-618">Az.MarketplaceOrdering</span><span class="sxs-lookup"><span data-stu-id="6a1d9-618">Az.MarketplaceOrdering</span></span>
* <span data-ttu-id="6a1d9-619">uppdatera exempelbeskrivningen för marketplace-cmdletar</span><span class="sxs-lookup"><span data-stu-id="6a1d9-619">update the examples description for marketplace cmdlets</span></span>

### <a name="aznetwork"></a><span data-ttu-id="6a1d9-620">Az.Network</span><span class="sxs-lookup"><span data-stu-id="6a1d9-620">Az.Network</span></span>
* <span data-ttu-id="6a1d9-621">Cmdlet New-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayCustomError, Get-AzureRmApplicationGatewayCustomError, Set-AzureRmApplicationGatewayCustomError, Remove-AzureRmApplicationGatewayCustomErreller Add-AzureRmApplicationGatewayHttpListenerCustomError, Get-AzureRmApplicationGatewayHttpListenerCustomError, Set-AzureRmApplicationGatewayHttpListenerCustomError, Remove-AzureRmApplicationGatewayHttpListenerCustomError har lagts till</span><span class="sxs-lookup"><span data-stu-id="6a1d9-621">Added cmdlet New-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayCustomError, Get-AzureRmApplicationGatewayCustomError, Set-AzureRmApplicationGatewayCustomError, Remove-AzureRmApplicationGatewayCustomError, Add-AzureRmApplicationGatewayHttpListenerCustomError, Get-AzureRmApplicationGatewayHttpListenerCustomError, Set-AzureRmApplicationGatewayHttpListenerCustomError, Remove-AzureRmApplicationGatewayHttpListenerCustomError</span></span>
* <span data-ttu-id="6a1d9-622">ICMP tillbaka till stöd för Azure Firewall-nätverksprotokoll har lagts till</span><span class="sxs-lookup"><span data-stu-id="6a1d9-622">Added ICMP back to supported AzureFirewall Network Protocols</span></span>
* <span data-ttu-id="6a1d9-623">Uppdatera cmdlet Test-AzureRmNetworkWatcherConnectivity, lägga till verifiering av mål-id, adress och port.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-623">Update cmdlet Test-AzureRmNetworkWatcherConnectivity, add validation on destination id, address and port.</span></span>
* <span data-ttu-id="6a1d9-624">Åtgärda problem med minnesanvändning i VirtualNetwork-karta</span><span class="sxs-lookup"><span data-stu-id="6a1d9-624">Fix issues with memory usage in VirtualNetwork map</span></span>

### <a name="azrecoveryservicesbackup"></a><span data-ttu-id="6a1d9-625">Az.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="6a1d9-625">Az.RecoveryServices.Backup</span></span>
* <span data-ttu-id="6a1d9-626">Åtgärda för att ändra principen för en skyddad fildelning.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-626">Fix for modifying policy for a protected file share.</span></span>
* <span data-ttu-id="6a1d9-627">Tidszonsprincipen har konverterats till versaler.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-627">Converted policy timezone to uppercase.</span></span>

### <a name="azrecoveryservicessiterecovery"></a><span data-ttu-id="6a1d9-628">Az.RecoveryServices.SiteRecovery</span><span class="sxs-lookup"><span data-stu-id="6a1d9-628">Az.RecoveryServices.SiteRecovery</span></span>
* <span data-ttu-id="6a1d9-629">Exempel i New-AzureRmRecoveryServicesAsrProtectableItem har åtgärdats</span><span class="sxs-lookup"><span data-stu-id="6a1d9-629">Corrected example in New-AzureRmRecoveryServicesAsrProtectableItem</span></span>
* <span data-ttu-id="6a1d9-630">Uppdatera beroenden för problemet med typmappning</span><span class="sxs-lookup"><span data-stu-id="6a1d9-630">Update dependencies for type mapping issue</span></span>

### <a name="azrelay"></a><span data-ttu-id="6a1d9-631">Az.Relay</span><span class="sxs-lookup"><span data-stu-id="6a1d9-631">Az.Relay</span></span>
* <span data-ttu-id="6a1d9-632">Valfri parameter -KeyValue till New-AzureRmRelayKey cmdlet har lagts till, vilket gör det möjligt för användare att tillhandahålla KeyValue.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-632">Added optional Parameter -KeyValue to New-AzureRmRelayKey cmdlet, which enables user to provide KeyValue.</span></span>

### <a name="azresources"></a><span data-ttu-id="6a1d9-633">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="6a1d9-633">Az.Resources</span></span>
* <span data-ttu-id="6a1d9-634">Uppdatera hjälpdokumentation för resursidentitet kopplad till parametrar i `New-AzureRmPolicyAssignment` och `Set-AzureRmPolicyAssignment`</span><span class="sxs-lookup"><span data-stu-id="6a1d9-634">Update help documentation for resource identity related parameters in `New-AzureRmPolicyAssignment` and `Set-AzureRmPolicyAssignment`</span></span>
* <span data-ttu-id="6a1d9-635">Lägg till ett exempel för New-AzureRmPolicyDefinition som använder -Metadata</span><span class="sxs-lookup"><span data-stu-id="6a1d9-635">Add an example for New-AzureRmPolicyDefinition that uses -Metadata</span></span>
* <span data-ttu-id="6a1d9-636">Korrigera så att skiftläge behålls i taggnycklar i NetStandard: #7678 #7703</span><span class="sxs-lookup"><span data-stu-id="6a1d9-636">Fix to allow case preservation in Tag keys in NetStandard: #7678 #7703</span></span>

### <a name="azservicefabric"></a><span data-ttu-id="6a1d9-637">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="6a1d9-637">Az.ServiceFabric</span></span>
* <span data-ttu-id="6a1d9-638">Lägg till utfasningsmeddelanden för kommande icke-kompatibla ändringar</span><span class="sxs-lookup"><span data-stu-id="6a1d9-638">Add deprecation messages for upcoming breaking changes</span></span>

### <a name="azsql"></a><span data-ttu-id="6a1d9-639">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="6a1d9-639">Az.Sql</span></span>
* <span data-ttu-id="6a1d9-640">Nya cmdletar för CRUD-åtgärder på Azure Sql Database-hanterad instans och Azure Sql-hanterad databas</span><span class="sxs-lookup"><span data-stu-id="6a1d9-640">Added new cmdlets for CRUD operations on Azure Sql Database Managed Instance and Azure Sql Managed Database</span></span>
    - <span data-ttu-id="6a1d9-641">Get-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="6a1d9-641">Get-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="6a1d9-642">New-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="6a1d9-642">New-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="6a1d9-643">Set-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="6a1d9-643">Set-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="6a1d9-644">Remove-AzureRmSqlInstance</span><span class="sxs-lookup"><span data-stu-id="6a1d9-644">Remove-AzureRmSqlInstance</span></span>
    - <span data-ttu-id="6a1d9-645">Get-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="6a1d9-645">Get-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="6a1d9-646">New-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="6a1d9-646">New-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="6a1d9-647">Restore-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="6a1d9-647">Restore-AzureRmSqlInstanceDatabase</span></span>
    - <span data-ttu-id="6a1d9-648">Remove-AzureRmSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="6a1d9-648">Remove-AzureRmSqlInstanceDatabase</span></span>
* <span data-ttu-id="6a1d9-649">Hantering av utökad granskningsprincip på en server eller en databas har aktiverats.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-649">Enabled Extended Auditing Policy management on a server or a database.</span></span>
    - <span data-ttu-id="6a1d9-650">Ny parameter (PredicateExpression) har lagts till för att aktivera filtrering av granskningsloggar.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-650">New parameter (PredicateExpression) was added to enable filtering of audit logs.</span></span>
    - <span data-ttu-id="6a1d9-651">Cmdletar har ändrats så att de använder SQL-klienter i stället för äldre klienter.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-651">Cmdlets were modified to use SQL clients instead of Legacy clients.</span></span>
    - <span data-ttu-id="6a1d9-652">Set-AzureRmSqlServerAuditing.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-652">Set-AzureRmSqlServerAuditing.</span></span>
    - <span data-ttu-id="6a1d9-653">Get-AzureRmSqlServerAuditing.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-653">Get-AzureRmSqlServerAuditing.</span></span>
    - <span data-ttu-id="6a1d9-654">Get-AzureRmSqlServerAuditing.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-654">Set-AzureRmSqlDatabaseAuditing.</span></span>
    - <span data-ttu-id="6a1d9-655">Get-AzureRmSqlDatabaseAuditing.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-655">Get-AzureRmSqlDatabaseAuditing.</span></span>
* <span data-ttu-id="6a1d9-656">Problem med att använda Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings med lagringskontots namnparameter har korrigerats</span><span class="sxs-lookup"><span data-stu-id="6a1d9-656">Fixed issue with using Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings with storage account name parameter set</span></span>

## <a name="050---november-2018"></a><span data-ttu-id="6a1d9-657">0.5.0 – november 2018</span><span class="sxs-lookup"><span data-stu-id="6a1d9-657">0.5.0 - November 2018</span></span>
#### <a name="general"></a><span data-ttu-id="6a1d9-658">Allmänt</span><span class="sxs-lookup"><span data-stu-id="6a1d9-658">General</span></span>
* <span data-ttu-id="6a1d9-659">Lade till resurskompletterare till många kärn-cmdletar – dessa gör att du kan stega genom befintliga resursnamn med TABB vid interaktiva anrop till cmdletar</span><span class="sxs-lookup"><span data-stu-id="6a1d9-659">Added Resource Completers to many core cmdlets - these alloow you to tab through existing resource names when invoking cmdlets interactively</span></span>

#### <a name="azprofile"></a><span data-ttu-id="6a1d9-660">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="6a1d9-660">Az.Profile</span></span>
* <span data-ttu-id="6a1d9-661">Uppdatera gemensam kod så att den använder den senaste versionen av ClientRuntime</span><span class="sxs-lookup"><span data-stu-id="6a1d9-661">Update common code to use latest version of ClientRuntime</span></span>
* <span data-ttu-id="6a1d9-662">Bytte namn på parametern TenantId i cmdleten Connect-AzAccount till Tenant och lade till ett alias för TenantId</span><span class="sxs-lookup"><span data-stu-id="6a1d9-662">Rename param TenantId in cmdlet Connect-AzAccount to Tenant and add an alias for TenantId</span></span>
* <span data-ttu-id="6a1d9-663">Uppdaterade TenantId-beskrivningen för Connect-AzAccount</span><span class="sxs-lookup"><span data-stu-id="6a1d9-663">Updated TenantId description for Connect-AzAccount</span></span>
* <span data-ttu-id="6a1d9-664">Åtgärda felmeddelande för misslyckad inloggning när du tillhandahåller klientdomän</span><span class="sxs-lookup"><span data-stu-id="6a1d9-664">Fix error message for failed login when providing tenant domain</span></span>
    - https://github.com/Azure/azure-powershell/issues/6936
* <span data-ttu-id="6a1d9-665">Åtgärda problem med att kontextnamn hamnar i konflikt för konton utan prenumerationer i klientorganisationen</span><span class="sxs-lookup"><span data-stu-id="6a1d9-665">Fix issue with context name clashing for accounts with no subscriptions in tenant</span></span>
    - https://github.com/Azure/azure-powershell/issues/7453
* <span data-ttu-id="6a1d9-666">Åtgärda problem med DataLake-slutpunkter vid användning av MSI</span><span class="sxs-lookup"><span data-stu-id="6a1d9-666">Fix issue with DataLake endpoints when using MSI</span></span>
    - https://github.com/Azure/azure-powershell/issues/7462
* <span data-ttu-id="6a1d9-667">Åtgärdade problem med att Disconnect-AzAccount kastades om den inte anslöts</span><span class="sxs-lookup"><span data-stu-id="6a1d9-667">Fix issue where 'Disconnect-AzAccount' would throw if not connected</span></span>
    - https://github.com/Azure/azure-powershell/issues/7167

#### <a name="azcognitiveservices"></a><span data-ttu-id="6a1d9-668">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="6a1d9-668">Az.CognitiveServices</span></span>
* <span data-ttu-id="6a1d9-669">Lade till åtgärden Get-AzCognitiveServicesAccountSkus.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-669">Add Get-AzCognitiveServicesAccountSkus operation.</span></span>

#### <a name="azcompute"></a><span data-ttu-id="6a1d9-670">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="6a1d9-670">Az.Compute</span></span>
* <span data-ttu-id="6a1d9-671">Lade till cmdletarna Add-AzVmssVMDataDisk och Remove-AzVmssVMDataDisk</span><span class="sxs-lookup"><span data-stu-id="6a1d9-671">Add Add-AzVmssVMDataDisk and Remove-AzVmssVMDataDisk cmdlets</span></span>
* <span data-ttu-id="6a1d9-672">Get-AzVMImage visar AutomaticOSUpgradeProperties</span><span class="sxs-lookup"><span data-stu-id="6a1d9-672">Get-AzVMImage shows AutomaticOSUpgradeProperties</span></span>
* <span data-ttu-id="6a1d9-673">Åtgärdade att värdena för alternativen SetAzVMChefExtension -BootstrapOptions och -JsonAttribute inte angavs i json-format.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-673">Fixed SetAzVMChefExtension -BootstrapOptions and -JsonAttribute option values are not setting in json format.</span></span>

#### <a name="azdatalakestore"></a><span data-ttu-id="6a1d9-674">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="6a1d9-674">Az.DataLakeStore</span></span>
* <span data-ttu-id="6a1d9-675">Uppdatera DataLake-paketet till 1.1.10.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-675">Update the DataLake package to 1.1.10.</span></span>
* <span data-ttu-id="6a1d9-676">Lägg till standardsamtidighet för flertrådade åtgärder.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-676">Add default Concurrency to multithreaded operations.</span></span>

#### <a name="azinsights"></a><span data-ttu-id="6a1d9-677">Az.Insights</span><span class="sxs-lookup"><span data-stu-id="6a1d9-677">Az.Insights</span></span>
* <span data-ttu-id="6a1d9-678">Åtgärdade problem #7267 (autoskalningsområde)</span><span class="sxs-lookup"><span data-stu-id="6a1d9-678">Fixed issue #7267 (Autoscale area)</span></span>
    - <span data-ttu-id="6a1d9-679">Problem med att uppräknade parametrar inte ställdes in ordentligt när du skapade en ny autoskalningsregel (de ställdes alltid in med standardvärdet).</span><span class="sxs-lookup"><span data-stu-id="6a1d9-679">Issues with creating a new autoscale rule not properly setting enumerated parameters (would always set them to the default value).</span></span>
* <span data-ttu-id="6a1d9-680">Åtgärdade problem #7513 [Insights] Set-AzDiagnosticSetting kräver uttrycklig specifikation av kategorier när inställningar skapas</span><span class="sxs-lookup"><span data-stu-id="6a1d9-680">Fixed issue #7513 [Insights] Set-AzDiagnosticSetting requires explicit specification of categories during creation of setting</span></span>
    - <span data-ttu-id="6a1d9-681">Nu kräver inte cmdleten uttrycklig anvisning av kategorierna för att aktiveras under skapande, d.v.s. den fungerar enligt beskrivning</span><span class="sxs-lookup"><span data-stu-id="6a1d9-681">Now the cmdlet does not require explicit indication of the categories to enable during creation, i.e. it works as it is documented</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="6a1d9-682">Az.Network</span><span class="sxs-lookup"><span data-stu-id="6a1d9-682">Az.Network</span></span>
* <span data-ttu-id="6a1d9-683">PeeringType ändrades till en obligatorisk parameter för följande cmdletar:</span><span class="sxs-lookup"><span data-stu-id="6a1d9-683">Changed PeeringType to be a mandatory parameter for the following cmdlets:-</span></span>
    - <span data-ttu-id="6a1d9-684">Get-AzExpressRouteCircuitRouteTable</span><span class="sxs-lookup"><span data-stu-id="6a1d9-684">Get-AzExpressRouteCircuitRouteTable</span></span>
    - <span data-ttu-id="6a1d9-685">Get-AzExpressRouteCircuitARPTable</span><span class="sxs-lookup"><span data-stu-id="6a1d9-685">Get-AzExpressRouteCircuitARPTable</span></span>
    - <span data-ttu-id="6a1d9-686">Get-AzExpressRouteCircuitRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="6a1d9-686">Get-AzExpressRouteCircuitRouteTableSummary</span></span>
    - <span data-ttu-id="6a1d9-687">Get-AzExpressRouteCrossConnectionArpTable</span><span class="sxs-lookup"><span data-stu-id="6a1d9-687">Get-AzExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="6a1d9-688">Get-AzExpressRouteCrossConnectionRouteTable</span><span class="sxs-lookup"><span data-stu-id="6a1d9-688">Get-AzExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="6a1d9-689">Get-AzExpressRouteCrossConnectionRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="6a1d9-689">Get-AzExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azpolicyinsights"></a><span data-ttu-id="6a1d9-690">Az.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="6a1d9-690">Az.PolicyInsights</span></span>
* <span data-ttu-id="6a1d9-691">Cmdletar för principreparation har lagts till</span><span class="sxs-lookup"><span data-stu-id="6a1d9-691">Added policy remediation cmdlets</span></span>

#### <a name="azresources"></a><span data-ttu-id="6a1d9-692">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="6a1d9-692">Az.Resources</span></span>
* <span data-ttu-id="6a1d9-693">Korrigering för https://github.com/Azure/azure-powershell/issues/7402</span><span class="sxs-lookup"><span data-stu-id="6a1d9-693">Fix for https://github.com/Azure/azure-powershell/issues/7402</span></span>
    - <span data-ttu-id="6a1d9-694">Tillåt att resurser listas med parametern -ResourceId för Get-AzResource</span><span class="sxs-lookup"><span data-stu-id="6a1d9-694">Allow listing resources using the '-ResourceId' parameter for 'Get-AzResource'</span></span>

#### <a name="azservicebus"></a><span data-ttu-id="6a1d9-695">Az.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="6a1d9-695">Az.ServiceBus</span></span>
* <span data-ttu-id="6a1d9-696">Skrivskyddad MigrationState-egenskap har lagts till i PSServiceBusMigrationConfigurationAttributes, som hjälper till att hålla koll på migreringstillståndet.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-696">Added MigrationState read-only property to PSServiceBusMigrationConfigurationAttributes which will help to know the Migration state.</span></span>

#### <a name="azservicefabric"></a><span data-ttu-id="6a1d9-697">Az.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="6a1d9-697">Az.ServiceFabric</span></span>
* <span data-ttu-id="6a1d9-698">Åtgärda att lägga till certifikat till Linux-Vmss.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-698">Fix add certificate to Linux Vmss.</span></span>
* <span data-ttu-id="6a1d9-699">Åtgärdade Add-AzServiceFabricClusterCertificate</span><span class="sxs-lookup"><span data-stu-id="6a1d9-699">Fix 'Add-AzServiceFabricClusterCertificate'</span></span>
    - <span data-ttu-id="6a1d9-700">Använd rätt tumavtryck från nya certifikat (Azure/service-fabric-issues#932).</span><span class="sxs-lookup"><span data-stu-id="6a1d9-700">Using correct thumbprint from new certificate (Azure/service-fabric-issues#932).</span></span>
    - <span data-ttu-id="6a1d9-701">Visa undantag korrekt (Azure/service-fabric-issues#1054).</span><span class="sxs-lookup"><span data-stu-id="6a1d9-701">Display exception correctly (Azure/service-fabric-issues#1054).</span></span>
* <span data-ttu-id="6a1d9-702">Åtgärdade Update-AzServiceFabricDurability så att klusterkonfigurationen uppdateras innan Vmss-åtgärden CreateOrUpdate påbörjas.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-702">Fix 'Update-AzServiceFabricDurability' to update cluster configuration before starting Vmss CreateOrUpdate operation.</span></span>

## <a name="040---october-2018"></a><span data-ttu-id="6a1d9-703">0.4.0 – oktober 2018</span><span class="sxs-lookup"><span data-stu-id="6a1d9-703">0.4.0 - October 2018</span></span>
#### <a name="azprofile"></a><span data-ttu-id="6a1d9-704">Az.Profile</span><span class="sxs-lookup"><span data-stu-id="6a1d9-704">Az.Profile</span></span>
* <span data-ttu-id="6a1d9-705">Åtgärdade problemet med Get-AzSubscription i CloudShell</span><span class="sxs-lookup"><span data-stu-id="6a1d9-705">Fix issue with Get-AzSubscription in CloudShell</span></span>
* <span data-ttu-id="6a1d9-706">Uppdatera gemensam kod så att den använder den senaste versionen av ClientRuntime</span><span class="sxs-lookup"><span data-stu-id="6a1d9-706">Update common code to use latest version of ClientRuntime</span></span>

#### <a name="azcompute"></a><span data-ttu-id="6a1d9-707">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="6a1d9-707">Az.Compute</span></span>
* <span data-ttu-id="6a1d9-708">Nya storlekar lades till i listan över godkända VM-storlekar för vilka accelererat nätverk kommer att aktiveras vid användning av den enkla parameteruppsättningen för New-AzVm</span><span class="sxs-lookup"><span data-stu-id="6a1d9-708">Added new sizes to the whitelist of VM sizes for which accelerated networking will be turned on when using the simple param set for 'New-AzVm'</span></span>
* <span data-ttu-id="6a1d9-709">Argumentslutförare för ResourceName har lagts till i alla cmdletar.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-709">Added ResourceName argument completer to all cmdlets.</span></span>

#### <a name="azdatalakestore"></a><span data-ttu-id="6a1d9-710">Az.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="6a1d9-710">Az.DataLakeStore</span></span>
* <span data-ttu-id="6a1d9-711">Lägger till stöd för regler för virtuellt nätverk</span><span class="sxs-lookup"><span data-stu-id="6a1d9-711">Adding support for Virtual Network Rules</span></span>
    - <span data-ttu-id="6a1d9-712">Get-AzDataLakeStoreVirtualNetworkRule: Hämtar eller listar regel för virtuellt nätverk i Azure Data Lake Store.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-712">Get-AzDataLakeStoreVirtualNetworkRule: Gets or Lists Azure Data Lake Store virtual network rule.</span></span>
    - <span data-ttu-id="6a1d9-713">Add-AzDataLakeStoreVirtualNetworkRule: Lägger till en regel för virtuellt nätverk i det angivna Data Lake Store-kontot.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-713">Add-AzDataLakeStoreVirtualNetworkRule: Adds a virtual network rule to the specified Data Lake Store account.</span></span>
    - <span data-ttu-id="6a1d9-714">Set-AzDataLakeStoreVirtualNetworkRule: Ändrar den angivna regeln för virtuellt nätverk i det angivna Data Lake Store-kontot.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-714">Set-AzDataLakeStoreVirtualNetworkRule: Modifies the specified virtual network rule in the specified Data Lake Store account.</span></span>
    - <span data-ttu-id="6a1d9-715">Remove-AzDataLakeStoreVirtualNetworkRule: Tar bort en regel för virtuellt nätverk i Azure Data Lake Store.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-715">Remove-AzDataLakeStoreVirtualNetworkRule: Deletes an Azure Data Lake Store virtual network rule.</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="6a1d9-716">Az.Network</span><span class="sxs-lookup"><span data-stu-id="6a1d9-716">Az.Network</span></span>
* <span data-ttu-id="6a1d9-717">Skicka protokollvärdet till serverdelen för att uppdatera cmdleten Test-AzNetworkWatcherConnectivity.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-717">Update cmdlet Test-AzNetworkWatcherConnectivity, pass the protocol value to backend.</span></span>
* <span data-ttu-id="6a1d9-718">Argumentslutförare för ResourceName har lagts till i alla cmdletar.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-718">Added ResourceName argument completer to all cmdlets.</span></span>

#### <a name="azresources"></a><span data-ttu-id="6a1d9-719">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="6a1d9-719">Az.Resources</span></span>
* <span data-ttu-id="6a1d9-720">Åtgärdade problem där Get-AzRoleDefinition genererar ett oläsligt undantag (när standardprofilen inte innehåller någon prenumeration och ingen omfattning har angetts) genom att lägga till ett beskrivande undantag i scenariot.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-720">Fix isssue where Get-AzRoleDefinition throws an unintelligible exception (when the default profile has no subscription in it and no scope is specified) by adding a meaningful exception in the scenario.</span></span> <span data-ttu-id="6a1d9-721">Ställ in ”RoleDefinitionNameParameterSet” som standardparameteruppsättning.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-721">Also set the default param set to 'RoleDefinitionNameParameterSet'.</span></span>

## <a name="030---october-2018"></a><span data-ttu-id="6a1d9-722">0.3.0 – oktober 2018</span><span class="sxs-lookup"><span data-stu-id="6a1d9-722">0.3.0 - October 2018</span></span>
#### <a name="azurestorage"></a><span data-ttu-id="6a1d9-723">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="6a1d9-723">Azure.Storage</span></span>
* <span data-ttu-id="6a1d9-724">Åtgärda fel där Kopiera blob/fil inte kopierar metadata när målplatsen har ett problem med metadata</span><span class="sxs-lookup"><span data-stu-id="6a1d9-724">Fix Copy Blob/File won't copy metadata when destination has metadata issue</span></span>
    - <span data-ttu-id="6a1d9-725">Start-AzureStorageBlobCopy</span><span class="sxs-lookup"><span data-stu-id="6a1d9-725">Start-AzureStorageBlobCopy</span></span>
    - <span data-ttu-id="6a1d9-726">Start-AzureStorageFileCopy</span><span class="sxs-lookup"><span data-stu-id="6a1d9-726">Start-AzureStorageFileCopy</span></span>
* <span data-ttu-id="6a1d9-727">Stöd för att hämta användningsinformation om en Storage-resurs för en specifik plats och för att lägga till ett varningsmeddelande för att hämta användningsinformation om en global Storage-resurs är inaktuellt.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-727">Support get the Storage resource usage of a specific location, and add warning message for get global Storage resource usage is obsolete.</span></span>
    - <span data-ttu-id="6a1d9-728">Get-AzStorageUsage</span><span class="sxs-lookup"><span data-stu-id="6a1d9-728">Get-AzStorageUsage</span></span>

#### <a name="azcognitiveservices"></a><span data-ttu-id="6a1d9-729">Az.CognitiveServices</span><span class="sxs-lookup"><span data-stu-id="6a1d9-729">Az.CognitiveServices</span></span>
* <span data-ttu-id="6a1d9-730">Stöd för Get-AzCognitiveServicesAccountSkus utan ett befintligt konto.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-730">Support Get-AzCognitiveServicesAccountSkus without an existing account.</span></span>

#### <a name="azcompute"></a><span data-ttu-id="6a1d9-731">Az.Compute</span><span class="sxs-lookup"><span data-stu-id="6a1d9-731">Az.Compute</span></span>
* <span data-ttu-id="6a1d9-732">Åtgärdade fel där Get-AzVM -ResourceGroupName <rg> returnerar fler än 50 resultat om det behövs</span><span class="sxs-lookup"><span data-stu-id="6a1d9-732">Fix Get-AzVM -ResourceGroupName <rg> to return more than 50 results if needed</span></span>
* <span data-ttu-id="6a1d9-733">Lade till ett exempel för SimpleParameterSet i hjälpen för cmdleten New-AzVmss.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-733">Added an example of the 'SimpleParameterSet' to New-AzVmss cmdlet help.</span></span>
* <span data-ttu-id="6a1d9-734">Ett stavfel i förloppsmeddelandet för Azure Disk Encryption har korrigerats</span><span class="sxs-lookup"><span data-stu-id="6a1d9-734">Fixed a typo in the Azure Disk Encryption progress message</span></span>

#### <a name="azdatafactoryv2"></a><span data-ttu-id="6a1d9-735">Az.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="6a1d9-735">Az.DataFactoryV2</span></span>
* <span data-ttu-id="6a1d9-736">ADF .Net SDK-versionen har uppdaterats till 2.3.0.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-736">Updated the ADF .Net SDK version to 2.3.0.</span></span>

#### <a name="aznetwork"></a><span data-ttu-id="6a1d9-737">Az.Network</span><span class="sxs-lookup"><span data-stu-id="6a1d9-737">Az.Network</span></span>
* <span data-ttu-id="6a1d9-738">Funktionalitet för NetworkProfile har lagts till.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-738">Added NetworkProfile functionality.</span></span> <span data-ttu-id="6a1d9-739">nya cmdletar har lagts till</span><span class="sxs-lookup"><span data-stu-id="6a1d9-739">new cmdlets added</span></span>
    - <span data-ttu-id="6a1d9-740">Get-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="6a1d9-740">Get-AzNetworkProfile</span></span>
    - <span data-ttu-id="6a1d9-741">New-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="6a1d9-741">New-AzNetworkProfile</span></span>
    - <span data-ttu-id="6a1d9-742">Remove-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="6a1d9-742">Remove-AzNetworkProfile</span></span>
    - <span data-ttu-id="6a1d9-743">Set-AzNetworkProfile</span><span class="sxs-lookup"><span data-stu-id="6a1d9-743">Set-AzNetworkProfile</span></span>
    - <span data-ttu-id="6a1d9-744">New-AzContainerNicConfig</span><span class="sxs-lookup"><span data-stu-id="6a1d9-744">New-AzContainerNicConfig</span></span>
    - <span data-ttu-id="6a1d9-745">New-AzContainerNicConfigIpConfig</span><span class="sxs-lookup"><span data-stu-id="6a1d9-745">New-AzContainerNicConfigIpConfig</span></span>
* <span data-ttu-id="6a1d9-746">Länk för tjänstassociering på modell för undernät har lagts till</span><span class="sxs-lookup"><span data-stu-id="6a1d9-746">Added service association link on Subnet Model</span></span>
* <span data-ttu-id="6a1d9-747">Cmdletarna New-AzVirtualNetworkTap, Get-AzVirtualNetworkTap, Set-AzVirtualNetworkTap och Remove-AzVirtualNetworkTap har lagts till</span><span class="sxs-lookup"><span data-stu-id="6a1d9-747">Added cmdlet New-AzVirtualNetworkTap, Get-AzVirtualNetworkTap, Set-AzVirtualNetworkTap, Remove-AzVirtualNetworkTap</span></span>
* <span data-ttu-id="6a1d9-748">Cmdletarna Set-AzNEtworkInterfaceTapConfig, Get-AzNEtworkInterfaceTapConfig och Remove-AzNEtworkInterfaceTapConfig har lagts till</span><span class="sxs-lookup"><span data-stu-id="6a1d9-748">Added cmdlet Set-AzNEtworkInterfaceTapConfig, Get-AzNEtworkInterfaceTapConfig, Remove-AzNEtworkInterfaceTapConfig</span></span>

#### <a name="azrediscache"></a><span data-ttu-id="6a1d9-749">Az.RedisCache</span><span class="sxs-lookup"><span data-stu-id="6a1d9-749">Az.RedisCache</span></span>
* <span data-ttu-id="6a1d9-750">Tillåt att alla strängar används som storleksparametrar framöver.</span><span class="sxs-lookup"><span data-stu-id="6a1d9-750">Allow any string as Size parameter going forward.</span></span> <span data-ttu-id="6a1d9-751">Lägg till P5 i popup-fönstret PSArgumentCompleter</span><span class="sxs-lookup"><span data-stu-id="6a1d9-751">Add P5 in PSArgumentCompleter popup</span></span>

#### <a name="azresources"></a><span data-ttu-id="6a1d9-752">Az.Resources</span><span class="sxs-lookup"><span data-stu-id="6a1d9-752">Az.Resources</span></span>
* <span data-ttu-id="6a1d9-753">Parametern -Mode som saknades i Set-AzPolicyDefinition har lagts till</span><span class="sxs-lookup"><span data-stu-id="6a1d9-753">Add missing -Mode parameter to Set-AzPolicyDefinition</span></span>
* <span data-ttu-id="6a1d9-754">Åtgärdade buggen för cmdleten Get-AzProviderOperation för åtgärder med ursprung som innehåller användare</span><span class="sxs-lookup"><span data-stu-id="6a1d9-754">Fix Get-AzProviderOperation commandlet bug for operations with Origin containing User</span></span>

#### <a name="azsql"></a><span data-ttu-id="6a1d9-755">Az.Sql</span><span class="sxs-lookup"><span data-stu-id="6a1d9-755">Az.Sql</span></span>
* <span data-ttu-id="6a1d9-756">Ett problem där vissa cmdletar för säkerhetskopiering inte kunde identifiera den aktuella azure-prenumerationen har åtgärdats</span><span class="sxs-lookup"><span data-stu-id="6a1d9-756">Fixed issue where some backup cmdlets would not recognize the current azure subscription</span></span>

#### <a name="azwebsites"></a><span data-ttu-id="6a1d9-757">Az.Websites</span><span class="sxs-lookup"><span data-stu-id="6a1d9-757">Az.Websites</span></span>
* <span data-ttu-id="6a1d9-758">Ny cmdlet: Get-AzWebAppContainerContinuousDeploymentUrl – Hämtar webhook-URL:en för kontinuerlig distribution av container</span><span class="sxs-lookup"><span data-stu-id="6a1d9-758">New Cmdlet Get-AzWebAppContainerContinuousDeploymentUrl - Gets the Container Continuous Deployment Webhook URL</span></span>
* <span data-ttu-id="6a1d9-759">Nya cmdletar: New-AzWebAppContainerPSSession och Enter-WebAppContainerPSSession – Startar en PowerShell-fjärrsession i en containerapp för windows</span><span class="sxs-lookup"><span data-stu-id="6a1d9-759">New Cmdlets New-AzWebAppContainerPSSession and Enter-WebAppContainerPSSession  - Initiates a PowerShell remote session into a windows container app</span></span>

## <a name="020---september-2018"></a><span data-ttu-id="6a1d9-760">0.2.0 – september 2018</span><span class="sxs-lookup"><span data-stu-id="6a1d9-760">0.2.0 - September 2018</span></span>
 <span data-ttu-id="6a1d9-761">Första versionen</span><span class="sxs-lookup"><span data-stu-id="6a1d9-761">Initial Release</span></span>
