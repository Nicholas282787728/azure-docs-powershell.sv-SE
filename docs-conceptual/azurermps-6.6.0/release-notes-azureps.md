...
* Common.Strategy-biblioteket har uppdaterats för att kunna verifiera att den aktuella konfigurationsfilen för en resurs är kompatibel med målresursen. Standardvärdet är alltid true, enskilda resurser och skriver över standardvärdet.
* ps1xml-typer har lagts till i Common.Storage

#### <a name="azurestorage"></a>Azure.Storage
* Stöd har lagts till för att hämta lagringskontext från DefaulfProfile
* Lägg till Ps1XmlAttribute i egenskaper för cmdletar för utdatatyper.
