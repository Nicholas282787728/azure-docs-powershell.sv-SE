...
### Exempel 1: ta bort ett VM-tillägg som finns 
```powershell
PS C:\> Remove-AzsVMExtension -Location local -Publisher Microsoft -Type MicroExtension -Version 0.1.0
```

Ett lyckat samtal för att ta bort en Beräknad kvot returnerar inte något resultat

### Exempel 2: ta bort ett VM-tillägg som inte finns
```powershell
